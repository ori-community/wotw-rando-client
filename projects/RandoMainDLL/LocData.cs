...
namespace RandoMainDLL {
  ...
  public static class LocDataStaticHelper {
    ...
    public static Dictionary<UberId, LocData> All = new Dictionary<UberId, LocData>() {
      ...
      {new UberId(16155, 38979), new LocData(ZoneType.Willow, LocType.Ore)},
      {new UberId(16155, 49381), new LocData(ZoneType.Willow, LocType.SpiritLight)},
      {new UberId(16155, 46270), new LocData(ZoneType.Willow, LocType.Health)},
      {new UberId(48248, 4045), new LocData(ZoneType.Willow, LocType.Shop)},
      {new UberId(16155, 9230), new LocData(ZoneType.Willow, LocType.Ore)},
      {new UberId(16155, 55446), new LocData(ZoneType.Willow, LocType.SpiritLight)},
      {new UberId(36153, 23902), new LocData(ZoneType.Willow, LocType.SpiritLight)},
      {new UberId(36153, 3662), new LocData(ZoneType.Willow, LocType.SpiritLight)},

        ...
        IL2CPP_INTERCEPT(Moon, UberStateCollection, void, PrepareRuntimeDataType, (app::UberStateCollection* this_ptr)) {
            if (!initialized)
            {
                std::vector<app::IUberState*> states = {
                    ...
                    add_state<app::SerializedBooleanUberState>("SerializedBooleanUberState", constants::RANDO_UPGRADE_GROUP_NAME, constants::RANDO_UPGRADE_GROUP_ID, "Autoaim", 37, true),
                    ...
                    add_state<app::SerializedByteUberState>("SerializedIntUberState", constants::RANDO_STATS_GROUP_NAME, constants::RANDO_STATS_GROUP_ID, "Marsh Time", 0, 0),
                    add_state<app::SerializedByteUberState>("SerializedIntUberState", constants::RANDO_STATS_GROUP_NAME, constants::RANDO_STATS_GROUP_ID, "Hollow Time", 1, 0),
                    add_state<app::SerializedByteUberState>("SerializedIntUberState", constants::RANDO_STATS_GROUP_NAME, constants::RANDO_STATS_GROUP_ID, "Glades Time", 2, 0),
                    add_state<app::SerializedByteUberState>("SerializedIntUberState", constants::RANDO_STATS_GROUP_NAME, constants::RANDO_STATS_GROUP_ID, "Wellspring Time", 3, 0),
                    add_state<app::SerializedByteUberState>("SerializedIntUberState", constants::RANDO_STATS_GROUP_NAME, constants::RANDO_STATS_GROUP_ID, "Burrows Time", 4, 0),
                    add_state<app::SerializedByteUberState>("SerializedIntUberState", constants::RANDO_STATS_GROUP_NAME, constants::RANDO_STATS_GROUP_ID, "Woods Time", 5, 0),
                    add_state<app::SerializedByteUberState>("SerializedIntUberState", constants::RANDO_STATS_GROUP_NAME, constants::RANDO_STATS_GROUP_ID, "Reach Time", 6, 0),
                    add_state<app::SerializedByteUberState>("SerializedIntUberState", constants::RANDO_STATS_GROUP_NAME, constants::RANDO_STATS_GROUP_ID, "Pools Time", 7, 0),
                    add_state<app::SerializedByteUberState>("SerializedIntUberState", constants::RANDO_STATS_GROUP_NAME, constants::RANDO_STATS_GROUP_ID, "Depths Time", 8, 0),
                    add_state<app::SerializedByteUberState>("SerializedIntUberState", constants::RANDO_STATS_GROUP_NAME, constants::RANDO_STATS_GROUP_ID, "Wastes Time", 9, 0),
                    add_state<app::SerializedByteUberState>("SerializedIntUberState", constants::RANDO_STATS_GROUP_NAME, constants::RANDO_STATS_GROUP_ID, "Ruins Time", 10, 0),
                    add_state<app::SerializedByteUberState>("SerializedIntUberState", constants::RANDO_STATS_GROUP_NAME, constants::RANDO_STATS_GROUP_ID, "Willow Time", 11, 0),
                    add_state<app::SerializedByteUberState>("SerializedIntUberState", constants::RANDO_STATS_GROUP_NAME, constants::RANDO_STATS_GROUP_ID, "Void Time", 12, 0),
                    ...
                    add_state<app::SerializedByteUberState>("SerializedIntUberState", constants::RANDO_STATS_GROUP_NAME, constants::RANDO_STATS_GROUP_ID, "Marsh Pickups", 40, 0),
                    add_state<app::SerializedByteUberState>("SerializedIntUberState", constants::RANDO_STATS_GROUP_NAME, constants::RANDO_STATS_GROUP_ID, "Hollow Pickups", 41, 0),
                    add_state<app::SerializedByteUberState>("SerializedIntUberState", constants::RANDO_STATS_GROUP_NAME, constants::RANDO_STATS_GROUP_ID, "Glades Pickups", 42, 0),
                    add_state<app::SerializedByteUberState>("SerializedIntUberState", constants::RANDO_STATS_GROUP_NAME, constants::RANDO_STATS_GROUP_ID, "Wellspring Pickups", 43, 0),
                    add_state<app::SerializedByteUberState>("SerializedIntUberState", constants::RANDO_STATS_GROUP_NAME, constants::RANDO_STATS_GROUP_ID, "Burrows Pickups", 44, 0),
                    add_state<app::SerializedByteUberState>("SerializedIntUberState", constants::RANDO_STATS_GROUP_NAME, constants::RANDO_STATS_GROUP_ID, "Woods Pickups", 45, 0),
                    add_state<app::SerializedByteUberState>("SerializedIntUberState", constants::RANDO_STATS_GROUP_NAME, constants::RANDO_STATS_GROUP_ID, "Reach Pickups", 46, 0),
                    add_state<app::SerializedByteUberState>("SerializedIntUberState", constants::RANDO_STATS_GROUP_NAME, constants::RANDO_STATS_GROUP_ID, "Pools Pickups", 47, 0),
                    add_state<app::SerializedByteUberState>("SerializedIntUberState", constants::RANDO_STATS_GROUP_NAME, constants::RANDO_STATS_GROUP_ID, "Depths Pickups", 48, 0),
                    add_state<app::SerializedByteUberState>("SerializedIntUberState", constants::RANDO_STATS_GROUP_NAME, constants::RANDO_STATS_GROUP_ID, "Wastes Pickups", 49, 0),
                    add_state<app::SerializedByteUberState>("SerializedIntUberState", constants::RANDO_STATS_GROUP_NAME, constants::RANDO_STATS_GROUP_ID, "Ruins Pickups", 50, 0),
                    add_state<app::SerializedByteUberState>("SerializedIntUberState", constants::RANDO_STATS_GROUP_NAME, constants::RANDO_STATS_GROUP_ID, "Willow Pickups", 51, 0),
                    add_state<app::SerializedByteUberState>("SerializedIntUberState", constants::RANDO_STATS_GROUP_NAME, constants::RANDO_STATS_GROUP_ID, "Void Pickups", 52, 0),

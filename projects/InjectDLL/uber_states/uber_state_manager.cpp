        ...
        IL2CPP_INTERCEPT(Moon, UberStateCollection, void, PrepareRuntimeDataType, (app::UberStateCollection* this_ptr)) {
            if (!initialized)
            {
                std::vector<app::IUberState*> states = {
                    ...
                    add_state<app::SerializedBooleanUberState>("SerializedBooleanUberState", constants::RANDO_UPGRADE_GROUP_NAME, constants::RANDO_UPGRADE_GROUP_ID, "Autoaim", 37, !csharp_bridge::check_ini("DisableAutoaim")),
                    add_state<app::SerializedBooleanUberState>("SerializedBooleanUberState", constants::RANDO_UPGRADE_GROUP_NAME, constants::RANDO_UPGRADE_GROUP_ID, "AlwaysShowSecrets", 38, !csharp_bridge::check_ini("DisableShowSecrets")),
                    ...
                    add_state<app::SerializedFloatUberState>("SerializedFloatUberState", constants::RANDO_CONFIG_GROUP_NAME, constants::RANDO_CONFIG_GROUP_ID, "icon_transparency", ICON_TRANSPARENCY_ID, 0.f),

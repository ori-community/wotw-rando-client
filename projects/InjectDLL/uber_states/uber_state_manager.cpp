        ...
        IL2CPP_INTERCEPT(Moon, UberStateCollection, void, PrepareRuntimeDataType, (app::UberStateCollection* this_ptr)) {
            if (!initialized)
            {
                std::vector<app::IUberState*> states = {
                    ...
                    add_state<app::SerializedIntUberState>("SerializedIntUberState", constants::OPHER_WEAPON_GROUP_NAME, constants::OPHER_WEAPON_GROUP_ID, "Water Breath cost", 11023, 0),
                    add_state<app::SerializedIntUberState>("SerializedIntUberState", constants::OPHER_WEAPON_GROUP_NAME, constants::OPHER_WEAPON_GROUP_ID, "Exploding Spike cost", 11074, 0),
                    add_state<app::SerializedIntUberState>("SerializedIntUberState", constants::OPHER_WEAPON_GROUP_NAME, constants::OPHER_WEAPON_GROUP_ID, "Shock Smash cost", 11098, 0),
                    add_state<app::SerializedIntUberState>("SerializedIntUberState", constants::OPHER_WEAPON_GROUP_NAME, constants::OPHER_WEAPON_GROUP_ID, "Static Star cost", 11106, 0),
                    add_state<app::SerializedIntUberState>("SerializedIntUberState", constants::OPHER_WEAPON_GROUP_NAME, constants::OPHER_WEAPON_GROUP_ID, "Charge Blaze cost", 11115, 0),
                    add_state<app::SerializedIntUberState>("SerializedIntUberState", constants::OPHER_WEAPON_GROUP_NAME, constants::OPHER_WEAPON_GROUP_ID, "Rapid Sentry cost", 11116, 0),

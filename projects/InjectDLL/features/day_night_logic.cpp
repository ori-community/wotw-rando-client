...
namespace {
    ...
    void initialize_day_night_logic() {
        ...
        // Sword Cutscene rain
        randomizer::conditions::register_new_setup_intercept({ "swampGetSpiritBlade/timesOfDayController", "swampGetSpiritBlade/timesOfDayTransition" }, { -480342150, 907153171 }, [](auto, auto, auto, auto) -> int32_t {

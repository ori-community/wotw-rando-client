...
#include <Il2CppModLoader/app/methods/SwampNightDayTransition.h>
#include <Il2CppModLoader/app/methods/PlayerAbilities.h>
#include <Il2CppModLoader/app/methods/QuestNodeSetup_QuestInteraction.h>
...
namespace {
    ...
    void
    find_day_night(app::List_1_SetupStateModifier___Fields &modifiers, app::GameObject *&day, app::GameObject *&night) {
    ...
    void initialize_day_night_logic() {
        randomizer::conditions::register_new_setup_intercept({"swampTorchIntroductionA/*setups/*timesOfDay"},
                                                             {-1052258879, 1819061226},
                                                             [](auto, auto, auto, auto) -> int32_t {
                                                                 return is_day() ? -1052258879 : 1819061226;
                                                             });

        randomizer::conditions::register_new_setup_intercept({"swampIntroBottom/artSetups/dayNightSetup"},
        ...
        randomizer::conditions::register_new_setup_intercept(
                {"willOfTheWispsLagoonConnection/artSetups/timesOfDayTransition"}, {1340727368, -76384365},
                [](auto, auto, auto, auto) -> int32_t {
        ...
        randomizer::conditions::register_new_setup_intercept(
                {"swampNightcrawlerBshortcut/*setups/timesOfDayTransition"}, {1001861749, 787945376},
                [](auto, auto, auto, auto) -> int32_t {
    ...
    IL2CPP_INTERCEPT(PlayerAbilities, bool, HasAbility,
                     (app::PlayerAbilities * this_ptr, app::AbilityType__Enum ability)) {

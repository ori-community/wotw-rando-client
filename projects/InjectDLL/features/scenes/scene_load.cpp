...
namespace scenes {
    ...
    namespace {
        ...
        IL2CPP_BINDING(, ScenesManager, app::RuntimeSceneMetaData*, RequestAdditivelyLoadScene, (app::ScenesManager * this_ptr, app::RuntimeSceneMetaData* meta, bool async, bool keepPreloaded, bool forceLoad, bool loadDependantScenes, bool queueIncludedScenes));
        ...
        IL2CPP_BINDING_OVERLOAD(, ScenesManager, void, UnsetPreventUnloading, (app::ScenesManager * this_ptr, app::RuntimeSceneMetaData* metaData), (
        ...
        IL2CPP_BINDING_OVERLOAD(, ScenesManager, app::SceneManagerScene*, GetFromCurrentScenes, (app::ScenesManager * this_ptr, app::RuntimeSceneMetaData* meta), (
                                                                                                                                                                          : RuntimeSceneMetaData
                                                                                                                                                                  ));

        IL2CPP_BINDING_OVERLOAD(, ScenesManager, void, PreventUnloading, (app::ScenesManager * this_ptr, app::RuntimeSceneMetaData* meta, bool prevent_disabling), (
                                                                                                                                                                           : RuntimeSceneMetaData, System
                                                                                                                                                                           : Boolean
                                                                                                                                                                   ))

...
namespace
{
    ...
    void initialize_water()
    {
        ...
        // corrupted / clean
        randomizer::conditions::register_new_setup_intercept({ "wellspringGladesHubBackground/dynamicSetups/waterStateController" },
            { 739518878, -1861424606 }, ai_create(739518878, -1861424606));
        // Corrupted / Clean
        randomizer::conditions::register_new_setup_intercept({
                "wellspringGladesHub/dynamicSetups/waterStateController",
                "wellspringGladesHubB/dynamicSetups/waterStateController"
            }, { 2054782292, -357160486 }, ai_create(2054782292, -357160486)
        );
        // Corrupted / Clean
        ...
        randomizer::conditions::register_new_setup_intercept({ "wotwSaveRoomC__clone0__clone1/dynamicSetups/waterSetup" },
            { -1876259767, -1976832348 }, ai_create(-1876259767, -1976832348));
        // Corrupted / Clean
        randomizer::conditions::register_new_setup_intercept({ "waterMillPool__clone0/dynamicSetups/waterSetup" },
            { -1947088109, 385303388 }, ai_create(-1947088109, 385303388));
        // Poisoned / Clean
        ...
        // Corrupted / Clean
        randomizer::conditions::register_new_setup_intercept({ "kwoloksCavernStomperSideRoom/dynamicSetups/waterStateController" },
            { 1762013712, 816885685 }, ai_create(1762013712, 816885685));

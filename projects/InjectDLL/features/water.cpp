...
namespace {
    ...
    void initialize_water() {
        ...
        // corrupted / clean
        randomizer::conditions::register_new_setup_intercept({ "lumaPoolsP/dynamicSetups/waterStateController" }, { 742737118, 669048353 }, ai_create(742737118, 669048353));
        // corrupted / clean
        randomizer::conditions::register_new_setup_intercept({ "wellspringGladesHubBackground/dynamicSetups/waterStateController" }, { 739518878, -1861424606 }, ai_create(739518878, -1861424606));
        // Corrupted / Clean
        randomizer::conditions::register_new_setup_intercept({ "wellspringGladesHub/dynamicSetups/waterStateController", "wellspringGladesHubB/dynamicSetups/waterStateController" }, { 2054782292, -357160486 }, ai_create(2054782292, -357160486));
        // Corrupted / Clean
        randomizer::conditions::register_new_setup_intercept({ "waterMillCEntrance/dynamicSetups/waterSetup" }, { 1639966459, 127921689 }, ai_create(1639966459, 127921689));
        // Corrupted / Clean
        randomizer::conditions::register_new_setup_intercept({ "wotwSaveRoomC__clone0__clone1/dynamicSetups/waterSetup" }, { -1876259767, -1976832348 }, ai_create(-1876259767, -1976832348));
        // Corrupted / Clean
        randomizer::conditions::register_new_setup_intercept({ "waterMillPool__clone0/dynamicSetups/waterSetup" }, { -1947088109, 385303388 }, ai_create(-1947088109, 385303388));
        // Poisoned / Clean
        randomizer::conditions::register_new_setup_intercept({ "kwoloksCavernE/setups/poisonWaterToggle" }, { 378117992, -760384866 }, ai_create(378117992, -760384866));
        // corrupted / clean
        randomizer::conditions::register_new_setup_intercept({ "kwoloksCavernF/dynamicSetups/waterStateController" }, { -144265033, 685358568 }, ai_create(-144265033, 685358568));
        // corrupted / clean
        randomizer::conditions::register_new_setup_intercept({ "kwoloksCavernBackgroundA/dynamicSetups/waterStateController" }, { -882028644, -1833484193 }, ai_create(-882028644, -1833484193));
        // corrupted / clean
        randomizer::conditions::register_new_setup_intercept({ "kwoloksCavernB/dynamicSetups/waterStateController" }, { -1848734555, 30971136 }, ai_create(-1848734555, 30971136));
        // Corrupted / Clean
        randomizer::conditions::register_new_setup_intercept({ "kwoloksCavernStomperSideRoom/dynamicSetups/waterStateController" }, { 1762013712, 816885685 }, ai_create(1762013712, 816885685));

        //-> -1629508673 : NotStarted
        //-> -1353113975 : Started
        //-> -2075520848 : Finished
        randomizer::conditions::register_new_setup_intercept({ "waterMillEscapeABBackground/escapeSetups" }, { -1629508673, -1353113975, -2075520848 }, [](auto, auto, auto state, auto) -> int32_t {
            if (state == -1353113975)

...
namespace csharp_bridge
{
    namespace signatures
    {
        ...
        using f_void_ptr_int_int_int_int = void(*)(void*, int, int, int, int);
    ...
    extern signatures::f_void_ptr_int_int_int_int filter_icon_text;
    extern signatures::f_void_ptr_int_int_int_int quest_loc_text;

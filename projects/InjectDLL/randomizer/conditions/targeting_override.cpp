...
namespace randomizer
{
    namespace conditions
    {
        namespace
        {
            ...
            IL2CPP_BINDING(, EntityTargetting, void, RefreshAttackable, (app::EntityTargetting* this_ptr));
            ...
            IL2CPP_INTERCEPT(, EntityTargetting, void, OnUpdate, (app::EntityTargetting* this_ptr, float dt)) {
                ...
                return EntityTargetting::OnUpdate(this_ptr, dt);
            }

            bool targetable(void* attacker, app::IAttackable* attackable, std::string const& path) { return true; }
            bool untargetable(void* attacker, app::IAttackable* attackable, std::string const& path) { return false; }

...
namespace randomizer {
    namespace shaders {
        STATIC_IL2CPP_BINDING(, UberShaderAPI, bool, HasProperty, (app::Renderer * renderer, app::UberShaderProperty_Texture__Enum prop, app::UberShaderProperties_TextureSuffixType__Enum suffix));
        NAMED_STATIC_IL2CPP_BINDING_OVERLOAD(, UberShaderAPI, bool, HasProperty, HasPropertyColor, (app::Renderer * renderer, app::UberShaderProperty_Color__Enum prop), (UnityEngine
                                                                                                                                                                          : Renderer, UberShaderProperty_Color));
        NAMED_STATIC_IL2CPP_BINDING_OVERLOAD(, UberShaderAPI, bool, HasProperty, HasPropertyVector, (app::Renderer * renderer, app::UberShaderProperty_Vector__Enum prop), (UnityEngine
                                                                                                                                                                            : Renderer, UberShaderProperty_Vector));
        NAMED_STATIC_IL2CPP_BINDING_OVERLOAD(, UberShaderAPI, bool, HasProperty, HasPropertyFloat, (app::Renderer * renderer, app::UberShaderProperty_Float__Enum prop), (UnityEngine
                                                                                                                                                                          : Renderer, UberShaderProperty_Float));

        IL2CPP_BINDING_OVERLOAD(UnityEngine, Material, void, SetInt, (app::Material * this_ptr, app::String* name, int value), (System
                                                                                                                                : String, System
                                                                                                                                : Int32));
        IL2CPP_BINDING_OVERLOAD(UnityEngine, Material, void, SetFloat, (app::Material * this_ptr, app::String* name, float value), (System
                                                                                                                                    : String, System
                                                                                                                                    : Single));
        IL2CPP_BINDING_OVERLOAD(UnityEngine, Material, void, SetColor, (app::Material * this_ptr, app::String* name, app::Color* value), (System
                                                                                                                                          : String, UnityEngine
                                                                                                                                          : Color));
        IL2CPP_BINDING_OVERLOAD(UnityEngine, Material, void, SetVector, (app::Material * this_ptr, app::String* name, app::Vector4* value), (System
                                                                                                                                             : String, UnityEngine
                                                                                                                                             : Vector3));
        IL2CPP_BINDING_OVERLOAD(UnityEngine, Material, void, SetTexture, (app::Material * this_ptr, app::String* name, app::Texture* value), (System
                                                                                                                                              : String, UnityEngine
                                                                                                                                              : Texture));
        ...
        NAMED_IL2CPP_BINDING_OVERLOAD(UnityEngine, Material, void, .ctor, ctor_shader, (app::Material * this_ptr, app::Shader* shader), (UnityEngine
                                                                                                                                         : Shader));
        NAMED_IL2CPP_BINDING_OVERLOAD(UnityEngine, Material, void, .ctor, ctor, (app::Material * this_ptr, app::Material* other), (UnityEngine
                                                                                                                                   : Material));

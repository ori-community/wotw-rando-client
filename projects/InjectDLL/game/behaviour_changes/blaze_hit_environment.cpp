...
namespace {
    ...
    NAMED_IL2CPP_BINDING(, Damage, void, .ctor, ctor, (app::Damage * this_ptr, float amount, app::Vector2 force, app::Vector3 position, app::DamageType__Enum type, app::AbilityType__Enum abilityType, app::GameObject* sender, int damageID, app::DamageOwner* owner, app::SpiritShardType__Enum shardType, bool ignoreKickback, app::DamageWeight__Enum weight, float speedTransfer, bool bypassPlayersInvincibility));

    IL2CPP_BINDING_OVERLOAD(, Damage, void, DealToComponents, (app::Damage * this_ptr, app::GameObject* go), (UnityEngine
                                                                                                              : GameObject));

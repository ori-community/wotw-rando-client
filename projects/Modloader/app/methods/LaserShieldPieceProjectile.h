...
namespace app::classes::LaserShieldPieceProjectile {
    ...
    IL2CPP_REGISTER_METHOD(0x00F0CAB0, void, SetRepairMode, (app::LaserShieldPieceProjectile * this_ptr, app::LaserShieldRotationController* shield_controller, app::Transform* target, int32_t ring_index, int32_t piece_model_index, int32_t connected_piece_index, app::Vector3 initial_direction))
    IL2CPP_REGISTER_METHOD(0x00F0CFD0, void, SetAttackMode, (app::LaserShieldPieceProjectile * this_ptr, app::LaserShieldRotationController* shield_controller, app::Vector3 direction, int32_t ring_index, int32_t piece_model_index, int32_t connected_piece_index))
    IL2CPP_REGISTER_METHOD(0x00C75390, void, OnGoThroughPortal, (app::LaserShieldPieceProjectile * this_ptr))
    IL2CPP_REGISTER_METHOD(0x00F0D080, void, OnDamageDealt, (app::LaserShieldPieceProjectile * this_ptr, app::DamageDealer* damage_dealer, app::DamageResult damage_result))

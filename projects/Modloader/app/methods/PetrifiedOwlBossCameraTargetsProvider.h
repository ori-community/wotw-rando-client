...
namespace app::classes::PetrifiedOwlBossCameraTargetsProvider {
    ...
    IL2CPP_REGISTER_METHOD(0x0049D3E0, void, GetFight1Targets, (app::PetrifiedOwlBossCameraTargetsProvider * this_ptr, app::List_1_Moon_CameraTargetSettings_** targets))
    IL2CPP_REGISTER_METHOD(0x0049D670, void, GetFight2Targets, (app::PetrifiedOwlBossCameraTargetsProvider * this_ptr, app::List_1_Moon_CameraTargetSettings_** targets))

...
namespace app::classes::CameraFilterPack_Blur_Radial {
    ...
    IL2CPP_REGISTER_METHOD(0x024D3960, void, OnRenderImage, (app::CameraFilterPack_Blur_Radial * this_ptr, app::RenderTexture* source_texture, app::RenderTexture* dest_texture))

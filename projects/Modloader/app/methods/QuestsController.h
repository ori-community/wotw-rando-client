...
namespace app::classes::QuestsController {
    ...
    IL2CPP_REGISTER_METHOD(0x00E8FB00, bool, TryGetRootQuestByUberState, (app::QuestsController * this_ptr, app::IGenericUberState* uber_state, app::Quest** quest))
    IL2CPP_REGISTER_METHOD(0x00E8FC20, bool, TryRemapStateToQuestIndex, (app::QuestsController * this_ptr, app::SerializedIntUberState* uber_state, int32_t state_value, int32_t* quest_index))
    ...
    IL2CPP_REGISTER_METHOD(0x00E90E00, void, AssignQuest, (app::QuestsController * this_ptr, app::Quest* quest, bool with_message, bool updated, bool set_as_active))

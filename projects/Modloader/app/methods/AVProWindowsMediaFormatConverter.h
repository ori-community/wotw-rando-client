...
namespace app::classes::AVProWindowsMediaFormatConverter {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        bool,
        Build,
        app::AVProWindowsMediaFormatConverter* this_ptr,
        int32_t movie_handle,
        int32_t width,
        int32_t height,
        app::AVProWindowsMediaPlugin_VideoFrameFormat__Enum format,
        bool use_b_t709,
        bool flip_x,
        bool flip_y,
        app::FilterMode__Enum filter_mode,
        app::TextureWrapMode__Enum wrap_mode
    )

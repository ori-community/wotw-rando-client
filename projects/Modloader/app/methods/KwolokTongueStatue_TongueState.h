...
namespace app::classes::KwolokTongueStatue_TongueState {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::KwolokTongueStatue_TongueState* this_ptr,
        app::KwolokTongueStatue* owner,
        app::KwolokTongueStatue_KwolowTongueStatueState__Enum desired_state,
    ...
    IL2CPP_REGISTER_METHOD(
        0x00EFB3A0,
        void,
        AsureStateCorrectness,
        app::KwolokTongueStatue_TongueState* this_ptr,
        app::DesiredUberStateByte* desired_state,

...
namespace app::classes::frameworks::Switch::ControllerVibrationSetting {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::ControllerVibrationSetting__Boxed* this_ptr,
        float left,
        float right,
        float left_trigger,
        float right_trigger
    ...
    inline bool operator==(app::ControllerVibrationSetting a, app::ControllerVibrationSetting b) { return op_Equality(a, b); }
    inline bool operator!=(app::ControllerVibrationSetting a, app::ControllerVibrationSetting b) { return op_Inequality(a, b); }
} // namespace app::classes::frameworks::Switch::ControllerVibrationSetting

...
namespace app::classes::SteeringForces_SteeringForcesBuilder {
    ...
    IL2CPP_REGISTER_METHOD(
        0x0064EC70,
        app::SteeringForces_SteeringForcesBuilder*,
        AddNoise,
        app::SteeringForces_SteeringForcesBuilder* this_ptr,
        app::Vector3 direction
    )
    IL2CPP_REGISTER_METHOD(
        0x0064EE40,
        app::SteeringForces_SteeringForcesBuilder*,
        AddDirectionAvoidance,
        app::SteeringForces_SteeringForcesBuilder* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::SteeringForces_SteeringForcesBuilder* this_ptr,
        app::Vector3 origin,
        app::SteeringForcesAngleAvoidanceSettings* angle_avoidance,
        app::Vector3 direction,
        float offset,
        float distance,
        int32_t amount_of_rays,
        float avoidance_scale,
        app::SteeringForces_AvoidanceCurve__Enum curve,
        bool use_offseted_direction,
        bool reflect
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x0064FE90,
        app::Vector3,
        CalculateAvoidanceFromTarget,
        app::Vector3 origin,
        app::Vector3 avoidance_target,
        float distance,
        float avoidance_scale,
        bool draw_gizmo
    )

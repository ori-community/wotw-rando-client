...
namespace app::classes::SceneSettingsComponent {
    ...
    IL2CPP_REGISTER_METHOD(0x00BBEC50, float, GetDownSamplingRatioForRenderer_2, (app::Renderer * renderer, app::SliceRenderSettings_Slice__Array* slices, app::LayeredRenderSettings* layered_render_settings))
    ...
    IL2CPP_REGISTER_METHOD(0x00BBEF60, float, GetDofRatioForRenderer_2, (app::Renderer * renderer, app::SliceRenderSettings_Slice__Array* slices, app::LayeredRenderSettings* layered_render_settings))
    ...
    IL2CPP_REGISTER_METHOD(0x00BBF1E0, int32_t, GetLayerIndexForRenderer_2, (app::SceneSettingsComponent * this_ptr, app::Renderer* renderer, app::SliceRenderSettings_Slice__Array* slices, app::LayeredRenderSettings* layered_render_settings))

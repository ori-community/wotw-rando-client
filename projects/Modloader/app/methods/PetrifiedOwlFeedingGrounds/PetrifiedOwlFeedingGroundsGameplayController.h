...
namespace app::classes::PetrifiedOwlFeedingGrounds::PetrifiedOwlFeedingGroundsGameplayController {
    ...
    IL2CPP_REGISTER_METHOD(
        0x014DFC30,
        app::List_1_UnityEngine_GameObject_*,
        IUberStateApplier_get_AllTargets,
        app::PetrifiedOwlFeedingGroundsGameplayController* this_ptr
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        SetState,
        app::PetrifiedOwlFeedingGroundsGameplayController* this_ptr,
        app::PetrifiedOwlFeedingGroundsGameplayController_PetrifiedOwlFeedingGroundsGameplayState__Enum new_state
    )

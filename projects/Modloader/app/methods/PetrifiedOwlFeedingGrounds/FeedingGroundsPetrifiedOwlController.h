...
namespace app::classes::PetrifiedOwlFeedingGrounds::FeedingGroundsPetrifiedOwlController {
    ...
    IL2CPP_REGISTER_METHOD(
        0x014DA010,
        app::FeedingGroundsPetrifiedOwlController_FeedingGroundsChaseState__Enum,
        get_CurrentChaseState,
        app::FeedingGroundsPetrifiedOwlController* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x014DA040,
        void,
        set_CurrentChaseState,
        app::FeedingGroundsPetrifiedOwlController* this_ptr,
        app::FeedingGroundsPetrifiedOwlController_FeedingGroundsChaseState__Enum value
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        SetState,
        app::FeedingGroundsPetrifiedOwlController* this_ptr,
        app::PetrifiedOwlFeedingGroundsState__Enum new_state
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        GetKillSweepOffset,
        app::FeedingGroundsPetrifiedOwlController* this_ptr,
        app::FeedingGroundsPetrifiedOwlController_KillType__Enum kill_type
    )
    IL2CPP_REGISTER_METHOD(
        0x014DD8C0,
        app::MoonTimeline*,
        GetKillSweepTimeline,
        app::FeedingGroundsPetrifiedOwlController* this_ptr,
        app::FeedingGroundsPetrifiedOwlController_KillType__Enum kill_type
    )

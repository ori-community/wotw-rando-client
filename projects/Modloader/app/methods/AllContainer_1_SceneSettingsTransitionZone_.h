...
namespace app::classes::AllContainer_1_SceneSettingsTransitionZone_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x047798A8, AllContainer_1_SceneSettingsTransitionZone__get_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x019D77E0, int32_t, get_Count, (app::AllContainer_1_SceneSettingsTransitionZone_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0472F6C8, AllContainer_1_SceneSettingsTransitionZone__get_Count__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x019D79D0, void, Clear, (app::AllContainer_1_SceneSettingsTransitionZone_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047795F0, AllContainer_1_SceneSettingsTransitionZone__Clear__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04755440, AllContainer_1_SceneSettingsTransitionZone__Add__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04712630, AllContainer_1_SceneSettingsTransitionZone__Remove__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x018E6D70, void, ctor, (app::AllContainer_1_SceneSettingsTransitionZone_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04701118, AllContainer_1_SceneSettingsTransitionZone___ctor__MethodInfo)
} // namespace app::classes::AllContainer_1_SceneSettingsTransitionZone_

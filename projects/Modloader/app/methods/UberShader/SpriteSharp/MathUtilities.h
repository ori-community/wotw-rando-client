...
namespace app::classes::UberShader::SpriteSharp::MathUtilities {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Vector2 line1_start,
        app::Vector2 line1_end,
        app::Vector2 line2_start,
        app::Vector2 line2_end
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x018FBC00,
        bool,
        IsPolygonInsidePolygon_1,
        app::Vector2__Array* inner_polygon,
        app::Rect inner_polygon_rect,
        app::Vector2__Array* outer_polygon,
        app::Rect outer_polygon_rect
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x018FC540,
        float,
        CalculateMeshAreaAndBoundingBox,
        app::UInt16__Array* triangles,
        app::Vector2__Array* vertices,
        app::Vector2* min,
        app::Vector2* max
    )

...
namespace app::classes::ColorVariation {
    ...
    IL2CPP_REGISTER_METHOD(
        0x012D5840,
        void,
        FillPropertiesForShaders,
        app::ColorVariation* this_ptr,
        app::Vector4__Array** colors,
        app::Vector4__Array** nz_d_w_h,
        app::Vector4__Array** plane_o,
        app::Vector4__Array** main_tex_scale_offset,
        app::Vector4__Array** main_tex_scroll,
        app::Vector4__Array** distortion_scale_offset,
        app::Vector4__Array** distortion_scroll_strength,
        app::Vector4__Array** slices_ranges,
        int32_t start_pos,
        int32_t planes_count
    )
    IL2CPP_REGISTER_METHOD(
        0x012D6050,
        void,
        FillZeroPropertiesForShaders,
        app::Vector4__Array** colors,
        app::Vector4__Array** nz_d_w_h,
        app::Vector4__Array** plane_o,
        app::Vector4__Array** main_tex_scale_offset,

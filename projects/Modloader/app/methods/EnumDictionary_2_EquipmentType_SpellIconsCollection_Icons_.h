...
namespace app::classes::EnumDictionary_2_EquipmentType_SpellIconsCollection_Icons_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04766330, EnumDictionary_2_EquipmentType_SpellIconsCollection_Icons__GetValue__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x019E4F00, void, ctor, (app::EnumDictionary_2_EquipmentType_SpellIconsCollection_Icons_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0473F2A8, EnumDictionary_2_EquipmentType_SpellIconsCollection_Icons___ctor__MethodInfo)

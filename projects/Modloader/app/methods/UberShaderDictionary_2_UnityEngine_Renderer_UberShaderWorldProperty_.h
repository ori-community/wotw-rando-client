...
namespace app::classes::UberShaderDictionary_2_UnityEngine_Renderer_UberShaderWorldProperty_ {
    IL2CPP_REGISTER_METHOD(
        0x0225D7D0,
        app::Dictionary_2_TKey_TValue_KeyCollection_UnityEngine_Renderer_UberShaderWorldProperty_*,
        get_Keys,
        app::UberShaderDictionary_2_UnityEngine_Renderer_UberShaderWorldProperty_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x0225D8E0,
        app::UberShaderWorldProperty*,
        get_Item,
        app::UberShaderDictionary_2_UnityEngine_Renderer_UberShaderWorldProperty_* this_ptr,
        app::Renderer* index
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x0225D800,
        app::IEnumerator_1_KeyValuePair_2_UnityEngine_Renderer_UberShaderWorldProperty_*,

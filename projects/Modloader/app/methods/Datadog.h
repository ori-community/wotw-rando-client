...
namespace app::classes::Datadog {
    ...
    IL2CPP_REGISTER_METHOD(0x003FFDF0, bool, MyRemoteCertificateValidationCallback, (app::Object * sender, app::X509Certificate_1* certificate, app::X509Chain* chain, app::SslPolicyErrors__Enum sslpolicyerrors))

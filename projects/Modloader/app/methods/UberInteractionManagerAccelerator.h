...
namespace app::classes::UberInteractionManagerAccelerator {
    ...
    IL2CPP_REGISTER_METHOD(
        0x002FB950,
        app::UberInteractionManagerAccelerator_CellInteractionData__Array*,
        get_DynamicObjects,
        app::UberInteractionManagerAccelerator* this_ptr
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x00FCB8C0,
        app::UberInteractionManagerAccelerator_Cell*,
        GetCell,
        app::UberInteractionManagerAccelerator* this_ptr,
        int32_t x,
        int32_t y,

...
namespace app::classes::RootMotion::Demos::AnimatorController3rdPersonIK {
    ...
    IL2CPP_REGISTER_METHOD(0x0220A040, void, Move, (app::AnimatorController3rdPersonIK * this_ptr, app::Vector3 move_input, bool is_moving, app::Vector3 face_direction, app::Vector3 aim_target))

...
namespace app::classes::RootMotion::FinalIK::IKMappingLimb {
    ...
    IL2CPP_REGISTER_METHOD(0x02BDFE40, void, ctor_2, (app::IKMappingLimb * this_ptr, app::Transform* bone1, app::Transform* bone2, app::Transform* bone3, app::Transform* parent_bone))
    IL2CPP_REGISTER_METHOD(0x02BE02A0, void, SetBones, (app::IKMappingLimb * this_ptr, app::Transform* bone1, app::Transform* bone2, app::Transform* bone3, app::Transform* parent_bone))

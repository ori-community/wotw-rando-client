...
namespace app::classes::RootMotion::FinalIK::InteractionObject {
    ...
    IL2CPP_REGISTER_METHOD(
        0x02A0BBD0,
        app::InteractionTarget*,
        GetTarget_1,
        app::InteractionObject* this_ptr,
        app::FullBodyBipedEffector__Enum effector_type,
        app::InteractionSystem* interaction_system
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Apply_1,
        app::InteractionObject* this_ptr,
        app::IKSolverFullBodyBiped* solver,
        app::FullBodyBipedEffector__Enum effector,
        app::InteractionTarget* target,
        float timer,
        float weight
    )
    IL2CPP_REGISTER_METHOD(
        ...
        GetValue,
        app::InteractionObject* this_ptr,
        app::InteractionObject_WeightCurve_Type__Enum weight_curve_type,
        app::InteractionTarget* target,
        float timer
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::IKSolverFullBodyBiped* solver,
        app::FullBodyBipedEffector__Enum effector,
        app::InteractionObject_WeightCurve_Type__Enum type,
        float value,
        float weight
    )

...
namespace app::classes::RootMotion::FinalIK::IKMappingSpine {
    ...
    IL2CPP_REGISTER_METHOD(0x02BE1770, void, ctor_2, (app::IKMappingSpine * this_ptr, app::Transform__Array* spine_bones, app::Transform* left_upper_arm_bone, app::Transform* right_upper_arm_bone, app::Transform* left_thigh_bone, app::Transform* right_thigh_bone))

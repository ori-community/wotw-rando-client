...
namespace app::classes::RootMotion::FinalIK::IKSolverLookAt {
    ...
    IL2CPP_REGISTER_METHOD(0x02C01840, app::Vector3__Array*, GetForwards, (app::IKSolverLookAt * this_ptr, app::Vector3__Array** forwards, app::Vector3 base_forward, app::Vector3 target_forward, int32_t bones, float clamp))

...
namespace app::classes::RootMotion::BipedReferences {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::BipedReferences** references,
        app::Transform* root,
        app::BipedReferences_AutoDetectParams auto_detect_params
    )
    IL2CPP_REGISTER_METHOD(
        0x02202C20,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        DetectLimb,
        app::BipedNaming_BoneType__Enum bone_type,
        app::BipedNaming_BoneSide__Enum bone_side,
        app::Transform** first_bone,
        app::Transform** second_bone,
        app::Transform** last_bone,

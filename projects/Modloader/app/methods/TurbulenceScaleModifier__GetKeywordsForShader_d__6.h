...
namespace app::classes::TurbulenceScaleModifier__GetKeywordsForShader_d__6 {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04730A98, TurbulenceScaleModifier_GetKeywordsForShader_d_6_System_Collections_IEnumerator_Reset__MethodInfo)
    ...
    IL2CPP_REGISTER_METHOD(0x00B1A410, app::IEnumerator_1_System_String_*, IEnumerable_string__GetEnumerator, (app::TurbulenceScaleModifier_GetKeywordsForShader_d_6 * this_ptr))

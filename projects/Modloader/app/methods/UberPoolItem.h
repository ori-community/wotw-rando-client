...
namespace app::classes::UberPoolItem {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        AddStateRecurs,
        app::UberPoolItem* this_ptr,
        app::Transform* trans,
        app::List_1_UnityEngine_GameObject_* active_at_start,
        app::List_1_UnityEngine_Transform_* children
    )
    IL2CPP_REGISTER_METHOD(
        0x00FD7290,
        void,
        AddEntryRecurs,
        app::UberPoolItem* this_ptr,
        app::Dictionary_2_System_Int32_UberPoolItem_* add,
        app::GameObject* go
    )

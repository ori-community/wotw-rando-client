...
namespace app::classes::SetupControllerStateHolder {
    ...
    IL2CPP_REGISTER_METHOD(
        0x01B7AF50,
        app::Dictionary_2_System_Int32_SetupStateModifier_*,
        get_GuidToUberStateModifier,
        app::SetupControllerStateHolder* this_ptr
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        GetUberStateModifier,
        app::SetupControllerStateHolder* this_ptr,
        int32_t uber_state_modifier_g_u_i_d
    )

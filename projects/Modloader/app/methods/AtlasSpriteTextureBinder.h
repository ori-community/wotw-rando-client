...
namespace app::classes::AtlasSpriteTextureBinder {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::AtlasSpriteTextureBinder* this_ptr,
        app::AnimationMeshingSettings* settings,
        bool sprice_spaceuvs,
        app::Mesh* mesh
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        BindTo,
        app::AtlasSpriteTextureBinder* this_ptr,
        app::MeshFilter* filter,
        app::Renderer* renderer,
        app::Atlas* atlas,
        app::UberScreenMode__Enum mode,
        app::AtlasSpriteTexture* texture
    )

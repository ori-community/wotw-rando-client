...
namespace app::classes::PiranhaLocomotionSwimmingBehaviour {
    ...
    IL2CPP_REGISTER_METHOD(
        0x01160B80,
        app::PiranhaLocomotionSwimmingBehaviour_SpeedSetting*,
        GetSpeedSettingForTier,
        app::PiranhaLocomotionSwimmingBehaviour* this_ptr,
        float speed_tier
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ChangeState,
        app::PiranhaLocomotionSwimmingBehaviour* this_ptr,
        app::PiranhaLocomotionSwimmingBehaviour_State__Enum state
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        AccelerateTowards,
        app::PiranhaLocomotionSwimmingBehaviour* this_ptr,
        app::Vector2 target_velocity,
        app::PiranhaLocomotionSwimmingBehaviour_SpeedSetting* setting
    )

...
namespace app::classes::EquipmentUIInventoryGrid {
    ...
    IL2CPP_REGISTER_METHOD(0x00978330, void, Configure, (app::EquipmentUIInventoryGrid * this_ptr, app::GameObject* item_prefab, app::GameObject* item_highlight_g_o, app::Action_1_UnityEngine_GameObject_* on_new_item_instantiated))
    ...
    IL2CPP_REGISTER_METHOD(0x009791E0, void, Populate, (app::EquipmentUIInventoryGrid * this_ptr, app::List_1_System_Object_* inventory_items, app::Object* grid_context, bool run_actions))
    IL2CPP_REGISTER_METHOD(0x00979D40, void, PopulateUsingCache, (app::EquipmentUIInventoryGrid * this_ptr, app::List_1_System_Object_* inventory_items, app::Object* grid_context, bool run_actions))

...
namespace app::classes::TriangleNet::Configuration___c {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04719550, Configuration_c___ctor_b__0_1__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x0261A5A0, app::TrianglePool*, __ctor_b__1_0, (app::Configuration_c * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04745750, Configuration_c___ctor_b__1_0__MethodInfo)
} // namespace app::classes::TriangleNet::Configuration___c

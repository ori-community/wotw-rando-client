...
namespace app::classes::TriangleNet::Meshing::Algorithm::SweepLine {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        HeapInsert,
        app::SweepLine* this_ptr,
        app::SweepLine_SweepEvent__Array* heap,
        int32_t heapsize,
        app::SweepLine_SweepEvent* newevent
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x02638B50,
        app::SweepLine_SplayNode*,
        Splay,
        app::SweepLine* this_ptr,
        app::SweepLine_SplayNode* splaytree,
        app::Point* searchpoint,
        app::Otri* searchtri
    )
    IL2CPP_REGISTER_METHOD(
        0x02638EB0,
        ...
        SplayInsert,
        app::SweepLine* this_ptr,
        app::SweepLine_SplayNode* splayroot,
        app::Otri newkey,
        app::Point* searchpoint
    )
    IL2CPP_REGISTER_METHOD(
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::SweepLine* this_ptr,
        app::Otri* checktri,
        app::SweepLine_SweepEvent__Array* eventheap,
        int32_t* heapsize
    )

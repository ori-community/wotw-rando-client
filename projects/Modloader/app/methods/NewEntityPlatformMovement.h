...
namespace app::classes::NewEntityPlatformMovement {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        AddKickback_1,
        app::NewEntityPlatformMovement* this_ptr,
        app::Kickback* kickback,
        bool add_last_value_to_local_speed,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        float air_sustain_duration,
        bool instant,
        app::Transform* height_match_transform,
        bool height_match
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        CheckForAirSustain,
        app::NewEntityPlatformMovement* this_ptr,
        app::NewEntityPlatformMovement_KickbackEntry** kick_back
    )

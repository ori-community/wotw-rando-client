...
namespace app::classes::CameraFilterPack_Blend2Camera_Lighten {
    ...
    IL2CPP_REGISTER_METHOD(0x027511D0, void, OnRenderImage, (app::CameraFilterPack_Blend2Camera_Lighten * this_ptr, app::RenderTexture* source_texture, app::RenderTexture* dest_texture))

...
namespace app::classes::MortarWormChargingState {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::MortarWormChargingState* this_ptr,
        app::MortarWormEnemy* mortar_worm_enemy,
        app::TextureAnimationWithTransitions* charging,
        app::PrefabSpawner* charging_effect,
        app::SoundSource* charging_sound
    )

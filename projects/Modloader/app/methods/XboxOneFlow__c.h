...
namespace app::classes::XboxOneFlow___c {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04787A20, XboxOneFlow_c__UpdateNextSaveSlot_b__39_1__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0471EC00, XboxOneFlow_c__StatisticsTest_b__41_0__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x01C58A30, void, _StatisticsTest_b__41_1, (app::XboxOneFlow_c * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0472D3E8, XboxOneFlow_c__StatisticsTest_b__41_1__MethodInfo)
} // namespace app::classes::XboxOneFlow___c

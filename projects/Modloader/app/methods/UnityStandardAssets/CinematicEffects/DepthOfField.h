...
namespace app::classes::UnityStandardAssets::CinematicEffects::DepthOfField {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        DoHexagonalBlur,
        app::DepthOfField_1* this_ptr,
        app::RenderTexture* blurred_fg_coc,
        app::RenderTexture** src,
        app::RenderTexture** dst,
        float max_radius
    )
    IL2CPP_REGISTER_METHOD(
        0x02503600,
    ...
    IL2CPP_REGISTER_METHOD(
        0x025048A0,
        void,
        GetDirectionalBlurPassesFromRadius,
        app::RenderTexture* blurred_fg_coc,
        float max_radius,
        int32_t* blur_pass,
        int32_t* blur_and_merge_pass
    )

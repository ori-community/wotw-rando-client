...
namespace app::classes::RaceLeaderboardsTitlescreenController {
    ...
    IL2CPP_REGISTER_METHOD(0x00EA6610, void, SetState, (app::RaceLeaderboardsTitlescreenController * this_ptr, app::RaceLeaderboardsTitlescreenController_OnlineHandlerState__Enum state))

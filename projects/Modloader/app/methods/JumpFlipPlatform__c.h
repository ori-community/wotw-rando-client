...
namespace app::classes::JumpFlipPlatform___c {
    ...
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __cctor_b__41_1, (app::JumpFlipPlatform_c * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04744140, JumpFlipPlatform_c___cctor_b__41_1__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __cctor_b__41_2, (app::JumpFlipPlatform_c * this_ptr))

...
namespace app::classes::UberPoolGroup {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Init,
        app::UberPoolGroup* this_ptr,
        app::String* pool_name,
        app::UberPoolSettings* settings,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Dictionary_2_System_Int32_UberPoolItem_* entries
    )
    IL2CPP_REGISTER_METHOD(
        0x00FD30C0,
        app::UberPoolItem*,
        PrewarmInstanceFromScene,
        app::UberPoolGroup* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Nullable_1_Single_* new_object_elapsed_millis
    )

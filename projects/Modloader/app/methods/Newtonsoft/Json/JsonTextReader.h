...
namespace app::classes::Newtonsoft::Json::JsonTextReader {
    ...
    IL2CPP_REGISTER_METHOD(0x01EF5660, void, WriteCharToBuffer, (app::JsonTextReader * this_ptr, char16_t write_char, int32_t last_write_position, int32_t write_to_position))
    ...
    IL2CPP_REGISTER_METHOD(0x01EF7950, void, ParseReadNumber, (app::JsonTextReader * this_ptr, app::ReadType__Enum read_type, char16_t first_char, int32_t initial_position))

...
namespace app::classes::Newtonsoft::Json::JsonPosition {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        WriteTo,
        app::JsonPosition__Boxed* this_ptr,
        app::StringBuilder* sb,
        app::StringWriter** writer,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::String*,
        BuildPath,
        app::List_1_Newtonsoft_Json_JsonPosition_* positions,
        app::Nullable_1_Newtonsoft_Json_JsonPosition_ current_position
    )

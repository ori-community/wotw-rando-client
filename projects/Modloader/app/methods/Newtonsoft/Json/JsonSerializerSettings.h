...
namespace app::classes::Newtonsoft::Json::JsonSerializerSettings {
    ...
    IL2CPP_REGISTER_METHOD(0x00418200, app::Func_1_Newtonsoft_Json_Serialization_IReferenceResolver_*, get_ReferenceResolverProvider, (app::JsonSerializerSettings * this_ptr))

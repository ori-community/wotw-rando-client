...
namespace app::classes::Newtonsoft::Json::Utilities::StringUtils {
    ...
    IL2CPP_REGISTER_METHOD(
        0x015805D0,
        app::Object*,
        ForgivingCaseSensitiveFind_1,
        app::IEnumerable_1_System_Object_* source,
        app::Func_2_Object_String_* value_selector,
        app::String* test_value
    )
    IL2CPP_REGISTER_METHOD(
        0x015805D0,
        app::JsonProperty*,
        ForgivingCaseSensitiveFind_2,
        app::IEnumerable_1_Newtonsoft_Json_Serialization_JsonProperty_* source,
        app::Func_2_Newtonsoft_Json_Serialization_JsonProperty_String_* value_selector,
        app::String* test_value
    )
} // namespace app::classes::Newtonsoft::Json::Utilities::StringUtils

...
namespace app::classes::Newtonsoft::Json::Utilities::JavaScriptUtils {
    ...
    IL2CPP_REGISTER_METHOD(0x0301C770, void, WriteEscapedJavaScriptString, (app::TextWriter * writer, app::String* s, char16_t delimiter, bool append_delimiters, app::Boolean__Array* char_escape_flags, app::StringEscapeHandling__Enum string_escape_handling, app::IArrayPool_1_System_Char_* buffer_pool, app::Char__Array** write_buffer))
    IL2CPP_REGISTER_METHOD(0x0301CDE0, app::String*, ToEscapedJavaScriptString, (app::String * value, char16_t delimiter, bool append_delimiters, app::StringEscapeHandling__Enum string_escape_handling))

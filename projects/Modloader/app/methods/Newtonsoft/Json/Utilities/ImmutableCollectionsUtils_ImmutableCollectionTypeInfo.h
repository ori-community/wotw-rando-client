...
namespace app::classes::Newtonsoft::Json::Utilities::ImmutableCollectionsUtils_ImmutableCollectionTypeInfo {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::ImmutableCollectionsUtils_ImmutableCollectionTypeInfo* this_ptr,
        app::String* contract_type_name,
        app::String* created_type_name,
        app::String* builder_type_name
    )

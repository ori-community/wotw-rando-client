...
namespace app::classes::Newtonsoft::Json::Utilities::ReflectionUtils {
    ...
    IL2CPP_REGISTER_METHOD(0x03020D00, app::String*, GetTypeName, (app::Type * t, app::TypeNameAssemblyFormatHandling__Enum assembly_format, app::ISerializationBinder* binder))
    ...
    IL2CPP_REGISTER_METHOD(0x03021BE0, bool, ImplementsGenericDefinition_2, (app::Type * type, app::Type* generic_interface_definition, app::Type** implementing_type))
    ...
    IL2CPP_REGISTER_METHOD(0x03022200, bool, InheritsGenericDefinitionInternal, (app::Type * current_type, app::Type* generic_class_definition, app::Type** implementing_type))
    ...
    IL2CPP_REGISTER_METHOD(0x030236E0, app::List_1_System_Reflection_MemberInfo_*, GetFieldsAndProperties, (app::Type * type, app::BindingFlags__Enum binding_attr))
    ...
    IL2CPP_REGISTER_METHOD(0x03025080, app::IEnumerable_1_System_Reflection_FieldInfo_*, GetFields, (app::Type * target_type, app::BindingFlags__Enum binding_attr))
    IL2CPP_REGISTER_METHOD(0x03025250, void, GetChildPrivateFields, (app::IList_1_System_Reflection_MemberInfo_ * initial_fields, app::Type* target_type, app::BindingFlags__Enum binding_attr))
    IL2CPP_REGISTER_METHOD(0x03025500, app::IEnumerable_1_System_Reflection_PropertyInfo_*, GetProperties, (app::Type * target_type, app::BindingFlags__Enum binding_attr))
    ...
    IL2CPP_REGISTER_METHOD(0x030258C0, void, GetChildPrivateProperties, (app::IList_1_System_Reflection_PropertyInfo_ * initial_properties, app::Type* target_type, app::BindingFlags__Enum binding_attr))

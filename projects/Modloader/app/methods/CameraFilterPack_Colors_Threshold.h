...
namespace app::classes::CameraFilterPack_Colors_Threshold {
    ...
    IL2CPP_REGISTER_METHOD(0x024E3790, void, OnRenderImage, (app::CameraFilterPack_Colors_Threshold * this_ptr, app::RenderTexture* source_texture, app::RenderTexture* dest_texture))

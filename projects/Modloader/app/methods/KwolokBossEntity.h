...
namespace app::classes::KwolokBossEntity {
    ...
    IL2CPP_REGISTER_METHOD(0x012D7710, void, add_ModifyLookAngleChangeSpeed, (app::KwolokBossEntity * this_ptr, app::KwolokBossEntity_ModifyLookAngleChangeSpeedDelegate* value))
    IL2CPP_REGISTER_METHOD(0x012D7800, void, remove_ModifyLookAngleChangeSpeed, (app::KwolokBossEntity * this_ptr, app::KwolokBossEntity_ModifyLookAngleChangeSpeedDelegate* value))
    IL2CPP_REGISTER_METHOD(0x012D78F0, void, add_ModifyDesiredLookAngle, (app::KwolokBossEntity * this_ptr, app::KwolokBossEntity_ModifyDesiredLookAngleDelegate* value))
    IL2CPP_REGISTER_METHOD(0x012D79E0, void, remove_ModifyDesiredLookAngle, (app::KwolokBossEntity * this_ptr, app::KwolokBossEntity_ModifyDesiredLookAngleDelegate* value))
    ...
    IL2CPP_REGISTER_METHOD(0x012D8080, void, add_OnDamageReceivedCallback, (app::KwolokBossEntity * this_ptr, app::KwolokBossEntity_OnDamageReceivedDelegate* value))
    IL2CPP_REGISTER_METHOD(0x012D8170, void, remove_OnDamageReceivedCallback, (app::KwolokBossEntity * this_ptr, app::KwolokBossEntity_OnDamageReceivedDelegate* value))
    ...
    IL2CPP_REGISTER_METHOD(0x012D8350, void, remove_ModifyCameraTargets, (app::KwolokBossEntity * this_ptr, app::KwolokBossEntity_ModifyCameraTargetsDelegate* value))
    ...
    IL2CPP_REGISTER_METHOD(0x012DBD80, void, MoveTowards, (app::KwolokBossEntity * this_ptr, app::Transform* target, app::Vector3 ideal_target, app::AnimationCurve* speed_curve))

...
namespace app::classes::CameraPostProcessing {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        SetCameraSettings,
        app::CameraPostProcessing* this_ptr,
        app::CameraSettings* camera_settings,
        bool force_apply_to_scene_camera
    )
    IL2CPP_REGISTER_METHOD(
        0x016A0D30,
        void,
        ForceFogIntoCurrentCameraSettings,
        app::CameraPostProcessing* this_ptr,
        app::FogGradientController* fog_gradient_controller
    )

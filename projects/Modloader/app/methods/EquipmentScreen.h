...
namespace app::classes::EquipmentScreen {
    ...
    IL2CPP_REGISTER_METHOD(0x00975AB0, void, UpdateBinding, (app::EquipmentScreen * this_ptr, app::PlayerUberStateInventory_InventoryItem* item, app::SpellInventory_Binding__Enum binding))

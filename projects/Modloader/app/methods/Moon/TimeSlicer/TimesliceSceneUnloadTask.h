...
namespace app::classes::Moon::TimeSlicer::TimesliceSceneUnloadTask {
    ...
    IL2CPP_REGISTER_METHOD(0x010C5C10, void, ctor, (app::TimesliceSceneUnloadTask * this_ptr, app::List_1_UnityEngine_GameObject_* target_objects, app::GameObject* scene_root, bool reversed_order, app::GameObject* owner, app::Action_1_Boolean_* on_job_completed, app::String* scene_name))

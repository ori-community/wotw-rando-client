...
namespace app::classes::Moon::TimeSlicer::TimeSlicedActivationTask {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_1,
        app::TimeSlicedActivationTask* this_ptr,
        app::List_1_UnityEngine_GameObject_* target_objects,
        app::List_1_UnityEngine_Component_* pre_enable_observers,
        app::List_1_UnityEngine_Component_* post_enable_observers,
        bool activate,
        bool reversed_order,
    ...
    IL2CPP_REGISTER_METHOD(
        0x010C0980,
        void,
        CreateTimeSlicedActivationTask,
        app::TimeSlicedActivationTask* this_ptr,
        app::List_1_UnityEngine_GameObject_* target_objects,
        app::List_1_UnityEngine_Component_* pre_enable_observers,
        app::List_1_UnityEngine_Component_* post_enable_observers,

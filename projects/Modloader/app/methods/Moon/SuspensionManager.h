...
namespace app::classes::Moon::SuspensionManager {
    ...
    IL2CPP_REGISTER_METHOD(0x031AD7A0, app::HashSet_1_Moon_ISuspendable_*, GetSuspendables_2, (app::HashSet_1_Moon_ISuspendable_ * suspendables, app::GameObject__Array* gos))
    IL2CPP_REGISTER_METHOD(0x031AD990, app::HashSet_1_Moon_ISuspendable_*, GetSuspendables_3, (app::HashSet_1_Moon_ISuspendable_ * suspendables, bool include_inactive, app::GameObject* go))

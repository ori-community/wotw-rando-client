...
namespace app::classes::Moon::InteractionGraph::ChangeStateInteractionNodeDecorator_StateConditionSetupHolder {
    ...
    IL2CPP_REGISTER_METHOD(
        0x0198C0C0,
        app::ChangeStateInteractionNodeDecorator_StateConditionSetupData*,
        get_DesiredState,
        app::ChangeStateInteractionNodeDecorator_StateConditionSetupHolder* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x0198C170,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Perform,
        app::ChangeStateInteractionNodeDecorator_StateConditionSetupHolder* this_ptr,
        app::ChangeStateInteractionNodeDecorator_StateConditionSetupData* state
    )

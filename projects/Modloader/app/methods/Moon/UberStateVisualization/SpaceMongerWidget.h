...
namespace app::classes::Moon::UberStateVisualization::SpaceMongerWidget {
    IL2CPP_REGISTER_METHOD(
        0x030BED70,
        void,
        add_OnSelectionChanged,
        app::SpaceMongerWidget* this_ptr,
        app::Action_1_Moon_UberStateVisualization_UberStateData_* value
    )
    IL2CPP_REGISTER_METHOD(
        0x030BEE60,
        void,
        remove_OnSelectionChanged,
        app::SpaceMongerWidget* this_ptr,
        app::Action_1_Moon_UberStateVisualization_UberStateData_* value
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        UpdateWithModel,
        app::SpaceMongerWidget* this_ptr,
        app::List_1_Moon_UberStateVisualization_UberStateGroupData_* state_group_datas
    )

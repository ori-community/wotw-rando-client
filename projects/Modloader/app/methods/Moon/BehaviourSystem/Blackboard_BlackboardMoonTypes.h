...
namespace app::classes::Moon::BehaviourSystem::Blackboard_BlackboardMoonTypes {
    ...
    IL2CPP_REGISTER_METHOD(
        0x0154B3B0,
        void,
        RemoveVariableFromList_1,
        app::Blackboard_BlackboardMoonTypes* this_ptr,
        app::String* var_name,
        app::List_1_System_Object_* list
    )
    IL2CPP_REGISTER_METHOD(
        0x0154AFE0,
        void,
        MergeLists_1,
        app::Blackboard_BlackboardMoonTypes* this_ptr,
        app::List_1_System_Object_* one,
        app::List_1_System_Object_* two
    )
    IL2CPP_REGISTER_METHOD(
        0x015EBDA0,
        app::BlackboardVariableInt*,
        GetNewVariable_2,
        app::Blackboard_BlackboardMoonTypes* this_ptr,
        app::String* var_name,
        app::Type* type
    ...
    IL2CPP_REGISTER_METHOD(
        0x015EBDA0,
        app::BlackboardVariableGameObject*,
        GetNewVariable_6,
        app::Blackboard_BlackboardMoonTypes* this_ptr,
        app::String* var_name,
        app::Type* type
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        MergeLists_2,
        app::Blackboard_BlackboardMoonTypes* this_ptr,
        app::List_1_Moon_BehaviourSystem_BlackboardVariableBool_* one,
        app::List_1_Moon_BehaviourSystem_BlackboardVariableBool_* two
    )
    IL2CPP_REGISTER_METHOD(
        0x0154AEB0,
        void,
        MergeLists_3,
        app::Blackboard_BlackboardMoonTypes* this_ptr,
        app::List_1_Moon_BehaviourSystem_BlackboardVariableInt_* one,
        app::List_1_Moon_BehaviourSystem_BlackboardVariableInt_* two
    )
    IL2CPP_REGISTER_METHOD(
        0x0154B120,
        void,
        MergeLists_4,
        app::Blackboard_BlackboardMoonTypes* this_ptr,
        app::List_1_Moon_BehaviourSystem_BlackboardVariableFloat_* one,
        app::List_1_Moon_BehaviourSystem_BlackboardVariableFloat_* two
    )
    IL2CPP_REGISTER_METHOD(
        0x0154AFE0,
        void,
        MergeLists_5,
        app::Blackboard_BlackboardMoonTypes* this_ptr,
        app::List_1_Moon_BehaviourSystem_BlackboardVariableString_* one,
        app::List_1_Moon_BehaviourSystem_BlackboardVariableString_* two
    )
    IL2CPP_REGISTER_METHOD(
        0x0154B250,
        void,
        MergeLists_6,
        app::Blackboard_BlackboardMoonTypes* this_ptr,
        app::List_1_Moon_BehaviourSystem_BlackboardVariableVector3_* one,
        app::List_1_Moon_BehaviourSystem_BlackboardVariableVector3_* two
    )
    IL2CPP_REGISTER_METHOD(
        0x0154AFE0,
        void,
        MergeLists_7,
        app::Blackboard_BlackboardMoonTypes* this_ptr,
        app::List_1_Moon_BehaviourSystem_BlackboardVariableGameObject_* one,
        app::List_1_Moon_BehaviourSystem_BlackboardVariableGameObject_* two
    )
    IL2CPP_REGISTER_METHOD(
        0x0154AFE0,
        void,
        MergeLists_8,
        app::Blackboard_BlackboardMoonTypes* this_ptr,
        app::List_1_Moon_BehaviourSystem_BlackboardVariableObject_* one,
        app::List_1_Moon_BehaviourSystem_BlackboardVariableObject_* two
    )
    IL2CPP_REGISTER_METHOD(
        0x0154AD70,
        void,

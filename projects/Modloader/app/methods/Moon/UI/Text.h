...
namespace app::classes::Moon::UI::Text {
    ...
    IL2CPP_REGISTER_METHOD(0x01186600, void, AdjustBaseline, (app::Text_1 * this_ptr, int32_t current_char_index, float baseline_adjustment, app::Vector2* caret, app::TextBoxLine_1* line))

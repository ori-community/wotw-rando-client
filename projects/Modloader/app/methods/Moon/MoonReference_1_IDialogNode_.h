...
namespace app::classes::Moon::MoonReference_1_IDialogNode_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0479A078, MoonReference_1_IDialogNode__CanResolve__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04752780, MoonReference_1_IDialogNode__Resolve__MethodInfo)
} // namespace app::classes::Moon::MoonReference_1_IDialogNode_

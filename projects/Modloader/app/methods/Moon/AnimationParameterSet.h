...
namespace app::classes::Moon::AnimationParameterSet {
    ...
    IL2CPP_REGISTER_METHOD(
        0x002FB930,
        app::Dictionary_2_Moon_AnimationParameter_Moon_AnimationParameter_Instance_*,
        get_Parameters,
        app::AnimationParameterSet* this_ptr
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x015EBAB0,
        app::FloatAnimationParameter_Instance*,
        GetParameterInstance_2,
        app::AnimationParameterSet* this_ptr,
        app::AnimationParameter* parameter
    )
    IL2CPP_REGISTER_METHOD(
        0x015EBAB0,
        app::VectorAnimationParameter_Instance*,
        GetParameterInstance_3,
        app::AnimationParameterSet* this_ptr,
        app::AnimationParameter* parameter
    )

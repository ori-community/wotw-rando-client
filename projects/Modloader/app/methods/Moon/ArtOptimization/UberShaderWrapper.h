...
namespace app::classes::Moon::ArtOptimization::UberShaderWrapper {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::UberShaderWrapper* this_ptr,
        app::UberShaderComponent* uber_shader,
        app::SerializableUberShaderWrapper* serializable_wrapper
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x002FB9F0,
        app::Dictionary_2_UberShaderModifier_Moon_ArtOptimization_ModifierWrapper_*,
        get_ModifiersMap,
        app::UberShaderWrapper* this_ptr
    )

...
namespace app::classes::Moon::Driver::UpdateManager {
    ...
    IL2CPP_REGISTER_METHOD(0x03138690, bool, ListIsValidForBinarySearch, (app::List_1_Moon_Driver_UpdateManager_Entry_ * entry_list, app::IComparer_1_Moon_Driver_UpdateManager_Entry_* cmp))
    IL2CPP_REGISTER_METHOD(0x03138830, void, AddEntryByInsertSort, (app::List_1_Moon_Driver_UpdateManager_Entry_ * entry_list, app::UpdateManager_Entry* entry, app::IComparer_1_Moon_Driver_UpdateManager_Entry_* cmp))

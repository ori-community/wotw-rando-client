...
namespace app::classes::Moon::InterestSettings {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04755980, InterestSettings__GetDebugMenuItems_b__3_1__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00B83F30, float, _GetDebugMenuItems_b__3_2, (app::InterestSettings * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0475AF20, InterestSettings__GetDebugMenuItems_b__3_2__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00B83F40, void, _GetDebugMenuItems_b__3_3, (app::InterestSettings * this_ptr, float f))
    IL2CPP_REGISTER_METHODINFO(0x04782EA0, InterestSettings__GetDebugMenuItems_b__3_3__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00863E90, float, _GetDebugMenuItems_b__3_4, (app::InterestSettings * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047644B0, InterestSettings__GetDebugMenuItems_b__3_4__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00863EA0, void, _GetDebugMenuItems_b__3_5, (app::InterestSettings * this_ptr, float f))
    IL2CPP_REGISTER_METHODINFO(0x0478AE30, InterestSettings__GetDebugMenuItems_b__3_5__MethodInfo)

...
namespace app::classes::Moon::Wwise::ArtificialSoundHost {
    ...
    IL2CPP_REGISTER_METHOD(0x027092E0, void, SetGameObjectAuxSendValues, (uint64_t in_game_object_i_d, app::AkAuxSendArray* in_a_aux_send_values, uint32_t in_u_num_send_values))
} // namespace app::classes::Moon::Wwise::ArtificialSoundHost

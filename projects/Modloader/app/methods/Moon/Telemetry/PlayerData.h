...
namespace app::classes::Moon::Telemetry::PlayerData {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        AddSessions,
        app::PlayerData* this_ptr,
        app::DataPointType__Enum point_type,
        app::Dictionary_2_System_String_Moon_Telemetry_GameSession_* new_sessions,
    ...
    IL2CPP_REGISTER_METHOD(
        0x002FB930,
        app::Dictionary_2_DataPointType_Dictionary_2_System_String_Moon_Telemetry_GameSession_*,
        GetSessions_2,
        app::PlayerData* this_ptr
    )

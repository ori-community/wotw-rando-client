...
namespace app::classes::Moon::Telemetry::Performance::ProfilingSettings {
    ...
    IL2CPP_REGISTER_METHOD(
        0x00E38A60,
        app::ProfilingSettings_BulkSettings*,
        SetStateBulk_2,
        app::ProfilingSettings_SettingType__Enum__Array* settings_to_disable,
        app::ProfilingSettings_SettingType__Enum__Array* settings_to_enable,
        app::ProfilingSettings_SettingType__Enum__Array* settings_to_restore
    )

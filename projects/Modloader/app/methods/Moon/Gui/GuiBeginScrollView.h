...
namespace app::classes::Moon::Gui::GuiBeginScrollView {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_4,
        app::GuiBeginScrollView* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::GuiBeginScrollView* this_ptr,
        app::Vector2 scroll_position,
        app::GUIStyle* horizontal_scroll_bar,
        app::GUIStyle* vertical_scroll_bar
    )
    IL2CPP_REGISTER_METHOD(
        0x01989010,
        void,
        ...
        app::GuiBeginScrollView* this_ptr,
        app::Vector2 scroll_position,
        bool always_show_horizontal_scroll_bar,
        bool always_show_vertical_scroll_bar,
        app::GUIStyle* horizontal_scroll_bar,
        app::GUIStyle* vertical_scroll_bar
    )
    IL2CPP_REGISTER_METHOD(

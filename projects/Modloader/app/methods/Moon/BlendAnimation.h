...
namespace app::classes::Moon::BlendAnimation {
    ...
    IL2CPP_REGISTER_METHOD(0x01B079A0, app::MoonAnimation_RootMotionSample, EvaluateRootMotion, (app::BlendAnimation * this_ptr, float time, app::AnimationParameterSet* parameter_set))
    ...
    IL2CPP_REGISTER_METHOD(0x01B07CD0, void, ComputeCurrentBlendNodes, (app::BlendAnimation_Input__Array * inputs, float parameter_value, app::BlendAnimationMode__Enum mode, float* current_blend_weight, int32_t* current_blend_node_index))

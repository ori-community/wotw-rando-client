...
namespace app::classes::Moon::Network::Web::WebClientImpl {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Send,
        app::WebClientImpl* this_ptr,
        app::Method__Enum methods,
        app::Action_1_Moon_Network_Web_WebResponse_* callback
    )
    IL2CPP_REGISTER_METHOD(
        0x002FA000,
        void,
        M_client_UploadProgressChanged,
        app::WebClientImpl* this_ptr,
        app::Object* sender,
    ...
    IL2CPP_REGISTER_METHOD(
        0x002FA000,
        void,
        M_client_DownloadProgressChanged,
        app::WebClientImpl* this_ptr,
        app::Object* sender,
        app::DownloadProgressChangedEventArgs* e
    )

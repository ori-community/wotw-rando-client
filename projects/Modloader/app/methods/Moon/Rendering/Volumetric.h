...
namespace app::classes::Moon::Rendering::Volumetric {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        SetupConfig,
        app::Volumetric* this_ptr,
        app::CommandBuffer* cmd,
        float mie_scattering_factor,
        float ray_amount,
        float extinction_coeff,
        float camera_ray_marching_step_size,
        float light_ray_marching_step_since_size,
        bool enable_noise,
        float noise_speed,
        float noise_size,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Camera* cull_cam,
        app::CommandBuffer* cmd,
        app::RenderTarget* depth,
        app::RenderTarget* light_band_weights,
        app::RenderTargetIdentifier dest,
        int32_t slice,
        app::RenderTarget* alpha_tex
    )

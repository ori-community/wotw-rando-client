...
namespace app::classes::Moon::Rendering::MoonRenderPipelineView_SrpProfilerSample {
    ...
    IL2CPP_REGISTER_METHOD(
        0x00EB0C50,
        app::MoonRenderPipelineView_SrpProfilerSample,
        op_Addition,
        app::MoonRenderPipelineView_SrpProfilerSample a,
        app::MoonRenderPipelineView_SrpProfilerSample b
    )
    ...
    inline app::MoonRenderPipelineView_SrpProfilerSample operator+(
        app::MoonRenderPipelineView_SrpProfilerSample a,
        app::MoonRenderPipelineView_SrpProfilerSample b
    ) {
        return op_Addition(a, b);
    }
    inline app::MoonRenderPipelineView_SrpProfilerSample operator/(app::MoonRenderPipelineView_SrpProfilerSample a, int32_t b) { return op_Division(a, b); }
} // namespace app::classes::Moon::Rendering::MoonRenderPipelineView_SrpProfilerSample

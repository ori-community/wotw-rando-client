...
namespace app::classes::Moon::Rendering::SliceRenderSettings_Slice {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Lerp,
        app::SliceRenderSettings_Slice__Boxed* this_ptr,
        app::SliceRenderSettings_Slice from,
        app::SliceRenderSettings_Slice to,
        float t
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        GetComputeKernel,
        float kernel_pixel_radius,
        float cam_movement_delta,
        int32_t* kernel_pass_index,
        int32_t* thread_size,
        int32_t* pass_max_radius,
        int32_t* pass_index
    )
    IL2CPP_REGISTER_METHOD(
        0x00EBDDE0,

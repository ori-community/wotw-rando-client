...
namespace app::classes::Moon::Rendering::RenderTarget {
    ...
    IL2CPP_REGISTER_METHOD(0x00EB1DA0, void, Set, (app::RenderTarget * this_ptr, app::RenderTargetType__Enum _type, app::String* _name, app::RenderTextureDescriptor _desc, app::FilterMode__Enum _filter_mode))

...
namespace app::classes::Moon::Rendering::RuntimeSliceRenderSettings {
    ...
    IL2CPP_REGISTER_METHOD(
        0x00EB3E80,
        app::SliceRenderSettings*,
        GetSliceRenderSettings,
        app::RuntimeSliceRenderSettings* this_ptr,
        app::SceneSettings* setting
    )
    IL2CPP_REGISTER_METHOD(
        0x00EB3F80,
        void,
        Update,
        app::RuntimeSliceRenderSettings* this_ptr,
        app::SliceRenderSettings** out_s_r_s,
        app::LayeredRenderSettings** out_l_r_s,
        app::MotionBlurController** out_m_b,
        app::MoonRenderPipelineAsset* srp_asset
    )
    IL2CPP_REGISTER_METHOD(
        0x00EB4920,
        void,
        ApplyLayerSettings,
        app::RuntimeSliceRenderSettings* this_ptr,
        app::LayeredRenderSettings** destination,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        GenerateAllSlices,
        app::RuntimeSliceRenderSettings* this_ptr,
        app::SliceRenderSettings* from,
        app::SliceRenderSettings* to,
        app::LayeredRenderSettings* from_layer,
        app::LayeredRenderSettings* to_layer,
        float dof_tween_time,
        app::MoonRenderPipelineAsset* srp_asset
    )
    IL2CPP_REGISTER_METHOD(
        0x00EB4E50,
        ...
        float dof_tween_time,
        app::MoonRenderPipelineAsset* srp_asset,
        bool should_do_ui_background_blur
    )
    IL2CPP_REGISTER_METHOD(
        0x00EB54E0,
        void,
        ...
        app::RuntimeSliceRenderSettings* this_ptr,
        int32_t idx,
        app::SliceRenderSettings_Slice* slice_setting,
        app::SliceRenderSettings* settings
    )

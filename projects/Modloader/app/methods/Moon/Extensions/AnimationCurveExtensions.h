...
namespace app::classes::Moon::Extensions::AnimationCurveExtensions {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::AnimationCurveExtensions_TangentMode__Enum tangent_mode,
        int32_t keyframe
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x031B5990,
        int32_t,
        GetNewTangentKeyMode,
        int32_t current_tangent_mode,
        app::AnimationCurveExtensions_TangentDirection__Enum left_right,
        app::AnimationCurveExtensions_TangentMode__Enum mode
    )
} // namespace app::classes::Moon::Extensions::AnimationCurveExtensions

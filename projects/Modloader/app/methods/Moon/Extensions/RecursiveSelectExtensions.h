...
namespace app::classes::Moon::Extensions::RecursiveSelectExtensions {
    IL2CPP_REGISTER_METHOD(
        0x00E7D2A0,
        app::IEnumerable_1_System_Object_*,
        RecursiveSelect_1,
        app::IEnumerable_1_System_Object_* source,
        app::Func_2_Object_System_Collections_Generic_IEnumerable_1_* child_selector
    )
    IL2CPP_REGISTER_METHOD(
        0x00E77800,
        app::IEnumerable_1_System_Object_*,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::IEnumerable_1_System_Object_* source,
        app::Func_2_Object_System_Collections_Generic_IEnumerable_1_* child_selector,
        app::Func_4_Object_Int32_Int32_Object_* selector
    )
    IL2CPP_REGISTER_METHOD(
        0x00E77A40,
        app::IEnumerable_1_System_Object_*,

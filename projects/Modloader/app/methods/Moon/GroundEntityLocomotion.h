...
namespace app::classes::Moon::GroundEntityLocomotion {
    ...
    IL2CPP_REGISTER_METHOD(0x01490260, void, MoveInTheDirection, (app::GroundEntityLocomotion * this_ptr, app::Vector2 direction, app::EntityBehaviourNode* source))
    ...
    IL2CPP_REGISTER_METHOD(0x014907F0, void, SetLookDirectionX_2, (app::GroundEntityLocomotion * this_ptr, float x_look_direction, app::EntityBehaviourNode* source, bool instant))
    IL2CPP_REGISTER_METHOD(0x01490800, void, SetLookDirection, (app::GroundEntityLocomotion * this_ptr, app::Vector2 look_direction, app::EntityBehaviourNode* source, bool instant))
    IL2CPP_REGISTER_METHOD(0x01490930, void, SetLookDirectionTowardsPoint, (app::GroundEntityLocomotion * this_ptr, app::Vector2 point, app::EntityBehaviourNode* source, bool instant))
    IL2CPP_REGISTER_METHOD(0x01490A40, void, PropagateTargetPoint, (app::GroundEntityLocomotion * this_ptr, app::Vector3 point))
    IL2CPP_REGISTER_METHOD(0x01490A80, app::Vector3, GetGroundProjectedTargetPosition, (app::GroundEntityLocomotion * this_ptr, app::Vector3 target_position, float offset_y, float ray_length))

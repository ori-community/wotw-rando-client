...
namespace app::classes::Moon::MoonAnimation {
    ...
    IL2CPP_REGISTER_METHOD(0x01B172B0, app::AnimationTransition*, GetTransition, (app::MoonAnimation * this_ptr, app::IAnimation* target_animation, float current_normalized_time))

...
namespace app::classes::Moon::MoonAnimator___c {
    ...
    IL2CPP_REGISTER_METHODINFO(0x047498E8, MoonAnimator_c__ClearRootMotion_b__202_1__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor_b__208_0, (app::MoonAnimator_c * this_ptr, app::Vector3 _p0_))
    IL2CPP_REGISTER_METHODINFO(0x047161E8, MoonAnimator_c___ctor_b__208_0__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor_b__208_1, (app::MoonAnimator_c * this_ptr, app::Quaternion _p0_))
    IL2CPP_REGISTER_METHODINFO(0x04739C48, MoonAnimator_c___ctor_b__208_1__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor_b__208_2, (app::MoonAnimator_c * this_ptr, app::IAnimation* _p0_, app::ActiveAnimationHandle _p1_, int32_t _p2_, app::Func_1_Boolean_* _p3_))
    IL2CPP_REGISTER_METHODINFO(0x04728180, MoonAnimator_c___ctor_b__208_2__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0470BD68, MoonAnimator_c___ctor_b__208_3__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0472D728, MoonAnimator_c___ctor_b__208_4__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x047389C8, MoonAnimator_c___ctor_b__208_5__MethodInfo)
} // namespace app::classes::Moon::MoonAnimator___c

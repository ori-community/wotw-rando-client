...
namespace app::classes::Moon::QuadTree {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        GetListFromSet,
        app::QuadTree* this_ptr,
        app::HashSet_1_Moon_IRectProvider_* set,
        app::List_1_Moon_IRectProvider_* list_to_populate
    )
    IL2CPP_REGISTER_METHOD(
        0x01995690,
        void,
        QueryRecursively_1,
        app::QuadTree* this_ptr,
        app::QuadTree_Node* node,
        app::Vector3 position,
        app::Byte__Array* bitmask,
        app::List_1_System_Int32_* list_to_populate
    )
    IL2CPP_REGISTER_METHOD(
        0x01995970,
        void,
        ...
        app::QuadTree_Node* node,
        app::Vector3 position,
        app::HashSet_1_Moon_IRectProvider_* results_map
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::QuadTree* this_ptr,
        app::QuadTree_Node* node,
        app::IRectProvider* rect_provider,
        int32_t idx
    )

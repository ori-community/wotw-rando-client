...
namespace app::classes::Moon::Timeline::VirtualTimelineConstrainedTimelineEntity {
    ...
    IL2CPP_REGISTER_METHOD(0x01E92AE0, app::IConstrainedEntity*, GetConstrainedEntityFrom, (app::VirtualTimelineConstrainedTimelineEntity * this_ptr, int32_t index))
    IL2CPP_REGISTER_METHOD(0x01E92BB0, app::IConstrainedEntity*, GetConstrainedEntity, (app::VirtualTimelineConstrainedTimelineEntity * this_ptr, app::EntityId entity_id))
    ...
    IL2CPP_REGISTER_METHOD(0x0058DA40, void, ctor, (app::VirtualTimelineConstrainedTimelineEntity * this_ptr, app::TimelineEntityRecord* timeline_entity_record, app::VirtualMoonTimeline* moon_timeline))
} // namespace app::classes::Moon::Timeline::VirtualTimelineConstrainedTimelineEntity

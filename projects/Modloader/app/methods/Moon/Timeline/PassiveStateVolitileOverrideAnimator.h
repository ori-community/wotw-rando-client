...
namespace app::classes::Moon::Timeline::PassiveStateVolitileOverrideAnimator {
    ...
    IL2CPP_REGISTER_METHOD(0x01E791B0, void, SynchronizePad, (app::PassiveStateVolitileOverrideAnimator * this_ptr, app::MoonTimeline* timeline, app::TimelineEntityRecord* record, app::TimelineEntity* entity, app::Constraint__Enum type))

...
namespace app::classes::Moon::Timeline::ColorAnimator {
    ...
    IL2CPP_REGISTER_METHOD(0x00760290, void, SynchronizePad, (app::ColorAnimator * this_ptr, app::MoonTimeline* timeline, app::TimelineEntityRecord* record, app::TimelineEntity* entity, app::Constraint__Enum type))

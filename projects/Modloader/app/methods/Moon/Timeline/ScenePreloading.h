...
namespace app::classes::Moon::Timeline::ScenePreloading {
    IL2CPP_REGISTER_METHOD(
        0x00784150,
        app::FixedDurationSceneEntity*,
        GetNextSceneEntity_1,
        app::MoonTimeline* timeline,
        app::TimelineEntity* preloading_entity
    )
    IL2CPP_REGISTER_METHOD(
        0x00784210,
        app::FixedDurationSceneEntity*,
        GetNextSceneEntity_2,
        app::MoonTimeline* timeline,
        app::List_1_Moon_Timeline_FixedDurationSceneEntity_* entities,
        app::TimelineEntity* preloading_entity
    )

...
namespace app::classes::Moon::Timeline::ConstraintOperation {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::IConstraint*,
        ModifyConstraint,
        app::MoonTimeline* owning_timeline,
    ...
    IL2CPP_REGISTER_METHOD(
        0x01BB0DC0,
        void,
        ReplaceConstraintUnsafe,
        app::ITimelineEntityParent* owning_timeline,
        app::EntityId from_entity,
        app::Constraint__Enum from_constraint,
        app::TimelineConstraint* constraint
    )
    IL2CPP_REGISTER_METHOD(
        0x01BB0EE0,
        app::ConstraintsMetaData*,
        GetMeta,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::ITimelineEntityParent* timeline,
        app::EntityId entity_id,
        app::Constraint__Enum end,
        app::ConstraintFlag__Enum pad
    )
    IL2CPP_REGISTER_METHOD(
        0x01BB1280,
        bool,
        CheckConstraintFlags,
        app::ITimelineEntityParent* timline,
        app::EntityId entity_id,
        app::Constraint__Enum type,
        app::ConstraintFlag__Enum flags
    )
    IL2CPP_REGISTER_METHOD(
        0x01BB1380,
        app::ConstraintsMetaData*,

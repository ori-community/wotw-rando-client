...
namespace app::classes::Moon::BidirectionalDictionary_2_System_Object_System_Object_ {
    IL2CPP_REGISTER_METHOD(
        ...
        get_FirstValues,
        app::BidirectionalDictionary_2_System_Object_System_Object_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x0271C9B0,
        app::ICollection_1_System_Object_*,
    ...
    IL2CPP_REGISTER_METHOD(
        0x0271D470,
        int32_t,
        System_Collections_Generic_ICollection_Moon_BidirectionalValuePair_T1_T2___get_Count,
        app::BidirectionalDictionary_2_System_Object_System_Object_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x0271D4A0,
        bool,
        System_Collections_Generic_ICollection_Moon_BidirectionalValuePair_T1_T2___get_IsReadOnly,
        app::BidirectionalDictionary_2_System_Object_System_Object_* this_ptr
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x0271D130,
        app::IEnumerator_1_Moon_BidirectionalValuePair_2_*,
        System_Collections_Generic_IEnumerable_Moon_BidirectionalValuePair_T1_T2___GetEnumerator,
        app::BidirectionalDictionary_2_System_Object_System_Object_* this_ptr
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x0271D250,
        void,
        System_Collections_Generic_ICollection_Moon_BidirectionalValuePair_T1_T2___Add,
        app::BidirectionalDictionary_2_System_Object_System_Object_* this_ptr,
        app::BidirectionalValuePair_2_System_Object_System_Object_ item
    )
    IL2CPP_REGISTER_METHOD(
        0x0271D290,
        void,
        System_Collections_Generic_ICollection_Moon_BidirectionalValuePair_T1_T2___Clear,
        app::BidirectionalDictionary_2_System_Object_System_Object_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x0271D2C0,
        bool,
        System_Collections_Generic_ICollection_Moon_BidirectionalValuePair_T1_T2___Contains,
        app::BidirectionalDictionary_2_System_Object_System_Object_* this_ptr,
        app::BidirectionalValuePair_2_System_Object_System_Object_ item
    )
    IL2CPP_REGISTER_METHOD(
        0x0271D360,
        void,
        System_Collections_Generic_ICollection_Moon_BidirectionalValuePair_T1_T2___CopyTo,
        app::BidirectionalDictionary_2_System_Object_System_Object_* this_ptr,
        app::BidirectionalValuePair_2_System_Object_System_Object___Array* array,
        int32_t array_index
    )
    IL2CPP_REGISTER_METHOD(
        0x0271D390,
        bool,
        System_Collections_Generic_ICollection_Moon_BidirectionalValuePair_T1_T2___Remove,
        app::BidirectionalDictionary_2_System_Object_System_Object_* this_ptr,
        app::BidirectionalValuePair_2_System_Object_System_Object_ item
    )
    IL2CPP_REGISTER_METHOD(

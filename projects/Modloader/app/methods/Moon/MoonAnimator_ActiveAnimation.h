...
namespace app::classes::Moon::MoonAnimator_ActiveAnimation {
    ...
    IL2CPP_REGISTER_METHOD(0x0210E520, void, OnAllocated, (app::MoonAnimator_ActiveAnimation * this_ptr, app::IAnimation* animation, int32_t priority, app::MoonAnimator* animator))
    ...
    IL2CPP_REGISTER_METHOD(0x0210E630, app::MoonAnimator_AnimationInstance*, InstantiateAnimation, (app::MoonAnimator_ActiveAnimation * this_ptr, app::MoonAnimator* animator))

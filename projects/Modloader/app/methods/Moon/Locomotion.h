...
namespace app::classes::Moon::Locomotion {
    ...
    IL2CPP_REGISTER_METHOD(0x0110BC40, void, ConfigureFSMState, (app::Locomotion * this_ptr, app::EntityLocomotionTask* task, app::Locomotion_StateTransitionEntry__Array* transitions))
    ...
    IL2CPP_REGISTER_METHOD(0x0110CC60, void, StartRootMotion_1, (app::Locomotion * this_ptr, app::RootMotionProcessorData* config_data, int32_t source_i_d, app::Func_2_UnityEngine_Vector3_UnityEngine_Vector3_* motion_modifier))
    IL2CPP_REGISTER_METHOD(0x0110CE70, void, StartRootMotion_2, (app::Locomotion * this_ptr, app::RootMotionProcessorData* config_data, app::MonoBehaviour* source, app::Func_2_UnityEngine_Vector3_UnityEngine_Vector3_* motion_modifier))

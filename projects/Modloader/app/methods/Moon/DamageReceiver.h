...
namespace app::classes::Moon::DamageReceiver {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        bool,
        ProcessDamage,
        app::DamageReceiver* this_ptr,
        app::DamageReceiver_DamageEntry* entry,
        app::HashSet_1_System_Int32_* processed
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Transform*,
        SpawnEffect_1,
        app::EffectSpawn prefab,
        app::Damage* damage,
        app::IDamageReciever* receiver,
        float rand,
        app::EffectTransformType__Enum override_transform_type
    )
    IL2CPP_REGISTER_METHOD(
        0x00CD4B50,
        app::Transform*,
        ...
        app::IDamageReciever* receiver,
        float rand,
        app::EffectTransformType__Enum transform_type,

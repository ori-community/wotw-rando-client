...
namespace app::classes::Moon::DynamicCameraTargetting {
    ...
    IL2CPP_REGISTER_METHOD(
        0x01202F50,
        void,
        AdjustCameraTargetWeightForLeashHooks,
        float* weight,
        app::ICameraTarget* target,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Rect,
        GetRect,
        app::DynamicCameraTargetting* this_ptr,
        app::CameraTargetSettings setting,
        app::Vector3 primary_target_position
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        DebugDrawCamera,
        app::DynamicCameraTargetting* this_ptr,
        app::Rect bounding_rect,
        app::Rect padded_rect,
        app::Rect debug_res,
        app::Rect cover,
        app::Rect resultant_rect,
        app::Vector2 target_pos
    )
    IL2CPP_REGISTER_METHOD(
        0x01205820,
        void,
        PropagateWeightToLayers,
        app::DynamicCameraTargetting* this_ptr,
        float target_weight,
        float delta_time,
        bool instant
    ...
    IL2CPP_REGISTER_METHOD(
        0x01205D50,
        void,
        FillRectsFromTargets,
        app::DynamicCameraTargetting* this_ptr,
        app::List_1_Moon_CameraTargetSettings_* provided_targets,
        app::CameraTargetSettings primary_target
    )

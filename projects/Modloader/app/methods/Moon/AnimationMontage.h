...
namespace app::classes::Moon::AnimationMontage {
    ...
    IL2CPP_REGISTER_METHOD(0x01338220, void, PlayMontage, (app::AnimationMontage * this_ptr, app::MoonAnimator* target, app::Action* stop_playing_action, app::Dictionary_2_System_String_Moon_MoonAnimator_* sub_montages_by_name))
    IL2CPP_REGISTER_METHOD(0x01338C80, void, StopMontage, (app::AnimationMontage * this_ptr, bool invoke_stop_playing_action))
    IL2CPP_REGISTER_METHOD(0x01338FA0, void, SetAnimatorParent, (app::AnimationMontage * this_ptr, app::MoonAnimator* parent_animator, app::MoonAnimator* current_animator, app::String* path))
    ...
    IL2CPP_REGISTER_METHOD(0x01339970, void, SubscribeToEvent, (app::AnimationMontage * this_ptr, app::String* value_name, app::Action* enter_event, app::Action* stay_event, app::Action* exit_event))
    IL2CPP_REGISTER_METHOD(0x01339B60, void, UnsubscribeFromEvent, (app::AnimationMontage * this_ptr, app::String* value_name, app::Action* enter_event, app::Action* stay_event, app::Action* exit_event))
    ...
    IL2CPP_REGISTER_METHOD(0x0154A4B0, void, SubscribeToValue, (app::AnimationMontage * this_ptr, app::String* value_name, app::Action_1_Object_* callback, app::Object* default_value))

...
namespace app::classes::Moon::MoonDriver {
    ...
    IL2CPP_REGISTER_METHOD(0x0313C650, void, GetEntryCounts, (app::MoonDriver * this_ptr, int32_t* update_manager_count, int32_t* fixed_update_manager_count, int32_t* late_update_manager_count))

...
namespace app::classes::Moon::UberStateController {
    ...
    IL2CPP_REGISTER_METHOD(0x01B6BB30, void, SetWaitingApplierContext, (app::UberStateController * this_ptr, int32_t index, app::UberStateApplyContext__Enum context))

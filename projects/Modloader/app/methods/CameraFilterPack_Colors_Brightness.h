...
namespace app::classes::CameraFilterPack_Colors_Brightness {
    ...
    IL2CPP_REGISTER_METHOD(0x024E0450, void, OnRenderImage, (app::CameraFilterPack_Colors_Brightness * this_ptr, app::RenderTexture* source_texture, app::RenderTexture* dest_texture))

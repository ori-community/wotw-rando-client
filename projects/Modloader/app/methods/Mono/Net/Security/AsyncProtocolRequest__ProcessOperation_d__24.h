...
namespace app::classes::Mono::Net::Security::AsyncProtocolRequest__ProcessOperation_d__24 {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0478EAD0, AsyncProtocolRequest_ProcessOperation_d_24_MoveNext__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x0011DCA0, void, SetStateMachine, (app::AsyncProtocolRequest_ProcessOperation_d_24__Boxed * this_ptr, app::IAsyncStateMachine* state_machine))
} // namespace app::classes::Mono::Net::Security::AsyncProtocolRequest__ProcessOperation_d__24

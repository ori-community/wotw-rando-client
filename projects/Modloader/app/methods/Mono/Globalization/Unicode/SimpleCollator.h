...
namespace app::classes::Mono::Globalization::Unicode::SimpleCollator {
    ...
    IL2CPP_REGISTER_METHOD(0x023BF4F0, int32_t, FilterExtender, (app::SimpleCollator * this_ptr, int32_t i, app::SimpleCollator_ExtenderType__Enum ext, app::CompareOptions__Enum opt))
    ...
    IL2CPP_REGISTER_METHOD(0x023BF880, app::SortKey*, GetSortKey_2, (app::SimpleCollator * this_ptr, app::String* s, int32_t start, int32_t length, app::CompareOptions__Enum options))
    IL2CPP_REGISTER_METHOD(0x023BFA50, void, GetSortKey_3, (app::SimpleCollator * this_ptr, app::String* s, int32_t start, int32_t end, app::SortKeyBuffer* buf, app::CompareOptions__Enum opt))
    IL2CPP_REGISTER_METHOD(0x023BFE70, void, FillSortKeyRaw, (app::SimpleCollator * this_ptr, int32_t i, app::SimpleCollator_ExtenderType__Enum ext, app::SortKeyBuffer* buf, app::CompareOptions__Enum opt))
    ...
    IL2CPP_REGISTER_METHOD(0x023C0410, int32_t, Compare, (app::SimpleCollator * this_ptr, app::String* s1, int32_t idx1, int32_t len1, app::String* s2, int32_t idx2, int32_t len2, app::CompareOptions__Enum options))
    IL2CPP_REGISTER_METHOD(0x023C0510, void, ClearBuffer, (app::SimpleCollator * this_ptr, uint8_t* buffer, int32_t size))
    IL2CPP_REGISTER_METHOD(0x023C0530, int32_t, CompareInternal, (app::SimpleCollator * this_ptr, app::String* s1, int32_t idx1, int32_t len1, app::String* s2, int32_t idx2, int32_t len2, bool* target_consumed, bool* source_consumed, bool skip_heading_extenders, bool immediate_breakup, app::SimpleCollator_Context* ctx))
    ...
    IL2CPP_REGISTER_METHOD(0x023C1920, bool, IsPrefix_2, (app::SimpleCollator * this_ptr, app::String* s, app::String* target, int32_t start, int32_t length, app::CompareOptions__Enum opt))
    IL2CPP_REGISTER_METHOD(0x023C1A20, bool, IsPrefix_3, (app::SimpleCollator * this_ptr, app::String* s, app::String* target, int32_t start, int32_t length, bool skip_heading_extenders, app::SimpleCollator_Context* ctx))
    ...
    IL2CPP_REGISTER_METHOD(0x023C31A0, bool, MatchesForward, (app::SimpleCollator * this_ptr, app::String* s, int32_t* idx, int32_t end, int32_t ti, uint8_t* sortkey, bool no_lv4, app::SimpleCollator_Context* ctx))
    IL2CPP_REGISTER_METHOD(0x023C3370, bool, MatchesForwardCore, (app::SimpleCollator * this_ptr, app::String* s, int32_t* idx, int32_t end, int32_t ti, uint8_t* sortkey, bool no_lv4, app::SimpleCollator_ExtenderType__Enum ext, app::Contraction** ct, app::SimpleCollator_Context* ctx))
    IL2CPP_REGISTER_METHOD(0x023C37A0, bool, MatchesPrimitive, (app::SimpleCollator * this_ptr, app::CompareOptions__Enum opt, uint8_t* source, int32_t si, app::SimpleCollator_ExtenderType__Enum ext, uint8_t* target, int32_t ti, bool no_lv4))
    IL2CPP_REGISTER_METHOD(0x023C39F0, bool, MatchesBackward, (app::SimpleCollator * this_ptr, app::String* s, int32_t* idx, int32_t end, int32_t org_start, int32_t ti, uint8_t* sortkey, bool no_lv4, app::SimpleCollator_Context* ctx))
    IL2CPP_REGISTER_METHOD(0x023C3BD0, bool, MatchesBackwardCore, (app::SimpleCollator * this_ptr, app::String* s, int32_t* idx, int32_t end, int32_t org_start, int32_t ti, uint8_t* sortkey, bool no_lv4, app::SimpleCollator_ExtenderType__Enum ext, app::Contraction** ct, app::SimpleCollator_Context* ctx))

...
namespace app::classes::Mono::Security::Protocol::Tls::CipherSuiteCollection {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Add,
        app::CipherSuiteCollection* this_ptr,
        int16_t code,
        app::String* name,
        app::CipherAlgorithmType__Enum cipher_type,
        app::HashAlgorithmType__Enum hash_type,
        app::ExchangeAlgorithmType__Enum exchange_type,
        bool exportable,
        bool block_mode,
        uint8_t key_material_size,
        uint8_t expanded_key_material_size,
        int16_t effective_key_bytes,
        uint8_t iv_size,
        uint8_t block_size
    )

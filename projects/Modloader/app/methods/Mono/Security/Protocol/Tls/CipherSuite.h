...
namespace app::classes::Mono::Security::Protocol::Tls::CipherSuite {
    ...
    IL2CPP_REGISTER_METHOD(0x01F636E0, app::Byte__Array*, PRF, (app::CipherSuite * this_ptr, app::Byte__Array* secret, app::String* label, app::Byte__Array* data, int32_t length))
    IL2CPP_REGISTER_METHOD(0x01F63AD0, app::Byte__Array*, Expand, (app::CipherSuite * this_ptr, app::HashAlgorithm* hash, app::Byte__Array* secret, app::Byte__Array* seed, int32_t length))

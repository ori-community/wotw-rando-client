...
namespace app::classes::Mono::Security::X509::PKCS12 {
    ...
    IL2CPP_REGISTER_METHOD(
        0x025DCD70,
        app::SymmetricAlgorithm*,
        GetSymmetricAlgorithm_1,
        app::PKCS12* this_ptr,
        app::String* algorithm_oid,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Byte__Array* salt,
        int32_t iteration_count,
        app::Byte__Array* encrypted_data
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x02925760,
        app::SymmetricAlgorithm*,
        GetSymmetricAlgorithm_2,
        app::PKCS12_1* this_ptr,
        app::String* algorithm_oid,
        app::Byte__Array* salt,
        int32_t iteration_count
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::PKCS12_1* this_ptr,
        app::AsymmetricAlgorithm* aa,
        app::IDictionary* attributes
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x0292E400,
        app::PKCS7_ContentInfo_1*,
        EncryptedContentInfo_2,
        app::PKCS12_1* this_ptr,
        app::ASN1_1* safe_bags,
        app::String* algorithm_oid
    )

...
namespace app::classes::Mono::Math::BigInteger_Kernel {
    ...
    IL2CPP_REGISTER_METHOD(0x023CB4F0, void, Multiply_1, (app::UInt32__Array * x, uint32_t x_offset, uint32_t x_len, app::UInt32__Array* y, uint32_t y_offset, uint32_t y_len, app::UInt32__Array* d, uint32_t d_offset))
    IL2CPP_REGISTER_METHOD(0x023CB640, void, MultiplyMod2p32pmod_1, (app::UInt32__Array * x, int32_t x_offset, int32_t x_len, app::UInt32__Array* y, int32_t y_offest, int32_t y_len, app::UInt32__Array* d, int32_t d_offset, int32_t mod))
    ...
    IL2CPP_REGISTER_METHOD(0x023CB4F0, void, Multiply_2, (app::UInt32__Array * x, uint32_t x_offset, uint32_t x_len, app::UInt32__Array* y, uint32_t y_offset, uint32_t y_len, app::UInt32__Array* d, uint32_t d_offset))
    IL2CPP_REGISTER_METHOD(0x023CB640, void, MultiplyMod2p32pmod_2, (app::UInt32__Array * x, int32_t x_offset, int32_t x_len, app::UInt32__Array* y, int32_t y_offest, int32_t y_len, app::UInt32__Array* d, int32_t d_offset, int32_t mod))

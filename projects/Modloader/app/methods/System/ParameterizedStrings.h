...
namespace app::classes::System::ParameterizedStrings {
    ...
    IL2CPP_REGISTER_METHOD(0x0227E210, app::ParameterizedStrings_FormatParam__Array*, GetDynamicOrStaticVariables, (char16_t c, app::ParameterizedStrings_FormatParam__Array** dynamic_vars, app::ParameterizedStrings_FormatParam__Array** static_vars, int32_t* index))
} // namespace app::classes::System::ParameterizedStrings

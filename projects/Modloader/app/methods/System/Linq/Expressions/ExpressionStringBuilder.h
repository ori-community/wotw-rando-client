...
namespace app::classes::System::Linq::Expressions::ExpressionStringBuilder {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::ExpressionStringBuilder* this_ptr,
        app::MemberMemberBinding* binding
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::ExpressionStringBuilder* this_ptr,
        char16_t open,
        app::ReadOnlyCollection_1_System_Object_* expressions,
        char16_t close
    )
    IL2CPP_REGISTER_METHOD(
        0x01AEFC70,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::ExpressionStringBuilder* this_ptr,
        char16_t open,
        app::ReadOnlyCollection_1_System_Linq_Expressions_ParameterExpression_* expressions,
        char16_t close
    )
    IL2CPP_REGISTER_METHOD(
        0x01AEFBA0,

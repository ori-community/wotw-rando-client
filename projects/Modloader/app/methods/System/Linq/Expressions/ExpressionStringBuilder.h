...
namespace app::classes::System::Linq::Expressions::ExpressionStringBuilder {
    ...
    IL2CPP_REGISTER_METHOD(0x022C7C90, void, Out_2, (app::ExpressionStringBuilder * this_ptr, char16_t c))
    ...
    IL2CPP_REGISTER_METHOD(0x01AEFBA0, void, VisitExpressions_1, (app::ExpressionStringBuilder * this_ptr, char16_t open, app::ReadOnlyCollection_1_System_Object_* expressions, char16_t close))
    IL2CPP_REGISTER_METHOD(0x01AEFC70, void, VisitExpressions_2, (app::ExpressionStringBuilder * this_ptr, char16_t open, app::ReadOnlyCollection_1_System_Object_* expressions, char16_t close, app::String* seperator))
    ...
    IL2CPP_REGISTER_METHOD(0x01AEFBA0, void, VisitExpressions_3, (app::ExpressionStringBuilder * this_ptr, char16_t open, app::ReadOnlyCollection_1_System_Linq_Expressions_ParameterExpression_* expressions, char16_t close))
    IL2CPP_REGISTER_METHOD(0x01AEFBA0, void, VisitExpressions_4, (app::ExpressionStringBuilder * this_ptr, char16_t open, app::ReadOnlyCollection_1_System_Linq_Expressions_Expression_* expressions, char16_t close))
} // namespace app::classes::System::Linq::Expressions::ExpressionStringBuilder

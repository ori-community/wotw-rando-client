...
namespace app::classes::System::Linq::Expressions::Block4 {
    IL2CPP_REGISTER_METHOD(0x01F9E9B0, void, ctor, (app::Block4 * this_ptr, app::Expression* arg0, app::Expression* arg1, app::Expression* arg2, app::Expression* arg3))
    ...
    IL2CPP_REGISTER_METHOD(0x01F9EB00, app::BlockExpression*, Rewrite, (app::Block4 * this_ptr, app::ReadOnlyCollection_1_System_Linq_Expressions_ParameterExpression_* variables, app::Expression__Array* args))
} // namespace app::classes::System::Linq::Expressions::Block4

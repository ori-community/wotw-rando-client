...
namespace app::classes::System::Linq::Expressions::Interpreter::InstructionList_DebugView {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        GetInstructionViews_1,
        app::InstructionList_DebugView* this_ptr,
        bool include_debug_cookies
    )
    IL2CPP_REGISTER_METHOD(
        0x01CE0C40,
        app::InstructionList_DebugView_InstructionView__Array*,
        GetInstructionViews_2,
        app::IReadOnlyList_1_System_Linq_Expressions_Interpreter_Instruction_* instructions,
        app::IReadOnlyList_1_System_Object_* objects,
        app::Func_2_Int32_Int32_* label_indexer,
        app::IReadOnlyList_1_KeyValuePair_2_System_Int32_System_Object_* debug_cookies
    )

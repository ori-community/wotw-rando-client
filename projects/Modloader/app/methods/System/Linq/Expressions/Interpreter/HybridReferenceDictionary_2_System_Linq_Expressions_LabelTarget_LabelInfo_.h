...
namespace app::classes::System::Linq::Expressions::Interpreter::HybridReferenceDictionary_2_System_Linq_Expressions_LabelTarget_LabelInfo_ {
    IL2CPP_REGISTER_METHOD(
        ...
        bool,
        ContainsKey,
        app::HybridReferenceDictionary_2_System_Linq_Expressions_LabelTarget_LabelInfo_* this_ptr,
        app::LabelTarget* key
    )
    IL2CPP_REGISTER_METHOD(
        0x025457C0,
    ...
    IL2CPP_REGISTER_METHOD(
        0x02545990,
        app::IEnumerator_1_KeyValuePair_2_System_Linq_Expressions_LabelTarget_System_Linq_Expressions_Interpreter_LabelInfo_*,
        GetEnumerator,
        app::HybridReferenceDictionary_2_System_Linq_Expressions_LabelTarget_LabelInfo_* this_ptr
    )
} // namespace app::classes::System::Linq::Expressions::Interpreter::HybridReferenceDictionary_2_System_Linq_Expressions_LabelTarget_LabelInfo_

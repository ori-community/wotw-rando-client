...
namespace app::classes::System::Linq::Expressions::Interpreter::LightCompiler {
    ...
    IL2CPP_REGISTER_METHOD(0x01CF8260, void, CompileMethodCallExpression_2, (app::LightCompiler * this_ptr, app::Expression* object, app::MethodInfo_1* method_1, app::IArgumentProvider* arguments))
    IL2CPP_REGISTER_METHOD(0x01CF88A0, app::ByRefUpdater*, CompileArrayIndexAddress, (app::LightCompiler * this_ptr, app::Expression* array, app::Expression* index, int32_t argument_index))

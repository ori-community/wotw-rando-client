...
namespace app::classes::System::Linq::Expressions::DebugViewWriter {
    ...
    IL2CPP_REGISTER_METHOD(0x01FA44B0, void, Out_4, (app::DebugViewWriter * this_ptr, app::DebugViewWriter_Flow__Enum before, app::String* s, app::DebugViewWriter_Flow__Enum after))
    ...
    IL2CPP_REGISTER_METHOD(0x01FA5CA0, void, OutMember, (app::DebugViewWriter * this_ptr, app::Expression* node, app::Expression* instance, app::MemberInfo_1* member))

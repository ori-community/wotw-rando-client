...
namespace app::classes::System::Linq::Enumerable_Iterator_1_SceneLoadingQueue_QueueSceneToLoad_ {
    ...
    IL2CPP_REGISTER_METHOD(0x009EB5D0, app::SceneLoadingQueue_QueueSceneToLoad, get_Current, (app::Enumerable_Iterator_1_SceneLoadingQueue_QueueSceneToLoad_ * this_ptr))
    IL2CPP_REGISTER_METHOD(0x0298B3B0, void, Dispose, (app::Enumerable_Iterator_1_SceneLoadingQueue_QueueSceneToLoad_ * this_ptr))
    IL2CPP_REGISTER_METHOD(0x02980540, app::IEnumerator_1_SceneLoadingQueue_QueueSceneToLoad_*, GetEnumerator, (app::Enumerable_Iterator_1_SceneLoadingQueue_QueueSceneToLoad_ * this_ptr))
    ...
    IL2CPP_REGISTER_METHODINFO(0x04726BC8, Enumerable_Iterator_1_SceneLoadingQueue_QueueSceneToLoad__System_Collections_IEnumerator_Reset__MethodInfo)
} // namespace app::classes::System::Linq::Enumerable_Iterator_1_SceneLoadingQueue_QueueSceneToLoad_

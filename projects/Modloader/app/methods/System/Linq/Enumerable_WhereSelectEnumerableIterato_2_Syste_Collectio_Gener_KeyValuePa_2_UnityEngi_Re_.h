...
namespace app::classes::System::Linq::Enumerable_WhereSelectEnumerableIterator_2_System_Collections_Generic_KeyValuePair_2_UnityEngine_Rect_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_1,
        app::Enumerable_WhereSelectEnumerableIterator_2_System_Collections_Generic_KeyValuePair_2_UnityEngine_Rect_* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_2,
        app::Enumerable_WhereSelectEnumerableIterator_2_System_Collections_Generic_KeyValuePair_2_UnityEngine_Rect__1* this_ptr,

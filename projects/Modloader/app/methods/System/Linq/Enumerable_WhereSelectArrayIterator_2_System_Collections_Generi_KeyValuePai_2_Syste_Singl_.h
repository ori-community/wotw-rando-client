...
#include <Modloader/app/structs/Enumerable_WhereSelectArrayIterator_2_Syste_Collection_Generi_KeyValuePai_2_Syste_Singl__1.h>
#include <Modloader/app/structs/Enumerable_WhereSelectArrayIterator_2_System_Collections_Generi_KeyValuePai_2_Syste_Singl_.h>
...
namespace app::classes::System::Linq::Enumerable_WhereSelectArrayIterator_2_System_Collections_Generic_KeyValuePair_2_System_Single_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_1,
        app::Enumerable_WhereSelectArrayIterator_2_System_Collections_Generic_KeyValuePair_2_System_Single_* this_ptr,
        app::KeyValuePair_2_System_Object_System_Int32___Array* source,
        app::Func_2_System_Collections_Generic_KeyValuePair_2_Boolean__4* predicate,
        app::Func_2_System_Collections_Generic_KeyValuePair_2_Single__1* selector
    )
    IL2CPP_REGISTER_METHOD(
        0x028951E0,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_2,
        app::Enumerable_WhereSelectArrayIterator_2_System_Collections_Generic_KeyValuePair_2_System_Single__1* this_ptr,
        app::KeyValuePair_2_System_Object_System_Object___Array* source,
        app::Func_2_System_Collections_Generic_KeyValuePair_2_Boolean__3* predicate,
        app::Func_2_System_Collections_Generic_KeyValuePair_2_Single__2* selector
    )
    IL2CPP_REGISTER_METHOD(
        0x028951E0,
        app::Enumerable_Iterator_1_System_Single_*,

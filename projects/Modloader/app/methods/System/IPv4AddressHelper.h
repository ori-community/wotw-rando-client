...
namespace app::classes::System::IPv4AddressHelper {
    ...
    IL2CPP_REGISTER_METHOD(0x0200B2D0, bool, IsValid, (char16_t* name, int32_t start, int32_t* end, bool allow_i_pv6, bool not_implicit_file, bool unknown_scheme))
    IL2CPP_REGISTER_METHOD(0x0200B480, bool, IsValidCanonical, (char16_t* name, int32_t start, int32_t* end, bool allow_i_pv6, bool not_implicit_file))
    IL2CPP_REGISTER_METHOD(0x0200B5F0, int64_t, ParseNonCanonical, (char16_t* name, int32_t start, int32_t* end, bool not_implicit_file))

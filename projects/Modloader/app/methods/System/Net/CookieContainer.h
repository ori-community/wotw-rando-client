...
namespace app::classes::System::Net::CookieContainer {
    ...
    IL2CPP_REGISTER_METHOD(
        0x01EA58E0,
        app::CookieCollection*,
        CookieCutter,
        app::CookieContainer* this_ptr,
        app::Uri* uri,
        app::String* header_name,
        app::String* set_cookie_header,
        bool is_throw
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        bool is_secure,
        int32_t port,
        app::CookieCollection* cookies,
        app::List_1_System_String_* domain_attribute,
        bool match_only_plain_cookie
    )
    IL2CPP_REGISTER_METHOD(
        0x01EA6FB0,
        void,
        ...
        app::CookieContainer* this_ptr,
        app::CookieCollection* destination,
        app::CookieCollection* source,
        int32_t port,
        bool is_secure,
        bool is_plain_only
    )

...
namespace app::classes::System::Net::WebHeaderCollection {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_4,
        app::WebHeaderCollection* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        0x01D754A0,
        app::DataParseStatus__Enum,
        ParseHeaders,
        app::WebHeaderCollection* this_ptr,
        app::Byte__Array* buffer,
        int32_t size,
        int32_t* unparsed,
        int32_t* total_response_headers_length,
        int32_t maximum_response_headers_length,
        app::WebParseError* parse_error
    )
    IL2CPP_REGISTER_METHOD(
        0x01D75940,
        app::DataParseStatus__Enum,

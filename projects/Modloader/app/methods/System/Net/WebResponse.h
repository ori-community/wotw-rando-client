...
namespace app::classes::System::Net::WebResponse {
    ...
    IL2CPP_REGISTER_METHOD(0x002FA000, void, ctor_2, (app::WebResponse * this_ptr, app::SerializationInfo* serialization_info, app::StreamingContext streaming_context))

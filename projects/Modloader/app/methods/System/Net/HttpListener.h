...
namespace app::classes::System::Net::HttpListener {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        bool owns_stream,
        app::RemoteCertificateValidationCallback* callback
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::HttpListener* this_ptr,
        app::HttpListener_ExtendedProtectionSelector* value
    )

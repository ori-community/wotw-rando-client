...
namespace app::classes::System::Net::Http::Headers::HttpHeaders__GetEnumerator_d__19 {
    ...
    IL2CPP_REGISTER_METHOD(
        0x00C3DD30,
        app::KeyValuePair_2_System_String_IEnumerable_1_System_String_,
        IEnumerator_KeyValuePair_string__IEnumerable_string____get_Current,
        app::HttpHeaders_GetEnumerator_d_19* this_ptr
    )

...
namespace app::classes::System::Net::Http::Headers::CollectionExtensions {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        bool,
        SequenceEqual_2,
        app::List_1_System_Net_Http_Headers_NameValueHeaderValue_* first,
        app::List_1_System_Net_Http_Headers_NameValueHeaderValue_* second
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        bool,
        SequenceEqual_4,
        app::List_1_System_Net_Http_Headers_RangeItemHeaderValue_* first,
        app::List_1_System_Net_Http_Headers_RangeItemHeaderValue_* second
    )
} // namespace app::classes::System::Net::Http::Headers::CollectionExtensions

...
namespace app::classes::System::Net::ServicePoint {
    ...
    IL2CPP_REGISTER_METHOD(0x01BD7710, app::Socket*, GetConnection, (app::ServicePoint * this_ptr, app::PooledStream* pooled_stream, app::Object* owner, bool async, app::IPAddress** address, app::Socket** abort_socket, app::Socket** abort_socket6))

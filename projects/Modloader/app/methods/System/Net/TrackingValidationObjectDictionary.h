...
namespace app::classes::System::Net::TrackingValidationObjectDictionary {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::TrackingValidationObjectDictionary* this_ptr,
        app::IDictionary_2_System_String_System_Net_TrackingValidationObjectDictionary_ValidateAndParseValue_* validators
    )
    IL2CPP_REGISTER_METHOD(
        0x020AA250,
        void,

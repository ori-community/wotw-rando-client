...
namespace app::classes::System::Net::FtpWebResponse {
    ...
    IL2CPP_REGISTER_METHOD(0x01D37D00, void, ctor_2, (app::FtpWebResponse * this_ptr, app::FtpWebRequest* request, app::Uri* uri, app::String* method_1, app::FtpStatusCode__Enum status_code, app::String* status_description))
    IL2CPP_REGISTER_METHOD(0x01D37E30, void, ctor_3, (app::FtpWebResponse * this_ptr, app::FtpWebRequest* request, app::Uri* uri, app::String* method_1, app::FtpStatus* status))

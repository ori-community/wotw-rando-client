...
namespace app::classes::System::Net::Security::SslStream {
    ...
    IL2CPP_REGISTER_METHOD(0x01BD1D40, void, ctor, (app::SslStream * this_ptr, app::Stream* inner_stream, bool leave_inner_stream_open, app::MonoTlsProvider* provider, app::MonoTlsSettings* settings))
    IL2CPP_REGISTER_METHOD(0x01BD1DC0, app::IMonoSslStream*, CreateMonoSslStream, (app::Stream * inner_stream, bool leave_inner_stream_open, app::MonoTlsProvider* provider, app::MonoTlsSettings* settings))
    IL2CPP_REGISTER_METHOD(0x01BD1F50, void, AuthenticateAsServer, (app::SslStream * this_ptr, app::X509Certificate_1* server_certificate, bool client_certificate_required, app::SslProtocols__Enum enabled_ssl_protocols, bool check_certificate_revocation))
    ...
    IL2CPP_REGISTER_METHOD(0x01BD2BE0, app::IAsyncResult*, BeginRead, (app::SslStream * this_ptr, app::Byte__Array* buffer, int32_t offset, int32_t count, app::AsyncCallback* async_callback, app::Object* async_state))
    IL2CPP_REGISTER_METHOD(0x01BD2CC0, int32_t, EndRead, (app::SslStream * this_ptr, app::IAsyncResult* async_result))
    IL2CPP_REGISTER_METHOD(0x01BD2D70, app::IAsyncResult*, BeginWrite, (app::SslStream * this_ptr, app::Byte__Array* buffer, int32_t offset, int32_t count, app::AsyncCallback* async_callback, app::Object* async_state))

...
namespace app::classes::System::ComponentModel::MaskedTextProvider {
    ...
    IL2CPP_REGISTER_METHOD(0x01FF6740, void, ctor_6, (app::MaskedTextProvider * this_ptr, app::String* mask, app::CultureInfo* culture, char16_t password_char, bool allow_prompt_as_input))
    IL2CPP_REGISTER_METHOD(0x01FF6780, void, ctor_7, (app::MaskedTextProvider * this_ptr, app::String* mask, app::CultureInfo* culture, bool allow_prompt_as_input, char16_t prompt_char, char16_t password_char, bool restrict_to_ascii))
    ...
    IL2CPP_REGISTER_METHOD(0x01FF8F20, bool, Add_2, (app::MaskedTextProvider * this_ptr, char16_t input, int32_t* test_position, app::MaskedTextResultHint__Enum* result_hint))
    ...
    IL2CPP_REGISTER_METHOD(0x01FF9B50, bool, InsertAt_2, (app::MaskedTextProvider * this_ptr, char16_t input, int32_t position, int32_t* test_position, app::MaskedTextResultHint__Enum* result_hint))
    ...
    IL2CPP_REGISTER_METHOD(0x01FFB210, bool, Replace_2, (app::MaskedTextProvider * this_ptr, char16_t input, int32_t position, int32_t* test_position, app::MaskedTextResultHint__Enum* result_hint))
    IL2CPP_REGISTER_METHOD(0x01FFB310, bool, Replace_3, (app::MaskedTextProvider * this_ptr, char16_t input, int32_t start_position, int32_t end_position, int32_t* test_position, app::MaskedTextResultHint__Enum* result_hint))
    ...
    IL2CPP_REGISTER_METHOD(0x01FFC150, void, SetChar_2, (app::MaskedTextProvider * this_ptr, char16_t input, int32_t position, app::MaskedTextProvider_CharDescriptor* char_descriptor))
    IL2CPP_REGISTER_METHOD(0x01FFC3A0, void, SetString, (app::MaskedTextProvider * this_ptr, app::String* input, int32_t test_position))
    IL2CPP_REGISTER_METHOD(0x01FFC470, bool, TestChar, (app::MaskedTextProvider * this_ptr, char16_t input, int32_t position, app::MaskedTextResultHint__Enum* result_hint))
    IL2CPP_REGISTER_METHOD(0x01FFCA00, bool, TestEscapeChar_1, (app::MaskedTextProvider * this_ptr, char16_t input, int32_t position))
    IL2CPP_REGISTER_METHOD(0x01FFCAD0, bool, TestEscapeChar_2, (app::MaskedTextProvider * this_ptr, char16_t input, int32_t position, app::MaskedTextProvider_CharDescriptor* char_dex))
    IL2CPP_REGISTER_METHOD(0x01FFCC00, bool, TestSetChar, (app::MaskedTextProvider * this_ptr, char16_t input, int32_t position, app::MaskedTextResultHint__Enum* result_hint))
    ...
    IL2CPP_REGISTER_METHOD(0x01FFD790, bool, VerifyChar, (app::MaskedTextProvider * this_ptr, char16_t input, int32_t position, app::MaskedTextResultHint__Enum* hint))

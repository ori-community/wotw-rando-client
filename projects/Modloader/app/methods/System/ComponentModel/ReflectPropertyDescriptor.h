...
namespace app::classes::System::ComponentModel::ReflectPropertyDescriptor {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_1,
        app::ReflectPropertyDescriptor* this_ptr,
        app::Type* component_class,
        app::String* name,
        app::Type* type,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::String* name,
        app::Type* type,
        app::PropertyInfo_1* prop_info,
        app::MethodInfo_1* get_method,
        app::MethodInfo_1* set_method,
        app::Attribute__Array* attrs
    )
    IL2CPP_REGISTER_METHOD(
        0x0299BE10,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::ReflectPropertyDescriptor* this_ptr,
        app::Type* component_class,
        app::PropertyDescriptor* old_reflect_property_descriptor,
        app::Attribute__Array* attributes
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::IExtenderProvider* provider,
        app::Object* component,
        app::PropertyDescriptor* notify_desc
    )
    IL2CPP_REGISTER_METHOD(
        0x0299EB60,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::ReflectPropertyDescriptor* this_ptr,
        app::Object* component,
        app::PropertyChangedEventArgs* e
    )

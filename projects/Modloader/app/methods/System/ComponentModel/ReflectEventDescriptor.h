...
namespace app::classes::System::ComponentModel::ReflectEventDescriptor {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_1,
        app::ReflectEventDescriptor* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::EventDescriptor_1* old_reflect_event_descriptor,
        app::Attribute__Array* attributes
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::ReflectEventDescriptor* this_ptr,
        app::EventInfo_1* real_event_info,
        app::IList* attributes
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::ReflectEventDescriptor* this_ptr,
        app::MethodInfo_1* real_method_info,
        app::IList* attributes
    )

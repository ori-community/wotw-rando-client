...
namespace app::classes::System::ComponentModel::LicenseManager_LicenseInteropHelper {
    ...
    IL2CPP_REGISTER_METHOD(0x01FF3D10, void, GetCurrentContextInfo, (app::LicenseManager_LicenseInteropHelper * this_ptr, int32_t* f_design_time, void** bstr_key, app::RuntimeTypeHandle rth))

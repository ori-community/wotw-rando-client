...
namespace app::classes::System::Text::UnicodeEncoding {
    ...
    IL2CPP_REGISTER_METHOD(0x027D3B10, int32_t, GetBytes_3, (app::UnicodeEncoding * this_ptr, char16_t* chars, int32_t char_count, uint8_t* bytes, int32_t byte_count))
    ...
    IL2CPP_REGISTER_METHOD(0x027D4240, int32_t, GetChars_2, (app::UnicodeEncoding * this_ptr, uint8_t* bytes, int32_t byte_count, char16_t* chars, int32_t char_count))
    ...
    IL2CPP_REGISTER_METHOD(0x027D4E40, int32_t, GetBytes_4, (app::UnicodeEncoding * this_ptr, char16_t* chars, int32_t char_count, uint8_t* bytes, int32_t byte_count, app::EncoderNLS* encoder))
    ...
    IL2CPP_REGISTER_METHOD(0x027D63A0, int32_t, GetChars_3, (app::UnicodeEncoding * this_ptr, uint8_t* bytes, int32_t byte_count, char16_t* chars, int32_t char_count, app::DecoderNLS* base_decoder))

...
namespace app::classes::System::Text::EncoderExceptionFallbackBuffer {
    ...
    IL2CPP_REGISTER_METHOD(0x0244C780, bool, Fallback_2, (app::EncoderExceptionFallbackBuffer * this_ptr, char16_t char_unknown_high, char16_t char_unknown_low, int32_t index))

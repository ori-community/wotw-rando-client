...
namespace app::classes::System::Text::Latin1Encoding {
    ...
    IL2CPP_REGISTER_METHOD(0x024599A0, int32_t, GetBytes, (app::Latin1Encoding * this_ptr, char16_t* chars, int32_t char_count, uint8_t* bytes, int32_t byte_count, app::EncoderNLS* encoder))
    ...
    IL2CPP_REGISTER_METHOD(0x02459E30, int32_t, GetChars, (app::Latin1Encoding * this_ptr, uint8_t* bytes, int32_t byte_count, char16_t* chars, int32_t char_count, app::DecoderNLS* decoder))

...
namespace app::classes::System::Text::Encoding_DefaultEncoder {
    ...
    IL2CPP_REGISTER_METHOD(0x02454810, int32_t, GetBytes_2, (app::Encoding_DefaultEncoder * this_ptr, char16_t* chars, int32_t char_count, uint8_t* bytes, int32_t byte_count, bool flush))
} // namespace app::classes::System::Text::Encoding_DefaultEncoder

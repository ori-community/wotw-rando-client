...
namespace app::classes::System::Text::StringBuilder {
    ...
    IL2CPP_REGISTER_METHOD(0x02460C50, void, ReplaceInPlaceAtChunk, (app::StringBuilder * this_ptr, app::StringBuilder** chunk, int32_t* index_in_chunk, char16_t* value, int32_t count))

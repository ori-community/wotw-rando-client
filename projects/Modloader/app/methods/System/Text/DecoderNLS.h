...
namespace app::classes::System::Text::DecoderNLS {
    ...
    IL2CPP_REGISTER_METHOD(0x0244AB40, int32_t, GetChars_3, (app::DecoderNLS * this_ptr, uint8_t* bytes, int32_t byte_count, char16_t* chars, int32_t char_count, bool flush))
    ...
    IL2CPP_REGISTER_METHOD(0x0244B030, void, Convert_2, (app::DecoderNLS * this_ptr, uint8_t* bytes, int32_t byte_count, char16_t* chars, int32_t char_count, bool flush, int32_t* bytes_used, int32_t* chars_used, bool* completed))

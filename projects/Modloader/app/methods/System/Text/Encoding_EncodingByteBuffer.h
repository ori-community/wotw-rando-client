...
namespace app::classes::System::Text::Encoding_EncodingByteBuffer {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::Encoding_EncodingByteBuffer* this_ptr,
        app::Encoding* in_encoding,
        app::EncoderNLS* in_encoder,
        uint8_t* in_byte_start,
        int32_t in_byte_count,
        char16_t* in_char_start,
        int32_t in_char_count
    )

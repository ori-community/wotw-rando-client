...
namespace app::classes::System::Text::Encoding_EncodingByteBuffer {
    IL2CPP_REGISTER_METHOD(0x02454840, void, ctor, (app::Encoding_EncodingByteBuffer * this_ptr, app::Encoding* in_encoding, app::EncoderNLS* in_encoder, uint8_t* in_byte_start, int32_t in_byte_count, char16_t* in_char_start, int32_t in_char_count))
    ...
    IL2CPP_REGISTER_METHOD(0x02454E40, char16_t, GetNextChar, (app::Encoding_EncodingByteBuffer * this_ptr))

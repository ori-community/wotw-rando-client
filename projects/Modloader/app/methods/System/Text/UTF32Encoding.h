...
namespace app::classes::System::Text::UTF32Encoding {
    ...
    IL2CPP_REGISTER_METHOD(0x027C8450, int32_t, GetBytes_3, (app::UTF32Encoding * this_ptr, char16_t* chars, int32_t char_count, uint8_t* bytes, int32_t byte_count))
    ...
    IL2CPP_REGISTER_METHOD(0x027C8B80, int32_t, GetChars_2, (app::UTF32Encoding * this_ptr, uint8_t* bytes, int32_t byte_count, char16_t* chars, int32_t char_count))
    ...
    IL2CPP_REGISTER_METHOD(0x027C92C0, int32_t, GetBytes_4, (app::UTF32Encoding * this_ptr, char16_t* chars, int32_t char_count, uint8_t* bytes, int32_t byte_count, app::EncoderNLS* encoder))
    ...
    IL2CPP_REGISTER_METHOD(0x027C9D30, int32_t, GetChars_3, (app::UTF32Encoding * this_ptr, uint8_t* bytes, int32_t byte_count, char16_t* chars, int32_t char_count, app::DecoderNLS* base_decoder))

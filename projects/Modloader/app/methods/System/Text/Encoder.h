...
namespace app::classes::System::Text::Encoder {
    ...
    IL2CPP_REGISTER_METHOD(0x0244BC00, int32_t, GetBytes, (app::Encoder * this_ptr, char16_t* chars, int32_t char_count, uint8_t* bytes, int32_t byte_count, bool flush))
    ...
    IL2CPP_REGISTER_METHOD(0x0244C200, void, Convert_2, (app::Encoder * this_ptr, char16_t* chars, int32_t char_count, uint8_t* bytes, int32_t byte_count, bool flush, int32_t* chars_used, int32_t* bytes_used, bool* completed))
} // namespace app::classes::System::Text::Encoder

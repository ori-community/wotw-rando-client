...
namespace app::classes::System::Text::Encoding_DefaultDecoder {
    ...
    IL2CPP_REGISTER_METHOD(0x024542E0, int32_t, GetChars_3, (app::Encoding_DefaultDecoder * this_ptr, uint8_t* bytes, int32_t byte_count, char16_t* chars, int32_t char_count, bool flush))
} // namespace app::classes::System::Text::Encoding_DefaultDecoder

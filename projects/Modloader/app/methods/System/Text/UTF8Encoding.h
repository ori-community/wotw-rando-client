...
namespace app::classes::System::Text::UTF8Encoding {
    ...
    IL2CPP_REGISTER_METHOD(0x027CEF40, int32_t, GetBytes_3, (app::UTF8Encoding * this_ptr, char16_t* chars, int32_t char_count, uint8_t* bytes, int32_t byte_count))
    ...
    IL2CPP_REGISTER_METHOD(0x027CF670, int32_t, GetChars_2, (app::UTF8Encoding * this_ptr, uint8_t* bytes, int32_t byte_count, char16_t* chars, int32_t char_count))
    ...
    IL2CPP_REGISTER_METHOD(0x027D0100, int32_t, GetBytes_4, (app::UTF8Encoding * this_ptr, char16_t* chars, int32_t char_count, uint8_t* bytes, int32_t byte_count, app::EncoderNLS* base_encoder))
    ...
    IL2CPP_REGISTER_METHOD(0x027D0FA0, int32_t, GetChars_3, (app::UTF8Encoding * this_ptr, uint8_t* bytes, int32_t byte_count, char16_t* chars, int32_t char_count, app::DecoderNLS* base_decoder))
    IL2CPP_REGISTER_METHOD(0x027D1A10, bool, FallbackInvalidByteSequence_1, (app::UTF8Encoding * this_ptr, app::uint8_t** p_src, int32_t ch, app::DecoderFallbackBuffer* fallback, app::char16_t** p_target))

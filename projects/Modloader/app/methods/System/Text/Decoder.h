...
namespace app::classes::System::Text::Decoder {
    ...
    IL2CPP_REGISTER_METHOD(0x02448500, int32_t, GetChars_2, (app::Decoder * this_ptr, uint8_t* bytes, int32_t byte_count, char16_t* chars, int32_t char_count, bool flush))
    ...
    IL2CPP_REGISTER_METHOD(0x02448B00, void, Convert_2, (app::Decoder * this_ptr, uint8_t* bytes, int32_t byte_count, char16_t* chars, int32_t char_count, bool flush, int32_t* bytes_used, int32_t* chars_used, bool* completed))
} // namespace app::classes::System::Text::Decoder

...
namespace app::classes::System::Tuple_4_Object_Object_Int32_Int32_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02A6CB20, void, ctor, (app::Tuple_4_Object_Object_Int32_Int32_ * this_ptr, app::Object* item1, app::Object* item2, int32_t item3, int32_t item4))
    IL2CPP_REGISTER_METHOD(0x02A6CB50, bool, Equals, (app::Tuple_4_Object_Object_Int32_Int32_ * this_ptr, app::Object* obj))
    IL2CPP_REGISTER_METHOD(0x02A6CC30, bool, IStructuralEquatable_Equals, (app::Tuple_4_Object_Object_Int32_Int32_ * this_ptr, app::Object* other, app::IEqualityComparer* comparer))
    ...
    IL2CPP_REGISTER_METHOD(0x02A6CF60, int32_t, IStructuralComparable_CompareTo, (app::Tuple_4_Object_Object_Int32_Int32_ * this_ptr, app::Object* other, app::IComparer* comparer))
    IL2CPP_REGISTER_METHODINFO(0x04701C28, Tuple_4_Object_Object_Int32_Int32__System_Collections_IStructuralComparable_CompareTo__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02A6D230, int32_t, GetHashCode, (app::Tuple_4_Object_Object_Int32_Int32_ * this_ptr))
    IL2CPP_REGISTER_METHOD(0x02A6D300, int32_t, IStructuralEquatable_GetHashCode, (app::Tuple_4_Object_Object_Int32_Int32_ * this_ptr, app::IEqualityComparer* comparer))

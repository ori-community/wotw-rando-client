...
namespace app::classes::System::Configuration::LocalFileSettingsProvider {
    ...
    IL2CPP_REGISTER_METHOD(
        0x02961DB0,
        app::SettingsPropertyValue*,
        GetPreviousVersion,
        app::LocalFileSettingsProvider* this_ptr,
        app::SettingsContext* context,
        app::SettingsProperty* property
    )
    IL2CPP_REGISTER_METHOD(
        0x02961DE0,
        app::SettingsPropertyValueCollection*,
        GetPropertyValues,
        app::LocalFileSettingsProvider* this_ptr,
        app::SettingsContext* context,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::LocalFileSettingsProvider* this_ptr,
        app::SettingsContext* context,
        app::SettingsPropertyValueCollection* values
    )
    IL2CPP_REGISTER_METHOD(
        0x02961EA0,
        void,

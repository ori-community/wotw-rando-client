...
namespace app::classes::System::Configuration::SettingsProperty {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_3,
        app::SettingsProperty* this_ptr,
        app::String* name,
        app::Type* property_type,
        app::SettingsProvider* provider,
        bool is_read_only,
        app::Object* default_value,
        app::SettingsSerializeAs__Enum serialize_as,
        app::SettingsAttributeDictionary* attributes,
        bool throw_on_error_deserializing,
        bool throw_on_error_serializing
    )

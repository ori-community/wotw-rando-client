...
namespace app::classes::System::Array_EmptyInternalEnumerator_1_PreRecordingDynamicSceneObjectEntry_ {
    ...
    IL2CPP_REGISTER_METHOD(0x01D07CD0, app::PreRecordingDynamicSceneObjectEntry, get_Current, (app::Array_EmptyInternalEnumerator_1_PreRecordingDynamicSceneObjectEntry_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047576C0, Array_EmptyInternalEnumerator_1_PreRecordingDynamicSceneObjectEntry__get_Current__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x01CFED80, app::Object*, IEnumerator_get_Current, (app::Array_EmptyInternalEnumerator_1_PreRecordingDynamicSceneObjectEntry_ * this_ptr))

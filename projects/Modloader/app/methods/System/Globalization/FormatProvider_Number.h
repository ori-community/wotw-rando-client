...
namespace app::classes::System::Globalization::FormatProvider_Number {
    ...
    IL2CPP_REGISTER_METHOD(0x030F54C0, bool, ParseNumber, (app::char16_t** str, app::NumberStyles__Enum options, app::FormatProvider_Number_NumberBuffer* number, app::StringBuilder* sb, app::NumberFormatInfo* numfmt, bool parse_decimal))
    ...
    IL2CPP_REGISTER_METHOD(0x030F6170, app::String*, NumberToString, (app::FormatProvider_Number_NumberBuffer number, char16_t format, int32_t n_max_digits, app::NumberFormatInfo* info, bool is_decimal))
    ...
    IL2CPP_REGISTER_METHOD(0x030F7310, void, FormatScientific, (app::StringBuilder * sb, app::FormatProvider_Number_NumberBuffer number, int32_t n_min_digits, int32_t n_max_digits, app::NumberFormatInfo* info, char16_t exp_char))
    IL2CPP_REGISTER_METHOD(0x030F74C0, void, FormatExponent, (app::StringBuilder * sb, app::NumberFormatInfo* info, int32_t value, char16_t exp_char, int32_t min_digits, bool positive_sign))
    IL2CPP_REGISTER_METHOD(0x030F77A0, void, FormatGeneral, (app::StringBuilder * sb, app::FormatProvider_Number_NumberBuffer number, int32_t n_min_digits, int32_t n_max_digits, app::NumberFormatInfo* info, char16_t exp_char, bool b_suppress_scientific))

...
namespace app::classes::System::Globalization::TimeSpanParse {
    IL2CPP_REGISTER_METHOD(
        ...
        TryTimeToTicks,
        bool positive,
        app::TimeSpanParse_TimeSpanToken days,
        app::TimeSpanParse_TimeSpanToken hours,
        app::TimeSpanParse_TimeSpanToken minutes,
        app::TimeSpanParse_TimeSpanToken seconds,
        app::TimeSpanParse_TimeSpanToken fraction,
        int64_t* result
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        TryParseTimeSpan,
        app::String* input,
        app::TimeSpanParse_TimeSpanStandardStyles__Enum style,
        app::IFormatProvider* format_provider,
        app::TimeSpanParse_TimeSpanResult* result
    )
    IL2CPP_REGISTER_METHOD(
        0x01DF27C0,
        bool,
        ProcessTerminalState,
        app::TimeSpanParse_TimeSpanRawInfo* raw,
        app::TimeSpanParse_TimeSpanStandardStyles__Enum style,
        app::TimeSpanParse_TimeSpanResult* result
    )
    IL2CPP_REGISTER_METHOD(

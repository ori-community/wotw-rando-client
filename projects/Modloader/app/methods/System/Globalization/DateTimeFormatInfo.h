...
namespace app::classes::System::Globalization::DateTimeFormatInfo {
    ...
    IL2CPP_REGISTER_METHOD(0x025FCD70, void, InitializeOverridableProperties, (app::DateTimeFormatInfo * this_ptr, app::CultureData* culture_data, int32_t calendar_i_d))
    ...
    IL2CPP_REGISTER_METHOD(0x025FFEC0, app::String*, internalGetMonthName, (app::DateTimeFormatInfo * this_ptr, int32_t month, app::MonthNameStyles__Enum style, bool abbreviated))
    ...
    IL2CPP_REGISTER_METHOD(0x026003C0, app::String__Array*, GetCombinedPatterns, (app::String__Array * patterns1, app::String__Array* patterns2, app::String* connect_string))
    ...
    IL2CPP_REGISTER_METHOD(0x026046D0, bool, Tokenize, (app::DateTimeFormatInfo * this_ptr, app::TokenType__Enum token_mask, app::TokenType__Enum* token_type, int32_t* token_value, app::_DTString* str))
    IL2CPP_REGISTER_METHOD(0x02604BD0, void, InsertAtCurrentHashNode, (app::DateTimeFormatInfo * this_ptr, app::TokenHashValue__Array* hash_table, app::String* str, char16_t ch, app::TokenType__Enum token_type, int32_t token_value, int32_t pos, int32_t hashcode, int32_t hash_probe))
    IL2CPP_REGISTER_METHOD(0x02604ED0, void, InsertHash, (app::DateTimeFormatInfo * this_ptr, app::TokenHashValue__Array* hash_table, app::String* str, app::TokenType__Enum token_type, int32_t token_value))

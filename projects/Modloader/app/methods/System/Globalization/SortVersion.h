...
namespace app::classes::System::Globalization::SortVersion {
    ...
    inline bool operator==(app::SortVersion& left, app::SortVersion& right) { return op_Equality(&left, &right); }
    inline bool operator!=(app::SortVersion& left, app::SortVersion& right) { return op_Inequality(&left, &right); }
} // namespace app::classes::System::Globalization::SortVersion

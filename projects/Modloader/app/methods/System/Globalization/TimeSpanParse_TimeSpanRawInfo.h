...
namespace app::classes::System::Globalization::TimeSpanParse_TimeSpanRawInfo {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        bool,
        FullAppCompatMatch,
        app::TimeSpanParse_TimeSpanRawInfo__Boxed* this_ptr,
        app::TimeSpanFormat_FormatLiterals pattern
    )
    IL2CPP_REGISTER_METHOD(
        0x001D3DD0,
        bool,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ProcessToken,
        app::TimeSpanParse_TimeSpanRawInfo__Boxed* this_ptr,
        app::TimeSpanParse_TimeSpanToken* tok,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        AddNum,
        app::TimeSpanParse_TimeSpanRawInfo__Boxed* this_ptr,
        app::TimeSpanParse_TimeSpanToken num,
        app::TimeSpanParse_TimeSpanResult* result
    )
} // namespace app::classes::System::Globalization::TimeSpanParse_TimeSpanRawInfo

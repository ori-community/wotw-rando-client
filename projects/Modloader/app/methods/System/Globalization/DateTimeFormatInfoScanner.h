...
namespace app::classes::System::Globalization::DateTimeFormatInfoScanner {
    ...
    IL2CPP_REGISTER_METHOD(0x02606A60, app::FORMATFLAGS__Enum, GetFormatFlagGenitiveMonth, (app::String__Array * month_names, app::String__Array* genitve_month_names, app::String__Array* abbrev_month_names, app::String__Array* genetive_abbrev_month_names))
    IL2CPP_REGISTER_METHOD(0x02606AB0, app::FORMATFLAGS__Enum, GetFormatFlagUseSpaceInMonthNames, (app::String__Array * month_names, app::String__Array* genitve_month_names, app::String__Array* abbrev_month_names, app::String__Array* genetive_abbrev_month_names))
    IL2CPP_REGISTER_METHOD(0x02606B70, app::FORMATFLAGS__Enum, GetFormatFlagUseSpaceInDayNames, (app::String__Array * day_names, app::String__Array* abbrev_day_names))

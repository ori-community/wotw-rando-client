...
namespace app::classes::System::Action_1_Moon_Vitals_DamageProcessHelper_DamageBucket_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Invoke,
        app::Action_1_Moon_Vitals_DamageProcessHelper_DamageBucket_* this_ptr,

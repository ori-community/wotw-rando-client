...
namespace app::classes::System::__DTString {
    ...
    IL2CPP_REGISTER_METHOD(0x0024A0A0, app::TokenType__Enum, GetSeparatorToken, (app::_DTString__Boxed * this_ptr, app::DateTimeFormatInfo* dtfi, int32_t* index_before_separator, char16_t* char_before_separator))

...
namespace app::classes::System::Array_InternalEnumerator_1_PreRecordingInstantiationEntry_ {
    ...
    IL2CPP_REGISTER_METHOD(0x001AF460, app::PreRecordingInstantiationEntry, get_Current, (app::Array_InternalEnumerator_1_PreRecordingInstantiationEntry___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0476E678, Array_InternalEnumerator_1_PreRecordingInstantiationEntry__get_Current__MethodInfo)

...
namespace app::classes::System::Number {
    ...
    IL2CPP_REGISTER_METHOD(0x02270750, uint16_t*, MatchChars_1, (uint16_t * p, app::String* str))
    IL2CPP_REGISTER_METHOD(0x022707A0, uint16_t*, MatchChars_2, (uint16_t * p, uint16_t* str))

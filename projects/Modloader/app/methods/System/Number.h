...
namespace app::classes::System::Number {
    ...
    IL2CPP_REGISTER_METHOD(0x022711F0, bool, ParseNumber, (app::char16_t** str, app::NumberStyles__Enum options, app::Number_NumberBuffer* number, app::StringBuilder* sb, app::NumberFormatInfo* numfmt, bool parse_decimal))

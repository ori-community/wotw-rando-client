...
namespace app::classes::System::DateTimeFormat {
    ...
    IL2CPP_REGISTER_METHOD(0x028A6FB0, int32_t, ParseRepeatPattern, (app::String * format, int32_t pos, uint16_t pattern_char))
    ...
    IL2CPP_REGISTER_METHOD(0x028A73F0, bool, IsUseGenitiveForm, (app::String * format, int32_t index, int32_t token_len, uint16_t pattern_to_match))
    ...
    IL2CPP_REGISTER_METHOD(0x028A9EE0, app::String__Array*, GetAllDateTimes_1, (app::DateTime date_time, uint16_t format, app::DateTimeFormatInfo* dtfi))

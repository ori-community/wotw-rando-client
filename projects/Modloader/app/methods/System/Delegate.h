...
namespace app::classes::System::Delegate {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Type* type,
        app::Object* target,
        app::MethodInfo_1* info,
        bool throw_on_bind_failure
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::RuntimeType* type,
        app::Object* first_argument,
        app::MethodInfo_1* method_1
    )
    IL2CPP_REGISTER_METHOD(0x017400C0, app::MulticastDelegate*, AllocDelegateLike_internal, app::Delegate* d)
    inline bool operator==(app::Delegate& d1, app::Delegate& d2) { return op_Equality(&d1, &d2); }
} // namespace app::classes::System::Delegate

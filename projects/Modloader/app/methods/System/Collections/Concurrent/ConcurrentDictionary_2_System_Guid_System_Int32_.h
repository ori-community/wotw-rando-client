...
namespace app::classes::System::Collections::Concurrent::ConcurrentDictionary_2_System_Guid_System_Int32_ {
    ...
    IL2CPP_REGISTER_METHOD(
        0x02AE5130,
        app::KeyValuePair_2_System_Guid_System_Int32___Array*,
        ToArray,
        app::ConcurrentDictionary_2_System_Guid_System_Int32_* this_ptr
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::ConcurrentDictionary_2_System_Guid_System_Int32_* this_ptr,
        app::KeyValuePair_2_System_Guid_System_Int32___Array* array,
        int32_t index
    )
    IL2CPP_REGISTER_METHOD(
        0x02AE5410,
    ...
    IL2CPP_REGISTER_METHOD(
        0x02AE57F0,
        app::IEnumerator_1_KeyValuePair_2_System_Guid_System_Int32_*,
        GetEnumerator,
        app::ConcurrentDictionary_2_System_Guid_System_Int32_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::ConcurrentDictionary_2_System_Guid_System_Int32_* this_ptr,
        app::Guid key,
        app::Func_2_Guid_Int32_* value_factory
    )
    IL2CPP_REGISTER_METHOD(
        0x02AE6A80,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::ConcurrentDictionary_2_System_Guid_System_Int32_* this_ptr,
        app::KeyValuePair_2_System_Guid_System_Int32_ key_value_pair
    )
    IL2CPP_REGISTER_METHOD(
        0x02AE6C40,
        bool,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        GrowTable,
        app::ConcurrentDictionary_2_System_Guid_System_Int32_* this_ptr,
        app::ConcurrentDictionary_2_TKey_TValue_Tables_System_Guid_System_Int32_* tables
    )

...
namespace app::classes::System::Collections::ObjectModel::ReadOnlyCollection_1_LightCanvasEditorTextureCache_LightCanvasEditorTextureData_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::ReadOnlyCollection_1_LightCanvasEditorTextureCache_LightCanvasEditorTextureData_* this_ptr,
        app::IList_1_LightCanvasEditorTextureCache_LightCanvasEditorTextureData_* list
    )

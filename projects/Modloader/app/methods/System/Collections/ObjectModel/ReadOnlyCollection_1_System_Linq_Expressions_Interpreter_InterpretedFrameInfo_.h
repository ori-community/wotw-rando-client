...
namespace app::classes::System::Collections::ObjectModel::ReadOnlyCollection_1_System_Linq_Expressions_Interpreter_InterpretedFrameInfo_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::ReadOnlyCollection_1_System_Linq_Expressions_Interpreter_InterpretedFrameInfo_* this_ptr,
        app::IList_1_System_Linq_Expressions_Interpreter_InterpretedFrameInfo_* list
    )

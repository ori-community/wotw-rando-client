...
namespace app::classes::System::Collections::ObjectModel::ReadOnlyCollection_1_UnityEngine_EventSystems_RaycastResult_ {
    IL2CPP_REGISTER_METHOD(0x02B7DCF0, void, ctor, (app::ReadOnlyCollection_1_UnityEngine_EventSystems_RaycastResult_ * this_ptr, app::IList_1_UnityEngine_EventSystems_RaycastResult_* list))
    ...
    IL2CPP_REGISTER_METHOD(0x02B7DEC0, void, CopyTo, (app::ReadOnlyCollection_1_UnityEngine_EventSystems_RaycastResult_ * this_ptr, app::RaycastResult__Array* array, int32_t index))
    IL2CPP_REGISTER_METHOD(0x02B7DF30, app::IEnumerator_1_UnityEngine_EventSystems_RaycastResult_*, GetEnumerator, (app::ReadOnlyCollection_1_UnityEngine_EventSystems_RaycastResult_ * this_ptr))
    ...
    IL2CPP_REGISTER_METHOD(0x003FFDF0, bool, System_Collections_Generic_ICollection_T__get_IsReadOnly, (app::ReadOnlyCollection_1_UnityEngine_EventSystems_RaycastResult_ * this_ptr))
    IL2CPP_REGISTER_METHOD(0x02ECC140, app::RaycastResult, System_Collections_Generic_IList_T__get_Item, (app::ReadOnlyCollection_1_UnityEngine_EventSystems_RaycastResult_ * this_ptr, int32_t index))
    IL2CPP_REGISTER_METHOD(0x02B7E070, void, System_Collections_Generic_IList_T__set_Item, (app::ReadOnlyCollection_1_UnityEngine_EventSystems_RaycastResult_ * this_ptr, int32_t index, app::RaycastResult value))
    IL2CPP_REGISTER_METHOD(0x02B7E070, void, System_Collections_Generic_ICollection_T__Add, (app::ReadOnlyCollection_1_UnityEngine_EventSystems_RaycastResult_ * this_ptr, app::RaycastResult value))
    IL2CPP_REGISTER_METHOD(0x02B7E070, void, System_Collections_Generic_ICollection_T__Clear, (app::ReadOnlyCollection_1_UnityEngine_EventSystems_RaycastResult_ * this_ptr))
    IL2CPP_REGISTER_METHOD(0x02B7E070, void, System_Collections_Generic_IList_T__Insert, (app::ReadOnlyCollection_1_UnityEngine_EventSystems_RaycastResult_ * this_ptr, int32_t index, app::RaycastResult value))
    IL2CPP_REGISTER_METHOD(0x02B7E070, bool, System_Collections_Generic_ICollection_T__Remove, (app::ReadOnlyCollection_1_UnityEngine_EventSystems_RaycastResult_ * this_ptr, app::RaycastResult value))
    IL2CPP_REGISTER_METHOD(0x02B7E070, void, System_Collections_Generic_IList_T__RemoveAt, (app::ReadOnlyCollection_1_UnityEngine_EventSystems_RaycastResult_ * this_ptr, int32_t index))
    IL2CPP_REGISTER_METHOD(0x02ECC380, app::IEnumerator*, IEnumerable_GetEnumerator, (app::ReadOnlyCollection_1_UnityEngine_EventSystems_RaycastResult_ * this_ptr))
    ...
    IL2CPP_REGISTER_METHOD(0x02ECC5A0, void, ICollection_CopyTo, (app::ReadOnlyCollection_1_UnityEngine_EventSystems_RaycastResult_ * this_ptr, app::Array* array, int32_t index))
    ...
    IL2CPP_REGISTER_METHOD(0x02B7E070, void, IList_set_Item, (app::ReadOnlyCollection_1_UnityEngine_EventSystems_RaycastResult_ * this_ptr, int32_t index, app::Object* value))
    ...
    IL2CPP_REGISTER_METHOD(0x02B7E070, void, IList_Insert, (app::ReadOnlyCollection_1_UnityEngine_EventSystems_RaycastResult_ * this_ptr, int32_t index, app::Object* value))

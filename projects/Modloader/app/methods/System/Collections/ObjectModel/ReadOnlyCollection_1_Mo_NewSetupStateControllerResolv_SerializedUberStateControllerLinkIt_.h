...
namespace app::classes::System::Collections::ObjectModel::ReadOnlyCollection_1_Moon_NewSetupStateControllerResolver_SerializedUberStateControllerLinkItem_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::ReadOnlyCollection_1_Moon_NewSetupStateControllerResolver_SerializedUberStateControllerLinkItem_* this_ptr,
        app::IList_1_Moon_NewSetupStateControllerResolver_SerializedUberStateControllerLinkItem_* list
    )
    IL2CPP_REGISTER_METHOD(
        0x02B7DD20,
        int32_t,

...
namespace app::classes::System::Collections::ObjectModel::ReadOnlyCollection_1_Moon_IExternallyModifiableUberState_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::ReadOnlyCollection_1_Moon_IExternallyModifiableUberState_* this_ptr,
        app::IList_1_Moon_IExternallyModifiableUberState_* list
    )
    IL2CPP_REGISTER_METHOD(
        0x02EC2580,
        app::IExternallyModifiableUberState*,
        get_Item,
        app::ReadOnlyCollection_1_Moon_IExternallyModifiableUberState_* this_ptr,
        int32_t index
    )

...
namespace app::classes::System::Collections::ObjectModel::Collection_1_Newtonsoft_Json_Serialization_JsonProperty_ {
    IL2CPP_REGISTER_METHOD(
        0x02B833F0,
        app::IEnumerator_1_Newtonsoft_Json_Serialization_JsonProperty_*,
        GetEnumerator,
        app::Collection_1_Newtonsoft_Json_Serialization_JsonProperty_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x002FA280,

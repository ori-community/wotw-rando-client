...
namespace app::classes::System::Collections::ObjectModel::ReadOnlyCollection_1_System_ValueTuple_4_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02B7EA90, app::ValueTuple_4_Object_Int32_Int32_Single_, get_Item, (app::ReadOnlyCollection_1_System_ValueTuple_4_ * this_ptr, int32_t index))
    IL2CPP_REGISTER_METHOD(0x02B7EB70, bool, Contains, (app::ReadOnlyCollection_1_System_ValueTuple_4_ * this_ptr, app::ValueTuple_4_Object_Int32_Int32_Single_ value))
    IL2CPP_REGISTER_METHOD(0x02B7DEC0, void, CopyTo, (app::ReadOnlyCollection_1_System_ValueTuple_4_ * this_ptr, app::ValueTuple_4_Object_Int32_Int32_Single___Array* array, int32_t index))
    ...
    IL2CPP_REGISTER_METHOD(0x02B7EBE0, int32_t, IndexOf, (app::ReadOnlyCollection_1_System_ValueTuple_4_ * this_ptr, app::ValueTuple_4_Object_Int32_Int32_Single_ value))
    ...
    IL2CPP_REGISTER_METHOD(0x02B7EA90, app::ValueTuple_4_Object_Int32_Int32_Single_, System_Collections_Generic_IList_T__get_Item, (app::ReadOnlyCollection_1_System_ValueTuple_4_ * this_ptr, int32_t index))
    IL2CPP_REGISTER_METHOD(0x02B7E070, void, System_Collections_Generic_IList_T__set_Item, (app::ReadOnlyCollection_1_System_ValueTuple_4_ * this_ptr, int32_t index, app::ValueTuple_4_Object_Int32_Int32_Single_ value))
    IL2CPP_REGISTER_METHOD(0x02B7E070, void, System_Collections_Generic_ICollection_T__Add, (app::ReadOnlyCollection_1_System_ValueTuple_4_ * this_ptr, app::ValueTuple_4_Object_Int32_Int32_Single_ value))
    ...
    IL2CPP_REGISTER_METHOD(0x02B7E070, void, System_Collections_Generic_IList_T__Insert, (app::ReadOnlyCollection_1_System_ValueTuple_4_ * this_ptr, int32_t index, app::ValueTuple_4_Object_Int32_Int32_Single_ value))
    IL2CPP_REGISTER_METHOD(0x02B7E070, bool, System_Collections_Generic_ICollection_T__Remove, (app::ReadOnlyCollection_1_System_ValueTuple_4_ * this_ptr, app::ValueTuple_4_Object_Int32_Int32_Single_ value))
    IL2CPP_REGISTER_METHOD(0x02B7E070, void, System_Collections_Generic_IList_T__RemoveAt, (app::ReadOnlyCollection_1_System_ValueTuple_4_ * this_ptr, int32_t index))

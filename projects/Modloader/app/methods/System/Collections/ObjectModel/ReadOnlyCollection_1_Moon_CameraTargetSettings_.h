...
namespace app::classes::System::Collections::ObjectModel::ReadOnlyCollection_1_Moon_CameraTargetSettings_ {
    IL2CPP_REGISTER_METHOD(0x02B7DCF0, void, ctor, (app::ReadOnlyCollection_1_Moon_CameraTargetSettings_ * this_ptr, app::IList_1_Moon_CameraTargetSettings_* list))
    ...
    IL2CPP_REGISTER_METHOD(0x02B7DEC0, void, CopyTo, (app::ReadOnlyCollection_1_Moon_CameraTargetSettings_ * this_ptr, app::CameraTargetSettings__Array* array, int32_t index))
    IL2CPP_REGISTER_METHOD(0x02B7DF30, app::IEnumerator_1_Moon_CameraTargetSettings_*, GetEnumerator, (app::ReadOnlyCollection_1_Moon_CameraTargetSettings_ * this_ptr))
    ...
    IL2CPP_REGISTER_METHOD(0x003FFDF0, bool, System_Collections_Generic_ICollection_T__get_IsReadOnly, (app::ReadOnlyCollection_1_Moon_CameraTargetSettings_ * this_ptr))
    IL2CPP_REGISTER_METHOD(0x02B7DD70, app::CameraTargetSettings, System_Collections_Generic_IList_T__get_Item, (app::ReadOnlyCollection_1_Moon_CameraTargetSettings_ * this_ptr, int32_t index))
    IL2CPP_REGISTER_METHOD(0x02B7E070, void, System_Collections_Generic_IList_T__set_Item, (app::ReadOnlyCollection_1_Moon_CameraTargetSettings_ * this_ptr, int32_t index, app::CameraTargetSettings value))
    IL2CPP_REGISTER_METHOD(0x02B7E070, void, System_Collections_Generic_ICollection_T__Add, (app::ReadOnlyCollection_1_Moon_CameraTargetSettings_ * this_ptr, app::CameraTargetSettings value))
    ...
    IL2CPP_REGISTER_METHOD(0x02B7E070, void, System_Collections_Generic_IList_T__Insert, (app::ReadOnlyCollection_1_Moon_CameraTargetSettings_ * this_ptr, int32_t index, app::CameraTargetSettings value))
    IL2CPP_REGISTER_METHOD(0x02B7E070, bool, System_Collections_Generic_ICollection_T__Remove, (app::ReadOnlyCollection_1_Moon_CameraTargetSettings_ * this_ptr, app::CameraTargetSettings value))
    IL2CPP_REGISTER_METHOD(0x02B7E070, void, System_Collections_Generic_IList_T__RemoveAt, (app::ReadOnlyCollection_1_Moon_CameraTargetSettings_ * this_ptr, int32_t index))
    ...
    IL2CPP_REGISTER_METHOD(0x02E3C6C0, void, ICollection_CopyTo, (app::ReadOnlyCollection_1_Moon_CameraTargetSettings_ * this_ptr, app::Array* array, int32_t index))

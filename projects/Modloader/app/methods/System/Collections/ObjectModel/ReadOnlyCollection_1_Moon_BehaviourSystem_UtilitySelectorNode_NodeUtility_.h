...
namespace app::classes::System::Collections::ObjectModel::ReadOnlyCollection_1_Moon_BehaviourSystem_UtilitySelectorNode_NodeUtility_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::ReadOnlyCollection_1_Moon_BehaviourSystem_UtilitySelectorNode_NodeUtility_* this_ptr,
        app::IList_1_Moon_BehaviourSystem_UtilitySelectorNode_NodeUtility_* list
    )

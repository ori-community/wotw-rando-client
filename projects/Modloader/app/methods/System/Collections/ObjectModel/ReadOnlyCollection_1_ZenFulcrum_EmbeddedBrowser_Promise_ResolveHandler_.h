...
namespace app::classes::System::Collections::ObjectModel::ReadOnlyCollection_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::ReadOnlyCollection_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_* this_ptr,
        app::IList_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_* list
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Contains,
        app::ReadOnlyCollection_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_* this_ptr,
        app::Promise_ResolveHandler value
    )
    IL2CPP_REGISTER_METHOD(
        0x02B7DEC0,
        void,
        CopyTo,
        app::ReadOnlyCollection_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_* this_ptr,
        app::Promise_ResolveHandler__Array* array,
        int32_t index
    )
    IL2CPP_REGISTER_METHOD(
        0x02B7DF30,
        app::IEnumerator_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_*,
        GetEnumerator,
        app::ReadOnlyCollection_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(

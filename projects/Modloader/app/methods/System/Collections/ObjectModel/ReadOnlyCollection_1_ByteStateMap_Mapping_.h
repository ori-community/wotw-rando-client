...
namespace app::classes::System::Collections::ObjectModel::ReadOnlyCollection_1_ByteStateMap_Mapping_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02B7DEC0, void, CopyTo, (app::ReadOnlyCollection_1_ByteStateMap_Mapping_ * this_ptr, app::ByteStateMap_Mapping__Array* array, int32_t index))
    ...
    IL2CPP_REGISTER_METHOD(0x003FFDF0, bool, System_Collections_Generic_ICollection_T__get_IsReadOnly, (app::ReadOnlyCollection_1_ByteStateMap_Mapping_ * this_ptr))
    IL2CPP_REGISTER_METHOD(0x02CFE3E0, app::ByteStateMap_Mapping, System_Collections_Generic_IList_T__get_Item, (app::ReadOnlyCollection_1_ByteStateMap_Mapping_ * this_ptr, int32_t index))
    IL2CPP_REGISTER_METHOD(0x02B7E070, void, System_Collections_Generic_IList_T__set_Item, (app::ReadOnlyCollection_1_ByteStateMap_Mapping_ * this_ptr, int32_t index, app::ByteStateMap_Mapping value))
    IL2CPP_REGISTER_METHOD(0x02B7E070, void, System_Collections_Generic_ICollection_T__Add, (app::ReadOnlyCollection_1_ByteStateMap_Mapping_ * this_ptr, app::ByteStateMap_Mapping value))
    ...
    IL2CPP_REGISTER_METHOD(0x02B7E070, void, System_Collections_Generic_IList_T__Insert, (app::ReadOnlyCollection_1_ByteStateMap_Mapping_ * this_ptr, int32_t index, app::ByteStateMap_Mapping value))
    IL2CPP_REGISTER_METHOD(0x02B7E070, bool, System_Collections_Generic_ICollection_T__Remove, (app::ReadOnlyCollection_1_ByteStateMap_Mapping_ * this_ptr, app::ByteStateMap_Mapping value))
    IL2CPP_REGISTER_METHOD(0x02B7E070, void, System_Collections_Generic_IList_T__RemoveAt, (app::ReadOnlyCollection_1_ByteStateMap_Mapping_ * this_ptr, int32_t index))

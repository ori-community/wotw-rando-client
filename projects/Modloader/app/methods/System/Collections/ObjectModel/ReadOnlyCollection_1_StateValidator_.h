...
namespace app::classes::System::Collections::ObjectModel::ReadOnlyCollection_1_StateValidator_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02B7EA90, app::StateValidator, System_Collections_Generic_IList_T__get_Item, (app::ReadOnlyCollection_1_StateValidator_ * this_ptr, int32_t index))
    IL2CPP_REGISTER_METHOD(0x02B7E070, void, System_Collections_Generic_IList_T__set_Item, (app::ReadOnlyCollection_1_StateValidator_ * this_ptr, int32_t index, app::StateValidator value))
    IL2CPP_REGISTER_METHOD(0x02B7E070, void, System_Collections_Generic_ICollection_T__Add, (app::ReadOnlyCollection_1_StateValidator_ * this_ptr, app::StateValidator value))
    ...
    IL2CPP_REGISTER_METHOD(0x02B7E070, void, System_Collections_Generic_IList_T__Insert, (app::ReadOnlyCollection_1_StateValidator_ * this_ptr, int32_t index, app::StateValidator value))
    IL2CPP_REGISTER_METHOD(0x02B7E070, bool, System_Collections_Generic_ICollection_T__Remove, (app::ReadOnlyCollection_1_StateValidator_ * this_ptr, app::StateValidator value))

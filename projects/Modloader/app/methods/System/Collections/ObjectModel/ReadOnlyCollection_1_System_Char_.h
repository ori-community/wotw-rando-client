...
namespace app::classes::System::Collections::ObjectModel::ReadOnlyCollection_1_System_Char_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02CFE3E0, uint16_t, get_Item, (app::ReadOnlyCollection_1_System_Char_ * this_ptr, int32_t index))
    IL2CPP_REGISTER_METHOD(0x02EC3C40, bool, Contains, (app::ReadOnlyCollection_1_System_Char_ * this_ptr, uint16_t value))
    ...
    IL2CPP_REGISTER_METHOD(0x02EC3CB0, int32_t, IndexOf, (app::ReadOnlyCollection_1_System_Char_ * this_ptr, uint16_t value))
    ...
    IL2CPP_REGISTER_METHOD(0x02CFE3E0, uint16_t, System_Collections_Generic_IList_T__get_Item, (app::ReadOnlyCollection_1_System_Char_ * this_ptr, int32_t index))
    IL2CPP_REGISTER_METHOD(0x02B7E070, void, System_Collections_Generic_IList_T__set_Item, (app::ReadOnlyCollection_1_System_Char_ * this_ptr, int32_t index, uint16_t value))
    IL2CPP_REGISTER_METHOD(0x02B7E070, void, System_Collections_Generic_ICollection_T__Add, (app::ReadOnlyCollection_1_System_Char_ * this_ptr, uint16_t value))
    ...
    IL2CPP_REGISTER_METHOD(0x02B7E070, void, System_Collections_Generic_IList_T__Insert, (app::ReadOnlyCollection_1_System_Char_ * this_ptr, int32_t index, uint16_t value))
    IL2CPP_REGISTER_METHOD(0x02B7E070, bool, System_Collections_Generic_ICollection_T__Remove, (app::ReadOnlyCollection_1_System_Char_ * this_ptr, uint16_t value))

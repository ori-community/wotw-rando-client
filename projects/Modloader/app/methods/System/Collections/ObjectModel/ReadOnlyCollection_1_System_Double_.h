...
namespace app::classes::System::Collections::ObjectModel::ReadOnlyCollection_1_System_Double_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02B7E070, void, System_Collections_Generic_IList_T__set_Item, (app::ReadOnlyCollection_1_System_Double_ * this_ptr, int32_t index, double value))
    ...
    IL2CPP_REGISTER_METHOD(0x02B7E070, void, System_Collections_Generic_IList_T__Insert, (app::ReadOnlyCollection_1_System_Double_ * this_ptr, int32_t index, double value))

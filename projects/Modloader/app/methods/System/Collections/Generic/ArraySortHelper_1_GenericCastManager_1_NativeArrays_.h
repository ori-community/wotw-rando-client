...
namespace app::classes::System::Collections::Generic::ArraySortHelper_1_GenericCastManager_1_NativeArrays_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Sort_1,
        app::GenericCastManager_1_Command_NativeArrays_UnityEngine_CapsulecastCommand___Array* keys,
        int32_t index,
        int32_t length,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t index,
        int32_t length,
        app::Comparison_1_GenericCastManager_1_NativeArrays_* comparer
    )
    IL2CPP_REGISTER_METHOD(
        0x02F31D30,
        int32_t,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Swap_1,
        app::GenericCastManager_1_Command_NativeArrays_UnityEngine_CapsulecastCommand___Array* a,
        int32_t i,
        int32_t j
    )
    IL2CPP_REGISTER_METHOD(
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Sort_3,
        app::GenericCastManager_1_Command_NativeArrays_UnityEngine_RaycastCommand___Array* keys,
        int32_t index,
        int32_t length,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t index,
        int32_t length,
        app::Comparison_1_GenericCastManager_1_NativeArrays__1* comparer
    )
    IL2CPP_REGISTER_METHOD(
        0x02F31D30,
        int32_t,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Sort_5,
        app::GenericCastManager_1_Command_NativeArrays_UnityEngine_SpherecastCommand___Array* keys,
        int32_t index,
        int32_t length,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t index,
        int32_t length,
        app::Comparison_1_GenericCastManager_1_NativeArrays__2* comparer
    )
    IL2CPP_REGISTER_METHOD(
        0x02F31D30,
        int32_t,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Swap_3,
        app::GenericCastManager_1_Command_NativeArrays_UnityEngine_SpherecastCommand___Array* a,
        int32_t i,
        int32_t j
    )
    IL2CPP_REGISTER_METHOD(

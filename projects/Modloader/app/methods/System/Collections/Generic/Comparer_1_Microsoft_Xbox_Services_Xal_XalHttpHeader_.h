...
namespace app::classes::System::Collections::Generic::Comparer_1_Microsoft_Xbox_Services_Xal_XalHttpHeader_ {
    ...
    IL2CPP_REGISTER_METHOD(0x0280C510, app::Comparer_1_Microsoft_Xbox_Services_Xal_XalHttpHeader_*, Create, (app::Comparison_1_Microsoft_Xbox_Services_Xal_XalHttpHeader_ * comparison))
    IL2CPP_REGISTER_METHODINFO(0x047546C0, Comparer_1_Microsoft_Xbox_Services_Xal_XalHttpHeader__Create__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x0280C710, app::Comparer_1_Microsoft_Xbox_Services_Xal_XalHttpHeader_*, CreateComparer, ())
    IL2CPP_REGISTER_METHOD(0x028085A0, int32_t, IComparer_Compare, (app::Comparer_1_Microsoft_Xbox_Services_Xal_XalHttpHeader_ * this_ptr, app::Object* x, app::Object* y))

...
namespace app::classes::System::Collections::Generic::Stack_1_System_Dynamic_BindingRestrictions_TestBuilder_AndNode_ {
    IL2CPP_REGISTER_METHOD(
        ...
        Pop,
        app::Stack_1_System_Dynamic_BindingRestrictions_TestBuilder_AndNode_* this_ptr
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Push,
        app::Stack_1_System_Dynamic_BindingRestrictions_TestBuilder_AndNode_* this_ptr,
        app::BindingRestrictions_TestBuilder_AndNode item
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x02CF65D0,
        app::Stack_1_T_Enumerator_System_Dynamic_BindingRestrictions_TestBuilder_AndNode_,
        GetEnumerator,
        app::Stack_1_System_Dynamic_BindingRestrictions_TestBuilder_AndNode_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x02CF6610,
        app::IEnumerator_1_System_Dynamic_BindingRestrictions_TestBuilder_AndNode_*,
    ...
    IL2CPP_REGISTER_METHOD(
        0x02CF68C0,
        app::BindingRestrictions_TestBuilder_AndNode__Array*,
        ToArray,
        app::Stack_1_System_Dynamic_BindingRestrictions_TestBuilder_AndNode_* this_ptr
    )

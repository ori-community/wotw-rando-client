...
namespace app::classes::System::Collections::Generic::List_1_System_Byte_ {
    ...
    IL2CPP_REGISTER_METHOD(0x025F01C0, int32_t, BinarySearch_1, (app::List_1_System_Byte_ * this_ptr, int32_t index, int32_t count, uint8_t item, app::IComparer_1_System_Byte_* comparer))
    ...
    IL2CPP_REGISTER_METHOD(0x025E95B0, void, CopyTo_2, (app::List_1_System_Byte_ * this_ptr, int32_t index, app::Byte__Array* array, int32_t array_index, int32_t count))
    ...
    IL2CPP_REGISTER_METHOD(0x02F518F0, int32_t, FindIndex_2, (app::List_1_System_Byte_ * this_ptr, int32_t start_index, int32_t count, app::Predicate_1_Byte_* match))
    IL2CPP_REGISTER_METHOD(0x02F530D0, void, ForEach, (app::List_1_System_Byte_ * this_ptr, app::Action_1_Byte__1* action))
    IL2CPP_REGISTER_METHOD(0x02F51BC0, app::IEnumerator_1_System_Byte_*, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_System_Byte_ * this_ptr))

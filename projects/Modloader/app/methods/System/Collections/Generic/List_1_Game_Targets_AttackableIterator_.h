...
namespace app::classes::System::Collections::Generic::List_1_Game_Targets_AttackableIterator_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x047503D8, List_1_Game_Targets_AttackableIterator__GetEnumerator__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x022A4010, void, Clear, (app::List_1_Game_Targets_AttackableIterator_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047930A8, List_1_Game_Targets_AttackableIterator__Clear__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E81E0, void, ctor, (app::List_1_Game_Targets_AttackableIterator_ * this_ptr, int32_t capacity))
    IL2CPP_REGISTER_METHODINFO(0x0474BAB8, List_1_Game_Targets_AttackableIterator___ctor__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04755CF0, List_1_Game_Targets_AttackableIterator__Add__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0478D400, List_1_Game_Targets_AttackableIterator__Remove__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_Game_Targets_AttackableIterator_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047360B8, List_1_Game_Targets_AttackableIterator__get_Count__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04795AA8, List_1_Game_Targets_AttackableIterator__get_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025F1690, void, RemoveAt, (app::List_1_Game_Targets_AttackableIterator_ * this_ptr, int32_t index))
    IL2CPP_REGISTER_METHODINFO(0x04789878, List_1_Game_Targets_AttackableIterator__RemoveAt__MethodInfo)
} // namespace app::classes::System::Collections::Generic::List_1_Game_Targets_AttackableIterator_

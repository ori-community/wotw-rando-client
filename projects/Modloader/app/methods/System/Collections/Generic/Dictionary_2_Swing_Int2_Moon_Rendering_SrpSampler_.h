...
namespace app::classes::System::Collections::Generic::Dictionary_2_Swing_Int2_Moon_Rendering_SrpSampler_ {
    IL2CPP_REGISTER_METHOD(
        ...
        bool,
        TryGetValue,
        app::Dictionary_2_Swing_Int2_Moon_Rendering_SrpSampler_* this_ptr,
        app::Int2 key,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ctor_3,
        app::Dictionary_2_Swing_Int2_Moon_Rendering_SrpSampler_* this_ptr,
        app::IEqualityComparer_1_Swing_Int2_* comparer
    )
    IL2CPP_REGISTER_METHOD(
        0x02E2F3B0,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ctor_5,
        app::Dictionary_2_Swing_Int2_Moon_Rendering_SrpSampler_* this_ptr,
        app::IDictionary_2_Swing_Int2_Moon_Rendering_SrpSampler_* dictionary
    )
    IL2CPP_REGISTER_METHOD(
        0x02E2F4F0,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        0x0283B2B0,
        app::Dictionary_2_TKey_TValue_KeyCollection_Swing_Int2_Moon_Rendering_SrpSampler_*,
        get_Keys,
        app::Dictionary_2_Swing_Int2_Moon_Rendering_SrpSampler_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x0283B2B0,
        app::ICollection_1_Swing_Int2_*,
        System_Collections_Generic_IDictionary_TKey_TValue__get_Keys,
        app::Dictionary_2_Swing_Int2_Moon_Rendering_SrpSampler_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x0283B2B0,
        app::IEnumerable_1_Swing_Int2_*,
        System_Collections_Generic_IReadOnlyDictionary_TKey_TValue__get_Keys,
        app::Dictionary_2_Swing_Int2_Moon_Rendering_SrpSampler_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x0283B3E0,
        app::Dictionary_2_TKey_TValue_ValueCollection_Swing_Int2_Moon_Rendering_SrpSampler_*,
        get_Values,
        app::Dictionary_2_Swing_Int2_Moon_Rendering_SrpSampler_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x0283B3E0,
        app::ICollection_1_Moon_Rendering_SrpSampler_*,
        System_Collections_Generic_IDictionary_TKey_TValue__get_Values,
        app::Dictionary_2_Swing_Int2_Moon_Rendering_SrpSampler_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x0283B3E0,
        app::IEnumerable_1_Moon_Rendering_SrpSampler_*,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Dictionary_2_Swing_Int2_Moon_Rendering_SrpSampler_* this_ptr,
        app::KeyValuePair_2_Swing_Int2_Moon_Rendering_SrpSampler_ key_value_pair
    )
    IL2CPP_REGISTER_METHOD(
        0x02DD60E0,
        bool,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        CopyTo,
        app::Dictionary_2_Swing_Int2_Moon_Rendering_SrpSampler_* this_ptr,
        app::KeyValuePair_2_Swing_Int2_Moon_Rendering_SrpSampler___Array* array,
        int32_t index
    )
    IL2CPP_REGISTER_METHOD(
        0x02DA8610,
        app::Dictionary_2_TKey_TValue_Enumerator_Swing_Int2_Moon_Rendering_SrpSampler_,
        GetEnumerator,
        app::Dictionary_2_Swing_Int2_Moon_Rendering_SrpSampler_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x02DA8680,
        app::IEnumerator_1_KeyValuePair_2_Swing_Int2_Moon_Rendering_SrpSampler_*,

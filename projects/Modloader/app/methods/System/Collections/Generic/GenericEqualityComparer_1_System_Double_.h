...
namespace app::classes::System::Collections::Generic::GenericEqualityComparer_1_System_Double_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02AB10B0, int32_t, IndexOf, (app::GenericEqualityComparer_1_System_Double_ * this_ptr, app::Double__Array* array, double value, int32_t start_index, int32_t count))
    IL2CPP_REGISTER_METHOD(0x02AB1140, int32_t, LastIndexOf, (app::GenericEqualityComparer_1_System_Double_ * this_ptr, app::Double__Array* array, double value, int32_t start_index, int32_t count))

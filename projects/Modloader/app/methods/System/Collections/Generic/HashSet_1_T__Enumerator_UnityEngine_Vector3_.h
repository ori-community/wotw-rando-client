...
namespace app::classes::System::Collections::Generic::HashSet_1_T__Enumerator_UnityEngine_Vector3_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0471F3D8, HashSet_1_T_Enumerator_UnityEngine_Vector3__MoveNext__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0478B428, HashSet_1_T_Enumerator_UnityEngine_Vector3__System_Collections_IEnumerator_get_Current__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00221140, void, IEnumerator_Reset, (app::HashSet_1_T_Enumerator_UnityEngine_Vector3___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047748C0, HashSet_1_T_Enumerator_UnityEngine_Vector3__System_Collections_IEnumerator_Reset__MethodInfo)
} // namespace app::classes::System::Collections::Generic::HashSet_1_T__Enumerator_UnityEngine_Vector3_

...
namespace app::classes::System::Collections::Generic::List_1_DigZone_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04786800, List_1_DigZone__GetEnumerator__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02F1E150, void, Add, (app::List_1_DigZone_ * this_ptr, app::DigZone* item))
    IL2CPP_REGISTER_METHODINFO(0x047081A0, List_1_DigZone__Add__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025F12F0, bool, Remove, (app::List_1_DigZone_ * this_ptr, app::DigZone* item))
    IL2CPP_REGISTER_METHODINFO(0x047240C8, List_1_DigZone__Remove__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025EFC50, app::DigZone*, get_Item, (app::List_1_DigZone_ * this_ptr, int32_t index))
    IL2CPP_REGISTER_METHODINFO(0x0472B510, List_1_DigZone__get_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_DigZone_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04757130, List_1_DigZone__get_Count__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x022A4010, void, Clear, (app::List_1_DigZone_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04720A60, List_1_DigZone__Clear__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor, (app::List_1_DigZone_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0475F240, List_1_DigZone___ctor__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04741078, List_1_DigZone__ConvertAll__MethodInfo)
} // namespace app::classes::System::Collections::Generic::List_1_DigZone_

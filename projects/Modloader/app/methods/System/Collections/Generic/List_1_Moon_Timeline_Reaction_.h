...
namespace app::classes::System::Collections::Generic::List_1_Moon_Timeline_Reaction_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02C1E5B0, int32_t, BinarySearch_1, (app::List_1_Moon_Timeline_Reaction_ * this_ptr, int32_t index, int32_t count, app::Reaction item, app::IComparer_1_Moon_Timeline_Reaction_* comparer))
    IL2CPP_REGISTER_METHOD(0x02C1E650, int32_t, BinarySearch_2, (app::List_1_Moon_Timeline_Reaction_ * this_ptr, app::Reaction item, app::IComparer_1_Moon_Timeline_Reaction_* comparer))
    ...
    IL2CPP_REGISTER_METHOD(0x025E95B0, void, CopyTo_2, (app::List_1_Moon_Timeline_Reaction_ * this_ptr, int32_t index, app::Reaction__Array* array, int32_t array_index, int32_t count))
    ...
    IL2CPP_REGISTER_METHOD(0x02C1EB60, app::List_1_Moon_Timeline_Reaction_*, FindAll, (app::List_1_Moon_Timeline_Reaction_ * this_ptr, app::Predicate_1_Moon_Timeline_Reaction_* match))
    ...
    IL2CPP_REGISTER_METHOD(0x02C1EDA0, int32_t, FindIndex_2, (app::List_1_Moon_Timeline_Reaction_ * this_ptr, int32_t start_index, int32_t count, app::Predicate_1_Moon_Timeline_Reaction_* match))
    ...
    IL2CPP_REGISTER_METHOD(0x02C1F0C0, app::IEnumerator_1_Moon_Timeline_Reaction_*, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_Moon_Timeline_Reaction_ * this_ptr))
    IL2CPP_REGISTER_METHOD(0x02C1F0C0, app::IEnumerator*, IEnumerable_GetEnumerator, (app::List_1_Moon_Timeline_Reaction_ * this_ptr))
    IL2CPP_REGISTER_METHOD(0x025E9DF0, app::List_1_Moon_Timeline_Reaction_*, GetRange, (app::List_1_Moon_Timeline_Reaction_ * this_ptr, int32_t index, int32_t count))
    ...
    IL2CPP_REGISTER_METHOD(0x02DEDFF0, void, InsertRange, (app::List_1_Moon_Timeline_Reaction_ * this_ptr, int32_t index, app::IEnumerable_1_Moon_Timeline_Reaction_* collection))
    ...
    IL2CPP_REGISTER_METHOD(0x025EAE20, void, Sort_3, (app::List_1_Moon_Timeline_Reaction_ * this_ptr, int32_t index, int32_t count, app::IComparer_1_Moon_Timeline_Reaction_* comparer))

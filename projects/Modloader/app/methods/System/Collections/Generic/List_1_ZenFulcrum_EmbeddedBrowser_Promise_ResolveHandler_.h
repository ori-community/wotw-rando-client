...
namespace app::classes::System::Collections::Generic::List_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_3,
        app::List_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_* this_ptr,
        app::IEnumerable_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_* collection
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x025E9050,
        app::ReadOnlyCollection_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_*,
        AsReadOnly,
        app::List_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t index,
        int32_t count,
        app::Promise_ResolveHandler item,
        app::IComparer_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_* comparer
    )
    IL2CPP_REGISTER_METHOD(
        0x025E91F0,
        int32_t,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Exists,
        app::List_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_* this_ptr,
        app::Predicate_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_* match
    )
    IL2CPP_REGISTER_METHOD(
        0x025E96E0,
        app::Promise_ResolveHandler,
    ...
    IL2CPP_REGISTER_METHOD(
        0x025E9800,
        app::List_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_*,
        FindAll,
        app::List_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_* this_ptr,
        app::Predicate_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_* match
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ForEach,
        app::List_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_* this_ptr,
        app::Action_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_* action
    )
    IL2CPP_REGISTER_METHOD(
        0x025E9D20,
        app::List_1_T_Enumerator_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_,
        GetEnumerator,
        app::List_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Sort_4,
        app::List_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_* this_ptr,
        app::Comparison_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_* comparison
    )

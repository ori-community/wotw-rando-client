...
namespace app::classes::System::Collections::Generic::ArraySortHelper_1_ServerPhysicalSystemManager_RigidbodyStateData_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02C86EC0, void, IntrospectiveSort, (app::ServerPhysicalSystemManager_RigidbodyStateData__Array * keys, int32_t left, int32_t length, app::Comparison_1_ServerPhysicalSystemManager_RigidbodyStateData_* comparer))
    IL2CPP_REGISTER_METHOD(0x02C86FB0, void, IntroSort, (app::ServerPhysicalSystemManager_RigidbodyStateData__Array * keys, int32_t lo, int32_t hi, int32_t depth_limit, app::Comparison_1_ServerPhysicalSystemManager_RigidbodyStateData_* comparer))
    IL2CPP_REGISTER_METHOD(0x02F37770, int32_t, PickPivotAndPartition, (app::ServerPhysicalSystemManager_RigidbodyStateData__Array * keys, int32_t lo, int32_t hi, app::Comparison_1_ServerPhysicalSystemManager_RigidbodyStateData_* comparer))
    IL2CPP_REGISTER_METHOD(0x02C87750, void, Heapsort, (app::ServerPhysicalSystemManager_RigidbodyStateData__Array * keys, int32_t lo, int32_t hi, app::Comparison_1_ServerPhysicalSystemManager_RigidbodyStateData_* comparer))
    IL2CPP_REGISTER_METHOD(0x02F37C40, void, DownHeap, (app::ServerPhysicalSystemManager_RigidbodyStateData__Array * keys, int32_t i, int32_t n, int32_t lo, app::Comparison_1_ServerPhysicalSystemManager_RigidbodyStateData_* comparer))
    IL2CPP_REGISTER_METHOD(0x02F38060, void, InsertionSort, (app::ServerPhysicalSystemManager_RigidbodyStateData__Array * keys, int32_t lo, int32_t hi, app::Comparison_1_ServerPhysicalSystemManager_RigidbodyStateData_* comparer))
} // namespace app::classes::System::Collections::Generic::ArraySortHelper_1_ServerPhysicalSystemManager_RigidbodyStateData_

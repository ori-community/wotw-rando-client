...
namespace app::classes::System::Collections::Generic::EqualityComparer_1_System_Char_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02D9D120, int32_t, IndexOf, (app::EqualityComparer_1_System_Char_ * this_ptr, app::Char__Array* array, char16_t value, int32_t start_index, int32_t count))
    IL2CPP_REGISTER_METHOD(0x02D9D1D0, int32_t, LastIndexOf, (app::EqualityComparer_1_System_Char_ * this_ptr, app::Char__Array* array, char16_t value, int32_t start_index, int32_t count))

...
namespace app::classes::System::Collections::Generic::List_1_T__Enumerator_Moon_UberStateController_ApplierContext_ {
    IL2CPP_REGISTER_METHOD(0x00136440, app::UberStateController_ApplierContext, get_Current, (app::List_1_T_Enumerator_Moon_UberStateController_ApplierContext___Boxed * this_ptr))
    ...
    IL2CPP_REGISTER_METHOD(0x0014CA00, void, ctor, (app::List_1_T_Enumerator_Moon_UberStateController_ApplierContext___Boxed * this_ptr, app::List_1_Moon_UberStateController_ApplierContext_* list))
    ...
    IL2CPP_REGISTER_METHOD(0x0014CB40, app::Object*, IEnumerator_get_Current, (app::List_1_T_Enumerator_Moon_UberStateController_ApplierContext___Boxed * this_ptr))

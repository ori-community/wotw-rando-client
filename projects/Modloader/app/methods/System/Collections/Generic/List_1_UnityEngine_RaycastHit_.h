...
namespace app::classes::System::Collections::Generic::List_1_UnityEngine_RaycastHit_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02EE1780, int32_t, BinarySearch_1, (app::List_1_UnityEngine_RaycastHit_ * this_ptr, int32_t index, int32_t count, app::RaycastHit item, app::IComparer_1_UnityEngine_RaycastHit_* comparer))
    IL2CPP_REGISTER_METHOD(0x02EE1830, int32_t, BinarySearch_2, (app::List_1_UnityEngine_RaycastHit_ * this_ptr, app::RaycastHit item, app::IComparer_1_UnityEngine_RaycastHit_* comparer))
    ...
    IL2CPP_REGISTER_METHOD(0x025E95B0, void, CopyTo_2, (app::List_1_UnityEngine_RaycastHit_ * this_ptr, int32_t index, app::RaycastHit__Array* array, int32_t array_index, int32_t count))
    ...
    IL2CPP_REGISTER_METHOD(0x02EE1DD0, app::List_1_UnityEngine_RaycastHit_*, FindAll, (app::List_1_UnityEngine_RaycastHit_ * this_ptr, app::Predicate_1_UnityEngine_RaycastHit_* match))
    ...
    IL2CPP_REGISTER_METHOD(0x02EE2050, int32_t, FindIndex_2, (app::List_1_UnityEngine_RaycastHit_ * this_ptr, int32_t start_index, int32_t count, app::Predicate_1_UnityEngine_RaycastHit_* match))
    ...
    IL2CPP_REGISTER_METHOD(0x02EE23B0, app::IEnumerator_1_UnityEngine_RaycastHit_*, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_UnityEngine_RaycastHit_ * this_ptr))
    IL2CPP_REGISTER_METHOD(0x02EE23B0, app::IEnumerator*, IEnumerable_GetEnumerator, (app::List_1_UnityEngine_RaycastHit_ * this_ptr))
    IL2CPP_REGISTER_METHOD(0x025E9DF0, app::List_1_UnityEngine_RaycastHit_*, GetRange, (app::List_1_UnityEngine_RaycastHit_ * this_ptr, int32_t index, int32_t count))
    ...
    IL2CPP_REGISTER_METHOD(0x02EE2900, void, InsertRange, (app::List_1_UnityEngine_RaycastHit_ * this_ptr, int32_t index, app::IEnumerable_1_UnityEngine_RaycastHit_* collection))
    ...
    IL2CPP_REGISTER_METHOD(0x025EAE20, void, Sort_3, (app::List_1_UnityEngine_RaycastHit_ * this_ptr, int32_t index, int32_t count, app::IComparer_1_UnityEngine_RaycastHit_* comparer))

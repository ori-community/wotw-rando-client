...
namespace app::classes::System::Collections::Generic::ObjectEqualityComparer_1_System_Int64Enum_ {
    IL2CPP_REGISTER_METHOD(0x02435D10, bool, Equals_1, (app::ObjectEqualityComparer_1_System_Int64Enum_ * this_ptr, app::Int64Enum__Enum x, app::Int64Enum__Enum y))
    ...
    IL2CPP_REGISTER_METHOD(0x02435E20, int32_t, IndexOf, (app::ObjectEqualityComparer_1_System_Int64Enum_ * this_ptr, app::Int64Enum__Enum__Array* array, app::Int64Enum__Enum value, int32_t start_index, int32_t count))
    IL2CPP_REGISTER_METHOD(0x02435F70, int32_t, LastIndexOf, (app::ObjectEqualityComparer_1_System_Int64Enum_ * this_ptr, app::Int64Enum__Enum__Array* array, app::Int64Enum__Enum value, int32_t start_index, int32_t count))

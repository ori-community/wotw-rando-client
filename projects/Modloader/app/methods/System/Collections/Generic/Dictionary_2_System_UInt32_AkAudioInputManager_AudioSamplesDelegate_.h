...
namespace app::classes::System::Collections::Generic::Dictionary_2_System_UInt32_AkAudioInputManager_AudioSamplesDelegate_ {
    ...
    IL2CPP_REGISTER_METHOD(
        0x02F028F0,
        app::AkAudioInputManager_AudioSamplesDelegate*,
        get_Item,
        app::Dictionary_2_System_UInt32_AkAudioInputManager_AudioSamplesDelegate_* this_ptr,
        uint32_t key
    )
    IL2CPP_REGISTER_METHOD(
        0x02BAC170,
        ...
        app::Dictionary_2_System_UInt32_AkAudioInputManager_AudioSamplesDelegate_* this_ptr,
        uint32_t key,
        app::AkAudioInputManager_AudioSamplesDelegate* value
    )

...
namespace app::classes::System::Collections::Generic::List_1_RuntimeWorldMapIcon_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0472BCF8, List_1_RuntimeWorldMapIcon__get_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_RuntimeWorldMapIcon_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04768E28, List_1_RuntimeWorldMapIcon__get_Count__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0471C1B0, List_1_RuntimeWorldMapIcon__GetEnumerator__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x022A4010, void, Clear, (app::List_1_RuntimeWorldMapIcon_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0470DCC0, List_1_RuntimeWorldMapIcon__Clear__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor, (app::List_1_RuntimeWorldMapIcon_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04713438, List_1_RuntimeWorldMapIcon___ctor__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02F1E150, void, Add, (app::List_1_RuntimeWorldMapIcon_ * this_ptr, app::RuntimeWorldMapIcon* item))
    IL2CPP_REGISTER_METHODINFO(0x0470A4C0, List_1_RuntimeWorldMapIcon__Add__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04791FA8, List_1_RuntimeWorldMapIcon__Find__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E8790, void, set_Capacity, (app::List_1_RuntimeWorldMapIcon_ * this_ptr, int32_t value))
    IL2CPP_REGISTER_METHODINFO(0x0475BB50, List_1_RuntimeWorldMapIcon__set_Capacity__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04714558, List_1_RuntimeWorldMapIcon__Sort__MethodInfo)
} // namespace app::classes::System::Collections::Generic::List_1_RuntimeWorldMapIcon_

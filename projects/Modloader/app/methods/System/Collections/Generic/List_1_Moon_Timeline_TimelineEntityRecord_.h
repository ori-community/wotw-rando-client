...
namespace app::classes::System::Collections::Generic::List_1_Moon_Timeline_TimelineEntityRecord_ {
    ...
    IL2CPP_REGISTER_METHOD(
        0x025F0B10,
        app::List_1_T_Enumerator_Moon_Timeline_TimelineEntityRecord_,
        GetEnumerator,
        app::List_1_Moon_Timeline_TimelineEntityRecord_* this_ptr
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        AddRange,
        app::List_1_Moon_Timeline_TimelineEntityRecord_* this_ptr,
        app::IEnumerable_1_Moon_Timeline_TimelineEntityRecord_* collection
    )
    IL2CPP_REGISTER_METHOD(
        0x02F1EFE0,
        int32_t,
        RemoveAll,
        app::List_1_Moon_Timeline_TimelineEntityRecord_* this_ptr,
        app::Predicate_1_Moon_Timeline_TimelineEntityRecord_* match
    )
} // namespace app::classes::System::Collections::Generic::List_1_Moon_Timeline_TimelineEntityRecord_

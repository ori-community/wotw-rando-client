...
namespace app::classes::System::Collections::Generic::Dictionary_2_TKey_TValue__ValueCollection_System_Int32_System_Object_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::Dictionary_2_TKey_TValue_ValueCollection_System_Int32_System_Object_* this_ptr,
        app::Dictionary_2_System_Int32_System_Object_* dictionary
    )
    IL2CPP_REGISTER_METHOD(
        0x01A729A0,
        app::Dictionary_2_TKey_TValue_ValueCollection_TKey_TValue_Enumerator_System_Int32_System_Object_,
        GetEnumerator,
        app::Dictionary_2_TKey_TValue_ValueCollection_System_Int32_System_Object_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(

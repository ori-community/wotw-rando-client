...
namespace app::classes::System::Collections::Generic::ObjectEqualityComparer_1_UnityEngine_UI_Navigation_ {
    ...
    IL2CPP_REGISTER_METHOD(0x01CD2E30, int32_t, IndexOf, (app::ObjectEqualityComparer_1_UnityEngine_UI_Navigation_ * this_ptr, app::Navigation__Array* array, app::Navigation value, int32_t start_index, int32_t count))
    IL2CPP_REGISTER_METHOD(0x01CD2FD0, int32_t, LastIndexOf, (app::ObjectEqualityComparer_1_UnityEngine_UI_Navigation_ * this_ptr, app::Navigation__Array* array, app::Navigation value, int32_t start_index, int32_t count))

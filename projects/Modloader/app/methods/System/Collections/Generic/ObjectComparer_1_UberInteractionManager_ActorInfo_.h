...
namespace app::classes::System::Collections::Generic::ObjectComparer_1_UberInteractionManager_ActorInfo_ {
    IL2CPP_REGISTER_METHOD(0x01CCD520, int32_t, Compare, (app::ObjectComparer_1_UberInteractionManager_ActorInfo_ * this_ptr, app::UberInteractionManager_ActorInfo x, app::UberInteractionManager_ActorInfo y))

...
namespace app::classes::System::Collections::Generic::List_1_Moon_SerializedIntUberState_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04793C58, List_1_Moon_SerializedIntUberState__get_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_Moon_SerializedIntUberState_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04706398, List_1_Moon_SerializedIntUberState__get_Count__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor, (app::List_1_Moon_SerializedIntUberState_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047350F8, List_1_Moon_SerializedIntUberState___ctor__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x022A4010, void, Clear, (app::List_1_Moon_SerializedIntUberState_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04790510, List_1_Moon_SerializedIntUberState__Clear__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E8790, void, set_Capacity, (app::List_1_Moon_SerializedIntUberState_ * this_ptr, int32_t value))
    IL2CPP_REGISTER_METHODINFO(0x0472A5B0, List_1_Moon_SerializedIntUberState__set_Capacity__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0473E448, List_1_Moon_SerializedIntUberState__GetEnumerator__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0476FBD0, List_1_Moon_SerializedIntUberState__Contains__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0475B778, List_1_Moon_SerializedIntUberState__Add__MethodInfo)
} // namespace app::classes::System::Collections::Generic::List_1_Moon_SerializedIntUberState_

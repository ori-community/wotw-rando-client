...
namespace app::classes::System::Collections::Generic::Dictionary_2_AbilityType_Moon_uberSerializationWisp_PlayerUberStateAbilities_Ability_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x047589B0, Dictionary_2_AbilityType_Moon_uberSerializationWisp_PlayerUberStateAbilities_Ability___ctor__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0474BAC0, Dictionary_2_AbilityType_Moon_uberSerializationWisp_PlayerUberStateAbilities_Ability__Add__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04726C08, Dictionary_2_AbilityType_Moon_uberSerializationWisp_PlayerUberStateAbilities_Ability__get_Item__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04731718, Dictionary_2_AbilityType_Moon_uberSerializationWisp_PlayerUberStateAbilities_Ability__ContainsKey__MethodInfo)
} // namespace app::classes::System::Collections::Generic::Dictionary_2_AbilityType_Moon_uberSerializationWisp_PlayerUberStateAbilities_Ability_

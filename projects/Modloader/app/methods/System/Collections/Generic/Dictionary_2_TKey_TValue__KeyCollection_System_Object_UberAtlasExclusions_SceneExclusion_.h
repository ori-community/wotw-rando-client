...
#include <Modloader/app/structs/Dictionary_2_TK_TVal_KeyCollecti_TK_TVal_Enumerat_Syst_Obje_UberAtlasExclusio_SceneExclus_.h>
...
namespace app::classes::System::Collections::Generic::Dictionary_2_TKey_TValue__KeyCollection_System_Object_UberAtlasExclusions_SceneExclusion_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::Dictionary_2_TKey_TValue_KeyCollection_System_Object_UberAtlasExclusions_SceneExclusion_* this_ptr,
        app::Dictionary_2_System_Object_UberAtlasExclusions_SceneExclusion_* dictionary
    )
    IL2CPP_REGISTER_METHOD(
        0x01A729A0,
        app::Dictionary_2_TKey_TValue_KeyCollection_TKey_TValue_Enumerator_System_Object_UberAtlasExclusions_SceneExclusion_,
        GetEnumerator,
        app::Dictionary_2_TKey_TValue_KeyCollection_System_Object_UberAtlasExclusions_SceneExclusion_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(

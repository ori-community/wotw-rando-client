...
namespace app::classes::System::Collections::Generic::Dictionary_2_SpiderBossBaseBehaviour_SpiderBossEntity_ExecuteAttackInfo_ {
    ...
    IL2CPP_REGISTER_METHOD(
        0x02BA5400,
        app::Dictionary_2_TKey_TValue_Enumerator_SpiderBossBaseBehaviour_SpiderBossEntity_ExecuteAttackInfo_,
        GetEnumerator,
        app::Dictionary_2_SpiderBossBaseBehaviour_SpiderBossEntity_ExecuteAttackInfo_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x02BBA760,
        bool,
        TryGetValue,
        app::Dictionary_2_SpiderBossBaseBehaviour_SpiderBossEntity_ExecuteAttackInfo_* this_ptr,
        app::SpiderBossBaseBehaviour* key,
        app::SpiderBossEntity_ExecuteAttackInfo** value
    )

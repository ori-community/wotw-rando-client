...
namespace app::classes::System::Collections::Generic::Dictionary_2_System_Int32_Moon_HierarchyPerformanceTest_HPerfTestResult_ {
    IL2CPP_REGISTER_METHOD(
        0x0283B3E0,
        app::Dictionary_2_TKey_TValue_ValueCollection_System_Int32_Moon_HierarchyPerformanceTest_HPerfTestResult_*,
        get_Values,
        app::Dictionary_2_System_Int32_Moon_HierarchyPerformanceTest_HPerfTestResult_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x02BBA760,
        bool,
    ...
    IL2CPP_REGISTER_METHOD(
        0x02BA5400,
        app::Dictionary_2_TKey_TValue_Enumerator_System_Int32_Moon_HierarchyPerformanceTest_HPerfTestResult_,
        GetEnumerator,
        app::Dictionary_2_System_Int32_Moon_HierarchyPerformanceTest_HPerfTestResult_* this_ptr
    )
} // namespace app::classes::System::Collections::Generic::Dictionary_2_System_Int32_Moon_HierarchyPerformanceTest_HPerfTestResult_

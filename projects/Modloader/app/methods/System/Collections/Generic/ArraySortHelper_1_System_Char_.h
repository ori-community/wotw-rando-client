...
namespace app::classes::System::Collections::Generic::ArraySortHelper_1_System_Char_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02FF4F60, int32_t, BinarySearch, (app::Char__Array * array, int32_t index, int32_t length, char16_t value, app::IComparer_1_System_Char_* comparer))
    ...
    IL2CPP_REGISTER_METHOD(0x02F7FD80, int32_t, InternalBinarySearch, (app::Char__Array * array, int32_t index, int32_t length, char16_t value, app::IComparer_1_System_Char_* comparer))

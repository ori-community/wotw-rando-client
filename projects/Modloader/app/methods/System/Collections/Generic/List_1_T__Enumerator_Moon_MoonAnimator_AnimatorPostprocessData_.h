...
namespace app::classes::System::Collections::Generic::List_1_T__Enumerator_Moon_MoonAnimator_AnimatorPostprocessData_ {
    ...
    IL2CPP_REGISTER_METHOD(0x001354E0, app::MoonAnimator_AnimatorPostprocessData, get_Current, (app::List_1_T_Enumerator_Moon_MoonAnimator_AnimatorPostprocessData___Boxed * this_ptr))
    IL2CPP_REGISTER_METHOD(0x001529D0, app::Object*, IEnumerator_get_Current, (app::List_1_T_Enumerator_Moon_MoonAnimator_AnimatorPostprocessData___Boxed * this_ptr))

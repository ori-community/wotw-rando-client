...
namespace app::classes::System::Collections::Generic::ArraySortHelper_1_System_Linq_Expressions_Interpreter_InstructionList_DebugView_InstructionView_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Sort_1,
        app::InstructionList_DebugView_InstructionView__Array* keys,
        int32_t index,
        int32_t length,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t index,
        int32_t length,
        app::Comparison_1_System_Linq_Expressions_Interpreter_InstructionList_DebugView_InstructionView_* comparer
    )
    IL2CPP_REGISTER_METHOD(
        0x02C8AB70,
        int32_t,

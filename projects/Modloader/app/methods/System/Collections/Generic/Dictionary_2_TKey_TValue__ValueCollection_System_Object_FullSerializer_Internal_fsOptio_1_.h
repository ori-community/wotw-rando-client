...
namespace app::classes::System::Collections::Generic::Dictionary_2_TKey_TValue__ValueCollection_System_Object_FullSerializer_Internal_fsOption_1_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::Dictionary_2_TKey_TValue_ValueCollection_System_Object_FullSerializer_Internal_fsOption_1_* this_ptr,
        app::Dictionary_2_System_Object_FullSerializer_Internal_fsOption_1_* dictionary
    )
    IL2CPP_REGISTER_METHOD(
        0x01ADBCA0,
        app::Dictionary_2_TKey_TValue_ValueCollection_TKey_TValue_Enumerator_System_Object_FullSerializer_Internal_fsOption_1_,
        GetEnumerator,
        app::Dictionary_2_TKey_TValue_ValueCollection_System_Object_FullSerializer_Internal_fsOption_1_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Dictionary_2_TKey_TValue_ValueCollection_System_Object_FullSerializer_Internal_fsOption_1_* this_ptr,
        app::fsOption_1_fsVersionedType_ item
    )
    IL2CPP_REGISTER_METHOD(
        0x026B8E20,
        bool,
    ...
    IL2CPP_REGISTER_METHOD(
        0x01ADC0B0,
        app::IEnumerator_1_FullSerializer_Internal_fsOption_1_*,

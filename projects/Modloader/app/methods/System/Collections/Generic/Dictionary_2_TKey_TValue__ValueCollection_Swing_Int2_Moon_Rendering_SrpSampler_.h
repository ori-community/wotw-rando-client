...
namespace app::classes::System::Collections::Generic::Dictionary_2_TKey_TValue__ValueCollection_Swing_Int2_Moon_Rendering_SrpSampler_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::Dictionary_2_TKey_TValue_ValueCollection_Swing_Int2_Moon_Rendering_SrpSampler_* this_ptr,
        app::Dictionary_2_Swing_Int2_Moon_Rendering_SrpSampler_* dictionary
    )
    IL2CPP_REGISTER_METHOD(
        0x01ADB1F0,
        app::Dictionary_2_TKey_TValue_ValueCollection_TKey_TValue_Enumerator_Swing_Int2_Moon_Rendering_SrpSampler_,
        GetEnumerator,
        app::Dictionary_2_TKey_TValue_ValueCollection_Swing_Int2_Moon_Rendering_SrpSampler_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(

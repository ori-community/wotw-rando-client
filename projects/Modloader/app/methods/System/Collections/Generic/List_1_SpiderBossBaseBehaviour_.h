...
namespace app::classes::System::Collections::Generic::List_1_SpiderBossBaseBehaviour_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04704A68, List_1_SpiderBossBaseBehaviour__Clear__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02F1E150, void, Add, (app::List_1_SpiderBossBaseBehaviour_ * this_ptr, app::SpiderBossBaseBehaviour* item))
    IL2CPP_REGISTER_METHODINFO(0x04785E20, List_1_SpiderBossBaseBehaviour__Add__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0475BD28, List_1_SpiderBossBaseBehaviour__Remove__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor, (app::List_1_SpiderBossBaseBehaviour_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04703660, List_1_SpiderBossBaseBehaviour___ctor__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_SpiderBossBaseBehaviour_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04709390, List_1_SpiderBossBaseBehaviour__get_Count__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04720968, List_1_SpiderBossBaseBehaviour__get_Item__MethodInfo)
} // namespace app::classes::System::Collections::Generic::List_1_SpiderBossBaseBehaviour_

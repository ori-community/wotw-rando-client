...
namespace app::classes::System::Collections::Generic::GenericEqualityComparer_1_System_Char_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02AB1300, int32_t, IndexOf, (app::GenericEqualityComparer_1_System_Char_ * this_ptr, app::Char__Array* array, char16_t value, int32_t start_index, int32_t count))
    IL2CPP_REGISTER_METHOD(0x02AB1360, int32_t, LastIndexOf, (app::GenericEqualityComparer_1_System_Char_ * this_ptr, app::Char__Array* array, char16_t value, int32_t start_index, int32_t count))

...
namespace app::classes::System::Collections::Generic::List_1_T__Enumerator_SeinSpiritSpearSpell_FlyingSpear_ {
    IL2CPP_REGISTER_METHOD(0x0014E010, void, ctor, (app::List_1_T_Enumerator_SeinSpiritSpearSpell_FlyingSpear___Boxed * this_ptr, app::List_1_SeinSpiritSpearSpell_FlyingSpear_* list))
    ...
    IL2CPP_REGISTER_METHOD(0x0014E1C0, app::SeinSpiritSpearSpell_FlyingSpear, get_Current, (app::List_1_T_Enumerator_SeinSpiritSpearSpell_FlyingSpear___Boxed * this_ptr))

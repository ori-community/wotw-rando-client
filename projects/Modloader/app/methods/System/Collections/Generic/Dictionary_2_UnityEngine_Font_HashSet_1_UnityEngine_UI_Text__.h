...
namespace app::classes::System::Collections::Generic::Dictionary_2_UnityEngine_Font_HashSet_1_UnityEngine_UI_Text__ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x047731F0, Dictionary_2_UnityEngine_Font_HashSet_1_UnityEngine_UI_Text__TryGetValue__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04757B98, Dictionary_2_UnityEngine_Font_HashSet_1_UnityEngine_UI_Text__get_Count__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02BAC170, void, Add, (app::Dictionary_2_UnityEngine_Font_HashSet_1_UnityEngine_UI_Text_ * this_ptr, app::Font* key, app::HashSet_1_UnityEngine_UI_Text_* value))
    IL2CPP_REGISTER_METHODINFO(0x0475F390, Dictionary_2_UnityEngine_Font_HashSet_1_UnityEngine_UI_Text__Add__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04726DA0, Dictionary_2_UnityEngine_Font_HashSet_1_UnityEngine_UI_Text__Remove__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x0283AC20, void, ctor, (app::Dictionary_2_UnityEngine_Font_HashSet_1_UnityEngine_UI_Text_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0471CFA0, Dictionary_2_UnityEngine_Font_HashSet_1_UnityEngine_UI_Text___ctor__MethodInfo)
} // namespace app::classes::System::Collections::Generic::Dictionary_2_UnityEngine_Font_HashSet_1_UnityEngine_UI_Text__

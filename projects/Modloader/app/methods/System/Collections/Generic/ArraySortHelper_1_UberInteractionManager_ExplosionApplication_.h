...
namespace app::classes::System::Collections::Generic::ArraySortHelper_1_UberInteractionManager_ExplosionApplication_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Sort_1,
        app::UberInteractionManager_ExplosionApplication__Array* keys,
        int32_t index,
        int32_t length,
        app::IComparer_1_UberInteractionManager_ExplosionApplication_* comparer
    )
    IL2CPP_REGISTER_METHOD(
        0x02F86D60,
        int32_t,
        BinarySearch,
        app::UberInteractionManager_ExplosionApplication__Array* array,
        int32_t index,
        int32_t length,
        app::UberInteractionManager_ExplosionApplication value,
        app::IComparer_1_UberInteractionManager_ExplosionApplication_* comparer
    )
    IL2CPP_REGISTER_METHOD(
        0x02F86F30,
        ...
        int32_t index,
        int32_t length,
        app::Comparison_1_UberInteractionManager_ExplosionApplication_* comparer
    )
    IL2CPP_REGISTER_METHOD(
        0x02F37310,
        int32_t,

...
namespace app::classes::System::Collections::Generic::List_1_Moon_UI_TextBoxLine_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t,
        BinarySearch_1,
        app::List_1_Moon_UI_TextBoxLine_* this_ptr,
        int32_t index,
        int32_t count,
        app::TextBoxLine_1 item,
    ...
    IL2CPP_REGISTER_METHOD(
        0x02DE5B10,
        app::List_1_Moon_UI_TextBoxLine_*,
        FindAll,
        app::List_1_Moon_UI_TextBoxLine_* this_ptr,
        app::Predicate_1_Moon_UI_TextBoxLine_* match
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x02DE60A0,
        app::IEnumerator_1_Moon_UI_TextBoxLine_*,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::List_1_Moon_UI_TextBoxLine_* this_ptr,
        int32_t index,
        app::IEnumerable_1_Moon_UI_TextBoxLine_* collection
    )

...
namespace app::classes::System::Collections::Generic::Queue_1_FullSerializer_Internal_fsVersionedType_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0471C318, Queue_1_FullSerializer_Internal_fsVersionedType___ctor__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0473D8F0, Queue_1_FullSerializer_Internal_fsVersionedType__Enqueue__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04792F10, Queue_1_FullSerializer_Internal_fsVersionedType__Dequeue__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x002FD1D0, int32_t, get_Count, (app::Queue_1_FullSerializer_Internal_fsVersionedType_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0473F028, Queue_1_FullSerializer_Internal_fsVersionedType__get_Count__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04727FA8, Queue_1_FullSerializer_Internal_fsVersionedType___ctor_1__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x047061F8, Queue_1_FullSerializer_Internal_fsVersionedType__System_Collections_ICollection_CopyTo__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04795E78, Queue_1_FullSerializer_Internal_fsVersionedType__ThrowForEmptyQueue__MethodInfo)
} // namespace app::classes::System::Collections::Generic::Queue_1_FullSerializer_Internal_fsVersionedType_

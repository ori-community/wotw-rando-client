...
#include <Modloader/app/structs/Dictionary_2_TKey_TValue_Enumerator_System_Object_System_Resources_ResourceLocator_.h>
...
#include <Modloader/app/structs/ICollection_1_System_Resources_ResourceLocator_.h>
#include <Modloader/app/structs/IDictionaryEnumerator.h>
#include <Modloader/app/structs/IDictionary_2_System_Object_System_Resources_ResourceLocator_.h>
#include <Modloader/app/structs/IEnumerable_1_System_Object_.h>
#include <Modloader/app/structs/IEnumerable_1_System_Resources_ResourceLocator_.h>
#include <Modloader/app/structs/IEnumerator.h>
#include <Modloader/app/structs/IEnumerator_1_KeyValuePair_2_System_Object_System_Resources_ResourceLocator_.h>
...
#include <Modloader/app/structs/KeyValuePair_2_System_Object_System_Resources_ResourceLocator___Array.h>
...
namespace app::classes::System::Collections::Generic::Dictionary_2_System_Object_System_Resources_ResourceLocator_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_3,
        app::Dictionary_2_System_Object_System_Resources_ResourceLocator_* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ctor_5,
        app::Dictionary_2_System_Object_System_Resources_ResourceLocator_* this_ptr,
        app::IDictionary_2_System_Object_System_Resources_ResourceLocator_* dictionary
    )
    IL2CPP_REGISTER_METHOD(
        0x02BD5280,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        0x0283B2B0,
        app::Dictionary_2_TKey_TValue_KeyCollection_System_Object_System_Resources_ResourceLocator_*,
        get_Keys,
        app::Dictionary_2_System_Object_System_Resources_ResourceLocator_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
    ...
    IL2CPP_REGISTER_METHOD(
        0x0283B3E0,
        app::Dictionary_2_TKey_TValue_ValueCollection_System_Object_System_Resources_ResourceLocator_*,
        get_Values,
        app::Dictionary_2_System_Object_System_Resources_ResourceLocator_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x0283B3E0,
        app::ICollection_1_System_Resources_ResourceLocator_*,
        System_Collections_Generic_IDictionary_TKey_TValue__get_Values,
        app::Dictionary_2_System_Object_System_Resources_ResourceLocator_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x0283B3E0,
        app::IEnumerable_1_System_Resources_ResourceLocator_*,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Dictionary_2_System_Object_System_Resources_ResourceLocator_* this_ptr,
        app::KeyValuePair_2_System_Object_System_Resources_ResourceLocator_ key_value_pair
    )
    IL2CPP_REGISTER_METHOD(
        0x02BC5880,
        bool,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        CopyTo,
        app::Dictionary_2_System_Object_System_Resources_ResourceLocator_* this_ptr,
        app::KeyValuePair_2_System_Object_System_Resources_ResourceLocator___Array* array,
        int32_t index
    )
    IL2CPP_REGISTER_METHOD(
        0x0283BD60,
        app::Dictionary_2_TKey_TValue_Enumerator_System_Object_System_Resources_ResourceLocator_,
        GetEnumerator,
        app::Dictionary_2_System_Object_System_Resources_ResourceLocator_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x0283BDB0,
        app::IEnumerator_1_KeyValuePair_2_System_Object_System_Resources_ResourceLocator_*,

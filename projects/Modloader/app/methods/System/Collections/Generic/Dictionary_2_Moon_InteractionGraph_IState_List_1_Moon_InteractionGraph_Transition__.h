...
namespace app::classes::System::Collections::Generic::Dictionary_2_Moon_InteractionGraph_IState_List_1_Moon_InteractionGraph_Transition__ {
    ...
    IL2CPP_REGISTER_METHOD(0x02BAC170, void, Add, (app::Dictionary_2_Moon_InteractionGraph_IState_List_1_Moon_InteractionGraph_Transition_ * this_ptr, app::IState_1* key, app::List_1_Moon_InteractionGraph_Transition_* value))

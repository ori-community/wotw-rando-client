...
namespace app::classes::System::Collections::Generic::ObjectEqualityComparer_1_Moon_Timeline_ExperimentalTransparencyAnimatorSystemStrategy_Request_ {
    IL2CPP_REGISTER_METHOD(
        ...
        bool,
        Equals_1,
        app::ObjectEqualityComparer_1_Moon_Timeline_ExperimentalTransparencyAnimatorSystemStrategy_Request_* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        GetHashCode_1,
        app::ObjectEqualityComparer_1_Moon_Timeline_ExperimentalTransparencyAnimatorSystemStrategy_Request_* this_ptr,
        app::ExperimentalTransparencyAnimatorSystemStrategy_Request obj
    )
    IL2CPP_REGISTER_METHOD(
        0x01CD3230,
        int32_t,

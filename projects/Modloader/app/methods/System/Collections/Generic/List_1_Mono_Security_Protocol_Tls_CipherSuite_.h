...
namespace app::classes::System::Collections::Generic::List_1_Mono_Security_Protocol_Tls_CipherSuite_ {
    ...
    IL2CPP_REGISTER_METHOD(0x00417870, bool, System_Collections_Generic_ICollection_T__get_IsReadOnly, (app::List_1_Mono_Security_Protocol_Tls_CipherSuite_ * this_ptr))
    ...
    IL2CPP_REGISTER_METHOD(0x025E95F0, void, CopyTo, (app::List_1_Mono_Security_Protocol_Tls_CipherSuite_ * this_ptr, app::CipherSuite__Array* array, int32_t array_index))
    ...
    IL2CPP_REGISTER_METHOD(0x025F0B50, app::IEnumerator_1_Mono_Security_Protocol_Tls_CipherSuite_*, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_Mono_Security_Protocol_Tls_CipherSuite_ * this_ptr))
    ...
    IL2CPP_REGISTER_METHOD(0x02FE8F50, void, ICollection_CopyTo, (app::List_1_Mono_Security_Protocol_Tls_CipherSuite_ * this_ptr, app::Array* array, int32_t array_index))

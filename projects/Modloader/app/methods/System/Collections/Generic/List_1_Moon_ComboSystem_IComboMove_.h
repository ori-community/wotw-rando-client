...
namespace app::classes::System::Collections::Generic::List_1_Moon_ComboSystem_IComboMove_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04794BE8, List_1_Moon_ComboSystem_IComboMove___ctor__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x022A4010, void, Clear, (app::List_1_Moon_ComboSystem_IComboMove_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04738D98, List_1_Moon_ComboSystem_IComboMove__Clear__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02FE8D00, bool, Contains, (app::List_1_Moon_ComboSystem_IComboMove_ * this_ptr, app::IComboMove* item))
    IL2CPP_REGISTER_METHODINFO(0x0470F638, List_1_Moon_ComboSystem_IComboMove__Contains__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02F1E150, void, Add, (app::List_1_Moon_ComboSystem_IComboMove_ * this_ptr, app::IComboMove* item))
    IL2CPP_REGISTER_METHODINFO(0x04780168, List_1_Moon_ComboSystem_IComboMove__Add__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_Moon_ComboSystem_IComboMove_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047227A8, List_1_Moon_ComboSystem_IComboMove__get_Count__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025EFC50, app::IComboMove*, get_Item, (app::List_1_Moon_ComboSystem_IComboMove_ * this_ptr, int32_t index))
    IL2CPP_REGISTER_METHODINFO(0x04753668, List_1_Moon_ComboSystem_IComboMove__get_Item__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04762068, List_1_Moon_ComboSystem_IComboMove__GetEnumerator__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04739960, List_1_Moon_ComboSystem_IComboMove__Insert__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025F0BE0, int32_t, IndexOf, (app::List_1_Moon_ComboSystem_IComboMove_ * this_ptr, app::IComboMove* item))
    IL2CPP_REGISTER_METHODINFO(0x04745028, List_1_Moon_ComboSystem_IComboMove__IndexOf__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025F12F0, bool, Remove, (app::List_1_Moon_ComboSystem_IComboMove_ * this_ptr, app::IComboMove* item))
    IL2CPP_REGISTER_METHODINFO(0x04747858, List_1_Moon_ComboSystem_IComboMove__Remove__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor_2, (app::List_1_Moon_ComboSystem_IComboMove_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0471DD50, List_1_Moon_ComboSystem_IComboMove___ctor_1__MethodInfo)
} // namespace app::classes::System::Collections::Generic::List_1_Moon_ComboSystem_IComboMove_

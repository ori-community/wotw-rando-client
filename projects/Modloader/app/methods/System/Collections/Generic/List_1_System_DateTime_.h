...
namespace app::classes::System::Collections::Generic::List_1_System_DateTime_ {
    ...
    IL2CPP_REGISTER_METHOD(0x025F01C0, int32_t, BinarySearch_1, (app::List_1_System_DateTime_ * this_ptr, int32_t index, int32_t count, app::DateTime item, app::IComparer_1_System_DateTime_* comparer))
    IL2CPP_REGISTER_METHOD(0x025F0230, int32_t, BinarySearch_2, (app::List_1_System_DateTime_ * this_ptr, app::DateTime item, app::IComparer_1_System_DateTime_* comparer))
    ...
    IL2CPP_REGISTER_METHOD(0x025E95B0, void, CopyTo_2, (app::List_1_System_DateTime_ * this_ptr, int32_t index, app::DateTime__Array* array, int32_t array_index, int32_t count))
    ...
    IL2CPP_REGISTER_METHOD(0x025F0880, int32_t, FindIndex_2, (app::List_1_System_DateTime_ * this_ptr, int32_t start_index, int32_t count, app::Predicate_1_DateTime_* match))
    ...
    IL2CPP_REGISTER_METHOD(0x025F0B50, app::IEnumerator_1_System_DateTime_*, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_System_DateTime_ * this_ptr))
    ...
    IL2CPP_REGISTER_METHOD(0x02EF2320, void, InsertRange, (app::List_1_System_DateTime_ * this_ptr, int32_t index, app::IEnumerable_1_System_DateTime_* collection))
    ...
    IL2CPP_REGISTER_METHOD(0x025EAE20, void, Sort_3, (app::List_1_System_DateTime_ * this_ptr, int32_t index, int32_t count, app::IComparer_1_System_DateTime_* comparer))

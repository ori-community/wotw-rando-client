...
#include <Modloader/app/structs/Dictionary_2_TKe_TValu_ValueCollectio_TKe_TValu_Enumerato_Syste_Int3_UnityEngin_RaycastHi_.h>
...
namespace app::classes::System::Collections::Generic::Dictionary_2_TKey_TValue__ValueCollection_System_Int32_UnityEngine_RaycastHit_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::Dictionary_2_TKey_TValue_ValueCollection_System_Int32_UnityEngine_RaycastHit_* this_ptr,
        app::Dictionary_2_System_Int32_UnityEngine_RaycastHit_* dictionary
    )
    IL2CPP_REGISTER_METHOD(
        0x026B1240,
        app::Dictionary_2_TKey_TValue_ValueCollection_TKey_TValue_Enumerator_System_Int32_UnityEngine_RaycastHit_,
        GetEnumerator,
        app::Dictionary_2_TKey_TValue_ValueCollection_System_Int32_UnityEngine_RaycastHit_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(

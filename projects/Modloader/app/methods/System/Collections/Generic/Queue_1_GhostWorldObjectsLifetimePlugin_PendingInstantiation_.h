...
namespace app::classes::System::Collections::Generic::Queue_1_GhostWorldObjectsLifetimePlugin_PendingInstantiation_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Dequeue,
        app::Queue_1_GhostWorldObjectsLifetimePlugin_PendingInstantiation_* this_ptr
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Enqueue,
        app::Queue_1_GhostWorldObjectsLifetimePlugin_PendingInstantiation_* this_ptr,
        app::GhostWorldObjectsLifetimePlugin_PendingInstantiation item
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x0243D290,
        app::Queue_1_T_Enumerator_GhostWorldObjectsLifetimePlugin_PendingInstantiation_,
        GetEnumerator,
        app::Queue_1_GhostWorldObjectsLifetimePlugin_PendingInstantiation_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x0243D2D0,
        app::IEnumerator_1_GhostWorldObjectsLifetimePlugin_PendingInstantiation_*,
    ...
    IL2CPP_REGISTER_METHOD(
        0x0243D5D0,
        app::GhostWorldObjectsLifetimePlugin_PendingInstantiation__Array*,
        ToArray,
        app::Queue_1_GhostWorldObjectsLifetimePlugin_PendingInstantiation_* this_ptr
    )

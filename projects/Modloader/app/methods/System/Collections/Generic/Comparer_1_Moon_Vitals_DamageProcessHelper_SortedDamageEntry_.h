...
namespace app::classes::System::Collections::Generic::Comparer_1_Moon_Vitals_DamageProcessHelper_SortedDamageEntry_ {
    IL2CPP_REGISTER_METHOD(0x0281D000, app::Comparer_1_Moon_Vitals_DamageProcessHelper_SortedDamageEntry_*, Create, (app::Comparison_1_Moon_Vitals_DamageProcessHelper_SortedDamageEntry_ * comparison))
    IL2CPP_REGISTER_METHODINFO(0x0478FF90, Comparer_1_Moon_Vitals_DamageProcessHelper_SortedDamageEntry__Create__MethodInfo)
    ...
    IL2CPP_REGISTER_METHOD(0x02808F10, int32_t, IComparer_Compare, (app::Comparer_1_Moon_Vitals_DamageProcessHelper_SortedDamageEntry_ * this_ptr, app::Object* x, app::Object* y))

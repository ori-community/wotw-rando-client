...
namespace app::classes::System::Collections::Generic::Queue_1_MeleeWeaponColliderStick_DebugCircle_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Enqueue,
        app::Queue_1_MeleeWeaponColliderStick_DebugCircle_* this_ptr,
        app::MeleeWeaponColliderStick_DebugCircle* item
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x02CA76E0,
        app::Queue_1_T_Enumerator_MeleeWeaponColliderStick_DebugCircle_,
        GetEnumerator,
        app::Queue_1_MeleeWeaponColliderStick_DebugCircle_* this_ptr
    )

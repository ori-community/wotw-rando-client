...
namespace app::classes::System::Collections::Generic::List_1_IPostProcessInfluencer_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04708DE8, List_1_IPostProcessInfluencer__get_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_IPostProcessInfluencer_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047826B0, List_1_IPostProcessInfluencer__get_Count__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025F1690, void, RemoveAt, (app::List_1_IPostProcessInfluencer_ * this_ptr, int32_t index))
    IL2CPP_REGISTER_METHODINFO(0x0472E448, List_1_IPostProcessInfluencer__RemoveAt__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x047981D8, List_1_IPostProcessInfluencer__Contains__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0475D440, List_1_IPostProcessInfluencer__Insert__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02F1E150, void, Add, (app::List_1_IPostProcessInfluencer_ * this_ptr, app::IPostProcessInfluencer* item))
    IL2CPP_REGISTER_METHODINFO(0x04779D38, List_1_IPostProcessInfluencer__Add__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04702CD8, List_1_IPostProcessInfluencer__Remove__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor, (app::List_1_IPostProcessInfluencer_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04794DF8, List_1_IPostProcessInfluencer___ctor__MethodInfo)
} // namespace app::classes::System::Collections::Generic::List_1_IPostProcessInfluencer_

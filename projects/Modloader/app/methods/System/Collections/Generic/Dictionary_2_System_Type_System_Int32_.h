...
namespace app::classes::System::Collections::Generic::Dictionary_2_System_Type_System_Int32_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04759F00, Dictionary_2_System_Type_System_Int32__TryGetValue__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x0283AC20, void, ctor_1, (app::Dictionary_2_System_Type_System_Int32_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0477A320, Dictionary_2_System_Type_System_Int32___ctor__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0471C1F0, Dictionary_2_System_Type_System_Int32__Add__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02259DF0, void, ctor_2, (app::Dictionary_2_System_Type_System_Int32_ * this_ptr, int32_t capacity))
    IL2CPP_REGISTER_METHODINFO(0x0470D9F0, Dictionary_2_System_Type_System_Int32___ctor_1__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x0283B2A0, int32_t, get_Count, (app::Dictionary_2_System_Type_System_Int32_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04704BA0, Dictionary_2_System_Type_System_Int32__get_Count__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02BA5090, bool, ContainsKey, (app::Dictionary_2_System_Type_System_Int32_ * this_ptr, app::Type* key))
    IL2CPP_REGISTER_METHODINFO(0x047704B0, Dictionary_2_System_Type_System_Int32__ContainsKey__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02BCC050, int32_t, get_Item, (app::Dictionary_2_System_Type_System_Int32_ * this_ptr, app::Type* key))
    IL2CPP_REGISTER_METHODINFO(0x0470C060, Dictionary_2_System_Type_System_Int32__get_Item__MethodInfo)
} // namespace app::classes::System::Collections::Generic::Dictionary_2_System_Type_System_Int32_

...
namespace app::classes::System::Collections::Generic::List_1_T__Enumerator_SaveSlotBackupsManager_BackupParseQueue_ {
    ...
    IL2CPP_REGISTER_METHOD(0x0014CA00, void, ctor, (app::List_1_T_Enumerator_SaveSlotBackupsManager_BackupParseQueue___Boxed * this_ptr, app::List_1_SaveSlotBackupsManager_BackupParseQueue_* list))
    ...
    IL2CPP_REGISTER_METHOD(0x0014CB40, app::Object*, IEnumerator_get_Current, (app::List_1_T_Enumerator_SaveSlotBackupsManager_BackupParseQueue___Boxed * this_ptr))

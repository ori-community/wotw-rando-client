...
namespace app::classes::System::Collections::Generic::List_1_UnityEngine_ParticleCollisionEvent_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02D2D9F0, void, ctor_3, (app::List_1_UnityEngine_ParticleCollisionEvent_ * this_ptr, app::IEnumerable_1_UnityEngine_ParticleCollisionEvent_* collection))
    ...
    IL2CPP_REGISTER_METHOD(0x00417870, bool, System_Collections_Generic_ICollection_T__get_IsReadOnly, (app::List_1_UnityEngine_ParticleCollisionEvent_ * this_ptr))
    ...
    IL2CPP_REGISTER_METHOD(0x02D24DF0, void, set_Item, (app::List_1_UnityEngine_ParticleCollisionEvent_ * this_ptr, int32_t index, app::ParticleCollisionEvent value))
    ...
    IL2CPP_REGISTER_METHOD(0x025E9020, void, AddRange, (app::List_1_UnityEngine_ParticleCollisionEvent_ * this_ptr, app::IEnumerable_1_UnityEngine_ParticleCollisionEvent_* collection))
    IL2CPP_REGISTER_METHOD(0x025E9050, app::ReadOnlyCollection_1_UnityEngine_ParticleCollisionEvent_*, AsReadOnly, (app::List_1_UnityEngine_ParticleCollisionEvent_ * this_ptr))
    IL2CPP_REGISTER_METHOD(0x02D25420, int32_t, BinarySearch_1, (app::List_1_UnityEngine_ParticleCollisionEvent_ * this_ptr, int32_t index, int32_t count, app::ParticleCollisionEvent item, app::IComparer_1_UnityEngine_ParticleCollisionEvent_* comparer))
    IL2CPP_REGISTER_METHOD(0x02D254D0, int32_t, BinarySearch_2, (app::List_1_UnityEngine_ParticleCollisionEvent_ * this_ptr, app::ParticleCollisionEvent item, app::IComparer_1_UnityEngine_ParticleCollisionEvent_* comparer))
    ...
    IL2CPP_REGISTER_METHOD(0x02D2E350, void, ICollection_CopyTo, (app::List_1_UnityEngine_ParticleCollisionEvent_ * this_ptr, app::Array* array, int32_t array_index))
    IL2CPP_REGISTER_METHOD(0x025E95B0, void, CopyTo_2, (app::List_1_UnityEngine_ParticleCollisionEvent_ * this_ptr, int32_t index, app::ParticleCollisionEvent__Array* array, int32_t array_index, int32_t count))
    IL2CPP_REGISTER_METHOD(0x025E95F0, void, CopyTo_3, (app::List_1_UnityEngine_ParticleCollisionEvent_ * this_ptr, app::ParticleCollisionEvent__Array* array, int32_t array_index))
    ...
    IL2CPP_REGISTER_METHOD(0x025E96A0, bool, Exists, (app::List_1_UnityEngine_ParticleCollisionEvent_ * this_ptr, app::Predicate_1_UnityEngine_ParticleCollisionEvent_* match))
    IL2CPP_REGISTER_METHOD(0x02D258D0, app::ParticleCollisionEvent, Find, (app::List_1_UnityEngine_ParticleCollisionEvent_ * this_ptr, app::Predicate_1_UnityEngine_ParticleCollisionEvent_* match))
    IL2CPP_REGISTER_METHOD(0x02D25A30, app::List_1_UnityEngine_ParticleCollisionEvent_*, FindAll, (app::List_1_UnityEngine_ParticleCollisionEvent_ * this_ptr, app::Predicate_1_UnityEngine_ParticleCollisionEvent_* match))
    IL2CPP_REGISTER_METHOD(0x025E9A20, int32_t, FindIndex_1, (app::List_1_UnityEngine_ParticleCollisionEvent_ * this_ptr, app::Predicate_1_UnityEngine_ParticleCollisionEvent_* match))
    IL2CPP_REGISTER_METHOD(0x02D25CA0, int32_t, FindIndex_2, (app::List_1_UnityEngine_ParticleCollisionEvent_ * this_ptr, int32_t start_index, int32_t count, app::Predicate_1_UnityEngine_ParticleCollisionEvent_* match))
    IL2CPP_REGISTER_METHOD(0x02D2E440, void, ForEach, (app::List_1_UnityEngine_ParticleCollisionEvent_ * this_ptr, app::Action_1_UnityEngine_ParticleCollisionEvent_* action))
    IL2CPP_REGISTER_METHOD(0x02D25F90, app::List_1_T_Enumerator_UnityEngine_ParticleCollisionEvent_, GetEnumerator, (app::List_1_UnityEngine_ParticleCollisionEvent_ * this_ptr))
    IL2CPP_REGISTER_METHOD(0x02D25FF0, app::IEnumerator_1_UnityEngine_ParticleCollisionEvent_*, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_UnityEngine_ParticleCollisionEvent_ * this_ptr))
    ...
    IL2CPP_REGISTER_METHOD(0x025E9DF0, app::List_1_UnityEngine_ParticleCollisionEvent_*, GetRange, (app::List_1_UnityEngine_ParticleCollisionEvent_ * this_ptr, int32_t index, int32_t count))
    ...
    IL2CPP_REGISTER_METHOD(0x02D2E7B0, void, InsertRange, (app::List_1_UnityEngine_ParticleCollisionEvent_ * this_ptr, int32_t index, app::IEnumerable_1_UnityEngine_ParticleCollisionEvent_* collection))
    ...
    IL2CPP_REGISTER_METHOD(0x02D26A60, int32_t, RemoveAll, (app::List_1_UnityEngine_ParticleCollisionEvent_ * this_ptr, app::Predicate_1_UnityEngine_ParticleCollisionEvent_* match))
    ...
    IL2CPP_REGISTER_METHOD(0x025EADB0, void, Sort_2, (app::List_1_UnityEngine_ParticleCollisionEvent_ * this_ptr, app::IComparer_1_UnityEngine_ParticleCollisionEvent_* comparer))
    IL2CPP_REGISTER_METHOD(0x025EAE20, void, Sort_3, (app::List_1_UnityEngine_ParticleCollisionEvent_ * this_ptr, int32_t index, int32_t count, app::IComparer_1_UnityEngine_ParticleCollisionEvent_* comparer))
    IL2CPP_REGISTER_METHOD(0x025EAEA0, void, Sort_4, (app::List_1_UnityEngine_ParticleCollisionEvent_ * this_ptr, app::Comparison_1_UnityEngine_ParticleCollisionEvent_* comparison))

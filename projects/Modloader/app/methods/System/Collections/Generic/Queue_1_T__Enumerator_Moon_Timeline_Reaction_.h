...
namespace app::classes::System::Collections::Generic::Queue_1_T__Enumerator_Moon_Timeline_Reaction_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04772A30, Queue_1_T_Enumerator_Moon_Timeline_Reaction__get_Current__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x001ED730, bool, MoveNext, (app::Queue_1_T_Enumerator_Moon_Timeline_Reaction___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047351E8, Queue_1_T_Enumerator_Moon_Timeline_Reaction__MoveNext__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x001ED710, void, Dispose, (app::Queue_1_T_Enumerator_Moon_Timeline_Reaction___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04714560, Queue_1_T_Enumerator_Moon_Timeline_Reaction__Dispose__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0473D278, Queue_1_T_Enumerator_Moon_Timeline_Reaction__ThrowEnumerationNotStartedOrEnded__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04750EF8, Queue_1_T_Enumerator_Moon_Timeline_Reaction__System_Collections_IEnumerator_Reset__MethodInfo)
} // namespace app::classes::System::Collections::Generic::Queue_1_T__Enumerator_Moon_Timeline_Reaction_

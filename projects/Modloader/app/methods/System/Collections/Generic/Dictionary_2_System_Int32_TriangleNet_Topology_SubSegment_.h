...
namespace app::classes::System::Collections::Generic::Dictionary_2_System_Int32_TriangleNet_Topology_SubSegment_ {
    ...
    IL2CPP_REGISTER_METHOD(
        0x0283B3E0,
        app::Dictionary_2_TKey_TValue_ValueCollection_System_Int32_TriangleNet_Topology_SubSegment_*,
        get_Values,
        app::Dictionary_2_System_Int32_TriangleNet_Topology_SubSegment_* this_ptr
    )

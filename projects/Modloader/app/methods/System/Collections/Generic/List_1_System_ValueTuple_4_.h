...
namespace app::classes::System::Collections::Generic::List_1_System_ValueTuple_4_ {
    ...
    IL2CPP_REGISTER_METHOD(0x025EC7A0, void, set_Item, (app::List_1_System_ValueTuple_4__1 * this_ptr, int32_t index, app::ValueTuple_4_Object_Int32_Int32_Single_ value))
    ...
    IL2CPP_REGISTER_METHOD(0x025ECD80, int32_t, BinarySearch_1, (app::List_1_System_ValueTuple_4__1 * this_ptr, int32_t index, int32_t count, app::ValueTuple_4_Object_Int32_Int32_Single_ item, app::IComparer_1_System_ValueTuple_4_* comparer))
    IL2CPP_REGISTER_METHOD(0x025ECE20, int32_t, BinarySearch_2, (app::List_1_System_ValueTuple_4__1 * this_ptr, app::ValueTuple_4_Object_Int32_Int32_Single_ item, app::IComparer_1_System_ValueTuple_4_* comparer))
    ...
    IL2CPP_REGISTER_METHOD(0x025E95B0, void, CopyTo_2, (app::List_1_System_ValueTuple_4__1 * this_ptr, int32_t index, app::ValueTuple_4_Object_Int32_Int32_Single___Array* array, int32_t array_index, int32_t count))
    IL2CPP_REGISTER_METHOD(0x025E95F0, void, CopyTo_3, (app::List_1_System_ValueTuple_4__1 * this_ptr, app::ValueTuple_4_Object_Int32_Int32_Single___Array* array, int32_t array_index))
    IL2CPP_REGISTER_METHOD(0x025E9620, void, EnsureCapacity, (app::List_1_System_ValueTuple_4__1 * this_ptr, int32_t min))
    IL2CPP_REGISTER_METHOD(0x025E96A0, bool, Exists, (app::List_1_System_ValueTuple_4__1 * this_ptr, app::Predicate_1_ValueTuple_4_Object_Int32_Int32_Single_* match))
    IL2CPP_REGISTER_METHOD(0x025ED1F0, app::ValueTuple_4_Object_Int32_Int32_Single_, Find, (app::List_1_System_ValueTuple_4__1 * this_ptr, app::Predicate_1_ValueTuple_4_Object_Int32_Int32_Single_* match))
    IL2CPP_REGISTER_METHOD(0x025ED330, app::List_1_System_ValueTuple_4__1*, FindAll, (app::List_1_System_ValueTuple_4__1 * this_ptr, app::Predicate_1_ValueTuple_4_Object_Int32_Int32_Single_* match))
    IL2CPP_REGISTER_METHOD(0x025E9A20, int32_t, FindIndex_1, (app::List_1_System_ValueTuple_4__1 * this_ptr, app::Predicate_1_ValueTuple_4_Object_Int32_Int32_Single_* match))
    IL2CPP_REGISTER_METHOD(0x025ED580, int32_t, FindIndex_2, (app::List_1_System_ValueTuple_4__1 * this_ptr, int32_t start_index, int32_t count, app::Predicate_1_ValueTuple_4_Object_Int32_Int32_Single_* match))
    IL2CPP_REGISTER_METHOD(0x02F22F00, void, ForEach, (app::List_1_System_ValueTuple_4__1 * this_ptr, app::Action_1_ValueTuple_4_Object_Int32_Int32_Single_* action))
    ...
    IL2CPP_REGISTER_METHOD(0x025ED8A0, app::IEnumerator_1_System_ValueTuple_4__1*, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_System_ValueTuple_4__1 * this_ptr))
    IL2CPP_REGISTER_METHOD(0x025ED8A0, app::IEnumerator*, IEnumerable_GetEnumerator, (app::List_1_System_ValueTuple_4__1 * this_ptr))
    IL2CPP_REGISTER_METHOD(0x025E9DF0, app::List_1_System_ValueTuple_4__1*, GetRange, (app::List_1_System_ValueTuple_4__1 * this_ptr, int32_t index, int32_t count))
    ...
    IL2CPP_REGISTER_METHOD(0x025EDAF0, void, Insert, (app::List_1_System_ValueTuple_4__1 * this_ptr, int32_t index, app::ValueTuple_4_Object_Int32_Int32_Single_ item))
    ...
    IL2CPP_REGISTER_METHOD(0x02F23250, void, InsertRange, (app::List_1_System_ValueTuple_4__1 * this_ptr, int32_t index, app::IEnumerable_1_System_ValueTuple_4_* collection))
    ...
    IL2CPP_REGISTER_METHOD(0x025EE2B0, int32_t, RemoveAll, (app::List_1_System_ValueTuple_4__1 * this_ptr, app::Predicate_1_ValueTuple_4_Object_Int32_Int32_Single_* match))
    ...
    IL2CPP_REGISTER_METHOD(0x025EAE20, void, Sort_3, (app::List_1_System_ValueTuple_4__1 * this_ptr, int32_t index, int32_t count, app::IComparer_1_System_ValueTuple_4_* comparer))
    IL2CPP_REGISTER_METHOD(0x025EAEA0, void, Sort_4, (app::List_1_System_ValueTuple_4__1 * this_ptr, app::Comparison_1_ValueTuple_4_Object_Int32_Int32_Single_* comparison))

...
namespace app::classes::System::Collections::Generic::List_1_VerticalSpacer_Item_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t,
        BinarySearch_1,
        app::List_1_VerticalSpacer_Item_* this_ptr,
        int32_t index,
        int32_t count,
        app::VerticalSpacer_Item item,
    ...
    IL2CPP_REGISTER_METHOD(
        0x02C1EB60,
        app::List_1_VerticalSpacer_Item_*,
        FindAll,
        app::List_1_VerticalSpacer_Item_* this_ptr,
        app::Predicate_1_VerticalSpacer_Item_* match
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x02C1F0C0,
        app::IEnumerator_1_VerticalSpacer_Item_*,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::List_1_VerticalSpacer_Item_* this_ptr,
        int32_t index,
        app::IEnumerable_1_VerticalSpacer_Item_* collection
    )

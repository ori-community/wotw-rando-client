...
namespace app::classes::System::Collections::Generic::List_1_TriangleNet_Topology_Otri_ {
    ...
    IL2CPP_REGISTER_METHOD(0x025E9020, void, AddRange, (app::List_1_TriangleNet_Topology_Otri_ * this_ptr, app::IEnumerable_1_TriangleNet_Topology_Otri_* collection))
    ...
    IL2CPP_REGISTER_METHOD(0x025E9160, int32_t, BinarySearch_1, (app::List_1_TriangleNet_Topology_Otri_ * this_ptr, int32_t index, int32_t count, app::Otri item, app::IComparer_1_TriangleNet_Topology_Otri_* comparer))
    IL2CPP_REGISTER_METHOD(0x025E91F0, int32_t, BinarySearch_2, (app::List_1_TriangleNet_Topology_Otri_ * this_ptr, app::Otri item, app::IComparer_1_TriangleNet_Topology_Otri_* comparer))
    ...
    IL2CPP_REGISTER_METHOD(0x025E95B0, void, CopyTo_2, (app::List_1_TriangleNet_Topology_Otri_ * this_ptr, int32_t index, app::Otri__Array* array, int32_t array_index, int32_t count))
    ...
    IL2CPP_REGISTER_METHOD(0x025E9800, app::List_1_TriangleNet_Topology_Otri_*, FindAll, (app::List_1_TriangleNet_Topology_Otri_ * this_ptr, app::Predicate_1_TriangleNet_Topology_Otri_* match))
    IL2CPP_REGISTER_METHOD(0x025E9A20, int32_t, FindIndex_1, (app::List_1_TriangleNet_Topology_Otri_ * this_ptr, app::Predicate_1_TriangleNet_Topology_Otri_* match))
    IL2CPP_REGISTER_METHOD(0x025E9A50, int32_t, FindIndex_2, (app::List_1_TriangleNet_Topology_Otri_ * this_ptr, int32_t start_index, int32_t count, app::Predicate_1_TriangleNet_Topology_Otri_* match))
    ...
    IL2CPP_REGISTER_METHOD(0x025E9D60, app::IEnumerator_1_TriangleNet_Topology_Otri_*, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_TriangleNet_Topology_Otri_ * this_ptr))
    ...
    IL2CPP_REGISTER_METHOD(0x025E9DF0, app::List_1_TriangleNet_Topology_Otri_*, GetRange, (app::List_1_TriangleNet_Topology_Otri_ * this_ptr, int32_t index, int32_t count))
    ...
    IL2CPP_REGISTER_METHOD(0x02ED6E40, void, InsertRange, (app::List_1_TriangleNet_Topology_Otri_ * this_ptr, int32_t index, app::IEnumerable_1_TriangleNet_Topology_Otri_* collection))
    ...
    IL2CPP_REGISTER_METHOD(0x025EAE20, void, Sort_3, (app::List_1_TriangleNet_Topology_Otri_ * this_ptr, int32_t index, int32_t count, app::IComparer_1_TriangleNet_Topology_Otri_* comparer))

...
namespace app::classes::System::Collections::Generic::Dictionary_2_TKey_TValue__KeyCollection_System_Object_KeyValuePair_2_System_Object_System_Object__ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::Dictionary_2_TKey_TValue_KeyCollection_System_Object_KeyValuePair_2_System_Object_System_Object_* this_ptr,
        app::Dictionary_2_System_Object_KeyValuePair_2_System_Object_System_Object_* dictionary
    )
    IL2CPP_REGISTER_METHOD(
        0x01A729A0,
        app::Dictionary_2_TKey_TValue_KeyCollection_TKey_TValue_Enumerator_System_Object_KeyValuePair_2_System_Object_System_Object_,
        GetEnumerator,
        app::Dictionary_2_TKey_TValue_KeyCollection_System_Object_KeyValuePair_2_System_Object_System_Object_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(

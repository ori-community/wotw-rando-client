...
namespace app::classes::System::Collections::Generic::Dictionary_2_SurfaceMaterialType_UnityEngine_ParticleSystem_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        bool,
        ContainsKey,
        app::Dictionary_2_SurfaceMaterialType_UnityEngine_ParticleSystem_* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        0x02BA5400,
        app::Dictionary_2_TKey_TValue_Enumerator_SurfaceMaterialType_UnityEngine_ParticleSystem_,
        GetEnumerator,
        app::Dictionary_2_SurfaceMaterialType_UnityEngine_ParticleSystem_* this_ptr
    )

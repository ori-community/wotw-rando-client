...
namespace app::classes::System::Collections::Generic::List_1_DistortionAnimator_RendererData_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x047477F8, List_1_DistortionAnimator_RendererData__Clear__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0475A2B0, List_1_DistortionAnimator_RendererData__Add__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0475AF28, List_1_DistortionAnimator_RendererData__get_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_DistortionAnimator_RendererData_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047340E8, List_1_DistortionAnimator_RendererData__get_Count__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor_1, (app::List_1_DistortionAnimator_RendererData_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04739148, List_1_DistortionAnimator_RendererData___ctor__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E81E0, void, ctor_2, (app::List_1_DistortionAnimator_RendererData_ * this_ptr, int32_t capacity))
    IL2CPP_REGISTER_METHOD(0x02E5CA20, void, ctor_3, (app::List_1_DistortionAnimator_RendererData_ * this_ptr, app::IEnumerable_1_DistortionAnimator_RendererData_* collection))
    ...
    IL2CPP_REGISTER_METHOD(0x025EC7A0, void, set_Item, (app::List_1_DistortionAnimator_RendererData_ * this_ptr, int32_t index, app::DistortionAnimator_RendererData value))
    ...
    IL2CPP_REGISTER_METHOD(0x025E9020, void, AddRange, (app::List_1_DistortionAnimator_RendererData_ * this_ptr, app::IEnumerable_1_DistortionAnimator_RendererData_* collection))
    IL2CPP_REGISTER_METHOD(0x025E9050, app::ReadOnlyCollection_1_DistortionAnimator_RendererData_*, AsReadOnly, (app::List_1_DistortionAnimator_RendererData_ * this_ptr))
    IL2CPP_REGISTER_METHOD(0x025ECD80, int32_t, BinarySearch_1, (app::List_1_DistortionAnimator_RendererData_ * this_ptr, int32_t index, int32_t count, app::DistortionAnimator_RendererData item, app::IComparer_1_DistortionAnimator_RendererData_* comparer))
    IL2CPP_REGISTER_METHOD(0x025ECE20, int32_t, BinarySearch_2, (app::List_1_DistortionAnimator_RendererData_ * this_ptr, app::DistortionAnimator_RendererData item, app::IComparer_1_DistortionAnimator_RendererData_* comparer))
    ...
    IL2CPP_REGISTER_METHOD(0x025E9490, void, CopyTo_1, (app::List_1_DistortionAnimator_RendererData_ * this_ptr, app::DistortionAnimator_RendererData__Array* array))
    ...
    IL2CPP_REGISTER_METHOD(0x025E95B0, void, CopyTo_2, (app::List_1_DistortionAnimator_RendererData_ * this_ptr, int32_t index, app::DistortionAnimator_RendererData__Array* array, int32_t array_index, int32_t count))
    IL2CPP_REGISTER_METHOD(0x025E95F0, void, CopyTo_3, (app::List_1_DistortionAnimator_RendererData_ * this_ptr, app::DistortionAnimator_RendererData__Array* array, int32_t array_index))
    IL2CPP_REGISTER_METHOD(0x025E9620, void, EnsureCapacity, (app::List_1_DistortionAnimator_RendererData_ * this_ptr, int32_t min))
    IL2CPP_REGISTER_METHOD(0x025E96A0, bool, Exists, (app::List_1_DistortionAnimator_RendererData_ * this_ptr, app::Predicate_1_DistortionAnimator_RendererData_* match))
    IL2CPP_REGISTER_METHOD(0x025ED1F0, app::DistortionAnimator_RendererData, Find, (app::List_1_DistortionAnimator_RendererData_ * this_ptr, app::Predicate_1_DistortionAnimator_RendererData_* match))
    IL2CPP_REGISTER_METHOD(0x025ED330, app::List_1_DistortionAnimator_RendererData_*, FindAll, (app::List_1_DistortionAnimator_RendererData_ * this_ptr, app::Predicate_1_DistortionAnimator_RendererData_* match))
    IL2CPP_REGISTER_METHOD(0x025E9A20, int32_t, FindIndex_1, (app::List_1_DistortionAnimator_RendererData_ * this_ptr, app::Predicate_1_DistortionAnimator_RendererData_* match))
    IL2CPP_REGISTER_METHOD(0x025ED580, int32_t, FindIndex_2, (app::List_1_DistortionAnimator_RendererData_ * this_ptr, int32_t start_index, int32_t count, app::Predicate_1_DistortionAnimator_RendererData_* match))
    IL2CPP_REGISTER_METHOD(0x02E5D450, void, ForEach, (app::List_1_DistortionAnimator_RendererData_ * this_ptr, app::Action_1_DistortionAnimator_RendererData_* action))
    IL2CPP_REGISTER_METHOD(0x025ED850, app::List_1_T_Enumerator_DistortionAnimator_RendererData_, GetEnumerator, (app::List_1_DistortionAnimator_RendererData_ * this_ptr))
    IL2CPP_REGISTER_METHOD(0x025ED8A0, app::IEnumerator_1_DistortionAnimator_RendererData_*, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_DistortionAnimator_RendererData_ * this_ptr))
    ...
    IL2CPP_REGISTER_METHOD(0x025E9DF0, app::List_1_DistortionAnimator_RendererData_*, GetRange, (app::List_1_DistortionAnimator_RendererData_ * this_ptr, int32_t index, int32_t count))
    ...
    IL2CPP_REGISTER_METHOD(0x025EDAF0, void, Insert, (app::List_1_DistortionAnimator_RendererData_ * this_ptr, int32_t index, app::DistortionAnimator_RendererData item))
    ...
    IL2CPP_REGISTER_METHOD(0x02E5D7A0, void, InsertRange, (app::List_1_DistortionAnimator_RendererData_ * this_ptr, int32_t index, app::IEnumerable_1_DistortionAnimator_RendererData_* collection))
    ...
    IL2CPP_REGISTER_METHOD(0x025EE2B0, int32_t, RemoveAll, (app::List_1_DistortionAnimator_RendererData_ * this_ptr, app::Predicate_1_DistortionAnimator_RendererData_* match))
    ...
    IL2CPP_REGISTER_METHOD(0x025EADB0, void, Sort_2, (app::List_1_DistortionAnimator_RendererData_ * this_ptr, app::IComparer_1_DistortionAnimator_RendererData_* comparer))
    IL2CPP_REGISTER_METHOD(0x025EAE20, void, Sort_3, (app::List_1_DistortionAnimator_RendererData_ * this_ptr, int32_t index, int32_t count, app::IComparer_1_DistortionAnimator_RendererData_* comparer))
    IL2CPP_REGISTER_METHOD(0x025EAEA0, void, Sort_4, (app::List_1_DistortionAnimator_RendererData_ * this_ptr, app::Comparison_1_DistortionAnimator_RendererData_* comparison))

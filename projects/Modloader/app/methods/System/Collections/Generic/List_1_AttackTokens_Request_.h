...
#include <Modloader/app/structs/IEnumerable_1_AttackTokens_Request_.h>
...
#include <Modloader/app/structs/List_1_T_Enumerator_AttackTokens_Request_.h>
...
namespace app::classes::System::Collections::Generic::List_1_AttackTokens_Request_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t,
        BinarySearch_1,
        app::List_1_AttackTokens_Request_* this_ptr,
        int32_t index,
        int32_t count,
        app::AttackTokens_Request item,
        app::IComparer_1_AttackTokens_Request_* comparer
    )
    IL2CPP_REGISTER_METHOD(
        0x025ECE20,
        int32_t,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Find,
        app::List_1_AttackTokens_Request_* this_ptr,
        app::Predicate_1_AttackTokens_Request_* match
    )
    IL2CPP_REGISTER_METHOD(
        0x025ED330,
        app::List_1_AttackTokens_Request_*,
        FindAll,
        app::List_1_AttackTokens_Request_* this_ptr,
        app::Predicate_1_AttackTokens_Request_* match
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x025ED8A0,
        app::IEnumerator_1_AttackTokens_Request_*,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::List_1_AttackTokens_Request_* this_ptr,
        int32_t index,
        app::IEnumerable_1_AttackTokens_Request_* collection
    )

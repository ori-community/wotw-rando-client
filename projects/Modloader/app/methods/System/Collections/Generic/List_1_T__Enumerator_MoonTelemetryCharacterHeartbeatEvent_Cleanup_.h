...
namespace app::classes::System::Collections::Generic::List_1_T__Enumerator_MoonTelemetryCharacterHeartbeatEvent_Cleanup_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0477D7E0, List_1_T_Enumerator_MoonTelemetryCharacterHeartbeatEvent_Cleanup__get_Current__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x047633D0, List_1_T_Enumerator_MoonTelemetryCharacterHeartbeatEvent_Cleanup__MoveNext__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04737168, List_1_T_Enumerator_MoonTelemetryCharacterHeartbeatEvent_Cleanup__Dispose__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x0014D030, void, ctor, (app::List_1_T_Enumerator_MoonTelemetryCharacterHeartbeatEvent_Cleanup___Boxed * this_ptr, app::List_1_MoonTelemetryCharacterHeartbeatEvent_Cleanup_* list))
    ...
    IL2CPP_REGISTER_METHOD(0x0014D1A0, app::Object*, IEnumerator_get_Current, (app::List_1_T_Enumerator_MoonTelemetryCharacterHeartbeatEvent_Cleanup___Boxed * this_ptr))

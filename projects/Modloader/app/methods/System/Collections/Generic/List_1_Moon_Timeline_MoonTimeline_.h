...
namespace app::classes::System::Collections::Generic::List_1_Moon_Timeline_MoonTimeline_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04775228, List_1_Moon_Timeline_MoonTimeline__Clear__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02F1E150, void, Add, (app::List_1_Moon_Timeline_MoonTimeline_ * this_ptr, app::MoonTimeline* item))
    IL2CPP_REGISTER_METHODINFO(0x0473D888, List_1_Moon_Timeline_MoonTimeline__Add__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025F12F0, bool, Remove, (app::List_1_Moon_Timeline_MoonTimeline_ * this_ptr, app::MoonTimeline* item))
    IL2CPP_REGISTER_METHODINFO(0x04742808, List_1_Moon_Timeline_MoonTimeline__Remove__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04795778, List_1_Moon_Timeline_MoonTimeline__GetEnumerator__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor, (app::List_1_Moon_Timeline_MoonTimeline_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0472CA70, List_1_Moon_Timeline_MoonTimeline___ctor__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0474F0B0, List_1_Moon_Timeline_MoonTimeline__get_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_Moon_Timeline_MoonTimeline_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0478D660, List_1_Moon_Timeline_MoonTimeline__get_Count__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025EAC80, void, Reverse, (app::List_1_Moon_Timeline_MoonTimeline_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04773C40, List_1_Moon_Timeline_MoonTimeline__Reverse__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02FE8D00, bool, Contains, (app::List_1_Moon_Timeline_MoonTimeline_ * this_ptr, app::MoonTimeline* item))
    IL2CPP_REGISTER_METHODINFO(0x04721AE0, List_1_Moon_Timeline_MoonTimeline__Contains__MethodInfo)
} // namespace app::classes::System::Collections::Generic::List_1_Moon_Timeline_MoonTimeline_

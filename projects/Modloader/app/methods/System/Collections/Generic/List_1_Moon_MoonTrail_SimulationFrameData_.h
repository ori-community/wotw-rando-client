...
namespace app::classes::System::Collections::Generic::List_1_Moon_MoonTrail_SimulationFrameData_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02DE48E0, void, ctor_3, (app::List_1_Moon_MoonTrail_SimulationFrameData_ * this_ptr, app::IEnumerable_1_Moon_MoonTrail_SimulationFrameData_* collection))
    ...
    IL2CPP_REGISTER_METHOD(0x00417870, bool, System_Collections_Generic_ICollection_T__get_IsReadOnly, (app::List_1_Moon_MoonTrail_SimulationFrameData_ * this_ptr))
    ...
    IL2CPP_REGISTER_METHOD(0x02DE4F20, void, set_Item, (app::List_1_Moon_MoonTrail_SimulationFrameData_ * this_ptr, int32_t index, app::MoonTrail_SimulationFrameData value))
    ...
    IL2CPP_REGISTER_METHOD(0x025E9020, void, AddRange, (app::List_1_Moon_MoonTrail_SimulationFrameData_ * this_ptr, app::IEnumerable_1_Moon_MoonTrail_SimulationFrameData_* collection))
    IL2CPP_REGISTER_METHOD(0x025E9050, app::ReadOnlyCollection_1_Moon_MoonTrail_SimulationFrameData_*, AsReadOnly, (app::List_1_Moon_MoonTrail_SimulationFrameData_ * this_ptr))
    IL2CPP_REGISTER_METHOD(0x02DE5510, int32_t, BinarySearch_1, (app::List_1_Moon_MoonTrail_SimulationFrameData_ * this_ptr, int32_t index, int32_t count, app::MoonTrail_SimulationFrameData item, app::IComparer_1_Moon_MoonTrail_SimulationFrameData_* comparer))
    IL2CPP_REGISTER_METHOD(0x02DE55C0, int32_t, BinarySearch_2, (app::List_1_Moon_MoonTrail_SimulationFrameData_ * this_ptr, app::MoonTrail_SimulationFrameData item, app::IComparer_1_Moon_MoonTrail_SimulationFrameData_* comparer))
    ...
    IL2CPP_REGISTER_METHOD(0x025E9490, void, CopyTo_1, (app::List_1_Moon_MoonTrail_SimulationFrameData_ * this_ptr, app::MoonTrail_SimulationFrameData__Array* array))
    IL2CPP_REGISTER_METHOD(0x02DE58D0, void, ICollection_CopyTo, (app::List_1_Moon_MoonTrail_SimulationFrameData_ * this_ptr, app::Array* array, int32_t array_index))
    IL2CPP_REGISTER_METHOD(0x025E95B0, void, CopyTo_2, (app::List_1_Moon_MoonTrail_SimulationFrameData_ * this_ptr, int32_t index, app::MoonTrail_SimulationFrameData__Array* array, int32_t array_index, int32_t count))
    IL2CPP_REGISTER_METHOD(0x025E95F0, void, CopyTo_3, (app::List_1_Moon_MoonTrail_SimulationFrameData_ * this_ptr, app::MoonTrail_SimulationFrameData__Array* array, int32_t array_index))
    ...
    IL2CPP_REGISTER_METHOD(0x025E96A0, bool, Exists, (app::List_1_Moon_MoonTrail_SimulationFrameData_ * this_ptr, app::Predicate_1_Moon_MoonTrail_SimulationFrameData_* match))
    IL2CPP_REGISTER_METHOD(0x02DE59C0, app::MoonTrail_SimulationFrameData, Find, (app::List_1_Moon_MoonTrail_SimulationFrameData_ * this_ptr, app::Predicate_1_Moon_MoonTrail_SimulationFrameData_* match))
    IL2CPP_REGISTER_METHOD(0x02DE5B10, app::List_1_Moon_MoonTrail_SimulationFrameData_*, FindAll, (app::List_1_Moon_MoonTrail_SimulationFrameData_ * this_ptr, app::Predicate_1_Moon_MoonTrail_SimulationFrameData_* match))
    IL2CPP_REGISTER_METHOD(0x025E9A20, int32_t, FindIndex_1, (app::List_1_Moon_MoonTrail_SimulationFrameData_ * this_ptr, app::Predicate_1_Moon_MoonTrail_SimulationFrameData_* match))
    IL2CPP_REGISTER_METHOD(0x02DE5D60, int32_t, FindIndex_2, (app::List_1_Moon_MoonTrail_SimulationFrameData_ * this_ptr, int32_t start_index, int32_t count, app::Predicate_1_Moon_MoonTrail_SimulationFrameData_* match))
    IL2CPP_REGISTER_METHOD(0x02DE5E90, void, ForEach, (app::List_1_Moon_MoonTrail_SimulationFrameData_ * this_ptr, app::Action_1_Moon_MoonTrail_SimulationFrameData_* action))
    IL2CPP_REGISTER_METHOD(0x02DE6050, app::List_1_T_Enumerator_Moon_MoonTrail_SimulationFrameData_, GetEnumerator, (app::List_1_Moon_MoonTrail_SimulationFrameData_ * this_ptr))
    IL2CPP_REGISTER_METHOD(0x02DE60A0, app::IEnumerator_1_Moon_MoonTrail_SimulationFrameData_*, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_Moon_MoonTrail_SimulationFrameData_ * this_ptr))
    ...
    IL2CPP_REGISTER_METHOD(0x025E9DF0, app::List_1_Moon_MoonTrail_SimulationFrameData_*, GetRange, (app::List_1_Moon_MoonTrail_SimulationFrameData_ * this_ptr, int32_t index, int32_t count))
    ...
    IL2CPP_REGISTER_METHOD(0x02DE6300, void, Insert, (app::List_1_Moon_MoonTrail_SimulationFrameData_ * this_ptr, int32_t index, app::MoonTrail_SimulationFrameData item))
    ...
    IL2CPP_REGISTER_METHOD(0x02DE6590, void, InsertRange, (app::List_1_Moon_MoonTrail_SimulationFrameData_ * this_ptr, int32_t index, app::IEnumerable_1_Moon_MoonTrail_SimulationFrameData_* collection))
    ...
    IL2CPP_REGISTER_METHOD(0x02DE6AE0, int32_t, RemoveAll, (app::List_1_Moon_MoonTrail_SimulationFrameData_ * this_ptr, app::Predicate_1_Moon_MoonTrail_SimulationFrameData_* match))
    ...
    IL2CPP_REGISTER_METHOD(0x025EADB0, void, Sort_2, (app::List_1_Moon_MoonTrail_SimulationFrameData_ * this_ptr, app::IComparer_1_Moon_MoonTrail_SimulationFrameData_* comparer))
    IL2CPP_REGISTER_METHOD(0x025EAE20, void, Sort_3, (app::List_1_Moon_MoonTrail_SimulationFrameData_ * this_ptr, int32_t index, int32_t count, app::IComparer_1_Moon_MoonTrail_SimulationFrameData_* comparer))
    IL2CPP_REGISTER_METHOD(0x025EAEA0, void, Sort_4, (app::List_1_Moon_MoonTrail_SimulationFrameData_ * this_ptr, app::Comparison_1_Moon_MoonTrail_SimulationFrameData_* comparison))

...
namespace app::classes::System::Collections::Generic::ObjectEqualityComparer_1_Moon_UI_TextBoxLine_ {
    ...
    IL2CPP_REGISTER_METHOD(0x01CD1D00, int32_t, IndexOf, (app::ObjectEqualityComparer_1_Moon_UI_TextBoxLine_ * this_ptr, app::TextBoxLine_1__Array* array, app::TextBoxLine_1 value, int32_t start_index, int32_t count))
    IL2CPP_REGISTER_METHOD(0x01CD1EA0, int32_t, LastIndexOf, (app::ObjectEqualityComparer_1_Moon_UI_TextBoxLine_ * this_ptr, app::TextBoxLine_1__Array* array, app::TextBoxLine_1 value, int32_t start_index, int32_t count))

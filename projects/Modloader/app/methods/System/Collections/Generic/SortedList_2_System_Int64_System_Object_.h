...
namespace app::classes::System::Collections::Generic::SortedList_2_System_Int64_System_Object_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02CB0D00, void, System_Collections_Generic_ICollection_System_Collections_Generic_KeyValuePair_TKey_TValue___Add, (app::SortedList_2_System_Int64_System_Object_ * this_ptr, app::KeyValuePair_2_System_Int64_System_Object_ key_value_pair))
    IL2CPP_REGISTER_METHOD(0x02CB0D30, bool, System_Collections_Generic_ICollection_System_Collections_Generic_KeyValuePair_TKey_TValue___Contains, (app::SortedList_2_System_Int64_System_Object_ * this_ptr, app::KeyValuePair_2_System_Int64_System_Object_ key_value_pair))
    IL2CPP_REGISTER_METHOD(0x02CB0E00, bool, System_Collections_Generic_ICollection_System_Collections_Generic_KeyValuePair_TKey_TValue___Remove, (app::SortedList_2_System_Int64_System_Object_ * this_ptr, app::KeyValuePair_2_System_Int64_System_Object_ key_value_pair))
    ...
    IL2CPP_REGISTER_METHOD(0x01D0DC00, app::ICollection_1_System_Int64_*, System_Collections_Generic_IDictionary_TKey_TValue__get_Keys, (app::SortedList_2_System_Int64_System_Object_ * this_ptr))
    ...
    IL2CPP_REGISTER_METHOD(0x01D0DC00, app::IEnumerable_1_System_Int64_*, System_Collections_Generic_IReadOnlyDictionary_TKey_TValue__get_Keys, (app::SortedList_2_System_Int64_System_Object_ * this_ptr))
    ...
    IL2CPP_REGISTER_METHOD(0x02CAEF10, app::ICollection_1_System_Object_*, System_Collections_Generic_IDictionary_TKey_TValue__get_Values, (app::SortedList_2_System_Int64_System_Object_ * this_ptr))
    ...
    IL2CPP_REGISTER_METHOD(0x02CAEF10, app::IEnumerable_1_System_Object_*, System_Collections_Generic_IReadOnlyDictionary_TKey_TValue__get_Values, (app::SortedList_2_System_Int64_System_Object_ * this_ptr))
    IL2CPP_REGISTER_METHOD(0x02CAEF40, app::SortedList_2_TKey_TValue_KeyList_System_Int64_System_Object_*, GetKeyListHelper, (app::SortedList_2_System_Int64_System_Object_ * this_ptr))
    IL2CPP_REGISTER_METHOD(0x02CAF070, app::SortedList_2_TKey_TValue_ValueList_System_Int64_System_Object_*, GetValueListHelper, (app::SortedList_2_System_Int64_System_Object_ * this_ptr))
    IL2CPP_REGISTER_METHOD(0x00417870, bool, System_Collections_Generic_ICollection_System_Collections_Generic_KeyValuePair_TKey_TValue___get_IsReadOnly, (app::SortedList_2_System_Int64_System_Object_ * this_ptr))
    ...
    IL2CPP_REGISTER_METHOD(0x02CB1620, void, System_Collections_Generic_ICollection_System_Collections_Generic_KeyValuePair_TKey_TValue___CopyTo, (app::SortedList_2_System_Int64_System_Object_ * this_ptr, app::KeyValuePair_2_System_Int64_System_Object___Array* array, int32_t array_index))
    ...
    IL2CPP_REGISTER_METHOD(0x02CB1EC0, app::IEnumerator_1_KeyValuePair_2_System_Int64_System_Object_*, GetEnumerator, (app::SortedList_2_System_Int64_System_Object_ * this_ptr))
    IL2CPP_REGISTER_METHOD(0x02CB1EC0, app::IEnumerator_1_KeyValuePair_2_System_Int64_System_Object_*, System_Collections_Generic_IEnumerable_System_Collections_Generic_KeyValuePair_TKey_TValue___GetEnumerator, (app::SortedList_2_System_Int64_System_Object_ * this_ptr))
    ...
    IL2CPP_REGISTER_METHOD(0x02CB2460, void, IDictionary_set_Item, (app::SortedList_2_System_Int64_System_Object_ * this_ptr, app::Object* key, app::Object* value))

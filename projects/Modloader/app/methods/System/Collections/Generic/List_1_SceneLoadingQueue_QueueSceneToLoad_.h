...
namespace app::classes::System::Collections::Generic::List_1_SceneLoadingQueue_QueueSceneToLoad_ {
    IL2CPP_REGISTER_METHOD(
        ...
        get_Item,
        app::List_1_SceneLoadingQueue_QueueSceneToLoad_* this_ptr,
        int32_t index
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ctor_3,
        app::List_1_SceneLoadingQueue_QueueSceneToLoad_* this_ptr,
        app::IEnumerable_1_SceneLoadingQueue_QueueSceneToLoad_* collection
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x025E9050,
        app::ReadOnlyCollection_1_SceneLoadingQueue_QueueSceneToLoad_*,
        AsReadOnly,
        app::List_1_SceneLoadingQueue_QueueSceneToLoad_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t index,
        int32_t count,
        app::SceneLoadingQueue_QueueSceneToLoad item,
        app::IComparer_1_SceneLoadingQueue_QueueSceneToLoad_* comparer
    )
    IL2CPP_REGISTER_METHOD(
        0x025ECE20,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Exists,
        app::List_1_SceneLoadingQueue_QueueSceneToLoad_* this_ptr,
        app::Predicate_1_SceneLoadingQueue_QueueSceneToLoad_* match
    )
    IL2CPP_REGISTER_METHOD(
        0x025ED1F0,
        app::SceneLoadingQueue_QueueSceneToLoad,
    ...
    IL2CPP_REGISTER_METHOD(
        0x025ED330,
        app::List_1_SceneLoadingQueue_QueueSceneToLoad_*,
        FindAll,
        app::List_1_SceneLoadingQueue_QueueSceneToLoad_* this_ptr,
        app::Predicate_1_SceneLoadingQueue_QueueSceneToLoad_* match
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ForEach,
        app::List_1_SceneLoadingQueue_QueueSceneToLoad_* this_ptr,
        app::Action_1_SceneLoadingQueue_QueueSceneToLoad_* action
    )
    IL2CPP_REGISTER_METHOD(
        0x025ED850,
        app::List_1_T_Enumerator_SceneLoadingQueue_QueueSceneToLoad_,
        GetEnumerator,
        app::List_1_SceneLoadingQueue_QueueSceneToLoad_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(

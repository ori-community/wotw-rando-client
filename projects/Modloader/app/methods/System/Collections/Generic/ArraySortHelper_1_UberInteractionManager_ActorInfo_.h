...
namespace app::classes::System::Collections::Generic::ArraySortHelper_1_UberInteractionManager_ActorInfo_ {
    IL2CPP_REGISTER_METHOD(
        0x02F86420,
        void,
        Sort_1,
        app::UberInteractionManager_ActorInfo__Array* keys,
        int32_t index,
        int32_t length,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t index,
        int32_t length,
        app::Comparison_1_UberInteractionManager_ActorInfo_* comparer
    )
    IL2CPP_REGISTER_METHOD(
        0x02C8AB70,
        int32_t,

...
namespace app::classes::System::Collections::Generic::List_1_MicroProfilerGraph_MarkerCache_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x047672F8, List_1_MicroProfilerGraph_MarkerCache___ctor__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x022A4010, void, Clear, (app::List_1_MicroProfilerGraph_MarkerCache_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04743DE8, List_1_MicroProfilerGraph_MarkerCache__Clear__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_MicroProfilerGraph_MarkerCache_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0475C4A8, List_1_MicroProfilerGraph_MarkerCache__get_Count__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04775368, List_1_MicroProfilerGraph_MarkerCache__Add__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02D49BC0, void, set_Item, (app::List_1_MicroProfilerGraph_MarkerCache_ * this_ptr, int32_t index, app::MicroProfilerGraph_MarkerCache value))
    IL2CPP_REGISTER_METHODINFO(0x047071E0, List_1_MicroProfilerGraph_MarkerCache__set_Item__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0475E110, List_1_MicroProfilerGraph_MarkerCache__get_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E81E0, void, ctor_2, (app::List_1_MicroProfilerGraph_MarkerCache_ * this_ptr, int32_t capacity))
    IL2CPP_REGISTER_METHOD(0x02D49590, void, ctor_3, (app::List_1_MicroProfilerGraph_MarkerCache_ * this_ptr, app::IEnumerable_1_MicroProfilerGraph_MarkerCache_* collection))
    ...
    IL2CPP_REGISTER_METHOD(0x025E9020, void, AddRange, (app::List_1_MicroProfilerGraph_MarkerCache_ * this_ptr, app::IEnumerable_1_MicroProfilerGraph_MarkerCache_* collection))
    IL2CPP_REGISTER_METHOD(0x025E9050, app::ReadOnlyCollection_1_MicroProfilerGraph_MarkerCache_*, AsReadOnly, (app::List_1_MicroProfilerGraph_MarkerCache_ * this_ptr))
    IL2CPP_REGISTER_METHOD(0x02D4A170, int32_t, BinarySearch_1, (app::List_1_MicroProfilerGraph_MarkerCache_ * this_ptr, int32_t index, int32_t count, app::MicroProfilerGraph_MarkerCache item, app::IComparer_1_MicroProfilerGraph_MarkerCache_* comparer))
    IL2CPP_REGISTER_METHOD(0x02D4A210, int32_t, BinarySearch_2, (app::List_1_MicroProfilerGraph_MarkerCache_ * this_ptr, app::MicroProfilerGraph_MarkerCache item, app::IComparer_1_MicroProfilerGraph_MarkerCache_* comparer))
    ...
    IL2CPP_REGISTER_METHOD(0x025E95B0, void, CopyTo_2, (app::List_1_MicroProfilerGraph_MarkerCache_ * this_ptr, int32_t index, app::MicroProfilerGraph_MarkerCache__Array* array, int32_t array_index, int32_t count))
    IL2CPP_REGISTER_METHOD(0x025E95F0, void, CopyTo_3, (app::List_1_MicroProfilerGraph_MarkerCache_ * this_ptr, app::MicroProfilerGraph_MarkerCache__Array* array, int32_t array_index))
    IL2CPP_REGISTER_METHOD(0x025E9620, void, EnsureCapacity, (app::List_1_MicroProfilerGraph_MarkerCache_ * this_ptr, int32_t min))
    IL2CPP_REGISTER_METHOD(0x025E96A0, bool, Exists, (app::List_1_MicroProfilerGraph_MarkerCache_ * this_ptr, app::Predicate_1_MicroProfilerGraph_MarkerCache_* match))
    IL2CPP_REGISTER_METHOD(0x02D4A5E0, app::MicroProfilerGraph_MarkerCache, Find, (app::List_1_MicroProfilerGraph_MarkerCache_ * this_ptr, app::Predicate_1_MicroProfilerGraph_MarkerCache_* match))
    IL2CPP_REGISTER_METHOD(0x02D4A710, app::List_1_MicroProfilerGraph_MarkerCache_*, FindAll, (app::List_1_MicroProfilerGraph_MarkerCache_ * this_ptr, app::Predicate_1_MicroProfilerGraph_MarkerCache_* match))
    IL2CPP_REGISTER_METHOD(0x025E9A20, int32_t, FindIndex_1, (app::List_1_MicroProfilerGraph_MarkerCache_ * this_ptr, app::Predicate_1_MicroProfilerGraph_MarkerCache_* match))
    IL2CPP_REGISTER_METHOD(0x02D4A950, int32_t, FindIndex_2, (app::List_1_MicroProfilerGraph_MarkerCache_ * this_ptr, int32_t start_index, int32_t count, app::Predicate_1_MicroProfilerGraph_MarkerCache_* match))
    IL2CPP_REGISTER_METHOD(0x02D4AA70, void, ForEach, (app::List_1_MicroProfilerGraph_MarkerCache_ * this_ptr, app::Action_1_MicroProfilerGraph_MarkerCache_* action))
    IL2CPP_REGISTER_METHOD(0x02D4AC20, app::List_1_T_Enumerator_MicroProfilerGraph_MarkerCache_, GetEnumerator, (app::List_1_MicroProfilerGraph_MarkerCache_ * this_ptr))
    IL2CPP_REGISTER_METHOD(0x02D4AC60, app::IEnumerator_1_MicroProfilerGraph_MarkerCache_*, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::List_1_MicroProfilerGraph_MarkerCache_ * this_ptr))
    ...
    IL2CPP_REGISTER_METHOD(0x025E9DF0, app::List_1_MicroProfilerGraph_MarkerCache_*, GetRange, (app::List_1_MicroProfilerGraph_MarkerCache_ * this_ptr, int32_t index, int32_t count))
    ...
    IL2CPP_REGISTER_METHOD(0x02D4AE90, void, Insert, (app::List_1_MicroProfilerGraph_MarkerCache_ * this_ptr, int32_t index, app::MicroProfilerGraph_MarkerCache item))
    ...
    IL2CPP_REGISTER_METHOD(0x02D4B110, void, InsertRange, (app::List_1_MicroProfilerGraph_MarkerCache_ * this_ptr, int32_t index, app::IEnumerable_1_MicroProfilerGraph_MarkerCache_* collection))
    ...
    IL2CPP_REGISTER_METHOD(0x02D4B650, int32_t, RemoveAll, (app::List_1_MicroProfilerGraph_MarkerCache_ * this_ptr, app::Predicate_1_MicroProfilerGraph_MarkerCache_* match))
    ...
    IL2CPP_REGISTER_METHOD(0x025EADB0, void, Sort_2, (app::List_1_MicroProfilerGraph_MarkerCache_ * this_ptr, app::IComparer_1_MicroProfilerGraph_MarkerCache_* comparer))
    IL2CPP_REGISTER_METHOD(0x025EAE20, void, Sort_3, (app::List_1_MicroProfilerGraph_MarkerCache_ * this_ptr, int32_t index, int32_t count, app::IComparer_1_MicroProfilerGraph_MarkerCache_* comparer))
    IL2CPP_REGISTER_METHOD(0x025EAEA0, void, Sort_4, (app::List_1_MicroProfilerGraph_MarkerCache_ * this_ptr, app::Comparison_1_MicroProfilerGraph_MarkerCache_* comparison))

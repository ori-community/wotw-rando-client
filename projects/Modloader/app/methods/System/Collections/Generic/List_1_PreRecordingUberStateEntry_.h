...
#include <Modloader/app/structs/IEnumerable_1_PreRecordingUberStateEntry_.h>
...
namespace app::classes::System::Collections::Generic::List_1_PreRecordingUberStateEntry_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_3,
        app::List_1_PreRecordingUberStateEntry_* this_ptr,
        app::IEnumerable_1_PreRecordingUberStateEntry_* collection
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t index,
        int32_t count,
        app::PreRecordingUberStateEntry item,
        app::IComparer_1_PreRecordingUberStateEntry_* comparer
    )
    IL2CPP_REGISTER_METHOD(
        0x025E91F0,
        int32_t,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Find,
        app::List_1_PreRecordingUberStateEntry_* this_ptr,
        app::Predicate_1_PreRecordingUberStateEntry_* match
    )
    IL2CPP_REGISTER_METHOD(
        0x025E9800,
        app::List_1_PreRecordingUberStateEntry_*,
        FindAll,
        app::List_1_PreRecordingUberStateEntry_* this_ptr,
        app::Predicate_1_PreRecordingUberStateEntry_* match
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Sort_4,
        app::List_1_PreRecordingUberStateEntry_* this_ptr,
        app::Comparison_1_PreRecordingUberStateEntry_* comparison
    )

...
namespace app::classes::System::Collections::Generic::Comparer_1_InstantiateUtility_InstantiationInfo_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02C9FD90, app::Comparer_1_InstantiateUtility_InstantiationInfo_*, Create, (app::Comparison_1_InstantiateUtility_InstantiationInfo_ * comparison))
    IL2CPP_REGISTER_METHODINFO(0x04752030, Comparer_1_InstantiateUtility_InstantiationInfo__Create__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02C9FF90, app::Comparer_1_InstantiateUtility_InstantiationInfo_*, CreateComparer, ())
    IL2CPP_REGISTER_METHOD(0x0280A070, int32_t, IComparer_Compare, (app::Comparer_1_InstantiateUtility_InstantiationInfo_ * this_ptr, app::Object* x, app::Object* y))

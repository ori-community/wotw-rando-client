...
namespace app::classes::System::Collections::Generic::Dictionary_2_System_Object_System_Byte_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02BC20C0, void, ctor_4, (app::Dictionary_2_System_Object_System_Byte_ * this_ptr, int32_t capacity, app::IEqualityComparer_1_System_Object_* comparer))
    IL2CPP_REGISTER_METHODINFO(0x0470F488, Dictionary_2_System_Object_System_Byte___ctor_3__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x0283ADC0, void, ctor_5, (app::Dictionary_2_System_Object_System_Byte_ * this_ptr, app::IDictionary_2_System_Object_System_Byte_* dictionary))
    IL2CPP_REGISTER_METHOD(0x02BC2200, void, ctor_6, (app::Dictionary_2_System_Object_System_Byte_ * this_ptr, app::IDictionary_2_System_Object_System_Byte_* dictionary, app::IEqualityComparer_1_System_Object_* comparer))
    IL2CPP_REGISTER_METHODINFO(0x04704570, Dictionary_2_System_Object_System_Byte___ctor_5__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02BC25D0, void, ctor_7, (app::Dictionary_2_System_Object_System_Byte_ * this_ptr, app::SerializationInfo* info, app::StreamingContext context))
    ...
    IL2CPP_REGISTER_METHOD(0x0283B2B0, app::Dictionary_2_TKey_TValue_KeyCollection_System_Object_System_Byte_*, get_Keys, (app::Dictionary_2_System_Object_System_Byte_ * this_ptr))
    IL2CPP_REGISTER_METHOD(0x0283B2B0, app::ICollection_1_System_Object_*, System_Collections_Generic_IDictionary_TKey_TValue__get_Keys, (app::Dictionary_2_System_Object_System_Byte_ * this_ptr))
    IL2CPP_REGISTER_METHOD(0x0283B2B0, app::IEnumerable_1_System_Object_*, System_Collections_Generic_IReadOnlyDictionary_TKey_TValue__get_Keys, (app::Dictionary_2_System_Object_System_Byte_ * this_ptr))
    IL2CPP_REGISTER_METHOD(0x0283B3E0, app::Dictionary_2_TKey_TValue_ValueCollection_System_Object_System_Byte_*, get_Values, (app::Dictionary_2_System_Object_System_Byte_ * this_ptr))
    IL2CPP_REGISTER_METHOD(0x0283B3E0, app::ICollection_1_System_Byte_*, System_Collections_Generic_IDictionary_TKey_TValue__get_Values, (app::Dictionary_2_System_Object_System_Byte_ * this_ptr))
    IL2CPP_REGISTER_METHOD(0x0283B3E0, app::IEnumerable_1_System_Byte_*, System_Collections_Generic_IReadOnlyDictionary_TKey_TValue__get_Values, (app::Dictionary_2_System_Object_System_Byte_ * this_ptr))
    ...
    IL2CPP_REGISTER_METHOD(0x02BA5400, app::Dictionary_2_TKey_TValue_Enumerator_System_Object_System_Byte_, GetEnumerator, (app::Dictionary_2_System_Object_System_Byte_ * this_ptr))
    IL2CPP_REGISTER_METHOD(0x02BA5450, app::IEnumerator_1_KeyValuePair_2_System_Object_System_Byte_*, System_Collections_Generic_IEnumerable_System_Collections_Generic_KeyValuePair_TKey_TValue___GetEnumerator, (app::Dictionary_2_System_Object_System_Byte_ * this_ptr))

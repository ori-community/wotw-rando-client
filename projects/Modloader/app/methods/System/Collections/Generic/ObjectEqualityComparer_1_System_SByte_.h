...
namespace app::classes::System::Collections::Generic::ObjectEqualityComparer_1_System_SByte_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02436320, int32_t, IndexOf, (app::ObjectEqualityComparer_1_System_SByte_ * this_ptr, app::SByte__Array* array, int8_t value, int32_t start_index, int32_t count))
    IL2CPP_REGISTER_METHOD(0x02436400, int32_t, LastIndexOf, (app::ObjectEqualityComparer_1_System_SByte_ * this_ptr, app::SByte__Array* array, int8_t value, int32_t start_index, int32_t count))

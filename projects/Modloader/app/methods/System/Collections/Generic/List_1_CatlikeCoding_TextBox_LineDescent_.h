...
namespace app::classes::System::Collections::Generic::List_1_CatlikeCoding_TextBox_LineDescent_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_3,
        app::List_1_CatlikeCoding_TextBox_LineDescent_* this_ptr,
        app::IEnumerable_1_CatlikeCoding_TextBox_LineDescent_* collection
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x025E9050,
        app::ReadOnlyCollection_1_CatlikeCoding_TextBox_LineDescent_*,
        AsReadOnly,
        app::List_1_CatlikeCoding_TextBox_LineDescent_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Exists,
        app::List_1_CatlikeCoding_TextBox_LineDescent_* this_ptr,
        app::Predicate_1_CatlikeCoding_TextBox_LineDescent_* match
    )
    IL2CPP_REGISTER_METHOD(
        0x02DC65F0,
        app::LineDescent,
    ...
    IL2CPP_REGISTER_METHOD(
        0x02DC66F0,
        app::List_1_CatlikeCoding_TextBox_LineDescent_*,
        FindAll,
        app::List_1_CatlikeCoding_TextBox_LineDescent_* this_ptr,
        app::Predicate_1_CatlikeCoding_TextBox_LineDescent_* match
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ForEach,
        app::List_1_CatlikeCoding_TextBox_LineDescent_* this_ptr,
        app::Action_1_CatlikeCoding_TextBox_LineDescent_* action
    )
    IL2CPP_REGISTER_METHOD(
        0x025F0B10,
        app::List_1_T_Enumerator_CatlikeCoding_TextBox_LineDescent_,
        GetEnumerator,
        app::List_1_CatlikeCoding_TextBox_LineDescent_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x025F0B50,
        app::IEnumerator_1_CatlikeCoding_TextBox_LineDescent_*,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Sort_4,
        app::List_1_CatlikeCoding_TextBox_LineDescent_* this_ptr,
        app::Comparison_1_CatlikeCoding_TextBox_LineDescent_* comparison
    )

...
namespace app::classes::System::Collections::Generic::Queue_1_T__Enumerator_System_Object_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x047387C8, Queue_1_T_Enumerator_System_Object__MoveNext__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0472EF30, Queue_1_T_Enumerator_System_Object__ThrowEnumerationNotStartedOrEnded__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x001EE3B0, void, IEnumerator_Reset, (app::Queue_1_T_Enumerator_System_Object___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04755200, Queue_1_T_Enumerator_System_Object__System_Collections_IEnumerator_Reset__MethodInfo)
} // namespace app::classes::System::Collections::Generic::Queue_1_T__Enumerator_System_Object_

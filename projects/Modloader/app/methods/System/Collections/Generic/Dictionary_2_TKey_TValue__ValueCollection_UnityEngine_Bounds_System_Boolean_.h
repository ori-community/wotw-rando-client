...
#include <Modloader/app/structs/Dictionary_2_TKey_TValue_ValueCollectio_TKe_TValu_Enumerato_UnityEngin_Bound_Syste_Boolea_.h>
...
namespace app::classes::System::Collections::Generic::Dictionary_2_TKey_TValue__ValueCollection_UnityEngine_Bounds_System_Boolean_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::Dictionary_2_TKey_TValue_ValueCollection_UnityEngine_Bounds_System_Boolean_* this_ptr,
        app::Dictionary_2_UnityEngine_Bounds_System_Boolean_* dictionary
    )
    IL2CPP_REGISTER_METHOD(
        0x01ADC710,
        app::Dictionary_2_TKey_TValue_ValueCollection_TKey_TValue_Enumerator_UnityEngine_Bounds_System_Boolean_,
        GetEnumerator,
        app::Dictionary_2_TKey_TValue_ValueCollection_UnityEngine_Bounds_System_Boolean_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(

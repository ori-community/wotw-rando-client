...
namespace app::classes::System::Collections::Generic::Dictionary_2_System_Int32_WorldMapAreaState_ {
    ...
    IL2CPP_REGISTER_METHOD(
        0x02BAC6E0,
        app::Dictionary_2_TKey_TValue_Enumerator_System_Int32_WorldMapAreaState_,
        GetEnumerator,
        app::Dictionary_2_System_Int32_WorldMapAreaState_* this_ptr
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Dictionary_2_System_Int32_WorldMapAreaState_* this_ptr,
        int32_t key,
        app::WorldMapAreaState__Enum value
    )
    IL2CPP_REGISTER_METHOD(
        0x02BADFC0,
        bool,

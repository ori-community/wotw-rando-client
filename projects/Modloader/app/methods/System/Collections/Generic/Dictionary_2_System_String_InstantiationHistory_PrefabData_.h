...
namespace app::classes::System::Collections::Generic::Dictionary_2_System_String_InstantiationHistory_PrefabData_ {
    IL2CPP_REGISTER_METHOD(
        0x02BA5400,
        app::Dictionary_2_TKey_TValue_Enumerator_System_String_InstantiationHistory_PrefabData_,
        GetEnumerator,
        app::Dictionary_2_System_String_InstantiationHistory_PrefabData_* this_ptr
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Dictionary_2_System_String_InstantiationHistory_PrefabData_* this_ptr,
        app::String* key,
        app::InstantiationHistory_PrefabData* value
    )
    IL2CPP_REGISTER_METHOD(
        0x02BD24D0,

...
namespace app::classes::System::Collections::Generic::List_1_System_Text_RegularExpressions_RegexNode_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04709D18, List_1_System_Text_RegularExpressions_RegexNode__get_Count__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0472CBB0, List_1_System_Text_RegularExpressions_RegexNode__get_Item__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04787618, List_1_System_Text_RegularExpressions_RegexNode__Reverse__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04779650, List_1_System_Text_RegularExpressions_RegexNode__set_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02FE94A0, void, InsertRange, (app::List_1_System_Text_RegularExpressions_RegexNode_ * this_ptr, int32_t index, app::IEnumerable_1_System_Text_RegularExpressions_RegexNode_* collection))
    IL2CPP_REGISTER_METHODINFO(0x047143F8, List_1_System_Text_RegularExpressions_RegexNode__InsertRange__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x047559A8, List_1_System_Text_RegularExpressions_RegexNode__RemoveRange__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04734DD0, List_1_System_Text_RegularExpressions_RegexNode___ctor__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04714C28, List_1_System_Text_RegularExpressions_RegexNode__Add__MethodInfo)
} // namespace app::classes::System::Collections::Generic::List_1_System_Text_RegularExpressions_RegexNode_

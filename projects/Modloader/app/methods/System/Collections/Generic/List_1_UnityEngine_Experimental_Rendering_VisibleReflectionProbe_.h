...
namespace app::classes::System::Collections::Generic::List_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_3,
        app::List_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_* this_ptr,
        app::IEnumerable_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_* collection
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Add,
        app::List_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_* this_ptr,
        app::VisibleReflectionProbe item
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x025E9050,
        app::ReadOnlyCollection_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_*,
        AsReadOnly,
        app::List_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t count,
        app::VisibleReflectionProbe item,
        app::IComparer_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_* comparer
    )
    IL2CPP_REGISTER_METHOD(
        0x02D2BB40,
        int32_t,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Exists,
        app::List_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_* this_ptr,
        app::Predicate_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_* match
    )
    IL2CPP_REGISTER_METHOD(
        0x02D2C080,
        app::VisibleReflectionProbe,
    ...
    IL2CPP_REGISTER_METHOD(
        0x02D2C240,
        app::List_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_*,
        FindAll,
        app::List_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_* this_ptr,
        app::Predicate_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_* match
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ForEach,
        app::List_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_* this_ptr,
        app::Action_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_* action
    )
    IL2CPP_REGISTER_METHOD(
        0x02D2C8B0,
        app::List_1_T_Enumerator_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_,
        GetEnumerator,
        app::List_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x02D2C910,
        app::IEnumerator_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_*,
    ...
    IL2CPP_REGISTER_METHOD(
        0x025EAEF0,
        app::VisibleReflectionProbe__Array*,
        ToArray,
        app::List_1_UnityEngine_Experimental_Rendering_VisibleReflectionProbe_* this_ptr
    )

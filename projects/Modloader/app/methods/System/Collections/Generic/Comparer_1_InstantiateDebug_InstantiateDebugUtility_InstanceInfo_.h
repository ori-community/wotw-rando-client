...
namespace app::classes::System::Collections::Generic::Comparer_1_InstantiateDebug_InstantiateDebugUtility_InstanceInfo_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02C9F5C0, app::Comparer_1_InstantiateDebug_InstantiateDebugUtility_InstanceInfo_*, Create, (app::Comparison_1_InstantiateDebug_InstantiateDebugUtility_InstanceInfo_ * comparison))
    IL2CPP_REGISTER_METHODINFO(0x04735330, Comparer_1_InstantiateDebug_InstantiateDebugUtility_InstanceInfo__Create__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02C9F7C0, app::Comparer_1_InstantiateDebug_InstantiateDebugUtility_InstanceInfo_*, CreateComparer, ())
    IL2CPP_REGISTER_METHOD(0x0280A070, int32_t, IComparer_Compare, (app::Comparer_1_InstantiateDebug_InstantiateDebugUtility_InstanceInfo_ * this_ptr, app::Object* x, app::Object* y))

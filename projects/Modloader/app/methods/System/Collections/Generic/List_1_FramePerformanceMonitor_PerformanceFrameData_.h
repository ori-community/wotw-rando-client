...
namespace app::classes::System::Collections::Generic::List_1_FramePerformanceMonitor_PerformanceFrameData_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Add,
        app::List_1_FramePerformanceMonitor_PerformanceFrameData_* this_ptr,
        app::FramePerformanceMonitor_PerformanceFrameData item
    )
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, app::List_1_FramePerformanceMonitor_PerformanceFrameData_* this_ptr)
    IL2CPP_REGISTER_METHOD(
        0x025ED850,
        app::List_1_T_Enumerator_FramePerformanceMonitor_PerformanceFrameData_,
        GetEnumerator,
        app::List_1_FramePerformanceMonitor_PerformanceFrameData_* this_ptr
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ctor_3,
        app::List_1_FramePerformanceMonitor_PerformanceFrameData_* this_ptr,
        app::IEnumerable_1_FramePerformanceMonitor_PerformanceFrameData_* collection
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x025E9050,
        app::ReadOnlyCollection_1_FramePerformanceMonitor_PerformanceFrameData_*,
        AsReadOnly,
        app::List_1_FramePerformanceMonitor_PerformanceFrameData_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t count,
        app::FramePerformanceMonitor_PerformanceFrameData item,
        app::IComparer_1_FramePerformanceMonitor_PerformanceFrameData_* comparer
    )
    IL2CPP_REGISTER_METHOD(
        0x025ECE20,
        int32_t,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Exists,
        app::List_1_FramePerformanceMonitor_PerformanceFrameData_* this_ptr,
        app::Predicate_1_FramePerformanceMonitor_PerformanceFrameData_* match
    )
    IL2CPP_REGISTER_METHOD(
        0x025ED1F0,
        app::FramePerformanceMonitor_PerformanceFrameData,
    ...
    IL2CPP_REGISTER_METHOD(
        0x025ED330,
        app::List_1_FramePerformanceMonitor_PerformanceFrameData_*,
        FindAll,
        app::List_1_FramePerformanceMonitor_PerformanceFrameData_* this_ptr,
        app::Predicate_1_FramePerformanceMonitor_PerformanceFrameData_* match
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ForEach,
        app::List_1_FramePerformanceMonitor_PerformanceFrameData_* this_ptr,
        app::Action_1_FramePerformanceMonitor_PerformanceFrameData_* action
    )
    IL2CPP_REGISTER_METHOD(
        0x025ED8A0,
    ...
    IL2CPP_REGISTER_METHOD(
        0x025EAEF0,
        app::FramePerformanceMonitor_PerformanceFrameData__Array*,
        ToArray,
        app::List_1_FramePerformanceMonitor_PerformanceFrameData_* this_ptr
    )

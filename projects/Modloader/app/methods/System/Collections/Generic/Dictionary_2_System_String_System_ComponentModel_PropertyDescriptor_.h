...
namespace app::classes::System::Collections::Generic::Dictionary_2_System_String_System_ComponentModel_PropertyDescriptor_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Add,
        app::Dictionary_2_System_String_System_ComponentModel_PropertyDescriptor_* this_ptr,
        app::String* key,
        app::PropertyDescriptor* value
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x0283B3E0,
        app::Dictionary_2_TKey_TValue_ValueCollection_System_String_System_ComponentModel_PropertyDescriptor_*,
        get_Values,
        app::Dictionary_2_System_String_System_ComponentModel_PropertyDescriptor_* this_ptr
    )
} // namespace app::classes::System::Collections::Generic::Dictionary_2_System_String_System_ComponentModel_PropertyDescriptor_

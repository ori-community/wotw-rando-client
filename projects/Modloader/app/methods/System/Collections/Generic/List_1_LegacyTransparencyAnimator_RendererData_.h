...
namespace app::classes::System::Collections::Generic::List_1_LegacyTransparencyAnimator_RendererData_ {
    IL2CPP_REGISTER_METHOD(
        0x025E9D20,
        app::List_1_T_Enumerator_LegacyTransparencyAnimator_RendererData_,
        GetEnumerator,
        app::List_1_LegacyTransparencyAnimator_RendererData_* this_ptr
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Add,
        app::List_1_LegacyTransparencyAnimator_RendererData_* this_ptr,
        app::LegacyTransparencyAnimator_RendererData item
    )
    IL2CPP_REGISTER_METHOD(
        0x025E8A60,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ctor_3,
        app::List_1_LegacyTransparencyAnimator_RendererData_* this_ptr,
        app::IEnumerable_1_LegacyTransparencyAnimator_RendererData_* collection
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x025E9050,
        app::ReadOnlyCollection_1_LegacyTransparencyAnimator_RendererData_*,
        AsReadOnly,
        app::List_1_LegacyTransparencyAnimator_RendererData_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t count,
        app::LegacyTransparencyAnimator_RendererData item,
        app::IComparer_1_LegacyTransparencyAnimator_RendererData_* comparer
    )
    IL2CPP_REGISTER_METHOD(
        0x025E91F0,
        int32_t,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Exists,
        app::List_1_LegacyTransparencyAnimator_RendererData_* this_ptr,
        app::Predicate_1_LegacyTransparencyAnimator_RendererData_* match
    )
    IL2CPP_REGISTER_METHOD(
        0x025E96E0,
        app::LegacyTransparencyAnimator_RendererData,
    ...
    IL2CPP_REGISTER_METHOD(
        0x025E9800,
        app::List_1_LegacyTransparencyAnimator_RendererData_*,
        FindAll,
        app::List_1_LegacyTransparencyAnimator_RendererData_* this_ptr,
        app::Predicate_1_LegacyTransparencyAnimator_RendererData_* match
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ForEach,
        app::List_1_LegacyTransparencyAnimator_RendererData_* this_ptr,
        app::Action_1_LegacyTransparencyAnimator_RendererData_* action
    )
    IL2CPP_REGISTER_METHOD(
        0x025E9D60,
    ...
    IL2CPP_REGISTER_METHOD(
        0x025EAEF0,
        app::LegacyTransparencyAnimator_RendererData__Array*,
        ToArray,
        app::List_1_LegacyTransparencyAnimator_RendererData_* this_ptr
    )

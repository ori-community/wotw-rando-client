...
namespace app::classes::System::Collections::Generic::SortedList_2_System_Int64_UberWaterReflectionView_Group_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Add,
        app::SortedList_2_System_Int64_UberWaterReflectionView_Group_* this_ptr,
        int64_t key,
        app::UberWaterReflectionView_Group* value
    )
    IL2CPP_REGISTER_METHOD(
        0x02CB1EC0,
        app::IEnumerator_1_KeyValuePair_2_System_Int64_UberWaterReflectionView_Group_*,
        GetEnumerator,
        app::SortedList_2_System_Int64_UberWaterReflectionView_Group_* this_ptr
    )

...
namespace app::classes::System::Collections::Generic::List_1_Moon_ScalableAnimationPlayer_ {
    ...
    IL2CPP_REGISTER_METHOD(
        0x025F0B10,
        app::List_1_T_Enumerator_Moon_ScalableAnimationPlayer_,
        GetEnumerator,
        app::List_1_Moon_ScalableAnimationPlayer_* this_ptr
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        AddRange,
        app::List_1_Moon_ScalableAnimationPlayer_* this_ptr,
        app::IEnumerable_1_Moon_ScalableAnimationPlayer_* collection
    )
} // namespace app::classes::System::Collections::Generic::List_1_Moon_ScalableAnimationPlayer_

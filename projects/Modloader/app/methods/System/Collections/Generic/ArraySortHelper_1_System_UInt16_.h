...
namespace app::classes::System::Collections::Generic::ArraySortHelper_1_System_UInt16_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t length,
        uint16_t value,
        app::IComparer_1_System_UInt16_* comparer
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        IntroSort,
        app::UInt16__Array* keys,
        int32_t lo,
        int32_t hi,
        int32_t depth_limit,
        app::Comparison_1_UInt16_* comparer
    )

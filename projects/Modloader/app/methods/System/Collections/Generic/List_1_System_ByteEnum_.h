...
namespace app::classes::System::Collections::Generic::List_1_System_ByteEnum_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t,
        BinarySearch_1,
        app::List_1_System_ByteEnum_* this_ptr,
        int32_t index,
        int32_t count,
        app::ByteEnum__Enum item,
        app::IComparer_1_System_ByteEnum_* comparer
    )
    IL2CPP_REGISTER_METHOD(
        0x02F512B0,
        int32_t,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t start_index,
        int32_t count,
        app::Predicate_1_ByteEnum_* match
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::List_1_System_ByteEnum_* this_ptr,
        int32_t index,
        app::IEnumerable_1_System_ByteEnum_* collection
    )

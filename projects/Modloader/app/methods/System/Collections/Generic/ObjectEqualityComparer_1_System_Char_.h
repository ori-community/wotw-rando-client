...
namespace app::classes::System::Collections::Generic::ObjectEqualityComparer_1_System_Char_ {
    ...
    IL2CPP_REGISTER_METHOD(0x0265AF60, int32_t, IndexOf, (app::ObjectEqualityComparer_1_System_Char_ * this_ptr, app::Char__Array* array, char16_t value, int32_t start_index, int32_t count))
    IL2CPP_REGISTER_METHOD(0x0265B040, int32_t, LastIndexOf, (app::ObjectEqualityComparer_1_System_Char_ * this_ptr, app::Char__Array* array, char16_t value, int32_t start_index, int32_t count))

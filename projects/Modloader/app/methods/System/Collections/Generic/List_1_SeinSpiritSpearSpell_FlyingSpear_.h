...
namespace app::classes::System::Collections::Generic::List_1_SeinSpiritSpearSpell_FlyingSpear_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        set_Item,
        app::List_1_SeinSpiritSpearSpell_FlyingSpear_* this_ptr,
        int32_t index,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ctor_3,
        app::List_1_SeinSpiritSpearSpell_FlyingSpear_* this_ptr,
        app::IEnumerable_1_SeinSpiritSpearSpell_FlyingSpear_* collection
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x025E9050,
        app::ReadOnlyCollection_1_SeinSpiritSpearSpell_FlyingSpear_*,
        AsReadOnly,
        app::List_1_SeinSpiritSpearSpell_FlyingSpear_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t index,
        int32_t count,
        app::SeinSpiritSpearSpell_FlyingSpear item,
        app::IComparer_1_SeinSpiritSpearSpell_FlyingSpear_* comparer
    )
    IL2CPP_REGISTER_METHOD(
        0x02D84A20,
        int32_t,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Exists,
        app::List_1_SeinSpiritSpearSpell_FlyingSpear_* this_ptr,
        app::Predicate_1_SeinSpiritSpearSpell_FlyingSpear_* match
    )
    IL2CPP_REGISTER_METHOD(
        0x02D84E60,
    ...
    IL2CPP_REGISTER_METHOD(
        0x02D84FF0,
        app::List_1_SeinSpiritSpearSpell_FlyingSpear_*,
        FindAll,
        app::List_1_SeinSpiritSpearSpell_FlyingSpear_* this_ptr,
        app::Predicate_1_SeinSpiritSpearSpell_FlyingSpear_* match
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ForEach,
        app::List_1_SeinSpiritSpearSpell_FlyingSpear_* this_ptr,
        app::Action_1_SeinSpiritSpearSpell_FlyingSpear_* action
    )
    IL2CPP_REGISTER_METHOD(
        0x02D85580,
        app::List_1_T_Enumerator_SeinSpiritSpearSpell_FlyingSpear_,
        GetEnumerator,
        app::List_1_SeinSpiritSpearSpell_FlyingSpear_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Sort_4,
        app::List_1_SeinSpiritSpearSpell_FlyingSpear_* this_ptr,
        app::Comparison_1_SeinSpiritSpearSpell_FlyingSpear_* comparison
    )

...
namespace app::classes::System::Collections::Generic::Dictionary_2_TKey_TValue__ValueCollection_System_Object_NearbySceneData_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::Dictionary_2_TKey_TValue_ValueCollection_System_Object_NearbySceneData_* this_ptr,
        app::Dictionary_2_System_Object_NearbySceneData_* dictionary
    )
    IL2CPP_REGISTER_METHOD(
        0x01A7BB40,
        app::Dictionary_2_TKey_TValue_ValueCollection_TKey_TValue_Enumerator_System_Object_NearbySceneData_,
        GetEnumerator,
        app::Dictionary_2_TKey_TValue_ValueCollection_System_Object_NearbySceneData_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
    ...
    IL2CPP_REGISTER_METHOD(
        0x01A7BF40,
        app::IEnumerator_1_NearbySceneData_*,

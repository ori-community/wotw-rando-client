...
namespace app::classes::System::Collections::Generic::List_1_PreRecordingDynamicSceneObjectEntry_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        get_Item,
        app::List_1_PreRecordingDynamicSceneObjectEntry_* this_ptr,
        int32_t index
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ctor_3,
        app::List_1_PreRecordingDynamicSceneObjectEntry_* this_ptr,
        app::IEnumerable_1_PreRecordingDynamicSceneObjectEntry_* collection
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x025E9050,
        app::ReadOnlyCollection_1_PreRecordingDynamicSceneObjectEntry_*,
        AsReadOnly,
        app::List_1_PreRecordingDynamicSceneObjectEntry_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t index,
        int32_t count,
        app::PreRecordingDynamicSceneObjectEntry item,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Exists,
        app::List_1_PreRecordingDynamicSceneObjectEntry_* this_ptr,
        app::Predicate_1_PreRecordingDynamicSceneObjectEntry_* match
    )
    IL2CPP_REGISTER_METHOD(
        0x025F05A0,
        app::PreRecordingDynamicSceneObjectEntry,
    ...
    IL2CPP_REGISTER_METHOD(
        0x025F0680,
        app::List_1_PreRecordingDynamicSceneObjectEntry_*,
        FindAll,
        app::List_1_PreRecordingDynamicSceneObjectEntry_* this_ptr,
        app::Predicate_1_PreRecordingDynamicSceneObjectEntry_* match
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ForEach,
        app::List_1_PreRecordingDynamicSceneObjectEntry_* this_ptr,
        app::Action_1_PreRecordingDynamicSceneObjectEntry_* action
    )
    IL2CPP_REGISTER_METHOD(
        0x025F0B10,
        app::List_1_T_Enumerator_PreRecordingDynamicSceneObjectEntry_,
        GetEnumerator,
        app::List_1_PreRecordingDynamicSceneObjectEntry_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(

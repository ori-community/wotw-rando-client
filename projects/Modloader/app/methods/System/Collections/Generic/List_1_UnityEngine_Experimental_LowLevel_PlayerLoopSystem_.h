...
namespace app::classes::System::Collections::Generic::List_1_UnityEngine_Experimental_LowLevel_PlayerLoopSystem_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        get_Item,
        app::List_1_UnityEngine_Experimental_LowLevel_PlayerLoopSystem_* this_ptr,
        int32_t index
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ctor_2,
        app::List_1_UnityEngine_Experimental_LowLevel_PlayerLoopSystem_* this_ptr,
        app::IEnumerable_1_UnityEngine_Experimental_LowLevel_PlayerLoopSystem_* collection
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x025E9050,
        app::ReadOnlyCollection_1_UnityEngine_Experimental_LowLevel_PlayerLoopSystem_*,
        AsReadOnly,
        app::List_1_UnityEngine_Experimental_LowLevel_PlayerLoopSystem_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t count,
        app::PlayerLoopSystem item,
        app::IComparer_1_UnityEngine_Experimental_LowLevel_PlayerLoopSystem_* comparer
    )
    IL2CPP_REGISTER_METHOD(
        0x02D254D0,
        int32_t,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Exists,
        app::List_1_UnityEngine_Experimental_LowLevel_PlayerLoopSystem_* this_ptr,
        app::Predicate_1_UnityEngine_Experimental_LowLevel_PlayerLoopSystem_* match
    )
    IL2CPP_REGISTER_METHOD(
        0x02D258D0,
        app::PlayerLoopSystem,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ForEach,
        app::List_1_UnityEngine_Experimental_LowLevel_PlayerLoopSystem_* this_ptr,
        app::Action_1_UnityEngine_Experimental_LowLevel_PlayerLoopSystem_* action
    )
    IL2CPP_REGISTER_METHOD(
        0x02D25F90,
        app::List_1_T_Enumerator_UnityEngine_Experimental_LowLevel_PlayerLoopSystem_,
        GetEnumerator,
        app::List_1_UnityEngine_Experimental_LowLevel_PlayerLoopSystem_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(

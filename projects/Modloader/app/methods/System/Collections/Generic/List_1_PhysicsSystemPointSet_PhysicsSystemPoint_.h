...
namespace app::classes::System::Collections::Generic::List_1_PhysicsSystemPointSet_PhysicsSystemPoint_ {
    IL2CPP_REGISTER_METHOD(
        0x025EFC50,
        app::PhysicsSystemPointSet_PhysicsSystemPoint*,
        get_Item,
        app::List_1_PhysicsSystemPointSet_PhysicsSystemPoint_* this_ptr,
        int32_t index
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Add,
        app::List_1_PhysicsSystemPointSet_PhysicsSystemPoint_* this_ptr,
        app::PhysicsSystemPointSet_PhysicsSystemPoint* item
    )
} // namespace app::classes::System::Collections::Generic::List_1_PhysicsSystemPointSet_PhysicsSystemPoint_

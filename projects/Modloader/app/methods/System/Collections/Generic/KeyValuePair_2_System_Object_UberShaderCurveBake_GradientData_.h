...
namespace app::classes::System::Collections::Generic::KeyValuePair_2_System_Object_UberShaderCurveBake_GradientData_ {
    ...
    IL2CPP_REGISTER_METHOD(0x0014FCD0, app::UberShaderCurveBake_GradientData, get_Value, (app::KeyValuePair_2_System_Object_UberShaderCurveBake_GradientData___Boxed * this_ptr))

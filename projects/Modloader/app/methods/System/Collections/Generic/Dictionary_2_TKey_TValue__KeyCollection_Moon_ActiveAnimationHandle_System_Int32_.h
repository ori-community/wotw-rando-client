...
#include <Modloader/app/structs/Dictionary_2_TKe_TValu_KeyCollectio_TKe_TValu_Enumerato_Moo_ActiveAnimationHandl_Syst_Int_.h>
...
namespace app::classes::System::Collections::Generic::Dictionary_2_TKey_TValue__KeyCollection_Moon_ActiveAnimationHandle_System_Int32_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::Dictionary_2_TKey_TValue_KeyCollection_Moon_ActiveAnimationHandle_System_Int32_* this_ptr,
        app::Dictionary_2_Moon_ActiveAnimationHandle_System_Int32_* dictionary
    )
    IL2CPP_REGISTER_METHOD(
        0x01A7A830,
        app::Dictionary_2_TKey_TValue_KeyCollection_TKey_TValue_Enumerator_Moon_ActiveAnimationHandle_System_Int32_,
        GetEnumerator,
        app::Dictionary_2_TKey_TValue_KeyCollection_Moon_ActiveAnimationHandle_System_Int32_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(

...
namespace app::classes::System::Collections::Generic::List_1_T__Enumerator_LegacyMaterialColorGradientAnimator_RendererData_ {
    ...
    IL2CPP_REGISTER_METHOD(0x00133A80, app::LegacyMaterialColorGradientAnimator_RendererData, get_Current, (app::List_1_T_Enumerator_LegacyMaterialColorGradientAnimator_RendererData___Boxed * this_ptr))
    IL2CPP_REGISTER_METHOD(0x0014D1A0, app::Object*, IEnumerator_get_Current, (app::List_1_T_Enumerator_LegacyMaterialColorGradientAnimator_RendererData___Boxed * this_ptr))

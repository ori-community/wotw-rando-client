...
namespace app::classes::System::Collections::Generic::List_1_TriangleNet_Geometry_Point_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04749288, List_1_TriangleNet_Geometry_Point___ctor__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02F1E150, void, Add, (app::List_1_TriangleNet_Geometry_Point_ * this_ptr, app::Point* item))
    IL2CPP_REGISTER_METHODINFO(0x04761940, List_1_TriangleNet_Geometry_Point__Add__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_TriangleNet_Geometry_Point_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0477D0C0, List_1_TriangleNet_Geometry_Point__get_Count__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x047299E0, List_1_TriangleNet_Geometry_Point__GetEnumerator__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x022A4010, void, Clear, (app::List_1_TriangleNet_Geometry_Point_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0478B1A0, List_1_TriangleNet_Geometry_Point__Clear__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0475A5E8, List_1_TriangleNet_Geometry_Point__AddRange__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E81E0, void, ctor_2, (app::List_1_TriangleNet_Geometry_Point_ * this_ptr, int32_t capacity))
    IL2CPP_REGISTER_METHODINFO(0x04794A00, List_1_TriangleNet_Geometry_Point___ctor_1__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025EFC50, app::Point*, get_Item, (app::List_1_TriangleNet_Geometry_Point_ * this_ptr, int32_t index))
    IL2CPP_REGISTER_METHODINFO(0x0471CA48, List_1_TriangleNet_Geometry_Point__get_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025EAC80, void, Reverse, (app::List_1_TriangleNet_Geometry_Point_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04789478, List_1_TriangleNet_Geometry_Point__Reverse__MethodInfo)
} // namespace app::classes::System::Collections::Generic::List_1_TriangleNet_Geometry_Point_

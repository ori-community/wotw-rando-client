...
namespace app::classes::System::Collections::Generic::Queue_1_T__Enumerator_QuestsController_QueuedQuestMessage_ {
    IL2CPP_REGISTER_METHOD(0x001ECB90, void, ctor, (app::Queue_1_T_Enumerator_QuestsController_QueuedQuestMessage___Boxed * this_ptr, app::Queue_1_QuestsController_QueuedQuestMessage_* q))
    ...
    IL2CPP_REGISTER_METHOD(0x001EDC00, app::QuestsController_QueuedQuestMessage, get_Current, (app::Queue_1_T_Enumerator_QuestsController_QueuedQuestMessage___Boxed * this_ptr))

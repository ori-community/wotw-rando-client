...
#include <Modloader/app/structs/IDictionary_2_System_UInt32_RuntimeGuidMapping_CacheEntry_.h>
#include <Modloader/app/structs/IEnumerable_1_RuntimeGuidMapping_CacheEntry_.h>
#include <Modloader/app/structs/IEnumerable_1_System_UInt32_.h>
#include <Modloader/app/structs/IEnumerator.h>
#include <Modloader/app/structs/IEnumerator_1_KeyValuePair_2_System_UInt32_RuntimeGuidMapping_CacheEntry_.h>
...
#include <Modloader/app/structs/KeyValuePair_2_System_UInt32_RuntimeGuidMapping_CacheEntry___Array.h>
...
namespace app::classes::System::Collections::Generic::Dictionary_2_System_UInt32_RuntimeGuidMapping_CacheEntry_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        bool,
        TryGetValue,
        app::Dictionary_2_System_UInt32_RuntimeGuidMapping_CacheEntry_* this_ptr,
        uint32_t key,
        app::RuntimeGuidMapping_CacheEntry* value
    )
    IL2CPP_REGISTER_METHOD(
        0x02BAC140,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ctor_5,
        app::Dictionary_2_System_UInt32_RuntimeGuidMapping_CacheEntry_* this_ptr,
        app::IDictionary_2_System_UInt32_RuntimeGuidMapping_CacheEntry_* dictionary
    )
    IL2CPP_REGISTER_METHOD(
        0x02EFEE80,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        0x002FB990,
        app::IEqualityComparer_1_System_UInt32_*,
        get_Comparer,
        app::Dictionary_2_System_UInt32_RuntimeGuidMapping_CacheEntry_* this_ptr
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x0283B2B0,
        app::Dictionary_2_TKey_TValue_KeyCollection_System_UInt32_RuntimeGuidMapping_CacheEntry_*,
        get_Keys,
        app::Dictionary_2_System_UInt32_RuntimeGuidMapping_CacheEntry_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
    ...
    IL2CPP_REGISTER_METHOD(
        0x0283B3E0,
        app::Dictionary_2_TKey_TValue_ValueCollection_System_UInt32_RuntimeGuidMapping_CacheEntry_*,
        get_Values,
        app::Dictionary_2_System_UInt32_RuntimeGuidMapping_CacheEntry_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x0283B3E0,
        app::ICollection_1_RuntimeGuidMapping_CacheEntry_*,
        System_Collections_Generic_IDictionary_TKey_TValue__get_Values,
        app::Dictionary_2_System_UInt32_RuntimeGuidMapping_CacheEntry_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x0283B3E0,
        app::IEnumerable_1_RuntimeGuidMapping_CacheEntry_*,
        System_Collections_Generic_IReadOnlyDictionary_TKey_TValue__get_Values,
        app::Dictionary_2_System_UInt32_RuntimeGuidMapping_CacheEntry_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x02EFF320,
        app::RuntimeGuidMapping_CacheEntry,
        get_Item,
        app::Dictionary_2_System_UInt32_RuntimeGuidMapping_CacheEntry_* this_ptr,
        uint32_t key
    )
    IL2CPP_REGISTER_METHOD(
        ...
        app::Dictionary_2_System_UInt32_RuntimeGuidMapping_CacheEntry_* this_ptr,
        app::KeyValuePair_2_System_UInt32_RuntimeGuidMapping_CacheEntry_ key_value_pair
    )
    IL2CPP_REGISTER_METHOD(
        0x02EFF460,
        bool,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        CopyTo,
        app::Dictionary_2_System_UInt32_RuntimeGuidMapping_CacheEntry_* this_ptr,
        app::KeyValuePair_2_System_UInt32_RuntimeGuidMapping_CacheEntry___Array* array,
        int32_t index
    )
    IL2CPP_REGISTER_METHOD(
        0x02EFF960,
        app::Dictionary_2_TKey_TValue_Enumerator_System_UInt32_RuntimeGuidMapping_CacheEntry_,
        GetEnumerator,
        app::Dictionary_2_System_UInt32_RuntimeGuidMapping_CacheEntry_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x02EFF9B0,
        app::IEnumerator_1_KeyValuePair_2_System_UInt32_RuntimeGuidMapping_CacheEntry_*,

...
namespace app::classes::System::Collections::Generic::List_1_TriangleNet_Geometry_ISegment_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        AddRange,
        app::List_1_TriangleNet_Geometry_ISegment_* this_ptr,
        app::IEnumerable_1_TriangleNet_Geometry_ISegment_* collection
    )
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, app::List_1_TriangleNet_Geometry_ISegment_* this_ptr)
    IL2CPP_REGISTER_METHOD(
        0x025F0B10,
        app::List_1_T_Enumerator_TriangleNet_Geometry_ISegment_,
        GetEnumerator,
        app::List_1_TriangleNet_Geometry_ISegment_* this_ptr
    )

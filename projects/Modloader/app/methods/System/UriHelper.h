...
namespace app::classes::System::UriHelper {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        char16_t* p_str,
        app::Char__Array* dest,
        int32_t current_input_pos,
        int16_t chars_to_add,
        int16_t min_reallocate_chars,
        int32_t* dest_pos,
        int32_t prev_input_pos
    )
    IL2CPP_REGISTER_METHOD(
        0x02A8FFA0,
        app::Char__Array*,
        ...
        int32_t end,
        app::Char__Array* dest,
        int32_t* dest_position,
        char16_t rsvd1,
        char16_t rsvd2,
        char16_t rsvd3,
        app::UnescapeMode__Enum unescape_mode,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Char__Array* dest,
        int32_t* dest_offset,
        app::Char__Array* unescaped_chars,
        int32_t char_count,

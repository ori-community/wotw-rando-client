...
namespace app::classes::System::Convert {
    ...
    IL2CPP_REGISTER_METHOD(0x0203F4E0, int32_t, ConvertToBase64Array, (char16_t* out_chars, uint8_t* in_data, int32_t offset, int32_t length, bool insert_line_breaks))
    ...
    IL2CPP_REGISTER_METHOD(0x0203FE40, int32_t, FromBase64_Decode, (char16_t* start_input_ptr, int32_t input_length, uint8_t* start_dest_ptr, int32_t dest_length))

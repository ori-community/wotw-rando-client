...
namespace app::classes::System::Version {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        bool,
        TryParseComponent,
        app::String* component,
        app::String* component_name,
        app::Version_VersionResult* result,
        int32_t* parsed_component
    )
    ...
    inline bool operator==(app::Version& v1, app::Version& v2) { return op_Equality(&v1, &v2); }
    inline bool operator!=(app::Version& v1, app::Version& v2) { return op_Inequality(&v1, &v2); }
    inline bool operator<(app::Version& v1, app::Version& v2) { return op_LessThan(&v1, &v2); }
    inline bool operator<=(app::Version& v1, app::Version& v2) { return op_LessThanOrEqual(&v1, &v2); }
    inline bool operator>(app::Version& v1, app::Version& v2) { return op_GreaterThan(&v1, &v2); }
    inline bool operator>=(app::Version& v1, app::Version& v2) { return op_GreaterThanOrEqual(&v1, &v2); }
} // namespace app::classes::System::Version

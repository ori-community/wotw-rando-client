...
namespace app::classes::System::Array_InternalEnumerator_1_TextureAnimation_AnimationTextureInfo_ {
    ...
    IL2CPP_REGISTER_METHOD(0x00173170, app::TextureAnimation_AnimationTextureInfo, get_Current, (app::Array_InternalEnumerator_1_TextureAnimation_AnimationTextureInfo___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04757BC0, Array_InternalEnumerator_1_TextureAnimation_AnimationTextureInfo__get_Current__MethodInfo)
    ...
    IL2CPP_REGISTER_METHOD(0x001731A0, app::Object*, IEnumerator_get_Current, (app::Array_InternalEnumerator_1_TextureAnimation_AnimationTextureInfo___Boxed * this_ptr))
} // namespace app::classes::System::Array_InternalEnumerator_1_TextureAnimation_AnimationTextureInfo_

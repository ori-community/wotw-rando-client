...
namespace app::classes::System::Tuple_4_Boolean_Boolean_Boolean_Boolean_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04750948, Tuple_4_Boolean_Boolean_Boolean_Boolean__get_Item1__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00504D80, bool, get_Item2, (app::Tuple_4_Boolean_Boolean_Boolean_Boolean_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047853F8, Tuple_4_Boolean_Boolean_Boolean_Boolean__get_Item2__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x01BFB750, bool, get_Item3, (app::Tuple_4_Boolean_Boolean_Boolean_Boolean_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0471F170, Tuple_4_Boolean_Boolean_Boolean_Boolean__get_Item3__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02619D10, bool, get_Item4, (app::Tuple_4_Boolean_Boolean_Boolean_Boolean_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047098B8, Tuple_4_Boolean_Boolean_Boolean_Boolean__get_Item4__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04733FF8, Tuple_4_Boolean_Boolean_Boolean_Boolean___ctor__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02A6AC90, bool, Equals, (app::Tuple_4_Boolean_Boolean_Boolean_Boolean_ * this_ptr, app::Object* obj))
    IL2CPP_REGISTER_METHOD(0x02A6AD70, bool, IStructuralEquatable_Equals, (app::Tuple_4_Boolean_Boolean_Boolean_Boolean_ * this_ptr, app::Object* other, app::IEqualityComparer* comparer))
    ...
    IL2CPP_REGISTER_METHOD(0x02A6B170, int32_t, IStructuralComparable_CompareTo, (app::Tuple_4_Boolean_Boolean_Boolean_Boolean_ * this_ptr, app::Object* other, app::IComparer* comparer))
    IL2CPP_REGISTER_METHODINFO(0x04762A78, Tuple_4_Boolean_Boolean_Boolean_Boolean__System_Collections_IStructuralComparable_CompareTo__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02A6B510, int32_t, GetHashCode, (app::Tuple_4_Boolean_Boolean_Boolean_Boolean_ * this_ptr))
    IL2CPP_REGISTER_METHOD(0x02A6B5E0, int32_t, IStructuralEquatable_GetHashCode, (app::Tuple_4_Boolean_Boolean_Boolean_Boolean_ * this_ptr, app::IEqualityComparer* comparer))

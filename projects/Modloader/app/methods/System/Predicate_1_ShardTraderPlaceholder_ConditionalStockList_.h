...
namespace app::classes::System::Predicate_1_ShardTraderPlaceholder_ConditionalStockList_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        bool,
        Invoke,
        app::Predicate_1_ShardTraderPlaceholder_ConditionalStockList_* this_ptr,

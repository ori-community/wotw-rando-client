...
namespace app::classes::System::Runtime::Remoting::Messaging::MonoMethodMessage {
    ...
    IL2CPP_REGISTER_METHOD(0x02318410, void, ctor, (app::MonoMethodMessage * this_ptr, app::MethodInfo_1* minfo, app::Object__Array* in_args, app::Object__Array* out_args))

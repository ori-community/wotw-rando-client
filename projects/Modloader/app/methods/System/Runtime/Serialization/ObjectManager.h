...
namespace app::classes::System::Runtime::Serialization::ObjectManager {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::ObjectManager* this_ptr,
        app::ISurrogateSelector* selector,
        app::StreamingContext context,
        bool check_security,
        bool is_cross_app_domain
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        GetCompletionInfo,
        app::ObjectManager* this_ptr,
        app::FixupHolder* fixup,
        app::ObjectHolder** holder,
        app::Object** member,
        bool b_throw_if_missing
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::ObjectManager* this_ptr,
        app::FixupHolder* fixup,
        int64_t object_to_be_fixed,
        int64_t object_required
    )
    IL2CPP_REGISTER_METHOD(
        0x01EDAF10,
        void,

...
namespace app::classes::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1_SystemIntegration_Races_RaceRequestResult_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Start_1,
        app::AsyncTaskMethodBuilder_1_SystemIntegration_Races_RaceRequestResult___Boxed* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::AsyncTaskMethodBuilder_1_SystemIntegration_Races_RaceRequestResult___Boxed* this_ptr,
        app::TaskAwaiter_1_SystemIntegration_Races_RaceRequestResultEntry_* awaiter,
        app::PlayFabRaceServiceProvider_ProcessLeaderBoardList_d_13* state_machine
    )
} // namespace app::classes::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1_SystemIntegration_Races_RaceRequestResult_

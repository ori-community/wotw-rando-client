...
namespace app::classes::System::Runtime::CompilerServices::AsyncMethodBuilderCore {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Action*,
        GetCompletionAction,
        app::AsyncMethodBuilderCore__Boxed* this_ptr,
        app::Task* task_for_tracing,
        app::AsyncMethodBuilderCore_MoveNextRunner** runner_to_initialize
    )
    IL2CPP_REGISTER_METHOD(
        0x0018ED80,
        app::Action*,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::AsyncMethodBuilderCore_MoveNextRunner* runner,
        app::Task* built_task
    )

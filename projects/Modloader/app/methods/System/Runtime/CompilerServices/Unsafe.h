...
namespace app::classes::System::Runtime::CompilerServices::Unsafe {
    ...
    IL2CPP_REGISTER_METHOD(0x0153B7B0, void*, ByteOffset_3, (char16_t* origin, char16_t* target))
    IL2CPP_REGISTER_METHOD(0x0157E100, uint8_t*, Add_2, (uint8_t * source, int32_t element_offset))
    IL2CPP_REGISTER_METHOD(0x0157E110, char16_t*, Add_3, (char16_t* source, int32_t element_offset))
    IL2CPP_REGISTER_METHOD(0x0157E130, uint8_t*, AddByteOffset_2, (uint8_t * source, void* byte_offset))
    IL2CPP_REGISTER_METHOD(0x0157E130, char16_t*, AddByteOffset_3, (char16_t* source, void* byte_offset))
    IL2CPP_REGISTER_METHOD(0x004C50A0, uint8_t*, AsRef_2, (app::Void * source))
    IL2CPP_REGISTER_METHOD(0x004C50A0, char16_t*, AsRef_3, (app::Void * source))
} // namespace app::classes::System::Runtime::CompilerServices::Unsafe

...
namespace app::classes::System::Runtime::InteropServices::DllImportAttribute {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_1,
        app::DllImportAttribute* this_ptr,
        app::String* dll_name,
        app::String* entry_point,
        app::CharSet__Enum char_set,
        bool exact_spelling,
        bool set_last_error,
        bool preserve_sig,
        app::CallingConvention__Enum calling_convention,
        bool best_fit_mapping,
        bool throw_on_unmappable_char
    )

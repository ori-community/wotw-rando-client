...
namespace app::classes::System::Threading::ThreadPoolWorkQueue_SparseArray_1_ThreadPoolWorkQueue_WorkStealingQueue_ {
    IL2CPP_REGISTER_METHOD(
        0x02775660,
        app::ThreadPoolWorkQueue_WorkStealingQueue__Array*,
        get_Current,
        app::ThreadPoolWorkQueue_SparseArray_1_ThreadPoolWorkQueue_WorkStealingQueue_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x02A61DB0,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Add,
        app::ThreadPoolWorkQueue_SparseArray_1_ThreadPoolWorkQueue_WorkStealingQueue_* this_ptr,
        app::ThreadPoolWorkQueue_WorkStealingQueue* e
    )
    IL2CPP_REGISTER_METHOD(
        0x02A620A0,
        void,

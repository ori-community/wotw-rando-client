...
namespace app::classes::System::Threading::CancellationToken {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::CancellationToken__Boxed* this_ptr,
    ...
    inline bool operator==(app::CancellationToken left, app::CancellationToken right) { return op_Equality(left, right); }
    inline bool operator!=(app::CancellationToken left, app::CancellationToken right) { return op_Inequality(left, right); }
} // namespace app::classes::System::Threading::CancellationToken

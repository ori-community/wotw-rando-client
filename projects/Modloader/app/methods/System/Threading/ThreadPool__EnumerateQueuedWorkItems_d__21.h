...
namespace app::classes::System::Threading::ThreadPool__EnumerateQueuedWorkItems_d__21 {
    ...
    IL2CPP_REGISTER_METHOD(
        0x002FB930,
        app::IThreadPoolWorkItem*,
        IEnumerator_IThreadPoolWorkItem__get_Current,
        app::ThreadPool_EnumerateQueuedWorkItems_d_21* this_ptr
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x023466D0,
        app::IEnumerator_1_System_Threading_IThreadPoolWorkItem_*,
        IEnumerable_IThreadPoolWorkItem__GetEnumerator,
        app::ThreadPool_EnumerateQueuedWorkItems_d_21* this_ptr
    )

...
namespace app::classes::System::Threading::ReaderWriterLockSlim {
    ...
    IL2CPP_REGISTER_METHOD(
        0x02FD2D20,
        bool,
        TryEnterUpgradeableReadLock_2,
        app::ReaderWriterLockSlim* this_ptr,
        app::ReaderWriterLockSlim_TimeoutTracker timeout
    )
    IL2CPP_REGISTER_METHOD(
        0x02FD2D30,
        bool,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        LazyCreateEvent,
        app::ReaderWriterLockSlim* this_ptr,
        app::EventWaitHandle** wait_event,
        bool make_auto_reset_event
    )
    IL2CPP_REGISTER_METHOD(
        0x02FD38B0,
        bool,

...
namespace app::classes::System::Threading::Tasks::TaskFactory_1_System_Boolean_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_2,
        app::TaskFactory_1_System_Boolean_* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Func_2_IAsyncResult_Boolean_* end_function,
        app::Action_1_IAsyncResult_* end_action,
        app::Task_1_System_Boolean_* promise,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Func_2_IAsyncResult_Boolean_* end_method,
        app::Object* state
    )
    IL2CPP_REGISTER_METHOD(
        0x02779310,

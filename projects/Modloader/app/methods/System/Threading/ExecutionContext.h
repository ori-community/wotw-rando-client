...
namespace app::classes::System::Threading::ExecutionContext {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::ContextCallback* callback,
        app::Object* state,
        bool preserve_sync_ctx
    )
    IL2CPP_REGISTER_METHOD(
        0x027DCBE0,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        0x027DCFB0,
        void,
        EstablishCopyOnWriteScope_2,
        app::Thread* current_thread,
        bool known_null_windows_identity,
        app::ExecutionContextSwitcher* ecsw
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::ExecutionContext_CaptureOptions__Enum options
    )

...
namespace app::classes::System::Threading::ThreadPoolWorkQueue {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Dequeue,
        app::ThreadPoolWorkQueue* this_ptr,
        app::ThreadPoolWorkQueueThreadLocals* tl,
        app::IThreadPoolWorkItem** callback,
        bool* missed_steal
    )

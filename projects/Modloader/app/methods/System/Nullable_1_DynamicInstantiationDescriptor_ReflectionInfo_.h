...
namespace app::classes::System::Nullable_1_DynamicInstantiationDescriptor_ReflectionInfo_ {
    ...
    IL2CPP_REGISTER_METHOD(0x001F42D0, app::DynamicInstantiationDescriptor_ReflectionInfo, get_Value, (app::Nullable_1_DynamicInstantiationDescriptor_ReflectionInfo___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04759678, Nullable_1_DynamicInstantiationDescriptor_ReflectionInfo__get_Value__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x001F42B0, void, ctor, (app::Nullable_1_DynamicInstantiationDescriptor_ReflectionInfo___Boxed * this_ptr, app::DynamicInstantiationDescriptor_ReflectionInfo value))
    ...
    IL2CPP_REGISTER_METHOD(0x001F4430, bool, Equals_2, (app::Nullable_1_DynamicInstantiationDescriptor_ReflectionInfo___Boxed * this_ptr, app::Nullable_1_DynamicInstantiationDescriptor_ReflectionInfo_ other))
    ...
    IL2CPP_REGISTER_METHOD(0x001F4590, app::DynamicInstantiationDescriptor_ReflectionInfo, GetValueOrDefault_1, (app::Nullable_1_DynamicInstantiationDescriptor_ReflectionInfo___Boxed * this_ptr))
    IL2CPP_REGISTER_METHOD(0x001F45B0, app::DynamicInstantiationDescriptor_ReflectionInfo, GetValueOrDefault_2, (app::Nullable_1_DynamicInstantiationDescriptor_ReflectionInfo___Boxed * this_ptr, app::DynamicInstantiationDescriptor_ReflectionInfo default_value))

...
namespace app::classes::System::AssemblyLoadEventHandler {
    ...
    IL2CPP_REGISTER_METHOD(0x01435260, app::IAsyncResult*, BeginInvoke, (app::AssemblyLoadEventHandler * this_ptr, app::Object* sender, app::AssemblyLoadEventArgs* args, app::AsyncCallback* callback, app::Object* object))

...
namespace app::classes::System::Array_InternalEnumerator_1_Moon_IkChainSolver_JointData_ {
    ...
    IL2CPP_REGISTER_METHOD(0x001647C0, app::IkChainSolver_JointData, get_Current, (app::Array_InternalEnumerator_1_Moon_IkChainSolver_JointData___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0473B7E0, Array_InternalEnumerator_1_Moon_IkChainSolver_JointData__get_Current__MethodInfo)

...
namespace app::classes::System::IO::FileSystemEnumerableIterator_1_System_Object_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_1,
        app::FileSystemEnumerableIterator_1_System_Object_* this_ptr,
        app::String* path,
        app::String* original_user_path,
        app::String* search_pattern,
        app::SearchOption__Enum search_option,
        app::SearchResultHandler_1_System_Object_* result_handler,
        bool check_host
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ctor_2,
        app::FileSystemEnumerableIterator_1_System_Object_* this_ptr,
        app::String* full_path,
        app::String* normalized_search_path,
        app::String* search_criteria,
        app::String* user_path,
        app::SearchOption__Enum search_option,
        app::SearchResultHandler_1_System_Object_* result_handler,
        bool check_host
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        CreateSearchResult,
        app::FileSystemEnumerableIterator_1_System_Object_* this_ptr,
        app::Directory_SearchData* local_search_data,
        app::Win32Native_WIN32_FIND_DATA* find_data
    )

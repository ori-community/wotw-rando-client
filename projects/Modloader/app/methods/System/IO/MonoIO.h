...
namespace app::classes::System::IO::MonoIO {
    ...
    IL2CPP_REGISTER_METHOD(0x02374C00, void*, Open_1, (char16_t* filename, app::FileMode__Enum mode, app::FileAccess__Enum access, app::FileShare__Enum share, app::FileOptions__Enum options, app::MonoIOError__Enum* error))
    ...
    IL2CPP_REGISTER_METHOD(0x02375890, bool, DuplicateHandle, (void* source_process_handle, void* source_handle, void* target_process_handle, void** target_handle, int32_t access, int32_t inherit, int32_t options, app::MonoIOError__Enum* error))

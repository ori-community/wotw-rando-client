...
namespace app::classes::System::Numerics::BigInteger {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Byte__Array*,
        TryGetBytes,
        app::BigInteger_2__Boxed* this_ptr,
        app::BigInteger_GetBytesMode__Enum mode,
        app::Span_1_Byte_ destination,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::BigInteger_2,
        Add,
        app::UInt32__Array* left_bits,
        int32_t left_sign,
        app::UInt32__Array* right_bits,
        int32_t right_sign
    )
    ...
    inline app::BigInteger_2 operator-(app::BigInteger_2 left, app::BigInteger_2 right) { return op_Subtraction(left, right); }
    inline app::BigInteger_2 operator-(app::BigInteger_2 value) { return op_UnaryNegation(value); }
    inline app::BigInteger_2 operator+(app::BigInteger_2 left, app::BigInteger_2 right) { return op_Addition(left, right); }
    inline app::BigInteger_2 operator*(app::BigInteger_2 left, app::BigInteger_2 right) { return op_Multiply(left, right); }
    inline bool operator<=(app::BigInteger_2 left, app::BigInteger_2 right) { return op_LessThanOrEqual_1(left, right); }
    inline bool operator!=(app::BigInteger_2 left, app::BigInteger_2 right) { return op_Inequality_1(left, right); }
    inline bool operator<(app::BigInteger_2 left, int64_t right) { return op_LessThan_1(left, right); }
    inline bool operator<=(app::BigInteger_2 left, int64_t right) { return op_LessThanOrEqual_2(left, right); }
    inline bool operator==(app::BigInteger_2 left, int64_t right) { return op_Equality(left, right); }
    inline bool operator!=(app::BigInteger_2 left, int64_t right) { return op_Inequality_2(left, right); }
    inline bool operator<(int64_t left, app::BigInteger_2 right) { return op_LessThan_2(left, right); }
    inline bool operator<=(int64_t left, app::BigInteger_2 right) { return op_LessThanOrEqual_3(left, right); }
} // namespace app::classes::System::Numerics::BigInteger

...
namespace app::classes::System::TimeZoneInfo_TransitionTime {
    ...
    IL2CPP_REGISTER_METHOD(
        0x027BA8F0,
        app::TimeZoneInfo_TransitionTime,
        CreateFloatingDateRule,
        app::DateTime time_of_day,
        int32_t month,
        int32_t week,
        app::DayOfWeek__Enum day_of_week
    )
    IL2CPP_REGISTER_METHOD(
        0x027BA9A0,
        app::TimeZoneInfo_TransitionTime,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::TimeZoneInfo_TransitionTime__Boxed* this_ptr,
    ...
    inline bool operator!=(app::TimeZoneInfo_TransitionTime t1, app::TimeZoneInfo_TransitionTime t2) { return op_Inequality(t1, t2); }
} // namespace app::classes::System::TimeZoneInfo_TransitionTime

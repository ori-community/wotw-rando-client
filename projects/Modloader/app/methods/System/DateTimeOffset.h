...
namespace app::classes::System::DateTimeOffset {
    ...
    IL2CPP_REGISTER_METHOD(0x00214BC0, void, ctor_4, (app::DateTimeOffset__Boxed * this_ptr, int32_t year, int32_t month, int32_t day, int32_t hour, int32_t minute, int32_t second, app::TimeSpan offset))
    IL2CPP_REGISTER_METHOD(0x00214CF0, void, ctor_5, (app::DateTimeOffset__Boxed * this_ptr, int32_t year, int32_t month, int32_t day, int32_t hour, int32_t minute, int32_t second, int32_t millisecond, app::TimeSpan offset))
    IL2CPP_REGISTER_METHOD(0x00214E20, void, ctor_6, (app::DateTimeOffset__Boxed * this_ptr, int32_t year, int32_t month, int32_t day, int32_t hour, int32_t minute, int32_t second, int32_t millisecond, app::Calendar* calendar, app::TimeSpan offset))
    ...
    IL2CPP_REGISTER_METHOD(0x00215560, void, ISerializable_GetObjectData, (app::DateTimeOffset__Boxed * this_ptr, app::SerializationInfo* info, app::StreamingContext context))
    ...
    IL2CPP_REGISTER_METHOD(0x028AB5C0, app::DateTimeOffset, Parse_2, (app::String * input, app::IFormatProvider* format_provider, app::DateTimeStyles__Enum styles))
    IL2CPP_REGISTER_METHOD(0x028AB830, app::DateTimeOffset, ParseExact, (app::String * input, app::String__Array* formats, app::IFormatProvider* format_provider, app::DateTimeStyles__Enum styles))
    ...
    IL2CPP_REGISTER_METHOD(0x00215A90, app::String*, ToString_4, (app::DateTimeOffset__Boxed * this_ptr, app::String* format, app::IFormatProvider* format_provider))
    IL2CPP_REGISTER_METHOD(0x00215AA0, app::DateTimeOffset, ToUniversalTime, (app::DateTimeOffset__Boxed * this_ptr))
    IL2CPP_REGISTER_METHOD(0x028ABF50, bool, TryParse, (app::String * input, app::IFormatProvider* format_provider, app::DateTimeStyles__Enum styles, app::DateTimeOffset* result))
    IL2CPP_REGISTER_METHOD(0x028AC220, bool, TryParseExact_1, (app::String * input, app::String* format, app::IFormatProvider* format_provider, app::DateTimeStyles__Enum styles, app::DateTimeOffset* result))
    IL2CPP_REGISTER_METHOD(0x028AC500, bool, TryParseExact_2, (app::String * input, app::String__Array* formats, app::IFormatProvider* format_provider, app::DateTimeStyles__Enum styles, app::DateTimeOffset* result))

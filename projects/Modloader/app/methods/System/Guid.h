...
namespace app::classes::System::Guid {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t flags,
        int16_t* result,
        app::Guid_GuidResult* parse_result
    )
    IL2CPP_REGISTER_METHOD(
        0x01DFAC10,
        bool,
    ...
    IL2CPP_REGISTER_METHOD(0x01DFC320, char16_t, HexToChar, int32_t a)
    IL2CPP_REGISTER_METHOD(0x01DFC340, int32_t, HexsToChars_1, char16_t* guid_chars, int32_t offset, int32_t a, int32_t b)
    IL2CPP_REGISTER_METHOD(0x01DFC420, int32_t, HexsToChars_2, char16_t* guid_chars, int32_t offset, int32_t a, int32_t b, bool hex)
    ...
    inline bool operator==(app::Guid a, app::Guid b) { return op_Equality(a, b); }
    inline bool operator!=(app::Guid a, app::Guid b) { return op_Inequality(a, b); }
} // namespace app::classes::System::Guid

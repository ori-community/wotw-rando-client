...
namespace app::classes::System::Array_InternalEnumerator_1_Moon_MoonAnimatorLayerDefinition_ {
    ...
    IL2CPP_REGISTER_METHOD(0x00164BC0, app::MoonAnimatorLayerDefinition, get_Current, (app::Array_InternalEnumerator_1_Moon_MoonAnimatorLayerDefinition___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0478CCE0, Array_InternalEnumerator_1_Moon_MoonAnimatorLayerDefinition__get_Current__MethodInfo)
    ...
    IL2CPP_REGISTER_METHOD(0x00164BF0, app::Object*, IEnumerator_get_Current, (app::Array_InternalEnumerator_1_Moon_MoonAnimatorLayerDefinition___Boxed * this_ptr))
} // namespace app::classes::System::Array_InternalEnumerator_1_Moon_MoonAnimatorLayerDefinition_

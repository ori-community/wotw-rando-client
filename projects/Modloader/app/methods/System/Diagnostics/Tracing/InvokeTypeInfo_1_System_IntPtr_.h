...
namespace app::classes::System::Diagnostics::Tracing::InvokeTypeInfo_1_System_IntPtr_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        WriteMetadata,
        app::InvokeTypeInfo_1_System_IntPtr_* this_ptr,
        app::TraceLoggingMetadataCollector* collector,
        app::String* name,
        app::EventFieldFormat__Enum format
    )
    IL2CPP_REGISTER_METHOD(0x02B98F50, void, WriteData, app::InvokeTypeInfo_1_System_IntPtr_* this_ptr, app::TraceLoggingDataCollector* collector, void** value)

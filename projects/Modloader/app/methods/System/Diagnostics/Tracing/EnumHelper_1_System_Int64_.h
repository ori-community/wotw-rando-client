...
namespace app::classes::System::Diagnostics::Tracing::EnumHelper_1_System_Int64_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02FF6990, int64_t, Cast_3, char16_t value)
    IL2CPP_REGISTER_METHOD(0x02FF6A60, int64_t, Cast_4, app::KeyValuePair_2_System_Object_System_Object_ value)
    IL2CPP_REGISTER_METHOD(0x02FF6B30, int64_t, Cast_5, app::DateTime value)
    IL2CPP_REGISTER_METHOD(0x02FF6A60, int64_t, Cast_6, app::DateTimeOffset value)
    IL2CPP_REGISTER_METHOD(0x02FF6A60, int64_t, Cast_7, app::Decimal value)
    IL2CPP_REGISTER_METHOD(0x02FF6C00, int64_t, Cast_8, app::EmptyStruct value)
    IL2CPP_REGISTER_METHOD(0x02FF6CD0, int64_t, Cast_9, double value)
    IL2CPP_REGISTER_METHOD(0x02FF6A60, int64_t, Cast_10, app::Guid value)
    ...
    IL2CPP_REGISTER_METHOD(0x02FF6B30, int64_t, Cast_18, app::TimeSpan value)

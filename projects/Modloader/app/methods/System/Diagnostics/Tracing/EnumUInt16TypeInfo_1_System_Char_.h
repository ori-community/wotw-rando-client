...
namespace app::classes::System::Diagnostics::Tracing::EnumUInt16TypeInfo_1_System_Char_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02B919C0, void, WriteData, (app::EnumUInt16TypeInfo_1_System_Char_ * this_ptr, app::TraceLoggingDataCollector* collector, char16_t* value))

...
namespace app::classes::System::Diagnostics::Tracing::ClassPropertyWriter_2_System_TimeSpan_System_Int32_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02B379C0, void, Write, (app::ClassPropertyWriter_2_System_TimeSpan_System_Int32_ * this_ptr, app::TraceLoggingDataCollector* collector, app::TimeSpan* container))

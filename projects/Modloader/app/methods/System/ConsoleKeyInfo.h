...
namespace app::classes::System::ConsoleKeyInfo {
    IL2CPP_REGISTER_METHOD(0x001DBE50, void, ctor, (app::ConsoleKeyInfo__Boxed * this_ptr, char16_t key_char, app::ConsoleKey__Enum key, bool shift, bool alt, bool control))

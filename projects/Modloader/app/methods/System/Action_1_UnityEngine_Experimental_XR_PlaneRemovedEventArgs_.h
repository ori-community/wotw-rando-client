...
namespace app::classes::System::Action_1_UnityEngine_Experimental_XR_PlaneRemovedEventArgs_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::Action_1_UnityEngine_Experimental_XR_PlaneRemovedEventArgs_* this_ptr,
        app::Object* object,
        void* method_1
    )
    IL2CPP_REGISTER_METHOD(

...
namespace app::classes::System::Func_2_System_Collections_DictionaryEntry_Object_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::IAsyncResult*,
        BeginInvoke,
        app::Func_2_System_Collections_DictionaryEntry_Object_* this_ptr,
        app::DictionaryEntry arg,

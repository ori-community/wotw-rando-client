...
namespace app::classes::System::Dynamic::ExpandoObject {
    ...
    IL2CPP_REGISTER_METHOD(0x01F8DA60, app::DynamicMetaObject*, IDynamicMetaObjectProvider_GetMetaObject, (app::ExpandoObject * this_ptr, app::Expression* parameter))
    ...
    IL2CPP_REGISTER_METHOD(0x01F8EE10, app::IEnumerator_1_KeyValuePair_2_System_String_System_Object_*, IEnumerable_KeyValuePair_string__object___GetEnumerator, (app::ExpandoObject * this_ptr))
    IL2CPP_REGISTER_METHOD(0x01F8EE10, app::IEnumerator*, IEnumerable_GetEnumerator, (app::ExpandoObject * this_ptr))
    IL2CPP_REGISTER_METHOD(0x01F8EE40, app::IEnumerator_1_KeyValuePair_2_System_String_System_Object_*, GetExpandoEnumerator, (app::ExpandoObject * this_ptr, app::ExpandoObject_ExpandoData* data, int32_t version))

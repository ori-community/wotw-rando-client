...
namespace app::classes::System::Dynamic::ExpandoObject_MetaExpando {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::ExpandoObject_MetaExpando* this_ptr,
        app::DynamicMetaObjectBinder* binder,
        app::String* name,
        bool ignore_case,
        app::DynamicMetaObject* fallback,
        app::Func_2_System_Dynamic_DynamicMetaObject_System_Dynamic_DynamicMetaObject_* fallback_invoke
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::ExpandoClass* original_class,
        app::DynamicMetaObject* succeeds
    )
    IL2CPP_REGISTER_METHOD(
        0x01F92290,
        app::ExpandoClass*,

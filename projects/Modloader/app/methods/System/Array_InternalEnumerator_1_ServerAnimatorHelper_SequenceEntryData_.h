...
namespace app::classes::System::Array_InternalEnumerator_1_ServerAnimatorHelper_SequenceEntryData_ {
    ...
    IL2CPP_REGISTER_METHOD(0x001B0590, app::ServerAnimatorHelper_SequenceEntryData, get_Current, (app::Array_InternalEnumerator_1_ServerAnimatorHelper_SequenceEntryData___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0470D038, Array_InternalEnumerator_1_ServerAnimatorHelper_SequenceEntryData__get_Current__MethodInfo)
    ...
    IL2CPP_REGISTER_METHOD(0x001B05C0, app::Object*, IEnumerator_get_Current, (app::Array_InternalEnumerator_1_ServerAnimatorHelper_SequenceEntryData___Boxed * this_ptr))
} // namespace app::classes::System::Array_InternalEnumerator_1_ServerAnimatorHelper_SequenceEntryData_

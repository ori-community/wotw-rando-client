...
namespace app::classes::System::RuntimeType_ListBuilder_1_System_Reflection_FieldInfo_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04713448, RuntimeType_ListBuilder_1_System_Reflection_FieldInfo___ctor__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04728408, RuntimeType_ListBuilder_1_System_Reflection_FieldInfo__Add__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04710238, RuntimeType_ListBuilder_1_System_Reflection_FieldInfo__ToArray__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0475DBB0, RuntimeType_ListBuilder_1_System_Reflection_FieldInfo__get_Count__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x047586A8, RuntimeType_ListBuilder_1_System_Reflection_FieldInfo__CopyTo__MethodInfo)
} // namespace app::classes::System::RuntimeType_ListBuilder_1_System_Reflection_FieldInfo_

...
namespace app::classes::System::Array_InternalEnumerator_1_UnityEngine_SendMouseEvents_HitInfo_ {
    ...
    IL2CPP_REGISTER_METHOD(0x00176FE0, app::SendMouseEvents_HitInfo, get_Current, (app::Array_InternalEnumerator_1_UnityEngine_SendMouseEvents_HitInfo___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04756E28, Array_InternalEnumerator_1_UnityEngine_SendMouseEvents_HitInfo__get_Current__MethodInfo)
    ...
    IL2CPP_REGISTER_METHOD(0x00177010, app::Object*, IEnumerator_get_Current, (app::Array_InternalEnumerator_1_UnityEngine_SendMouseEvents_HitInfo___Boxed * this_ptr))
} // namespace app::classes::System::Array_InternalEnumerator_1_UnityEngine_SendMouseEvents_HitInfo_

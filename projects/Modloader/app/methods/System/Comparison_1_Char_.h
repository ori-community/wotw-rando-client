...
namespace app::classes::System::Comparison_1_Char_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02C7CEC0, int32_t, Invoke, (app::Comparison_1_Char_ * this_ptr, char16_t x, char16_t y))
    IL2CPP_REGISTER_METHOD(0x02C7D240, app::IAsyncResult*, BeginInvoke, (app::Comparison_1_Char_ * this_ptr, char16_t x, char16_t y, app::AsyncCallback* callback, app::Object* object))

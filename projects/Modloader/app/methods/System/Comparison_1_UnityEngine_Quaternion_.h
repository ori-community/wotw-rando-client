...
namespace app::classes::System::Comparison_1_UnityEngine_Quaternion_ {
    IL2CPP_REGISTER_METHOD(0x00611810, void, ctor, app::Comparison_1_UnityEngine_Quaternion_* this_ptr, app::Object* object, void* method_1)
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::IAsyncResult*,
        BeginInvoke,
        app::Comparison_1_UnityEngine_Quaternion_* this_ptr,
        app::Quaternion x,
        app::Quaternion y,

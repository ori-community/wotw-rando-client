...
namespace app::classes::System::Nullable_1_System_Runtime_Serialization_StreamingContext_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        GetValueOrDefault_1,
        app::Nullable_1_System_Runtime_Serialization_StreamingContext___Boxed* this_ptr
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Equals_2,
        app::Nullable_1_System_Runtime_Serialization_StreamingContext___Boxed* this_ptr,
        app::Nullable_1_System_Runtime_Serialization_StreamingContext_ other
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        GetValueOrDefault_2,
        app::Nullable_1_System_Runtime_Serialization_StreamingContext___Boxed* this_ptr,
        app::StreamingContext default_value
    )

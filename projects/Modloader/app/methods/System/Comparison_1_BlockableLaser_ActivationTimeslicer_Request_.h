...
namespace app::classes::System::Comparison_1_BlockableLaser_ActivationTimeslicer_Request_ {
    IL2CPP_REGISTER_METHOD(0x00611810, void, ctor, (app::Comparison_1_BlockableLaser_ActivationTimeslicer_Request_ * this_ptr, app::Object* object, void* method_1))
    ...
    IL2CPP_REGISTER_METHOD(0x02B84F40, app::IAsyncResult*, BeginInvoke, (app::Comparison_1_BlockableLaser_ActivationTimeslicer_Request_ * this_ptr, app::BlockableLaser_ActivationTimeslicer_Request x, app::BlockableLaser_ActivationTimeslicer_Request y, app::AsyncCallback* callback, app::Object* object))

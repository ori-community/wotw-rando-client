...
namespace app::classes::System::Array_InternalEnumerator_1_MeshTrail_MeshTrailTurbulence_ {
    ...
    IL2CPP_REGISTER_METHOD(0x00163440, app::MeshTrail_MeshTrailTurbulence, get_Current, (app::Array_InternalEnumerator_1_MeshTrail_MeshTrailTurbulence___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047610E8, Array_InternalEnumerator_1_MeshTrail_MeshTrailTurbulence__get_Current__MethodInfo)

...
namespace app::classes::System::Comparison_1_PreRecordingInstantiationEntry_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02C7B650, app::IAsyncResult*, BeginInvoke, (app::Comparison_1_PreRecordingInstantiationEntry_ * this_ptr, app::PreRecordingInstantiationEntry x, app::PreRecordingInstantiationEntry y, app::AsyncCallback* callback, app::Object* object))

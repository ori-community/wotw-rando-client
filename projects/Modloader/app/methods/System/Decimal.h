...
namespace app::classes::System::Decimal {
    ...
    inline app::Decimal operator-(app::Decimal d) { return op_UnaryNegation(d); }
    inline app::Decimal operator++(app::Decimal d) { return op_Increment(d); }
    inline app::Decimal operator+(app::Decimal d1, app::Decimal d2) { return op_Addition(d1, d2); }
    inline app::Decimal operator-(app::Decimal d1, app::Decimal d2) { return op_Subtraction(d1, d2); }
    inline app::Decimal operator*(app::Decimal d1, app::Decimal d2) { return op_Multiply(d1, d2); }
    inline app::Decimal operator/(app::Decimal d1, app::Decimal d2) { return op_Division(d1, d2); }
    inline bool operator==(app::Decimal d1, app::Decimal d2) { return op_Equality(d1, d2); }
    inline bool operator!=(app::Decimal d1, app::Decimal d2) { return op_Inequality(d1, d2); }
    inline bool operator<(app::Decimal d1, app::Decimal d2) { return op_LessThan(d1, d2); }
    inline bool operator<=(app::Decimal d1, app::Decimal d2) { return op_LessThanOrEqual(d1, d2); }
    inline bool operator>(app::Decimal d1, app::Decimal d2) { return op_GreaterThan(d1, d2); }
    inline bool operator>=(app::Decimal d1, app::Decimal d2) { return op_GreaterThanOrEqual(d1, d2); }
} // namespace app::classes::System::Decimal

...
namespace app::classes::System::Action_1_GenericCastManager_1_NativeArrays_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Invoke_1,
        app::Action_1_GenericCastManager_1_NativeArrays_* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Invoke_2,
        app::Action_1_GenericCastManager_1_NativeArrays__1* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Invoke_3,
        app::Action_1_GenericCastManager_1_NativeArrays__2* this_ptr,

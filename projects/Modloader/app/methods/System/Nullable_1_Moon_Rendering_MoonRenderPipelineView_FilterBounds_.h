...
namespace app::classes::System::Nullable_1_Moon_Rendering_MoonRenderPipelineView_FilterBounds_ {
    ...
    IL2CPP_REGISTER_METHOD(0x001F5A60, app::MoonRenderPipelineView_FilterBounds, get_Value, (app::Nullable_1_Moon_Rendering_MoonRenderPipelineView_FilterBounds___Boxed * this_ptr))
    IL2CPP_REGISTER_METHOD(0x001F42B0, void, ctor, (app::Nullable_1_Moon_Rendering_MoonRenderPipelineView_FilterBounds___Boxed * this_ptr, app::MoonRenderPipelineView_FilterBounds value))
    ...
    IL2CPP_REGISTER_METHOD(0x001F5BC0, bool, Equals_2, (app::Nullable_1_Moon_Rendering_MoonRenderPipelineView_FilterBounds___Boxed * this_ptr, app::Nullable_1_Moon_Rendering_MoonRenderPipelineView_FilterBounds_ other))
    ...
    IL2CPP_REGISTER_METHOD(0x001F4590, app::MoonRenderPipelineView_FilterBounds, GetValueOrDefault_1, (app::Nullable_1_Moon_Rendering_MoonRenderPipelineView_FilterBounds___Boxed * this_ptr))
    IL2CPP_REGISTER_METHOD(0x001F45B0, app::MoonRenderPipelineView_FilterBounds, GetValueOrDefault_2, (app::Nullable_1_Moon_Rendering_MoonRenderPipelineView_FilterBounds___Boxed * this_ptr, app::MoonRenderPipelineView_FilterBounds default_value))

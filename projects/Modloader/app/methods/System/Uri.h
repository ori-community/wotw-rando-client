...
namespace app::classes::System::Uri {
    ...
    IL2CPP_REGISTER_METHOD(0x02A866D0, uint16_t, ParseSchemeCheckImplicitFile, (char16_t* uri_string, uint16_t length, app::ParsingError__Enum* err, app::Uri_Flags__Enum* flags, app::UriParser** syntax))
    ...
    IL2CPP_REGISTER_METHOD(0x02A87300, uint16_t, CheckAuthorityHelper, (app::Uri * this_ptr, char16_t* p_string, uint16_t idx, uint16_t length, app::ParsingError__Enum* err, app::Uri_Flags__Enum* flags, app::UriParser* syntax, app::String** new_host))
    IL2CPP_REGISTER_METHOD(0x02A881D0, void, CheckAuthorityHelperHandleDnsIri, (app::Uri * this_ptr, char16_t* p_string, uint16_t start, int32_t end, int32_t start_input, bool iri_parsing, bool has_unicode, app::UriParser* syntax, app::String* user_info_string, app::Uri_Flags__Enum* flags, bool* just_normalized, app::String** new_host, app::ParsingError__Enum* err))
    IL2CPP_REGISTER_METHOD(0x02A88610, void, CheckAuthorityHelperHandleAnyHostIri, (app::Uri * this_ptr, char16_t* p_string, int32_t start_input, int32_t end, bool iri_parsing, bool has_unicode, app::UriParser* syntax, app::Uri_Flags__Enum* flags, app::String** new_host, app::ParsingError__Enum* err))

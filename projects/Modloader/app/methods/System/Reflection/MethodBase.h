...
namespace app::classes::System::Reflection::MethodBase {
    ...
    IL2CPP_REGISTER_METHOD(
        0x0268D8E0,
        app::MethodBase*,
        GetMethodFromHandleNoGenericCheck_2,
        app::RuntimeMethodHandle handle,
        app::RuntimeTypeHandle reflected_type
    )
    ...
    inline bool operator==(app::MethodBase& left, app::MethodBase& right) { return op_Equality(&left, &right); }
    inline bool operator!=(app::MethodBase& left, app::MethodBase& right) { return op_Inequality(&left, &right); }
} // namespace app::classes::System::Reflection::MethodBase

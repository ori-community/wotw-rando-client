...
namespace app::classes::System::Reflection::ConstructorInfo {
    ...
    inline bool operator==(app::ConstructorInfo& left, app::ConstructorInfo& right) { return op_Equality(&left, &right); }
    inline bool operator!=(app::ConstructorInfo& left, app::ConstructorInfo& right) { return op_Inequality(&left, &right); }
} // namespace app::classes::System::Reflection::ConstructorInfo

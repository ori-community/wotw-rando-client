...
namespace app::classes::System::Reflection::Assembly {
    ...
    IL2CPP_REGISTER_METHOD(0x02281BA0, app::Stream*, GetManifestResourceStream_2, (app::Assembly * this_ptr, app::Type* type, app::String* name, bool skip_security_check, app::StackCrawlMark__Enum* stack_mark))
    IL2CPP_REGISTER_METHOD(0x02281E20, app::Stream*, GetManifestResourceStream_3, (app::Assembly * this_ptr, app::String* name, app::StackCrawlMark__Enum* stack_mark, bool skip_security_check))
    ...
    IL2CPP_REGISTER_METHOD(0x02282100, app::Type*, InternalGetType, (app::Assembly * this_ptr, app::Module* module, app::String* name, bool throw_on_error, bool ignore_case))
    ...
    IL2CPP_REGISTER_METHOD(0x02282310, app::RuntimeAssembly*, InternalGetSatelliteAssembly, (app::Assembly * this_ptr, app::String* name, app::CultureInfo* culture, app::Version* version, bool throw_on_file_not_found, app::StackCrawlMark__Enum* stack_mark))

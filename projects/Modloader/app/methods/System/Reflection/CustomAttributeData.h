...
namespace app::classes::System::Reflection::CustomAttributeData {
    ...
    IL2CPP_REGISTER_METHOD(0x0267D660, void, ctor_2, (app::CustomAttributeData * this_ptr, app::ConstructorInfo* ctor_info, app::Assembly* assembly, void* data, uint32_t data_length))
    IL2CPP_REGISTER_METHOD(0x0267D7F0, void, ResolveArgumentsInternal, (app::ConstructorInfo * ctor, app::Assembly* assembly, void* data, uint32_t data_length, app::Object__Array** ctor_args, app::Object__Array** named_args))
    ...
    IL2CPP_REGISTER_METHOD(0x0267D940, app::IList_1_System_Reflection_CustomAttributeTypedArgument_*, get_ConstructorArguments, (app::CustomAttributeData * this_ptr))

...
namespace app::classes::System::Reflection::MemberInfo {
    ...
    inline bool operator==(app::MemberInfo_1& left, app::MemberInfo_1& right) { return op_Equality(&left, &right); }
    inline bool operator!=(app::MemberInfo_1& left, app::MemberInfo_1& right) { return op_Inequality(&left, &right); }
} // namespace app::classes::System::Reflection::MemberInfo

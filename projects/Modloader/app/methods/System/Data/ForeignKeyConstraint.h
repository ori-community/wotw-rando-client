...
namespace app::classes::System::Data::ForeignKeyConstraint {
    ...
    IL2CPP_REGISTER_METHOD(0x01F5EBA0, void, ctor_2, (app::ForeignKeyConstraint * this_ptr, app::String* constraint_name, app::DataColumn* parent_column, app::DataColumn* child_column))
    IL2CPP_REGISTER_METHOD(0x01F5ED50, void, ctor_3, (app::ForeignKeyConstraint * this_ptr, app::DataColumn__Array* parent_columns, app::DataColumn__Array* child_columns))
    IL2CPP_REGISTER_METHOD(0x01F5EDB0, void, ctor_4, (app::ForeignKeyConstraint * this_ptr, app::String* constraint_name, app::DataColumn__Array* parent_columns, app::DataColumn__Array* child_columns))
    IL2CPP_REGISTER_METHOD(0x01F5EE20, void, ctor_5, (app::ForeignKeyConstraint * this_ptr, app::String* constraint_name, app::String* parent_table_name, app::String__Array* parent_column_names, app::String__Array* child_column_names, app::AcceptRejectRule__Enum accept_reject_rule, app::Rule__Enum delete_rule, app::Rule__Enum update_rule))
    IL2CPP_REGISTER_METHOD(0x01F5EEA0, void, ctor_6, (app::ForeignKeyConstraint * this_ptr, app::String* constraint_name, app::String* parent_table_name, app::String* parent_table_namespace, app::String__Array* parent_column_names, app::String__Array* child_column_names, app::AcceptRejectRule__Enum accept_reject_rule, app::Rule__Enum delete_rule, app::Rule__Enum update_rule))

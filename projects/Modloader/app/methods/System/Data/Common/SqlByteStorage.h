...
namespace app::classes::System::Data::Common::SqlByteStorage {
    ...
    IL2CPP_REGISTER_METHOD(0x02846510, void, CopyValue, (app::SqlByteStorage * this_ptr, int32_t record, app::Object* store, app::BitArray* nullbits, int32_t store_index))

...
namespace app::classes::System::Data::DataRelation {
    ...
    IL2CPP_REGISTER_METHOD(0x023A1720, void, ctor_2, (app::DataRelation * this_ptr, app::String* relation_name, app::DataColumn* parent_column, app::DataColumn* child_column, bool create_constraints))
    IL2CPP_REGISTER_METHOD(0x023A19A0, void, ctor_3, (app::DataRelation * this_ptr, app::String* relation_name, app::DataColumn__Array* parent_columns, app::DataColumn__Array* child_columns))
    IL2CPP_REGISTER_METHOD(0x023A19C0, void, ctor_4, (app::DataRelation * this_ptr, app::String* relation_name, app::DataColumn__Array* parent_columns, app::DataColumn__Array* child_columns, bool create_constraints))
    IL2CPP_REGISTER_METHOD(0x023A1AC0, void, ctor_5, (app::DataRelation * this_ptr, app::String* relation_name, app::String* parent_table_name, app::String* child_table_name, app::String__Array* parent_column_names, app::String__Array* child_column_names, bool nested))
    IL2CPP_REGISTER_METHOD(0x023A1BC0, void, ctor_6, (app::DataRelation * this_ptr, app::String* relation_name, app::String* parent_table_name, app::String* parent_table_namespace, app::String* child_table_name, app::String* child_table_namespace, app::String__Array* parent_column_names, app::String__Array* child_column_names, bool nested))
    ...
    IL2CPP_REGISTER_METHOD(0x023A1EA0, app::DataRow__Array*, GetChildRows, (app::DataKey parent_key, app::DataKey child_key, app::DataRow* parent_row, app::DataRowVersion__Enum version))
    IL2CPP_REGISTER_METHOD(0x023A1FE0, app::DataRow__Array*, GetParentRows, (app::DataKey parent_key, app::DataKey child_key, app::DataRow* child_row, app::DataRowVersion__Enum version))
    IL2CPP_REGISTER_METHOD(0x023A2120, app::DataRow*, GetParentRow, (app::DataKey parent_key, app::DataKey child_key, app::DataRow* child_row, app::DataRowVersion__Enum version))
    ...
    IL2CPP_REGISTER_METHOD(0x023A40B0, void, Create, (app::DataRelation * this_ptr, app::String* relation_name, app::DataColumn__Array* parent_columns, app::DataColumn__Array* child_columns, bool create_constraints))

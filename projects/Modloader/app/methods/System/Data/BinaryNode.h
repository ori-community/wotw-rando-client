...
namespace app::classes::System::Data::BinaryNode {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Object*,
        Eval_4,
        app::ExpressionNode* expr,
        app::DataRow* row,
        app::DataRowVersion__Enum version,
        app::Int32__Array* record_nos
    )
    IL2CPP_REGISTER_METHOD(
        0x0214B250,
        int32_t,
        ...
        app::Object* v_left,
        app::Object* v_right,
        app::StorageType__Enum result_type,
        int32_t op
    )
    IL2CPP_REGISTER_METHOD(
        0x0214B280,
    ...
    IL2CPP_REGISTER_METHOD(
        0x02150CE0,
        app::StorageType__Enum,
        ResultType,
        app::BinaryNode* this_ptr,
        app::StorageType__Enum left,
        app::StorageType__Enum right,
        bool lc,
        bool rc,
        int32_t op
    )

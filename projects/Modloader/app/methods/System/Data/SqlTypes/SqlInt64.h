...
namespace app::classes::System::Data::SqlTypes::SqlInt64 {
    ...
    inline app::SqlInt64 operator-(app::SqlInt64 x) { return op_UnaryNegation(x); }
    inline app::SqlInt64 operator+(app::SqlInt64 x, app::SqlInt64 y) { return op_Addition(x, y); }
    inline app::SqlInt64 operator-(app::SqlInt64 x, app::SqlInt64 y) { return op_Subtraction(x, y); }
    inline app::SqlInt64 operator*(app::SqlInt64 x, app::SqlInt64 y) { return op_Multiply(x, y); }
    inline app::SqlInt64 operator/(app::SqlInt64 x, app::SqlInt64 y) { return op_Division(x, y); }
    inline app::SqlInt64 operator%(app::SqlInt64 x, app::SqlInt64 y) { return op_Modulus(x, y); }
    inline app::SqlBoolean operator==(app::SqlInt64 x, app::SqlInt64 y) { return op_Equality(x, y); }
    inline app::SqlBoolean operator<(app::SqlInt64 x, app::SqlInt64 y) { return op_LessThan(x, y); }
    inline app::SqlBoolean operator>(app::SqlInt64 x, app::SqlInt64 y) { return op_GreaterThan(x, y); }
} // namespace app::classes::System::Data::SqlTypes::SqlInt64

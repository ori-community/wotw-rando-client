...
namespace app::classes::System::Data::SqlTypes::SqlSingle {
    ...
    inline app::SqlSingle operator-(app::SqlSingle x) { return op_UnaryNegation(x); }
    inline app::SqlSingle operator+(app::SqlSingle x, app::SqlSingle y) { return op_Addition(x, y); }
    inline app::SqlSingle operator-(app::SqlSingle x, app::SqlSingle y) { return op_Subtraction(x, y); }
    inline app::SqlSingle operator*(app::SqlSingle x, app::SqlSingle y) { return op_Multiply(x, y); }
    inline app::SqlSingle operator/(app::SqlSingle x, app::SqlSingle y) { return op_Division(x, y); }
    inline app::SqlBoolean operator==(app::SqlSingle x, app::SqlSingle y) { return op_Equality(x, y); }
    inline app::SqlBoolean operator<(app::SqlSingle x, app::SqlSingle y) { return op_LessThan(x, y); }
    inline app::SqlBoolean operator>(app::SqlSingle x, app::SqlSingle y) { return op_GreaterThan(x, y); }
} // namespace app::classes::System::Data::SqlTypes::SqlSingle

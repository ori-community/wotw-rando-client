...
namespace app::classes::System::Data::SqlTypes::SqlInt32 {
    ...
    inline app::SqlInt32 operator-(app::SqlInt32 x) { return op_UnaryNegation(x); }
    inline app::SqlInt32 operator+(app::SqlInt32 x, app::SqlInt32 y) { return op_Addition(x, y); }
    inline app::SqlInt32 operator-(app::SqlInt32 x, app::SqlInt32 y) { return op_Subtraction(x, y); }
    inline app::SqlInt32 operator*(app::SqlInt32 x, app::SqlInt32 y) { return op_Multiply(x, y); }
    inline app::SqlInt32 operator/(app::SqlInt32 x, app::SqlInt32 y) { return op_Division(x, y); }
    inline app::SqlBoolean operator==(app::SqlInt32 x, app::SqlInt32 y) { return op_Equality(x, y); }
    inline app::SqlBoolean operator<(app::SqlInt32 x, app::SqlInt32 y) { return op_LessThan(x, y); }
    inline app::SqlBoolean operator>(app::SqlInt32 x, app::SqlInt32 y) { return op_GreaterThan(x, y); }
} // namespace app::classes::System::Data::SqlTypes::SqlInt32

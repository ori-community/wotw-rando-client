...
namespace app::classes::System::Data::Index {
    ...
    IL2CPP_REGISTER_METHOD(0x01E39C70, void, ctor_2, (app::Index * this_ptr, app::DataTable* table, app::Comparison_1_System_Data_DataRow_* comparison, app::DataViewRowState__Enum record_states, app::IFilter* row_filter))
    IL2CPP_REGISTER_METHOD(0x01E39DF0, app::IndexField__Array*, GetAllFields, (app::DataColumnCollection * columns))
    IL2CPP_REGISTER_METHOD(0x01E39F10, void, ctor_3, (app::Index * this_ptr, app::DataTable* table, app::IndexField__Array* index_fields, app::Comparison_1_System_Data_DataRow_* comparison, app::DataViewRowState__Enum record_states, app::IFilter* row_filter))
    IL2CPP_REGISTER_METHOD(0x01E3A500, bool, Equal, (app::Index * this_ptr, app::IndexField__Array* index_desc, app::DataViewRowState__Enum record_states, app::IFilter* row_filter))
    ...
    IL2CPP_REGISTER_METHOD(0x01E3D300, int32_t, GetChangeAction, (app::Index * this_ptr, app::DataViewRowState__Enum old_state, app::DataViewRowState__Enum new_state))
    ...
    IL2CPP_REGISTER_METHOD(0x01E3E020, void, OnListChanged_1, (app::Index * this_ptr, app::ListChangedType__Enum changed_type, int32_t new_index, int32_t old_index))
    ...
    IL2CPP_REGISTER_METHOD(0x01E3E5B0, void, MaintainDataView, (app::Index * this_ptr, app::ListChangedType__Enum changed_type, int32_t record, bool track_add_remove))
    ...
    IL2CPP_REGISTER_METHOD(0x01E3EBE0, void, RecordStateChanged_1, (app::Index * this_ptr, int32_t record, app::DataViewRowState__Enum old_state, app::DataViewRowState__Enum new_state))
    IL2CPP_REGISTER_METHOD(0x01E3ED30, void, RecordStateChanged_2, (app::Index * this_ptr, int32_t old_record, app::DataViewRowState__Enum old_old_state, app::DataViewRowState__Enum old_new_state, int32_t new_record, app::DataViewRowState__Enum new_old_state, app::DataViewRowState__Enum new_new_state))

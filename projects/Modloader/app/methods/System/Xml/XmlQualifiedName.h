...
namespace app::classes::System::Xml::XmlQualifiedName {
    ...
    inline bool operator==(app::XmlQualifiedName& a, app::XmlQualifiedName& b) { return op_Equality(&a, &b); }
    inline bool operator!=(app::XmlQualifiedName& a, app::XmlQualifiedName& b) { return op_Inequality(&a, &b); }
} // namespace app::classes::System::Xml::XmlQualifiedName

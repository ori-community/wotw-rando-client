...
namespace app::classes::System::Xml::XmlWellFormedWriter_AttributeValueCache {
    ...
    IL2CPP_REGISTER_METHOD(0x01FD38F0, void, WriteCharEntity, (app::XmlWellFormedWriter_AttributeValueCache * this_ptr, char16_t ch))
    IL2CPP_REGISTER_METHOD(0x01FD39F0, void, WriteSurrogateCharEntity, (app::XmlWellFormedWriter_AttributeValueCache * this_ptr, char16_t low_char, char16_t high_char))

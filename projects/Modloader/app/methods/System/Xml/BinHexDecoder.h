...
namespace app::classes::System::Xml::BinHexDecoder {
    ...
    IL2CPP_REGISTER_METHOD(0x021E1C90, void, Decode_3, (char16_t* p_chars, char16_t* p_chars_end_pos, uint8_t* p_bytes, uint8_t* p_bytes_end_pos, bool* has_half_byte_cached, uint8_t* cached_half_byte, int32_t* chars_decoded, int32_t* bytes_decoded))
} // namespace app::classes::System::Xml::BinHexDecoder

...
namespace app::classes::System::Xml::XmlEncodedRawTextWriterIndent {
    ...
    IL2CPP_REGISTER_METHOD(0x01DB4890, void, WriteDocType, (app::XmlEncodedRawTextWriterIndent * this_ptr, app::String* name, app::String* pubid, app::String* sysid, app::String* subset))
    IL2CPP_REGISTER_METHOD(0x01DB4900, void, WriteStartElement, (app::XmlEncodedRawTextWriterIndent * this_ptr, app::String* prefix, app::String* local_name, app::String* ns))
    ...
    IL2CPP_REGISTER_METHOD(0x01DB4A20, void, WriteEndElement, (app::XmlEncodedRawTextWriterIndent * this_ptr, app::String* prefix, app::String* local_name, app::String* ns))
    IL2CPP_REGISTER_METHOD(0x01DB4B00, void, WriteFullEndElement, (app::XmlEncodedRawTextWriterIndent * this_ptr, app::String* prefix, app::String* local_name, app::String* ns))
    IL2CPP_REGISTER_METHOD(0x01DB4BE0, void, WriteStartAttribute, (app::XmlEncodedRawTextWriterIndent * this_ptr, app::String* prefix, app::String* local_name, app::String* ns))

...
namespace app::classes::System::Xml::Schema::XmlSchemaInference {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::XmlSchemaSet*,
        InferSchema1,
        app::XmlSchemaInference* this_ptr,
        app::XmlReader* instance_document,
        app::XmlSchemaSet* schemas
    )
    IL2CPP_REGISTER_METHOD(
        0x01CAA2E0,
        app::XmlSchemaAttribute*,
        AddAttribute,
        app::XmlSchemaInference* this_ptr,
        app::String* local_name,
        app::String* prefix,
        app::String* child_u_r_i,
        app::String* attr_value,
        bool b_creating_new_type,
        app::XmlSchema* parent_schema,
        app::XmlSchemaObjectCollection* add_location,
        app::XmlSchemaObjectTable* compiled_attributes
    )
    IL2CPP_REGISTER_METHOD(0x01CAB1E0, app::XmlSchema*, CreateXmlSchema, app::XmlSchemaInference* this_ptr, app::String* target_n_s)
    IL2CPP_REGISTER_METHOD(
        0x01CAB370,
        app::XmlSchemaElement*,
        AddElement,
        app::XmlSchemaInference* this_ptr,
        app::String* local_name,
        app::String* prefix,
        ...
        app::XmlSchema* parent_schema,
        app::XmlSchemaObjectCollection* add_location,
        int32_t position_within_collection
    )
    IL2CPP_REGISTER_METHOD(
        0x01CABE90,
        void,
        InferElement,
        app::XmlSchemaInference* this_ptr,
        app::XmlSchemaElement* xse,
        bool b_creating_new_type,
        app::XmlSchema* parent_schema
    )
    IL2CPP_REGISTER_METHOD(
        0x01CAD8F0,
        app::XmlSchemaSimpleContentExtension*,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::XmlReader* xtr,
        app::XmlSchemaComplexType* ct,
        int32_t* last_used_seq_item,
        bool* b_particle_changed,
        app::XmlSchema* parent_schema,
        bool set_maxoccurs
    )
    IL2CPP_REGISTER_METHOD(
        ...
        app::XmlSchemaInference* this_ptr,
        app::XmlSchemaElement** xse,
        app::XmlSchemaType* effective_schema_type,
        bool b_creating_new_type,
        app::XmlSchema* parent_schema
    )
    IL2CPP_REGISTER_METHOD(
        ...
        MoveAttributes_1,
        app::XmlSchemaInference* this_ptr,
        app::XmlSchemaSimpleContentExtension* sc_extension,
        app::XmlSchemaComplexType* ct
    )
    IL2CPP_REGISTER_METHOD(
        0x01CAFF30,
        ...
        app::XmlSchemaInference* this_ptr,
        app::XmlSchemaComplexType* ct,
        app::XmlSchemaSimpleContentExtension* simple_content_extension,
        bool b_creating_new_type
    )
    IL2CPP_REGISTER_METHOD(
        0x01CB02A0,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        FindElement,
        app::XmlSchemaInference* this_ptr,
        app::XmlSchemaObjectCollection* elements,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::XmlSchemaInference* this_ptr,
        app::XmlSchemaComplexType* ct,
        app::XmlSchemaObjectCollection* attributes_in_instance
    )
    IL2CPP_REGISTER_METHOD(
        0x01CB0F70,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::XmlSchemaInference* this_ptr,
        app::XmlSchemaElement* copy_element
    )

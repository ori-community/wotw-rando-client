...
namespace app::classes::System::Xml::Schema::Compiler {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Compiler* this_ptr,
        app::XmlSchemaGroup* redefined_group,
        app::XmlSchemaGroup* base_group
    )
    IL2CPP_REGISTER_METHOD(
        0x019B0A80,
        void,
        ...
        app::XmlSchemaAttributeGroup* base_attribute_group
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        CheckUnionType,
        app::Compiler* this_ptr,
        app::XmlSchemaSimpleType* union_member,
        app::ArrayList* member_type_definitions,
        app::XmlSchemaSimpleType* parent_type
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Compiler* this_ptr,
        app::XmlSchemaComplexType* complex_type,
        app::XmlSchemaSimpleContentExtension* simple_extension
    )
    IL2CPP_REGISTER_METHOD(
        0x019B2510,
        void,
        ...
        app::Compiler* this_ptr,
        app::XmlSchemaComplexType* complex_type,
        app::XmlSchemaSimpleContentRestriction* simple_restriction
    )
    IL2CPP_REGISTER_METHOD(
        0x019B2930,
        void,
        ...
        app::Compiler* this_ptr,
        app::XmlSchemaComplexType* complex_type,
        app::XmlSchemaComplexContent* complex_content,
        app::XmlSchemaComplexContentExtension* complex_extension
    )
    IL2CPP_REGISTER_METHOD(
        0x019B2D80,
        void,
        ...
        app::XmlSchemaComplexType* complex_type,
        app::XmlSchemaComplexContent* complex_content,
        app::XmlSchemaComplexContentRestriction* complex_restriction
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x019B3430,
        void,
        CheckParticleDerivation_2,
        app::Compiler* this_ptr,
        app::XmlSchemaParticle* derived_particle,
        app::XmlSchemaParticle* base_particle
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Compiler* this_ptr,
        app::XmlSchemaElement* derived_element,
        app::XmlSchemaElement* base_element
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        IsGroupBaseFromAny,
        app::Compiler* this_ptr,
        app::XmlSchemaGroupBase* derived_group_base,
        app::XmlSchemaAny* base_any
    )
    IL2CPP_REGISTER_METHOD(
        0x019B7270,
        bool,
        ...
        app::Compiler* this_ptr,
        app::XmlSchemaElement* derived_element,
        app::XmlSchemaGroupBase* base_group_base
    )
    IL2CPP_REGISTER_METHOD(
        0x019B7F70,
        bool,
        ...
        app::Compiler* this_ptr,
        app::XmlSchemaChoice* derived_choice,
        app::XmlSchemaChoice* base_choice
    )
    IL2CPP_REGISTER_METHOD(
        0x019B8120,
        bool,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Compiler* this_ptr,
        app::XmlSchemaSequence* derived_sequence,
        app::XmlSchemaChoice* base_choice
    )
    IL2CPP_REGISTER_METHOD(
        0x019B8F70,
        bool,
        IsValidOccurrenceRangeRestriction_1,
        app::Compiler* this_ptr,
        app::XmlSchemaParticle* derived_particle,
        app::XmlSchemaParticle* base_particle
    )
    IL2CPP_REGISTER_METHOD(
        0x019B90C0,
        bool,
        IsValidOccurrenceRangeRestriction_2,
        app::Compiler* this_ptr,
        app::Decimal min_occurs,
        app::Decimal max_occurs,
        app::Decimal base_min_occurs,
        app::Decimal base_max_occurs
    )
    IL2CPP_REGISTER_METHOD(
        0x019B91F0,
        int32_t,
        GetMappingParticle,
        app::Compiler* this_ptr,
        app::XmlSchemaParticle* particle,
        app::XmlSchemaObjectCollection* collection
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x016F5F70,
        app::XmlSchemaContentType__Enum,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Compiler* this_ptr,
        app::XmlSchemaComplexType* base_type,
        app::XmlSchemaComplexType* derived_type,
        app::XmlSchemaObjectCollection* attributes,
        app::XmlSchemaAnyAttribute* any_attribute,
        app::XmlSchemaDerivationMethod__Enum derived_by
    )
    IL2CPP_REGISTER_METHOD(
        0x019BBC50,
        void,
        ...
        app::Compiler* this_ptr,
        app::XmlSchemaAttributeGroup* base_attribute_group,
        app::XmlSchemaAttributeGroup* derived_attribute_group
    )
    IL2CPP_REGISTER_METHOD(
        0x019BC460,
        bool,
        ...
        app::Compiler* this_ptr,
        app::XmlSchemaComplexType* base_type,
        app::XmlSchemaAnyAttribute* derived_attribute_wildcard,
        app::XmlSchemaAnyAttribute* base_attribute_wildcard
    )
    IL2CPP_REGISTER_METHOD(
        0x019BC560,
        ...
        app::Compiler* this_ptr,
        app::XmlSchemaAnyAttribute* a,
        app::XmlSchemaAnyAttribute* b
    )
    IL2CPP_REGISTER_METHOD(
        0x019BC650,
        app::XmlSchemaAnyAttribute*,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Compiler* this_ptr,
        app::ParticleContentValidator* content_validator,
        app::XmlSchemaParticle* particle
    )
    IL2CPP_REGISTER_METHOD(
        0x019BF760,
        void,
        CompileParticleElements_1,
        app::Compiler* this_ptr,
        app::XmlSchemaComplexType* complex_type,
        app::XmlSchemaParticle* particle
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        CopyPosition,
        app::Compiler* this_ptr,
        app::XmlSchemaAnnotated* to,
        app::XmlSchemaAnnotated* from,
        bool copy_parent
    )

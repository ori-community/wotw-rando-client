...
namespace app::classes::System::Xml::Schema::BaseValidator {
    ...
    IL2CPP_REGISTER_METHOD(0x019A5C10, void, ctor_2, (app::BaseValidator * this_ptr, app::XmlValidatingReaderImpl* reader, app::XmlSchemaCollection* schema_collection, app::IValidationEventHandling* event_handling))

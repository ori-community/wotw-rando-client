...
namespace app::classes::System::Xml::Schema::XdrBuilder {
    ...
    IL2CPP_REGISTER_METHOD(0x01ABE7D0, void, ProcessAttribute, (app::XdrBuilder * this_ptr, app::String* prefix, app::String* name, app::String* ns, app::String* value))
    ...
    IL2CPP_REGISTER_METHOD(0x01AC5CC0, void, XDR_CheckAttributeDefault, (app::XdrBuilder * this_ptr, app::XdrBuilder_DeclBaseInfo* decl, app::SchemaAttDef* p_attdef))
    ...
    IL2CPP_REGISTER_METHOD(0x01AC6670, void, SendValidationEvent_1, (app::XdrBuilder * this_ptr, app::String* code, app::String__Array* args, app::XmlSeverityType__Enum severity))

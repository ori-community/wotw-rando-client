...
namespace app::classes::System::Xml::Schema::XsdBuilder_XsdEntry {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::XsdBuilder_XsdEntry* this_ptr,
        app::SchemaNames_Token__Enum n,
        app::XsdBuilder_State__Enum state,
        app::XsdBuilder_State__Enum__Array* next_states,
        app::XsdBuilder_XsdAttributeEntry__Array* attributes,
        app::XsdBuilder_XsdInitFunction* init,
        app::XsdBuilder_XsdEndChildFunction* end,
        bool parse_content
    )
}

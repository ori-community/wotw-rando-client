...
namespace app::classes::System::Xml::Serialization::XmlSerializer {
    ...
    IL2CPP_REGISTER_METHOD(0x0194A100, void, ctor_2, (app::XmlSerializer * this_ptr, app::Type* type, app::XmlAttributeOverrides* overrides, app::Type__Array* extra_types, app::XmlRootAttribute* root, app::String* default_namespace))

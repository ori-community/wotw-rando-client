...
namespace app::classes::System::Xml::Linq::XContainer__GetElements_d__40 {
    ...
    IL2CPP_REGISTER_METHODINFO(0x047316F8, XContainer_GetElements_d_40_System_Collections_IEnumerator_Reset__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x002FB930, app::Object*, IEnumerator_get_Current, (app::XContainer_GetElements_d_40 * this_ptr))
    IL2CPP_REGISTER_METHOD(0x03034C50, app::IEnumerator_1_System_Xml_Linq_XElement_*, IEnumerable_XElement__GetEnumerator, (app::XContainer_GetElements_d_40 * this_ptr))

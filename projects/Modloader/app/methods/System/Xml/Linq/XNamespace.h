...
namespace app::classes::System::Xml::Linq::XNamespace {
    ...
    inline bool operator==(app::XNamespace& left, app::XNamespace& right) { return op_Equality(&left, &right); }
    inline bool operator!=(app::XNamespace& left, app::XNamespace& right) { return op_Inequality(&left, &right); }
} // namespace app::classes::System::Xml::Linq::XNamespace

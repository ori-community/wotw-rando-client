...
namespace app::classes::System::Xml::XmlNodeReader {
    ...
    IL2CPP_REGISTER_METHOD(0x01DC9C70, app::IDictionary_2_System_String_System_String_*, IXmlNamespaceResolver_GetNamespacesInScope, (app::XmlNodeReader * this_ptr, app::XmlNamespaceScope__Enum scope))

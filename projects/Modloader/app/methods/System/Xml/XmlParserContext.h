...
namespace app::classes::System::Xml::XmlParserContext {
    ...
    IL2CPP_REGISTER_METHOD(0x016FF200, void, ctor_2, (app::XmlParserContext * this_ptr, app::XmlNameTable* nt, app::XmlNamespaceManager* ns_mgr, app::String* doc_type_name, app::String* pub_id, app::String* sys_id, app::String* internal_subset, app::String* base_u_r_i, app::String* xml_lang, app::XmlSpace__Enum xml_space))
    IL2CPP_REGISTER_METHOD(0x016FF270, void, ctor_3, (app::XmlParserContext * this_ptr, app::XmlNameTable* nt, app::XmlNamespaceManager* ns_mgr, app::String* doc_type_name, app::String* pub_id, app::String* sys_id, app::String* internal_subset, app::String* base_u_r_i, app::String* xml_lang, app::XmlSpace__Enum xml_space, app::Encoding* enc))

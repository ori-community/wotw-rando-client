...
namespace app::classes::System::Xml::HtmlEncodedRawTextWriter {
    ...
    IL2CPP_REGISTER_METHOD(0x021F8A50, void, WriteDocType, (app::HtmlEncodedRawTextWriter * this_ptr, app::String* name, app::String* pubid, app::String* sysid, app::String* subset))
    IL2CPP_REGISTER_METHOD(0x021F8E60, void, WriteStartElement, (app::HtmlEncodedRawTextWriter * this_ptr, app::String* prefix, app::String* local_name, app::String* ns))
    IL2CPP_REGISTER_METHOD(0x021F9020, void, StartElementContent, (app::HtmlEncodedRawTextWriter * this_ptr))
    IL2CPP_REGISTER_METHOD(0x021F9090, void, WriteEndElement, (app::HtmlEncodedRawTextWriter * this_ptr, app::String* prefix, app::String* local_name, app::String* ns))
    IL2CPP_REGISTER_METHOD(0x021F9260, void, WriteFullEndElement, (app::HtmlEncodedRawTextWriter * this_ptr, app::String* prefix, app::String* local_name, app::String* ns))
    IL2CPP_REGISTER_METHOD(0x021F9430, void, WriteStartAttribute, (app::HtmlEncodedRawTextWriter * this_ptr, app::String* prefix, app::String* local_name, app::String* ns))

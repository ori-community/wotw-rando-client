...
namespace app::classes::System::Xml::XmlCharType {
    ...
    IL2CPP_REGISTER_METHOD(0x00153570, bool, IsWhiteSpace, (app::XmlCharType__Boxed * this_ptr, uint16_t ch))
    IL2CPP_REGISTER_METHOD(0x001535B0, bool, IsNCNameSingleChar, (app::XmlCharType__Boxed * this_ptr, uint16_t ch))
    IL2CPP_REGISTER_METHOD(0x001535F0, bool, IsStartNCNameSingleChar, (app::XmlCharType__Boxed * this_ptr, uint16_t ch))
    IL2CPP_REGISTER_METHOD(0x00153630, bool, IsNameSingleChar, (app::XmlCharType__Boxed * this_ptr, uint16_t ch))
    IL2CPP_REGISTER_METHOD(0x00153680, bool, IsCharData, (app::XmlCharType__Boxed * this_ptr, uint16_t ch))
    IL2CPP_REGISTER_METHOD(0x001536C0, bool, IsPubidChar, (app::XmlCharType__Boxed * this_ptr, uint16_t ch))
    IL2CPP_REGISTER_METHOD(0x001536D0, bool, IsTextChar, (app::XmlCharType__Boxed * this_ptr, uint16_t ch))
    IL2CPP_REGISTER_METHOD(0x00153710, bool, IsLetter, (app::XmlCharType__Boxed * this_ptr, uint16_t ch))
    IL2CPP_REGISTER_METHOD(0x00153750, bool, IsNCNameCharXml4e, (app::XmlCharType__Boxed * this_ptr, uint16_t ch))
    IL2CPP_REGISTER_METHOD(0x00153790, bool, IsStartNCNameCharXml4e, (app::XmlCharType__Boxed * this_ptr, uint16_t ch))
    IL2CPP_REGISTER_METHOD(0x001537E0, bool, IsNameCharXml4e, (app::XmlCharType__Boxed * this_ptr, uint16_t ch))
    ...
    IL2CPP_REGISTER_METHOD(0x0195FA90, void, SplitSurrogateChar, (int32_t combined_char, uint16_t* low_char, uint16_t* high_char))

...
namespace app::classes::System::Xml::XmlWriter {
    ...
    IL2CPP_REGISTER_METHOD(0x01FD5650, void, WriteAttributeString_3, (app::XmlWriter * this_ptr, app::String* prefix, app::String* local_name, app::String* ns, app::String* value))

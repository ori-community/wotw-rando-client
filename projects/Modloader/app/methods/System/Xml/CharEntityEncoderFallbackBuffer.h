...
namespace app::classes::System::Xml::CharEntityEncoderFallbackBuffer {
    ...
    IL2CPP_REGISTER_METHOD(0x021E87D0, bool, Fallback_2, (app::CharEntityEncoderFallbackBuffer * this_ptr, char16_t char_unknown_high, char16_t char_unknown_low, int32_t index))
    ...
    IL2CPP_REGISTER_METHOD(0x021E8D00, int32_t, SurrogateCharToUtf32, (app::CharEntityEncoderFallbackBuffer * this_ptr, char16_t high_surrogate, char16_t low_surrogate))
} // namespace app::classes::System::Xml::CharEntityEncoderFallbackBuffer

...
namespace app::classes::System::Nullable_1_Newtonsoft_Json_JsonToken_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0476BAE8, Nullable_1_Newtonsoft_Json_JsonToken___ctor__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x001F6090, bool, get_HasValue, (app::Nullable_1_Newtonsoft_Json_JsonToken___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04715020, Nullable_1_Newtonsoft_Json_JsonToken__get_HasValue__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04765150, Nullable_1_Newtonsoft_Json_JsonToken__GetValueOrDefault__MethodInfo)
} // namespace app::classes::System::Nullable_1_Newtonsoft_Json_JsonToken_

...
namespace app::classes::System::Security::Cryptography::PasswordDeriveBytes {
    ...
    IL2CPP_REGISTER_METHOD(0x020DFE60, void, ctor_3, (app::PasswordDeriveBytes * this_ptr, app::String* str_password, app::Byte__Array* rgb_salt, app::String* str_hash_name, int32_t iterations))
    IL2CPP_REGISTER_METHOD(0x020E0010, void, ctor_4, (app::PasswordDeriveBytes * this_ptr, app::Byte__Array* password, app::Byte__Array* salt, app::String* hash_name, int32_t iterations))
    IL2CPP_REGISTER_METHOD(0x020E01C0, void, ctor_5, (app::PasswordDeriveBytes * this_ptr, app::String* str_password, app::Byte__Array* rgb_salt, app::CspParameters* csp_params))
    IL2CPP_REGISTER_METHOD(0x020E0290, void, ctor_6, (app::PasswordDeriveBytes * this_ptr, app::Byte__Array* password, app::Byte__Array* salt, app::CspParameters* csp_params))
    IL2CPP_REGISTER_METHOD(0x020E0360, void, ctor_7, (app::PasswordDeriveBytes * this_ptr, app::String* str_password, app::Byte__Array* rgb_salt, app::String* str_hash_name, int32_t iterations, app::CspParameters* csp_params))
    IL2CPP_REGISTER_METHOD(0x020E0500, void, ctor_8, (app::PasswordDeriveBytes * this_ptr, app::Byte__Array* password, app::Byte__Array* salt, app::String* hash_name, int32_t iterations, app::CspParameters* csp_params))
    ...
    IL2CPP_REGISTER_METHOD(0x020E10A0, app::Byte__Array*, CryptDeriveKey, (app::PasswordDeriveBytes * this_ptr, app::String* algname, app::String* alghashname, int32_t key_size, app::Byte__Array* rgb_i_v))

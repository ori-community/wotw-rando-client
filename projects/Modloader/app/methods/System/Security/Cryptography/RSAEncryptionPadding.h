...
namespace app::classes::System::Security::Cryptography::RSAEncryptionPadding {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_1,
        app::RSAEncryptionPadding* this_ptr,
        app::RSAEncryptionPaddingMode__Enum mode,
        app::HashAlgorithmName oaep_hash_algorithm
    )
    ...
    inline bool operator==(app::RSAEncryptionPadding& left, app::RSAEncryptionPadding& right) { return op_Equality(&left, &right); }
    inline bool operator!=(app::RSAEncryptionPadding& left, app::RSAEncryptionPadding& right) { return op_Inequality(&left, &right); }
} // namespace app::classes::System::Security::Cryptography::RSAEncryptionPadding

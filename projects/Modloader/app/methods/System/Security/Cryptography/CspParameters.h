...
namespace app::classes::System::Security::Cryptography::CspParameters {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_4,
        app::CspParameters* this_ptr,
        int32_t dw_type_in,
        app::String* str_provider_name_in,
        app::String* str_container_name_in
    )
    IL2CPP_REGISTER_METHOD(
        0x020D06D0,
        void,
        ...
        app::String* key_container_name,
        app::CryptoKeySecurity* crypto_key_security,
        app::SecureString* key_password
    )
    IL2CPP_REGISTER_METHOD(
        0x020D0710,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::String* provider_name,
        app::String* key_container_name,
        app::CspProviderFlags__Enum flags
    )

...
namespace app::classes::System::Security::Cryptography::HashAlgorithmName {
    ...
    inline bool operator==(app::HashAlgorithmName left, app::HashAlgorithmName right) { return op_Equality(left, right); }
    inline bool operator!=(app::HashAlgorithmName left, app::HashAlgorithmName right) { return op_Inequality(left, right); }
} // namespace app::classes::System::Security::Cryptography::HashAlgorithmName

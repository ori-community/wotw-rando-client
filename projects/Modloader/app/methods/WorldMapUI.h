...
namespace app::classes::WorldMapUI {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Vector3,
        ApplyIconLerp,
        app::WorldMapUI* this_ptr,
        app::Vector2 world_map_position,
        app::Vector2 area_map_position,
    ...
    IL2CPP_REGISTER_METHOD(
        0x0058C710,
        void,
        CreateTeleporterIcon,
        app::WorldMapUI* this_ptr,
        app::GameMapSavePedestal* pedestal,
        app::List_1_UnityEngine_Transform_* pedestals
    )

...
namespace app::classes::GoToSceneController {
    ...
    IL2CPP_REGISTER_METHOD(0x007FF5C0, void, GoToScene_2, (app::GoToSceneController * this_ptr, app::SceneMetaData* scene_meta_data, app::Action* on_complete, bool create_checkpoint))
    IL2CPP_REGISTER_METHOD(0x007FF670, void, GoToScene_3, (app::GoToSceneController * this_ptr, app::RuntimeSceneMetaData* scene_meta_data, app::Action* on_complete, bool create_checkpoint))
    IL2CPP_REGISTER_METHOD(0x007FF7B0, void, GoToSceneAsync_1, (app::GoToSceneController * this_ptr, app::SceneMetaData* scene_meta_data, app::Action* on_complete, bool create_checkpoint))
    IL2CPP_REGISTER_METHOD(0x007FF860, void, GoToSceneAsync_2, (app::GoToSceneController * this_ptr, app::RuntimeSceneMetaData* scene_meta_data, app::Action* on_complete, bool create_checkpoint))
    IL2CPP_REGISTER_METHOD(0x007FF9A0, void, GoToReplayScene, (app::GoToSceneController * this_ptr, app::RuntimeSceneMetaData* scene_meta_data, app::Action* on_complete, bool create_checkpoint, app::Vector3 position))
    IL2CPP_REGISTER_METHOD(0x007FFA00, void, GoToExitReplayScene, (app::GoToSceneController * this_ptr, app::RuntimeSceneMetaData* scene_meta_data, app::Action* on_complete, bool create_checkpoint))
    ...
    IL2CPP_REGISTER_METHOD(0x007FFBD0, void, GoToSceneImmediately_2, (app::GoToSceneController * this_ptr, app::MoonGuid* scene_guid, app::Action* on_complete, app::Vector3 position))
    IL2CPP_REGISTER_METHOD(0x007FFBF0, void, GoToSceneImmediately_3, (app::GoToSceneController * this_ptr, app::RuntimeSceneMetaData* scene, app::Action* on_complete))

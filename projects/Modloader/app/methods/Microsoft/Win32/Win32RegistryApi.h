...
namespace app::classes::Microsoft::Win32::Win32RegistryApi {
    ...
    IL2CPP_REGISTER_METHOD(0x023B80A0, int32_t, RegOpenKeyEx, void* key_base, app::String* key_name, void* reserved, int32_t access, void** key_handle)
    IL2CPP_REGISTER_METHOD(
        ...
        char16_t* lp_name,
        int32_t* lpcb_name,
        app::Int32__Array* lp_reserved,
        app::StringBuilder* lp_class,
        app::Int32__Array* lpcb_class,
        app::Int64__Array* lpft_last_write_time
    )
    IL2CPP_REGISTER_METHOD(
        0x023B82B0,
        int32_t,
        ...
        void* reserved,
        app::RegistryValueKind__Enum* type,
        void* zero,
        int32_t* data_size
    )
    IL2CPP_REGISTER_METHOD(
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::StringBuilder* lp_class,
        app::Int32__Array* lpcb_class,
        void* lp_reserved__must_be_zero,
        int32_t* lpc_sub_keys,
        app::Int32__Array* lpcb_max_sub_key_len,
        app::Int32__Array* lpcb_max_class_len,
        int32_t* lpc_values,
        app::Int32__Array* lpcb_max_value_name_len,
        app::Int32__Array* lpcb_max_value_len,
        app::Int32__Array* lpcb_security_descriptor,
        app::Int32__Array* lpft_last_write_time
    )

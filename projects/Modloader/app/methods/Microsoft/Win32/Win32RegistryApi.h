...
namespace app::classes::Microsoft::Win32::Win32RegistryApi {
    ...
    IL2CPP_REGISTER_METHOD(0x023B8180, int32_t, RegEnumKeyEx, (void* key_handle, int32_t dw_index, char16_t* lp_name, int32_t* lpcb_name, app::Int32__Array* lp_reserved, app::StringBuilder* lp_class, app::Int32__Array* lpcb_class, app::Int64__Array* lpft_last_write_time))

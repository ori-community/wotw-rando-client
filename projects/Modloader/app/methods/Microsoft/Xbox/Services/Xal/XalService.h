...
namespace app::classes::Microsoft::Xbox::Services::Xal::XalService {
    ...
    IL2CPP_REGISTER_METHOD(0x01436AC0, void, OnShowUrl, (void* context, void* user_context, void* operation, app::String* start_url, app::String* final_url, bool suppress_ui))
    IL2CPP_REGISTER_METHODINFO(0x04738900, XalService_OnShowUrl__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x002FA000, void, ShowWebView, (app::XalService * this_ptr, void* operation_id, app::String* start_url, app::String* final_url, bool suppress_ui))
    ...
    IL2CPP_REGISTER_METHOD(0x01437150, void, OnPlatformStorageWrite, (void* context, void* user_context, void* operation, app::String* key, void* data_size, void* data))
    ...
    IL2CPP_REGISTER_METHOD(0x01438270, void, SetPlatformWebShowUrlComplete, (app::XalService * this_ptr, void* operation_id, app::XalPlatformOperationResult__Enum result, app::String* url))
    ...
    IL2CPP_REGISTER_METHOD(0x01438810, void, OnPlatformRemoteConnectShow, (void* context, void* user_context, void* operation, app::String* url, app::String* code))
    ...
    IL2CPP_REGISTER_METHOD(0x0143A140, int32_t, XalWrapper_XalUserDuplicateHandle, (void* user, app::void** duplicate_user))
    IL2CPP_REGISTER_METHOD(0x0143A1F0, void, XalWrapper_XalUserCloseHandle, (void* user))
    IL2CPP_REGISTER_METHOD(0x0143A290, int32_t, XalWrapper_XalInitialize, (app::XalService_CommonArgs * common, uint32_t third_party_consent_count, app::String__Array* third_party_consents, app::XalService_DeviceInfoArgs* device_info, app::XalService_TelemetryInfoArgs* telemetry_info, void* internal_work_queue))
    ...
    IL2CPP_REGISTER_METHOD(0x0143AD00, bool, XalWrapper_DispatchAsyncQueue, (void* queue, app::XalService_AsyncQueueCallbackType__Enum type, uint32_t timeout_in_ms))
    ...
    IL2CPP_REGISTER_METHOD(0x0143B070, int32_t, XalWrapper_XalTryAddFirstUserSilentlyResult, (void* async, app::void** new_user))
    IL2CPP_REGISTER_METHOD(0x0143B120, int32_t, XalWrapper_XalAddUserWithUiAsync, (void* queue, void* user_context))
    IL2CPP_REGISTER_METHOD(0x0143B1D0, int32_t, XalWrapper_XalAddUserWithUiResult, (void* async, app::void** new_user))
    IL2CPP_REGISTER_METHOD(0x0143B280, int32_t, XalWrapper_XalPlatformWebSetEventHandler, (void* queue, void* context, app::XalService_XalPlatformWebShowUrlEventHandler* handler))
    IL2CPP_REGISTER_METHOD(0x0143B340, int32_t, XalWrapper_XalPlatformWebShowUrlComplete, (void* operation, app::XalPlatformOperationResult__Enum result, app::String* url))
    IL2CPP_REGISTER_METHOD(0x0143B4E0, int32_t, XalWrapper_XalPlatformStorageSetEventHandlers, (void* queue, app::XalService_XalPlatformStorageEventHandlers* handlers))
    ...
    IL2CPP_REGISTER_METHOD(0x0143B740, int32_t, XalWrapper_XalPlatformStorageReadComplete, (void* operation, app::XalPlatformOperationResult__Enum result, void* data_size, app::Byte__Array* data))
    ...
    IL2CPP_REGISTER_METHOD(0x0143B8C0, int32_t, XalWrapper_XalPlatformRemoteConnectSetEventHandlers, (void* queue, app::XalService_XalPlatformRemoteConnectEventHandlers* handlers))

...
namespace app::classes::Microsoft::Xbox::Services::Xal::XalUser {
    ...
    IL2CPP_REGISTER_METHOD(0x01441D40, int32_t, XalWrapper_XalUserGetGamertag, (void* user, void* gamertag_size, app::StringBuilder* gamertag, void** gamertag_size_used))
    ...
    IL2CPP_REGISTER_METHOD(0x01442690, int32_t, XalWrapper_XalUserGetTokenAndSignatureSilentlyResult, (void* async, void* buffer_size, void* buffer, void** result, void** buffer_used))

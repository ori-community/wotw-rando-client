...
namespace app::classes::Microsoft::Xbox::Services::Xal::XalUser {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        add_UserChanged,
        app::XalUser_1* this_ptr,
        app::EventHandler_1_Microsoft_Xbox_Services_Xal_UserChangeEventArgs_* value
    )
    IL2CPP_REGISTER_METHOD(
        0x0143FAB0,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        0x01440740,
        void,
        GetTokenAndSignatureSilentlyAsync,
        app::XalUser_1* this_ptr,
        app::XalUserGetTokenAndSignatureArgs args,
        app::Action_1_Microsoft_Xbox_Services_Xal_XalUserGetTokenAndSignatureData_* on_complete,
        app::Action_1_Int32_* on_error
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x01441D40,
        int32_t,
        XalWrapper_XalUserGetGamertag,
        void* user,
        void* gamertag_size,
        app::StringBuilder* gamertag,
        void** gamertag_size_used
    )
    ...
    IL2CPP_REGISTER_METHOD(0x01442000, int32_t, XalWrapper_XalUserGetGamerPictureResultSize, void* async, void** buffer_size)
    ...
    IL2CPP_REGISTER_METHOD(
        0x01442210,
        int32_t,
        XalWrapper_XalUserCheckPrivilege,
        void* user,
        app::XalPrivilege__Enum privilege,
        bool* has_privilege,
        app::XalPrivilegeCheckDenyReasons__Enum* reasons
    )
    IL2CPP_REGISTER_METHOD(
        0x014422F0,
        int32_t,
        XalWrapper_XalUserGetTokenAndSignatureSilentlyAsync,
        void* async,
        void* user,
        app::XalUser_InternalXalUserGetTokenAndSignatureArgs* args,
        uint32_t header_count,
        app::XalHttpHeader__Array* headers,
        void* body_count,
        app::Byte__Array* body
    )
    IL2CPP_REGISTER_METHOD(0x014425E0, int32_t, XalWrapper_XalUserGetTokenAndSignatureSilentlyResultSize, void* async, void** buffer_size)
    IL2CPP_REGISTER_METHOD(
        0x01442690,
        int32_t,
        XalWrapper_XalUserGetTokenAndSignatureSilentlyResult,
        void* async,
        void* buffer_size,
        void* buffer,
        void** result,
    ...
    IL2CPP_REGISTER_METHOD(
        0x014429A0,
        int32_t,
        XalWrapper_XalUserRegisterChangeEventHandler,
        void* queue,
        void* context,
        app::XalUser_XalUserChangeEventHandler* handler,
        uint64_t* token
    )

...
namespace app::classes::MS::Internal::Xml::Linq::ComponentModel::XPropertyDescriptor_2_System_Xml_Linq_XAttribute_System_String_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        AddValueChanged,
        app::XPropertyDescriptor_2_System_Xml_Linq_XAttribute_System_String_* this_ptr,

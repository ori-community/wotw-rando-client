...
namespace app::classes::LocomotionGroundMoveBehaviour {
    ...
    IL2CPP_REGISTER_METHOD(0x00FC5D00, void, SetTempArrivalDistance, (app::LocomotionGroundMoveBehaviour * this_ptr, float arrival_distance, float slow_down_distance))

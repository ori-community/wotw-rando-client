...
namespace app::classes::GameplaySoundManager {
    ...
    IL2CPP_REGISTER_METHOD(0x00410AC0, void, SetAudioQuality, (app::GameplaySoundManager * this_ptr, app::GameplaySoundManager_AudioQualitySetting__Enum quality_setting))
    ...
    IL2CPP_REGISTER_METHOD(0x004119A0, void, ProcessSurfaceHit, (app::GameplaySoundManager * this_ptr, app::GameObject* weapon, app::AbilityType__Enum ability_type, app::String* hit_name))
    IL2CPP_REGISTER_METHOD(0x00411C60, void, TriggerWeaponHitEvent, (app::GameplaySoundManager * this_ptr, app::GameObject* weapon, app::AbilityType__Enum ability_type, app::ArtificialSoundHostReference host))
    ...
    IL2CPP_REGISTER_METHOD(0x00411EA0, void, ProcessEnemyReceivedHit, (app::GameplaySoundManager * this_ptr, app::DamageResult damage_result, app::EnemyEntity* enemy))

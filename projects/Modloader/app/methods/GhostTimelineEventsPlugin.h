...
namespace app::classes::GhostTimelineEventsPlugin {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        OnTimelineEvent,
        app::GhostTimelineEventsPlugin* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        0x007EBB30,
        void,
        RecordScalableAnimation,
        app::GhostTimelineEventsPlugin* this_ptr,
        app::ScalableAnimationPlayer* scalable_animation_player,
        app::AnimationContext context
    )

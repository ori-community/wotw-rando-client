...
namespace app::classes::MaterialVFXManager {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Instantiate_1,
        app::MaterialVFXManager* this_ptr,
        app::Collider* collider,
        app::MaterialTypeVFXSettings_EffectSize__Enum surface_impact_size,
        app::Vector3 position,
        app::Quaternion rotation,
        app::EquipmentType__Enum weapon,
        app::MaterialTypeVFXSettings_EffectSize__Enum weapon_impact_size
    )
    IL2CPP_REGISTER_METHOD(
        0x01383EE0,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        InstantiateOptional,
        app::MaterialVFXManager* this_ptr,
        app::InstantiationRecycleHelper* surface_f_x_recycler,
        app::InstantiationRecycleHelper* weapon_fx_recycler,
        app::SurfaceMaterialType__Enum material_type,
        app::MaterialTypeVFXSettings_EffectSize__Enum surface_impact_size,
        app::Vector3 position,
        app::Quaternion rotation,

...
namespace app::classes::UberInteractionManager_ExplosionApplicationComparer {
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t,
        Compare,
        app::UberInteractionManager_ExplosionApplicationComparer* this_ptr,
        app::UberInteractionManager_ExplosionApplication a,
        app::UberInteractionManager_ExplosionApplication b
    )

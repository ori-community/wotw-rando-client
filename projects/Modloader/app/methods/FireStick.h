...
namespace app::classes::FireStick {
    ...
    IL2CPP_REGISTER_METHOD(0x01258D10, void, SetupInstantiatedFlameProperties, (app::FireStick * this_ptr, app::Flammable_FlameColor__Enum color, app::Flammable_FlameState__Enum state))

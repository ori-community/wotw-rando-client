...
namespace app::classes::CutsceneButtonPressedTransition___c {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04766F70, CutsceneButtonPressedTransition_c__ShouldTransition_b__4_1__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04759778, CutsceneButtonPressedTransition_c__ShouldTransition_b__4_2__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0470BBC0, CutsceneButtonPressedTransition_c__ShouldTransition_b__4_3__MethodInfo)
} // namespace app::classes::CutsceneButtonPressedTransition___c

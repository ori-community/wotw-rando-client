...
namespace app::classes::SystemIntegration::Synchronizer::Statistics::PlayFabStatistics___c__DisplayClass14_0 {
    ...
    IL2CPP_REGISTER_METHODINFO(0x047806A0, PlayFabStatistics_c_DisplayClass14_0__GetStatistics_b__0__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04708A10, PlayFabStatistics_c_DisplayClass14_0__GetStatistics_b__1__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0473AE20, PlayFabStatistics_c_DisplayClass14_0__GetStatistics_b__2__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04730770, PlayFabStatistics_c_DisplayClass14_0__GetStatistics_b__3__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00539A10, void, _GetStatistics_b__4, (app::PlayFabStatistics_c_DisplayClass14_0 * this_ptr, app::GetLeaderboardAroundPlayerResult* result))
    IL2CPP_REGISTER_METHODINFO(0x0472A1E8, PlayFabStatistics_c_DisplayClass14_0__GetStatistics_b__4__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04768C78, PlayFabStatistics_c_DisplayClass14_0__GetStatistics_b__5__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00539C90, void, _GetStatistics_b__6, (app::PlayFabStatistics_c_DisplayClass14_0 * this_ptr, app::GetFriendLeaderboardAroundPlayerResult* result))
    IL2CPP_REGISTER_METHODINFO(0x0477DD08, PlayFabStatistics_c_DisplayClass14_0__GetStatistics_b__6__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04722108, PlayFabStatistics_c_DisplayClass14_0__GetStatistics_b__7__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0476D650, PlayFabStatistics_c_DisplayClass14_0__GetStatistics_b__8__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04768610, PlayFabStatistics_c_DisplayClass14_0__GetStatistics_b__12__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04797650, PlayFabStatistics_c_DisplayClass14_0__GetStatistics_b__9__MethodInfo)
} // namespace app::classes::SystemIntegration::Synchronizer::Statistics::PlayFabStatistics___c__DisplayClass14_0

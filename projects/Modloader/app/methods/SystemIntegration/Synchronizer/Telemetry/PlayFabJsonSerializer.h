...
namespace app::classes::SystemIntegration::Synchronizer::Telemetry::PlayFabJsonSerializer {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::String*,
        SerializeObject_2,
        app::PlayFabJsonSerializer* this_ptr,
        app::Object* obj,
        app::Object* serializer_strategy
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x0054C130,
        void,
        SerializeBase_PlayFab_SharedModels_PlayFabRequestCommon,
        app::JsonBuilder_Object obj,
        app::PlayFabRequestCommon* value
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x0054C610,
        void,
        Serialize_PlayFab_ClientModels_ExecuteCloudScriptRequest,
        app::JsonBuilder_Slot slot,
        app::ExecuteCloudScriptRequest* value
    )
    IL2CPP_REGISTER_METHOD(
        0x0054CAC0,
        void,
        Serialize_PlayFab_ClientModels_GetFriendLeaderboardAroundPlayerRequest,
        app::JsonBuilder_Slot slot,
        app::GetFriendLeaderboardAroundPlayerRequest* value
    )
    IL2CPP_REGISTER_METHOD(
        0x0054D150,
        void,
        Serialize_PlayFab_ClientModels_GetFriendLeaderboardRequest,
        app::JsonBuilder_Slot slot,
        app::GetFriendLeaderboardRequest* value
    )
    IL2CPP_REGISTER_METHOD(
        0x0054D820,
        void,
        Serialize_PlayFab_ClientModels_GetFriendsListRequest,
        app::JsonBuilder_Slot slot,
        app::GetFriendsListRequest* value
    )
    IL2CPP_REGISTER_METHOD(
        0x0054DC10,
        void,
        Serialize_PlayFab_ClientModels_GetLeaderboardAroundPlayerRequest,
        app::JsonBuilder_Slot slot,
        app::GetLeaderboardAroundPlayerRequest* value
    )
    IL2CPP_REGISTER_METHOD(
        0x0054E0B0,
        void,
        Serialize_PlayFab_ClientModels_GetLeaderboardRequest,
        app::JsonBuilder_Slot slot,
        app::GetLeaderboardRequest* value
    )
    IL2CPP_REGISTER_METHOD(
        0x0054E590,
        void,
        Serialize_PlayFab_ClientModels_GetPlayFabIDsFromNintendoSwitchDeviceIdsRequest,
        app::JsonBuilder_Slot slot,
        app::GetPlayFabIDsFromNintendoSwitchDeviceIdsRequest* value
    )
    IL2CPP_REGISTER_METHOD(
        0x0054E8B0,
        void,
        Serialize_PlayFab_ClientModels_GetPlayerCombinedInfoRequestParams,
        app::JsonBuilder_Slot slot,
        app::GetPlayerCombinedInfoRequestParams* value
    )
    IL2CPP_REGISTER_METHOD(
        0x0054F2A0,
        void,
        Serialize_PlayFab_ClientModels_GetPlayerStatisticsRequest,
        app::JsonBuilder_Slot slot,
        app::GetPlayerStatisticsRequest* value
    )
    IL2CPP_REGISTER_METHOD(
        0x0054F790,
        void,
        Serialize_PlayFab_ClientModels_LinkNintendoSwitchDeviceIdRequest,
        app::JsonBuilder_Slot slot,
        app::LinkNintendoSwitchDeviceIdRequest* value
    )
    IL2CPP_REGISTER_METHOD(
        0x0054FA40,
        void,
        Serialize_PlayFab_ClientModels_LinkSteamAccountRequest,
        app::JsonBuilder_Slot slot,
        app::LinkSteamAccountRequest* value
    )
    IL2CPP_REGISTER_METHOD(
        0x0054FCF0,
        void,
        Serialize_PlayFab_ClientModels_LoginWithCustomIDRequest,
        app::JsonBuilder_Slot slot,
        app::LoginWithCustomIDRequest* value
    )
    IL2CPP_REGISTER_METHOD(
        0x00550060,
        void,
        Serialize_PlayFab_ClientModels_PlayerProfileViewConstraints,
        app::JsonBuilder_Slot slot,
        app::PlayerProfileViewConstraints* value
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x005507A0,
        void,
        Serialize_PlayFab_ClientModels_UpdateUserTitleDisplayNameRequest,
        app::JsonBuilder_Slot slot,
        app::UpdateUserTitleDisplayNameRequest* value
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x00550CB0,
        void,
        Serialize_PlayFab_DataModels_InitiateFileUploadsRequest,
        app::JsonBuilder_Slot slot,
        app::InitiateFileUploadsRequest* value
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x00551EC0,
        void,
        Serialize_PlayFab_ProfilesModels_EntityPermissionStatement,
        app::JsonBuilder_Slot slot,
        app::EntityPermissionStatement* value
    )
    IL2CPP_REGISTER_METHOD(
        0x00552170,
        void,
        Serialize_PlayFab_ProfilesModels_SetEntityProfilePolicyRequest,
        app::JsonBuilder_Slot slot,
        app::SetEntityProfilePolicyRequest* value
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x00552670,
        app::AdCampaignAttributionModel*,
        Deserialize_PlayFab_ClientModels_AdCampaignAttributionModel,
        app::JsonParser_Slot value
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x00556800,
        app::GetFriendLeaderboardAroundPlayerResult*,
        Deserialize_PlayFab_ClientModels_GetFriendLeaderboardAroundPlayerResult,
        app::JsonParser_Slot value
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x00557640,
        app::GetLeaderboardAroundPlayerResult*,
        Deserialize_PlayFab_ClientModels_GetLeaderboardAroundPlayerResult,
        app::JsonParser_Slot value
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x00558580,
        app::GetPlayFabIDsFromNintendoSwitchDeviceIdsResult*,
        Deserialize_PlayFab_ClientModels_GetPlayFabIDsFromNintendoSwitchDeviceIdsResult,
        app::JsonParser_Slot value
    )
    IL2CPP_REGISTER_METHOD(
        0x00558C20,
        app::GetPlayerCombinedInfoResultPayload*,
        Deserialize_PlayFab_ClientModels_GetPlayerCombinedInfoResultPayload,
        app::JsonParser_Slot value
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x0055BF20,
        app::LinkNintendoSwitchDeviceIdResult*,
        Deserialize_PlayFab_ClientModels_LinkNintendoSwitchDeviceIdResult,
        app::JsonParser_Slot value
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x0055C780,
        app::LinkedPlatformAccountModel*,
        Deserialize_PlayFab_ClientModels_LinkedPlatformAccountModel,
        app::JsonParser_Slot value
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x0055EBD0,
        app::NintendoSwitchPlayFabIdPair*,
        Deserialize_PlayFab_ClientModels_NintendoSwitchPlayFabIdPair,
        app::JsonParser_Slot value
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x00561590,
        app::PushNotificationRegistrationModel*,
        Deserialize_PlayFab_ClientModels_PushNotificationRegistrationModel,
        app::JsonParser_Slot value
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x00563CD0,
        app::UpdateUserTitleDisplayNameResult*,
        Deserialize_PlayFab_ClientModels_UpdateUserTitleDisplayNameResult,
        app::JsonParser_Slot value
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x005661C0,
        app::UserFacebookInstantGamesIdInfo*,
        Deserialize_PlayFab_ClientModels_UserFacebookInstantGamesIdInfo,
        app::JsonParser_Slot value
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x00567920,
        app::UserNintendoSwitchDeviceIdInfo*,
        Deserialize_PlayFab_ClientModels_UserNintendoSwitchDeviceIdInfo,
        app::JsonParser_Slot value
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x0056B4C0,
        app::VirtualCurrencyRechargeTime*,
        Deserialize_PlayFab_ClientModels_VirtualCurrencyRechargeTime,
        app::JsonParser_Slot value
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x0056D1C0,
        app::InitiateFileUploadsResponse*,
        Deserialize_PlayFab_DataModels_InitiateFileUploadsResponse,
        app::JsonParser_Slot value
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x0056E040,
        app::EntityPermissionStatement*,
        Deserialize_PlayFab_ProfilesModels_EntityPermissionStatement,
        app::JsonParser_Slot value
    )
    IL2CPP_REGISTER_METHOD(
        0x0056E830,
        app::SetEntityProfilePolicyResponse*,
        Deserialize_PlayFab_ProfilesModels_SetEntityProfilePolicyResponse,
        app::JsonParser_Slot value
    )

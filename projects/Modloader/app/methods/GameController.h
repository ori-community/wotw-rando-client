...
namespace app::classes::GameController {
    ...
    IL2CPP_REGISTER_METHOD(0x00691880, void, SetupGameplay, (app::GameController * this_ptr, app::SceneRoot* scene_root, app::WorldEventsOnAwake* world_events_on_awake))

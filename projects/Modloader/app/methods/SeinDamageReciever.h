...
namespace app::classes::SeinDamageReciever {
    ...
    IL2CPP_REGISTER_METHOD(0x006E4B60, bool, CheckForDamageBeforeMovement, (app::SeinDamageReciever * this_ptr, app::Vector3 direction, float distance, app::RaycastHit* hit_info))
    ...
    IL2CPP_REGISTER_METHOD(0x006E6E60, void, HandleGroundAnimationAndKickback, (app::SeinDamageReciever * this_ptr, app::Damage* damage, bool kickback_enabled, float* hurt_timeremaining, app::ActiveAnimationHandle* active_animation, app::SeinDamageReceiverPuppet* puppet))
    ...
    IL2CPP_REGISTER_METHOD(0x006E8E30, void, PerformCounterstrikeDamage, (app::SeinDamageReciever * this_ptr, app::Damage* damage, app::EnemyEntity* enemy, app::DamageReceiver* damage_receiver))

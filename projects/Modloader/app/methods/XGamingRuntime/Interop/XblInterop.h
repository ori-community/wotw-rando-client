...
namespace app::classes::XGamingRuntime::Interop::XblInterop {
    IL2CPP_REGISTER_METHOD(0x030B3F20, int32_t, XblAchievementsResultGetAchievements, (app::XblAchievementsResultHandle_1 result_handle, void** achievements, app::SizeT* achievements_count))

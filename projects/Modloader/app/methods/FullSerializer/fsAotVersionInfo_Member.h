...
namespace app::classes::FullSerializer::fsAotVersionInfo_Member {
    ...
    inline bool operator==(app::fsAotVersionInfo_Member a, app::fsAotVersionInfo_Member b) { return op_Equality(a, b); }
    inline bool operator!=(app::fsAotVersionInfo_Member a, app::fsAotVersionInfo_Member b) { return op_Inequality(a, b); }
} // namespace app::classes::FullSerializer::fsAotVersionInfo_Member

...
namespace app::classes::FullSerializer::Internal::fsPortableReflection__GetFlattenedMethods_d__18 {
    ...
    IL2CPP_REGISTER_METHODINFO(0x047546B0, fsPortableReflection_GetFlattenedMethods_d_18_System_Collections_IEnumerator_Reset__MethodInfo)
    ...
    IL2CPP_REGISTER_METHOD(0x0165AEC0, app::IEnumerator_1_System_Reflection_MethodInfo_*, IEnumerable_MethodInfo__GetEnumerator, (app::fsPortableReflection_GetFlattenedMethods_d_18 * this_ptr))

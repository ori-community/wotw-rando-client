...
namespace app::classes::FullSerializer::fsJsonParser {
    ...
    IL2CPP_REGISTER_METHOD(0x0150C880, char16_t, Character_1, (app::fsJsonParser * this_ptr))
    IL2CPP_REGISTER_METHOD(0x0150C8B0, char16_t, Character_2, (app::fsJsonParser * this_ptr, int32_t offset))
    IL2CPP_REGISTER_METHOD(0x0150C8E0, void, SkipSpace, (app::fsJsonParser * this_ptr))
    IL2CPP_REGISTER_METHOD(0x0150CC80, bool, IsHex, (app::fsJsonParser * this_ptr, char16_t c))
    IL2CPP_REGISTER_METHOD(0x0150CCB0, uint32_t, ParseSingleChar, (app::fsJsonParser * this_ptr, char16_t c1, uint32_t multipliyer))
    IL2CPP_REGISTER_METHOD(0x0150CCF0, uint32_t, ParseUnicode, (app::fsJsonParser * this_ptr, char16_t c1, char16_t c2, char16_t c3, char16_t c4))
    IL2CPP_REGISTER_METHOD(0x0150CE40, app::fsResult, TryUnescapeChar, (app::fsJsonParser * this_ptr, char16_t* escaped))
    ...
    IL2CPP_REGISTER_METHOD(0x0150DDC0, bool, IsSeparator, (app::fsJsonParser * this_ptr, char16_t c))

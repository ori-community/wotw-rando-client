...
namespace app::classes::FullSerializer::fsSerializer {
    ...
    IL2CPP_REGISTER_METHOD(0x0151A410, app::fsResult, InternalSerialize_2_Inheritance, (app::fsSerializer * this_ptr, app::Type* storage_type, app::Type* override_converter_type, app::Object* instance, app::fsData** data))
    IL2CPP_REGISTER_METHOD(0x0151A710, app::fsResult, InternalSerialize_3_ProcessVersioning, (app::fsSerializer * this_ptr, app::Type* override_converter_type, app::Object* instance, app::fsData** data))
    IL2CPP_REGISTER_METHOD(0x0151AA70, app::fsResult, InternalSerialize_4_Converter, (app::fsSerializer * this_ptr, app::Type* override_converter_type, app::Object* instance, app::fsData** data))
    IL2CPP_REGISTER_METHOD(0x0151AB20, app::fsResult, TryDeserialize_1, (app::fsSerializer * this_ptr, app::fsData* data, app::Type* storage_type, app::Object** result))
    IL2CPP_REGISTER_METHOD(0x0151AB60, app::fsResult, TryDeserialize_2, (app::fsSerializer * this_ptr, app::fsData* data, app::Type* storage_type, app::Type* override_converter_type, app::Object** result))
    IL2CPP_REGISTER_METHOD(0x0151AE20, app::fsResult, InternalDeserialize_1_CycleReference, (app::fsSerializer * this_ptr, app::Type* override_converter_type, app::fsData* data, app::Type* storage_type, app::Object** result, app::List_1_FullSerializer_fsObjectProcessor_** processors))
    IL2CPP_REGISTER_METHOD(0x0151B250, app::fsResult, InternalDeserialize_2_Version, (app::fsSerializer * this_ptr, app::Type* override_converter_type, app::fsData* data, app::Type* storage_type, app::Object** result, app::List_1_FullSerializer_fsObjectProcessor_** processors))
    IL2CPP_REGISTER_METHOD(0x0151B880, app::fsResult, InternalDeserialize_3_Inheritance, (app::fsSerializer * this_ptr, app::Type* override_converter_type, app::fsData* data, app::Type* storage_type, app::Object** result, app::List_1_FullSerializer_fsObjectProcessor_** processors))
    IL2CPP_REGISTER_METHOD(0x0151C110, app::fsResult, InternalDeserialize_4_Cycles, (app::fsSerializer * this_ptr, app::Type* override_converter_type, app::fsData* data, app::Type* result_type, app::Object** result))

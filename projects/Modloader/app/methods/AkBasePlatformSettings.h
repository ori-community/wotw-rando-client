...
namespace app::classes::AkBasePlatformSettings {
    ...
    IL2CPP_REGISTER_METHOD(0x026CF810, app::AkCallbackManager_InitializationSettings*, get_CallbackManagerInitializationSettings, (app::AkBasePlatformSettings * this_ptr))

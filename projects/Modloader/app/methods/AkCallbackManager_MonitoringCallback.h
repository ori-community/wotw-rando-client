...
namespace app::classes::AkCallbackManager_MonitoringCallback {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Invoke,
        app::AkCallbackManager_MonitoringCallback* this_ptr,
        app::AkMonitorErrorCode__Enum in_error_code,
        app::AkMonitorErrorLevel__Enum in_error_level,
        uint32_t in_playing_i_d,
        uint64_t in_game_obj_i_d,
        app::String* in_msg
    )
    IL2CPP_REGISTER_METHOD(
        0x026D5190,

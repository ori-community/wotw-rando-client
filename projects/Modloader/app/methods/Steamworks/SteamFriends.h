...
namespace app::classes::Steamworks::SteamFriends {
    ...
    IL2CPP_REGISTER_METHOD(0x027EAAE0, void, GetFriendsGroupMembersList, (app::FriendsGroupID_t friends_group_i_d, app::CSteamID__Array* p_out_steam_i_d_members, int32_t n_members_count))
    ...
    IL2CPP_REGISTER_METHOD(0x027EE130, int32_t, GetClanChatMessage, (app::CSteamID steam_i_d_clan_chat, int32_t i_message, app::String** prgch_text, int32_t cch_text_max, app::EChatEntryType__Enum* pe_chat_entry_type, app::CSteamID* psteamid_chatter))
    ...
    IL2CPP_REGISTER_METHOD(0x027EE9D0, int32_t, GetFriendMessage, (app::CSteamID steam_i_d_friend, int32_t i_message_i_d, app::String** pv_data, int32_t cub_data, app::EChatEntryType__Enum* pe_chat_entry_type))

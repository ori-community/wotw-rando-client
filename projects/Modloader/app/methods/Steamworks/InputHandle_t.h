...
namespace app::classes::Steamworks::InputHandle_t {
    ...
    inline bool operator==(app::InputHandle_t x, app::InputHandle_t y) { return op_Equality(x, y); }
    inline bool operator!=(app::InputHandle_t x, app::InputHandle_t y) { return op_Inequality(x, y); }
} // namespace app::classes::Steamworks::InputHandle_t

...
namespace app::classes::Steamworks::UGCHandle_t {
    ...
    inline bool operator==(app::UGCHandle_t x, app::UGCHandle_t y) { return op_Equality(x, y); }
    inline bool operator!=(app::UGCHandle_t x, app::UGCHandle_t y) { return op_Inequality(x, y); }
} // namespace app::classes::Steamworks::UGCHandle_t

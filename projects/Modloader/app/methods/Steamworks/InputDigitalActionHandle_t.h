...
namespace app::classes::Steamworks::InputDigitalActionHandle_t {
    ...
    inline bool operator==(app::InputDigitalActionHandle_t x, app::InputDigitalActionHandle_t y) { return op_Equality(x, y); }
    inline bool operator!=(app::InputDigitalActionHandle_t x, app::InputDigitalActionHandle_t y) { return op_Inequality(x, y); }
} // namespace app::classes::Steamworks::InputDigitalActionHandle_t

...
namespace app::classes::Steamworks::ISteamMatchmakingServerListResponse_InternalServerFailedToRespond {
    IL2CPP_REGISTER_METHOD(
        0x00611810,
        void,
        ctor,
        app::ISteamMatchmakingServerListResponse_InternalServerFailedToRespond* this_ptr,
        app::Object* object,
        void* method_1
    )
    IL2CPP_REGISTER_METHOD(

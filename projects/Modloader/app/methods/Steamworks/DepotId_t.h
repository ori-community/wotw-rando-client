...
namespace app::classes::Steamworks::DepotId_t {
    ...
    inline bool operator==(app::DepotId_t x, app::DepotId_t y) { return op_Equality(x, y); }
    inline bool operator!=(app::DepotId_t x, app::DepotId_t y) { return op_Inequality(x, y); }
} // namespace app::classes::Steamworks::DepotId_t

...
namespace app::classes::Steamworks::SteamAPICall_t {
    ...
    inline bool operator==(app::SteamAPICall_t x, app::SteamAPICall_t y) { return op_Equality(x, y); }
    inline bool operator!=(app::SteamAPICall_t x, app::SteamAPICall_t y) { return op_Inequality(x, y); }
} // namespace app::classes::Steamworks::SteamAPICall_t

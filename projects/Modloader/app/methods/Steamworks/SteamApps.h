...
namespace app::classes::Steamworks::SteamApps {
    ...
    IL2CPP_REGISTER_METHOD(0x027E2980, bool, BGetDLCDataByIndex, (int32_t i_d_l_c, app::AppId_t* p_app_i_d, bool* pb_available, app::String** pch_name, int32_t cch_name_buffer_size))

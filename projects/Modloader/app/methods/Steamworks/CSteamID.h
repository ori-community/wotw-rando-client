...
namespace app::classes::Steamworks::CSteamID {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_1,
        app::CSteamID__Boxed* this_ptr,
        app::AccountID_t un_account_i_d,
        app::EUniverse__Enum e_universe,
    ...
    inline bool operator==(app::CSteamID x, app::CSteamID y) { return op_Equality(x, y); }
    inline bool operator!=(app::CSteamID x, app::CSteamID y) { return op_Inequality(x, y); }
} // namespace app::classes::Steamworks::CSteamID

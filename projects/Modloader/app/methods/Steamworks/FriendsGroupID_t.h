...
namespace app::classes::Steamworks::FriendsGroupID_t {
    ...
    inline bool operator==(app::FriendsGroupID_t x, app::FriendsGroupID_t y) { return op_Equality(x, y); }
    inline bool operator!=(app::FriendsGroupID_t x, app::FriendsGroupID_t y) { return op_Inequality(x, y); }
} // namespace app::classes::Steamworks::FriendsGroupID_t

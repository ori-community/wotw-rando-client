...
namespace app::classes::Steamworks::SteamMatchmakingServers {
    IL2CPP_REGISTER_METHOD(
        0x0278A110,
        app::HServerListRequest,
        RequestInternetServerList,
        app::AppId_t i_app,
        app::MatchMakingKeyValuePair_t__Array* ppch_filters,
        uint32_t n_filters,
        app::ISteamMatchmakingServerListResponse* p_request_servers_response
    )
    IL2CPP_REGISTER_METHOD(
        0x0278A370,
        app::HServerListRequest,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        uint32_t un_i_p,
        uint16_t us_port,
        app::ISteamMatchmakingPingResponse* p_request_servers_response
    )
    IL2CPP_REGISTER_METHOD(
        0x0278B630,
        app::HServerQuery,
        ...
        uint32_t un_i_p,
        uint16_t us_port,
        app::ISteamMatchmakingPlayersResponse* p_request_servers_response
    )
    IL2CPP_REGISTER_METHOD(
        0x0278B7A0,
        app::HServerQuery,
        ...
        uint32_t un_i_p,
        uint16_t us_port,
        app::ISteamMatchmakingRulesResponse* p_request_servers_response
    )

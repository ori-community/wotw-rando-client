...
namespace app::classes::Steamworks::ISteamMatchmakingPlayersResponse_InternalAddPlayerToList {
    ...
    IL2CPP_REGISTER_METHOD(0x015FD3D0, void, Invoke, (app::ISteamMatchmakingPlayersResponse_InternalAddPlayerToList * this_ptr, void* thisptr, void* pch_name, int32_t n_score, float fl_time_played))
    IL2CPP_REGISTER_METHOD(0x015FD7F0, app::IAsyncResult*, BeginInvoke, (app::ISteamMatchmakingPlayersResponse_InternalAddPlayerToList * this_ptr, void* thisptr, void* pch_name, int32_t n_score, float fl_time_played, app::AsyncCallback* callback, app::Object* object))

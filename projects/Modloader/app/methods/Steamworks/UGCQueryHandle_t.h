...
namespace app::classes::Steamworks::UGCQueryHandle_t {
    ...
    inline bool operator==(app::UGCQueryHandle_t x, app::UGCQueryHandle_t y) { return op_Equality(x, y); }
    inline bool operator!=(app::UGCQueryHandle_t x, app::UGCQueryHandle_t y) { return op_Inequality(x, y); }
} // namespace app::classes::Steamworks::UGCQueryHandle_t

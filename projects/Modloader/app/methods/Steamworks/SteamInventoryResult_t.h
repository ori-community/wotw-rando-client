...
namespace app::classes::Steamworks::SteamInventoryResult_t {
    ...
    inline bool operator==(app::SteamInventoryResult_t x, app::SteamInventoryResult_t y) { return op_Equality(x, y); }
    inline bool operator!=(app::SteamInventoryResult_t x, app::SteamInventoryResult_t y) { return op_Inequality(x, y); }
} // namespace app::classes::Steamworks::SteamInventoryResult_t

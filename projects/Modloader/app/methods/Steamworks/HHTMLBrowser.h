...
namespace app::classes::Steamworks::HHTMLBrowser {
    ...
    inline bool operator==(app::HHTMLBrowser x, app::HHTMLBrowser y) { return op_Equality(x, y); }
    inline bool operator!=(app::HHTMLBrowser x, app::HHTMLBrowser y) { return op_Inequality(x, y); }
} // namespace app::classes::Steamworks::HHTMLBrowser

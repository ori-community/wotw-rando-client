...
namespace app::classes::Steamworks::InputAnalogActionHandle_t {
    ...
    inline bool operator==(app::InputAnalogActionHandle_t x, app::InputAnalogActionHandle_t y) { return op_Equality(x, y); }
    inline bool operator!=(app::InputAnalogActionHandle_t x, app::InputAnalogActionHandle_t y) { return op_Inequality(x, y); }
} // namespace app::classes::Steamworks::InputAnalogActionHandle_t

...
namespace app::classes::Steamworks::PublishedFileUpdateHandle_t {
    ...
    inline bool operator==(app::PublishedFileUpdateHandle_t x, app::PublishedFileUpdateHandle_t y) { return op_Equality(x, y); }
    inline bool operator!=(app::PublishedFileUpdateHandle_t x, app::PublishedFileUpdateHandle_t y) { return op_Inequality(x, y); }
} // namespace app::classes::Steamworks::PublishedFileUpdateHandle_t

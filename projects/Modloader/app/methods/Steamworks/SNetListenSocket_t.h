...
namespace app::classes::Steamworks::SNetListenSocket_t {
    ...
    inline bool operator==(app::SNetListenSocket_t x, app::SNetListenSocket_t y) { return op_Equality(x, y); }
    inline bool operator!=(app::SNetListenSocket_t x, app::SNetListenSocket_t y) { return op_Inequality(x, y); }
} // namespace app::classes::Steamworks::SNetListenSocket_t

...
namespace app::classes::Steamworks::SteamController {
    ...
    IL2CPP_REGISTER_METHOD(0x027E97D0, app::EControllerActionOrigin__Enum, GetActionOriginFromXboxOrigin, (app::ControllerHandle_t controller_handle, app::EXboxOrigin__Enum e_origin))
    IL2CPP_REGISTER_METHOD(0x027E98A0, app::EControllerActionOrigin__Enum, TranslateActionOrigin, (app::ESteamInputType__Enum e_destination_input_type, app::EControllerActionOrigin__Enum e_source_origin))

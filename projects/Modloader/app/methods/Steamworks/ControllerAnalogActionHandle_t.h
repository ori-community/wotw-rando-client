...
namespace app::classes::Steamworks::ControllerAnalogActionHandle_t {
    ...
    inline bool operator==(app::ControllerAnalogActionHandle_t x, app::ControllerAnalogActionHandle_t y) { return op_Equality(x, y); }
    inline bool operator!=(app::ControllerAnalogActionHandle_t x, app::ControllerAnalogActionHandle_t y) { return op_Inequality(x, y); }
} // namespace app::classes::Steamworks::ControllerAnalogActionHandle_t

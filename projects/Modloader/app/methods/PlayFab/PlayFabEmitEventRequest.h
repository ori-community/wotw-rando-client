...
namespace app::classes::PlayFab::PlayFabEmitEventRequest {
    ...
    IL2CPP_REGISTER_METHOD(
        0x002FB950,
        app::TaskCompletionSource_1_PlayFab_IPlayFabEmitEventResponse_*,
        get_ResultPromise,
        app::PlayFabEmitEventRequest* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x002FB960,
        void,
        set_ResultPromise,
        app::PlayFabEmitEventRequest* this_ptr,
        app::TaskCompletionSource_1_PlayFab_IPlayFabEmitEventResponse_* value
    )

...
namespace app::classes::PlayFab::Pipeline::PipelineStageBase_2_PlayFab_IPlayFabEmitEventRequest_TitleEventBatch_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        RunStage,
        app::PipelineStageBase_2_PlayFab_IPlayFabEmitEventRequest_TitleEventBatch_* this_ptr,
        app::BlockingCollection_1_PlayFab_IPlayFabEmitEventRequest_* input,
        app::BlockingCollection_1_PlayFab_Pipeline_TitleEventBatch_* output,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        StoreOutput,
        app::PipelineStageBase_2_PlayFab_IPlayFabEmitEventRequest_TitleEventBatch_* this_ptr,
        app::TitleEventBatch* output_item
    )
} // namespace app::classes::PlayFab::Pipeline::PipelineStageBase_2_PlayFab_IPlayFabEmitEventRequest_TitleEventBatch_

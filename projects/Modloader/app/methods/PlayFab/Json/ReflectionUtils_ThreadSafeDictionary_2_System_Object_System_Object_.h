...
namespace app::classes::PlayFab::Json::ReflectionUtils_ThreadSafeDictionary_2_System_Object_System_Object_ {
    IL2CPP_REGISTER_METHOD(
        ...
        get_Keys,
        app::ReflectionUtils_ThreadSafeDictionary_2_System_Object_System_Object_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x01D15DD0,
        app::ICollection_1_System_Object_*,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ctor,
        app::ReflectionUtils_ThreadSafeDictionary_2_System_Object_System_Object_* this_ptr,
        app::ReflectionUtils_ThreadSafeDictionaryValueFactory_2_System_Object_System_Object_* value_factory
    )

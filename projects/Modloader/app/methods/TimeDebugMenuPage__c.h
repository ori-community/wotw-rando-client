...
namespace app::classes::TimeDebugMenuPage___c {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04788978, TimeDebugMenuPage_c__GetItems_b__9_3__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x010EFA10, bool, _GetItems_b__9_4, (app::TimeDebugMenuPage_c * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04735D28, TimeDebugMenuPage_c__GetItems_b__9_4__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x010EFAB0, void, _GetItems_b__9_5, (app::TimeDebugMenuPage_c * this_ptr, bool val))
    IL2CPP_REGISTER_METHODINFO(0x0478AC10, TimeDebugMenuPage_c__GetItems_b__9_5__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x010EFB60, bool, _GetItems_b__9_6, (app::TimeDebugMenuPage_c * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04775678, TimeDebugMenuPage_c__GetItems_b__9_6__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x010EFBF0, void, _GetItems_b__9_7, (app::TimeDebugMenuPage_c * this_ptr, bool v))
    IL2CPP_REGISTER_METHODINFO(0x04701908, TimeDebugMenuPage_c__GetItems_b__9_7__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x010EFD90, app::String*, _GetItems_b__9_8, (app::TimeDebugMenuPage_c * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0472BE28, TimeDebugMenuPage_c__GetItems_b__9_8__MethodInfo)
} // namespace app::classes::TimeDebugMenuPage___c

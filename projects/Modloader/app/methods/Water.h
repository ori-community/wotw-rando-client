...
namespace app::classes::Water {
    ...
    IL2CPP_REGISTER_METHOD(0x02D6E0C0, void, CreateWaterObjects, (app::Water * this_ptr, app::Camera* current_camera, app::Camera** reflection_camera, app::Camera** refraction_camera))
    ...
    IL2CPP_REGISTER_METHOD(0x02D6F580, app::Vector4, CameraSpacePlane, (app::Water * this_ptr, app::Camera* cam, app::Vector3 pos, app::Vector3 normal, float side_sign))

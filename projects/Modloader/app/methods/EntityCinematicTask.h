...
namespace app::classes::EntityCinematicTask {
    ...
    IL2CPP_REGISTER_METHOD(0x002FB9E0, void, set_ForceReturnTaskStatus, (app::EntityCinematicTask * this_ptr, app::Nullable_1_Moon_BehaviourSystem_BehaviourStatus_ value))

...
namespace app::classes::LogCallbackHandler {
    ...
    IL2CPP_REGISTER_METHOD(0x03190230, void, HandleException, (app::LogCallbackHandler * this_ptr, app::String* condition, app::String* stack_trace, app::LogType__Enum type))

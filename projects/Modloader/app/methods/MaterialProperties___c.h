...
namespace app::classes::MaterialProperties___c {
    ...
    IL2CPP_REGISTER_METHOD(
        0x01382A00,
        bool,
        _RemovePropertiesThatArntOverwridden_b__5_0,
        app::MaterialProperties_c* this_ptr,
        app::OverridableTextureProperty* a
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x00AD4920,
        app::String*,
        _RemovePropertiesThatArntOverwridden_b__5_3,
        app::MaterialProperties_c* this_ptr,
        app::OverridableTextureProperty* a
    )
    IL2CPP_REGISTER_METHOD(
        0x00AD4920,
        app::String*,
        _RemovePropertiesThatArntOverwridden_b__5_4,
        app::MaterialProperties_c* this_ptr,
        app::OverridableFloatProperty* a
    )
    IL2CPP_REGISTER_METHOD(
        0x00AD4920,
        app::String*,
        _RemovePropertiesThatArntOverwridden_b__5_5,
        app::MaterialProperties_c* this_ptr,
        app::OverridableColorProperty* a
    )
} // namespace app::classes::MaterialProperties___c

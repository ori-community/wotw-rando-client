...
namespace app::classes::SurfaceBasedSettings_1_System_Object_ {
    ...
    IL2CPP_REGISTER_METHOD(0x01D1CE70, app::Object*, GetValue_3, (app::SurfaceBasedSettings_1_System_Object_ * this_ptr, app::SurfaceMaterialType__Enum material_type))

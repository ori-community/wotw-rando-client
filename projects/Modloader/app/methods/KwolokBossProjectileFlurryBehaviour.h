...
namespace app::classes::KwolokBossProjectileFlurryBehaviour {
    ...
    IL2CPP_REGISTER_METHOD(0x012E9900, void, ModifyStayAtRangeSettings, (app::KwolokBossProjectileFlurryBehaviour * this_ptr, app::KwolokBossLocomotion_StayAtRangeSettings* settings))

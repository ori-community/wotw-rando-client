...
namespace app::classes::GroundLocomotion {
    ...
    IL2CPP_REGISTER_METHOD(0x01095540, void, SetLookDirectionX_1, (app::GroundLocomotion * this_ptr, float x_look_direction, app::EntityBehaviour* source, bool instant))
    IL2CPP_REGISTER_METHOD(0x01095560, void, SetLookDirectionTowardsPoint_1, (app::GroundLocomotion * this_ptr, app::Vector2 point, app::EntityBehaviour* source, bool instant))
    IL2CPP_REGISTER_METHOD(0x010957E0, void, SetLookDirection_1, (app::GroundLocomotion * this_ptr, app::Vector2 direction, app::EntityBehaviour* source, bool instant))
    IL2CPP_REGISTER_METHOD(0x01095810, void, SetLookDirectionTowardsPoint_2, (app::GroundLocomotion * this_ptr, app::Vector2 point, app::EntityBehaviourNode* source, bool instant))
    IL2CPP_REGISTER_METHOD(0x01095540, void, SetLookDirectionX_2, (app::GroundLocomotion * this_ptr, float x_look_direction, app::EntityBehaviourNode* source, bool instant))
    IL2CPP_REGISTER_METHOD(0x010957E0, void, SetLookDirection_2, (app::GroundLocomotion * this_ptr, app::Vector2 direction, app::EntityBehaviourNode* source, bool instant))

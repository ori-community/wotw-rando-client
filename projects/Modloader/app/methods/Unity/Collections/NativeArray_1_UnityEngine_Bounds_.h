...
namespace app::classes::Unity::Collections::NativeArray_1_UnityEngine_Bounds_ {
    ...
    IL2CPP_REGISTER_METHOD(0x001DFB30, app::NativeArray_1_T_Enumerator_UnityEngine_Bounds_, GetEnumerator, (app::NativeArray_1_UnityEngine_Bounds___Boxed * this_ptr))
    IL2CPP_REGISTER_METHOD(0x001DFB90, app::IEnumerator_1_UnityEngine_Bounds_*, System_Collections_Generic_IEnumerable_T__GetEnumerator, (app::NativeArray_1_UnityEngine_Bounds___Boxed * this_ptr))
    ...
    IL2CPP_REGISTER_METHOD(0x02264BD0, void, Copy_5, (app::Bounds__Array * src, int32_t src_index, app::NativeArray_1_UnityEngine_Bounds_ dst, int32_t dst_index, int32_t length))
    IL2CPP_REGISTER_METHOD(0x02264D40, void, Copy_6, (app::NativeArray_1_UnityEngine_Bounds_ src, int32_t src_index, app::Bounds__Array* dst, int32_t dst_index, int32_t length))
} // namespace app::classes::Unity::Collections::NativeArray_1_UnityEngine_Bounds_

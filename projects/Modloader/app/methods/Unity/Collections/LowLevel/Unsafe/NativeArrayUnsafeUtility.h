...
namespace app::classes::Unity::Collections::LowLevel::Unsafe::NativeArrayUnsafeUtility {
    ...
    IL2CPP_REGISTER_METHOD(0x02FF6F40, app::NativeArray_1_System_Byte_, ConvertExistingDataToNativeArray, (app::Void * data_pointer, int32_t length, app::Allocator__Enum allocator))
} // namespace app::classes::Unity::Collections::LowLevel::Unsafe::NativeArrayUnsafeUtility

...
namespace app::classes::MeleeComboMoveHammerChargeable {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::SeinComboHandler* handler,
        app::MeleeWeapon* weapon
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        GetEffectInstance,
        app::MeleeComboMoveHammerChargeable* this_ptr,
        app::GameObject* current_shock_wave,
        bool track_as_suspendable
    )
    IL2CPP_REGISTER_METHOD(
        0x01392EB0,
        app::GameObject*,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ChangeState,
        app::MeleeComboMoveHammerChargeable* this_ptr,
        app::MeleeComboMoveHammerChargeable_State__Enum new_state
    )

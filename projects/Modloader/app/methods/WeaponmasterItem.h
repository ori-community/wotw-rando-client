...
namespace app::classes::WeaponmasterItem {
    ...
    IL2CPP_REGISTER_METHOD(0x00571DF0, bool, TryPurchase, (app::WeaponmasterItem * this_ptr, app::Action_1_MessageProvider_* show_hint, app::UISoundSettingsAsset* sounds, app::ShopKeeperHints* hints))

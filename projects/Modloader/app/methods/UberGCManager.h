...
namespace app::classes::UberGCManager {
    ...
    IL2CPP_REGISTER_METHOD(0x013EC240, void, OnCleanupOutsideOfGameplayInternal, (app::UberGCLogic_CleanupTrigger__Enum trigger, app::UberGCLogic_CleanupOutsideOfGameplayTrigger__Enum proactive_trigger))

...
namespace app::classes::RecordableObjectPuppet {
    ...
    IL2CPP_REGISTER_METHOD(0x00736660, void, OnInitializeGhostPuppet, (app::RecordableObjectPuppet * this_ptr, app::IPuppetBase* puppet, int32_t recording_id, app::GhostPlayer* player))

...
namespace app::classes::StateOverrideSystem {
    ...
    IL2CPP_REGISTER_METHOD(
        0x031476B0,
        void,
        SubmitDynamicStateOverride_2,
        app::StateOverrideSystem* this_ptr,
        app::IPassiveStateDescriptor* passive_state_descriptor,
        int32_t state
    )
    IL2CPP_REGISTER_METHOD(
        0x03147980,
        void,
        SubmitStaticStateOverride,
        app::StateOverrideSystem* this_ptr,
        app::IPassiveStateDescriptor* passive_state_descriptor,
        int32_t state,

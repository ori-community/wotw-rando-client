...
namespace app::classes::RuntimeSceneMetaData {
    ...
    IL2CPP_REGISTER_METHOD(
        0x0137D3F0,
        bool,
        IsInsideScenePaddingBounds_1,
        app::RuntimeSceneMetaData* this_ptr,
        app::Vector3 position,
        app::Rect current_scene_bounds
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x0137D620,
        bool,
        IsInsideScenePaddingBounds_2,
        app::RuntimeSceneMetaData* this_ptr,
        app::Vector3 position,
        app::RuntimeSceneMetaData_PositionTypes__Enum type
    )
    IL2CPP_REGISTER_METHOD(
        0x0137D8A0,
        bool,
        IsInsideSceneBounds_1,
        app::RuntimeSceneMetaData* this_ptr,
        app::Vector3 position,
        app::RuntimeSceneMetaData_PositionTypes__Enum type
    )
    ...
    inline bool operator==(app::RuntimeSceneMetaData& a, app::RuntimeSceneMetaData& b) { return op_Equality(&a, &b); }
    inline bool operator!=(app::RuntimeSceneMetaData& a, app::RuntimeSceneMetaData& b) { return op_Inequality(&a, &b); }
} // namespace app::classes::RuntimeSceneMetaData

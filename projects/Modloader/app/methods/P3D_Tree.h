...
namespace app::classes::P3D_Tree {
    ...
    IL2CPP_REGISTER_METHOD(0x0309B170, app::P3D_Result*, GetResult, (app::P3D_Tree * this_ptr, app::P3D_Triangle* triangle, app::Vector3 weights, float distance01))
    ...
    IL2CPP_REGISTER_METHOD(0x0309C410, void, SortTriangle, (app::P3D_Tree * this_ptr, app::P3D_Triangle* triangle, int32_t* min_index, int32_t* max_index, bool above_pivot))

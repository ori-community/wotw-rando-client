...
namespace app::classes::LightCullingSystem_LightCullingGroup {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        set_Config,
        app::LightCullingSystem_LightCullingGroup* this_ptr,
        app::LightCullingSystem_LightCullingConfigPerType value
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ctor,
        app::LightCullingSystem_LightCullingGroup* this_ptr,
        app::LightCullingSystem_LightCullingGroupId__Enum id,
        int32_t max_amount,
        app::LightPriority_Layer__Enum__Array* layers
    )
    IL2CPP_REGISTER_METHOD(
        0x0114BD70,
        void,
        Update,
        app::LightCullingSystem_LightCullingGroup* this_ptr,
        app::List_1_PointLightMaskModifier_* lights,
        float delta_time
    )

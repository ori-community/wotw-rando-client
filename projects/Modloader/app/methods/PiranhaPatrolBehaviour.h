...
namespace app::classes::PiranhaPatrolBehaviour {
    ...
    IL2CPP_REGISTER_METHOD(0x01163F40, bool, TryCalculateTargetPosition, (app::PiranhaPatrolBehaviour * this_ptr, int32_t longtitude_index, int32_t latitude_index, app::Vector3* move_target))

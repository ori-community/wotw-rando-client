...
namespace app::classes::UberShaderAPI {
    ...
    IL2CPP_REGISTER_METHOD(0x01905B00, bool, HasProperty_1, (app::Renderer * renderer, app::UberShaderProperty_Texture__Enum property, app::UberShaderProperties_TextureSuffixType__Enum suffix))
    ...
    IL2CPP_REGISTER_METHOD(0x019073E0, void, SetTextureScrollRotData, (app::Renderer * renderer, app::UberShaderProperty_Texture__Enum property, app::Vector4 scroll_rot))
    IL2CPP_REGISTER_METHOD(0x01907630, void, SetTextureAtlasUVs, (app::Renderer * renderer, app::UberShaderProperty_Texture__Enum property, app::Vector4 atlas_u_vs))
    IL2CPP_REGISTER_METHOD(0x01907880, void, SetTextureAtlasScrollRotData, (app::Renderer * renderer, app::UberShaderProperty_Texture__Enum property, app::Vector4 atlas_scroll_rot))
    ...
    IL2CPP_REGISTER_METHOD(0x01907C20, void, SetColor_2, (app::Renderer * renderer, app::Material* material, app::UberShaderProperty_Color__Enum property, app::Color color))
    IL2CPP_REGISTER_METHOD(0x01907D30, void, SetAlpha, (app::Renderer * renderer, app::Material* material, app::UberShaderProperty_Color__Enum property, float color))
    ...
    IL2CPP_REGISTER_METHOD(0x01907F50, void, SetVector_2, (app::Renderer * renderer, app::UberShaderProperty_Vector__Enum property, app::Vector4 vector4, app::Material* material))
    ...
    IL2CPP_REGISTER_METHOD(0x019081B0, void, SetFloat_2, (app::Renderer * renderer, app::UberShaderProperty_Float__Enum property, float val, app::Material* material))
    IL2CPP_REGISTER_METHOD(0x002FA000, void, ClearPropertyBlock, (app::Renderer * renderer))
    IL2CPP_REGISTER_METHOD(0x019082C0, void, SetVectorInPropertyBlock, (app::Renderer * renderer, app::UberShaderProperty_Vector__Enum property, app::Vector4 value))

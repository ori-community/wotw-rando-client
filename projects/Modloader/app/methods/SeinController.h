...
namespace app::classes::SeinController {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        bool,
        RayTest_3,
        app::SeinController* this_ptr,
        app::Vector3 target,
        app::Vector2 start_offset,
        app::Vector2 end_offset,
    ...
    IL2CPP_REGISTER_METHOD(
        0x006DEB50,
        bool,
        ParseRayTestCommandResult,
        app::SeinController* this_ptr,
        app::GameObject* target,
        app::Rigidbody* target_rigidbody,

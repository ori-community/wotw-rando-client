...
namespace app::classes::AkAudioInputManager {
    IL2CPP_REGISTER_METHOD(
        0x026C6E70,
        uint32_t,
        PostAudioInputEvent_1,
        app::Event_1* ak_event,
        app::GameObject* game_object,
        app::AkAudioInputManager_AudioSamplesDelegate* sample_delegate,
        app::AkAudioInputManager_AudioFormatDelegate* format_delegate
    )
    IL2CPP_REGISTER_METHOD(
        0x026C70E0,
        uint32_t,
        PostAudioInputEvent_2,
        uint32_t ak_event_i_d,
        app::GameObject* game_object,
        app::AkAudioInputManager_AudioSamplesDelegate* sample_delegate,
        app::AkAudioInputManager_AudioFormatDelegate* format_delegate
    )
    IL2CPP_REGISTER_METHOD(
        0x026C72D0,
        uint32_t,
        PostAudioInputEvent_3,
        app::String* ak_event_name,
        app::GameObject* game_object,
        app::AkAudioInputManager_AudioSamplesDelegate* sample_delegate,
        app::AkAudioInputManager_AudioFormatDelegate* format_delegate
    )

...
namespace app::classes::SeinLogicCycle {
    IL2CPP_REGISTER_METHOD(
        0x00894F40,
        app::SeinLogicCycle_StateFlags__Enum,
        GetFlags,
        app::SeinLogicCycle* this_ptr,
        app::SeinLogicCycle_StateFlags__Enum test_flags
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::SeinLogicCycle* this_ptr,
        app::Type* type,
        app::SeinLogicCycle_IsAllowedDelegate* is_allowed
    )

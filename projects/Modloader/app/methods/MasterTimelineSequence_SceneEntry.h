...
namespace app::classes::MasterTimelineSequence_SceneEntry {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        SetEndConstraint,
        app::MasterTimelineSequence_SceneEntry* this_ptr,
        app::IEntry* constraint,
        app::LegacyTimelineSequence_SequenceEntry_Constraint_AnchorPoint__Enum anchor
    )
    IL2CPP_REGISTER_METHOD(
        0x00420EE0,
        app::LegacyTimelineSequence_SequenceEntry_Constraint*,
        get_StartConstraint,
        app::MasterTimelineSequence_SceneEntry* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        ...
        set_StartConstraint,
        app::MasterTimelineSequence_SceneEntry* this_ptr,
        app::LegacyTimelineSequence_SequenceEntry_Constraint* value
    )
    IL2CPP_REGISTER_METHOD(
        0x00420EE0,
        app::LegacyTimelineSequence_SequenceEntry_Constraint*,

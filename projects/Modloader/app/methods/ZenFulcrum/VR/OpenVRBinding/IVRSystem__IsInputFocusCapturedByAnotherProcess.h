...
namespace app::classes::ZenFulcrum::VR::OpenVRBinding::IVRSystem__IsInputFocusCapturedByAnotherProcess {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::IAsyncResult*,
        BeginInvoke,
        app::IVRSystem_IsInputFocusCapturedByAnotherProcess* this_ptr,

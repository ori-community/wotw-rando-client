...
namespace app::classes::ZenFulcrum::VR::OpenVRBinding::CVRChaperoneSetup {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::CVRChaperoneSetup* this_ptr,
        app::HmdMatrix34_t* pmat_seated_zero_pose_to_raw_tracking_pose
    )
    IL2CPP_REGISTER_METHOD(
        0x01677880,
        bool,
        ...
        app::CVRChaperoneSetup* this_ptr,
        app::HmdMatrix34_t* pmat_standing_zero_pose_to_raw_tracking_pose
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::CVRChaperoneSetup* this_ptr,
        app::HmdMatrix34_t* p_mat_standing_zero_pose_to_raw_tracking_pose
    )

...
namespace app::classes::ZenFulcrum::VR::OpenVRBinding::IVRSystem__GetUint64TrackedDeviceProperty {
    IL2CPP_REGISTER_METHOD(0x00611810, void, ctor, app::IVRSystem_GetUint64TrackedDeviceProperty* this_ptr, app::Object* object, void* method_1)
    IL2CPP_REGISTER_METHOD(
        0x02CEEF20,
        uint64_t,
        Invoke,
        app::IVRSystem_GetUint64TrackedDeviceProperty* this_ptr,

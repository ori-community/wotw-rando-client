...
namespace app::classes::ZenFulcrum::VR::OpenVRBinding::IVROverlay__HandleControllerOverlayInteractionAsMouse {
    ...
    IL2CPP_REGISTER_METHOD(0x02D7D9B0, app::IAsyncResult*, BeginInvoke, (app::IVROverlay_HandleControllerOverlayInteractionAsMouse * this_ptr, uint64_t ul_overlay_handle, uint32_t un_controller_device_index, app::AsyncCallback* callback, app::Object* object))

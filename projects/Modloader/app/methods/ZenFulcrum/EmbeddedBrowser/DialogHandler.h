...
namespace app::classes::ZenFulcrum::EmbeddedBrowser::DialogHandler {
    IL2CPP_REGISTER_METHOD(
        ...
        Create,
        app::Browser* parent,
        app::DialogHandler_DialogCallback* dialog_callback,
        app::DialogHandler_MenuCallback* context_callback
    )
    IL2CPP_REGISTER_METHOD(
        0x01DD49E0,
        void,
        HandleDialog,
        app::DialogHandler* this_ptr,
        app::BrowserNative_DialogType__Enum type,
        app::String* text,
        app::String* prompt_default
    )

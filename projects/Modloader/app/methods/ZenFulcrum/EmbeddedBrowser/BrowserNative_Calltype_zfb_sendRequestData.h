...
namespace app::classes::ZenFulcrum::EmbeddedBrowser::BrowserNative_Calltype_zfb_sendRequestData {
    ...
    IL2CPP_REGISTER_METHOD(0x01C79170, void, Invoke, (app::BrowserNative_Calltype_zfb_sendRequestData * this_ptr, int32_t request_id, void* data, int32_t data_size))
    IL2CPP_REGISTER_METHOD(0x01DCB150, app::IAsyncResult*, BeginInvoke, (app::BrowserNative_Calltype_zfb_sendRequestData * this_ptr, int32_t request_id, void* data, int32_t data_size, app::AsyncCallback* callback, app::Object* object))

...
namespace app::classes::ZenFulcrum::EmbeddedBrowser::BrowserNative_Calltype_zfb_shutdown {
    IL2CPP_REGISTER_METHOD(0x00611810, void, ctor, app::BrowserNative_Calltype_zfb_shutdown* this_ptr, app::Object* object, void* method_1)
    IL2CPP_REGISTER_METHOD(0x00611820, void, Invoke, app::BrowserNative_Calltype_zfb_shutdown* this_ptr)
    IL2CPP_REGISTER_METHOD(
        0x00611B10,
        app::IAsyncResult*,
        BeginInvoke,
        app::BrowserNative_Calltype_zfb_shutdown* this_ptr,

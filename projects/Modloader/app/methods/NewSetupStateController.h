...
namespace app::classes::NewSetupStateController {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ApplyKnownState,
        app::NewSetupStateController* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ApplyData,
        app::NewSetupStateController* this_ptr,
        app::SetupStateModifierData* modifier_data,
        app::UberStateApplyContext__Enum context
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x01B77120,
        void,
        CollectDynamicGraphics,
        app::NewSetupStateController* this_ptr,
        app::List_1_UnityEngine_GameObject_** dynamic_targets,
        app::List_1_UnityEngine_GameObject_** managed_early_z_targets
    )

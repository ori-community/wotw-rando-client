...
namespace app::classes::RigidbodyInteractionController {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        HandleCollision,
        app::RigidbodyInteractionController* this_ptr,
        app::RigidbodyInteractionController_InteractionInformation interaction_information,
        app::RigidbodyInteractionController_InstanciationInteractionSettings__Array* collision_instanciation_settings,
        app::RigidbodyInteractionController_SoundInteractionSettings__Array* collision_sound_settings
    )
    IL2CPP_REGISTER_METHOD(
        0x00913670,
        float,
        GetRemappedModulationValue,
        app::RigidbodyInteractionController* this_ptr,
        app::Rect range_remapping,

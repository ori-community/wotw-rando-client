...
namespace app::classes::YouCanLeaveYourHatOn___c {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t,
        _PrintReport_b__5_0,
        app::YouCanLeaveYourHatOn_c* this_ptr,
        app::YouCanLeaveYourHatOn_Data* a,
        app::YouCanLeaveYourHatOn_Data* b
    )
    IL2CPP_REGISTER_METHOD(
        0x01C5FBD0,
        int32_t,
        _PrintReport_b__5_2,
        app::YouCanLeaveYourHatOn_c* this_ptr,
        app::YouCanLeaveYourHatOn_AssetWithSize* a,
        app::YouCanLeaveYourHatOn_AssetWithSize* b
    )
    IL2CPP_REGISTER_METHOD(
        0x01C5FBD0,
        int32_t,

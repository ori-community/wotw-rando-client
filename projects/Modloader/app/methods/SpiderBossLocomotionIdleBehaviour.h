...
namespace app::classes::SpiderBossLocomotionIdleBehaviour {
    IL2CPP_REGISTER_METHOD(
        ...
        app::MoonTimeline*,
        GetIdleAnimation,
        app::SpiderBossLocomotionIdleBehaviour* this_ptr,
        app::SpiderBossLocationZone__Enum location_zone
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        SwapIdle,
        app::SpiderBossLocomotionIdleBehaviour* this_ptr,
        app::SpiderBossLocationZone__Enum zone,
        app::MirroredTimelineSet* timelines
    )

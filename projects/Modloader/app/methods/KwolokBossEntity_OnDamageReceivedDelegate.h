...
namespace app::classes::KwolokBossEntity_OnDamageReceivedDelegate {
    ...
    IL2CPP_REGISTER_METHOD(0x012DEBE0, app::IAsyncResult*, BeginInvoke, (app::KwolokBossEntity_OnDamageReceivedDelegate * this_ptr, app::DamageResult result, app::AsyncCallback* callback, app::Object* object))

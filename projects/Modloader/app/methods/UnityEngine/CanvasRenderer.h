...
namespace app::classes::UnityEngine::CanvasRenderer {
    ...
    IL2CPP_REGISTER_METHOD(0x031A6860, void, SplitUIVertexStreams, (app::List_1_UnityEngine_UIVertex_ * verts, app::List_1_UnityEngine_Vector3_* positions, app::List_1_UnityEngine_Color32_* colors, app::List_1_UnityEngine_Vector2_* uv0_s, app::List_1_UnityEngine_Vector2_* uv1_s, app::List_1_UnityEngine_Vector2_* uv2_s, app::List_1_UnityEngine_Vector2_* uv3_s, app::List_1_UnityEngine_Vector3_* normals, app::List_1_UnityEngine_Vector4_* tangents, app::List_1_System_Int32_* indices))
    IL2CPP_REGISTER_METHOD(0x031A6980, void, CreateUIVertexStream, (app::List_1_UnityEngine_UIVertex_ * verts, app::List_1_UnityEngine_Vector3_* positions, app::List_1_UnityEngine_Color32_* colors, app::List_1_UnityEngine_Vector2_* uv0_s, app::List_1_UnityEngine_Vector2_* uv1_s, app::List_1_UnityEngine_Vector2_* uv2_s, app::List_1_UnityEngine_Vector2_* uv3_s, app::List_1_UnityEngine_Vector3_* normals, app::List_1_UnityEngine_Vector4_* tangents, app::List_1_System_Int32_* indices))
    IL2CPP_REGISTER_METHOD(0x031A6A10, void, AddUIVertexStream, (app::List_1_UnityEngine_UIVertex_ * verts, app::List_1_UnityEngine_Vector3_* positions, app::List_1_UnityEngine_Color32_* colors, app::List_1_UnityEngine_Vector2_* uv0_s, app::List_1_UnityEngine_Vector2_* uv1_s, app::List_1_UnityEngine_Vector2_* uv2_s, app::List_1_UnityEngine_Vector2_* uv3_s, app::List_1_UnityEngine_Vector3_* normals, app::List_1_UnityEngine_Vector4_* tangents))
    IL2CPP_REGISTER_METHOD(0x031A6AA0, void, SplitIndicesStreamsInternal, (app::Object * verts, app::Object* indices))
    IL2CPP_REGISTER_METHOD(0x031A6A10, void, SplitUIVertexStreamsInternal, (app::Object * verts, app::Object* positions, app::Object* colors, app::Object* uv0_s, app::Object* uv1_s, app::Object* uv2_s, app::Object* uv3_s, app::Object* normals, app::Object* tangents))
    IL2CPP_REGISTER_METHOD(0x031A6980, void, CreateUIVertexStreamInternal, (app::Object * verts, app::Object* positions, app::Object* colors, app::Object* uv0_s, app::Object* uv1_s, app::Object* uv2_s, app::Object* uv3_s, app::Object* normals, app::Object* tangents, app::Object* indices))

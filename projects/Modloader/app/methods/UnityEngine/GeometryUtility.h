...
namespace app::classes::UnityEngine::GeometryUtility {
    ...
    IL2CPP_REGISTER_METHOD(
        0x02529350,
        void,
        TestPlanesAABBBatched,
        app::Plane__Array* planes,
        app::NativeArray_1_UnityEngine_Bounds_ bounds,
        int32_t bounds_count,
        app::NativeArray_1_System_Byte_ inside_reults
    )
    IL2CPP_REGISTER_METHOD(
        0x02529450,
        void,
        Internal_TestPlanesAABBBatched,
        app::Plane__Array* planes,
        app::Void* bounds,
        int32_t bounds_count,
        app::Void* inside_reults
    )

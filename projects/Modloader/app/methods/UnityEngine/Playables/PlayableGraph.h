...
namespace app::classes::UnityEngine::Playables::PlayableGraph {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        bool,
        ConnectInternal,
        app::PlayableGraph__Boxed* this_ptr,
        app::PlayableHandle source,
        int32_t source_output_port,
        app::PlayableHandle destination,
        int32_t destination_input_port
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Playable source,
        int32_t source_output_port,
        app::AnimationLayerMixerPlayable destination,
        int32_t destination_input_port
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Playable source,
        int32_t source_output_port,
        app::AnimationMixerPlayable destination,
        int32_t destination_input_port
    )
    IL2CPP_REGISTER_METHOD(
        0x0012CDE0,

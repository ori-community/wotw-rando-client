...
namespace app::classes::UnityEngine::Jobs::IJobParallelForTransformExtensions_TransformParallelForLoopStruct_1_AttachSpriteToPhysicsSystem_JobWithMonoBehaviour_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02ACC520, void, Execute, (app::AttachSpriteToPhysicsSystem_JobWithMonoBehaviour * job_data, void* job_data2, void* buffer_range_patch_data, app::JobRanges* ranges, int32_t job_index))
} // namespace app::classes::UnityEngine::Jobs::IJobParallelForTransformExtensions_TransformParallelForLoopStruct_1_AttachSpriteToPhysicsSystem_JobWithMonoBehaviour_

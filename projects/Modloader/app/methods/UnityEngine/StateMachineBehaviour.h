...
namespace app::classes::UnityEngine::StateMachineBehaviour {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        OnStateEnter_1,
        app::StateMachineBehaviour* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        0x002FA000,
        void,
        OnStateMachineEnter_1,
        app::StateMachineBehaviour* this_ptr,
        app::Animator* animator,
        int32_t state_machine_path_hash
    )
    IL2CPP_REGISTER_METHOD(
        0x002FA000,
        void,
        OnStateMachineExit_1,
        app::StateMachineBehaviour* this_ptr,
        app::Animator* animator,
        int32_t state_machine_path_hash
    )
    IL2CPP_REGISTER_METHOD(
        ...
        app::AnimatorStateInfo state_info,
        int32_t layer_index,
        app::AnimatorControllerPlayable controller
    )
    IL2CPP_REGISTER_METHOD(
        0x002FA000,
        void,

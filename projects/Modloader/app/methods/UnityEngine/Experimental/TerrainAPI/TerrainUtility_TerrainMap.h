...
namespace app::classes::UnityEngine::Experimental::TerrainAPI::TerrainUtility_TerrainMap {
    ...
    IL2CPP_REGISTER_METHOD(0x03198460, app::TerrainUtility_TerrainMap*, CreateFromPlacement_1, (app::Terrain_1 * origin_terrain, app::TerrainUtility_TerrainMap_TerrainFilter* filter, bool full_validation))
    IL2CPP_REGISTER_METHOD(0x031988E0, app::TerrainUtility_TerrainMap*, CreateFromPlacement_2, (app::Vector2 grid_origin, app::Vector2 grid_size, app::TerrainUtility_TerrainMap_TerrainFilter* filter, bool full_validation))

...
namespace app::classes::UnityEngine::Experimental::Rendering::SupportedRenderingFeatures {
    ...
    IL2CPP_REGISTER_METHOD(
        0x02525620,
        app::SupportedRenderingFeatures_LightmapMixedBakeMode__Enum,
        get_defaultMixedLightingMode,
        app::SupportedRenderingFeatures* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x024AD170,
        app::SupportedRenderingFeatures_LightmapMixedBakeMode__Enum,
        get_supportedMixedLightingModes,
        app::SupportedRenderingFeatures* this_ptr
    )

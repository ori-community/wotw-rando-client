...
namespace app::classes::UnityEngine::Rigidbody2D {
    ...
    IL2CPP_REGISTER_METHOD(0x031737D0, bool, IsTouching_OtherColliderWithFilter_Internal, (app::Rigidbody2D * this_ptr, app::Collider2D* collider, app::ContactFilter2D contact_filter))
    ...
    IL2CPP_REGISTER_METHOD(0x03173F10, void, AddForceAtPosition_2, (app::Rigidbody2D * this_ptr, app::Vector2 force, app::Vector2 position, app::ForceMode2D__Enum mode))
    ...
    IL2CPP_REGISTER_METHOD(0x03174310, int32_t, OverlapCollider, (app::Rigidbody2D * this_ptr, app::ContactFilter2D contact_filter, app::Collider2D__Array* results))
    IL2CPP_REGISTER_METHOD(0x03174380, int32_t, GetContacts_1, (app::Rigidbody2D * this_ptr, app::ContactPoint2D__Array* contacts))
    IL2CPP_REGISTER_METHOD(0x031744A0, int32_t, GetContacts_2, (app::Rigidbody2D * this_ptr, app::ContactFilter2D contact_filter, app::ContactPoint2D__Array* contacts))
    IL2CPP_REGISTER_METHOD(0x03174580, int32_t, GetContacts_3, (app::Rigidbody2D * this_ptr, app::Collider2D__Array* colliders))
    IL2CPP_REGISTER_METHOD(0x031746A0, int32_t, GetContacts_4, (app::Rigidbody2D * this_ptr, app::ContactFilter2D contact_filter, app::Collider2D__Array* colliders))
    ...
    IL2CPP_REGISTER_METHOD(0x03174830, int32_t, Cast_3, (app::Rigidbody2D * this_ptr, app::Vector2 direction, app::ContactFilter2D contact_filter, app::RaycastHit2D__Array* results))
    IL2CPP_REGISTER_METHOD(0x031748D0, int32_t, Cast_4, (app::Rigidbody2D * this_ptr, app::Vector2 direction, app::ContactFilter2D contact_filter, app::RaycastHit2D__Array* results, float distance))
    IL2CPP_REGISTER_METHOD(0x03174970, int32_t, Cast_Internal, (app::Rigidbody2D * this_ptr, app::Vector2 direction, float distance, app::RaycastHit2D__Array* results))
    IL2CPP_REGISTER_METHOD(0x031749F0, int32_t, CastFiltered_Internal, (app::Rigidbody2D * this_ptr, app::Vector2 direction, float distance, app::ContactFilter2D contact_filter, app::RaycastHit2D__Array* results))
    ...
    IL2CPP_REGISTER_METHOD(0x03174D80, bool, IsTouching_OtherColliderWithFilter_Internal_Injected, (app::Rigidbody2D * this_ptr, app::Collider2D* collider, app::ContactFilter2D* contact_filter))
    IL2CPP_REGISTER_METHOD(0x03174DF0, bool, IsTouching_AnyColliderWithFilter_Internal_Injected, (app::Rigidbody2D * this_ptr, app::ContactFilter2D* contact_filter))
    ...
    IL2CPP_REGISTER_METHOD(0x03175000, void, AddForceAtPosition_Injected, (app::Rigidbody2D * this_ptr, app::Vector2* force, app::Vector2* position, app::ForceMode2D__Enum mode))
    ...
    IL2CPP_REGISTER_METHOD(0x03175320, int32_t, OverlapCollider_Injected, (app::Rigidbody2D * this_ptr, app::ContactFilter2D* contact_filter, app::Collider2D__Array* results))
    IL2CPP_REGISTER_METHOD(0x03175390, int32_t, Cast_Internal_Injected, (app::Rigidbody2D * this_ptr, app::Vector2* direction, float distance, app::RaycastHit2D__Array* results))
    IL2CPP_REGISTER_METHOD(0x03175410, int32_t, CastFiltered_Internal_Injected, (app::Rigidbody2D * this_ptr, app::Vector2* direction, float distance, app::ContactFilter2D* contact_filter, app::RaycastHit2D__Array* results))
} // namespace app::classes::UnityEngine::Rigidbody2D

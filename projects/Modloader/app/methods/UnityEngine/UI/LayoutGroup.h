...
namespace app::classes::UnityEngine::UI::LayoutGroup {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::LayoutGroup* this_ptr,
        float total_min,
        float total_preferred,
        float total_flexible,
        int32_t axis
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        SetProperty_2,
        app::LayoutGroup* this_ptr,
        app::GridLayoutGroup_Corner__Enum* current_value,
        app::GridLayoutGroup_Corner__Enum new_value
    )
    IL2CPP_REGISTER_METHOD(
        0x015E6920,
        void,
        SetProperty_3,
        app::LayoutGroup* this_ptr,
        app::GridLayoutGroup_Axis__Enum* current_value,
        app::GridLayoutGroup_Axis__Enum new_value
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        SetProperty_5,
        app::LayoutGroup* this_ptr,
        app::GridLayoutGroup_Constraint__Enum* current_value,
        app::GridLayoutGroup_Constraint__Enum new_value
    )

...
namespace app::classes::UnityEngine::UI::InputField_OnValidateInput {
    ...
    IL2CPP_REGISTER_METHOD(0x024CEE30, app::IAsyncResult*, BeginInvoke, (app::InputField_OnValidateInput * this_ptr, app::String* text, int32_t char_index, char16_t added_char, app::AsyncCallback* callback, app::Object* object))

...
namespace app::classes::UnityEngine::UI::ColorBlock {
    ...
    inline bool operator==(app::ColorBlock point1, app::ColorBlock point2) { return op_Equality(point1, point2); }
    inline bool operator!=(app::ColorBlock point1, app::ColorBlock point2) { return op_Inequality(point1, point2); }
} // namespace app::classes::UnityEngine::UI::ColorBlock

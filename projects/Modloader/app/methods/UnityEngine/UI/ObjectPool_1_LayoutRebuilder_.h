...
namespace app::classes::UnityEngine::UI::ObjectPool_1_LayoutRebuilder_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::ObjectPool_1_LayoutRebuilder_* this_ptr,
        app::UnityAction_1_UnityEngine_UI_LayoutRebuilder_* action_on_get,
        app::UnityAction_1_UnityEngine_UI_LayoutRebuilder_* action_on_release
    )

...
namespace app::classes::UnityEngine::Texture2D {
    ...
    IL2CPP_REGISTER_METHOD(0x02C66BD0, void, ctor_2, (app::Texture2D * this_ptr, int32_t width, int32_t height, app::GraphicsFormat__Enum format, app::TextureCreationFlags__Enum flags))
    IL2CPP_REGISTER_METHOD(0x02C66CC0, void, ctor_3, (app::Texture2D * this_ptr, int32_t width, int32_t height, app::TextureFormat__Enum texture_format, bool mip_chain, bool linear, void* native_tex))
    IL2CPP_REGISTER_METHOD(0x02C66DD0, void, ctor_4, (app::Texture2D * this_ptr, int32_t width, int32_t height, app::TextureFormat__Enum texture_format, bool mip_chain, bool linear))
    IL2CPP_REGISTER_METHOD(0x02C66EA0, void, ctor_5, (app::Texture2D * this_ptr, int32_t width, int32_t height, app::TextureFormat__Enum texture_format, bool mip_chain))
    ...
    IL2CPP_REGISTER_METHOD(0x02C671E0, bool, Internal_CreateImpl, (app::Texture2D * mono, int32_t w, int32_t h, app::GraphicsFormat__Enum format, app::TextureCreationFlags__Enum flags, void* native_tex))
    IL2CPP_REGISTER_METHOD(0x02C67260, void, Internal_Create, (app::Texture2D * mono, int32_t w, int32_t h, app::GraphicsFormat__Enum format, app::TextureCreationFlags__Enum flags, void* native_tex))
    ...
    IL2CPP_REGISTER_METHOD(0x02C676C0, bool, ResizeWithFormatImpl, (app::Texture2D * this_ptr, int32_t width, int32_t height, app::TextureFormat__Enum format, bool has_mip_map))
    IL2CPP_REGISTER_METHOD(0x02C67750, void, ReadPixelsImpl, (app::Texture2D * this_ptr, app::Rect source, int32_t dest_x, int32_t dest_y, bool recalculate_mip_maps))
    IL2CPP_REGISTER_METHOD(0x02C677E0, void, SetPixelsImpl, (app::Texture2D * this_ptr, int32_t x, int32_t y, int32_t w, int32_t h, app::Color__Array* pixel, int32_t miplevel, int32_t frame))
    ...
    IL2CPP_REGISTER_METHOD(0x02C67E10, void, SetBlockOfPixels32, (app::Texture2D * this_ptr, int32_t x, int32_t y, int32_t block_width, int32_t block_height, app::Color32__Array* colors, int32_t miplevel))
    IL2CPP_REGISTER_METHOD(0x02C67E90, app::Byte__Array*, GetRawTextureData, (app::Texture2D * this_ptr))
    IL2CPP_REGISTER_METHOD(0x02C67EE0, app::Color__Array*, GetPixels_1, (app::Texture2D * this_ptr, int32_t x, int32_t y, int32_t block_width, int32_t block_height, int32_t miplevel))
    IL2CPP_REGISTER_METHOD(0x02C67F60, app::Color__Array*, GetPixels_2, (app::Texture2D * this_ptr, int32_t x, int32_t y, int32_t block_width, int32_t block_height))
    ...
    IL2CPP_REGISTER_METHOD(0x02C680B0, app::Rect__Array*, PackTextures_1, (app::Texture2D * this_ptr, app::Texture2D__Array* textures, int32_t padding, int32_t maximum_atlas_size, bool make_no_longer_readable))
    IL2CPP_REGISTER_METHOD(0x02C68140, app::Rect__Array*, PackTextures_2, (app::Texture2D * this_ptr, app::Texture2D__Array* textures, int32_t padding, int32_t maximum_atlas_size))
    ...
    IL2CPP_REGISTER_METHOD(0x02C68250, app::Texture2D*, CreateExternalTexture, (int32_t width, int32_t height, app::TextureFormat__Enum format, bool mip_chain, bool linear, void* native_tex))
    IL2CPP_REGISTER_METHOD(0x02C68430, void, SetPixel, (app::Texture2D * this_ptr, int32_t x, int32_t y, app::Color color))
    IL2CPP_REGISTER_METHOD(0x02C68560, void, SetPixels_1, (app::Texture2D * this_ptr, int32_t x, int32_t y, int32_t block_width, int32_t block_height, app::Color__Array* colors, int32_t miplevel))
    IL2CPP_REGISTER_METHOD(0x02C68690, void, SetPixels_2, (app::Texture2D * this_ptr, int32_t x, int32_t y, int32_t block_width, int32_t block_height, app::Color__Array* colors))
    ...
    IL2CPP_REGISTER_METHOD(0x02C68F90, bool, Resize_2, (app::Texture2D * this_ptr, int32_t width, int32_t height, app::TextureFormat__Enum format, bool has_mip_map))
    IL2CPP_REGISTER_METHOD(0x02C690C0, void, ReadPixels_1, (app::Texture2D * this_ptr, app::Rect source, int32_t dest_x, int32_t dest_y, bool recalculate_mip_maps))
    IL2CPP_REGISTER_METHOD(0x02C691F0, void, ReadPixels_2, (app::Texture2D * this_ptr, app::Rect source, int32_t dest_x, int32_t dest_y))
    IL2CPP_REGISTER_METHOD(0x02C69220, bool, GenerateAtlas, (app::Vector2__Array * sizes, int32_t padding, int32_t atlas_size, app::List_1_UnityEngine_Rect_* results))
    ...
    IL2CPP_REGISTER_METHOD(0x02C67E10, void, SetPixels32_3, (app::Texture2D * this_ptr, int32_t x, int32_t y, int32_t block_width, int32_t block_height, app::Color32__Array* colors, int32_t miplevel))
    IL2CPP_REGISTER_METHOD(0x02C69590, void, SetPixels32_4, (app::Texture2D * this_ptr, int32_t x, int32_t y, int32_t block_width, int32_t block_height, app::Color32__Array* colors))
    ...
    IL2CPP_REGISTER_METHOD(0x02C69930, void, ReadPixelsImpl_Injected, (app::Texture2D * this_ptr, app::Rect* source, int32_t dest_x, int32_t dest_y, bool recalculate_mip_maps))
} // namespace app::classes::UnityEngine::Texture2D

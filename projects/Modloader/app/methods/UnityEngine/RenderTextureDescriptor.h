...
namespace app::classes::UnityEngine::RenderTextureDescriptor {
    ...
    IL2CPP_REGISTER_METHOD(0x00218180, void, SetOrClearRenderTextureCreationFlag, (app::RenderTextureDescriptor__Boxed * this_ptr, bool value, app::RenderTextureCreationFlags__Enum flag))

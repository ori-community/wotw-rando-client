...
namespace app::classes::UnityEngine::EventSystems::PointerInputModule_MouseState {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        GetButtonState,
        app::PointerInputModule_MouseState* this_ptr,
        app::PointerEventData_InputButton__Enum button
    )
    IL2CPP_REGISTER_METHOD(
        0x01F25EB0,
        void,
        ...
        app::PointerInputModule_MouseState* this_ptr,
        app::PointerEventData_InputButton__Enum button,
        app::PointerEventData_FramePressState__Enum state_for_mouse_button,
        app::PointerEventData* data
    )
} // namespace app::classes::UnityEngine::EventSystems::PointerInputModule_MouseState

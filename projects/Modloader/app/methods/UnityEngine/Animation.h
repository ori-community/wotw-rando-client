...
namespace app::classes::UnityEngine::Animation {
    ...
    IL2CPP_REGISTER_METHOD(0x0307A5B0, app::AnimationState*, CrossFadeQueued_1, (app::Animation * this_ptr, app::String* animation, float fade_length, app::QueueMode__Enum queue, app::PlayMode__Enum mode))
    IL2CPP_REGISTER_METHOD(0x0307A640, app::AnimationState*, CrossFadeQueued_2, (app::Animation * this_ptr, app::String* animation, float fade_length, app::QueueMode__Enum queue))
    ...
    IL2CPP_REGISTER_METHOD(0x0307A6B0, app::AnimationState*, PlayQueued_1, (app::Animation * this_ptr, app::String* animation, app::QueueMode__Enum queue, app::PlayMode__Enum mode))
    ...
    IL2CPP_REGISTER_METHOD(0x0307A800, void, AddClip_2, (app::Animation * this_ptr, app::AnimationClip* clip, app::String* new_name, int32_t first_frame, int32_t last_frame, bool add_loop_frame))
    IL2CPP_REGISTER_METHOD(0x0307A890, void, AddClip_3, (app::Animation * this_ptr, app::AnimationClip* clip, app::String* new_name, int32_t first_frame, int32_t last_frame))

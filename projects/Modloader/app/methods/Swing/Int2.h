...
namespace app::classes::Swing::Int2 {
    ...
    inline bool operator==(app::Int2 lhs, app::Int2 rhs) { return op_Equality(lhs, rhs); }
    inline bool operator!=(app::Int2 lhs, app::Int2 rhs) { return op_Inequality(lhs, rhs); }
    inline app::Int2 operator+(app::Int2 a, app::Int2 b) { return op_Addition(a, b); }
    inline app::Int2 operator-(app::Int2 a, app::Int2 b) { return op_Subtraction(a, b); }
    inline app::Int2 operator-(app::Int2 a) { return op_UnaryNegation(a); }
    inline app::Int2 operator*(app::Int2 a, int32_t d) { return op_Multiply_1(a, d); }
    inline app::Int2 operator*(int32_t d, app::Int2 a) { return op_Multiply_2(d, a); }
    inline app::Int2 operator*(app::Int2 a, app::Int2 b) { return op_Multiply_3(a, b); }
    inline app::Vector2 operator*(app::Int2 a, float d) { return op_Multiply_4(a, d); }
    inline app::Vector2 operator*(float d, app::Int2 a) { return op_Multiply_5(d, a); }
    inline app::Vector2 operator/(app::Int2 a, float d) { return op_Division_1(a, d); }
    inline app::Vector2 operator/(float f, app::Int2 d) { return op_Division_2(f, d); }
    inline app::Vector2 operator/(app::Int2 a, app::Int2 b) { return op_Division_3(a, b); }
} // namespace app::classes::Swing::Int2

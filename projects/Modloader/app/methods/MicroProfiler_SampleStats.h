...
namespace app::classes::MicroProfiler_SampleStats {
    ...
    IL2CPP_REGISTER_METHOD(0x03157280, void, SetMetric, (app::MicroProfiler_SampleStats * this_ptr, app::Metric__Enum id, int64_t ns_invoked, uint32_t invoked_count))
    IL2CPP_REGISTER_METHOD(0x031572E0, void, SetMetricValue, (app::MicroProfiler_SampleStats * this_ptr, app::Metric__Enum id, int64_t ns_invoked, uint32_t invoked_count))

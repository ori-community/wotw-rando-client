...
namespace app::classes::types {
    namespace LightCanvas_LightCanvasStateData {
        inline app::LightCanvas_LightCanvasStateData__Class** type_info() {
            static app::LightCanvas_LightCanvasStateData__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::LightCanvas_LightCanvasStateData__Class**)(modloader::win::memory::resolve_rva(0x04780618));
            }
            return cache;
        }

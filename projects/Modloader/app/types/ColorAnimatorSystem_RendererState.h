...
namespace app::classes::types {
    namespace ColorAnimatorSystem_RendererState {
        inline app::ColorAnimatorSystem_RendererState__Class** type_info = (app::ColorAnimatorSystem_RendererState__Class**)(modloader::win::memory::resolve_rva(0x047424F8));

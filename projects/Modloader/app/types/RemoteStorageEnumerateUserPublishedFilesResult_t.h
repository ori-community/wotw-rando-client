...
namespace app::classes::types {
    namespace RemoteStorageEnumerateUserPublishedFilesResult_t {
        namespace {
            inline app::RemoteStorageEnumerateUserPublishedFilesResult_t__Class* type_info_ref = nullptr;
        }
        inline app::RemoteStorageEnumerateUserPublishedFilesResult_t__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace KeyValuePair_2_AbilityType_Moon_uberSerializationWisp_PlayerUberStateAbilities_Ability___Array {
        namespace {
            inline app::KeyValuePair_2_AbilityType_Moon_uberSerializationWisp_PlayerUberStateAbilities_Ability___Array__Class* type_info_ref = nullptr;
        }
        inline app::KeyValuePair_2_AbilityType_Moon_uberSerializationWisp_PlayerUberStateAbilities_Ability___Array__Class** type_info = &type_info_ref;

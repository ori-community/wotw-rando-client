...
namespace app::classes::types {
    namespace LoadingBoostController_BoostModeSettings {
        inline app::LoadingBoostController_BoostModeSettings__Class** type_info() {
            static app::LoadingBoostController_BoostModeSettings__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::LoadingBoostController_BoostModeSettings__Class**)(modloader::win::memory::resolve_rva(0x047109B8));
            }
            return cache;
        }

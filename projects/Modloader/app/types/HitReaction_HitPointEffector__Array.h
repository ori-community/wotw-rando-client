...
namespace app::classes::types {
    namespace HitReaction_HitPointEffector__Array {
        namespace {
            inline app::HitReaction_HitPointEffector__Array__Class* type_info_ref = nullptr;
        }
        inline app::HitReaction_HitPointEffector__Array__Class** type_info = &type_info_ref;

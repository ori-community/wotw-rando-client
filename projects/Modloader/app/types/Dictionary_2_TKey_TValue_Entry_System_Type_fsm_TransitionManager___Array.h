...
namespace app::classes::types {
    namespace Dictionary_2_TKey_TValue_Entry_System_Type_fsm_TransitionManager___Array {
        namespace {
            inline app::Dictionary_2_TKey_TValue_Entry_System_Type_fsm_TransitionManager___Array__Class* type_info_ref = nullptr;
        }
        inline app::Dictionary_2_TKey_TValue_Entry_System_Type_fsm_TransitionManager___Array__Class** type_info = &type_info_ref;

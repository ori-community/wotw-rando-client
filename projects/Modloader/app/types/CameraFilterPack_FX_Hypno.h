...
namespace app::classes::types {
    namespace CameraFilterPack_FX_Hypno {
        inline app::CameraFilterPack_FX_Hypno__Class** type_info() {
            static app::CameraFilterPack_FX_Hypno__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::CameraFilterPack_FX_Hypno__Class**)(modloader::win::memory::resolve_rva(0x04796248));
            }
            return cache;
        }

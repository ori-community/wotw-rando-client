...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_Vision_Tunnel {
        inline app::ShaderID_CameraFilterPack_Vision_Tunnel__Class** type_info() {
            static app::ShaderID_CameraFilterPack_Vision_Tunnel__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ShaderID_CameraFilterPack_Vision_Tunnel__Class**)(modloader::win::memory::resolve_rva(0x04733C88));
            }
            return cache;
        }

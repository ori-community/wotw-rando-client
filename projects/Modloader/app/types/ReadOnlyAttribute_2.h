...
namespace app::classes::types {
    namespace ReadOnlyAttribute_2 {
        inline app::ReadOnlyAttribute_2__Class** type_info() {
            static app::ReadOnlyAttribute_2__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::ReadOnlyAttribute_2__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace NotEqualInstruction_NotEqualInt16 {
        inline app::NotEqualInstruction_NotEqualInt16__Class** type_info() {
            static app::NotEqualInstruction_NotEqualInt16__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::NotEqualInstruction_NotEqualInt16__Class**)(modloader::win::memory::resolve_rva(0x0470DBE0));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace KwolokBossDeathReactionBehaviour_State__Enum {
        namespace {
            inline app::KwolokBossDeathReactionBehaviour_State__Enum__Class* type_info_ref = nullptr;
        }
        inline app::KwolokBossDeathReactionBehaviour_State__Enum__Class** type_info = &type_info_ref;

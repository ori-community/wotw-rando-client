...
#include <Modloader/app/structs/Dictionary_2_TKey_TValue_Entry_System_Type_List_1_DynamicInstantiationDescriptor_ReflectionInfo___Array__Class.h>
#include <Modloader/app/structs/Dictionary_2_TKey_TValue_Entry_System_Type_List_1_DynamicInstantiationDescriptor_ReflectionInfo___Array.h>

namespace app::classes::types {
    namespace Dictionary_2_TKey_TValue_Entry_System_Type_List_1_DynamicInstantiationDescriptor_ReflectionInfo___Array {
        namespace {
            inline app::Dictionary_2_TKey_TValue_Entry_System_Type_List_1_DynamicInstantiationDescriptor_ReflectionInfo___Array__Class* type_info_ref = nullptr;
        }
        inline app::Dictionary_2_TKey_TValue_Entry_System_Type_List_1_DynamicInstantiationDescriptor_ReflectionInfo___Array__Class** type_info = &type_info_ref;

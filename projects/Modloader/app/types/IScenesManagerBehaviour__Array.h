...
namespace app::classes::types {
    namespace IScenesManagerBehaviour__Array {
        inline app::IScenesManagerBehaviour__Array__Class** type_info() {
            static app::IScenesManagerBehaviour__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::IScenesManagerBehaviour__Array__Class**)(modloader::win::memory::resolve_rva(0x04794178));
            }
            return cache;
        }

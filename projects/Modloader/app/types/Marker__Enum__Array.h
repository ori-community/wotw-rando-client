...
namespace app::classes::types {
    namespace Marker__Enum__Array {
        inline app::Marker__Enum__Array__Class** type_info() {
            static app::Marker__Enum__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::Marker__Enum__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace SeinBowMark_State__Enum {
        inline app::SeinBowMark_State__Enum__Class** type_info() {
            static app::SeinBowMark_State__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SeinBowMark_State__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

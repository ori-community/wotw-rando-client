...
namespace app::classes::types {
    namespace SDK_c_DisplayClass13_0 {
        inline app::SDK_c_DisplayClass13_0__Class** type_info() {
            static app::SDK_c_DisplayClass13_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::SDK_c_DisplayClass13_0__Class**)(modloader::win::memory::resolve_rva(0x0471CE68));
            }
            return cache;
        }

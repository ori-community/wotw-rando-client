...
namespace app::classes::types {
    namespace SceneLayers_Layer__Array {
        inline app::SceneLayers_Layer__Array__Class** type_info() {
            static app::SceneLayers_Layer__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::SceneLayers_Layer__Array__Class**)(modloader::win::memory::resolve_rva(0x04777E58));
            }
            return cache;
        }

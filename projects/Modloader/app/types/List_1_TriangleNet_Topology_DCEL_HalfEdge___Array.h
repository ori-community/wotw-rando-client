...
namespace app::classes::types {
    namespace List_1_TriangleNet_Topology_DCEL_HalfEdge___Array {
        inline app::List_1_TriangleNet_Topology_DCEL_HalfEdge___Array__Class** type_info() {
            static app::List_1_TriangleNet_Topology_DCEL_HalfEdge___Array__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::List_1_TriangleNet_Topology_DCEL_HalfEdge___Array__Class**)(modloader::win::memory::resolve_rva(0x04713710));
            }
            return cache;
        }

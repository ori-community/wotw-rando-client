...
#include <Modloader/app/structs/Dictionary_2_TKey_TValue_Entry_System_Object_TextureAnimation_AnimationTextureInfo___Array__Class.h>
...
namespace app::classes::types {
    namespace Dictionary_2_TKey_TValue_Entry_System_Object_TextureAnimation_AnimationTextureInfo___Array {
        namespace {
            inline app::Dictionary_2_TKey_TValue_Entry_System_Object_TextureAnimation_AnimationTextureInfo___Array__Class* type_info_ref = nullptr;
        }
        inline app::Dictionary_2_TKey_TValue_Entry_System_Object_TextureAnimation_AnimationTextureInfo___Array__Class** type_info = &type_info_ref;

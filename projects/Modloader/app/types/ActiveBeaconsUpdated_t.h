...
#include <Modloader/app/structs/ActiveBeaconsUpdated_t__Boxed.h>
...
namespace app::classes::types {
    namespace ActiveBeaconsUpdated_t {
        inline app::ActiveBeaconsUpdated_t__Class** type_info() {
            static app::ActiveBeaconsUpdated_t__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::ActiveBeaconsUpdated_t__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

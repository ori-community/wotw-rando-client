...
namespace app::classes::types {
    namespace WebConnectionStream_c_DisplayClass75_0 {
        inline app::WebConnectionStream_c_DisplayClass75_0__Class** type_info() {
            static app::WebConnectionStream_c_DisplayClass75_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::WebConnectionStream_c_DisplayClass75_0__Class**)(modloader::win::memory::resolve_rva(0x0470C138));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace GZipStream_2 {
        inline app::GZipStream_2__Class** type_info() {
            static app::GZipStream_2__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::GZipStream_2__Class**)(modloader::win::memory::resolve_rva(0x0478F710));
            }
            return cache;
        }

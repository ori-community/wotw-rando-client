...
namespace app::classes::types {
    namespace BlackboardVariableFloat__Array {
        inline app::BlackboardVariableFloat__Array__Class** type_info() {
            static app::BlackboardVariableFloat__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::BlackboardVariableFloat__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

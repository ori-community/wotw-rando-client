...
namespace app::classes::types {
    namespace SandWormLocomotion_SpeedSetting__Enum {
        namespace {
            inline app::SandWormLocomotion_SpeedSetting__Enum__Class* type_info_ref = nullptr;
        }
        inline app::SandWormLocomotion_SpeedSetting__Enum__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace KwolokBossUnderwaterPullBehaviour_State__Enum {
        inline app::KwolokBossUnderwaterPullBehaviour_State__Enum__Class** type_info() {
            static app::KwolokBossUnderwaterPullBehaviour_State__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::KwolokBossUnderwaterPullBehaviour_State__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

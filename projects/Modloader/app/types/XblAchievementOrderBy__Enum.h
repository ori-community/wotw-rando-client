...
namespace app::classes::types {
    namespace XblAchievementOrderBy__Enum {
        inline app::XblAchievementOrderBy__Enum__Class** type_info() {
            static app::XblAchievementOrderBy__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::XblAchievementOrderBy__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace SpiderBossAttackCallMinions_State__Enum {
        namespace {
            inline app::SpiderBossAttackCallMinions_State__Enum__Class* type_info_ref = nullptr;
        }
        inline app::SpiderBossAttackCallMinions_State__Enum__Class** type_info = &type_info_ref;

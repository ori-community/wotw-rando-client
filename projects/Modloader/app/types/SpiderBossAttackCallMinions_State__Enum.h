...
namespace app::classes::types {
    namespace SpiderBossAttackCallMinions_State__Enum {
        inline app::SpiderBossAttackCallMinions_State__Enum__Class** type_info() {
            static app::SpiderBossAttackCallMinions_State__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SpiderBossAttackCallMinions_State__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

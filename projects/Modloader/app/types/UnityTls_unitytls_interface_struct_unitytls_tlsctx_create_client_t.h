...
#include <Modloader/app/structs/UnityTls_unitytls_interface_struct_unitytls_tlsctx_create_client_t__Class.h>
#include <Modloader/il2cpp_helpers.h>
#include <Modloader/macros.h>

namespace app::classes::types {
    namespace UnityTls_unitytls_interface_struct_unitytls_tlsctx_create_client_t {
        inline app::UnityTls_unitytls_interface_struct_unitytls_tlsctx_create_client_t__Class** type_info() {
            static app::UnityTls_unitytls_interface_struct_unitytls_tlsctx_create_client_t__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::UnityTls_unitytls_interface_struct_unitytls_tlsctx_create_client_t__Class**)(modloader::win::memory::resolve_rva(0x04714988));
            }
            return cache;
        }

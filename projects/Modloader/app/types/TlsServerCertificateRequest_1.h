...
namespace app::classes::types {
    namespace TlsServerCertificateRequest_1 {
        inline app::TlsServerCertificateRequest_1__Class** type_info() {
            static app::TlsServerCertificateRequest_1__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::TlsServerCertificateRequest_1__Class**)(modloader::win::memory::resolve_rva(0x04732110));
            }
            return cache;
        }

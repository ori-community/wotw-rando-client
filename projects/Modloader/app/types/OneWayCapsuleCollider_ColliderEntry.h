...
namespace app::classes::types {
    namespace OneWayCapsuleCollider_ColliderEntry {
        inline app::OneWayCapsuleCollider_ColliderEntry__Class** type_info() {
            static app::OneWayCapsuleCollider_ColliderEntry__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::OneWayCapsuleCollider_ColliderEntry__Class**)(modloader::win::memory::resolve_rva(0x04717948));
            }
            return cache;
        }

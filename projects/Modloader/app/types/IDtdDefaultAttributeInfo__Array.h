...
namespace app::classes::types {
    namespace IDtdDefaultAttributeInfo__Array {
        inline app::IDtdDefaultAttributeInfo__Array__Class** type_info() {
            static app::IDtdDefaultAttributeInfo__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::IDtdDefaultAttributeInfo__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

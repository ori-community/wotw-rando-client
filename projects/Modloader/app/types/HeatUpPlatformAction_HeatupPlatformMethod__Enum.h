...
namespace app::classes::types {
    namespace HeatUpPlatformAction_HeatupPlatformMethod__Enum {
        namespace {
            inline app::HeatUpPlatformAction_HeatupPlatformMethod__Enum__Class* type_info_ref = nullptr;
        }
        inline app::HeatUpPlatformAction_HeatupPlatformMethod__Enum__Class** type_info = &type_info_ref;

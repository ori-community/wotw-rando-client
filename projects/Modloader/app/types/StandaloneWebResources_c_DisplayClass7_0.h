...
namespace app::classes::types {
    namespace StandaloneWebResources_c_DisplayClass7_0 {
        inline app::StandaloneWebResources_c_DisplayClass7_0__Class** type_info() {
            static app::StandaloneWebResources_c_DisplayClass7_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::StandaloneWebResources_c_DisplayClass7_0__Class**)(modloader::win::memory::resolve_rva(0x04786FA8));
            }
            return cache;
        }

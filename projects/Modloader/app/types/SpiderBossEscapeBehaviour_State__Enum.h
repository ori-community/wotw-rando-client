...
namespace app::classes::types {
    namespace SpiderBossEscapeBehaviour_State__Enum {
        inline app::SpiderBossEscapeBehaviour_State__Enum__Class** type_info() {
            static app::SpiderBossEscapeBehaviour_State__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SpiderBossEscapeBehaviour_State__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace SpiderBossEscapeBehaviour_State__Enum {
        namespace {
            inline app::SpiderBossEscapeBehaviour_State__Enum__Class* type_info_ref = nullptr;
        }
        inline app::SpiderBossEscapeBehaviour_State__Enum__Class** type_info = &type_info_ref;

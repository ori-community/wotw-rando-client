...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_Light_Rainbow {
        inline app::ShaderID_CameraFilterPack_Light_Rainbow__Class** type_info = (app::ShaderID_CameraFilterPack_Light_Rainbow__Class**)(modloader::win::memory::resolve_rva(0x047246F8));

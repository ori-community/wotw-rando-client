...
namespace app::classes::types {
    namespace UnityTls_unitytls_interface_struct_unitytls_key_parse_der_t {
        inline app::UnityTls_unitytls_interface_struct_unitytls_key_parse_der_t__Class** type_info() {
            static app::UnityTls_unitytls_interface_struct_unitytls_key_parse_der_t__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::UnityTls_unitytls_interface_struct_unitytls_key_parse_der_t__Class**)(modloader::win::memory::resolve_rva(0x04789380));
            }
            return cache;
        }

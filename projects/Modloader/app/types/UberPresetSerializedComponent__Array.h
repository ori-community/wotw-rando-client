...
namespace app::classes::types {
    namespace UberPresetSerializedComponent__Array {
        namespace {
            inline app::UberPresetSerializedComponent__Array__Class* type_info_ref = nullptr;
        }
        inline app::UberPresetSerializedComponent__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace CollisionEventHandler__Array {
        inline app::CollisionEventHandler__Array__Class** type_info() {
            static app::CollisionEventHandler__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::CollisionEventHandler__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace P3D_TexturePreview__Array {
        inline app::P3D_TexturePreview__Array__Class** type_info() {
            static app::P3D_TexturePreview__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::P3D_TexturePreview__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

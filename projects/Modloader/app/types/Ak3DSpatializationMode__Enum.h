...
namespace app::classes::types {
    namespace Ak3DSpatializationMode__Enum {
        inline app::Ak3DSpatializationMode__Enum__Class** type_info() {
            static app::Ak3DSpatializationMode__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::Ak3DSpatializationMode__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

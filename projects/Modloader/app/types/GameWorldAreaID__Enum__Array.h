...
namespace app::classes::types {
    namespace GameWorldAreaID__Enum__Array {
        inline app::GameWorldAreaID__Enum__Array__Class** type_info() {
            static app::GameWorldAreaID__Enum__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::GameWorldAreaID__Enum__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

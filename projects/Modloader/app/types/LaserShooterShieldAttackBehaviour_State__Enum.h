...
namespace app::classes::types {
    namespace LaserShooterShieldAttackBehaviour_State__Enum {
        namespace {
            inline app::LaserShooterShieldAttackBehaviour_State__Enum__Class* type_info_ref = nullptr;
        }
        inline app::LaserShooterShieldAttackBehaviour_State__Enum__Class** type_info = &type_info_ref;

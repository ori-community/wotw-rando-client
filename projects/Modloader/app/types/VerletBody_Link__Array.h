...
namespace app::classes::types {
    namespace VerletBody_Link__Array {
        inline app::VerletBody_Link__Array__Class** type_info() {
            static app::VerletBody_Link__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::VerletBody_Link__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

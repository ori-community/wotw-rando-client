...
#include <Modloader/app/structs/KeyValuePair_2_SpiritShardType_Moon_uberSerializationWisp_PlayerUberStateShards_Shard___Array__Class.h>
#include <Modloader/app/structs/KeyValuePair_2_SpiritShardType_Moon_uberSerializationWisp_PlayerUberStateShards_Shard___Array.h>

namespace app::classes::types {
    namespace KeyValuePair_2_SpiritShardType_Moon_uberSerializationWisp_PlayerUberStateShards_Shard___Array {
        namespace {
            inline app::KeyValuePair_2_SpiritShardType_Moon_uberSerializationWisp_PlayerUberStateShards_Shard___Array__Class* type_info_ref = nullptr;
        }
        inline app::KeyValuePair_2_SpiritShardType_Moon_uberSerializationWisp_PlayerUberStateShards_Shard___Array__Class** type_info = &type_info_ref;

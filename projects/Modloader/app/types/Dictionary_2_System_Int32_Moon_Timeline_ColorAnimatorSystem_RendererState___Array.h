...
namespace app::classes::types {
    namespace Dictionary_2_System_Int32_Moon_Timeline_ColorAnimatorSystem_RendererState___Array {
        inline app::Dictionary_2_System_Int32_Moon_Timeline_ColorAnimatorSystem_RendererState___Array__Class** type_info = (app::Dictionary_2_System_Int32_Moon_Timeline_ColorAnimatorSystem_RendererState___Array__Class**)(modloader::win::memory::resolve_rva(0x04792FC8));

...
namespace app::classes::types {
    namespace GhostWorldObjectsLifetimePlugin_WorldRecordableEventsData {
        inline app::GhostWorldObjectsLifetimePlugin_WorldRecordableEventsData__Class** type_info = (app::GhostWorldObjectsLifetimePlugin_WorldRecordableEventsData__Class**)(modloader::win::memory::resolve_rva(0x04725720));

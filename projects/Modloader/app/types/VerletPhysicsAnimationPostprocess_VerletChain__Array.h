...
namespace app::classes::types {
    namespace VerletPhysicsAnimationPostprocess_VerletChain__Array {
        inline app::VerletPhysicsAnimationPostprocess_VerletChain__Array__Class** type_info() {
            static app::VerletPhysicsAnimationPostprocess_VerletChain__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::VerletPhysicsAnimationPostprocess_VerletChain__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

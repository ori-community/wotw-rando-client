...
namespace app::classes::types {
    namespace LaserShieldPieceProjectile_Mode__Enum {
        namespace {
            inline app::LaserShieldPieceProjectile_Mode__Enum__Class* type_info_ref = nullptr;
        }
        inline app::LaserShieldPieceProjectile_Mode__Enum__Class** type_info = &type_info_ref;

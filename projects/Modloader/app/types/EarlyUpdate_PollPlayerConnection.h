...
namespace app::classes::types {
    namespace EarlyUpdate_PollPlayerConnection {
        inline app::EarlyUpdate_PollPlayerConnection__Class** type_info() {
            static app::EarlyUpdate_PollPlayerConnection__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::EarlyUpdate_PollPlayerConnection__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

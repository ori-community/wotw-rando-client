...
#include <Modloader/app/structs/ProfilingSettings_SettingType__Enum__Array__Array__Class.h>
#include <Modloader/il2cpp_helpers.h>
#include <Modloader/macros.h>

namespace app::classes::types {
    namespace ProfilingSettings_SettingType__Enum__Array__Array {
        inline app::ProfilingSettings_SettingType__Enum__Array__Array__Class** type_info() {
            static app::ProfilingSettings_SettingType__Enum__Array__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ProfilingSettings_SettingType__Enum__Array__Array__Class**)(modloader::win::memory::resolve_rva(0x0476FC60));
            }
            return cache;
        }

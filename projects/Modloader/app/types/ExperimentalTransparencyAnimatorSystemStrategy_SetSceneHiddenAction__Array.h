...
namespace app::classes::types {
    namespace ExperimentalTransparencyAnimatorSystemStrategy_SetSceneHiddenAction__Array {
        namespace {
            inline app::ExperimentalTransparencyAnimatorSystemStrategy_SetSceneHiddenAction__Array__Class* type_info_ref = nullptr;
        }
        inline app::ExperimentalTransparencyAnimatorSystemStrategy_SetSceneHiddenAction__Array__Class** type_info = &type_info_ref;

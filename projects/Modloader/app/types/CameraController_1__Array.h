...
namespace app::classes::types {
    namespace CameraController_1__Array {
        inline app::CameraController_1__Array__Class** type_info() {
            static app::CameraController_1__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::CameraController_1__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace IDebugRendererSubscriber__Array {
        inline app::IDebugRendererSubscriber__Array__Class** type_info() {
            static app::IDebugRendererSubscriber__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::IDebugRendererSubscriber__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

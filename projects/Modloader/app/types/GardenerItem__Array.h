...
namespace app::classes::types {
    namespace GardenerItem__Array {
        inline app::GardenerItem__Array__Class** type_info() {
            static app::GardenerItem__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::GardenerItem__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace SceneMetaData_SceneSavePedestal__Array {
        namespace {
            inline app::SceneMetaData_SceneSavePedestal__Array__Class* type_info_ref = nullptr;
        }
        inline app::SceneMetaData_SceneSavePedestal__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace SceneMetaData_SceneSavePedestal__Array {
        inline app::SceneMetaData_SceneSavePedestal__Array__Class** type_info() {
            static app::SceneMetaData_SceneSavePedestal__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SceneMetaData_SceneSavePedestal__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

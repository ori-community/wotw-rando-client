...
namespace app::classes::types {
    namespace MoonTelemetryCharacterBaseEvent_SpiritShardData {
        namespace {
            inline app::MoonTelemetryCharacterBaseEvent_SpiritShardData__Class* type_info_ref = nullptr;
        }
        inline app::MoonTelemetryCharacterBaseEvent_SpiritShardData__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace _PrivateImplementationDetails_StaticArrayInitTypeSize_14 {
        inline app::_PrivateImplementationDetails_StaticArrayInitTypeSize_14__Class** type_info() {
            static app::_PrivateImplementationDetails_StaticArrayInitTypeSize_14__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::_PrivateImplementationDetails_StaticArrayInitTypeSize_14__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

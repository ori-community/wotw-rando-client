...
namespace app::classes::types {
    namespace CameraFilterPack_Distortion_Dream2 {
        inline app::CameraFilterPack_Distortion_Dream2__Class** type_info() {
            static app::CameraFilterPack_Distortion_Dream2__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::CameraFilterPack_Distortion_Dream2__Class**)(modloader::win::memory::resolve_rva(0x04756BE8));
            }
            return cache;
        }

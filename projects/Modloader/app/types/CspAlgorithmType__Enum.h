...
namespace app::classes::types {
    namespace CspAlgorithmType__Enum {
        inline app::CspAlgorithmType__Enum__Class** type_info() {
            static app::CspAlgorithmType__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::CspAlgorithmType__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

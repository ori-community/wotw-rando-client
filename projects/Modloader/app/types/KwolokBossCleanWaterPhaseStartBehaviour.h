...
namespace app::classes::types {
    namespace KwolokBossCleanWaterPhaseStartBehaviour {
        namespace {
            inline app::KwolokBossCleanWaterPhaseStartBehaviour__Class* type_info_ref = nullptr;
        }
        inline app::KwolokBossCleanWaterPhaseStartBehaviour__Class** type_info = &type_info_ref;

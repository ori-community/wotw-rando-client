...
namespace app::classes::types {
    namespace AkCommonOutputSettings_ChannelConfiguration_ChannelConfigType__Enum {
        namespace {
            inline app::AkCommonOutputSettings_ChannelConfiguration_ChannelConfigType__Enum__Class* type_info_ref = nullptr;
        }
        inline app::AkCommonOutputSettings_ChannelConfiguration_ChannelConfigType__Enum__Class** type_info = &type_info_ref;

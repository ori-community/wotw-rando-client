...
namespace app::classes::types {
    namespace MoonIconRenderer_c_1 {
        inline app::MoonIconRenderer_c_1__Class** type_info() {
            static app::MoonIconRenderer_c_1__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::MoonIconRenderer_c_1__Class**)(modloader::win::memory::resolve_rva(0x0477D538));
            }
            return cache;
        }

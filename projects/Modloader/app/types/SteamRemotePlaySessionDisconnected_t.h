...
namespace app::classes::types {
    namespace SteamRemotePlaySessionDisconnected_t {
        namespace {
            inline app::SteamRemotePlaySessionDisconnected_t__Class* type_info_ref = nullptr;
        }
        inline app::SteamRemotePlaySessionDisconnected_t__Class** type_info = &type_info_ref;

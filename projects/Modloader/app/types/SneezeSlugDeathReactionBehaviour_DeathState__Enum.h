...
namespace app::classes::types {
    namespace SneezeSlugDeathReactionBehaviour_DeathState__Enum {
        namespace {
            inline app::SneezeSlugDeathReactionBehaviour_DeathState__Enum__Class* type_info_ref = nullptr;
        }
        inline app::SneezeSlugDeathReactionBehaviour_DeathState__Enum__Class** type_info = &type_info_ref;

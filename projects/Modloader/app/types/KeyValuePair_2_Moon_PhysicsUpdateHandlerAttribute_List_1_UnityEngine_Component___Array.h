...
#include <Modloader/app/structs/KeyValuePair_2_Moon_PhysicsUpdateHandlerAttribute_List_1_UnityEngine_Component___Array__Class.h>
...
namespace app::classes::types {
    namespace KeyValuePair_2_Moon_PhysicsUpdateHandlerAttribute_List_1_UnityEngine_Component___Array {
        namespace {
            inline app::KeyValuePair_2_Moon_PhysicsUpdateHandlerAttribute_List_1_UnityEngine_Component___Array__Class* type_info_ref = nullptr;
        }
        inline app::KeyValuePair_2_Moon_PhysicsUpdateHandlerAttribute_List_1_UnityEngine_Component___Array__Class** type_info = &type_info_ref;

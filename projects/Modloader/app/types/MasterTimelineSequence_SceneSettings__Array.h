...
namespace app::classes::types {
    namespace MasterTimelineSequence_SceneSettings__Array {
        inline app::MasterTimelineSequence_SceneSettings__Array__Class** type_info() {
            static app::MasterTimelineSequence_SceneSettings__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::MasterTimelineSequence_SceneSettings__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

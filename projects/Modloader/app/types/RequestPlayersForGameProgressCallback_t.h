...
namespace app::classes::types {
    namespace RequestPlayersForGameProgressCallback_t {
        namespace {
            inline app::RequestPlayersForGameProgressCallback_t__Class* type_info_ref = nullptr;
        }
        inline app::RequestPlayersForGameProgressCallback_t__Class** type_info = &type_info_ref;

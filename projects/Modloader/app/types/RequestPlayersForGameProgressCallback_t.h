...
namespace app::classes::types {
    namespace RequestPlayersForGameProgressCallback_t {
        inline app::RequestPlayersForGameProgressCallback_t__Class** type_info() {
            static app::RequestPlayersForGameProgressCallback_t__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::RequestPlayersForGameProgressCallback_t__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

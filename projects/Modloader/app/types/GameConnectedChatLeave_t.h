...
namespace app::classes::types {
    namespace GameConnectedChatLeave_t {
        inline app::GameConnectedChatLeave_t__Class** type_info() {
            static app::GameConnectedChatLeave_t__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::GameConnectedChatLeave_t__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

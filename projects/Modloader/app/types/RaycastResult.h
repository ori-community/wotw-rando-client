...
namespace app::classes::types {
    namespace RaycastResult {
        inline app::RaycastResult__Class** type_info() {
            static app::RaycastResult__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::RaycastResult__Class**)(modloader::win::memory::resolve_rva(0x0471CED8));
            }
            return cache;
        }

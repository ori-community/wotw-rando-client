...
namespace app::classes::types {
    namespace ReflectionUtils_1 {
        inline app::ReflectionUtils_1__Class** type_info() {
            static app::ReflectionUtils_1__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ReflectionUtils_1__Class**)(modloader::win::memory::resolve_rva(0x0475B630));
            }
            return cache;
        }

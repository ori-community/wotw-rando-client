...
namespace app::classes::types {
    namespace UberAtlasPrefabAreas {
        inline app::UberAtlasPrefabAreas__Class** type_info() {
            static app::UberAtlasPrefabAreas__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::UberAtlasPrefabAreas__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

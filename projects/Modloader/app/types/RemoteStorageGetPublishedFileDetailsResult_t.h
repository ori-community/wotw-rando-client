...
namespace app::classes::types {
    namespace RemoteStorageGetPublishedFileDetailsResult_t {
        namespace {
            inline app::RemoteStorageGetPublishedFileDetailsResult_t__Class* type_info_ref = nullptr;
        }
        inline app::RemoteStorageGetPublishedFileDetailsResult_t__Class** type_info = &type_info_ref;

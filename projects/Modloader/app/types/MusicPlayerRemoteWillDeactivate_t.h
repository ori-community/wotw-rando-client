...
namespace app::classes::types {
    namespace MusicPlayerRemoteWillDeactivate_t {
        inline app::MusicPlayerRemoteWillDeactivate_t__Class** type_info() {
            static app::MusicPlayerRemoteWillDeactivate_t__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::MusicPlayerRemoteWillDeactivate_t__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

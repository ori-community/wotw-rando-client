...
namespace app::classes::types {
    namespace GhostWorldObjectsLifetimePlugin_RecordableTrackingEntry__Array {
        inline app::GhostWorldObjectsLifetimePlugin_RecordableTrackingEntry__Array__Class** type_info() {
            static app::GhostWorldObjectsLifetimePlugin_RecordableTrackingEntry__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::GhostWorldObjectsLifetimePlugin_RecordableTrackingEntry__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace ParticleSystemSimulationSpace__Enum {
        namespace {
            inline app::ParticleSystemSimulationSpace__Enum__Class* type_info_ref = nullptr;
        }
        inline app::ParticleSystemSimulationSpace__Enum__Class** type_info = &type_info_ref;

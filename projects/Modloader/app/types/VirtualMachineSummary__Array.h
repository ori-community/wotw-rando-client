...
namespace app::classes::types {
    namespace VirtualMachineSummary__Array {
        inline app::VirtualMachineSummary__Array__Class** type_info() {
            static app::VirtualMachineSummary__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::VirtualMachineSummary__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

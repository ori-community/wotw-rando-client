...
namespace app::classes::types {
    namespace HornBugDeathReaction_State__Enum {
        inline app::HornBugDeathReaction_State__Enum__Class** type_info() {
            static app::HornBugDeathReaction_State__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::HornBugDeathReaction_State__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

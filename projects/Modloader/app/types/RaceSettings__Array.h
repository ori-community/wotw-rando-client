...
namespace app::classes::types {
    namespace RaceSettings__Array {
        inline app::RaceSettings__Array__Class** type_info() {
            static app::RaceSettings__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::RaceSettings__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

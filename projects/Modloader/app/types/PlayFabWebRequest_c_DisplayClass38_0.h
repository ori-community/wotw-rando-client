...
namespace app::classes::types {
    namespace PlayFabWebRequest_c_DisplayClass38_0 {
        inline app::PlayFabWebRequest_c_DisplayClass38_0__Class** type_info() {
            static app::PlayFabWebRequest_c_DisplayClass38_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::PlayFabWebRequest_c_DisplayClass38_0__Class**)(modloader::win::memory::resolve_rva(0x0472A500));
            }
            return cache;
        }

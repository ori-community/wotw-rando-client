...
namespace app::classes::types {
    namespace UberShaderAnimatorStrategyStandard_UberShaderAnimation_1_UnityEngine_Color___Array {
        namespace {
            inline app::UberShaderAnimatorStrategyStandard_UberShaderAnimation_1_UnityEngine_Color___Array__Class* type_info_ref = nullptr;
        }
        inline app::UberShaderAnimatorStrategyStandard_UberShaderAnimation_1_UnityEngine_Color___Array__Class** type_info = &type_info_ref;

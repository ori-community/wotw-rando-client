...
namespace app::classes::types {
    namespace BrowserNative_DisplayDialogFunc {
        inline app::BrowserNative_DisplayDialogFunc__Class** type_info() {
            static app::BrowserNative_DisplayDialogFunc__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::BrowserNative_DisplayDialogFunc__Class**)(modloader::win::memory::resolve_rva(0x0471A448));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace PhraseRecognitionSystem_ErrorDelegate {
        namespace {
            inline app::PhraseRecognitionSystem_ErrorDelegate__Class* type_info_ref = nullptr;
        }
        inline app::PhraseRecognitionSystem_ErrorDelegate__Class** type_info = &type_info_ref;

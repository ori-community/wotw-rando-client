...
namespace app::classes::types {
    namespace MoonRenderPipelineAsset_FrameBufferFormat__Enum {
        namespace {
            inline app::MoonRenderPipelineAsset_FrameBufferFormat__Enum__Class* type_info_ref = nullptr;
        }
        inline app::MoonRenderPipelineAsset_FrameBufferFormat__Enum__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace SpellPickupPlaceholder {
        inline app::SpellPickupPlaceholder__Class** type_info() {
            static app::SpellPickupPlaceholder__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SpellPickupPlaceholder__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace SpellUIEquipScreen_c_DisplayClass85_0 {
        inline app::SpellUIEquipScreen_c_DisplayClass85_0__Class** type_info() {
            static app::SpellUIEquipScreen_c_DisplayClass85_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::SpellUIEquipScreen_c_DisplayClass85_0__Class**)(modloader::win::memory::resolve_rva(0x0473F3A0));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace UberInteractionManager_ActorInfo__Array {
        inline app::UberInteractionManager_ActorInfo__Array__Class** type_info() {
            static app::UberInteractionManager_ActorInfo__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::UberInteractionManager_ActorInfo__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

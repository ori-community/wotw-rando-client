...
namespace app::classes::types {
    namespace Button_OnFinishSubmit_c_Iterator0 {
        inline app::Button_OnFinishSubmit_c_Iterator0__Class** type_info() {
            static app::Button_OnFinishSubmit_c_Iterator0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::Button_OnFinishSubmit_c_Iterator0__Class**)(modloader::win::memory::resolve_rva(0x0471CD38));
            }
            return cache;
        }

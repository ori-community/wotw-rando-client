...
namespace app::classes::types {
    namespace BashAttackCritical_State__Enum {
        inline app::BashAttackCritical_State__Enum__Class** type_info() {
            static app::BashAttackCritical_State__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::BashAttackCritical_State__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

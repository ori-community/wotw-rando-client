...
namespace app::classes::types {
    namespace JsonSerializerInternalReader_PropertyPresence__Enum {
        namespace {
            inline app::JsonSerializerInternalReader_PropertyPresence__Enum__Class* type_info_ref = nullptr;
        }
        inline app::JsonSerializerInternalReader_PropertyPresence__Enum__Class** type_info = &type_info_ref;

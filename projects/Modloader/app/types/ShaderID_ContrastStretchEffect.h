...
namespace app::classes::types {
    namespace ShaderID_ContrastStretchEffect {
        inline app::ShaderID_ContrastStretchEffect__Class** type_info() {
            static app::ShaderID_ContrastStretchEffect__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ShaderID_ContrastStretchEffect__Class**)(modloader::win::memory::resolve_rva(0x04788810));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace TorchInsideZoneChecker_FlameColorType__Enum {
        namespace {
            inline app::TorchInsideZoneChecker_FlameColorType__Enum__Class* type_info_ref = nullptr;
        }
        inline app::TorchInsideZoneChecker_FlameColorType__Enum__Class** type_info = &type_info_ref;

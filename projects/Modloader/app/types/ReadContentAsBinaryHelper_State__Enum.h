...
namespace app::classes::types {
    namespace ReadContentAsBinaryHelper_State__Enum {
        namespace {
            inline app::ReadContentAsBinaryHelper_State__Enum__Class* type_info_ref = nullptr;
        }
        inline app::ReadContentAsBinaryHelper_State__Enum__Class** type_info = &type_info_ref;

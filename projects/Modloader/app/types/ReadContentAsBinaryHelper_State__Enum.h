...
namespace app::classes::types {
    namespace ReadContentAsBinaryHelper_State__Enum {
        inline app::ReadContentAsBinaryHelper_State__Enum__Class** type_info() {
            static app::ReadContentAsBinaryHelper_State__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::ReadContentAsBinaryHelper_State__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

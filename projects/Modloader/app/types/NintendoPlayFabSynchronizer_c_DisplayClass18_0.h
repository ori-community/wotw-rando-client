...
#include <Modloader/app/structs/NintendoPlayFabSynchronizer_c_DisplayClass18_0__Class.h>
#include <Modloader/il2cpp_helpers.h>
#include <Modloader/macros.h>

namespace app::classes::types {
    namespace NintendoPlayFabSynchronizer_c_DisplayClass18_0 {
        inline app::NintendoPlayFabSynchronizer_c_DisplayClass18_0__Class** type_info() {
            static app::NintendoPlayFabSynchronizer_c_DisplayClass18_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::NintendoPlayFabSynchronizer_c_DisplayClass18_0__Class**)(modloader::win::memory::resolve_rva(0x04713B48));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace Wrapper_c_DisplayClass45_0 {
        inline app::Wrapper_c_DisplayClass45_0__Class** type_info() {
            static app::Wrapper_c_DisplayClass45_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::Wrapper_c_DisplayClass45_0__Class**)(modloader::win::memory::resolve_rva(0x04705930));
            }
            return cache;
        }

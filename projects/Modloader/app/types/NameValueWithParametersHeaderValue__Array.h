...
namespace app::classes::types {
    namespace NameValueWithParametersHeaderValue__Array {
        inline app::NameValueWithParametersHeaderValue__Array__Class** type_info() {
            static app::NameValueWithParametersHeaderValue__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::NameValueWithParametersHeaderValue__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

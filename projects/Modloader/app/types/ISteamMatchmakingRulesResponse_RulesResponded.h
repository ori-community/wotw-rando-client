...
namespace app::classes::types {
    namespace ISteamMatchmakingRulesResponse_RulesResponded {
        namespace {
            inline app::ISteamMatchmakingRulesResponse_RulesResponded__Class* type_info_ref = nullptr;
        }
        inline app::ISteamMatchmakingRulesResponse_RulesResponded__Class** type_info = &type_info_ref;

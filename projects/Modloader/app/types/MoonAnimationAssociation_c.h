...
namespace app::classes::types {
    namespace MoonAnimationAssociation_c {
        inline app::MoonAnimationAssociation_c__Class** type_info() {
            static app::MoonAnimationAssociation_c__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::MoonAnimationAssociation_c__Class**)(modloader::win::memory::resolve_rva(0x0477E840));
            }
            return cache;
        }

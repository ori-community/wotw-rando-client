...
namespace app::classes::types {
    namespace XmlTextReaderImpl_EntityExpandType__Enum {
        namespace {
            inline app::XmlTextReaderImpl_EntityExpandType__Enum__Class* type_info_ref = nullptr;
        }
        inline app::XmlTextReaderImpl_EntityExpandType__Enum__Class** type_info = &type_info_ref;

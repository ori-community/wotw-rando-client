...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_NightVision_4 {
        inline app::ShaderID_CameraFilterPack_NightVision_4__Class** type_info() {
            static app::ShaderID_CameraFilterPack_NightVision_4__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ShaderID_CameraFilterPack_NightVision_4__Class**)(modloader::win::memory::resolve_rva(0x0478F8B0));
            }
            return cache;
        }

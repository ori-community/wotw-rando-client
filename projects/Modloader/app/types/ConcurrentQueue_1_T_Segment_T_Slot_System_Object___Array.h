...
namespace app::classes::types {
    namespace ConcurrentQueue_1_T_Segment_T_Slot_System_Object___Array {
        inline app::ConcurrentQueue_1_T_Segment_T_Slot_System_Object___Array__Class** type_info() {
            static app::ConcurrentQueue_1_T_Segment_T_Slot_System_Object___Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::ConcurrentQueue_1_T_Segment_T_Slot_System_Object___Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

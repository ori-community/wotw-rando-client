...
#include <Modloader/app/structs/BrowserNative_Calltype_zfb_registerNavStateCallback__Class.h>
#include <Modloader/il2cpp_helpers.h>
#include <Modloader/macros.h>

namespace app::classes::types {
    namespace BrowserNative_Calltype_zfb_registerNavStateCallback {
        inline app::BrowserNative_Calltype_zfb_registerNavStateCallback__Class** type_info() {
            static app::BrowserNative_Calltype_zfb_registerNavStateCallback__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::BrowserNative_Calltype_zfb_registerNavStateCallback__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

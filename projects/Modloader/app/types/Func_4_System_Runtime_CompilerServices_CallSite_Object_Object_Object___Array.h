...
namespace app::classes::types {
    namespace Func_4_System_Runtime_CompilerServices_CallSite_Object_Object_Object___Array {
        namespace {
            inline app::Func_4_System_Runtime_CompilerServices_CallSite_Object_Object_Object___Array__Class* type_info_ref = nullptr;
        }
        inline app::Func_4_System_Runtime_CompilerServices_CallSite_Object_Object_Object___Array__Class** type_info = &type_info_ref;

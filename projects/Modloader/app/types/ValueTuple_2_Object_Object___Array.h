...
namespace app::classes::types {
    namespace ValueTuple_2_Object_Object___Array {
        namespace {
            inline app::ValueTuple_2_Object_Object___Array__Class* type_info_ref = nullptr;
        }
        inline app::ValueTuple_2_Object_Object___Array__Class** type_info = &type_info_ref;

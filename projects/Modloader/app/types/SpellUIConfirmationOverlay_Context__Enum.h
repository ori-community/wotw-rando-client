...
namespace app::classes::types {
    namespace SpellUIConfirmationOverlay_Context__Enum {
        namespace {
            inline app::SpellUIConfirmationOverlay_Context__Enum__Class* type_info_ref = nullptr;
        }
        inline app::SpellUIConfirmationOverlay_Context__Enum__Class** type_info = &type_info_ref;

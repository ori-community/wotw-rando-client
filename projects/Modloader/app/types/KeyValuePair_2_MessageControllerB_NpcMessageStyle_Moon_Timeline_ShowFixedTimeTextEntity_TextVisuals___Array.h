...
namespace app::classes::types {
    namespace KeyValuePair_2_MessageControllerB_NpcMessageStyle_Moon_Timeline_ShowFixedTimeTextEntity_TextVisuals___Array {
        namespace {
            inline app::KeyValuePair_2_MessageControllerB_NpcMessageStyle_Moon_Timeline_ShowFixedTimeTextEntity_TextVisuals___Array__Class* type_info_ref = nullptr;
        }
        inline app::KeyValuePair_2_MessageControllerB_NpcMessageStyle_Moon_Timeline_ShowFixedTimeTextEntity_TextVisuals___Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace IconPlacementScaler_IconOffsetPosition__Array {
        namespace {
            inline app::IconPlacementScaler_IconOffsetPosition__Array__Class* type_info_ref = nullptr;
        }
        inline app::IconPlacementScaler_IconOffsetPosition__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace VirtualTimelineRepresentationGroup__Enum__Array {
        inline app::VirtualTimelineRepresentationGroup__Enum__Array__Class** type_info() {
            static app::VirtualTimelineRepresentationGroup__Enum__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::VirtualTimelineRepresentationGroup__Enum__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

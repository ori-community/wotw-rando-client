...
namespace app::classes::types {
    namespace ScriptableCullingParameters_m_CullingPlanes_FixedBuffer9 {
        namespace {
            inline app::ScriptableCullingParameters_m_CullingPlanes_FixedBuffer9__Class* type_info_ref = nullptr;
        }
        inline app::ScriptableCullingParameters_m_CullingPlanes_FixedBuffer9__Class** type_info = &type_info_ref;

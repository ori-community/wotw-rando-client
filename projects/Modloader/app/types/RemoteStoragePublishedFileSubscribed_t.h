...
namespace app::classes::types {
    namespace RemoteStoragePublishedFileSubscribed_t {
        namespace {
            inline app::RemoteStoragePublishedFileSubscribed_t__Class* type_info_ref = nullptr;
        }
        inline app::RemoteStoragePublishedFileSubscribed_t__Class** type_info = &type_info_ref;

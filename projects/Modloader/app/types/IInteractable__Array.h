...
namespace app::classes::types {
    namespace IInteractable__Array {
        inline app::IInteractable__Array__Class** type_info() {
            static app::IInteractable__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::IInteractable__Array__Class**)(modloader::win::memory::resolve_rva(0x04780460));
            }
            return cache;
        }

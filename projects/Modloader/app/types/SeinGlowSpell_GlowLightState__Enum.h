...
namespace app::classes::types {
    namespace SeinGlowSpell_GlowLightState__Enum {
        namespace {
            inline app::SeinGlowSpell_GlowLightState__Enum__Class* type_info_ref = nullptr;
        }
        inline app::SeinGlowSpell_GlowLightState__Enum__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace SpaceMongerWidget_UberStateGroupDataSizeComparer {
        inline app::SpaceMongerWidget_UberStateGroupDataSizeComparer__Class** type_info = (app::SpaceMongerWidget_UberStateGroupDataSizeComparer__Class**)(modloader::win::memory::resolve_rva(0x047897B8));

...
namespace app::classes::types {
    namespace Browser_c_DisplayClass149_0 {
        inline app::Browser_c_DisplayClass149_0__Class** type_info() {
            static app::Browser_c_DisplayClass149_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::Browser_c_DisplayClass149_0__Class**)(modloader::win::memory::resolve_rva(0x04771678));
            }
            return cache;
        }

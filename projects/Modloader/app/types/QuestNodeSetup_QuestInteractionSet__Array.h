...
namespace app::classes::types {
    namespace QuestNodeSetup_QuestInteractionSet__Array {
        namespace {
            inline app::QuestNodeSetup_QuestInteractionSet__Array__Class* type_info_ref = nullptr;
        }
        inline app::QuestNodeSetup_QuestInteractionSet__Array__Class** type_info = &type_info_ref;

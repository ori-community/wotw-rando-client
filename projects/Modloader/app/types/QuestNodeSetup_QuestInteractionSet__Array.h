...
#include <Modloader/app/structs/QuestNodeSetup_QuestInteractionSet__Array__Class.h>
#include <Modloader/il2cpp_helpers.h>
#include <Modloader/macros.h>

namespace app::classes::types {
    namespace QuestNodeSetup_QuestInteractionSet__Array {
        inline app::QuestNodeSetup_QuestInteractionSet__Array__Class** type_info() {
            static app::QuestNodeSetup_QuestInteractionSet__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::QuestNodeSetup_QuestInteractionSet__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

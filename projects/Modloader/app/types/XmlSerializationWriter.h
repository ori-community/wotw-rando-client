...
namespace app::classes::types {
    namespace XmlSerializationWriter {
        inline app::XmlSerializationWriter__Class** type_info() {
            static app::XmlSerializationWriter__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::XmlSerializationWriter__Class**)(modloader::win::memory::resolve_rva(0x04795F58));
            }
            return cache;
        }

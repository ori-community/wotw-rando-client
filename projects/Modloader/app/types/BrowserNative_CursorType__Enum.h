...
namespace app::classes::types {
    namespace BrowserNative_CursorType__Enum {
        inline app::BrowserNative_CursorType__Enum__Class** type_info() {
            static app::BrowserNative_CursorType__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::BrowserNative_CursorType__Enum__Class**)(modloader::win::memory::resolve_rva(0x04705488));
            }
            return cache;
        }

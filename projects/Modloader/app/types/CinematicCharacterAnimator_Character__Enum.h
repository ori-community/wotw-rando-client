...
#include <Modloader/app/structs/CinematicCharacterAnimator_Character__Enum__Class.h>
#include <Modloader/il2cpp_helpers.h>
#include <Modloader/macros.h>

namespace app::classes::types {
    namespace CinematicCharacterAnimator_Character__Enum {
        inline app::CinematicCharacterAnimator_Character__Enum__Class** type_info() {
            static app::CinematicCharacterAnimator_Character__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::CinematicCharacterAnimator_Character__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace GetTimeRequest_1 {
        inline app::GetTimeRequest_1__Class** type_info() {
            static app::GetTimeRequest_1__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::GetTimeRequest_1__Class**)(modloader::win::memory::resolve_rva(0x0478BED8));
            }
            return cache;
        }

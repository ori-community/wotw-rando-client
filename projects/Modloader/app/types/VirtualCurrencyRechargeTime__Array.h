...
namespace app::classes::types {
    namespace VirtualCurrencyRechargeTime__Array {
        namespace {
            inline app::VirtualCurrencyRechargeTime__Array__Class* type_info_ref = nullptr;
        }
        inline app::VirtualCurrencyRechargeTime__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace DistortionAnimator_RendererData__Array {
        namespace {
            inline app::DistortionAnimator_RendererData__Array__Class* type_info_ref = nullptr;
        }
        inline app::DistortionAnimator_RendererData__Array__Class** type_info = &type_info_ref;

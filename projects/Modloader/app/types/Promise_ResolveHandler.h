...
namespace app::classes::types {
    namespace Promise_ResolveHandler {
        inline app::Promise_ResolveHandler__Class** type_info() {
            static app::Promise_ResolveHandler__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::Promise_ResolveHandler__Class**)(modloader::win::memory::resolve_rva(0x0478DD70));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace VolumeEffectFlags_c_DisplayClass3_0 {
        inline app::VolumeEffectFlags_c_DisplayClass3_0__Class** type_info() {
            static app::VolumeEffectFlags_c_DisplayClass3_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::VolumeEffectFlags_c_DisplayClass3_0__Class**)(modloader::win::memory::resolve_rva(0x04753DA0));
            }
            return cache;
        }

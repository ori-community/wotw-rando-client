...
namespace app::classes::types {
    namespace MessageControllerB_NpcMessageStyle__Enum__Array {
        inline app::MessageControllerB_NpcMessageStyle__Enum__Array__Class** type_info() {
            static app::MessageControllerB_NpcMessageStyle__Enum__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::MessageControllerB_NpcMessageStyle__Enum__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

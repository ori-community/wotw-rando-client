...
namespace app::classes::types {
    namespace BrowserNative_MouseButton__Enum {
        inline app::BrowserNative_MouseButton__Enum__Class** type_info() {
            static app::BrowserNative_MouseButton__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::BrowserNative_MouseButton__Enum__Class**)(modloader::win::memory::resolve_rva(0x0470E088));
            }
            return cache;
        }

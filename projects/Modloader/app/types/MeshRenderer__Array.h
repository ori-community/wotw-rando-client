...
namespace app::classes::types {
    namespace MeshRenderer__Array {
        inline app::MeshRenderer__Array__Class** type_info() {
            static app::MeshRenderer__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::MeshRenderer__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

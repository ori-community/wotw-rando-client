...
namespace app::classes::types {
    namespace DesiredUberStateDoor_DoorState__Enum {
        namespace {
            inline app::DesiredUberStateDoor_DoorState__Enum__Class* type_info_ref = nullptr;
        }
        inline app::DesiredUberStateDoor_DoorState__Enum__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace OperationTypes__Enum {
        inline app::OperationTypes__Enum__Class** type_info() {
            static app::OperationTypes__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::OperationTypes__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

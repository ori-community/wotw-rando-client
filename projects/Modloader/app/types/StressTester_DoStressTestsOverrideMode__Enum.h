...
namespace app::classes::types {
    namespace StressTester_DoStressTestsOverrideMode__Enum {
        inline app::StressTester_DoStressTestsOverrideMode__Enum__Class** type_info() {
            static app::StressTester_DoStressTestsOverrideMode__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::StressTester_DoStressTestsOverrideMode__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace UpdateAvatarUrlRequest_1 {
        inline app::UpdateAvatarUrlRequest_1__Class** type_info() {
            static app::UpdateAvatarUrlRequest_1__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::UpdateAvatarUrlRequest_1__Class**)(modloader::win::memory::resolve_rva(0x0476A0F8));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_EXTRA_Rotation {
        inline app::ShaderID_CameraFilterPack_EXTRA_Rotation__Class** type_info = (app::ShaderID_CameraFilterPack_EXTRA_Rotation__Class**)(modloader::win::memory::resolve_rva(0x04754B48));

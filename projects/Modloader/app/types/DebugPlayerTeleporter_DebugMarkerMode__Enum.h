...
namespace app::classes::types {
    namespace DebugPlayerTeleporter_DebugMarkerMode__Enum {
        namespace {
            inline app::DebugPlayerTeleporter_DebugMarkerMode__Enum__Class* type_info_ref = nullptr;
        }
        inline app::DebugPlayerTeleporter_DebugMarkerMode__Enum__Class** type_info = &type_info_ref;

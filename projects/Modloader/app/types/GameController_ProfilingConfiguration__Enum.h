...
namespace app::classes::types {
    namespace GameController_ProfilingConfiguration__Enum {
        inline app::GameController_ProfilingConfiguration__Enum__Class** type_info() {
            static app::GameController_ProfilingConfiguration__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::GameController_ProfilingConfiguration__Enum__Class**)(modloader::win::memory::resolve_rva(0x04732308));
            }
            return cache;
        }

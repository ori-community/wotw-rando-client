...
namespace app::classes::types {
    namespace MoonAnimator_PreviewAnimation__Array {
        inline app::MoonAnimator_PreviewAnimation__Array__Class** type_info() {
            static app::MoonAnimator_PreviewAnimation__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::MoonAnimator_PreviewAnimation__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

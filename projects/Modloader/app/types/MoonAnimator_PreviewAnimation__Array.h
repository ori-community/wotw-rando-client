...
namespace app::classes::types {
    namespace MoonAnimator_PreviewAnimation__Array {
        namespace {
            inline app::MoonAnimator_PreviewAnimation__Array__Class* type_info_ref = nullptr;
        }
        inline app::MoonAnimator_PreviewAnimation__Array__Class** type_info = &type_info_ref;

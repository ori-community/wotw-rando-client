...
namespace app::classes::types {
    namespace DeadJumpingSootEnemy_State__Enum {
        inline app::DeadJumpingSootEnemy_State__Enum__Class** type_info() {
            static app::DeadJumpingSootEnemy_State__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::DeadJumpingSootEnemy_State__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

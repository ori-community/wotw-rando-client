...
namespace app::classes::types {
    namespace RenderModel_TextureMap_t {
        inline app::RenderModel_TextureMap_t__Class** type_info() {
            static app::RenderModel_TextureMap_t__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::RenderModel_TextureMap_t__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

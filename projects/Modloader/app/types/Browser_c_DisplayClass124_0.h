...
namespace app::classes::types {
    namespace Browser_c_DisplayClass124_0 {
        inline app::Browser_c_DisplayClass124_0__Class** type_info() {
            static app::Browser_c_DisplayClass124_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::Browser_c_DisplayClass124_0__Class**)(modloader::win::memory::resolve_rva(0x0476ED38));
            }
            return cache;
        }

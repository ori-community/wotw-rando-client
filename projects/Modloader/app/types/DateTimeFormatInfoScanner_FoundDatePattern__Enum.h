...
namespace app::classes::types {
    namespace DateTimeFormatInfoScanner_FoundDatePattern__Enum {
        namespace {
            inline app::DateTimeFormatInfoScanner_FoundDatePattern__Enum__Class* type_info_ref = nullptr;
        }
        inline app::DateTimeFormatInfoScanner_FoundDatePattern__Enum__Class** type_info = &type_info_ref;

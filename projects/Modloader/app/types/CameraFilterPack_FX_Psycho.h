...
namespace app::classes::types {
    namespace CameraFilterPack_FX_Psycho {
        inline app::CameraFilterPack_FX_Psycho__Class** type_info() {
            static app::CameraFilterPack_FX_Psycho__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::CameraFilterPack_FX_Psycho__Class**)(modloader::win::memory::resolve_rva(0x04784068));
            }
            return cache;
        }

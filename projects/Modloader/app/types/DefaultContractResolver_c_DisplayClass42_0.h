...
namespace app::classes::types {
    namespace DefaultContractResolver_c_DisplayClass42_0 {
        inline app::DefaultContractResolver_c_DisplayClass42_0__Class** type_info = (app::DefaultContractResolver_c_DisplayClass42_0__Class**)(modloader::win::memory::resolve_rva(0x0472F558));

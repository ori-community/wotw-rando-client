...
namespace app::classes::types {
    namespace SphereColliderAnimator_AnimationMode__Enum {
        namespace {
            inline app::SphereColliderAnimator_AnimationMode__Enum__Class* type_info_ref = nullptr;
        }
        inline app::SphereColliderAnimator_AnimationMode__Enum__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace ShowFixedTimeTextEntity_TextVisuals {
        inline app::ShowFixedTimeTextEntity_TextVisuals__Class** type_info() {
            static app::ShowFixedTimeTextEntity_TextVisuals__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ShowFixedTimeTextEntity_TextVisuals__Class**)(modloader::win::memory::resolve_rva(0x04786FF8));
            }
            return cache;
        }

#pragma once
#include <Modloader/app/structs/ShaderID_Antialiasing.h>
...
namespace app::classes::types {
    namespace ShaderID_Antialiasing {
        inline app::ShaderID_Antialiasing__Class** type_info() {
            static app::ShaderID_Antialiasing__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ShaderID_Antialiasing__Class**)(modloader::win::memory::resolve_rva(0x0478F148));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace InteractionObject_WeightCurve__Array {
        inline app::InteractionObject_WeightCurve__Array__Class** type_info() {
            static app::InteractionObject_WeightCurve__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::InteractionObject_WeightCurve__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace JsonWriter_State__Enum__Array__Array {
        inline app::JsonWriter_State__Enum__Array__Array__Class** type_info() {
            static app::JsonWriter_State__Enum__Array__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::JsonWriter_State__Enum__Array__Array__Class**)(modloader::win::memory::resolve_rva(0x0478ED18));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace MusicPlayerWantsShuffled_t {
        inline app::MusicPlayerWantsShuffled_t__Class** type_info() {
            static app::MusicPlayerWantsShuffled_t__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::MusicPlayerWantsShuffled_t__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace CharacterState__Array {
        inline app::CharacterState__Array__Class** type_info() {
            static app::CharacterState__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::CharacterState__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_Gradients_Rainbow {
        inline app::ShaderID_CameraFilterPack_Gradients_Rainbow__Class** type_info = (app::ShaderID_CameraFilterPack_Gradients_Rainbow__Class**)(modloader::win::memory::resolve_rva(0x04730DC8));

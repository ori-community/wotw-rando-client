...
namespace app::classes::types {
    namespace SkillTreeManager_AbilityMessageProvider__Array {
        namespace {
            inline app::SkillTreeManager_AbilityMessageProvider__Array__Class* type_info_ref = nullptr;
        }
        inline app::SkillTreeManager_AbilityMessageProvider__Array__Class** type_info = &type_info_ref;

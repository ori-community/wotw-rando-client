...
namespace app::classes::types {
    namespace OnReceiveDamage_1 {
        inline app::OnReceiveDamage_1__Class** type_info() {
            static app::OnReceiveDamage_1__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::OnReceiveDamage_1__Class**)(modloader::win::memory::resolve_rva(0x04700DC8));
            }
            return cache;
        }

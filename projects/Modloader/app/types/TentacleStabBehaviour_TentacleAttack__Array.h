...
namespace app::classes::types {
    namespace TentacleStabBehaviour_TentacleAttack__Array {
        namespace {
            inline app::TentacleStabBehaviour_TentacleAttack__Array__Class* type_info_ref = nullptr;
        }
        inline app::TentacleStabBehaviour_TentacleAttack__Array__Class** type_info = &type_info_ref;

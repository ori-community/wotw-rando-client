...
namespace app::classes::types {
    namespace TargetInSpiderBossBehaviourZoneCondition {
        namespace {
            inline app::TargetInSpiderBossBehaviourZoneCondition__Class* type_info_ref = nullptr;
        }
        inline app::TargetInSpiderBossBehaviourZoneCondition__Class** type_info = &type_info_ref;

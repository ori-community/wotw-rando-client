...
namespace app::classes::types {
    namespace PickupMessageIcon_PickupType__Enum {
        namespace {
            inline app::PickupMessageIcon_PickupType__Enum__Class* type_info_ref = nullptr;
        }
        inline app::PickupMessageIcon_PickupType__Enum__Class** type_info = &type_info_ref;

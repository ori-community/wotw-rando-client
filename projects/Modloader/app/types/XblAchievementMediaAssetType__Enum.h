...
namespace app::classes::types {
    namespace XblAchievementMediaAssetType__Enum {
        inline app::XblAchievementMediaAssetType__Enum__Class** type_info() {
            static app::XblAchievementMediaAssetType__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::XblAchievementMediaAssetType__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

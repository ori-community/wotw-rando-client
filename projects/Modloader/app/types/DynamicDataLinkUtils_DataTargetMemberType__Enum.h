...
namespace app::classes::types {
    namespace DynamicDataLinkUtils_DataTargetMemberType__Enum {
        namespace {
            inline app::DynamicDataLinkUtils_DataTargetMemberType__Enum__Class* type_info_ref = nullptr;
        }
        inline app::DynamicDataLinkUtils_DataTargetMemberType__Enum__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace AkCommonOutputSettings_ChannelConfiguration_ChannelMask__Enum {
        inline app::AkCommonOutputSettings_ChannelConfiguration_ChannelMask__Enum__Class** type_info() {
            static app::AkCommonOutputSettings_ChannelConfiguration_ChannelMask__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::AkCommonOutputSettings_ChannelConfiguration_ChannelMask__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

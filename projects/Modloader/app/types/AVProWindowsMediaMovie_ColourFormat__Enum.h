...
namespace app::classes::types {
    namespace AVProWindowsMediaMovie_ColourFormat__Enum {
        namespace {
            inline app::AVProWindowsMediaMovie_ColourFormat__Enum__Class* type_info_ref = nullptr;
        }
        inline app::AVProWindowsMediaMovie_ColourFormat__Enum__Class** type_info = &type_info_ref;

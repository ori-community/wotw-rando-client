...
namespace app::classes::types {
    namespace UberShaderAnimatorStrategyStandard_Request_1_UnityEngine_Vector4___Array {
        namespace {
            inline app::UberShaderAnimatorStrategyStandard_Request_1_UnityEngine_Vector4___Array__Class* type_info_ref = nullptr;
        }
        inline app::UberShaderAnimatorStrategyStandard_Request_1_UnityEngine_Vector4___Array__Class** type_info = &type_info_ref;

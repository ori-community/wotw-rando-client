...
namespace app::classes::types {
    namespace ETextureType__Enum {
        inline app::ETextureType__Enum__Class** type_info() {
            static app::ETextureType__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ETextureType__Enum__Class**)(modloader::win::memory::resolve_rva(0x0477D418));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace BrowserNative_Calltype_zfb_setLocalRequestHandler {
        namespace {
            inline app::BrowserNative_Calltype_zfb_setLocalRequestHandler__Class* type_info_ref = nullptr;
        }
        inline app::BrowserNative_Calltype_zfb_setLocalRequestHandler__Class** type_info = &type_info_ref;

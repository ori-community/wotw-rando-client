...
namespace app::classes::types {
    namespace TurbulenceTranslationModifier_GetKeywordsForShader_d_9 {
        inline app::TurbulenceTranslationModifier_GetKeywordsForShader_d_9__Class** type_info = (app::TurbulenceTranslationModifier_GetKeywordsForShader_d_9__Class**)(modloader::win::memory::resolve_rva(0x047588D0));

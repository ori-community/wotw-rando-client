...
namespace app::classes::types {
    namespace AmbienceZone_WiseAuxSend {
        inline app::AmbienceZone_WiseAuxSend__Class** type_info() {
            static app::AmbienceZone_WiseAuxSend__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::AmbienceZone_WiseAuxSend__Class**)(modloader::win::memory::resolve_rva(0x04720EE8));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace MethodInfo_1 {
        inline app::MethodInfo_1__Class** type_info() {
            static app::MethodInfo_1__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::MethodInfo_1__Class**)(modloader::win::memory::resolve_rva(0x0476AEE8));
            }
            return cache;
        }

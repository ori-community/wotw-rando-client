...
namespace app::classes::types {
    namespace Vector4__Array {
        inline app::Vector4__Array__Class** type_info() {
            static app::Vector4__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::Vector4__Array__Class**)(modloader::win::memory::resolve_rva(0x047163D8));
            }
            return cache;
        }

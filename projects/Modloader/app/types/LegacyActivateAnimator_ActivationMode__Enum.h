...
namespace app::classes::types {
    namespace LegacyActivateAnimator_ActivationMode__Enum {
        namespace {
            inline app::LegacyActivateAnimator_ActivationMode__Enum__Class* type_info_ref = nullptr;
        }
        inline app::LegacyActivateAnimator_ActivationMode__Enum__Class** type_info = &type_info_ref;

...
#include <Modloader/app/structs/_PrivateImplementationDetails_ArrayType_12__Boxed.h>
#include <Modloader/app/structs/_PrivateImplementationDetails_ArrayType_12__Class.h>
#include <Modloader/il2cpp_helpers.h>
#include <Modloader/macros.h>

namespace app::classes::types {
    namespace _PrivateImplementationDetails_ArrayType_12 {
        inline app::_PrivateImplementationDetails_ArrayType_12__Class** type_info() {
            static app::_PrivateImplementationDetails_ArrayType_12__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::_PrivateImplementationDetails_ArrayType_12__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

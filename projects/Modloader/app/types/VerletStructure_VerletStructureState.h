...
namespace app::classes::types {
    namespace VerletStructure_VerletStructureState {
        inline app::VerletStructure_VerletStructureState__Class** type_info() {
            static app::VerletStructure_VerletStructureState__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::VerletStructure_VerletStructureState__Class**)(modloader::win::memory::resolve_rva(0x0470A5C8));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace LegacyTimelineSequence_SequenceEntry__Array {
        inline app::LegacyTimelineSequence_SequenceEntry__Array__Class** type_info() {
            static app::LegacyTimelineSequence_SequenceEntry__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::LegacyTimelineSequence_SequenceEntry__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

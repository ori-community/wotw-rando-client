...
namespace app::classes::types {
    namespace DepthOfFieldDeprecated_DofBlurriness__Enum {
        namespace {
            inline app::DepthOfFieldDeprecated_DofBlurriness__Enum__Class* type_info_ref = nullptr;
        }
        inline app::DepthOfFieldDeprecated_DofBlurriness__Enum__Class** type_info = &type_info_ref;

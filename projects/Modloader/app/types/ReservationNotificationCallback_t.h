...
namespace app::classes::types {
    namespace ReservationNotificationCallback_t {
        inline app::ReservationNotificationCallback_t__Class** type_info() {
            static app::ReservationNotificationCallback_t__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::ReservationNotificationCallback_t__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

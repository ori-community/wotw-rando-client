...
namespace app::classes::types {
    namespace ProductHeaderValue {
        inline app::ProductHeaderValue__Class** type_info() {
            static app::ProductHeaderValue__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ProductHeaderValue__Class**)(modloader::win::memory::resolve_rva(0x0474E8E0));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace PropertyAccessor_1_System_UInt16___Array {
        namespace {
            inline app::PropertyAccessor_1_System_UInt16___Array__Class* type_info_ref = nullptr;
        }
        inline app::PropertyAccessor_1_System_UInt16___Array__Class** type_info = &type_info_ref;

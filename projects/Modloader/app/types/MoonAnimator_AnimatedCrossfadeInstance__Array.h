...
namespace app::classes::types {
    namespace MoonAnimator_AnimatedCrossfadeInstance__Array {
        namespace {
            inline app::MoonAnimator_AnimatedCrossfadeInstance__Array__Class* type_info_ref = nullptr;
        }
        inline app::MoonAnimator_AnimatedCrossfadeInstance__Array__Class** type_info = &type_info_ref;

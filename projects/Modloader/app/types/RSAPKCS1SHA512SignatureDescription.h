...
namespace app::classes::types {
    namespace RSAPKCS1SHA512SignatureDescription {
        inline app::RSAPKCS1SHA512SignatureDescription__Class** type_info() {
            static app::RSAPKCS1SHA512SignatureDescription__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::RSAPKCS1SHA512SignatureDescription__Class**)(modloader::win::memory::resolve_rva(0x04715718));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace TeleportDebugMenuPage_c_DisplayClass6_0 {
        inline app::TeleportDebugMenuPage_c_DisplayClass6_0__Class** type_info() {
            static app::TeleportDebugMenuPage_c_DisplayClass6_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::TeleportDebugMenuPage_c_DisplayClass6_0__Class**)(modloader::win::memory::resolve_rva(0x04702870));
            }
            return cache;
        }

...
#include <Modloader/app/structs/Dictionary_2_TKey_TValue_Entry_System_Linq_Expressions_LambdaExpression_System_Int32___Array__Class.h>
#include <Modloader/app/structs/Dictionary_2_TKey_TValue_Entry_System_Linq_Expressions_LambdaExpression_System_Int32___Array.h>

namespace app::classes::types {
    namespace Dictionary_2_TKey_TValue_Entry_System_Linq_Expressions_LambdaExpression_System_Int32___Array {
        namespace {
            inline app::Dictionary_2_TKey_TValue_Entry_System_Linq_Expressions_LambdaExpression_System_Int32___Array__Class* type_info_ref = nullptr;
        }
        inline app::Dictionary_2_TKey_TValue_Entry_System_Linq_Expressions_LambdaExpression_System_Int32___Array__Class** type_info = &type_info_ref;

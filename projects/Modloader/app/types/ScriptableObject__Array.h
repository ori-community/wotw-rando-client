...
namespace app::classes::types {
    namespace ScriptableObject__Array {
        inline app::ScriptableObject__Array__Class** type_info() {
            static app::ScriptableObject__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::ScriptableObject__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

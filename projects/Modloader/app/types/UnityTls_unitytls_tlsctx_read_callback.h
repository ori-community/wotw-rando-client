...
namespace app::classes::types {
    namespace UnityTls_unitytls_tlsctx_read_callback {
        inline app::UnityTls_unitytls_tlsctx_read_callback__Class** type_info() {
            static app::UnityTls_unitytls_tlsctx_read_callback__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::UnityTls_unitytls_tlsctx_read_callback__Class**)(modloader::win::memory::resolve_rva(0x04725D70));
            }
            return cache;
        }

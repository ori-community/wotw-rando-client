...
namespace app::classes::types {
    namespace ShaderID_CharacterAnimationSimple {
        inline app::ShaderID_CharacterAnimationSimple__Class** type_info = (app::ShaderID_CharacterAnimationSimple__Class**)(modloader::win::memory::resolve_rva(0x0473F480));

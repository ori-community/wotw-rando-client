...
namespace app::classes::types {
    namespace MoonReference_1_Moon_Timeline_ITimelineEntity___Array {
        namespace {
            inline app::MoonReference_1_Moon_Timeline_ITimelineEntity___Array__Class* type_info_ref = nullptr;
        }
        inline app::MoonReference_1_Moon_Timeline_ITimelineEntity___Array__Class** type_info = &type_info_ref;

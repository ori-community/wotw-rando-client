...
namespace app::classes::types {
    namespace AreaMapNavigation_State__Enum {
        inline app::AreaMapNavigation_State__Enum__Class** type_info() {
            static app::AreaMapNavigation_State__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::AreaMapNavigation_State__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

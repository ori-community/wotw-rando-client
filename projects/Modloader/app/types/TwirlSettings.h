...
namespace app::classes::types {
    namespace TwirlSettings {
        inline app::TwirlSettings__Class** type_info() {
            static app::TwirlSettings__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::TwirlSettings__Class**)(modloader::win::memory::resolve_rva(0x0470D478));
            }
            return cache;
        }

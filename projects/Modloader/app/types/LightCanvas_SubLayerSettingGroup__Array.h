...
namespace app::classes::types {
    namespace LightCanvas_SubLayerSettingGroup__Array {
        inline app::LightCanvas_SubLayerSettingGroup__Array__Class** type_info() {
            static app::LightCanvas_SubLayerSettingGroup__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::LightCanvas_SubLayerSettingGroup__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

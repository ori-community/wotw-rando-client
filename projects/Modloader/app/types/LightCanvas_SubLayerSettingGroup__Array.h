...
namespace app::classes::types {
    namespace LightCanvas_SubLayerSettingGroup__Array {
        namespace {
            inline app::LightCanvas_SubLayerSettingGroup__Array__Class* type_info_ref = nullptr;
        }
        inline app::LightCanvas_SubLayerSettingGroup__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace TeleportBeacon_State__Enum {
        inline app::TeleportBeacon_State__Enum__Class** type_info() {
            static app::TeleportBeacon_State__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::TeleportBeacon_State__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

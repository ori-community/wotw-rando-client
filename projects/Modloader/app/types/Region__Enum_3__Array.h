...
namespace app::classes::types {
    namespace Region__Enum_3__Array {
        inline app::Region__Enum_3__Array__Class** type_info() {
            static app::Region__Enum_3__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::Region__Enum_3__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace ShardTraderPlaceholder_ConditionalStockList__Array {
        namespace {
            inline app::ShardTraderPlaceholder_ConditionalStockList__Array__Class* type_info_ref = nullptr;
        }
        inline app::ShardTraderPlaceholder_ConditionalStockList__Array__Class** type_info = &type_info_ref;

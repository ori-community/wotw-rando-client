...
namespace app::classes::types {
    namespace SeinSpiritShardsSpell_MontageEvents__Enum {
        namespace {
            inline app::SeinSpiritShardsSpell_MontageEvents__Enum__Class* type_info_ref = nullptr;
        }
        inline app::SeinSpiritShardsSpell_MontageEvents__Enum__Class** type_info = &type_info_ref;

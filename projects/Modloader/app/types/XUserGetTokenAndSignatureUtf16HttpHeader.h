...
namespace app::classes::types {
    namespace XUserGetTokenAndSignatureUtf16HttpHeader {
        namespace {
            inline app::XUserGetTokenAndSignatureUtf16HttpHeader__Class* type_info_ref = nullptr;
        }
        inline app::XUserGetTokenAndSignatureUtf16HttpHeader__Class** type_info = &type_info_ref;

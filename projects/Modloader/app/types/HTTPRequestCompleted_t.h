...
namespace app::classes::types {
    namespace HTTPRequestCompleted_t {
        inline app::HTTPRequestCompleted_t__Class** type_info() {
            static app::HTTPRequestCompleted_t__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::HTTPRequestCompleted_t__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace SeinHomingMissileSpell_State__Enum {
        inline app::SeinHomingMissileSpell_State__Enum__Class** type_info() {
            static app::SeinHomingMissileSpell_State__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SeinHomingMissileSpell_State__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

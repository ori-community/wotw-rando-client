...
namespace app::classes::types {
    namespace QuestsController_c_DisplayClass53_0 {
        inline app::QuestsController_c_DisplayClass53_0__Class** type_info() {
            static app::QuestsController_c_DisplayClass53_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::QuestsController_c_DisplayClass53_0__Class**)(modloader::win::memory::resolve_rva(0x0472A098));
            }
            return cache;
        }

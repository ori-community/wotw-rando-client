...
namespace app::classes::types {
    namespace RigidbodyInteractionController_InstanciationInteractionSettings__Array {
        namespace {
            inline app::RigidbodyInteractionController_InstanciationInteractionSettings__Array__Class* type_info_ref = nullptr;
        }
        inline app::RigidbodyInteractionController_InstanciationInteractionSettings__Array__Class** type_info = &type_info_ref;

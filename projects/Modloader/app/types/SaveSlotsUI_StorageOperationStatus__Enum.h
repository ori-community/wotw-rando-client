...
namespace app::classes::types {
    namespace SaveSlotsUI_StorageOperationStatus__Enum {
        namespace {
            inline app::SaveSlotsUI_StorageOperationStatus__Enum__Class* type_info_ref = nullptr;
        }
        inline app::SaveSlotsUI_StorageOperationStatus__Enum__Class** type_info = &type_info_ref;

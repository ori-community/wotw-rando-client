...
namespace app::classes::types {
    namespace QuestsController_QuestStateToIndexRemap_StateToIndex__Array {
        inline app::QuestsController_QuestStateToIndexRemap_StateToIndex__Array__Class** type_info() {
            static app::QuestsController_QuestStateToIndexRemap_StateToIndex__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::QuestsController_QuestStateToIndexRemap_StateToIndex__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

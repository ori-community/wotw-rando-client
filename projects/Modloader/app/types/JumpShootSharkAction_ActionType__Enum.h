...
namespace app::classes::types {
    namespace JumpShootSharkAction_ActionType__Enum {
        inline app::JumpShootSharkAction_ActionType__Enum__Class** type_info() {
            static app::JumpShootSharkAction_ActionType__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::JumpShootSharkAction_ActionType__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

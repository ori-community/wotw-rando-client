...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_TV_ARCADE_Fast {
        inline app::ShaderID_CameraFilterPack_TV_ARCADE_Fast__Class** type_info() {
            static app::ShaderID_CameraFilterPack_TV_ARCADE_Fast__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ShaderID_CameraFilterPack_TV_ARCADE_Fast__Class**)(modloader::win::memory::resolve_rva(0x04795BA8));
            }
            return cache;
        }

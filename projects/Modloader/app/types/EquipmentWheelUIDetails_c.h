...
namespace app::classes::types {
    namespace EquipmentWheelUIDetails_c {
        inline app::EquipmentWheelUIDetails_c__Class** type_info() {
            static app::EquipmentWheelUIDetails_c__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::EquipmentWheelUIDetails_c__Class**)(modloader::win::memory::resolve_rva(0x0473FCF0));
            }
            return cache;
        }

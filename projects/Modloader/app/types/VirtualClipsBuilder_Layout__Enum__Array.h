...
namespace app::classes::types {
    namespace VirtualClipsBuilder_Layout__Enum__Array {
        namespace {
            inline app::VirtualClipsBuilder_Layout__Enum__Array__Class* type_info_ref = nullptr;
        }
        inline app::VirtualClipsBuilder_Layout__Enum__Array__Class** type_info = &type_info_ref;

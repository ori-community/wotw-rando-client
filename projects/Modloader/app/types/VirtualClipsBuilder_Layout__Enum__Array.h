...
namespace app::classes::types {
    namespace VirtualClipsBuilder_Layout__Enum__Array {
        inline app::VirtualClipsBuilder_Layout__Enum__Array__Class** type_info() {
            static app::VirtualClipsBuilder_Layout__Enum__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::VirtualClipsBuilder_Layout__Enum__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

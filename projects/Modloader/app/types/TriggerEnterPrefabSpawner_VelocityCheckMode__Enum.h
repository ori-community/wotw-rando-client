...
namespace app::classes::types {
    namespace TriggerEnterPrefabSpawner_VelocityCheckMode__Enum {
        namespace {
            inline app::TriggerEnterPrefabSpawner_VelocityCheckMode__Enum__Class* type_info_ref = nullptr;
        }
        inline app::TriggerEnterPrefabSpawner_VelocityCheckMode__Enum__Class** type_info = &type_info_ref;

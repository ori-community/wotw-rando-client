...
namespace app::classes::types {
    namespace KuMeditateSpell_State__Enum {
        inline app::KuMeditateSpell_State__Enum__Class** type_info() {
            static app::KuMeditateSpell_State__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::KuMeditateSpell_State__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace _PrivateImplementationDetails_StaticArrayInitTypeSize_20_4 {
        namespace {
            inline app::_PrivateImplementationDetails_StaticArrayInitTypeSize_20_4__Class* type_info_ref = nullptr;
        }
        inline app::_PrivateImplementationDetails_StaticArrayInitTypeSize_20_4__Class** type_info = &type_info_ref;

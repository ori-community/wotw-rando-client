...
namespace app::classes::types {
    namespace MinerSpawnTask_c_DisplayClass8_0 {
        inline app::MinerSpawnTask_c_DisplayClass8_0__Class** type_info() {
            static app::MinerSpawnTask_c_DisplayClass8_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::MinerSpawnTask_c_DisplayClass8_0__Class**)(modloader::win::memory::resolve_rva(0x0471DA90));
            }
            return cache;
        }

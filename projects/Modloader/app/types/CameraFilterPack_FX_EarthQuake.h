...
namespace app::classes::types {
    namespace CameraFilterPack_FX_EarthQuake {
        inline app::CameraFilterPack_FX_EarthQuake__Class** type_info() {
            static app::CameraFilterPack_FX_EarthQuake__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::CameraFilterPack_FX_EarthQuake__Class**)(modloader::win::memory::resolve_rva(0x047137F0));
            }
            return cache;
        }

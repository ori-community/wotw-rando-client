...
namespace app::classes::types {
    namespace PlayerUberStateInventory_InventoryItem__Array {
        namespace {
            inline app::PlayerUberStateInventory_InventoryItem__Array__Class* type_info_ref = nullptr;
        }
        inline app::PlayerUberStateInventory_InventoryItem__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace CameraFilterPack_FX_DigitalMatrix {
        inline app::CameraFilterPack_FX_DigitalMatrix__Class** type_info() {
            static app::CameraFilterPack_FX_DigitalMatrix__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::CameraFilterPack_FX_DigitalMatrix__Class**)(modloader::win::memory::resolve_rva(0x04774750));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace StatSettingStrings_EnemyLabels__Array {
        inline app::StatSettingStrings_EnemyLabels__Array__Class** type_info() {
            static app::StatSettingStrings_EnemyLabels__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::StatSettingStrings_EnemyLabels__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

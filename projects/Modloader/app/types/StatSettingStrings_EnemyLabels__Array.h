...
namespace app::classes::types {
    namespace StatSettingStrings_EnemyLabels__Array {
        namespace {
            inline app::StatSettingStrings_EnemyLabels__Array__Class* type_info_ref = nullptr;
        }
        inline app::StatSettingStrings_EnemyLabels__Array__Class** type_info = &type_info_ref;

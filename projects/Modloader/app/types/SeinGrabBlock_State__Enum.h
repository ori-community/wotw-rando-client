...
namespace app::classes::types {
    namespace SeinGrabBlock_State__Enum {
        inline app::SeinGrabBlock_State__Enum__Class** type_info() {
            static app::SeinGrabBlock_State__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SeinGrabBlock_State__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

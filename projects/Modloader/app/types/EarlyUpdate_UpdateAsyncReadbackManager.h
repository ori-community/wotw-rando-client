...
namespace app::classes::types {
    namespace EarlyUpdate_UpdateAsyncReadbackManager {
        inline app::EarlyUpdate_UpdateAsyncReadbackManager__Class** type_info() {
            static app::EarlyUpdate_UpdateAsyncReadbackManager__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::EarlyUpdate_UpdateAsyncReadbackManager__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

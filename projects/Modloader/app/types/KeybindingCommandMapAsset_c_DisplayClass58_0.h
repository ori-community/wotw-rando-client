...
namespace app::classes::types {
    namespace KeybindingCommandMapAsset_c_DisplayClass58_0 {
        inline app::KeybindingCommandMapAsset_c_DisplayClass58_0__Class** type_info() {
            static app::KeybindingCommandMapAsset_c_DisplayClass58_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::KeybindingCommandMapAsset_c_DisplayClass58_0__Class**)(modloader::win::memory::resolve_rva(0x0477D080));
            }
            return cache;
        }

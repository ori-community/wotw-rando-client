...
namespace app::classes::types {
    namespace GenericCastManager_1_Command_NativeArrays_UnityEngine_CapsulecastCommand___Array {
        namespace {
            inline app::GenericCastManager_1_Command_NativeArrays_UnityEngine_CapsulecastCommand___Array__Class* type_info_ref = nullptr;
        }
        inline app::GenericCastManager_1_Command_NativeArrays_UnityEngine_CapsulecastCommand___Array__Class** type_info = &type_info_ref;

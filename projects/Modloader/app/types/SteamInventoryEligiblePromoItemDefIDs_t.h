...
namespace app::classes::types {
    namespace SteamInventoryEligiblePromoItemDefIDs_t {
        namespace {
            inline app::SteamInventoryEligiblePromoItemDefIDs_t__Class* type_info_ref = nullptr;
        }
        inline app::SteamInventoryEligiblePromoItemDefIDs_t__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace ScaleAnimatorEntity_ScaleMode__Enum {
        namespace {
            inline app::ScaleAnimatorEntity_ScaleMode__Enum__Class* type_info_ref = nullptr;
        }
        inline app::ScaleAnimatorEntity_ScaleMode__Enum__Class** type_info = &type_info_ref;

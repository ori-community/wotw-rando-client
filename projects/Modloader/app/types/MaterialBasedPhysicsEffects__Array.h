...
namespace app::classes::types {
    namespace MaterialBasedPhysicsEffects__Array {
        inline app::MaterialBasedPhysicsEffects__Array__Class** type_info() {
            static app::MaterialBasedPhysicsEffects__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::MaterialBasedPhysicsEffects__Array__Class**)(modloader::win::memory::resolve_rva(0x04777988));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace ValueTuple_3_Int32_Object_Int32___Array {
        namespace {
            inline app::ValueTuple_3_Int32_Object_Int32___Array__Class* type_info_ref = nullptr;
        }
        inline app::ValueTuple_3_Int32_Object_Int32___Array__Class** type_info = &type_info_ref;

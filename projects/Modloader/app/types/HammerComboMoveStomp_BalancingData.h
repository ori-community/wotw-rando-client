...
namespace app::classes::types {
    namespace HammerComboMoveStomp_BalancingData {
        namespace {
            inline app::HammerComboMoveStomp_BalancingData__Class* type_info_ref = nullptr;
        }
        inline app::HammerComboMoveStomp_BalancingData__Class** type_info = &type_info_ref;

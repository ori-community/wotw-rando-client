...
namespace app::classes::types {
    namespace TurbulenceStateDefinition_TurbulenceState__Array {
        namespace {
            inline app::TurbulenceStateDefinition_TurbulenceState__Array__Class* type_info_ref = nullptr;
        }
        inline app::TurbulenceStateDefinition_TurbulenceState__Array__Class** type_info = &type_info_ref;

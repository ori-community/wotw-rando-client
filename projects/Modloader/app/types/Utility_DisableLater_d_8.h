...
namespace app::classes::types {
    namespace Utility_DisableLater_d_8 {
        inline app::Utility_DisableLater_d_8__Class** type_info() {
            static app::Utility_DisableLater_d_8__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::Utility_DisableLater_d_8__Class**)(modloader::win::memory::resolve_rva(0x0470A9A0));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace EntityPlaceholderScalingData__Array {
        namespace {
            inline app::EntityPlaceholderScalingData__Array__Class* type_info_ref = nullptr;
        }
        inline app::EntityPlaceholderScalingData__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace CleverMenuItemLayout_Alignment__Enum {
        namespace {
            inline app::CleverMenuItemLayout_Alignment__Enum__Class* type_info_ref = nullptr;
        }
        inline app::CleverMenuItemLayout_Alignment__Enum__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace FixedUpdate_ScriptRunDelayedFixedFrameRate {
        namespace {
            inline app::FixedUpdate_ScriptRunDelayedFixedFrameRate__Class* type_info_ref = nullptr;
        }
        inline app::FixedUpdate_ScriptRunDelayedFixedFrameRate__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace CrabClawAttackBehaviourNew_EAttackMoveDirection__Enum {
        namespace {
            inline app::CrabClawAttackBehaviourNew_EAttackMoveDirection__Enum__Class* type_info_ref = nullptr;
        }
        inline app::CrabClawAttackBehaviourNew_EAttackMoveDirection__Enum__Class** type_info = &type_info_ref;

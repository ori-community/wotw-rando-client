...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_Gradients_Tech {
        inline app::ShaderID_CameraFilterPack_Gradients_Tech__Class** type_info() {
            static app::ShaderID_CameraFilterPack_Gradients_Tech__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ShaderID_CameraFilterPack_Gradients_Tech__Class**)(modloader::win::memory::resolve_rva(0x047267F0));
            }
            return cache;
        }

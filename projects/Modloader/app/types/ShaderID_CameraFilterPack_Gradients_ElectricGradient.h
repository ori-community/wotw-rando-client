...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_Gradients_ElectricGradient {
        inline app::ShaderID_CameraFilterPack_Gradients_ElectricGradient__Class** type_info() {
            static app::ShaderID_CameraFilterPack_Gradients_ElectricGradient__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ShaderID_CameraFilterPack_Gradients_ElectricGradient__Class**)(modloader::win::memory::resolve_rva(0x0477CD28));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace GetPlayFabIDsFromFacebookInstantGamesIdsResult_1 {
        inline app::GetPlayFabIDsFromFacebookInstantGamesIdsResult_1__Class** type_info() {
            static app::GetPlayFabIDsFromFacebookInstantGamesIdsResult_1__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::GetPlayFabIDsFromFacebookInstantGamesIdsResult_1__Class**)(modloader::win::memory::resolve_rva(0x04766320));
            }
            return cache;
        }

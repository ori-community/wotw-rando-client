...
namespace app::classes::types {
    namespace FPSTestResult__Array {
        inline app::FPSTestResult__Array__Class** type_info() {
            static app::FPSTestResult__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::FPSTestResult__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

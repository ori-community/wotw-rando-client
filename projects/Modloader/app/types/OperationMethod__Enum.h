...
namespace app::classes::types {
    namespace OperationMethod__Enum {
        inline app::OperationMethod__Enum__Class** type_info() {
            static app::OperationMethod__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::OperationMethod__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace ExperimentalTransparencyAnimatorSystemStrategy_Request {
        inline app::ExperimentalTransparencyAnimatorSystemStrategy_Request__Class** type_info = (app::ExperimentalTransparencyAnimatorSystemStrategy_Request__Class**)(modloader::win::memory::resolve_rva(0x04739A78));

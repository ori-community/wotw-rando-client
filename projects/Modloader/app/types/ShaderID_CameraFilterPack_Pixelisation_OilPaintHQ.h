...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_Pixelisation_OilPaintHQ {
        inline app::ShaderID_CameraFilterPack_Pixelisation_OilPaintHQ__Class** type_info() {
            static app::ShaderID_CameraFilterPack_Pixelisation_OilPaintHQ__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ShaderID_CameraFilterPack_Pixelisation_OilPaintHQ__Class**)(modloader::win::memory::resolve_rva(0x0471D3C0));
            }
            return cache;
        }

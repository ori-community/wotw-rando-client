...
namespace app::classes::types {
    namespace Socket_c_DisplayClass242_0 {
        inline app::Socket_c_DisplayClass242_0__Class** type_info() {
            static app::Socket_c_DisplayClass242_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::Socket_c_DisplayClass242_0__Class**)(modloader::win::memory::resolve_rva(0x04730B28));
            }
            return cache;
        }

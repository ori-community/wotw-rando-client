...
namespace app::classes::types {
    namespace XmlTextReaderImpl_ParsingMode__Enum {
        inline app::XmlTextReaderImpl_ParsingMode__Enum__Class** type_info() {
            static app::XmlTextReaderImpl_ParsingMode__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::XmlTextReaderImpl_ParsingMode__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

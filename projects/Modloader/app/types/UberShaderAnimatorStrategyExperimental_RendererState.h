...
namespace app::classes::types {
    namespace UberShaderAnimatorStrategyExperimental_RendererState {
        inline app::UberShaderAnimatorStrategyExperimental_RendererState__Class** type_info() {
            static app::UberShaderAnimatorStrategyExperimental_RendererState__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::UberShaderAnimatorStrategyExperimental_RendererState__Class**)(modloader::win::memory::resolve_rva(0x047283D8));
            }
            return cache;
        }

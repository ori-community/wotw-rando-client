...
namespace app::classes::types {
    namespace BrowserNative_Calltype_zfb_setDebugFunc {
        namespace {
            inline app::BrowserNative_Calltype_zfb_setDebugFunc__Class* type_info_ref = nullptr;
        }
        inline app::BrowserNative_Calltype_zfb_setDebugFunc__Class** type_info = &type_info_ref;

#pragma once
#include <Modloader/app/structs/PreLateUpdate_UNetUpdate.h>
#include <Modloader/app/structs/PreLateUpdate_UNetUpdate__Boxed.h>
...
namespace app::classes::types {
    namespace PreLateUpdate_UNetUpdate {
        inline app::PreLateUpdate_UNetUpdate__Class** type_info() {
            static app::PreLateUpdate_UNetUpdate__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::PreLateUpdate_UNetUpdate__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace SneezeSlugBlastBehaviour_State__Enum {
        namespace {
            inline app::SneezeSlugBlastBehaviour_State__Enum__Class* type_info_ref = nullptr;
        }
        inline app::SneezeSlugBlastBehaviour_State__Enum__Class** type_info = &type_info_ref;

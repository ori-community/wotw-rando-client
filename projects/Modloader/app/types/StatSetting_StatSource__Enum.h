...
namespace app::classes::types {
    namespace StatSetting_StatSource__Enum {
        inline app::StatSetting_StatSource__Enum__Class** type_info() {
            static app::StatSetting_StatSource__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::StatSetting_StatSource__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

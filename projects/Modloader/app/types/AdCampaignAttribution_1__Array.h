...
namespace app::classes::types {
    namespace AdCampaignAttribution_1__Array {
        inline app::AdCampaignAttribution_1__Array__Class** type_info() {
            static app::AdCampaignAttribution_1__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::AdCampaignAttribution_1__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

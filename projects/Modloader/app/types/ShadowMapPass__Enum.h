...
namespace app::classes::types {
    namespace ShadowMapPass__Enum {
        inline app::ShadowMapPass__Enum__Class** type_info() {
            static app::ShadowMapPass__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::ShadowMapPass__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

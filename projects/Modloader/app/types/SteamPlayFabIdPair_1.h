...
namespace app::classes::types {
    namespace SteamPlayFabIdPair_1 {
        inline app::SteamPlayFabIdPair_1__Class** type_info() {
            static app::SteamPlayFabIdPair_1__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SteamPlayFabIdPair_1__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace ReadyForAnimationTrigger_State__Enum {
        namespace {
            inline app::ReadyForAnimationTrigger_State__Enum__Class* type_info_ref = nullptr;
        }
        inline app::ReadyForAnimationTrigger_State__Enum__Class** type_info = &type_info_ref;

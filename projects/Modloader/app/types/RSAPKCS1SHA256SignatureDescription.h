...
namespace app::classes::types {
    namespace RSAPKCS1SHA256SignatureDescription {
        inline app::RSAPKCS1SHA256SignatureDescription__Class** type_info = (app::RSAPKCS1SHA256SignatureDescription__Class**)(modloader::win::memory::resolve_rva(0x04775BA8));

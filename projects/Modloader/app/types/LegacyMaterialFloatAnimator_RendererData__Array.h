...
#include <Modloader/app/structs/LegacyMaterialFloatAnimator_RendererData__Array__Class.h>
#include <Modloader/il2cpp_helpers.h>
#include <Modloader/macros.h>

namespace app::classes::types {
    namespace LegacyMaterialFloatAnimator_RendererData__Array {
        inline app::LegacyMaterialFloatAnimator_RendererData__Array__Class** type_info() {
            static app::LegacyMaterialFloatAnimator_RendererData__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::LegacyMaterialFloatAnimator_RendererData__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

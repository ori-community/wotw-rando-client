...
namespace app::classes::types {
    namespace EventPipelineKey__Enum__Array {
        inline app::EventPipelineKey__Enum__Array__Class** type_info() {
            static app::EventPipelineKey__Enum__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::EventPipelineKey__Enum__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

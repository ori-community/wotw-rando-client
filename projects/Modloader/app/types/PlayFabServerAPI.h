...
namespace app::classes::types {
    namespace PlayFabServerAPI {
        inline app::PlayFabServerAPI__Class** type_info() {
            static app::PlayFabServerAPI__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::PlayFabServerAPI__Class**)(modloader::win::memory::resolve_rva(0x04722760));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace XmlSqlBinaryReader_ElemInfo__Array {
        inline app::XmlSqlBinaryReader_ElemInfo__Array__Class** type_info() {
            static app::XmlSqlBinaryReader_ElemInfo__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::XmlSqlBinaryReader_ElemInfo__Array__Class**)(modloader::win::memory::resolve_rva(0x0471DB48));
            }
            return cache;
        }

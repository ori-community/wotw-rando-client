...
namespace app::classes::types {
    namespace NotEqualInstruction_NotEqualInt16LiftedToNull {
        inline app::NotEqualInstruction_NotEqualInt16LiftedToNull__Class** type_info() {
            static app::NotEqualInstruction_NotEqualInt16LiftedToNull__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::NotEqualInstruction_NotEqualInt16LiftedToNull__Class**)(modloader::win::memory::resolve_rva(0x047369B0));
            }
            return cache;
        }

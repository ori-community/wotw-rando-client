...
namespace app::classes::types {
    namespace Ucs4Decoder1234 {
        inline app::Ucs4Decoder1234__Class** type_info() {
            static app::Ucs4Decoder1234__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::Ucs4Decoder1234__Class**)(modloader::win::memory::resolve_rva(0x04784530));
            }
            return cache;
        }

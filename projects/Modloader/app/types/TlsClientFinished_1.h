...
namespace app::classes::types {
    namespace TlsClientFinished_1 {
        inline app::TlsClientFinished_1__Class** type_info() {
            static app::TlsClientFinished_1__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::TlsClientFinished_1__Class**)(modloader::win::memory::resolve_rva(0x04725C98));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace UnlockContainerItemResult_1 {
        inline app::UnlockContainerItemResult_1__Class** type_info() {
            static app::UnlockContainerItemResult_1__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::UnlockContainerItemResult_1__Class**)(modloader::win::memory::resolve_rva(0x0476D510));
            }
            return cache;
        }

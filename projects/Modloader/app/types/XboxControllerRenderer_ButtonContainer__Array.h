...
namespace app::classes::types {
    namespace XboxControllerRenderer_ButtonContainer__Array {
        inline app::XboxControllerRenderer_ButtonContainer__Array__Class** type_info() {
            static app::XboxControllerRenderer_ButtonContainer__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::XboxControllerRenderer_ButtonContainer__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

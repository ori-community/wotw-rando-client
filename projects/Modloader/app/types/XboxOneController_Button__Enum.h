...
namespace app::classes::types {
    namespace XboxOneController_Button__Enum {
        inline app::XboxOneController_Button__Enum__Class** type_info() {
            static app::XboxOneController_Button__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::XboxOneController_Button__Enum__Class**)(modloader::win::memory::resolve_rva(0x04717168));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace BlackboardVariableGameObject__Array {
        namespace {
            inline app::BlackboardVariableGameObject__Array__Class* type_info_ref = nullptr;
        }
        inline app::BlackboardVariableGameObject__Array__Class** type_info = &type_info_ref;

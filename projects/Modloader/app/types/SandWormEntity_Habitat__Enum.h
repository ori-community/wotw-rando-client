...
namespace app::classes::types {
    namespace SandWormEntity_Habitat__Enum {
        inline app::SandWormEntity_Habitat__Enum__Class** type_info() {
            static app::SandWormEntity_Habitat__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SandWormEntity_Habitat__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

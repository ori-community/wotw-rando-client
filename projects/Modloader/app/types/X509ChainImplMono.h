...
namespace app::classes::types {
    namespace X509ChainImplMono {
        inline app::X509ChainImplMono__Class** type_info() {
            static app::X509ChainImplMono__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::X509ChainImplMono__Class**)(modloader::win::memory::resolve_rva(0x047311F0));
            }
            return cache;
        }

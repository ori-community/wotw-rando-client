...
#include <Modloader/app/structs/RemoteStorageUpdatePublishedFileResult_t__Boxed.h>
...
namespace app::classes::types {
    namespace RemoteStorageUpdatePublishedFileResult_t {
        inline app::RemoteStorageUpdatePublishedFileResult_t__Class** type_info() {
            static app::RemoteStorageUpdatePublishedFileResult_t__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::RemoteStorageUpdatePublishedFileResult_t__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace RemoteStorageUpdatePublishedFileResult_t {
        namespace {
            inline app::RemoteStorageUpdatePublishedFileResult_t__Class* type_info_ref = nullptr;
        }
        inline app::RemoteStorageUpdatePublishedFileResult_t__Class** type_info = &type_info_ref;

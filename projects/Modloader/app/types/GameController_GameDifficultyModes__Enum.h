...
namespace app::classes::types {
    namespace GameController_GameDifficultyModes__Enum {
        inline app::GameController_GameDifficultyModes__Enum__Class** type_info() {
            static app::GameController_GameDifficultyModes__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::GameController_GameDifficultyModes__Enum__Class**)(modloader::win::memory::resolve_rva(0x0470DF28));
            }
            return cache;
        }

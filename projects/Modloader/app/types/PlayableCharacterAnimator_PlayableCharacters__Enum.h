...
namespace app::classes::types {
    namespace PlayableCharacterAnimator_PlayableCharacters__Enum {
        namespace {
            inline app::PlayableCharacterAnimator_PlayableCharacters__Enum__Class* type_info_ref = nullptr;
        }
        inline app::PlayableCharacterAnimator_PlayableCharacters__Enum__Class** type_info = &type_info_ref;

#pragma once
#include <Modloader/app/structs/Dictionary_2_System_UInt16_List_1_UnityEngine_Vector3___Array.h>
#include <Modloader/app/structs/Dictionary_2_System_UInt16_List_1_UnityEngine_Vector3___Array__Class.h>
#include <Modloader/il2cpp_helpers.h>
#include <Modloader/macros.h>

namespace app::classes::types {
    namespace Dictionary_2_System_UInt16_List_1_UnityEngine_Vector3___Array {
        inline app::Dictionary_2_System_UInt16_List_1_UnityEngine_Vector3___Array__Class** type_info() {
            static app::Dictionary_2_System_UInt16_List_1_UnityEngine_Vector3___Array__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::Dictionary_2_System_UInt16_List_1_UnityEngine_Vector3___Array__Class**)(modloader::win::memory::resolve_rva(0x04743720));
            }
            return cache;
        }

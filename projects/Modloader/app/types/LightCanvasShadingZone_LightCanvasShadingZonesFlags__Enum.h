...
namespace app::classes::types {
    namespace LightCanvasShadingZone_LightCanvasShadingZonesFlags__Enum {
        namespace {
            inline app::LightCanvasShadingZone_LightCanvasShadingZonesFlags__Enum__Class* type_info_ref = nullptr;
        }
        inline app::LightCanvasShadingZone_LightCanvasShadingZonesFlags__Enum__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace FieldInfo_1__Array {
        inline app::FieldInfo_1__Array__Class** type_info() {
            static app::FieldInfo_1__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::FieldInfo_1__Array__Class**)(modloader::win::memory::resolve_rva(0x04788860));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace WaterCurrentZone__Array {
        inline app::WaterCurrentZone__Array__Class** type_info() {
            static app::WaterCurrentZone__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::WaterCurrentZone__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

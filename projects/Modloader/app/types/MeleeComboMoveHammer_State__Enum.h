...
namespace app::classes::types {
    namespace MeleeComboMoveHammer_State__Enum {
        inline app::MeleeComboMoveHammer_State__Enum__Class** type_info() {
            static app::MeleeComboMoveHammer_State__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::MeleeComboMoveHammer_State__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

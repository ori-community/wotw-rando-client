...
namespace app::classes::types {
    namespace UberShaderProperty_Float__Enum__Array {
        namespace {
            inline app::UberShaderProperty_Float__Enum__Array__Class* type_info_ref = nullptr;
        }
        inline app::UberShaderProperty_Float__Enum__Array__Class** type_info = &type_info_ref;

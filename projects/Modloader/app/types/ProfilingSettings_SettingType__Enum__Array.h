...
namespace app::classes::types {
    namespace ProfilingSettings_SettingType__Enum__Array {
        inline app::ProfilingSettings_SettingType__Enum__Array__Class** type_info = (app::ProfilingSettings_SettingType__Enum__Array__Class**)(modloader::win::memory::resolve_rva(0x0478F440));

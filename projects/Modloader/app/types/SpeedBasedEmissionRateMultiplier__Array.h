...
namespace app::classes::types {
    namespace SpeedBasedEmissionRateMultiplier__Array {
        namespace {
            inline app::SpeedBasedEmissionRateMultiplier__Array__Class* type_info_ref = nullptr;
        }
        inline app::SpeedBasedEmissionRateMultiplier__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace MultiplayerServerVmUnassignmentStartedEventDataDoc {
        namespace {
            inline app::MultiplayerServerVmUnassignmentStartedEventDataDoc__Class* type_info_ref = nullptr;
        }
        inline app::MultiplayerServerVmUnassignmentStartedEventDataDoc__Class** type_info = &type_info_ref;

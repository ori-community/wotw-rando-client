...
#include <Modloader/app/structs/UnsafeNativeMethods_ManifestEtw_TRACE_GUID_INFO__Boxed.h>
#include <Modloader/app/structs/UnsafeNativeMethods_ManifestEtw_TRACE_GUID_INFO__Class.h>
#include <Modloader/il2cpp_helpers.h>
#include <Modloader/macros.h>

namespace app::classes::types {
    namespace UnsafeNativeMethods_ManifestEtw_TRACE_GUID_INFO {
        inline app::UnsafeNativeMethods_ManifestEtw_TRACE_GUID_INFO__Class** type_info() {
            static app::UnsafeNativeMethods_ManifestEtw_TRACE_GUID_INFO__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::UnsafeNativeMethods_ManifestEtw_TRACE_GUID_INFO__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

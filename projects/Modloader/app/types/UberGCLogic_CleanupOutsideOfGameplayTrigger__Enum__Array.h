...
#include <Modloader/app/structs/UberGCLogic_CleanupOutsideOfGameplayTrigger__Enum__Array__Class.h>
#include <Modloader/il2cpp_helpers.h>
#include <Modloader/macros.h>

namespace app::classes::types {
    namespace UberGCLogic_CleanupOutsideOfGameplayTrigger__Enum__Array {
        inline app::UberGCLogic_CleanupOutsideOfGameplayTrigger__Enum__Array__Class** type_info() {
            static app::UberGCLogic_CleanupOutsideOfGameplayTrigger__Enum__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::UberGCLogic_CleanupOutsideOfGameplayTrigger__Enum__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace Func_1_ZenFulcrum_EmbeddedBrowser_IPromise___Array {
        namespace {
            inline app::Func_1_ZenFulcrum_EmbeddedBrowser_IPromise___Array__Class* type_info_ref = nullptr;
        }
        inline app::Func_1_ZenFulcrum_EmbeddedBrowser_IPromise___Array__Class** type_info = &type_info_ref;

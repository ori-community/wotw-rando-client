...
namespace app::classes::types {
    namespace CameraFilterPack_Blur_GaussianBlur {
        inline app::CameraFilterPack_Blur_GaussianBlur__Class** type_info() {
            static app::CameraFilterPack_Blur_GaussianBlur__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::CameraFilterPack_Blur_GaussianBlur__Class**)(modloader::win::memory::resolve_rva(0x04799B10));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace ESteamUserStatType__Enum {
        inline app::ESteamUserStatType__Enum__Class** type_info() {
            static app::ESteamUserStatType__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::ESteamUserStatType__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

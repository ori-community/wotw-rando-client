...
namespace app::classes::types {
    namespace SneezeSlugBurrowBehaviour_State__Enum {
        namespace {
            inline app::SneezeSlugBurrowBehaviour_State__Enum__Class* type_info_ref = nullptr;
        }
        inline app::SneezeSlugBurrowBehaviour_State__Enum__Class** type_info = &type_info_ref;

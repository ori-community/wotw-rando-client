...
namespace app::classes::types {
    namespace SkinningEdge_c_DisplayClass4_0 {
        inline app::SkinningEdge_c_DisplayClass4_0__Class** type_info() {
            static app::SkinningEdge_c_DisplayClass4_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::SkinningEdge_c_DisplayClass4_0__Class**)(modloader::win::memory::resolve_rva(0x04799F10));
            }
            return cache;
        }

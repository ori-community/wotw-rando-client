...
namespace app::classes::types {
    namespace Datatype_language {
        inline app::Datatype_language__Class** type_info() {
            static app::Datatype_language__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::Datatype_language__Class**)(modloader::win::memory::resolve_rva(0x04719798));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace PreLateUpdate_UpdateMasterServerInterface {
        namespace {
            inline app::PreLateUpdate_UpdateMasterServerInterface__Class* type_info_ref = nullptr;
        }
        inline app::PreLateUpdate_UpdateMasterServerInterface__Class** type_info = &type_info_ref;

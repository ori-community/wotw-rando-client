...
namespace app::classes::types {
    namespace EControllerActionOrigin__Enum__Array {
        namespace {
            inline app::EControllerActionOrigin__Enum__Array__Class* type_info_ref = nullptr;
        }
        inline app::EControllerActionOrigin__Enum__Array__Class** type_info = &type_info_ref;

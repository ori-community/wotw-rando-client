...
namespace app::classes::types {
    namespace SavePedestal_State__Enum {
        inline app::SavePedestal_State__Enum__Class** type_info() {
            static app::SavePedestal_State__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SavePedestal_State__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

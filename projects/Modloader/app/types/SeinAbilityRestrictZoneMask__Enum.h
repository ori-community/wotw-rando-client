...
namespace app::classes::types {
    namespace SeinAbilityRestrictZoneMask__Enum {
        inline app::SeinAbilityRestrictZoneMask__Enum__Class** type_info() {
            static app::SeinAbilityRestrictZoneMask__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SeinAbilityRestrictZoneMask__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

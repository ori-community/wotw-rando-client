...
namespace app::classes::types {
    namespace SeinGlowSpell_QuickGlowSetupInfo {
        inline app::SeinGlowSpell_QuickGlowSetupInfo__Class** type_info() {
            static app::SeinGlowSpell_QuickGlowSetupInfo__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::SeinGlowSpell_QuickGlowSetupInfo__Class**)(modloader::win::memory::resolve_rva(0x04720760));
            }
            return cache;
        }

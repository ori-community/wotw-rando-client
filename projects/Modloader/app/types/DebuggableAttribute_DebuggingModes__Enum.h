...
namespace app::classes::types {
    namespace DebuggableAttribute_DebuggingModes__Enum {
        namespace {
            inline app::DebuggableAttribute_DebuggingModes__Enum__Class* type_info_ref = nullptr;
        }
        inline app::DebuggableAttribute_DebuggingModes__Enum__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace HttpConnection_InputState__Enum {
        inline app::HttpConnection_InputState__Enum__Class** type_info() {
            static app::HttpConnection_InputState__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::HttpConnection_InputState__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

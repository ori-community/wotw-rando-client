...
namespace app::classes::types {
    namespace Guid_GuidStyles__Enum {
        inline app::Guid_GuidStyles__Enum__Class** type_info() {
            static app::Guid_GuidStyles__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::Guid_GuidStyles__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace CameraFilterPack_Gradients_ElectricGradient {
        inline app::CameraFilterPack_Gradients_ElectricGradient__Class** type_info() {
            static app::CameraFilterPack_Gradients_ElectricGradient__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::CameraFilterPack_Gradients_ElectricGradient__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

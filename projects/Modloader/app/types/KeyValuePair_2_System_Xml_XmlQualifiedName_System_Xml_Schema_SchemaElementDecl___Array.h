...
#include <Modloader/app/structs/KeyValuePair_2_System_Xml_XmlQualifiedName_System_Xml_Schema_SchemaElementDecl___Array__Class.h>
...
namespace app::classes::types {
    namespace KeyValuePair_2_System_Xml_XmlQualifiedName_System_Xml_Schema_SchemaElementDecl___Array {
        namespace {
            inline app::KeyValuePair_2_System_Xml_XmlQualifiedName_System_Xml_Schema_SchemaElementDecl___Array__Class* type_info_ref = nullptr;
        }
        inline app::KeyValuePair_2_System_Xml_XmlQualifiedName_System_Xml_Schema_SchemaElementDecl___Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace WeaponMasterIdle_c {
        inline app::WeaponMasterIdle_c__Class** type_info() {
            static app::WeaponMasterIdle_c__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::WeaponMasterIdle_c__Class**)(modloader::win::memory::resolve_rva(0x0471F810));
            }
            return cache;
        }

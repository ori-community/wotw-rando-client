...
namespace app::classes::types {
    namespace UnsafeNclNativeMethods_HttpApi_HTTP_REQUEST_HEADER_ID {
        inline app::UnsafeNclNativeMethods_HttpApi_HTTP_REQUEST_HEADER_ID__Class** type_info = (app::UnsafeNclNativeMethods_HttpApi_HTTP_REQUEST_HEADER_ID__Class**)(modloader::win::memory::resolve_rva(0x04760320));

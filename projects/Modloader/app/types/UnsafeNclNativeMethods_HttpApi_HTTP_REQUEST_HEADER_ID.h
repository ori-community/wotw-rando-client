#pragma once
#include <Modloader/app/structs/UnsafeNclNativeMethods_HttpApi_HTTP_REQUEST_HEADER_ID.h>
...
namespace app::classes::types {
    namespace UnsafeNclNativeMethods_HttpApi_HTTP_REQUEST_HEADER_ID {
        inline app::UnsafeNclNativeMethods_HttpApi_HTTP_REQUEST_HEADER_ID__Class** type_info() {
            static app::UnsafeNclNativeMethods_HttpApi_HTTP_REQUEST_HEADER_ID__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::UnsafeNclNativeMethods_HttpApi_HTTP_REQUEST_HEADER_ID__Class**)(modloader::win::memory::resolve_rva(0x04760320));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace EntityHitReaction_KickbackRuleOverrideForBehaviour__Array {
        namespace {
            inline app::EntityHitReaction_KickbackRuleOverrideForBehaviour__Array__Class* type_info_ref = nullptr;
        }
        inline app::EntityHitReaction_KickbackRuleOverrideForBehaviour__Array__Class** type_info = &type_info_ref;

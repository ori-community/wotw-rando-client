...
namespace app::classes::types {
    namespace TimeSpanParse_ParseFailureKind__Enum {
        inline app::TimeSpanParse_ParseFailureKind__Enum__Class** type_info() {
            static app::TimeSpanParse_ParseFailureKind__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::TimeSpanParse_ParseFailureKind__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

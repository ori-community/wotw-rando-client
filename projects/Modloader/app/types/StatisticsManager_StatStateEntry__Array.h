...
namespace app::classes::types {
    namespace StatisticsManager_StatStateEntry__Array {
        namespace {
            inline app::StatisticsManager_StatStateEntry__Array__Class* type_info_ref = nullptr;
        }
        inline app::StatisticsManager_StatStateEntry__Array__Class** type_info = &type_info_ref;

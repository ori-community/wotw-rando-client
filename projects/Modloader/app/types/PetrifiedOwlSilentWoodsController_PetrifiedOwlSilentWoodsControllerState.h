...
namespace app::classes::types {
    namespace PetrifiedOwlSilentWoodsController_PetrifiedOwlSilentWoodsControllerState {
        namespace {
            inline app::PetrifiedOwlSilentWoodsController_PetrifiedOwlSilentWoodsControllerState__Class* type_info_ref = nullptr;
        }
        inline app::PetrifiedOwlSilentWoodsController_PetrifiedOwlSilentWoodsControllerState__Class** type_info = &type_info_ref;

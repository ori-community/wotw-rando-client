...
namespace app::classes::types {
    namespace BrowserNative_Calltype_zfb_mouseMove {
        namespace {
            inline app::BrowserNative_Calltype_zfb_mouseMove__Class* type_info_ref = nullptr;
        }
        inline app::BrowserNative_Calltype_zfb_mouseMove__Class** type_info = &type_info_ref;

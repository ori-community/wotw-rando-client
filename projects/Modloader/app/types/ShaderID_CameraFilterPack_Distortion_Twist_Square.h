...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_Distortion_Twist_Square {
        inline app::ShaderID_CameraFilterPack_Distortion_Twist_Square__Class** type_info() {
            static app::ShaderID_CameraFilterPack_Distortion_Twist_Square__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ShaderID_CameraFilterPack_Distortion_Twist_Square__Class**)(modloader::win::memory::resolve_rva(0x04796E30));
            }
            return cache;
        }

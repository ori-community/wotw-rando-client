...
namespace app::classes::types {
    namespace Datatype_untypedAtomicType {
        inline app::Datatype_untypedAtomicType__Class** type_info() {
            static app::Datatype_untypedAtomicType__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::Datatype_untypedAtomicType__Class**)(modloader::win::memory::resolve_rva(0x04745878));
            }
            return cache;
        }

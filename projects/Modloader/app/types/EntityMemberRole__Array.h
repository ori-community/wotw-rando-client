...
namespace app::classes::types {
    namespace EntityMemberRole__Array {
        inline app::EntityMemberRole__Array__Class** type_info() {
            static app::EntityMemberRole__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::EntityMemberRole__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

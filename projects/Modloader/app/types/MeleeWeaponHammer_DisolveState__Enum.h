...
namespace app::classes::types {
    namespace MeleeWeaponHammer_DisolveState__Enum {
        namespace {
            inline app::MeleeWeaponHammer_DisolveState__Enum__Class* type_info_ref = nullptr;
        }
        inline app::MeleeWeaponHammer_DisolveState__Enum__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace KwolokBossBehaviourZones_ZoneAndState__Array {
        namespace {
            inline app::KwolokBossBehaviourZones_ZoneAndState__Array__Class* type_info_ref = nullptr;
        }
        inline app::KwolokBossBehaviourZones_ZoneAndState__Array__Class** type_info = &type_info_ref;

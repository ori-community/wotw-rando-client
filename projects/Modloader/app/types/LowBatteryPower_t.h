...
namespace app::classes::types {
    namespace LowBatteryPower_t {
        inline app::LowBatteryPower_t__Class** type_info() {
            static app::LowBatteryPower_t__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::LowBatteryPower_t__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace EarlyUpdate_PollHtcsPlayerConnection {
        namespace {
            inline app::EarlyUpdate_PollHtcsPlayerConnection__Class* type_info_ref = nullptr;
        }
        inline app::EarlyUpdate_PollHtcsPlayerConnection__Class** type_info = &type_info_ref;

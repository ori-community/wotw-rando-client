...
namespace app::classes::types {
    namespace PlayFabStatistics_c_DisplayClass14_0 {
        inline app::PlayFabStatistics_c_DisplayClass14_0__Class** type_info() {
            static app::PlayFabStatistics_c_DisplayClass14_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::PlayFabStatistics_c_DisplayClass14_0__Class**)(modloader::win::memory::resolve_rva(0x0475ADF0));
            }
            return cache;
        }

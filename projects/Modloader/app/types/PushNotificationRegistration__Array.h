...
namespace app::classes::types {
    namespace PushNotificationRegistration__Array {
        namespace {
            inline app::PushNotificationRegistration__Array__Class* type_info_ref = nullptr;
        }
        inline app::PushNotificationRegistration__Array__Class** type_info = &type_info_ref;

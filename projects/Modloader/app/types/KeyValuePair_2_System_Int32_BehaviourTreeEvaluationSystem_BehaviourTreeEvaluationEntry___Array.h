...
#include <Modloader/app/structs/KeyValuePair_2_System_Int32_BehaviourTreeEvaluationSystem_BehaviourTreeEvaluationEntry___Array__Class.h>
#include <Modloader/app/structs/KeyValuePair_2_System_Int32_BehaviourTreeEvaluationSystem_BehaviourTreeEvaluationEntry___Array.h>

namespace app::classes::types {
    namespace KeyValuePair_2_System_Int32_BehaviourTreeEvaluationSystem_BehaviourTreeEvaluationEntry___Array {
        namespace {
            inline app::KeyValuePair_2_System_Int32_BehaviourTreeEvaluationSystem_BehaviourTreeEvaluationEntry___Array__Class* type_info_ref = nullptr;
        }
        inline app::KeyValuePair_2_System_Int32_BehaviourTreeEvaluationSystem_BehaviourTreeEvaluationEntry___Array__Class** type_info = &type_info_ref;

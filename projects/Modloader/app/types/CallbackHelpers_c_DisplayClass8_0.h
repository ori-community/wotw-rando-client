...
namespace app::classes::types {
    namespace CallbackHelpers_c_DisplayClass8_0 {
        inline app::CallbackHelpers_c_DisplayClass8_0__Class** type_info() {
            static app::CallbackHelpers_c_DisplayClass8_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::CallbackHelpers_c_DisplayClass8_0__Class**)(modloader::win::memory::resolve_rva(0x0471C328));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace PauseMenuInventoryElements_UberStateToElement__Array {
        inline app::PauseMenuInventoryElements_UberStateToElement__Array__Class** type_info() {
            static app::PauseMenuInventoryElements_UberStateToElement__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::PauseMenuInventoryElements_UberStateToElement__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

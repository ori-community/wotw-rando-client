...
namespace app::classes::types {
    namespace NodeDataUI__Array {
        inline app::NodeDataUI__Array__Class** type_info() {
            static app::NodeDataUI__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::NodeDataUI__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

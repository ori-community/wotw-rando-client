...
namespace app::classes::types {
    namespace RockyEnemySpiritLeashedState {
        inline app::RockyEnemySpiritLeashedState__Class** type_info() {
            static app::RockyEnemySpiritLeashedState__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::RockyEnemySpiritLeashedState__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

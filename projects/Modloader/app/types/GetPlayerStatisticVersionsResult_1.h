...
namespace app::classes::types {
    namespace GetPlayerStatisticVersionsResult_1 {
        inline app::GetPlayerStatisticVersionsResult_1__Class** type_info = (app::GetPlayerStatisticVersionsResult_1__Class**)(modloader::win::memory::resolve_rva(0x0471E930));

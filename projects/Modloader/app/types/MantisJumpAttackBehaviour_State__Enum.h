...
namespace app::classes::types {
    namespace MantisJumpAttackBehaviour_State__Enum {
        namespace {
            inline app::MantisJumpAttackBehaviour_State__Enum__Class* type_info_ref = nullptr;
        }
        inline app::MantisJumpAttackBehaviour_State__Enum__Class** type_info = &type_info_ref;

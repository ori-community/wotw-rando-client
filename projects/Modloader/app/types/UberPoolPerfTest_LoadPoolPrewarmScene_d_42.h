...
namespace app::classes::types {
    namespace UberPoolPerfTest_LoadPoolPrewarmScene_d_42 {
        namespace {
            inline app::UberPoolPerfTest_LoadPoolPrewarmScene_d_42__Class* type_info_ref = nullptr;
        }
        inline app::UberPoolPerfTest_LoadPoolPrewarmScene_d_42__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace ICleverMenuFadeObserver__Array {
        inline app::ICleverMenuFadeObserver__Array__Class** type_info() {
            static app::ICleverMenuFadeObserver__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::ICleverMenuFadeObserver__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

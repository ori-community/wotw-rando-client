...
namespace app::classes::types {
    namespace XblAchievement_1 {
        inline app::XblAchievement_1__Class** type_info() {
            static app::XblAchievement_1__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::XblAchievement_1__Class**)(modloader::win::memory::resolve_rva(0x04732490));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace EquipmentSelectionGrid_EquipmentAnchorGroup__Array {
        inline app::EquipmentSelectionGrid_EquipmentAnchorGroup__Array__Class** type_info() {
            static app::EquipmentSelectionGrid_EquipmentAnchorGroup__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::EquipmentSelectionGrid_EquipmentAnchorGroup__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

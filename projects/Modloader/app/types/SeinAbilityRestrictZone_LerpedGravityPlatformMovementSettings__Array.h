...
namespace app::classes::types {
    namespace SeinAbilityRestrictZone_LerpedGravityPlatformMovementSettings__Array {
        namespace {
            inline app::SeinAbilityRestrictZone_LerpedGravityPlatformMovementSettings__Array__Class* type_info_ref = nullptr;
        }
        inline app::SeinAbilityRestrictZone_LerpedGravityPlatformMovementSettings__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace HasEnoughExperienceCondition_ComparisonMode__Enum {
        inline app::HasEnoughExperienceCondition_ComparisonMode__Enum__Class** type_info() {
            static app::HasEnoughExperienceCondition_ComparisonMode__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::HasEnoughExperienceCondition_ComparisonMode__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace CameraFilterPack_AAA_BloodOnScreen {
        inline app::CameraFilterPack_AAA_BloodOnScreen__Class** type_info() {
            static app::CameraFilterPack_AAA_BloodOnScreen__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::CameraFilterPack_AAA_BloodOnScreen__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

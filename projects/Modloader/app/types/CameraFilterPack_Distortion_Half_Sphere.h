...
namespace app::classes::types {
    namespace CameraFilterPack_Distortion_Half_Sphere {
        inline app::CameraFilterPack_Distortion_Half_Sphere__Class** type_info = (app::CameraFilterPack_Distortion_Half_Sphere__Class**)(modloader::win::memory::resolve_rva(0x0478D7D8));

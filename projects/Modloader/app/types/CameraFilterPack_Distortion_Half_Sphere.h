...
#include <Modloader/app/structs/CameraFilterPack_Distortion_Half_Sphere__Class.h>
#include <Modloader/il2cpp_helpers.h>
#include <Modloader/macros.h>

namespace app::classes::types {
    namespace CameraFilterPack_Distortion_Half_Sphere {
        inline app::CameraFilterPack_Distortion_Half_Sphere__Class** type_info() {
            static app::CameraFilterPack_Distortion_Half_Sphere__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::CameraFilterPack_Distortion_Half_Sphere__Class**)(modloader::win::memory::resolve_rva(0x0478D7D8));
            }
            return cache;
        }

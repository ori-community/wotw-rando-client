...
#include <Modloader/app/structs/Dictionary_2_TKey_TValue_Entry_System_Reflection_FieldInfo_System_Linq_Expressions_Interpreter_Instruction___Array__Class.h>
#include <Modloader/app/structs/Dictionary_2_TKey_TValue_Entry_System_Reflection_FieldInfo_System_Linq_Expressions_Interpreter_Instruction___Array.h>
...
namespace app::classes::types {
    namespace Dictionary_2_TKey_TValue_Entry_System_Reflection_FieldInfo_System_Linq_Expressions_Interpreter_Instruction___Array {
        namespace {
            inline app::Dictionary_2_TKey_TValue_Entry_System_Reflection_FieldInfo_System_Linq_Expressions_Interpreter_Instruction___Array__Class* type_info_ref = nullptr;
        }
        inline app::Dictionary_2_TKey_TValue_Entry_System_Reflection_FieldInfo_System_Linq_Expressions_Interpreter_Instruction___Array__Class** type_info = &type_info_ref;

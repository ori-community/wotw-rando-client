...
namespace app::classes::types {
    namespace DepthOfField_TweakMode__Enum {
        inline app::DepthOfField_TweakMode__Enum__Class** type_info() {
            static app::DepthOfField_TweakMode__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::DepthOfField_TweakMode__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

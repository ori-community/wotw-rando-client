...
namespace app::classes::types {
    namespace Dictionary_2_TKey_TValue_Entry_PlayFab_PluginContractKey_PlayFab_IPlayFabPlugin___Array {
        namespace {
            inline app::Dictionary_2_TKey_TValue_Entry_PlayFab_PluginContractKey_PlayFab_IPlayFabPlugin___Array__Class* type_info_ref = nullptr;
        }
        inline app::Dictionary_2_TKey_TValue_Entry_PlayFab_PluginContractKey_PlayFab_IPlayFabPlugin___Array__Class** type_info = &type_info_ref;

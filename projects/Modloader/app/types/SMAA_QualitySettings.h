...
namespace app::classes::types {
    namespace SMAA_QualitySettings {
        inline app::SMAA_QualitySettings__Class** type_info() {
            static app::SMAA_QualitySettings__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::SMAA_QualitySettings__Class**)(modloader::win::memory::resolve_rva(0x04777208));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace EventPayload_GetEnumerator_d_17 {
        inline app::EventPayload_GetEnumerator_d_17__Class** type_info() {
            static app::EventPayload_GetEnumerator_d_17__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::EventPayload_GetEnumerator_d_17__Class**)(modloader::win::memory::resolve_rva(0x04750C28));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace _PrivateImplementationDetails_StaticArrayInitTypeSize_72 {
        inline app::_PrivateImplementationDetails_StaticArrayInitTypeSize_72__Class** type_info() {
            static app::_PrivateImplementationDetails_StaticArrayInitTypeSize_72__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::_PrivateImplementationDetails_StaticArrayInitTypeSize_72__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

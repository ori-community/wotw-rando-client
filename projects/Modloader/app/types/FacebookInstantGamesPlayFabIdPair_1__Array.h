...
namespace app::classes::types {
    namespace FacebookInstantGamesPlayFabIdPair_1__Array {
        namespace {
            inline app::FacebookInstantGamesPlayFabIdPair_1__Array__Class* type_info_ref = nullptr;
        }
        inline app::FacebookInstantGamesPlayFabIdPair_1__Array__Class** type_info = &type_info_ref;

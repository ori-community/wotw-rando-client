...
namespace app::classes::types {
    namespace FacebookInstantGamesPlayFabIdPair_1__Array {
        inline app::FacebookInstantGamesPlayFabIdPair_1__Array__Class** type_info() {
            static app::FacebookInstantGamesPlayFabIdPair_1__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::FacebookInstantGamesPlayFabIdPair_1__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

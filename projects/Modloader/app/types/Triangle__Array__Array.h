...
namespace app::classes::types {
    namespace Triangle__Array__Array {
        inline app::Triangle__Array__Array__Class** type_info() {
            static app::Triangle__Array__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::Triangle__Array__Array__Class**)(modloader::win::memory::resolve_rva(0x04782C08));
            }
            return cache;
        }

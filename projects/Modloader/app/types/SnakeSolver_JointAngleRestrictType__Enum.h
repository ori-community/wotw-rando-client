...
namespace app::classes::types {
    namespace SnakeSolver_JointAngleRestrictType__Enum {
        namespace {
            inline app::SnakeSolver_JointAngleRestrictType__Enum__Class* type_info_ref = nullptr;
        }
        inline app::SnakeSolver_JointAngleRestrictType__Enum__Class** type_info = &type_info_ref;

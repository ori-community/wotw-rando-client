...
namespace app::classes::types {
    namespace NormalizationForm__Enum {
        inline app::NormalizationForm__Enum__Class** type_info() {
            static app::NormalizationForm__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::NormalizationForm__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

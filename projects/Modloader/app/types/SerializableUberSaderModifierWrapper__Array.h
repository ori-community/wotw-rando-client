...
namespace app::classes::types {
    namespace SerializableUberSaderModifierWrapper__Array {
        namespace {
            inline app::SerializableUberSaderModifierWrapper__Array__Class* type_info_ref = nullptr;
        }
        inline app::SerializableUberSaderModifierWrapper__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace GroundPatrolWithDirectionTask_GroundPatrolDirectionMode__Enum {
        namespace {
            inline app::GroundPatrolWithDirectionTask_GroundPatrolDirectionMode__Enum__Class* type_info_ref = nullptr;
        }
        inline app::GroundPatrolWithDirectionTask_GroundPatrolDirectionMode__Enum__Class** type_info = &type_info_ref;

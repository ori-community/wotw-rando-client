#pragma once
#include <Modloader/app/structs/CameraFilterPack_TV_BrokenGlass.h>
...
namespace app::classes::types {
    namespace CameraFilterPack_TV_BrokenGlass {
        inline app::CameraFilterPack_TV_BrokenGlass__Class** type_info() {
            static app::CameraFilterPack_TV_BrokenGlass__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::CameraFilterPack_TV_BrokenGlass__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

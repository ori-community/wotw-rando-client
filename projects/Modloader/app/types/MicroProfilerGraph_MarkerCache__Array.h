...
namespace app::classes::types {
    namespace MicroProfilerGraph_MarkerCache__Array {
        inline app::MicroProfilerGraph_MarkerCache__Array__Class** type_info() {
            static app::MicroProfilerGraph_MarkerCache__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::MicroProfilerGraph_MarkerCache__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

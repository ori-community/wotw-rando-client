...
namespace app::classes::types {
    namespace ShaderID_ImageEffects {
        inline app::ShaderID_ImageEffects__Class** type_info() {
            static app::ShaderID_ImageEffects__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ShaderID_ImageEffects__Class**)(modloader::win::memory::resolve_rva(0x0472DE48));
            }
            return cache;
        }

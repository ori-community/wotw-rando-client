...
namespace app::classes::types {
    namespace CameraFilterPack_NightVisionFX_preset__Enum {
        inline app::CameraFilterPack_NightVisionFX_preset__Enum__Class** type_info() {
            static app::CameraFilterPack_NightVisionFX_preset__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::CameraFilterPack_NightVisionFX_preset__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

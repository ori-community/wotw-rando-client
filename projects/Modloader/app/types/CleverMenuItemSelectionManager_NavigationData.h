...
namespace app::classes::types {
    namespace CleverMenuItemSelectionManager_NavigationData {
        inline app::CleverMenuItemSelectionManager_NavigationData__Class** type_info() {
            static app::CleverMenuItemSelectionManager_NavigationData__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::CleverMenuItemSelectionManager_NavigationData__Class**)(modloader::win::memory::resolve_rva(0x04784D28));
            }
            return cache;
        }

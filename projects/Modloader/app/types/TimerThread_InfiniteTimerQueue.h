...
namespace app::classes::types {
    namespace TimerThread_InfiniteTimerQueue {
        inline app::TimerThread_InfiniteTimerQueue__Class** type_info() {
            static app::TimerThread_InfiniteTimerQueue__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::TimerThread_InfiniteTimerQueue__Class**)(modloader::win::memory::resolve_rva(0x047774F0));
            }
            return cache;
        }

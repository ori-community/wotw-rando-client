...
namespace app::classes::types {
    namespace GhostWorldObjectsLifetimePlugin_WorldRecordableEventsData_ActionType__Enum {
        namespace {
            inline app::GhostWorldObjectsLifetimePlugin_WorldRecordableEventsData_ActionType__Enum__Class* type_info_ref = nullptr;
        }
        inline app::GhostWorldObjectsLifetimePlugin_WorldRecordableEventsData_ActionType__Enum__Class** type_info = &type_info_ref;

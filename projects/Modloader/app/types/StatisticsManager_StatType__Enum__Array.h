...
namespace app::classes::types {
    namespace StatisticsManager_StatType__Enum__Array {
        namespace {
            inline app::StatisticsManager_StatType__Enum__Array__Class* type_info_ref = nullptr;
        }
        inline app::StatisticsManager_StatType__Enum__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace SceneLoadingTest_LoadAndUnloadScene_d_20 {
        inline app::SceneLoadingTest_LoadAndUnloadScene_d_20__Class** type_info() {
            static app::SceneLoadingTest_LoadAndUnloadScene_d_20__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SceneLoadingTest_LoadAndUnloadScene_d_20__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

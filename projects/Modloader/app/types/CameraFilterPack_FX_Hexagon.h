...
namespace app::classes::types {
    namespace CameraFilterPack_FX_Hexagon {
        inline app::CameraFilterPack_FX_Hexagon__Class** type_info() {
            static app::CameraFilterPack_FX_Hexagon__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::CameraFilterPack_FX_Hexagon__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
#include <Modloader/app/structs/MeleeComboMoveHammerChargeable_State__Enum__Class.h>
#include <Modloader/il2cpp_helpers.h>
#include <Modloader/macros.h>

namespace app::classes::types {
    namespace MeleeComboMoveHammerChargeable_State__Enum {
        inline app::MeleeComboMoveHammerChargeable_State__Enum__Class** type_info() {
            static app::MeleeComboMoveHammerChargeable_State__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::MeleeComboMoveHammerChargeable_State__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

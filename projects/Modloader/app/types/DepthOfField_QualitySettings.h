...
namespace app::classes::types {
    namespace DepthOfField_QualitySettings {
        inline app::DepthOfField_QualitySettings__Class** type_info() {
            static app::DepthOfField_QualitySettings__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::DepthOfField_QualitySettings__Class**)(modloader::win::memory::resolve_rva(0x047421D8));
            }
            return cache;
        }

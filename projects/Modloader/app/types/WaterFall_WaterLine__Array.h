...
namespace app::classes::types {
    namespace WaterFall_WaterLine__Array {
        inline app::WaterFall_WaterLine__Array__Class** type_info() {
            static app::WaterFall_WaterLine__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::WaterFall_WaterLine__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

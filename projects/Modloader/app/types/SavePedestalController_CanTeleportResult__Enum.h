...
namespace app::classes::types {
    namespace SavePedestalController_CanTeleportResult__Enum {
        namespace {
            inline app::SavePedestalController_CanTeleportResult__Enum__Class* type_info_ref = nullptr;
        }
        inline app::SavePedestalController_CanTeleportResult__Enum__Class** type_info = &type_info_ref;

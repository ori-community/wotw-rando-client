...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_FX_8bits {
        inline app::ShaderID_CameraFilterPack_FX_8bits__Class** type_info = (app::ShaderID_CameraFilterPack_FX_8bits__Class**)(modloader::win::memory::resolve_rva(0x0470C210));

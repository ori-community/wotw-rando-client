...
namespace app::classes::types {
    namespace ReflectionUtils_GetDelegate__Array {
        namespace {
            inline app::ReflectionUtils_GetDelegate__Array__Class* type_info_ref = nullptr;
        }
        inline app::ReflectionUtils_GetDelegate__Array__Class** type_info = &type_info_ref;

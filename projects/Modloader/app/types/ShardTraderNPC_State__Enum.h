...
namespace app::classes::types {
    namespace ShardTraderNPC_State__Enum {
        inline app::ShardTraderNPC_State__Enum__Class** type_info() {
            static app::ShardTraderNPC_State__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::ShardTraderNPC_State__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

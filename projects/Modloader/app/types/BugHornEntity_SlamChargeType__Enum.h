...
namespace app::classes::types {
    namespace BugHornEntity_SlamChargeType__Enum {
        inline app::BugHornEntity_SlamChargeType__Enum__Class** type_info() {
            static app::BugHornEntity_SlamChargeType__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::BugHornEntity_SlamChargeType__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

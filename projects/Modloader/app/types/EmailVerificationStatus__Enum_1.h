...
namespace app::classes::types {
    namespace EmailVerificationStatus__Enum_1 {
        inline app::EmailVerificationStatus__Enum_1__Class** type_info() {
            static app::EmailVerificationStatus__Enum_1__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::EmailVerificationStatus__Enum_1__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

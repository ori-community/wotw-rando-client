...
namespace app::classes::types {
    namespace MaskedTextProvider_CharDescriptor {
        inline app::MaskedTextProvider_CharDescriptor__Class** type_info() {
            static app::MaskedTextProvider_CharDescriptor__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::MaskedTextProvider_CharDescriptor__Class**)(modloader::win::memory::resolve_rva(0x047917E8));
            }
            return cache;
        }

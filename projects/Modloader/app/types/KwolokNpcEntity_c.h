...
namespace app::classes::types {
    namespace KwolokNpcEntity_c {
        inline app::KwolokNpcEntity_c__Class** type_info() {
            static app::KwolokNpcEntity_c__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::KwolokNpcEntity_c__Class**)(modloader::win::memory::resolve_rva(0x04765468));
            }
            return cache;
        }

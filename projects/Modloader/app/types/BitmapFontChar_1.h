...
namespace app::classes::types {
    namespace BitmapFontChar_1 {
        inline app::BitmapFontChar_1__Class** type_info() {
            static app::BitmapFontChar_1__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::BitmapFontChar_1__Class**)(modloader::win::memory::resolve_rva(0x0474B588));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace IVRSystem_GetEventTypeNameFromEnum {
        inline app::IVRSystem_GetEventTypeNameFromEnum__Class** type_info() {
            static app::IVRSystem_GetEventTypeNameFromEnum__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::IVRSystem_GetEventTypeNameFromEnum__Class**)(modloader::win::memory::resolve_rva(0x04780860));
            }
            return cache;
        }

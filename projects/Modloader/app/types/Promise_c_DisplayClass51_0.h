...
namespace app::classes::types {
    namespace Promise_c_DisplayClass51_0 {
        inline app::Promise_c_DisplayClass51_0__Class** type_info() {
            static app::Promise_c_DisplayClass51_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::Promise_c_DisplayClass51_0__Class**)(modloader::win::memory::resolve_rva(0x047424E0));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace MoonRenderPipelineAsset_DeferredLightingDebug__Enum {
        namespace {
            inline app::MoonRenderPipelineAsset_DeferredLightingDebug__Enum__Class* type_info_ref = nullptr;
        }
        inline app::MoonRenderPipelineAsset_DeferredLightingDebug__Enum__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace VirtualTimelineRepresentationGroup__Enum {
        inline app::VirtualTimelineRepresentationGroup__Enum__Class** type_info = (app::VirtualTimelineRepresentationGroup__Enum__Class**)(modloader::win::memory::resolve_rva(0x04768478));

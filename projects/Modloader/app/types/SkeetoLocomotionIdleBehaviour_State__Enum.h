...
namespace app::classes::types {
    namespace SkeetoLocomotionIdleBehaviour_State__Enum {
        namespace {
            inline app::SkeetoLocomotionIdleBehaviour_State__Enum__Class* type_info_ref = nullptr;
        }
        inline app::SkeetoLocomotionIdleBehaviour_State__Enum__Class** type_info = &type_info_ref;

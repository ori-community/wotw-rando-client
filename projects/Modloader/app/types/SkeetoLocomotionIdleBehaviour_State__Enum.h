...
#include <Modloader/app/structs/SkeetoLocomotionIdleBehaviour_State__Enum__Class.h>
#include <Modloader/il2cpp_helpers.h>
#include <Modloader/macros.h>

namespace app::classes::types {
    namespace SkeetoLocomotionIdleBehaviour_State__Enum {
        inline app::SkeetoLocomotionIdleBehaviour_State__Enum__Class** type_info() {
            static app::SkeetoLocomotionIdleBehaviour_State__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SkeetoLocomotionIdleBehaviour_State__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

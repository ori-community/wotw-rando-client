...
namespace app::classes::types {
    namespace CryptoStream_WriteAsyncInternal_d_37 {
        namespace {
            inline app::CryptoStream_WriteAsyncInternal_d_37__Class* type_info_ref = nullptr;
        }
        inline app::CryptoStream_WriteAsyncInternal_d_37__Class** type_info = &type_info_ref;

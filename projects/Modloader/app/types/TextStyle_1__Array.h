...
namespace app::classes::types {
    namespace TextStyle_1__Array {
        inline app::TextStyle_1__Array__Class** type_info() {
            static app::TextStyle_1__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::TextStyle_1__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

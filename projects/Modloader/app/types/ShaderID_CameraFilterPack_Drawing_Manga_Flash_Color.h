...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_Drawing_Manga_Flash_Color {
        inline app::ShaderID_CameraFilterPack_Drawing_Manga_Flash_Color__Class** type_info = (app::ShaderID_CameraFilterPack_Drawing_Manga_Flash_Color__Class**)(modloader::win::memory::resolve_rva(0x047538A0));

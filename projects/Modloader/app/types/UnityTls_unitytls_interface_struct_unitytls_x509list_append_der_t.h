...
namespace app::classes::types {
    namespace UnityTls_unitytls_interface_struct_unitytls_x509list_append_der_t {
        inline app::UnityTls_unitytls_interface_struct_unitytls_x509list_append_der_t__Class** type_info = (app::UnityTls_unitytls_interface_struct_unitytls_x509list_append_der_t__Class**)(modloader::win::memory::resolve_rva(0x0477C170));

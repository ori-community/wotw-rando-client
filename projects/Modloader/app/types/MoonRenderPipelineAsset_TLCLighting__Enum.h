...
namespace app::classes::types {
    namespace MoonRenderPipelineAsset_TLCLighting__Enum {
        namespace {
            inline app::MoonRenderPipelineAsset_TLCLighting__Enum__Class* type_info_ref = nullptr;
        }
        inline app::MoonRenderPipelineAsset_TLCLighting__Enum__Class** type_info = &type_info_ref;

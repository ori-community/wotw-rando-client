...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_FX_Drunk {
        inline app::ShaderID_CameraFilterPack_FX_Drunk__Class** type_info = (app::ShaderID_CameraFilterPack_FX_Drunk__Class**)(modloader::win::memory::resolve_rva(0x04762B20));

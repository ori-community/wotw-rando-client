...
namespace app::classes::types {
    namespace SpiderBossAcidAttack_c_DisplayClass36_0 {
        inline app::SpiderBossAcidAttack_c_DisplayClass36_0__Class** type_info() {
            static app::SpiderBossAcidAttack_c_DisplayClass36_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::SpiderBossAcidAttack_c_DisplayClass36_0__Class**)(modloader::win::memory::resolve_rva(0x04716F50));
            }
            return cache;
        }

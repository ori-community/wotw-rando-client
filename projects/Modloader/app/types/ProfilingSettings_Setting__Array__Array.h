...
namespace app::classes::types {
    namespace ProfilingSettings_Setting__Array__Array {
        inline app::ProfilingSettings_Setting__Array__Array__Class** type_info() {
            static app::ProfilingSettings_Setting__Array__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::ProfilingSettings_Setting__Array__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace BaseSpline_SplineSegmentType__Enum {
        namespace {
            inline app::BaseSpline_SplineSegmentType__Enum__Class* type_info_ref = nullptr;
        }
        inline app::BaseSpline_SplineSegmentType__Enum__Class** type_info = &type_info_ref;

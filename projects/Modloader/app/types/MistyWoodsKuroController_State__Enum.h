...
namespace app::classes::types {
    namespace MistyWoodsKuroController_State__Enum {
        namespace {
            inline app::MistyWoodsKuroController_State__Enum__Class* type_info_ref = nullptr;
        }
        inline app::MistyWoodsKuroController_State__Enum__Class** type_info = &type_info_ref;

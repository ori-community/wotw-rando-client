...
namespace app::classes::types {
    namespace AkCommonAdvancedSettings_SpatialAudioSettings {
        inline app::AkCommonAdvancedSettings_SpatialAudioSettings__Class** type_info() {
            static app::AkCommonAdvancedSettings_SpatialAudioSettings__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::AkCommonAdvancedSettings_SpatialAudioSettings__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

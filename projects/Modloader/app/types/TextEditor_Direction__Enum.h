...
namespace app::classes::types {
    namespace TextEditor_Direction__Enum {
        inline app::TextEditor_Direction__Enum__Class** type_info() {
            static app::TextEditor_Direction__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::TextEditor_Direction__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

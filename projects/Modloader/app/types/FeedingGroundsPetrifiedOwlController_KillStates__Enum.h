...
namespace app::classes::types {
    namespace FeedingGroundsPetrifiedOwlController_KillStates__Enum {
        namespace {
            inline app::FeedingGroundsPetrifiedOwlController_KillStates__Enum__Class* type_info_ref = nullptr;
        }
        inline app::FeedingGroundsPetrifiedOwlController_KillStates__Enum__Class** type_info = &type_info_ref;

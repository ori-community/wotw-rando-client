...
#include <Modloader/app/structs/KeyValuePair_2_System_Object_System_Runtime_Serialization_DataContractAttribute___Array__Class.h>
...
namespace app::classes::types {
    namespace KeyValuePair_2_System_Object_System_Runtime_Serialization_DataContractAttribute___Array {
        namespace {
            inline app::KeyValuePair_2_System_Object_System_Runtime_Serialization_DataContractAttribute___Array__Class* type_info_ref = nullptr;
        }
        inline app::KeyValuePair_2_System_Object_System_Runtime_Serialization_DataContractAttribute___Array__Class** type_info = &type_info_ref;

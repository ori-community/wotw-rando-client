...
namespace app::classes::types {
    namespace HashSet_1_T_Slot_UnityEngine_Vector2___Array {
        namespace {
            inline app::HashSet_1_T_Slot_UnityEngine_Vector2___Array__Class* type_info_ref = nullptr;
        }
        inline app::HashSet_1_T_Slot_UnityEngine_Vector2___Array__Class** type_info = &type_info_ref;

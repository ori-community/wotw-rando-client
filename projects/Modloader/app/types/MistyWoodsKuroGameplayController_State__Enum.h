...
namespace app::classes::types {
    namespace MistyWoodsKuroGameplayController_State__Enum {
        inline app::MistyWoodsKuroGameplayController_State__Enum__Class** type_info() {
            static app::MistyWoodsKuroGameplayController_State__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::MistyWoodsKuroGameplayController_State__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace SceneSettingsTransitionZone_Direction__Enum {
        namespace {
            inline app::SceneSettingsTransitionZone_Direction__Enum__Class* type_info_ref = nullptr;
        }
        inline app::SceneSettingsTransitionZone_Direction__Enum__Class** type_info = &type_info_ref;

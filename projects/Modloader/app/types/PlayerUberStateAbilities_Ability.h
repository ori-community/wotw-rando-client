...
namespace app::classes::types {
    namespace PlayerUberStateAbilities_Ability {
        inline app::PlayerUberStateAbilities_Ability__Class** type_info() {
            static app::PlayerUberStateAbilities_Ability__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::PlayerUberStateAbilities_Ability__Class**)(modloader::win::memory::resolve_rva(0x04799F88));
            }
            return cache;
        }

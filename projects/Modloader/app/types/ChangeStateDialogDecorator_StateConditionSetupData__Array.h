...
namespace app::classes::types {
    namespace ChangeStateDialogDecorator_StateConditionSetupData__Array {
        namespace {
            inline app::ChangeStateDialogDecorator_StateConditionSetupData__Array__Class* type_info_ref = nullptr;
        }
        inline app::ChangeStateDialogDecorator_StateConditionSetupData__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace XHashtable_1_TValue_XHashtableState_TValue_Entry_System_Object___Array {
        namespace {
            inline app::XHashtable_1_TValue_XHashtableState_TValue_Entry_System_Object___Array__Class* type_info_ref = nullptr;
        }
        inline app::XHashtable_1_TValue_XHashtableState_TValue_Entry_System_Object___Array__Class** type_info = &type_info_ref;

...
#include <Modloader/app/structs/Dictionary_2_TKey_TValue_Entry_Moon_Timeline_ITimelineEntity_Moon_Timeline_ITimelineEntityParent___Array__Class.h>
#include <Modloader/app/structs/Dictionary_2_TKey_TValue_Entry_Moon_Timeline_ITimelineEntity_Moon_Timeline_ITimelineEntityParent___Array.h>

namespace app::classes::types {
    namespace Dictionary_2_TKey_TValue_Entry_Moon_Timeline_ITimelineEntity_Moon_Timeline_ITimelineEntityParent___Array {
        namespace {
            inline app::Dictionary_2_TKey_TValue_Entry_Moon_Timeline_ITimelineEntity_Moon_Timeline_ITimelineEntityParent___Array__Class* type_info_ref = nullptr;
        }
        inline app::Dictionary_2_TKey_TValue_Entry_Moon_Timeline_ITimelineEntity_Moon_Timeline_ITimelineEntityParent___Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace MainThreadWorkStealer_WorkStealingMode__Enum__Array {
        namespace {
            inline app::MainThreadWorkStealer_WorkStealingMode__Enum__Array__Class* type_info_ref = nullptr;
        }
        inline app::MainThreadWorkStealer_WorkStealingMode__Enum__Array__Class** type_info = &type_info_ref;

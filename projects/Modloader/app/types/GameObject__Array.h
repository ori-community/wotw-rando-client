...
namespace app::classes::types {
    namespace GameObject__Array {
        inline app::GameObject__Array__Class** type_info() {
            static app::GameObject__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::GameObject__Array__Class**)(modloader::win::memory::resolve_rva(0x04711C80));
            }
            return cache;
        }

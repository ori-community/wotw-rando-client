...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_Colors_Adjust_PreFilters {
        inline app::ShaderID_CameraFilterPack_Colors_Adjust_PreFilters__Class** type_info = (app::ShaderID_CameraFilterPack_Colors_Adjust_PreFilters__Class**)(modloader::win::memory::resolve_rva(0x0470FBA8));

...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_Blend2Camera_Subtract {
        inline app::ShaderID_CameraFilterPack_Blend2Camera_Subtract__Class** type_info = (app::ShaderID_CameraFilterPack_Blend2Camera_Subtract__Class**)(modloader::win::memory::resolve_rva(0x04760E40));

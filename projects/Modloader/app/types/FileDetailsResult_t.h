...
namespace app::classes::types {
    namespace FileDetailsResult_t {
        inline app::FileDetailsResult_t__Class** type_info() {
            static app::FileDetailsResult_t__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::FileDetailsResult_t__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_Blend2Camera_SplitScreen {
        inline app::ShaderID_CameraFilterPack_Blend2Camera_SplitScreen__Class** type_info() {
            static app::ShaderID_CameraFilterPack_Blend2Camera_SplitScreen__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ShaderID_CameraFilterPack_Blend2Camera_SplitScreen__Class**)(modloader::win::memory::resolve_rva(0x047387A8));
            }
            return cache;
        }

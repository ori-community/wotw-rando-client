...
namespace app::classes::types {
    namespace VRBrowserPanel__Array {
        inline app::VRBrowserPanel__Array__Class** type_info() {
            static app::VRBrowserPanel__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::VRBrowserPanel__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

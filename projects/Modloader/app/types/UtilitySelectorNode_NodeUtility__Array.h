...
namespace app::classes::types {
    namespace UtilitySelectorNode_NodeUtility__Array {
        namespace {
            inline app::UtilitySelectorNode_NodeUtility__Array__Class* type_info_ref = nullptr;
        }
        inline app::UtilitySelectorNode_NodeUtility__Array__Class** type_info = &type_info_ref;

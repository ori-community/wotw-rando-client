...
#include <Modloader/app/structs/Dictionary_2_TKey_TValue_Entry_EntityWeightData_EntityWeight_EntityWeightData_EntityWeightSettings___Array__Class.h>
#include <Modloader/app/structs/Dictionary_2_TKey_TValue_Entry_EntityWeightData_EntityWeight_EntityWeightData_EntityWeightSettings___Array.h>
...
namespace app::classes::types {
    namespace Dictionary_2_TKey_TValue_Entry_EntityWeightData_EntityWeight_EntityWeightData_EntityWeightSettings___Array {
        namespace {
            inline app::Dictionary_2_TKey_TValue_Entry_EntityWeightData_EntityWeight_EntityWeightData_EntityWeightSettings___Array__Class* type_info_ref = nullptr;
        }
        inline app::Dictionary_2_TKey_TValue_Entry_EntityWeightData_EntityWeight_EntityWeightData_EntityWeightSettings___Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace SteamInventoryStartPurchaseResult_t {
        namespace {
            inline app::SteamInventoryStartPurchaseResult_t__Class* type_info_ref = nullptr;
        }
        inline app::SteamInventoryStartPurchaseResult_t__Class** type_info = &type_info_ref;

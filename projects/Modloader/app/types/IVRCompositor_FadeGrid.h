...
namespace app::classes::types {
    namespace IVRCompositor_FadeGrid {
        inline app::IVRCompositor_FadeGrid__Class** type_info() {
            static app::IVRCompositor_FadeGrid__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::IVRCompositor_FadeGrid__Class**)(modloader::win::memory::resolve_rva(0x04741DA8));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace ExpandoObject_ValueCollection_GetEnumerator_d_15 {
        inline app::ExpandoObject_ValueCollection_GetEnumerator_d_15__Class** type_info() {
            static app::ExpandoObject_ValueCollection_GetEnumerator_d_15__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ExpandoObject_ValueCollection_GetEnumerator_d_15__Class**)(modloader::win::memory::resolve_rva(0x047799B0));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace TextBoxIconsFontGenerator_IconData__Array {
        namespace {
            inline app::TextBoxIconsFontGenerator_IconData__Array__Class* type_info_ref = nullptr;
        }
        inline app::TextBoxIconsFontGenerator_IconData__Array__Class** type_info = &type_info_ref;

#pragma once
#include <Modloader/app/structs/AdvancedDebugMenuPage_c_DisplayClass65_0.h>
...
namespace app::classes::types {
    namespace AdvancedDebugMenuPage_c_DisplayClass65_0 {
        inline app::AdvancedDebugMenuPage_c_DisplayClass65_0__Class** type_info() {
            static app::AdvancedDebugMenuPage_c_DisplayClass65_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::AdvancedDebugMenuPage_c_DisplayClass65_0__Class**)(modloader::win::memory::resolve_rva(0x047886B8));
            }
            return cache;
        }

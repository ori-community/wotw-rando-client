...
namespace app::classes::types {
    namespace WandererEntity_WandererAnimationState__Enum {
        namespace {
            inline app::WandererEntity_WandererAnimationState__Enum__Class* type_info_ref = nullptr;
        }
        inline app::WandererEntity_WandererAnimationState__Enum__Class** type_info = &type_info_ref;

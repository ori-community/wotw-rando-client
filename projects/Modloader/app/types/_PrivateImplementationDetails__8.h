...
namespace app::classes::types {
    namespace _PrivateImplementationDetails__8 {
        inline app::_PrivateImplementationDetails__8__Class** type_info() {
            static app::_PrivateImplementationDetails__8__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::_PrivateImplementationDetails__8__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

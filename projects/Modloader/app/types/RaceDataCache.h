...
namespace app::classes::types {
    namespace RaceDataCache {
        inline app::RaceDataCache__Class** type_info() {
            static app::RaceDataCache__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::RaceDataCache__Class**)(modloader::win::memory::resolve_rva(0x0477F458));
            }
            return cache;
        }

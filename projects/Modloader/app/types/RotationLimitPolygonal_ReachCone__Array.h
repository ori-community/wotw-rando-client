...
namespace app::classes::types {
    namespace RotationLimitPolygonal_ReachCone__Array {
        inline app::RotationLimitPolygonal_ReachCone__Array__Class** type_info() {
            static app::RotationLimitPolygonal_ReachCone__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::RotationLimitPolygonal_ReachCone__Array__Class**)(modloader::win::memory::resolve_rva(0x0477C940));
            }
            return cache;
        }

...
#include <Modloader/app/structs/InteractionLightModifier_GetKeywordsForShader_d_10__Class.h>
#include <Modloader/il2cpp_helpers.h>
#include <Modloader/macros.h>

namespace app::classes::types {
    namespace InteractionLightModifier_GetKeywordsForShader_d_10 {
        inline app::InteractionLightModifier_GetKeywordsForShader_d_10__Class** type_info() {
            static app::InteractionLightModifier_GetKeywordsForShader_d_10__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::InteractionLightModifier_GetKeywordsForShader_d_10__Class**)(modloader::win::memory::resolve_rva(0x04739C20));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace ShaderID_DebugRenderer {
        inline app::ShaderID_DebugRenderer__Class** type_info() {
            static app::ShaderID_DebugRenderer__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ShaderID_DebugRenderer__Class**)(modloader::win::memory::resolve_rva(0x0472C200));
            }
            return cache;
        }

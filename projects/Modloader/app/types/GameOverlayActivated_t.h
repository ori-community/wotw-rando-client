...
namespace app::classes::types {
    namespace GameOverlayActivated_t {
        inline app::GameOverlayActivated_t__Class** type_info() {
            static app::GameOverlayActivated_t__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::GameOverlayActivated_t__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

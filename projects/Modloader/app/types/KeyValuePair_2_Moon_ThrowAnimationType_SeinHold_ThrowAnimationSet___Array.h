...
namespace app::classes::types {
    namespace KeyValuePair_2_Moon_ThrowAnimationType_SeinHold_ThrowAnimationSet___Array {
        namespace {
            inline app::KeyValuePair_2_Moon_ThrowAnimationType_SeinHold_ThrowAnimationSet___Array__Class* type_info_ref = nullptr;
        }
        inline app::KeyValuePair_2_Moon_ThrowAnimationType_SeinHold_ThrowAnimationSet___Array__Class** type_info = &type_info_ref;

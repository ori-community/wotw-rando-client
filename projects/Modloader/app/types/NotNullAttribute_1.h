...
namespace app::classes::types {
    namespace NotNullAttribute_1 {
        inline app::NotNullAttribute_1__Class** type_info() {
            static app::NotNullAttribute_1__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::NotNullAttribute_1__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

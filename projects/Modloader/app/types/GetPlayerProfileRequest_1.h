...
namespace app::classes::types {
    namespace GetPlayerProfileRequest_1 {
        inline app::GetPlayerProfileRequest_1__Class** type_info() {
            static app::GetPlayerProfileRequest_1__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::GetPlayerProfileRequest_1__Class**)(modloader::win::memory::resolve_rva(0x04710A00));
            }
            return cache;
        }

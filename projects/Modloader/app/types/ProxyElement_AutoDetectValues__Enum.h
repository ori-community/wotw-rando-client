...
namespace app::classes::types {
    namespace ProxyElement_AutoDetectValues__Enum {
        inline app::ProxyElement_AutoDetectValues__Enum__Class** type_info() {
            static app::ProxyElement_AutoDetectValues__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::ProxyElement_AutoDetectValues__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace ShaderID_AmbientOcclusion {
        inline app::ShaderID_AmbientOcclusion__Class** type_info() {
            static app::ShaderID_AmbientOcclusion__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ShaderID_AmbientOcclusion__Class**)(modloader::win::memory::resolve_rva(0x047957F8));
            }
            return cache;
        }

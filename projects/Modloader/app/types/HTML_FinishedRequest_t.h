...
namespace app::classes::types {
    namespace HTML_FinishedRequest_t {
        inline app::HTML_FinishedRequest_t__Class** type_info() {
            static app::HTML_FinishedRequest_t__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::HTML_FinishedRequest_t__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

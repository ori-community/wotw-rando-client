...
namespace app::classes::types {
    namespace PetrifiedOwlBossAnimationDirectionBrainController {
        namespace {
            inline app::PetrifiedOwlBossAnimationDirectionBrainController__Class* type_info_ref = nullptr;
        }
        inline app::PetrifiedOwlBossAnimationDirectionBrainController__Class** type_info = &type_info_ref;

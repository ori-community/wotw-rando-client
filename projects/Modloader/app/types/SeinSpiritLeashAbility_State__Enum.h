...
namespace app::classes::types {
    namespace SeinSpiritLeashAbility_State__Enum {
        inline app::SeinSpiritLeashAbility_State__Enum__Class** type_info() {
            static app::SeinSpiritLeashAbility_State__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SeinSpiritLeashAbility_State__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace SeinSpiritLeashAbility_State__Enum {
        namespace {
            inline app::SeinSpiritLeashAbility_State__Enum__Class* type_info_ref = nullptr;
        }
        inline app::SeinSpiritLeashAbility_State__Enum__Class** type_info = &type_info_ref;

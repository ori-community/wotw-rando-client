...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_FX_InverChromiLum {
        inline app::ShaderID_CameraFilterPack_FX_InverChromiLum__Class** type_info = (app::ShaderID_CameraFilterPack_FX_InverChromiLum__Class**)(modloader::win::memory::resolve_rva(0x04765118));

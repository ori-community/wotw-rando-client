...
namespace app::classes::types {
    namespace Action_1_System_Collections_Generic_IEnumerable_1___Array {
        inline app::Action_1_System_Collections_Generic_IEnumerable_1___Array__Class** type_info() {
            static app::Action_1_System_Collections_Generic_IEnumerable_1___Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::Action_1_System_Collections_Generic_IEnumerable_1___Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

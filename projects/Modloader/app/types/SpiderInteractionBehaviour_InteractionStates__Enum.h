...
namespace app::classes::types {
    namespace SpiderInteractionBehaviour_InteractionStates__Enum {
        inline app::SpiderInteractionBehaviour_InteractionStates__Enum__Class** type_info() {
            static app::SpiderInteractionBehaviour_InteractionStates__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::SpiderInteractionBehaviour_InteractionStates__Enum__Class**)(modloader::win::memory::resolve_rva(0x04779E30));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace InteractionSystem_InteractionEventDelegate {
        namespace {
            inline app::InteractionSystem_InteractionEventDelegate__Class* type_info_ref = nullptr;
        }
        inline app::InteractionSystem_InteractionEventDelegate__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace SpiderBossBehaviourZone__Enum__Array {
        namespace {
            inline app::SpiderBossBehaviourZone__Enum__Array__Class* type_info_ref = nullptr;
        }
        inline app::SpiderBossBehaviourZone__Enum__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace GraphicRaycaster_BlockingObjects__Enum {
        namespace {
            inline app::GraphicRaycaster_BlockingObjects__Enum__Class* type_info_ref = nullptr;
        }
        inline app::GraphicRaycaster_BlockingObjects__Enum__Class** type_info = &type_info_ref;

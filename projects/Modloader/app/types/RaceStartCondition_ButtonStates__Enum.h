...
namespace app::classes::types {
    namespace RaceStartCondition_ButtonStates__Enum {
        inline app::RaceStartCondition_ButtonStates__Enum__Class** type_info() {
            static app::RaceStartCondition_ButtonStates__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::RaceStartCondition_ButtonStates__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace ContactEmailInfoModel_1 {
        inline app::ContactEmailInfoModel_1__Class** type_info() {
            static app::ContactEmailInfoModel_1__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::ContactEmailInfoModel_1__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

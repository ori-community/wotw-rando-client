...
namespace app::classes::types {
    namespace Environment_SpecialFolder__Enum {
        inline app::Environment_SpecialFolder__Enum__Class** type_info() {
            static app::Environment_SpecialFolder__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::Environment_SpecialFolder__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

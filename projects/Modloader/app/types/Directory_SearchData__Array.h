...
namespace app::classes::types {
    namespace Directory_SearchData__Array {
        inline app::Directory_SearchData__Array__Class** type_info() {
            static app::Directory_SearchData__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::Directory_SearchData__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

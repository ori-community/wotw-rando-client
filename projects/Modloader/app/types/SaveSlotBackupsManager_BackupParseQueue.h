...
namespace app::classes::types {
    namespace SaveSlotBackupsManager_BackupParseQueue {
        inline app::SaveSlotBackupsManager_BackupParseQueue__Class** type_info = (app::SaveSlotBackupsManager_BackupParseQueue__Class**)(modloader::win::memory::resolve_rva(0x047788E8));

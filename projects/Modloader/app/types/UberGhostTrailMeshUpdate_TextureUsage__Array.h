...
namespace app::classes::types {
    namespace UberGhostTrailMeshUpdate_TextureUsage__Array {
        namespace {
            inline app::UberGhostTrailMeshUpdate_TextureUsage__Array__Class* type_info_ref = nullptr;
        }
        inline app::UberGhostTrailMeshUpdate_TextureUsage__Array__Class** type_info = &type_info_ref;

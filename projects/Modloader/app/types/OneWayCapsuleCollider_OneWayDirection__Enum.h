...
namespace app::classes::types {
    namespace OneWayCapsuleCollider_OneWayDirection__Enum {
        namespace {
            inline app::OneWayCapsuleCollider_OneWayDirection__Enum__Class* type_info_ref = nullptr;
        }
        inline app::OneWayCapsuleCollider_OneWayDirection__Enum__Class** type_info = &type_info_ref;

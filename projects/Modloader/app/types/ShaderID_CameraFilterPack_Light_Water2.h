...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_Light_Water2 {
        inline app::ShaderID_CameraFilterPack_Light_Water2__Class** type_info() {
            static app::ShaderID_CameraFilterPack_Light_Water2__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ShaderID_CameraFilterPack_Light_Water2__Class**)(modloader::win::memory::resolve_rva(0x04733650));
            }
            return cache;
        }

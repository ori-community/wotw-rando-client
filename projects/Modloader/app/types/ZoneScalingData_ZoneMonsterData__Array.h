...
namespace app::classes::types {
    namespace ZoneScalingData_ZoneMonsterData__Array {
        namespace {
            inline app::ZoneScalingData_ZoneMonsterData__Array__Class* type_info_ref = nullptr;
        }
        inline app::ZoneScalingData_ZoneMonsterData__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace SteamPartyBeaconLocation_t__Array {
        inline app::SteamPartyBeaconLocation_t__Array__Class** type_info() {
            static app::SteamPartyBeaconLocation_t__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SteamPartyBeaconLocation_t__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

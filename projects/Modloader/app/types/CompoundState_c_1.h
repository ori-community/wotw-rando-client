...
namespace app::classes::types {
    namespace CompoundState_c_1 {
        inline app::CompoundState_c_1__Class** type_info() {
            static app::CompoundState_c_1__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::CompoundState_c_1__Class**)(modloader::win::memory::resolve_rva(0x0477ACD8));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace ResourcesUnloadingProfilingSetting {
        namespace {
            inline app::ResourcesUnloadingProfilingSetting__Class* type_info_ref = nullptr;
        }
        inline app::ResourcesUnloadingProfilingSetting__Class** type_info = &type_info_ref;

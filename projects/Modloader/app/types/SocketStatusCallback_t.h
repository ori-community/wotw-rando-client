...
namespace app::classes::types {
    namespace SocketStatusCallback_t {
        inline app::SocketStatusCallback_t__Class** type_info() {
            static app::SocketStatusCallback_t__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SocketStatusCallback_t__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

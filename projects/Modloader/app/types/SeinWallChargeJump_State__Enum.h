...
namespace app::classes::types {
    namespace SeinWallChargeJump_State__Enum {
        inline app::SeinWallChargeJump_State__Enum__Class** type_info() {
            static app::SeinWallChargeJump_State__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SeinWallChargeJump_State__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

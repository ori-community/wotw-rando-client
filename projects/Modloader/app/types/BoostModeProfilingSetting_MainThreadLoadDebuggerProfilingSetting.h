...
namespace app::classes::types {
    namespace BoostModeProfilingSetting_MainThreadLoadDebuggerProfilingSetting {
        namespace {
            inline app::BoostModeProfilingSetting_MainThreadLoadDebuggerProfilingSetting__Class* type_info_ref = nullptr;
        }
        inline app::BoostModeProfilingSetting_MainThreadLoadDebuggerProfilingSetting__Class** type_info = &type_info_ref;

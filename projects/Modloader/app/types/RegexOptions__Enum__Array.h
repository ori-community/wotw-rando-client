...
namespace app::classes::types {
    namespace RegexOptions__Enum__Array {
        inline app::RegexOptions__Enum__Array__Class** type_info() {
            static app::RegexOptions__Enum__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::RegexOptions__Enum__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

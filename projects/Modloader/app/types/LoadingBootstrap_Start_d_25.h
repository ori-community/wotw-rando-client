...
namespace app::classes::types {
    namespace LoadingBootstrap_Start_d_25 {
        inline app::LoadingBootstrap_Start_d_25__Class** type_info() {
            static app::LoadingBootstrap_Start_d_25__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::LoadingBootstrap_Start_d_25__Class**)(modloader::win::memory::resolve_rva(0x04742DA8));
            }
            return cache;
        }

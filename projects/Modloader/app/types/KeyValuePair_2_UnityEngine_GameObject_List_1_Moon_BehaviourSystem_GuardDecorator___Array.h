...
#include <Modloader/app/structs/KeyValuePair_2_UnityEngine_GameObject_List_1_Moon_BehaviourSystem_GuardDecorator___Array__Class.h>
...
namespace app::classes::types {
    namespace KeyValuePair_2_UnityEngine_GameObject_List_1_Moon_BehaviourSystem_GuardDecorator___Array {
        namespace {
            inline app::KeyValuePair_2_UnityEngine_GameObject_List_1_Moon_BehaviourSystem_GuardDecorator___Array__Class* type_info_ref = nullptr;
        }
        inline app::KeyValuePair_2_UnityEngine_GameObject_List_1_Moon_BehaviourSystem_GuardDecorator___Array__Class** type_info = &type_info_ref;

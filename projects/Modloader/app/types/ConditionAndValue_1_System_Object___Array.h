...
namespace app::classes::types {
    namespace ConditionAndValue_1_System_Object___Array {
        namespace {
            inline app::ConditionAndValue_1_System_Object___Array__Class* type_info_ref = nullptr;
        }
        inline app::ConditionAndValue_1_System_Object___Array__Class** type_info = &type_info_ref;

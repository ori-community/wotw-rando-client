...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_Fly_Vision {
        inline app::ShaderID_CameraFilterPack_Fly_Vision__Class** type_info = (app::ShaderID_CameraFilterPack_Fly_Vision__Class**)(modloader::win::memory::resolve_rva(0x04756D40));

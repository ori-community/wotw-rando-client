...
namespace app::classes::types {
    namespace CameraFilterPack_FX_Glitch2 {
        inline app::CameraFilterPack_FX_Glitch2__Class** type_info() {
            static app::CameraFilterPack_FX_Glitch2__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::CameraFilterPack_FX_Glitch2__Class**)(modloader::win::memory::resolve_rva(0x04758DF8));
            }
            return cache;
        }

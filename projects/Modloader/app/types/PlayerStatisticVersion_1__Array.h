...
namespace app::classes::types {
    namespace PlayerStatisticVersion_1__Array {
        inline app::PlayerStatisticVersion_1__Array__Class** type_info() {
            static app::PlayerStatisticVersion_1__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::PlayerStatisticVersion_1__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

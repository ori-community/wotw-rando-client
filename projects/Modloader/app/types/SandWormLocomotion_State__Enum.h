...
namespace app::classes::types {
    namespace SandWormLocomotion_State__Enum {
        inline app::SandWormLocomotion_State__Enum__Class** type_info() {
            static app::SandWormLocomotion_State__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SandWormLocomotion_State__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

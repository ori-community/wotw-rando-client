...
namespace app::classes::types {
    namespace MobileAuthenticatedStream_OperationType__Enum {
        namespace {
            inline app::MobileAuthenticatedStream_OperationType__Enum__Class* type_info_ref = nullptr;
        }
        inline app::MobileAuthenticatedStream_OperationType__Enum__Class** type_info = &type_info_ref;

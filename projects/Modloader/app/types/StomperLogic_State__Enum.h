...
namespace app::classes::types {
    namespace StomperLogic_State__Enum {
        inline app::StomperLogic_State__Enum__Class** type_info() {
            static app::StomperLogic_State__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::StomperLogic_State__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace RuntimeSliceRenderSettings_DofCurveMode__Enum {
        namespace {
            inline app::RuntimeSliceRenderSettings_DofCurveMode__Enum__Class* type_info_ref = nullptr;
        }
        inline app::RuntimeSliceRenderSettings_DofCurveMode__Enum__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace EarlyUpdate_ScriptRunDelayedStartupFrame {
        inline app::EarlyUpdate_ScriptRunDelayedStartupFrame__Class** type_info() {
            static app::EarlyUpdate_ScriptRunDelayedStartupFrame__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::EarlyUpdate_ScriptRunDelayedStartupFrame__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace StrippableBuildContex_Platform__Enum {
        namespace {
            inline app::StrippableBuildContex_Platform__Enum__Class* type_info_ref = nullptr;
        }
        inline app::StrippableBuildContex_Platform__Enum__Class** type_info = &type_info_ref;

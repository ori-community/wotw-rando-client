...
namespace app::classes::types {
    namespace SceneManagementSystem_SceneLoadedState__Array {
        inline app::SceneManagementSystem_SceneLoadedState__Array__Class** type_info() {
            static app::SceneManagementSystem_SceneLoadedState__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SceneManagementSystem_SceneLoadedState__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

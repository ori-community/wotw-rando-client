...
namespace app::classes::types {
    namespace DataProvider_c_DisplayClass14_0 {
        inline app::DataProvider_c_DisplayClass14_0__Class** type_info() {
            static app::DataProvider_c_DisplayClass14_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::DataProvider_c_DisplayClass14_0__Class**)(modloader::win::memory::resolve_rva(0x0475AC98));
            }
            return cache;
        }

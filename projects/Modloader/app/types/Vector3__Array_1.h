...
namespace app::classes::types {
    namespace Vector3__Array_1 {
        inline app::Vector3__Array_1__Class** type_info() {
            static app::Vector3__Array_1__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::Vector3__Array_1__Class**)(modloader::win::memory::resolve_rva(0x0474C390));
            }
            return cache;
        }

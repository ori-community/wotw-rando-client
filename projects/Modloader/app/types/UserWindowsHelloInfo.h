...
namespace app::classes::types {
    namespace UserWindowsHelloInfo {
        inline app::UserWindowsHelloInfo__Class** type_info() {
            static app::UserWindowsHelloInfo__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::UserWindowsHelloInfo__Class**)(modloader::win::memory::resolve_rva(0x04736950));
            }
            return cache;
        }

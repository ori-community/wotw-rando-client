#pragma once
#include <Modloader/app/structs/KeyValuePair_2_GameMapPins_PinColour_GameMapPins_Pin___Array.h>
#include <Modloader/app/structs/KeyValuePair_2_GameMapPins_PinColour_GameMapPins_Pin___Array__Class.h>
#include <Modloader/il2cpp_helpers.h>
#include <Modloader/macros.h>

namespace app::classes::types {
    namespace KeyValuePair_2_GameMapPins_PinColour_GameMapPins_Pin___Array {
        inline app::KeyValuePair_2_GameMapPins_PinColour_GameMapPins_Pin___Array__Class** type_info() {
            static app::KeyValuePair_2_GameMapPins_PinColour_GameMapPins_Pin___Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::KeyValuePair_2_GameMapPins_PinColour_GameMapPins_Pin___Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

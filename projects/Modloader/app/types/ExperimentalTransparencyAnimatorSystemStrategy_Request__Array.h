...
namespace app::classes::types {
    namespace ExperimentalTransparencyAnimatorSystemStrategy_Request__Array {
        inline app::ExperimentalTransparencyAnimatorSystemStrategy_Request__Array__Class** type_info() {
            static app::ExperimentalTransparencyAnimatorSystemStrategy_Request__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::ExperimentalTransparencyAnimatorSystemStrategy_Request__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

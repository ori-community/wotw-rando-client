...
namespace app::classes::types {
    namespace SpiritLightCapsuleVisualAffector__Array {
        namespace {
            inline app::SpiritLightCapsuleVisualAffector__Array__Class* type_info_ref = nullptr;
        }
        inline app::SpiritLightCapsuleVisualAffector__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace NotEqualInstruction_NotEqualCharLiftedToNull {
        inline app::NotEqualInstruction_NotEqualCharLiftedToNull__Class** type_info() {
            static app::NotEqualInstruction_NotEqualCharLiftedToNull__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::NotEqualInstruction_NotEqualCharLiftedToNull__Class**)(modloader::win::memory::resolve_rva(0x047907E0));
            }
            return cache;
        }

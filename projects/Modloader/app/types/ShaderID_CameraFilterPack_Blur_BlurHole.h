...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_Blur_BlurHole {
        inline app::ShaderID_CameraFilterPack_Blur_BlurHole__Class** type_info = (app::ShaderID_CameraFilterPack_Blur_BlurHole__Class**)(modloader::win::memory::resolve_rva(0x04727718));

...
namespace app::classes::types {
    namespace MoonAnimator_AnimatorPostprocessData {
        inline app::MoonAnimator_AnimatorPostprocessData__Class** type_info = (app::MoonAnimator_AnimatorPostprocessData__Class**)(modloader::win::memory::resolve_rva(0x04797C00));

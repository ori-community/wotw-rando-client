...
namespace app::classes::types {
    namespace ScreenSpaceReflection_PassIndex__Enum {
        namespace {
            inline app::ScreenSpaceReflection_PassIndex__Enum__Class* type_info_ref = nullptr;
        }
        inline app::ScreenSpaceReflection_PassIndex__Enum__Class** type_info = &type_info_ref;

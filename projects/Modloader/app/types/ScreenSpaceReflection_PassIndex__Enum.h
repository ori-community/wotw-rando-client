...
namespace app::classes::types {
    namespace ScreenSpaceReflection_PassIndex__Enum {
        inline app::ScreenSpaceReflection_PassIndex__Enum__Class** type_info() {
            static app::ScreenSpaceReflection_PassIndex__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::ScreenSpaceReflection_PassIndex__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

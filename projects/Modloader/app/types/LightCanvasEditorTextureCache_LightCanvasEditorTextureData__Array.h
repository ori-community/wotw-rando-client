...
namespace app::classes::types {
    namespace LightCanvasEditorTextureCache_LightCanvasEditorTextureData__Array {
        namespace {
            inline app::LightCanvasEditorTextureCache_LightCanvasEditorTextureData__Array__Class* type_info_ref = nullptr;
        }
        inline app::LightCanvasEditorTextureCache_LightCanvasEditorTextureData__Array__Class** type_info = &type_info_ref;

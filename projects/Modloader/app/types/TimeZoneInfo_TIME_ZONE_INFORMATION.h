...
namespace app::classes::types {
    namespace TimeZoneInfo_TIME_ZONE_INFORMATION {
        namespace {
            inline app::TimeZoneInfo_TIME_ZONE_INFORMATION__Class* type_info_ref = nullptr;
        }
        inline app::TimeZoneInfo_TIME_ZONE_INFORMATION__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_Vision_Blood_Fast {
        inline app::ShaderID_CameraFilterPack_Vision_Blood_Fast__Class** type_info = (app::ShaderID_CameraFilterPack_Vision_Blood_Fast__Class**)(modloader::win::memory::resolve_rva(0x04779170));

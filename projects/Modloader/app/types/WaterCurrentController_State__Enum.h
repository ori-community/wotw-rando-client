...
namespace app::classes::types {
    namespace WaterCurrentController_State__Enum {
        namespace {
            inline app::WaterCurrentController_State__Enum__Class* type_info_ref = nullptr;
        }
        inline app::WaterCurrentController_State__Enum__Class** type_info = &type_info_ref;

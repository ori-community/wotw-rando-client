...
namespace app::classes::types {
    namespace LocomotionTimelineAnimation__Array {
        namespace {
            inline app::LocomotionTimelineAnimation__Array__Class* type_info_ref = nullptr;
        }
        inline app::LocomotionTimelineAnimation__Array__Class** type_info = &type_info_ref;

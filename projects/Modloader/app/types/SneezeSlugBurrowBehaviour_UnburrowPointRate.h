...
namespace app::classes::types {
    namespace SneezeSlugBurrowBehaviour_UnburrowPointRate {
        inline app::SneezeSlugBurrowBehaviour_UnburrowPointRate__Class** type_info() {
            static app::SneezeSlugBurrowBehaviour_UnburrowPointRate__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::SneezeSlugBurrowBehaviour_UnburrowPointRate__Class**)(modloader::win::memory::resolve_rva(0x04784538));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace WebResponse_1 {
        inline app::WebResponse_1__Class** type_info() {
            static app::WebResponse_1__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::WebResponse_1__Class**)(modloader::win::memory::resolve_rva(0x04713D08));
            }
            return cache;
        }

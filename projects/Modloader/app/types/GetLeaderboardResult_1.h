...
namespace app::classes::types {
    namespace GetLeaderboardResult_1 {
        inline app::GetLeaderboardResult_1__Class** type_info() {
            static app::GetLeaderboardResult_1__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::GetLeaderboardResult_1__Class**)(modloader::win::memory::resolve_rva(0x0474D720));
            }
            return cache;
        }

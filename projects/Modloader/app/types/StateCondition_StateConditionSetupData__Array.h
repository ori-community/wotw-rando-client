...
namespace app::classes::types {
    namespace StateCondition_StateConditionSetupData__Array {
        inline app::StateCondition_StateConditionSetupData__Array__Class** type_info() {
            static app::StateCondition_StateConditionSetupData__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::StateCondition_StateConditionSetupData__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

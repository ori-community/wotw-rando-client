...
namespace app::classes::types {
    namespace LoremasterReplayController_State__Enum {
        namespace {
            inline app::LoremasterReplayController_State__Enum__Class* type_info_ref = nullptr;
        }
        inline app::LoremasterReplayController_State__Enum__Class** type_info = &type_info_ref;

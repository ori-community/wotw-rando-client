...
namespace app::classes::types {
    namespace LoremasterReplayController_State__Enum {
        inline app::LoremasterReplayController_State__Enum__Class** type_info() {
            static app::LoremasterReplayController_State__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::LoremasterReplayController_State__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

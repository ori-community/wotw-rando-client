...
namespace app::classes::types {
    namespace UserStatsUnloaded_t {
        inline app::UserStatsUnloaded_t__Class** type_info() {
            static app::UserStatsUnloaded_t__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::UserStatsUnloaded_t__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

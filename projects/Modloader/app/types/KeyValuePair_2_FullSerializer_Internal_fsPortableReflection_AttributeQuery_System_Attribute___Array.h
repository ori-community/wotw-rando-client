...
namespace app::classes::types {
    namespace KeyValuePair_2_FullSerializer_Internal_fsPortableReflection_AttributeQuery_System_Attribute___Array {
        namespace {
            inline app::KeyValuePair_2_FullSerializer_Internal_fsPortableReflection_AttributeQuery_System_Attribute___Array__Class* type_info_ref = nullptr;
        }
        inline app::KeyValuePair_2_FullSerializer_Internal_fsPortableReflection_AttributeQuery_System_Attribute___Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace JoinClanChatRoomCompletionResult_t {
        namespace {
            inline app::JoinClanChatRoomCompletionResult_t__Class* type_info_ref = nullptr;
        }
        inline app::JoinClanChatRoomCompletionResult_t__Class** type_info = &type_info_ref;

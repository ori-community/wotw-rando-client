...
namespace app::classes::types {
    namespace EOverlayDirection__Enum {
        inline app::EOverlayDirection__Enum__Class** type_info() {
            static app::EOverlayDirection__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::EOverlayDirection__Enum__Class**)(modloader::win::memory::resolve_rva(0x04791208));
            }
            return cache;
        }

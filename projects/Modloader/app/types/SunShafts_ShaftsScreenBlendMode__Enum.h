...
namespace app::classes::types {
    namespace SunShafts_ShaftsScreenBlendMode__Enum {
        namespace {
            inline app::SunShafts_ShaftsScreenBlendMode__Enum__Class* type_info_ref = nullptr;
        }
        inline app::SunShafts_ShaftsScreenBlendMode__Enum__Class** type_info = &type_info_ref;

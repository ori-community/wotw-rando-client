...
namespace app::classes::types {
    namespace PetrifiedOwlBossFinalComboBehaviour_DiveVerticalState {
        inline app::PetrifiedOwlBossFinalComboBehaviour_DiveVerticalState__Class** type_info() {
            static app::PetrifiedOwlBossFinalComboBehaviour_DiveVerticalState__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::PetrifiedOwlBossFinalComboBehaviour_DiveVerticalState__Class**)(modloader::win::memory::resolve_rva(0x04765B78));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace CleverMenuItemSelectionManager_Direction__Enum {
        namespace {
            inline app::CleverMenuItemSelectionManager_Direction__Enum__Class* type_info_ref = nullptr;
        }
        inline app::CleverMenuItemSelectionManager_Direction__Enum__Class** type_info = &type_info_ref;

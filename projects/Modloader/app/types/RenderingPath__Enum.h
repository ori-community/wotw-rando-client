...
namespace app::classes::types {
    namespace RenderingPath__Enum {
        inline app::RenderingPath__Enum__Class** type_info() {
            static app::RenderingPath__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::RenderingPath__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

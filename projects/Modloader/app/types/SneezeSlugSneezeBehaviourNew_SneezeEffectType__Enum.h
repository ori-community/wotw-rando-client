...
namespace app::classes::types {
    namespace SneezeSlugSneezeBehaviourNew_SneezeEffectType__Enum {
        namespace {
            inline app::SneezeSlugSneezeBehaviourNew_SneezeEffectType__Enum__Class* type_info_ref = nullptr;
        }
        inline app::SneezeSlugSneezeBehaviourNew_SneezeEffectType__Enum__Class** type_info = &type_info_ref;

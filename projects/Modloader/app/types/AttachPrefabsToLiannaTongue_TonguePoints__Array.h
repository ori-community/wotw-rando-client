...
namespace app::classes::types {
    namespace AttachPrefabsToLiannaTongue_TonguePoints__Array {
        namespace {
            inline app::AttachPrefabsToLiannaTongue_TonguePoints__Array__Class* type_info_ref = nullptr;
        }
        inline app::AttachPrefabsToLiannaTongue_TonguePoints__Array__Class** type_info = &type_info_ref;

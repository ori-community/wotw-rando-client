...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_Drawing_Paper2 {
        inline app::ShaderID_CameraFilterPack_Drawing_Paper2__Class** type_info() {
            static app::ShaderID_CameraFilterPack_Drawing_Paper2__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ShaderID_CameraFilterPack_Drawing_Paper2__Class**)(modloader::win::memory::resolve_rva(0x04743CC8));
            }
            return cache;
        }

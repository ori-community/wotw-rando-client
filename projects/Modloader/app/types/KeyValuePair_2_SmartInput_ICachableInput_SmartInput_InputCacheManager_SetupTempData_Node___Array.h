...
#include <Modloader/app/structs/KeyValuePair_2_SmartInput_ICachableInput_SmartInput_InputCacheManager_SetupTempData_Node___Array__Class.h>
#include <Modloader/app/structs/KeyValuePair_2_SmartInput_ICachableInput_SmartInput_InputCacheManager_SetupTempData_Node___Array.h>

namespace app::classes::types {
    namespace KeyValuePair_2_SmartInput_ICachableInput_SmartInput_InputCacheManager_SetupTempData_Node___Array {
        namespace {
            inline app::KeyValuePair_2_SmartInput_ICachableInput_SmartInput_InputCacheManager_SetupTempData_Node___Array__Class* type_info_ref = nullptr;
        }
        inline app::KeyValuePair_2_SmartInput_ICachableInput_SmartInput_InputCacheManager_SetupTempData_Node___Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace List_1_Moon_CrossSceneDependencyInjector___Array {
        namespace {
            inline app::List_1_Moon_CrossSceneDependencyInjector___Array__Class* type_info_ref = nullptr;
        }
        inline app::List_1_Moon_CrossSceneDependencyInjector___Array__Class** type_info = &type_info_ref;

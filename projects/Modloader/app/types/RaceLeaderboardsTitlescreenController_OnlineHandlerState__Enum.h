...
namespace app::classes::types {
    namespace RaceLeaderboardsTitlescreenController_OnlineHandlerState__Enum {
        namespace {
            inline app::RaceLeaderboardsTitlescreenController_OnlineHandlerState__Enum__Class* type_info_ref = nullptr;
        }
        inline app::RaceLeaderboardsTitlescreenController_OnlineHandlerState__Enum__Class** type_info = &type_info_ref;

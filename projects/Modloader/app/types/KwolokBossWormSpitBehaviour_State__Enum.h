...
namespace app::classes::types {
    namespace KwolokBossWormSpitBehaviour_State__Enum {
        namespace {
            inline app::KwolokBossWormSpitBehaviour_State__Enum__Class* type_info_ref = nullptr;
        }
        inline app::KwolokBossWormSpitBehaviour_State__Enum__Class** type_info = &type_info_ref;

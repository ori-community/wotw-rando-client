...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_FX_DigitalMatrix {
        inline app::ShaderID_CameraFilterPack_FX_DigitalMatrix__Class** type_info = (app::ShaderID_CameraFilterPack_FX_DigitalMatrix__Class**)(modloader::win::memory::resolve_rva(0x0473B208));

...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_FX_Glitch2 {
        inline app::ShaderID_CameraFilterPack_FX_Glitch2__Class** type_info() {
            static app::ShaderID_CameraFilterPack_FX_Glitch2__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ShaderID_CameraFilterPack_FX_Glitch2__Class**)(modloader::win::memory::resolve_rva(0x04721800));
            }
            return cache;
        }

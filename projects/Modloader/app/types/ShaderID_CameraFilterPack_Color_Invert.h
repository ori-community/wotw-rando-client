...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_Color_Invert {
        inline app::ShaderID_CameraFilterPack_Color_Invert__Class** type_info = (app::ShaderID_CameraFilterPack_Color_Invert__Class**)(modloader::win::memory::resolve_rva(0x0475BEF8));

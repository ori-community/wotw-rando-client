...
namespace app::classes::types {
    namespace SpiderBossBehaviourZone__Enum {
        inline app::SpiderBossBehaviourZone__Enum__Class** type_info() {
            static app::SpiderBossBehaviourZone__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::SpiderBossBehaviourZone__Enum__Class**)(modloader::win::memory::resolve_rva(0x0470B0F0));
            }
            return cache;
        }

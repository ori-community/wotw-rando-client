...
namespace app::classes::types {
    namespace UberPoolPerfTest_BenchmarkSinglePrefabPrewarm_d_39 {
        namespace {
            inline app::UberPoolPerfTest_BenchmarkSinglePrefabPrewarm_d_39__Class* type_info_ref = nullptr;
        }
        inline app::UberPoolPerfTest_BenchmarkSinglePrefabPrewarm_d_39__Class** type_info = &type_info_ref;

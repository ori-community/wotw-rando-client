...
namespace app::classes::types {
    namespace SandWormChaseBehaviour_State__Enum {
        inline app::SandWormChaseBehaviour_State__Enum__Class** type_info() {
            static app::SandWormChaseBehaviour_State__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SandWormChaseBehaviour_State__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

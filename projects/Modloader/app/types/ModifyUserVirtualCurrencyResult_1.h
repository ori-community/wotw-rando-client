...
namespace app::classes::types {
    namespace ModifyUserVirtualCurrencyResult_1 {
        inline app::ModifyUserVirtualCurrencyResult_1__Class** type_info = (app::ModifyUserVirtualCurrencyResult_1__Class**)(modloader::win::memory::resolve_rva(0x04729748));

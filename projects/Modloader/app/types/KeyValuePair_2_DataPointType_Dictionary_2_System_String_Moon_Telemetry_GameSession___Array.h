...
#include <Modloader/app/structs/KeyValuePair_2_DataPointType_Dictionary_2_System_String_Moon_Telemetry_GameSession___Array__Class.h>
...
namespace app::classes::types {
    namespace KeyValuePair_2_DataPointType_Dictionary_2_System_String_Moon_Telemetry_GameSession___Array {
        namespace {
            inline app::KeyValuePair_2_DataPointType_Dictionary_2_System_String_Moon_Telemetry_GameSession___Array__Class* type_info_ref = nullptr;
        }
        inline app::KeyValuePair_2_DataPointType_Dictionary_2_System_String_Moon_Telemetry_GameSession___Array__Class** type_info = &type_info_ref;

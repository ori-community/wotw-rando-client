...
namespace app::classes::types {
    namespace KeyValuePair_2_Moon_InteractionGraph_IState_List_1_Moon_InteractionGraph_Transition___Array {
        namespace {
            inline app::KeyValuePair_2_Moon_InteractionGraph_IState_List_1_Moon_InteractionGraph_Transition___Array__Class* type_info_ref = nullptr;
        }
        inline app::KeyValuePair_2_Moon_InteractionGraph_IState_List_1_Moon_InteractionGraph_Transition___Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace XsdDateTime_DateTimeTypeCode__Enum {
        namespace {
            inline app::XsdDateTime_DateTimeTypeCode__Enum__Class* type_info_ref = nullptr;
        }
        inline app::XsdDateTime_DateTimeTypeCode__Enum__Class** type_info = &type_info_ref;

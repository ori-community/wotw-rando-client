...
namespace app::classes::types {
    namespace CameraMotionBlur_MotionBlurFilter__Enum {
        namespace {
            inline app::CameraMotionBlur_MotionBlurFilter__Enum__Class* type_info_ref = nullptr;
        }
        inline app::CameraMotionBlur_MotionBlurFilter__Enum__Class** type_info = &type_info_ref;

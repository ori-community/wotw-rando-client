...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_FX_Glitch1 {
        inline app::ShaderID_CameraFilterPack_FX_Glitch1__Class** type_info = (app::ShaderID_CameraFilterPack_FX_Glitch1__Class**)(modloader::win::memory::resolve_rva(0x0471E058));

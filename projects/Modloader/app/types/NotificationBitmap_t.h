...
#include <Modloader/app/structs/NotificationBitmap_t__Boxed.h>
...
namespace app::classes::types {
    namespace NotificationBitmap_t {
        inline app::NotificationBitmap_t__Class** type_info() {
            static app::NotificationBitmap_t__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::NotificationBitmap_t__Class**)(modloader::win::memory::resolve_rva(0x0478D530));
            }
            return cache;
        }

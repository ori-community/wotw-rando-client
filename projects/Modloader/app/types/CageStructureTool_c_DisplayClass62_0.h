...
namespace app::classes::types {
    namespace CageStructureTool_c_DisplayClass62_0 {
        inline app::CageStructureTool_c_DisplayClass62_0__Class** type_info = (app::CageStructureTool_c_DisplayClass62_0__Class**)(modloader::win::memory::resolve_rva(0x04716900));

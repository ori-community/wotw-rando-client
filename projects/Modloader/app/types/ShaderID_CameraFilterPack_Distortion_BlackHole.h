...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_Distortion_BlackHole {
        inline app::ShaderID_CameraFilterPack_Distortion_BlackHole__Class** type_info = (app::ShaderID_CameraFilterPack_Distortion_BlackHole__Class**)(modloader::win::memory::resolve_rva(0x04764C20));

...
namespace app::classes::types {
    namespace SubInstruction_SubSingle {
        inline app::SubInstruction_SubSingle__Class** type_info() {
            static app::SubInstruction_SubSingle__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::SubInstruction_SubSingle__Class**)(modloader::win::memory::resolve_rva(0x0475C600));
            }
            return cache;
        }

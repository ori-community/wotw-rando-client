...
namespace app::classes::types {
    namespace DamageSurfacesMap_DamageSurfaceMapEntry__Array {
        namespace {
            inline app::DamageSurfacesMap_DamageSurfaceMapEntry__Array__Class* type_info_ref = nullptr;
        }
        inline app::DamageSurfacesMap_DamageSurfaceMapEntry__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace FramePerformanceMonitor_PerformanceEntry {
        inline app::FramePerformanceMonitor_PerformanceEntry__Class** type_info() {
            static app::FramePerformanceMonitor_PerformanceEntry__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::FramePerformanceMonitor_PerformanceEntry__Class**)(modloader::win::memory::resolve_rva(0x04749050));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_Color_YUV {
        inline app::ShaderID_CameraFilterPack_Color_YUV__Class** type_info = (app::ShaderID_CameraFilterPack_Color_YUV__Class**)(modloader::win::memory::resolve_rva(0x04791AA0));

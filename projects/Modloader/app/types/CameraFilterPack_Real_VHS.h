...
namespace app::classes::types {
    namespace CameraFilterPack_Real_VHS {
        inline app::CameraFilterPack_Real_VHS__Class** type_info() {
            static app::CameraFilterPack_Real_VHS__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::CameraFilterPack_Real_VHS__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

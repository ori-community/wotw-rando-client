...
namespace app::classes::types {
    namespace PromiseTimer_c_DisplayClass3_0 {
        inline app::PromiseTimer_c_DisplayClass3_0__Class** type_info() {
            static app::PromiseTimer_c_DisplayClass3_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::PromiseTimer_c_DisplayClass3_0__Class**)(modloader::win::memory::resolve_rva(0x0470B5F8));
            }
            return cache;
        }

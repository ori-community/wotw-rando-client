...
namespace app::classes::types {
    namespace OffsetEffector_EffectorLink__Array {
        namespace {
            inline app::OffsetEffector_EffectorLink__Array__Class* type_info_ref = nullptr;
        }
        inline app::OffsetEffector_EffectorLink__Array__Class** type_info = &type_info_ref;

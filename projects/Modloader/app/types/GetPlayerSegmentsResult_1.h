...
namespace app::classes::types {
    namespace GetPlayerSegmentsResult_1 {
        inline app::GetPlayerSegmentsResult_1__Class** type_info() {
            static app::GetPlayerSegmentsResult_1__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::GetPlayerSegmentsResult_1__Class**)(modloader::win::memory::resolve_rva(0x04763DB0));
            }
            return cache;
        }

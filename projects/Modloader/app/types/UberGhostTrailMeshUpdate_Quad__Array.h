...
namespace app::classes::types {
    namespace UberGhostTrailMeshUpdate_Quad__Array {
        inline app::UberGhostTrailMeshUpdate_Quad__Array__Class** type_info() {
            static app::UberGhostTrailMeshUpdate_Quad__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::UberGhostTrailMeshUpdate_Quad__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

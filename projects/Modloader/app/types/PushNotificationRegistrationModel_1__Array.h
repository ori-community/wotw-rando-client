...
namespace app::classes::types {
    namespace PushNotificationRegistrationModel_1__Array {
        namespace {
            inline app::PushNotificationRegistrationModel_1__Array__Class* type_info_ref = nullptr;
        }
        inline app::PushNotificationRegistrationModel_1__Array__Class** type_info = &type_info_ref;

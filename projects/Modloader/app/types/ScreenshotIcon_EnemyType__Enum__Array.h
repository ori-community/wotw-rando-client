...
namespace app::classes::types {
    namespace ScreenshotIcon_EnemyType__Enum__Array {
        inline app::ScreenshotIcon_EnemyType__Enum__Array__Class** type_info() {
            static app::ScreenshotIcon_EnemyType__Enum__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::ScreenshotIcon_EnemyType__Enum__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

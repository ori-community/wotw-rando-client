...
namespace app::classes::types {
    namespace SpiritLeashEffectPoseAnimator__Array {
        namespace {
            inline app::SpiritLeashEffectPoseAnimator__Array__Class* type_info_ref = nullptr;
        }
        inline app::SpiritLeashEffectPoseAnimator__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace JUnitReporter_TestSuite__Array {
        inline app::JUnitReporter_TestSuite__Array__Class** type_info() {
            static app::JUnitReporter_TestSuite__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::JUnitReporter_TestSuite__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

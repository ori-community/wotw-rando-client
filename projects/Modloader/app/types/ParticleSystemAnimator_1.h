...
namespace app::classes::types {
    namespace ParticleSystemAnimator_1 {
        inline app::ParticleSystemAnimator_1__Class** type_info() {
            static app::ParticleSystemAnimator_1__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::ParticleSystemAnimator_1__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

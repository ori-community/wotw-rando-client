...
namespace app::classes::types {
    namespace UberShaderBlock_ColliderTypeEnum__Enum {
        namespace {
            inline app::UberShaderBlock_ColliderTypeEnum__Enum__Class* type_info_ref = nullptr;
        }
        inline app::UberShaderBlock_ColliderTypeEnum__Enum__Class** type_info = &type_info_ref;

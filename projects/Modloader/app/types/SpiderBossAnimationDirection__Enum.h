...
namespace app::classes::types {
    namespace SpiderBossAnimationDirection__Enum {
        inline app::SpiderBossAnimationDirection__Enum__Class** type_info = (app::SpiderBossAnimationDirection__Enum__Class**)(modloader::win::memory::resolve_rva(0x04704B38));

...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_Vision_Warp2 {
        inline app::ShaderID_CameraFilterPack_Vision_Warp2__Class** type_info = (app::ShaderID_CameraFilterPack_Vision_Warp2__Class**)(modloader::win::memory::resolve_rva(0x04746FE0));

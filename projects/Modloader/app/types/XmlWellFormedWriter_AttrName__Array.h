...
namespace app::classes::types {
    namespace XmlWellFormedWriter_AttrName__Array {
        inline app::XmlWellFormedWriter_AttrName__Array__Class** type_info() {
            static app::XmlWellFormedWriter_AttrName__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::XmlWellFormedWriter_AttrName__Array__Class**)(modloader::win::memory::resolve_rva(0x0473DF48));
            }
            return cache;
        }

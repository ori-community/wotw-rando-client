...
namespace app::classes::types {
    namespace CylinderRevolveAxis__Enum_1 {
        inline app::CylinderRevolveAxis__Enum_1__Class** type_info() {
            static app::CylinderRevolveAxis__Enum_1__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::CylinderRevolveAxis__Enum_1__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

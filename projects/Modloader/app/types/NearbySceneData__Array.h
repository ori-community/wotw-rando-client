...
namespace app::classes::types {
    namespace NearbySceneData__Array {
        inline app::NearbySceneData__Array__Class** type_info() {
            static app::NearbySceneData__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::NearbySceneData__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

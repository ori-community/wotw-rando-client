...
namespace app::classes::types {
    namespace CleverMenuItem_ExtraNavigationButton__Enum {
        namespace {
            inline app::CleverMenuItem_ExtraNavigationButton__Enum__Class* type_info_ref = nullptr;
        }
        inline app::CleverMenuItem_ExtraNavigationButton__Enum__Class** type_info = &type_info_ref;

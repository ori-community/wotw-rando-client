...
namespace app::classes::types {
    namespace UberStateWwiseStateManager_ResetStateData__Array {
        inline app::UberStateWwiseStateManager_ResetStateData__Array__Class** type_info() {
            static app::UberStateWwiseStateManager_ResetStateData__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::UberStateWwiseStateManager_ResetStateData__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

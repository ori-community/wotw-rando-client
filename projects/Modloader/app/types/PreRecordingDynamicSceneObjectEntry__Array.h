...
namespace app::classes::types {
    namespace PreRecordingDynamicSceneObjectEntry__Array {
        namespace {
            inline app::PreRecordingDynamicSceneObjectEntry__Array__Class* type_info_ref = nullptr;
        }
        inline app::PreRecordingDynamicSceneObjectEntry__Array__Class** type_info = &type_info_ref;

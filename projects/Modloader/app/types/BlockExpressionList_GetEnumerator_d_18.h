...
namespace app::classes::types {
    namespace BlockExpressionList_GetEnumerator_d_18 {
        inline app::BlockExpressionList_GetEnumerator_d_18__Class** type_info() {
            static app::BlockExpressionList_GetEnumerator_d_18__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::BlockExpressionList_GetEnumerator_d_18__Class**)(modloader::win::memory::resolve_rva(0x04778E60));
            }
            return cache;
        }

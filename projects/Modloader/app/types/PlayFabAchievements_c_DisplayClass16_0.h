...
namespace app::classes::types {
    namespace PlayFabAchievements_c_DisplayClass16_0 {
        inline app::PlayFabAchievements_c_DisplayClass16_0__Class** type_info() {
            static app::PlayFabAchievements_c_DisplayClass16_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::PlayFabAchievements_c_DisplayClass16_0__Class**)(modloader::win::memory::resolve_rva(0x0477A5E8));
            }
            return cache;
        }

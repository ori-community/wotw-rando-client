...
namespace app::classes::types {
    namespace CollisionTriggerSetupHolder {
        inline app::CollisionTriggerSetupHolder__Class** type_info() {
            static app::CollisionTriggerSetupHolder__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::CollisionTriggerSetupHolder__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

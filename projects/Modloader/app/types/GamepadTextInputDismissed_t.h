...
namespace app::classes::types {
    namespace GamepadTextInputDismissed_t {
        inline app::GamepadTextInputDismissed_t__Class** type_info() {
            static app::GamepadTextInputDismissed_t__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::GamepadTextInputDismissed_t__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

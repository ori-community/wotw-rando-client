...
namespace app::classes::types {
    namespace SteamAppUninstalled_t {
        inline app::SteamAppUninstalled_t__Class** type_info() {
            static app::SteamAppUninstalled_t__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SteamAppUninstalled_t__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

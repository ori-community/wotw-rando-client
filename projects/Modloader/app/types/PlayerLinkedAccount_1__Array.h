...
namespace app::classes::types {
    namespace PlayerLinkedAccount_1__Array {
        inline app::PlayerLinkedAccount_1__Array__Class** type_info() {
            static app::PlayerLinkedAccount_1__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::PlayerLinkedAccount_1__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace MoonReference_1_Moon_BehaviourSystem_ITask___Array {
        inline app::MoonReference_1_Moon_BehaviourSystem_ITask___Array__Class** type_info() {
            static app::MoonReference_1_Moon_BehaviourSystem_ITask___Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::MoonReference_1_Moon_BehaviourSystem_ITask___Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

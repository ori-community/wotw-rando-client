...
namespace app::classes::types {
    namespace GhostWorldObjectsLifetimePlugin_PendingInstantiation {
        namespace {
            inline app::GhostWorldObjectsLifetimePlugin_PendingInstantiation__Class* type_info_ref = nullptr;
        }
        inline app::GhostWorldObjectsLifetimePlugin_PendingInstantiation__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace SeinPickupProcessor_PickupProcessorState__Enum {
        namespace {
            inline app::SeinPickupProcessor_PickupProcessorState__Enum__Class* type_info_ref = nullptr;
        }
        inline app::SeinPickupProcessor_PickupProcessorState__Enum__Class** type_info = &type_info_ref;

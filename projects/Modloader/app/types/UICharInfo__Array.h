...
namespace app::classes::types {
    namespace UICharInfo__Array {
        inline app::UICharInfo__Array__Class** type_info() {
            static app::UICharInfo__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::UICharInfo__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

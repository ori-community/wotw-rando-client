...
namespace app::classes::types {
    namespace HierarchySuspensionTest_State__Enum {
        namespace {
            inline app::HierarchySuspensionTest_State__Enum__Class* type_info_ref = nullptr;
        }
        inline app::HierarchySuspensionTest_State__Enum__Class** type_info = &type_info_ref;

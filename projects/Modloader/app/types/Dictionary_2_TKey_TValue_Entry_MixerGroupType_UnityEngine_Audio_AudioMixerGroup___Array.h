...
#include <Modloader/app/structs/Dictionary_2_TKey_TValue_Entry_MixerGroupType_UnityEngine_Audio_AudioMixerGroup___Array__Class.h>
...
namespace app::classes::types {
    namespace Dictionary_2_TKey_TValue_Entry_MixerGroupType_UnityEngine_Audio_AudioMixerGroup___Array {
        namespace {
            inline app::Dictionary_2_TKey_TValue_Entry_MixerGroupType_UnityEngine_Audio_AudioMixerGroup___Array__Class* type_info_ref = nullptr;
        }
        inline app::Dictionary_2_TKey_TValue_Entry_MixerGroupType_UnityEngine_Audio_AudioMixerGroup___Array__Class** type_info = &type_info_ref;

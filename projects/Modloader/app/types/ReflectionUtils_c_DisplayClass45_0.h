...
namespace app::classes::types {
    namespace ReflectionUtils_c_DisplayClass45_0 {
        inline app::ReflectionUtils_c_DisplayClass45_0__Class** type_info() {
            static app::ReflectionUtils_c_DisplayClass45_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ReflectionUtils_c_DisplayClass45_0__Class**)(modloader::win::memory::resolve_rva(0x0471F270));
            }
            return cache;
        }

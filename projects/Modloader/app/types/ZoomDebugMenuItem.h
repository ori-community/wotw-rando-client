...
namespace app::classes::types {
    namespace ZoomDebugMenuItem {
        inline app::ZoomDebugMenuItem__Class** type_info() {
            static app::ZoomDebugMenuItem__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ZoomDebugMenuItem__Class**)(modloader::win::memory::resolve_rva(0x0478E620));
            }
            return cache;
        }

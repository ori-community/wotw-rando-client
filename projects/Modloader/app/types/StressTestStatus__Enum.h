...
namespace app::classes::types {
    namespace StressTestStatus__Enum {
        inline app::StressTestStatus__Enum__Class** type_info() {
            static app::StressTestStatus__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::StressTestStatus__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

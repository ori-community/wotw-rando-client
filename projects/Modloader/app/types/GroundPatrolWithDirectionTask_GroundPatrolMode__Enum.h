...
namespace app::classes::types {
    namespace GroundPatrolWithDirectionTask_GroundPatrolMode__Enum {
        namespace {
            inline app::GroundPatrolWithDirectionTask_GroundPatrolMode__Enum__Class* type_info_ref = nullptr;
        }
        inline app::GroundPatrolWithDirectionTask_GroundPatrolMode__Enum__Class** type_info = &type_info_ref;

...
#include <Modloader/app/structs/UnsafeNativeMethods_ManifestEtw_TRACE_ENABLE_INFO__Boxed.h>
...
namespace app::classes::types {
    namespace UnsafeNativeMethods_ManifestEtw_TRACE_ENABLE_INFO {
        inline app::UnsafeNativeMethods_ManifestEtw_TRACE_ENABLE_INFO__Class** type_info() {
            static app::UnsafeNativeMethods_ManifestEtw_TRACE_ENABLE_INFO__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::UnsafeNativeMethods_ManifestEtw_TRACE_ENABLE_INFO__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

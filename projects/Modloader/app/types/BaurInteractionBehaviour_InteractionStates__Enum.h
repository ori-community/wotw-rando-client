...
namespace app::classes::types {
    namespace BaurInteractionBehaviour_InteractionStates__Enum {
        inline app::BaurInteractionBehaviour_InteractionStates__Enum__Class** type_info = (app::BaurInteractionBehaviour_InteractionStates__Enum__Class**)(modloader::win::memory::resolve_rva(0x0474AE00));

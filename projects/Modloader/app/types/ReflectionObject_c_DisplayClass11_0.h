...
namespace app::classes::types {
    namespace ReflectionObject_c_DisplayClass11_0 {
        inline app::ReflectionObject_c_DisplayClass11_0__Class** type_info() {
            static app::ReflectionObject_c_DisplayClass11_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ReflectionObject_c_DisplayClass11_0__Class**)(modloader::win::memory::resolve_rva(0x04700F08));
            }
            return cache;
        }

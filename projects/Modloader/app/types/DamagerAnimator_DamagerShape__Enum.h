...
namespace app::classes::types {
    namespace DamagerAnimator_DamagerShape__Enum {
        namespace {
            inline app::DamagerAnimator_DamagerShape__Enum__Class* type_info_ref = nullptr;
        }
        inline app::DamagerAnimator_DamagerShape__Enum__Class** type_info = &type_info_ref;

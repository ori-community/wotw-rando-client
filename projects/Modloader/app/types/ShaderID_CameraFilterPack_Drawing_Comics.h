...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_Drawing_Comics {
        inline app::ShaderID_CameraFilterPack_Drawing_Comics__Class** type_info = (app::ShaderID_CameraFilterPack_Drawing_Comics__Class**)(modloader::win::memory::resolve_rva(0x0476B2C0));

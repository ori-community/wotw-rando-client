...
namespace app::classes::types {
    namespace ExperimentalTransparencyAnimatorSystemStrategy_RendererState__Array {
        namespace {
            inline app::ExperimentalTransparencyAnimatorSystemStrategy_RendererState__Array__Class* type_info_ref = nullptr;
        }
        inline app::ExperimentalTransparencyAnimatorSystemStrategy_RendererState__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace MicroProfilerGraph_FrameCache {
        inline app::MicroProfilerGraph_FrameCache__Class** type_info() {
            static app::MicroProfilerGraph_FrameCache__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::MicroProfilerGraph_FrameCache__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace X509Store_1 {
        inline app::X509Store_1__Class** type_info() {
            static app::X509Store_1__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::X509Store_1__Class**)(modloader::win::memory::resolve_rva(0x047030B8));
            }
            return cache;
        }

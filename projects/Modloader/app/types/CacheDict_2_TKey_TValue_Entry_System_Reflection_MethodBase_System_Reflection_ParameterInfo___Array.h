...
#include <Modloader/app/structs/CacheDict_2_TKey_TValue_Entry_System_Reflection_MethodBase_System_Reflection_ParameterInfo___Array__Class.h>
#include <Modloader/app/structs/CacheDict_2_TKey_TValue_Entry_System_Reflection_MethodBase_System_Reflection_ParameterInfo___Array.h>

namespace app::classes::types {
    namespace CacheDict_2_TKey_TValue_Entry_System_Reflection_MethodBase_System_Reflection_ParameterInfo___Array {
        namespace {
            inline app::CacheDict_2_TKey_TValue_Entry_System_Reflection_MethodBase_System_Reflection_ParameterInfo___Array__Class* type_info_ref = nullptr;
        }
        inline app::CacheDict_2_TKey_TValue_Entry_System_Reflection_MethodBase_System_Reflection_ParameterInfo___Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace KwolokBossWormSpitBehaviour_WormInfo__Array {
        namespace {
            inline app::KwolokBossWormSpitBehaviour_WormInfo__Array__Class* type_info_ref = nullptr;
        }
        inline app::KwolokBossWormSpitBehaviour_WormInfo__Array__Class** type_info = &type_info_ref;

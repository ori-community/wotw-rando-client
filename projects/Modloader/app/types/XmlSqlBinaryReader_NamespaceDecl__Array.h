...
namespace app::classes::types {
    namespace XmlSqlBinaryReader_NamespaceDecl__Array {
        namespace {
            inline app::XmlSqlBinaryReader_NamespaceDecl__Array__Class* type_info_ref = nullptr;
        }
        inline app::XmlSqlBinaryReader_NamespaceDecl__Array__Class** type_info = &type_info_ref;

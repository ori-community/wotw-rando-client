...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_TV_Old_Movie_2 {
        inline app::ShaderID_CameraFilterPack_TV_Old_Movie_2__Class** type_info() {
            static app::ShaderID_CameraFilterPack_TV_Old_Movie_2__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ShaderID_CameraFilterPack_TV_Old_Movie_2__Class**)(modloader::win::memory::resolve_rva(0x0473A388));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace EarlyUpdate_UpdateKinect {
        inline app::EarlyUpdate_UpdateKinect__Class** type_info() {
            static app::EarlyUpdate_UpdateKinect__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::EarlyUpdate_UpdateKinect__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

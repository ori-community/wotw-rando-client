...
namespace app::classes::types {
    namespace CharacterLeaderboardEntry_1 {
        inline app::CharacterLeaderboardEntry_1__Class** type_info() {
            static app::CharacterLeaderboardEntry_1__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::CharacterLeaderboardEntry_1__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

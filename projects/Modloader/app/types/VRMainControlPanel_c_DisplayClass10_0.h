...
namespace app::classes::types {
    namespace VRMainControlPanel_c_DisplayClass10_0 {
        inline app::VRMainControlPanel_c_DisplayClass10_0__Class** type_info() {
            static app::VRMainControlPanel_c_DisplayClass10_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::VRMainControlPanel_c_DisplayClass10_0__Class**)(modloader::win::memory::resolve_rva(0x04733920));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace CCTextTorusWrapper_RevolveMode__Enum {
        namespace {
            inline app::CCTextTorusWrapper_RevolveMode__Enum__Class* type_info_ref = nullptr;
        }
        inline app::CCTextTorusWrapper_RevolveMode__Enum__Class** type_info = &type_info_ref;

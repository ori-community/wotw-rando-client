...
#include <Modloader/app/structs/SpiritLightAffectorBasedTrigger_State__Enum__Class.h>
#include <Modloader/il2cpp_helpers.h>
#include <Modloader/macros.h>

namespace app::classes::types {
    namespace SpiritLightAffectorBasedTrigger_State__Enum {
        inline app::SpiritLightAffectorBasedTrigger_State__Enum__Class** type_info() {
            static app::SpiritLightAffectorBasedTrigger_State__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SpiritLightAffectorBasedTrigger_State__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

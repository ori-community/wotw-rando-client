...
namespace app::classes::types {
    namespace SpiritLightAffectorBasedTrigger_State__Enum {
        namespace {
            inline app::SpiritLightAffectorBasedTrigger_State__Enum__Class* type_info_ref = nullptr;
        }
        inline app::SpiritLightAffectorBasedTrigger_State__Enum__Class** type_info = &type_info_ref;

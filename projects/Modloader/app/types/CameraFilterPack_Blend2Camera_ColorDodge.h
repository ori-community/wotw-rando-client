...
namespace app::classes::types {
    namespace CameraFilterPack_Blend2Camera_ColorDodge {
        inline app::CameraFilterPack_Blend2Camera_ColorDodge__Class** type_info() {
            static app::CameraFilterPack_Blend2Camera_ColorDodge__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::CameraFilterPack_Blend2Camera_ColorDodge__Class**)(modloader::win::memory::resolve_rva(0x0475EF90));
            }
            return cache;
        }

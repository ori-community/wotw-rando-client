...
namespace app::classes::types {
    namespace MistyWoodsAreaMapCanvas_CanvasItem__Array {
        namespace {
            inline app::MistyWoodsAreaMapCanvas_CanvasItem__Array__Class* type_info_ref = nullptr;
        }
        inline app::MistyWoodsAreaMapCanvas_CanvasItem__Array__Class** type_info = &type_info_ref;

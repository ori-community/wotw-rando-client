...
namespace app::classes::types {
    namespace StorageType__Enum {
        inline app::StorageType__Enum__Class** type_info() {
            static app::StorageType__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::StorageType__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace Sharpen_Algorithm__Enum {
        inline app::Sharpen_Algorithm__Enum__Class** type_info() {
            static app::Sharpen_Algorithm__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::Sharpen_Algorithm__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

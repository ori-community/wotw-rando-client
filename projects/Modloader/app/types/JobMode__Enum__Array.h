...
namespace app::classes::types {
    namespace JobMode__Enum__Array {
        inline app::JobMode__Enum__Array__Class** type_info() {
            static app::JobMode__Enum__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::JobMode__Enum__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace ServerSpawnOnKill_SpawnOnKillData {
        inline app::ServerSpawnOnKill_SpawnOnKillData__Class** type_info = (app::ServerSpawnOnKill_SpawnOnKillData__Class**)(modloader::win::memory::resolve_rva(0x04736B88));

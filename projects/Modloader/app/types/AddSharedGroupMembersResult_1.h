...
namespace app::classes::types {
    namespace AddSharedGroupMembersResult_1 {
        inline app::AddSharedGroupMembersResult_1__Class** type_info() {
            static app::AddSharedGroupMembersResult_1__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::AddSharedGroupMembersResult_1__Class**)(modloader::win::memory::resolve_rva(0x0471DBA0));
            }
            return cache;
        }

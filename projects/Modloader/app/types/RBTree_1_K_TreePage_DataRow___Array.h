...
namespace app::classes::types {
    namespace RBTree_1_K_TreePage_DataRow___Array {
        namespace {
            inline app::RBTree_1_K_TreePage_DataRow___Array__Class* type_info_ref = nullptr;
        }
        inline app::RBTree_1_K_TreePage_DataRow___Array__Class** type_info = &type_info_ref;

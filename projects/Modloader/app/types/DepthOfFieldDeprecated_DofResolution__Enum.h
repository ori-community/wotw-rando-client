...
namespace app::classes::types {
    namespace DepthOfFieldDeprecated_DofResolution__Enum {
        namespace {
            inline app::DepthOfFieldDeprecated_DofResolution__Enum__Class* type_info_ref = nullptr;
        }
        inline app::DepthOfFieldDeprecated_DofResolution__Enum__Class** type_info = &type_info_ref;

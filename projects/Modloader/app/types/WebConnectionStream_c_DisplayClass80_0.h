...
namespace app::classes::types {
    namespace WebConnectionStream_c_DisplayClass80_0 {
        inline app::WebConnectionStream_c_DisplayClass80_0__Class** type_info = (app::WebConnectionStream_c_DisplayClass80_0__Class**)(modloader::win::memory::resolve_rva(0x04753028));

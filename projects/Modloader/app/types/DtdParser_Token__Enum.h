...
namespace app::classes::types {
    namespace DtdParser_Token__Enum {
        inline app::DtdParser_Token__Enum__Class** type_info() {
            static app::DtdParser_Token__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::DtdParser_Token__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
#include <Modloader/app/structs/SoundZoneTrigger_SoundZoneTriggerType__Enum__Class.h>
#include <Modloader/il2cpp_helpers.h>
#include <Modloader/macros.h>

namespace app::classes::types {
    namespace SoundZoneTrigger_SoundZoneTriggerType__Enum {
        inline app::SoundZoneTrigger_SoundZoneTriggerType__Enum__Class** type_info() {
            static app::SoundZoneTrigger_SoundZoneTriggerType__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SoundZoneTrigger_SoundZoneTriggerType__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

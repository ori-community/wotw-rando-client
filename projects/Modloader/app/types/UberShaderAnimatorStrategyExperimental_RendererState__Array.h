...
namespace app::classes::types {
    namespace UberShaderAnimatorStrategyExperimental_RendererState__Array {
        inline app::UberShaderAnimatorStrategyExperimental_RendererState__Array__Class** type_info() {
            static app::UberShaderAnimatorStrategyExperimental_RendererState__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::UberShaderAnimatorStrategyExperimental_RendererState__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

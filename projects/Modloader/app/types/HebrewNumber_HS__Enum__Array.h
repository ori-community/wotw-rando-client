...
namespace app::classes::types {
    namespace HebrewNumber_HS__Enum__Array {
        inline app::HebrewNumber_HS__Enum__Array__Class** type_info() {
            static app::HebrewNumber_HS__Enum__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::HebrewNumber_HS__Enum__Array__Class**)(modloader::win::memory::resolve_rva(0x04704880));
            }
            return cache;
        }

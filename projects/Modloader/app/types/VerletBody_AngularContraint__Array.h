...
namespace app::classes::types {
    namespace VerletBody_AngularContraint__Array {
        inline app::VerletBody_AngularContraint__Array__Class** type_info() {
            static app::VerletBody_AngularContraint__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::VerletBody_AngularContraint__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace VerletBody_AngularContraint__Array {
        namespace {
            inline app::VerletBody_AngularContraint__Array__Class* type_info_ref = nullptr;
        }
        inline app::VerletBody_AngularContraint__Array__Class** type_info = &type_info_ref;

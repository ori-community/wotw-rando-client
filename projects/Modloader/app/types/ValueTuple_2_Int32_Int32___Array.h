...
namespace app::classes::types {
    namespace ValueTuple_2_Int32_Int32___Array {
        inline app::ValueTuple_2_Int32_Int32___Array__Class** type_info() {
            static app::ValueTuple_2_Int32_Int32___Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::ValueTuple_2_Int32_Int32___Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

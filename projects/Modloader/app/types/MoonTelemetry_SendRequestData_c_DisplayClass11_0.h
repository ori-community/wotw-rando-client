...
namespace app::classes::types {
    namespace MoonTelemetry_SendRequestData_c_DisplayClass11_0 {
        inline app::MoonTelemetry_SendRequestData_c_DisplayClass11_0__Class** type_info() {
            static app::MoonTelemetry_SendRequestData_c_DisplayClass11_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::MoonTelemetry_SendRequestData_c_DisplayClass11_0__Class**)(modloader::win::memory::resolve_rva(0x047494D8));
            }
            return cache;
        }

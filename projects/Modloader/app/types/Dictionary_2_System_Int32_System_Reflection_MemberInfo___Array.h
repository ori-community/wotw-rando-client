...
namespace app::classes::types {
    namespace Dictionary_2_System_Int32_System_Reflection_MemberInfo___Array {
        inline app::Dictionary_2_System_Int32_System_Reflection_MemberInfo___Array__Class** type_info() {
            static app::Dictionary_2_System_Int32_System_Reflection_MemberInfo___Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::Dictionary_2_System_Int32_System_Reflection_MemberInfo___Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

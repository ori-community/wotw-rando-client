...
namespace app::classes::types {
    namespace GroundPatrolWithDirectionBehaviourNew_GroundPatrolMode__Enum {
        inline app::GroundPatrolWithDirectionBehaviourNew_GroundPatrolMode__Enum__Class** type_info() {
            static app::GroundPatrolWithDirectionBehaviourNew_GroundPatrolMode__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::GroundPatrolWithDirectionBehaviourNew_GroundPatrolMode__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace OneDSEventsAPI_c_DisplayClass13_0_WaitWhile_b_0_d {
        namespace {
            inline app::OneDSEventsAPI_c_DisplayClass13_0_WaitWhile_b_0_d__Class* type_info_ref = nullptr;
        }
        inline app::OneDSEventsAPI_c_DisplayClass13_0_WaitWhile_b_0_d__Class** type_info = &type_info_ref;

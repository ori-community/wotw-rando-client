...
namespace app::classes::types {
    namespace NickHitReactionBehaviour_NonInterruptibleTaskCondition__Array {
        namespace {
            inline app::NickHitReactionBehaviour_NonInterruptibleTaskCondition__Array__Class* type_info_ref = nullptr;
        }
        inline app::NickHitReactionBehaviour_NonInterruptibleTaskCondition__Array__Class** type_info = &type_info_ref;

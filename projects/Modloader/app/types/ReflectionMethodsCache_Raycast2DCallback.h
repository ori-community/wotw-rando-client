...
namespace app::classes::types {
    namespace ReflectionMethodsCache_Raycast2DCallback {
        inline app::ReflectionMethodsCache_Raycast2DCallback__Class** type_info() {
            static app::ReflectionMethodsCache_Raycast2DCallback__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ReflectionMethodsCache_Raycast2DCallback__Class**)(modloader::win::memory::resolve_rva(0x0479A1B8));
            }
            return cache;
        }

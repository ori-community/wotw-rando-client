...
namespace app::classes::types {
    namespace ISliceRenderSettingsInfluencer__Array {
        namespace {
            inline app::ISliceRenderSettingsInfluencer__Array__Class* type_info_ref = nullptr;
        }
        inline app::ISliceRenderSettingsInfluencer__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_Blur_Focus {
        inline app::ShaderID_CameraFilterPack_Blur_Focus__Class** type_info = (app::ShaderID_CameraFilterPack_Blur_Focus__Class**)(modloader::win::memory::resolve_rva(0x0475A4C0));

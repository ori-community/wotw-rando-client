...
namespace app::classes::types {
    namespace Set_1_TElement_Slot_System_Object___Array {
        namespace {
            inline app::Set_1_TElement_Slot_System_Object___Array__Class* type_info_ref = nullptr;
        }
        inline app::Set_1_TElement_Slot_System_Object___Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace CompiledIdentityConstraint_ConstraintRole__Enum {
        namespace {
            inline app::CompiledIdentityConstraint_ConstraintRole__Enum__Class* type_info_ref = nullptr;
        }
        inline app::CompiledIdentityConstraint_ConstraintRole__Enum__Class** type_info = &type_info_ref;

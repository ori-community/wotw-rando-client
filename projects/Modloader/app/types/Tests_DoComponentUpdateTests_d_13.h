...
namespace app::classes::types {
    namespace Tests_DoComponentUpdateTests_d_13 {
        inline app::Tests_DoComponentUpdateTests_d_13__Class** type_info() {
            static app::Tests_DoComponentUpdateTests_d_13__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::Tests_DoComponentUpdateTests_d_13__Class**)(modloader::win::memory::resolve_rva(0x047127F0));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace SerializedIntUberState__Array {
        inline app::SerializedIntUberState__Array__Class** type_info() {
            static app::SerializedIntUberState__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SerializedIntUberState__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

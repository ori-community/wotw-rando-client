...
namespace app::classes::types {
    namespace KeyValuePair_2_IAttackable_SpiritTurret_AttackableRayHandle___Array {
        namespace {
            inline app::KeyValuePair_2_IAttackable_SpiritTurret_AttackableRayHandle___Array__Class* type_info_ref = nullptr;
        }
        inline app::KeyValuePair_2_IAttackable_SpiritTurret_AttackableRayHandle___Array__Class** type_info = &type_info_ref;

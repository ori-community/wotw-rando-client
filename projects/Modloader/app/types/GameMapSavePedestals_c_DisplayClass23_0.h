...
namespace app::classes::types {
    namespace GameMapSavePedestals_c_DisplayClass23_0 {
        inline app::GameMapSavePedestals_c_DisplayClass23_0__Class** type_info() {
            static app::GameMapSavePedestals_c_DisplayClass23_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::GameMapSavePedestals_c_DisplayClass23_0__Class**)(modloader::win::memory::resolve_rva(0x04773B30));
            }
            return cache;
        }

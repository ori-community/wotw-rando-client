...
namespace app::classes::types {
    namespace DesertEscapeWorm_States__Enum {
        inline app::DesertEscapeWorm_States__Enum__Class** type_info() {
            static app::DesertEscapeWorm_States__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::DesertEscapeWorm_States__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace RemoteStorageSetUserPublishedFileActionResult_t {
        inline app::RemoteStorageSetUserPublishedFileActionResult_t__Class** type_info() {
            static app::RemoteStorageSetUserPublishedFileActionResult_t__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::RemoteStorageSetUserPublishedFileActionResult_t__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

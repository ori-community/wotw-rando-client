...
namespace app::classes::types {
    namespace AnimatorAction_FindAnimatorsMode__Enum {
        namespace {
            inline app::AnimatorAction_FindAnimatorsMode__Enum__Class* type_info_ref = nullptr;
        }
        inline app::AnimatorAction_FindAnimatorsMode__Enum__Class** type_info = &type_info_ref;

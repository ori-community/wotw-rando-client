...
namespace app::classes::types {
    namespace UberShaderVectorAnimator_VectorProperty__Enum__Array {
        namespace {
            inline app::UberShaderVectorAnimator_VectorProperty__Enum__Array__Class* type_info_ref = nullptr;
        }
        inline app::UberShaderVectorAnimator_VectorProperty__Enum__Array__Class** type_info = &type_info_ref;

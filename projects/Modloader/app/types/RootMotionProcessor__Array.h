...
namespace app::classes::types {
    namespace RootMotionProcessor__Array {
        inline app::RootMotionProcessor__Array__Class** type_info() {
            static app::RootMotionProcessor__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::RootMotionProcessor__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

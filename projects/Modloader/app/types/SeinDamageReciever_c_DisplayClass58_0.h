...
namespace app::classes::types {
    namespace SeinDamageReciever_c_DisplayClass58_0 {
        inline app::SeinDamageReciever_c_DisplayClass58_0__Class** type_info() {
            static app::SeinDamageReciever_c_DisplayClass58_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::SeinDamageReciever_c_DisplayClass58_0__Class**)(modloader::win::memory::resolve_rva(0x0475FDB0));
            }
            return cache;
        }

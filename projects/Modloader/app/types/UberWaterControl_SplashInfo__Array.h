...
namespace app::classes::types {
    namespace UberWaterControl_SplashInfo__Array {
        namespace {
            inline app::UberWaterControl_SplashInfo__Array__Class* type_info_ref = nullptr;
        }
        inline app::UberWaterControl_SplashInfo__Array__Class** type_info = &type_info_ref;

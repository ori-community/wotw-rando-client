...
namespace app::classes::types {
    namespace HttpListenerElement {
        inline app::HttpListenerElement__Class** type_info() {
            static app::HttpListenerElement__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::HttpListenerElement__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace UberGCLogic_CleanupOutsideOfGameplayTrigger__Enum {
        inline app::UberGCLogic_CleanupOutsideOfGameplayTrigger__Enum__Class** type_info() {
            static app::UberGCLogic_CleanupOutsideOfGameplayTrigger__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::UberGCLogic_CleanupOutsideOfGameplayTrigger__Enum__Class**)(modloader::win::memory::resolve_rva(0x0477DA68));
            }
            return cache;
        }

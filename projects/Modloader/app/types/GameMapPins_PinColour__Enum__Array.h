...
namespace app::classes::types {
    namespace GameMapPins_PinColour__Enum__Array {
        namespace {
            inline app::GameMapPins_PinColour__Enum__Array__Class* type_info_ref = nullptr;
        }
        inline app::GameMapPins_PinColour__Enum__Array__Class** type_info = &type_info_ref;

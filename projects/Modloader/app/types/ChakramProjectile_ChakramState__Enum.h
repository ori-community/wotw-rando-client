...
namespace app::classes::types {
    namespace ChakramProjectile_ChakramState__Enum {
        namespace {
            inline app::ChakramProjectile_ChakramState__Enum__Class* type_info_ref = nullptr;
        }
        inline app::ChakramProjectile_ChakramState__Enum__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_Blend2Camera_VividLight {
        inline app::ShaderID_CameraFilterPack_Blend2Camera_VividLight__Class** type_info = (app::ShaderID_CameraFilterPack_Blend2Camera_VividLight__Class**)(modloader::win::memory::resolve_rva(0x04705608));

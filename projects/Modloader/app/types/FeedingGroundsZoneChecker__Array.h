...
namespace app::classes::types {
    namespace FeedingGroundsZoneChecker__Array {
        inline app::FeedingGroundsZoneChecker__Array__Class** type_info() {
            static app::FeedingGroundsZoneChecker__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::FeedingGroundsZoneChecker__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

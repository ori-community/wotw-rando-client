...
namespace app::classes::types {
    namespace XHashtable_1_TValue_XHashtableState_TValue_Entry_XName___Array {
        inline app::XHashtable_1_TValue_XHashtableState_TValue_Entry_XName___Array__Class** type_info() {
            static app::XHashtable_1_TValue_XHashtableState_TValue_Entry_XName___Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::XHashtable_1_TValue_XHashtableState_TValue_Entry_XName___Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

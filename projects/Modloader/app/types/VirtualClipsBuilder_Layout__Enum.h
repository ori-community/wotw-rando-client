...
namespace app::classes::types {
    namespace VirtualClipsBuilder_Layout__Enum {
        inline app::VirtualClipsBuilder_Layout__Enum__Class** type_info() {
            static app::VirtualClipsBuilder_Layout__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::VirtualClipsBuilder_Layout__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

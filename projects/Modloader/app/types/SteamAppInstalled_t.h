...
namespace app::classes::types {
    namespace SteamAppInstalled_t {
        inline app::SteamAppInstalled_t__Class** type_info() {
            static app::SteamAppInstalled_t__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SteamAppInstalled_t__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

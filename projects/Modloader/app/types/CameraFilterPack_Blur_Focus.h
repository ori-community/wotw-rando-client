...
namespace app::classes::types {
    namespace CameraFilterPack_Blur_Focus {
        inline app::CameraFilterPack_Blur_Focus__Class** type_info() {
            static app::CameraFilterPack_Blur_Focus__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::CameraFilterPack_Blur_Focus__Class**)(modloader::win::memory::resolve_rva(0x0476DF10));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace ExternalTimelineEntity__Array {
        inline app::ExternalTimelineEntity__Array__Class** type_info() {
            static app::ExternalTimelineEntity__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::ExternalTimelineEntity__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace CanvasScaler_ScreenMatchMode__Enum {
        namespace {
            inline app::CanvasScaler_ScreenMatchMode__Enum__Class* type_info_ref = nullptr;
        }
        inline app::CanvasScaler_ScreenMatchMode__Enum__Class** type_info = &type_info_ref;

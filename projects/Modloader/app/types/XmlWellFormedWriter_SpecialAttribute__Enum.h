...
namespace app::classes::types {
    namespace XmlWellFormedWriter_SpecialAttribute__Enum {
        namespace {
            inline app::XmlWellFormedWriter_SpecialAttribute__Enum__Class* type_info_ref = nullptr;
        }
        inline app::XmlWellFormedWriter_SpecialAttribute__Enum__Class** type_info = &type_info_ref;

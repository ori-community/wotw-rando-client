...
namespace app::classes::types {
    namespace NewSetupStateControllerResolver_SerializedUberStateControllerLinkItem__Array {
        namespace {
            inline app::NewSetupStateControllerResolver_SerializedUberStateControllerLinkItem__Array__Class* type_info_ref = nullptr;
        }
        inline app::NewSetupStateControllerResolver_SerializedUberStateControllerLinkItem__Array__Class** type_info = &type_info_ref;

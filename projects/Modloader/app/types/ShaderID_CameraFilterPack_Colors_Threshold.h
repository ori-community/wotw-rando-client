...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_Colors_Threshold {
        inline app::ShaderID_CameraFilterPack_Colors_Threshold__Class** type_info = (app::ShaderID_CameraFilterPack_Colors_Threshold__Class**)(modloader::win::memory::resolve_rva(0x047101D0));

...
namespace app::classes::types {
    namespace WaitForPresentSyncPoint__Enum__Array {
        namespace {
            inline app::WaitForPresentSyncPoint__Enum__Array__Class* type_info_ref = nullptr;
        }
        inline app::WaitForPresentSyncPoint__Enum__Array__Class** type_info = &type_info_ref;

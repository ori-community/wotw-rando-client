...
namespace app::classes::types {
    namespace DeadBatEnemy_State__Enum {
        inline app::DeadBatEnemy_State__Enum__Class** type_info() {
            static app::DeadBatEnemy_State__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::DeadBatEnemy_State__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

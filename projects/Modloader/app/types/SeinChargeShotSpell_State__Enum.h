...
namespace app::classes::types {
    namespace SeinChargeShotSpell_State__Enum {
        inline app::SeinChargeShotSpell_State__Enum__Class** type_info() {
            static app::SeinChargeShotSpell_State__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SeinChargeShotSpell_State__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

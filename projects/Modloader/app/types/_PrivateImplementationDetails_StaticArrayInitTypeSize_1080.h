...
namespace app::classes::types {
    namespace _PrivateImplementationDetails_StaticArrayInitTypeSize_1080 {
        namespace {
            inline app::_PrivateImplementationDetails_StaticArrayInitTypeSize_1080__Class* type_info_ref = nullptr;
        }
        inline app::_PrivateImplementationDetails_StaticArrayInitTypeSize_1080__Class** type_info = &type_info_ref;

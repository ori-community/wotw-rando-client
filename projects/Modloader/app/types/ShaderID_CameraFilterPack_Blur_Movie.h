...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_Blur_Movie {
        inline app::ShaderID_CameraFilterPack_Blur_Movie__Class** type_info = (app::ShaderID_CameraFilterPack_Blur_Movie__Class**)(modloader::win::memory::resolve_rva(0x04753310));

...
namespace app::classes::types {
    namespace WebService_c_DisplayClass1_0 {
        inline app::WebService_c_DisplayClass1_0__Class** type_info() {
            static app::WebService_c_DisplayClass1_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::WebService_c_DisplayClass1_0__Class**)(modloader::win::memory::resolve_rva(0x04707328));
            }
            return cache;
        }

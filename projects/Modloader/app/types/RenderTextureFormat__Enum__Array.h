...
namespace app::classes::types {
    namespace RenderTextureFormat__Enum__Array {
        inline app::RenderTextureFormat__Enum__Array__Class** type_info() {
            static app::RenderTextureFormat__Enum__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::RenderTextureFormat__Enum__Array__Class**)(modloader::win::memory::resolve_rva(0x04784F28));
            }
            return cache;
        }

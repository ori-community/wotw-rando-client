...
namespace app::classes::types {
    namespace PositionAnimatorEntity_PositionMovementType__Enum {
        namespace {
            inline app::PositionAnimatorEntity_PositionMovementType__Enum__Class* type_info_ref = nullptr;
        }
        inline app::PositionAnimatorEntity_PositionMovementType__Enum__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace Ucs4Decoder4321 {
        inline app::Ucs4Decoder4321__Class** type_info() {
            static app::Ucs4Decoder4321__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::Ucs4Decoder4321__Class**)(modloader::win::memory::resolve_rva(0x04786828));
            }
            return cache;
        }

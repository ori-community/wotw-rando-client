...
#include <Modloader/app/structs/ControllerDigitalActionData_t__Boxed.h>
...
namespace app::classes::types {
    namespace ControllerDigitalActionData_t {
        inline app::ControllerDigitalActionData_t__Class** type_info() {
            static app::ControllerDigitalActionData_t__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::ControllerDigitalActionData_t__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

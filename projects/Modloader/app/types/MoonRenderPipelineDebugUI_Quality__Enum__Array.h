...
namespace app::classes::types {
    namespace MoonRenderPipelineDebugUI_Quality__Enum__Array {
        namespace {
            inline app::MoonRenderPipelineDebugUI_Quality__Enum__Array__Class* type_info_ref = nullptr;
        }
        inline app::MoonRenderPipelineDebugUI_Quality__Enum__Array__Class** type_info = &type_info_ref;

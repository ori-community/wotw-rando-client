...
namespace app::classes::types {
    namespace LoadingBootstrap_c_DisplayClass28_0 {
        inline app::LoadingBootstrap_c_DisplayClass28_0__Class** type_info() {
            static app::LoadingBootstrap_c_DisplayClass28_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::LoadingBootstrap_c_DisplayClass28_0__Class**)(modloader::win::memory::resolve_rva(0x0477DFA8));
            }
            return cache;
        }

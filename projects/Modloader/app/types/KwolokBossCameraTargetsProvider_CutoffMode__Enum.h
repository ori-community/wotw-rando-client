...
namespace app::classes::types {
    namespace KwolokBossCameraTargetsProvider_CutoffMode__Enum {
        namespace {
            inline app::KwolokBossCameraTargetsProvider_CutoffMode__Enum__Class* type_info_ref = nullptr;
        }
        inline app::KwolokBossCameraTargetsProvider_CutoffMode__Enum__Class** type_info = &type_info_ref;

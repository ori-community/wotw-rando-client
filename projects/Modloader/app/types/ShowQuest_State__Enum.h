...
namespace app::classes::types {
    namespace ShowQuest_State__Enum {
        inline app::ShowQuest_State__Enum__Class** type_info() {
            static app::ShowQuest_State__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::ShowQuest_State__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

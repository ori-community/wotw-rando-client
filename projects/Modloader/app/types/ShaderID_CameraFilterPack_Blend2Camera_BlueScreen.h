...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_Blend2Camera_BlueScreen {
        inline app::ShaderID_CameraFilterPack_Blend2Camera_BlueScreen__Class** type_info = (app::ShaderID_CameraFilterPack_Blend2Camera_BlueScreen__Class**)(modloader::win::memory::resolve_rva(0x047463C8));

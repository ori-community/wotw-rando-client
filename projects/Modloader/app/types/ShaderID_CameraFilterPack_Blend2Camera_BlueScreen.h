...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_Blend2Camera_BlueScreen {
        inline app::ShaderID_CameraFilterPack_Blend2Camera_BlueScreen__Class** type_info() {
            static app::ShaderID_CameraFilterPack_Blend2Camera_BlueScreen__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ShaderID_CameraFilterPack_Blend2Camera_BlueScreen__Class**)(modloader::win::memory::resolve_rva(0x047463C8));
            }
            return cache;
        }

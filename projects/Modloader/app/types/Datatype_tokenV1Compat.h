...
namespace app::classes::types {
    namespace Datatype_tokenV1Compat {
        inline app::Datatype_tokenV1Compat__Class** type_info() {
            static app::Datatype_tokenV1Compat__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::Datatype_tokenV1Compat__Class**)(modloader::win::memory::resolve_rva(0x04735440));
            }
            return cache;
        }

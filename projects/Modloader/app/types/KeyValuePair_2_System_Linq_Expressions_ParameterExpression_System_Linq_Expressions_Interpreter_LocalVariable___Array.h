...
#include <Modloader/app/structs/KeyValuePair_2_System_Linq_Expressions_ParameterExpression_System_Linq_Expressions_Interpreter_LocalVariable___Array__Class.h>
#include <Modloader/app/structs/KeyValuePair_2_System_Linq_Expressions_ParameterExpression_System_Linq_Expressions_Interpreter_LocalVariable___Array.h>
...
namespace app::classes::types {
    namespace KeyValuePair_2_System_Linq_Expressions_ParameterExpression_System_Linq_Expressions_Interpreter_LocalVariable___Array {
        namespace {
            inline app::KeyValuePair_2_System_Linq_Expressions_ParameterExpression_System_Linq_Expressions_Interpreter_LocalVariable___Array__Class* type_info_ref = nullptr;
        }
        inline app::KeyValuePair_2_System_Linq_Expressions_ParameterExpression_System_Linq_Expressions_Interpreter_LocalVariable___Array__Class** type_info = &type_info_ref;

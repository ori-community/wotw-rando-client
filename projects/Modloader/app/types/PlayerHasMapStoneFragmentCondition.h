...
namespace app::classes::types {
    namespace PlayerHasMapStoneFragmentCondition {
        namespace {
            inline app::PlayerHasMapStoneFragmentCondition__Class* type_info_ref = nullptr;
        }
        inline app::PlayerHasMapStoneFragmentCondition__Class** type_info = &type_info_ref;

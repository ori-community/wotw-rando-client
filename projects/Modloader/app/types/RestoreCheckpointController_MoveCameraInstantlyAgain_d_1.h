...
namespace app::classes::types {
    namespace RestoreCheckpointController_MoveCameraInstantlyAgain_d_1 {
        inline app::RestoreCheckpointController_MoveCameraInstantlyAgain_d_1__Class** type_info() {
            static app::RestoreCheckpointController_MoveCameraInstantlyAgain_d_1__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::RestoreCheckpointController_MoveCameraInstantlyAgain_d_1__Class**)(modloader::win::memory::resolve_rva(0x04793C70));
            }
            return cache;
        }

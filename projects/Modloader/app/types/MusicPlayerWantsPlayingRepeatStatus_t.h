...
namespace app::classes::types {
    namespace MusicPlayerWantsPlayingRepeatStatus_t {
        namespace {
            inline app::MusicPlayerWantsPlayingRepeatStatus_t__Class* type_info_ref = nullptr;
        }
        inline app::MusicPlayerWantsPlayingRepeatStatus_t__Class** type_info = &type_info_ref;

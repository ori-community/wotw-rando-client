...
namespace app::classes::types {
    namespace MulInstruction_MulInt64 {
        inline app::MulInstruction_MulInt64__Class** type_info() {
            static app::MulInstruction_MulInt64__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::MulInstruction_MulInt64__Class**)(modloader::win::memory::resolve_rva(0x04719810));
            }
            return cache;
        }

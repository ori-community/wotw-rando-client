...
namespace app::classes::types {
    namespace SkeetoEntity_SkeetoState__Enum__Array {
        inline app::SkeetoEntity_SkeetoState__Enum__Array__Class** type_info() {
            static app::SkeetoEntity_SkeetoState__Enum__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SkeetoEntity_SkeetoState__Enum__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

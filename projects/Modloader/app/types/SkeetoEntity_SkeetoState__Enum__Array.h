...
namespace app::classes::types {
    namespace SkeetoEntity_SkeetoState__Enum__Array {
        namespace {
            inline app::SkeetoEntity_SkeetoState__Enum__Array__Class* type_info_ref = nullptr;
        }
        inline app::SkeetoEntity_SkeetoState__Enum__Array__Class** type_info = &type_info_ref;

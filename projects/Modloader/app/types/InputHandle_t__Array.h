...
namespace app::classes::types {
    namespace InputHandle_t__Array {
        inline app::InputHandle_t__Array__Class** type_info() {
            static app::InputHandle_t__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::InputHandle_t__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

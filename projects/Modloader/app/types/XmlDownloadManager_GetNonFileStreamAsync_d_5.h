...
namespace app::classes::types {
    namespace XmlDownloadManager_GetNonFileStreamAsync_d_5 {
        namespace {
            inline app::XmlDownloadManager_GetNonFileStreamAsync_d_5__Class* type_info_ref = nullptr;
        }
        inline app::XmlDownloadManager_GetNonFileStreamAsync_d_5__Class** type_info = &type_info_ref;

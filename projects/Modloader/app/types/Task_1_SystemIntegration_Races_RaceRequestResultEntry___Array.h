...
namespace app::classes::types {
    namespace Task_1_SystemIntegration_Races_RaceRequestResultEntry___Array {
        inline app::Task_1_SystemIntegration_Races_RaceRequestResultEntry___Array__Class** type_info = (app::Task_1_SystemIntegration_Races_RaceRequestResultEntry___Array__Class**)(modloader::win::memory::resolve_rva(0x047994D0));

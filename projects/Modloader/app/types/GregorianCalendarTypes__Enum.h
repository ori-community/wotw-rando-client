...
namespace app::classes::types {
    namespace GregorianCalendarTypes__Enum {
        inline app::GregorianCalendarTypes__Enum__Class** type_info() {
            static app::GregorianCalendarTypes__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::GregorianCalendarTypes__Enum__Class**)(modloader::win::memory::resolve_rva(0x0477CAA8));
            }
            return cache;
        }

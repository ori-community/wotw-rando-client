...
namespace app::classes::types {
    namespace MoonAnimator_AnimationInstanceType__Enum {
        namespace {
            inline app::MoonAnimator_AnimationInstanceType__Enum__Class* type_info_ref = nullptr;
        }
        inline app::MoonAnimator_AnimationInstanceType__Enum__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace RendererCullingCategoryResults__Array {
        namespace {
            inline app::RendererCullingCategoryResults__Array__Class* type_info_ref = nullptr;
        }
        inline app::RendererCullingCategoryResults__Array__Class** type_info = &type_info_ref;

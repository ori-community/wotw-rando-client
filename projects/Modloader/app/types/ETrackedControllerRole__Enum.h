...
namespace app::classes::types {
    namespace ETrackedControllerRole__Enum {
        inline app::ETrackedControllerRole__Enum__Class** type_info() {
            static app::ETrackedControllerRole__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ETrackedControllerRole__Enum__Class**)(modloader::win::memory::resolve_rva(0x04722158));
            }
            return cache;
        }

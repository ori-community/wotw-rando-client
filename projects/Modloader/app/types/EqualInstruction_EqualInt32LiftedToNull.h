...
namespace app::classes::types {
    namespace EqualInstruction_EqualInt32LiftedToNull {
        inline app::EqualInstruction_EqualInt32LiftedToNull__Class** type_info() {
            static app::EqualInstruction_EqualInt32LiftedToNull__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::EqualInstruction_EqualInt32LiftedToNull__Class**)(modloader::win::memory::resolve_rva(0x0476EE18));
            }
            return cache;
        }

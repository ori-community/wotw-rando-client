...
namespace app::classes::types {
    namespace WebRequest_c_DisplayClass79_0 {
        inline app::WebRequest_c_DisplayClass79_0__Class** type_info() {
            static app::WebRequest_c_DisplayClass79_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::WebRequest_c_DisplayClass79_0__Class**)(modloader::win::memory::resolve_rva(0x04719AD8));
            }
            return cache;
        }

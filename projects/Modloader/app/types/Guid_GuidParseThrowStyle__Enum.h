...
namespace app::classes::types {
    namespace Guid_GuidParseThrowStyle__Enum {
        inline app::Guid_GuidParseThrowStyle__Enum__Class** type_info() {
            static app::Guid_GuidParseThrowStyle__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::Guid_GuidParseThrowStyle__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

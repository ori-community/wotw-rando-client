...
namespace app::classes::types {
    namespace MonoBehaviour__Array {
        inline app::MonoBehaviour__Array__Class** type_info() {
            static app::MonoBehaviour__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::MonoBehaviour__Array__Class**)(modloader::win::memory::resolve_rva(0x0470B8F0));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace SqlInt32__Array {
        inline app::SqlInt32__Array__Class** type_info() {
            static app::SqlInt32__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::SqlInt32__Array__Class**)(modloader::win::memory::resolve_rva(0x04728BA8));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace SoundZoneProcessor_Job_ZoneType__Enum {
        namespace {
            inline app::SoundZoneProcessor_Job_ZoneType__Enum__Class* type_info_ref = nullptr;
        }
        inline app::SoundZoneProcessor_Job_ZoneType__Enum__Class** type_info = &type_info_ref;

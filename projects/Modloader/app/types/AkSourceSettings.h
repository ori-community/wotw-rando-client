...
namespace app::classes::types {
    namespace AkSourceSettings {
        inline app::AkSourceSettings__Class** type_info() {
            static app::AkSourceSettings__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::AkSourceSettings__Class**)(modloader::win::memory::resolve_rva(0x047580F8));
            }
            return cache;
        }

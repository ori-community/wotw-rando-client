#pragma once
#include <Modloader/app/structs/StatisticNameVersion_1.h>
...
namespace app::classes::types {
    namespace StatisticNameVersion_1 {
        inline app::StatisticNameVersion_1__Class** type_info() {
            static app::StatisticNameVersion_1__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::StatisticNameVersion_1__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

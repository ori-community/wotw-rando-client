...
namespace app::classes::types {
    namespace Camera_MonoOrStereoscopicEye__Enum {
        namespace {
            inline app::Camera_MonoOrStereoscopicEye__Enum__Class* type_info_ref = nullptr;
        }
        inline app::Camera_MonoOrStereoscopicEye__Enum__Class** type_info = &type_info_ref;

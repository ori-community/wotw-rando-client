...
namespace app::classes::types {
    namespace SinMovement_Affect_AffectType__Enum {
        namespace {
            inline app::SinMovement_Affect_AffectType__Enum__Class* type_info_ref = nullptr;
        }
        inline app::SinMovement_Affect_AffectType__Enum__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace RigidbodyInterpolation2D__Enum {
        inline app::RigidbodyInterpolation2D__Enum__Class** type_info() {
            static app::RigidbodyInterpolation2D__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::RigidbodyInterpolation2D__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

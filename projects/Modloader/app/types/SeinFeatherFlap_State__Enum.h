...
namespace app::classes::types {
    namespace SeinFeatherFlap_State__Enum {
        inline app::SeinFeatherFlap_State__Enum__Class** type_info() {
            static app::SeinFeatherFlap_State__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SeinFeatherFlap_State__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

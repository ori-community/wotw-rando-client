...
#include <Modloader/app/structs/Dictionary_2_TKey_TValue_Entry_FullSerializer_Internal_fsPortableReflection_AttributeQuery_System_Attribute___Array__Class.h>
...
namespace app::classes::types {
    namespace Dictionary_2_TKey_TValue_Entry_FullSerializer_Internal_fsPortableReflection_AttributeQuery_System_Attribute___Array {
        namespace {
            inline app::Dictionary_2_TKey_TValue_Entry_FullSerializer_Internal_fsPortableReflection_AttributeQuery_System_Attribute___Array__Class* type_info_ref = nullptr;
        }
        inline app::Dictionary_2_TKey_TValue_Entry_FullSerializer_Internal_fsPortableReflection_AttributeQuery_System_Attribute___Array__Class** type_info = &type_info_ref;

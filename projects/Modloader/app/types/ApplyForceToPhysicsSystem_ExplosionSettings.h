...
namespace app::classes::types {
    namespace ApplyForceToPhysicsSystem_ExplosionSettings {
        namespace {
            inline app::ApplyForceToPhysicsSystem_ExplosionSettings__Class* type_info_ref = nullptr;
        }
        inline app::ApplyForceToPhysicsSystem_ExplosionSettings__Class** type_info = &type_info_ref;

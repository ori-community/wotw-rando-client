...
namespace app::classes::types {
    namespace MoonRenderPipelineAsset_FxaaQualityLevel__Enum {
        inline app::MoonRenderPipelineAsset_FxaaQualityLevel__Enum__Class** type_info() {
            static app::MoonRenderPipelineAsset_FxaaQualityLevel__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::MoonRenderPipelineAsset_FxaaQualityLevel__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

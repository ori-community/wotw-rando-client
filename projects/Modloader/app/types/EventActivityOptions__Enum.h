...
namespace app::classes::types {
    namespace EventActivityOptions__Enum {
        inline app::EventActivityOptions__Enum__Class** type_info() {
            static app::EventActivityOptions__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::EventActivityOptions__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

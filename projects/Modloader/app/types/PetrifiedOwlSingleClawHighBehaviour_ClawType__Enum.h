...
namespace app::classes::types {
    namespace PetrifiedOwlSingleClawHighBehaviour_ClawType__Enum {
        namespace {
            inline app::PetrifiedOwlSingleClawHighBehaviour_ClawType__Enum__Class* type_info_ref = nullptr;
        }
        inline app::PetrifiedOwlSingleClawHighBehaviour_ClawType__Enum__Class** type_info = &type_info_ref;

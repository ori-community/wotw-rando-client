...
namespace app::classes::types {
    namespace TransactionStatus__Enum_1 {
        inline app::TransactionStatus__Enum_1__Class** type_info() {
            static app::TransactionStatus__Enum_1__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::TransactionStatus__Enum_1__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

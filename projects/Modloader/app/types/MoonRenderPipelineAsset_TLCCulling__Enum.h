...
namespace app::classes::types {
    namespace MoonRenderPipelineAsset_TLCCulling__Enum {
        namespace {
            inline app::MoonRenderPipelineAsset_TLCCulling__Enum__Class* type_info_ref = nullptr;
        }
        inline app::MoonRenderPipelineAsset_TLCCulling__Enum__Class** type_info = &type_info_ref;

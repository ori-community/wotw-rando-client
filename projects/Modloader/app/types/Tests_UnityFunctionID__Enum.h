...
namespace app::classes::types {
    namespace Tests_UnityFunctionID__Enum {
        inline app::Tests_UnityFunctionID__Enum__Class** type_info() {
            static app::Tests_UnityFunctionID__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::Tests_UnityFunctionID__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

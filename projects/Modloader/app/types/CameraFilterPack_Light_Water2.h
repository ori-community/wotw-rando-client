...
namespace app::classes::types {
    namespace CameraFilterPack_Light_Water2 {
        inline app::CameraFilterPack_Light_Water2__Class** type_info() {
            static app::CameraFilterPack_Light_Water2__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::CameraFilterPack_Light_Water2__Class**)(modloader::win::memory::resolve_rva(0x04798620));
            }
            return cache;
        }

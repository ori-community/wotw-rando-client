...
namespace app::classes::types {
    namespace SourceType__Enum_1 {
        inline app::SourceType__Enum_1__Class** type_info() {
            static app::SourceType__Enum_1__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SourceType__Enum_1__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace CameraFilterPack_Edge_Golden {
        inline app::CameraFilterPack_Edge_Golden__Class** type_info() {
            static app::CameraFilterPack_Edge_Golden__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::CameraFilterPack_Edge_Golden__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace GreaterThanOrEqualInstruction_GreaterThanOrEqualInt16 {
        inline app::GreaterThanOrEqualInstruction_GreaterThanOrEqualInt16__Class** type_info() {
            static app::GreaterThanOrEqualInstruction_GreaterThanOrEqualInt16__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::GreaterThanOrEqualInstruction_GreaterThanOrEqualInt16__Class**)(modloader::win::memory::resolve_rva(0x04721D10));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace MoonTelemetryPlayerSessionPauseEvent {
        namespace {
            inline app::MoonTelemetryPlayerSessionPauseEvent__Class* type_info_ref = nullptr;
        }
        inline app::MoonTelemetryPlayerSessionPauseEvent__Class** type_info = &type_info_ref;

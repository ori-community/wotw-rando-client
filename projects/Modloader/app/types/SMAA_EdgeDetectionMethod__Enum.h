...
namespace app::classes::types {
    namespace SMAA_EdgeDetectionMethod__Enum {
        inline app::SMAA_EdgeDetectionMethod__Enum__Class** type_info() {
            static app::SMAA_EdgeDetectionMethod__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SMAA_EdgeDetectionMethod__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace MoonRenderPipelineAsset_WaterSimulationUpdateMode__Enum__Array {
        inline app::MoonRenderPipelineAsset_WaterSimulationUpdateMode__Enum__Array__Class** type_info() {
            static app::MoonRenderPipelineAsset_WaterSimulationUpdateMode__Enum__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::MoonRenderPipelineAsset_WaterSimulationUpdateMode__Enum__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

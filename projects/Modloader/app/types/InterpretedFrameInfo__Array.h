...
namespace app::classes::types {
    namespace InterpretedFrameInfo__Array {
        inline app::InterpretedFrameInfo__Array__Class** type_info() {
            static app::InterpretedFrameInfo__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::InterpretedFrameInfo__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace HTML_BrowserReady_t {
        inline app::HTML_BrowserReady_t__Class** type_info() {
            static app::HTML_BrowserReady_t__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::HTML_BrowserReady_t__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

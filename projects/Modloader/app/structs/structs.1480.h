namespace app {
    ...
    struct EarlyZChildDebugger__Array__VTable {
    };
    ...
    enum class PetrifiedOwlBossEntity_AnimationDirections__Enum : int32_t {
        Normal = 0x00000000,
        Mirrored = 0x00000001,
    };

    struct PetrifiedOwlBossEntity_AnimationDirections__Enum__Boxed {
        struct PetrifiedOwlBossEntity_AnimationDirections__Enum__Class* klass;
        MonitorData* monitor;
        PetrifiedOwlBossEntity_AnimationDirections__Enum value;
    };

    struct PetrifiedOwlBossEntity_AnimationDirections__Enum__VTable {
        VirtualInvokeData Equals;
        VirtualInvokeData Finalize;
        VirtualInvokeData GetHashCode;
        VirtualInvokeData ToString;
    ...
    struct PetrifiedOwlBossEntity_AnimationDirections__Enum__StaticFields {
    };

    struct PetrifiedOwlBossEntity_AnimationDirections__Enum__Class {
        Il2CppClass_0 _0;
        Il2CppRuntimeInterfaceOffsetPair* interfaceOffsets;
        struct PetrifiedOwlBossEntity_AnimationDirections__Enum__StaticFields* static_fields;
        const Il2CppRGCTXData* rgctx_data;
        Il2CppClass_1 _1;
        struct PetrifiedOwlBossEntity_AnimationDirections__Enum__VTable vtable;
    };
    ...
    struct SmoothCurve__Array__VTable {
    };

    struct SmoothCurve__Array__StaticFields {
    };

    struct SmoothCurve__Array__Class {
        Il2CppClass_0 _0;
        Il2CppRuntimeInterfaceOffsetPair* interfaceOffsets;
        struct SmoothCurve__Array__StaticFields* static_fields;
        const Il2CppRGCTXData* rgctx_data;
        Il2CppClass_1 _1;
        struct SmoothCurve__Array__VTable vtable;
    };

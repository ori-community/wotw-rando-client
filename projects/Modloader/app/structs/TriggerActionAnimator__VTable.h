...
#ifdef IL2CPP_STRUCT_TriggerActionAnimator__VTable_INITIALIZING
#elif defined(IL2CPP_STRUCTS_INITIALIZING)
#define IL2CPP_STRUCT_TriggerActionAnimator__VTable_INITIALIZING
#if !defined(IL2CPP_STRUCT_TriggerActionAnimator__VTable_DEFINED)
#define IL2CPP_STRUCT_TriggerActionAnimator__VTable_DEFINED
...
#endif
#if !defined(IL2CPP_STRUCT_TriggerActionAnimator__VTable_FWDDECL)
#define IL2CPP_STRUCT_TriggerActionAnimator__VTable_FWDDECL
#endif
#undef IL2CPP_STRUCT_TriggerActionAnimator__VTable_INITIALIZING
#if !defined(IL2CPP_STRUCT_TriggerActionAnimator__VTable_DEFINED) && !defined(IL2CPP_STRUCT_TriggerActionAnimator__VTable_FWDDECL)
#include <Modloader/app/structs/TriggerActionAnimator__VTable.h>
#endif
#else
namespace app {

namespace app {
    ...
    enum class LightCullingSystem_LightCullingGroupId__Enum : int32_t {
        TorchLights = 0x00000000,
        GameplayLights = 0x00000001,
    };

    struct LightCullingSystem_LightCullingGroupId__Enum__Boxed {
        struct LightCullingSystem_LightCullingGroupId__Enum__Class* klass;
        MonitorData* monitor;
        LightCullingSystem_LightCullingGroupId__Enum value;
    };
    ...
    struct MoonRenderPipelineViewType__Enum__Boxed {
        struct MoonRenderPipelineViewType__Enum__Class* klass;
        MonitorData* monitor;
        MoonRenderPipelineViewType__Enum value;
    };
    ...
    enum class RuntimeSliceRenderSettings_DofCurveMode__Enum : int32_t {
        From = 0x00000000,
        To = 0x00000001,
        Tween = 0x00000002,
        Off = 0x00000003,

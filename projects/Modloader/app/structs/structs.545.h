namespace app {
    ...
    enum class DamageType__Enum : int32_t {
        ...
        Explosion = 0x00000008,
        Heat = 0x00000009,
        Bat = 0x0000000a,
        Enemy = 0x0000000b,
        Crush = 0x0000000c,
        SpiritFlame = 0x0000000d,
        Bash = 0x0000000e,
        Grenade = 0x0000000f,
        GoldenSein = 0x00000010,
        Stomp = 0x00000011,
        StompBlast = 0x00000012,
        Chakram = 0x00000013,
        NightBerryDied = 0x00000014,
        HitSurface = 0x00000015,
        SpiritFlameSplatter = 0x00000016,
        LevelUp = 0x00000017,
        Drowning = 0x00000018,
        ChargeFlame = 0x00000019,
        SpiritSlash = 0x0000001a,
        HeavySpiritSlash = 0x0000001b,
        HomingMissile = 0x0000001c,
        JumpShot = 0x0000001d,
        LightSpear = 0x0000001e,
        Fireburst = 0x0000001f,
        Firewhirl = 0x00000020,
        LifeAbsorb = 0x00000021,
        Powerslide = 0x00000022,
        SpiritSpear = 0x00000023,
        SpiritCresent = 0x00000024,
        SpiritShard = 0x00000025,
        LockOn = 0x00000026,
        SpiritSentry = 0x00000027,
        Mine = 0x00000028,
        StickyMine = 0x00000029,
        ChargeShot = 0x0000002a,
        Bow = 0x0000002b,
        Hammer = 0x0000002c,
        TorchStick = 0x0000002d,
        IgnitedTorchStickRed = 0x0000002e,
        Sword = 0x0000002f,
        Wind = 0x00000030,
        IgnitedTorchStickBlue = 0x00000031,
        Obstacle = 0x00000032,
        Draining = 0x00000033,
        Glow = 0x00000034,
        SpiritLeash = 0x00000035,
        ChargeJump = 0x00000036,
        Tar = 0x00000037,
        BashThrough = 0x00000038,
        Blaze = 0x00000039,
        Melee = 0x00000064,
        DiggingDash = 0x00000065,
        SwimmingDash = 0x00000066,
        DebugDamage = 0x00000190,
        InstantKill = 0x00000191,
        DeadlyDarkness = 0x00000192,
        Interaction = 0x00000193,
    };

    struct DamageType__Enum__Boxed {
        struct DamageType__Enum__Class* klass;
        MonitorData* monitor;
    ...
    struct DamageLayerMask__Enum__Boxed {
        struct DamageLayerMask__Enum__Class* klass;
        MonitorData* monitor;
        DamageLayerMask__Enum value;
    };

    enum class Damage_DamageEffectPositionMode__Enum : int32_t {
        ReceiverPosition = 0x00000000,
        ReceiverClosestPointFromSender = 0x00000001,
    };
    ...
    enum class DamageResultType__Enum : int32_t {
        Received = 0x00000000,
        Ignored = 0x00000001,
        Blocked = 0x00000002,
    };
    ...
    struct DamageResultType__Enum__Boxed {
        struct DamageResultType__Enum__Class* klass;
        MonitorData* monitor;
    ...
    struct EffectTransformType__Enum__Boxed {
        struct EffectTransformType__Enum__Class* klass;
        MonitorData* monitor;
        EffectTransformType__Enum value;
    };
    ...
    enum class SeinGlide_State__Enum : int32_t {
        Idle = 0x00000000,
        Glide = 0x00000001,
    };

    struct SeinGlide_State__Enum__Boxed {
        struct SeinGlide_State__Enum__Class* klass;
        MonitorData* monitor;
        SeinGlide_State__Enum value;
    };
    ...
    enum class SeinFeatherFlap_State__Enum : int32_t {
        Idle = 0x00000000,
        Attack = 0x00000001,
    };

    struct SeinFeatherFlap_State__Enum__Boxed {
        struct SeinFeatherFlap_State__Enum__Class* klass;
        MonitorData* monitor;
        SeinFeatherFlap_State__Enum value;
    };
    ...
    enum class SeinGrabBlock_State__Enum : int32_t {
        Push = 0x00000000,
        PushFail = 0x00000001,
        Pull = 0x00000002,
        PullFail = 0x00000003,
    ...
    struct SeinGrabBlock_State__Enum__Boxed {
        struct SeinGrabBlock_State__Enum__Class* klass;
        MonitorData* monitor;
        SeinGrabBlock_State__Enum value;
    };
    ...
    enum class SeinWallSlide_State__Enum : int32_t {
        Normal = 0x00000000,
        SlidingLeft = 0x00000001,
        SlidingRight = 0x00000002,
    };

    struct SeinWallSlide_State__Enum__Boxed {
        struct SeinWallSlide_State__Enum__Class* klass;
        MonitorData* monitor;
        SeinWallSlide_State__Enum value;
    };
    ...
    struct SeinGrabRope_State__Enum__Boxed {
        struct SeinGrabRope_State__Enum__Class* klass;
        MonitorData* monitor;
        SeinGrabRope_State__Enum value;
    };

namespace app {
    ...
    struct XHashtable_1_TValue_XHashtableState_TValue_Entry_System_Object___Array__VTable {
    };

    struct XHashtable_1_TValue_XHashtableState_TValue_Entry_System_Object___Array__StaticFields {
    };

    struct XHashtable_1_TValue_XHashtableState_TValue_Entry_System_Object___Array__Class {
        Il2CppClass_0 _0;
        Il2CppRuntimeInterfaceOffsetPair* interfaceOffsets;
        struct XHashtable_1_TValue_XHashtableState_TValue_Entry_System_Object___Array__StaticFields* static_fields;
        const Il2CppRGCTXData* rgctx_data;
        Il2CppClass_1 _1;
        struct XHashtable_1_TValue_XHashtableState_TValue_Entry_System_Object___Array__VTable vtable;
    };

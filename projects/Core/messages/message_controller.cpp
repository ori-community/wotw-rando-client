...
namespace core::messages {
    namespace {
        ...
        auto on_game_ready = modloader::event_bus().register_handler(ModloaderEvent::GameReady, [](auto) {
            ...
            recent_pickups_background->texture(core::api::graphics::textures::get_texture_from_identifier("file:textures/gradient_corner_bottom_left.png"));
    ...
    message_handle_ptr_t MessageController::queue_central(MessageInfo info, bool add_to_recent) {
        if (add_to_recent) {
            // Copy processed text

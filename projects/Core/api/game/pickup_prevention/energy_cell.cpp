...
namespace {
    IL2CPP_INTERCEPT(void, SeinEnergy, set_BaseMaxEnergy, app::SeinEnergy * this_ptr, float value) {
        if (!core::api::game::player::prevent_default_pickup_handlers) {
            next::SeinEnergy::set_BaseMaxEnergy(this_ptr, value);
        }
    }

    IL2CPP_INTERCEPT(void, SeinEnergy, set_Current, app::SeinEnergy * this_ptr, float value) {
        if (!core::api::game::player::prevent_default_pickup_handlers) {
            next::SeinEnergy::set_Current(this_ptr, value);
        }
    }

    IL2CPP_INTERCEPT(void, SeinLevel, set_PartialEnergyContainers, app::SeinLevel * this_ptr, int value) {
        if (!core::api::game::player::prevent_default_pickup_handlers) {

...
CORE_C_DLLEXPORT bool has_ability(app::AbilityType__Enum ability) {
    return game::player::has_ability(ability);
}

CORE_C_DLLEXPORT void set_ability(app::AbilityType__Enum ability, bool value) {
    return game::player::set_ability(ability, value);
}

CORE_C_DLLEXPORT void set_equipment(app::EquipmentType__Enum equip, bool value) {
...
CORE_C_DLLEXPORT bool player_can_move() {

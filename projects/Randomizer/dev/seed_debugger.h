...
namespace randomizer::dev::seed_debugger {
    ...
    using seed_event_t = std::variant<seed::SeedClientEvent, core::api::uber_states::UberState, std::size_t>;
    ...
    void add_seed_event_breakpoint(DebuggerType debugger, seed::SeedClientEvent event);
    bool remove_seed_event_breakpoint(DebuggerType debugger, seed::SeedClientEvent event);
    bool toggle_seed_event_breakpoint(DebuggerType debugger, seed::SeedClientEvent event);
    ...
    void seed_event_start(seed::SeedClientEvent event);
    void seed_event_end(seed::SeedClientEvent event);

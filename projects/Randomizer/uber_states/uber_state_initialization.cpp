    ...
    namespace {
        ...
        IL2CPP_INTERCEPT(Moon::UberStateCollection, void, PrepareRuntimeDataType, (app::UberStateCollection * this_ptr)) {
            ...
            std::vector<app::IUberState*> states = {
                ...
                add_state<app::SerializedBooleanUberState>(UberStateGroup::GromShop, "spiritWellPlayCutscene", 216825, false),
                add_state<app::SerializedBooleanUberState>(UberStateGroup::GromShop, "housesAPlayCutscene", 251230, false),
                add_state<app::SerializedBooleanUberState>(UberStateGroup::GromShop, "housesBPlayCutscene", 223607, false),
                add_state<app::SerializedBooleanUberState>(UberStateGroup::GromShop, "housesCPlayCutscene", 240448, false),
                add_state<app::SerializedBooleanUberState>(UberStateGroup::GromShop, "removeThornsPlayCutscene", 218751, false),
                add_state<app::SerializedBooleanUberState>(UberStateGroup::GromShop, "openCavePlayCutscene", 216586, false),
                add_state<app::SerializedBooleanUberState>(UberStateGroup::GromShop, "beautifyPlayCutscene", 215068, false),
                ...
                add_state<app::SerializedIntUberState>(UberStateGroup::TuleyShop, "bashPlantsCost", 147651, 0),
                add_state<app::SerializedIntUberState>(UberStateGroup::TuleyShop, "flowersCost", 116254, 0),
                add_state<app::SerializedIntUberState>(UberStateGroup::TuleyShop, "grapplePlantsCost", 133011, 0),
                add_state<app::SerializedIntUberState>(UberStateGroup::TuleyShop, "grassCost", 164583, 0),
                add_state<app::SerializedIntUberState>(UberStateGroup::TuleyShop, "springPlantsCost", 138393, 0),
                add_state<app::SerializedIntUberState>(UberStateGroup::TuleyShop, "treeCost", 140006, 0),

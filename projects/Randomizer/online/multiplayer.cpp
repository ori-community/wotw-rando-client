...
namespace randomizer::online {
    ...
    void MultiplayerUniverse::process_set_game_difficulty_settings_overrides_message(const Network::SetGameDifficultySettingsOverridesMessage& message) {
        ...
        if (
            ...
            set_game_difficulty_settings_overrides(
                seed::Seed::GameDifficultySettings{
                    static_cast<seed::Seed::GameDifficultySetting>(message.overrides().easy()),
                    static_cast<seed::Seed::GameDifficultySetting>(message.overrides().normal()),
                    static_cast<seed::Seed::GameDifficultySetting>(message.overrides().hard()),
                }
            );
        }
    }
    ...
    void MultiplayerUniverse::set_game_difficulty_settings_overrides(std::optional<seed::Seed::GameDifficultySettings> overrides) {

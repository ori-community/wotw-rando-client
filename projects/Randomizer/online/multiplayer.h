...
namespace randomizer::online {
    ...
    public:
        ...
        std::optional<seed::Seed::GameDifficultySettings> game_difficulty_settings_overrides() const { return m_game_difficulty_settings_overrides; }
        ...
        void set_game_difficulty_settings_overrides(std::optional<seed::Seed::GameDifficultySettings> overrides);
    ...
    private:
        ...
        std::optional<seed::Seed::GameDifficultySettings> m_game_difficulty_settings_overrides = std::nullopt;

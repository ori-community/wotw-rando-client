...
namespace shops {
    ...
    std::shared_ptr<core::textures::TextureData> default_texture;
    std::shared_ptr<core::textures::TextureData> get_icon(ShopType type, void* shop_item) {
        std::shared_ptr<core::textures::TextureData> output;
        ...
        if (default_texture == nullptr) {
            default_texture = core::textures::create_texture();
    ...
    void set_item(ShopItem& item, const wchar_t* name, const wchar_t* description, const wchar_t* texture, bool uses_energy, bool is_locked, bool is_visible) {
        ...
        if (texture == nullptr)
            ...
            item.texture_data = core::textures::get_texture(texture);

...
namespace {
    ...
    IL2CPP_INTERCEPT(PlayerSpiritShards, bool, HasShard, (app::PlayerSpiritShards * this_ptr, app::SpiritShardType__Enum shad_type)) {
        if (shops::is_in_shop(shops::ShopType::Twillen) && TWILLEN_SHARDS.find(shad_type) != TWILLEN_SHARDS.end())
            return csharp_bridge::twillen_bought_shard(static_cast<ShardType>(shad_type));
    ...
    IL2CPP_INTERCEPT(SpiritShardsShopScreen, void, CompletePurchase, (app::SpiritShardsShopScreen * this_ptr)) {
        ...
        csharp_bridge::twillen_buy_shard(static_cast<ShardType>(shard->fields.m_type));
    ...
    IL2CPP_INTERCEPT(UpgradableShardItem, void, DoPurchase, (app::UpgradableShardItem * this_ptr, app::PurchaseContext* context)) {
        ...
        csharp_bridge::twillen_shard_upgraded(static_cast<ShardType>(this_ptr->fields.Shard), level, cost);
    }

    std::shared_ptr<core::textures::TextureData> get_shard_icon(app::SpiritShardType__Enum shard) {
    ...
    std::unordered_map<app::SpiritShardType__Enum, std::shared_ptr<core::textures::TextureData>> shard_textures;
    ...
    IL2CPP_INTERCEPT(SpiritShardDescription, int, get_BuyCost, (app::SpiritShardDescription * this_ptr)) {
        return csharp_bridge::twillen_shard_cost(static_cast<ShardType>(this_ptr->fields.InitialBuyCost));
    }
    ...
    IL2CPP_INTERCEPT(SpiritShardShopUIItem, void, UpdateShard, (app::SpiritShardShopUIItem * this_ptr, app::PlayerUberStateShards_Shard* shard)) {
        ...
        if (shard != nullptr) {
            ...
            owned = csharp_bridge::twillen_bought_shard(static_cast<ShardType>(shard->fields.m_type));
            visible = Moon::uberSerializationWisp::PlayerUberStateShards_Shard::get_VisibleInShop(shard);
            auto cost = csharp_bridge::twillen_shard_cost(static_cast<ShardType>(shard->fields.m_type));
...
RANDOMIZER_C_DLLEXPORT void set_twillen_item(int shard, const wchar_t* name, const wchar_t* description, const wchar_t* texture, bool is_locked, bool is_visible) {

...
namespace {
    ...
    IL2CPP_INTERCEPT(ControlList, void, RemoveBinding, (app::ControlList * this_ptr, app::ControlItem* control, app::KeyCode__Enum code)) {
        if (is_assigning_key) {
            return;
        }
    ...
    IL2CPP_INTERCEPT(ControlList, void, AssignKey, (app::ControlList * this_ptr, app::ControlItem* control, int32_t index, app::KeyCode__Enum pressed_key)) {

...
namespace custom_cutscene_skips {
    namespace {
        ...
        constexpr frozen::unordered_map<frozen::string, VanillaCutsceneSkipConfig, 6> AUTOMATIC_CUTSCENE_SKIP_BLOCK_TIMES_FOR_VANILLA_CUTSCENES{
            ...
            {"meetingKwolokMaster/skipCutscene", {1.0f}},
            {"baurSetupScene/interactives/baurSetup/skipAfterAvalancheCutscene", {1.0f}},
            {"matkasChamberBossPlaceholder__clone1/setups/skipCutscene", {1.0f}},
        };

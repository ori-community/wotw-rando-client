...
namespace randomizer::doors {
    namespace {
        ...
        const std::unordered_map<DoorName, DoorInfo> DEFAULT_DOORS{
            ...
            {"waterMillInsideDoorC",    {"wellspringSecondFloorExit", {"waterMillBEntrance"}, "waterMillOutsideDoorC"}                                     },
            {"waterMillOutsideDoorD",   {"wellspringThirdFloorEntrance", {"waterMillEntranceTop"}, "waterMillInsideDoorD"}                                 },

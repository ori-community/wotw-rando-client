...
RANDOMIZER_C_DLLEXPORT void add_player(const wchar_t* id, const wchar_t* name, multiplayer::PlayerIcon icon);
RANDOMIZER_C_DLLEXPORT void set_player_icon(const wchar_t* id, multiplayer::PlayerIcon icon);
RANDOMIZER_C_DLLEXPORT void set_player_color(const wchar_t* id, float r, float g, float b, float a);
RANDOMIZER_C_DLLEXPORT void set_player_visibility(const wchar_t* id, bool world, bool map);
RANDOMIZER_C_DLLEXPORT void set_local_player_color(float r, float g, float b, float a);
RANDOMIZER_C_DLLEXPORT void clear_players();
RANDOMIZER_C_DLLEXPORT void remove_player(const wchar_t* id);
RANDOMIZER_C_DLLEXPORT void update_player_position(const wchar_t* id, float x, float y, const char* ghost_frame_data, int ghost_frame_data_length);
RANDOMIZER_C_DLLEXPORT void set_player_online(const wchar_t* id, bool online);
...
RANDOMIZER_C_DLLEXPORT void update_player_map_position(const wchar_t* id, float x, float y) {
    auto it = multiplayer::player_map.find(id);
    if (it != multiplayer::player_map.end()) {
        multiplayer::PlayerInfo& info = multiplayer::players[it->second];
...
RANDOMIZER_C_DLLEXPORT app::Vector2 get_player_position(const wchar_t* id) {
    auto it = multiplayer::player_map.find(id);
    if (it != multiplayer::player_map.end()) {
...
RANDOMIZER_C_DLLEXPORT app::Vector2 get_player_map_position(const wchar_t* id) {
    auto it = multiplayer::player_map.find(id);
    if (it != multiplayer::player_map.end())

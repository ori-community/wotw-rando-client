...
enum EditorBrowsableState__Enum : int32_t {
  EditorBrowsableState__Enum_Always = 0,
  EditorBrowsableState__Enum_Never = 1,
  EditorBrowsableState__Enum_Advanced = 2,
};
struct EditorBrowsableState__Enum__Boxed {
  struct Enum__Class *klass;
  struct MonitorData *monitor;
  enum EditorBrowsableState__Enum value;
};
struct __declspec(align(8)) EditorBrowsableAttribute__Fields {
  enum EditorBrowsableState__Enum browsableState;
};
...
enum LicenseUsageMode__Enum : int32_t {
  LicenseUsageMode__Enum_Runtime = 0,
  LicenseUsageMode__Enum_Designtime = 1,
};
struct LicenseUsageMode__Enum__Boxed {
  struct Enum__Class *klass;
  struct MonitorData *monitor;
  enum LicenseUsageMode__Enum value;
};
...
struct __declspec(align(8)) LicenseManager_LicenseInteropHelper_CLRLicenseContext__Fields {
  enum LicenseUsageMode__Enum usageMode;
  struct Type * type;
  struct String * key;
};

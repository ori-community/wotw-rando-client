...
enum CameraSettingsZone_ZoneMode__Enum : int32_t {
  CameraSettingsZone_ZoneMode__Enum_Single = 0,
  CameraSettingsZone_ZoneMode__Enum_Gradient = 1,
};
struct CameraSettingsZone_ZoneMode__Enum__Boxed {
  struct Enum__Class *klass;
  struct MonitorData *monitor;
  enum CameraSettingsZone_ZoneMode__Enum value;
};
enum CameraSettingsZone_Direction__Enum : int32_t {
  CameraSettingsZone_Direction__Enum_Horizontal = 0,
  CameraSettingsZone_Direction__Enum_Vertical = 1,
};
struct CameraSettingsZone_Direction__Enum__Boxed {
  struct Enum__Class *klass;
  struct MonitorData *monitor;
  enum CameraSettingsZone_Direction__Enum value;
};
struct CameraSettingsZone__Fields {
  struct MonoBehaviour__Fields _;
  enum CameraSettingsZone_ZoneMode__Enum Mode;
  enum CameraSettingsZone_Direction__Enum GradientDirection;

...
enum CartAccelerationInputType__Enum : int32_t {
  CartAccelerationInputType__Enum_ShoulderButtons = 0,
  CartAccelerationInputType__Enum_AnalogStickFullRange = 1,
  CartAccelerationInputType__Enum_AnalogStickLeftRight = 2,
  CartAccelerationInputType__Enum_Custom = 3,
};
struct CartAccelerationInputType__Enum__Boxed {
  struct Enum__Class *klass;
  struct MonitorData *monitor;
  enum CartAccelerationInputType__Enum value;
};
enum Input_Button__Enum : int32_t {
  Input_Button__Enum_ButtonA = 0,
  Input_Button__Enum_ButtonX = 1,
  Input_Button__Enum_ButtonY = 2,
  Input_Button__Enum_ButtonB = 3,
  Input_Button__Enum_LeftTrigger = 4,
  Input_Button__Enum_RightTrigger = 5,
  Input_Button__Enum_LeftShoulder = 6,
  Input_Button__Enum_RightShoulder = 7,
  Input_Button__Enum_Left = 8,
  Input_Button__Enum_Right = 9,
  Input_Button__Enum_Up = 10,
  Input_Button__Enum_Down = 11,
  Input_Button__Enum_Unassigned = 12,
  Input_Button__Enum_Any = 13,
  Input_Button__Enum_LeftStick = 14,
  Input_Button__Enum_RightStick = 15,
};
struct Input_Button__Enum__Boxed {
  struct Enum__Class *klass;
  struct MonitorData *monitor;
  enum Input_Button__Enum value;
};
struct CartController__Fields {
  struct SaveSerialize__Fields _;
  bool IgnoreControllerInput;
  struct Cart * Cart;
  enum CartAccelerationInputType__Enum CartAccelerationInputType;
  enum Input_Button__Enum AccelerateButton;
  enum Input_Button__Enum DecelerateButton;
  enum Input_Button__Enum BoostButton;
  enum Input_Button__Enum FlipButton;
  bool UseStickToFlip;
  bool AllowBash;
  bool LimitBrakeTime;
...
struct PlatformBehaviour__Fields {
  ...
  enum SurfaceMaterialType__Enum m_wallSurfaceMaterialType;
  enum SurfaceMaterialType__Enum m_groundSurfaceMaterialType;
  enum SurfaceMaterialType__Enum m_ceilingSurfaceMaterialType;
};
...
enum LegacyTimelineSequence_SortMode__Enum : int32_t {
  LegacyTimelineSequence_SortMode__Enum_None = 0,
  LegacyTimelineSequence_SortMode__Enum_Name = 1,
  LegacyTimelineSequence_SortMode__Enum_Time = 2,
};
struct LegacyTimelineSequence_SortMode__Enum__Boxed {
  struct Enum__Class *klass;
  struct MonitorData *monitor;
  enum LegacyTimelineSequence_SortMode__Enum value;
};
struct LegacyTimelineSequence__Fields {
  struct BaseTimelineSequence__Fields _;
  enum LegacyTimelineSequence_SortMode__Enum Mode;

...
enum GameMapUI_WorldMapStates__Enum : int32_t {
  GameMapUI_WorldMapStates__Enum_Normal = 0,
  GameMapUI_WorldMapStates__Enum_ShowingObjective = 1,
  GameMapUI_WorldMapStates__Enum_RevealingMap = 2,
  GameMapUI_WorldMapStates__Enum_ShowingPedestals = 3,
  GameMapUI_WorldMapStates__Enum_ShowingQuests = 4,
  GameMapUI_WorldMapStates__Enum_ShowingLegend = 5,
  GameMapUI_WorldMapStates__Enum_PlacingPins = 6,
  GameMapUI_WorldMapStates__Enum_ShowingWorldMap = 7,
};
struct GameMapUI_WorldMapStates__Enum__Boxed {
  struct Enum__Class *klass;
  struct MonitorData *monitor;
  enum GameMapUI_WorldMapStates__Enum value;
};
struct GameMapUI__Fields {
  ...
  enum GameMapUI_WorldMapStates__Enum MapState;
  struct List_1_RuntimeWorldMapIcon_ * TeleportTargets;
  bool m_shouldRestoreStateAfterEnteringAreaMap;
  enum GameMapUI_WorldMapStates__Enum m_mapStateBeforeWorldMap;

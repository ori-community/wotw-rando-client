...
struct JPropertyDescriptor__Fields {
...
struct JPropertyDescriptor__VTable {
...
struct JPropertyDescriptor__StaticFields {
};
struct JPropertyDescriptor__Class {
  struct Il2CppClass_0 _0;
  Il2CppRuntimeInterfaceOffsetPair *interfaceOffsets;
  struct JPropertyDescriptor__StaticFields *static_fields;
  const Il2CppRGCTXData *rgctx_data;
  struct Il2CppClass_1 _1;
  struct JPropertyDescriptor__VTable vtable;
};

struct JValue__Fields {
  struct JToken__Fields _;
  enum JTokenType__Enum _valueType;

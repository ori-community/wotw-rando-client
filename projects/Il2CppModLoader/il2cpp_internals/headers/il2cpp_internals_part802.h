...
enum XalTraceLevel__Enum : int32_t {
  XalTraceLevel__Enum_Off = 0,
  XalTraceLevel__Enum_Error = 1,
  XalTraceLevel__Enum_Warning = 2,
  XalTraceLevel__Enum_Important = 3,
  XalTraceLevel__Enum_Information = 4,
  XalTraceLevel__Enum_Verbose = 5,
};
struct XalTraceLevel__Enum__Boxed {
  struct Enum__Class *klass;
  struct MonitorData *monitor;
  enum XalTraceLevel__Enum value;
};

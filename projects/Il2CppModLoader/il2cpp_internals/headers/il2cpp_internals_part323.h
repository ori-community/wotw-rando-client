namespace app {
struct GenericPlayFabIdPair__StaticFields {
};
struct GenericPlayFabIdPair__Class {
  struct Il2CppClass_0 _0;
  Il2CppRuntimeInterfaceOffsetPair *interfaceOffsets;
  struct GenericPlayFabIdPair__StaticFields *static_fields;
  const Il2CppRGCTXData *rgctx_data;
  struct Il2CppClass_1 _1;
  struct GenericPlayFabIdPair__VTable vtable;
};
struct IEnumerator_1_PlayFab_ClientModels_GenericPlayFabIdPair___VTable {
  VirtualInvokeData get_Current;
};
struct IEnumerator_1_PlayFab_ClientModels_GenericPlayFabIdPair___StaticFields {
};
struct IEnumerator_1_PlayFab_ClientModels_GenericPlayFabIdPair___Class {
  struct Il2CppClass_0 _0;
  Il2CppRuntimeInterfaceOffsetPair *interfaceOffsets;
  struct IEnumerator_1_PlayFab_ClientModels_GenericPlayFabIdPair___StaticFields *static_fields;
  const Il2CppRGCTXData *rgctx_data;
  struct Il2CppClass_1 _1;
  struct IEnumerator_1_PlayFab_ClientModels_GenericPlayFabIdPair___VTable vtable;
};

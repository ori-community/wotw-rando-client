...
enum GlobalBrightnessController_BrigthnessContributionOrder__Enum : int32_t {
  GlobalBrightnessController_BrigthnessContributionOrder__Enum_DynamicCameraTargetting = 0,
  GlobalBrightnessController_BrigthnessContributionOrder__Enum_DynamicBrightnessSource = 10,
  GlobalBrightnessController_BrigthnessContributionOrder__Enum_BrightnessZoneModifier = 15,
  GlobalBrightnessController_BrigthnessContributionOrder__Enum_GlobalBrightnessAnimator = 20,
};
struct GlobalBrightnessController_BrigthnessContributionOrder__Enum__Boxed {
  struct Enum__Class *klass;
  struct MonitorData *monitor;
  enum GlobalBrightnessController_BrigthnessContributionOrder__Enum value;
};
...
enum CameraScrollLock_ScrollLockMode__Enum : int32_t {
  CameraScrollLock_ScrollLockMode__Enum_BothSides = 0,
  CameraScrollLock_ScrollLockMode__Enum_LeftOrBottom = 1,
  CameraScrollLock_ScrollLockMode__Enum_RightOrTop = 2,
};
struct CameraScrollLock_ScrollLockMode__Enum__Boxed {
  struct Enum__Class *klass;
  struct MonitorData *monitor;
  enum CameraScrollLock_ScrollLockMode__Enum value;
};
enum CameraScrollLock_Type__Enum : int32_t {
  CameraScrollLock_Type__Enum_Horizontal = 0,
  CameraScrollLock_Type__Enum_Vertical = 1,
};
struct CameraScrollLock_Type__Enum__Boxed {
  struct Enum__Class *klass;
  struct MonitorData *monitor;
  enum CameraScrollLock_Type__Enum value;
};
struct CameraScrollLock__Fields {
  ...
  bool Dynamic;
  enum CameraScrollLock_ScrollLockMode__Enum LockMode;
  struct Rect m_boundingRect;
  bool m_boundingRectCalculated;
  enum CameraScrollLock_Type__Enum m_scrollType;
};

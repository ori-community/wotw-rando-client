...
struct FtpWebResponse__Fields {
  ...
  struct Stream * stream;
  struct Uri * uri;
  enum FtpStatusCode__Enum statusCode;
...
enum FtpWebRequest_RequestState__Enum : int32_t {
  FtpWebRequest_RequestState__Enum_Before = 0,
  FtpWebRequest_RequestState__Enum_Scheduled = 1,
  FtpWebRequest_RequestState__Enum_Connecting = 2,
  FtpWebRequest_RequestState__Enum_Authenticating = 3,
  FtpWebRequest_RequestState__Enum_OpeningData = 4,
  FtpWebRequest_RequestState__Enum_TransferInProgress = 5,
  FtpWebRequest_RequestState__Enum_Finished = 6,
  FtpWebRequest_RequestState__Enum_Aborted = 7,
  FtpWebRequest_RequestState__Enum_Error = 8,
};
struct FtpWebRequest_RequestState__Enum__Boxed {
  struct Enum__Class *klass;
  struct MonitorData *monitor;
  enum FtpWebRequest_RequestState__Enum value;
};
struct FtpWebRequest__Fields {
  ...
  struct Object * locker;
  enum FtpWebRequest_RequestState__Enum requestState;

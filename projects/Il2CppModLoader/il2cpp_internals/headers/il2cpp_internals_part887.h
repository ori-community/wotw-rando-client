...
enum PlayableCharacterAnimator_PlayableCharacters__Enum : int32_t {
  PlayableCharacterAnimator_PlayableCharacters__Enum_Ku = 0,
  PlayableCharacterAnimator_PlayableCharacters__Enum_Ori = 1,
};
struct PlayableCharacterAnimator_PlayableCharacters__Enum__Boxed {
  struct Enum__Class *klass;
  struct MonitorData *monitor;
  enum PlayableCharacterAnimator_PlayableCharacters__Enum value;
};
struct PlayableCharacterAnimator__Fields {
  struct TimelineEntity__Fields _;
  enum PlayableCharacterAnimator_PlayableCharacters__Enum PlayableCharacter;
...
enum PlayableCharacterControlAnimator_PlayableCharacters__Enum : int32_t {
  PlayableCharacterControlAnimator_PlayableCharacters__Enum_Ori = 0,
  PlayableCharacterControlAnimator_PlayableCharacters__Enum_Ku = 1,
};
struct PlayableCharacterControlAnimator_PlayableCharacters__Enum__Boxed {
  struct Enum__Class *klass;
  struct MonitorData *monitor;
  enum PlayableCharacterControlAnimator_PlayableCharacters__Enum value;
};
struct PlayableCharacterControlAnimator__Fields {
  struct TimelineEntity__Fields _;
  enum PlayableCharacterControlAnimator_PlayableCharacters__Enum PlayableCharacter;
...
struct ShowGetWispTextEntity__Fields {
  struct ShowTextEntity__Fields _;
  enum WispMessageIcon_Wisp__Enum Wisp;
};
...
enum ShowQuestEntity_State__Enum : int32_t {
  ShowQuestEntity_State__Enum_NotStarted = 0,
  ShowQuestEntity_State__Enum_WaitingForMenu = 1,
  ShowQuestEntity_State__Enum_Started = 2,
  ShowQuestEntity_State__Enum_ShowingPlayer = 3,
  ShowQuestEntity_State__Enum_MovingToQuest = 4,
  ShowQuestEntity_State__Enum_ShowingQuest = 5,
  ShowQuestEntity_State__Enum_WaitingForExit = 6,
  ShowQuestEntity_State__Enum_Finished = 7,
};
struct ShowQuestEntity_State__Enum__Boxed {
  struct Enum__Class *klass;
  struct MonitorData *monitor;
  enum ShowQuestEntity_State__Enum value;
};
struct ShowQuestEntity__Fields {
  ...
  bool Pause;
  enum ShowQuestEntity_State__Enum CurrentState;
  float m_stateTime;

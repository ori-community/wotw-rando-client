...
namespace app::classes::types {
    namespace AkWwiseInitializationSettings_PlatformSettings {
        namespace {
            inline app::AkWwiseInitializationSettings_PlatformSettings__Class* type_info_ref = nullptr;
        }
        inline app::AkWwiseInitializationSettings_PlatformSettings__Class** type_info = &type_info_ref;

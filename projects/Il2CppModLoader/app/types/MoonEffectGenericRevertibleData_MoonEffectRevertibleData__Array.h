...
namespace app::classes::types {
    namespace MoonEffectGenericRevertibleData_MoonEffectRevertibleData__Array {
        namespace {
            app::MoonEffectGenericRevertibleData_MoonEffectRevertibleData__Array__Class* type_info_ref = nullptr;
        }
        app::MoonEffectGenericRevertibleData_MoonEffectRevertibleData__Array__Class** type_info = &type_info_ref;

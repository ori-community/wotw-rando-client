...
namespace app::classes::types {
    namespace SoundZoneProcessor_Job_PositionZoneEventType__Enum {
        namespace {
            app::SoundZoneProcessor_Job_PositionZoneEventType__Enum__Class* type_info_ref = nullptr;
        }
        app::SoundZoneProcessor_Job_PositionZoneEventType__Enum__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace _PrivateImplementationDetails_StaticArrayInitTypeSize_240 {
        namespace {
            app::_PrivateImplementationDetails_StaticArrayInitTypeSize_240__Class* type_info_ref = nullptr;
        }
        app::_PrivateImplementationDetails_StaticArrayInitTypeSize_240__Class** type_info = &type_info_ref;

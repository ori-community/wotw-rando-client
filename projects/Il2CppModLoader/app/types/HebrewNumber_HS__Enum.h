...
namespace app::classes::types {
    namespace HebrewNumber_HS__Enum {
        namespace {
            app::HebrewNumber_HS__Enum__Class* type_info_ref = nullptr;
        }
        app::HebrewNumber_HS__Enum__Class** type_info = &type_info_ref;
        ...
        inline app::HebrewNumber_HS__Enum__Array* create_array(const std::vector<app::HebrewNumber_HS__Enum__Boxed*>& items) {

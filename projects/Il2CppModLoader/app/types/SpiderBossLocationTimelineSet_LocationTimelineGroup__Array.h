...
namespace app::classes::types {
    namespace SpiderBossLocationTimelineSet_LocationTimelineGroup__Array {
        namespace {
            app::SpiderBossLocationTimelineSet_LocationTimelineGroup__Array__Class* type_info_ref = nullptr;
        }
        app::SpiderBossLocationTimelineSet_LocationTimelineGroup__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_Distortion_FishEye {
        inline app::ShaderID_CameraFilterPack_Distortion_FishEye__Class** type_info = (app::ShaderID_CameraFilterPack_Distortion_FishEye__Class**)(modloader::win::memory::resolve_rva(0x0473B608));

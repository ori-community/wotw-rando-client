...
namespace app::classes::types {
    namespace SandWormEntity_BodyPhysicsMode__Enum {
        namespace {
            inline app::SandWormEntity_BodyPhysicsMode__Enum__Class* type_info_ref = nullptr;
        }
        inline app::SandWormEntity_BodyPhysicsMode__Enum__Class** type_info = &type_info_ref;

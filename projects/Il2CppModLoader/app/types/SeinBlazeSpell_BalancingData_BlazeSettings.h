...
namespace app::classes::types {
    namespace SeinBlazeSpell_BalancingData_BlazeSettings {
        namespace {
            app::SeinBlazeSpell_BalancingData_BlazeSettings__Class* type_info_ref = nullptr;
        }
        app::SeinBlazeSpell_BalancingData_BlazeSettings__Class** type_info = &type_info_ref;

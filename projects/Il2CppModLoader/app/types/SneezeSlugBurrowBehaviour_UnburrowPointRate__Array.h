...
namespace app::classes::types {
    namespace SneezeSlugBurrowBehaviour_UnburrowPointRate__Array {
        namespace {
            inline app::SneezeSlugBurrowBehaviour_UnburrowPointRate__Array__Class* type_info_ref = nullptr;
        }
        inline app::SneezeSlugBurrowBehaviour_UnburrowPointRate__Array__Class** type_info = &type_info_ref;

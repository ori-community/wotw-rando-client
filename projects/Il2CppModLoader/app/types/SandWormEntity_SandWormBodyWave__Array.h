...
namespace app::classes::types {
    namespace SandWormEntity_SandWormBodyWave__Array {
        namespace {
            inline app::SandWormEntity_SandWormBodyWave__Array__Class* type_info_ref = nullptr;
        }
        inline app::SandWormEntity_SandWormBodyWave__Array__Class** type_info = &type_info_ref;

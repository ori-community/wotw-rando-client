...
namespace app::classes::types {
    namespace MainThreadWorkStealer_WorkStealingMode__Enum {
        ...
        inline app::MainThreadWorkStealer_WorkStealingMode__Enum__Array* create_array(const std::vector<app::MainThreadWorkStealer_WorkStealingMode__Enum__Boxed*>& items) {

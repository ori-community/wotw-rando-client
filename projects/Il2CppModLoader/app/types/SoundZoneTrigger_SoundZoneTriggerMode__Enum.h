...
namespace app::classes::types {
    namespace SoundZoneTrigger_SoundZoneTriggerMode__Enum {
        namespace {
            app::SoundZoneTrigger_SoundZoneTriggerMode__Enum__Class* type_info_ref = nullptr;
        }
        app::SoundZoneTrigger_SoundZoneTriggerMode__Enum__Class** type_info = &type_info_ref;

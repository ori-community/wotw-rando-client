...
namespace app::classes::types {
    namespace QuestNodeSetup_QuestInteractionSetup__Array {
        namespace {
            app::QuestNodeSetup_QuestInteractionSetup__Array__Class* type_info_ref = nullptr;
        }
        app::QuestNodeSetup_QuestInteractionSetup__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace SpiderBossEntity_SpiderFightState__Enum {
        namespace {
            inline app::SpiderBossEntity_SpiderFightState__Enum__Class* type_info_ref = nullptr;
        }
        inline app::SpiderBossEntity_SpiderFightState__Enum__Class** type_info = &type_info_ref;

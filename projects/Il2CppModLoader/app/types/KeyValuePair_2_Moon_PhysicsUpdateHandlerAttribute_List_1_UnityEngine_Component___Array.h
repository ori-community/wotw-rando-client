...
namespace app::classes::types {
    namespace KeyValuePair_2_Moon_PhysicsUpdateHandlerAttribute_List_1_UnityEngine_Component___Array {
        namespace {
            app::KeyValuePair_2_Moon_PhysicsUpdateHandlerAttribute_List_1_UnityEngine_Component___Array__Class* type_info_ref = nullptr;
        }
        app::KeyValuePair_2_Moon_PhysicsUpdateHandlerAttribute_List_1_UnityEngine_Component___Array__Class** type_info = &type_info_ref;

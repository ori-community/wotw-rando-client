...
namespace app::classes::types {
    namespace Dictionary_2_TKey_TValue_Entry_System_String_AkBankManager_BankHandle___Array {
        namespace {
            app::Dictionary_2_TKey_TValue_Entry_System_String_AkBankManager_BankHandle___Array__Class* type_info_ref = nullptr;
        }
        app::Dictionary_2_TKey_TValue_Entry_System_String_AkBankManager_BankHandle___Array__Class** type_info = &type_info_ref;

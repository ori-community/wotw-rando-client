...
namespace app::classes::types {
    namespace CrabHitReactionBehaviour_NonInterruptibleTaskCondition {
        namespace {
            app::CrabHitReactionBehaviour_NonInterruptibleTaskCondition__Class* type_info_ref = nullptr;
        }
        app::CrabHitReactionBehaviour_NonInterruptibleTaskCondition__Class** type_info = &type_info_ref;

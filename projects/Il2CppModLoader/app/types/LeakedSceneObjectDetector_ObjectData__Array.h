...
namespace app::classes::types {
    namespace LeakedSceneObjectDetector_ObjectData__Array {
        namespace {
            app::LeakedSceneObjectDetector_ObjectData__Array__Class* type_info_ref = nullptr;
        }
        app::LeakedSceneObjectDetector_ObjectData__Array__Class** type_info = &type_info_ref;

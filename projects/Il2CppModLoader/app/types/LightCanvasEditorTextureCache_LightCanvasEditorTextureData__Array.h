...
namespace app::classes::types {
    namespace LightCanvasEditorTextureCache_LightCanvasEditorTextureData__Array {
        namespace {
            app::LightCanvasEditorTextureCache_LightCanvasEditorTextureData__Array__Class* type_info_ref = nullptr;
        }
        app::LightCanvasEditorTextureCache_LightCanvasEditorTextureData__Array__Class** type_info = &type_info_ref;

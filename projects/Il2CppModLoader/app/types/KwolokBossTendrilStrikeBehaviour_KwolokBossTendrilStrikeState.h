...
namespace app::classes::types {
    namespace KwolokBossTendrilStrikeBehaviour_KwolokBossTendrilStrikeState {
        namespace {
            app::KwolokBossTendrilStrikeBehaviour_KwolokBossTendrilStrikeState__Class* type_info_ref = nullptr;
        }
        app::KwolokBossTendrilStrikeBehaviour_KwolokBossTendrilStrikeState__Class** type_info = &type_info_ref;

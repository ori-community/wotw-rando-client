...
namespace app::classes::types {
    namespace InventoryScreenPickupElements_UberStateToElement__Array {
        namespace {
            app::InventoryScreenPickupElements_UberStateToElement__Array__Class* type_info_ref = nullptr;
        }
        app::InventoryScreenPickupElements_UberStateToElement__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace InventoryScreenPickupElements_UberStateToElement__Array {
        namespace {
            inline app::InventoryScreenPickupElements_UberStateToElement__Array__Class* type_info_ref = nullptr;
        }
        inline app::InventoryScreenPickupElements_UberStateToElement__Array__Class** type_info = &type_info_ref;

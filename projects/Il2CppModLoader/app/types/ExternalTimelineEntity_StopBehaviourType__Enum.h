...
namespace app::classes::types {
    namespace ExternalTimelineEntity_StopBehaviourType__Enum {
        namespace {
            app::ExternalTimelineEntity_StopBehaviourType__Enum__Class* type_info_ref = nullptr;
        }
        app::ExternalTimelineEntity_StopBehaviourType__Enum__Class** type_info = &type_info_ref;

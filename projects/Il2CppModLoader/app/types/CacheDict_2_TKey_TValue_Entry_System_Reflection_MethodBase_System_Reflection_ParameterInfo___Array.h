...
namespace app::classes::types {
    namespace CacheDict_2_TKey_TValue_Entry_System_Reflection_MethodBase_System_Reflection_ParameterInfo___Array {
        namespace {
            app::CacheDict_2_TKey_TValue_Entry_System_Reflection_MethodBase_System_Reflection_ParameterInfo___Array__Class* type_info_ref = nullptr;
        }
        app::CacheDict_2_TKey_TValue_Entry_System_Reflection_MethodBase_System_Reflection_ParameterInfo___Array__Class** type_info = &type_info_ref;

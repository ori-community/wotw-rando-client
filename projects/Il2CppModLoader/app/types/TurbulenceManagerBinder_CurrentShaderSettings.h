...
namespace app::classes::types {
    namespace TurbulenceManagerBinder_CurrentShaderSettings {
        namespace {
            inline app::TurbulenceManagerBinder_CurrentShaderSettings__Class* type_info_ref = nullptr;
        }
        inline app::TurbulenceManagerBinder_CurrentShaderSettings__Class** type_info = &type_info_ref;

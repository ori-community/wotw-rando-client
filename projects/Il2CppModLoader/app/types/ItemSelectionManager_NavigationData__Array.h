...
namespace app::classes::types {
    namespace ItemSelectionManager_NavigationData__Array {
        namespace {
            app::ItemSelectionManager_NavigationData__Array__Class* type_info_ref = nullptr;
        }
        app::ItemSelectionManager_NavigationData__Array__Class** type_info = &type_info_ref;

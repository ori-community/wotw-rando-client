...
namespace app::classes::types {
    namespace SequencePlatformB_SequencePlatformColliderSettings {
        namespace {
            inline app::SequencePlatformB_SequencePlatformColliderSettings__Class* type_info_ref = nullptr;
        }
        inline app::SequencePlatformB_SequencePlatformColliderSettings__Class** type_info = &type_info_ref;

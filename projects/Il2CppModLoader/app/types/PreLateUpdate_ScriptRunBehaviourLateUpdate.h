...
namespace app::classes::types {
    namespace PreLateUpdate_ScriptRunBehaviourLateUpdate {
        namespace {
            app::PreLateUpdate_ScriptRunBehaviourLateUpdate__Class* type_info_ref = nullptr;
        }
        app::PreLateUpdate_ScriptRunBehaviourLateUpdate__Class** type_info = &type_info_ref;

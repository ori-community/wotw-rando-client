...
namespace app::classes::types {
    namespace LayeredRenderSettings_LayeredRenderSettingsPlatformOverride__Enum {
        namespace {
            app::LayeredRenderSettings_LayeredRenderSettingsPlatformOverride__Enum__Class* type_info_ref = nullptr;
        }
        app::LayeredRenderSettings_LayeredRenderSettingsPlatformOverride__Enum__Class** type_info = &type_info_ref;

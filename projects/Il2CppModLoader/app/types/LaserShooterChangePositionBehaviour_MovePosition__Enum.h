...
namespace app::classes::types {
    namespace LaserShooterChangePositionBehaviour_MovePosition__Enum {
        namespace {
            app::LaserShooterChangePositionBehaviour_MovePosition__Enum__Class* type_info_ref = nullptr;
        }
        app::LaserShooterChangePositionBehaviour_MovePosition__Enum__Class** type_info = &type_info_ref;

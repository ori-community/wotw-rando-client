...
namespace app::classes::types {
    namespace ChangeStateInteractionNodeDecorator_StateConditionSetupData__Array {
        namespace {
            app::ChangeStateInteractionNodeDecorator_StateConditionSetupData__Array__Class* type_info_ref = nullptr;
        }
        app::ChangeStateInteractionNodeDecorator_StateConditionSetupData__Array__Class** type_info = &type_info_ref;

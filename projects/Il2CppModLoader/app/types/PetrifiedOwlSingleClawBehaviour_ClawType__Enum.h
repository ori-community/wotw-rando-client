...
namespace app::classes::types {
    namespace PetrifiedOwlSingleClawBehaviour_ClawType__Enum {
        namespace {
            app::PetrifiedOwlSingleClawBehaviour_ClawType__Enum__Class* type_info_ref = nullptr;
        }
        app::PetrifiedOwlSingleClawBehaviour_ClawType__Enum__Class** type_info = &type_info_ref;

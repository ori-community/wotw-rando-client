...
namespace app::classes::types {
    namespace fsPortableReflection_AttributeQuery__Array {
        namespace {
            app::fsPortableReflection_AttributeQuery__Array__Class* type_info_ref = nullptr;
        }
        app::fsPortableReflection_AttributeQuery__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace KeyValuePair_2_System_Int64_GhostWorldObjectsLifetimePlugin_RecordableTrackingEntry___Array {
        namespace {
            app::KeyValuePair_2_System_Int64_GhostWorldObjectsLifetimePlugin_RecordableTrackingEntry___Array__Class* type_info_ref = nullptr;
        }
        app::KeyValuePair_2_System_Int64_GhostWorldObjectsLifetimePlugin_RecordableTrackingEntry___Array__Class** type_info = &type_info_ref;

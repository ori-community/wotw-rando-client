...
namespace app::classes::types {
    namespace InstantiateDebugUtility_InstantiationType__Enum {
        inline app::InstantiateDebugUtility_InstantiationType__Enum__Class** type_info = (app::InstantiateDebugUtility_InstantiationType__Enum__Class**)(modloader::win::memory::resolve_rva(0x0471F600));

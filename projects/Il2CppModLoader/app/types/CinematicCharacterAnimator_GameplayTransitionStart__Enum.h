...
namespace app::classes::types {
    namespace CinematicCharacterAnimator_GameplayTransitionStart__Enum {
        namespace {
            app::CinematicCharacterAnimator_GameplayTransitionStart__Enum__Class* type_info_ref = nullptr;
        }
        app::CinematicCharacterAnimator_GameplayTransitionStart__Enum__Class** type_info = &type_info_ref;

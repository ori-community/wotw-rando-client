...
namespace app::classes::types {
    namespace PreLateUpdate_DirectorUpdateAnimationEnd {
        namespace {
            inline app::PreLateUpdate_DirectorUpdateAnimationEnd__Class* type_info_ref = nullptr;
        }
        inline app::PreLateUpdate_DirectorUpdateAnimationEnd__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace TorchInsideZoneChecker_FlameColorType__Enum {
        namespace {
            app::TorchInsideZoneChecker_FlameColorType__Enum__Class* type_info_ref = nullptr;
        }
        app::TorchInsideZoneChecker_FlameColorType__Enum__Class** type_info = &type_info_ref;

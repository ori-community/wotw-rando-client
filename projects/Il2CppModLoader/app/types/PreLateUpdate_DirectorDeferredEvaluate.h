...
namespace app::classes::types {
    namespace PreLateUpdate_DirectorDeferredEvaluate {
        namespace {
            inline app::PreLateUpdate_DirectorDeferredEvaluate__Class* type_info_ref = nullptr;
        }
        inline app::PreLateUpdate_DirectorDeferredEvaluate__Class** type_info = &type_info_ref;

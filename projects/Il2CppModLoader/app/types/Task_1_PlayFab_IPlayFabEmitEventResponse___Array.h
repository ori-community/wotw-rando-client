...
namespace app::classes::types {
    namespace Task_1_PlayFab_IPlayFabEmitEventResponse___Array {
        namespace {
            app::Task_1_PlayFab_IPlayFabEmitEventResponse___Array__Class* type_info_ref = nullptr;
        }
        app::Task_1_PlayFab_IPlayFabEmitEventResponse___Array__Class** type_info = &type_info_ref;

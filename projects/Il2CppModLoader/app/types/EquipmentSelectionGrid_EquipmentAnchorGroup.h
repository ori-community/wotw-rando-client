...
namespace app::classes::types {
    namespace EquipmentSelectionGrid_EquipmentAnchorGroup {
        namespace {
            app::EquipmentSelectionGrid_EquipmentAnchorGroup__Class* type_info_ref = nullptr;
        }
        app::EquipmentSelectionGrid_EquipmentAnchorGroup__Class** type_info = &type_info_ref;

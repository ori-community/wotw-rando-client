...
namespace app::classes::types {
    namespace MoonIconRenderer_IconObject__Array {
        namespace {
            inline app::MoonIconRenderer_IconObject__Array__Class* type_info_ref = nullptr;
        }
        inline app::MoonIconRenderer_IconObject__Array__Class** type_info = &type_info_ref;

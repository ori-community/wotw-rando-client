...
namespace app::classes::types {
    namespace CleverMenuItemGroup_CleverMenuItemGroupItem__Array {
        namespace {
            app::CleverMenuItemGroup_CleverMenuItemGroupItem__Array__Class* type_info_ref = nullptr;
        }
        app::CleverMenuItemGroup_CleverMenuItemGroupItem__Array__Class** type_info = &type_info_ref;

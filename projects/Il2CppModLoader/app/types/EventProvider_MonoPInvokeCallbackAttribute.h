...
namespace app::classes::types {
    namespace EventProvider_MonoPInvokeCallbackAttribute {
        namespace {
            app::EventProvider_MonoPInvokeCallbackAttribute__Class* type_info_ref = nullptr;
        }
        app::EventProvider_MonoPInvokeCallbackAttribute__Class** type_info = &type_info_ref;

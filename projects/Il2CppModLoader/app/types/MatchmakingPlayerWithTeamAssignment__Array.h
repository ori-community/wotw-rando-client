...
namespace app::classes::types {
    namespace MatchmakingPlayerWithTeamAssignment__Array {
        namespace {
            app::MatchmakingPlayerWithTeamAssignment__Array__Class* type_info_ref = nullptr;
        }
        app::MatchmakingPlayerWithTeamAssignment__Array__Class** type_info = &type_info_ref;

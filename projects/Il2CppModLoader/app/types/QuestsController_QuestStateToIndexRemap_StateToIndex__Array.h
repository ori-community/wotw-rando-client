...
namespace app::classes::types {
    namespace QuestsController_QuestStateToIndexRemap_StateToIndex__Array {
        namespace {
            app::QuestsController_QuestStateToIndexRemap_StateToIndex__Array__Class* type_info_ref = nullptr;
        }
        app::QuestsController_QuestStateToIndexRemap_StateToIndex__Array__Class** type_info = &type_info_ref;

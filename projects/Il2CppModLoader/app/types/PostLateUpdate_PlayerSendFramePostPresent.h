...
namespace app::classes::types {
    namespace PostLateUpdate_PlayerSendFramePostPresent {
        namespace {
            app::PostLateUpdate_PlayerSendFramePostPresent__Class* type_info_ref = nullptr;
        }
        app::PostLateUpdate_PlayerSendFramePostPresent__Class** type_info = &type_info_ref;

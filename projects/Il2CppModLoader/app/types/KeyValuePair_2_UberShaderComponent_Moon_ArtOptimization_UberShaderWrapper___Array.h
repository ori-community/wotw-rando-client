...
namespace app::classes::types {
    namespace KeyValuePair_2_UberShaderComponent_Moon_ArtOptimization_UberShaderWrapper___Array {
        namespace {
            app::KeyValuePair_2_UberShaderComponent_Moon_ArtOptimization_UberShaderWrapper___Array__Class* type_info_ref = nullptr;
        }
        app::KeyValuePair_2_UberShaderComponent_Moon_ArtOptimization_UberShaderWrapper___Array__Class** type_info = &type_info_ref;

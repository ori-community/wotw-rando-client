...
namespace app::classes::types {
    namespace FramePerformanceMonitor_PerformanceFrameData__Array {
        namespace {
            app::FramePerformanceMonitor_PerformanceFrameData__Array__Class* type_info_ref = nullptr;
        }
        app::FramePerformanceMonitor_PerformanceFrameData__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_Antialiasing_FXAA {
        inline app::ShaderID_CameraFilterPack_Antialiasing_FXAA__Class** type_info = (app::ShaderID_CameraFilterPack_Antialiasing_FXAA__Class**)(modloader::win::memory::resolve_rva(0x04727430));

...
namespace app::classes::types {
    namespace TentacleEnemy_MeleeAttackState_AttackType__Enum {
        namespace {
            app::TentacleEnemy_MeleeAttackState_AttackType__Enum__Class* type_info_ref = nullptr;
        }
        app::TentacleEnemy_MeleeAttackState_AttackType__Enum__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace DictionaryList_2_Key_Value_KeyValuePair_System_Object_System_Object___Array {
        namespace {
            app::DictionaryList_2_Key_Value_KeyValuePair_System_Object_System_Object___Array__Class* type_info_ref = nullptr;
        }
        app::DictionaryList_2_Key_Value_KeyValuePair_System_Object_System_Object___Array__Class** type_info = &type_info_ref;

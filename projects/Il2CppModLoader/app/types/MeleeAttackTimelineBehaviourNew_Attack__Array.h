...
namespace app::classes::types {
    namespace MeleeAttackTimelineBehaviourNew_Attack__Array {
        namespace {
            app::MeleeAttackTimelineBehaviourNew_Attack__Array__Class* type_info_ref = nullptr;
        }
        app::MeleeAttackTimelineBehaviourNew_Attack__Array__Class** type_info = &type_info_ref;

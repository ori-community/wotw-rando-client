...
namespace app::classes::types {
    namespace RockyEnemyPlaceholder_RockyEnemyPlaceholderSettings {
        namespace {
            inline app::RockyEnemyPlaceholder_RockyEnemyPlaceholderSettings__Class* type_info_ref = nullptr;
        }
        inline app::RockyEnemyPlaceholder_RockyEnemyPlaceholderSettings__Class** type_info = &type_info_ref;

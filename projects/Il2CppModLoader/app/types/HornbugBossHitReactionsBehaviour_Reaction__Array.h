...
namespace app::classes::types {
    namespace HornbugBossHitReactionsBehaviour_Reaction__Array {
        namespace {
            app::HornbugBossHitReactionsBehaviour_Reaction__Array__Class* type_info_ref = nullptr;
        }
        app::HornbugBossHitReactionsBehaviour_Reaction__Array__Class** type_info = &type_info_ref;

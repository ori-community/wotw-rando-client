...
namespace app::classes::types {
    namespace CameraFilterPack_Gradients_ElectricGradient {
        namespace {
            app::CameraFilterPack_Gradients_ElectricGradient__Class* type_info_ref = nullptr;
        }
        app::CameraFilterPack_Gradients_ElectricGradient__Class** type_info = &type_info_ref;

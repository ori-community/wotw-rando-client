...
namespace app::classes::types {
    namespace AsyncProtocolRequest_ProcessOperation_d_24 {
        namespace {
            app::AsyncProtocolRequest_ProcessOperation_d_24__Class* type_info_ref = nullptr;
        }
        app::AsyncProtocolRequest_ProcessOperation_d_24__Class** type_info = &type_info_ref;

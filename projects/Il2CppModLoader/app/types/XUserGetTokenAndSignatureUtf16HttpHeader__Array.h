...
namespace app::classes::types {
    namespace XUserGetTokenAndSignatureUtf16HttpHeader__Array {
        namespace {
            app::XUserGetTokenAndSignatureUtf16HttpHeader__Array__Class* type_info_ref = nullptr;
        }
        app::XUserGetTokenAndSignatureUtf16HttpHeader__Array__Class** type_info = &type_info_ref;

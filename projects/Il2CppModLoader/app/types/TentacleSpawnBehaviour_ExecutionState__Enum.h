...
namespace app::classes::types {
    namespace TentacleSpawnBehaviour_ExecutionState__Enum {
        namespace {
            app::TentacleSpawnBehaviour_ExecutionState__Enum__Class* type_info_ref = nullptr;
        }
        app::TentacleSpawnBehaviour_ExecutionState__Enum__Class** type_info = &type_info_ref;

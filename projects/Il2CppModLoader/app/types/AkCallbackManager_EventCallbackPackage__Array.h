...
namespace app::classes::types {
    namespace AkCallbackManager_EventCallbackPackage__Array {
        namespace {
            app::AkCallbackManager_EventCallbackPackage__Array__Class* type_info_ref = nullptr;
        }
        app::AkCallbackManager_EventCallbackPackage__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_NightVisionFX {
        inline app::ShaderID_CameraFilterPack_NightVisionFX__Class** type_info = (app::ShaderID_CameraFilterPack_NightVisionFX__Class**)(modloader::win::memory::resolve_rva(0x04783520));

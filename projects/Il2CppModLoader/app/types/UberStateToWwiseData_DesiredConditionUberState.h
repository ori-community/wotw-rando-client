...
namespace app::classes::types {
    namespace UberStateToWwiseData_DesiredConditionUberState {
        inline app::UberStateToWwiseData_DesiredConditionUberState__Class** type_info = (app::UberStateToWwiseData_DesiredConditionUberState__Class**)(modloader::win::memory::resolve_rva(0x04747FB0));

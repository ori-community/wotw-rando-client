...
namespace app::classes::types {
    namespace PropertyTabScope__Enum {
        namespace {
            app::PropertyTabScope__Enum__Class* type_info_ref = nullptr;
        }
        app::PropertyTabScope__Enum__Class** type_info = &type_info_ref;
        ...
        inline app::PropertyTabScope__Enum__Array* create_array(const std::vector<app::PropertyTabScope__Enum__Boxed*>& items) {

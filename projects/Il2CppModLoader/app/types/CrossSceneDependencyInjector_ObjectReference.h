...
namespace app::classes::types {
    namespace CrossSceneDependencyInjector_ObjectReference {
        namespace {
            app::CrossSceneDependencyInjector_ObjectReference__Class* type_info_ref = nullptr;
        }
        app::CrossSceneDependencyInjector_ObjectReference__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace InstructionList_DebugView_InstructionView__Array {
        namespace {
            inline app::InstructionList_DebugView_InstructionView__Array__Class* type_info_ref = nullptr;
        }
        inline app::InstructionList_DebugView_InstructionView__Array__Class** type_info = &type_info_ref;

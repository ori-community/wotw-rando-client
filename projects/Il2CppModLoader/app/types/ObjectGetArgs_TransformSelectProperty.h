...
namespace app::classes::types {
    namespace ObjectGetArgs_TransformSelectProperty {
        namespace {
            inline app::ObjectGetArgs_TransformSelectProperty__Class* type_info_ref = nullptr;
        }
        inline app::ObjectGetArgs_TransformSelectProperty__Class** type_info = &type_info_ref;

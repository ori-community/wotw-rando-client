...
namespace app::classes::types {
    namespace NewSetupStateControllerResolver_IRuntimeUberStateControllerDataLink__Array {
        namespace {
            app::NewSetupStateControllerResolver_IRuntimeUberStateControllerDataLink__Array__Class* type_info_ref = nullptr;
        }
        app::NewSetupStateControllerResolver_IRuntimeUberStateControllerDataLink__Array__Class** type_info = &type_info_ref;

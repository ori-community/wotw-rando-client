...
namespace app::classes::types {
    namespace StructMultiKey_2_System_Object_System_Object___Array {
        namespace {
            app::StructMultiKey_2_System_Object_System_Object___Array__Class* type_info_ref = nullptr;
        }
        app::StructMultiKey_2_System_Object_System_Object___Array__Class** type_info = &type_info_ref;

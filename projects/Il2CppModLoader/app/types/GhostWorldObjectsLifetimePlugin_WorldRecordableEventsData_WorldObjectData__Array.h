...
namespace app::classes::types {
    namespace GhostWorldObjectsLifetimePlugin_WorldRecordableEventsData_WorldObjectData__Array {
        namespace {
            app::GhostWorldObjectsLifetimePlugin_WorldRecordableEventsData_WorldObjectData__Array__Class* type_info_ref = nullptr;
        }
        app::GhostWorldObjectsLifetimePlugin_WorldRecordableEventsData_WorldObjectData__Array__Class** type_info = &type_info_ref;

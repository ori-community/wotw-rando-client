...
namespace app::classes::types {
    namespace MoonRenderPipelineDebugUI_SliceRangeMode__Enum {
        namespace {
            app::MoonRenderPipelineDebugUI_SliceRangeMode__Enum__Class* type_info_ref = nullptr;
        }
        app::MoonRenderPipelineDebugUI_SliceRangeMode__Enum__Class** type_info = &type_info_ref;

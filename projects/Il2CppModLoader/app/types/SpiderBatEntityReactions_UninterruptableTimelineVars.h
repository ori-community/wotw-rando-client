...
namespace app::classes::types {
    namespace SpiderBatEntityReactions_UninterruptableTimelineVars {
        namespace {
            app::SpiderBatEntityReactions_UninterruptableTimelineVars__Class* type_info_ref = nullptr;
        }
        app::SpiderBatEntityReactions_UninterruptableTimelineVars__Class** type_info = &type_info_ref;

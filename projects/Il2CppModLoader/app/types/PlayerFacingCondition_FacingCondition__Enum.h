...
namespace app::classes::types {
    namespace PlayerFacingCondition_FacingCondition__Enum {
        namespace {
            app::PlayerFacingCondition_FacingCondition__Enum__Class* type_info_ref = nullptr;
        }
        app::PlayerFacingCondition_FacingCondition__Enum__Class** type_info = &type_info_ref;

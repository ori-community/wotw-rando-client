...
namespace app::classes::types {
    namespace AkWwiseInitializationSettings_PlatformSettings__Array {
        namespace {
            app::AkWwiseInitializationSettings_PlatformSettings__Array__Class* type_info_ref = nullptr;
        }
        app::AkWwiseInitializationSettings_PlatformSettings__Array__Class** type_info = &type_info_ref;

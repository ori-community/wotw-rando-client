...
namespace app::classes::types {
    namespace CameraFilterPack_Blend2Camera_Blend {
        inline app::CameraFilterPack_Blend2Camera_Blend__Class** type_info = (app::CameraFilterPack_Blend2Camera_Blend__Class**)(modloader::win::memory::resolve_rva(0x0477D210));

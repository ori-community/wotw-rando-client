...
namespace app::classes::types {
    namespace LaserShooterProjectileAttackWithCycleRepetitionBehaviour_State__Enum {
        namespace {
            app::LaserShooterProjectileAttackWithCycleRepetitionBehaviour_State__Enum__Class* type_info_ref = nullptr;
        }
        app::LaserShooterProjectileAttackWithCycleRepetitionBehaviour_State__Enum__Class** type_info = &type_info_ref;

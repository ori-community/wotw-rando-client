...
namespace app::classes::types {
    ...
    namespace IPolymorphicSerializationTypeMapContributor {
        IL2CPP_MODLOADER_DLLEXPORT ::app::IPolymorphicSerializationTypeMapContributor__Class** type_info = (::app::IPolymorphicSerializationTypeMapContributor__Class**)(modloader::win::memory::resolve_rva(0x047351C0));
    }
    namespace IFormatter {
        IL2CPP_MODLOADER_DLLEXPORT ::app::IFormatter__Class** type_info = (::app::IFormatter__Class**)(modloader::win::memory::resolve_rva(0x0478C7B0));
    }
    ...
    namespace IDtdParserAdapterV1 {
        IL2CPP_MODLOADER_DLLEXPORT ::app::IDtdParserAdapterV1__Class** type_info = (::app::IDtdParserAdapterV1__Class**)(modloader::win::memory::resolve_rva(0x0473F958));
    }
    ...
    namespace IContributeDynamicSink {
        IL2CPP_MODLOADER_DLLEXPORT ::app::IContributeDynamicSink__Class** type_info = (::app::IContributeDynamicSink__Class**)(modloader::win::memory::resolve_rva(0x04775970));
    }
    namespace OpCodes {
    ...
    namespace ILocomotionMovementProcessor {
        IL2CPP_MODLOADER_DLLEXPORT ::app::ILocomotionMovementProcessor__Class** type_info = (::app::ILocomotionMovementProcessor__Class**)(modloader::win::memory::resolve_rva(0x0475A8D0));
    }
    ...
    namespace IEntityHighlight {
        IL2CPP_MODLOADER_DLLEXPORT ::app::IEntityHighlight__Class** type_info = (::app::IEntityHighlight__Class**)(modloader::win::memory::resolve_rva(0x04753518));
    }
    ...
    namespace ILocomotionBehaviour {
        IL2CPP_MODLOADER_DLLEXPORT ::app::ILocomotionBehaviour__Class** type_info = (::app::ILocomotionBehaviour__Class**)(modloader::win::memory::resolve_rva(0x047757C8));
    }
    ...
    namespace IMeshFormat {
        IL2CPP_MODLOADER_DLLEXPORT ::app::IMeshFormat__Class** type_info = (::app::IMeshFormat__Class**)(modloader::win::memory::resolve_rva(0x0470AD60));
    }
    namespace IPolygonFormat {
        IL2CPP_MODLOADER_DLLEXPORT ::app::IPolygonFormat__Class** type_info = (::app::IPolygonFormat__Class**)(modloader::win::memory::resolve_rva(0x04750590));
    }
    namespace ICloseEx {
        IL2CPP_MODLOADER_DLLEXPORT ::app::ICloseEx__Class** type_info = (::app::ICloseEx__Class**)(modloader::win::memory::resolve_rva(0x04739788));
    }
    namespace File {
    ...
    namespace IFloatUberState {
        IL2CPP_MODLOADER_DLLEXPORT ::app::IFloatUberState__Class** type_info = (::app::IFloatUberState__Class**)(modloader::win::memory::resolve_rva(0x0470EB68));
    }
    ...
    namespace INewFrameCaptureAgent {
        IL2CPP_MODLOADER_DLLEXPORT ::app::INewFrameCaptureAgent__Class** type_info = (::app::INewFrameCaptureAgent__Class**)(modloader::win::memory::resolve_rva(0x0474F838));
    }
    ...
    namespace IGlobalRecordingTableReceiver {
        IL2CPP_MODLOADER_DLLEXPORT ::app::IGlobalRecordingTableReceiver__Class** type_info = (::app::IGlobalRecordingTableReceiver__Class**)(modloader::win::memory::resolve_rva(0x04744108));
    }
    ...
    namespace IBrigthnessContributionAgentWithUpdate {
        IL2CPP_MODLOADER_DLLEXPORT ::app::IBrigthnessContributionAgentWithUpdate__Class** type_info = (::app::IBrigthnessContributionAgentWithUpdate__Class**)(modloader::win::memory::resolve_rva(0x0477E980));
    }
    ...
    namespace IMeshModifier {
        IL2CPP_MODLOADER_DLLEXPORT ::app::IMeshModifier__Class** type_info = (::app::IMeshModifier__Class**)(modloader::win::memory::resolve_rva(0x0476CB08));
    }
    namespace ICanvasRaycastFilter {
        IL2CPP_MODLOADER_DLLEXPORT ::app::ICanvasRaycastFilter__Class** type_info = (::app::ICanvasRaycastFilter__Class**)(modloader::win::memory::resolve_rva(0x04706988));
    }
    namespace IMaterialModifier {
        IL2CPP_MODLOADER_DLLEXPORT ::app::IMaterialModifier__Class** type_info = (::app::IMaterialModifier__Class**)(modloader::win::memory::resolve_rva(0x047981E0));
    }

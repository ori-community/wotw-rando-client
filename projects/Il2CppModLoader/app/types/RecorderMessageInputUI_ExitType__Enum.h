...
namespace app::classes::types {
    namespace RecorderMessageInputUI_ExitType__Enum {
        namespace {
            inline app::RecorderMessageInputUI_ExitType__Enum__Class* type_info_ref = nullptr;
        }
        inline app::RecorderMessageInputUI_ExitType__Enum__Class** type_info = &type_info_ref;

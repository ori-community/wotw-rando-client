...
namespace app::classes::types {
    namespace Dictionary_2_TKey_TValue_Entry_System_UInt32_AkAudioInputManager_AudioFormatDelegate___Array {
        namespace {
            app::Dictionary_2_TKey_TValue_Entry_System_UInt32_AkAudioInputManager_AudioFormatDelegate___Array__Class* type_info_ref = nullptr;
        }
        app::Dictionary_2_TKey_TValue_Entry_System_UInt32_AkAudioInputManager_AudioFormatDelegate___Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace MatchmakingPlayerWithTeamAssignment {
        namespace {
            inline app::MatchmakingPlayerWithTeamAssignment__Class* type_info_ref = nullptr;
        }
        inline app::MatchmakingPlayerWithTeamAssignment__Class** type_info = &type_info_ref;

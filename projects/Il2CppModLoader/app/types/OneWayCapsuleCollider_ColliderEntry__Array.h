...
namespace app::classes::types {
    namespace OneWayCapsuleCollider_ColliderEntry__Array {
        namespace {
            app::OneWayCapsuleCollider_ColliderEntry__Array__Class* type_info_ref = nullptr;
        }
        app::OneWayCapsuleCollider_ColliderEntry__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace OneWayCapsuleCollider_ColliderEntry__Array {
        namespace {
            inline app::OneWayCapsuleCollider_ColliderEntry__Array__Class* type_info_ref = nullptr;
        }
        inline app::OneWayCapsuleCollider_ColliderEntry__Array__Class** type_info = &type_info_ref;

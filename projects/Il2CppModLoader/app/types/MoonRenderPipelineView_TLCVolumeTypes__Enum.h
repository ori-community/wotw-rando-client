...
namespace app::classes::types {
    namespace MoonRenderPipelineView_TLCVolumeTypes__Enum {
        namespace {
            app::MoonRenderPipelineView_TLCVolumeTypes__Enum__Class* type_info_ref = nullptr;
        }
        app::MoonRenderPipelineView_TLCVolumeTypes__Enum__Class** type_info = &type_info_ref;

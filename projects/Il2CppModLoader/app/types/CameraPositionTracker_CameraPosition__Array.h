...
namespace app::classes::types {
    namespace CameraPositionTracker_CameraPosition__Array {
        namespace {
            app::CameraPositionTracker_CameraPosition__Array__Class* type_info_ref = nullptr;
        }
        app::CameraPositionTracker_CameraPosition__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_Blend2Camera_ColorBurn {
        inline app::ShaderID_CameraFilterPack_Blend2Camera_ColorBurn__Class** type_info = (app::ShaderID_CameraFilterPack_Blend2Camera_ColorBurn__Class**)(modloader::win::memory::resolve_rva(0x0478D730));

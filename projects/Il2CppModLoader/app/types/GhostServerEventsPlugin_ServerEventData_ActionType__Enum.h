...
namespace app::classes::types {
    namespace GhostServerEventsPlugin_ServerEventData_ActionType__Enum {
        namespace {
            app::GhostServerEventsPlugin_ServerEventData_ActionType__Enum__Class* type_info_ref = nullptr;
        }
        app::GhostServerEventsPlugin_ServerEventData_ActionType__Enum__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace SearchForGameResultCallback_t {
        namespace {
            app::SearchForGameResultCallback_t__Class* type_info_ref = nullptr;
        }
        app::SearchForGameResultCallback_t__Class** type_info = &type_info_ref;
        ...
        inline app::SearchForGameResultCallback_t__Boxed* box(app::SearchForGameResultCallback_t value) {
            return il2cpp::box_value<app::SearchForGameResultCallback_t__Boxed>(get_class(), value);
        }
    } // namespace SearchForGameResultCallback_t
} // namespace app::classes::types

...
namespace app::classes::types {
    namespace XHashtable_1_TValue_XHashtableState_TValue_Entry_XName___Array {
        namespace {
            app::XHashtable_1_TValue_XHashtableState_TValue_Entry_XName___Array__Class* type_info_ref = nullptr;
        }
        app::XHashtable_1_TValue_XHashtableState_TValue_Entry_XName___Array__Class** type_info = &type_info_ref;

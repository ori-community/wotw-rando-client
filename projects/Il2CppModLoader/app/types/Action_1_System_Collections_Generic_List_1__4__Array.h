...
namespace app::classes::types {
    namespace Action_1_System_Collections_Generic_List_1__4__Array {
        namespace {
            inline app::Action_1_System_Collections_Generic_List_1__4__Array__Class* type_info_ref = nullptr;
        }
        inline app::Action_1_System_Collections_Generic_List_1__4__Array__Class** type_info = &type_info_ref;

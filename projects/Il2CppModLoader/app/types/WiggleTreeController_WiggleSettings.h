...
namespace app::classes::types {
    namespace WiggleTreeController_WiggleSettings {
        namespace {
            inline app::WiggleTreeController_WiggleSettings__Class* type_info_ref = nullptr;
        }
        inline app::WiggleTreeController_WiggleSettings__Class** type_info = &type_info_ref;

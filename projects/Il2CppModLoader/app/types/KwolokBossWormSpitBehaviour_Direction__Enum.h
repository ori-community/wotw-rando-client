...
namespace app::classes::types {
    namespace KwolokBossWormSpitBehaviour_Direction__Enum {
        namespace {
            app::KwolokBossWormSpitBehaviour_Direction__Enum__Class* type_info_ref = nullptr;
        }
        app::KwolokBossWormSpitBehaviour_Direction__Enum__Class** type_info = &type_info_ref;

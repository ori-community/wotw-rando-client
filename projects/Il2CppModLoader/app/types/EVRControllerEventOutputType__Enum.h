...
namespace app::classes::types {
    namespace EVRControllerEventOutputType__Enum {
        namespace {
            inline app::EVRControllerEventOutputType__Enum__Class* type_info_ref = nullptr;
        }
        inline app::EVRControllerEventOutputType__Enum__Class** type_info = &type_info_ref;

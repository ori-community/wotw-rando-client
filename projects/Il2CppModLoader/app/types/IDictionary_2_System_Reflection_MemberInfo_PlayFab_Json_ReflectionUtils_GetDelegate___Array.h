...
namespace app::classes::types {
    namespace IDictionary_2_System_Reflection_MemberInfo_PlayFab_Json_ReflectionUtils_GetDelegate___Array {
        namespace {
            app::IDictionary_2_System_Reflection_MemberInfo_PlayFab_Json_ReflectionUtils_GetDelegate___Array__Class* type_info_ref = nullptr;
        }
        app::IDictionary_2_System_Reflection_MemberInfo_PlayFab_Json_ReflectionUtils_GetDelegate___Array__Class** type_info = &type_info_ref;

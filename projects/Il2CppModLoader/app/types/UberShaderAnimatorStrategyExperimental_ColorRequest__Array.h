...
namespace app::classes::types {
    namespace UberShaderAnimatorStrategyExperimental_ColorRequest__Array {
        namespace {
            app::UberShaderAnimatorStrategyExperimental_ColorRequest__Array__Class* type_info_ref = nullptr;
        }
        app::UberShaderAnimatorStrategyExperimental_ColorRequest__Array__Class** type_info = &type_info_ref;

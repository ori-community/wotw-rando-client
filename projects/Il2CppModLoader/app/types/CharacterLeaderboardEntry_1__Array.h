...
namespace app::classes::types {
    namespace CharacterLeaderboardEntry_1__Array {
        namespace {
            inline app::CharacterLeaderboardEntry_1__Array__Class* type_info_ref = nullptr;
        }
        inline app::CharacterLeaderboardEntry_1__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace KeyValuePair_2_AbilityType_SeinLogicCycle_StateFlags___Array {
        namespace {
            app::KeyValuePair_2_AbilityType_SeinLogicCycle_StateFlags___Array__Class* type_info_ref = nullptr;
        }
        app::KeyValuePair_2_AbilityType_SeinLogicCycle_StateFlags___Array__Class** type_info = &type_info_ref;

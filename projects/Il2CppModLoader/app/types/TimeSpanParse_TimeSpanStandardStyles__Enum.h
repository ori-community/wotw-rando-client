...
namespace app::classes::types {
    namespace TimeSpanParse_TimeSpanStandardStyles__Enum {
        namespace {
            app::TimeSpanParse_TimeSpanStandardStyles__Enum__Class* type_info_ref = nullptr;
        }
        app::TimeSpanParse_TimeSpanStandardStyles__Enum__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace LaserShooterBeamAttackWithCycleRepetitionBehaviour_State__Enum {
        namespace {
            app::LaserShooterBeamAttackWithCycleRepetitionBehaviour_State__Enum__Class* type_info_ref = nullptr;
        }
        app::LaserShooterBeamAttackWithCycleRepetitionBehaviour_State__Enum__Class** type_info = &type_info_ref;

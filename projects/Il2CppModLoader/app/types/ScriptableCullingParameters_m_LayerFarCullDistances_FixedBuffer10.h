...
namespace app::classes::types {
    namespace ScriptableCullingParameters_m_LayerFarCullDistances_FixedBuffer10 {
        namespace {
            app::ScriptableCullingParameters_m_LayerFarCullDistances_FixedBuffer10__Class* type_info_ref = nullptr;
        }
        app::ScriptableCullingParameters_m_LayerFarCullDistances_FixedBuffer10__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace CinematicCharacterAnimator_GameplayTransitionEnd__Enum {
        namespace {
            app::CinematicCharacterAnimator_GameplayTransitionEnd__Enum__Class* type_info_ref = nullptr;
        }
        app::CinematicCharacterAnimator_GameplayTransitionEnd__Enum__Class** type_info = &type_info_ref;

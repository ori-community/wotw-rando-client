...
namespace app::classes::types {
    namespace ConcurrentQueue_1_T_Segment_T_Slot_System_Object___Array {
        namespace {
            app::ConcurrentQueue_1_T_Segment_T_Slot_System_Object___Array__Class* type_info_ref = nullptr;
        }
        app::ConcurrentQueue_1_T_Segment_T_Slot_System_Object___Array__Class** type_info = &type_info_ref;

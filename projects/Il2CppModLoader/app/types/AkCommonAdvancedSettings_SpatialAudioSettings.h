...
namespace app::classes::types {
    namespace AkCommonAdvancedSettings_SpatialAudioSettings {
        namespace {
            app::AkCommonAdvancedSettings_SpatialAudioSettings__Class* type_info_ref = nullptr;
        }
        app::AkCommonAdvancedSettings_SpatialAudioSettings__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace BoostModeProfilingSetting_CallMoonCleanupWhenNotAwokenProfilingSetting {
        namespace {
            app::BoostModeProfilingSetting_CallMoonCleanupWhenNotAwokenProfilingSetting__Class* type_info_ref = nullptr;
        }
        app::BoostModeProfilingSetting_CallMoonCleanupWhenNotAwokenProfilingSetting__Class** type_info = &type_info_ref;

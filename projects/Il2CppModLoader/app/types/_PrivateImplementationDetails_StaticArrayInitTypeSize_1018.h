...
namespace app::classes::types {
    namespace _PrivateImplementationDetails_StaticArrayInitTypeSize_1018 {
        namespace {
            app::_PrivateImplementationDetails_StaticArrayInitTypeSize_1018__Class* type_info_ref = nullptr;
        }
        app::_PrivateImplementationDetails_StaticArrayInitTypeSize_1018__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace RandomAnimationPlayer_WeightedAnimation__Array {
        namespace {
            app::RandomAnimationPlayer_WeightedAnimation__Array__Class* type_info_ref = nullptr;
        }
        app::RandomAnimationPlayer_WeightedAnimation__Array__Class** type_info = &type_info_ref;

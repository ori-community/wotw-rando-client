...
namespace app::classes::types {
    namespace OptionalInstantiationHandler_InstanceInfo {
        namespace {
            app::OptionalInstantiationHandler_InstanceInfo__Class* type_info_ref = nullptr;
        }
        app::OptionalInstantiationHandler_InstanceInfo__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace NativeContainerSupportsDeallocateOnJobCompletionAttribute {
        namespace {
            app::NativeContainerSupportsDeallocateOnJobCompletionAttribute__Class* type_info_ref = nullptr;
        }
        app::NativeContainerSupportsDeallocateOnJobCompletionAttribute__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace MultiplayerServerBuildRegionStatusChangedEventDataDoc {
        namespace {
            inline app::MultiplayerServerBuildRegionStatusChangedEventDataDoc__Class* type_info_ref = nullptr;
        }
        inline app::MultiplayerServerBuildRegionStatusChangedEventDataDoc__Class** type_info = &type_info_ref;

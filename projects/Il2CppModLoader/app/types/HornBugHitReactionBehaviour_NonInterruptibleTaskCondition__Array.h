...
namespace app::classes::types {
    namespace HornBugHitReactionBehaviour_NonInterruptibleTaskCondition__Array {
        namespace {
            app::HornBugHitReactionBehaviour_NonInterruptibleTaskCondition__Array__Class* type_info_ref = nullptr;
        }
        app::HornBugHitReactionBehaviour_NonInterruptibleTaskCondition__Array__Class** type_info = &type_info_ref;

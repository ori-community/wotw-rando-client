...
namespace app::classes::types {
    namespace LegacyBabySandWormNew_BabySandwormState__Enum {
        namespace {
            app::LegacyBabySandWormNew_BabySandwormState__Enum__Class* type_info_ref = nullptr;
        }
        app::LegacyBabySandWormNew_BabySandwormState__Enum__Class** type_info = &type_info_ref;

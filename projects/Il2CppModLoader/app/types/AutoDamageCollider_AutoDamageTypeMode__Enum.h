...
namespace app::classes::types {
    namespace AutoDamageCollider_AutoDamageTypeMode__Enum {
        namespace {
            app::AutoDamageCollider_AutoDamageTypeMode__Enum__Class* type_info_ref = nullptr;
        }
        app::AutoDamageCollider_AutoDamageTypeMode__Enum__Class** type_info = &type_info_ref;

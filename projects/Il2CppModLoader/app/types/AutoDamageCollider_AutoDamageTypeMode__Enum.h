...
namespace app::classes::types {
    namespace AutoDamageCollider_AutoDamageTypeMode__Enum {
        namespace {
            inline app::AutoDamageCollider_AutoDamageTypeMode__Enum__Class* type_info_ref = nullptr;
        }
        inline app::AutoDamageCollider_AutoDamageTypeMode__Enum__Class** type_info = &type_info_ref;

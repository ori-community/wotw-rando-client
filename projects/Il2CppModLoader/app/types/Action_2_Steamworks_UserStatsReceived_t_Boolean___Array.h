...
namespace app::classes::types {
    namespace Action_2_Steamworks_UserStatsReceived_t_Boolean___Array {
        namespace {
            app::Action_2_Steamworks_UserStatsReceived_t_Boolean___Array__Class* type_info_ref = nullptr;
        }
        app::Action_2_Steamworks_UserStatsReceived_t_Boolean___Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace Tuple_2_System_Diagnostics_Tracing_EventProvider_SessionInfo_Boolean___Array {
        namespace {
            app::Tuple_2_System_Diagnostics_Tracing_EventProvider_SessionInfo_Boolean___Array__Class* type_info_ref = nullptr;
        }
        app::Tuple_2_System_Diagnostics_Tracing_EventProvider_SessionInfo_Boolean___Array__Class** type_info = &type_info_ref;

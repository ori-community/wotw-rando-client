...
namespace app::classes::types {
    namespace CleverMenuItemSelectionManager_NavigationData__Array {
        namespace {
            app::CleverMenuItemSelectionManager_NavigationData__Array__Class* type_info_ref = nullptr;
        }
        app::CleverMenuItemSelectionManager_NavigationData__Array__Class** type_info = &type_info_ref;

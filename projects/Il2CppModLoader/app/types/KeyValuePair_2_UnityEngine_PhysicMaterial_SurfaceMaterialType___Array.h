...
namespace app::classes::types {
    namespace KeyValuePair_2_UnityEngine_PhysicMaterial_SurfaceMaterialType___Array {
        namespace {
            app::KeyValuePair_2_UnityEngine_PhysicMaterial_SurfaceMaterialType___Array__Class* type_info_ref = nullptr;
        }
        app::KeyValuePair_2_UnityEngine_PhysicMaterial_SurfaceMaterialType___Array__Class** type_info = &type_info_ref;

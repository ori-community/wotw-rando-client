...
namespace app::classes::types {
    namespace MasterTimelineSequence_SceneSettings {
        namespace {
            inline app::MasterTimelineSequence_SceneSettings__Class* type_info_ref = nullptr;
        }
        inline app::MasterTimelineSequence_SceneSettings__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace UberStateVisualizationView_UberStateVisualizationLayout {
        namespace {
            app::UberStateVisualizationView_UberStateVisualizationLayout__Class* type_info_ref = nullptr;
        }
        app::UberStateVisualizationView_UberStateVisualizationLayout__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace AdCampaignAttributionModel_1__Array {
        namespace {
            inline app::AdCampaignAttributionModel_1__Array__Class* type_info_ref = nullptr;
        }
        inline app::AdCampaignAttributionModel_1__Array__Class** type_info = &type_info_ref;

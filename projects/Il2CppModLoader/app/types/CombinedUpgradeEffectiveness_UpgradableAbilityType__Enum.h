...
namespace app::classes::types {
    namespace CombinedUpgradeEffectiveness_UpgradableAbilityType__Enum {
        namespace {
            app::CombinedUpgradeEffectiveness_UpgradableAbilityType__Enum__Class* type_info_ref = nullptr;
        }
        app::CombinedUpgradeEffectiveness_UpgradableAbilityType__Enum__Class** type_info = &type_info_ref;

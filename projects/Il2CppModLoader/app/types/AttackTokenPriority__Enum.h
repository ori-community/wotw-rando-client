...
namespace app::classes::types {
    namespace AttackTokenPriority__Enum {
        namespace {
            app::AttackTokenPriority__Enum__Class* type_info_ref = nullptr;
        }
        app::AttackTokenPriority__Enum__Class** type_info = &type_info_ref;
        ...
        inline app::AttackTokenPriority__Enum__Array* create_array(const std::vector<app::AttackTokenPriority__Enum__Boxed*>& items) {

...
namespace app::classes::types {
    namespace ChallengeShrineManager_AddTimeTrigger__Array {
        namespace {
            app::ChallengeShrineManager_AddTimeTrigger__Array__Class* type_info_ref = nullptr;
        }
        app::ChallengeShrineManager_AddTimeTrigger__Array__Class** type_info = &type_info_ref;

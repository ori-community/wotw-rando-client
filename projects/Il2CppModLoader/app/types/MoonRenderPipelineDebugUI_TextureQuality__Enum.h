...
namespace app::classes::types {
    namespace MoonRenderPipelineDebugUI_TextureQuality__Enum {
        ...
        inline app::MoonRenderPipelineDebugUI_TextureQuality__Enum__Array* create_array(const std::vector<app::MoonRenderPipelineDebugUI_TextureQuality__Enum__Boxed*>& items) {

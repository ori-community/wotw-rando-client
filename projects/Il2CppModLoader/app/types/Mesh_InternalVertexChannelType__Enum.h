...
namespace app::classes::types {
    namespace Mesh_InternalVertexChannelType__Enum {
        namespace {
            inline app::Mesh_InternalVertexChannelType__Enum__Class* type_info_ref = nullptr;
        }
        inline app::Mesh_InternalVertexChannelType__Enum__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace SpiderBossLaserAttackCeiling_State__Enum {
        namespace {
            inline app::SpiderBossLaserAttackCeiling_State__Enum__Class* type_info_ref = nullptr;
        }
        inline app::SpiderBossLaserAttackCeiling_State__Enum__Class** type_info = &type_info_ref;

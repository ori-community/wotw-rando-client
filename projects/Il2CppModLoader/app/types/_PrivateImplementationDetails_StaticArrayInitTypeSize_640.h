...
namespace app::classes::types {
    namespace _PrivateImplementationDetails_StaticArrayInitTypeSize_640 {
        namespace {
            app::_PrivateImplementationDetails_StaticArrayInitTypeSize_640__Class* type_info_ref = nullptr;
        }
        app::_PrivateImplementationDetails_StaticArrayInitTypeSize_640__Class** type_info = &type_info_ref;

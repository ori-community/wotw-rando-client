...
namespace app::classes::types {
    namespace KeyValuePair_2_Moon_Timeline_MoonTimeline_Moon_Timeline_FloatAnimator___Array {
        namespace {
            app::KeyValuePair_2_Moon_Timeline_MoonTimeline_Moon_Timeline_FloatAnimator___Array__Class* type_info_ref = nullptr;
        }
        app::KeyValuePair_2_Moon_Timeline_MoonTimeline_Moon_Timeline_FloatAnimator___Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace MainThreadWorkStealer_WorkStealingMode__Enum__Array {
        namespace {
            app::MainThreadWorkStealer_WorkStealingMode__Enum__Array__Class* type_info_ref = nullptr;
        }
        app::MainThreadWorkStealer_WorkStealingMode__Enum__Array__Class** type_info = &type_info_ref;

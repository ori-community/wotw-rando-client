...
namespace app::classes::types {
    namespace ISteamMatchmakingPingResponse_ServerFailedToRespond {
        namespace {
            app::ISteamMatchmakingPingResponse_ServerFailedToRespond__Class* type_info_ref = nullptr;
        }
        app::ISteamMatchmakingPingResponse_ServerFailedToRespond__Class** type_info = &type_info_ref;

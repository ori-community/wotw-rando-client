...
namespace app::classes::types {
    namespace _PrivateImplementationDetails_StaticArrayInitTypeSize_506 {
        namespace {
            app::_PrivateImplementationDetails_StaticArrayInitTypeSize_506__Class* type_info_ref = nullptr;
        }
        app::_PrivateImplementationDetails_StaticArrayInitTypeSize_506__Class** type_info = &type_info_ref;

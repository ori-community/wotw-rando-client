...
namespace app::classes::types {
    namespace TestSpiderColliderManager_ColliderHolder__Array {
        namespace {
            app::TestSpiderColliderManager_ColliderHolder__Array__Class* type_info_ref = nullptr;
        }
        app::TestSpiderColliderManager_ColliderHolder__Array__Class** type_info = &type_info_ref;

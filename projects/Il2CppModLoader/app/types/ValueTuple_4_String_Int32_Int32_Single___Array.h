...
namespace app::classes::types {
    namespace ValueTuple_4_String_Int32_Int32_Single___Array {
        namespace {
            inline app::ValueTuple_4_String_Int32_Int32_Single___Array__Class* type_info_ref = nullptr;
        }
        inline app::ValueTuple_4_String_Int32_Int32_Single___Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace PostLateUpdate_TriggerEndOfFrameCallbacks {
        namespace {
            app::PostLateUpdate_TriggerEndOfFrameCallbacks__Class* type_info_ref = nullptr;
        }
        app::PostLateUpdate_TriggerEndOfFrameCallbacks__Class** type_info = &type_info_ref;

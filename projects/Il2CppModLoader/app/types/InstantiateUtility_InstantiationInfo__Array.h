...
namespace app::classes::types {
    namespace InstantiateUtility_InstantiationInfo__Array {
        namespace {
            app::InstantiateUtility_InstantiationInfo__Array__Class* type_info_ref = nullptr;
        }
        app::InstantiateUtility_InstantiationInfo__Array__Class** type_info = &type_info_ref;

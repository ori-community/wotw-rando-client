...
namespace app::classes::types {
    namespace EarlyUpdate_UpdateStreamingManager {
        namespace {
            inline app::EarlyUpdate_UpdateStreamingManager__Class* type_info_ref = nullptr;
        }
        inline app::EarlyUpdate_UpdateStreamingManager__Class** type_info = &type_info_ref;

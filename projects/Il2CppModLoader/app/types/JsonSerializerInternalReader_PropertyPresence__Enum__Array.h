...
namespace app::classes::types {
    namespace JsonSerializerInternalReader_PropertyPresence__Enum__Array {
        namespace {
            app::JsonSerializerInternalReader_PropertyPresence__Enum__Array__Class* type_info_ref = nullptr;
        }
        app::JsonSerializerInternalReader_PropertyPresence__Enum__Array__Class** type_info = &type_info_ref;

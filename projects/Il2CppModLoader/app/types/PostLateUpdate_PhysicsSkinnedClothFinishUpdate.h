...
namespace app::classes::types {
    namespace PostLateUpdate_PhysicsSkinnedClothFinishUpdate {
        namespace {
            app::PostLateUpdate_PhysicsSkinnedClothFinishUpdate__Class* type_info_ref = nullptr;
        }
        app::PostLateUpdate_PhysicsSkinnedClothFinishUpdate__Class** type_info = &type_info_ref;

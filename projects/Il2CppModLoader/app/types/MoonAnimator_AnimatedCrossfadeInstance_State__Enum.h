...
namespace app::classes::types {
    namespace MoonAnimator_AnimatedCrossfadeInstance_State__Enum {
        namespace {
            app::MoonAnimator_AnimatedCrossfadeInstance_State__Enum__Class* type_info_ref = nullptr;
        }
        app::MoonAnimator_AnimatedCrossfadeInstance_State__Enum__Class** type_info = &type_info_ref;

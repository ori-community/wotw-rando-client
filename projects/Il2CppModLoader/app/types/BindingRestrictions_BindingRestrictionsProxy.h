...
namespace app::classes::types {
    namespace BindingRestrictions_BindingRestrictionsProxy {
        namespace {
            app::BindingRestrictions_BindingRestrictionsProxy__Class* type_info_ref = nullptr;
        }
        app::BindingRestrictions_BindingRestrictionsProxy__Class** type_info = &type_info_ref;

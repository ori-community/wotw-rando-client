...
namespace app::classes::types {
    namespace TurtleShell_DamageReactionMultipler__Array {
        namespace {
            app::TurtleShell_DamageReactionMultipler__Array__Class* type_info_ref = nullptr;
        }
        app::TurtleShell_DamageReactionMultipler__Array__Class** type_info = &type_info_ref;

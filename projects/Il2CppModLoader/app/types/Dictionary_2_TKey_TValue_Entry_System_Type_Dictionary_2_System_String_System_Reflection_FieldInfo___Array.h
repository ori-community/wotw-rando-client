...
namespace app::classes::types {
    namespace Dictionary_2_TKey_TValue_Entry_System_Type_Dictionary_2_System_String_System_Reflection_FieldInfo___Array {
        namespace {
            app::Dictionary_2_TKey_TValue_Entry_System_Type_Dictionary_2_System_String_System_Reflection_FieldInfo___Array__Class* type_info_ref = nullptr;
        }
        app::Dictionary_2_TKey_TValue_Entry_System_Type_Dictionary_2_System_String_System_Reflection_FieldInfo___Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace EntityWeightData_EntityWeight__Enum__Array {
        namespace {
            app::EntityWeightData_EntityWeight__Enum__Array__Class* type_info_ref = nullptr;
        }
        app::EntityWeightData_EntityWeight__Enum__Array__Class** type_info = &type_info_ref;

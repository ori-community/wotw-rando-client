...
enum class UnsafeNativeMethods_ManifestEtw_ActivityControl__Enum : uint32_t {
    EVENT_ACTIVITY_CTRL_GET_ID = 0x00000001,
    EVENT_ACTIVITY_CTRL_SET_ID = 0x00000002,
    EVENT_ACTIVITY_CTRL_CREATE_ID = 0x00000003,
    EVENT_ACTIVITY_CTRL_GET_SET_ID = 0x00000004,
    EVENT_ACTIVITY_CTRL_CREATE_SET_ID = 0x00000005,
};
...
struct UnsafeNativeMethods_ManifestEtw_ActivityControl__Enum__Boxed {
    ...
    MonitorData *monitor;
    UnsafeNativeMethods_ManifestEtw_ActivityControl__Enum value;
...
enum class UnsafeNativeMethods_ManifestEtw_EVENT_INFO_CLASS__Enum : int32_t {
    BinaryTrackInfo = 0x00000000,
    SetEnableAllKeywords = 0x00000001,
    SetTraits = 0x00000002,
};
...
struct UnsafeNativeMethods_ManifestEtw_EVENT_INFO_CLASS__Enum__Boxed {
    ...
    MonitorData *monitor;
    UnsafeNativeMethods_ManifestEtw_EVENT_INFO_CLASS__Enum value;
...
enum class RegistryValueOptions__Enum : int32_t {
    None = 0x00000000,
    DoNotExpandEnvironmentNames = 0x00000001,
};

struct RegistryValueOptions__Enum__Boxed {
    struct RegistryValueOptions__Enum__Class *klass;
    MonitorData *monitor;
    RegistryValueOptions__Enum value;
...
enum class ExceptionArgument__Enum : int32_t {
    obj = 0x00000000,
    dictionary = 0x00000001,
    dictionaryCreationThreshold = 0x00000002,
    array = 0x00000003,
    info = 0x00000004,
    key = 0x00000005,
    collection = 0x00000006,
    list = 0x00000007,
    match = 0x00000008,
    converter = 0x00000009,
    queue = 0x0000000a,
    stack = 0x0000000b,
    capacity = 0x0000000c,
    index = 0x0000000d,
    startIndex = 0x0000000e,
    value = 0x0000000f,
    count = 0x00000010,
    arrayIndex = 0x00000011,
    name = 0x00000012,
    mode = 0x00000013,
    item = 0x00000014,
    options = 0x00000015,
    view = 0x00000016,
    sourceBytesToCopy = 0x00000017,
    start = 0x00000018,
    pointer = 0x00000019,
    ownedMemory = 0x0000001a,
    text = 0x0000001b,
};

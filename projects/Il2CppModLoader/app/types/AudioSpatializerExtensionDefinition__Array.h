...
namespace app::classes::types {
    namespace AudioSpatializerExtensionDefinition__Array {
        namespace {
            inline app::AudioSpatializerExtensionDefinition__Array__Class* type_info_ref = nullptr;
        }
        inline app::AudioSpatializerExtensionDefinition__Array__Class** type_info = &type_info_ref;

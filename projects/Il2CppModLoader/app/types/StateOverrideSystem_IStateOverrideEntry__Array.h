...
namespace app::classes::types {
    namespace StateOverrideSystem_IStateOverrideEntry__Array {
        namespace {
            app::StateOverrideSystem_IStateOverrideEntry__Array__Class* type_info_ref = nullptr;
        }
        app::StateOverrideSystem_IStateOverrideEntry__Array__Class** type_info = &type_info_ref;

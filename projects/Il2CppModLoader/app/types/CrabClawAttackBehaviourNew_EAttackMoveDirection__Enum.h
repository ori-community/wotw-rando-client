...
namespace app::classes::types {
    namespace CrabClawAttackBehaviourNew_EAttackMoveDirection__Enum {
        namespace {
            app::CrabClawAttackBehaviourNew_EAttackMoveDirection__Enum__Class* type_info_ref = nullptr;
        }
        app::CrabClawAttackBehaviourNew_EAttackMoveDirection__Enum__Class** type_info = &type_info_ref;

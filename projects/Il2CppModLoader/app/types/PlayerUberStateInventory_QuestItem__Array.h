...
namespace app::classes::types {
    namespace PlayerUberStateInventory_QuestItem__Array {
        namespace {
            inline app::PlayerUberStateInventory_QuestItem__Array__Class* type_info_ref = nullptr;
        }
        inline app::PlayerUberStateInventory_QuestItem__Array__Class** type_info = &type_info_ref;

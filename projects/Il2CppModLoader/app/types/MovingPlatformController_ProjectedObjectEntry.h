...
namespace app::classes::types {
    namespace MovingPlatformController_ProjectedObjectEntry {
        namespace {
            app::MovingPlatformController_ProjectedObjectEntry__Class* type_info_ref = nullptr;
        }
        app::MovingPlatformController_ProjectedObjectEntry__Class** type_info = &type_info_ref;

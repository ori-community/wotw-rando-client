...
namespace app::classes::types {
    namespace MantisHorizontalJumpAttackBehaviour_State__Enum {
        namespace {
            inline app::MantisHorizontalJumpAttackBehaviour_State__Enum__Class* type_info_ref = nullptr;
        }
        inline app::MantisHorizontalJumpAttackBehaviour_State__Enum__Class** type_info = &type_info_ref;

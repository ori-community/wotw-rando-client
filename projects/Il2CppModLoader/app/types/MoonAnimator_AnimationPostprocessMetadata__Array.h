...
namespace app::classes::types {
    namespace MoonAnimator_AnimationPostprocessMetadata__Array {
        namespace {
            app::MoonAnimator_AnimationPostprocessMetadata__Array__Class* type_info_ref = nullptr;
        }
        app::MoonAnimator_AnimationPostprocessMetadata__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace SoundCompositionTransition_SoundFadeInformation__Array {
        namespace {
            app::SoundCompositionTransition_SoundFadeInformation__Array__Class* type_info_ref = nullptr;
        }
        app::SoundCompositionTransition_SoundFadeInformation__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace CartographerDesertPatrolBehaviour_State__Enum {
        namespace {
            app::CartographerDesertPatrolBehaviour_State__Enum__Class* type_info_ref = nullptr;
        }
        app::CartographerDesertPatrolBehaviour_State__Enum__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace DiscriminatedUnionConverter_UnionCase__Array {
        namespace {
            app::DiscriminatedUnionConverter_UnionCase__Array__Class* type_info_ref = nullptr;
        }
        app::DiscriminatedUnionConverter_UnionCase__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace EVROverlayIntersectionMaskPrimitiveType__Enum {
        namespace {
            inline app::EVROverlayIntersectionMaskPrimitiveType__Enum__Class* type_info_ref = nullptr;
        }
        inline app::EVROverlayIntersectionMaskPrimitiveType__Enum__Class** type_info = &type_info_ref;

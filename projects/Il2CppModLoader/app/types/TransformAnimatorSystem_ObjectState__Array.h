...
namespace app::classes::types {
    namespace TransformAnimatorSystem_ObjectState__Array {
        namespace {
            app::TransformAnimatorSystem_ObjectState__Array__Class* type_info_ref = nullptr;
        }
        app::TransformAnimatorSystem_ObjectState__Array__Class** type_info = &type_info_ref;

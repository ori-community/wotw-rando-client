...
namespace app::classes::types {
    namespace GhostTimelineEventsPlugin_PendingEvent__Array {
        namespace {
            app::GhostTimelineEventsPlugin_PendingEvent__Array__Class* type_info_ref = nullptr;
        }
        app::GhostTimelineEventsPlugin_PendingEvent__Array__Class** type_info = &type_info_ref;

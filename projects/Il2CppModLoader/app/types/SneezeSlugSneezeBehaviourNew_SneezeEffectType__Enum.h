...
namespace app::classes::types {
    namespace SneezeSlugSneezeBehaviourNew_SneezeEffectType__Enum {
        namespace {
            app::SneezeSlugSneezeBehaviourNew_SneezeEffectType__Enum__Class* type_info_ref = nullptr;
        }
        app::SneezeSlugSneezeBehaviourNew_SneezeEffectType__Enum__Class** type_info = &type_info_ref;

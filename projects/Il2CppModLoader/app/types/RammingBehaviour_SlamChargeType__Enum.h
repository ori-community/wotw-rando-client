...
namespace app::classes::types {
    namespace RammingBehaviour_SlamChargeType__Enum {
        namespace {
            inline app::RammingBehaviour_SlamChargeType__Enum__Class* type_info_ref = nullptr;
        }
        inline app::RammingBehaviour_SlamChargeType__Enum__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace WotwUberStateToWwiseData_AbilityRequirementCondition__Array {
        namespace {
            app::WotwUberStateToWwiseData_AbilityRequirementCondition__Array__Class* type_info_ref = nullptr;
        }
        app::WotwUberStateToWwiseData_AbilityRequirementCondition__Array__Class** type_info = &type_info_ref;

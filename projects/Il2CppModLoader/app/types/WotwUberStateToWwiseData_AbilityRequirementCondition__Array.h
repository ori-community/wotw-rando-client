...
namespace app::classes::types {
    namespace WotwUberStateToWwiseData_AbilityRequirementCondition__Array {
        namespace {
            inline app::WotwUberStateToWwiseData_AbilityRequirementCondition__Array__Class* type_info_ref = nullptr;
        }
        inline app::WotwUberStateToWwiseData_AbilityRequirementCondition__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace List_1_Moon_CrossSceneDependencyInjector___Array {
        namespace {
            app::List_1_Moon_CrossSceneDependencyInjector___Array__Class* type_info_ref = nullptr;
        }
        app::List_1_Moon_CrossSceneDependencyInjector___Array__Class** type_info = &type_info_ref;

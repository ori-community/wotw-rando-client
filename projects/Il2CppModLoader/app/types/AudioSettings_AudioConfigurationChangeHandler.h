...
namespace app::classes::types {
    namespace AudioSettings_AudioConfigurationChangeHandler {
        namespace {
            app::AudioSettings_AudioConfigurationChangeHandler__Class* type_info_ref = nullptr;
        }
        app::AudioSettings_AudioConfigurationChangeHandler__Class** type_info = &type_info_ref;

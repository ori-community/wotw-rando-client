...
namespace app::classes::types {
    namespace SpiderBatEntityReactions_UninterruptableTimelineVars__Array {
        namespace {
            inline app::SpiderBatEntityReactions_UninterruptableTimelineVars__Array__Class* type_info_ref = nullptr;
        }
        inline app::SpiderBatEntityReactions_UninterruptableTimelineVars__Array__Class** type_info = &type_info_ref;

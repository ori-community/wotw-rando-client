...
namespace app::classes::types {
    namespace KeyValuePair_2_UnityEngine_GameObject_List_1_UnityEngine_ParticleSystem___Array {
        namespace {
            app::KeyValuePair_2_UnityEngine_GameObject_List_1_UnityEngine_ParticleSystem___Array__Class* type_info_ref = nullptr;
        }
        app::KeyValuePair_2_UnityEngine_GameObject_List_1_UnityEngine_ParticleSystem___Array__Class** type_info = &type_info_ref;

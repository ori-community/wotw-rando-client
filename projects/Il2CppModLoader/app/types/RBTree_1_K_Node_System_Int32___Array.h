...
namespace app::classes::types {
    namespace RBTree_1_K_Node_System_Int32___Array {
        namespace {
            inline app::RBTree_1_K_Node_System_Int32___Array__Class* type_info_ref = nullptr;
        }
        inline app::RBTree_1_K_Node_System_Int32___Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace Input_Button__Enum {
        namespace {
            app::Input_Button__Enum__Class* type_info_ref = nullptr;
        }
        app::Input_Button__Enum__Class** type_info = &type_info_ref;
        ...
        inline app::Input_Button__Enum__Array* create_array(const std::vector<app::Input_Button__Enum__Boxed*>& items) {

...
namespace app::classes::types {
    namespace ISwarmAttackable {
        IL2CPP_MODLOADER_DLLEXPORT ::app::ISwarmAttackable__Class** type_info = (::app::ISwarmAttackable__Class**)(modloader::win::memory::resolve_rva(0x047991C0));
    }
    ...
    namespace IMoonEffectPoolable {
        IL2CPP_MODLOADER_DLLEXPORT ::app::IMoonEffectPoolable__Class** type_info = (::app::IMoonEffectPoolable__Class**)(modloader::win::memory::resolve_rva(0x047451B0));
    }
    ...
    namespace IMoonEffectCompositionRoot {
        IL2CPP_MODLOADER_DLLEXPORT ::app::IMoonEffectCompositionRoot__Class** type_info = (::app::IMoonEffectCompositionRoot__Class**)(modloader::win::memory::resolve_rva(0x04701498));
    }
    namespace IBoxableInstruction {
        IL2CPP_MODLOADER_DLLEXPORT ::app::IBoxableInstruction__Class** type_info = (::app::IBoxableInstruction__Class**)(modloader::win::memory::resolve_rva(0x0476DFC8));
    }
    namespace IIntUberState {
        IL2CPP_MODLOADER_DLLEXPORT ::app::IIntUberState__Class** type_info = (::app::IIntUberState__Class**)(modloader::win::memory::resolve_rva(0x04764DD8));
    }
    ...
    namespace IReflectableType {
        IL2CPP_MODLOADER_DLLEXPORT ::app::IReflectableType__Class** type_info = (::app::IReflectableType__Class**)(modloader::win::memory::resolve_rva(0x04745F30));
    }
    namespace UriHelper {
    ...
    namespace ILayoutIgnorer {
        IL2CPP_MODLOADER_DLLEXPORT ::app::ILayoutIgnorer__Class** type_info = (::app::ILayoutIgnorer__Class**)(modloader::win::memory::resolve_rva(0x0477FDE0));
    }
    namespace ILayoutController {
        IL2CPP_MODLOADER_DLLEXPORT ::app::ILayoutController__Class** type_info = (::app::ILayoutController__Class**)(modloader::win::memory::resolve_rva(0x04781338));
    }
    namespace ILayoutSelfController {
        IL2CPP_MODLOADER_DLLEXPORT ::app::ILayoutSelfController__Class** type_info = (::app::ILayoutSelfController__Class**)(modloader::win::memory::resolve_rva(0x0474CF80));
    }
    ...
    namespace ITypeResolutionService {
        IL2CPP_MODLOADER_DLLEXPORT ::app::ITypeResolutionService__Class** type_info = (::app::ITypeResolutionService__Class**)(modloader::win::memory::resolve_rva(0x04789CC8));
    }
    ...
    namespace ICloneable {
        IL2CPP_MODLOADER_DLLEXPORT ::app::ICloneable__Class** type_info = (::app::ICloneable__Class**)(modloader::win::memory::resolve_rva(0x0471DD70));
    }
    ...
    namespace IMaskable {
        IL2CPP_MODLOADER_DLLEXPORT ::app::IMaskable__Class** type_info = (::app::IMaskable__Class**)(modloader::win::memory::resolve_rva(0x047730C0));
    }
    ...
    namespace IHammerAttackable {
        IL2CPP_MODLOADER_DLLEXPORT ::app::IHammerAttackable__Class** type_info = (::app::IHammerAttackable__Class**)(modloader::win::memory::resolve_rva(0x04753610));
    }
    namespace ITorchAttackable {
        IL2CPP_MODLOADER_DLLEXPORT ::app::ITorchAttackable__Class** type_info = (::app::ITorchAttackable__Class**)(modloader::win::memory::resolve_rva(0x0471E0E8));
    }
    ...
    namespace IInternalMessage {
        IL2CPP_MODLOADER_DLLEXPORT ::app::IInternalMessage__Class** type_info = (::app::IInternalMessage__Class**)(modloader::win::memory::resolve_rva(0x047679A0));
    }
    ...
    namespace ITimelineItem {
        IL2CPP_MODLOADER_DLLEXPORT ::app::ITimelineItem__Class** type_info = (::app::ITimelineItem__Class**)(modloader::win::memory::resolve_rva(0x047771F0));
    }
    ...
    namespace INpcInteractionNode {
        IL2CPP_MODLOADER_DLLEXPORT ::app::INpcInteractionNode__Class** type_info = (::app::INpcInteractionNode__Class**)(modloader::win::memory::resolve_rva(0x04722AF0));
    }
    ...
    namespace INearSeinReceiver {
        IL2CPP_MODLOADER_DLLEXPORT ::app::INearSeinReceiver__Class** type_info = (::app::INearSeinReceiver__Class**)(modloader::win::memory::resolve_rva(0x04755320));
    }

...
namespace app::classes::types {
    namespace AlwaysShowDynamicTestDebugInfoProfilingSetting {
        namespace {
            app::AlwaysShowDynamicTestDebugInfoProfilingSetting__Class* type_info_ref = nullptr;
        }
        app::AlwaysShowDynamicTestDebugInfoProfilingSetting__Class** type_info = &type_info_ref;

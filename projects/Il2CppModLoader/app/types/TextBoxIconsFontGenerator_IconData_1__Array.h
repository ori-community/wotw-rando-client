...
namespace app::classes::types {
    namespace TextBoxIconsFontGenerator_IconData_1__Array {
        namespace {
            app::TextBoxIconsFontGenerator_IconData_1__Array__Class* type_info_ref = nullptr;
        }
        app::TextBoxIconsFontGenerator_IconData_1__Array__Class** type_info = &type_info_ref;

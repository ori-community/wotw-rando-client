...
namespace app::classes::types {
    namespace MultiplayerServerBuildDeletedEventPayload {
        namespace {
            app::MultiplayerServerBuildDeletedEventPayload__Class* type_info_ref = nullptr;
        }
        app::MultiplayerServerBuildDeletedEventPayload__Class** type_info = &type_info_ref;

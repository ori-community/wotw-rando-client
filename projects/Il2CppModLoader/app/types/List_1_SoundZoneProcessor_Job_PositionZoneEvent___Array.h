...
namespace app::classes::types {
    namespace List_1_SoundZoneProcessor_Job_PositionZoneEvent___Array {
        inline app::List_1_SoundZoneProcessor_Job_PositionZoneEvent___Array__Class** type_info = (app::List_1_SoundZoneProcessor_Job_PositionZoneEvent___Array__Class**)(modloader::win::memory::resolve_rva(0x04772AA8));

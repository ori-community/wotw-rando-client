...
namespace app::classes::types {
    namespace FastHashSet_1_T_TNode_System_Object___Array {
        namespace {
            app::FastHashSet_1_T_TNode_System_Object___Array__Class* type_info_ref = nullptr;
        }
        app::FastHashSet_1_T_TNode_System_Object___Array__Class** type_info = &type_info_ref;

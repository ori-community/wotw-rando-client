...
namespace app::classes::types {
    namespace RenderBufferStoreAction__Enum {
        namespace {
            app::RenderBufferStoreAction__Enum__Class* type_info_ref = nullptr;
        }
        app::RenderBufferStoreAction__Enum__Class** type_info = &type_info_ref;
        ...
        inline app::RenderBufferStoreAction__Enum__Array* create_array(const std::vector<app::RenderBufferStoreAction__Enum__Boxed*>& items) {

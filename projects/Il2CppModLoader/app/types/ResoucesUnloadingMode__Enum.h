...
namespace app::classes::types {
    namespace ResoucesUnloadingMode__Enum {
        namespace {
            app::ResoucesUnloadingMode__Enum__Class* type_info_ref = nullptr;
        }
        app::ResoucesUnloadingMode__Enum__Class** type_info = &type_info_ref;
        ...
        inline app::ResoucesUnloadingMode__Enum__Array* create_array(const std::vector<app::ResoucesUnloadingMode__Enum__Boxed*>& items) {

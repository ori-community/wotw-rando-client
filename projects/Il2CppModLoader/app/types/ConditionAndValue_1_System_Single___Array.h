...
namespace app::classes::types {
    namespace ConditionAndValue_1_System_Single___Array {
        namespace {
            app::ConditionAndValue_1_System_Single___Array__Class* type_info_ref = nullptr;
        }
        app::ConditionAndValue_1_System_Single___Array__Class** type_info = &type_info_ref;

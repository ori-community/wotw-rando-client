...
namespace app::classes::types {
    namespace SimpleSwayAnimPostprocess_PerFrameReadOnly {
        namespace {
            app::SimpleSwayAnimPostprocess_PerFrameReadOnly__Class* type_info_ref = nullptr;
        }
        app::SimpleSwayAnimPostprocess_PerFrameReadOnly__Class** type_info = &type_info_ref;

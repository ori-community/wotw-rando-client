...
namespace app::classes::types {
    namespace Dictionary_2_TKey_TValue_Entry_Moon_Profile_Metric_System_Single__1__Array {
        namespace {
            app::Dictionary_2_TKey_TValue_Entry_Moon_Profile_Metric_System_Single__1__Array__Class* type_info_ref = nullptr;
        }
        app::Dictionary_2_TKey_TValue_Entry_Moon_Profile_Metric_System_Single__1__Array__Class** type_info = &type_info_ref;

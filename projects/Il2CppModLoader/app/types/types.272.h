namespace app {
struct FABRIKChain__Array__VTable {
};

struct FABRIKChain__Array__StaticFields {
};

struct FABRIKChain__Array__Class {
    Il2CppClass_0 _0;
    Il2CppRuntimeInterfaceOffsetPair *interfaceOffsets;
    struct FABRIKChain__Array__StaticFields *static_fields;
    const Il2CppRGCTXData *rgctx_data;
    Il2CppClass_1 _1;
    struct FABRIKChain__Array__VTable vtable;
};
...
struct FBBIKHeadEffector_BendBone__Array__VTable {
};

struct FBBIKHeadEffector_BendBone__Array__StaticFields {
};

struct FBBIKHeadEffector_BendBone__Array__Class {
    Il2CppClass_0 _0;
    Il2CppRuntimeInterfaceOffsetPair *interfaceOffsets;
    struct FBBIKHeadEffector_BendBone__Array__StaticFields *static_fields;
    const Il2CppRGCTXData *rgctx_data;
    Il2CppClass_1 _1;
    struct FBBIKHeadEffector_BendBone__Array__VTable vtable;
};
...
enum class IKMappingLimb_BoneMapType__Enum : int32_t {
    Parent = 0x00000000,
    Bone1 = 0x00000001,
    Bone2 = 0x00000002,
    Bone3 = 0x00000003,
...
struct IKMappingLimb_BoneMapType__Enum__Boxed {
    struct IKMappingLimb_BoneMapType__Enum__Class *klass;
    MonitorData *monitor;
    IKMappingLimb_BoneMapType__Enum value;
    
};

struct IKMappingLimb_BoneMapType__Enum__VTable {
    VirtualInvokeData Equals;
    VirtualInvokeData Finalize;
    VirtualInvokeData GetHashCode;
    VirtualInvokeData ToString;
...
struct IKMappingLimb_BoneMapType__Enum__StaticFields {
};

struct IKMappingLimb_BoneMapType__Enum__Class {
    Il2CppClass_0 _0;
    Il2CppRuntimeInterfaceOffsetPair *interfaceOffsets;
    struct IKMappingLimb_BoneMapType__Enum__StaticFields *static_fields;
    const Il2CppRGCTXData *rgctx_data;
    Il2CppClass_1 _1;
    struct IKMappingLimb_BoneMapType__Enum__VTable vtable;
};

struct IKSolver_Bone___VTable {
};

struct IKSolver_Bone___StaticFields {
};

struct IKSolver_Bone___Class {
    Il2CppClass_0 _0;
    Il2CppRuntimeInterfaceOffsetPair *interfaceOffsets;
    struct IKSolver_Bone___StaticFields *static_fields;
    const Il2CppRGCTXData *rgctx_data;
    Il2CppClass_1 _1;
    struct IKSolver_Bone___VTable vtable;
};

struct IKSolver_Point___VTable {
};

struct IKSolver_Point___StaticFields {
};

struct IKSolver_Point___Class {
    Il2CppClass_0 _0;
    Il2CppRuntimeInterfaceOffsetPair *interfaceOffsets;
    struct IKSolver_Point___StaticFields *static_fields;
    const Il2CppRGCTXData *rgctx_data;
    Il2CppClass_1 _1;
    struct IKSolver_Point___VTable vtable;
};

enum class FullBodyBipedChain__Enum : int32_t {
    LeftArm = 0x00000000,
    RightArm = 0x00000001,
    LeftLeg = 0x00000002,
    RightLeg = 0x00000003,
...
struct FullBodyBipedChain__Enum__Boxed {
    struct FullBodyBipedChain__Enum__Class *klass;
    MonitorData *monitor;
    FullBodyBipedChain__Enum value;
    
};

struct FullBodyBipedChain__Enum__VTable {
    VirtualInvokeData Equals;
    VirtualInvokeData Finalize;
    VirtualInvokeData GetHashCode;
    VirtualInvokeData ToString;
...
struct FullBodyBipedChain__Enum__StaticFields {
};

struct FullBodyBipedChain__Enum__Class {
    Il2CppClass_0 _0;
    Il2CppRuntimeInterfaceOffsetPair *interfaceOffsets;
    struct FullBodyBipedChain__Enum__StaticFields *static_fields;
    const Il2CppRGCTXData *rgctx_data;
    Il2CppClass_1 _1;
    struct FullBodyBipedChain__Enum__VTable vtable;
};

struct IKSolverLimb_AxisDirection___VTable {
};

struct IKSolverLimb_AxisDirection___StaticFields {
};

struct IKSolverLimb_AxisDirection___Class {
    Il2CppClass_0 _0;
    Il2CppRuntimeInterfaceOffsetPair *interfaceOffsets;
    struct IKSolverLimb_AxisDirection___StaticFields *static_fields;
    const Il2CppRGCTXData *rgctx_data;
    Il2CppClass_1 _1;
    struct IKSolverLimb_AxisDirection___VTable vtable;
};
...
struct IKSolverLookAt_LookAtBone___VTable {
};

struct IKSolverLookAt_LookAtBone___StaticFields {
};

struct IKSolverLookAt_LookAtBone___Class {
    Il2CppClass_0 _0;
    Il2CppRuntimeInterfaceOffsetPair *interfaceOffsets;
    struct IKSolverLookAt_LookAtBone___StaticFields *static_fields;
    const Il2CppRGCTXData *rgctx_data;
    Il2CppClass_1 _1;
    struct IKSolverLookAt_LookAtBone___VTable vtable;
};
...
enum class InteractionObject_WeightCurve_Type__Enum : int32_t {
    PositionWeight = 0x00000000,
    RotationWeight = 0x00000001,
    PositionOffsetX = 0x00000002,
    PositionOffsetY = 0x00000003,
    PositionOffsetZ = 0x00000004,
    Pull = 0x00000005,
    Reach = 0x00000006,
    RotateBoneWeight = 0x00000007,
    Push = 0x00000008,
    PushParent = 0x00000009,
    PoserWeight = 0x0000000a,
};

struct InteractionObject_WeightCurve_Type__Enum__Boxed {
    struct InteractionObject_WeightCurve_Type__Enum__Class *klass;
    MonitorData *monitor;
    InteractionObject_WeightCurve_Type__Enum value;
    
};

struct __declspec(align(8)) InteractionObject_WeightCurve__Fields {
    InteractionObject_WeightCurve_Type__Enum type;
...
struct FullBodyBipedEffector__Enum__Array {
    ...
    Il2CppArrayBounds *bounds;
    il2cpp_array_size_t max_length;
    FullBodyBipedEffector__Enum vector[32];
};

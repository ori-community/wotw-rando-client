...
namespace app::classes::types {
    namespace UberGCManager_GcCleanupReason__Enum {
        inline app::UberGCManager_GcCleanupReason__Enum__Class** type_info = (app::UberGCManager_GcCleanupReason__Enum__Class**)(modloader::win::memory::resolve_rva(0x04712580));

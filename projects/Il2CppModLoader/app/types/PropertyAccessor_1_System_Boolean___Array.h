...
namespace app::classes::types {
    namespace PropertyAccessor_1_System_Boolean___Array {
        namespace {
            app::PropertyAccessor_1_System_Boolean___Array__Class* type_info_ref = nullptr;
        }
        app::PropertyAccessor_1_System_Boolean___Array__Class** type_info = &type_info_ref;

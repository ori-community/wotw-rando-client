...
namespace app::classes::types {
    namespace _PrivateImplementationDetails_StaticArrayInitTypeSize_6 {
        namespace {
            app::_PrivateImplementationDetails_StaticArrayInitTypeSize_6__Class* type_info_ref = nullptr;
        }
        app::_PrivateImplementationDetails_StaticArrayInitTypeSize_6__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace ISteamMatchmakingPlayersResponse_PlayersFailedToRespond {
        namespace {
            app::ISteamMatchmakingPlayersResponse_PlayersFailedToRespond__Class* type_info_ref = nullptr;
        }
        app::ISteamMatchmakingPlayersResponse_PlayersFailedToRespond__Class** type_info = &type_info_ref;

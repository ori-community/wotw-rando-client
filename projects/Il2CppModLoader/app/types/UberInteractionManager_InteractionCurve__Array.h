...
namespace app::classes::types {
    namespace UberInteractionManager_InteractionCurve__Array {
        namespace {
            app::UberInteractionManager_InteractionCurve__Array__Class* type_info_ref = nullptr;
        }
        app::UberInteractionManager_InteractionCurve__Array__Class** type_info = &type_info_ref;

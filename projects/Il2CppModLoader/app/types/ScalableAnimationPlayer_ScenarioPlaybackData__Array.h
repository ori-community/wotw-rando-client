...
namespace app::classes::types {
    namespace ScalableAnimationPlayer_ScenarioPlaybackData__Array {
        namespace {
            inline app::ScalableAnimationPlayer_ScenarioPlaybackData__Array__Class* type_info_ref = nullptr;
        }
        inline app::ScalableAnimationPlayer_ScenarioPlaybackData__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace KeyValuePair_2_Moon_Timeline_UberShaderVectorAnimator_VectorProperty_System_String___Array {
        namespace {
            app::KeyValuePair_2_Moon_Timeline_UberShaderVectorAnimator_VectorProperty_System_String___Array__Class* type_info_ref = nullptr;
        }
        app::KeyValuePair_2_Moon_Timeline_UberShaderVectorAnimator_VectorProperty_System_String___Array__Class** type_info = &type_info_ref;

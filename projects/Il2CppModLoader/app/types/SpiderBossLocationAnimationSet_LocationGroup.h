...
namespace app::classes::types {
    namespace SpiderBossLocationAnimationSet_LocationGroup {
        namespace {
            inline app::SpiderBossLocationAnimationSet_LocationGroup__Class* type_info_ref = nullptr;
        }
        inline app::SpiderBossLocationAnimationSet_LocationGroup__Class** type_info = &type_info_ref;

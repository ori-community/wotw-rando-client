...
namespace app::classes::types {
    namespace KeyValuePair_2_System_Int32_BehaviourTreeEvaluationSystem_BehaviourTreeEvaluationEntry___Array {
        namespace {
            app::KeyValuePair_2_System_Int32_BehaviourTreeEvaluationSystem_BehaviourTreeEvaluationEntry___Array__Class* type_info_ref = nullptr;
        }
        app::KeyValuePair_2_System_Int32_BehaviourTreeEvaluationSystem_BehaviourTreeEvaluationEntry___Array__Class** type_info = &type_info_ref;

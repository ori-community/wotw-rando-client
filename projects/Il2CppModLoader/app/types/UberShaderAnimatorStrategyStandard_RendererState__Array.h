...
namespace app::classes::types {
    namespace UberShaderAnimatorStrategyStandard_RendererState__Array {
        namespace {
            app::UberShaderAnimatorStrategyStandard_RendererState__Array__Class* type_info_ref = nullptr;
        }
        app::UberShaderAnimatorStrategyStandard_RendererState__Array__Class** type_info = &type_info_ref;

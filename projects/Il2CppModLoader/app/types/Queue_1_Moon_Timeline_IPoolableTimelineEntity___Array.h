...
namespace app::classes::types {
    namespace Queue_1_Moon_Timeline_IPoolableTimelineEntity___Array {
        namespace {
            inline app::Queue_1_Moon_Timeline_IPoolableTimelineEntity___Array__Class* type_info_ref = nullptr;
        }
        inline app::Queue_1_Moon_Timeline_IPoolableTimelineEntity___Array__Class** type_info = &type_info_ref;

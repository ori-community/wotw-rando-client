...
namespace app::classes::types {
    namespace Queue_1_Moon_Timeline_IPoolableTimelineEntity___Array {
        namespace {
            app::Queue_1_Moon_Timeline_IPoolableTimelineEntity___Array__Class* type_info_ref = nullptr;
        }
        app::Queue_1_Moon_Timeline_IPoolableTimelineEntity___Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace MoonRenderPipelineView_GodRayBlurRT__Array {
        inline app::MoonRenderPipelineView_GodRayBlurRT__Array__Class** type_info = (app::MoonRenderPipelineView_GodRayBlurRT__Array__Class**)(modloader::win::memory::resolve_rva(0x04794EA8));

...
namespace app::classes::types {
    namespace WaterPoisonTrail_DamagePoint__Array {
        namespace {
            inline app::WaterPoisonTrail_DamagePoint__Array__Class* type_info_ref = nullptr;
        }
        inline app::WaterPoisonTrail_DamagePoint__Array__Class** type_info = &type_info_ref;

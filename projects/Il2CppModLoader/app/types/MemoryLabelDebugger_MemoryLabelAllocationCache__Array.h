...
namespace app::classes::types {
    namespace MemoryLabelDebugger_MemoryLabelAllocationCache__Array {
        namespace {
            app::MemoryLabelDebugger_MemoryLabelAllocationCache__Array__Class* type_info_ref = nullptr;
        }
        app::MemoryLabelDebugger_MemoryLabelAllocationCache__Array__Class** type_info = &type_info_ref;

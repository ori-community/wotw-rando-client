...
namespace app::classes::types {
    namespace DepthOfFieldDeprecated_Dof34QualitySetting__Enum {
        namespace {
            app::DepthOfFieldDeprecated_Dof34QualitySetting__Enum__Class* type_info_ref = nullptr;
        }
        app::DepthOfFieldDeprecated_Dof34QualitySetting__Enum__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace DtdParser_ParseElementOnlyContent_LocalFrame__Array {
        namespace {
            app::DtdParser_ParseElementOnlyContent_LocalFrame__Array__Class* type_info_ref = nullptr;
        }
        app::DtdParser_ParseElementOnlyContent_LocalFrame__Array__Class** type_info = &type_info_ref;

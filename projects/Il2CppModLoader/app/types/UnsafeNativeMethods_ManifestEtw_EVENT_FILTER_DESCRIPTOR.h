...
namespace app::classes::types {
    namespace UnsafeNativeMethods_ManifestEtw_EVENT_FILTER_DESCRIPTOR {
        namespace {
            app::UnsafeNativeMethods_ManifestEtw_EVENT_FILTER_DESCRIPTOR__Class* type_info_ref = nullptr;
        }
        app::UnsafeNativeMethods_ManifestEtw_EVENT_FILTER_DESCRIPTOR__Class** type_info = &type_info_ref;

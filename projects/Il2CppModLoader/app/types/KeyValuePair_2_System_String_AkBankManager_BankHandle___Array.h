...
namespace app::classes::types {
    namespace KeyValuePair_2_System_String_AkBankManager_BankHandle___Array {
        namespace {
            app::KeyValuePair_2_System_String_AkBankManager_BankHandle___Array__Class* type_info_ref = nullptr;
        }
        app::KeyValuePair_2_System_String_AkBankManager_BankHandle___Array__Class** type_info = &type_info_ref;

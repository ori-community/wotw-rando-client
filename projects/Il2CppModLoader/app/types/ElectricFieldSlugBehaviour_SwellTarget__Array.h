...
namespace app::classes::types {
    namespace ElectricFieldSlugBehaviour_SwellTarget__Array {
        namespace {
            app::ElectricFieldSlugBehaviour_SwellTarget__Array__Class* type_info_ref = nullptr;
        }
        app::ElectricFieldSlugBehaviour_SwellTarget__Array__Class** type_info = &type_info_ref;

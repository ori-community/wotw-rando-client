...
namespace app::classes::types {
    namespace VROverlayIntersectionMaskPrimitive_Data_t {
        namespace {
            app::VROverlayIntersectionMaskPrimitive_Data_t__Class* type_info_ref = nullptr;
        }
        app::VROverlayIntersectionMaskPrimitive_Data_t__Class** type_info = &type_info_ref;

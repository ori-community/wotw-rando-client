...
namespace app::classes::types {
    namespace MoonAnimator_LayeredInstance__Array {
        namespace {
            inline app::MoonAnimator_LayeredInstance__Array__Class* type_info_ref = nullptr;
        }
        inline app::MoonAnimator_LayeredInstance__Array__Class** type_info = &type_info_ref;

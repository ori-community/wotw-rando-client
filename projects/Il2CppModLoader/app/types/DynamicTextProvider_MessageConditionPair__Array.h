...
namespace app::classes::types {
    namespace DynamicTextProvider_MessageConditionPair__Array {
        namespace {
            app::DynamicTextProvider_MessageConditionPair__Array__Class* type_info_ref = nullptr;
        }
        app::DynamicTextProvider_MessageConditionPair__Array__Class** type_info = &type_info_ref;

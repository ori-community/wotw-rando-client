...
namespace app::classes::types {
    namespace DeltaTimeManager_InsertionMode__Enum {
        namespace {
            inline app::DeltaTimeManager_InsertionMode__Enum__Class* type_info_ref = nullptr;
        }
        inline app::DeltaTimeManager_InsertionMode__Enum__Class** type_info = &type_info_ref;

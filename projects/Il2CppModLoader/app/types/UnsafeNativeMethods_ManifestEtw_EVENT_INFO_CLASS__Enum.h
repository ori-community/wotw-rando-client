...
namespace app::classes::types {
    namespace UnsafeNativeMethods_ManifestEtw_EVENT_INFO_CLASS__Enum {
        namespace {
            inline app::UnsafeNativeMethods_ManifestEtw_EVENT_INFO_CLASS__Enum__Class* type_info_ref = nullptr;
        }
        inline app::UnsafeNativeMethods_ManifestEtw_EVENT_INFO_CLASS__Enum__Class** type_info = &type_info_ref;

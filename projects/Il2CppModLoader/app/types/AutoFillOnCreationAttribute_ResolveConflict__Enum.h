...
namespace app::classes::types {
    namespace AutoFillOnCreationAttribute_ResolveConflict__Enum {
        namespace {
            app::AutoFillOnCreationAttribute_ResolveConflict__Enum__Class* type_info_ref = nullptr;
        }
        app::AutoFillOnCreationAttribute_ResolveConflict__Enum__Class** type_info = &type_info_ref;

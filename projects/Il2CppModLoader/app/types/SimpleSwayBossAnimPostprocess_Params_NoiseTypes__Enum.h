...
namespace app::classes::types {
    namespace SimpleSwayBossAnimPostprocess_Params_NoiseTypes__Enum {
        namespace {
            app::SimpleSwayBossAnimPostprocess_Params_NoiseTypes__Enum__Class* type_info_ref = nullptr;
        }
        app::SimpleSwayBossAnimPostprocess_Params_NoiseTypes__Enum__Class** type_info = &type_info_ref;

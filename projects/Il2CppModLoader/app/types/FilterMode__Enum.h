...
namespace app::classes::types {
    namespace FilterMode__Enum {
        namespace {
            app::FilterMode__Enum__Class* type_info_ref = nullptr;
        }
        app::FilterMode__Enum__Class** type_info = &type_info_ref;
        ...
        inline app::FilterMode__Enum__Array* create_array(const std::vector<app::FilterMode__Enum__Boxed*>& items) {

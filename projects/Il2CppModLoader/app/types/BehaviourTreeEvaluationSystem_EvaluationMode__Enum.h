...
namespace app::classes::types {
    namespace BehaviourTreeEvaluationSystem_EvaluationMode__Enum {
        ...
        inline app::BehaviourTreeEvaluationSystem_EvaluationMode__Enum__Array* create_array(const std::vector<app::BehaviourTreeEvaluationSystem_EvaluationMode__Enum__Boxed*>& items) {

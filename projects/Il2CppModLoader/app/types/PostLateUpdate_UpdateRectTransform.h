...
namespace app::classes::types {
    namespace PostLateUpdate_UpdateRectTransform {
        namespace {
            inline app::PostLateUpdate_UpdateRectTransform__Class* type_info_ref = nullptr;
        }
        inline app::PostLateUpdate_UpdateRectTransform__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace XUserGetTokenAndSignatureUtf16Data {
        inline app::XUserGetTokenAndSignatureUtf16Data__Class** type_info = (app::XUserGetTokenAndSignatureUtf16Data__Class**)(modloader::win::memory::resolve_rva(0x04787E20));

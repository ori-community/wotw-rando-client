...
namespace app::classes::types {
    namespace YouCanLeaveYourHatOn_AssetWithSize__Array {
        namespace {
            app::YouCanLeaveYourHatOn_AssetWithSize__Array__Class* type_info_ref = nullptr;
        }
        app::YouCanLeaveYourHatOn_AssetWithSize__Array__Class** type_info = &type_info_ref;

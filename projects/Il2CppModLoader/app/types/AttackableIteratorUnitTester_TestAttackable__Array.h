...
namespace app::classes::types {
    namespace AttackableIteratorUnitTester_TestAttackable__Array {
        namespace {
            app::AttackableIteratorUnitTester_TestAttackable__Array__Class* type_info_ref = nullptr;
        }
        app::AttackableIteratorUnitTester_TestAttackable__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace KwolokTongueStatue_KwolowTongueStatueState__Enum {
        namespace {
            inline app::KwolokTongueStatue_KwolowTongueStatueState__Enum__Class* type_info_ref = nullptr;
        }
        inline app::KwolokTongueStatue_KwolowTongueStatueState__Enum__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace EquipmentRadialSelection_RadialItemVisual__Array {
        namespace {
            app::EquipmentRadialSelection_RadialItemVisual__Array__Class* type_info_ref = nullptr;
        }
        app::EquipmentRadialSelection_RadialItemVisual__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace PointerEventData_InputButton__Enum {
        namespace {
            inline app::PointerEventData_InputButton__Enum__Class* type_info_ref = nullptr;
        }
        inline app::PointerEventData_InputButton__Enum__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace ConcurrentDictionary_2_TKey_TValue_Node_System_Type_System_Type___Array {
        namespace {
            app::ConcurrentDictionary_2_TKey_TValue_Node_System_Type_System_Type___Array__Class* type_info_ref = nullptr;
        }
        app::ConcurrentDictionary_2_TKey_TValue_Node_System_Type_System_Type___Array__Class** type_info = &type_info_ref;

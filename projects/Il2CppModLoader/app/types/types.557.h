...
enum class MeleeComboMoveHammer_State__Enum : int32_t {
    None = 0x00000000,
    Prepare = 0x00000001,
    Charge = 0x00000002,
    Attack = 0x00000003,
    GroundMiss = 0x00000004,
    GroundHit = 0x00000005,
};
...
struct MeleeWeaponHammer_DisolveState__Enum__Boxed {
    struct MeleeWeaponHammer_DisolveState__Enum__Class *klass;
    MonitorData *monitor;
    MeleeWeaponHammer_DisolveState__Enum value;
...
enum class SeinGrabSurface_AnimationState__Enum : int32_t {
    None = 0x00000000,
    Climb = 0x00000001,
    GrabWallDown = 0x00000002,
    GrabWallIdle = 0x00000003,
    GrabGroundIdle = 0x00000004,
    GrabGroundMove = 0x00000005,
};

struct SeinGrabSurface_AnimationState__Enum__Boxed {
    struct SeinGrabSurface_AnimationState__Enum__Class *klass;
    MonitorData *monitor;
    SeinGrabSurface_AnimationState__Enum value;

...
namespace app::classes::types {
    namespace LegacyTransparencyAnimator_RendererData__Array {
        namespace {
            app::LegacyTransparencyAnimator_RendererData__Array__Class* type_info_ref = nullptr;
        }
        app::LegacyTransparencyAnimator_RendererData__Array__Class** type_info = &type_info_ref;

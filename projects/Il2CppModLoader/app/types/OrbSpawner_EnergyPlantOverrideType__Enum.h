...
namespace app::classes::types {
    namespace OrbSpawner_EnergyPlantOverrideType__Enum {
        namespace {
            inline app::OrbSpawner_EnergyPlantOverrideType__Enum__Class* type_info_ref = nullptr;
        }
        inline app::OrbSpawner_EnergyPlantOverrideType__Enum__Class** type_info = &type_info_ref;

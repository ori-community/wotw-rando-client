...
namespace app::classes::types {
    namespace MoonReference_1_Moon_BehaviourSystem_ITask___Array {
        namespace {
            app::MoonReference_1_Moon_BehaviourSystem_ITask___Array__Class* type_info_ref = nullptr;
        }
        app::MoonReference_1_Moon_BehaviourSystem_ITask___Array__Class** type_info = &type_info_ref;

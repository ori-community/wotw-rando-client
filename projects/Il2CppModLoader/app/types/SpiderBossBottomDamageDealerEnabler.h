...
namespace app::classes::types {
    namespace SpiderBossBottomDamageDealerEnabler {
        namespace {
            inline app::SpiderBossBottomDamageDealerEnabler__Class* type_info_ref = nullptr;
        }
        inline app::SpiderBossBottomDamageDealerEnabler__Class** type_info = &type_info_ref;

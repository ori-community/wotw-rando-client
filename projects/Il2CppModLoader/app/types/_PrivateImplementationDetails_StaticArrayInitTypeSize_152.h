...
namespace app::classes::types {
    namespace _PrivateImplementationDetails_StaticArrayInitTypeSize_152 {
        namespace {
            app::_PrivateImplementationDetails_StaticArrayInitTypeSize_152__Class* type_info_ref = nullptr;
        }
        app::_PrivateImplementationDetails_StaticArrayInitTypeSize_152__Class** type_info = &type_info_ref;

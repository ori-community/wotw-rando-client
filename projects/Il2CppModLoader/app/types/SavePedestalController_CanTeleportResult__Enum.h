...
namespace app::classes::types {
    namespace SavePedestalController_CanTeleportResult__Enum {
        namespace {
            app::SavePedestalController_CanTeleportResult__Enum__Class* type_info_ref = nullptr;
        }
        app::SavePedestalController_CanTeleportResult__Enum__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace MoonRenderPipelineView_SrpProfilerFrame_Slice__Array {
        namespace {
            app::MoonRenderPipelineView_SrpProfilerFrame_Slice__Array__Class* type_info_ref = nullptr;
        }
        app::MoonRenderPipelineView_SrpProfilerFrame_Slice__Array__Class** type_info = &type_info_ref;

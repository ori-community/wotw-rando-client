...
namespace app::classes::types {
    namespace XmlTextReaderImpl_IncrementalReadState__Enum {
        namespace {
            app::XmlTextReaderImpl_IncrementalReadState__Enum__Class* type_info_ref = nullptr;
        }
        app::XmlTextReaderImpl_IncrementalReadState__Enum__Class** type_info = &type_info_ref;

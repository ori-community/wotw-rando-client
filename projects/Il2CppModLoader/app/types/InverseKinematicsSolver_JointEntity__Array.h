...
namespace app::classes::types {
    namespace InverseKinematicsSolver_JointEntity__Array {
        namespace {
            app::InverseKinematicsSolver_JointEntity__Array__Class* type_info_ref = nullptr;
        }
        app::InverseKinematicsSolver_JointEntity__Array__Class** type_info = &type_info_ref;

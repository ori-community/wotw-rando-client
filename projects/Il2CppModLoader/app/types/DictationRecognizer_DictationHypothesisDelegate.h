...
namespace app::classes::types {
    namespace DictationRecognizer_DictationHypothesisDelegate {
        namespace {
            app::DictationRecognizer_DictationHypothesisDelegate__Class* type_info_ref = nullptr;
        }
        app::DictationRecognizer_DictationHypothesisDelegate__Class** type_info = &type_info_ref;

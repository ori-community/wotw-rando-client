...
namespace app::classes::types {
    namespace CrossSceneDependencyInjector_ObjectReference__Array {
        namespace {
            inline app::CrossSceneDependencyInjector_ObjectReference__Array__Class* type_info_ref = nullptr;
        }
        inline app::CrossSceneDependencyInjector_ObjectReference__Array__Class** type_info = &type_info_ref;

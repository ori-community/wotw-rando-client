...
namespace app::classes::types {
    namespace KeyValuePair_2_System_Int32_TriangleNet_Voronoi_Legacy_VoronoiRegion___Array {
        namespace {
            inline app::KeyValuePair_2_System_Int32_TriangleNet_Voronoi_Legacy_VoronoiRegion___Array__Class* type_info_ref = nullptr;
        }
        inline app::KeyValuePair_2_System_Int32_TriangleNet_Voronoi_Legacy_VoronoiRegion___Array__Class** type_info = &type_info_ref;

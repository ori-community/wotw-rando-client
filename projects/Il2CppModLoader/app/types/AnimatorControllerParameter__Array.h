...
namespace app::classes::types {
    namespace AnimatorControllerParameter__Array {
        namespace {
            inline app::AnimatorControllerParameter__Array__Class* type_info_ref = nullptr;
        }
        inline app::AnimatorControllerParameter__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace AbilitiesPlugin_FieldInfoCollection__Array {
        namespace {
            app::AbilitiesPlugin_FieldInfoCollection__Array__Class* type_info_ref = nullptr;
        }
        app::AbilitiesPlugin_FieldInfoCollection__Array__Class** type_info = &type_info_ref;

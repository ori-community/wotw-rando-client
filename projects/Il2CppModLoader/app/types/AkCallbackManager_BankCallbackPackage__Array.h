...
namespace app::classes::types {
    namespace AkCallbackManager_BankCallbackPackage__Array {
        namespace {
            inline app::AkCallbackManager_BankCallbackPackage__Array__Class* type_info_ref = nullptr;
        }
        inline app::AkCallbackManager_BankCallbackPackage__Array__Class** type_info = &type_info_ref;

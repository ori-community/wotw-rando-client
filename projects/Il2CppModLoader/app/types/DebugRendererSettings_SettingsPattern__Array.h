...
namespace app::classes::types {
    namespace DebugRendererSettings_SettingsPattern__Array {
        namespace {
            app::DebugRendererSettings_SettingsPattern__Array__Class* type_info_ref = nullptr;
        }
        app::DebugRendererSettings_SettingsPattern__Array__Class** type_info = &type_info_ref;

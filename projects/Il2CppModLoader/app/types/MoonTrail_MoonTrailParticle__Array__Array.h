...
namespace app::classes::types {
    namespace MoonTrail_MoonTrailParticle__Array__Array {
        namespace {
            app::MoonTrail_MoonTrailParticle__Array__Array__Class* type_info_ref = nullptr;
        }
        app::MoonTrail_MoonTrailParticle__Array__Array__Class** type_info = &type_info_ref;

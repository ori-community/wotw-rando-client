...
namespace app::classes::types {
    namespace SeinAbilityRestrictZone_LerpedHorizontalMovementSetting {
        namespace {
            app::SeinAbilityRestrictZone_LerpedHorizontalMovementSetting__Class* type_info_ref = nullptr;
        }
        app::SeinAbilityRestrictZone_LerpedHorizontalMovementSetting__Class** type_info = &type_info_ref;

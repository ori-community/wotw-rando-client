...
namespace app::classes::types {
    namespace LizardMeleeAttackBehaviour_AttackType__Enum {
        namespace {
            app::LizardMeleeAttackBehaviour_AttackType__Enum__Class* type_info_ref = nullptr;
        }
        app::LizardMeleeAttackBehaviour_AttackType__Enum__Class** type_info = &type_info_ref;

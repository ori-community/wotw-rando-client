...
namespace app::classes::types {
    namespace DisableGameObjectWithHealthWhenOutOfFrustum {
        namespace {
            inline app::DisableGameObjectWithHealthWhenOutOfFrustum__Class* type_info_ref = nullptr;
        }
        inline app::DisableGameObjectWithHealthWhenOutOfFrustum__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace UberShaderAnimatorStrategyStandard_Request_1_System_Object___Array {
        namespace {
            app::UberShaderAnimatorStrategyStandard_Request_1_System_Object___Array__Class* type_info_ref = nullptr;
        }
        app::UberShaderAnimatorStrategyStandard_Request_1_System_Object___Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace TerrainUtility_TerrainMap_ErrorCode__Enum {
        namespace {
            app::TerrainUtility_TerrainMap_ErrorCode__Enum__Class* type_info_ref = nullptr;
        }
        app::TerrainUtility_TerrainMap_ErrorCode__Enum__Class** type_info = &type_info_ref;

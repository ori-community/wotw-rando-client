...
namespace app::classes::types {
    namespace MeleeAttackTimelineBehaviourNew_c_DisplayClass46_0 {
        inline app::MeleeAttackTimelineBehaviourNew_c_DisplayClass46_0__Class** type_info = (app::MeleeAttackTimelineBehaviourNew_c_DisplayClass46_0__Class**)(modloader::win::memory::resolve_rva(0x04792E20));

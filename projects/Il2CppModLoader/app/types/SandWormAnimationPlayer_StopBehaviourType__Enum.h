...
namespace app::classes::types {
    namespace SandWormAnimationPlayer_StopBehaviourType__Enum {
        namespace {
            app::SandWormAnimationPlayer_StopBehaviourType__Enum__Class* type_info_ref = nullptr;
        }
        app::SandWormAnimationPlayer_StopBehaviourType__Enum__Class** type_info = &type_info_ref;

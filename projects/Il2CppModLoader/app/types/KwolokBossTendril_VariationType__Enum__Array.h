...
namespace app::classes::types {
    namespace KwolokBossTendril_VariationType__Enum__Array {
        namespace {
            inline app::KwolokBossTendril_VariationType__Enum__Array__Class* type_info_ref = nullptr;
        }
        inline app::KwolokBossTendril_VariationType__Enum__Array__Class** type_info = &type_info_ref;

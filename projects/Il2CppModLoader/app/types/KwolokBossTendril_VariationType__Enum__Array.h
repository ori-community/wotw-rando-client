...
namespace app::classes::types {
    namespace KwolokBossTendril_VariationType__Enum__Array {
        namespace {
            app::KwolokBossTendril_VariationType__Enum__Array__Class* type_info_ref = nullptr;
        }
        app::KwolokBossTendril_VariationType__Enum__Array__Class** type_info = &type_info_ref;

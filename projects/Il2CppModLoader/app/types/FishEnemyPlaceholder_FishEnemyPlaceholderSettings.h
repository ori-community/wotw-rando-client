...
namespace app::classes::types {
    namespace FishEnemyPlaceholder_FishEnemyPlaceholderSettings {
        namespace {
            app::FishEnemyPlaceholder_FishEnemyPlaceholderSettings__Class* type_info_ref = nullptr;
        }
        app::FishEnemyPlaceholder_FishEnemyPlaceholderSettings__Class** type_info = &type_info_ref;

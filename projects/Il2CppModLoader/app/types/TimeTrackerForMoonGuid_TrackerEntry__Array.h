...
namespace app::classes::types {
    namespace TimeTrackerForMoonGuid_TrackerEntry__Array {
        namespace {
            app::TimeTrackerForMoonGuid_TrackerEntry__Array__Class* type_info_ref = nullptr;
        }
        app::TimeTrackerForMoonGuid_TrackerEntry__Array__Class** type_info = &type_info_ref;

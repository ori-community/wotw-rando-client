...
namespace app::classes::types {
    namespace HashSet_1_T_Slot_UnityEngine_Collider___Array {
        namespace {
            app::HashSet_1_T_Slot_UnityEngine_Collider___Array__Class* type_info_ref = nullptr;
        }
        app::HashSet_1_T_Slot_UnityEngine_Collider___Array__Class** type_info = &type_info_ref;

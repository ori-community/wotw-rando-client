...
namespace app::classes::types {
    namespace LegacyTimelineSequence_SequenceEntry__Array {
        namespace {
            app::LegacyTimelineSequence_SequenceEntry__Array__Class* type_info_ref = nullptr;
        }
        app::LegacyTimelineSequence_SequenceEntry__Array__Class** type_info = &type_info_ref;

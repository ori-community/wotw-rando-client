...
namespace app::classes::types {
    namespace MovingPlatformController_ProjectedObjectEntry__Array {
        namespace {
            inline app::MovingPlatformController_ProjectedObjectEntry__Array__Class* type_info_ref = nullptr;
        }
        inline app::MovingPlatformController_ProjectedObjectEntry__Array__Class** type_info = &type_info_ref;

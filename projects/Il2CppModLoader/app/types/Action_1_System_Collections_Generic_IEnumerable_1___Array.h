...
namespace app::classes::types {
    namespace Action_1_System_Collections_Generic_IEnumerable_1___Array {
        namespace {
            app::Action_1_System_Collections_Generic_IEnumerable_1___Array__Class* type_info_ref = nullptr;
        }
        app::Action_1_System_Collections_Generic_IEnumerable_1___Array__Class** type_info = &type_info_ref;

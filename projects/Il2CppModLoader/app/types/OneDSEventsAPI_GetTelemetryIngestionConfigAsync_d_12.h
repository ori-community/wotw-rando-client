...
namespace app::classes::types {
    namespace OneDSEventsAPI_GetTelemetryIngestionConfigAsync_d_12 {
        namespace {
            app::OneDSEventsAPI_GetTelemetryIngestionConfigAsync_d_12__Class* type_info_ref = nullptr;
        }
        app::OneDSEventsAPI_GetTelemetryIngestionConfigAsync_d_12__Class** type_info = &type_info_ref;

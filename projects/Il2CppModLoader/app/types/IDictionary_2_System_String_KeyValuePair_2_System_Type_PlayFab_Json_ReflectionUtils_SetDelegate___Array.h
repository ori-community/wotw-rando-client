...
namespace app::classes::types {
    namespace IDictionary_2_System_String_KeyValuePair_2_System_Type_PlayFab_Json_ReflectionUtils_SetDelegate___Array {
        namespace {
            app::IDictionary_2_System_String_KeyValuePair_2_System_Type_PlayFab_Json_ReflectionUtils_SetDelegate___Array__Class* type_info_ref = nullptr;
        }
        app::IDictionary_2_System_String_KeyValuePair_2_System_Type_PlayFab_Json_ReflectionUtils_SetDelegate___Array__Class** type_info = &type_info_ref;

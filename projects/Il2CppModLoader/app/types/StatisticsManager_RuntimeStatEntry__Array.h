...
namespace app::classes::types {
    namespace StatisticsManager_RuntimeStatEntry__Array {
        namespace {
            app::StatisticsManager_RuntimeStatEntry__Array__Class* type_info_ref = nullptr;
        }
        app::StatisticsManager_RuntimeStatEntry__Array__Class** type_info = &type_info_ref;

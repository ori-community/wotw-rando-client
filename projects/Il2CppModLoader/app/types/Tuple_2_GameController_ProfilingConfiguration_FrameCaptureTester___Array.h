...
namespace app::classes::types {
    namespace Tuple_2_GameController_ProfilingConfiguration_FrameCaptureTester___Array {
        namespace {
            app::Tuple_2_GameController_ProfilingConfiguration_FrameCaptureTester___Array__Class* type_info_ref = nullptr;
        }
        app::Tuple_2_GameController_ProfilingConfiguration_FrameCaptureTester___Array__Class** type_info = &type_info_ref;

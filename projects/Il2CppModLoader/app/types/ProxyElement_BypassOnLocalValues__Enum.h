...
namespace app::classes::types {
    namespace ProxyElement_BypassOnLocalValues__Enum {
        namespace {
            inline app::ProxyElement_BypassOnLocalValues__Enum__Class* type_info_ref = nullptr;
        }
        inline app::ProxyElement_BypassOnLocalValues__Enum__Class** type_info = &type_info_ref;

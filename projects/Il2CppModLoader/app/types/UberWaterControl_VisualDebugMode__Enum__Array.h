...
namespace app::classes::types {
    namespace UberWaterControl_VisualDebugMode__Enum__Array {
        namespace {
            app::UberWaterControl_VisualDebugMode__Enum__Array__Class* type_info_ref = nullptr;
        }
        app::UberWaterControl_VisualDebugMode__Enum__Array__Class** type_info = &type_info_ref;

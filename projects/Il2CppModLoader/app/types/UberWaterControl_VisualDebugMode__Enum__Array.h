...
namespace app::classes::types {
    namespace UberWaterControl_VisualDebugMode__Enum__Array {
        namespace {
            inline app::UberWaterControl_VisualDebugMode__Enum__Array__Class* type_info_ref = nullptr;
        }
        inline app::UberWaterControl_VisualDebugMode__Enum__Array__Class** type_info = &type_info_ref;

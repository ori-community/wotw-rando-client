...
namespace app::classes::types {
    namespace IVRChaperoneSetup_GetLiveSeatedZeroPoseToRawTrackingPose {
        inline app::IVRChaperoneSetup_GetLiveSeatedZeroPoseToRawTrackingPose__Class** type_info = (app::IVRChaperoneSetup_GetLiveSeatedZeroPoseToRawTrackingPose__Class**)(modloader::win::memory::resolve_rva(0x0476B110));

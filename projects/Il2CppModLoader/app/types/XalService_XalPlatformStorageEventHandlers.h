...
namespace app::classes::types {
    namespace XalService_XalPlatformStorageEventHandlers {
        namespace {
            app::XalService_XalPlatformStorageEventHandlers__Class* type_info_ref = nullptr;
        }
        app::XalService_XalPlatformStorageEventHandlers__Class** type_info = &type_info_ref;

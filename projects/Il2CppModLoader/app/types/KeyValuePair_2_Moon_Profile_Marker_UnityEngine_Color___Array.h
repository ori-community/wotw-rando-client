...
namespace app::classes::types {
    namespace KeyValuePair_2_Moon_Profile_Marker_UnityEngine_Color___Array {
        namespace {
            inline app::KeyValuePair_2_Moon_Profile_Marker_UnityEngine_Color___Array__Class* type_info_ref = nullptr;
        }
        inline app::KeyValuePair_2_Moon_Profile_Marker_UnityEngine_Color___Array__Class** type_info = &type_info_ref;

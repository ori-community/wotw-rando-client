...
namespace app::classes::types {
    namespace AkAudioInputManager_AudioSamplesDelegate__Array {
        namespace {
            app::AkAudioInputManager_AudioSamplesDelegate__Array__Class* type_info_ref = nullptr;
        }
        app::AkAudioInputManager_AudioSamplesDelegate__Array__Class** type_info = &type_info_ref;

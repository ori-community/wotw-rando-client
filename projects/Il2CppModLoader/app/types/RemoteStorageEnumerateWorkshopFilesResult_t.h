...
namespace app::classes::types {
    namespace RemoteStorageEnumerateWorkshopFilesResult_t {
        namespace {
            inline app::RemoteStorageEnumerateWorkshopFilesResult_t__Class* type_info_ref = nullptr;
        }
        inline app::RemoteStorageEnumerateWorkshopFilesResult_t__Class** type_info = &type_info_ref;

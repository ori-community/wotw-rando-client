...
namespace app::classes::types {
    namespace MemoryManagerDebugger_MemoryManagerAllocatorCache__Array {
        namespace {
            app::MemoryManagerDebugger_MemoryManagerAllocatorCache__Array__Class* type_info_ref = nullptr;
        }
        app::MemoryManagerDebugger_MemoryManagerAllocatorCache__Array__Class** type_info = &type_info_ref;

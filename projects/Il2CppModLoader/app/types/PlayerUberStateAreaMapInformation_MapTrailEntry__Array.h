...
namespace app::classes::types {
    namespace PlayerUberStateAreaMapInformation_MapTrailEntry__Array {
        namespace {
            app::PlayerUberStateAreaMapInformation_MapTrailEntry__Array__Class* type_info_ref = nullptr;
        }
        app::PlayerUberStateAreaMapInformation_MapTrailEntry__Array__Class** type_info = &type_info_ref;

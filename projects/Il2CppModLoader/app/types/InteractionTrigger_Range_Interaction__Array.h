...
namespace app::classes::types {
    namespace InteractionTrigger_Range_Interaction__Array {
        namespace {
            app::InteractionTrigger_Range_Interaction__Array__Class* type_info_ref = nullptr;
        }
        app::InteractionTrigger_Range_Interaction__Array__Class** type_info = &type_info_ref;

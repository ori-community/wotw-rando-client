...
namespace app::classes::types {
    namespace RigidbodyInteractionController_InstanciationPositionModes__Enum {
        namespace {
            app::RigidbodyInteractionController_InstanciationPositionModes__Enum__Class* type_info_ref = nullptr;
        }
        app::RigidbodyInteractionController_InstanciationPositionModes__Enum__Class** type_info = &type_info_ref;

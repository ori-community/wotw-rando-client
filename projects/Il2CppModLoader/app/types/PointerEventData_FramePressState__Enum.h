...
namespace app::classes::types {
    namespace PointerEventData_FramePressState__Enum {
        namespace {
            inline app::PointerEventData_FramePressState__Enum__Class* type_info_ref = nullptr;
        }
        inline app::PointerEventData_FramePressState__Enum__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace RendererCullingCategoryResults_Slice__Array {
        namespace {
            app::RendererCullingCategoryResults_Slice__Array__Class* type_info_ref = nullptr;
        }
        app::RendererCullingCategoryResults_Slice__Array__Class** type_info = &type_info_ref;

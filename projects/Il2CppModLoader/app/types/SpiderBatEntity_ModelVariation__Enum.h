...
namespace app::classes::types {
    namespace SpiderBatEntity_ModelVariation__Enum {
        namespace {
            inline app::SpiderBatEntity_ModelVariation__Enum__Class* type_info_ref = nullptr;
        }
        inline app::SpiderBatEntity_ModelVariation__Enum__Class** type_info = &type_info_ref;

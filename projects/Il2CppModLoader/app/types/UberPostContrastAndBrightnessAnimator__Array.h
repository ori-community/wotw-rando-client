...
namespace app::classes::types {
    namespace UberPostContrastAndBrightnessAnimator__Array {
        namespace {
            app::UberPostContrastAndBrightnessAnimator__Array__Class* type_info_ref = nullptr;
        }
        app::UberPostContrastAndBrightnessAnimator__Array__Class** type_info = &type_info_ref;

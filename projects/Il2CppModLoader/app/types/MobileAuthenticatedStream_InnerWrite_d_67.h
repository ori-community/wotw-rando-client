...
namespace app::classes::types {
    namespace MobileAuthenticatedStream_InnerWrite_d_67 {
        namespace {
            app::MobileAuthenticatedStream_InnerWrite_d_67__Class* type_info_ref = nullptr;
        }
        app::MobileAuthenticatedStream_InnerWrite_d_67__Class** type_info = &type_info_ref;

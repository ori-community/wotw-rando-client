...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_Film_ColorPerfection {
        inline app::ShaderID_CameraFilterPack_Film_ColorPerfection__Class** type_info = (app::ShaderID_CameraFilterPack_Film_ColorPerfection__Class**)(modloader::win::memory::resolve_rva(0x04766888));

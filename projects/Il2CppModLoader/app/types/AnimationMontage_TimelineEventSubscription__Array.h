...
namespace app::classes::types {
    namespace AnimationMontage_TimelineEventSubscription__Array {
        namespace {
            app::AnimationMontage_TimelineEventSubscription__Array__Class* type_info_ref = nullptr;
        }
        app::AnimationMontage_TimelineEventSubscription__Array__Class** type_info = &type_info_ref;

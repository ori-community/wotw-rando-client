...
namespace app::classes::types {
    namespace GroundPatrolWithDirectionTask_GroundPatrolMode__Enum {
        namespace {
            app::GroundPatrolWithDirectionTask_GroundPatrolMode__Enum__Class* type_info_ref = nullptr;
        }
        app::GroundPatrolWithDirectionTask_GroundPatrolMode__Enum__Class** type_info = &type_info_ref;

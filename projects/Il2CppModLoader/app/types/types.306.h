...
enum class SerializationFormat__Enum_1 : int32_t {
    Xml = 0x00000000,
    Binary = 0x00000001,
};

struct SerializationFormat__Enum_1__Boxed {
    struct SerializationFormat__Enum_1__Class *klass;
    MonitorData *monitor;
    SerializationFormat__Enum_1 value;
...
struct DataViewRowState__Enum__Boxed {
    struct DataViewRowState__Enum__Class *klass;
    MonitorData *monitor;
    DataViewRowState__Enum value;
...
enum class StorageType__Enum : int32_t {
    Empty = 0x00000000,
    Object = 0x00000001,
    DBNull = 0x00000002,
    Boolean = 0x00000003,
    ...
    String = 0x00000012,
    Guid = 0x00000013,
    ByteArray = 0x00000014,
    CharArray = 0x00000015,
    Type = 0x00000016,
    DateTimeOffset = 0x00000017,
    BigInteger = 0x00000018,
    Uri = 0x00000019,
    SqlBinary = 0x0000001a,
    SqlBoolean = 0x0000001b,
    SqlByte = 0x0000001c,
    SqlBytes = 0x0000001d,
    SqlChars = 0x0000001e,
    SqlDateTime = 0x0000001f,
    SqlDecimal = 0x00000020,
    SqlDouble = 0x00000021,
    SqlGuid = 0x00000022,
    SqlInt16 = 0x00000023,
    SqlInt32 = 0x00000024,
    SqlInt64 = 0x00000025,
    SqlMoney = 0x00000026,
    SqlSingle = 0x00000027,
    SqlString = 0x00000028,
};

struct StorageType__Enum__Boxed {
    struct StorageType__Enum__Class *klass;
    MonitorData *monitor;
    StorageType__Enum value;
    
};

enum class DataSetDateTime__Enum : int32_t {
    Local = 0x00000001,
    Unspecified = 0x00000002,
    UnspecifiedLocal = 0x00000003,
    Utc = 0x00000004,
};

struct DataSetDateTime__Enum__Boxed {
    struct DataSetDateTime__Enum__Class *klass;
    MonitorData *monitor;
    DataSetDateTime__Enum value;
...
struct MappingType__Enum__Boxed {
    struct MappingType__Enum__Class *klass;
    MonitorData *monitor;
    MappingType__Enum value;
...
struct Aggregate__Enum__Boxed {
    struct Aggregate__Enum__Class *klass;
    MonitorData *monitor;
    Aggregate__Enum value;
...
struct DataRowAction__Enum__Boxed {
    struct DataRowAction__Enum__Class *klass;
    MonitorData *monitor;
    DataRowAction__Enum value;

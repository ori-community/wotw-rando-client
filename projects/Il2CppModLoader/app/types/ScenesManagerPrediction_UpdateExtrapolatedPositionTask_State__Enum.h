...
namespace app::classes::types {
    namespace ScenesManagerPrediction_UpdateExtrapolatedPositionTask_State__Enum {
        namespace {
            app::ScenesManagerPrediction_UpdateExtrapolatedPositionTask_State__Enum__Class* type_info_ref = nullptr;
        }
        app::ScenesManagerPrediction_UpdateExtrapolatedPositionTask_State__Enum__Class** type_info = &type_info_ref;

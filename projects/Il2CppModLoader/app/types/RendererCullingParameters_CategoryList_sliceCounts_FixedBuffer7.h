...
namespace app::classes::types {
    namespace RendererCullingParameters_CategoryList_sliceCounts_FixedBuffer7 {
        namespace {
            app::RendererCullingParameters_CategoryList_sliceCounts_FixedBuffer7__Class* type_info_ref = nullptr;
        }
        app::RendererCullingParameters_CategoryList_sliceCounts_FixedBuffer7__Class** type_info = &type_info_ref;

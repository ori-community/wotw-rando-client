...
namespace app::classes::types {
    namespace SynchronizationContextProperties__Enum {
        namespace {
            inline app::SynchronizationContextProperties__Enum__Class* type_info_ref = nullptr;
        }
        inline app::SynchronizationContextProperties__Enum__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace RenderBufferStoreAction__Enum__Array {
        namespace {
            inline app::RenderBufferStoreAction__Enum__Array__Class* type_info_ref = nullptr;
        }
        inline app::RenderBufferStoreAction__Enum__Array__Class** type_info = &type_info_ref;

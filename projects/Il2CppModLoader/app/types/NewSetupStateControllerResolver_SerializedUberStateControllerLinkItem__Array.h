...
namespace app::classes::types {
    namespace NewSetupStateControllerResolver_SerializedUberStateControllerLinkItem__Array {
        namespace {
            app::NewSetupStateControllerResolver_SerializedUberStateControllerLinkItem__Array__Class* type_info_ref = nullptr;
        }
        app::NewSetupStateControllerResolver_SerializedUberStateControllerLinkItem__Array__Class** type_info = &type_info_ref;

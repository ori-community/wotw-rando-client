...
namespace app::classes::types {
    namespace RigidbodyInteractionController_InstanciationInteractionSettings {
        namespace {
            app::RigidbodyInteractionController_InstanciationInteractionSettings__Class* type_info_ref = nullptr;
        }
        app::RigidbodyInteractionController_InstanciationInteractionSettings__Class** type_info = &type_info_ref;

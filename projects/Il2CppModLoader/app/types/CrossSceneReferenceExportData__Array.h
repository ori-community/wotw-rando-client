...
namespace app::classes::types {
    namespace CrossSceneReferenceExportData__Array {
        namespace {
            inline app::CrossSceneReferenceExportData__Array__Class* type_info_ref = nullptr;
        }
        inline app::CrossSceneReferenceExportData__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace CinematicEntityAnimator_TargetModes__Enum {
        namespace {
            app::CinematicEntityAnimator_TargetModes__Enum__Class* type_info_ref = nullptr;
        }
        app::CinematicEntityAnimator_TargetModes__Enum__Class** type_info = &type_info_ref;

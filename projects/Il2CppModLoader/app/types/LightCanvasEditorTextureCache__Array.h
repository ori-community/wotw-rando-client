...
namespace app::classes::types {
    namespace LightCanvasEditorTextureCache__Array {
        namespace {
            inline app::LightCanvasEditorTextureCache__Array__Class* type_info_ref = nullptr;
        }
        inline app::LightCanvasEditorTextureCache__Array__Class** type_info = &type_info_ref;

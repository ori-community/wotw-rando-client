...
namespace app::classes::types {
    namespace MoonRenderPipelineAsset_GodRaySampleCount__Enum {
        namespace {
            app::MoonRenderPipelineAsset_GodRaySampleCount__Enum__Class* type_info_ref = nullptr;
        }
        app::MoonRenderPipelineAsset_GodRaySampleCount__Enum__Class** type_info = &type_info_ref;

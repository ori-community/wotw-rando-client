...
struct JsonBuilder__Array__VTable {
};

struct JsonBuilder__Array__StaticFields {
};

struct JsonBuilder__Array__Class {
    Il2CppClass_0 _0;
    Il2CppRuntimeInterfaceOffsetPair *interfaceOffsets;
    struct JsonBuilder__Array__StaticFields *static_fields;
    const Il2CppRGCTXData *rgctx_data;
    Il2CppClass_1 _1;
    struct JsonBuilder__Array__VTable vtable;
};
...
struct JsonParser__Array__VTable {
};

struct JsonParser__Array__StaticFields {
};

struct JsonParser__Array__Class {
    Il2CppClass_0 _0;
    Il2CppRuntimeInterfaceOffsetPair *interfaceOffsets;
    struct JsonParser__Array__StaticFields *static_fields;
    const Il2CppRGCTXData *rgctx_data;
    Il2CppClass_1 _1;
    struct JsonParser__Array__VTable vtable;
};
...
struct Substr__Array__VTable {
};

struct Substr__Array__StaticFields {
};

struct Substr__Array__Class {
    Il2CppClass_0 _0;
    Il2CppRuntimeInterfaceOffsetPair *interfaceOffsets;
    struct Substr__Array__StaticFields *static_fields;
    const Il2CppRGCTXData *rgctx_data;
    Il2CppClass_1 _1;
    struct Substr__Array__VTable vtable;
};
...
enum class ExposedPropertyCategory__Enum : int32_t {
    NotExposed = 0x00000000,
    Basic = 0x00000001,
    Advanced = 0x00000002,
};

struct ExposedPropertyCategory__Enum__Boxed {
    struct ExposedPropertyCategory__Enum__Class *klass;
    MonitorData *monitor;
    ExposedPropertyCategory__Enum value;
...
struct ExposedPropertyCategory__Enum__VTable {
    VirtualInvokeData Equals;
    VirtualInvokeData Finalize;
    VirtualInvokeData GetHashCode;
    VirtualInvokeData ToString;
...
struct ExposedPropertyCategory__Enum__StaticFields {
};

struct ExposedPropertyCategory__Enum__Class {
    Il2CppClass_0 _0;
    Il2CppRuntimeInterfaceOffsetPair *interfaceOffsets;
    struct ExposedPropertyCategory__Enum__StaticFields *static_fields;
    const Il2CppRGCTXData *rgctx_data;
    Il2CppClass_1 _1;
    struct ExposedPropertyCategory__Enum__VTable vtable;
};
...
struct ExposedProperty__Array__VTable {
};

struct ExposedProperty__Array__StaticFields {
};

struct ExposedProperty__Array__Class {
    Il2CppClass_0 _0;
    Il2CppRuntimeInterfaceOffsetPair *interfaceOffsets;
    struct ExposedProperty__Array__StaticFields *static_fields;
    const Il2CppRGCTXData *rgctx_data;
    Il2CppClass_1 _1;
    struct ExposedProperty__Array__VTable vtable;
};
...
struct Enum__Array__VTable {
};

struct Enum__Array__StaticFields {
};

struct Enum__Array__Class {
    Il2CppClass_0 _0;
    Il2CppRuntimeInterfaceOffsetPair *interfaceOffsets;
    struct Enum__Array__StaticFields *static_fields;
    const Il2CppRGCTXData *rgctx_data;
    Il2CppClass_1 _1;
    struct Enum__Array__VTable vtable;
};

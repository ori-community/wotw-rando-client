...
namespace app::classes::types {
    namespace ObjectProfilingCaptureAgent_ObjectProfilingHeader__Enum {
        namespace {
            app::ObjectProfilingCaptureAgent_ObjectProfilingHeader__Enum__Class* type_info_ref = nullptr;
        }
        app::ObjectProfilingCaptureAgent_ObjectProfilingHeader__Enum__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace PostLateUpdate_UpdateCustomRenderTextures {
        namespace {
            inline app::PostLateUpdate_UpdateCustomRenderTextures__Class* type_info_ref = nullptr;
        }
        inline app::PostLateUpdate_UpdateCustomRenderTextures__Class** type_info = &type_info_ref;

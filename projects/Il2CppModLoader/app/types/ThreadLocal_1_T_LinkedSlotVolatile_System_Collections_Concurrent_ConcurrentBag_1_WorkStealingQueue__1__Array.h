...
namespace app::classes::types {
    namespace ThreadLocal_1_T_LinkedSlotVolatile_System_Collections_Concurrent_ConcurrentBag_1_WorkStealingQueue__1__Array {
        namespace {
            app::ThreadLocal_1_T_LinkedSlotVolatile_System_Collections_Concurrent_ConcurrentBag_1_WorkStealingQueue__1__Array__Class* type_info_ref = nullptr;
        }
        app::ThreadLocal_1_T_LinkedSlotVolatile_System_Collections_Concurrent_ConcurrentBag_1_WorkStealingQueue__1__Array__Class** type_info = &type_info_ref;

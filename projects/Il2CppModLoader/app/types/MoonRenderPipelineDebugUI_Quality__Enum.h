...
namespace app::classes::types {
    namespace MoonRenderPipelineDebugUI_Quality__Enum {
        inline app::MoonRenderPipelineDebugUI_Quality__Enum__Class** type_info = (app::MoonRenderPipelineDebugUI_Quality__Enum__Class**)(modloader::win::memory::resolve_rva(0x04712530));

...
namespace app::classes::types {
    namespace TransparencyAnimatorSystemStrategy_RendererState__Array {
        namespace {
            app::TransparencyAnimatorSystemStrategy_RendererState__Array__Class* type_info_ref = nullptr;
        }
        app::TransparencyAnimatorSystemStrategy_RendererState__Array__Class** type_info = &type_info_ref;

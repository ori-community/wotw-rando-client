...
namespace app::classes::types {
    namespace EntityHitReaction_KickbackRuleOverrideForBehaviour {
        namespace {
            app::EntityHitReaction_KickbackRuleOverrideForBehaviour__Class* type_info_ref = nullptr;
        }
        app::EntityHitReaction_KickbackRuleOverrideForBehaviour__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace ShowFixedTimeTextEntity_InteractionType__Enum {
        namespace {
            app::ShowFixedTimeTextEntity_InteractionType__Enum__Class* type_info_ref = nullptr;
        }
        app::ShowFixedTimeTextEntity_InteractionType__Enum__Class** type_info = &type_info_ref;

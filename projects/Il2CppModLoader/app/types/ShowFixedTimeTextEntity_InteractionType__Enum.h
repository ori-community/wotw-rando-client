...
namespace app::classes::types {
    namespace ShowFixedTimeTextEntity_InteractionType__Enum {
        namespace {
            inline app::ShowFixedTimeTextEntity_InteractionType__Enum__Class* type_info_ref = nullptr;
        }
        inline app::ShowFixedTimeTextEntity_InteractionType__Enum__Class** type_info = &type_info_ref;

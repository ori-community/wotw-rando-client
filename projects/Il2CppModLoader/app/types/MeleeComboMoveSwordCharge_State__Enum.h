...
namespace app::classes::types {
    namespace MeleeComboMoveSwordCharge_State__Enum {
        namespace {
            inline app::MeleeComboMoveSwordCharge_State__Enum__Class* type_info_ref = nullptr;
        }
        inline app::MeleeComboMoveSwordCharge_State__Enum__Class** type_info = &type_info_ref;

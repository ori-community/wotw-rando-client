...
namespace app::classes::types {
    namespace NativeContainerSupportsDeferredConvertListToArray {
        namespace {
            app::NativeContainerSupportsDeferredConvertListToArray__Class* type_info_ref = nullptr;
        }
        app::NativeContainerSupportsDeferredConvertListToArray__Class** type_info = &type_info_ref;

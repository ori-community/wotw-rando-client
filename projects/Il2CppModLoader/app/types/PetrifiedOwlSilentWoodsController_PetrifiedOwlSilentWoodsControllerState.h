...
namespace app::classes::types {
    namespace PetrifiedOwlSilentWoodsController_PetrifiedOwlSilentWoodsControllerState {
        namespace {
            app::PetrifiedOwlSilentWoodsController_PetrifiedOwlSilentWoodsControllerState__Class* type_info_ref = nullptr;
        }
        app::PetrifiedOwlSilentWoodsController_PetrifiedOwlSilentWoodsControllerState__Class** type_info = &type_info_ref;

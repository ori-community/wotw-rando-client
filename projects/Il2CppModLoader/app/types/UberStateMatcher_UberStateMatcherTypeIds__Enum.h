...
namespace app::classes::types {
    namespace UberStateMatcher_UberStateMatcherTypeIds__Enum {
        namespace {
            app::UberStateMatcher_UberStateMatcherTypeIds__Enum__Class* type_info_ref = nullptr;
        }
        app::UberStateMatcher_UberStateMatcherTypeIds__Enum__Class** type_info = &type_info_ref;

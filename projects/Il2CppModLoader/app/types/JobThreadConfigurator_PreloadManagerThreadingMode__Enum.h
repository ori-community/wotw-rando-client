...
namespace app::classes::types {
    namespace JobThreadConfigurator_PreloadManagerThreadingMode__Enum {
        namespace {
            app::JobThreadConfigurator_PreloadManagerThreadingMode__Enum__Class* type_info_ref = nullptr;
        }
        app::JobThreadConfigurator_PreloadManagerThreadingMode__Enum__Class** type_info = &type_info_ref;

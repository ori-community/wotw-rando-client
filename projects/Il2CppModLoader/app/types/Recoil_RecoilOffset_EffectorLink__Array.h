...
namespace app::classes::types {
    namespace Recoil_RecoilOffset_EffectorLink__Array {
        namespace {
            inline app::Recoil_RecoilOffset_EffectorLink__Array__Class* type_info_ref = nullptr;
        }
        inline app::Recoil_RecoilOffset_EffectorLink__Array__Class** type_info = &type_info_ref;

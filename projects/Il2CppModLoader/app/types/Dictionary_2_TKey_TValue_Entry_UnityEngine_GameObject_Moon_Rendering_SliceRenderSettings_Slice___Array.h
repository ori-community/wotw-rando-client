...
namespace app::classes::types {
    namespace Dictionary_2_TKey_TValue_Entry_UnityEngine_GameObject_Moon_Rendering_SliceRenderSettings_Slice___Array {
        namespace {
            app::Dictionary_2_TKey_TValue_Entry_UnityEngine_GameObject_Moon_Rendering_SliceRenderSettings_Slice___Array__Class* type_info_ref = nullptr;
        }
        app::Dictionary_2_TKey_TValue_Entry_UnityEngine_GameObject_Moon_Rendering_SliceRenderSettings_Slice___Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace HitReaction_HitPointEffector_EffectorLink {
        namespace {
            inline app::HitReaction_HitPointEffector_EffectorLink__Class* type_info_ref = nullptr;
        }
        inline app::HitReaction_HitPointEffector_EffectorLink__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace SpiderBossLocomotionMoveBehaviour_SpiderBossTransition__Array {
        namespace {
            app::SpiderBossLocomotionMoveBehaviour_SpiderBossTransition__Array__Class* type_info_ref = nullptr;
        }
        app::SpiderBossLocomotionMoveBehaviour_SpiderBossTransition__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace GPUAutoProfilerReport_ReportSampleEntry__Array {
        namespace {
            inline app::GPUAutoProfilerReport_ReportSampleEntry__Array__Class* type_info_ref = nullptr;
        }
        inline app::GPUAutoProfilerReport_ReportSampleEntry__Array__Class** type_info = &type_info_ref;

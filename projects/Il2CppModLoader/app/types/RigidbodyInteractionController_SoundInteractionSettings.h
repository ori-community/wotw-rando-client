...
namespace app::classes::types {
    namespace RigidbodyInteractionController_SoundInteractionSettings {
        namespace {
            app::RigidbodyInteractionController_SoundInteractionSettings__Class* type_info_ref = nullptr;
        }
        app::RigidbodyInteractionController_SoundInteractionSettings__Class** type_info = &type_info_ref;

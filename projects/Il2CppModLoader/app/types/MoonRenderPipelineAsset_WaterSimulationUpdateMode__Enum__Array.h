...
namespace app::classes::types {
    namespace MoonRenderPipelineAsset_WaterSimulationUpdateMode__Enum__Array {
        namespace {
            app::MoonRenderPipelineAsset_WaterSimulationUpdateMode__Enum__Array__Class* type_info_ref = nullptr;
        }
        app::MoonRenderPipelineAsset_WaterSimulationUpdateMode__Enum__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace PauseMenuInventoryElements_UberStateToElement__Array {
        namespace {
            inline app::PauseMenuInventoryElements_UberStateToElement__Array__Class* type_info_ref = nullptr;
        }
        inline app::PauseMenuInventoryElements_UberStateToElement__Array__Class** type_info = &type_info_ref;

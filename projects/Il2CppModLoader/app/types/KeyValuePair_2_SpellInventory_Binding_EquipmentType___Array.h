...
namespace app::classes::types {
    namespace KeyValuePair_2_SpellInventory_Binding_EquipmentType___Array {
        namespace {
            app::KeyValuePair_2_SpellInventory_Binding_EquipmentType___Array__Class* type_info_ref = nullptr;
        }
        app::KeyValuePair_2_SpellInventory_Binding_EquipmentType___Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace SeinGlowSpell_GlowLightInfo__Array {
        namespace {
            inline app::SeinGlowSpell_GlowLightInfo__Array__Class* type_info_ref = nullptr;
        }
        inline app::SeinGlowSpell_GlowLightInfo__Array__Class** type_info = &type_info_ref;

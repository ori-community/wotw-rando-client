...
namespace app::classes::types {
    namespace GetPlayFabIDsFromPSNAccountIDsRequest_1 {
        inline app::GetPlayFabIDsFromPSNAccountIDsRequest_1__Class** type_info = (app::GetPlayFabIDsFromPSNAccountIDsRequest_1__Class**)(modloader::win::memory::resolve_rva(0x04740A98));

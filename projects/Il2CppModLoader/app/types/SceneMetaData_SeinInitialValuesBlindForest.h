...
namespace app::classes::types {
    namespace SceneMetaData_SeinInitialValuesBlindForest {
        namespace {
            app::SceneMetaData_SeinInitialValuesBlindForest__Class* type_info_ref = nullptr;
        }
        app::SceneMetaData_SeinInitialValuesBlindForest__Class** type_info = &type_info_ref;

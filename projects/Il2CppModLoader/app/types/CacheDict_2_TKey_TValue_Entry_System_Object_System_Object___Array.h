...
namespace app::classes::types {
    namespace CacheDict_2_TKey_TValue_Entry_System_Object_System_Object___Array {
        namespace {
            app::CacheDict_2_TKey_TValue_Entry_System_Object_System_Object___Array__Class* type_info_ref = nullptr;
        }
        app::CacheDict_2_TKey_TValue_Entry_System_Object_System_Object___Array__Class** type_info = &type_info_ref;

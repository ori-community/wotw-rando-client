...
namespace app::classes::types {
    namespace LegacyBabySandWorm_PositionHistoryEntry__Array {
        namespace {
            app::LegacyBabySandWorm_PositionHistoryEntry__Array__Class* type_info_ref = nullptr;
        }
        app::LegacyBabySandWorm_PositionHistoryEntry__Array__Class** type_info = &type_info_ref;

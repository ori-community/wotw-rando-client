...
namespace app::classes::types {
    namespace PetrifiedOwlBossEntity_Phases__Enum {
        namespace {
            inline app::PetrifiedOwlBossEntity_Phases__Enum__Class* type_info_ref = nullptr;
        }
        inline app::PetrifiedOwlBossEntity_Phases__Enum__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace KwolokTongueSyncGroup_KwolokTongueGroupEntry {
        namespace {
            app::KwolokTongueSyncGroup_KwolokTongueGroupEntry__Class* type_info_ref = nullptr;
        }
        app::KwolokTongueSyncGroup_KwolokTongueGroupEntry__Class** type_info = &type_info_ref;

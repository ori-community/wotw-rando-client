...
namespace app::classes::types {
    namespace EntitySpawnSetup_AfterSpawnStateSetupHolder {
        namespace {
            app::EntitySpawnSetup_AfterSpawnStateSetupHolder__Class* type_info_ref = nullptr;
        }
        app::EntitySpawnSetup_AfterSpawnStateSetupHolder__Class** type_info = &type_info_ref;

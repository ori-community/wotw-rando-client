...
namespace app::classes::types {
    namespace PostLateUpdate_PhysicsSkinnedClothBeginUpdate {
        namespace {
            app::PostLateUpdate_PhysicsSkinnedClothBeginUpdate__Class* type_info_ref = nullptr;
        }
        app::PostLateUpdate_PhysicsSkinnedClothBeginUpdate__Class** type_info = &type_info_ref;

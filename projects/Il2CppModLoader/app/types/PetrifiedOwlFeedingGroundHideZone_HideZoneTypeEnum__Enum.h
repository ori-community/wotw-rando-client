...
namespace app::classes::types {
    namespace PetrifiedOwlFeedingGroundHideZone_HideZoneTypeEnum__Enum {
        namespace {
            inline app::PetrifiedOwlFeedingGroundHideZone_HideZoneTypeEnum__Enum__Class* type_info_ref = nullptr;
        }
        inline app::PetrifiedOwlFeedingGroundHideZone_HideZoneTypeEnum__Enum__Class** type_info = &type_info_ref;

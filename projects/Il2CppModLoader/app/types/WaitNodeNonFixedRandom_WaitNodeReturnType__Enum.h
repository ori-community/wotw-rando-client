...
namespace app::classes::types {
    namespace WaitNodeNonFixedRandom_WaitNodeReturnType__Enum {
        namespace {
            app::WaitNodeNonFixedRandom_WaitNodeReturnType__Enum__Class* type_info_ref = nullptr;
        }
        app::WaitNodeNonFixedRandom_WaitNodeReturnType__Enum__Class** type_info = &type_info_ref;

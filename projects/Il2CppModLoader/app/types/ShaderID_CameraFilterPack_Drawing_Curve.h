...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_Drawing_Curve {
        inline app::ShaderID_CameraFilterPack_Drawing_Curve__Class** type_info = (app::ShaderID_CameraFilterPack_Drawing_Curve__Class**)(modloader::win::memory::resolve_rva(0x0478F858));

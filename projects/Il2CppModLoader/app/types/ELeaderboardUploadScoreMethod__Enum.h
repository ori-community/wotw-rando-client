...
namespace app::classes::types {
    namespace ELeaderboardUploadScoreMethod__Enum {
        namespace {
            inline app::ELeaderboardUploadScoreMethod__Enum__Class* type_info_ref = nullptr;
        }
        inline app::ELeaderboardUploadScoreMethod__Enum__Class** type_info = &type_info_ref;

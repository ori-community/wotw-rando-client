...
namespace app::classes::types {
    namespace KeyValuePair_2_JumpGridEntry_CellTag_UnityEngine_Color___Array {
        namespace {
            app::KeyValuePair_2_JumpGridEntry_CellTag_UnityEngine_Color___Array__Class* type_info_ref = nullptr;
        }
        app::KeyValuePair_2_JumpGridEntry_CellTag_UnityEngine_Color___Array__Class** type_info = &type_info_ref;

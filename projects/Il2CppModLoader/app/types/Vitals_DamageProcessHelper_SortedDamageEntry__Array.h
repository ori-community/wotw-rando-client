...
namespace app::classes::types {
    namespace Vitals_DamageProcessHelper_SortedDamageEntry__Array {
        namespace {
            app::Vitals_DamageProcessHelper_SortedDamageEntry__Array__Class* type_info_ref = nullptr;
        }
        app::Vitals_DamageProcessHelper_SortedDamageEntry__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace KeybindingCommandMapAsset_ExclusiveCommandList__Array {
        namespace {
            app::KeybindingCommandMapAsset_ExclusiveCommandList__Array__Class* type_info_ref = nullptr;
        }
        app::KeybindingCommandMapAsset_ExclusiveCommandList__Array__Class** type_info = &type_info_ref;

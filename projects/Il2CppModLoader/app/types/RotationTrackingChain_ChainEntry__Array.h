...
namespace app::classes::types {
    namespace RotationTrackingChain_ChainEntry__Array {
        namespace {
            inline app::RotationTrackingChain_ChainEntry__Array__Class* type_info_ref = nullptr;
        }
        inline app::RotationTrackingChain_ChainEntry__Array__Class** type_info = &type_info_ref;

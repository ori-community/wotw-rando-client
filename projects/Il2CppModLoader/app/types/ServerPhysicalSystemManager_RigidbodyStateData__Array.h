...
namespace app::classes::types {
    namespace ServerPhysicalSystemManager_RigidbodyStateData__Array {
        namespace {
            app::ServerPhysicalSystemManager_RigidbodyStateData__Array__Class* type_info_ref = nullptr;
        }
        app::ServerPhysicalSystemManager_RigidbodyStateData__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace UberWaterControl_VisualDebugMode__Enum {
        namespace {
            app::UberWaterControl_VisualDebugMode__Enum__Class* type_info_ref = nullptr;
        }
        app::UberWaterControl_VisualDebugMode__Enum__Class** type_info = &type_info_ref;
        ...
        inline app::UberWaterControl_VisualDebugMode__Enum__Array* create_array(const std::vector<app::UberWaterControl_VisualDebugMode__Enum__Boxed*>& items) {

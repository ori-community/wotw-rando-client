...
namespace app::classes::types {
    namespace UberWaterReflectionView_c_DisplayClass21_0 {
        namespace {
            app::UberWaterReflectionView_c_DisplayClass21_0__Class* type_info_ref = nullptr;
        }
        app::UberWaterReflectionView_c_DisplayClass21_0__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace UberWaterReflectionView_c_DisplayClass21_0 {
        namespace {
            inline app::UberWaterReflectionView_c_DisplayClass21_0__Class* type_info_ref = nullptr;
        }
        inline app::UberWaterReflectionView_c_DisplayClass21_0__Class** type_info = &type_info_ref;

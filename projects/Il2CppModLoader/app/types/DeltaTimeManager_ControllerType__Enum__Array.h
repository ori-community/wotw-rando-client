...
namespace app::classes::types {
    namespace DeltaTimeManager_ControllerType__Enum__Array {
        namespace {
            inline app::DeltaTimeManager_ControllerType__Enum__Array__Class* type_info_ref = nullptr;
        }
        inline app::DeltaTimeManager_ControllerType__Enum__Array__Class** type_info = &type_info_ref;

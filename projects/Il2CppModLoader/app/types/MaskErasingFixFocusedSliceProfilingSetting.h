...
namespace app::classes::types {
    namespace MaskErasingFixFocusedSliceProfilingSetting {
        namespace {
            app::MaskErasingFixFocusedSliceProfilingSetting__Class* type_info_ref = nullptr;
        }
        app::MaskErasingFixFocusedSliceProfilingSetting__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace AnimationTester_AnimationTestEntry__Array {
        namespace {
            app::AnimationTester_AnimationTestEntry__Array__Class* type_info_ref = nullptr;
        }
        app::AnimationTester_AnimationTestEntry__Array__Class** type_info = &type_info_ref;

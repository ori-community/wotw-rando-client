...
namespace app::classes::types {
    namespace SeinChakramSpell_BalancingData_ChakramDamageSettings__Array {
        namespace {
            inline app::SeinChakramSpell_BalancingData_ChakramDamageSettings__Array__Class* type_info_ref = nullptr;
        }
        inline app::SeinChakramSpell_BalancingData_ChakramDamageSettings__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace DynamicDataResolver_SerializedDynamicDataLinkItem__Array {
        namespace {
            inline app::DynamicDataResolver_SerializedDynamicDataLinkItem__Array__Class* type_info_ref = nullptr;
        }
        inline app::DynamicDataResolver_SerializedDynamicDataLinkItem__Array__Class** type_info = &type_info_ref;

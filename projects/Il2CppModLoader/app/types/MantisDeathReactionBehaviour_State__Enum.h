...
namespace app::classes::types {
    namespace MantisDeathReactionBehaviour_State__Enum {
        namespace {
            inline app::MantisDeathReactionBehaviour_State__Enum__Class* type_info_ref = nullptr;
        }
        inline app::MantisDeathReactionBehaviour_State__Enum__Class** type_info = &type_info_ref;

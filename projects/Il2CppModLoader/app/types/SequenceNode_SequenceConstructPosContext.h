...
namespace app::classes::types {
    namespace SequenceNode_SequenceConstructPosContext {
        namespace {
            inline app::SequenceNode_SequenceConstructPosContext__Class* type_info_ref = nullptr;
        }
        inline app::SequenceNode_SequenceConstructPosContext__Class** type_info = &type_info_ref;

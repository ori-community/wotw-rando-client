...
namespace app::classes::types {
    namespace CartLogicCycle_IsAllowedDelegate__Array {
        namespace {
            inline app::CartLogicCycle_IsAllowedDelegate__Array__Class* type_info_ref = nullptr;
        }
        inline app::CartLogicCycle_IsAllowedDelegate__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace Dictionary_2_System_Int32_WorldMapAreaState___Array {
        namespace {
            app::Dictionary_2_System_Int32_WorldMapAreaState___Array__Class* type_info_ref = nullptr;
        }
        app::Dictionary_2_System_Int32_WorldMapAreaState___Array__Class** type_info = &type_info_ref;

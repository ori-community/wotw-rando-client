...
namespace app::classes::types {
    namespace BrowserNative_Calltype_zfb_registerContextMenuCallback {
        namespace {
            app::BrowserNative_Calltype_zfb_registerContextMenuCallback__Class* type_info_ref = nullptr;
        }
        app::BrowserNative_Calltype_zfb_registerContextMenuCallback__Class** type_info = &type_info_ref;

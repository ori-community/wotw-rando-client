...
enum class FormatterTypeStyle__Enum : int32_t {
...
struct FormatterTypeStyle__Enum__Boxed {
    ...
    MonitorData *monitor;
    FormatterTypeStyle__Enum value;
    
};

enum class FormatterAssemblyStyle__Enum : int32_t {
    Simple = 0x00000000,
    Full = 0x00000001,
};
...
struct FormatterAssemblyStyle__Enum__Boxed {
    ...
    MonitorData *monitor;
    FormatterAssemblyStyle__Enum value;
...
struct IEqualityComparer_1_Newtonsoft_Json_Utilities_StructMultiKey_2_ {
    struct IEqualityComparer_1_Newtonsoft_Json_Utilities_StructMultiKey_2___Class *klass;
    MonitorData *monitor;
};

struct ICollection_1_Newtonsoft_Json_Utilities_StructMultiKey_2_ {
    struct ICollection_1_Newtonsoft_Json_Utilities_StructMultiKey_2___Class *klass;
    MonitorData *monitor;
};
...
struct KeyValuePair_2_Newtonsoft_Json_Utilities_StructMultiKey_2_System_Type___Array {
    struct KeyValuePair_2_Newtonsoft_Json_Utilities_StructMultiKey_2_System_Type___Array__Class *klass;
    MonitorData *monitor;
    Il2CppArrayBounds *bounds;
    il2cpp_array_size_t max_length;
    struct KeyValuePair_2_Newtonsoft_Json_Utilities_StructMultiKey_2_System_Type_ vector[32];
};
...
struct IEnumerable_1_Newtonsoft_Json_Utilities_StructMultiKey_2_ {
    struct IEnumerable_1_Newtonsoft_Json_Utilities_StructMultiKey_2___Class *klass;
    MonitorData *monitor;
};

struct Func_2_Newtonsoft_Json_Utilities_StructMultiKey_2_Type___Fields {

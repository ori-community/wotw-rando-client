...
namespace app::classes::types {
    namespace MoonRenderPipelineView_GodRaySrcRT {
        inline app::MoonRenderPipelineView_GodRaySrcRT__Class** type_info = (app::MoonRenderPipelineView_GodRaySrcRT__Class**)(modloader::win::memory::resolve_rva(0x0473C038));

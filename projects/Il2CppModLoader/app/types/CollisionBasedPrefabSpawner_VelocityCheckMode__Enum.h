...
namespace app::classes::types {
    namespace CollisionBasedPrefabSpawner_VelocityCheckMode__Enum {
        namespace {
            app::CollisionBasedPrefabSpawner_VelocityCheckMode__Enum__Class* type_info_ref = nullptr;
        }
        app::CollisionBasedPrefabSpawner_VelocityCheckMode__Enum__Class** type_info = &type_info_ref;

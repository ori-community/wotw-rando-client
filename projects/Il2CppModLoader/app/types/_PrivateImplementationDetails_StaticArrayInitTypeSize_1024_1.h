...
namespace app::classes::types {
    namespace _PrivateImplementationDetails_StaticArrayInitTypeSize_1024_1 {
        namespace {
            app::_PrivateImplementationDetails_StaticArrayInitTypeSize_1024_1__Class* type_info_ref = nullptr;
        }
        app::_PrivateImplementationDetails_StaticArrayInitTypeSize_1024_1__Class** type_info = &type_info_ref;

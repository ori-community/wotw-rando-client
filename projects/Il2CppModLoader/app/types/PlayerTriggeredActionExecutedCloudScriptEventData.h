...
namespace app::classes::types {
    namespace PlayerTriggeredActionExecutedCloudScriptEventData {
        namespace {
            app::PlayerTriggeredActionExecutedCloudScriptEventData__Class* type_info_ref = nullptr;
        }
        app::PlayerTriggeredActionExecutedCloudScriptEventData__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace InstantiateUtility_DeinstantiationInfo {
        namespace {
            inline app::InstantiateUtility_DeinstantiationInfo__Class* type_info_ref = nullptr;
        }
        inline app::InstantiateUtility_DeinstantiationInfo__Class** type_info = &type_info_ref;

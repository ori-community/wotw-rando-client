...
namespace app::classes::types {
    namespace LightCanvasShadingZone_LightCanvasShadingZonesFlags__Enum {
        namespace {
            app::LightCanvasShadingZone_LightCanvasShadingZonesFlags__Enum__Class* type_info_ref = nullptr;
        }
        app::LightCanvasShadingZone_LightCanvasShadingZonesFlags__Enum__Class** type_info = &type_info_ref;

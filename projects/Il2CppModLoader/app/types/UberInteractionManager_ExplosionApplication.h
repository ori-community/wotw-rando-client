...
namespace app::classes::types {
    namespace UberInteractionManager_ExplosionApplication {
        inline app::UberInteractionManager_ExplosionApplication__Class** type_info = (app::UberInteractionManager_ExplosionApplication__Class**)(modloader::win::memory::resolve_rva(0x0473B818));

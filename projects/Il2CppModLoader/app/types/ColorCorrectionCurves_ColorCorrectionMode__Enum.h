...
namespace app::classes::types {
    namespace ColorCorrectionCurves_ColorCorrectionMode__Enum {
        namespace {
            app::ColorCorrectionCurves_ColorCorrectionMode__Enum__Class* type_info_ref = nullptr;
        }
        app::ColorCorrectionCurves_ColorCorrectionMode__Enum__Class** type_info = &type_info_ref;

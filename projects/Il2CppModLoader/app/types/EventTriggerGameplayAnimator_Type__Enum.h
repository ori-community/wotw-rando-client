...
namespace app::classes::types {
    namespace EventTriggerGameplayAnimator_Type__Enum {
        namespace {
            inline app::EventTriggerGameplayAnimator_Type__Enum__Class* type_info_ref = nullptr;
        }
        inline app::EventTriggerGameplayAnimator_Type__Enum__Class** type_info = &type_info_ref;

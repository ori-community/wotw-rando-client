...
namespace app::classes::types {
    namespace HttpListenerRequestUriBuilder_EncodingType__Enum {
        namespace {
            app::HttpListenerRequestUriBuilder_EncodingType__Enum__Class* type_info_ref = nullptr;
        }
        app::HttpListenerRequestUriBuilder_EncodingType__Enum__Class** type_info = &type_info_ref;

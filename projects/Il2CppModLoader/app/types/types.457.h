...
struct EntityKey_7__Array__VTable {
};
...
struct EntityProfileBody__Array__VTable {
};
...
enum class OperationTypes__Enum_2 : int32_t {
    Created = 0x00000000,
    Updated = 0x00000001,
    Deleted = 0x00000002,
    None = 0x00000003,
...
struct OperationTypes__Enum_2__VTable {
    VirtualInvokeData Equals;
    VirtualInvokeData Finalize;
    VirtualInvokeData GetHashCode;
    VirtualInvokeData ToString;

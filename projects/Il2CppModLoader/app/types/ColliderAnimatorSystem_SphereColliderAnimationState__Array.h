...
namespace app::classes::types {
    namespace ColliderAnimatorSystem_SphereColliderAnimationState__Array {
        namespace {
            app::ColliderAnimatorSystem_SphereColliderAnimationState__Array__Class* type_info_ref = nullptr;
        }
        app::ColliderAnimatorSystem_SphereColliderAnimationState__Array__Class** type_info = &type_info_ref;

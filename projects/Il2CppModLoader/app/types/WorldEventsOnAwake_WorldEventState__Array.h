...
namespace app::classes::types {
    namespace WorldEventsOnAwake_WorldEventState__Array {
        namespace {
            inline app::WorldEventsOnAwake_WorldEventState__Array__Class* type_info_ref = nullptr;
        }
        inline app::WorldEventsOnAwake_WorldEventState__Array__Class** type_info = &type_info_ref;

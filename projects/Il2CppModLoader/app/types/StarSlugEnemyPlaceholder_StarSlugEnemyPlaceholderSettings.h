...
namespace app::classes::types {
    namespace StarSlugEnemyPlaceholder_StarSlugEnemyPlaceholderSettings {
        namespace {
            app::StarSlugEnemyPlaceholder_StarSlugEnemyPlaceholderSettings__Class* type_info_ref = nullptr;
        }
        app::StarSlugEnemyPlaceholder_StarSlugEnemyPlaceholderSettings__Class** type_info = &type_info_ref;

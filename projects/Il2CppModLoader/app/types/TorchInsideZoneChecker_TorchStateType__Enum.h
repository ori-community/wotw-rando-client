...
namespace app::classes::types {
    namespace TorchInsideZoneChecker_TorchStateType__Enum {
        namespace {
            app::TorchInsideZoneChecker_TorchStateType__Enum__Class* type_info_ref = nullptr;
        }
        app::TorchInsideZoneChecker_TorchStateType__Enum__Class** type_info = &type_info_ref;

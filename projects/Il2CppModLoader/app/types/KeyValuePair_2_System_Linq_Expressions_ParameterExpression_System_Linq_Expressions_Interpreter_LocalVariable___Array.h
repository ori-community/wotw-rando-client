...
namespace app::classes::types {
    namespace KeyValuePair_2_System_Linq_Expressions_ParameterExpression_System_Linq_Expressions_Interpreter_LocalVariable___Array {
        namespace {
            app::KeyValuePair_2_System_Linq_Expressions_ParameterExpression_System_Linq_Expressions_Interpreter_LocalVariable___Array__Class* type_info_ref = nullptr;
        }
        app::KeyValuePair_2_System_Linq_Expressions_ParameterExpression_System_Linq_Expressions_Interpreter_LocalVariable___Array__Class** type_info = &type_info_ref;

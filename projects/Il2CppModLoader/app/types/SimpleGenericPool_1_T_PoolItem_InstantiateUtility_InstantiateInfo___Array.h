...
namespace app::classes::types {
    namespace SimpleGenericPool_1_T_PoolItem_InstantiateUtility_InstantiateInfo___Array {
        namespace {
            app::SimpleGenericPool_1_T_PoolItem_InstantiateUtility_InstantiateInfo___Array__Class* type_info_ref = nullptr;
        }
        app::SimpleGenericPool_1_T_PoolItem_InstantiateUtility_InstantiateInfo___Array__Class** type_info = &type_info_ref;

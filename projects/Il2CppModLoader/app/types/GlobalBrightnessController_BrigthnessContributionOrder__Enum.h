...
namespace app::classes::types {
    namespace GlobalBrightnessController_BrigthnessContributionOrder__Enum {
        namespace {
            inline app::GlobalBrightnessController_BrigthnessContributionOrder__Enum__Class* type_info_ref = nullptr;
        }
        inline app::GlobalBrightnessController_BrigthnessContributionOrder__Enum__Class** type_info = &type_info_ref;

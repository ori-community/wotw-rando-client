...
namespace app::classes::types {
    namespace KeyValuePair_2_GameMapPins_PinColour_GameMapPins_Pin___Array {
        namespace {
            app::KeyValuePair_2_GameMapPins_PinColour_GameMapPins_Pin___Array__Class* type_info_ref = nullptr;
        }
        app::KeyValuePair_2_GameMapPins_PinColour_GameMapPins_Pin___Array__Class** type_info = &type_info_ref;

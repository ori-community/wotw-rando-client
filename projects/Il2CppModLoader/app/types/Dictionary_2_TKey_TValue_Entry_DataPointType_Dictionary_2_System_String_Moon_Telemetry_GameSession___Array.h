...
namespace app::classes::types {
    namespace Dictionary_2_TKey_TValue_Entry_DataPointType_Dictionary_2_System_String_Moon_Telemetry_GameSession___Array {
        namespace {
            app::Dictionary_2_TKey_TValue_Entry_DataPointType_Dictionary_2_System_String_Moon_Telemetry_GameSession___Array__Class* type_info_ref = nullptr;
        }
        app::Dictionary_2_TKey_TValue_Entry_DataPointType_Dictionary_2_System_String_Moon_Telemetry_GameSession___Array__Class** type_info = &type_info_ref;

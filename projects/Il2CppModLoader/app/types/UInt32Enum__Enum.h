...
namespace app::classes::types {
    namespace UInt32Enum__Enum {
        namespace {
            app::UInt32Enum__Enum__Class* type_info_ref = nullptr;
        }
        app::UInt32Enum__Enum__Class** type_info = &type_info_ref;
        ...
        inline app::UInt32Enum__Enum__Array* create_array(const std::vector<app::UInt32Enum__Enum__Boxed*>& items) {

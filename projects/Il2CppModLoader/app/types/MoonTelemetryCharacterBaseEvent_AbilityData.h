...
namespace app::classes::types {
    namespace MoonTelemetryCharacterBaseEvent_AbilityData {
        namespace {
            app::MoonTelemetryCharacterBaseEvent_AbilityData__Class* type_info_ref = nullptr;
        }
        app::MoonTelemetryCharacterBaseEvent_AbilityData__Class** type_info = &type_info_ref;

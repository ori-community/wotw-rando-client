...
namespace app::classes::types {
    namespace DynamicInstantiationScanner_Visitor__Array {
        namespace {
            app::DynamicInstantiationScanner_Visitor__Array__Class* type_info_ref = nullptr;
        }
        app::DynamicInstantiationScanner_Visitor__Array__Class** type_info = &type_info_ref;

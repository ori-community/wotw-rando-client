...
namespace app::classes::types {
    namespace KeyValuePair_2_SmartInput_ICachableInput_SmartInput_InputCacheManager_SetupTempData_Node___Array {
        namespace {
            app::KeyValuePair_2_SmartInput_ICachableInput_SmartInput_InputCacheManager_SetupTempData_Node___Array__Class* type_info_ref = nullptr;
        }
        app::KeyValuePair_2_SmartInput_ICachableInput_SmartInput_InputCacheManager_SetupTempData_Node___Array__Class** type_info = &type_info_ref;

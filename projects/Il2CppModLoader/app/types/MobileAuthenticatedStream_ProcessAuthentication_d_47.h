...
namespace app::classes::types {
    namespace MobileAuthenticatedStream_ProcessAuthentication_d_47 {
        namespace {
            inline app::MobileAuthenticatedStream_ProcessAuthentication_d_47__Class* type_info_ref = nullptr;
        }
        inline app::MobileAuthenticatedStream_ProcessAuthentication_d_47__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace XmlSqlBinaryReader_AttrInfo__Array {
        inline app::XmlSqlBinaryReader_AttrInfo__Array__Class** type_info = (app::XmlSqlBinaryReader_AttrInfo__Array__Class**)(modloader::win::memory::resolve_rva(0x04790428));

...
namespace app::classes::types {
    namespace ThreadLocal_1_T_LinkedSlotVolatile_System_Object___Array {
        namespace {
            app::ThreadLocal_1_T_LinkedSlotVolatile_System_Object___Array__Class* type_info_ref = nullptr;
        }
        app::ThreadLocal_1_T_LinkedSlotVolatile_System_Object___Array__Class** type_info = &type_info_ref;

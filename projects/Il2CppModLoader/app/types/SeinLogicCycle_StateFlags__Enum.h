...
namespace app::classes::types {
    namespace SeinLogicCycle_StateFlags__Enum {
        namespace {
            app::SeinLogicCycle_StateFlags__Enum__Class* type_info_ref = nullptr;
        }
        app::SeinLogicCycle_StateFlags__Enum__Class** type_info = &type_info_ref;
        ...
        inline app::SeinLogicCycle_StateFlags__Enum__Array* create_array(const std::vector<app::SeinLogicCycle_StateFlags__Enum__Boxed*>& items) {

...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_FX_Mirror {
        inline app::ShaderID_CameraFilterPack_FX_Mirror__Class** type_info = (app::ShaderID_CameraFilterPack_FX_Mirror__Class**)(modloader::win::memory::resolve_rva(0x047957E8));

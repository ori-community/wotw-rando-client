...
namespace app::classes::types {
    namespace ObjectInstantiationCaptureAgent_ObjectInstantiationHeader__Enum {
        namespace {
            app::ObjectInstantiationCaptureAgent_ObjectInstantiationHeader__Enum__Class* type_info_ref = nullptr;
        }
        app::ObjectInstantiationCaptureAgent_ObjectInstantiationHeader__Enum__Class** type_info = &type_info_ref;

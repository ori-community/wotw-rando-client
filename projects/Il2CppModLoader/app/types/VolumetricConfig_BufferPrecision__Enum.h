...
namespace app::classes::types {
    namespace VolumetricConfig_BufferPrecision__Enum {
        namespace {
            inline app::VolumetricConfig_BufferPrecision__Enum__Class* type_info_ref = nullptr;
        }
        inline app::VolumetricConfig_BufferPrecision__Enum__Class** type_info = &type_info_ref;

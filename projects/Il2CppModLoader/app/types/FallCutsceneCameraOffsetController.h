...
namespace app::classes::types {
    namespace FallCutsceneCameraOffsetController {
        namespace {
            inline app::FallCutsceneCameraOffsetController__Class* type_info_ref = nullptr;
        }
        inline app::FallCutsceneCameraOffsetController__Class** type_info = &type_info_ref;

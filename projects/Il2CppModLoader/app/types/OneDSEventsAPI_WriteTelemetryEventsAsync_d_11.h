...
namespace app::classes::types {
    namespace OneDSEventsAPI_WriteTelemetryEventsAsync_d_11 {
        namespace {
            app::OneDSEventsAPI_WriteTelemetryEventsAsync_d_11__Class* type_info_ref = nullptr;
        }
        app::OneDSEventsAPI_WriteTelemetryEventsAsync_d_11__Class** type_info = &type_info_ref;

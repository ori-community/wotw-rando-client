...
namespace app::classes::types {
    namespace PlayableCharacterAnimator_PlayableCharacters__Enum {
        namespace {
            app::PlayableCharacterAnimator_PlayableCharacters__Enum__Class* type_info_ref = nullptr;
        }
        app::PlayableCharacterAnimator_PlayableCharacters__Enum__Class** type_info = &type_info_ref;

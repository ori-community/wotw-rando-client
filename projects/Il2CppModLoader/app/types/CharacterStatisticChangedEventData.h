...
namespace app::classes::types {
    namespace CharacterStatisticChangedEventData {
        namespace {
            inline app::CharacterStatisticChangedEventData__Class* type_info_ref = nullptr;
        }
        inline app::CharacterStatisticChangedEventData__Class** type_info = &type_info_ref;

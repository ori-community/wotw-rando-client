...
namespace app::classes::types {
    namespace MeleeAttackBehaviourNew_DamageDirectionType__Enum {
        namespace {
            app::MeleeAttackBehaviourNew_DamageDirectionType__Enum__Class* type_info_ref = nullptr;
        }
        app::MeleeAttackBehaviourNew_DamageDirectionType__Enum__Class** type_info = &type_info_ref;

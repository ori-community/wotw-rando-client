...
namespace app::classes::types {
    namespace QuestsController_QueuedQuestMessage__Array {
        namespace {
            app::QuestsController_QueuedQuestMessage__Array__Class* type_info_ref = nullptr;
        }
        app::QuestsController_QueuedQuestMessage__Array__Class** type_info = &type_info_ref;

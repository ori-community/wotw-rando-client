...
namespace app::classes::types {
    namespace GhostTimelineEventsPlugin_TimelineEventData_ActionType__Enum {
        namespace {
            app::GhostTimelineEventsPlugin_TimelineEventData_ActionType__Enum__Class* type_info_ref = nullptr;
        }
        app::GhostTimelineEventsPlugin_TimelineEventData_ActionType__Enum__Class** type_info = &type_info_ref;

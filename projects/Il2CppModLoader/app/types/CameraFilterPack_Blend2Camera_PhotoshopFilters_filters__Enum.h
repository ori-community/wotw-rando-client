...
namespace app::classes::types {
    namespace CameraFilterPack_Blend2Camera_PhotoshopFilters_filters__Enum {
        namespace {
            app::CameraFilterPack_Blend2Camera_PhotoshopFilters_filters__Enum__Class* type_info_ref = nullptr;
        }
        app::CameraFilterPack_Blend2Camera_PhotoshopFilters_filters__Enum__Class** type_info = &type_info_ref;

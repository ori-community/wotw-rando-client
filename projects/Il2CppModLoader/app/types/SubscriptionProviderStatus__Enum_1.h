...
namespace app::classes::types {
    namespace SubscriptionProviderStatus__Enum_1 {
        namespace {
            inline app::SubscriptionProviderStatus__Enum_1__Class* type_info_ref = nullptr;
        }
        inline app::SubscriptionProviderStatus__Enum_1__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace AkCommonUserSettings_SpatialAudioSettings_DiffractionFlags__Enum {
        namespace {
            app::AkCommonUserSettings_SpatialAudioSettings_DiffractionFlags__Enum__Class* type_info_ref = nullptr;
        }
        app::AkCommonUserSettings_SpatialAudioSettings_DiffractionFlags__Enum__Class** type_info = &type_info_ref;

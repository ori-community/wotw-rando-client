...
namespace app::classes::types {
    namespace CollapsingPlatform_CollapsingPlatformType__Enum {
        namespace {
            app::CollapsingPlatform_CollapsingPlatformType__Enum__Class* type_info_ref = nullptr;
        }
        app::CollapsingPlatform_CollapsingPlatformType__Enum__Class** type_info = &type_info_ref;

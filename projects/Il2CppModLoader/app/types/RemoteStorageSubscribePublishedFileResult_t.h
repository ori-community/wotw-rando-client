...
namespace app::classes::types {
    namespace RemoteStorageSubscribePublishedFileResult_t {
        namespace {
            app::RemoteStorageSubscribePublishedFileResult_t__Class* type_info_ref = nullptr;
        }
        app::RemoteStorageSubscribePublishedFileResult_t__Class** type_info = &type_info_ref;

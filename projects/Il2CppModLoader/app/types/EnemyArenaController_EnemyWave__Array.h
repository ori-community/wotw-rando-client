...
namespace app::classes::types {
    namespace EnemyArenaController_EnemyWave__Array {
        namespace {
            inline app::EnemyArenaController_EnemyWave__Array__Class* type_info_ref = nullptr;
        }
        inline app::EnemyArenaController_EnemyWave__Array__Class** type_info = &type_info_ref;

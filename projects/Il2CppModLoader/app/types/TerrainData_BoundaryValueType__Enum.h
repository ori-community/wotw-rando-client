...
namespace app::classes::types {
    namespace TerrainData_BoundaryValueType__Enum {
        namespace {
            inline app::TerrainData_BoundaryValueType__Enum__Class* type_info_ref = nullptr;
        }
        inline app::TerrainData_BoundaryValueType__Enum__Class** type_info = &type_info_ref;

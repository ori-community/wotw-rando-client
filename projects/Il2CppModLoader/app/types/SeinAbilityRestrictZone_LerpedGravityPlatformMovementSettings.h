...
namespace app::classes::types {
    namespace SeinAbilityRestrictZone_LerpedGravityPlatformMovementSettings {
        namespace {
            app::SeinAbilityRestrictZone_LerpedGravityPlatformMovementSettings__Class* type_info_ref = nullptr;
        }
        app::SeinAbilityRestrictZone_LerpedGravityPlatformMovementSettings__Class** type_info = &type_info_ref;

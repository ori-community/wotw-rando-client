...
namespace app::classes::types {
    namespace CameraFrustumOptimizer_EarlyZActivation__Array {
        namespace {
            app::CameraFrustumOptimizer_EarlyZActivation__Array__Class* type_info_ref = nullptr;
        }
        app::CameraFrustumOptimizer_EarlyZActivation__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace MoonAnimator_AnimationPostprocessState__Enum {
        namespace {
            app::MoonAnimator_AnimationPostprocessState__Enum__Class* type_info_ref = nullptr;
        }
        app::MoonAnimator_AnimationPostprocessState__Enum__Class** type_info = &type_info_ref;

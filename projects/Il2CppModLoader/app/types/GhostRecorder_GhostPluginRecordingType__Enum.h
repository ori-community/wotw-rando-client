...
namespace app::classes::types {
    namespace GhostRecorder_GhostPluginRecordingType__Enum {
        namespace {
            app::GhostRecorder_GhostPluginRecordingType__Enum__Class* type_info_ref = nullptr;
        }
        app::GhostRecorder_GhostPluginRecordingType__Enum__Class** type_info = &type_info_ref;

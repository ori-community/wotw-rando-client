...
namespace app::classes::types {
    namespace DateTimeParse_DS__Enum {
        namespace {
            app::DateTimeParse_DS__Enum__Class* type_info_ref = nullptr;
        }
        app::DateTimeParse_DS__Enum__Class** type_info = &type_info_ref;
        ...
        inline app::DateTimeParse_DS__Enum__Array* create_array(const std::vector<app::DateTimeParse_DS__Enum__Boxed*>& items) {

...
namespace app::classes::types {
    namespace FacebookInstantGamesPlayFabIdPair__Array {
        namespace {
            inline app::FacebookInstantGamesPlayFabIdPair__Array__Class* type_info_ref = nullptr;
        }
        inline app::FacebookInstantGamesPlayFabIdPair__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace LensAberrations_ChromaticAberrationSettings {
        namespace {
            inline app::LensAberrations_ChromaticAberrationSettings__Class* type_info_ref = nullptr;
        }
        inline app::LensAberrations_ChromaticAberrationSettings__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace ScreenSpaceReflection_SSRReflectionBlendType__Enum {
        namespace {
            app::ScreenSpaceReflection_SSRReflectionBlendType__Enum__Class* type_info_ref = nullptr;
        }
        app::ScreenSpaceReflection_SSRReflectionBlendType__Enum__Class** type_info = &type_info_ref;

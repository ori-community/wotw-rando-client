...
namespace app::classes::types {
    namespace KeyValuePair_2_Moon_InteractionGraph_IState_Dictionary_2_System_Int32_System_Action___Array {
        namespace {
            inline app::KeyValuePair_2_Moon_InteractionGraph_IState_Dictionary_2_System_Int32_System_Action___Array__Class* type_info_ref = nullptr;
        }
        inline app::KeyValuePair_2_Moon_InteractionGraph_IState_Dictionary_2_System_Int32_System_Action___Array__Class** type_info = &type_info_ref;

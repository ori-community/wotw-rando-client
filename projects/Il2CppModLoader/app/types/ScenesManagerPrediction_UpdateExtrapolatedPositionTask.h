...
namespace app::classes::types {
    namespace ScenesManagerPrediction_UpdateExtrapolatedPositionTask {
        namespace {
            app::ScenesManagerPrediction_UpdateExtrapolatedPositionTask__Class* type_info_ref = nullptr;
        }
        app::ScenesManagerPrediction_UpdateExtrapolatedPositionTask__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace UnsafeNativeMethods_ManifestEtw_ActivityControl__Enum {
        namespace {
            app::UnsafeNativeMethods_ManifestEtw_ActivityControl__Enum__Class* type_info_ref = nullptr;
        }
        app::UnsafeNativeMethods_ManifestEtw_ActivityControl__Enum__Class** type_info = &type_info_ref;

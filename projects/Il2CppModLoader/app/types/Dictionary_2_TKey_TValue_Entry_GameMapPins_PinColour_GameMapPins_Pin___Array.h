...
namespace app::classes::types {
    namespace Dictionary_2_TKey_TValue_Entry_GameMapPins_PinColour_GameMapPins_Pin___Array {
        namespace {
            inline app::Dictionary_2_TKey_TValue_Entry_GameMapPins_PinColour_GameMapPins_Pin___Array__Class* type_info_ref = nullptr;
        }
        inline app::Dictionary_2_TKey_TValue_Entry_GameMapPins_PinColour_GameMapPins_Pin___Array__Class** type_info = &type_info_ref;

...
struct Dictionary_2_TKey_TValue_Entry_System_String_Newtonsoft_Json_Linq_JToken___Array__VTable {
};

struct Dictionary_2_TKey_TValue_Entry_System_String_Newtonsoft_Json_Linq_JToken___Array__StaticFields {
};

struct Dictionary_2_TKey_TValue_Entry_System_String_Newtonsoft_Json_Linq_JToken___Array__Class {
    Il2CppClass_0 _0;
    Il2CppRuntimeInterfaceOffsetPair *interfaceOffsets;
    struct Dictionary_2_TKey_TValue_Entry_System_String_Newtonsoft_Json_Linq_JToken___Array__StaticFields *static_fields;
    const Il2CppRGCTXData *rgctx_data;
    Il2CppClass_1 _1;
    struct Dictionary_2_TKey_TValue_Entry_System_String_Newtonsoft_Json_Linq_JToken___Array__VTable vtable;
};
...
struct JToken___VTable {
};

struct JToken___StaticFields {
};

struct JToken___Class {
    Il2CppClass_0 _0;
    Il2CppRuntimeInterfaceOffsetPair *interfaceOffsets;
    struct JToken___StaticFields *static_fields;
    const Il2CppRGCTXData *rgctx_data;
    Il2CppClass_1 _1;
    struct JToken___VTable vtable;
};
...
struct KeyValuePair_2_System_String_Newtonsoft_Json_Linq_JToken___Array__VTable {
};

struct KeyValuePair_2_System_String_Newtonsoft_Json_Linq_JToken___Array__StaticFields {
};

struct KeyValuePair_2_System_String_Newtonsoft_Json_Linq_JToken___Array__Class {
    Il2CppClass_0 _0;
    Il2CppRuntimeInterfaceOffsetPair *interfaceOffsets;
    struct KeyValuePair_2_System_String_Newtonsoft_Json_Linq_JToken___Array__StaticFields *static_fields;
    const Il2CppRGCTXData *rgctx_data;
    Il2CppClass_1 _1;
    struct KeyValuePair_2_System_String_Newtonsoft_Json_Linq_JToken___Array__VTable vtable;
};

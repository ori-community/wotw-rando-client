...
namespace app::classes::types {
    namespace OriGhostRigVisuals_GhostVisualSettings__Array {
        namespace {
            inline app::OriGhostRigVisuals_GhostVisualSettings__Array__Class* type_info_ref = nullptr;
        }
        inline app::OriGhostRigVisuals_GhostVisualSettings__Array__Class** type_info = &type_info_ref;

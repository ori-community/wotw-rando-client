...
namespace app::classes::types {
    namespace UberShaderTextureBase_SubBindIdCache__Array {
        namespace {
            app::UberShaderTextureBase_SubBindIdCache__Array__Class* type_info_ref = nullptr;
        }
        app::UberShaderTextureBase_SubBindIdCache__Array__Class** type_info = &type_info_ref;

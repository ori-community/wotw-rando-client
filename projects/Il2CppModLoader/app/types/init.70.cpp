...
namespace app::classes::types {
    namespace AllEnemiesKilledTrigger {
        IL2CPP_MODLOADER_DLLEXPORT ::app::AllEnemiesKilledTrigger__Class** type_info = (::app::AllEnemiesKilledTrigger__Class**)(modloader::win::memory::resolve_rva(0x047560E8));
    }
    namespace AutoDamageCollider_AutoDamageColliderEntry {
        IL2CPP_MODLOADER_DLLEXPORT ::app::AutoDamageCollider_AutoDamageColliderEntry__Class** type_info = (::app::AutoDamageCollider_AutoDamageColliderEntry__Class**)(modloader::win::memory::resolve_rva(0x04790E50));
    }
    namespace AutoDamageCollider_c {
        IL2CPP_MODLOADER_DLLEXPORT ::app::AutoDamageCollider_c__Class** type_info = (::app::AutoDamageCollider_c__Class**)(modloader::win::memory::resolve_rva(0x04791D90));
    }
    namespace AutoDamageColliderResolver {
        IL2CPP_MODLOADER_DLLEXPORT ::app::AutoDamageColliderResolver__Class** type_info = (::app::AutoDamageColliderResolver__Class**)(modloader::win::memory::resolve_rva(0x04710E48));
    }
    namespace DamageResultContext {
        IL2CPP_MODLOADER_DLLEXPORT ::app::DamageResultContext__Class** type_info = (::app::DamageResultContext__Class**)(modloader::win::memory::resolve_rva(0x04705EB8));
    }
    namespace Damage_c {
        IL2CPP_MODLOADER_DLLEXPORT ::app::Damage_c__Class** type_info = (::app::Damage_c__Class**)(modloader::win::memory::resolve_rva(0x0473FCB0));
    }
    namespace DamageDealer_c {
        IL2CPP_MODLOADER_DLLEXPORT ::app::DamageDealer_c__Class** type_info = (::app::DamageDealer_c__Class**)(modloader::win::memory::resolve_rva(0x0477D1D0));
    }
    namespace EnemyArenaController_WaveStatus__Enum {
        IL2CPP_MODLOADER_DLLEXPORT ::app::EnemyArenaController_WaveStatus__Enum__Class** type_info = (::app::EnemyArenaController_WaveStatus__Enum__Class**)(modloader::win::memory::resolve_rva(0x04726CC0));
    }
    namespace EnemyArenaController_EnemyWave {
        IL2CPP_MODLOADER_DLLEXPORT ::app::EnemyArenaController_EnemyWave__Class** type_info = (::app::EnemyArenaController_EnemyWave__Class**)(modloader::win::memory::resolve_rva(0x04732F50));
    }
    namespace SpriteAnimator_c {
        IL2CPP_MODLOADER_DLLEXPORT ::app::SpriteAnimator_c__Class** type_info = (::app::SpriteAnimator_c__Class**)(modloader::win::memory::resolve_rva(0x04755828));
    }
    namespace SpriteAnimatorWithTransitions_c {
        IL2CPP_MODLOADER_DLLEXPORT ::app::SpriteAnimatorWithTransitions_c__Class** type_info = (::app::SpriteAnimatorWithTransitions_c__Class**)(modloader::win::memory::resolve_rva(0x04752D58));
    }
    namespace TextureAnimation_c_DisplayClass15_0 {
        IL2CPP_MODLOADER_DLLEXPORT ::app::TextureAnimation_c_DisplayClass15_0__Class** type_info = (::app::TextureAnimation_c_DisplayClass15_0__Class**)(modloader::win::memory::resolve_rva(0x04790CB8));
    }
    namespace TextureAnimator_c {
        IL2CPP_MODLOADER_DLLEXPORT ::app::TextureAnimator_c__Class** type_info = (::app::TextureAnimator_c__Class**)(modloader::win::memory::resolve_rva(0x0475B798));
    }
    namespace DashOwlEnemy_States {
        IL2CPP_MODLOADER_DLLEXPORT ::app::DashOwlEnemy_States__Class** type_info = (::app::DashOwlEnemy_States__Class**)(modloader::win::memory::resolve_rva(0x0477B468));
    }
    namespace DashOwlIdleState {
        IL2CPP_MODLOADER_DLLEXPORT ::app::DashOwlIdleState__Class** type_info = (::app::DashOwlIdleState__Class**)(modloader::win::memory::resolve_rva(0x04736100));
    }
    namespace DashOwlFlyHomeState {
        IL2CPP_MODLOADER_DLLEXPORT ::app::DashOwlFlyHomeState__Class** type_info = (::app::DashOwlFlyHomeState__Class**)(modloader::win::memory::resolve_rva(0x047979A8));
    }
    namespace DashOwlBashedState {
        IL2CPP_MODLOADER_DLLEXPORT ::app::DashOwlBashedState__Class** type_info = (::app::DashOwlBashedState__Class**)(modloader::win::memory::resolve_rva(0x0474EEE0));
    }
    namespace DashOwlBounceState {
        IL2CPP_MODLOADER_DLLEXPORT ::app::DashOwlBounceState__Class** type_info = (::app::DashOwlBounceState__Class**)(modloader::win::memory::resolve_rva(0x04723580));
    }
    namespace DashOwlDashState {
        IL2CPP_MODLOADER_DLLEXPORT ::app::DashOwlDashState__Class** type_info = (::app::DashOwlDashState__Class**)(modloader::win::memory::resolve_rva(0x047096D0));
    }
    namespace DashOwlDashAlertState {
        IL2CPP_MODLOADER_DLLEXPORT ::app::DashOwlDashAlertState__Class** type_info = (::app::DashOwlDashAlertState__Class**)(modloader::win::memory::resolve_rva(0x04736340));
    }
    namespace DashOwlHurtState {
        IL2CPP_MODLOADER_DLLEXPORT ::app::DashOwlHurtState__Class** type_info = (::app::DashOwlHurtState__Class**)(modloader::win::memory::resolve_rva(0x0478B268));
    }
    namespace DashOwlSpiritLeashedState {
        IL2CPP_MODLOADER_DLLEXPORT ::app::DashOwlSpiritLeashedState__Class** type_info = (::app::DashOwlSpiritLeashedState__Class**)(modloader::win::memory::resolve_rva(0x04704B30));
    }
    namespace DashOwlEnemy_c {
        IL2CPP_MODLOADER_DLLEXPORT ::app::DashOwlEnemy_c__Class** type_info = (::app::DashOwlEnemy_c__Class**)(modloader::win::memory::resolve_rva(0x04702AF8));
    }
    namespace DropSlugAlertState {
        IL2CPP_MODLOADER_DLLEXPORT ::app::DropSlugAlertState__Class** type_info = (::app::DropSlugAlertState__Class**)(modloader::win::memory::resolve_rva(0x0471F140));
    }
    namespace DropSlugEnemy_States {
        IL2CPP_MODLOADER_DLLEXPORT ::app::DropSlugEnemy_States__Class** type_info = (::app::DropSlugEnemy_States__Class**)(modloader::win::memory::resolve_rva(0x047109B0));
    }
    namespace DropSlugIdleState {
        IL2CPP_MODLOADER_DLLEXPORT ::app::DropSlugIdleState__Class** type_info = (::app::DropSlugIdleState__Class**)(modloader::win::memory::resolve_rva(0x0472A818));
    }
    ...
    namespace IRespawnReciever {
        IL2CPP_MODLOADER_DLLEXPORT ::app::IRespawnReciever__Class** type_info = (::app::IRespawnReciever__Class**)(modloader::win::memory::resolve_rva(0x04796AC0));
    }

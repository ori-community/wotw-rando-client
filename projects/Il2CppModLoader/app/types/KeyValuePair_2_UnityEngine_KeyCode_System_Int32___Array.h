...
namespace app::classes::types {
    namespace KeyValuePair_2_UnityEngine_KeyCode_System_Int32___Array {
        namespace {
            app::KeyValuePair_2_UnityEngine_KeyCode_System_Int32___Array__Class* type_info_ref = nullptr;
        }
        app::KeyValuePair_2_UnityEngine_KeyCode_System_Int32___Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_Oculus_NightVision1 {
        inline app::ShaderID_CameraFilterPack_Oculus_NightVision1__Class** type_info = (app::ShaderID_CameraFilterPack_Oculus_NightVision1__Class**)(modloader::win::memory::resolve_rva(0x04793E48));

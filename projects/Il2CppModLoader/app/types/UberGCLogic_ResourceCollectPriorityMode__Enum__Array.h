...
namespace app::classes::types {
    namespace UberGCLogic_ResourceCollectPriorityMode__Enum__Array {
        namespace {
            inline app::UberGCLogic_ResourceCollectPriorityMode__Enum__Array__Class* type_info_ref = nullptr;
        }
        inline app::UberGCLogic_ResourceCollectPriorityMode__Enum__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace UberGCLogic_ResourceCollectPriorityMode__Enum__Array {
        namespace {
            app::UberGCLogic_ResourceCollectPriorityMode__Enum__Array__Class* type_info_ref = nullptr;
        }
        app::UberGCLogic_ResourceCollectPriorityMode__Enum__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace GroundAreaPatrolBehaviourNew_GroundAreaPatrolModeType__Enum {
        namespace {
            app::GroundAreaPatrolBehaviourNew_GroundAreaPatrolModeType__Enum__Class* type_info_ref = nullptr;
        }
        app::GroundAreaPatrolBehaviourNew_GroundAreaPatrolModeType__Enum__Class** type_info = &type_info_ref;

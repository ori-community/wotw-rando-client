...
namespace app::classes::types {
    namespace PreRecordingDynamicSceneObjectEntry__Array {
        namespace {
            app::PreRecordingDynamicSceneObjectEntry__Array__Class* type_info_ref = nullptr;
        }
        app::PreRecordingDynamicSceneObjectEntry__Array__Class** type_info = &type_info_ref;

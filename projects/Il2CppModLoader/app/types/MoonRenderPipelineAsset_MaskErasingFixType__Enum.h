...
namespace app::classes::types {
    namespace MoonRenderPipelineAsset_MaskErasingFixType__Enum {
        namespace {
            app::MoonRenderPipelineAsset_MaskErasingFixType__Enum__Class* type_info_ref = nullptr;
        }
        app::MoonRenderPipelineAsset_MaskErasingFixType__Enum__Class** type_info = &type_info_ref;

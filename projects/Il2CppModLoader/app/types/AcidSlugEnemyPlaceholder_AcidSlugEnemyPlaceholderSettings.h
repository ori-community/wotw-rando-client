...
namespace app::classes::types {
    namespace AcidSlugEnemyPlaceholder_AcidSlugEnemyPlaceholderSettings {
        namespace {
            app::AcidSlugEnemyPlaceholder_AcidSlugEnemyPlaceholderSettings__Class* type_info_ref = nullptr;
        }
        app::AcidSlugEnemyPlaceholder_AcidSlugEnemyPlaceholderSettings__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace UberPoolPerfTest_BenchmarkSinglePrefabProfiler_d_38 {
        namespace {
            app::UberPoolPerfTest_BenchmarkSinglePrefabProfiler_d_38__Class* type_info_ref = nullptr;
        }
        app::UberPoolPerfTest_BenchmarkSinglePrefabProfiler_d_38__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace MantisHorizontalJumpAttackBehaviour {
        namespace {
            inline app::MantisHorizontalJumpAttackBehaviour__Class* type_info_ref = nullptr;
        }
        inline app::MantisHorizontalJumpAttackBehaviour__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace XmlSchemaObjectTable_EnumeratorType__Enum {
        namespace {
            app::XmlSchemaObjectTable_EnumeratorType__Enum__Class* type_info_ref = nullptr;
        }
        app::XmlSchemaObjectTable_EnumeratorType__Enum__Class** type_info = &type_info_ref;

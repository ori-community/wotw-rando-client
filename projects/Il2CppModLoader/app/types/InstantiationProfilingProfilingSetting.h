...
namespace app::classes::types {
    namespace InstantiationProfilingProfilingSetting {
        namespace {
            inline app::InstantiationProfilingProfilingSetting__Class* type_info_ref = nullptr;
        }
        inline app::InstantiationProfilingProfilingSetting__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace CameraFilterPack_Blend2Camera_SplitScreen {
        inline app::CameraFilterPack_Blend2Camera_SplitScreen__Class** type_info = (app::CameraFilterPack_Blend2Camera_SplitScreen__Class**)(modloader::win::memory::resolve_rva(0x0478CA98));

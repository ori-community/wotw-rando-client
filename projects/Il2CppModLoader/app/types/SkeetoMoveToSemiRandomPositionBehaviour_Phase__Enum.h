...
namespace app::classes::types {
    namespace SkeetoMoveToSemiRandomPositionBehaviour_Phase__Enum {
        namespace {
            inline app::SkeetoMoveToSemiRandomPositionBehaviour_Phase__Enum__Class* type_info_ref = nullptr;
        }
        inline app::SkeetoMoveToSemiRandomPositionBehaviour_Phase__Enum__Class** type_info = &type_info_ref;

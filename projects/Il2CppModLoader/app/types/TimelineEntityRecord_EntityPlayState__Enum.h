...
namespace app::classes::types {
    namespace TimelineEntityRecord_EntityPlayState__Enum {
        namespace {
            app::TimelineEntityRecord_EntityPlayState__Enum__Class* type_info_ref = nullptr;
        }
        app::TimelineEntityRecord_EntityPlayState__Enum__Class** type_info = &type_info_ref;

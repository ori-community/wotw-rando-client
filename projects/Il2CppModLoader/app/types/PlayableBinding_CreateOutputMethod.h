...
namespace app::classes::types {
    namespace PlayableBinding_CreateOutputMethod {
        namespace {
            inline app::PlayableBinding_CreateOutputMethod__Class* type_info_ref = nullptr;
        }
        inline app::PlayableBinding_CreateOutputMethod__Class** type_info = &type_info_ref;

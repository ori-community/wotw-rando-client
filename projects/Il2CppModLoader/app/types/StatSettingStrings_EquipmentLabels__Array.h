...
namespace app::classes::types {
    namespace StatSettingStrings_EquipmentLabels__Array {
        namespace {
            app::StatSettingStrings_EquipmentLabels__Array__Class* type_info_ref = nullptr;
        }
        app::StatSettingStrings_EquipmentLabels__Array__Class** type_info = &type_info_ref;

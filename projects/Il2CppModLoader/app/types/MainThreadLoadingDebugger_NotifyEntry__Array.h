...
namespace app::classes::types {
    namespace MainThreadLoadingDebugger_NotifyEntry__Array {
        namespace {
            app::MainThreadLoadingDebugger_NotifyEntry__Array__Class* type_info_ref = nullptr;
        }
        app::MainThreadLoadingDebugger_NotifyEntry__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace UberShaderAtlasUtilities_TextureInfo__Array {
        namespace {
            app::UberShaderAtlasUtilities_TextureInfo__Array__Class* type_info_ref = nullptr;
        }
        app::UberShaderAtlasUtilities_TextureInfo__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_TV_VHS_Rewind {
        inline app::ShaderID_CameraFilterPack_TV_VHS_Rewind__Class** type_info = (app::ShaderID_CameraFilterPack_TV_VHS_Rewind__Class**)(modloader::win::memory::resolve_rva(0x04728270));

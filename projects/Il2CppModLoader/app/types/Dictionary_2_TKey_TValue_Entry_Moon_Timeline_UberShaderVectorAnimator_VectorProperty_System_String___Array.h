...
namespace app::classes::types {
    namespace Dictionary_2_TKey_TValue_Entry_Moon_Timeline_UberShaderVectorAnimator_VectorProperty_System_String___Array {
        namespace {
            app::Dictionary_2_TKey_TValue_Entry_Moon_Timeline_UberShaderVectorAnimator_VectorProperty_System_String___Array__Class* type_info_ref = nullptr;
        }
        app::Dictionary_2_TKey_TValue_Entry_Moon_Timeline_UberShaderVectorAnimator_VectorProperty_System_String___Array__Class** type_info = &type_info_ref;

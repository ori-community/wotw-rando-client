...
namespace app::classes::types {
    namespace SeinInteraction_ThrownKeystone__Array {
        namespace {
            inline app::SeinInteraction_ThrownKeystone__Array__Class* type_info_ref = nullptr;
        }
        inline app::SeinInteraction_ThrownKeystone__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace PetrifiedOwlBossBaseBehaviour_PetrifiedOwlBossBaseStatesSet {
        namespace {
            inline app::PetrifiedOwlBossBaseBehaviour_PetrifiedOwlBossBaseStatesSet__Class* type_info_ref = nullptr;
        }
        inline app::PetrifiedOwlBossBaseBehaviour_PetrifiedOwlBossBaseStatesSet__Class** type_info = &type_info_ref;

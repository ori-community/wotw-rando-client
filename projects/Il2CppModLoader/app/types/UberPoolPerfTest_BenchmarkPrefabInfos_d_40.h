...
namespace app::classes::types {
    namespace UberPoolPerfTest_BenchmarkPrefabInfos_d_40 {
        namespace {
            inline app::UberPoolPerfTest_BenchmarkPrefabInfos_d_40__Class* type_info_ref = nullptr;
        }
        inline app::UberPoolPerfTest_BenchmarkPrefabInfos_d_40__Class** type_info = &type_info_ref;

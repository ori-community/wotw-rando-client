...
namespace app::classes::types {
    namespace WandererNPC_State__Enum {
        namespace {
            app::WandererNPC_State__Enum__Class* type_info_ref = nullptr;
        }
        app::WandererNPC_State__Enum__Class** type_info = &type_info_ref;
        ...
        inline app::WandererNPC_State__Enum__Array* create_array(const std::vector<app::WandererNPC_State__Enum__Boxed*>& items) {

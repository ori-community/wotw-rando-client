...
namespace app::classes::types {
    namespace HornBugStunBehaviour_IncapacitationPhase__Enum {
        namespace {
            app::HornBugStunBehaviour_IncapacitationPhase__Enum__Class* type_info_ref = nullptr;
        }
        app::HornBugStunBehaviour_IncapacitationPhase__Enum__Class** type_info = &type_info_ref;

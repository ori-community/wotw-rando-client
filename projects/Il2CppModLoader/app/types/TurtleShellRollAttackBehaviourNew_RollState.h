...
namespace app::classes::types {
    namespace TurtleShellRollAttackBehaviourNew_RollState {
        namespace {
            app::TurtleShellRollAttackBehaviourNew_RollState__Class* type_info_ref = nullptr;
        }
        app::TurtleShellRollAttackBehaviourNew_RollState__Class** type_info = &type_info_ref;

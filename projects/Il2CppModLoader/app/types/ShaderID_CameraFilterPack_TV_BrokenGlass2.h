...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_TV_BrokenGlass2 {
        inline app::ShaderID_CameraFilterPack_TV_BrokenGlass2__Class** type_info = (app::ShaderID_CameraFilterPack_TV_BrokenGlass2__Class**)(modloader::win::memory::resolve_rva(0x04726FB8));

...
namespace app::classes::types {
    namespace IEnumerable_1_System_Security_Claims_Claim___Array {
        namespace {
            app::IEnumerable_1_System_Security_Claims_Claim___Array__Class* type_info_ref = nullptr;
        }
        app::IEnumerable_1_System_Security_Claims_Claim___Array__Class** type_info = &type_info_ref;

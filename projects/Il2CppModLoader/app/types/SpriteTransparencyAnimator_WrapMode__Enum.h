...
namespace app::classes::types {
    namespace SpriteTransparencyAnimator_WrapMode__Enum {
        namespace {
            app::SpriteTransparencyAnimator_WrapMode__Enum__Class* type_info_ref = nullptr;
        }
        app::SpriteTransparencyAnimator_WrapMode__Enum__Class** type_info = &type_info_ref;

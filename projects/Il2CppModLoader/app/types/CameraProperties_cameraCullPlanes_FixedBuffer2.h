...
namespace app::classes::types {
    namespace CameraProperties_cameraCullPlanes_FixedBuffer2 {
        namespace {
            app::CameraProperties_cameraCullPlanes_FixedBuffer2__Class* type_info_ref = nullptr;
        }
        app::CameraProperties_cameraCullPlanes_FixedBuffer2__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace GameplaySoundManager_AudioQualitySetting__Enum {
        namespace {
            inline app::GameplaySoundManager_AudioQualitySetting__Enum__Class* type_info_ref = nullptr;
        }
        inline app::GameplaySoundManager_AudioQualitySetting__Enum__Class** type_info = &type_info_ref;

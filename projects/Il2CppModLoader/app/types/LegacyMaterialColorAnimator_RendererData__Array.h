...
namespace app::classes::types {
    namespace LegacyMaterialColorAnimator_RendererData__Array {
        namespace {
            app::LegacyMaterialColorAnimator_RendererData__Array__Class* type_info_ref = nullptr;
        }
        app::LegacyMaterialColorAnimator_RendererData__Array__Class** type_info = &type_info_ref;

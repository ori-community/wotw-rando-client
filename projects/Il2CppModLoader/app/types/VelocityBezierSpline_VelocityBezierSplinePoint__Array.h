...
namespace app::classes::types {
    namespace VelocityBezierSpline_VelocityBezierSplinePoint__Array {
        namespace {
            app::VelocityBezierSpline_VelocityBezierSplinePoint__Array__Class* type_info_ref = nullptr;
        }
        app::VelocityBezierSpline_VelocityBezierSplinePoint__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace UberShaderVectorAnimator_VectorProperty__Enum {
        namespace {
            app::UberShaderVectorAnimator_VectorProperty__Enum__Class* type_info_ref = nullptr;
        }
        app::UberShaderVectorAnimator_VectorProperty__Enum__Class** type_info = &type_info_ref;

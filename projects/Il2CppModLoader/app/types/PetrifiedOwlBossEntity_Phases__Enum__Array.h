...
namespace app::classes::types {
    namespace PetrifiedOwlBossEntity_Phases__Enum__Array {
        namespace {
            app::PetrifiedOwlBossEntity_Phases__Enum__Array__Class* type_info_ref = nullptr;
        }
        app::PetrifiedOwlBossEntity_Phases__Enum__Array__Class** type_info = &type_info_ref;

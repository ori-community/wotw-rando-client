...
namespace app::classes::types {
    namespace BezierSpline_BezierSplinePoint__Array {
        namespace {
            inline app::BezierSpline_BezierSplinePoint__Array__Class* type_info_ref = nullptr;
        }
        inline app::BezierSpline_BezierSplinePoint__Array__Class** type_info = &type_info_ref;

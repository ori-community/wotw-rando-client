...
namespace app::classes::types {
    namespace AttachSpriteToPhysicsSystem_SystemWithMonoBehaviour_Samplers {
        namespace {
            app::AttachSpriteToPhysicsSystem_SystemWithMonoBehaviour_Samplers__Class* type_info_ref = nullptr;
        }
        app::AttachSpriteToPhysicsSystem_SystemWithMonoBehaviour_Samplers__Class** type_info = &type_info_ref;

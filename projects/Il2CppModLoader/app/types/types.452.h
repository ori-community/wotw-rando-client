...
struct ConnectedPlayer__Array__StaticFields {
};

struct ConnectedPlayer__Array__Class {
    Il2CppClass_0 _0;
    Il2CppRuntimeInterfaceOffsetPair *interfaceOffsets;
    struct ConnectedPlayer__Array__StaticFields *static_fields;
    const Il2CppRGCTXData *rgctx_data;
    Il2CppClass_1 _1;
    struct ConnectedPlayer__Array__VTable vtable;
};

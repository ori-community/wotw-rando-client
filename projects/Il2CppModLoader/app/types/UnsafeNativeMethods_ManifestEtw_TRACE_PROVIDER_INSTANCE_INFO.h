...
namespace app::classes::types {
    namespace UnsafeNativeMethods_ManifestEtw_TRACE_PROVIDER_INSTANCE_INFO {
        namespace {
            app::UnsafeNativeMethods_ManifestEtw_TRACE_PROVIDER_INSTANCE_INFO__Class* type_info_ref = nullptr;
        }
        app::UnsafeNativeMethods_ManifestEtw_TRACE_PROVIDER_INSTANCE_INFO__Class** type_info = &type_info_ref;

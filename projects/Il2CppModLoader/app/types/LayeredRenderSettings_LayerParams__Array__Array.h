...
namespace app::classes::types {
    namespace LayeredRenderSettings_LayerParams__Array__Array {
        namespace {
            inline app::LayeredRenderSettings_LayerParams__Array__Array__Class* type_info_ref = nullptr;
        }
        inline app::LayeredRenderSettings_LayerParams__Array__Array__Class** type_info = &type_info_ref;

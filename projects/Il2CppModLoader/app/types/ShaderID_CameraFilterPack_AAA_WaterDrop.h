...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_AAA_WaterDrop {
        inline app::ShaderID_CameraFilterPack_AAA_WaterDrop__Class** type_info = (app::ShaderID_CameraFilterPack_AAA_WaterDrop__Class**)(modloader::win::memory::resolve_rva(0x04731B30));

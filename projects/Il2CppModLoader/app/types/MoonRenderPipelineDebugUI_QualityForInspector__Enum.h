...
namespace app::classes::types {
    namespace MoonRenderPipelineDebugUI_QualityForInspector__Enum {
        namespace {
            app::MoonRenderPipelineDebugUI_QualityForInspector__Enum__Class* type_info_ref = nullptr;
        }
        app::MoonRenderPipelineDebugUI_QualityForInspector__Enum__Class** type_info = &type_info_ref;

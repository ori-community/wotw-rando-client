...
namespace app::classes::types {
    namespace SaveSlotsUI_StorageOperation__Array {
        namespace {
            inline app::SaveSlotsUI_StorageOperation__Array__Class* type_info_ref = nullptr;
        }
        inline app::SaveSlotsUI_StorageOperation__Array__Class** type_info = &type_info_ref;

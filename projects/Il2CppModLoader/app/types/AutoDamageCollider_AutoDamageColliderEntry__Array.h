...
namespace app::classes::types {
    namespace AutoDamageCollider_AutoDamageColliderEntry__Array {
        namespace {
            app::AutoDamageCollider_AutoDamageColliderEntry__Array__Class* type_info_ref = nullptr;
        }
        app::AutoDamageCollider_AutoDamageColliderEntry__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace JsonSerializerInternalReader_CreatorPropertyContext__Array {
        namespace {
            app::JsonSerializerInternalReader_CreatorPropertyContext__Array__Class* type_info_ref = nullptr;
        }
        app::JsonSerializerInternalReader_CreatorPropertyContext__Array__Class** type_info = &type_info_ref;

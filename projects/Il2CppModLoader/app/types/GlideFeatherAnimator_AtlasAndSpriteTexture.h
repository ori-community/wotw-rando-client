...
namespace app::classes::types {
    namespace GlideFeatherAnimator_AtlasAndSpriteTexture {
        namespace {
            inline app::GlideFeatherAnimator_AtlasAndSpriteTexture__Class* type_info_ref = nullptr;
        }
        inline app::GlideFeatherAnimator_AtlasAndSpriteTexture__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace GhostAnimationParameterPlugin_FloatParamenterTracker__Array {
        namespace {
            app::GhostAnimationParameterPlugin_FloatParamenterTracker__Array__Class* type_info_ref = nullptr;
        }
        app::GhostAnimationParameterPlugin_FloatParamenterTracker__Array__Class** type_info = &type_info_ref;

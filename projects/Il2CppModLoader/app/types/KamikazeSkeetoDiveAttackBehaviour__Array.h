...
namespace app::classes::types {
    namespace KamikazeSkeetoDiveAttackBehaviour__Array {
        namespace {
            inline app::KamikazeSkeetoDiveAttackBehaviour__Array__Class* type_info_ref = nullptr;
        }
        inline app::KamikazeSkeetoDiveAttackBehaviour__Array__Class** type_info = &type_info_ref;

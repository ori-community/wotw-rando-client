...
namespace app::classes::types {
    namespace LeaderboardTableUI_LeaderboardMetaData__Array {
        namespace {
            app::LeaderboardTableUI_LeaderboardMetaData__Array__Class* type_info_ref = nullptr;
        }
        app::LeaderboardTableUI_LeaderboardMetaData__Array__Class** type_info = &type_info_ref;

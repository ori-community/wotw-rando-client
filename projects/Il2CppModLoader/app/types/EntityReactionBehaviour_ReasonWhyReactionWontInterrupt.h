...
namespace app::classes::types {
    namespace EntityReactionBehaviour_ReasonWhyReactionWontInterrupt {
        namespace {
            app::EntityReactionBehaviour_ReasonWhyReactionWontInterrupt__Class* type_info_ref = nullptr;
        }
        app::EntityReactionBehaviour_ReasonWhyReactionWontInterrupt__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace XmlSchemaObjectTable_XmlSchemaObjectEntry__Array {
        namespace {
            app::XmlSchemaObjectTable_XmlSchemaObjectEntry__Array__Class* type_info_ref = nullptr;
        }
        app::XmlSchemaObjectTable_XmlSchemaObjectEntry__Array__Class** type_info = &type_info_ref;

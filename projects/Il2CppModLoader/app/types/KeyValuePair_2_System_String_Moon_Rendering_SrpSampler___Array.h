...
namespace app::classes::types {
    namespace KeyValuePair_2_System_String_Moon_Rendering_SrpSampler___Array {
        namespace {
            inline app::KeyValuePair_2_System_String_Moon_Rendering_SrpSampler___Array__Class* type_info_ref = nullptr;
        }
        inline app::KeyValuePair_2_System_String_Moon_Rendering_SrpSampler___Array__Class** type_info = &type_info_ref;

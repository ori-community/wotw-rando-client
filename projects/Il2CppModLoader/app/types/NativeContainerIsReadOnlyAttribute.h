...
namespace app::classes::types {
    namespace NativeContainerIsReadOnlyAttribute {
        namespace {
            inline app::NativeContainerIsReadOnlyAttribute__Class* type_info_ref = nullptr;
        }
        inline app::NativeContainerIsReadOnlyAttribute__Class** type_info = &type_info_ref;

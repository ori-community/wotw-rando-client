...
namespace app::classes::types {
    namespace Initialization_AsyncUploadTimeSlicedUpdate {
        namespace {
            app::Initialization_AsyncUploadTimeSlicedUpdate__Class* type_info_ref = nullptr;
        }
        app::Initialization_AsyncUploadTimeSlicedUpdate__Class** type_info = &type_info_ref;

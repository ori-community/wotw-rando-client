...
namespace app::classes::types {
    namespace UberTextureSettingsAnimator_TextureName__Enum {
        namespace {
            inline app::UberTextureSettingsAnimator_TextureName__Enum__Class* type_info_ref = nullptr;
        }
        inline app::UberTextureSettingsAnimator_TextureName__Enum__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace PhysicalSystemState_PhysicalSystemStateType__Enum {
        namespace {
            app::PhysicalSystemState_PhysicalSystemStateType__Enum__Class* type_info_ref = nullptr;
        }
        app::PhysicalSystemState_PhysicalSystemStateType__Enum__Class** type_info = &type_info_ref;

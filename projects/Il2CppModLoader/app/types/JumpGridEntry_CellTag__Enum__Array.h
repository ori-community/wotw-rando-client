...
namespace app::classes::types {
    namespace JumpGridEntry_CellTag__Enum__Array {
        namespace {
            inline app::JumpGridEntry_CellTag__Enum__Array__Class* type_info_ref = nullptr;
        }
        inline app::JumpGridEntry_CellTag__Enum__Array__Class** type_info = &type_info_ref;

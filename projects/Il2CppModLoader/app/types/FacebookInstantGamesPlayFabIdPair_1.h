...
namespace app::classes::types {
    namespace FacebookInstantGamesPlayFabIdPair_1 {
        namespace {
            inline app::FacebookInstantGamesPlayFabIdPair_1__Class* type_info_ref = nullptr;
        }
        inline app::FacebookInstantGamesPlayFabIdPair_1__Class** type_info = &type_info_ref;

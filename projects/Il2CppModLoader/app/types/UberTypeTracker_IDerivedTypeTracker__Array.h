...
namespace app::classes::types {
    namespace UberTypeTracker_IDerivedTypeTracker__Array {
        namespace {
            app::UberTypeTracker_IDerivedTypeTracker__Array__Class* type_info_ref = nullptr;
        }
        app::UberTypeTracker_IDerivedTypeTracker__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace InputCacheManager_SetupTempData_Node__Array {
        namespace {
            inline app::InputCacheManager_SetupTempData_Node__Array__Class* type_info_ref = nullptr;
        }
        inline app::InputCacheManager_SetupTempData_Node__Array__Class** type_info = &type_info_ref;

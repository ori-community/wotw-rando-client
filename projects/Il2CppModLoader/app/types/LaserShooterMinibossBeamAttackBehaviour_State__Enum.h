...
namespace app::classes::types {
    namespace LaserShooterMinibossBeamAttackBehaviour_State__Enum {
        namespace {
            app::LaserShooterMinibossBeamAttackBehaviour_State__Enum__Class* type_info_ref = nullptr;
        }
        app::LaserShooterMinibossBeamAttackBehaviour_State__Enum__Class** type_info = &type_info_ref;

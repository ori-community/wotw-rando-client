...
namespace app::classes::types {
    namespace IConvertible {
        IL2CPP_MODLOADER_DLLEXPORT ::app::IConvertible__Class** type_info = (::app::IConvertible__Class**)(modloader::win::memory::resolve_rva(0x0470FB60));
    }
    ...
    namespace IMessageSink {
        IL2CPP_MODLOADER_DLLEXPORT ::app::IMessageSink__Class** type_info = (::app::IMessageSink__Class**)(modloader::win::memory::resolve_rva(0x0478BC38));
    }
    namespace IContextProperty {
        IL2CPP_MODLOADER_DLLEXPORT ::app::IContextProperty__Class** type_info = (::app::IContextProperty__Class**)(modloader::win::memory::resolve_rva(0x0473FEF0));
    }

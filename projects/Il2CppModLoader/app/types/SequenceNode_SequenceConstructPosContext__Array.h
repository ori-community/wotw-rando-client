...
namespace app::classes::types {
    namespace SequenceNode_SequenceConstructPosContext__Array {
        namespace {
            app::SequenceNode_SequenceConstructPosContext__Array__Class* type_info_ref = nullptr;
        }
        app::SequenceNode_SequenceConstructPosContext__Array__Class** type_info = &type_info_ref;

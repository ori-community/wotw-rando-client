...
namespace app::classes::types {
    namespace WorldCoordinatesMap_SegmentDirection__Enum {
        namespace {
            app::WorldCoordinatesMap_SegmentDirection__Enum__Class* type_info_ref = nullptr;
        }
        app::WorldCoordinatesMap_SegmentDirection__Enum__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace AkAudioInputManager_AudioFormatDelegate__Array {
        namespace {
            app::AkAudioInputManager_AudioFormatDelegate__Array__Class* type_info_ref = nullptr;
        }
        app::AkAudioInputManager_AudioFormatDelegate__Array__Class** type_info = &type_info_ref;

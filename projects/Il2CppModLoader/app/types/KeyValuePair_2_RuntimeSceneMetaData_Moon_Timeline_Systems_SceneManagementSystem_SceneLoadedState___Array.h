...
namespace app::classes::types {
    namespace KeyValuePair_2_RuntimeSceneMetaData_Moon_Timeline_Systems_SceneManagementSystem_SceneLoadedState___Array {
        namespace {
            app::KeyValuePair_2_RuntimeSceneMetaData_Moon_Timeline_Systems_SceneManagementSystem_SceneLoadedState___Array__Class* type_info_ref = nullptr;
        }
        app::KeyValuePair_2_RuntimeSceneMetaData_Moon_Timeline_Systems_SceneManagementSystem_SceneLoadedState___Array__Class** type_info = &type_info_ref;

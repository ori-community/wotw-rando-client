...
namespace app::classes::types {
    namespace StatisticsManager_StatType__Enum {
        namespace {
            app::StatisticsManager_StatType__Enum__Class* type_info_ref = nullptr;
        }
        app::StatisticsManager_StatType__Enum__Class** type_info = &type_info_ref;
        ...
        inline app::StatisticsManager_StatType__Enum__Array* create_array(const std::vector<app::StatisticsManager_StatType__Enum__Boxed*>& items) {

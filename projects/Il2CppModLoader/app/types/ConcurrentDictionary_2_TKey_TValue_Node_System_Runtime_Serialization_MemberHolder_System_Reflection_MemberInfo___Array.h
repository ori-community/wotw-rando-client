...
namespace app::classes::types {
    namespace ConcurrentDictionary_2_TKey_TValue_Node_System_Runtime_Serialization_MemberHolder_System_Reflection_MemberInfo___Array {
        namespace {
            inline app::ConcurrentDictionary_2_TKey_TValue_Node_System_Runtime_Serialization_MemberHolder_System_Reflection_MemberInfo___Array__Class* type_info_ref = nullptr;
        }
        inline app::ConcurrentDictionary_2_TKey_TValue_Node_System_Runtime_Serialization_MemberHolder_System_Reflection_MemberInfo___Array__Class** type_info = &type_info_ref;

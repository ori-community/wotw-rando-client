...
namespace app::classes::types {
    namespace SeinBashVersionAsset_BashVersion__Enum {
        namespace {
            inline app::SeinBashVersionAsset_BashVersion__Enum__Class* type_info_ref = nullptr;
        }
        inline app::SeinBashVersionAsset_BashVersion__Enum__Class** type_info = &type_info_ref;

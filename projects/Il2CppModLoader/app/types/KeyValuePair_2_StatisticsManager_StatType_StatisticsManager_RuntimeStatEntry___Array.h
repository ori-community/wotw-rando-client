...
namespace app::classes::types {
    namespace KeyValuePair_2_StatisticsManager_StatType_StatisticsManager_RuntimeStatEntry___Array {
        namespace {
            app::KeyValuePair_2_StatisticsManager_StatType_StatisticsManager_RuntimeStatEntry___Array__Class* type_info_ref = nullptr;
        }
        app::KeyValuePair_2_StatisticsManager_StatType_StatisticsManager_RuntimeStatEntry___Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace CameraFilterPack_Colors_Adjust_PreFilters {
        namespace {
            app::CameraFilterPack_Colors_Adjust_PreFilters__Class* type_info_ref = nullptr;
        }
        app::CameraFilterPack_Colors_Adjust_PreFilters__Class** type_info = &type_info_ref;

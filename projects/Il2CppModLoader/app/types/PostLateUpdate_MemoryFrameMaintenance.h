...
namespace app::classes::types {
    namespace PostLateUpdate_MemoryFrameMaintenance {
        namespace {
            inline app::PostLateUpdate_MemoryFrameMaintenance__Class* type_info_ref = nullptr;
        }
        inline app::PostLateUpdate_MemoryFrameMaintenance__Class** type_info = &type_info_ref;

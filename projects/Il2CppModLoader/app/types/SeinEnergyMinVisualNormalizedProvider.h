...
namespace app::classes::types {
    namespace SeinEnergyMinVisualNormalizedProvider {
        namespace {
            inline app::SeinEnergyMinVisualNormalizedProvider__Class* type_info_ref = nullptr;
        }
        inline app::SeinEnergyMinVisualNormalizedProvider__Class** type_info = &type_info_ref;

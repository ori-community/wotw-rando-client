...
namespace app::classes::types {
    namespace MoonRenderPipelineView_SrpProfilerFrame_Slice {
        ...
        inline app::MoonRenderPipelineView_SrpProfilerFrame_Slice__Array* create_array(const std::vector<app::MoonRenderPipelineView_SrpProfilerFrame_Slice__Boxed>& items) {

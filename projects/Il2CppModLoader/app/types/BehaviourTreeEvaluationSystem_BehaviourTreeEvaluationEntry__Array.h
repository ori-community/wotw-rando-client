...
namespace app::classes::types {
    namespace BehaviourTreeEvaluationSystem_BehaviourTreeEvaluationEntry__Array {
        namespace {
            app::BehaviourTreeEvaluationSystem_BehaviourTreeEvaluationEntry__Array__Class* type_info_ref = nullptr;
        }
        app::BehaviourTreeEvaluationSystem_BehaviourTreeEvaluationEntry__Array__Class** type_info = &type_info_ref;

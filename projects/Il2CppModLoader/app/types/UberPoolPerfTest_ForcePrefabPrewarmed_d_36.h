...
namespace app::classes::types {
    namespace UberPoolPerfTest_ForcePrefabPrewarmed_d_36 {
        namespace {
            app::UberPoolPerfTest_ForcePrefabPrewarmed_d_36__Class* type_info_ref = nullptr;
        }
        app::UberPoolPerfTest_ForcePrefabPrewarmed_d_36__Class** type_info = &type_info_ref;

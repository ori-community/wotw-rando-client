...
namespace app::classes::types {
    namespace SkeetoDiveAttackBehaviour_DiveAttackState__Enum {
        namespace {
            app::SkeetoDiveAttackBehaviour_DiveAttackState__Enum__Class* type_info_ref = nullptr;
        }
        app::SkeetoDiveAttackBehaviour_DiveAttackState__Enum__Class** type_info = &type_info_ref;

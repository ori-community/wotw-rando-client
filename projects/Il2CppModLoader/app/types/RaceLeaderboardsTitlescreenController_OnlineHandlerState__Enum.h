...
namespace app::classes::types {
    namespace RaceLeaderboardsTitlescreenController_OnlineHandlerState__Enum {
        namespace {
            app::RaceLeaderboardsTitlescreenController_OnlineHandlerState__Enum__Class* type_info_ref = nullptr;
        }
        app::RaceLeaderboardsTitlescreenController_OnlineHandlerState__Enum__Class** type_info = &type_info_ref;

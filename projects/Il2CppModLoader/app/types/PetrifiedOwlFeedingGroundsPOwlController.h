...
namespace app::classes::types {
    namespace PetrifiedOwlFeedingGroundsPOwlController {
        namespace {
            inline app::PetrifiedOwlFeedingGroundsPOwlController__Class* type_info_ref = nullptr;
        }
        inline app::PetrifiedOwlFeedingGroundsPOwlController__Class** type_info = &type_info_ref;

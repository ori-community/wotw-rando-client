...
namespace app::classes::types {
    namespace HornBugHitReactionBehaviour_NonInterruptibleTaskCondition {
        namespace {
            app::HornBugHitReactionBehaviour_NonInterruptibleTaskCondition__Class* type_info_ref = nullptr;
        }
        app::HornBugHitReactionBehaviour_NonInterruptibleTaskCondition__Class** type_info = &type_info_ref;

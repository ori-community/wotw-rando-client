...
namespace app::classes::types {
    namespace UberAtlasExclusions_SceneExclusion__Array {
        namespace {
            inline app::UberAtlasExclusions_SceneExclusion__Array__Class* type_info_ref = nullptr;
        }
        inline app::UberAtlasExclusions_SceneExclusion__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace XboxQualityModeManager_QualityMode__Enum__Array {
        namespace {
            app::XboxQualityModeManager_QualityMode__Enum__Array__Class* type_info_ref = nullptr;
        }
        app::XboxQualityModeManager_QualityMode__Enum__Array__Class** type_info = &type_info_ref;

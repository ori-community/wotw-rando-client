...
namespace app::classes::types {
    namespace TextureTilingAdjuster_AdjustedTexture__Array {
        namespace {
            inline app::TextureTilingAdjuster_AdjustedTexture__Array__Class* type_info_ref = nullptr;
        }
        inline app::TextureTilingAdjuster_AdjustedTexture__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace VibrationFramework_HidVibrationSlot__Enum {
        namespace {
            app::VibrationFramework_HidVibrationSlot__Enum__Class* type_info_ref = nullptr;
        }
        app::VibrationFramework_HidVibrationSlot__Enum__Class** type_info = &type_info_ref;

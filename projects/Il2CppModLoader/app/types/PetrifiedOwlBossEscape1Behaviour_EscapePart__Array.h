...
namespace app::classes::types {
    namespace PetrifiedOwlBossEscape1Behaviour_EscapePart__Array {
        namespace {
            app::PetrifiedOwlBossEscape1Behaviour_EscapePart__Array__Class* type_info_ref = nullptr;
        }
        app::PetrifiedOwlBossEscape1Behaviour_EscapePart__Array__Class** type_info = &type_info_ref;

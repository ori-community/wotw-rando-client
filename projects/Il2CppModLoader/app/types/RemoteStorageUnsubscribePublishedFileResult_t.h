...
namespace app::classes::types {
    namespace RemoteStorageUnsubscribePublishedFileResult_t {
        namespace {
            app::RemoteStorageUnsubscribePublishedFileResult_t__Class* type_info_ref = nullptr;
        }
        app::RemoteStorageUnsubscribePublishedFileResult_t__Class** type_info = &type_info_ref;

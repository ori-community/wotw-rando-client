...
namespace app::classes::types {
    namespace BrowserNative_Calltype_zfb_registerChangeCallback {
        namespace {
            app::BrowserNative_Calltype_zfb_registerChangeCallback__Class* type_info_ref = nullptr;
        }
        app::BrowserNative_Calltype_zfb_registerChangeCallback__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace DepthOfFieldDeprecated_BokehDestination__Enum {
        namespace {
            inline app::DepthOfFieldDeprecated_BokehDestination__Enum__Class* type_info_ref = nullptr;
        }
        inline app::DepthOfFieldDeprecated_BokehDestination__Enum__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace LightCullingSystem_LightCullingConfigPerType {
        namespace {
            app::LightCullingSystem_LightCullingConfigPerType__Class* type_info_ref = nullptr;
        }
        app::LightCullingSystem_LightCullingConfigPerType__Class** type_info = &type_info_ref;
        ...
        inline app::LightCullingSystem_LightCullingConfigPerType__Array* create_array(const std::vector<app::LightCullingSystem_LightCullingConfigPerType__Boxed>& items) {

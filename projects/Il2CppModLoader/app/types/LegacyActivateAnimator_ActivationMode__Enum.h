...
namespace app::classes::types {
    namespace LegacyActivateAnimator_ActivationMode__Enum {
        namespace {
            app::LegacyActivateAnimator_ActivationMode__Enum__Class* type_info_ref = nullptr;
        }
        app::LegacyActivateAnimator_ActivationMode__Enum__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace ConditionalDecorator_ConditionsCheckMode__Enum {
        namespace {
            app::ConditionalDecorator_ConditionsCheckMode__Enum__Class* type_info_ref = nullptr;
        }
        app::ConditionalDecorator_ConditionsCheckMode__Enum__Class** type_info = &type_info_ref;

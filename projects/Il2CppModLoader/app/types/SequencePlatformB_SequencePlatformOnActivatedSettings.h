...
namespace app::classes::types {
    namespace SequencePlatformB_SequencePlatformOnActivatedSettings {
        namespace {
            app::SequencePlatformB_SequencePlatformOnActivatedSettings__Class* type_info_ref = nullptr;
        }
        app::SequencePlatformB_SequencePlatformOnActivatedSettings__Class** type_info = &type_info_ref;

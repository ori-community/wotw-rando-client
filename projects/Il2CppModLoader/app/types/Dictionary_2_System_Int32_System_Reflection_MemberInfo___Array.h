...
namespace app::classes::types {
    namespace Dictionary_2_System_Int32_System_Reflection_MemberInfo___Array {
        namespace {
            app::Dictionary_2_System_Int32_System_Reflection_MemberInfo___Array__Class* type_info_ref = nullptr;
        }
        app::Dictionary_2_System_Int32_System_Reflection_MemberInfo___Array__Class** type_info = &type_info_ref;

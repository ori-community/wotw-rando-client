...
namespace app::classes::types {
    namespace SpiderBossEntity_SpiderFightState__Enum__Array {
        namespace {
            app::SpiderBossEntity_SpiderFightState__Enum__Array__Class* type_info_ref = nullptr;
        }
        app::SpiderBossEntity_SpiderFightState__Enum__Array__Class** type_info = &type_info_ref;

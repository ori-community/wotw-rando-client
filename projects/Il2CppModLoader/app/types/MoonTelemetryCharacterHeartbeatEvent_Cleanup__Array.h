...
namespace app::classes::types {
    namespace MoonTelemetryCharacterHeartbeatEvent_Cleanup__Array {
        namespace {
            inline app::MoonTelemetryCharacterHeartbeatEvent_Cleanup__Array__Class* type_info_ref = nullptr;
        }
        inline app::MoonTelemetryCharacterHeartbeatEvent_Cleanup__Array__Class** type_info = &type_info_ref;

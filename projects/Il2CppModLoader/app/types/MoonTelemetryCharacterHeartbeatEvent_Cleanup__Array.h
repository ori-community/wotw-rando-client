...
namespace app::classes::types {
    namespace MoonTelemetryCharacterHeartbeatEvent_Cleanup__Array {
        namespace {
            app::MoonTelemetryCharacterHeartbeatEvent_Cleanup__Array__Class* type_info_ref = nullptr;
        }
        app::MoonTelemetryCharacterHeartbeatEvent_Cleanup__Array__Class** type_info = &type_info_ref;

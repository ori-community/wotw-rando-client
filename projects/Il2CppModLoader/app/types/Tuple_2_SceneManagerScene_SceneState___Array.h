...
namespace app::classes::types {
    namespace Tuple_2_SceneManagerScene_SceneState___Array {
        namespace {
            inline app::Tuple_2_SceneManagerScene_SceneState___Array__Class* type_info_ref = nullptr;
        }
        inline app::Tuple_2_SceneManagerScene_SceneState___Array__Class** type_info = &type_info_ref;

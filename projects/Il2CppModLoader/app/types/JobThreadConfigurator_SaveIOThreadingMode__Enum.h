...
namespace app::classes::types {
    namespace JobThreadConfigurator_SaveIOThreadingMode__Enum {
        namespace {
            inline app::JobThreadConfigurator_SaveIOThreadingMode__Enum__Class* type_info_ref = nullptr;
        }
        inline app::JobThreadConfigurator_SaveIOThreadingMode__Enum__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace ChangeStateOnConditionInteractionNodeDecorator {
        namespace {
            app::ChangeStateOnConditionInteractionNodeDecorator__Class* type_info_ref = nullptr;
        }
        app::ChangeStateOnConditionInteractionNodeDecorator__Class** type_info = &type_info_ref;

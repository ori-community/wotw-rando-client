...
namespace app::classes::types {
    namespace ExperimentalTransparencyAnimatorSystemStrategy_AlphaState {
        ...
        inline app::ExperimentalTransparencyAnimatorSystemStrategy_AlphaState__Array* create_array(const std::vector<app::ExperimentalTransparencyAnimatorSystemStrategy_AlphaState__Boxed>& items) {

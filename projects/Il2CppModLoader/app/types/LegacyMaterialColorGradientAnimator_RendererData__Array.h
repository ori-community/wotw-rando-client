...
namespace app::classes::types {
    namespace LegacyMaterialColorGradientAnimator_RendererData__Array {
        namespace {
            app::LegacyMaterialColorGradientAnimator_RendererData__Array__Class* type_info_ref = nullptr;
        }
        app::LegacyMaterialColorGradientAnimator_RendererData__Array__Class** type_info = &type_info_ref;

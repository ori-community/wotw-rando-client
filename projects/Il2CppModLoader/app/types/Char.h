...
namespace app::classes::types {
    namespace Char {
        inline app::Char__Class** type_info = (app::Char__Class**)(modloader::win::memory::resolve_rva(0x04707EA8));
        ...
        inline app::Char__Array* create_array(const std::vector<uint16_t>& items) {

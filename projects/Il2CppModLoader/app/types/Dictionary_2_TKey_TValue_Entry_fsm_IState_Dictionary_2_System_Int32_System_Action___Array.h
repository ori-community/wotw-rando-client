...
namespace app::classes::types {
    namespace Dictionary_2_TKey_TValue_Entry_fsm_IState_Dictionary_2_System_Int32_System_Action___Array {
        namespace {
            app::Dictionary_2_TKey_TValue_Entry_fsm_IState_Dictionary_2_System_Int32_System_Action___Array__Class* type_info_ref = nullptr;
        }
        app::Dictionary_2_TKey_TValue_Entry_fsm_IState_Dictionary_2_System_Int32_System_Action___Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace BrowserNative_Calltype_zfb_getVersion {
        namespace {
            inline app::BrowserNative_Calltype_zfb_getVersion__Class* type_info_ref = nullptr;
        }
        inline app::BrowserNative_Calltype_zfb_getVersion__Class** type_info = &type_info_ref;

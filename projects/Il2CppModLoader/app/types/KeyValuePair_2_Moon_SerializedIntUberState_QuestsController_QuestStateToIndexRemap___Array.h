...
namespace app::classes::types {
    namespace KeyValuePair_2_Moon_SerializedIntUberState_QuestsController_QuestStateToIndexRemap___Array {
        namespace {
            app::KeyValuePair_2_Moon_SerializedIntUberState_QuestsController_QuestStateToIndexRemap___Array__Class* type_info_ref = nullptr;
        }
        app::KeyValuePair_2_Moon_SerializedIntUberState_QuestsController_QuestStateToIndexRemap___Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace LaserBeam_ImpactEffectOrientationMethod__Enum {
        namespace {
            inline app::LaserBeam_ImpactEffectOrientationMethod__Enum__Class* type_info_ref = nullptr;
        }
        inline app::LaserBeam_ImpactEffectOrientationMethod__Enum__Class** type_info = &type_info_ref;

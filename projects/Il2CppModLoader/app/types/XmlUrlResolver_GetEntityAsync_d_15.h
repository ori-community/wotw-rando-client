...
namespace app::classes::types {
    namespace XmlUrlResolver_GetEntityAsync_d_15 {
        namespace {
            inline app::XmlUrlResolver_GetEntityAsync_d_15__Class* type_info_ref = nullptr;
        }
        inline app::XmlUrlResolver_GetEntityAsync_d_15__Class** type_info = &type_info_ref;

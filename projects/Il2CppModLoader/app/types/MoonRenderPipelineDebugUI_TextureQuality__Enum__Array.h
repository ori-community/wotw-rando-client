...
namespace app::classes::types {
    namespace MoonRenderPipelineDebugUI_TextureQuality__Enum__Array {
        namespace {
            app::MoonRenderPipelineDebugUI_TextureQuality__Enum__Array__Class* type_info_ref = nullptr;
        }
        app::MoonRenderPipelineDebugUI_TextureQuality__Enum__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace MaskedTextProvider_CharType__Enum {
        inline app::MaskedTextProvider_CharType__Enum__Class** type_info = (app::MaskedTextProvider_CharType__Enum__Class**)(modloader::win::memory::resolve_rva(0x0474CF70));

...
namespace app::classes::types {
    namespace LightCanvas_SubLayerSettings_LayerMode__Enum {
        namespace {
            inline app::LightCanvas_SubLayerSettings_LayerMode__Enum__Class* type_info_ref = nullptr;
        }
        inline app::LightCanvas_SubLayerSettings_LayerMode__Enum__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace KamikazeSootEnemyPlaceholder_KamikazeSootEnemyPlaceholderSettings {
        namespace {
            app::KamikazeSootEnemyPlaceholder_KamikazeSootEnemyPlaceholderSettings__Class* type_info_ref = nullptr;
        }
        app::KamikazeSootEnemyPlaceholder_KamikazeSootEnemyPlaceholderSettings__Class** type_info = &type_info_ref;

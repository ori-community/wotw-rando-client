...
namespace app::classes::types {
    namespace MonoAssemblyName_public_key_token_e_FixedBuffer {
        namespace {
            app::MonoAssemblyName_public_key_token_e_FixedBuffer__Class* type_info_ref = nullptr;
        }
        app::MonoAssemblyName_public_key_token_e_FixedBuffer__Class** type_info = &type_info_ref;

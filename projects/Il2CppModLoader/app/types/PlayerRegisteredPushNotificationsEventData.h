...
namespace app::classes::types {
    namespace PlayerRegisteredPushNotificationsEventData {
        namespace {
            app::PlayerRegisteredPushNotificationsEventData__Class* type_info_ref = nullptr;
        }
        app::PlayerRegisteredPushNotificationsEventData__Class** type_info = &type_info_ref;

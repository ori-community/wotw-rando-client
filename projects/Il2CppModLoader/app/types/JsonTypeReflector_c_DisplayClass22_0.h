...
namespace app::classes::types {
    namespace JsonTypeReflector_c_DisplayClass22_0 {
        inline app::JsonTypeReflector_c_DisplayClass22_0__Class** type_info = (app::JsonTypeReflector_c_DisplayClass22_0__Class**)(modloader::win::memory::resolve_rva(0x04770590));

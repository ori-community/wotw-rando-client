...
namespace app::classes::types {
    namespace AkCommonOutputSettings_ChannelConfiguration_ChannelMask__Enum {
        namespace {
            app::AkCommonOutputSettings_ChannelConfiguration_ChannelMask__Enum__Class* type_info_ref = nullptr;
        }
        app::AkCommonOutputSettings_ChannelConfiguration_ChannelMask__Enum__Class** type_info = &type_info_ref;

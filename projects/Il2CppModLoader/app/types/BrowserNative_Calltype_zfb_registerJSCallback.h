...
namespace app::classes::types {
    namespace BrowserNative_Calltype_zfb_registerJSCallback {
        namespace {
            app::BrowserNative_Calltype_zfb_registerJSCallback__Class* type_info_ref = nullptr;
        }
        app::BrowserNative_Calltype_zfb_registerJSCallback__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace KwolokTongueSyncGroup_KwolokTongueGroupEntry__Array {
        namespace {
            app::KwolokTongueSyncGroup_KwolokTongueGroupEntry__Array__Class* type_info_ref = nullptr;
        }
        app::KwolokTongueSyncGroup_KwolokTongueGroupEntry__Array__Class** type_info = &type_info_ref;

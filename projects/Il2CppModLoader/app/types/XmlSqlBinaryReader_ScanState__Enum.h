...
namespace app::classes::types {
    namespace XmlSqlBinaryReader_ScanState__Enum {
        namespace {
            inline app::XmlSqlBinaryReader_ScanState__Enum__Class* type_info_ref = nullptr;
        }
        inline app::XmlSqlBinaryReader_ScanState__Enum__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace KeyValuePair_2_SpiritShardType_Moon_uberSerializationWisp_PlayerUberStateShards_Shard___Array {
        namespace {
            app::KeyValuePair_2_SpiritShardType_Moon_uberSerializationWisp_PlayerUberStateShards_Shard___Array__Class* type_info_ref = nullptr;
        }
        app::KeyValuePair_2_SpiritShardType_Moon_uberSerializationWisp_PlayerUberStateShards_Shard___Array__Class** type_info = &type_info_ref;

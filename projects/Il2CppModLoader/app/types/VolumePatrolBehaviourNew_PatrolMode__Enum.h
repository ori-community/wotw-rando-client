...
namespace app::classes::types {
    namespace VolumePatrolBehaviourNew_PatrolMode__Enum {
        namespace {
            app::VolumePatrolBehaviourNew_PatrolMode__Enum__Class* type_info_ref = nullptr;
        }
        app::VolumePatrolBehaviourNew_PatrolMode__Enum__Class** type_info = &type_info_ref;

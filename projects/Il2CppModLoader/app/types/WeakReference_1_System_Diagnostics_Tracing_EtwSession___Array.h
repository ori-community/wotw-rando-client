...
namespace app::classes::types {
    namespace WeakReference_1_System_Diagnostics_Tracing_EtwSession___Array {
        namespace {
            app::WeakReference_1_System_Diagnostics_Tracing_EtwSession___Array__Class* type_info_ref = nullptr;
        }
        app::WeakReference_1_System_Diagnostics_Tracing_EtwSession___Array__Class** type_info = &type_info_ref;

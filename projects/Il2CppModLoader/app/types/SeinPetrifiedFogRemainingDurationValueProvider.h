...
namespace app::classes::types {
    namespace SeinPetrifiedFogRemainingDurationValueProvider {
        namespace {
            app::SeinPetrifiedFogRemainingDurationValueProvider__Class* type_info_ref = nullptr;
        }
        app::SeinPetrifiedFogRemainingDurationValueProvider__Class** type_info = &type_info_ref;

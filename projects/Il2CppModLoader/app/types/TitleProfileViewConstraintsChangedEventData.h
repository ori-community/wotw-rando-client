...
namespace app::classes::types {
    namespace TitleProfileViewConstraintsChangedEventData {
        namespace {
            app::TitleProfileViewConstraintsChangedEventData__Class* type_info_ref = nullptr;
        }
        app::TitleProfileViewConstraintsChangedEventData__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace Win32IPGlobalProperties_Win32_MIB_TCP6ROW__Array {
        namespace {
            inline app::Win32IPGlobalProperties_Win32_MIB_TCP6ROW__Array__Class* type_info_ref = nullptr;
        }
        inline app::Win32IPGlobalProperties_Win32_MIB_TCP6ROW__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace PauseMenuProgressElements_UberStateToElement__Array {
        namespace {
            app::PauseMenuProgressElements_UberStateToElement__Array__Class* type_info_ref = nullptr;
        }
        app::PauseMenuProgressElements_UberStateToElement__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace NickHitReactionBehaviour_NonInterruptibleTaskCondition {
        namespace {
            app::NickHitReactionBehaviour_NonInterruptibleTaskCondition__Class* type_info_ref = nullptr;
        }
        app::NickHitReactionBehaviour_NonInterruptibleTaskCondition__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace WandererNPC_InteractionLine__Array {
        namespace {
            inline app::WandererNPC_InteractionLine__Array__Class* type_info_ref = nullptr;
        }
        inline app::WandererNPC_InteractionLine__Array__Class** type_info = &type_info_ref;

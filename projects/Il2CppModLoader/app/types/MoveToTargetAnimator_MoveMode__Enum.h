...
namespace app::classes::types {
    namespace MoveToTargetAnimator_MoveMode__Enum {
        namespace {
            inline app::MoveToTargetAnimator_MoveMode__Enum__Class* type_info_ref = nullptr;
        }
        inline app::MoveToTargetAnimator_MoveMode__Enum__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace PiranhaLocomotionIdleBehaviour_State__Enum {
        namespace {
            app::PiranhaLocomotionIdleBehaviour_State__Enum__Class* type_info_ref = nullptr;
        }
        app::PiranhaLocomotionIdleBehaviour_State__Enum__Class** type_info = &type_info_ref;

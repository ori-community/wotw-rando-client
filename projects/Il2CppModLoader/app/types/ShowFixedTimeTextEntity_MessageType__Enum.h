...
namespace app::classes::types {
    namespace ShowFixedTimeTextEntity_MessageType__Enum {
        namespace {
            inline app::ShowFixedTimeTextEntity_MessageType__Enum__Class* type_info_ref = nullptr;
        }
        inline app::ShowFixedTimeTextEntity_MessageType__Enum__Class** type_info = &type_info_ref;

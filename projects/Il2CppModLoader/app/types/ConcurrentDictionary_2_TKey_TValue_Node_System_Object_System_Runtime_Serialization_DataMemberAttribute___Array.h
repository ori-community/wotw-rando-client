...
namespace app::classes::types {
    namespace ConcurrentDictionary_2_TKey_TValue_Node_System_Object_System_Runtime_Serialization_DataMemberAttribute___Array {
        namespace {
            app::ConcurrentDictionary_2_TKey_TValue_Node_System_Object_System_Runtime_Serialization_DataMemberAttribute___Array__Class* type_info_ref = nullptr;
        }
        app::ConcurrentDictionary_2_TKey_TValue_Node_System_Object_System_Runtime_Serialization_DataMemberAttribute___Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace SeinSoulFlame_SoulFlamePlacementSafety__Enum {
        namespace {
            app::SeinSoulFlame_SoulFlamePlacementSafety__Enum__Class* type_info_ref = nullptr;
        }
        app::SeinSoulFlame_SoulFlamePlacementSafety__Enum__Class** type_info = &type_info_ref;

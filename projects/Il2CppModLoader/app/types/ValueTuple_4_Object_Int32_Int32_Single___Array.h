...
namespace app::classes::types {
    namespace ValueTuple_4_Object_Int32_Int32_Single___Array {
        namespace {
            app::ValueTuple_4_Object_Int32_Int32_Single___Array__Class* type_info_ref = nullptr;
        }
        app::ValueTuple_4_Object_Int32_Int32_Single___Array__Class** type_info = &type_info_ref;

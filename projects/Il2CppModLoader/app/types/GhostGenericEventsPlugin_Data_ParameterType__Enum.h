...
namespace app::classes::types {
    namespace GhostGenericEventsPlugin_Data_ParameterType__Enum {
        namespace {
            app::GhostGenericEventsPlugin_Data_ParameterType__Enum__Class* type_info_ref = nullptr;
        }
        app::GhostGenericEventsPlugin_Data_ParameterType__Enum__Class** type_info = &type_info_ref;

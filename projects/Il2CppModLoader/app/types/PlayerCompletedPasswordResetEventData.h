...
namespace app::classes::types {
    namespace PlayerCompletedPasswordResetEventData {
        namespace {
            inline app::PlayerCompletedPasswordResetEventData__Class* type_info_ref = nullptr;
        }
        inline app::PlayerCompletedPasswordResetEventData__Class** type_info = &type_info_ref;

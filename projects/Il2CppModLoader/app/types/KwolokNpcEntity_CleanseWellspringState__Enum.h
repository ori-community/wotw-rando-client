...
namespace app::classes::types {
    namespace KwolokNpcEntity_CleanseWellspringState__Enum {
        namespace {
            app::KwolokNpcEntity_CleanseWellspringState__Enum__Class* type_info_ref = nullptr;
        }
        app::KwolokNpcEntity_CleanseWellspringState__Enum__Class** type_info = &type_info_ref;

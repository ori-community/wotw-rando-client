...
namespace app::classes::types {
    namespace KeyValuePair_2_System_Int32_List_1_System_Action___Array {
        namespace {
            app::KeyValuePair_2_System_Int32_List_1_System_Action___Array__Class* type_info_ref = nullptr;
        }
        app::KeyValuePair_2_System_Int32_List_1_System_Action___Array__Class** type_info = &type_info_ref;

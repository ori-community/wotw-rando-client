...
namespace app::classes::types {
    namespace MoonRenderPipelineAsset_FrameBufferDepth__Enum {
        namespace {
            app::MoonRenderPipelineAsset_FrameBufferDepth__Enum__Class* type_info_ref = nullptr;
        }
        app::MoonRenderPipelineAsset_FrameBufferDepth__Enum__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace FixedUpdateScheduler_ScheduledAction__Array {
        namespace {
            inline app::FixedUpdateScheduler_ScheduledAction__Array__Class* type_info_ref = nullptr;
        }
        inline app::FixedUpdateScheduler_ScheduledAction__Array__Class** type_info = &type_info_ref;

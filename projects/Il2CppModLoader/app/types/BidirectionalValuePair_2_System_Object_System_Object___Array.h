...
namespace app::classes::types {
    namespace BidirectionalValuePair_2_System_Object_System_Object___Array {
        namespace {
            app::BidirectionalValuePair_2_System_Object_System_Object___Array__Class* type_info_ref = nullptr;
        }
        app::BidirectionalValuePair_2_System_Object_System_Object___Array__Class** type_info = &type_info_ref;

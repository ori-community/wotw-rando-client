...
namespace app::classes::types {
    namespace GhostReplayMetaData_GhostReplayCollection {
        namespace {
            app::GhostReplayMetaData_GhostReplayCollection__Class* type_info_ref = nullptr;
        }
        app::GhostReplayMetaData_GhostReplayCollection__Class** type_info = &type_info_ref;

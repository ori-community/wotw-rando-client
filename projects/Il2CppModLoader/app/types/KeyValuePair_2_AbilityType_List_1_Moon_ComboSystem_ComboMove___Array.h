...
namespace app::classes::types {
    namespace KeyValuePair_2_AbilityType_List_1_Moon_ComboSystem_ComboMove___Array {
        namespace {
            inline app::KeyValuePair_2_AbilityType_List_1_Moon_ComboSystem_ComboMove___Array__Class* type_info_ref = nullptr;
        }
        inline app::KeyValuePair_2_AbilityType_List_1_Moon_ComboSystem_ComboMove___Array__Class** type_info = &type_info_ref;

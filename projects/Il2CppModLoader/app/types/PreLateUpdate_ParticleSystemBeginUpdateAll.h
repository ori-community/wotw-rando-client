...
namespace app::classes::types {
    namespace PreLateUpdate_ParticleSystemBeginUpdateAll {
        namespace {
            app::PreLateUpdate_ParticleSystemBeginUpdateAll__Class* type_info_ref = nullptr;
        }
        app::PreLateUpdate_ParticleSystemBeginUpdateAll__Class** type_info = &type_info_ref;

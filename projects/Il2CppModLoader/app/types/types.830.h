...
struct KeyValuePair_2_Moon_FloatAnimationParameter_System_Single___Array__VTable {
};

struct KeyValuePair_2_Moon_FloatAnimationParameter_System_Single___Array__StaticFields {
};

struct KeyValuePair_2_Moon_FloatAnimationParameter_System_Single___Array__Class {
    Il2CppClass_0 _0;
    Il2CppRuntimeInterfaceOffsetPair *interfaceOffsets;
    struct KeyValuePair_2_Moon_FloatAnimationParameter_System_Single___Array__StaticFields *static_fields;
    const Il2CppRGCTXData *rgctx_data;
    Il2CppClass_1 _1;
    struct KeyValuePair_2_Moon_FloatAnimationParameter_System_Single___Array__VTable vtable;
};
...
enum class CheckpointRestrictZone_CheckpointRestrictType__Enum : int32_t {
    None = 0x00000000,
    WaitUntilOutside = 0x00000001,
    UseLastPositionOutsideZone = 0x00000002,
    TargetPosition = 0x00000003,
};

struct CheckpointRestrictZone_CheckpointRestrictType__Enum__Boxed {
    struct CheckpointRestrictZone_CheckpointRestrictType__Enum__Class *klass;
    MonitorData *monitor;
    CheckpointRestrictZone_CheckpointRestrictType__Enum value;
...
struct CheckpointRestrictZone__Array__VTable {
};

struct CheckpointRestrictZone__Array__StaticFields {
};

struct CheckpointRestrictZone__Array__Class {
    Il2CppClass_0 _0;
    Il2CppRuntimeInterfaceOffsetPair *interfaceOffsets;
    struct CheckpointRestrictZone__Array__StaticFields *static_fields;
    const Il2CppRGCTXData *rgctx_data;
    Il2CppClass_1 _1;
    struct CheckpointRestrictZone__Array__VTable vtable;
};
...
struct CheckpointRestrictZone_CheckpointRestrictType__Enum__VTable {
    VirtualInvokeData Equals;
    VirtualInvokeData Finalize;
    VirtualInvokeData GetHashCode;
    VirtualInvokeData ToString;
...
struct CheckpointRestrictZone_CheckpointRestrictType__Enum__StaticFields {
};

struct CheckpointRestrictZone_CheckpointRestrictType__Enum__Class {
    Il2CppClass_0 _0;
    Il2CppRuntimeInterfaceOffsetPair *interfaceOffsets;
    struct CheckpointRestrictZone_CheckpointRestrictType__Enum__StaticFields *static_fields;
    const Il2CppRGCTXData *rgctx_data;
    Il2CppClass_1 _1;
    struct CheckpointRestrictZone_CheckpointRestrictType__Enum__VTable vtable;
};

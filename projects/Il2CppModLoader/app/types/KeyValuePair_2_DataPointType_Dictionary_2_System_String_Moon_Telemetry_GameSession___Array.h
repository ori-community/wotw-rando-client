...
namespace app::classes::types {
    namespace KeyValuePair_2_DataPointType_Dictionary_2_System_String_Moon_Telemetry_GameSession___Array {
        namespace {
            app::KeyValuePair_2_DataPointType_Dictionary_2_System_String_Moon_Telemetry_GameSession___Array__Class* type_info_ref = nullptr;
        }
        app::KeyValuePair_2_DataPointType_Dictionary_2_System_String_Moon_Telemetry_GameSession___Array__Class** type_info = &type_info_ref;

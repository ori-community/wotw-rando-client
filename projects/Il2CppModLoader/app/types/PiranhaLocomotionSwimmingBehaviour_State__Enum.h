...
namespace app::classes::types {
    namespace PiranhaLocomotionSwimmingBehaviour_State__Enum {
        namespace {
            inline app::PiranhaLocomotionSwimmingBehaviour_State__Enum__Class* type_info_ref = nullptr;
        }
        inline app::PiranhaLocomotionSwimmingBehaviour_State__Enum__Class** type_info = &type_info_ref;

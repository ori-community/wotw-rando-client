...
namespace app::classes::types {
    namespace PiranhaLocomotionSwimmingBehaviour_State__Enum {
        namespace {
            app::PiranhaLocomotionSwimmingBehaviour_State__Enum__Class* type_info_ref = nullptr;
        }
        app::PiranhaLocomotionSwimmingBehaviour_State__Enum__Class** type_info = &type_info_ref;

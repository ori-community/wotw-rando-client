...
struct TitleNewsItem_1__Array__VTable {
};

struct TitleNewsItem_1__Array__StaticFields {
};

struct TitleNewsItem_1__Array__Class {
    Il2CppClass_0 _0;
    Il2CppRuntimeInterfaceOffsetPair *interfaceOffsets;
    struct TitleNewsItem_1__Array__StaticFields *static_fields;
    const Il2CppRGCTXData *rgctx_data;
    Il2CppClass_1 _1;
    struct TitleNewsItem_1__Array__VTable vtable;
};

...
namespace app::classes::types {
    namespace UberShaderPrewarmer_PrewarmedShader__Array {
        namespace {
            inline app::UberShaderPrewarmer_PrewarmedShader__Array__Class* type_info_ref = nullptr;
        }
        inline app::UberShaderPrewarmer_PrewarmedShader__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_Drawing_Manga5 {
        inline app::ShaderID_CameraFilterPack_Drawing_Manga5__Class** type_info = (app::ShaderID_CameraFilterPack_Drawing_Manga5__Class**)(modloader::win::memory::resolve_rva(0x04780D38));

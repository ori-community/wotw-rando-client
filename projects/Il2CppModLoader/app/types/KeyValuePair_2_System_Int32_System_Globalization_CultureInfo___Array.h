...
namespace app::classes::types {
    namespace KeyValuePair_2_System_Int32_System_Globalization_CultureInfo___Array {
        namespace {
            inline app::KeyValuePair_2_System_Int32_System_Globalization_CultureInfo___Array__Class* type_info_ref = nullptr;
        }
        inline app::KeyValuePair_2_System_Int32_System_Globalization_CultureInfo___Array__Class** type_info = &type_info_ref;

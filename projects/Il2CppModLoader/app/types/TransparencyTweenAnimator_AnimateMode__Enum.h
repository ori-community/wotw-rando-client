...
namespace app::classes::types {
    namespace TransparencyTweenAnimator_AnimateMode__Enum {
        namespace {
            app::TransparencyTweenAnimator_AnimateMode__Enum__Class* type_info_ref = nullptr;
        }
        app::TransparencyTweenAnimator_AnimateMode__Enum__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace DictationRecognizer_DictationResultDelegate {
        namespace {
            app::DictationRecognizer_DictationResultDelegate__Class* type_info_ref = nullptr;
        }
        app::DictationRecognizer_DictationResultDelegate__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace UberStateToWwiseData_UberStateToWWiseEntry {
        namespace {
            app::UberStateToWwiseData_UberStateToWWiseEntry__Class* type_info_ref = nullptr;
        }
        app::UberStateToWwiseData_UberStateToWWiseEntry__Class** type_info = &type_info_ref;

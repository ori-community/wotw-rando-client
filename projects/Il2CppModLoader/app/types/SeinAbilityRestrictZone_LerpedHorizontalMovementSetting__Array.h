...
namespace app::classes::types {
    namespace SeinAbilityRestrictZone_LerpedHorizontalMovementSetting__Array {
        namespace {
            inline app::SeinAbilityRestrictZone_LerpedHorizontalMovementSetting__Array__Class* type_info_ref = nullptr;
        }
        inline app::SeinAbilityRestrictZone_LerpedHorizontalMovementSetting__Array__Class** type_info = &type_info_ref;

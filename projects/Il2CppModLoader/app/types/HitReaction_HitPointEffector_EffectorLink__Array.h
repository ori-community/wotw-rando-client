...
namespace app::classes::types {
    namespace HitReaction_HitPointEffector_EffectorLink__Array {
        namespace {
            app::HitReaction_HitPointEffector_EffectorLink__Array__Class* type_info_ref = nullptr;
        }
        app::HitReaction_HitPointEffector_EffectorLink__Array__Class** type_info = &type_info_ref;

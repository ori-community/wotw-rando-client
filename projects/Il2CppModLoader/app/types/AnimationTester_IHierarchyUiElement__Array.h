...
namespace app::classes::types {
    namespace AnimationTester_IHierarchyUiElement__Array {
        namespace {
            app::AnimationTester_IHierarchyUiElement__Array__Class* type_info_ref = nullptr;
        }
        app::AnimationTester_IHierarchyUiElement__Array__Class** type_info = &type_info_ref;

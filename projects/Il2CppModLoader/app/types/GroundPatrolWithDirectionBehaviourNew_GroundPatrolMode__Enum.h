...
namespace app::classes::types {
    namespace GroundPatrolWithDirectionBehaviourNew_GroundPatrolMode__Enum {
        namespace {
            app::GroundPatrolWithDirectionBehaviourNew_GroundPatrolMode__Enum__Class* type_info_ref = nullptr;
        }
        app::GroundPatrolWithDirectionBehaviourNew_GroundPatrolMode__Enum__Class** type_info = &type_info_ref;

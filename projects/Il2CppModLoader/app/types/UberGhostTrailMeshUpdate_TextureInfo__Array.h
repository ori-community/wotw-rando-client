...
namespace app::classes::types {
    namespace UberGhostTrailMeshUpdate_TextureInfo__Array {
        namespace {
            app::UberGhostTrailMeshUpdate_TextureInfo__Array__Class* type_info_ref = nullptr;
        }
        app::UberGhostTrailMeshUpdate_TextureInfo__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace PiranhaLocomotionSwimmingBehaviour_SpeedSetting__Array {
        namespace {
            app::PiranhaLocomotionSwimmingBehaviour_SpeedSetting__Array__Class* type_info_ref = nullptr;
        }
        app::PiranhaLocomotionSwimmingBehaviour_SpeedSetting__Array__Class** type_info = &type_info_ref;

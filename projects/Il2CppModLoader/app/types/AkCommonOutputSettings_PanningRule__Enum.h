...
namespace app::classes::types {
    namespace AkCommonOutputSettings_PanningRule__Enum {
        namespace {
            inline app::AkCommonOutputSettings_PanningRule__Enum__Class* type_info_ref = nullptr;
        }
        inline app::AkCommonOutputSettings_PanningRule__Enum__Class** type_info = &type_info_ref;

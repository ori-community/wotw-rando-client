...
namespace app::classes::types {
    namespace NightCrawlerReveal_AnimationEventAction__Array {
        namespace {
            app::NightCrawlerReveal_AnimationEventAction__Array__Class* type_info_ref = nullptr;
        }
        app::NightCrawlerReveal_AnimationEventAction__Array__Class** type_info = &type_info_ref;

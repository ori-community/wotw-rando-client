...
namespace app::classes::types {
    namespace DynamicInstantiationScanner_EvaluationFn_1_UnityEngine_Object___Array {
        namespace {
            app::DynamicInstantiationScanner_EvaluationFn_1_UnityEngine_Object___Array__Class* type_info_ref = nullptr;
        }
        app::DynamicInstantiationScanner_EvaluationFn_1_UnityEngine_Object___Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace UberPoolPrewarmMasterList_PrewarmConfig__Array {
        namespace {
            app::UberPoolPrewarmMasterList_PrewarmConfig__Array__Class* type_info_ref = nullptr;
        }
        app::UberPoolPrewarmMasterList_PrewarmConfig__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace GraphicsJobsSyncPoint__Enum {
        namespace {
            app::GraphicsJobsSyncPoint__Enum__Class* type_info_ref = nullptr;
        }
        app::GraphicsJobsSyncPoint__Enum__Class** type_info = &type_info_ref;
        ...
        inline app::GraphicsJobsSyncPoint__Enum__Array* create_array(const std::vector<app::GraphicsJobsSyncPoint__Enum__Boxed*>& items) {

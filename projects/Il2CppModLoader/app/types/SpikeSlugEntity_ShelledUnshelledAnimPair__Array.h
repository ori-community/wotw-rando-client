...
namespace app::classes::types {
    namespace SpikeSlugEntity_ShelledUnshelledAnimPair__Array {
        namespace {
            app::SpikeSlugEntity_ShelledUnshelledAnimPair__Array__Class* type_info_ref = nullptr;
        }
        app::SpikeSlugEntity_ShelledUnshelledAnimPair__Array__Class** type_info = &type_info_ref;

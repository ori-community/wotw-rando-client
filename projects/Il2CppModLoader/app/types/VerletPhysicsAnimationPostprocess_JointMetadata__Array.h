...
namespace app::classes::types {
    namespace VerletPhysicsAnimationPostprocess_JointMetadata__Array {
        namespace {
            app::VerletPhysicsAnimationPostprocess_JointMetadata__Array__Class* type_info_ref = nullptr;
        }
        app::VerletPhysicsAnimationPostprocess_JointMetadata__Array__Class** type_info = &type_info_ref;

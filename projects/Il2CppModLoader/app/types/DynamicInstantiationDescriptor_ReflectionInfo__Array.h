...
namespace app::classes::types {
    namespace DynamicInstantiationDescriptor_ReflectionInfo__Array {
        namespace {
            app::DynamicInstantiationDescriptor_ReflectionInfo__Array__Class* type_info_ref = nullptr;
        }
        app::DynamicInstantiationDescriptor_ReflectionInfo__Array__Class** type_info = &type_info_ref;

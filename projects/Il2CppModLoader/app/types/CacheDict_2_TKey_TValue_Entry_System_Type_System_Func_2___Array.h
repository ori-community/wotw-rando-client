...
namespace app::classes::types {
    namespace CacheDict_2_TKey_TValue_Entry_System_Type_System_Func_2___Array {
        namespace {
            inline app::CacheDict_2_TKey_TValue_Entry_System_Type_System_Func_2___Array__Class* type_info_ref = nullptr;
        }
        inline app::CacheDict_2_TKey_TValue_Entry_System_Type_System_Func_2___Array__Class** type_info = &type_info_ref;

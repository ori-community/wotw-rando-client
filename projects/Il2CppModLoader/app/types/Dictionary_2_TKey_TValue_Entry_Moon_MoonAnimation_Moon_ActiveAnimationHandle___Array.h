...
namespace app::classes::types {
    namespace Dictionary_2_TKey_TValue_Entry_Moon_MoonAnimation_Moon_ActiveAnimationHandle___Array {
        namespace {
            app::Dictionary_2_TKey_TValue_Entry_Moon_MoonAnimation_Moon_ActiveAnimationHandle___Array__Class* type_info_ref = nullptr;
        }
        app::Dictionary_2_TKey_TValue_Entry_Moon_MoonAnimation_Moon_ActiveAnimationHandle___Array__Class** type_info = &type_info_ref;

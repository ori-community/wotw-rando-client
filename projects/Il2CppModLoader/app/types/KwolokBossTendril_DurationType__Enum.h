...
namespace app::classes::types {
    namespace KwolokBossTendril_DurationType__Enum {
        inline app::KwolokBossTendril_DurationType__Enum__Class** type_info = (app::KwolokBossTendril_DurationType__Enum__Class**)(modloader::win::memory::resolve_rva(0x0472A810));

...
namespace app::classes::types {
    namespace ParticleSystemAnimator_ParticlePostPlaybackBehaviour__Enum {
        namespace {
            app::ParticleSystemAnimator_ParticlePostPlaybackBehaviour__Enum__Class* type_info_ref = nullptr;
        }
        app::ParticleSystemAnimator_ParticlePostPlaybackBehaviour__Enum__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace TentacleStabBehaviour_TentacleAttack {
        inline app::TentacleStabBehaviour_TentacleAttack__Class** type_info = (app::TentacleStabBehaviour_TentacleAttack__Class**)(modloader::win::memory::resolve_rva(0x047628B0));

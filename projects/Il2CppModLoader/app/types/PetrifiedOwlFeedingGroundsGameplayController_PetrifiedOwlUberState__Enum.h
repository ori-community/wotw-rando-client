...
namespace app::classes::types {
    namespace PetrifiedOwlFeedingGroundsGameplayController_PetrifiedOwlUberState__Enum {
        namespace {
            inline app::PetrifiedOwlFeedingGroundsGameplayController_PetrifiedOwlUberState__Enum__Class* type_info_ref = nullptr;
        }
        inline app::PetrifiedOwlFeedingGroundsGameplayController_PetrifiedOwlUberState__Enum__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace PlayAnimationCutsceneState_FacingMode__Enum {
        namespace {
            app::PlayAnimationCutsceneState_FacingMode__Enum__Class* type_info_ref = nullptr;
        }
        app::PlayAnimationCutsceneState_FacingMode__Enum__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_Blend2Camera_HardLight {
        inline app::ShaderID_CameraFilterPack_Blend2Camera_HardLight__Class** type_info = (app::ShaderID_CameraFilterPack_Blend2Camera_HardLight__Class**)(modloader::win::memory::resolve_rva(0x04710DD0));

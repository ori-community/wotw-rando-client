...
namespace app::classes::types {
    namespace LizardKamikazeAttackBehaviour_State__Enum {
        namespace {
            inline app::LizardKamikazeAttackBehaviour_State__Enum__Class* type_info_ref = nullptr;
        }
        inline app::LizardKamikazeAttackBehaviour_State__Enum__Class** type_info = &type_info_ref;

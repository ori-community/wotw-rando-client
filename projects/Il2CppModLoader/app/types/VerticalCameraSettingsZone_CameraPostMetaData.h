...
namespace app::classes::types {
    namespace VerticalCameraSettingsZone_CameraPostMetaData {
        namespace {
            app::VerticalCameraSettingsZone_CameraPostMetaData__Class* type_info_ref = nullptr;
        }
        app::VerticalCameraSettingsZone_CameraPostMetaData__Class** type_info = &type_info_ref;

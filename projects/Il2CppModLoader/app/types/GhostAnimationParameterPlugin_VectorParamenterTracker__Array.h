...
namespace app::classes::types {
    namespace GhostAnimationParameterPlugin_VectorParamenterTracker__Array {
        namespace {
            app::GhostAnimationParameterPlugin_VectorParamenterTracker__Array__Class* type_info_ref = nullptr;
        }
        app::GhostAnimationParameterPlugin_VectorParamenterTracker__Array__Class** type_info = &type_info_ref;

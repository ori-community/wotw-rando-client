...
namespace app::classes::types {
    namespace FramePerformanceMonitor_PerformanceEntry__Array {
        namespace {
            app::FramePerformanceMonitor_PerformanceEntry__Array__Class* type_info_ref = nullptr;
        }
        app::FramePerformanceMonitor_PerformanceEntry__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace ExperimentalTransparencyAnimatorSystemStrategy_Request__Array {
        namespace {
            app::ExperimentalTransparencyAnimatorSystemStrategy_Request__Array__Class* type_info_ref = nullptr;
        }
        app::ExperimentalTransparencyAnimatorSystemStrategy_Request__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace AttachPrefabsToLiannaTongue_TonguePoints__Array {
        namespace {
            app::AttachPrefabsToLiannaTongue_TonguePoints__Array__Class* type_info_ref = nullptr;
        }
        app::AttachPrefabsToLiannaTongue_TonguePoints__Array__Class** type_info = &type_info_ref;

...
namespace app::classes::types {
    namespace BehaviourTreeEvaluationSystem_EvaluationMode__Enum__Array {
        namespace {
            inline app::BehaviourTreeEvaluationSystem_EvaluationMode__Enum__Array__Class* type_info_ref = nullptr;
        }
        inline app::BehaviourTreeEvaluationSystem_EvaluationMode__Enum__Array__Class** type_info = &type_info_ref;

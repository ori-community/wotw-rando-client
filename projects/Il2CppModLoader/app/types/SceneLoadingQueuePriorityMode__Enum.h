...
namespace app::classes::types {
    namespace SceneLoadingQueuePriorityMode__Enum {
        namespace {
            inline app::SceneLoadingQueuePriorityMode__Enum__Class* type_info_ref = nullptr;
        }
        inline app::SceneLoadingQueuePriorityMode__Enum__Class** type_info = &type_info_ref;

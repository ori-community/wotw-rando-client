...
namespace app::classes::types {
    namespace MistyWoodsKuroGameplayController_State__Enum {
        namespace {
            app::MistyWoodsKuroGameplayController_State__Enum__Class* type_info_ref = nullptr;
        }
        app::MistyWoodsKuroGameplayController_State__Enum__Class** type_info = &type_info_ref;

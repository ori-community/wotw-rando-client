...
namespace app::classes::types {
    namespace KamikazeSkeetoDiveAttackBehaviour_DiveAttackState__Enum {
        namespace {
            app::KamikazeSkeetoDiveAttackBehaviour_DiveAttackState__Enum__Class* type_info_ref = nullptr;
        }
        app::KamikazeSkeetoDiveAttackBehaviour_DiveAttackState__Enum__Class** type_info = &type_info_ref;

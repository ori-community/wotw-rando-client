...
namespace app::classes::types {
    namespace SerializableUberShaderWrapper__Array {
        namespace {
            inline app::SerializableUberShaderWrapper__Array__Class* type_info_ref = nullptr;
        }
        inline app::SerializableUberShaderWrapper__Array__Class** type_info = &type_info_ref;

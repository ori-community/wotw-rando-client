...
namespace app::classes::types {
    namespace TentacleEnemyPlaceholder_TentacleEnemyPlaceholderSettings {
        namespace {
            app::TentacleEnemyPlaceholder_TentacleEnemyPlaceholderSettings__Class* type_info_ref = nullptr;
        }
        app::TentacleEnemyPlaceholder_TentacleEnemyPlaceholderSettings__Class** type_info = &type_info_ref;

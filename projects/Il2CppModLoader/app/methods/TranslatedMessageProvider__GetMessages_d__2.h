...
namespace app::methods::TranslatedMessageProvider__GetMessages_d__2 {
    ...
    IL2CPP_REGISTER_METHOD(0x004BD960, app::MessageDescriptor, IEnumerator_MessageDescriptor__get_Current, (app::TranslatedMessageProvider_GetMessages_d_2 * this_ptr))
    IL2CPP_REGISTER_METHOD(0x00B0B020, void, IEnumerator_Reset, (app::TranslatedMessageProvider_GetMessages_d_2 * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04779FE0, TranslatedMessageProvider_GetMessages_d_2_System_Collections_IEnumerator_Reset__MethodInfo)
    ...
    IL2CPP_REGISTER_METHOD(0x00B0B110, app::IEnumerator_1_MessageDescriptor_ *, IEnumerable_MessageDescriptor__GetEnumerator, (app::TranslatedMessageProvider_GetMessages_d_2 * this_ptr))

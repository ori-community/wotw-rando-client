...
namespace app::classes::PetrifiedOwlBossEscape1Behaviour {
    ...
    IL2CPP_REGISTER_METHOD(0x0071EAB0, app::PetrifiedOwlBossBaseBehaviour_PetrifiedOwlBossBaseStatesSet*, get_States, (app::PetrifiedOwlBossEscape1Behaviour * this_ptr))

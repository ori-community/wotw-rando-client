...
namespace app::classes::Steamworks::ISteamMatchmakingPlayersResponse {
    ...
    IL2CPP_REGISTER_METHOD(0x015FCCE0, void, InternalOnAddPlayerToList, (app::ISteamMatchmakingPlayersResponse * this_ptr, void* thisptr, void* pch_name, int32_t n_score, float fl_time_played))

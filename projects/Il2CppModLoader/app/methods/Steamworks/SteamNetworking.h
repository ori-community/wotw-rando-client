...
namespace app::methods::Steamworks::SteamNetworking {
    IL2CPP_REGISTER_METHOD(0x0278E260, bool, SendP2PPacket, (app::CSteamID steam_i_d_remote, app::Byte__Array * pub_data, uint32_t cub_data, app::EP2PSend__Enum e_p2_p_send_type, int32_t n_channel))
    IL2CPP_REGISTER_METHOD(0x0278E2D0, bool, IsP2PPacketAvailable, (uint32_t * pcub_msg_size, int32_t n_channel))
    IL2CPP_REGISTER_METHOD(0x0278E310, bool, ReadP2PPacket, (app::Byte__Array * pub_dest, uint32_t cub_dest, uint32_t * pcub_msg_size, app::CSteamID * psteam_i_d_remote, int32_t n_channel))
    ...
    IL2CPP_REGISTER_METHOD(0x0278E490, app::SNetListenSocket_t, CreateListenSocket, (int32_t n_virtual_p2_p_port, uint32_t n_i_p, uint16_t n_port, bool b_allow_use_of_packet_relay))
    IL2CPP_REGISTER_METHOD(0x0278E500, app::SNetSocket_t, CreateP2PConnectionSocket, (app::CSteamID steam_i_d_target, int32_t n_virtual_port, int32_t n_timeout_sec, bool b_allow_use_of_packet_relay))
    ...
    IL2CPP_REGISTER_METHOD(0x0278E6F0, bool, RetrieveDataFromSocket, (app::SNetSocket_t h_socket, app::Byte__Array * pub_dest, uint32_t cub_dest, uint32_t * pcub_msg_size))
    ...
    IL2CPP_REGISTER_METHOD(0x0278E7A0, bool, RetrieveData, (app::SNetListenSocket_t h_listen_socket, app::Byte__Array * pub_dest, uint32_t cub_dest, uint32_t * pcub_msg_size, app::SNetSocket_t * ph_socket))
    IL2CPP_REGISTER_METHOD(0x0278E810, bool, GetSocketInfo, (app::SNetSocket_t h_socket, app::CSteamID * p_steam_i_d_remote, int32_t * pe_socket_status, uint32_t * pun_i_p_remote, uint16_t * pun_port_remote))

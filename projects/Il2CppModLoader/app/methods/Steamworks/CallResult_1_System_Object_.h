...
namespace app::methods::Steamworks::CallResult_1_System_Object_ {
    IL2CPP_REGISTER_METHOD(0x002FB9B0, app::SteamAPICall_t, get_Handle, (app::CallResult_1_System_Object_ * this_ptr))
    IL2CPP_REGISTER_METHOD(0x01D1A5D0, void, add_m_Func, (app::CallResult_1_System_Object_ * this_ptr, app::CallResult_1_T_APIDispatchDelegate_System_Object_ * value))
    IL2CPP_REGISTER_METHOD(0x01D1A690, void, remove_m_Func, (app::CallResult_1_System_Object_ * this_ptr, app::CallResult_1_T_APIDispatchDelegate_System_Object_ * value))
    ...
    IL2CPP_REGISTER_METHOD(0x01D1B230, void, OnRunCallResult, (app::CallResult_1_System_Object_ * this_ptr, void * thisptr, void * pv_param, bool b_failed, uint64_t h_steam_a_p_i_call_))

...
namespace app::methods::CameraFilterPack_AAA_Blood_Hit {
    ...
    IL2CPP_REGISTER_METHOD(0x0273B450, void, OnRenderImage, (app::CameraFilterPack_AAA_Blood_Hit * this_ptr, app::RenderTexture * source_texture, app::RenderTexture * dest_texture))

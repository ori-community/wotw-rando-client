...
namespace app::methods::ForceLanguageTranslatedMessageProvider__GetMessages_d__1 {
    ...
    IL2CPP_REGISTER_METHOD(0x004BD960, app::MessageDescriptor, IEnumerator_MessageDescriptor__get_Current, (app::ForceLanguageTranslatedMessageProvider_GetMessages_d_1 * this_ptr))
    ...
    IL2CPP_REGISTER_METHODINFO(0x0470F9D8, ForceLanguageTranslatedMessageProvider_GetMessages_d_1_System_Collections_IEnumerator_Reset__MethodInfo)
    ...
    IL2CPP_REGISTER_METHOD(0x01281050, app::IEnumerator_1_MessageDescriptor_ *, IEnumerable_MessageDescriptor__GetEnumerator, (app::ForceLanguageTranslatedMessageProvider_GetMessages_d_1 * this_ptr))

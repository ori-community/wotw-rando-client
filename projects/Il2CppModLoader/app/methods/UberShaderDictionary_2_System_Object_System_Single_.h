...
namespace app::methods::UberShaderDictionary_2_System_Object_System_Single_ {
    ...
    IL2CPP_REGISTER_METHOD(0x0225D7A0, app::Dictionary_2_TKey_TValue_ValueCollection_System_Object_System_Single_ *, get_Values, (app::UberShaderDictionary_2_System_Object_System_Single_ * this_ptr))
    IL2CPP_REGISTER_METHOD(0x0225D7D0, app::Dictionary_2_TKey_TValue_KeyCollection_System_Object_System_Single_ *, get_Keys, (app::UberShaderDictionary_2_System_Object_System_Single_ * this_ptr))
    IL2CPP_REGISTER_METHOD(0x0225D800, app::IEnumerator_1_KeyValuePair_2_System_Object_System_Single_ *, System_Collections_Generic_IEnumerable_System_Collections_Generic_KeyValuePair_TK_TV___GetEnumerator, (app::UberShaderDictionary_2_System_Object_System_Single_ * this_ptr))

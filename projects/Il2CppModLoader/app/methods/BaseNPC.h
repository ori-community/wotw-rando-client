...
namespace app::methods::BaseNPC {
    ...
    IL2CPP_REGISTER_METHOD(0x00F86C70, void, StartInteraction, (app::BaseNPC * this_ptr, app::InteractionSettings * interaction_settings, app::String * replace, app::String * with))

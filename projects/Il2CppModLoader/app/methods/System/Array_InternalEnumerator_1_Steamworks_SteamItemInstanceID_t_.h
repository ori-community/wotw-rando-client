...
namespace app::methods::System::Array_InternalEnumerator_1_Steamworks_SteamItemInstanceID_t_ {
    ...
    IL2CPP_REGISTER_METHOD(0x001B23C0, app::SteamItemInstanceID_t, get_Current, (app::Array_InternalEnumerator_1_Steamworks_SteamItemInstanceID_t___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04791500, Array_InternalEnumerator_1_Steamworks_SteamItemInstanceID_t__get_Current__MethodInfo)
    ...
    IL2CPP_REGISTER_METHOD(0x001B2540, app::Object *, IEnumerator_get_Current, (app::Array_InternalEnumerator_1_Steamworks_SteamItemInstanceID_t___Boxed * this_ptr))
}

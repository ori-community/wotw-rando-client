...
namespace app::methods::System::Array_EmptyInternalEnumerator_1_EntityWeightData_EntityWeightSettings_ {
    ...
    IL2CPP_REGISTER_METHOD(0x01D048C0, app::EntityWeightData_EntityWeightSettings, get_Current, (app::Array_EmptyInternalEnumerator_1_EntityWeightData_EntityWeightSettings_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0473AC58, Array_EmptyInternalEnumerator_1_EntityWeightData_EntityWeightSettings__get_Current__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x01D02370, app::Object *, IEnumerator_get_Current, (app::Array_EmptyInternalEnumerator_1_EntityWeightData_EntityWeightSettings_ * this_ptr))

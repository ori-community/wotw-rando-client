...
namespace app::methods::System::Array_InternalEnumerator_1_MicroProfilerGraph_MetricCache_ {
    ...
    IL2CPP_REGISTER_METHOD(0x00163BB0, app::MicroProfilerGraph_MetricCache, get_Current, (app::Array_InternalEnumerator_1_MicroProfilerGraph_MetricCache___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0472AA48, Array_InternalEnumerator_1_MicroProfilerGraph_MetricCache__get_Current__MethodInfo)

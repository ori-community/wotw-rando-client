...
namespace app::methods::System::Array_InternalEnumerator_1_SceneLoadingQueue_QueueSceneToLoad_ {
    ...
    IL2CPP_REGISTER_METHOD(0x001AFE00, app::SceneLoadingQueue_QueueSceneToLoad, get_Current, (app::Array_InternalEnumerator_1_SceneLoadingQueue_QueueSceneToLoad___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0470AA78, Array_InternalEnumerator_1_SceneLoadingQueue_QueueSceneToLoad__get_Current__MethodInfo)
    ...
    IL2CPP_REGISTER_METHOD(0x001AFE30, app::Object *, IEnumerator_get_Current, (app::Array_InternalEnumerator_1_SceneLoadingQueue_QueueSceneToLoad___Boxed * this_ptr))
}

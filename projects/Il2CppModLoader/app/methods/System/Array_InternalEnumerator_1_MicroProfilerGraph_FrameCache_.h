...
namespace app::methods::System::Array_InternalEnumerator_1_MicroProfilerGraph_FrameCache_ {
    ...
    IL2CPP_REGISTER_METHOD(0x00163A00, app::MicroProfilerGraph_FrameCache, get_Current, (app::Array_InternalEnumerator_1_MicroProfilerGraph_FrameCache___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047988D0, Array_InternalEnumerator_1_MicroProfilerGraph_FrameCache__get_Current__MethodInfo)

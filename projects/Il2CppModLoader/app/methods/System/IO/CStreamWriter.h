...
namespace app::classes::System::IO::CStreamWriter {
    ...
    IL2CPP_REGISTER_METHOD(0x01E018F0, void, Write_2, (app::CStreamWriter * this_ptr, uint16_t val))
    IL2CPP_REGISTER_METHOD(0x01E01AE0, void, InternalWriteString, (app::CStreamWriter * this_ptr, app::String* val))
    IL2CPP_REGISTER_METHOD(0x01E01B80, void, InternalWriteChar, (app::CStreamWriter * this_ptr, uint16_t val))

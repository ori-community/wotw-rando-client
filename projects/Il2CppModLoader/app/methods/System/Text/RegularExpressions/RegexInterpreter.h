...
namespace app::methods::System::Text::RegularExpressions::RegexInterpreter {
    ...
    inline IL2CPP_REGISTER_METHOD(0x02593B30, void, SetOperator, (app::RegexInterpreter * this_ptr, int32_t op))
    ...
    inline IL2CPP_REGISTER_METHOD(0x00C03C70, int32_t, Operator, (app::RegexInterpreter * this_ptr))

...
namespace app::methods::System::Array_InternalEnumerator_1_FullSerializer_Internal_fsVersionedType_ {
    ...
    IL2CPP_REGISTER_METHOD(0x001615D0, app::fsVersionedType, get_Current, (app::Array_InternalEnumerator_1_FullSerializer_Internal_fsVersionedType___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0475E278, Array_InternalEnumerator_1_FullSerializer_Internal_fsVersionedType__get_Current__MethodInfo)
    ...
    IL2CPP_REGISTER_METHOD(0x00161600, app::Object *, IEnumerator_get_Current, (app::Array_InternalEnumerator_1_FullSerializer_Internal_fsVersionedType___Boxed * this_ptr))
}

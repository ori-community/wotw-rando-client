...
namespace app::methods::System::Array_InternalEnumerator_1_GameplayCameraTargetEntry_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x047112A0, Array_InternalEnumerator_1_GameplayCameraTargetEntry__get_Current__MethodInfo)

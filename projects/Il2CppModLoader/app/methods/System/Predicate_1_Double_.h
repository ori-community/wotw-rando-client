...
namespace app::methods::System::Predicate_1_Double_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02A51DF0, app::IAsyncResult *, BeginInvoke, (app::Predicate_1_Double_ * this_ptr, double obj, app::AsyncCallback * callback, app::Object * object))

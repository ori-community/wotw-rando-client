...
namespace app::methods::System::Predicate_1_Moon_ActiveAnimationHandle_ {
    ...
    IL2CPP_REGISTER_METHOD(0x028907A0, app::IAsyncResult *, BeginInvoke, (app::Predicate_1_Moon_ActiveAnimationHandle_ * this_ptr, app::ActiveAnimationHandle obj, app::AsyncCallback * callback, app::Object * object))

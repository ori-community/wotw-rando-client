...
namespace app::methods::System::Array_InternalEnumerator_1_FullSerializer_fsAotConfiguration_Entry_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04709870, Array_InternalEnumerator_1_FullSerializer_fsAotConfiguration_Entry__get_Current__MethodInfo)

...
namespace app::methods::System::Array_InternalEnumerator_1_XboxOneStatistics_StatisticReading_ {
    ...
    IL2CPP_REGISTER_METHOD(0x00178350, app::XboxOneStatistics_StatisticReading, get_Current, (app::Array_InternalEnumerator_1_XboxOneStatistics_StatisticReading___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047934F0, Array_InternalEnumerator_1_XboxOneStatistics_StatisticReading__get_Current__MethodInfo)
    ...
    IL2CPP_REGISTER_METHOD(0x00178380, app::Object *, IEnumerator_get_Current, (app::Array_InternalEnumerator_1_XboxOneStatistics_StatisticReading___Boxed * this_ptr))
}

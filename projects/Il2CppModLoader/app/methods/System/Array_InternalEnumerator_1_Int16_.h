...
namespace app::methods::System::Array_InternalEnumerator_1_Int16_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0473B0E0, Array_InternalEnumerator_1_Int16__get_Current__MethodInfo)

...
namespace app::methods::System::Array_InternalEnumerator_1_FullSerializer_Internal_fsOption_1_ {
    ...
    IL2CPP_REGISTER_METHOD(0x00161420, app::fsOption_1_fsVersionedType_, get_Current, (app::Array_InternalEnumerator_1_FullSerializer_Internal_fsOption_1___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04718708, Array_InternalEnumerator_1_FullSerializer_Internal_fsOption_1__get_Current__MethodInfo)
    ...
    IL2CPP_REGISTER_METHOD(0x00161450, app::Object *, IEnumerator_get_Current, (app::Array_InternalEnumerator_1_FullSerializer_Internal_fsOption_1___Boxed * this_ptr))
}

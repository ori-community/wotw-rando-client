...
namespace app::methods::System::Array_InternalEnumerator_1_ByteEnum_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04780A60, Array_InternalEnumerator_1_ByteEnum__get_Current__MethodInfo)

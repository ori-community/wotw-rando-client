...
namespace app::methods::System::Array_InternalEnumerator_1_Moon_Timeline_Reaction_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04767BB8, Array_InternalEnumerator_1_Moon_Timeline_Reaction__get_Current__MethodInfo)

...
namespace app::methods::System::Array_InternalEnumerator_1_UberShaderCurveBake_GradientData_ {
    ...
    IL2CPP_REGISTER_METHOD(0x00174340, app::UberShaderCurveBake_GradientData, get_Current, (app::Array_InternalEnumerator_1_UberShaderCurveBake_GradientData___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0473C768, Array_InternalEnumerator_1_UberShaderCurveBake_GradientData__get_Current__MethodInfo)
    ...
    IL2CPP_REGISTER_METHOD(0x00174380, app::Object *, IEnumerator_get_Current, (app::Array_InternalEnumerator_1_UberShaderCurveBake_GradientData___Boxed * this_ptr))
}

...
namespace app::methods::System::Array_InternalEnumerator_1_AchievementToDisplay_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04791EB0, Array_InternalEnumerator_1_AchievementToDisplay__get_Current__MethodInfo)

...
namespace app::methods::System::Array_InternalEnumerator_1_PlayFab_PluginContractKey_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0474DDC0, Array_InternalEnumerator_1_PlayFab_PluginContractKey__get_Current__MethodInfo)

...
namespace app::methods::System::Array_EmptyInternalEnumerator_1_SceneLoadingQueue_QueueSceneToLoad_ {
    ...
    IL2CPP_REGISTER_METHOD(0x01D080F0, app::SceneLoadingQueue_QueueSceneToLoad, get_Current, (app::Array_EmptyInternalEnumerator_1_SceneLoadingQueue_QueueSceneToLoad_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047579B0, Array_EmptyInternalEnumerator_1_SceneLoadingQueue_QueueSceneToLoad__get_Current__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x01CFF500, app::Object *, IEnumerator_get_Current, (app::Array_EmptyInternalEnumerator_1_SceneLoadingQueue_QueueSceneToLoad_ * this_ptr))

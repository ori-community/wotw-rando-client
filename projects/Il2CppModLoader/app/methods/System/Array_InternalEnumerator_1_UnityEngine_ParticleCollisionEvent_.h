...
namespace app::methods::System::Array_InternalEnumerator_1_UnityEngine_ParticleCollisionEvent_ {
    ...
    IL2CPP_REGISTER_METHOD(0x001762D0, app::ParticleCollisionEvent, get_Current, (app::Array_InternalEnumerator_1_UnityEngine_ParticleCollisionEvent___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047335B8, Array_InternalEnumerator_1_UnityEngine_ParticleCollisionEvent__get_Current__MethodInfo)
    ...
    IL2CPP_REGISTER_METHOD(0x00176310, app::Object *, IEnumerator_get_Current, (app::Array_InternalEnumerator_1_UnityEngine_ParticleCollisionEvent___Boxed * this_ptr))
}

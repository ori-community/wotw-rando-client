...
namespace app::methods::System::Array_InternalEnumerator_1_UnityEngine_Rect_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04784328, Array_InternalEnumerator_1_UnityEngine_Rect__get_Current__MethodInfo)

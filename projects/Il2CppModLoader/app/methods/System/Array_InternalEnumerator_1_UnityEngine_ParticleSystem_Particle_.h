...
namespace app::methods::System::Array_InternalEnumerator_1_UnityEngine_ParticleSystem_Particle_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04703668, Array_InternalEnumerator_1_UnityEngine_ParticleSystem_Particle__get_Current__MethodInfo)

...
namespace app::methods::System::Array_InternalEnumerator_1_System_Data_RBTree_1_Node_ {
    ...
    IL2CPP_REGISTER_METHOD(0x00199F10, app::RBTree_1_K_Node_System_Int32_, get_Current_1, (app::Array_InternalEnumerator_1_System_Data_RBTree_1_Node___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047957D0, Array_InternalEnumerator_1_System_Data_RBTree_1_Node__get_Current__MethodInfo)
    ...
    IL2CPP_REGISTER_METHOD(0x00199FF0, app::RBTree_1_K_Node_System_Object_, get_Current_2, (app::Array_InternalEnumerator_1_System_Data_RBTree_1_Node__1__Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047334C8, Array_InternalEnumerator_1_System_Data_RBTree_1_Node__1_get_Current__MethodInfo)

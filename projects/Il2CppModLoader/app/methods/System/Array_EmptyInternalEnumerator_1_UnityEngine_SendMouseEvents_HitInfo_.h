...
namespace app::methods::System::Array_EmptyInternalEnumerator_1_UnityEngine_SendMouseEvents_HitInfo_ {
    ...
    IL2CPP_REGISTER_METHOD(0x01D02ED0, app::SendMouseEvents_HitInfo, get_Current, (app::Array_EmptyInternalEnumerator_1_UnityEngine_SendMouseEvents_HitInfo_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0471F6B8, Array_EmptyInternalEnumerator_1_UnityEngine_SendMouseEvents_HitInfo__get_Current__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x01CFEE40, app::Object *, IEnumerator_get_Current, (app::Array_EmptyInternalEnumerator_1_UnityEngine_SendMouseEvents_HitInfo_ * this_ptr))

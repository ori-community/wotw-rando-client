...
namespace app::methods::System::Func_1_Char_ {
    IL2CPP_REGISTER_METHOD(0x00611810, void, ctor, (app::Func_1_Char_ * this_ptr, app::Object * object, void * method_1))
    IL2CPP_REGISTER_METHOD(0x028812A0, uint16_t, Invoke, (app::Func_1_Char_ * this_ptr))
    ...
    IL2CPP_REGISTER_METHOD(0x024CEF10, uint16_t, EndInvoke, (app::Func_1_Char_ * this_ptr, app::IAsyncResult * result))
}

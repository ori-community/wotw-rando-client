...
namespace app::methods::System::Comparison_1_Newtonsoft_Json_JsonPosition_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02C7B2B0, app::IAsyncResult *, BeginInvoke, (app::Comparison_1_Newtonsoft_Json_JsonPosition_ * this_ptr, app::JsonPosition x, app::JsonPosition y, app::AsyncCallback * callback, app::Object * object))

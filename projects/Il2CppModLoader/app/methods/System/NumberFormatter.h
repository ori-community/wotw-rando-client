...
namespace app::classes::System::NumberFormatter {
    ...
    IL2CPP_REGISTER_METHOD(0x02278220, app::String*, FormatExponential_2, (app::NumberFormatter * this_ptr, int32_t precision, app::NumberFormatInfo* nfi, int32_t exp_digits))
    ...
    IL2CPP_REGISTER_METHOD(0x02279390, void, AppendIntegerStringWithGroupSeparator, (app::NumberFormatter * this_ptr, app::Int32__Array* groups, app::String* group_separator))

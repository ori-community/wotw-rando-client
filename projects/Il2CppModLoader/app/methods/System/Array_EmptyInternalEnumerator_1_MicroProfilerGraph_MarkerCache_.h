...
namespace app::methods::System::Array_EmptyInternalEnumerator_1_MicroProfilerGraph_MarkerCache_ {
    ...
    IL2CPP_REGISTER_METHOD(0x01D05A60, app::MicroProfilerGraph_MarkerCache, get_Current, (app::Array_EmptyInternalEnumerator_1_MicroProfilerGraph_MarkerCache_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04737020, Array_EmptyInternalEnumerator_1_MicroProfilerGraph_MarkerCache__get_Current__MethodInfo)

...
namespace app::methods::System::Array_InternalEnumerator_1_VerticalSpacer_Item_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0477B850, Array_InternalEnumerator_1_VerticalSpacer_Item__get_Current__MethodInfo)

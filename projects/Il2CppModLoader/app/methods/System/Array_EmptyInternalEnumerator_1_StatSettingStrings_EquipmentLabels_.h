...
namespace app::methods::System::Array_EmptyInternalEnumerator_1_StatSettingStrings_EquipmentLabels_ {
    ...
    IL2CPP_REGISTER_METHOD(0x01D088D0, app::StatSettingStrings_EquipmentLabels, get_Current, (app::Array_EmptyInternalEnumerator_1_StatSettingStrings_EquipmentLabels_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0472A6E0, Array_EmptyInternalEnumerator_1_StatSettingStrings_EquipmentLabels__get_Current__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x01CFEE40, app::Object *, IEnumerator_get_Current, (app::Array_EmptyInternalEnumerator_1_StatSettingStrings_EquipmentLabels_ * this_ptr))

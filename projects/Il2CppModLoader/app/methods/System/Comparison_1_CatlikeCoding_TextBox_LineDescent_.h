...
namespace app::methods::System::Comparison_1_CatlikeCoding_TextBox_LineDescent_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02B859D0, app::IAsyncResult *, BeginInvoke, (app::Comparison_1_CatlikeCoding_TextBox_LineDescent_ * this_ptr, app::LineDescent x, app::LineDescent y, app::AsyncCallback * callback, app::Object * object))

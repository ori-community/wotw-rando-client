...
namespace app::methods::System::Array_InternalEnumerator_1_Boolean_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0475B3F8, Array_InternalEnumerator_1_Boolean__get_Current__MethodInfo)

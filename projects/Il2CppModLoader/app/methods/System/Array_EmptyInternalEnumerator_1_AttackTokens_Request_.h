...
namespace app::methods::System::Array_EmptyInternalEnumerator_1_AttackTokens_Request_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0474D1B0, Array_EmptyInternalEnumerator_1_AttackTokens_Request__get_Current__MethodInfo)

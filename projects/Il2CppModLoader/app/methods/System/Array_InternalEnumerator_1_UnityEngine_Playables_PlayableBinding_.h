...
namespace app::methods::System::Array_InternalEnumerator_1_UnityEngine_Playables_PlayableBinding_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04738888, Array_InternalEnumerator_1_UnityEngine_Playables_PlayableBinding__get_Current__MethodInfo)

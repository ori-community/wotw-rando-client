...
namespace app::methods::System::Predicate_1_LoadDebugMenuPage_DebugSaveInfo_ {
    ...
    IL2CPP_REGISTER_METHOD(0x0288FDC0, app::IAsyncResult *, BeginInvoke, (app::Predicate_1_LoadDebugMenuPage_DebugSaveInfo_ * this_ptr, app::LoadDebugMenuPage_DebugSaveInfo obj, app::AsyncCallback * callback, app::Object * object))

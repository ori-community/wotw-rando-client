...
namespace app::methods::System::Array_InternalEnumerator_1_System_Numerics_BigInteger_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0472B868, Array_InternalEnumerator_1_System_Numerics_BigInteger__get_Current__MethodInfo)

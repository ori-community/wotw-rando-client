...
namespace app::methods::System::Array_EmptyInternalEnumerator_1_Steamworks_SteamItemDef_t_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0477C410, Array_EmptyInternalEnumerator_1_Steamworks_SteamItemDef_t__get_Current__MethodInfo)

...
namespace app::methods::System::Array_InternalEnumerator_1_System_Net_HeaderVariantInfo_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04773428, Array_InternalEnumerator_1_System_Net_HeaderVariantInfo__get_Current__MethodInfo)

...
namespace app::methods::System::Data::DataTableNewRowEventHandler {
    ...
    IL2CPP_REGISTER_METHOD(0x01435260, app::IAsyncResult *, BeginInvoke, (app::DataTableNewRowEventHandler * this_ptr, app::Object * sender, app::DataTableNewRowEventArgs * e, app::AsyncCallback * callback, app::Object * object))

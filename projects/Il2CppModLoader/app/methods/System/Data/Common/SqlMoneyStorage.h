...
namespace app::methods::System::Data::Common::SqlMoneyStorage {
    ...
    IL2CPP_REGISTER_METHOD(0x0285DF50, void, CopyValue, (app::SqlMoneyStorage * this_ptr, int32_t record, app::Object * store, app::BitArray * nullbits, int32_t store_index))

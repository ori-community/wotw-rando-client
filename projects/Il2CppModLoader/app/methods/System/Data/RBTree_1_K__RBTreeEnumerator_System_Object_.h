...
namespace app::methods::System::Data::RBTree_1_K__RBTreeEnumerator_System_Object_ {
    ...
    IL2CPP_REGISTER_METHOD(0x0023FE20, void, ctor_2, (app::RBTree_1_K_RBTreeEnumerator_System_Object___Boxed * this_ptr, app::RBTree_1_System_Object_ * tree, int32_t position))
    IL2CPP_REGISTER_METHODINFO(0x04762688, RBTree_1_K_RBTreeEnumerator_System_Object___ctor_1__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04742798, RBTree_1_K_RBTreeEnumerator_System_Object__MoveNext__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x0023FFB0, void, IEnumerator_Reset, (app::RBTree_1_K_RBTreeEnumerator_System_Object___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04711DA0, RBTree_1_K_RBTreeEnumerator_System_Object__System_Collections_IEnumerator_Reset__MethodInfo)
}

...
namespace app::methods::System::Net::Sockets::SocketAsyncEventArgs {
    ...
    IL2CPP_REGISTER_METHOD(0x020A1770, void, add_Completed, (app::SocketAsyncEventArgs * this_ptr, app::EventHandler_1_System_Net_Sockets_SocketAsyncEventArgs_ * value))
    IL2CPP_REGISTER_METHOD(0x020A1860, void, remove_Completed, (app::SocketAsyncEventArgs * this_ptr, app::EventHandler_1_System_Net_Sockets_SocketAsyncEventArgs_ * value))

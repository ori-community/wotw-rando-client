...
namespace app::methods::System::Array_InternalEnumerator_1_Moon_Locomotion_StateTransitionEntry_ {
    ...
    IL2CPP_REGISTER_METHOD(0x00164900, app::Locomotion_StateTransitionEntry, get_Current, (app::Array_InternalEnumerator_1_Moon_Locomotion_StateTransitionEntry___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0472C358, Array_InternalEnumerator_1_Moon_Locomotion_StateTransitionEntry__get_Current__MethodInfo)
    ...
    IL2CPP_REGISTER_METHOD(0x00164930, app::Object *, IEnumerator_get_Current, (app::Array_InternalEnumerator_1_Moon_Locomotion_StateTransitionEntry___Boxed * this_ptr))
}

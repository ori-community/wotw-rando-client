...
namespace app::methods::System::Array_InternalEnumerator_1_UnityEngine_UI_Navigation_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04700C68, Array_InternalEnumerator_1_UnityEngine_UI_Navigation__get_Current__MethodInfo)

...
namespace app::methods::System::Array_InternalEnumerator_1_UnityEngine_RenderBuffer_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04779758, Array_InternalEnumerator_1_UnityEngine_RenderBuffer__get_Current__MethodInfo)

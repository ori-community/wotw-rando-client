...
namespace app::methods::System::Array_InternalEnumerator_1_HammerTrail_TrailPoint_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04787488, Array_InternalEnumerator_1_HammerTrail_TrailPoint__get_Current__MethodInfo)

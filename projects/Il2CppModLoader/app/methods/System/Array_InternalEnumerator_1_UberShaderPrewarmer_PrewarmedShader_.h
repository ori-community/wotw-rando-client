...
namespace app::methods::System::Array_InternalEnumerator_1_UberShaderPrewarmer_PrewarmedShader_ {
    ...
    IL2CPP_REGISTER_METHOD(0x00174500, app::UberShaderPrewarmer_PrewarmedShader, get_Current, (app::Array_InternalEnumerator_1_UberShaderPrewarmer_PrewarmedShader___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04744C08, Array_InternalEnumerator_1_UberShaderPrewarmer_PrewarmedShader__get_Current__MethodInfo)
    ...
    IL2CPP_REGISTER_METHOD(0x00174530, app::Object *, IEnumerator_get_Current, (app::Array_InternalEnumerator_1_UberShaderPrewarmer_PrewarmedShader___Boxed * this_ptr))
}

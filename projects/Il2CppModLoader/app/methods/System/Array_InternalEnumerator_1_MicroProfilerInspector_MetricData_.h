...
namespace app::methods::System::Array_InternalEnumerator_1_MicroProfilerInspector_MetricData_ {
    ...
    IL2CPP_REGISTER_METHOD(0x00163C80, app::MicroProfilerInspector_MetricData, get_Current, (app::Array_InternalEnumerator_1_MicroProfilerInspector_MetricData___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04761D70, Array_InternalEnumerator_1_MicroProfilerInspector_MetricData__get_Current__MethodInfo)
    ...
    IL2CPP_REGISTER_METHOD(0x00163CC0, app::Object *, IEnumerator_get_Current, (app::Array_InternalEnumerator_1_MicroProfilerInspector_MetricData___Boxed * this_ptr))
}

...
namespace app::classes::System::Array_InternalEnumerator_1_Moon_VerletBodyIndexed_Point_ {
    ...
    IL2CPP_REGISTER_METHOD(0x001ADD60, app::VerletBodyIndexed_Point, get_Current, (app::Array_InternalEnumerator_1_Moon_VerletBodyIndexed_Point___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04769840, Array_InternalEnumerator_1_Moon_VerletBodyIndexed_Point__get_Current__MethodInfo)

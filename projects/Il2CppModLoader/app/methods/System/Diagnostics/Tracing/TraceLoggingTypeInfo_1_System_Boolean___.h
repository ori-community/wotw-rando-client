...
namespace app::methods::System::Diagnostics::Tracing::TraceLoggingTypeInfo_1_System_Boolean___ {
    IL2CPP_REGISTER_METHOD(0x02876620, void, ctor, (app::TraceLoggingTypeInfo_1_System_Boolean__1 * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047386A0, TraceLoggingTypeInfo_1_System_Boolean__1__ctor__MethodInfo)

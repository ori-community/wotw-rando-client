...
namespace app::methods::System::Diagnostics::Tracing::NonGenericProperytWriter_1_System_Boolean_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02BA0C30, void, Write, (app::NonGenericProperytWriter_1_System_Boolean_ * this_ptr, app::TraceLoggingDataCollector * collector, bool * container))

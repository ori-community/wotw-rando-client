...
namespace app::methods::System::Diagnostics::Tracing::NonGenericProperytWriter_1_System_Int64_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02BA1050, void, Write, (app::NonGenericProperytWriter_1_System_Int64_ * this_ptr, app::TraceLoggingDataCollector * collector, int64_t * container))

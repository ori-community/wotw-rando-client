...
namespace app::methods::System::Diagnostics::Tracing::ClassPropertyWriter_2_System_Single_System_Int32_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02B3C840, void, Write, (app::ClassPropertyWriter_2_System_Single_System_Int32_ * this_ptr, app::TraceLoggingDataCollector * collector, float * container))

...
namespace app::classes::System::Diagnostics::Tracing::TraceLoggingTypeInfo_1_System_UInt16_ {
    IL2CPP_REGISTER_METHOD(0x02877D40, void, ctor_1, (app::TraceLoggingTypeInfo_1_System_UInt16_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0472DA50, TraceLoggingTypeInfo_1_System_UInt16___ctor__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02877E10, void, ctor_2, (app::TraceLoggingTypeInfo_1_System_UInt16_ * this_ptr, app::String* name, app::EventLevel__Enum level, app::EventOpcode__Enum opcode, app::EventKeywords__Enum keywords, app::EventTags__Enum tags))

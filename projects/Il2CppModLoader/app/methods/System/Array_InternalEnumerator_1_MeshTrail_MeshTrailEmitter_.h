...
namespace app::methods::System::Array_InternalEnumerator_1_MeshTrail_MeshTrailEmitter_ {
    ...
    IL2CPP_REGISTER_METHOD(0x00163340, app::MeshTrail_MeshTrailEmitter, get_Current, (app::Array_InternalEnumerator_1_MeshTrail_MeshTrailEmitter___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04738B20, Array_InternalEnumerator_1_MeshTrail_MeshTrailEmitter__get_Current__MethodInfo)

...
namespace app::methods::System::Array_InternalEnumerator_1_GlobalPlaceholderCountData_Tally_ {
    ...
    IL2CPP_REGISTER_METHOD(0x00161F60, app::GlobalPlaceholderCountData_Tally, get_Current, (app::Array_InternalEnumerator_1_GlobalPlaceholderCountData_Tally___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0475EE08, Array_InternalEnumerator_1_GlobalPlaceholderCountData_Tally__get_Current__MethodInfo)
    ...
    IL2CPP_REGISTER_METHOD(0x00161F90, app::Object *, IEnumerator_get_Current, (app::Array_InternalEnumerator_1_GlobalPlaceholderCountData_Tally___Boxed * this_ptr))
}

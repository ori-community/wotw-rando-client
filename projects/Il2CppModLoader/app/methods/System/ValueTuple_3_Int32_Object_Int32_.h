...
namespace app::methods::System::ValueTuple_3_Int32_Object_Int32_ {
    ...
    IL2CPP_REGISTER_METHOD(0x0021E720, bool, IStructuralEquatable_Equals, (app::ValueTuple_3_Int32_Object_Int32___Boxed * this_ptr, app::Object * other, app::IEqualityComparer * comparer))
    ...
    IL2CPP_REGISTER_METHODINFO(0x0477A018, ValueTuple_3_Int32_Object_Int32__System_IComparable_CompareTo__MethodInfo)
    ...
    IL2CPP_REGISTER_METHOD(0x0021E770, int32_t, IStructuralComparable_CompareTo, (app::ValueTuple_3_Int32_Object_Int32___Boxed * this_ptr, app::Object * other, app::IComparer * comparer))
    IL2CPP_REGISTER_METHODINFO(0x0475DCA8, ValueTuple_3_Int32_Object_Int32__System_Collections_IStructuralComparable_CompareTo__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x0021E780, int32_t, GetHashCode, (app::ValueTuple_3_Int32_Object_Int32___Boxed * this_ptr))
    IL2CPP_REGISTER_METHOD(0x0021E7D0, int32_t, IStructuralEquatable_GetHashCode, (app::ValueTuple_3_Int32_Object_Int32___Boxed * this_ptr, app::IEqualityComparer * comparer))

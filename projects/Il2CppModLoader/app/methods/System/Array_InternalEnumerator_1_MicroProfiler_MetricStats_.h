...
namespace app::methods::System::Array_InternalEnumerator_1_MicroProfiler_MetricStats_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04779450, Array_InternalEnumerator_1_MicroProfiler_MetricStats__get_Current__MethodInfo)

...
namespace app::methods::System::Nullable_1_UnityEngine_RaycastHit_ {
    IL2CPP_REGISTER_METHOD(0x00211790, void, ctor, (app::Nullable_1_UnityEngine_RaycastHit___Boxed * this_ptr, app::RaycastHit value))
    IL2CPP_REGISTER_METHODINFO(0x04713078, Nullable_1_UnityEngine_RaycastHit___ctor__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x002117C0, app::RaycastHit, get_Value, (app::Nullable_1_UnityEngine_RaycastHit___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047382A0, Nullable_1_UnityEngine_RaycastHit__get_Value__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x002117B0, bool, get_HasValue, (app::Nullable_1_UnityEngine_RaycastHit___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04714348, Nullable_1_UnityEngine_RaycastHit__get_HasValue__MethodInfo)

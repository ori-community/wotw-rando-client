...
namespace app::methods::System::Tuple_2_Object_Char_ {
    IL2CPP_REGISTER_METHOD(0x002FA280, app::Object *, get_Item1, (app::Tuple_2_Object_Char_ * this_ptr))
    IL2CPP_REGISTER_METHOD(0x02A66330, uint16_t, get_Item2, (app::Tuple_2_Object_Char_ * this_ptr))
    IL2CPP_REGISTER_METHOD(0x02A66340, void, ctor, (app::Tuple_2_Object_Char_ * this_ptr, app::Object * item1, uint16_t item2))
    IL2CPP_REGISTER_METHOD(0x02A66360, bool, Equals, (app::Tuple_2_Object_Char_ * this_ptr, app::Object * obj))
    IL2CPP_REGISTER_METHOD(0x02A66440, bool, IStructuralEquatable_Equals, (app::Tuple_2_Object_Char_ * this_ptr, app::Object * other, app::IEqualityComparer * comparer))
    IL2CPP_REGISTER_METHOD(0x02A665E0, int32_t, IComparable_CompareTo, (app::Tuple_2_Object_Char_ * this_ptr, app::Object * obj))
    IL2CPP_REGISTER_METHOD(0x02A666C0, int32_t, IStructuralComparable_CompareTo, (app::Tuple_2_Object_Char_ * this_ptr, app::Object * other, app::IComparer * comparer))
    IL2CPP_REGISTER_METHODINFO(0x04732330, Tuple_2_Object_Char__System_Collections_IStructuralComparable_CompareTo__MethodInfo)

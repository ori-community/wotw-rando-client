...
namespace app::methods::System::Array_InternalEnumerator_1_Moon_UI_TextBoxLine_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04734730, Array_InternalEnumerator_1_Moon_UI_TextBoxLine__get_Current__MethodInfo)

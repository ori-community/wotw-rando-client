...
namespace app::methods::System::Array_InternalEnumerator_1_SByte_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0470ADE0, Array_InternalEnumerator_1_SByte__get_Current__MethodInfo)

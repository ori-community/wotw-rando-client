...
namespace app::methods::System::ValueTuple_2_Int32_Boolean_ {
    IL2CPP_REGISTER_METHOD(0x001508B0, void, ctor, (app::ValueTuple_2_Int32_Boolean___Boxed * this_ptr, int32_t item1, bool item2))
    IL2CPP_REGISTER_METHODINFO(0x0471F428, ValueTuple_2_Int32_Boolean___ctor__MethodInfo)
    ...
    IL2CPP_REGISTER_METHOD(0x0021C2B0, bool, IStructuralEquatable_Equals, (app::ValueTuple_2_Int32_Boolean___Boxed * this_ptr, app::Object * other, app::IEqualityComparer * comparer))
    ...
    IL2CPP_REGISTER_METHODINFO(0x04723EF8, ValueTuple_2_Int32_Boolean__System_IComparable_CompareTo__MethodInfo)
    ...
    IL2CPP_REGISTER_METHOD(0x0021C400, int32_t, IStructuralComparable_CompareTo, (app::ValueTuple_2_Int32_Boolean___Boxed * this_ptr, app::Object * other, app::IComparer * comparer))
    IL2CPP_REGISTER_METHODINFO(0x04762BB0, ValueTuple_2_Int32_Boolean__System_Collections_IStructuralComparable_CompareTo__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x0021C410, int32_t, GetHashCode, (app::ValueTuple_2_Int32_Boolean___Boxed * this_ptr))
    IL2CPP_REGISTER_METHOD(0x0021C430, int32_t, IStructuralEquatable_GetHashCode, (app::ValueTuple_2_Int32_Boolean___Boxed * this_ptr, app::IEqualityComparer * comparer))

...
namespace app::methods::System::Array_InternalEnumerator_1_CatlikeCoding_TextBox_TextBoxLine_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04778508, Array_InternalEnumerator_1_CatlikeCoding_TextBox_TextBoxLine__get_Current__MethodInfo)
    ...
    IL2CPP_REGISTER_METHOD(0x001C8FA0, app::Object *, IEnumerator_get_Current, (app::Array_InternalEnumerator_1_CatlikeCoding_TextBox_TextBoxLine___Boxed * this_ptr))
}

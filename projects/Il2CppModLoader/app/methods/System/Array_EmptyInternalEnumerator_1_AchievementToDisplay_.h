...
namespace app::methods::System::Array_EmptyInternalEnumerator_1_AchievementToDisplay_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04773778, Array_EmptyInternalEnumerator_1_AchievementToDisplay__get_Current__MethodInfo)

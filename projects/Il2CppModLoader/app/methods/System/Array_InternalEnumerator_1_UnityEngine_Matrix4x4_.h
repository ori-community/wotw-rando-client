...
namespace app::methods::System::Array_InternalEnumerator_1_UnityEngine_Matrix4x4_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0474ABD8, Array_InternalEnumerator_1_UnityEngine_Matrix4x4__get_Current__MethodInfo)

...
namespace app::methods::System::Predicate_1_Moon_Substr_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02891BE0, app::IAsyncResult *, BeginInvoke, (app::Predicate_1_Moon_Substr_ * this_ptr, app::Substr obj, app::AsyncCallback * callback, app::Object * object))

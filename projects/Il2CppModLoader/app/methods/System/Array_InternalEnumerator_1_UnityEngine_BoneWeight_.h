...
namespace app::methods::System::Array_InternalEnumerator_1_UnityEngine_BoneWeight_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0478DB58, Array_InternalEnumerator_1_UnityEngine_BoneWeight__get_Current__MethodInfo)

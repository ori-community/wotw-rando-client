...
namespace app::methods::System::Runtime::Serialization::SafeSerializationManager {
    ...
    IL2CPP_REGISTER_METHOD(0x01EDBEC0, void, CompleteSerialization, (app::SafeSerializationManager * this_ptr, app::Object * serialized_object, app::SerializationInfo * info, app::StreamingContext context))
    ...
    IL2CPP_REGISTER_METHOD(0x01EDC4E0, void, ISerializable_GetObjectData, (app::SafeSerializationManager * this_ptr, app::SerializationInfo * info, app::StreamingContext context))

...
namespace app::methods::System::Array_InternalEnumerator_1_StatSettingStrings_EquipmentLabels_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04711460, Array_InternalEnumerator_1_StatSettingStrings_EquipmentLabels__get_Current__MethodInfo)

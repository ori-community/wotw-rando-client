...
namespace app::methods::System::Array_InternalEnumerator_1_UberShaderCustomShaderBlockResult_ {
    ...
    IL2CPP_REGISTER_METHOD(0x00174430, app::UberShaderCustomShaderBlockResult, get_Current, (app::Array_InternalEnumerator_1_UberShaderCustomShaderBlockResult___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047047B8, Array_InternalEnumerator_1_UberShaderCustomShaderBlockResult__get_Current__MethodInfo)
    ...
    IL2CPP_REGISTER_METHOD(0x00174460, app::Object *, IEnumerator_get_Current, (app::Array_InternalEnumerator_1_UberShaderCustomShaderBlockResult___Boxed * this_ptr))
}

...
namespace app::methods::System::Nullable_1_Newtonsoft_Json_JsonPosition_ {
    IL2CPP_REGISTER_METHOD(0x001F7BF0, bool, get_HasValue, (app::Nullable_1_Newtonsoft_Json_JsonPosition___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04774828, Nullable_1_Newtonsoft_Json_JsonPosition__get_HasValue__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04740468, Nullable_1_Newtonsoft_Json_JsonPosition__GetValueOrDefault__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04712868, Nullable_1_Newtonsoft_Json_JsonPosition___ctor__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04766610, Nullable_1_Newtonsoft_Json_JsonPosition__get_Value__MethodInfo)
    ...
    IL2CPP_REGISTER_METHOD(0x001F7D70, bool, Equals_2, (app::Nullable_1_Newtonsoft_Json_JsonPosition___Boxed * this_ptr, app::Nullable_1_Newtonsoft_Json_JsonPosition_ other))
    IL2CPP_REGISTER_METHOD(0x001F7DF0, int32_t, GetHashCode, (app::Nullable_1_Newtonsoft_Json_JsonPosition___Boxed * this_ptr))
    IL2CPP_REGISTER_METHOD(0x001F7EB0, app::JsonPosition, GetValueOrDefault_2, (app::Nullable_1_Newtonsoft_Json_JsonPosition___Boxed * this_ptr, app::JsonPosition default_value))

...
namespace app::methods::System::Tuple_2_Object_Boolean_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02A659F0, bool, IStructuralEquatable_Equals, (app::Tuple_2_Object_Boolean_ * this_ptr, app::Object * other, app::IEqualityComparer * comparer))
    IL2CPP_REGISTER_METHOD(0x02A65B90, int32_t, IComparable_CompareTo, (app::Tuple_2_Object_Boolean_ * this_ptr, app::Object * obj))
    IL2CPP_REGISTER_METHOD(0x02A65C70, int32_t, IStructuralComparable_CompareTo, (app::Tuple_2_Object_Boolean_ * this_ptr, app::Object * other, app::IComparer * comparer))
    IL2CPP_REGISTER_METHODINFO(0x04767A30, Tuple_2_Object_Boolean__System_Collections_IStructuralComparable_CompareTo__MethodInfo)

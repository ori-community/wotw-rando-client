...
namespace app::classes::System::Dynamic::Utils::ListProvider_1_System_Linq_Expressions_ParameterExpression_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02879AF0, void, Insert, (app::ListProvider_1_System_Linq_Expressions_ParameterExpression_ * this_ptr, int32_t index, app::ParameterExpression* item))
    ...
    IL2CPP_REGISTER_METHOD(0x02879C80, bool, Contains, (app::ListProvider_1_System_Linq_Expressions_ParameterExpression_ * this_ptr, app::ParameterExpression* item))
    IL2CPP_REGISTER_METHOD(0x02879CB0, void, CopyTo, (app::ListProvider_1_System_Linq_Expressions_ParameterExpression_ * this_ptr, app::ParameterExpression__Array* array, int32_t index))
    ...
    IL2CPP_REGISTER_METHOD(0x02879EF0, app::IEnumerator_1_System_Linq_Expressions_ParameterExpression_*, GetEnumerator, (app::ListProvider_1_System_Linq_Expressions_ParameterExpression_ * this_ptr))

...
namespace app::methods::System::Dynamic::Utils::TypeUtils {
    ...
    inline IL2CPP_REGISTER_METHOD(0x01F97C30, bool, HasBuiltInEqualityOperator, (app::Type * left, app::Type * right))
    ...
    inline IL2CPP_REGISTER_METHOD(0x01F98310, app::MethodInfo_1 *, FindConversionOperator, (app::MethodInfo_1__Array * methods, app::Type * type_from, app::Type * type_to))
    ...
    inline IL2CPP_REGISTER_METHOD(0x01F98C50, app::MethodInfo_1 *, GetBooleanOperator, (app::Type * type, app::String * name))

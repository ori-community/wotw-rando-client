...
namespace app::methods::System::Array_InternalEnumerator_1_UberWaterControl_ImpactBuf_ {
    ...
    IL2CPP_REGISTER_METHOD(0x001746B0, app::UberWaterControl_ImpactBuf, get_Current, (app::Array_InternalEnumerator_1_UberWaterControl_ImpactBuf___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04789B20, Array_InternalEnumerator_1_UberWaterControl_ImpactBuf__get_Current__MethodInfo)

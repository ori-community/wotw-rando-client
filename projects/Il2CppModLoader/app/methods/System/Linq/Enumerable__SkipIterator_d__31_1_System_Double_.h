...
namespace app::methods::System::Linq::Enumerable__SkipIterator_d__31_1_System_Double_ {
    ...
    IL2CPP_REGISTER_METHOD(0x0261CB30, double, System_Collections_Generic_IEnumerator_TSource__get_Current, (app::Enumerable_SkipIterator_d_31_1_System_Double_ * this_ptr))
    IL2CPP_REGISTER_METHOD(0x02989220, void, IEnumerator_Reset, (app::Enumerable_SkipIterator_d_31_1_System_Double_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04718AB0, Enumerable_SkipIterator_d_31_1_System_Double__System_Collections_IEnumerator_Reset__MethodInfo)
    ...
    IL2CPP_REGISTER_METHOD(0x0225B900, app::IEnumerator_1_System_Double_ *, System_Collections_Generic_IEnumerable_TSource__GetEnumerator, (app::Enumerable_SkipIterator_d_31_1_System_Double_ * this_ptr))

...
namespace app::methods::System::Linq::Enumerable__CastIterator_d__99_1_System_Object_ {
    IL2CPP_REGISTER_METHOD(0x002FB930, app::Object *, System_Collections_Generic_IEnumerator_TResult__get_Current, (app::Enumerable_CastIterator_d_99_1_System_Object_ * this_ptr))
    ...
    IL2CPP_REGISTER_METHODINFO(0x0473A790, Enumerable_CastIterator_d_99_1_System_Object__System_Collections_IEnumerator_Reset__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02985E70, app::IEnumerator_1_System_Object_ *, System_Collections_Generic_IEnumerable_TResult__GetEnumerator, (app::Enumerable_CastIterator_d_99_1_System_Object_ * this_ptr))

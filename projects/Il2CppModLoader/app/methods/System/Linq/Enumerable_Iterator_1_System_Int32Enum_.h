...
namespace app::methods::System::Linq::Enumerable_Iterator_1_System_Int32Enum_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0472B050, Enumerable_Iterator_1_System_Int32Enum__System_Collections_IEnumerator_Reset__MethodInfo)
}

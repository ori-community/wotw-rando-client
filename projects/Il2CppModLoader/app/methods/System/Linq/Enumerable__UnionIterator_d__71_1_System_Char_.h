...
namespace app::classes::System::Linq::Enumerable__UnionIterator_d__71_1_System_Char_ {
    ...
    IL2CPP_REGISTER_METHOD(0x0298AA10, uint16_t, System_Collections_Generic_IEnumerator_TSource__get_Current, (app::Enumerable_UnionIterator_d_71_1_System_Char_ * this_ptr))
    IL2CPP_REGISTER_METHOD(0x0298AA20, void, IEnumerator_Reset, (app::Enumerable_UnionIterator_d_71_1_System_Char_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047651B8, Enumerable_UnionIterator_d_71_1_System_Char__System_Collections_IEnumerator_Reset__MethodInfo)
    ...
    IL2CPP_REGISTER_METHOD(0x0298AAC0, app::IEnumerator_1_System_Char_*, System_Collections_Generic_IEnumerable_TSource__GetEnumerator, (app::Enumerable_UnionIterator_d_71_1_System_Char_ * this_ptr))

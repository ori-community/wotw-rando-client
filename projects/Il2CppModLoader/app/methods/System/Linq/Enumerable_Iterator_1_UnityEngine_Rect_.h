...
namespace app::methods::System::Linq::Enumerable_Iterator_1_UnityEngine_Rect_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04790AD8, Enumerable_Iterator_1_UnityEngine_Rect__System_Collections_IEnumerator_Reset__MethodInfo)
}

...
namespace app::methods::System::Linq::Expressions::PrimitiveParameterExpression_1_System_Single_ {
    IL2CPP_REGISTER_METHOD(0x025462B0, void, ctor, (app::PrimitiveParameterExpression_1_System_Single_ * this_ptr, app::String * name))
    IL2CPP_REGISTER_METHODINFO(0x047535E8, PrimitiveParameterExpression_1_System_Single___ctor__MethodInfo)

...
namespace app::methods::System::Linq::Expressions::Interpreter::MulOvfInstruction_MulOvfInt16 {
    IL2CPP_REGISTER_METHOD(0x023FF650, int32_t, Run, (app::MulOvfInstruction_MulOvfInt16 * this_ptr, app::InterpretedFrame * frame))
    IL2CPP_REGISTER_METHODINFO(0x0476F138, MulOvfInstruction_MulOvfInt16_Run__MethodInfo)

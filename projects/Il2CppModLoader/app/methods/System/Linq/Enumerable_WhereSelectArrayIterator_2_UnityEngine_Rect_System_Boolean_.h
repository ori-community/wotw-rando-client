...
namespace app::classes::System::Linq::Enumerable_WhereSelectArrayIterator_2_UnityEngine_Rect_System_Boolean_ {
    IL2CPP_REGISTER_METHOD(0x02895170, void, ctor, (app::Enumerable_WhereSelectArrayIterator_2_UnityEngine_Rect_System_Boolean_ * this_ptr, app::Rect__Array* source, app::Func_2_UnityEngine_Rect_Boolean_* predicate, app::Func_2_UnityEngine_Rect_Boolean_* selector))

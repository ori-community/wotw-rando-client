...
namespace app::methods::System::Linq::Enumerable__CastIterator_d__99_1_System_ByteEnum_ {
    ...
    IL2CPP_REGISTER_METHOD(0x00724AE0, app::ByteEnum__Enum, System_Collections_Generic_IEnumerator_TResult__get_Current, (app::Enumerable_CastIterator_d_99_1_System_ByteEnum_ * this_ptr))
    IL2CPP_REGISTER_METHOD(0x02984E50, void, IEnumerator_Reset, (app::Enumerable_CastIterator_d_99_1_System_ByteEnum_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04771090, Enumerable_CastIterator_d_99_1_System_ByteEnum__System_Collections_IEnumerator_Reset__MethodInfo)
    ...
    IL2CPP_REGISTER_METHOD(0x02984EF0, app::IEnumerator_1_System_ByteEnum_ *, System_Collections_Generic_IEnumerable_TResult__GetEnumerator, (app::Enumerable_CastIterator_d_99_1_System_ByteEnum_ * this_ptr))

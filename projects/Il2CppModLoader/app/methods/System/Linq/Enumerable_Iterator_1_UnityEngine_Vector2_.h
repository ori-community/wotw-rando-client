...
namespace app::methods::System::Linq::Enumerable_Iterator_1_UnityEngine_Vector2_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x047648F0, Enumerable_Iterator_1_UnityEngine_Vector2__System_Collections_IEnumerator_Reset__MethodInfo)
}

...
namespace app::methods::System::Linq::Enumerable__TakeIterator_d__25_1_System_Double_ {
    ...
    IL2CPP_REGISTER_METHOD(0x0261CB30, double, System_Collections_Generic_IEnumerator_TSource__get_Current, (app::Enumerable_TakeIterator_d_25_1_System_Double_ * this_ptr))
    IL2CPP_REGISTER_METHOD(0x02989CD0, void, IEnumerator_Reset, (app::Enumerable_TakeIterator_d_25_1_System_Double_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0474D000, Enumerable_TakeIterator_d_25_1_System_Double__System_Collections_IEnumerator_Reset__MethodInfo)
    ...
    IL2CPP_REGISTER_METHOD(0x02989D20, app::IEnumerator_1_System_Double_ *, System_Collections_Generic_IEnumerable_TSource__GetEnumerator, (app::Enumerable_TakeIterator_d_25_1_System_Double_ * this_ptr))

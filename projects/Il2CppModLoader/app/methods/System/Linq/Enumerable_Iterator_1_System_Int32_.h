...
namespace app::methods::System::Linq::Enumerable_Iterator_1_System_Int32_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04755530, Enumerable_Iterator_1_System_Int32__System_Collections_IEnumerator_Reset__MethodInfo)
}

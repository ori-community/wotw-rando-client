...
namespace app::methods::System::Linq::Enumerable_Iterator_1_System_ValueTuple_2_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0470AA20, Enumerable_Iterator_1_System_ValueTuple_2__System_Collections_IEnumerator_Reset__MethodInfo)
}

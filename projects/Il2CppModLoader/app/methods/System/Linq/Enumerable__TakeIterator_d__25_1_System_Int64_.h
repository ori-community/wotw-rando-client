...
namespace app::methods::System::Linq::Enumerable__TakeIterator_d__25_1_System_Int64_ {
    ...
    IL2CPP_REGISTER_METHOD(0x002FB930, int64_t, System_Collections_Generic_IEnumerator_TSource__get_Current, (app::Enumerable_TakeIterator_d_25_1_System_Int64_ * this_ptr))
    IL2CPP_REGISTER_METHOD(0x0298A150, void, IEnumerator_Reset, (app::Enumerable_TakeIterator_d_25_1_System_Int64_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04712498, Enumerable_TakeIterator_d_25_1_System_Int64__System_Collections_IEnumerator_Reset__MethodInfo)
    ...
    IL2CPP_REGISTER_METHOD(0x02989D20, app::IEnumerator_1_System_Int64__1 *, System_Collections_Generic_IEnumerable_TSource__GetEnumerator, (app::Enumerable_TakeIterator_d_25_1_System_Int64_ * this_ptr))

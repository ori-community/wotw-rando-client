...
namespace app::methods::System::Linq::Enumerable_Iterator_1_System_Object_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0477F7A8, Enumerable_Iterator_1_System_Object__System_Collections_IEnumerator_Reset__MethodInfo)
}

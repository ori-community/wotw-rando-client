...
namespace app::methods::System::Linq::Enumerable__DistinctIterator_d__68_1_System_Object_ {
    IL2CPP_REGISTER_METHOD(0x002FB930, app::Object *, System_Collections_Generic_IEnumerator_TSource__get_Current, (app::Enumerable_DistinctIterator_d_68_1_System_Object_ * this_ptr))
    ...
    IL2CPP_REGISTER_METHODINFO(0x04744328, Enumerable_DistinctIterator_d_68_1_System_Object__System_Collections_IEnumerator_Reset__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02986B10, app::IEnumerator_1_System_Object_ *, System_Collections_Generic_IEnumerable_TSource__GetEnumerator, (app::Enumerable_DistinctIterator_d_68_1_System_Object_ * this_ptr))

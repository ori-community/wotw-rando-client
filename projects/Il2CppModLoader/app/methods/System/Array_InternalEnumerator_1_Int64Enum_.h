...
namespace app::methods::System::Array_InternalEnumerator_1_Int64Enum_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x047238F8, Array_InternalEnumerator_1_Int64Enum__get_Current__MethodInfo)

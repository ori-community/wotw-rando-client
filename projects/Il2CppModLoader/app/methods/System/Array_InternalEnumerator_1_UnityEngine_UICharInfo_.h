...
namespace app::methods::System::Array_InternalEnumerator_1_UnityEngine_UICharInfo_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0473ED48, Array_InternalEnumerator_1_UnityEngine_UICharInfo__get_Current__MethodInfo)

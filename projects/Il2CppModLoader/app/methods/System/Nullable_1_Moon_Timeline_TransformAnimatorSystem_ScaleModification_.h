...
namespace app::classes::System::Nullable_1_Moon_Timeline_TransformAnimatorSystem_ScaleModification_ {
    ...
    IL2CPP_REGISTER_METHOD(0x001EB610, void, ctor, (app::Nullable_1_Moon_Timeline_TransformAnimatorSystem_ScaleModification___Boxed * this_ptr, app::TransformAnimatorSystem_ScaleModification value))
    ...
    IL2CPP_REGISTER_METHOD(0x001F6D20, app::TransformAnimatorSystem_ScaleModification, get_Value, (app::Nullable_1_Moon_Timeline_TransformAnimatorSystem_ScaleModification___Boxed * this_ptr))
    ...
    IL2CPP_REGISTER_METHOD(0x001F6FC0, app::TransformAnimatorSystem_ScaleModification, GetValueOrDefault_1, (app::Nullable_1_Moon_Timeline_TransformAnimatorSystem_ScaleModification___Boxed * this_ptr))
    ...
    IL2CPP_REGISTER_METHOD(0x001F6E20, bool, Equals_1, (app::Nullable_1_Moon_Timeline_TransformAnimatorSystem_ScaleModification___Boxed * this_ptr, app::Object* other))
    IL2CPP_REGISTER_METHOD(0x001F6E80, bool, Equals_2, (app::Nullable_1_Moon_Timeline_TransformAnimatorSystem_ScaleModification___Boxed * this_ptr, app::Nullable_1_Moon_Timeline_TransformAnimatorSystem_ScaleModification_ other))
    ...
    IL2CPP_REGISTER_METHOD(0x001F6FE0, app::TransformAnimatorSystem_ScaleModification, GetValueOrDefault_2, (app::Nullable_1_Moon_Timeline_TransformAnimatorSystem_ScaleModification___Boxed * this_ptr, app::TransformAnimatorSystem_ScaleModification default_value))

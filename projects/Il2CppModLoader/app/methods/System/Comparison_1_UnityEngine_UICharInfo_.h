...
namespace app::methods::System::Comparison_1_UnityEngine_UICharInfo_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02C84E30, app::IAsyncResult *, BeginInvoke, (app::Comparison_1_UnityEngine_UICharInfo_ * this_ptr, app::UICharInfo x, app::UICharInfo y, app::AsyncCallback * callback, app::Object * object))

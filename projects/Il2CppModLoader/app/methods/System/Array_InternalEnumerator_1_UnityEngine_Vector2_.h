...
namespace app::methods::System::Array_InternalEnumerator_1_UnityEngine_Vector2_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x047088D8, Array_InternalEnumerator_1_UnityEngine_Vector2__get_Current__MethodInfo)

...
namespace app::methods::System::Array_InternalEnumerator_1_Moon_Trail_Point_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04727AC0, Array_InternalEnumerator_1_Moon_Trail_Point__get_Current__MethodInfo)

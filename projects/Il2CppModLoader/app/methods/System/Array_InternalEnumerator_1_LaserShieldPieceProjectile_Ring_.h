...
namespace app::methods::System::Array_InternalEnumerator_1_LaserShieldPieceProjectile_Ring_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0478EAB0, Array_InternalEnumerator_1_LaserShieldPieceProjectile_Ring__get_Current__MethodInfo)

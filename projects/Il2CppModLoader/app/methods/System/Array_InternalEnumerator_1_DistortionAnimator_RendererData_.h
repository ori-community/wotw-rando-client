...
namespace app::methods::System::Array_InternalEnumerator_1_DistortionAnimator_RendererData_ {
    ...
    IL2CPP_REGISTER_METHOD(0x00160AE0, app::DistortionAnimator_RendererData, get_Current, (app::Array_InternalEnumerator_1_DistortionAnimator_RendererData___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0477F700, Array_InternalEnumerator_1_DistortionAnimator_RendererData__get_Current__MethodInfo)

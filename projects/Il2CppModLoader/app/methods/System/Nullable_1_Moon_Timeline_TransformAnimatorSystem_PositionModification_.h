...
namespace app::methods::System::Nullable_1_Moon_Timeline_TransformAnimatorSystem_PositionModification_ {
    ...
    IL2CPP_REGISTER_METHOD(0x001F63B0, void, ctor, (app::Nullable_1_Moon_Timeline_TransformAnimatorSystem_PositionModification___Boxed * this_ptr, app::TransformAnimatorSystem_PositionModification value))
    ...
    IL2CPP_REGISTER_METHOD(0x001F63E0, app::TransformAnimatorSystem_PositionModification, get_Value, (app::Nullable_1_Moon_Timeline_TransformAnimatorSystem_PositionModification___Boxed * this_ptr))
    ...
    IL2CPP_REGISTER_METHOD(0x001F66E0, app::TransformAnimatorSystem_PositionModification, GetValueOrDefault_1, (app::Nullable_1_Moon_Timeline_TransformAnimatorSystem_PositionModification___Boxed * this_ptr))
    ...
    IL2CPP_REGISTER_METHOD(0x001F6700, app::TransformAnimatorSystem_PositionModification, GetValueOrDefault_2, (app::Nullable_1_Moon_Timeline_TransformAnimatorSystem_PositionModification___Boxed * this_ptr, app::TransformAnimatorSystem_PositionModification default_value))

...
namespace app::methods::System::Collections::ObjectModel::ReadOnlyCollection_1_System_Exception_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04758D20, ReadOnlyCollection_1_System_Exception___ctor__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02B7DD20, int32_t, get_Count, (app::ReadOnlyCollection_1_System_Exception_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04778890, ReadOnlyCollection_1_System_Exception__get_Count__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04728400, ReadOnlyCollection_1_System_Exception__CopyTo__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04743638, ReadOnlyCollection_1_System_Exception__get_Item__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04747BD0, ReadOnlyCollection_1_System_Exception__GetEnumerator__MethodInfo)
}

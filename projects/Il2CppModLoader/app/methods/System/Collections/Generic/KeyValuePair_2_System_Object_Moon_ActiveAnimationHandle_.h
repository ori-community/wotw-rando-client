...
namespace app::methods::System::Collections::Generic::KeyValuePair_2_System_Object_Moon_ActiveAnimationHandle_ {
    IL2CPP_REGISTER_METHOD(0x00151540, void, ctor, (app::KeyValuePair_2_System_Object_Moon_ActiveAnimationHandle___Boxed * this_ptr, app::Object * key, app::ActiveAnimationHandle value))

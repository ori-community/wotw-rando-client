...
namespace app::methods::System::Collections::Generic::List_1_PostStateDefinition_PostState_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04793098, List_1_PostStateDefinition_PostState__get_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_PostStateDefinition_PostState_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04735AA0, List_1_PostStateDefinition_PostState__get_Count__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0472A5B8, List_1_PostStateDefinition_PostState__Add__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025F1690, void, RemoveAt, (app::List_1_PostStateDefinition_PostState_ * this_ptr, int32_t index))
    IL2CPP_REGISTER_METHODINFO(0x04773F48, List_1_PostStateDefinition_PostState__RemoveAt__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor, (app::List_1_PostStateDefinition_PostState_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04778428, List_1_PostStateDefinition_PostState___ctor__MethodInfo)
}

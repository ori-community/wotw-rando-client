...
namespace app::methods::System::Collections::Generic::Dictionary_2_System_Type_System_Action_2_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04730730, Dictionary_2_System_Type_System_Action_2__Add__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04770998, Dictionary_2_System_Type_System_Action_2__TryGetValue__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x0283AC20, void, ctor, (app::Dictionary_2_System_Type_System_Action_2_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047316E0, Dictionary_2_System_Type_System_Action_2___ctor__MethodInfo)
}

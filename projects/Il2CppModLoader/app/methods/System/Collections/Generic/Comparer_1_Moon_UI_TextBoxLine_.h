...
namespace app::methods::System::Collections::Generic::Comparer_1_Moon_UI_TextBoxLine_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04760820, Comparer_1_Moon_UI_TextBoxLine__Create__MethodInfo)

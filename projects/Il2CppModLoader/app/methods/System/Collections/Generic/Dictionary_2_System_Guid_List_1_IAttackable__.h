...
namespace app::classes::System::Collections::Generic::Dictionary_2_System_Guid_List_1_IAttackable__ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x047887E8, Dictionary_2_System_Guid_List_1_IAttackable__ContainsKey__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04712EB0, Dictionary_2_System_Guid_List_1_IAttackable__Add__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04748150, Dictionary_2_System_Guid_List_1_IAttackable__TryGetValue__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02EB1890, bool, Remove, (app::Dictionary_2_System_Guid_List_1_IAttackable_ * this_ptr, app::Guid key))
    IL2CPP_REGISTER_METHODINFO(0x04731388, Dictionary_2_System_Guid_List_1_IAttackable__Remove__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x0283B900, void, Clear, (app::Dictionary_2_System_Guid_List_1_IAttackable_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04767F70, Dictionary_2_System_Guid_List_1_IAttackable__Clear__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02259DF0, void, ctor, (app::Dictionary_2_System_Guid_List_1_IAttackable_ * this_ptr, int32_t capacity))
    IL2CPP_REGISTER_METHODINFO(0x04779E80, Dictionary_2_System_Guid_List_1_IAttackable___ctor__MethodInfo)
} // namespace app::classes::System::Collections::Generic::Dictionary_2_System_Guid_List_1_IAttackable__

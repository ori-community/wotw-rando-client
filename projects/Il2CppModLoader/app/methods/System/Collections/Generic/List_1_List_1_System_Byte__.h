...
namespace app::methods::System::Collections::Generic::List_1_List_1_System_Byte__ {
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_List_1_System_Byte_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04725820, List_1_List_1_System_Byte__get_Count__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x047762F0, List_1_List_1_System_Byte__GetEnumerator__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor, (app::List_1_List_1_System_Byte_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04704E90, List_1_List_1_System_Byte___ctor__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02F1E150, void, Add, (app::List_1_List_1_System_Byte_ * this_ptr, app::List_1_System_Byte_ * item))
    IL2CPP_REGISTER_METHODINFO(0x0477A060, List_1_List_1_System_Byte__Add__MethodInfo)
}

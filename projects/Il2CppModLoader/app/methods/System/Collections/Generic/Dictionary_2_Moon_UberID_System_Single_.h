...
namespace app::classes::System::Collections::Generic::Dictionary_2_Moon_UberID_System_Single_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04787180, Dictionary_2_Moon_UberID_System_Single___ctor__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04749C40, Dictionary_2_Moon_UberID_System_Single__TryGetValue__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0477DF08, Dictionary_2_Moon_UberID_System_Single__set_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x0283B2A0, int32_t, get_Count, (app::Dictionary_2_Moon_UberID_System_Single_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047214F0, Dictionary_2_Moon_UberID_System_Single__get_Count__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0478D690, Dictionary_2_Moon_UberID_System_Single__get_Keys__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0478BB68, Dictionary_2_Moon_UberID_System_Single__GetEnumerator__MethodInfo)
} // namespace app::classes::System::Collections::Generic::Dictionary_2_Moon_UberID_System_Single_

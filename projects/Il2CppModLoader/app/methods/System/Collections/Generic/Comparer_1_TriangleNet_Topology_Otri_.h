...
namespace app::methods::System::Collections::Generic::Comparer_1_TriangleNet_Topology_Otri_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0473B290, Comparer_1_TriangleNet_Topology_Otri__Create__MethodInfo)

...
namespace app::methods::System::Collections::Generic::Dictionary_2_System_String_UnityEngine_GUIStyle_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0473C410, Dictionary_2_System_String_UnityEngine_GUIStyle___ctor__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04791470, Dictionary_2_System_String_UnityEngine_GUIStyle__set_Item__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x047713A0, Dictionary_2_System_String_UnityEngine_GUIStyle__TryGetValue__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04702178, Dictionary_2_System_String_UnityEngine_GUIStyle__get_Values__MethodInfo)
}

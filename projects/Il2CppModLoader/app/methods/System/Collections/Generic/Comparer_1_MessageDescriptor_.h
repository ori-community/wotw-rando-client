...
namespace app::methods::System::Collections::Generic::Comparer_1_MessageDescriptor_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x047900C8, Comparer_1_MessageDescriptor__Create__MethodInfo)

...
namespace app::methods::System::Collections::Generic::ObjectEqualityComparer_1_System_Int32_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02435580, int32_t, IndexOf, (app::ObjectEqualityComparer_1_System_Int32_ * this_ptr, app::Int32__Array * array, int32_t value, int32_t start_index, int32_t count))
    IL2CPP_REGISTER_METHOD(0x02435660, int32_t, LastIndexOf, (app::ObjectEqualityComparer_1_System_Int32_ * this_ptr, app::Int32__Array * array, int32_t value, int32_t start_index, int32_t count))

...
namespace app::methods::System::Collections::Generic::Dictionary_2_Moon_ThrowAnimationType_SeinHold_ThrowAnimationSet_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02C35530, app::SeinHold_ThrowAnimationSet *, get_Item, (app::Dictionary_2_Moon_ThrowAnimationType_SeinHold_ThrowAnimationSet_ * this_ptr, app::ThrowAnimationType__Enum key))

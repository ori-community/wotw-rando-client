...
namespace app::methods::System::Collections::Generic::List_1_Moon_MoonAnimator_ActiveAnimation_ {
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_Moon_MoonAnimator_ActiveAnimation_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0473B9F8, List_1_Moon_MoonAnimator_ActiveAnimation__get_Count__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor, (app::List_1_Moon_MoonAnimator_ActiveAnimation_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047475D8, List_1_Moon_MoonAnimator_ActiveAnimation___ctor__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0475CA50, List_1_Moon_MoonAnimator_ActiveAnimation__get_Item__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04770D50, List_1_Moon_MoonAnimator_ActiveAnimation__Insert__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04768810, List_1_Moon_MoonAnimator_ActiveAnimation__Add__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x022A4010, void, Clear, (app::List_1_Moon_MoonAnimator_ActiveAnimation_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04799B68, List_1_Moon_MoonAnimator_ActiveAnimation__Clear__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025F1690, void, RemoveAt, (app::List_1_Moon_MoonAnimator_ActiveAnimation_ * this_ptr, int32_t index))
    IL2CPP_REGISTER_METHODINFO(0x0471C628, List_1_Moon_MoonAnimator_ActiveAnimation__RemoveAt__MethodInfo)
}

...
namespace app::methods::System::Collections::Generic::Dictionary_2_System_String_System_Type_ {
    IL2CPP_REGISTER_METHOD(0x0283AC20, void, ctor, (app::Dictionary_2_System_String_System_Type_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04797F60, Dictionary_2_System_String_System_Type___ctor__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02BA5090, bool, ContainsKey, (app::Dictionary_2_System_String_System_Type_ * this_ptr, app::String * key))
    IL2CPP_REGISTER_METHODINFO(0x04753488, Dictionary_2_System_String_System_Type__ContainsKey__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04780A50, Dictionary_2_System_String_System_Type__Add__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04766168, Dictionary_2_System_String_System_Type__get_Values__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04722F48, Dictionary_2_System_String_System_Type__TryGetValue__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x0283B900, void, Clear, (app::Dictionary_2_System_String_System_Type_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0473B300, Dictionary_2_System_String_System_Type__Clear__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x047922C0, Dictionary_2_System_String_System_Type__set_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02BD24D0, app::Type *, get_Item, (app::Dictionary_2_System_String_System_Type_ * this_ptr, app::String * key))
    IL2CPP_REGISTER_METHODINFO(0x0472F908, Dictionary_2_System_String_System_Type__get_Item__MethodInfo)
}

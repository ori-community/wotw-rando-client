...
namespace app::methods::System::Collections::Generic::ObjectEqualityComparer_1_Moon_Substr_ {
    ...
    IL2CPP_REGISTER_METHOD(0x01CD1130, int32_t, IndexOf, (app::ObjectEqualityComparer_1_Moon_Substr_ * this_ptr, app::Substr__Array * array, app::Substr value, int32_t start_index, int32_t count))
    IL2CPP_REGISTER_METHOD(0x01CD12A0, int32_t, LastIndexOf, (app::ObjectEqualityComparer_1_Moon_Substr_ * this_ptr, app::Substr__Array * array, app::Substr value, int32_t start_index, int32_t count))

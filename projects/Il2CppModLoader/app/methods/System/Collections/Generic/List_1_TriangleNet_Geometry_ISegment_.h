...
namespace app::methods::System::Collections::Generic::List_1_TriangleNet_Geometry_ISegment_ {
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor, (app::List_1_TriangleNet_Geometry_ISegment_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04756210, List_1_TriangleNet_Geometry_ISegment___ctor__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02F1E150, void, Add, (app::List_1_TriangleNet_Geometry_ISegment_ * this_ptr, app::ISegment * item))
    IL2CPP_REGISTER_METHODINFO(0x0470BB50, List_1_TriangleNet_Geometry_ISegment__Add__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0471C588, List_1_TriangleNet_Geometry_ISegment__AddRange__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_TriangleNet_Geometry_ISegment_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04768988, List_1_TriangleNet_Geometry_ISegment__get_Count__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04779CA0, List_1_TriangleNet_Geometry_ISegment__GetEnumerator__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025EFC50, app::ISegment *, get_Item, (app::List_1_TriangleNet_Geometry_ISegment_ * this_ptr, int32_t index))
    IL2CPP_REGISTER_METHODINFO(0x0471B378, List_1_TriangleNet_Geometry_ISegment__get_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E8790, void, set_Capacity, (app::List_1_TriangleNet_Geometry_ISegment_ * this_ptr, int32_t value))
    IL2CPP_REGISTER_METHODINFO(0x04700A58, List_1_TriangleNet_Geometry_ISegment__set_Capacity__MethodInfo)
}

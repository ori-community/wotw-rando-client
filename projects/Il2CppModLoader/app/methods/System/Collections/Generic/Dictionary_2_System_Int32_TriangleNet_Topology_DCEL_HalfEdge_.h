...
namespace app::methods::System::Collections::Generic::Dictionary_2_System_Int32_TriangleNet_Topology_DCEL_HalfEdge_ {
    IL2CPP_REGISTER_METHOD(0x0283AC20, void, ctor, (app::Dictionary_2_System_Int32_TriangleNet_Topology_DCEL_HalfEdge_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0476E4C0, Dictionary_2_System_Int32_TriangleNet_Topology_DCEL_HalfEdge___ctor__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0470B338, Dictionary_2_System_Int32_TriangleNet_Topology_DCEL_HalfEdge__Add__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04703438, Dictionary_2_System_Int32_TriangleNet_Topology_DCEL_HalfEdge__get_Values__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0477BE88, Dictionary_2_System_Int32_TriangleNet_Topology_DCEL_HalfEdge__get_Item__MethodInfo)
}

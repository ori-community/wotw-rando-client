...
namespace app::methods::System::Collections::Generic::Dictionary_2_Moon_Profile_Metric_System_Single___ {
    IL2CPP_REGISTER_METHOD(0x0283AC20, void, ctor, (app::Dictionary_2_Moon_Profile_Metric_System_Single__1 * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0478DEE8, Dictionary_2_Moon_Profile_Metric_System_Single__1__ctor__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04707A28, Dictionary_2_Moon_Profile_Metric_System_Single__1_Add__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04706B68, Dictionary_2_Moon_Profile_Metric_System_Single__1_set_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x0283B900, void, Clear, (app::Dictionary_2_Moon_Profile_Metric_System_Single__1 * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04787638, Dictionary_2_Moon_Profile_Metric_System_Single__1_Clear__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04769160, Dictionary_2_Moon_Profile_Metric_System_Single__1_GetEnumerator__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04796CB0, Dictionary_2_Moon_Profile_Metric_System_Single__1_get_Item__MethodInfo)
}

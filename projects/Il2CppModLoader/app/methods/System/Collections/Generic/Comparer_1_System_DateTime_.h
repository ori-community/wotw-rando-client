...
namespace app::methods::System::Collections::Generic::Comparer_1_System_DateTime_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0473DFB8, Comparer_1_System_DateTime__Create__MethodInfo)

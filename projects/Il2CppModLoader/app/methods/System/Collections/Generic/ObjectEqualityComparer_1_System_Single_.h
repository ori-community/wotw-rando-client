...
namespace app::methods::System::Collections::Generic::ObjectEqualityComparer_1_System_Single_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02436550, int32_t, IndexOf, (app::ObjectEqualityComparer_1_System_Single_ * this_ptr, app::Single__Array * array, float value, int32_t start_index, int32_t count))
    IL2CPP_REGISTER_METHOD(0x02436650, int32_t, LastIndexOf, (app::ObjectEqualityComparer_1_System_Single_ * this_ptr, app::Single__Array * array, float value, int32_t start_index, int32_t count))

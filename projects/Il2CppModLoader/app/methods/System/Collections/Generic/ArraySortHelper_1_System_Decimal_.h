...
namespace app::methods::System::Collections::Generic::ArraySortHelper_1_System_Decimal_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02FFDA80, int32_t, BinarySearch, (app::Decimal__Array * array, int32_t index, int32_t length, app::Decimal value, app::IComparer_1_System_Decimal_ * comparer))
    ...
    IL2CPP_REGISTER_METHOD(0x02C898B0, int32_t, InternalBinarySearch, (app::Decimal__Array * array, int32_t index, int32_t length, app::Decimal value, app::IComparer_1_System_Decimal_ * comparer))
    ...
    IL2CPP_REGISTER_METHOD(0x02C86FB0, void, IntroSort, (app::Decimal__Array * keys, int32_t lo, int32_t hi, int32_t depth_limit, app::Comparison_1_Decimal_ * comparer))

...
namespace app::methods::System::Collections::Generic::ObjectEqualityComparer_1_TriangleNet_Topology_Otri_ {
    ...
    IL2CPP_REGISTER_METHOD(0x01CD0960, int32_t, IndexOf, (app::ObjectEqualityComparer_1_TriangleNet_Topology_Otri_ * this_ptr, app::Otri__Array * array, app::Otri value, int32_t start_index, int32_t count))
    IL2CPP_REGISTER_METHOD(0x01CD0AD0, int32_t, LastIndexOf, (app::ObjectEqualityComparer_1_TriangleNet_Topology_Otri_ * this_ptr, app::Otri__Array * array, app::Otri value, int32_t start_index, int32_t count))

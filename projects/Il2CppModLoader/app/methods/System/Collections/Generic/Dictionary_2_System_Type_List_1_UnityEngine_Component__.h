...
namespace app::methods::System::Collections::Generic::Dictionary_2_System_Type_List_1_UnityEngine_Component__ {
    IL2CPP_REGISTER_METHOD(0x0283AC20, void, ctor, (app::Dictionary_2_System_Type_List_1_UnityEngine_Component_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04745C40, Dictionary_2_System_Type_List_1_UnityEngine_Component___ctor__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0477A228, Dictionary_2_System_Type_List_1_UnityEngine_Component__Add__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0477C450, Dictionary_2_System_Type_List_1_UnityEngine_Component__ContainsKey__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0478E828, Dictionary_2_System_Type_List_1_UnityEngine_Component__get_Item__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0477B4A0, Dictionary_2_System_Type_List_1_UnityEngine_Component__TryGetValue__MethodInfo)
}

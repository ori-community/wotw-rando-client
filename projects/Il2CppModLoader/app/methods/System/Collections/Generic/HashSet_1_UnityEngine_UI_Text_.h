...
namespace app::methods::System::Collections::Generic::HashSet_1_UnityEngine_UI_Text_ {
    IL2CPP_REGISTER_METHOD(0x02AB4370, void, ctor, (app::HashSet_1_UnityEngine_UI_Text_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04714A80, HashSet_1_UnityEngine_UI_Text___ctor__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02ABEAC0, bool, Contains, (app::HashSet_1_UnityEngine_UI_Text_ * this_ptr, app::Text * item))
    IL2CPP_REGISTER_METHODINFO(0x0476D628, HashSet_1_UnityEngine_UI_Text__Contains__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02AB4A60, bool, Add, (app::HashSet_1_UnityEngine_UI_Text_ * this_ptr, app::Text * item))
    IL2CPP_REGISTER_METHODINFO(0x047526F8, HashSet_1_UnityEngine_UI_Text__Add__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04757A68, HashSet_1_UnityEngine_UI_Text__GetEnumerator__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02ABEC50, bool, Remove, (app::HashSet_1_UnityEngine_UI_Text_ * this_ptr, app::Text * item))
    IL2CPP_REGISTER_METHODINFO(0x04757B88, HashSet_1_UnityEngine_UI_Text__Remove__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x002FD1D0, int32_t, get_Count, (app::HashSet_1_UnityEngine_UI_Text_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04747DF8, HashSet_1_UnityEngine_UI_Text__get_Count__MethodInfo)
}

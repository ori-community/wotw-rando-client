...
namespace app::methods::System::Collections::Generic::ObjectComparer_1_CatlikeCoding_TextBox_LineDescent_ {
    IL2CPP_REGISTER_METHOD(0x02C298F0, int32_t, Compare, (app::ObjectComparer_1_CatlikeCoding_TextBox_LineDescent_ * this_ptr, app::LineDescent x, app::LineDescent y))

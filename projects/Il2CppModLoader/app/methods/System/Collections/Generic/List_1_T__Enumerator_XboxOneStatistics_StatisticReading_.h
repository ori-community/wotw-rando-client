...
namespace app::methods::System::Collections::Generic::List_1_T__Enumerator_XboxOneStatistics_StatisticReading_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x047487C8, List_1_T_Enumerator_XboxOneStatistics_StatisticReading__get_Current__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x047483C8, List_1_T_Enumerator_XboxOneStatistics_StatisticReading__MoveNext__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04759BD0, List_1_T_Enumerator_XboxOneStatistics_StatisticReading__Dispose__MethodInfo)

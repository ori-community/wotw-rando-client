...
namespace app::methods::System::Collections::Generic::Dictionary_2_System_String_System_Reflection_FieldInfo_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0476BA98, Dictionary_2_System_String_System_Reflection_FieldInfo__TryGetValue__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x0283AC20, void, ctor, (app::Dictionary_2_System_String_System_Reflection_FieldInfo_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0472FD18, Dictionary_2_System_String_System_Reflection_FieldInfo___ctor__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0476B5E0, Dictionary_2_System_String_System_Reflection_FieldInfo__Add__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0475E570, Dictionary_2_System_String_System_Reflection_FieldInfo__ContainsKey__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04780060, Dictionary_2_System_String_System_Reflection_FieldInfo__get_Item__MethodInfo)
}

...
namespace app::methods::System::Collections::Generic::List_1_KeyValuePair_2_Moon_UberID_System_Object__ {
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor, (app::List_1_KeyValuePair_2_Moon_UberID_System_Object_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04724590, List_1_KeyValuePair_2_Moon_UberID_System_Object___ctor__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04721308, List_1_KeyValuePair_2_Moon_UberID_System_Object__Add__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04796D48, List_1_KeyValuePair_2_Moon_UberID_System_Object__Sort__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0470BD40, List_1_KeyValuePair_2_Moon_UberID_System_Object__GetEnumerator__MethodInfo)
}

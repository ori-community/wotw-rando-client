...
namespace app::methods::System::Collections::Generic::List_1_T__Enumerator_UnityEngine_AnimatorClipInfo_ {
    IL2CPP_REGISTER_METHOD(0x0014CC40, void, ctor, (app::List_1_T_Enumerator_UnityEngine_AnimatorClipInfo___Boxed * this_ptr, app::List_1_UnityEngine_AnimatorClipInfo_ * list))

...
namespace app::methods::System::Collections::Generic::ObjectEqualityComparer_1_UnityEngine_UI_ColorBlock_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02439860, int32_t, IndexOf, (app::ObjectEqualityComparer_1_UnityEngine_UI_ColorBlock_ * this_ptr, app::ColorBlock__Array * array, app::ColorBlock value, int32_t start_index, int32_t count))
    IL2CPP_REGISTER_METHOD(0x02439990, int32_t, LastIndexOf, (app::ObjectEqualityComparer_1_UnityEngine_UI_ColorBlock_ * this_ptr, app::ColorBlock__Array * array, app::ColorBlock value, int32_t start_index, int32_t count))

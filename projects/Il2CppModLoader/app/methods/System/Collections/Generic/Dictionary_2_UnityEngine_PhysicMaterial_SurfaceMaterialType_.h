...
namespace app::methods::System::Collections::Generic::Dictionary_2_UnityEngine_PhysicMaterial_SurfaceMaterialType_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0470EF88, Dictionary_2_UnityEngine_PhysicMaterial_SurfaceMaterialType__Add__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04730D68, Dictionary_2_UnityEngine_PhysicMaterial_SurfaceMaterialType__TryGetValue__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x0283AC20, void, ctor, (app::Dictionary_2_UnityEngine_PhysicMaterial_SurfaceMaterialType_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0474F3B8, Dictionary_2_UnityEngine_PhysicMaterial_SurfaceMaterialType___ctor__MethodInfo)
}

...
namespace app::methods::System::Collections::Generic::Dictionary_2_MoonGuid_TextureAnimation_AnimationTextureInfo_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0476ECC0, Dictionary_2_MoonGuid_TextureAnimation_AnimationTextureInfo__TryGetValue__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0475F5E0, Dictionary_2_MoonGuid_TextureAnimation_AnimationTextureInfo__Add__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x0283AC20, void, ctor, (app::Dictionary_2_MoonGuid_TextureAnimation_AnimationTextureInfo_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0478BE40, Dictionary_2_MoonGuid_TextureAnimation_AnimationTextureInfo___ctor__MethodInfo)
}

...
namespace app::methods::System::Collections::Generic::List_1_ZenFulcrum_EmbeddedBrowser_VRBrowserPanel_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04761040, List_1_ZenFulcrum_EmbeddedBrowser_VRBrowserPanel__FindIndex__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x047723F0, List_1_ZenFulcrum_EmbeddedBrowser_VRBrowserPanel__Insert__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_ZenFulcrum_EmbeddedBrowser_VRBrowserPanel_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04779B20, List_1_ZenFulcrum_EmbeddedBrowser_VRBrowserPanel__get_Count__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0475A400, List_1_ZenFulcrum_EmbeddedBrowser_VRBrowserPanel__get_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor, (app::List_1_ZenFulcrum_EmbeddedBrowser_VRBrowserPanel_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0478AF80, List_1_ZenFulcrum_EmbeddedBrowser_VRBrowserPanel___ctor__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x047062A8, List_1_ZenFulcrum_EmbeddedBrowser_VRBrowserPanel__Remove__MethodInfo)
}

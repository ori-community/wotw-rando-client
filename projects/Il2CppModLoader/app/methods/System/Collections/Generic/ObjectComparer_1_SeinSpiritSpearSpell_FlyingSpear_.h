...
namespace app::methods::System::Collections::Generic::ObjectComparer_1_SeinSpiritSpearSpell_FlyingSpear_ {
    IL2CPP_REGISTER_METHOD(0x01CC8C50, int32_t, Compare, (app::ObjectComparer_1_SeinSpiritSpearSpell_FlyingSpear_ * this_ptr, app::SeinSpiritSpearSpell_FlyingSpear x, app::SeinSpiritSpearSpell_FlyingSpear y))

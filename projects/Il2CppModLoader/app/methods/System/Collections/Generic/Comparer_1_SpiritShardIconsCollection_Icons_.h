...
namespace app::methods::System::Collections::Generic::Comparer_1_SpiritShardIconsCollection_Icons_ {
    IL2CPP_REGISTER_METHOD(0x02807CD0, app::Comparer_1_SpiritShardIconsCollection_Icons_ *, get_Default, ())
    IL2CPP_REGISTER_METHOD(0x02828B80, app::Comparer_1_SpiritShardIconsCollection_Icons_ *, Create, (app::Comparison_1_SpiritShardIconsCollection_Icons_ * comparison))
    IL2CPP_REGISTER_METHODINFO(0x04772B68, Comparer_1_SpiritShardIconsCollection_Icons__Create__MethodInfo)

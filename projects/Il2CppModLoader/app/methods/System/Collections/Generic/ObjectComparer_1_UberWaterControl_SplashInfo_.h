...
namespace app::methods::System::Collections::Generic::ObjectComparer_1_UberWaterControl_SplashInfo_ {
    IL2CPP_REGISTER_METHOD(0x01CCDDA0, int32_t, Compare, (app::ObjectComparer_1_UberWaterControl_SplashInfo_ * this_ptr, app::UberWaterControl_SplashInfo x, app::UberWaterControl_SplashInfo y))

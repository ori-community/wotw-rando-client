...
namespace app::methods::System::Collections::Generic::List_1_T__Enumerator_InstantiateUtility_InstantiationInfo_ {
    IL2CPP_REGISTER_METHOD(0x0014D4F0, void, ctor, (app::List_1_T_Enumerator_InstantiateUtility_InstantiationInfo___Boxed * this_ptr, app::List_1_InstantiateUtility_InstantiationInfo_ * list))
    ...
    IL2CPP_REGISTER_METHOD(0x00133F90, app::InstantiateUtility_InstantiationInfo, get_Current, (app::List_1_T_Enumerator_InstantiateUtility_InstantiationInfo___Boxed * this_ptr))

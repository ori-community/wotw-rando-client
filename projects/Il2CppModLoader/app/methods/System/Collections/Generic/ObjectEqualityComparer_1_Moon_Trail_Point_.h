...
namespace app::methods::System::Collections::Generic::ObjectEqualityComparer_1_Moon_Trail_Point_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02659880, int32_t, IndexOf, (app::ObjectEqualityComparer_1_Moon_Trail_Point_ * this_ptr, app::Trail_Point__Array * array, app::Trail_Point value, int32_t start_index, int32_t count))
    IL2CPP_REGISTER_METHOD(0x02659A40, int32_t, LastIndexOf, (app::ObjectEqualityComparer_1_Moon_Trail_Point_ * this_ptr, app::Trail_Point__Array * array, app::Trail_Point value, int32_t start_index, int32_t count))

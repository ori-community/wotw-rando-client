...
namespace app::methods::System::Collections::Generic::List_1_T__Enumerator_Moon_DesiredStateTransitionInfo_ {
    IL2CPP_REGISTER_METHOD(0x00152840, void, ctor, (app::List_1_T_Enumerator_Moon_DesiredStateTransitionInfo___Boxed * this_ptr, app::List_1_Moon_DesiredStateTransitionInfo_ * list))

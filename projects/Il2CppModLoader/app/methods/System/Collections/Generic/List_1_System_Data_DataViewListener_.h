...
namespace app::methods::System::Collections::Generic::List_1_System_Data_DataViewListener_ {
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor, (app::List_1_System_Data_DataViewListener_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0472F758, List_1_System_Data_DataViewListener___ctor__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0477F968, List_1_System_Data_DataViewListener__Remove__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_System_Data_DataViewListener_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04703D78, List_1_System_Data_DataViewListener__get_Count__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0474D7F0, List_1_System_Data_DataViewListener__get_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025F1690, void, RemoveAt, (app::List_1_System_Data_DataViewListener_ * this_ptr, int32_t index))
    IL2CPP_REGISTER_METHODINFO(0x047246D0, List_1_System_Data_DataViewListener__RemoveAt__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02F1E150, void, Add, (app::List_1_System_Data_DataViewListener_ * this_ptr, app::DataViewListener * item))
    IL2CPP_REGISTER_METHODINFO(0x04764D70, List_1_System_Data_DataViewListener__Add__MethodInfo)
}

...
namespace app::methods::System::Collections::Generic::List_1_Moon_Timeline_TimelineEntityRecord_ {
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_Moon_Timeline_TimelineEntityRecord_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0473A358, List_1_Moon_Timeline_TimelineEntityRecord__get_Count__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x022A4010, void, Clear, (app::List_1_Moon_Timeline_TimelineEntityRecord_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0474ECA8, List_1_Moon_Timeline_TimelineEntityRecord__Clear__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04757458, List_1_Moon_Timeline_TimelineEntityRecord__Add__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0474B7C8, List_1_Moon_Timeline_TimelineEntityRecord__GetEnumerator__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x047493F0, List_1_Moon_Timeline_TimelineEntityRecord__get_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor, (app::List_1_Moon_Timeline_TimelineEntityRecord_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04775C10, List_1_Moon_Timeline_TimelineEntityRecord___ctor__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0475F3F8, List_1_Moon_Timeline_TimelineEntityRecord__Remove__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025F1690, void, RemoveAt, (app::List_1_Moon_Timeline_TimelineEntityRecord_ * this_ptr, int32_t index))
    IL2CPP_REGISTER_METHODINFO(0x0472F128, List_1_Moon_Timeline_TimelineEntityRecord__RemoveAt__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04755A00, List_1_Moon_Timeline_TimelineEntityRecord__AddRange__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x047646B0, List_1_Moon_Timeline_TimelineEntityRecord__RemoveAll__MethodInfo)
}

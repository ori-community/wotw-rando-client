...
namespace app::methods::System::Collections::Generic::List_1_Moon_UberStateVisualization_ListViewItem_ {
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor, (app::List_1_Moon_UberStateVisualization_ListViewItem_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0476ECA8, List_1_Moon_UberStateVisualization_ListViewItem___ctor__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_Moon_UberStateVisualization_ListViewItem_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04775660, List_1_Moon_UberStateVisualization_ListViewItem__get_Count__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04706AE0, List_1_Moon_UberStateVisualization_ListViewItem__get_Item__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0470A138, List_1_Moon_UberStateVisualization_ListViewItem__GetEnumerator__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0470DEA8, List_1_Moon_UberStateVisualization_ListViewItem__IndexOf__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0474B008, List_1_Moon_UberStateVisualization_ListViewItem__Add__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04796020, List_1_Moon_UberStateVisualization_ListViewItem__Contains__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0478CAD8, List_1_Moon_UberStateVisualization_ListViewItem__Remove__MethodInfo)
}

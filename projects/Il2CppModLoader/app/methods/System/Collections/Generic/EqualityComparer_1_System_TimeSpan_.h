...
namespace app::methods::System::Collections::Generic::EqualityComparer_1_System_TimeSpan_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02B48030, int32_t, IndexOf, (app::EqualityComparer_1_System_TimeSpan_ * this_ptr, app::TimeSpan__Array * array, app::TimeSpan value, int32_t start_index, int32_t count))
    IL2CPP_REGISTER_METHOD(0x02B480E0, int32_t, LastIndexOf, (app::EqualityComparer_1_System_TimeSpan_ * this_ptr, app::TimeSpan__Array * array, app::TimeSpan value, int32_t start_index, int32_t count))

...
namespace app::methods::System::Collections::Generic::List_1_Moon_Timeline_IEventDescriptor_ {
    IL2CPP_REGISTER_METHOD(0x02F1E150, void, Add, (app::List_1_Moon_Timeline_IEventDescriptor_ * this_ptr, app::IEventDescriptor * item))
    IL2CPP_REGISTER_METHODINFO(0x04760F30, List_1_Moon_Timeline_IEventDescriptor__Add__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x022A4010, void, Clear, (app::List_1_Moon_Timeline_IEventDescriptor_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0475FB30, List_1_Moon_Timeline_IEventDescriptor__Clear__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_Moon_Timeline_IEventDescriptor_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0477CEB8, List_1_Moon_Timeline_IEventDescriptor__get_Count__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x047119A0, List_1_Moon_Timeline_IEventDescriptor__get_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor, (app::List_1_Moon_Timeline_IEventDescriptor_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0478F008, List_1_Moon_Timeline_IEventDescriptor___ctor__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0477BBD8, List_1_Moon_Timeline_IEventDescriptor__GetEnumerator__MethodInfo)
}

...
namespace app::methods::System::Collections::Generic::List_1_T__Enumerator_GeneralDebugMenuPage_SceneInfo_ {
    IL2CPP_REGISTER_METHOD(0x0014CA00, void, ctor, (app::List_1_T_Enumerator_GeneralDebugMenuPage_SceneInfo___Boxed * this_ptr, app::List_1_GeneralDebugMenuPage_SceneInfo_ * list))
    ...
    IL2CPP_REGISTER_METHOD(0x00136440, app::GeneralDebugMenuPage_SceneInfo, get_Current, (app::List_1_T_Enumerator_GeneralDebugMenuPage_SceneInfo___Boxed * this_ptr))

...
namespace app::methods::System::Collections::Generic::ObjectComparer_1_Trail_TrailPosition_ {
    IL2CPP_REGISTER_METHOD(0x01CCCFA0, int32_t, Compare, (app::ObjectComparer_1_Trail_TrailPosition_ * this_ptr, app::Trail_TrailPosition x, app::Trail_TrailPosition y))

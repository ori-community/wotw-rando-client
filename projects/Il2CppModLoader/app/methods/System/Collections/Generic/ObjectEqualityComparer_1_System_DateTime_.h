...
namespace app::methods::System::Collections::Generic::ObjectEqualityComparer_1_System_DateTime_ {
    ...
    IL2CPP_REGISTER_METHOD(0x0265B1A0, int32_t, IndexOf, (app::ObjectEqualityComparer_1_System_DateTime_ * this_ptr, app::DateTime__Array * array, app::DateTime value, int32_t start_index, int32_t count))
    IL2CPP_REGISTER_METHOD(0x0265B280, int32_t, LastIndexOf, (app::ObjectEqualityComparer_1_System_DateTime_ * this_ptr, app::DateTime__Array * array, app::DateTime value, int32_t start_index, int32_t count))

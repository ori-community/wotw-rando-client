...
namespace app::methods::System::Collections::Generic::List_1_UnityEngine_UI_Dropdown_OptionData_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0473CED0, List_1_UnityEngine_UI_Dropdown_OptionData__Add__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_UnityEngine_UI_Dropdown_OptionData_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04734E08, List_1_UnityEngine_UI_Dropdown_OptionData__get_Count__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04704C10, List_1_UnityEngine_UI_Dropdown_OptionData__get_Item__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04781710, List_1_UnityEngine_UI_Dropdown_OptionData__AddRange__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x022A4010, void, Clear, (app::List_1_UnityEngine_UI_Dropdown_OptionData_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047862F8, List_1_UnityEngine_UI_Dropdown_OptionData__Clear__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor, (app::List_1_UnityEngine_UI_Dropdown_OptionData_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04730B20, List_1_UnityEngine_UI_Dropdown_OptionData___ctor__MethodInfo)
}

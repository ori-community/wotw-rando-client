...
namespace app::classes::System::Collections::Generic::List_1_SandWormEntity_SandWormBodyWave_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04703E30, List_1_SandWormEntity_SandWormBodyWave__Add__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04778CC0, List_1_SandWormEntity_SandWormBodyWave__Remove__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_SandWormEntity_SandWormBodyWave_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0477BF18, List_1_SandWormEntity_SandWormBodyWave__get_Count__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04771470, List_1_SandWormEntity_SandWormBodyWave__get_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E81E0, void, ctor, (app::List_1_SandWormEntity_SandWormBodyWave_ * this_ptr, int32_t capacity))
    IL2CPP_REGISTER_METHODINFO(0x04708B40, List_1_SandWormEntity_SandWormBodyWave___ctor__MethodInfo)
} // namespace app::classes::System::Collections::Generic::List_1_SandWormEntity_SandWormBodyWave_

...
namespace app::methods::System::Collections::Generic::List_1_Moon_INonSerializedUberState_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x047729B0, List_1_Moon_INonSerializedUberState__Contains__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0476BB98, List_1_Moon_INonSerializedUberState__Add__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0477BD38, List_1_Moon_INonSerializedUberState__AsReadOnly__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04785B60, List_1_Moon_INonSerializedUberState__get_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_Moon_INonSerializedUberState_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0477F590, List_1_Moon_INonSerializedUberState__get_Count__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor, (app::List_1_Moon_INonSerializedUberState_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0475ACB8, List_1_Moon_INonSerializedUberState___ctor__MethodInfo)
}

...
namespace app::methods::System::Collections::Generic::Comparer_1_System_UInt32_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x047036E8, Comparer_1_System_UInt32__Create__MethodInfo)

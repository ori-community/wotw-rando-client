...
namespace app::methods::System::Collections::Generic::ObjectComparer_1_GeneralDebugMenuPage_SceneInfo_ {
    IL2CPP_REGISTER_METHOD(0x02C2AFB0, int32_t, Compare, (app::ObjectComparer_1_GeneralDebugMenuPage_SceneInfo_ * this_ptr, app::GeneralDebugMenuPage_SceneInfo x, app::GeneralDebugMenuPage_SceneInfo y))

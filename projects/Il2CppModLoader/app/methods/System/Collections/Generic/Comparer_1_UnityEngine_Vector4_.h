...
namespace app::methods::System::Collections::Generic::Comparer_1_UnityEngine_Vector4_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04736488, Comparer_1_UnityEngine_Vector4__Create__MethodInfo)

...
namespace app::methods::System::Collections::Generic::Dictionary_2_LeaderboardB_LeaderboardData_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0473B740, Dictionary_2_LeaderboardB_LeaderboardData__ContainsKey__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04704D80, Dictionary_2_LeaderboardB_LeaderboardData__get_Item__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0472FFC0, Dictionary_2_LeaderboardB_LeaderboardData__set_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x0283AC20, void, ctor, (app::Dictionary_2_LeaderboardB_LeaderboardData_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04781B68, Dictionary_2_LeaderboardB_LeaderboardData___ctor__MethodInfo)
}

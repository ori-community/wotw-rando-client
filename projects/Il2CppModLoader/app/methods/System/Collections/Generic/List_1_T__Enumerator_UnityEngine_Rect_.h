...
namespace app::methods::System::Collections::Generic::List_1_T__Enumerator_UnityEngine_Rect_ {
    IL2CPP_REGISTER_METHOD(0x00136440, app::Rect, get_Current, (app::List_1_T_Enumerator_UnityEngine_Rect___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04722D40, List_1_T_Enumerator_UnityEngine_Rect__get_Current__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x0014CA30, bool, MoveNext, (app::List_1_T_Enumerator_UnityEngine_Rect___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04759978, List_1_T_Enumerator_UnityEngine_Rect__MoveNext__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00002890, void, Dispose, (app::List_1_T_Enumerator_UnityEngine_Rect___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04722650, List_1_T_Enumerator_UnityEngine_Rect__Dispose__MethodInfo)

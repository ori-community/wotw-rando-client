...
namespace app::methods::System::Collections::Generic::List_1_List_1_IDebugMenuItem__ {
    IL2CPP_REGISTER_METHOD(0x02F1E150, void, Add, (app::List_1_List_1_IDebugMenuItem_ * this_ptr, app::List_1_IDebugMenuItem_ * item))
    IL2CPP_REGISTER_METHODINFO(0x0473B708, List_1_List_1_IDebugMenuItem__Add__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04753000, List_1_List_1_IDebugMenuItem__get_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x022A4010, void, Clear, (app::List_1_List_1_IDebugMenuItem_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047571F0, List_1_List_1_IDebugMenuItem__Clear__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_List_1_IDebugMenuItem_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04795690, List_1_List_1_IDebugMenuItem__get_Count__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E81E0, void, ctor, (app::List_1_List_1_IDebugMenuItem_ * this_ptr, int32_t capacity))
    IL2CPP_REGISTER_METHODINFO(0x04760A68, List_1_List_1_IDebugMenuItem___ctor__MethodInfo)
}

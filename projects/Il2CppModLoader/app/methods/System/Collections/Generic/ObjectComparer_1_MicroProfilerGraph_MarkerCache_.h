...
namespace app::methods::System::Collections::Generic::ObjectComparer_1_MicroProfilerGraph_MarkerCache_ {
    IL2CPP_REGISTER_METHOD(0x01CC4650, int32_t, Compare, (app::ObjectComparer_1_MicroProfilerGraph_MarkerCache_ * this_ptr, app::MicroProfilerGraph_MarkerCache x, app::MicroProfilerGraph_MarkerCache y))

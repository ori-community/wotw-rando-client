...
namespace app::methods::System::Collections::Generic::List_1_OverridableTextureProperty_ {
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor_1, (app::List_1_OverridableTextureProperty_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047721F0, List_1_OverridableTextureProperty___ctor__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x047853A8, List_1_OverridableTextureProperty___ctor_1__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0477F440, List_1_OverridableTextureProperty__RemoveAll__MethodInfo)
}

...
namespace app::methods::System::Collections::Generic::List_1_Core_Ambience_Layer_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04713C30, List_1_Core_Ambience_Layer__Sort__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor, (app::List_1_Core_Ambience_Layer_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04784508, List_1_Core_Ambience_Layer___ctor__MethodInfo)
}

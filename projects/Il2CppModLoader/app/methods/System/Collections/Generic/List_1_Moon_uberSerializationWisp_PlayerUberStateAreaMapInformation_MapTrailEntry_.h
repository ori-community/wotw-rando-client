...
namespace app::methods::System::Collections::Generic::List_1_Moon_uberSerializationWisp_PlayerUberStateAreaMapInformation_MapTrailEntry_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x047952A8, List_1_Moon_uberSerializationWisp_PlayerUberStateAreaMapInformation_MapTrailEntry__get_Count__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0470CF70, List_1_Moon_uberSerializationWisp_PlayerUberStateAreaMapInformation_MapTrailEntry__get_Item__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04740C90, List_1_Moon_uberSerializationWisp_PlayerUberStateAreaMapInformation_MapTrailEntry__Clear__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0475B1A8, List_1_Moon_uberSerializationWisp_PlayerUberStateAreaMapInformation_MapTrailEntry___ctor__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0476C580, List_1_Moon_uberSerializationWisp_PlayerUberStateAreaMapInformation_MapTrailEntry__RemoveAt__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0471A860, List_1_Moon_uberSerializationWisp_PlayerUberStateAreaMapInformation_MapTrailEntry__Add__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0478E9E8, List_1_Moon_uberSerializationWisp_PlayerUberStateAreaMapInformation_MapTrailEntry__RemoveRange__MethodInfo)
}

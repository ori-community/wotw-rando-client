...
namespace app::methods::System::Collections::Generic::EqualityComparer_1_Moon_Trail_Point_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02D3A690, int32_t, IndexOf, (app::EqualityComparer_1_Moon_Trail_Point_ * this_ptr, app::Trail_Point__Array * array, app::Trail_Point value, int32_t start_index, int32_t count))
    IL2CPP_REGISTER_METHOD(0x02D3A7D0, int32_t, LastIndexOf, (app::EqualityComparer_1_Moon_Trail_Point_ * this_ptr, app::Trail_Point__Array * array, app::Trail_Point value, int32_t start_index, int32_t count))

...
namespace app::methods::System::Collections::Generic::ObjectEqualityComparer_1_UnityEngine_Resolution_ {
    ...
    IL2CPP_REGISTER_METHOD(0x01CD3230, int32_t, IndexOf, (app::ObjectEqualityComparer_1_UnityEngine_Resolution_ * this_ptr, app::Resolution__Array * array, app::Resolution value, int32_t start_index, int32_t count))
    IL2CPP_REGISTER_METHOD(0x01CD33B0, int32_t, LastIndexOf, (app::ObjectEqualityComparer_1_UnityEngine_Resolution_ * this_ptr, app::Resolution__Array * array, app::Resolution value, int32_t start_index, int32_t count))

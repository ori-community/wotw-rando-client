...
namespace app::classes::System::Collections::Generic::List_1_FrameProfiler_MetricInfo_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0477A5C0, List_1_FrameProfiler_MetricInfo__IndexOf__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor, (app::List_1_FrameProfiler_MetricInfo_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04752E40, List_1_FrameProfiler_MetricInfo___ctor__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04796768, List_1_FrameProfiler_MetricInfo__Add__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_FrameProfiler_MetricInfo_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04720DC8, List_1_FrameProfiler_MetricInfo__get_Count__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0474F540, List_1_FrameProfiler_MetricInfo__get_Item__MethodInfo)
} // namespace app::classes::System::Collections::Generic::List_1_FrameProfiler_MetricInfo_

...
namespace app::methods::System::Collections::Generic::List_1_UnityEngine_UI_Toggle_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0474A658, List_1_UnityEngine_UI_Toggle__Find__MethodInfo)
}

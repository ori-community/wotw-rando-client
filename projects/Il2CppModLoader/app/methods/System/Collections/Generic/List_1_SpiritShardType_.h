...
namespace app::classes::System::Collections::Generic::List_1_SpiritShardType_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04797E50, List_1_SpiritShardType__get_Count__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04738010, List_1_SpiritShardType__GetEnumerator__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor_1, (app::List_1_SpiritShardType_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04743100, List_1_SpiritShardType___ctor__MethodInfo)

...
namespace app::methods::System::Collections::Generic::Comparer_1_UnityEngine_RaycastHit_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04790088, Comparer_1_UnityEngine_RaycastHit__Create__MethodInfo)

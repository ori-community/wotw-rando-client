...
namespace app::methods::System::Collections::Generic::List_1_HierarchyDebugMenu_GameObjectItem_ {
    IL2CPP_REGISTER_METHOD(0x022A4010, void, Clear, (app::List_1_HierarchyDebugMenu_GameObjectItem_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04777618, List_1_HierarchyDebugMenu_GameObjectItem__Clear__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0476F2E0, List_1_HierarchyDebugMenu_GameObjectItem__get_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_HierarchyDebugMenu_GameObjectItem_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04782BD0, List_1_HierarchyDebugMenu_GameObjectItem__get_Count__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04718BC8, List_1_HierarchyDebugMenu_GameObjectItem__GetEnumerator__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04785B20, List_1_HierarchyDebugMenu_GameObjectItem__Add__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor, (app::List_1_HierarchyDebugMenu_GameObjectItem_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04773990, List_1_HierarchyDebugMenu_GameObjectItem___ctor__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0476CFF0, List_1_HierarchyDebugMenu_GameObjectItem__Remove__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04720558, List_1_HierarchyDebugMenu_GameObjectItem__Sort__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04782E00, List_1_HierarchyDebugMenu_GameObjectItem__Insert__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025F1690, void, RemoveAt, (app::List_1_HierarchyDebugMenu_GameObjectItem_ * this_ptr, int32_t index))
    IL2CPP_REGISTER_METHODINFO(0x0476F3C0, List_1_HierarchyDebugMenu_GameObjectItem__RemoveAt__MethodInfo)
}

...
namespace app::methods::System::Collections::Generic::Dictionary_2_Moon_IUpdateHandlerBase_Moon_Driver_UpdateManager_Entry_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04730008, Dictionary_2_Moon_IUpdateHandlerBase_Moon_Driver_UpdateManager_Entry___ctor__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0470C1A0, Dictionary_2_Moon_IUpdateHandlerBase_Moon_Driver_UpdateManager_Entry__Add__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04772A28, Dictionary_2_Moon_IUpdateHandlerBase_Moon_Driver_UpdateManager_Entry__TryGetValue__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0474E898, Dictionary_2_Moon_IUpdateHandlerBase_Moon_Driver_UpdateManager_Entry__Remove__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x047306E0, Dictionary_2_Moon_IUpdateHandlerBase_Moon_Driver_UpdateManager_Entry__get_Count__MethodInfo)
}

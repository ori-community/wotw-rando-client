...
namespace app::methods::System::Collections::Generic::KeyValuePair_2_System_Int32_System_Boolean_ {
    IL2CPP_REGISTER_METHOD(0x0010E170, int32_t, get_Key, (app::KeyValuePair_2_System_Int32_System_Boolean___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04744E28, KeyValuePair_2_System_Int32_System_Boolean__get_Key__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x0011DC50, bool, get_Value, (app::KeyValuePair_2_System_Int32_System_Boolean___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047264A8, KeyValuePair_2_System_Int32_System_Boolean__get_Value__MethodInfo)

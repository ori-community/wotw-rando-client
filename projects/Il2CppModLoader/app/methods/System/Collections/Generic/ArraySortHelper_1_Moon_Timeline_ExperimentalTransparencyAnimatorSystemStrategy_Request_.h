...
namespace app::methods::System::Collections::Generic::ArraySortHelper_1_Moon_Timeline_ExperimentalTransparencyAnimatorSystemStrategy_Request_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02C86EC0, void, IntrospectiveSort, (app::ExperimentalTransparencyAnimatorSystemStrategy_Request__Array * keys, int32_t left, int32_t length, app::Comparison_1_Moon_Timeline_ExperimentalTransparencyAnimatorSystemStrategy_Request_ * comparer))
    IL2CPP_REGISTER_METHOD(0x02C86FB0, void, IntroSort, (app::ExperimentalTransparencyAnimatorSystemStrategy_Request__Array * keys, int32_t lo, int32_t hi, int32_t depth_limit, app::Comparison_1_Moon_Timeline_ExperimentalTransparencyAnimatorSystemStrategy_Request_ * comparer))
    IL2CPP_REGISTER_METHOD(0x02C888B0, int32_t, PickPivotAndPartition, (app::ExperimentalTransparencyAnimatorSystemStrategy_Request__Array * keys, int32_t lo, int32_t hi, app::Comparison_1_Moon_Timeline_ExperimentalTransparencyAnimatorSystemStrategy_Request_ * comparer))
    IL2CPP_REGISTER_METHOD(0x02C87750, void, Heapsort, (app::ExperimentalTransparencyAnimatorSystemStrategy_Request__Array * keys, int32_t lo, int32_t hi, app::Comparison_1_Moon_Timeline_ExperimentalTransparencyAnimatorSystemStrategy_Request_ * comparer))
    IL2CPP_REGISTER_METHOD(0x02C88CE0, void, DownHeap, (app::ExperimentalTransparencyAnimatorSystemStrategy_Request__Array * keys, int32_t i, int32_t n, int32_t lo, app::Comparison_1_Moon_Timeline_ExperimentalTransparencyAnimatorSystemStrategy_Request_ * comparer))
    IL2CPP_REGISTER_METHOD(0x02C89050, void, InsertionSort, (app::ExperimentalTransparencyAnimatorSystemStrategy_Request__Array * keys, int32_t lo, int32_t hi, app::Comparison_1_Moon_Timeline_ExperimentalTransparencyAnimatorSystemStrategy_Request_ * comparer))
}

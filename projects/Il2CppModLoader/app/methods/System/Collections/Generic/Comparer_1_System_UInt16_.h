...
namespace app::methods::System::Collections::Generic::Comparer_1_System_UInt16_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04773710, Comparer_1_System_UInt16__Create__MethodInfo)

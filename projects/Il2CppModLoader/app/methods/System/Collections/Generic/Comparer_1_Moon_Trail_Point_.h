...
namespace app::methods::System::Collections::Generic::Comparer_1_Moon_Trail_Point_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0477DF38, Comparer_1_Moon_Trail_Point__Create__MethodInfo)

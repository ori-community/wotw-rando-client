...
namespace app::methods::System::Collections::Generic::List_1_IFrustumOptimizable_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x047529F0, List_1_IFrustumOptimizable__get_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_IFrustumOptimizable_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0472FB88, List_1_IFrustumOptimizable__get_Count__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025F12F0, bool, Remove, (app::List_1_IFrustumOptimizable_ * this_ptr, app::IFrustumOptimizable * item))
    IL2CPP_REGISTER_METHODINFO(0x04725ED8, List_1_IFrustumOptimizable__Remove__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02F1E150, void, Add, (app::List_1_IFrustumOptimizable_ * this_ptr, app::IFrustumOptimizable * item))
    IL2CPP_REGISTER_METHODINFO(0x04782D18, List_1_IFrustumOptimizable__Add__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04717480, List_1_IFrustumOptimizable__GetEnumerator__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x022A4010, void, Clear, (app::List_1_IFrustumOptimizable_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04766B10, List_1_IFrustumOptimizable__Clear__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025F1690, void, RemoveAt, (app::List_1_IFrustumOptimizable_ * this_ptr, int32_t index))
    IL2CPP_REGISTER_METHODINFO(0x0475B780, List_1_IFrustumOptimizable__RemoveAt__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04761C80, List_1_IFrustumOptimizable__RemoveAll__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor, (app::List_1_IFrustumOptimizable_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04789C38, List_1_IFrustumOptimizable___ctor__MethodInfo)
}

...
namespace app::classes::System::Collections::Generic::List_1_Moon_IUberStateApplier_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04731940, List_1_Moon_IUberStateApplier___ctor__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x022A4010, void, Clear, (app::List_1_Moon_IUberStateApplier_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0470E2C0, List_1_Moon_IUberStateApplier__Clear__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02F1E150, void, Add, (app::List_1_Moon_IUberStateApplier_ * this_ptr, app::IUberStateApplier* item))
    IL2CPP_REGISTER_METHODINFO(0x0471F128, List_1_Moon_IUberStateApplier__Add__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025F12F0, bool, Remove, (app::List_1_Moon_IUberStateApplier_ * this_ptr, app::IUberStateApplier* item))
    IL2CPP_REGISTER_METHODINFO(0x04762C68, List_1_Moon_IUberStateApplier__Remove__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0475CD20, List_1_Moon_IUberStateApplier__get_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_Moon_IUberStateApplier_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04777BF0, List_1_Moon_IUberStateApplier__get_Count__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E81E0, void, ctor_2, (app::List_1_Moon_IUberStateApplier_ * this_ptr, int32_t capacity))
    IL2CPP_REGISTER_METHODINFO(0x0474BB80, List_1_Moon_IUberStateApplier___ctor_1__MethodInfo)
} // namespace app::classes::System::Collections::Generic::List_1_Moon_IUberStateApplier_

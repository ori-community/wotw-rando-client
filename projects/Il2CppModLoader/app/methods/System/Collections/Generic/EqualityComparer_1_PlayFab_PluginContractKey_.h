...
namespace app::methods::System::Collections::Generic::EqualityComparer_1_PlayFab_PluginContractKey_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02B48E30, int32_t, LastIndexOf, (app::EqualityComparer_1_PlayFab_PluginContractKey_ * this_ptr, app::PluginContractKey__Array * array, app::PluginContractKey value, int32_t start_index, int32_t count))
    IL2CPP_REGISTER_METHOD(0x02B48F00, int32_t, IEqualityComparer_GetHashCode, (app::EqualityComparer_1_PlayFab_PluginContractKey_ * this_ptr, app::Object * obj))
    IL2CPP_REGISTER_METHOD(0x02B49000, bool, IEqualityComparer_Equals, (app::EqualityComparer_1_PlayFab_PluginContractKey_ * this_ptr, app::Object * x, app::Object * y))
}

...
namespace app::methods::System::Collections::Generic::List_1_Moon_BehaviourSystem_Action_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0472FD60, List_1_Moon_BehaviourSystem_Action__GetEnumerator__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025F1690, void, RemoveAt, (app::List_1_Moon_BehaviourSystem_Action_ * this_ptr, int32_t index))
    IL2CPP_REGISTER_METHODINFO(0x0477A7F0, List_1_Moon_BehaviourSystem_Action__RemoveAt__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor, (app::List_1_Moon_BehaviourSystem_Action_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04759150, List_1_Moon_BehaviourSystem_Action___ctor__MethodInfo)
}

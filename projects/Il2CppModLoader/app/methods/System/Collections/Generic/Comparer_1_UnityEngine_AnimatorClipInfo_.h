...
namespace app::methods::System::Collections::Generic::Comparer_1_UnityEngine_AnimatorClipInfo_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04764AB0, Comparer_1_UnityEngine_AnimatorClipInfo__Create__MethodInfo)

...
namespace app::methods::System::Collections::Generic::Stack_1_T__Enumerator_System_Single_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04703A58, Stack_1_T_Enumerator_System_Single__MoveNext__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0470C0C8, Stack_1_T_Enumerator_System_Single__ThrowEnumerationNotStartedOrEnded__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0470B208, Stack_1_T_Enumerator_System_Single__System_Collections_IEnumerator_Reset__MethodInfo)
}

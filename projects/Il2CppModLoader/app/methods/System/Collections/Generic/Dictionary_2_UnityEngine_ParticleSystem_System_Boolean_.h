...
namespace app::methods::System::Collections::Generic::Dictionary_2_UnityEngine_ParticleSystem_System_Boolean_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04751650, Dictionary_2_UnityEngine_ParticleSystem_System_Boolean__get_Item__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x047906C8, Dictionary_2_UnityEngine_ParticleSystem_System_Boolean__Add__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0475A390, Dictionary_2_UnityEngine_ParticleSystem_System_Boolean__get_Keys__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x0283AC20, void, ctor, (app::Dictionary_2_UnityEngine_ParticleSystem_System_Boolean_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0476FDB8, Dictionary_2_UnityEngine_ParticleSystem_System_Boolean___ctor__MethodInfo)
}

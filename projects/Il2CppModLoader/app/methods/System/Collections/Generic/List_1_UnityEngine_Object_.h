...
namespace app::methods::System::Collections::Generic::List_1_UnityEngine_Object_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0470AFC8, List_1_UnityEngine_Object__GetEnumerator__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor, (app::List_1_UnityEngine_Object_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04704C90, List_1_UnityEngine_Object___ctor__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_UnityEngine_Object_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04791DB8, List_1_UnityEngine_Object__get_Count__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025EFC50, app::Object_1 *, get_Item, (app::List_1_UnityEngine_Object_ * this_ptr, int32_t index))
    IL2CPP_REGISTER_METHODINFO(0x0477F698, List_1_UnityEngine_Object__get_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x022A4010, void, Clear, (app::List_1_UnityEngine_Object_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0471D648, List_1_UnityEngine_Object__Clear__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x047347F0, List_1_UnityEngine_Object__AddRange__MethodInfo)
}

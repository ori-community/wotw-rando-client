...
namespace app::methods::System::Collections::Generic::Dictionary_2_Moon_ISuspendable_Moon_HitStop_Entry_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0478E9B8, Dictionary_2_Moon_ISuspendable_Moon_HitStop_Entry__TryGetValue__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0476FA38, Dictionary_2_Moon_ISuspendable_Moon_HitStop_Entry__Add__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04799968, Dictionary_2_Moon_ISuspendable_Moon_HitStop_Entry__Remove__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x0283B900, void, Clear, (app::Dictionary_2_Moon_ISuspendable_Moon_HitStop_Entry_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04762788, Dictionary_2_Moon_ISuspendable_Moon_HitStop_Entry__Clear__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x0283AC20, void, ctor, (app::Dictionary_2_Moon_ISuspendable_Moon_HitStop_Entry_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0472D8F8, Dictionary_2_Moon_ISuspendable_Moon_HitStop_Entry___ctor__MethodInfo)
}

...
namespace app::methods::System::Collections::Generic::EqualityComparer_1_StateValidator_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02B49B00, int32_t, IndexOf, (app::EqualityComparer_1_StateValidator_ * this_ptr, app::StateValidator__Array * array, app::StateValidator value, int32_t start_index, int32_t count))
    IL2CPP_REGISTER_METHOD(0x02B49BF0, int32_t, LastIndexOf, (app::EqualityComparer_1_StateValidator_ * this_ptr, app::StateValidator__Array * array, app::StateValidator value, int32_t start_index, int32_t count))

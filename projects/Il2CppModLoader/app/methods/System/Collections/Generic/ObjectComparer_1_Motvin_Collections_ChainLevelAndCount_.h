...
namespace app::methods::System::Collections::Generic::ObjectComparer_1_Motvin_Collections_ChainLevelAndCount_ {
    IL2CPP_REGISTER_METHOD(0x01CC7D40, int32_t, Compare, (app::ObjectComparer_1_Motvin_Collections_ChainLevelAndCount_ * this_ptr, app::ChainLevelAndCount x, app::ChainLevelAndCount y))

...
namespace app::methods::System::Collections::Generic::List_1_UnityEngine_EventSystems_EventSystem_ {
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_UnityEngine_EventSystems_EventSystem_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0470F238, List_1_UnityEngine_EventSystems_EventSystem__get_Count__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04706BC0, List_1_UnityEngine_EventSystems_EventSystem__get_Item__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0472D6A0, List_1_UnityEngine_EventSystems_EventSystem__IndexOf__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025F1690, void, RemoveAt, (app::List_1_UnityEngine_EventSystems_EventSystem_ * this_ptr, int32_t index))
    IL2CPP_REGISTER_METHODINFO(0x0470C420, List_1_UnityEngine_EventSystems_EventSystem__RemoveAt__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0471AEC0, List_1_UnityEngine_EventSystems_EventSystem__Insert__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04703FB0, List_1_UnityEngine_EventSystems_EventSystem__Add__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x047520A0, List_1_UnityEngine_EventSystems_EventSystem__Remove__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor, (app::List_1_UnityEngine_EventSystems_EventSystem_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0474B730, List_1_UnityEngine_EventSystems_EventSystem___ctor__MethodInfo)
}

...
namespace app::methods::System::Collections::Generic::List_1_PhysicsDebugTools_Record_ {
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_PhysicsDebugTools_Record_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047279D8, List_1_PhysicsDebugTools_Record__get_Count__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025EFC50, app::Record *, get_Item, (app::List_1_PhysicsDebugTools_Record_ * this_ptr, int32_t index))
    IL2CPP_REGISTER_METHODINFO(0x0472E390, List_1_PhysicsDebugTools_Record__get_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025F1690, void, RemoveAt, (app::List_1_PhysicsDebugTools_Record_ * this_ptr, int32_t index))
    IL2CPP_REGISTER_METHODINFO(0x0477B1F0, List_1_PhysicsDebugTools_Record__RemoveAt__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0474C380, List_1_PhysicsDebugTools_Record__Find__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02F1E150, void, Add, (app::List_1_PhysicsDebugTools_Record_ * this_ptr, app::Record * item))
    IL2CPP_REGISTER_METHODINFO(0x0473EC78, List_1_PhysicsDebugTools_Record__Add__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor, (app::List_1_PhysicsDebugTools_Record_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04724EF0, List_1_PhysicsDebugTools_Record___ctor__MethodInfo)
}

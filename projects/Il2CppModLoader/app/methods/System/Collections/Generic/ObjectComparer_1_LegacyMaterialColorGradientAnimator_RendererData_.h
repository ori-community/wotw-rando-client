...
namespace app::methods::System::Collections::Generic::ObjectComparer_1_LegacyMaterialColorGradientAnimator_RendererData_ {
    IL2CPP_REGISTER_METHOD(0x01CC3CF0, int32_t, Compare, (app::ObjectComparer_1_LegacyMaterialColorGradientAnimator_RendererData_ * this_ptr, app::LegacyMaterialColorGradientAnimator_RendererData x, app::LegacyMaterialColorGradientAnimator_RendererData y))

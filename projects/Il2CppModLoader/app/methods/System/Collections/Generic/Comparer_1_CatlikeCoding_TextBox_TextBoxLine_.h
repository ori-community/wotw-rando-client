...
namespace app::classes::System::Collections::Generic::Comparer_1_CatlikeCoding_TextBox_TextBoxLine_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02C96920, app::Comparer_1_CatlikeCoding_TextBox_TextBoxLine_*, Create, (app::Comparison_1_CatlikeCoding_TextBox_TextBoxLine_ * comparison))
    IL2CPP_REGISTER_METHODINFO(0x0474C670, Comparer_1_CatlikeCoding_TextBox_TextBoxLine__Create__MethodInfo)

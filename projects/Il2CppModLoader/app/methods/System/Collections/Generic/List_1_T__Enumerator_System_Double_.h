...
namespace app::methods::System::Collections::Generic::List_1_T__Enumerator_System_Double_ {
    IL2CPP_REGISTER_METHOD(0x00127520, double, get_Current, (app::List_1_T_Enumerator_System_Double___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0477D2F0, List_1_T_Enumerator_System_Double__get_Current__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x0014CEB0, bool, MoveNext, (app::List_1_T_Enumerator_System_Double___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04779ED0, List_1_T_Enumerator_System_Double__MoveNext__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00002890, void, Dispose, (app::List_1_T_Enumerator_System_Double___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04714D18, List_1_T_Enumerator_System_Double__Dispose__MethodInfo)

...
namespace app::methods::System::Collections::Generic::Dictionary_2_System_Int32_LeakedSceneObjectDetector_ObjectData_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04739A30, Dictionary_2_System_Int32_LeakedSceneObjectDetector_ObjectData__Clear__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04727A80, Dictionary_2_System_Int32_LeakedSceneObjectDetector_ObjectData__ContainsKey__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0477B3D8, Dictionary_2_System_Int32_LeakedSceneObjectDetector_ObjectData__get_Item__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04742FA0, Dictionary_2_System_Int32_LeakedSceneObjectDetector_ObjectData__set_Item__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04711980, Dictionary_2_System_Int32_LeakedSceneObjectDetector_ObjectData__get_Values__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x0283AC20, void, ctor, (app::Dictionary_2_System_Int32_LeakedSceneObjectDetector_ObjectData_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04774F20, Dictionary_2_System_Int32_LeakedSceneObjectDetector_ObjectData___ctor__MethodInfo)
}

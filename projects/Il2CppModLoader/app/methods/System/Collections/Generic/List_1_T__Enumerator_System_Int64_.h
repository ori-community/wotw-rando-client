...
namespace app::methods::System::Collections::Generic::List_1_T__Enumerator_System_Int64_ {
    IL2CPP_REGISTER_METHOD(0x00107C20, int64_t, get_Current, (app::List_1_T_Enumerator_System_Int64___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04733818, List_1_T_Enumerator_System_Int64__get_Current__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x0014CEB0, bool, MoveNext, (app::List_1_T_Enumerator_System_Int64___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047468A8, List_1_T_Enumerator_System_Int64__MoveNext__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00002890, void, Dispose, (app::List_1_T_Enumerator_System_Int64___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047367F0, List_1_T_Enumerator_System_Int64__Dispose__MethodInfo)

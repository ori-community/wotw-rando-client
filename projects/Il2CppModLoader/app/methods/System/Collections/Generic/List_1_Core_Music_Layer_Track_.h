...
namespace app::methods::System::Collections::Generic::List_1_Core_Music_Layer_Track_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x047630B8, List_1_Core_Music_Layer_Track__GetEnumerator__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor, (app::List_1_Core_Music_Layer_Track_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0476B870, List_1_Core_Music_Layer_Track___ctor__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02F1E150, void, Add, (app::List_1_Core_Music_Layer_Track_ * this_ptr, app::Music_Layer_Track * item))
    IL2CPP_REGISTER_METHODINFO(0x0478FA68, List_1_Core_Music_Layer_Track__Add__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0473FE38, List_1_Core_Music_Layer_Track__get_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_Core_Music_Layer_Track_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0475ACA8, List_1_Core_Music_Layer_Track__get_Count__MethodInfo)
}

...
namespace app::methods::System::Collections::Generic::List_1_LogCallbackHandler_LogEntry_ {
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor, (app::List_1_LogCallbackHandler_LogEntry_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04792C30, List_1_LogCallbackHandler_LogEntry___ctor__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04774240, List_1_LogCallbackHandler_LogEntry__GetEnumerator__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0471E570, List_1_LogCallbackHandler_LogEntry__Add__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04728968, List_1_LogCallbackHandler_LogEntry__get_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_LogCallbackHandler_LogEntry_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0476D488, List_1_LogCallbackHandler_LogEntry__get_Count__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x022A4010, void, Clear, (app::List_1_LogCallbackHandler_LogEntry_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0474B590, List_1_LogCallbackHandler_LogEntry__Clear__MethodInfo)
}

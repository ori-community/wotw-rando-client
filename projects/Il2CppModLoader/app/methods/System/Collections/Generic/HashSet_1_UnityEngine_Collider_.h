...
namespace app::methods::System::Collections::Generic::HashSet_1_UnityEngine_Collider_ {
    IL2CPP_REGISTER_METHOD(0x02AB4A90, void, Clear, (app::HashSet_1_UnityEngine_Collider_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047064B8, HashSet_1_UnityEngine_Collider__Clear__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02AB4A60, bool, Add, (app::HashSet_1_UnityEngine_Collider_ * this_ptr, app::Collider * item))
    IL2CPP_REGISTER_METHODINFO(0x0474F040, HashSet_1_UnityEngine_Collider__Add__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02ABEC50, bool, Remove, (app::HashSet_1_UnityEngine_Collider_ * this_ptr, app::Collider * item))
    IL2CPP_REGISTER_METHODINFO(0x0478E248, HashSet_1_UnityEngine_Collider__Remove__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0475D0C8, HashSet_1_UnityEngine_Collider__GetEnumerator__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02AB4370, void, ctor, (app::HashSet_1_UnityEngine_Collider_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047839E0, HashSet_1_UnityEngine_Collider___ctor__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x002FD1D0, int32_t, get_Count, (app::HashSet_1_UnityEngine_Collider_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047239B8, HashSet_1_UnityEngine_Collider__get_Count__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02ABEAC0, bool, Contains, (app::HashSet_1_UnityEngine_Collider_ * this_ptr, app::Collider * item))
    IL2CPP_REGISTER_METHODINFO(0x04736510, HashSet_1_UnityEngine_Collider__Contains__MethodInfo)
}

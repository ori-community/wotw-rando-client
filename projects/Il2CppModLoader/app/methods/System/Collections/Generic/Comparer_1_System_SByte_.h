...
namespace app::methods::System::Collections::Generic::Comparer_1_System_SByte_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0478CF28, Comparer_1_System_SByte__Create__MethodInfo)

...
namespace app::methods::System::Collections::Generic::StackDebugView_1_System_Object_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04762F60, StackDebugView_1_System_Object___ctor__MethodInfo)
}

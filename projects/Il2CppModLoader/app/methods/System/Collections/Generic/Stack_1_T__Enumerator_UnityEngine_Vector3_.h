...
namespace app::methods::System::Collections::Generic::Stack_1_T__Enumerator_UnityEngine_Vector3_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04763688, Stack_1_T_Enumerator_UnityEngine_Vector3__MoveNext__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04701508, Stack_1_T_Enumerator_UnityEngine_Vector3__ThrowEnumerationNotStartedOrEnded__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0472C100, Stack_1_T_Enumerator_UnityEngine_Vector3__System_Collections_IEnumerator_Reset__MethodInfo)
}

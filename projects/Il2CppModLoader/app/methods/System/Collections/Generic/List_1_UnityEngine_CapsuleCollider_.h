...
namespace app::methods::System::Collections::Generic::List_1_UnityEngine_CapsuleCollider_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0475CC48, List_1_UnityEngine_CapsuleCollider__Contains__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02F1E150, void, Add, (app::List_1_UnityEngine_CapsuleCollider_ * this_ptr, app::CapsuleCollider * item))
    IL2CPP_REGISTER_METHODINFO(0x0470D190, List_1_UnityEngine_CapsuleCollider__Add__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_UnityEngine_CapsuleCollider_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0478CE50, List_1_UnityEngine_CapsuleCollider__get_Count__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025F12F0, bool, Remove, (app::List_1_UnityEngine_CapsuleCollider_ * this_ptr, app::CapsuleCollider * item))
    IL2CPP_REGISTER_METHODINFO(0x04796A70, List_1_UnityEngine_CapsuleCollider__Remove__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E81E0, void, ctor, (app::List_1_UnityEngine_CapsuleCollider_ * this_ptr, int32_t capacity))
    IL2CPP_REGISTER_METHODINFO(0x047609A0, List_1_UnityEngine_CapsuleCollider___ctor__MethodInfo)
}

...
namespace app::methods::System::Collections::Generic::Stack_1_T__Enumerator_System_Object_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x047870A0, Stack_1_T_Enumerator_System_Object__MoveNext__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04734FF8, Stack_1_T_Enumerator_System_Object__ThrowEnumerationNotStartedOrEnded__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00234110, void, IEnumerator_Reset, (app::Stack_1_T_Enumerator_System_Object___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047071F0, Stack_1_T_Enumerator_System_Object__System_Collections_IEnumerator_Reset__MethodInfo)
}

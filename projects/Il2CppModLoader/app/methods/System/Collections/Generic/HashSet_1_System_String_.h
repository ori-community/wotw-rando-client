...
namespace app::methods::System::Collections::Generic::HashSet_1_System_String_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0472D9F8, HashSet_1_System_String__GetEnumerator__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02AB4370, void, ctor_1, (app::HashSet_1_System_String_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04746718, HashSet_1_System_String___ctor__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04792740, HashSet_1_System_String___ctor_1__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02ABEAC0, bool, Contains, (app::HashSet_1_System_String_ * this_ptr, app::String * item))
    IL2CPP_REGISTER_METHODINFO(0x0473EC00, HashSet_1_System_String__Contains__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02AB4A60, bool, Add, (app::HashSet_1_System_String_ * this_ptr, app::String * item))
    IL2CPP_REGISTER_METHODINFO(0x04720CB8, HashSet_1_System_String__Add__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02AB4A90, void, Clear, (app::HashSet_1_System_String_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047246F0, HashSet_1_System_String__Clear__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x002FD1D0, int32_t, get_Count, (app::HashSet_1_System_String_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04757F40, HashSet_1_System_String__get_Count__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02ABEC50, bool, Remove, (app::HashSet_1_System_String_ * this_ptr, app::String * item))
    IL2CPP_REGISTER_METHODINFO(0x04765BD0, HashSet_1_System_String__Remove__MethodInfo)
}

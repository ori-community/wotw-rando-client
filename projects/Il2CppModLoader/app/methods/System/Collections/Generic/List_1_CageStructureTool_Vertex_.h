...
namespace app::methods::System::Collections::Generic::List_1_CageStructureTool_Vertex_ {
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_CageStructureTool_Vertex_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04756330, List_1_CageStructureTool_Vertex__get_Count__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0473B110, List_1_CageStructureTool_Vertex__get_Item__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x047461C0, List_1_CageStructureTool_Vertex__Find__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0476C830, List_1_CageStructureTool_Vertex__Remove__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0472BD08, List_1_CageStructureTool_Vertex__FindIndex__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0478F390, List_1_CageStructureTool_Vertex__Add__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor, (app::List_1_CageStructureTool_Vertex_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047881F0, List_1_CageStructureTool_Vertex___ctor__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x022A4010, void, Clear, (app::List_1_CageStructureTool_Vertex_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04765928, List_1_CageStructureTool_Vertex__Clear__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0476B098, List_1_CageStructureTool_Vertex__GetEnumerator__MethodInfo)
}

...
namespace app::methods::System::Collections::Generic::List_1_LegacyTransparencyAnimator_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04748948, List_1_LegacyTransparencyAnimator__GetEnumerator__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor_1, (app::List_1_LegacyTransparencyAnimator_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04727FB8, List_1_LegacyTransparencyAnimator___ctor__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04764E18, List_1_LegacyTransparencyAnimator__Add__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0472F900, List_1_LegacyTransparencyAnimator__get_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_LegacyTransparencyAnimator_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047634A8, List_1_LegacyTransparencyAnimator__get_Count__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E81E0, void, ctor_2, (app::List_1_LegacyTransparencyAnimator_ * this_ptr, int32_t capacity))
    IL2CPP_REGISTER_METHODINFO(0x04754EB0, List_1_LegacyTransparencyAnimator___ctor_1__MethodInfo)
}

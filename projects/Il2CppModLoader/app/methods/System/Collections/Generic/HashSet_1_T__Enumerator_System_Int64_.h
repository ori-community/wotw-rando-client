...
namespace app::methods::System::Collections::Generic::HashSet_1_T__Enumerator_System_Int64_ {
    IL2CPP_REGISTER_METHOD(0x00107C20, int64_t, get_Current, (app::HashSet_1_T_Enumerator_System_Int64___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04772428, HashSet_1_T_Enumerator_System_Int64__get_Current__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00220570, bool, MoveNext, (app::HashSet_1_T_Enumerator_System_Int64___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047439A0, HashSet_1_T_Enumerator_System_Int64__MoveNext__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00002890, void, Dispose, (app::HashSet_1_T_Enumerator_System_Int64___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04730EC8, HashSet_1_T_Enumerator_System_Int64__Dispose__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0473F878, HashSet_1_T_Enumerator_System_Int64__System_Collections_IEnumerator_get_Current__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x002206C0, void, IEnumerator_Reset, (app::HashSet_1_T_Enumerator_System_Int64___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047509C0, HashSet_1_T_Enumerator_System_Int64__System_Collections_IEnumerator_Reset__MethodInfo)
}

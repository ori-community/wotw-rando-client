...
namespace app::methods::System::Collections::Generic::ObjectEqualityComparer_1_UnityEngine_Bounds_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02437CB0, int32_t, IndexOf, (app::ObjectEqualityComparer_1_UnityEngine_Bounds_ * this_ptr, app::Bounds__Array * array, app::Bounds value, int32_t start_index, int32_t count))
    IL2CPP_REGISTER_METHOD(0x02437DC0, int32_t, LastIndexOf, (app::ObjectEqualityComparer_1_UnityEngine_Bounds_ * this_ptr, app::Bounds__Array * array, app::Bounds value, int32_t start_index, int32_t count))

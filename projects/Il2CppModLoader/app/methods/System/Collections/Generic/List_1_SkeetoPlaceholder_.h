...
namespace app::methods::System::Collections::Generic::List_1_SkeetoPlaceholder_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0477ABC8, List_1_SkeetoPlaceholder__GetEnumerator__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_SkeetoPlaceholder_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0471FBD0, List_1_SkeetoPlaceholder__get_Count__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025EFC50, app::SkeetoPlaceholder *, get_Item, (app::List_1_SkeetoPlaceholder_ * this_ptr, int32_t index))
    IL2CPP_REGISTER_METHODINFO(0x0478E470, List_1_SkeetoPlaceholder__get_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor_1, (app::List_1_SkeetoPlaceholder_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04774288, List_1_SkeetoPlaceholder___ctor__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x047969B0, List_1_SkeetoPlaceholder___ctor_1__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025EABD0, void, RemoveRange, (app::List_1_SkeetoPlaceholder_ * this_ptr, int32_t index, int32_t count))
    IL2CPP_REGISTER_METHODINFO(0x0470E988, List_1_SkeetoPlaceholder__RemoveRange__MethodInfo)
}

...
namespace app::methods::System::Collections::Generic::List_1_Moon_Timeline_ITimelineStateObserver_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04745EF0, List_1_Moon_Timeline_ITimelineStateObserver__get_Item__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x047953D0, List_1_Moon_Timeline_ITimelineStateObserver__Insert__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_Moon_Timeline_ITimelineStateObserver_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04750FC8, List_1_Moon_Timeline_ITimelineStateObserver__get_Count__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x047595A8, List_1_Moon_Timeline_ITimelineStateObserver__Add__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04733520, List_1_Moon_Timeline_ITimelineStateObserver__Remove__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025F1690, void, RemoveAt, (app::List_1_Moon_Timeline_ITimelineStateObserver_ * this_ptr, int32_t index))
    IL2CPP_REGISTER_METHODINFO(0x0475E158, List_1_Moon_Timeline_ITimelineStateObserver__RemoveAt__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor, (app::List_1_Moon_Timeline_ITimelineStateObserver_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04795CF8, List_1_Moon_Timeline_ITimelineStateObserver___ctor__MethodInfo)
}

...
namespace app::methods::System::Collections::Generic::List_1_DynamicInstantiationDescriptor_ {
    IL2CPP_REGISTER_METHOD(0x022A4010, void, Clear, (app::List_1_DynamicInstantiationDescriptor_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04769608, List_1_DynamicInstantiationDescriptor__Clear__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E8790, void, set_Capacity, (app::List_1_DynamicInstantiationDescriptor_ * this_ptr, int32_t value))
    IL2CPP_REGISTER_METHODINFO(0x04774790, List_1_DynamicInstantiationDescriptor__set_Capacity__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E81E0, void, ctor_1, (app::List_1_DynamicInstantiationDescriptor_ * this_ptr, int32_t capacity))
    IL2CPP_REGISTER_METHODINFO(0x04783E80, List_1_DynamicInstantiationDescriptor___ctor__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04734CD0, List_1_DynamicInstantiationDescriptor__AddRange__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04793988, List_1_DynamicInstantiationDescriptor__Add__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor_2, (app::List_1_DynamicInstantiationDescriptor_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0476B5D8, List_1_DynamicInstantiationDescriptor___ctor_1__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04726A98, List_1_DynamicInstantiationDescriptor__GetEnumerator__MethodInfo)
}

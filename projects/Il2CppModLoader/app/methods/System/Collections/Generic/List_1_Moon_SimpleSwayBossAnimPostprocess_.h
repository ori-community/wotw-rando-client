...
namespace app::methods::System::Collections::Generic::List_1_Moon_SimpleSwayBossAnimPostprocess_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04746E70, List_1_Moon_SimpleSwayBossAnimPostprocess__GetEnumerator__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0473D8E0, List_1_Moon_SimpleSwayBossAnimPostprocess__Add__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0477C0A8, List_1_Moon_SimpleSwayBossAnimPostprocess__Remove__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E81E0, void, ctor, (app::List_1_Moon_SimpleSwayBossAnimPostprocess_ * this_ptr, int32_t capacity))
    IL2CPP_REGISTER_METHODINFO(0x0471DFF0, List_1_Moon_SimpleSwayBossAnimPostprocess___ctor__MethodInfo)
}

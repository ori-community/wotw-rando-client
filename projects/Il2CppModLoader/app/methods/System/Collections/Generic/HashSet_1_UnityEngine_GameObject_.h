...
namespace app::methods::System::Collections::Generic::HashSet_1_UnityEngine_GameObject_ {
    IL2CPP_REGISTER_METHOD(0x02AB4A90, void, Clear, (app::HashSet_1_UnityEngine_GameObject_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04746C90, HashSet_1_UnityEngine_GameObject__Clear__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02AB4A60, bool, Add, (app::HashSet_1_UnityEngine_GameObject_ * this_ptr, app::GameObject * item))
    IL2CPP_REGISTER_METHODINFO(0x04749D48, HashSet_1_UnityEngine_GameObject__Add__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x002FD1D0, int32_t, get_Count, (app::HashSet_1_UnityEngine_GameObject_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0476B0A8, HashSet_1_UnityEngine_GameObject__get_Count__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04719DD8, HashSet_1_UnityEngine_GameObject__GetEnumerator__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x047480C8, HashSet_1_UnityEngine_GameObject__RemoveWhere__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02AB4370, void, ctor, (app::HashSet_1_UnityEngine_GameObject_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04786188, HashSet_1_UnityEngine_GameObject___ctor__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02ABEAC0, bool, Contains, (app::HashSet_1_UnityEngine_GameObject_ * this_ptr, app::GameObject * item))
    IL2CPP_REGISTER_METHODINFO(0x04747B40, HashSet_1_UnityEngine_GameObject__Contains__MethodInfo)
}

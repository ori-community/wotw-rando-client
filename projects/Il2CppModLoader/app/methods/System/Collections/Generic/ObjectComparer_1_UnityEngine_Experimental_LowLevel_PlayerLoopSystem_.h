...
namespace app::methods::System::Collections::Generic::ObjectComparer_1_UnityEngine_Experimental_LowLevel_PlayerLoopSystem_ {
    IL2CPP_REGISTER_METHOD(0x01CCE5F0, int32_t, Compare, (app::ObjectComparer_1_UnityEngine_Experimental_LowLevel_PlayerLoopSystem_ * this_ptr, app::PlayerLoopSystem x, app::PlayerLoopSystem y))

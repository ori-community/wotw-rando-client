...
namespace app::methods::System::Collections::Generic::ArraySortHelper_1_System_ValueTuple_4_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02C86EC0, void, IntrospectiveSort, (app::ValueTuple_4_Object_Int32_Int32_Single___Array * keys, int32_t left, int32_t length, app::Comparison_1_ValueTuple_4_Object_Int32_Int32_Single_ * comparer))
    IL2CPP_REGISTER_METHOD(0x02C86FB0, void, IntroSort, (app::ValueTuple_4_Object_Int32_Int32_Single___Array * keys, int32_t lo, int32_t hi, int32_t depth_limit, app::Comparison_1_ValueTuple_4_Object_Int32_Int32_Single_ * comparer))
    IL2CPP_REGISTER_METHOD(0x02C8C3D0, int32_t, PickPivotAndPartition, (app::ValueTuple_4_Object_Int32_Int32_Single___Array * keys, int32_t lo, int32_t hi, app::Comparison_1_ValueTuple_4_Object_Int32_Int32_Single_ * comparer))
    IL2CPP_REGISTER_METHOD(0x02C87750, void, Heapsort, (app::ValueTuple_4_Object_Int32_Int32_Single___Array * keys, int32_t lo, int32_t hi, app::Comparison_1_ValueTuple_4_Object_Int32_Int32_Single_ * comparer))
    IL2CPP_REGISTER_METHOD(0x02C8C820, void, DownHeap, (app::ValueTuple_4_Object_Int32_Int32_Single___Array * keys, int32_t i, int32_t n, int32_t lo, app::Comparison_1_ValueTuple_4_Object_Int32_Int32_Single_ * comparer))
    IL2CPP_REGISTER_METHOD(0x02C8CBA0, void, InsertionSort, (app::ValueTuple_4_Object_Int32_Int32_Single___Array * keys, int32_t lo, int32_t hi, app::Comparison_1_ValueTuple_4_Object_Int32_Int32_Single_ * comparer))
}

...
namespace app::methods::System::Collections::Generic::EqualityComparer_1_UnityEngine_Vector3_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02B53BB0, int32_t, IndexOf, (app::EqualityComparer_1_UnityEngine_Vector3_ * this_ptr, app::Vector3__Array * array, app::Vector3 value, int32_t start_index, int32_t count))
    IL2CPP_REGISTER_METHOD(0x02B53C90, int32_t, LastIndexOf, (app::EqualityComparer_1_UnityEngine_Vector3_ * this_ptr, app::Vector3__Array * array, app::Vector3 value, int32_t start_index, int32_t count))

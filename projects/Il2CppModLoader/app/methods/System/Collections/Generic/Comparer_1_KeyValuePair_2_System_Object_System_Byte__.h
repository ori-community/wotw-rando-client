...
namespace app::methods::System::Collections::Generic::Comparer_1_KeyValuePair_2_System_Object_System_Byte__ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x047549A8, Comparer_1_KeyValuePair_2_System_Object_System_Byte__Create__MethodInfo)

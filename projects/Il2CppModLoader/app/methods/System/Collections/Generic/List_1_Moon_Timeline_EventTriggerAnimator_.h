...
namespace app::classes::System::Collections::Generic::List_1_Moon_Timeline_EventTriggerAnimator_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04778DB8, List_1_Moon_Timeline_EventTriggerAnimator__GetEnumerator__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor_1, (app::List_1_Moon_Timeline_EventTriggerAnimator_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04723CA8, List_1_Moon_Timeline_EventTriggerAnimator___ctor__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0473E168, List_1_Moon_Timeline_EventTriggerAnimator__get_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_Moon_Timeline_EventTriggerAnimator_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04792000, List_1_Moon_Timeline_EventTriggerAnimator__get_Count__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0478A478, List_1_Moon_Timeline_EventTriggerAnimator___ctor_1__MethodInfo)
} // namespace app::classes::System::Collections::Generic::List_1_Moon_Timeline_EventTriggerAnimator_

...
namespace app::methods::System::Collections::Generic::Dictionary_2_UnityEngine_GameObject_LeashMarkEffect_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x047088C0, Dictionary_2_UnityEngine_GameObject_LeashMarkEffect__ContainsKey__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04770A28, Dictionary_2_UnityEngine_GameObject_LeashMarkEffect__get_Item__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04709338, Dictionary_2_UnityEngine_GameObject_LeashMarkEffect__Remove__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04741930, Dictionary_2_UnityEngine_GameObject_LeashMarkEffect__Add__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x047677C0, Dictionary_2_UnityEngine_GameObject_LeashMarkEffect__get_Keys__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x0283AC20, void, ctor, (app::Dictionary_2_UnityEngine_GameObject_LeashMarkEffect_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04769710, Dictionary_2_UnityEngine_GameObject_LeashMarkEffect___ctor__MethodInfo)
}

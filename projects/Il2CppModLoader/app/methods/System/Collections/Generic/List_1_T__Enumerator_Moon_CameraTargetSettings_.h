...
namespace app::methods::System::Collections::Generic::List_1_T__Enumerator_Moon_CameraTargetSettings_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04712258, List_1_T_Enumerator_Moon_CameraTargetSettings__get_Current__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x0014D530, bool, MoveNext, (app::List_1_T_Enumerator_Moon_CameraTargetSettings___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04748F10, List_1_T_Enumerator_Moon_CameraTargetSettings__MoveNext__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00002890, void, Dispose, (app::List_1_T_Enumerator_Moon_CameraTargetSettings___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0472C738, List_1_T_Enumerator_Moon_CameraTargetSettings__Dispose__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x0014D4F0, void, ctor, (app::List_1_T_Enumerator_Moon_CameraTargetSettings___Boxed * this_ptr, app::List_1_Moon_CameraTargetSettings_ * list))

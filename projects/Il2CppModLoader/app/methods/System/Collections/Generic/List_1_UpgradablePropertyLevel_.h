...
namespace app::methods::System::Collections::Generic::List_1_UpgradablePropertyLevel_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0478A390, List_1_UpgradablePropertyLevel__get_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_UpgradablePropertyLevel_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0478F598, List_1_UpgradablePropertyLevel__get_Count__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E81E0, void, ctor, (app::List_1_UpgradablePropertyLevel_ * this_ptr, int32_t capacity))
    IL2CPP_REGISTER_METHODINFO(0x04766C70, List_1_UpgradablePropertyLevel___ctor__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02F1E150, void, Add, (app::List_1_UpgradablePropertyLevel_ * this_ptr, app::UpgradablePropertyLevel * item))
    IL2CPP_REGISTER_METHODINFO(0x04774370, List_1_UpgradablePropertyLevel__Add__MethodInfo)
}

...
namespace app::methods::System::Collections::Generic::List_1_ZenFulcrum_EmbeddedBrowser_JSONNode_ {
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor, (app::List_1_ZenFulcrum_EmbeddedBrowser_JSONNode_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0473A328, List_1_ZenFulcrum_EmbeddedBrowser_JSONNode___ctor__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_ZenFulcrum_EmbeddedBrowser_JSONNode_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0473B758, List_1_ZenFulcrum_EmbeddedBrowser_JSONNode__get_Count__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0475F0D8, List_1_ZenFulcrum_EmbeddedBrowser_JSONNode__get_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025F1690, void, RemoveAt, (app::List_1_ZenFulcrum_EmbeddedBrowser_JSONNode_ * this_ptr, int32_t index))
    IL2CPP_REGISTER_METHODINFO(0x0477D200, List_1_ZenFulcrum_EmbeddedBrowser_JSONNode__RemoveAt__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02F1E150, void, Add, (app::List_1_ZenFulcrum_EmbeddedBrowser_JSONNode_ * this_ptr, app::JSONNode * item))
    IL2CPP_REGISTER_METHODINFO(0x04718B38, List_1_ZenFulcrum_EmbeddedBrowser_JSONNode__Add__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0472E020, List_1_ZenFulcrum_EmbeddedBrowser_JSONNode__set_Item__MethodInfo)
}

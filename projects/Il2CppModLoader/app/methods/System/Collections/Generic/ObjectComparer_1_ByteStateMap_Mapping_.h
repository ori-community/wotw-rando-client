...
namespace app::methods::System::Collections::Generic::ObjectComparer_1_ByteStateMap_Mapping_ {
    IL2CPP_REGISTER_METHOD(0x02C29650, int32_t, Compare, (app::ObjectComparer_1_ByteStateMap_Mapping_ * this_ptr, app::ByteStateMap_Mapping x, app::ByteStateMap_Mapping y))

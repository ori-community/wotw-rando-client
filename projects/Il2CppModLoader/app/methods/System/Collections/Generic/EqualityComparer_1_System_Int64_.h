...
namespace app::methods::System::Collections::Generic::EqualityComparer_1_System_Int64_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02E61BD0, int32_t, IndexOf, (app::EqualityComparer_1_System_Int64_ * this_ptr, app::Int64__Array * array, int64_t value, int32_t start_index, int32_t count))
    IL2CPP_REGISTER_METHOD(0x02E61C80, int32_t, LastIndexOf, (app::EqualityComparer_1_System_Int64_ * this_ptr, app::Int64__Array * array, int64_t value, int32_t start_index, int32_t count))

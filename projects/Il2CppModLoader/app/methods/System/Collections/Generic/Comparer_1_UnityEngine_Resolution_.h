...
namespace app::methods::System::Collections::Generic::Comparer_1_UnityEngine_Resolution_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04793948, Comparer_1_UnityEngine_Resolution__Create__MethodInfo)

...
namespace app::methods::System::Collections::Generic::Comparer_1_DistortionAnimator_RendererData_ {
    IL2CPP_REGISTER_METHOD(0x02807CD0, app::Comparer_1_DistortionAnimator_RendererData_ *, get_Default, ())
    IL2CPP_REGISTER_METHOD(0x02C99030, app::Comparer_1_DistortionAnimator_RendererData_ *, Create, (app::Comparison_1_DistortionAnimator_RendererData_ * comparison))
    IL2CPP_REGISTER_METHODINFO(0x0475F0C8, Comparer_1_DistortionAnimator_RendererData__Create__MethodInfo)

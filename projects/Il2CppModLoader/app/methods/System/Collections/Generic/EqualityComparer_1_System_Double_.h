...
namespace app::methods::System::Collections::Generic::EqualityComparer_1_System_Double_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02DA5830, int32_t, IndexOf, (app::EqualityComparer_1_System_Double_ * this_ptr, app::Double__Array * array, double value, int32_t start_index, int32_t count))
    IL2CPP_REGISTER_METHOD(0x02DA58E0, int32_t, LastIndexOf, (app::EqualityComparer_1_System_Double_ * this_ptr, app::Double__Array * array, double value, int32_t start_index, int32_t count))

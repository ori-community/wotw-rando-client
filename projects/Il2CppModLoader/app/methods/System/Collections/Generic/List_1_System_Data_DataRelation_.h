...
namespace app::methods::System::Collections::Generic::List_1_System_Data_DataRelation_ {
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor, (app::List_1_System_Data_DataRelation_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04797420, List_1_System_Data_DataRelation___ctor__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02F1E150, void, Add, (app::List_1_System_Data_DataRelation_ * this_ptr, app::DataRelation * item))
    IL2CPP_REGISTER_METHODINFO(0x04733078, List_1_System_Data_DataRelation__Add__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_System_Data_DataRelation_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0477F790, List_1_System_Data_DataRelation__get_Count__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025EAEF0, app::DataRelation__Array *, ToArray, (app::List_1_System_Data_DataRelation_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04711948, List_1_System_Data_DataRelation__ToArray__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04746468, List_1_System_Data_DataRelation__GetEnumerator__MethodInfo)
}

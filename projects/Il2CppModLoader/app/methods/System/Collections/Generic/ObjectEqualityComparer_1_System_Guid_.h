...
namespace app::methods::System::Collections::Generic::ObjectEqualityComparer_1_System_Guid_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02435110, int32_t, IndexOf, (app::ObjectEqualityComparer_1_System_Guid_ * this_ptr, app::Guid__Array * array, app::Guid value, int32_t start_index, int32_t count))
    IL2CPP_REGISTER_METHOD(0x02435200, int32_t, LastIndexOf, (app::ObjectEqualityComparer_1_System_Guid_ * this_ptr, app::Guid__Array * array, app::Guid value, int32_t start_index, int32_t count))

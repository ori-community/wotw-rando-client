...
namespace app::methods::System::Collections::Generic::EqualityComparer_1_WaterPoisonCloud_Blob_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02B49B00, int32_t, IndexOf, (app::EqualityComparer_1_WaterPoisonCloud_Blob_ * this_ptr, app::WaterPoisonCloud_Blob__Array * array, app::WaterPoisonCloud_Blob value, int32_t start_index, int32_t count))
    IL2CPP_REGISTER_METHOD(0x02B49BF0, int32_t, LastIndexOf, (app::EqualityComparer_1_WaterPoisonCloud_Blob_ * this_ptr, app::WaterPoisonCloud_Blob__Array * array, app::WaterPoisonCloud_Blob value, int32_t start_index, int32_t count))

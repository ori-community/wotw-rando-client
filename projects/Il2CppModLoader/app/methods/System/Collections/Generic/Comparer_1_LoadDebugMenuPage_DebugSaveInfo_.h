...
namespace app::methods::System::Collections::Generic::Comparer_1_LoadDebugMenuPage_DebugSaveInfo_ {
    IL2CPP_REGISTER_METHOD(0x0280A220, app::Comparer_1_LoadDebugMenuPage_DebugSaveInfo_ *, Create, (app::Comparison_1_LoadDebugMenuPage_DebugSaveInfo_ * comparison))
    IL2CPP_REGISTER_METHODINFO(0x047646B8, Comparer_1_LoadDebugMenuPage_DebugSaveInfo__Create__MethodInfo)

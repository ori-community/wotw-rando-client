...
namespace app::methods::System::Collections::Generic::Dictionary_2_System_String_Microsoft_Applications_Events_DataModels_Value_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0473C668, Dictionary_2_System_String_Microsoft_Applications_Events_DataModels_Value___ctor__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0471A6A8, Dictionary_2_System_String_Microsoft_Applications_Events_DataModels_Value__GetEnumerator__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0475CF50, Dictionary_2_System_String_Microsoft_Applications_Events_DataModels_Value__Clear__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04769B20, Dictionary_2_System_String_Microsoft_Applications_Events_DataModels_Value__get_Count__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x047262E8, Dictionary_2_System_String_Microsoft_Applications_Events_DataModels_Value__set_Item__MethodInfo)
}

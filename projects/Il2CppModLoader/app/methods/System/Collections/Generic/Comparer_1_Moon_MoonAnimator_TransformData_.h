...
namespace app::methods::System::Collections::Generic::Comparer_1_Moon_MoonAnimator_TransformData_ {
    IL2CPP_REGISTER_METHOD(0x02807CD0, app::Comparer_1_Moon_MoonAnimator_TransformData_ *, get_Default, ())
    IL2CPP_REGISTER_METHOD(0x0280FFA0, app::Comparer_1_Moon_MoonAnimator_TransformData_ *, Create, (app::Comparison_1_Moon_MoonAnimator_TransformData_ * comparison))
    IL2CPP_REGISTER_METHODINFO(0x04776930, Comparer_1_Moon_MoonAnimator_TransformData__Create__MethodInfo)

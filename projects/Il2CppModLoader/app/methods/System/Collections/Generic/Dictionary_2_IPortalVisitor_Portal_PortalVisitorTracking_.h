...
namespace app::classes::System::Collections::Generic::Dictionary_2_IPortalVisitor_Portal_PortalVisitorTracking_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0476F658, Dictionary_2_IPortalVisitor_Portal_PortalVisitorTracking__ContainsKey__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04737C70, Dictionary_2_IPortalVisitor_Portal_PortalVisitorTracking__get_Item__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04714850, Dictionary_2_IPortalVisitor_Portal_PortalVisitorTracking__Add__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04786720, Dictionary_2_IPortalVisitor_Portal_PortalVisitorTracking__Remove__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0475FCF8, Dictionary_2_IPortalVisitor_Portal_PortalVisitorTracking___ctor__MethodInfo)
} // namespace app::classes::System::Collections::Generic::Dictionary_2_IPortalVisitor_Portal_PortalVisitorTracking_

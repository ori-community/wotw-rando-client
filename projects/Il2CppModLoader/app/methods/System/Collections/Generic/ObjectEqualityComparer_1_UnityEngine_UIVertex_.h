...
namespace app::methods::System::Collections::Generic::ObjectEqualityComparer_1_UnityEngine_UIVertex_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02439BA0, int32_t, IndexOf, (app::ObjectEqualityComparer_1_UnityEngine_UIVertex_ * this_ptr, app::UIVertex__Array * array, app::UIVertex value, int32_t start_index, int32_t count))
    IL2CPP_REGISTER_METHOD(0x02439D70, int32_t, LastIndexOf, (app::ObjectEqualityComparer_1_UnityEngine_UIVertex_ * this_ptr, app::UIVertex__Array * array, app::UIVertex value, int32_t start_index, int32_t count))

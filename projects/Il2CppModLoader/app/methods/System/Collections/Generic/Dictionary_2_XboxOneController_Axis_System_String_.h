...
namespace app::methods::System::Collections::Generic::Dictionary_2_XboxOneController_Axis_System_String_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04758F48, Dictionary_2_XboxOneController_Axis_System_String__ContainsKey__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04761508, Dictionary_2_XboxOneController_Axis_System_String__get_Item__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x047834E0, Dictionary_2_XboxOneController_Axis_System_String__set_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x0283AC20, void, ctor, (app::Dictionary_2_XboxOneController_Axis_System_String_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0478D5C0, Dictionary_2_XboxOneController_Axis_System_String___ctor__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04710E18, Dictionary_2_XboxOneController_Axis_System_String__Add__MethodInfo)
}

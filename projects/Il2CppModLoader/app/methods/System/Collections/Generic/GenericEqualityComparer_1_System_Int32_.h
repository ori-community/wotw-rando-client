...
namespace app::methods::System::Collections::Generic::GenericEqualityComparer_1_System_Int32_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02AB13C0, int32_t, IndexOf, (app::GenericEqualityComparer_1_System_Int32_ * this_ptr, app::Int32__Array * array, int32_t value, int32_t start_index, int32_t count))
    IL2CPP_REGISTER_METHOD(0x02AB1420, int32_t, LastIndexOf, (app::GenericEqualityComparer_1_System_Int32_ * this_ptr, app::Int32__Array * array, int32_t value, int32_t start_index, int32_t count))

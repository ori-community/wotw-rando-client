...
namespace app::methods::System::Collections::Generic::Dictionary_2_SpiderBossBaseBehaviour_SpiderBossEntity_ExecuteAttackInfo_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04733D10, Dictionary_2_SpiderBossBaseBehaviour_SpiderBossEntity_ExecuteAttackInfo__Clear__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0474A080, Dictionary_2_SpiderBossBaseBehaviour_SpiderBossEntity_ExecuteAttackInfo__GetEnumerator__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0473AB70, Dictionary_2_SpiderBossBaseBehaviour_SpiderBossEntity_ExecuteAttackInfo__TryGetValue__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0473C728, Dictionary_2_SpiderBossBaseBehaviour_SpiderBossEntity_ExecuteAttackInfo___ctor__MethodInfo)
}

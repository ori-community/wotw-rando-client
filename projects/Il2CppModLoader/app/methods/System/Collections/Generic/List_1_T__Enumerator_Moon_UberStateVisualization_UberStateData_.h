...
namespace app::methods::System::Collections::Generic::List_1_T__Enumerator_Moon_UberStateVisualization_UberStateData_ {
    IL2CPP_REGISTER_METHOD(0x0014DD20, void, ctor, (app::List_1_T_Enumerator_Moon_UberStateVisualization_UberStateData___Boxed * this_ptr, app::List_1_Moon_UberStateVisualization_UberStateData_ * list))
    ...
    IL2CPP_REGISTER_METHOD(0x0014DEE0, app::Object *, IEnumerator_get_Current, (app::List_1_T_Enumerator_Moon_UberStateVisualization_UberStateData___Boxed * this_ptr))

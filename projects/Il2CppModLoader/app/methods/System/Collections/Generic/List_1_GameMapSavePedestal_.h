...
namespace app::methods::System::Collections::Generic::List_1_GameMapSavePedestal_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04775310, List_1_GameMapSavePedestal__GetEnumerator__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0474D0A0, List_1_GameMapSavePedestal__get_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_GameMapSavePedestal_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04730F28, List_1_GameMapSavePedestal__get_Count__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04738D18, List_1_GameMapSavePedestal__FindIndex__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor, (app::List_1_GameMapSavePedestal_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0472F940, List_1_GameMapSavePedestal___ctor__MethodInfo)
}

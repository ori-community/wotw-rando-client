...
namespace app::methods::System::Collections::Generic::HashSet_1_T__Enumerator_System_Object_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04711F10, HashSet_1_T_Enumerator_System_Object__System_Collections_IEnumerator_get_Current__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04703060, HashSet_1_T_Enumerator_System_Object__MoveNext__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00220890, void, IEnumerator_Reset, (app::HashSet_1_T_Enumerator_System_Object___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04732600, HashSet_1_T_Enumerator_System_Object__System_Collections_IEnumerator_Reset__MethodInfo)
}

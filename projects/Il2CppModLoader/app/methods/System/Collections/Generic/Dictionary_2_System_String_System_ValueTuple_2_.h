...
namespace app::methods::System::Collections::Generic::Dictionary_2_System_String_System_ValueTuple_2_ {
    IL2CPP_REGISTER_METHOD(0x0283AC20, void, ctor, (app::Dictionary_2_System_String_System_ValueTuple_2_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04719740, Dictionary_2_System_String_System_ValueTuple_2___ctor__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04767348, Dictionary_2_System_String_System_ValueTuple_2__TryGetValue__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04771368, Dictionary_2_System_String_System_ValueTuple_2__set_Item__MethodInfo)
}

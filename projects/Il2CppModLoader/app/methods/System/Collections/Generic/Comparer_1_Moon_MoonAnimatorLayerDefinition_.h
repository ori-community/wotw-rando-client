...
namespace app::methods::System::Collections::Generic::Comparer_1_Moon_MoonAnimatorLayerDefinition_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04785E78, Comparer_1_Moon_MoonAnimatorLayerDefinition__Create__MethodInfo)

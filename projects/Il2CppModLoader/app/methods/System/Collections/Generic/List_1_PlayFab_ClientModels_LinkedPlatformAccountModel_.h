...
namespace app::methods::System::Collections::Generic::List_1_PlayFab_ClientModels_LinkedPlatformAccountModel_ {
    IL2CPP_REGISTER_METHOD(0x025F0B10, app::List_1_T_Enumerator_PlayFab_ClientModels_LinkedPlatformAccountModel_, GetEnumerator, (app::List_1_PlayFab_ClientModels_LinkedPlatformAccountModel_ * this_ptr))

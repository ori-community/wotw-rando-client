...
namespace app::methods::System::Collections::Generic::Dictionary_2_AbilityType_SeinLogicCycle_StateFlags_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x047771C8, Dictionary_2_AbilityType_SeinLogicCycle_StateFlags__TryGetValue__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x0283AC20, void, ctor, (app::Dictionary_2_AbilityType_SeinLogicCycle_StateFlags_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04748E98, Dictionary_2_AbilityType_SeinLogicCycle_StateFlags___ctor__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0474D008, Dictionary_2_AbilityType_SeinLogicCycle_StateFlags__Add__MethodInfo)
}

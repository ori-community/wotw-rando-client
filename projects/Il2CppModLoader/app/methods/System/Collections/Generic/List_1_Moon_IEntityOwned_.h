...
namespace app::methods::System::Collections::Generic::List_1_Moon_IEntityOwned_ {
    IL2CPP_REGISTER_METHOD(0x025EFC50, app::IEntityOwned *, get_Item, (app::List_1_Moon_IEntityOwned_ * this_ptr, int32_t index))
    IL2CPP_REGISTER_METHODINFO(0x047671A0, List_1_Moon_IEntityOwned__get_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_Moon_IEntityOwned_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04713E30, List_1_Moon_IEntityOwned__get_Count__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04786C70, List_1_Moon_IEntityOwned__Sort__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor, (app::List_1_Moon_IEntityOwned_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04756B68, List_1_Moon_IEntityOwned___ctor__MethodInfo)
}

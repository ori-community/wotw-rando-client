...
namespace app::methods::System::Collections::Generic::List_1_SetupStateModifierData_ {
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor, (app::List_1_SetupStateModifierData_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04730E20, List_1_SetupStateModifierData___ctor__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02F1E150, void, Add, (app::List_1_SetupStateModifierData_ * this_ptr, app::SetupStateModifierData * item))
    IL2CPP_REGISTER_METHODINFO(0x04701068, List_1_SetupStateModifierData__Add__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04786608, List_1_SetupStateModifierData__get_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_SetupStateModifierData_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047359C8, List_1_SetupStateModifierData__get_Count__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025F1690, void, RemoveAt, (app::List_1_SetupStateModifierData_ * this_ptr, int32_t index))
    IL2CPP_REGISTER_METHODINFO(0x047943F8, List_1_SetupStateModifierData__RemoveAt__MethodInfo)
}

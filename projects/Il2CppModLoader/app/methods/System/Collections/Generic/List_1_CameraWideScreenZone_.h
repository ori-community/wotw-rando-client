...
namespace app::methods::System::Collections::Generic::List_1_CameraWideScreenZone_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04713090, List_1_CameraWideScreenZone__get_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_CameraWideScreenZone_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04731BA8, List_1_CameraWideScreenZone__get_Count__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x022A4010, void, Clear, (app::List_1_CameraWideScreenZone_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04772648, List_1_CameraWideScreenZone__Clear__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02F1E150, void, Add, (app::List_1_CameraWideScreenZone_ * this_ptr, app::CameraWideScreenZone * item))
    IL2CPP_REGISTER_METHODINFO(0x0477E200, List_1_CameraWideScreenZone__Add__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025F12F0, bool, Remove, (app::List_1_CameraWideScreenZone_ * this_ptr, app::CameraWideScreenZone * item))
    IL2CPP_REGISTER_METHODINFO(0x0476D7C0, List_1_CameraWideScreenZone__Remove__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor, (app::List_1_CameraWideScreenZone_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04764D78, List_1_CameraWideScreenZone___ctor__MethodInfo)
}

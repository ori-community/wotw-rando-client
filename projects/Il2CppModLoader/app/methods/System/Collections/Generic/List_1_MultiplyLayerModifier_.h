...
namespace app::methods::System::Collections::Generic::List_1_MultiplyLayerModifier_ {
    IL2CPP_REGISTER_METHOD(0x022A4010, void, Clear, (app::List_1_MultiplyLayerModifier_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047246C8, List_1_MultiplyLayerModifier__Clear__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_MultiplyLayerModifier_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0474B680, List_1_MultiplyLayerModifier__get_Count__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04747878, List_1_MultiplyLayerModifier__get_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02F1E150, void, Add, (app::List_1_MultiplyLayerModifier_ * this_ptr, app::MultiplyLayerModifier * item))
    IL2CPP_REGISTER_METHODINFO(0x04762C50, List_1_MultiplyLayerModifier__Add__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025F12F0, bool, Remove, (app::List_1_MultiplyLayerModifier_ * this_ptr, app::MultiplyLayerModifier * item))
    IL2CPP_REGISTER_METHODINFO(0x047947D0, List_1_MultiplyLayerModifier__Remove__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor, (app::List_1_MultiplyLayerModifier_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04771D20, List_1_MultiplyLayerModifier___ctor__MethodInfo)
}

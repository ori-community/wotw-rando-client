...
namespace app::methods::System::Collections::Generic::Comparer_1_System_ByteEnum_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04708348, Comparer_1_System_ByteEnum__Create__MethodInfo)

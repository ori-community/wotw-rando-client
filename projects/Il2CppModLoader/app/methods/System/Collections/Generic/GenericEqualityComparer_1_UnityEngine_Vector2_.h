...
namespace app::methods::System::Collections::Generic::GenericEqualityComparer_1_UnityEngine_Vector2_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02AB3020, int32_t, IndexOf, (app::GenericEqualityComparer_1_UnityEngine_Vector2_ * this_ptr, app::Vector2__Array * array, app::Vector2 value, int32_t start_index, int32_t count))
    IL2CPP_REGISTER_METHOD(0x02AB30A0, int32_t, LastIndexOf, (app::GenericEqualityComparer_1_UnityEngine_Vector2_ * this_ptr, app::Vector2__Array * array, app::Vector2 value, int32_t start_index, int32_t count))

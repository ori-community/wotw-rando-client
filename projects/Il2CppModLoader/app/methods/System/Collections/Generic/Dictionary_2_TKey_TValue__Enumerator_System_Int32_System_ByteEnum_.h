...
namespace app::methods::System::Collections::Generic::Dictionary_2_TKey_TValue__Enumerator_System_Int32_System_ByteEnum_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0472FDF0, Dictionary_2_TKey_TValue_Enumerator_System_Int32_System_ByteEnum__MoveNext__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0476BBB8, Dictionary_2_TKey_TValue_Enumerator_System_Int32_System_ByteEnum__System_Collections_IEnumerator_get_Current__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04709670, Dictionary_2_TKey_TValue_Enumerator_System_Int32_System_ByteEnum__System_Collections_IEnumerator_Reset__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04749878, Dictionary_2_TKey_TValue_Enumerator_System_Int32_System_ByteEnum__System_Collections_IDictionaryEnumerator_get_Entry__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0471C850, Dictionary_2_TKey_TValue_Enumerator_System_Int32_System_ByteEnum__System_Collections_IDictionaryEnumerator_get_Key__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04770728, Dictionary_2_TKey_TValue_Enumerator_System_Int32_System_ByteEnum__System_Collections_IDictionaryEnumerator_get_Value__MethodInfo)
}

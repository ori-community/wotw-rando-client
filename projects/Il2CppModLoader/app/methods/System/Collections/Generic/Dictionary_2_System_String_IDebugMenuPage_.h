...
namespace app::methods::System::Collections::Generic::Dictionary_2_System_String_IDebugMenuPage_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04715E38, Dictionary_2_System_String_IDebugMenuPage__get_Item__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04715CC0, Dictionary_2_System_String_IDebugMenuPage__ContainsKey__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0473E520, Dictionary_2_System_String_IDebugMenuPage__Add__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x0283AC20, void, ctor, (app::Dictionary_2_System_String_IDebugMenuPage_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0474D290, Dictionary_2_System_String_IDebugMenuPage___ctor__MethodInfo)
}

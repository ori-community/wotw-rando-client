...
namespace app::methods::System::Collections::Generic::ObjectEqualityComparer_1_System_UInt16_ {
    ...
    IL2CPP_REGISTER_METHOD(0x024369D0, int32_t, IndexOf, (app::ObjectEqualityComparer_1_System_UInt16_ * this_ptr, app::UInt16__Array * array, uint16_t value, int32_t start_index, int32_t count))
    IL2CPP_REGISTER_METHOD(0x02436AB0, int32_t, LastIndexOf, (app::ObjectEqualityComparer_1_System_UInt16_ * this_ptr, app::UInt16__Array * array, uint16_t value, int32_t start_index, int32_t count))

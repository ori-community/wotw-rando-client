...
namespace app::methods::System::Collections::Generic::Comparer_1_System_Object_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04737F58, Comparer_1_System_Object__Create__MethodInfo)

...
namespace app::methods::System::Collections::Generic::List_1_T__Enumerator_StateValidator_ {
    IL2CPP_REGISTER_METHOD(0x00133A80, app::StateValidator, get_Current, (app::List_1_T_Enumerator_StateValidator___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0477B4A8, List_1_T_Enumerator_StateValidator__get_Current__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x0014D070, bool, MoveNext, (app::List_1_T_Enumerator_StateValidator___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0476A818, List_1_T_Enumerator_StateValidator__MoveNext__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00002890, void, Dispose, (app::List_1_T_Enumerator_StateValidator___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0478DEE0, List_1_T_Enumerator_StateValidator__Dispose__MethodInfo)

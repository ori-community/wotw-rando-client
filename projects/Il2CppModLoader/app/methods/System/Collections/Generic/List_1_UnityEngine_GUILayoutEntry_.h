...
namespace app::methods::System::Collections::Generic::List_1_UnityEngine_GUILayoutEntry_ {
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_UnityEngine_GUILayoutEntry_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047360C0, List_1_UnityEngine_GUILayoutEntry__get_Count__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04701DA0, List_1_UnityEngine_GUILayoutEntry__get_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor, (app::List_1_UnityEngine_GUILayoutEntry_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0478AC00, List_1_UnityEngine_GUILayoutEntry___ctor__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02F1E150, void, Add, (app::List_1_UnityEngine_GUILayoutEntry_ * this_ptr, app::GUILayoutEntry * item))
    IL2CPP_REGISTER_METHODINFO(0x04752B30, List_1_UnityEngine_GUILayoutEntry__Add__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0472F320, List_1_UnityEngine_GUILayoutEntry__GetEnumerator__MethodInfo)
}

...
namespace app::methods::System::Collections::Generic::ArraySortHelper_1_Moon_CameraTargetSettings_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02C86EC0, void, IntrospectiveSort, (app::CameraTargetSettings__Array * keys, int32_t left, int32_t length, app::Comparison_1_Moon_CameraTargetSettings_ * comparer))
    IL2CPP_REGISTER_METHOD(0x02C86FB0, void, IntroSort, (app::CameraTargetSettings__Array * keys, int32_t lo, int32_t hi, int32_t depth_limit, app::Comparison_1_Moon_CameraTargetSettings_ * comparer))
    IL2CPP_REGISTER_METHOD(0x02C8AF80, int32_t, PickPivotAndPartition, (app::CameraTargetSettings__Array * keys, int32_t lo, int32_t hi, app::Comparison_1_Moon_CameraTargetSettings_ * comparer))
    IL2CPP_REGISTER_METHOD(0x02C87750, void, Heapsort, (app::CameraTargetSettings__Array * keys, int32_t lo, int32_t hi, app::Comparison_1_Moon_CameraTargetSettings_ * comparer))
    IL2CPP_REGISTER_METHOD(0x02C8B3D0, void, DownHeap, (app::CameraTargetSettings__Array * keys, int32_t i, int32_t n, int32_t lo, app::Comparison_1_Moon_CameraTargetSettings_ * comparer))
    IL2CPP_REGISTER_METHOD(0x02C8B740, void, InsertionSort, (app::CameraTargetSettings__Array * keys, int32_t lo, int32_t hi, app::Comparison_1_Moon_CameraTargetSettings_ * comparer))
}

...
namespace app::methods::System::Collections::Generic::List_1_T__Enumerator_EntityReactions_ReactionInterruptionSuspensionEntry_ {
    ...
    IL2CPP_REGISTER_METHOD(0x00136440, app::EntityReactions_ReactionInterruptionSuspensionEntry, get_Current, (app::List_1_T_Enumerator_EntityReactions_ReactionInterruptionSuspensionEntry___Boxed * this_ptr))
    IL2CPP_REGISTER_METHOD(0x0014CB40, app::Object *, IEnumerator_get_Current, (app::List_1_T_Enumerator_EntityReactions_ReactionInterruptionSuspensionEntry___Boxed * this_ptr))

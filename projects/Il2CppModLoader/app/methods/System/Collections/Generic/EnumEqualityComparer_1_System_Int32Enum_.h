...
namespace app::classes::System::Collections::Generic::EnumEqualityComparer_1_System_Int32Enum_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02CBD1C0, void, ctor_2, (app::EnumEqualityComparer_1_System_Int32Enum_ * this_ptr, app::SerializationInfo* information, app::StreamingContext context))
    IL2CPP_REGISTER_METHOD(0x02CBD410, void, GetObjectData, (app::EnumEqualityComparer_1_System_Int32Enum_ * this_ptr, app::SerializationInfo* info, app::StreamingContext context))

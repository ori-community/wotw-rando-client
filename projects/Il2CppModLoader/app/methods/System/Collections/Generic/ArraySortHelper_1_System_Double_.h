...
namespace app::methods::System::Collections::Generic::ArraySortHelper_1_System_Double_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02C86FB0, void, IntroSort, (app::Double__Array * keys, int32_t lo, int32_t hi, int32_t depth_limit, app::Comparison_1_Double_ * comparer))

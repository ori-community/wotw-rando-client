...
namespace app::methods::System::Collections::Generic::List_1_MicroProfilerInspector_MetricPreset_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04755040, List_1_MicroProfilerInspector_MetricPreset__Add__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0477A9B0, List_1_MicroProfilerInspector_MetricPreset__get_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_MicroProfilerInspector_MetricPreset_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047152D0, List_1_MicroProfilerInspector_MetricPreset__get_Count__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor, (app::List_1_MicroProfilerInspector_MetricPreset_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04763E58, List_1_MicroProfilerInspector_MetricPreset___ctor__MethodInfo)
}

...
namespace app::methods::System::Collections::Generic::Dictionary_2_System_Int32_RootMotionProcessor_ {
    IL2CPP_REGISTER_METHOD(0x0283B900, void, Clear, (app::Dictionary_2_System_Int32_RootMotionProcessor_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04763188, Dictionary_2_System_Int32_RootMotionProcessor__Clear__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04773718, Dictionary_2_System_Int32_RootMotionProcessor__TryGetValue__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04762558, Dictionary_2_System_Int32_RootMotionProcessor__Add__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02BBA360, bool, Remove, (app::Dictionary_2_System_Int32_RootMotionProcessor_ * this_ptr, int32_t key))
    IL2CPP_REGISTER_METHODINFO(0x0474C750, Dictionary_2_System_Int32_RootMotionProcessor__Remove__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04781F38, Dictionary_2_System_Int32_RootMotionProcessor__GetEnumerator__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x0283AC20, void, ctor, (app::Dictionary_2_System_Int32_RootMotionProcessor_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0475B498, Dictionary_2_System_Int32_RootMotionProcessor___ctor__MethodInfo)
}

...
namespace app::methods::System::Collections::Generic::HashSet_1_T__Enumerator_System_Int32_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04791668, HashSet_1_T_Enumerator_System_Int32__MoveNext__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04756DC0, HashSet_1_T_Enumerator_System_Int32__System_Collections_IEnumerator_get_Current__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00220250, void, IEnumerator_Reset, (app::HashSet_1_T_Enumerator_System_Int32___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0471C638, HashSet_1_T_Enumerator_System_Int32__System_Collections_IEnumerator_Reset__MethodInfo)
}

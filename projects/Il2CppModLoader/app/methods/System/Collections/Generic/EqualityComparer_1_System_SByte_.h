...
namespace app::methods::System::Collections::Generic::EqualityComparer_1_System_SByte_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02D9B130, int32_t, IndexOf, (app::EqualityComparer_1_System_SByte_ * this_ptr, app::SByte__Array * array, int8_t value, int32_t start_index, int32_t count))
    IL2CPP_REGISTER_METHOD(0x02D9B1E0, int32_t, LastIndexOf, (app::EqualityComparer_1_System_SByte_ * this_ptr, app::SByte__Array * array, int8_t value, int32_t start_index, int32_t count))

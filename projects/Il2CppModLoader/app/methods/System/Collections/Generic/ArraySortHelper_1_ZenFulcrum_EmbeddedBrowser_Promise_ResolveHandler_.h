...
namespace app::methods::System::Collections::Generic::ArraySortHelper_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02C86EC0, void, IntrospectiveSort, (app::Promise_ResolveHandler__Array * keys, int32_t left, int32_t length, app::Comparison_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_ * comparer))
    IL2CPP_REGISTER_METHOD(0x02C86FB0, void, IntroSort, (app::Promise_ResolveHandler__Array * keys, int32_t lo, int32_t hi, int32_t depth_limit, app::Comparison_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_ * comparer))
    IL2CPP_REGISTER_METHOD(0x02C89C60, int32_t, PickPivotAndPartition, (app::Promise_ResolveHandler__Array * keys, int32_t lo, int32_t hi, app::Comparison_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_ * comparer))
    IL2CPP_REGISTER_METHOD(0x02C87750, void, Heapsort, (app::Promise_ResolveHandler__Array * keys, int32_t lo, int32_t hi, app::Comparison_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_ * comparer))
    IL2CPP_REGISTER_METHOD(0x02C8A050, void, DownHeap, (app::Promise_ResolveHandler__Array * keys, int32_t i, int32_t n, int32_t lo, app::Comparison_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_ * comparer))
    IL2CPP_REGISTER_METHOD(0x02C8A330, void, InsertionSort, (app::Promise_ResolveHandler__Array * keys, int32_t lo, int32_t hi, app::Comparison_1_ZenFulcrum_EmbeddedBrowser_Promise_ResolveHandler_ * comparer))
}

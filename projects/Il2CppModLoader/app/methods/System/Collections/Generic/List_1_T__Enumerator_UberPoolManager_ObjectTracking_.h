...
namespace app::methods::System::Collections::Generic::List_1_T__Enumerator_UberPoolManager_ObjectTracking_ {
    IL2CPP_REGISTER_METHOD(0x0014CA00, void, ctor, (app::List_1_T_Enumerator_UberPoolManager_ObjectTracking___Boxed * this_ptr, app::List_1_UberPoolManager_ObjectTracking_ * list))
    ...
    IL2CPP_REGISTER_METHOD(0x00136440, app::UberPoolManager_ObjectTracking, get_Current, (app::List_1_T_Enumerator_UberPoolManager_ObjectTracking___Boxed * this_ptr))

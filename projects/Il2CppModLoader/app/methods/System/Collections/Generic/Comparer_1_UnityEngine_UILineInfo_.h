...
namespace app::methods::System::Collections::Generic::Comparer_1_UnityEngine_UILineInfo_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04739CD8, Comparer_1_UnityEngine_UILineInfo__Create__MethodInfo)

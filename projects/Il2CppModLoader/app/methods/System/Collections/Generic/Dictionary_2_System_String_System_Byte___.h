...
namespace app::methods::System::Collections::Generic::Dictionary_2_System_String_System_Byte___ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04768510, Dictionary_2_System_String_System_Byte__TryGetValue__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04747658, Dictionary_2_System_String_System_Byte__set_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x0283B900, void, Clear, (app::Dictionary_2_System_String_System_Byte_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0470CF28, Dictionary_2_System_String_System_Byte__Clear__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02BA5090, bool, ContainsKey, (app::Dictionary_2_System_String_System_Byte_ * this_ptr, app::String * key))
    IL2CPP_REGISTER_METHODINFO(0x04774EA0, Dictionary_2_System_String_System_Byte__ContainsKey__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02BD3EC0, bool, Remove, (app::Dictionary_2_System_String_System_Byte_ * this_ptr, app::String * key))
    IL2CPP_REGISTER_METHODINFO(0x04714810, Dictionary_2_System_String_System_Byte__Remove__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x0283AC20, void, ctor, (app::Dictionary_2_System_String_System_Byte_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0478AE18, Dictionary_2_System_String_System_Byte___ctor__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x0283B2A0, int32_t, get_Count, (app::Dictionary_2_System_String_System_Byte_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04758E90, Dictionary_2_System_String_System_Byte__get_Count__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0475BCB0, Dictionary_2_System_String_System_Byte__GetEnumerator__MethodInfo)
}

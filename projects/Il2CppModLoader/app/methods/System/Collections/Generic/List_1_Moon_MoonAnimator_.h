...
namespace app::methods::System::Collections::Generic::List_1_Moon_MoonAnimator_ {
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_Moon_MoonAnimator_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0471A0C8, List_1_Moon_MoonAnimator__get_Count__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor, (app::List_1_Moon_MoonAnimator_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04728908, List_1_Moon_MoonAnimator___ctor__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0472C558, List_1_Moon_MoonAnimator__BinarySearch__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02F1EA40, void, Insert, (app::List_1_Moon_MoonAnimator_ * this_ptr, int32_t index, app::MoonAnimator * item))
    IL2CPP_REGISTER_METHODINFO(0x04780FB0, List_1_Moon_MoonAnimator__Insert__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0478C6D8, List_1_Moon_MoonAnimator__FindIndex__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025F1690, void, RemoveAt, (app::List_1_Moon_MoonAnimator_ * this_ptr, int32_t index))
    IL2CPP_REGISTER_METHODINFO(0x0473FFF0, List_1_Moon_MoonAnimator__RemoveAt__MethodInfo)
}

...
namespace app::methods::System::Collections::Generic::EqualityComparer_1_SceneOperation_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02B48D60, int32_t, IndexOf, (app::EqualityComparer_1_SceneOperation_ * this_ptr, app::SceneOperation__Array * array, app::SceneOperation value, int32_t start_index, int32_t count))
    IL2CPP_REGISTER_METHOD(0x02B48E30, int32_t, LastIndexOf, (app::EqualityComparer_1_SceneOperation_ * this_ptr, app::SceneOperation__Array * array, app::SceneOperation value, int32_t start_index, int32_t count))

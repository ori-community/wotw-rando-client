...
namespace app::methods::System::Collections::Generic::List_1_UnityEngine_AudioSourceExtension_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04798250, List_1_UnityEngine_AudioSourceExtension__Add__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_UnityEngine_AudioSourceExtension_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0470C3C8, List_1_UnityEngine_AudioSourceExtension__get_Count__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04756938, List_1_UnityEngine_AudioSourceExtension__get_Item__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0478E008, List_1_UnityEngine_AudioSourceExtension__set_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025F1690, void, RemoveAt, (app::List_1_UnityEngine_AudioSourceExtension_ * this_ptr, int32_t index))
    IL2CPP_REGISTER_METHODINFO(0x0476A6F0, List_1_UnityEngine_AudioSourceExtension__RemoveAt__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor, (app::List_1_UnityEngine_AudioSourceExtension_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04790138, List_1_UnityEngine_AudioSourceExtension___ctor__MethodInfo)
}

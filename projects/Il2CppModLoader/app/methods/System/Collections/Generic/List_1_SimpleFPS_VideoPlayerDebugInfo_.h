...
namespace app::methods::System::Collections::Generic::List_1_SimpleFPS_VideoPlayerDebugInfo_ {
    IL2CPP_REGISTER_METHOD(0x022A4010, void, Clear, (app::List_1_SimpleFPS_VideoPlayerDebugInfo_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04765578, List_1_SimpleFPS_VideoPlayerDebugInfo__Clear__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0475CC60, List_1_SimpleFPS_VideoPlayerDebugInfo__get_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025F1690, void, RemoveAt, (app::List_1_SimpleFPS_VideoPlayerDebugInfo_ * this_ptr, int32_t index))
    IL2CPP_REGISTER_METHODINFO(0x04737BC8, List_1_SimpleFPS_VideoPlayerDebugInfo__RemoveAt__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_SimpleFPS_VideoPlayerDebugInfo_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04788B38, List_1_SimpleFPS_VideoPlayerDebugInfo__get_Count__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04724040, List_1_SimpleFPS_VideoPlayerDebugInfo__Add__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor, (app::List_1_SimpleFPS_VideoPlayerDebugInfo_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047090F8, List_1_SimpleFPS_VideoPlayerDebugInfo___ctor__MethodInfo)
}

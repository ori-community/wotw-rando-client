...
namespace app::methods::System::Collections::Generic::List_1_T__Enumerator_Moon_Timeline_Reaction_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x047193A0, List_1_T_Enumerator_Moon_Timeline_Reaction__get_Current__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x0014D530, bool, MoveNext, (app::List_1_T_Enumerator_Moon_Timeline_Reaction___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04701B68, List_1_T_Enumerator_Moon_Timeline_Reaction__MoveNext__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00002890, void, Dispose, (app::List_1_T_Enumerator_Moon_Timeline_Reaction___Boxed * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0477B640, List_1_T_Enumerator_Moon_Timeline_Reaction__Dispose__MethodInfo)

...
namespace app::methods::System::Collections::Generic::ObjectComparer_1_KeyValuePair_2_System_Object_System_Object__ {
    IL2CPP_REGISTER_METHOD(0x01CCA980, int32_t, Compare, (app::ObjectComparer_1_KeyValuePair_2_System_Object_System_Object_ * this_ptr, app::KeyValuePair_2_System_Object_System_Object_ x, app::KeyValuePair_2_System_Object_System_Object_ y))

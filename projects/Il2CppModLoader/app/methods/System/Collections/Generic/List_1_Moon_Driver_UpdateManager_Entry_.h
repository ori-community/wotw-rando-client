...
namespace app::methods::System::Collections::Generic::List_1_Moon_Driver_UpdateManager_Entry_ {
    IL2CPP_REGISTER_METHOD(0x025E81E0, void, ctor_1, (app::List_1_Moon_Driver_UpdateManager_Entry_ * this_ptr, int32_t capacity))
    IL2CPP_REGISTER_METHODINFO(0x0477F310, List_1_Moon_Driver_UpdateManager_Entry___ctor__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor_2, (app::List_1_Moon_Driver_UpdateManager_Entry_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0474FCD0, List_1_Moon_Driver_UpdateManager_Entry___ctor_1__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, (app::List_1_Moon_Driver_UpdateManager_Entry_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04797EB0, List_1_Moon_Driver_UpdateManager_Entry__get_Count__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x022A4010, void, Clear, (app::List_1_Moon_Driver_UpdateManager_Entry_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04710ED8, List_1_Moon_Driver_UpdateManager_Entry__Clear__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04788ED8, List_1_Moon_Driver_UpdateManager_Entry__AddRange__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04753050, List_1_Moon_Driver_UpdateManager_Entry__get_Item__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04754888, List_1_Moon_Driver_UpdateManager_Entry__BinarySearch__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0477A608, List_1_Moon_Driver_UpdateManager_Entry__Insert__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025F1690, void, RemoveAt, (app::List_1_Moon_Driver_UpdateManager_Entry_ * this_ptr, int32_t index))
    IL2CPP_REGISTER_METHODINFO(0x04730208, List_1_Moon_Driver_UpdateManager_Entry__RemoveAt__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04719F30, List_1_Moon_Driver_UpdateManager_Entry__GetEnumerator__MethodInfo)
}

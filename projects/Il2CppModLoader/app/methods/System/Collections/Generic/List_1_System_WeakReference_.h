...
namespace app::methods::System::Collections::Generic::List_1_System_WeakReference_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04781120, List_1_System_WeakReference__GetEnumerator__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x022A4010, void, Clear, (app::List_1_System_WeakReference_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047877A8, List_1_System_WeakReference__Clear__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04753080, List_1_System_WeakReference__AddRange__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025EAF70, void, TrimExcess, (app::List_1_System_WeakReference_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0478CB30, List_1_System_WeakReference__TrimExcess__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor_2, (app::List_1_System_WeakReference_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0474F788, List_1_System_WeakReference___ctor_1__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x025F1690, void, RemoveAt, (app::List_1_System_WeakReference_ * this_ptr, int32_t index))
    IL2CPP_REGISTER_METHODINFO(0x0471B488, List_1_System_WeakReference__RemoveAt__MethodInfo)
}

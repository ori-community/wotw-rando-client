...
namespace app::methods::System::Collections::Concurrent::ConcurrentDictionary_2_System_Guid_System_Tuple_2_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0478DB50, ConcurrentDictionary_2_System_Guid_System_Tuple_2__TryGetValue__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0473A960, ConcurrentDictionary_2_System_Guid_System_Tuple_2__set_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02ADDC30, void, ctor, (app::ConcurrentDictionary_2_System_Guid_System_Tuple_2_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04752ED0, ConcurrentDictionary_2_System_Guid_System_Tuple_2___ctor__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04743A18, ConcurrentDictionary_2_System_Guid_System_Tuple_2__TryRemove__MethodInfo)
}

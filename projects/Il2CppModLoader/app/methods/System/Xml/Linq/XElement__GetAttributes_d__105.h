...
namespace app::methods::System::Xml::Linq::XElement__GetAttributes_d__105 {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0473D198, XElement_GetAttributes_d_105_System_Collections_IEnumerator_Reset__MethodInfo)

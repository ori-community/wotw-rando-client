...
namespace app::methods::System::Xml::Schema::XsdBuilder_XsdBuildFunction {
    ...
    IL2CPP_REGISTER_METHOD(0x01435260, app::IAsyncResult *, BeginInvoke, (app::XsdBuilder_XsdBuildFunction * this_ptr, app::XsdBuilder * builder, app::String * value, app::AsyncCallback * callback, app::Object * object))

...
namespace app::methods::System::Xml::Schema::XdrBuilder_XdrEndChildFunction {
    ...
    IL2CPP_REGISTER_METHOD(0x00674080, app::IAsyncResult *, BeginInvoke, (app::XdrBuilder_XdrEndChildFunction * this_ptr, app::XdrBuilder * builder, app::AsyncCallback * callback, app::Object * object))

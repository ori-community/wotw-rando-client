...
namespace app::methods::System::Array_InternalEnumerator_1_Moon_Profile_MetricOutput_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04745B60, Array_InternalEnumerator_1_Moon_Profile_MetricOutput__get_Current__MethodInfo)

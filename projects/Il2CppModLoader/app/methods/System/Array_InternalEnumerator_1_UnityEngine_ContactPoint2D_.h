...
namespace app::methods::System::Array_InternalEnumerator_1_UnityEngine_ContactPoint2D_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04709FE0, Array_InternalEnumerator_1_UnityEngine_ContactPoint2D__get_Current__MethodInfo)

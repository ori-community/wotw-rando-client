...
namespace app::methods::System::Array_InternalEnumerator_1_Steamworks_SteamItemDef_t_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x047057E8, Array_InternalEnumerator_1_Steamworks_SteamItemDef_t__get_Current__MethodInfo)

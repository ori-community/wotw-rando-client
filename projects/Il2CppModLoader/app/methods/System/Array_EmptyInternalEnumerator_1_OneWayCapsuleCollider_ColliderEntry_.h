...
namespace app::methods::System::Array_EmptyInternalEnumerator_1_OneWayCapsuleCollider_ColliderEntry_ {
    ...
    IL2CPP_REGISTER_METHOD(0x01D079D0, app::OneWayCapsuleCollider_ColliderEntry, get_Current, (app::Array_EmptyInternalEnumerator_1_OneWayCapsuleCollider_ColliderEntry_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04735288, Array_EmptyInternalEnumerator_1_OneWayCapsuleCollider_ColliderEntry__get_Current__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x01CFEE40, app::Object *, IEnumerator_get_Current, (app::Array_EmptyInternalEnumerator_1_OneWayCapsuleCollider_ColliderEntry_ * this_ptr))

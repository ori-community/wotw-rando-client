...
namespace app::methods::System::Array_EmptyInternalEnumerator_1_UberInteractionManager_InteractionInfo_ {
    ...
    IL2CPP_REGISTER_METHOD(0x01D015C0, app::UberInteractionManager_InteractionInfo, get_Current, (app::Array_EmptyInternalEnumerator_1_UberInteractionManager_InteractionInfo_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0477DBA0, Array_EmptyInternalEnumerator_1_UberInteractionManager_InteractionInfo__get_Current__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x01CFEFD0, app::Object *, IEnumerator_get_Current, (app::Array_EmptyInternalEnumerator_1_UberInteractionManager_InteractionInfo_ * this_ptr))

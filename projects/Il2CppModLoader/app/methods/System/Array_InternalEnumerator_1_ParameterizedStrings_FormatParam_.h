...
namespace app::methods::System::Array_InternalEnumerator_1_ParameterizedStrings_FormatParam_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04754708, Array_InternalEnumerator_1_ParameterizedStrings_FormatParam__get_Current__MethodInfo)

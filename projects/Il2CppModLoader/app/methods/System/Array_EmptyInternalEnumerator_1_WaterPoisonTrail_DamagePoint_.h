...
namespace app::methods::System::Array_EmptyInternalEnumerator_1_WaterPoisonTrail_DamagePoint_ {
    ...
    IL2CPP_REGISTER_METHOD(0x01D03590, app::WaterPoisonTrail_DamagePoint, get_Current, (app::Array_EmptyInternalEnumerator_1_WaterPoisonTrail_DamagePoint_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04799900, Array_EmptyInternalEnumerator_1_WaterPoisonTrail_DamagePoint__get_Current__MethodInfo)

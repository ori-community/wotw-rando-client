...
namespace app::methods::System::Array_InternalEnumerator_1_StatSettingStrings_EnemyLabels_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0474FE70, Array_InternalEnumerator_1_StatSettingStrings_EnemyLabels__get_Current__MethodInfo)

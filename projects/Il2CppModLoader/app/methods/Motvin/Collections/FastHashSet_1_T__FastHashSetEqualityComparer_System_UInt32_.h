...
namespace app::classes::Motvin::Collections::FastHashSet_1_T__FastHashSetEqualityComparer_System_UInt32_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02AF8690, int32_t, GetHashCode, (app::FastHashSet_1_T_FastHashSetEqualityComparer_System_UInt32_ * this_ptr, app::FastHashSet_1_System_UInt32_* set))

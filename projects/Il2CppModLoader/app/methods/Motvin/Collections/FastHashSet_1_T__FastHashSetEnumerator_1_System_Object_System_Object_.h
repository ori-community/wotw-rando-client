...
namespace app::methods::Motvin::Collections::FastHashSet_1_T__FastHashSetEnumerator_1_System_Object_System_Object_ {
    ...
    IL2CPP_REGISTER_METHOD(0x0298B8E0, app::Object *, IEnumerator_get_Current, (app::FastHashSet_1_T_FastHashSetEnumerator_1_System_Object_System_Object_ * this_ptr))
    IL2CPP_REGISTER_METHOD(0x02AF7D00, void, ctor, (app::FastHashSet_1_T_FastHashSetEnumerator_1_System_Object_System_Object_ * this_ptr, app::FastHashSet_1_System_Object_ * set))

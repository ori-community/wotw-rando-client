...
namespace app::methods::AllContainer_1_Moon_Timeline_CameraShakeAnimator_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04731708, AllContainer_1_Moon_Timeline_CameraShakeAnimator__get_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x019D77E0, int32_t, get_Count, (app::AllContainer_1_Moon_Timeline_CameraShakeAnimator_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04746620, AllContainer_1_Moon_Timeline_CameraShakeAnimator__get_Count__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x019D79D0, void, Clear, (app::AllContainer_1_Moon_Timeline_CameraShakeAnimator_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0473CC38, AllContainer_1_Moon_Timeline_CameraShakeAnimator__Clear__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0478C708, AllContainer_1_Moon_Timeline_CameraShakeAnimator__Remove__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0477C440, AllContainer_1_Moon_Timeline_CameraShakeAnimator__Contains__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04783078, AllContainer_1_Moon_Timeline_CameraShakeAnimator__Add__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x018E6D70, void, ctor, (app::AllContainer_1_Moon_Timeline_CameraShakeAnimator_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047790E0, AllContainer_1_Moon_Timeline_CameraShakeAnimator___ctor__MethodInfo)
}

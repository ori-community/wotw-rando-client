...
namespace app::classes::UberShader::LightDirectionMapCompressor {
    ...
    IL2CPP_REGISTER_METHOD(0x018F9F10, app::Texture2D*, Process, (app::LightDirectionMapCompressor * this_ptr, app::Texture2D* left_tex, app::Texture2D* right_tex, app::Texture2D* top_tex, app::Texture2D* bottom_tex, app::Texture2D* front_tex, app::Texture2D* rim_tex, float downsampling_factor))

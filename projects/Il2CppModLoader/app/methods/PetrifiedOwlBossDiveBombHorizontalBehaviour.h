...
namespace app::methods::PetrifiedOwlBossDiveBombHorizontalBehaviour {
    ...
    IL2CPP_REGISTER_METHOD(0x0049F2B0, app::PetrifiedOwlBossBaseBehaviour_PetrifiedOwlBossBaseStatesSet *, get_States, (app::PetrifiedOwlBossDiveBombHorizontalBehaviour * this_ptr))
    ...
    IL2CPP_REGISTER_METHOD(0x0049FA60, app::BehaviourStatus__Enum, OnExecute, (app::PetrifiedOwlBossDiveBombHorizontalBehaviour * this_ptr, app::IContext * context))

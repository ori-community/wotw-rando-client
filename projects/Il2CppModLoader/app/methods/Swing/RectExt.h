...
namespace app::classes::Swing::RectExt {
    ...
    IL2CPP_REGISTER_METHOD(0x0182E290, app::RectExt, anchoredInContainer, (app::Rect _container, app::TextAnchor__Enum _anchor, app::Vector2 _size, float _x_margin, float _y_margin))

...
namespace app::methods::GameTimeExtensions__ExecuteAfterAsync_d__1 {
    ...
    IL2CPP_REGISTER_METHODINFO(0x047305C0, GameTimeExtensions_ExecuteAfterAsync_d_1_System_Collections_IEnumerator_Reset__MethodInfo)

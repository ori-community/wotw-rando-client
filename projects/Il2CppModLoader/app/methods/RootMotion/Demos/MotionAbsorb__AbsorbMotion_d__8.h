...
namespace app::methods::RootMotion::Demos::MotionAbsorb__AbsorbMotion_d__8 {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04744960, MotionAbsorb_AbsorbMotion_d_8_System_Collections_IEnumerator_Reset__MethodInfo)

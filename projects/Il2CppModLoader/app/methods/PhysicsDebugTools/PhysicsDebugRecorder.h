...
namespace app::methods::PhysicsDebugTools::PhysicsDebugRecorder {
    ...
    IL2CPP_REGISTER_METHOD(0x014FCCF0, void, RecordEvent, (app::PhysicsDebugRecorder * this_ptr, app::Entity * target, app::CharacterPlatformMovement * movement_compoenent, app::Vector3 target_velocity, app::String * event_description))

...
namespace app::methods::UnityEngine::UI::ListPool_1_UnityEngine_Vector3_ {
    IL2CPP_REGISTER_METHOD(0x02ACE750, app::List_1_UnityEngine_Vector3_ *, Get, ())
    IL2CPP_REGISTER_METHODINFO(0x0473AF48, ListPool_1_UnityEngine_Vector3__Get__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x02ACE8C0, void, Release, (app::List_1_UnityEngine_Vector3_ * to_release))
    IL2CPP_REGISTER_METHODINFO(0x04729828, ListPool_1_UnityEngine_Vector3__Release__MethodInfo)

...
namespace app::methods::UnityEngine::UI::Button__OnFinishSubmit_c__Iterator0 {
    IL2CPP_REGISTER_METHOD(0x002FA000, void, ctor, (app::Button_OnFinishSubmit_c_Iterator0 * this_ptr))
    IL2CPP_REGISTER_METHOD(0x01F2C0C0, bool, MoveNext, (app::Button_OnFinishSubmit_c_Iterator0 * this_ptr))
    IL2CPP_REGISTER_METHOD(0x01704A60, app::Object *, IEnumerator_object__get_Current, (app::Button_OnFinishSubmit_c_Iterator0 * this_ptr))

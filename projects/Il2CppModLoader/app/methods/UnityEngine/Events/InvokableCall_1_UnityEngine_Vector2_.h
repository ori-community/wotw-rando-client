...
namespace app::methods::UnityEngine::Events::InvokableCall_1_UnityEngine_Vector2_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04745808, InvokableCall_1_UnityEngine_Vector2__Invoke__MethodInfo)

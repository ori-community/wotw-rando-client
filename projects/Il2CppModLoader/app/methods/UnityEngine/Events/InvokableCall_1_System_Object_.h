...
namespace app::methods::UnityEngine::Events::InvokableCall_1_System_Object_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04770CA8, InvokableCall_1_System_Object__Invoke__MethodInfo)

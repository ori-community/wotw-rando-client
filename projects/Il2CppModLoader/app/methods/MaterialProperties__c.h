...
namespace app::methods::MaterialProperties___c {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04723D10, MaterialProperties_c__RemovePropertiesThatArntOverwridden_b__5_0__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0474AA10, MaterialProperties_c__RemovePropertiesThatArntOverwridden_b__5_1__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0473F810, MaterialProperties_c__RemovePropertiesThatArntOverwridden_b__5_2__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04768DF0, MaterialProperties_c__RemovePropertiesThatArntOverwridden_b__5_3__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x047876C0, MaterialProperties_c__RemovePropertiesThatArntOverwridden_b__5_4__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04711B70, MaterialProperties_c__RemovePropertiesThatArntOverwridden_b__5_5__MethodInfo)
}

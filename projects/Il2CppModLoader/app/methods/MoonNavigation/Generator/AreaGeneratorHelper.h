...
namespace app::classes::MoonNavigation::Generator::AreaGeneratorHelper {
    ...
    IL2CPP_REGISTER_METHOD(0x0145BE00, void, FindIntersection, (app::Vector2 p1, app::Vector2 p2, app::Vector2 p3, app::Vector2 p4, bool* lines_intersect, bool* segments_intersect, app::Vector2* intersection, app::Vector2* close_p1, app::Vector2* close_p2))

...
namespace app::classes::KeybindingCommandMapAsset__GetAllBindingsIterator_d__62 {
    ...
    IL2CPP_REGISTER_METHOD(0x002FB930, app::CommandBinding*, IEnumerator_CommandBinding__get_Current, (app::KeybindingCommandMapAsset_GetAllBindingsIterator_d_62 * this_ptr))
    ...
    IL2CPP_REGISTER_METHODINFO(0x0474BA98, KeybindingCommandMapAsset_GetAllBindingsIterator_d_62_System_Collections_IEnumerator_Reset__MethodInfo)
    ...
    IL2CPP_REGISTER_METHOD(0x00E6BBD0, app::IEnumerator_1_CommandBinding_*, IEnumerable_CommandBinding__GetEnumerator, (app::KeybindingCommandMapAsset_GetAllBindingsIterator_d_62 * this_ptr))

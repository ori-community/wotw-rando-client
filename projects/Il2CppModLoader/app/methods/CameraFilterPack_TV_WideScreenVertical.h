...
namespace app::methods::CameraFilterPack_TV_WideScreenVertical {
    ...
    IL2CPP_REGISTER_METHOD(0x020F3400, void, OnRenderImage, (app::CameraFilterPack_TV_WideScreenVertical * this_ptr, app::RenderTexture * source_texture, app::RenderTexture * dest_texture))

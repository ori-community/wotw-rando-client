...
namespace app::methods::WeightedGroup_1_System_Object_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02ACF490, void, ctor_2, (app::WeightedGroup_1_System_Object_ * this_ptr, app::List_1_System_Object_ * elements, app::List_1_System_Single_ * weights))
    IL2CPP_REGISTER_METHOD(0x02ACF4C0, void, Initialize, (app::WeightedGroup_1_System_Object_ * this_ptr, app::List_1_System_Object_ * elements, app::List_1_System_Single_ * weights))
    IL2CPP_REGISTER_METHOD(0x02ACF7F0, void, SetElements, (app::WeightedGroup_1_System_Object_ * this_ptr, app::List_1_System_Object_ * elements, app::List_1_System_Single_ * weights))
    IL2CPP_REGISTER_METHOD(0x02ACF910, void, SetWeights, (app::WeightedGroup_1_System_Object_ * this_ptr, app::Dictionary_2_System_Object_System_Single_ * new_weights))

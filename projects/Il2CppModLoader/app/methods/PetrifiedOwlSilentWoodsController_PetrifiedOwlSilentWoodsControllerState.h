...
namespace app::methods::PetrifiedOwlSilentWoodsController_PetrifiedOwlSilentWoodsControllerState {
    IL2CPP_REGISTER_METHOD(0x014E7B90, void, ctor, (app::PetrifiedOwlSilentWoodsController_PetrifiedOwlSilentWoodsControllerState * this_ptr, app::PetrifiedOwlSilentWoodsController * controller))

...
namespace app::methods::AllContainer_1_EnvironmentLight_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0478DE18, AllContainer_1_EnvironmentLight__get_Item__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x019D77E0, int32_t, get_Count, (app::AllContainer_1_EnvironmentLight_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0473B0B8, AllContainer_1_EnvironmentLight__get_Count__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x019D79F0, bool, Contains, (app::AllContainer_1_EnvironmentLight_ * this_ptr, app::EnvironmentLight * item))
    IL2CPP_REGISTER_METHODINFO(0x04718EE0, AllContainer_1_EnvironmentLight__Contains__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x019D7830, void, Add, (app::AllContainer_1_EnvironmentLight_ * this_ptr, app::EnvironmentLight * item))
    IL2CPP_REGISTER_METHODINFO(0x0473D488, AllContainer_1_EnvironmentLight__Add__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x019D7990, void, Remove, (app::AllContainer_1_EnvironmentLight_ * this_ptr, app::EnvironmentLight * item))
    IL2CPP_REGISTER_METHODINFO(0x0474DAF0, AllContainer_1_EnvironmentLight__Remove__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x018E6D70, void, ctor, (app::AllContainer_1_EnvironmentLight_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04766578, AllContainer_1_EnvironmentLight___ctor__MethodInfo)
}

...
namespace app::methods::CameraFilterPack_Colors_BleachBypass {
    ...
    IL2CPP_REGISTER_METHOD(0x024DFC70, void, OnRenderImage, (app::CameraFilterPack_Colors_BleachBypass * this_ptr, app::RenderTexture * source_texture, app::RenderTexture * dest_texture))

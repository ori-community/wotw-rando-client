...
namespace app::methods::WeightedGroup_1_FallingRocksGroup_RockInfo_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04705B98, WeightedGroup_1_FallingRocksGroup_RockInfo__Initialize__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x047904B0, WeightedGroup_1_FallingRocksGroup_RockInfo__GetRandomElement__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x018E6D70, void, ctor, (app::WeightedGroup_1_FallingRocksGroup_RockInfo_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0474F528, WeightedGroup_1_FallingRocksGroup_RockInfo___ctor__MethodInfo)
}

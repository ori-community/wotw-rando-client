...
namespace app::methods::AkBaseArray_1_AkObstructionOcclusionValues_ {
    IL2CPP_REGISTER_METHOD(0x019D7280, void, ctor, (app::AkBaseArray_1_AkObstructionOcclusionValues_ * this_ptr, int32_t capacity))
    IL2CPP_REGISTER_METHODINFO(0x0478B618, AkBaseArray_1_AkObstructionOcclusionValues___ctor__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x002FB930, void *, GetBuffer, (app::AkBaseArray_1_AkObstructionOcclusionValues_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047413C0, AkBaseArray_1_AkObstructionOcclusionValues__GetBuffer__MethodInfo)
    ...
    IL2CPP_REGISTER_METHOD(0x002FA000, void, ReleaseAllocatedMemoryFromReferenceAtIntPtr, (app::AkBaseArray_1_AkObstructionOcclusionValues_ * this_ptr, void * address))
}

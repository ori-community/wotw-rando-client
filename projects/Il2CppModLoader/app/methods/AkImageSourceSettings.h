...
namespace app::classes::AkImageSourceSettings {
    ...
    IL2CPP_REGISTER_METHOD(0x026E7C60, void, ctor_3, (app::AkImageSourceSettings * this_ptr, app::AkVector* in_source_position, float in_f_distance_scaling_factor, float in_f_level))

...
namespace app::methods::LegacyEntityDamageReciever___c {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04721DD0, LegacyEntityDamageReciever_c__OnPoolSpawned_b__14_0__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0474F6E8, LegacyEntityDamageReciever_c__OnPoolSpawned_b__14_1__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor_b__28_0, (app::LegacyEntityDamageReciever_c * this_ptr, app::Damage * _p0_))
    IL2CPP_REGISTER_METHODINFO(0x047223B8, LegacyEntityDamageReciever_c___ctor_b__28_0__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __cctor_b__29_0, (app::LegacyEntityDamageReciever_c * this_ptr, app::LegacyEntity * _p0_))
    IL2CPP_REGISTER_METHODINFO(0x0478F348, LegacyEntityDamageReciever_c___cctor_b__29_0__MethodInfo)
}

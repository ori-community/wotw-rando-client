...
namespace app::methods::UberPoolPerfTest__FinishPendingTasks_d__43 {
    ...
    IL2CPP_REGISTER_METHOD(0x0011DCA0, void, SetStateMachine, (app::UberPoolPerfTest_FinishPendingTasks_d_43__Boxed * this_ptr, app::IAsyncStateMachine * state_machine))
}

...
namespace app::methods::RaceLeaderboardScreen___c {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04782830, RaceLeaderboardScreen_c__SetupEntries_b__55_0__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x047398D8, RaceLeaderboardScreen_c__SetupEntries_b__55_1__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x0060CE90, bool, _SetupEntries_b__55_2, (app::RaceLeaderboardScreen_c * this_ptr, app::LeaderBoardEntry * o))
    IL2CPP_REGISTER_METHODINFO(0x04763468, RaceLeaderboardScreen_c__SetupEntries_b__55_2__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor_b__64_0, (app::RaceLeaderboardScreen_c * this_ptr, app::String * _p0_, bool _p1_))
    IL2CPP_REGISTER_METHODINFO(0x047325F0, RaceLeaderboardScreen_c___ctor_b__64_0__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor_b__64_1, (app::RaceLeaderboardScreen_c * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04796A10, RaceLeaderboardScreen_c___ctor_b__64_1__MethodInfo)
}

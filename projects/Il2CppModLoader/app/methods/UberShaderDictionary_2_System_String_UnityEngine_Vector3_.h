...
namespace app::methods::UberShaderDictionary_2_System_String_UnityEngine_Vector3_ {
    IL2CPP_REGISTER_METHOD(0x0225DBC0, void, ctor, (app::UberShaderDictionary_2_System_String_UnityEngine_Vector3_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04777110, UberShaderDictionary_2_System_String_UnityEngine_Vector3___ctor__MethodInfo)
    ...
    IL2CPP_REGISTER_METHOD(0x02260590, app::IEnumerator_1_KeyValuePair_2_System_String_UnityEngine_Vector3_ *, System_Collections_Generic_IEnumerable_System_Collections_Generic_KeyValuePair_TK_TV___GetEnumerator, (app::UberShaderDictionary_2_System_String_UnityEngine_Vector3_ * this_ptr))

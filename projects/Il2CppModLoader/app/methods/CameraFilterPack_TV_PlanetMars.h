...
namespace app::classes::CameraFilterPack_TV_PlanetMars {
    ...
    IL2CPP_REGISTER_METHOD(0x020EC800, void, OnRenderImage, (app::CameraFilterPack_TV_PlanetMars * this_ptr, app::RenderTexture* source_texture, app::RenderTexture* dest_texture))

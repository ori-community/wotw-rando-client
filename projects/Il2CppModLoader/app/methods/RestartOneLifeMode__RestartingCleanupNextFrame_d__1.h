...
namespace app::methods::RestartOneLifeMode__RestartingCleanupNextFrame_d__1 {
    IL2CPP_REGISTER_METHOD(0x002FC6E0, void, ctor, (app::RestartOneLifeMode_RestartingCleanupNextFrame_d_1 * this_ptr, int32_t __1__state))
    IL2CPP_REGISTER_METHOD(0x002FA000, void, IDisposable_Dispose, (app::RestartOneLifeMode_RestartingCleanupNextFrame_d_1 * this_ptr))

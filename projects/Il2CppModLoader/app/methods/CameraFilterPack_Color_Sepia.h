...
namespace app::methods::CameraFilterPack_Color_Sepia {
    ...
    IL2CPP_REGISTER_METHOD(0x024DBD20, void, OnRenderImage, (app::CameraFilterPack_Color_Sepia * this_ptr, app::RenderTexture * source_texture, app::RenderTexture * dest_texture))

...
namespace app::methods::EnumDebugMenuItem_1_System_Int32Enum_ {
    ...
    IL2CPP_REGISTER_METHOD(0x019E1D40, void, ctor_2, (app::EnumDebugMenuItem_1_System_Int32Enum_ * this_ptr, app::String * path, app::String * text, app::Func_1_Int32Enum_ * getter, app::Action_1_Int32Enum_ * setter, app::String * help, bool should_show_only_selected))

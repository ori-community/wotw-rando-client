...
namespace app::classes::InteractionRotationModifier__GetKeywordsForShader_d__18 {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0478BFC0, InteractionRotationModifier_GetKeywordsForShader_d_18_System_Collections_IEnumerator_Reset__MethodInfo)
    ...
    IL2CPP_REGISTER_METHOD(0x0063B710, app::IEnumerator_1_System_String_*, IEnumerable_string__GetEnumerator, (app::InteractionRotationModifier_GetKeywordsForShader_d_18 * this_ptr))

...
namespace app::classes::AVProWindowsMediaMovie {
    ...
    IL2CPP_REGISTER_METHOD(0x0312E7A0, bool, LoadMovieFromMemory, (app::AVProWindowsMediaMovie * this_ptr, bool auto_play, app::String* name, void* movie_pointer, int64_t movie_length, app::FilterMode__Enum texture_filter_mode, app::TextureWrapMode__Enum texture_wrap_mode))

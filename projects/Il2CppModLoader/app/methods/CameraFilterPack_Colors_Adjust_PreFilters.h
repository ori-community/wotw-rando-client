...
namespace app::classes::CameraFilterPack_Colors_Adjust_PreFilters {
    ...
    IL2CPP_REGISTER_METHOD(0x024DEF50, void, OnRenderImage, (app::CameraFilterPack_Colors_Adjust_PreFilters * this_ptr, app::RenderTexture* source_texture, app::RenderTexture* dest_texture))

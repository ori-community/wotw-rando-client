...
namespace app::classes::CombinedMessageProvider__GetMessages_d__3 {
    ...
    IL2CPP_REGISTER_METHOD(0x004BD960, app::MessageDescriptor, IEnumerator_MessageDescriptor__get_Current, (app::CombinedMessageProvider_GetMessages_d_3 * this_ptr))
    IL2CPP_REGISTER_METHOD(0x011DE2A0, void, IEnumerator_Reset, (app::CombinedMessageProvider_GetMessages_d_3 * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04731230, CombinedMessageProvider_GetMessages_d_3_System_Collections_IEnumerator_Reset__MethodInfo)
    ...
    IL2CPP_REGISTER_METHOD(0x011DE390, app::IEnumerator_1_MessageDescriptor_*, IEnumerable_MessageDescriptor__GetEnumerator, (app::CombinedMessageProvider_GetMessages_d_3 * this_ptr))

...
namespace app::methods::ScenesManager {
    ...
    IL2CPP_REGISTER_METHOD(0x00BC2AC0, bool, PositionInsideSceneStillLoading_1, (app::ScenesManager * this_ptr, app::Vector3 position, app::StringBuilder * scenes_list))
    ...
    IL2CPP_REGISTER_METHOD(0x00BC3A00, bool, GetSceneBoundaryAtPosition_2, (app::ScenesManager * this_ptr, app::List_1_System_Int32_ * scenes_list, app::Vector3 position, app::Rect * bound))
    ...
    IL2CPP_REGISTER_METHOD(0x00BC4AF0, app::SceneManagerScene *, GetFromCurrentScenes_1, (app::ScenesManager * this_ptr, app::RuntimeSceneMetaData * scene_meta_data))
    ...
    IL2CPP_REGISTER_METHOD(0x00420EE0, app::SceneMetaData *, GetSceneMetaDataFromRuntimeMetaData, (app::ScenesManager * this_ptr, app::RuntimeSceneMetaData * runtime_meta))
    ...
    IL2CPP_REGISTER_METHOD(0x00BCBC40, void, RequestAdditivelyLoadScene, (app::ScenesManager * this_ptr, app::RuntimeSceneMetaData * scene_meta_data, bool async, bool keep_preloaded, bool force_load, bool load_dependant_scenes, bool queue_included_scenes))
    ...
    IL2CPP_REGISTER_METHOD(0x00BCC7B0, void, LoadScenesAtPosition, (app::ScenesManager * this_ptr, app::Vector3 position, bool async, bool loading_zones, bool keep_preloaded, bool force_load, bool load_dependant_scenes))
    IL2CPP_REGISTER_METHOD(0x00BCCC80, void, AdditivelyLoadScene, (app::ScenesManager * this_ptr, app::Vector3 position, app::MoonGuid * scene_guid, bool async, bool loading_zones, bool keep_preloaded))
    IL2CPP_REGISTER_METHOD(0x00BCD0F0, void, AdditivelyLoadScenesInsideRect, (app::ScenesManager * this_ptr, app::Rect rect, bool async, bool loading_zones, bool keep_preloaded, bool force_load, bool load_dependent_scenes, bool queue_included_scenes))
    ...
    IL2CPP_REGISTER_METHOD(0x00BD1EC0, void, EnableWithManualUnSuspend, (app::ScenesManager * this_ptr, app::MoonGuid * scene_guid, app::Action_1_Boolean_ * after_enable))
    ...
    IL2CPP_REGISTER_METHOD(0x00BD2510, app::IEnumerator *, WaitForSceneToLoadAndSendTelemetryEvent, (app::ScenesManager * this_ptr, app::AsyncOperation_1 * load_operation, app::RuntimeSceneMetaData * scene_meta_data))
    ...
    IL2CPP_REGISTER_METHOD(0x00BD2960, void, FindNearbyScenes, (app::ScenesManager * this_ptr, app::RuntimeSceneMetaData * scene, app::Dictionary_2_MoonGuid_NearbySceneData_ * nearby_scenes, int32_t hop))
    ...
    IL2CPP_REGISTER_METHOD(0x00BD3090, void, GetConnectedScenes, (app::ScenesManager * this_ptr, app::RuntimeSceneMetaData * meta_data, app::List_1_RuntimeSceneMetaData_ * connected_scenes))
    ...
    IL2CPP_REGISTER_METHOD(0x00BD44F0, void, AdditivelyLoadSceneFile, (app::ScenesManager * this_ptr, app::RuntimeSceneMetaData * runtime_meta, bool async, bool keep_preloaded, bool load_dependant_scenes, bool scene_already_loaded))
    IL2CPP_REGISTER_METHOD(0x00BD4BD0, app::AsyncOperation_1 *, AdditivelyLoadSceneFileEditor, (app::ScenesManager * this_ptr, app::RuntimeSceneMetaData * runtime_scene_meta_data, bool async))
    ...
    IL2CPP_REGISTER_METHOD(0x00BD5EE0, void, GetShowingAndHiddenSceneCount, (app::ScenesManager * this_ptr, app::MoonGuid * guid, int32_t * showing_count, int32_t * hidden_count))

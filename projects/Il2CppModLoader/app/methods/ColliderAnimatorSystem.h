...
namespace app::classes::ColliderAnimatorSystem {
    ...
    IL2CPP_REGISTER_METHOD(0x012CE550, void, SubmitColliderRadius, (app::ColliderAnimatorSystem * this_ptr, app::Collider* collider, float radius, app::SphereColliderAnimator_AnimationMode__Enum mode))
    ...
    IL2CPP_REGISTER_METHOD(0x012CEB50, void, ReturnStateToPool, (app::ColliderAnimatorSystem * this_ptr, app::ColliderAnimatorSystem_SphereColliderAnimationState* state))

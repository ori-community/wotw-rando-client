...
namespace app::classes::MeleeComboMoveHammerBase {
    ...
    IL2CPP_REGISTER_METHOD(0x01390050, void, OnCollision, (app::MeleeComboMoveHammerBase * this_ptr, app::Collider* collider, app::Vector3 hit_direction, app::Vector3 damage_position))

...
namespace app::methods::SeinChakramSpell_BalancingData {
    ...
    IL2CPP_REGISTER_METHOD(0x00A3F300, app::SeinChakramSpell_BalancingData_ChakramDamageSettings *, GetDamage, (app::SeinChakramSpell_BalancingData * this_ptr, int32_t hit_number))

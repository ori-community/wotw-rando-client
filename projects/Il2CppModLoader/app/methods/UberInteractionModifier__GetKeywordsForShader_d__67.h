...
namespace app::classes::UberInteractionModifier__GetKeywordsForShader_d__67 {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0478ED98, UberInteractionModifier_GetKeywordsForShader_d_67_System_Collections_IEnumerator_Reset__MethodInfo)
    ...
    IL2CPP_REGISTER_METHOD(0x00FCF0A0, app::IEnumerator_1_System_String_*, IEnumerable_string__GetEnumerator, (app::UberInteractionModifier_GetKeywordsForShader_d_67 * this_ptr))

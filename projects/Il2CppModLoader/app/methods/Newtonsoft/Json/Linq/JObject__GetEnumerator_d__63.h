...
namespace app::methods::Newtonsoft::Json::Linq::JObject__GetEnumerator_d__63 {
    ...
    IL2CPP_REGISTER_METHOD(0x00C3DD30, app::KeyValuePair_2_System_String_Newtonsoft_Json_Linq_JToken_, IEnumerator_KeyValuePair_string__JToken___get_Current, (app::JObject_GetEnumerator_d_63 * this_ptr))
    IL2CPP_REGISTER_METHOD(0x01F0CAC0, void, IEnumerator_Reset, (app::JObject_GetEnumerator_d_63 * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x047415B8, JObject_GetEnumerator_d_63_System_Collections_IEnumerator_Reset__MethodInfo)

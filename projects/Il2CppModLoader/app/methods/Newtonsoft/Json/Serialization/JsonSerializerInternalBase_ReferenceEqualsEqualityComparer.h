...
namespace app::classes::Newtonsoft::Json::Serialization::JsonSerializerInternalBase_ReferenceEqualsEqualityComparer {
    ...
    IL2CPP_REGISTER_METHOD(0x01652220, int32_t, IEqualityComparer_object__GetHashCode, (app::JsonSerializerInternalBase_ReferenceEqualsEqualityComparer * this_ptr, app::Object* obj))

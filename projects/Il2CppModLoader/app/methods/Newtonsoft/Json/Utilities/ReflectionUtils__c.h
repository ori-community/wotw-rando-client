...
namespace app::classes::Newtonsoft::Json::Utilities::ReflectionUtils___c {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04788398, ReflectionUtils_c__GetDefaultConstructor_b__11_0__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x0477A1A8, ReflectionUtils_c__GetFieldsAndProperties_b__31_0__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x047745F0, ReflectionUtils_c__GetMemberInfoFromType_b__39_0__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x03026750, bool, _GetChildPrivateFields_b__41_0, (app::ReflectionUtils_c * this_ptr, app::FieldInfo_1* f))
    IL2CPP_REGISTER_METHODINFO(0x0472E980, ReflectionUtils_c__GetChildPrivateFields_b__41_0__MethodInfo)
} // namespace app::classes::Newtonsoft::Json::Utilities::ReflectionUtils___c

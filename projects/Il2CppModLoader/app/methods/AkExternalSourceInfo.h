...
namespace app::methods::AkExternalSourceInfo {
    ...
    IL2CPP_REGISTER_METHOD(0x026E4B30, void, ctor_3, (app::AkExternalSourceInfo * this_ptr, void * in_p_in_memory, uint32_t in_ui_memory_size, uint32_t in_i_external_src_cookie, uint32_t in_id_codec))
    IL2CPP_REGISTER_METHOD(0x026E4C90, void, ctor_4, (app::AkExternalSourceInfo * this_ptr, app::String * in_psz_file_name, uint32_t in_i_external_src_cookie, uint32_t in_id_codec))
    IL2CPP_REGISTER_METHOD(0x026E4DF0, void, ctor_5, (app::AkExternalSourceInfo * this_ptr, uint32_t in_id_file, uint32_t in_i_external_src_cookie, uint32_t in_id_codec))

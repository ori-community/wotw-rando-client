...
namespace app::classes::SkeetoHitReaction {
    ...
    IL2CPP_REGISTER_METHOD(0x00757A80, void, HandleReasonToNotInterrupt, (app::SkeetoHitReaction * this_ptr, app::EntityReactionBehaviour_ReasonWhyReactionWontInterrupt reason, app::EntityEvent* reaction_event))

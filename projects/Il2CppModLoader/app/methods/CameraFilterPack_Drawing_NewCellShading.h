...
namespace app::methods::CameraFilterPack_Drawing_NewCellShading {
    ...
    IL2CPP_REGISTER_METHOD(0x024F8550, void, OnRenderImage, (app::CameraFilterPack_Drawing_NewCellShading * this_ptr, app::RenderTexture * source_texture, app::RenderTexture * dest_texture))

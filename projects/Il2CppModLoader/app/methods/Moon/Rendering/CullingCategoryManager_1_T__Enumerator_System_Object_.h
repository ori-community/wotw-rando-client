...
namespace app::methods::Moon::Rendering::CullingCategoryManager_1_T__Enumerator_System_Object_ {
    ...
    IL2CPP_REGISTER_METHOD(0x00216090, void, ctor, (app::CullingCategoryManager_1_T_Enumerator_System_Object___Boxed * this_ptr, app::Dictionary_2_System_Int32_System_Object_ * registered_items, app::RendererCullingCategoryResults_Slice__Array * slices))
    ...
    IL2CPP_REGISTER_METHOD(0x00216120, app::CullingCategoryManager_1_T_Enumerator_System_Object_, GetEnumerator, (app::CullingCategoryManager_1_T_Enumerator_System_Object___Boxed * this_ptr))
}

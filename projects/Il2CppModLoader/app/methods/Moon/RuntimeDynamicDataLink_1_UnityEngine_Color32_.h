...
namespace app::methods::Moon::RuntimeDynamicDataLink_1_UnityEngine_Color32_ {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04797700, RuntimeDynamicDataLink_1_UnityEngine_Color32__GetValue__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04748678, RuntimeDynamicDataLink_1_UnityEngine_Color32__CreateReflectionData__MethodInfo)

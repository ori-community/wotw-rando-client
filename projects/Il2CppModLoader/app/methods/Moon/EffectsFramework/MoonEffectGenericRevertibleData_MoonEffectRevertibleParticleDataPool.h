...
namespace app::methods::Moon::EffectsFramework::MoonEffectGenericRevertibleData_MoonEffectRevertibleParticleDataPool {
    ...
    IL2CPP_REGISTER_METHOD(0x002FA490, void, set_Instances, (app::MoonEffectGenericRevertibleData_MoonEffectRevertibleParticleDataPool * this_ptr, app::Stack_1_Moon_EffectsFramework_MoonEffectGenericRevertibleData_MoonEffectRevertibleParticleData_ * value))
    ...
    IL2CPP_REGISTER_METHOD(0x01981DB0, app::MoonEffectGenericRevertibleData_MoonEffectRevertibleParticleData *, CreateNewInstance, (app::MoonEffectGenericRevertibleData_MoonEffectRevertibleParticleDataPool * this_ptr))

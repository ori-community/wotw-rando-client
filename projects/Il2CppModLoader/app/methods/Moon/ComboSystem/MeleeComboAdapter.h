...
namespace app::methods::Moon::ComboSystem::MeleeComboAdapter {
    ...
    IL2CPP_REGISTER_METHOD(0x00CC8160, void, ModifyGravityPlatformMovementSettings, (app::MeleeComboAdapter * this_ptr, app::GravityPlatformMovementSettings * settings))
    IL2CPP_REGISTER_METHOD(0x00CC81A0, void, ModifyHorizontalPlatformMovementSettings, (app::MeleeComboAdapter * this_ptr, app::HorizontalPlatformMovementSettings * settings))

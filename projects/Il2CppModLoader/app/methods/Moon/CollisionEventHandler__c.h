...
namespace app::methods::Moon::CollisionEventHandler___c {
    ...
    IL2CPP_REGISTER_METHODINFO(0x0477ED60, CollisionEventHandler_c___ctor_b__6_0__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor_b__6_1, (app::CollisionEventHandler_c * this_ptr, app::Collision * _p0_))
    IL2CPP_REGISTER_METHODINFO(0x04787330, CollisionEventHandler_c___ctor_b__6_1__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor_b__6_2, (app::CollisionEventHandler_c * this_ptr, app::Collision * _p0_))
    IL2CPP_REGISTER_METHODINFO(0x04780D50, CollisionEventHandler_c___ctor_b__6_2__MethodInfo)
}

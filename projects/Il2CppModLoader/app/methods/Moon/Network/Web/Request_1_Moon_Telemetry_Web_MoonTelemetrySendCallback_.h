...
namespace app::methods::Moon::Network::Web::Request_1_Moon_Telemetry_Web_MoonTelemetrySendCallback_ {
    ...
    IL2CPP_REGISTER_METHOD(0x002FB950, app::String *, get_Path, (app::Request_1_Moon_Telemetry_Web_MoonTelemetrySendCallback_ * this_ptr))
    IL2CPP_REGISTER_METHOD(0x00529FF0, app::Method__Enum, get_Method, (app::Request_1_Moon_Telemetry_Web_MoonTelemetrySendCallback_ * this_ptr))
    IL2CPP_REGISTER_METHOD(0x002FBB00, app::IDataReader *, get_DataReader, (app::Request_1_Moon_Telemetry_Web_MoonTelemetrySendCallback_ * this_ptr))
    IL2CPP_REGISTER_METHOD(0x002FB9B0, app::Dictionary_2_System_String_System_String_ *, get_Headers, (app::Request_1_Moon_Telemetry_Web_MoonTelemetrySendCallback_ * this_ptr))
    IL2CPP_REGISTER_METHOD(0x027229E0, app::IRequestCallback *, CreateRequestCallbackObject, (app::Request_1_Moon_Telemetry_Web_MoonTelemetrySendCallback_ * this_ptr))

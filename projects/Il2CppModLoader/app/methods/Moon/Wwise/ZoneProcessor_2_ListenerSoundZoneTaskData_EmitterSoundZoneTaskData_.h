...
namespace app::classes::Moon::Wwise::ZoneProcessor_2_ListenerSoundZoneTaskData_EmitterSoundZoneTaskData_ {
    ...
    IL2CPP_REGISTER_METHOD(0x02AF52A0, app::EmitterSoundZoneTaskData, InitializeEmitterZoneTask, (app::ZoneProcessor_2_ListenerSoundZoneTaskData_EmitterSoundZoneTaskData_ * this_ptr, app::EmitterSoundZoneTaskData zone, app::AudioEmitterZone* audio_emitter_zone))
    IL2CPP_REGISTER_METHOD(0x02AF52A0, app::ListenerSoundZoneTaskData, InitializeListenerZoneTask, (app::ZoneProcessor_2_ListenerSoundZoneTaskData_EmitterSoundZoneTaskData_ * this_ptr, app::ListenerSoundZoneTaskData data, app::AudioListenerZone* audio_listener_zone))

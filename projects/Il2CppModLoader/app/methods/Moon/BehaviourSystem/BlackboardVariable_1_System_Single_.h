...
namespace app::methods::Moon::BehaviourSystem::BlackboardVariable_1_System_Single_ {
    IL2CPP_REGISTER_METHOD(0x018E6D70, void, ctor, (app::BlackboardVariable_1_System_Single_ * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0470CA38, BlackboardVariable_1_System_Single___ctor__MethodInfo)

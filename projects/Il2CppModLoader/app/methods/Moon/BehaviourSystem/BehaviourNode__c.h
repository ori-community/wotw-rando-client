...
namespace app::classes::Moon::BehaviourSystem::BehaviourNode___c {
    ...
    IL2CPP_REGISTER_METHODINFO(0x047890A8, BehaviourNode_c___ctor_b__61_1__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04776B60, BehaviourNode_c___ctor_b__61_2__MethodInfo)
    IL2CPP_REGISTER_METHOD(0x002FA000, void, __ctor_b__61_3, (app::BehaviourNode_c * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x0472B580, BehaviourNode_c___ctor_b__61_3__MethodInfo)
} // namespace app::classes::Moon::BehaviourSystem::BehaviourNode___c

...
namespace app::methods::Moon::Telemetry::DataPoint {
    ...
    IL2CPP_REGISTER_METHOD(0x00E326B0, void, ctor, (app::DataPoint * this_ptr, app::String * player_key, app::String * session_key, app::String * time, app::String * level, app::DataPointType__Enum type, app::Vector3 position))

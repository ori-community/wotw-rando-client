...
namespace app::methods::Moon::Timeline::TimelineHelper__EverythingConstrainedTo_d__28 {
    ...
    IL2CPP_REGISTER_METHOD(0x002FB930, app::TimelineEntityRecord *, IEnumerator_TimelineEntityRecord__get_Current, (app::TimelineHelper_EverythingConstrainedTo_d_28 * this_ptr))
    IL2CPP_REGISTER_METHOD(0x01E8C6A0, void, IEnumerator_Reset, (app::TimelineHelper_EverythingConstrainedTo_d_28 * this_ptr))
    IL2CPP_REGISTER_METHODINFO(0x04777E28, TimelineHelper_EverythingConstrainedTo_d_28_System_Collections_IEnumerator_Reset__MethodInfo)
    ...
    IL2CPP_REGISTER_METHOD(0x01E8C6F0, app::IEnumerator_1_Moon_Timeline_TimelineEntityRecord_ *, IEnumerable_TimelineEntityRecord__GetEnumerator, (app::TimelineHelper_EverythingConstrainedTo_d_28 * this_ptr))

...
namespace app::methods::Moon::Timeline::BlockDamageInterruption___c {
    ...
    IL2CPP_REGISTER_METHODINFO(0x04763BF8, BlockDamageInterruption_c___ctor_b__18_0__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04770150, BlockDamageInterruption_c___ctor_b__18_1__MethodInfo)
    ...
    IL2CPP_REGISTER_METHODINFO(0x04758C80, BlockDamageInterruption_c___ctor_b__18_2__MethodInfo)
}

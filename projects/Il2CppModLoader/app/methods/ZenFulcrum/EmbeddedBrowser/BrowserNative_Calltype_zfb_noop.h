...
namespace app::methods::ZenFulcrum::EmbeddedBrowser::BrowserNative_Calltype_zfb_noop {
    ...
    IL2CPP_REGISTER_METHOD(0x00611B10, app::IAsyncResult *, BeginInvoke, (app::BrowserNative_Calltype_zfb_noop * this_ptr, app::AsyncCallback * callback, app::Object * object))

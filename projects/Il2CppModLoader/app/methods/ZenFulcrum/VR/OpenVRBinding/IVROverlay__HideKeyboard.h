...
namespace app::methods::ZenFulcrum::VR::OpenVRBinding::IVROverlay__HideKeyboard {
    ...
    IL2CPP_REGISTER_METHOD(0x00611B10, app::IAsyncResult *, BeginInvoke, (app::IVROverlay_HideKeyboard * this_ptr, app::AsyncCallback * callback, app::Object * object))

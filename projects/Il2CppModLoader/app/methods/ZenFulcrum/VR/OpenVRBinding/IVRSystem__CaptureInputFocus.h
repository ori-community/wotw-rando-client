...
namespace app::methods::ZenFulcrum::VR::OpenVRBinding::IVRSystem__CaptureInputFocus {
    ...
    IL2CPP_REGISTER_METHOD(0x00611B10, app::IAsyncResult *, BeginInvoke, (app::IVRSystem_CaptureInputFocus * this_ptr, app::AsyncCallback * callback, app::Object * object))

...
namespace app::methods::ZenFulcrum::VR::OpenVRBinding::IVRSystem__AcknowledgeQuit_UserPrompt {
    ...
    IL2CPP_REGISTER_METHOD(0x00611B10, app::IAsyncResult *, BeginInvoke, (app::IVRSystem_AcknowledgeQuit_UserPrompt * this_ptr, app::AsyncCallback * callback, app::Object * object))

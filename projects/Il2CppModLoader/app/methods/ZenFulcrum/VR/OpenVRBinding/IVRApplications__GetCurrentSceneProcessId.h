...
namespace app::methods::ZenFulcrum::VR::OpenVRBinding::IVRApplications__GetCurrentSceneProcessId {
    ...
    IL2CPP_REGISTER_METHOD(0x00611B10, app::IAsyncResult *, BeginInvoke, (app::IVRApplications_GetCurrentSceneProcessId * this_ptr, app::AsyncCallback * callback, app::Object * object))

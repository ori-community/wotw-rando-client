namespace app {
    ...
    enum class ThrowAnimationType__Enum : int32_t {
        Grenade = 0x00000000,
    };
    ...
    struct ThrowAnimationType__Enum__Array {
        ...
        Il2CppArrayBounds* bounds;
        il2cpp_array_size_t max_length;
        ThrowAnimationType__Enum vector[32];
    };
    ...
    enum class SeinInteraction_KeystoneThrowMode__Enum : int32_t {
        Ground = 0x00000000,
        Air = 0x00000001,
    };

    struct SeinInteraction_KeystoneThrowMode__Enum__Boxed {
        struct SeinInteraction_KeystoneThrowMode__Enum__Class* klass;
        MonitorData* monitor;
        SeinInteraction_KeystoneThrowMode__Enum value;
    };
    ...
    struct SeinCinematic_MoveOriToPositionMode__Enum__Boxed {
        struct SeinCinematic_MoveOriToPositionMode__Enum__Class* klass;
        MonitorData* monitor;
        SeinCinematic_MoveOriToPositionMode__Enum value;
    };
    ...
    enum class SeinDashAttack_State__Enum : int32_t {
        Normal = 0x00000000,
        Dashing = 0x00000001,
        ChargeDashing = 0x00000002,
    };

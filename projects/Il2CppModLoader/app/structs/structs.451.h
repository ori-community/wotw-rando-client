namespace app {
    ...
    struct MatchmakingPlayerWithTeamAssignment__Array__VTable {
    };

    struct MatchmakingPlayerWithTeamAssignment__Array__StaticFields {
    };

    struct MatchmakingPlayerWithTeamAssignment__Array__Class {
        Il2CppClass_0 _0;
        Il2CppRuntimeInterfaceOffsetPair* interfaceOffsets;
        struct MatchmakingPlayerWithTeamAssignment__Array__StaticFields* static_fields;
        const Il2CppRGCTXData* rgctx_data;
        Il2CppClass_1 _1;
        struct MatchmakingPlayerWithTeamAssignment__Array__VTable vtable;
    };
    ...
    enum class RuleType__Enum : int32_t {
        Unknown = 0x00000000,
        DifferenceRule = 0x00000001,
        StringEqualityRule = 0x00000002,
        MatchTotalRule = 0x00000003,
        SetIntersectionRule = 0x00000004,
        TeamSizeBalanceRule = 0x00000005,
        RegionSelectionRule = 0x00000006,
        TeamDifferenceRule = 0x00000007,
        TeamTicketSizeSimilarityRule = 0x00000008,
    };

    struct RuleType__Enum__Boxed {
        struct RuleType__Enum__Class* klass;
        MonitorData* monitor;
        RuleType__Enum value;
    };
    ...
    struct RuleType__Enum__StaticFields {
    };

    struct RuleType__Enum__Class {
        Il2CppClass_0 _0;
        Il2CppRuntimeInterfaceOffsetPair* interfaceOffsets;
        struct RuleType__Enum__StaticFields* static_fields;
        const Il2CppRGCTXData* rgctx_data;
        Il2CppClass_1 _1;
        struct RuleType__Enum__VTable vtable;
    };
    ...
    struct MatchmakingQueueRule__Array__VTable {
    };

    struct MatchmakingQueueRule__Array__StaticFields {
    };

    struct MatchmakingQueueRule__Array__Class {
        Il2CppClass_0 _0;
        Il2CppRuntimeInterfaceOffsetPair* interfaceOffsets;
        struct MatchmakingQueueRule__Array__StaticFields* static_fields;
        const Il2CppRGCTXData* rgctx_data;
        Il2CppClass_1 _1;
        struct MatchmakingQueueRule__Array__VTable vtable;
    };

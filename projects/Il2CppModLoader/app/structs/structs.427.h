namespace app {
    ...
    struct GetSegmentResult__Array__VTable {
    };
    ...
    struct StatisticNameVersion__Array__VTable {
    };
    ...
    struct PlayerStatisticVersion__Array__VTable {
    };
    ...
    struct TradeInfo__Array__VTable {
    };

    struct TradeInfo__Array__StaticFields {
    };

    struct TradeInfo__Array__Class {
        Il2CppClass_0 _0;
        Il2CppRuntimeInterfaceOffsetPair* interfaceOffsets;
        struct TradeInfo__Array__StaticFields* static_fields;
        const Il2CppRGCTXData* rgctx_data;
        Il2CppClass_1 _1;
        struct TradeInfo__Array__VTable vtable;
    };

...
namespace core::api::audio {
    ...
    CORE_DLLEXPORT void post_trigger(SoundTriggerID trigger_id);
    CORE_DLLEXPORT void fire_and_forget(app::Event_1* event, app::ISoundHost* host = nullptr);
    CORE_DLLEXPORT void fire_and_forget(SoundEventID event_id, app::ISoundHost* host = nullptr);

...
namespace randomizer {
    ...
    namespace {
        ...
        messages::MessageQueue message_queue_instance({0.f, 3.f});
    ...
    messages::MessageQueue& message_queue() { return message_queue_instance; }
    messages::RecentMessagesView& recent_messages_view() { return recent_messages_view_instance; }

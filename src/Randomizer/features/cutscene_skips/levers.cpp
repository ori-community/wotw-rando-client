...
namespace {
    ...
    constexpr frozen::unordered_map<frozen::string, LeverConfig, 20> LEVER_CONFIGS = {
        ...
        {"e3DesertC__clone0/artSetups/verticalPlatformSpawnSetup/lever", LeverConfig{.disable_fade_on_automatic_cutscene_skip = true}},

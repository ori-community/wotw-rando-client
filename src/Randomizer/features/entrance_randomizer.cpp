...
namespace randomizer::entrances {
    namespace {
        ...
        const std::unordered_map<EntranceName, EntranceInfo> DEFAULT_ENTRANCES{
            {"lupoShopDoorOutside",     {"lupoShopOutside", {"wellspringGladesHubB"}, "lupoShopDoorInside"}                                                },
            {"lupoShopDoorInside",      {"lupoShopInside", {"hutInteriorA"}, "lupoShopDoorOutside"}                                                        },
            {"hutBEntrance",            {"lastHutOutside", {"wellspringGladesHub"}, "hutBExit"}                                                            },
            {"hutBExit",                {"lastHutInside", {"hutInteriorB"}, "hutBEntrance"}                                                                },
            {"hutCEntrance",            {"hutAboveMotayOutside", {"wellspringGladesHub", "wellspringGladesHubSetups"}, "hutCExit"}                         },
            {"hutCExit",                {"hutAboveMotayInside", {"hutInteriorC"}, "hutCEntrance"}                                                          },
            {"hutDEntrance",            {"treeHutOutside", {"wellspringGladesHubB"}, "hutDExit"}                                                           },
            {"hutDExit",                {"treeHutInside", {"hutInteriorD"}, "hutDEntrance"}                                                                },
            {"hutEEntrance",            {"mokiFatherHutOutside", {"wellspringGladesHub"}, "hutEExit"}                                                      },
            {"hutEExit",                {"mokiFatherHutInside", {"hutInteriorE"}, "hutEEntrance"}                                                          },
            {"hutFEntrance",            {"storageHutOutside", {"wellspringGladesHubB", "wellspringGladesHubSetups"}, "hutFExit"}                           },
            {"hutFExit",                {"storageHutInside", {"hutInteriorF"}, "hutFEntrance"}                                                             },
            {"caveEntrance",            {"caveOutside", {"wellspringGladesHub"}, "caveExit"}                                                               },
            {"caveExit",                {"caveInside", {"hubCaveInterior"}, "caveEntrance"}                                                                },
            {"waterMillOutsideDoorA",   {"wellspring1stFloorBottomOutside", {"waterMillEntrance"}, "waterMillInsideDoorA"}                                 },
            {"waterMillInsideDoorA",    {"wellspring1stFloorBottomInside", {"wotwSaveRoomC__clone0__clone1", "naruGumoBuildRaft"}, "waterMillOutsideDoorA"}},
            {"waterMillOutsideDoorB",   {"wellspring1stFloorTopOutside", {"waterMillEntrance"}, "waterMillInsideDoorB"}                                    },
            {"waterMillInsideDoorB",    {"wellspring1stFloorTopInside", {"waterMillAExit"}, "waterMillOutsideDoorB"}                                       },
            {"waterMillOutsideDoorC",   {"wellspring2ndFloorOutside", {"waterMillEntrance"}, "waterMillInsideDoorC"}                                       },
            {"waterMillInsideDoorC",    {"wellspring2ndFloorInside", {"waterMillBEntrance", "waterMillBCorridorB"}, "waterMillOutsideDoorC"}               },
            {"waterMillOutsideDoorD",   {"wellspring3rdFloorOutside", {"waterMillEntranceTop", "waterMillEntrance"}, "waterMillInsideDoorD"}               },
            {"waterMillInsideDoorD",    {"wellspring3rdFloorInside", {"waterMillCEntrance"}, "waterMillOutsideDoorD"}                                      },
            {"baursReachHutEntrance",   {"reachSeedOutside", {"baursReachGetAbility"}, "baursReachHutExit"}                                                },
            {"baursReachHutExit",       {"reachSeedInside", {"baursReachHutInterior"}, "baursReachHutEntrance"}                                            },
            {"petrifiedHutDoorOutside", {"teddyHutOutside", {"petrifiedForestNewTransitionOri"}, "petrifiedHutDoorInside"}                                },
            {"petrifiedHutDoorInside",  {"teddyHutInside", {"petrifiedForestHutInterior"}, "petrifiedHutDoorOutside"}                                        },
            {"desertRuinsEntranceDoor", {"ruinsOutside", {"desertRuinsTowerEntranceA"}, "doorB"}                                                          },

...
namespace {
    ...
    IL2CPP_INTERCEPT(app::Object_1*, GenericPuppet, Instantiate, app::GenericPuppet * this_ptr, app::GameObject* prefab, app::Vector3 position, app::Quaternion rotation, bool record) {

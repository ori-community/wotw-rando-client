    ...
    namespace {
        ...
        IL2CPP_INTERCEPT(void, Moon::UberStateCollection, PrepareRuntimeDataType, app::UberStateCollection * this_ptr) {
            ...
            std::vector<app::IUberState*> states = {
                ...
                add_state<app::SerializedBooleanUberState>(UberStateGroup::GromShop, "repairTheSpiritWell", 16825, false),
                add_state<app::SerializedBooleanUberState>(UberStateGroup::GromShop, "dwellingRepairs", 51230, false),
                add_state<app::SerializedBooleanUberState>(UberStateGroup::GromShop, "roofsOverHeads", 23607, false),
                add_state<app::SerializedBooleanUberState>(UberStateGroup::GromShop, "onwardsAndUpwards", 40448, false),
                add_state<app::SerializedBooleanUberState>(UberStateGroup::GromShop, "thornySituation", 18751, false),
                add_state<app::SerializedBooleanUberState>(UberStateGroup::GromShop, "clearTheCaveEntrance", 16586, false),
                add_state<app::SerializedBooleanUberState>(UberStateGroup::GromShop, "theGorlekTouch", 15068, false),

                add_state<app::SerializedBooleanUberState>(UberStateGroup::TuleyShop, "lightcatchers", 47651, false),
                add_state<app::SerializedBooleanUberState>(UberStateGroup::TuleyShop, "selaFlowers", 16254, false),
                add_state<app::SerializedBooleanUberState>(UberStateGroup::TuleyShop, "blueMoon", 33011, false),
                add_state<app::SerializedBooleanUberState>(UberStateGroup::TuleyShop, "stickyGrass", 64583, false),
                add_state<app::SerializedBooleanUberState>(UberStateGroup::TuleyShop, "springPlants", 38393, false),
                add_state<app::SerializedBooleanUberState>(UberStateGroup::TuleyShop, "lastTree", 40006, false),
                ...
                add_state<app::SerializedBooleanUberState>(UberStateGroup::GladesProjects, "lightcatchersPlanted", 47651, false),
                add_state<app::SerializedBooleanUberState>(UberStateGroup::GladesProjects, "selaFlowersPlanted", 16254, false),
                add_state<app::SerializedBooleanUberState>(UberStateGroup::GladesProjects, "blueMoonPlanted", 33011, false),
                add_state<app::SerializedBooleanUberState>(UberStateGroup::GladesProjects, "stickyGrassPlanted", 64583, false),
                add_state<app::SerializedBooleanUberState>(UberStateGroup::GladesProjects, "springPlantsPlanted", 38393, false),
                add_state<app::SerializedBooleanUberState>(UberStateGroup::GladesProjects, "lastTreePlanted", 40006, false),
                ...
                add_state<app::SerializedFloatUberState>(UberStateGroup::RandoUpgrade, "splinterLongerRange", 97, false),
                ...
                add_state<app::SerializedByteUberState>(UberStateGroup::RandoState, "bell1", 701, 1),
                add_state<app::SerializedByteUberState>(UberStateGroup::RandoState, "bell2", 702, 2),
                add_state<app::SerializedByteUberState>(UberStateGroup::RandoState, "bell3", 703, 3),
                add_state<app::SerializedByteUberState>(UberStateGroup::RandoState, "bell4", 704, 3),
                add_state<app::SerializedByteUberState>(UberStateGroup::RandoState, "bell5", 705, 1),
                add_state<app::SerializedByteUberState>(UberStateGroup::RandoState, "bell6", 706, 2),
                add_state<app::SerializedByteUberState>(UberStateGroup::RandoState, "bell7", 707, 1),
                add_state<app::SerializedByteUberState>(UberStateGroup::RandoState, "bell8", 708, 0),
                add_state<app::SerializedByteUberState>(UberStateGroup::RandoState, "bell9", 709, 0),
                ...
                add_state<app::SerializedBooleanUberState>(UberStateGroup::RandoConfig, "lightcatchersPlayCutscene", 510, false),
                add_state<app::SerializedBooleanUberState>(UberStateGroup::RandoConfig, "selaFlowersPlayCutscene", 511, false),
                add_state<app::SerializedBooleanUberState>(UberStateGroup::RandoConfig, "blueMoonPlayCutscene", 512, false),
                add_state<app::SerializedBooleanUberState>(UberStateGroup::RandoConfig, "stickyGrassPlayCutscene", 513, false),
                add_state<app::SerializedBooleanUberState>(UberStateGroup::RandoConfig, "springPlantsPlayCutscene", 514, false),
                add_state<app::SerializedBooleanUberState>(UberStateGroup::RandoConfig, "lastTreePlayCutscene", 515, false),

...
namespace ghosts::plugins {
    ...
    public:
        ...
        virtual void play(core::utils::ConstByteStream& stream, RandoGhost& ghost) = 0;
    };

    void play_rando_ghost_plugins(core::utils::ConstByteStream& stream, RandoGhost& ghost);

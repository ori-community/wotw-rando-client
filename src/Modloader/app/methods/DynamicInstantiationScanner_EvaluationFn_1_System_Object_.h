...
#include <Modloader/app/structs/DynamicInstantiationScanner_EvaluationFn_1_System_Object_.h>
...
namespace app::classes::DynamicInstantiationScanner_EvaluationFn_1_System_Object_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::DynamicInstantiationScanner_EvaluationFn_1_System_Object_* this_ptr,
        app::Object* object,
        void* method_1
    )
    IL2CPP_REGISTER_METHOD(

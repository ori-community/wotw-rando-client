...
namespace app::classes::SurfaceTypeVFXHandler_2_System_Object_System_Object_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::SurfaceTypeVFXHandler_2_System_Object_System_Object_* this_ptr,
        app::Object* effects_map,
        app::Transform* vfx_hodler,
        app::Func_2_Object_UnityEngine_GameObject_* get_effects_prefab_function,

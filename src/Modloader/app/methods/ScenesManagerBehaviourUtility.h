...
namespace app::classes::ScenesManagerBehaviourUtility {
    ...
    IL2CPP_REGISTER_METHOD(
        0x0105DF40,
        void,
        FindScenesToLoadAtPosition,
        app::ScenesManagerBehaviourUtility* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        0x0105E360,
        void,
        FindScenesToLoadAtPositionExtrapolated,
        app::ScenesManagerBehaviourUtility* this_ptr,
        app::List_1_System_Int32_* scene_list,
        bool async,
        bool loading_zones,
        bool keep_preloaded
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x0105ED10,
        void,
        UpdateSceneUtilityInternal,
        app::ScenesManagerBehaviourUtility* this_ptr,
        app::List_1_ScenesManagerBehaviourUtility_SceneMetaAndData_* scene_list,
        bool has_nearby,
        int32_t* idx
    )
    IL2CPP_REGISTER_METHOD(
    ...
    IL2CPP_REGISTER_METHOD(
        0x0105F030,
        void,
        ResetSceneUtilityNotInCurrentFrame,
        app::ScenesManagerBehaviourUtility* this_ptr,
        app::List_1_ScenesManagerBehaviourUtility_SceneMetaAndData_* scene_list
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x01060530,
        int32_t,
        CalculateSceneUtility,
        app::ScenesManagerBehaviourUtility* this_ptr,
        app::RuntimeSceneMetaData* meta,
        bool is_nearby,
        app::NearbySceneData near_scene_data
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x01061450,
        void,
        FindScenesToUnloadInternal,
        app::ScenesManagerBehaviourUtility* this_ptr,
        bool instant,
        bool keep_loaded_using_utility
    )
    IL2CPP_REGISTER_METHOD(
        0x01062340,
        bool,
        ShouldKeepConnectedLoaded,
        app::ScenesManagerBehaviourUtility* this_ptr,
        app::RuntimeSceneMetaData* meta_data,
        int32_t prevent_unloading_utility_value
    )

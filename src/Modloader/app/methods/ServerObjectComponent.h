...
namespace app::classes::ServerObjectComponent {
    ...
    IL2CPP_REGISTER_METHOD(
        0x016AB060,
        app::ServerConfigureConfigurableJointAction_ConfigureConfigurableJointActionData,
        GrabData_5,
        app::ServerObjectComponent* this_ptr
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x016AB1F0,
        app::ServerProjectileSpawnerPinkPlantBrain_ProjectileSpawnerPinkPlantBrainData,
        GrabData_14,
        app::ServerObjectComponent* this_ptr
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x016AAE90,
        app::ServerSetRigidBodyPropertiesAction_SetRigidBodyPropertiesActionData,
        GrabData_16,
        app::ServerObjectComponent* this_ptr
    )

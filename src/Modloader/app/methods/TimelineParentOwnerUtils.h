...
namespace app::classes::TimelineParentOwnerUtils {
    ...
    IL2CPP_REGISTER_METHOD(
        0x015E3070,
        void,
        CollectComponentsInChildren_1,
        app::Transform* source,
        app::List_1_System_Object_* result,
        app::Func_2_Object_Boolean_* condition
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        AddExternalGroup_1,
        app::VirtualTimelineRepresentationGroup__Enum group,
        app::GameObject* source,
        app::VirtualClipsBuilder* builder,
    ...
    IL2CPP_REGISTER_METHOD(
        0x015E3070,
        void,
        CollectComponentsInChildren_2,
        app::Transform* source,
        app::List_1_Moon_Timeline_MoonTimeline_* result,
        app::Func_2_Moon_Timeline_MoonTimeline_Boolean_* condition
    )
    IL2CPP_REGISTER_METHOD(
        0x015E3070,
        void,
        CollectComponentsInChildren_3,
        app::Transform* source,
        app::List_1_IVirtualTimelineGameObject_* result,
        app::Func_2_IVirtualTimelineGameObject_Boolean_* condition
    )
    IL2CPP_REGISTER_METHOD(
        0x015E2790,
        void,

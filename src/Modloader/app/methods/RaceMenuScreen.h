...
namespace app::classes::RaceMenuScreen {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        bool,
        IsRaceUnlocked_2,
        app::RaceMenuScreen* this_ptr,
        app::RaceSettings* race,
    ...
    IL2CPP_REGISTER_METHOD(
        0x00EAA9C0,
        void,
        InitiateNotificationSystemForSlot,
        app::RaceMenuScreen* this_ptr,
        int32_t slot_index,
        app::UberStateValueStore* uber_state_value_store
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x00EABF10,
        app::String*,
        GetRaceLeaderboardID,
        app::RaceMenuScreen* this_ptr,
        app::RaceSettings* settings,
        app::UberStateValueStore* store
    )

...
namespace app::classes::TriangleNet::IO::TriangleReader {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ReadVertex,
        app::TriangleReader* this_ptr,
        app::List_1_TriangleNet_Geometry_Vertex_* data,
        int32_t index,
        app::String__Array* line,
        int32_t attributes,
        int32_t marks
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::TriangleReader* this_ptr,
        app::String* filename,
        app::Polygon** geometry,
        app::List_1_TriangleNet_Geometry_ITriangle_** triangles
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x02624320,
        app::List_1_TriangleNet_Geometry_ITriangle_*,
        ReadEleFile_2,
        app::TriangleReader* this_ptr,
        app::String* elefilename,
        bool read_area
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x02624F30,
        app::List_1_TriangleNet_Geometry_Edge_*,
        ReadEdgeFile,
        app::TriangleReader* this_ptr,
        app::String* edge_file,
        int32_t invertices
    )

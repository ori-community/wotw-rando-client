...
namespace app::classes::TriangleNet::NewLocation {
    ...
    IL2CPP_REGISTER_METHOD(
        0x02B16A90,
        app::Point*,
        FindNewLocationWithoutMaxAngle,
        app::NewLocation* this_ptr,
        app::Vertex* torg,
        app::Vertex* tdest,
        app::Vertex* tapex,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        double x2,
        double y2,
        app::Double__Array__Array* polys
    )

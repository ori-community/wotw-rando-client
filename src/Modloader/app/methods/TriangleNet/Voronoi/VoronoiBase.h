...
namespace app::classes::TriangleNet::Voronoi::VoronoiBase {
    ...
    IL2CPP_REGISTER_METHOD(
        0x02AAF8B0,
        app::List_1_TriangleNet_Topology_DCEL_HalfEdge___Array*,
        ComputeVertices,
        app::VoronoiBase* this_ptr,
        app::Mesh_1* mesh,
        app::Vertex_1__Array* vertices
    )
    IL2CPP_REGISTER_METHOD(
        0x02AAFEB0,
        void,
        ...
        app::Mesh_1* mesh,
        app::Vertex_1__Array* vertices,
        app::Face__Array* faces,
        app::List_1_TriangleNet_Topology_DCEL_HalfEdge___Array* map
    )

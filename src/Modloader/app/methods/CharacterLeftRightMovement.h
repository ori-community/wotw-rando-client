...
namespace app::classes::CharacterLeftRightMovement {
    ...
    IL2CPP_REGISTER_METHOD(
        0x01302830,
        void,
        add_ModifyHorizontalPlatformMovementSettingsEvent,
        app::CharacterLeftRightMovement* this_ptr,
        app::Action_1_HorizontalPlatformMovementSettings_* value
    )
    IL2CPP_REGISTER_METHOD(
        0x01302920,
        void,
        remove_ModifyHorizontalPlatformMovementSettingsEvent,
        app::CharacterLeftRightMovement* this_ptr,
        app::Action_1_HorizontalPlatformMovementSettings_* value
    )

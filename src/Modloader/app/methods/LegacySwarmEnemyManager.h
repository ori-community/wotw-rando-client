...
namespace app::classes::LegacySwarmEnemyManager {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        QueueSpawn,
        app::LegacySwarmEnemyManager* this_ptr,
        app::Vector3 pos,
        app::Vector3 velocity,
        int32_t loot_amount,
        app::OrbSpawner* spawner,
        float damage_on_touch,
        app::GameObject* child,
        app::MoonGuid* scene_root,
        app::LegacySwarmEnemyPlaceholder* owner
    )

...
namespace app::classes::HierarchyPerfTest::Tests {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::IEnumerator*,
        DoEnableDisableTest,
        app::String* base_test_name,
        app::List_1_UnityEngine_GameObject_* objects_shuffled
    )
    IL2CPP_REGISTER_METHOD(
        0x01978450,
        app::IEnumerator*,
        DoMovementTests,
        app::String* base_test_name,
        app::List_1_UnityEngine_Transform_* transforms_to_move,
        app::List_1_UnityEngine_Vector3_* positions,
        app::List_1_UnityEngine_Quaternion_* rotations,
        app::List_1_UnityEngine_Vector3_* scales
    )
    IL2CPP_REGISTER_METHOD(
        0x019785D0,
        app::IEnumerator*,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        DoReparentTest,
        app::String* base_test_name,
        app::List_1_UnityEngine_Transform_* transforms_to_reparent,
        app::List_1_UnityEngine_Transform_* new_parents
    )
    IL2CPP_REGISTER_METHOD(
        0x019788B0,
        app::IEnumerator*,
        DoReparentAndTransformTest,
        app::String* base_test_name,
        app::List_1_UnityEngine_Transform_* transforms_to_reparent,
        app::List_1_UnityEngine_Transform_* new_parents,
        app::List_1_UnityEngine_Vector3_* positions,
    ...
    IL2CPP_REGISTER_METHOD(
        0x01978BA0,
        void,
        OnFirstLastRunnerFunctionCalled,
        app::Tests_CompoentRunnerID__Enum runner_i_d,
        app::Tests_UnityFunctionID__Enum function
    )

...
namespace app::classes::Mono::Unity::UnityTls_unitytls_interface_struct_unitytls_tlsctx_set_certificate_callback_t {
    IL2CPP_REGISTER_METHOD(
        0x00611810,
        void,
        ctor,
        app::UnityTls_unitytls_interface_struct_unitytls_tlsctx_set_certificate_callback_t* this_ptr,
        app::Object* object,
        void* method_1
    )
    IL2CPP_REGISTER_METHOD(
        ...
        app::UnityTls_unitytls_tlsctx_certificate_callback* cb,
        app::Void* user_data,

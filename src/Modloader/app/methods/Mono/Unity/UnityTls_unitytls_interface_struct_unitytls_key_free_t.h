...
namespace app::classes::Mono::Unity::UnityTls_unitytls_interface_struct_unitytls_key_free_t {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::IAsyncResult*,
        BeginInvoke,
        app::UnityTls_unitytls_interface_struct_unitytls_key_free_t* this_ptr,

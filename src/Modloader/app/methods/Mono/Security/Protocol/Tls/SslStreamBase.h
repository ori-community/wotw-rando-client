...
namespace app::classes::Mono::Security::Protocol::Tls::SslStreamBase {
    ...
    IL2CPP_REGISTER_METHOD(
        0x01F85740,
        void,
        InternalReadCallback_inner,
        app::SslStreamBase* this_ptr,
        app::SslStreamBase_InternalAsyncResult* internal_result,
        app::Byte__Array* recbuf,
        app::Object__Array* state,
        bool did_read,
        int32_t n
    )

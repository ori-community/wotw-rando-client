...
namespace app::classes::Mono::Security::Protocol::Tls::RecordProtocol_ReceiveRecordAsyncResult {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::RecordProtocol_ReceiveRecordAsyncResult* this_ptr,
        app::AsyncCallback* user_callback,
        app::Object* user_state,
        app::Byte__Array* initial_buffer,
        app::Stream* record
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::RecordProtocol_ReceiveRecordAsyncResult* this_ptr,
        app::Exception* ex,
        app::Byte__Array* resulting_buffer
    )

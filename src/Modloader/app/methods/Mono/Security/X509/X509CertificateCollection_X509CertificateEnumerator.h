...
namespace app::classes::Mono::Security::X509::X509CertificateCollection_X509CertificateEnumerator {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_1,
        app::X509CertificateCollection_X509CertificateEnumerator* this_ptr,
        app::X509CertificateCollection* mappings
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_2,
        app::X509CertificateCollection_X509CertificateEnumerator_2* this_ptr,
        app::X509CertificateCollection_2* mappings
    )

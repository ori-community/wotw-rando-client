...
namespace app::classes::Mono::Net::Security::ChainValidationHelper {
    ...
    IL2CPP_REGISTER_METHOD(
        0x0217CF20,
        app::ChainValidationHelper*,
        Create,
        app::MonoTlsProvider* provider,
        app::MonoTlsSettings** settings,
        app::MonoTlsStream* stream
    )
    IL2CPP_REGISTER_METHOD(
        0x0217D0B0,
        void,
        ctor,
        app::ChainValidationHelper* this_ptr,
        app::MonoTlsProvider* provider,
        app::MonoTlsSettings* settings,
        bool clone_settings,
        app::MonoTlsStream* stream,
        app::ServerCertValidationCallbackWrapper* callback_wrapper
    )
    IL2CPP_REGISTER_METHOD(
        0x01F767C0,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::X509Certificate_1* remote_certificate,
        app::String__Array* acceptable_issuers,
        app::X509Certificate_1** client_certificate
    )
    IL2CPP_REGISTER_METHOD(
        0x0217D680,
        ...
        app::String* host,
        bool server_mode,
        app::X509CertificateCollection_1* certs
    )
    IL2CPP_REGISTER_METHOD(
        0x0217D7E0,
        app::ValidationResult*,
        ValidateCertificate_2,
        app::ChainValidationHelper* this_ptr,
        app::String* host,
        bool server_mode,
        app::X509Certificate_1* leaf,
        app::X509Chain* chain
    )
    IL2CPP_REGISTER_METHOD(
        0x0217D920,
        ...
        app::X509Chain* chain,
        app::X509CertificateCollection_1* certs,
        app::SslPolicyErrors__Enum errors
    )
    IL2CPP_REGISTER_METHOD(
        0x0217DAD0,
        app::ValidationResult*,

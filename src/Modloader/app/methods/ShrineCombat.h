...
namespace app::classes::ShrineCombat {
    ...
    IL2CPP_REGISTER_METHOD(
        0x0073B810,
        void,
        SetAllVisualsToState,
        app::ShrineCombat* this_ptr,
        app::PassiveSetupInfo_State__Enum desired_state,
        bool do_transition,
        app::Func_2_ShrineCombat_WaveProgressMarker_Boolean_* condition
    )

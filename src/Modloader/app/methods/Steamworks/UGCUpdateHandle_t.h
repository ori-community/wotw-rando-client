...
namespace app::classes::Steamworks::UGCUpdateHandle_t {
    ...
    inline bool operator==(app::UGCUpdateHandle_t x, app::UGCUpdateHandle_t y) { return op_Equality(x, y); }
    inline bool operator!=(app::UGCUpdateHandle_t x, app::UGCUpdateHandle_t y) { return op_Inequality(x, y); }
} // namespace app::classes::Steamworks::UGCUpdateHandle_t

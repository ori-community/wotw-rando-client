...
namespace app::classes::Steamworks::ISteamMatchmakingServerListResponse {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::ISteamMatchmakingServerListResponse* this_ptr,
        app::ISteamMatchmakingServerListResponse_ServerResponded* on_server_responded,
        app::ISteamMatchmakingServerListResponse_ServerFailedToRespond* on_server_failed_to_respond,
        app::ISteamMatchmakingServerListResponse_RefreshComplete* on_refresh_complete
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x015FF030,
        void,
        InternalOnServerFailedToRespond,
        app::ISteamMatchmakingServerListResponse* this_ptr,
        void* thisptr,
        app::HServerListRequest h_request,
        int32_t i_server
    ...
    IL2CPP_REGISTER_METHOD(
        0x015FF060,
        void,
        InternalOnRefreshComplete,
        app::ISteamMatchmakingServerListResponse* this_ptr,
        void* thisptr,
        app::HServerListRequest h_request,
        app::EMatchMakingServerResponse__Enum response
    )

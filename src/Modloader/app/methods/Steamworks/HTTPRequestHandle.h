...
namespace app::classes::Steamworks::HTTPRequestHandle {
    ...
    inline bool operator==(app::HTTPRequestHandle x, app::HTTPRequestHandle y) { return op_Equality(x, y); }
    inline bool operator!=(app::HTTPRequestHandle x, app::HTTPRequestHandle y) { return op_Inequality(x, y); }
} // namespace app::classes::Steamworks::HTTPRequestHandle

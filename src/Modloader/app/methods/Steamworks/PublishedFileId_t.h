...
namespace app::classes::Steamworks::PublishedFileId_t {
    ...
    inline bool operator==(app::PublishedFileId_t x, app::PublishedFileId_t y) { return op_Equality(x, y); }
    inline bool operator!=(app::PublishedFileId_t x, app::PublishedFileId_t y) { return op_Inequality(x, y); }
} // namespace app::classes::Steamworks::PublishedFileId_t

...
namespace app::classes::Steamworks::HServerListRequest {
    ...
    inline bool operator==(app::HServerListRequest x, app::HServerListRequest y) { return op_Equality(x, y); }
    inline bool operator!=(app::HServerListRequest x, app::HServerListRequest y) { return op_Inequality(x, y); }
} // namespace app::classes::Steamworks::HServerListRequest

...
namespace app::classes::Steamworks::ISteamMatchmakingRulesResponse {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::ISteamMatchmakingRulesResponse* this_ptr,
        app::ISteamMatchmakingRulesResponse_RulesResponded* on_rules_responded,
        app::ISteamMatchmakingRulesResponse_RulesFailedToRespond* on_rules_failed_to_respond,
        app::ISteamMatchmakingRulesResponse_RulesRefreshComplete* on_rules_refresh_complete
    )
    IL2CPP_REGISTER_METHOD(0x015FE030, void, Finalize, app::ISteamMatchmakingRulesResponse* this_ptr)
    IL2CPP_REGISTER_METHOD(
        0x015FE140,
        void,
        InternalOnRulesResponded,
        app::ISteamMatchmakingRulesResponse* this_ptr,
        void* thisptr,
        void* pch_rule,
        void* pch_value

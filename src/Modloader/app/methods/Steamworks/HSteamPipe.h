...
namespace app::classes::Steamworks::HSteamPipe {
    ...
    inline bool operator==(app::HSteamPipe x, app::HSteamPipe y) { return op_Equality(x, y); }
    inline bool operator!=(app::HSteamPipe x, app::HSteamPipe y) { return op_Inequality(x, y); }
} // namespace app::classes::Steamworks::HSteamPipe

...
namespace app::classes::Steamworks::SteamLeaderboard_t {
    ...
    inline bool operator==(app::SteamLeaderboard_t x, app::SteamLeaderboard_t y) { return op_Equality(x, y); }
    inline bool operator!=(app::SteamLeaderboard_t x, app::SteamLeaderboard_t y) { return op_Inequality(x, y); }
} // namespace app::classes::Steamworks::SteamLeaderboard_t

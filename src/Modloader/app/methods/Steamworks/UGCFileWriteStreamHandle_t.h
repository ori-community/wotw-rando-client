...
namespace app::classes::Steamworks::UGCFileWriteStreamHandle_t {
    ...
    inline bool operator==(app::UGCFileWriteStreamHandle_t x, app::UGCFileWriteStreamHandle_t y) { return op_Equality(x, y); }
    inline bool operator!=(app::UGCFileWriteStreamHandle_t x, app::UGCFileWriteStreamHandle_t y) { return op_Inequality(x, y); }
} // namespace app::classes::Steamworks::UGCFileWriteStreamHandle_t

...
namespace app::classes::Steamworks::HServerQuery {
    ...
    inline bool operator==(app::HServerQuery x, app::HServerQuery y) { return op_Equality(x, y); }
    inline bool operator!=(app::HServerQuery x, app::HServerQuery y) { return op_Inequality(x, y); }
} // namespace app::classes::Steamworks::HServerQuery

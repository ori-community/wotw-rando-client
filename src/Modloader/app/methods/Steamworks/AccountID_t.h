...
namespace app::classes::Steamworks::AccountID_t {
    ...
    inline bool operator==(app::AccountID_t x, app::AccountID_t y) { return op_Equality(x, y); }
    inline bool operator!=(app::AccountID_t x, app::AccountID_t y) { return op_Inequality(x, y); }
} // namespace app::classes::Steamworks::AccountID_t

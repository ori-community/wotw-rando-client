...
namespace app::classes::Steamworks::SteamLeaderboardEntries_t {
    IL2CPP_REGISTER_METHOD(0x0010FD20, void, ctor, app::SteamLeaderboardEntries_t__Boxed* this_ptr, uint64_t value)
    ...
    IL2CPP_REGISTER_METHOD(0x015F8190, bool, op_Equality, app::SteamLeaderboardEntries_t x, app::SteamLeaderboardEntries_t y)
    IL2CPP_REGISTER_METHOD(0x015F81A0, bool, op_Inequality, app::SteamLeaderboardEntries_t x, app::SteamLeaderboardEntries_t y)
    IL2CPP_REGISTER_METHOD(0x004C50A0, app::SteamLeaderboardEntries_t, op_Explicit_1, uint64_t value)
    ...
    inline bool operator==(app::SteamLeaderboardEntries_t x, app::SteamLeaderboardEntries_t y) { return op_Equality(x, y); }
    inline bool operator!=(app::SteamLeaderboardEntries_t x, app::SteamLeaderboardEntries_t y) { return op_Inequality(x, y); }
} // namespace app::classes::Steamworks::SteamLeaderboardEntries_t

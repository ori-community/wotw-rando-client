...
namespace app::classes::Steamworks::ControllerActionSetHandle_t {
    ...
    inline bool operator==(app::ControllerActionSetHandle_t x, app::ControllerActionSetHandle_t y) { return op_Equality(x, y); }
    inline bool operator!=(app::ControllerActionSetHandle_t x, app::ControllerActionSetHandle_t y) { return op_Inequality(x, y); }
} // namespace app::classes::Steamworks::ControllerActionSetHandle_t

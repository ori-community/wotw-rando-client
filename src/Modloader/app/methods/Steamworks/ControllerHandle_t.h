...
namespace app::classes::Steamworks::ControllerHandle_t {
    ...
    inline bool operator==(app::ControllerHandle_t x, app::ControllerHandle_t y) { return op_Equality(x, y); }
    inline bool operator!=(app::ControllerHandle_t x, app::ControllerHandle_t y) { return op_Inequality(x, y); }
} // namespace app::classes::Steamworks::ControllerHandle_t

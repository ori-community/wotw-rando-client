...
namespace app::classes::Steamworks::ControllerDigitalActionHandle_t {
    ...
    inline bool operator==(app::ControllerDigitalActionHandle_t x, app::ControllerDigitalActionHandle_t y) { return op_Equality(x, y); }
    inline bool operator!=(app::ControllerDigitalActionHandle_t x, app::ControllerDigitalActionHandle_t y) { return op_Inequality(x, y); }
} // namespace app::classes::Steamworks::ControllerDigitalActionHandle_t

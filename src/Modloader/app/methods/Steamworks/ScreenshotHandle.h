...
namespace app::classes::Steamworks::ScreenshotHandle {
    ...
    inline bool operator==(app::ScreenshotHandle x, app::ScreenshotHandle y) { return op_Equality(x, y); }
    inline bool operator!=(app::ScreenshotHandle x, app::ScreenshotHandle y) { return op_Inequality(x, y); }
} // namespace app::classes::Steamworks::ScreenshotHandle

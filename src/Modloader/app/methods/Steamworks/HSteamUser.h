...
namespace app::classes::Steamworks::HSteamUser {
    ...
    inline bool operator==(app::HSteamUser x, app::HSteamUser y) { return op_Equality(x, y); }
    inline bool operator!=(app::HSteamUser x, app::HSteamUser y) { return op_Inequality(x, y); }
} // namespace app::classes::Steamworks::HSteamUser

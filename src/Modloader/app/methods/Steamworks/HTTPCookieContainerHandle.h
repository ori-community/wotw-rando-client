...
namespace app::classes::Steamworks::HTTPCookieContainerHandle {
    ...
    inline bool operator==(app::HTTPCookieContainerHandle x, app::HTTPCookieContainerHandle y) { return op_Equality(x, y); }
    inline bool operator!=(app::HTTPCookieContainerHandle x, app::HTTPCookieContainerHandle y) { return op_Inequality(x, y); }
} // namespace app::classes::Steamworks::HTTPCookieContainerHandle

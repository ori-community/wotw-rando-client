...
namespace app::classes::Steamworks::HAuthTicket {
    ...
    inline bool operator==(app::HAuthTicket x, app::HAuthTicket y) { return op_Equality(x, y); }
    inline bool operator!=(app::HAuthTicket x, app::HAuthTicket y) { return op_Inequality(x, y); }
} // namespace app::classes::Steamworks::HAuthTicket

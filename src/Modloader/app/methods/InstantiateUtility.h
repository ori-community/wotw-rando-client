...
namespace app::classes::InstantiateUtility {
    ...
    IL2CPP_REGISTER_METHOD(
        0x00630000,
        void,
        HandleInstantiationHooks,
        app::GameObject* original,
        app::GameObject* new_object,
        bool pooled,
        double ms_cost,
        bool new_in_pool
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x00632300,
        app::GameObject*,
        InstantiateImmediateOptional,
        app::Object_1* original,
        app::Vector3 position,
        app::Quaternion rotation,
        app::Object_1* owner,
        bool record,
        int32_t frames_to_test_against,
        int32_t allowed_instance_count,
        float distance_threshold
    )
    IL2CPP_REGISTER_METHOD(
        0x006324D0,
        bool,
        CheckAndRegisterInstantiateOptional,
        app::GameObject* original,
        app::Vector3 position,
        app::Quaternion rotation,
        int32_t frames_to_test_against,
    ...
    IL2CPP_REGISTER_METHOD(
        0x015EB360,
        app::BabySein*,
        InstantiateImmediate_10,
        app::BabySein* original,
        app::Vector3 position,
        app::Quaternion rotation,
        app::Object_1* owner,
        bool record
    ...
    IL2CPP_REGISTER_METHOD(
        0x015EB540,
        app::HealthBar*,
        InstantiateImmediate_12,
        app::HealthBar* original,
        app::Vector3 position,
        app::Quaternion rotation,
        app::Transform* parent,
        app::Object_1* owner,
    ...
    IL2CPP_REGISTER_METHOD(
        0x015EB360,
        app::RaceLeaderboardEntry*,
        InstantiateImmediate_14,
        app::RaceLeaderboardEntry* original,
        app::Vector3 position,
        app::Quaternion rotation,
        app::Object_1* owner,
        bool record
    ...
    IL2CPP_REGISTER_METHOD(
        0x015EB010,
        app::RaceLeaderboardScreen*,
        InstantiateImmediate_15,
        app::RaceLeaderboardScreen* original,
        app::Object_1* owner,
        bool record
    )
    IL2CPP_REGISTER_METHOD(
        0x015EB010,
        app::RaceTargetIndicator*,
        InstantiateImmediate_16,
        app::RaceTargetIndicator* original,
        app::Object_1* owner,
        bool record
    )
    IL2CPP_REGISTER_METHOD(
        0x015EB360,
        app::ConfirmOrCancel*,
        InstantiateImmediate_17,
        app::ConfirmOrCancel* original,
        app::Vector3 position,
        app::Quaternion rotation,
        app::Object_1* owner,
        bool record
    ...
    IL2CPP_REGISTER_METHOD(
        0x015EB360,
        app::SoundSource*,
        InstantiateImmediate_18,
        app::SoundSource* original,
        app::Vector3 position,
        app::Quaternion rotation,
        app::Object_1* owner,
        bool record

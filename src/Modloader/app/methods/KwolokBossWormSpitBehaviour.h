...
namespace app::classes::KwolokBossWormSpitBehaviour {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::KwolokBossWormSpitBehaviour* this_ptr,
        app::Collider__Array* colliders1,
        app::Collider__Array* colliders2,
        bool enabled
    )
    IL2CPP_REGISTER_METHOD(
        0x012FAD60,
        ...
        SetCurrentDirection,
        app::KwolokBossWormSpitBehaviour* this_ptr,
        app::KwolokBossWormSpitBehaviour_Direction__Enum dir
    )
    IL2CPP_REGISTER_METHOD(
        0x012FAEC0,
        app::Vector3,
        GetWormSpitDirection,
        app::KwolokBossWormSpitBehaviour* this_ptr,
        app::KwolokBossWormSpitBehaviour_Direction__Enum dir
    )

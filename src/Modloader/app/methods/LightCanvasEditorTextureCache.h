...
namespace app::classes::LightCanvasEditorTextureCache {
    ...
    IL2CPP_REGISTER_METHOD(
        0x01146BF0,
        app::Texture2D*,
        GetLightCanvasEditorTempLightTexture_1,
        app::LightCanvasEditorTextureCache* this_ptr,
        app::LightCanvas* light_canvas
    )
    IL2CPP_REGISTER_METHOD(
        0x01146C40,
        app::Texture2D*,
        GetLightCanvasEditorTempLightTexture_2,
        app::LightCanvasEditorTextureCache* this_ptr,
        app::LightCanvas* light_canvas,
        int32_t state
    )
    IL2CPP_REGISTER_METHOD(
        0x01146C80,
        app::RenderTexture*,
        GetLightCanvasEditorTempLightRenderTexture,
        app::LightCanvasEditorTextureCache* this_ptr,
        app::LightCanvas* light_canvas
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x01146FD0,
        app::Texture2D*,
        CreateNewEditorTempTextureForLightCanvas_1,
        app::LightCanvasEditorTextureCache* this_ptr,
        app::LightCanvas* light_canvas,
        int32_t width,
        int32_t height
    ...
    IL2CPP_REGISTER_METHOD(
        0x01147000,
        app::Texture2D*,
        CreateNewEditorTempTextureForLightCanvas_2,
        app::LightCanvasEditorTextureCache* this_ptr,
        app::LightCanvas* light_canvas,
        int32_t width,
        int32_t height,
    ...
    IL2CPP_REGISTER_METHOD(
        0x011473E0,
        app::RenderTexture*,
        CreateNewEditorTempRenderTextureForLightCanvas,
        app::LightCanvasEditorTextureCache* this_ptr,
        app::LightCanvas* light_canvas,
        int32_t width,
        int32_t height
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        GetTextureDataForLightCanvas_1,
        app::LightCanvasEditorTextureCache* this_ptr,
        app::LightCanvas* light_canvas
    )
    IL2CPP_REGISTER_METHOD(
        0x011477D0,
        app::LightCanvasEditorTextureCache_LightCanvasEditorTextureData,
        GetTextureDataForLightCanvas_2,
        app::LightCanvasEditorTextureCache* this_ptr,
        app::LightCanvas* light_canvas,
        int32_t state
    )

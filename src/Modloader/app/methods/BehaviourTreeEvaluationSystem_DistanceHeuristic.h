...
namespace app::classes::BehaviourTreeEvaluationSystem_DistanceHeuristic {
    IL2CPP_REGISTER_METHOD(
        0x00F9D6D0,
        app::BehaviourTreeEvaluationSystem_AllowedEvaluationSkips__Enum,
        EvaluateHeuristic,
        app::BehaviourTreeEvaluationSystem_DistanceHeuristic* this_ptr,
        app::Vector2 player_position,
        app::Vector2 entity_position
    )

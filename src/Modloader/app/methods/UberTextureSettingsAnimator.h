...
namespace app::classes::UberTextureSettingsAnimator {
    ...
    IL2CPP_REGISTER_METHOD(
        0x01290B60,
        app::UberShaderProperty_Texture__Enum,
        GetTexturePropertyFromTextureName,
        app::UberTextureSettingsAnimator* this_ptr,
        app::UberTextureSettingsAnimator_TextureName__Enum texture_name
    )
    IL2CPP_REGISTER_METHOD(
        0x01290C30,
        app::UberShaderTextureBase*,
        UberShaderTextureBaseFromTextureName,
        app::UberTextureSettingsAnimator* this_ptr,
        app::UberTextureSettingsAnimator_TextureName__Enum texture_name,

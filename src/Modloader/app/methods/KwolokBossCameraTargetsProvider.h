...
namespace app::classes::KwolokBossCameraTargetsProvider {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ModifyPaddings,
        app::KwolokBossCameraTargetsProvider* this_ptr,
        app::Vector2* horizontal_paddings,
        app::Vector2* vertical_paddings
    )
    IL2CPP_REGISTER_METHOD(
        0x0124BB70,
        void,
        ModifyLerping,
        app::KwolokBossCameraTargetsProvider* this_ptr,
        float* camera_target_lerp_speed,
        float* zoom_lerp_speed_dec,
        float* zoom_lerp_speed_inc
    )

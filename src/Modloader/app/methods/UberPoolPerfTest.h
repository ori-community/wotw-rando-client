...
namespace app::classes::UberPoolPerfTest {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        StartTest_2,
        app::UberPoolPerfTest_TestMode__Enum mode,
        bool is_automated_test,
        app::UberPoolPerfTest_Settings* settings
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x00FE1070,
        app::Task*,
        ForcePrefabPrewarmed,
        app::UberPoolPerfTest* this_ptr,
        int32_t count,
    ...
    IL2CPP_REGISTER_METHOD(
        0x00FE11B0,
        app::Task*,
        BenchmarkSinglePrefabInstantiation,
        app::UberPoolPerfTest* this_ptr,
        app::CsvWriter* output_writer,
        app::UberPoolPerfTest_PrefabInfo* info,
        app::Vector3 position,
        app::Stopwatch* stopwatch,
        app::List_1_UnityEngine_GameObject_* instances,
        app::List_1_System_Int64__1* instantiate_timings,
        app::List_1_System_Int64__1* destruction_timings
    )
    IL2CPP_REGISTER_METHOD(
        0x00FE1310,
        app::Task*,
        BenchmarkSinglePrefabProfiler,
        app::UberPoolPerfTest* this_ptr,
        app::CsvWriter* output_writer,
        app::UberPoolPerfTest_PrefabInfo* info,
        app::List_1_UnityEngine_GameObject_* instances,
        app::Vector3__Array* spawn_positions,
        app::IProfilingDataProvider* data_provider
    )
    IL2CPP_REGISTER_METHOD(
        0x00FE1450,
        app::Task*,
        BenchmarkSinglePrefabPrewarm,
        app::UberPoolPerfTest* this_ptr,
        app::CsvWriter* output_writer,
        app::UberPoolPerfTest_PrefabInfo* info,
        app::Stopwatch* stopwatch,
        app::List_1_UnityEngine_GameObject_* instances,
        app::List_1_System_Int64__1* instantiation_timings,
        app::List_1_System_Int64__1* prewarm_timings
    )
    IL2CPP_REGISTER_METHOD(
        0x00FE15A0,
        app::Task*,
        BenchmarkPrefabInfos,
        app::UberPoolPerfTest* this_ptr,
        app::UberPoolPerfTest_LogCatcher* log_catcher,
        app::CsvWriter* output_writer,
        app::Vector3 position,
        app::List_1_UberPoolPerfTest_PrefabInfo_* prefab_infos
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        OpenOutputWriter,
        app::UberPoolPerfTest_TestMode__Enum mode,
        bool use_static_output_file_name,
        int32_t iteration
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        WriteCsvHeader,
        app::UberPoolPerfTest_TestMode__Enum mode,
        app::CsvWriter* writer,
        app::UberPoolPerfTest_Settings* settings
    )
    IL2CPP_REGISTER_METHOD(
        0x00FE32D0,
        void,
        WriteCsvPrefabInfoProfiling,
        app::CsvWriter* writer,
        app::UberPoolPerfTest_PrefabInfo* info,
        app::Double__Array__Array* data,
        int32_t data_length
    )
    IL2CPP_REGISTER_METHOD(
        0x00FE3500,
        void,
        WriteCsvPrefabInfoInstantiations,
        app::CsvWriter* writer,
        app::UberPoolPerfTest_PrefabInfo* info,
        app::UberPoolPerfTest_Timings* instantiation_timings,
        app::UberPoolPerfTest_Timings* destruction_timings
    )
    IL2CPP_REGISTER_METHOD(
        0x00FE3690,
        void,
        WriteCsvPrefabInfoPrewarm,
        app::CsvWriter* writer,
        app::UberPoolPerfTest_PrefabInfo* info,
        app::UberPoolPerfTest_Timings* instantiation_timings,
        app::UberPoolPerfTest_Timings* prewarm_timings
    )

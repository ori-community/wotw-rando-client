...
namespace app::classes::UnityStandardAssets::ImageEffects::DepthOfFieldDeprecated {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Blur,
        app::DepthOfFieldDeprecated* this_ptr,
        app::RenderTexture* from,
        app::RenderTexture* to,
        app::DepthOfFieldDeprecated_DofBlurriness__Enum iterations,
        int32_t blur_pass,
        float spread
    )
    IL2CPP_REGISTER_METHOD(
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        AddBokeh,
        app::DepthOfFieldDeprecated* this_ptr,
        app::RenderTexture* bokeh_info,
        app::RenderTexture* temp_tex,
        app::RenderTexture* final_target
    )

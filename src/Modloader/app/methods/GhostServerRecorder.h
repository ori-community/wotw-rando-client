...
namespace app::classes::GhostServerRecorder {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        StartRecording,
        app::GhostServerRecorder* this_ptr,
        app::Action_1_Byte_* callback,
        app::Rigidbody__Array* rigid_bodies,
        app::ServerConfigurationProperties config,
        app::MoonGuid__Array* targets
    )

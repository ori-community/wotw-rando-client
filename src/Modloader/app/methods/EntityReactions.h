...
namespace app::classes::EntityReactions {
    ...
    IL2CPP_REGISTER_METHOD(
        0x00CA0E80,
        void,
        ExecuteReactionBehaviour,
        app::EntityReactions* this_ptr,
        app::EntityReactionBehaviour* behaviour,
    ...
    IL2CPP_REGISTER_METHOD(
        0x00CA16F0,
        void,
        RegisterReactionInterruptionSuspension,
        app::EntityReactions* this_ptr,
        float duration,
        app::EntityReactionBehaviour__Array* reactions
    )

...
namespace app::classes::RecorderIdUtility {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        int64_t,
        GetFileId_2,
        app::IRecordable* recordable_instance,
        app::GameObject* instance_root,
        app::GameObject* prefab_root
    )
    IL2CPP_REGISTER_METHOD(0x00420EE0, int64_t, GetObjectLocalIdInFile, app::Object_1* unity_obj)
    IL2CPP_REGISTER_METHOD(
        0x008F16D0,
        int64_t,
        SearchForChildRecordableFileId_1,
        app::IRecordable* recordable,
        app::Transform* instance_current,
        app::Transform* prefab_current
    )
    IL2CPP_REGISTER_METHOD(
        0x008F1710,
        int64_t,
        SearchForChildRecordableFileId_2,
        app::Component_1* recordable,
        app::Transform* instance_current,
        app::Transform* prefab_current
    )

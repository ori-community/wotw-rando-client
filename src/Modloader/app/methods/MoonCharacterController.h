...
namespace app::classes::MoonCharacterController {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        RenderVolume,
        app::MoonCharacterController* this_ptr,
        app::Vector3 p1,
        app::Vector3 p2,
        float radius,
        app::Vector3 dir,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::RaycastHit__Array** hit_info,
        float magnitude,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::MoonCharacterController* this_ptr,
        app::Vector3 delta,
        app::MoonControllerColliderHit* moon_hit_info,
        app::QueryTriggerInteraction__Enum trigger_interaction
    )
    IL2CPP_REGISTER_METHOD(
        0x00F45FD0,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::MoonCharacterController* this_ptr,
        app::Vector3 delta,
        app::Vector3 original_delta,
        bool use_safe_movement_code
    )
    IL2CPP_REGISTER_METHOD(
        0x00F46970,
        void,

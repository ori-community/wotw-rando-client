...
namespace app::classes::CharacterPlatformMovement_ScheduledSpeedCurve {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_1,
        app::CharacterPlatformMovement_ScheduledSpeedCurve* this_ptr,
        app::CharacterPlatformMovement_SpeedSpace__Enum space,
        bool additive,
        app::AnimationCurve* curve_x,
        app::AnimationCurve* curve_y,
        float curve_scale_x,
        float curve_scale_y,
        app::Func_1_Boolean_* can_continue
    )
    IL2CPP_REGISTER_METHOD(
        0x01312280,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Step,
        app::CharacterPlatformMovement_ScheduledSpeedCurve* this_ptr,
        app::CharacterPlatformMovement* target,
        float delta_time
    )
} // namespace app::classes::CharacterPlatformMovement_ScheduledSpeedCurve

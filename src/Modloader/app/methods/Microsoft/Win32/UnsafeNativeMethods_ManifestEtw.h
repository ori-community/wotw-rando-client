...
namespace app::classes::Microsoft::Win32::UnsafeNativeMethods_ManifestEtw {
    IL2CPP_REGISTER_METHOD(
        ...
        uint32_t,
        EventRegister,
        app::Guid* provider_id,
        app::UnsafeNativeMethods_ManifestEtw_EtwEnableCallback* enable_callback,
        app::Void* callback_context,
        int64_t* registration_handle
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t user_data_count,
        app::EventProvider_EventData* user_data
    )
    IL2CPP_REGISTER_METHOD(
        0x023B73B0,
        int32_t,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::UnsafeNativeMethods_ManifestEtw_ActivityControl__Enum control_code,
        app::Guid* activity_id
    )
    IL2CPP_REGISTER_METHOD(
        0x023B7530,
        ...
        EventSetInformation,
        int64_t registration_handle,
        app::UnsafeNativeMethods_ManifestEtw_EVENT_INFO_CLASS__Enum information_class,
        app::Void* event_information,
        int32_t information_length
    )
    IL2CPP_REGISTER_METHOD(
        0x023B75F0,
        int32_t,
        EnumerateTraceGuidsEx,
        app::UnsafeNativeMethods_ManifestEtw_TRACE_QUERY_INFO_CLASS__Enum trace_query_info_class,
        app::Void* in_buffer,
        int32_t in_buffer_size,
        app::Void* out_buffer,
        int32_t out_buffer_size,
        int32_t* return_length
    )
} // namespace app::classes::Microsoft::Win32::UnsafeNativeMethods_ManifestEtw

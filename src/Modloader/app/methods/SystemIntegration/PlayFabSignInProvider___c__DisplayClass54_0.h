...
namespace app::classes::SystemIntegration::PlayFabSignInProvider___c__DisplayClass54_0 {
    ...
    IL2CPP_REGISTER_METHOD(
        0x005214C0,
        void,
        _PlayFabPlatformLinkUpdate_b__0,
        app::PlayFabSignInProvider_c_DisplayClass54_0* this_ptr,
        app::LinkXboxAccountResult* res
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x005214C0,
        void,
        _PlayFabPlatformLinkUpdate_b__2,
        app::PlayFabSignInProvider_c_DisplayClass54_0* this_ptr,
        app::LinkSteamAccountResult* res
    )

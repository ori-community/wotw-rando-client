...
namespace app::classes::SystemIntegration::Races::PlayFabRaceServiceProvider {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::PlayFabRaceServiceProvider* this_ptr,
        app::IDataProvider* statistics_provider_provider,
        app::PlayFabSignInProvider* play_fab_sign_in_provider
    )
    IL2CPP_REGISTER_METHOD(
        0x00524950,
        void,
        LoadRaceCacheFor,
        app::PlayFabRaceServiceProvider* this_ptr,
        app::IEnumerable_1_System_String_* race_ids,
        app::RaceDataLeaderBoardType__Enum type,
    ...
    IL2CPP_REGISTER_METHOD(
        0x00525390,
        app::RaceRequestResult*,
        ProcessCachedLeaderBoardList,
        app::PlayFabRaceServiceProvider* this_ptr,
        app::RaceDataCache* data_cache
    )
    IL2CPP_REGISTER_METHOD(
        0x00525730,
        app::Task_1_SystemIntegration_Races_RaceRequestResult_*,
        ProcessLeaderBoardList,
        app::PlayFabRaceServiceProvider* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::RaceDataLeaderBoardType__Enum type,
        app::LeaderboardFilter__Enum filter,
        app::PlayerProfileModel* profile
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x00525EC0,
        bool,
        TryGetDeveloperGhostDataForRace,
        app::PlayFabRaceServiceProvider* this_ptr,
        app::String* race_id,
        app::LeaderBoardEntry** entry
    )
    IL2CPP_REGISTER_METHOD(
        0x00526060,
        void,
        SaveDeveloperGhostDataForRace,
        app::PlayFabRaceServiceProvider* this_ptr,
        app::String* race_id,
        int32_t score,
        app::Byte__Array* data

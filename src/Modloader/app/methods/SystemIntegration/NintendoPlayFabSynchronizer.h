...
namespace app::classes::SystemIntegration::NintendoPlayFabSynchronizer {
    ...
    IL2CPP_REGISTER_METHOD(
        0x002FA000,
        void,
        OnPlayFabFriendsRetrieved,
        app::NintendoPlayFabSynchronizer* this_ptr,
        app::GetFriendsListResult* friend_list_result
    )
    IL2CPP_REGISTER_METHOD(
        0x00517720,
        void,
        OnAllFriendDataRetrieved,
        app::NintendoPlayFabSynchronizer* this_ptr,
        app::GetPlayFabIDsFromNintendoSwitchDeviceIdsResult* pair_result,
        app::GetFriendsListResult* friend_list_result
    )

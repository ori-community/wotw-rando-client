...
namespace app::classes::SystemIntegration::Synchronizer::Achievements::XalAchievements {
    ...
    IL2CPP_REGISTER_METHOD(
        0x00531180,
        void,
        HeaderAndArgsForGetAchievements,
        app::String* full_address,
        app::String* method_1,
        app::String* body,
        app::List_1_Microsoft_Xbox_Services_Xal_XalHttpHeader_** headers,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        CallMethodWith,
        app::String* full_address,
        app::HttpMethod* method_1,
        app::String* body,
        app::IEnumerable_1_Microsoft_Xbox_Services_Xal_XalHttpHeader_* headers,
        app::String* signature,
        app::String* token,
        app::Action_1_String_* on_complete,
        app::Action_1_String_* on_error
    )
    IL2CPP_REGISTER_METHOD(
        0x00531C80,
        void,
        Perform,
        app::UnityWebRequest* request,
        app::IEnumerable_1_Microsoft_Xbox_Services_Xal_XalHttpHeader_* headers,
        app::String* signature,
        app::String* token,
        app::Action_1_String_* on_complete,

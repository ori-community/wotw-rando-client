...
namespace app::classes::XGamingRuntime::SDK_XBL {
    IL2CPP_REGISTER_METHOD(
        ...
        app::XblAchievementsResultHandle* result_handle,
        app::XblAchievement__Array** achievements
    )
    IL2CPP_REGISTER_METHOD(
        0x030B9520,
        void,
        XblAchievementsGetAchievementsForTitleIdAsync,
        app::XblContextHandle* xbox_live_context,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        uint64_t xbox_user_id,
        uint32_t title_id,
        app::String* service_configuration_id,
        app::String* achievement_id,
        uint32_t percent_complete,
        app::SDK_XBL_XblAchievementsUpdateAchievementForTitleIdResult* completion_routine
    )

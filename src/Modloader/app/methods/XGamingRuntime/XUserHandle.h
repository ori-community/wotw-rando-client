...
namespace app::classes::XGamingRuntime::XUserHandle {
    ...
    inline bool operator==(app::XUserHandle& handle1, app::XUserHandle& handle2) { return op_Equality(&handle1, &handle2); }
} // namespace app::classes::XGamingRuntime::XUserHandle

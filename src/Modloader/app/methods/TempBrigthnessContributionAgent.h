...
namespace app::classes::TempBrigthnessContributionAgent {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_1,
        app::TempBrigthnessContributionAgent__Boxed* this_ptr,
        app::IBrigthnessContributionAgent* agent,
        app::Ease_Easing__Enum easing,
        float speed,
        float timer
    )
    IL2CPP_REGISTER_METHOD(
        ...
        app::TempBrigthnessContributionAgent__Boxed* this_ptr,
        app::IBrigthnessContributionAgent* agent,
        app::WeightController* weight_controller
    )
    IL2CPP_REGISTER_METHOD(
        0x0010E170,
    ...
    IL2CPP_REGISTER_METHOD(
        0x0010DB80,
        void,
        set_BrightnessInfluceOrder,
        app::TempBrigthnessContributionAgent__Boxed* this_ptr,
        app::GlobalBrightnessController_BrigthnessContributionOrder__Enum value
    )

...
namespace app::classes::PlayFab::OneDSEventsAPI {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        SetCredentials,
        app::OneDSEventsAPI* this_ptr,
        app::String* project_id_ikey,
        app::String* ingestion_key,
        app::String* jwt_token,
        app::String* header_jwt_ticket_key,
        app::String* header_jwt_ticket_prefix
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        GetTelemetryIngestionConfigAsync,
        app::TelemetryIngestionConfigRequest* request,
        app::Object* custom_data,
        app::Dictionary_2_System_String_System_String_* extra_headers
    )

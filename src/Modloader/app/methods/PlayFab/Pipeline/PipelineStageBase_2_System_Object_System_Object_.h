...
namespace app::classes::PlayFab::Pipeline::PipelineStageBase_2_System_Object_System_Object_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        RunStage,
        app::PipelineStageBase_2_System_Object_System_Object_* this_ptr,
        app::BlockingCollection_1_System_Object_* input,
        app::BlockingCollection_1_System_Object_* output,

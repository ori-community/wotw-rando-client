...
namespace app::classes::PlayFab::Pipeline::EventBatchingStage__GetInputConsumingEnumerable_d__19 {
    ...
    IL2CPP_REGISTER_METHOD(
        0x002FB930,
        app::IPlayFabEmitEventRequest*,
        IEnumerator_IPlayFabEmitEventRequest__get_Current,
        app::EventBatchingStage_GetInputConsumingEnumerable_d_19* this_ptr
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x017AFAF0,
        app::IEnumerator_1_PlayFab_IPlayFabEmitEventRequest_*,
        IEnumerable_IPlayFabEmitEventRequest__GetEnumerator,
        app::EventBatchingStage_GetInputConsumingEnumerable_d_19* this_ptr
    )

...
namespace app::classes::PlayFab::Pipeline::EventSendingStage {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        FulfillPromises,
        app::EventSendingStage* this_ptr,
        app::List_1_PlayFab_IPlayFabEmitEventRequest_* batch,
        app::PlayFabResult_1_PlayFab_EventsModels_WriteEventsResponse_* play_fab_result
    )
} // namespace app::classes::PlayFab::Pipeline::EventSendingStage

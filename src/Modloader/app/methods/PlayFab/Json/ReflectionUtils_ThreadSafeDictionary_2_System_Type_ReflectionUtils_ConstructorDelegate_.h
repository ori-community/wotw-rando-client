...
namespace app::classes::PlayFab::Json::ReflectionUtils_ThreadSafeDictionary_2_System_Type_ReflectionUtils_ConstructorDelegate_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::ReflectionUtils_ThreadSafeDictionary_2_System_Type_ReflectionUtils_ConstructorDelegate_* this_ptr,
        app::ReflectionUtils_ThreadSafeDictionaryValueFactory_2_System_Type_ReflectionUtils_ConstructorDelegate_* value_factory
    )
}

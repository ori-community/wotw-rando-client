...
namespace app::classes::PlayFab::PlayFabDataInstanceAPI {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_4,
        app::PlayFabDataInstanceAPI* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        AbortFileUploads,
        app::PlayFabDataInstanceAPI* this_ptr,
        app::AbortFileUploadsRequest* request,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        DeleteFiles,
        app::PlayFabDataInstanceAPI* this_ptr,
        app::DeleteFilesRequest* request,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        InitiateFileUploads,
        app::PlayFabDataInstanceAPI* this_ptr,
        app::InitiateFileUploadsRequest* request,

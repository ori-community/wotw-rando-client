...
namespace app::classes::PlayerInputRebinding_KeyBindingSettings__GetKeysIterator_d__74 {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        System_Collections_Generic_IEnumerator_PlayerInputRebinding_PlayerInputKey__get_Current,
        app::PlayerInputRebinding_KeyBindingSettings_GetKeysIterator_d_74* this_ptr
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x01426ED0,
        app::IEnumerator_1_PlayerInputRebinding_PlayerInputKey_*,
        System_Collections_Generic_IEnumerable_PlayerInputRebinding_PlayerInputKey__GetEnumerator,
        app::PlayerInputRebinding_KeyBindingSettings_GetKeysIterator_d_74* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x014270C0,

...
namespace app::classes::CharacterGravity {
    ...
    IL2CPP_REGISTER_METHOD(
        0x01051FC0,
        void,
        add_ModifyGravityPlatformMovementSettingsEvent,
        app::CharacterGravity* this_ptr,
        app::Action_1_GravityPlatformMovementSettings_* value
    )
    IL2CPP_REGISTER_METHOD(
        0x010520B0,
        void,
        remove_ModifyGravityPlatformMovementSettingsEvent,
        app::CharacterGravity* this_ptr,
        app::Action_1_GravityPlatformMovementSettings_* value
    )

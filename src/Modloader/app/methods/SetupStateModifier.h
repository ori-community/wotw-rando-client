...
namespace app::classes::SetupStateModifier {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::SetupStateModifier* this_ptr,
        int32_t guid,
        app::List_1_SetupState_* states,
        app::Type* modifier_data_type
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        GetCorrectUberStateModifierDataType,
        app::SetupStateModifier* this_ptr,
        app::SetupStateModifierData* uber_state_modifier_data
    )

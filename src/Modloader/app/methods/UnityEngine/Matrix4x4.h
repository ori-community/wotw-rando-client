...
namespace app::classes::UnityEngine::Matrix4x4 {
    ...
    inline app::Matrix4x4 operator*(app::Matrix4x4 lhs, app::Matrix4x4 rhs) { return op_Multiply_1(lhs, rhs); }
    inline app::Vector4 operator*(app::Matrix4x4 lhs, app::Vector4 vector) { return op_Multiply_2(lhs, vector); }
    inline bool operator==(app::Matrix4x4 lhs, app::Matrix4x4 rhs) { return op_Equality(lhs, rhs); }
    inline bool operator!=(app::Matrix4x4 lhs, app::Matrix4x4 rhs) { return op_Inequality(lhs, rhs); }
} // namespace app::classes::UnityEngine::Matrix4x4

...
namespace app::classes::UnityEngine::Vector4 {
    ...
    inline app::Vector4 operator+(app::Vector4 a, app::Vector4 b) { return op_Addition(a, b); }
    inline app::Vector4 operator-(app::Vector4 a, app::Vector4 b) { return op_Subtraction(a, b); }
    inline app::Vector4 operator*(app::Vector4 a, float d) { return op_Multiply_1(a, d); }
    inline app::Vector4 operator*(float d, app::Vector4 a) { return op_Multiply_2(d, a); }
    inline app::Vector4 operator/(app::Vector4 a, float d) { return op_Division(a, d); }
    inline bool operator==(app::Vector4 lhs, app::Vector4 rhs) { return op_Equality(lhs, rhs); }
    inline bool operator!=(app::Vector4 lhs, app::Vector4 rhs) { return op_Inequality(lhs, rhs); }
} // namespace app::classes::UnityEngine::Vector4

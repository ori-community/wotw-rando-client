...
namespace app::classes::UnityEngine::Vector2 {
    ...
    inline app::Vector2 operator+(app::Vector2 a, app::Vector2 b) { return op_Addition(a, b); }
    inline app::Vector2 operator-(app::Vector2 a, app::Vector2 b) { return op_Subtraction(a, b); }
    inline app::Vector2 operator*(app::Vector2 a, app::Vector2 b) { return op_Multiply_1(a, b); }
    inline app::Vector2 operator/(app::Vector2 a, app::Vector2 b) { return op_Division_1(a, b); }
    inline app::Vector2 operator-(app::Vector2 a) { return op_UnaryNegation(a); }
    inline app::Vector2 operator*(app::Vector2 a, float d) { return op_Multiply_2(a, d); }
    inline app::Vector2 operator*(float d, app::Vector2 a) { return op_Multiply_3(d, a); }
    inline app::Vector2 operator/(app::Vector2 a, float d) { return op_Division_2(a, d); }
    inline bool operator==(app::Vector2 lhs, app::Vector2 rhs) { return op_Equality(lhs, rhs); }
    inline bool operator!=(app::Vector2 lhs, app::Vector2 rhs) { return op_Inequality(lhs, rhs); }
} // namespace app::classes::UnityEngine::Vector2

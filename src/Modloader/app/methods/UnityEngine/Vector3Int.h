...
namespace app::classes::UnityEngine::Vector3Int {
    ...
    inline app::Vector3Int operator-(app::Vector3Int a, app::Vector3Int b) { return op_Subtraction(a, b); }
    inline bool operator==(app::Vector3Int lhs, app::Vector3Int rhs) { return op_Equality(lhs, rhs); }
} // namespace app::classes::UnityEngine::Vector3Int

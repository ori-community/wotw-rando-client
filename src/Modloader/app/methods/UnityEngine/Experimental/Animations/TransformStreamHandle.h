...
namespace app::classes::UnityEngine::Experimental::Animations::TransformStreamHandle {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        SetPositionInternal,
        app::TransformStreamHandle__Boxed* this_ptr,
        app::AnimationStream* stream,
    ...
    IL2CPP_REGISTER_METHOD(
        0x030870E0,
        void,
        GetPositionInternal_Injected,
        app::TransformStreamHandle* _unity_self,
        app::AnimationStream* stream,
        app::Vector3* ret
    )
    IL2CPP_REGISTER_METHOD(

...
namespace app::classes::UnityEngine::Experimental::Rendering::ScriptableRenderContext {
    ...
    IL2CPP_REGISTER_METHOD(
        0x001F1D00,
        void,
        PrepareDrawRenderers_Internal,
        app::ScriptableRenderContext__Boxed* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        0x001F1E40,
        void,
        DrawRenderers_StateBlock_Internal,
        app::ScriptableRenderContext__Boxed* this_ptr,
        app::FilterResults renderers,
        app::DrawRendererSettings* draw_settings,
        app::FilterRenderersSettings filter_settings,
        app::RenderStateBlock state_block
    )
    IL2CPP_REGISTER_METHOD(
        0x001F1F40,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        0x02524AF0,
        void,
        PrepareDrawRenderers_Internal_Injected,
        app::ScriptableRenderContext* _unity_self,
        app::FilterResults* renderers,
        app::DrawRendererSettings* draw_settings,
        app::FilterRenderersSettings* filter_settings
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x02524BF0,
        void,
        DrawRenderers_StateBlock_Internal_Injected,
        app::ScriptableRenderContext* _unity_self,
        app::FilterResults* renderers,
        app::DrawRendererSettings* draw_settings,
        app::FilterRenderersSettings* filter_settings,

...
namespace app::classes::UnityEngine::Experimental::Rendering::CullResults {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Camera* camera,
        bool stereo_aware,
        app::ScriptableCullingParameters* culling_parameters,
        int32_t managed_culling_parameters_size
    )
    IL2CPP_REGISTER_METHOD(
        0x02433410,
        void,
        Internal_Cull,
        app::ScriptableCullingParameters* parameters,
        app::ScriptableRenderContext render_loop,
        app::CullResults* results
    )
    IL2CPP_REGISTER_METHOD(
        0x02433480,
        void,

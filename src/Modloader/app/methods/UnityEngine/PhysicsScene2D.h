...
namespace app::classes::UnityEngine::PhysicsScene2D {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::RaycastHit2D,
        Raycast_1,
        app::PhysicsScene2D__Boxed* this_ptr,
        app::Vector2 origin,
    ...
    IL2CPP_REGISTER_METHOD(
        0x03171FE0,
        int32_t,
        GetRayIntersectionNonAlloc_Internal,
        app::PhysicsScene2D physics_scene,
        app::Vector3 origin,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        float distance,
        app::ContactFilter2D* contact_filter,
        app::RaycastHit2D* ret
    )
    IL2CPP_REGISTER_METHOD(
        0x03172170,
        int32_t,
        RaycastNonAlloc_Internal_Injected,
        app::PhysicsScene2D* physics_scene,
        app::Vector2* origin,
        app::Vector2* direction,
        float distance,
    ...
    IL2CPP_REGISTER_METHOD(
        0x03172200,
        int32_t,
        GetRayIntersectionNonAlloc_Internal_Injected,
        app::PhysicsScene2D* physics_scene,
        app::Vector3* origin,
        app::Vector3* direction,
        float distance,
    ...
    IL2CPP_REGISTER_METHOD(
        0x03172290,
        int32_t,
        OverlapCollider_Internal_Injected,
        app::Collider2D* collider,
        app::ContactFilter2D* contact_filter,
        app::Collider2D__Array* results
    )

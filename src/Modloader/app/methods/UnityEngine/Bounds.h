...
namespace app::classes::UnityEngine::Bounds {
    ...
    inline bool operator==(app::Bounds lhs, app::Bounds rhs) { return op_Equality(lhs, rhs); }
    inline bool operator!=(app::Bounds lhs, app::Bounds rhs) { return op_Inequality(lhs, rhs); }
} // namespace app::classes::UnityEngine::Bounds

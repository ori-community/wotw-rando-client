...
namespace app::classes::UnityEngine::TextGenerator {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        bool,
        PopulateWithErrors,
        app::TextGenerator* this_ptr,
        app::String* str,
        app::TextGenerationSettings settings,
        app::GameObject* context
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        float scale_factor,
        float line_spacing,
        app::FontStyle__Enum style,
        bool rich_text,
        bool resize_text_for_best_fit,
        int32_t resize_text_min_size,
        int32_t resize_text_max_size,
        int32_t vertical_over_flow,
        int32_t horizontal_overflow,
        bool update_bounds,
        app::TextAnchor__Enum anchor,
        float extents_x,
        float extents_y,
        float pivot_x,
        float pivot_y,
        bool generate_out_of_bounds,
        bool align_by_geometry,
        uint32_t* error
    )
    IL2CPP_REGISTER_METHOD(
        0x0319D170,
        ...
        int32_t resize_text_min_size,
        int32_t resize_text_max_size,
        app::VerticalWrapMode__Enum vertical_over_flow,
        app::HorizontalWrapMode__Enum horizontal_overflow,
        bool update_bounds,
        app::TextAnchor__Enum anchor,
        app::Vector2 extents,
        app::Vector2 pivot,
        bool generate_out_of_bounds,
        bool align_by_geometry,
        app::TextGenerationError__Enum* error
    )

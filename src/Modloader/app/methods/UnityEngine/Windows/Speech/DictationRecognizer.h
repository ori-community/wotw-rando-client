...
namespace app::classes::UnityEngine::Windows::Speech::DictationRecognizer {
    ...
    IL2CPP_REGISTER_METHOD(
        0x02C79DB0,
        void,
        DictationRecognizer_InvokeResultGeneratedEvent,
        app::DictationRecognizer* this_ptr,
        app::String* keyword,
        app::ConfidenceLevel__Enum minimum_confidence
    )
    IL2CPP_REGISTER_METHOD(
        0x02C79DD0,
        void,
        DictationRecognizer_InvokeCompletedEvent,
        app::DictationRecognizer* this_ptr,

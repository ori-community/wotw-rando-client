...
namespace app::classes::UnityEngine::Color {
    ...
    inline app::Color operator+(app::Color a, app::Color b) { return op_Addition(a, b); }
    inline app::Color operator-(app::Color a, app::Color b) { return op_Subtraction(a, b); }
    inline app::Color operator*(app::Color a, app::Color b) { return op_Multiply_1(a, b); }
    inline app::Color operator*(app::Color a, float b) { return op_Multiply_2(a, b); }
    inline app::Color operator*(float b, app::Color a) { return op_Multiply_3(b, a); }
    inline app::Color operator/(app::Color a, float b) { return op_Division(a, b); }
    inline bool operator==(app::Color lhs, app::Color rhs) { return op_Equality(lhs, rhs); }
    inline bool operator!=(app::Color lhs, app::Color rhs) { return op_Inequality(lhs, rhs); }
} // namespace app::classes::UnityEngine::Color

...
namespace app::classes::UnityEngine::Quaternion {
    ...
    inline app::Quaternion operator*(app::Quaternion lhs, app::Quaternion rhs) { return op_Multiply_1(lhs, rhs); }
    inline app::Vector3 operator*(app::Quaternion rotation, app::Vector3 point) { return op_Multiply_2(rotation, point); }
    inline bool operator==(app::Quaternion lhs, app::Quaternion rhs) { return op_Equality(lhs, rhs); }
    inline bool operator!=(app::Quaternion lhs, app::Quaternion rhs) { return op_Inequality(lhs, rhs); }
} // namespace app::classes::UnityEngine::Quaternion

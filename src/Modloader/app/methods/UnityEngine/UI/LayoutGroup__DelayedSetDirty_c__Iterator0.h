...
namespace app::classes::UnityEngine::UI::LayoutGroup__DelayedSetDirty_c__Iterator0 {
    ...
    IL2CPP_REGISTER_METHOD(0x0265B870, bool, MoveNext, app::LayoutGroup_DelayedSetDirty_c_Iterator0* this_ptr)
    IL2CPP_REGISTER_METHOD(0x01F25880, app::Object*, IEnumerator_object__get_Current, app::LayoutGroup_DelayedSetDirty_c_Iterator0* this_ptr)

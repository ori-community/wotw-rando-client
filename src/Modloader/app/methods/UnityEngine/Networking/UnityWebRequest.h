...
namespace app::classes::UnityEngine::Networking::UnityWebRequest {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_3,
        app::UnityWebRequest* this_ptr,
        app::String* url,
        app::String* method_1,
        app::DownloadHandler* download_handler,
        app::UploadHandler* upload_handler
    )
    IL2CPP_REGISTER_METHOD(
        0x0317E5F0,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        0x0317ED40,
        app::UnityWebRequest_UnityWebRequestError__Enum,
        SetMethod,
        app::UnityWebRequest* this_ptr,
        app::UnityWebRequest_UnityWebRequestMethod__Enum method_type
    )

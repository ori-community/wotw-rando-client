...
namespace app::classes::UberShaderRuntimeUpdate {
    ...
    IL2CPP_REGISTER_METHOD(
        0x01285DC0,
        void,
        RegisterRuntimeWorldProjectionAnchoredTexture,
        app::UberShaderRuntimeUpdate* this_ptr,
        app::UberShaderRuntimeAnchoredTexture* uber_shader_runtime_achored_texture
    )
    IL2CPP_REGISTER_METHOD(
        0x01285E60,
        void,
        UnregisterRuntimeWorldProjectionAnchoredTexture,
        app::UberShaderRuntimeUpdate* this_ptr,
        app::UberShaderRuntimeAnchoredTexture* uber_shader_runtime_achored_texture
    )

...
namespace app::classes::HorizontalPlatformMovementSettings_SpeedSet {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        CopyFrom,
        app::HorizontalPlatformMovementSettings_SpeedSet* this_ptr,
        app::HorizontalPlatformMovementSettings_SpeedSet* speed_set
    )
    IL2CPP_REGISTER_METHOD(
        0x00B60620,
        void,
        ...
        app::HorizontalPlatformMovementSettings_SpeedSet* this_ptr,
        app::HorizontalPlatformMovementSettings_SpeedMultiplierSet* speed_multiplier_set
    )

...
namespace app::classes::SeinGlowSpell_GlowLightInfo {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::SeinGlowSpell_GlowLightInfo* this_ptr,
        float min_radius,
        float max_radius,
        float on_duration,
        app::AnimationCurve* turn_on_curve,
        app::AnimationCurve* turn_off_curve,
        app::SeinGlowSpell_GlowType__Enum glow_type,
        app::Transform* effect
    )

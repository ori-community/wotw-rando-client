...
namespace app::classes::FullSerializer::Internal::fsVersionedType {
    ...
    inline bool operator==(app::fsVersionedType a, app::fsVersionedType b) { return op_Equality(a, b); }
    inline bool operator!=(app::fsVersionedType a, app::fsVersionedType b) { return op_Inequality(a, b); }
} // namespace app::classes::FullSerializer::Internal::fsVersionedType

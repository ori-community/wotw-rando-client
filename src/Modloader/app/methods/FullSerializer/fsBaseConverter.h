...
namespace app::classes::FullSerializer::fsBaseConverter {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Type* override_converter_type,
        app::String* name,
        app::GradientAlphaKey__Array* value
    )
    IL2CPP_REGISTER_METHOD(
        0x018EBC00,
        app::fsResult,
        ...
        app::Type* override_converter_type,
        app::String* name,
        app::GradientColorKey__Array* value
    )
    IL2CPP_REGISTER_METHOD(
        0x018EAA70,
        app::fsResult,
        DeserializeMember_19,
        app::fsBaseConverter* this_ptr,
        app::Dictionary_2_System_String_FullSerializer_fsData_* data,
        app::Type* override_converter_type,
        app::String* name,

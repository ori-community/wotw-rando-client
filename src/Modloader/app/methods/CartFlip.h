...
namespace app::classes::CartFlip {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Collider*,
        CheckAboveCart,
        app::CartFlip* this_ptr,
        app::Collider* ignored_collider,
        app::Rail* current_rail,
        app::CapsuleCollider* capsule_collider,
        app::Transform* go_through_above_rail_raycast_position,
        int32_t rail_mask
    )

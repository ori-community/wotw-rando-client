...
namespace app::classes::AkTransform {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Set_1,
        app::AkTransform* this_ptr,
        app::AkVector* in_position,
        app::AkVector* in_orientation_front,
        app::AkVector* in_orientation_top
    )
    IL2CPP_REGISTER_METHOD(
        0x026FE7A0,
        void,
        ...
        float in_position_y,
        float in_position_z,
        float in_orient_front_x,
        float in_orient_front_y,
        float in_orient_front_z,
        float in_orient_top_x,
        float in_orient_top_y,
        float in_orient_top_z
    )

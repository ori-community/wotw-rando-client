...
namespace app::classes::SceneFrameworkDebugger {
    ...
    IL2CPP_REGISTER_METHOD(
        0x00B9DFC0,
        app::String*,
        _getColorForBoostMode,
        app::SceneFrameworkDebugger* this_ptr,
        app::LoadingBoostController_BoostModeLevel__Enum level
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x00B9E060,
        void,
        BoostModeChangedState,
        app::SceneFrameworkDebugger* this_ptr,
        app::LoadingBoostController_BoostModeLevel__Enum old,
        app::LoadingBoostController_BoostModeLevel__Enum new_level
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::SceneState__Enum old_state,

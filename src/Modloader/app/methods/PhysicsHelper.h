...
namespace app::classes::PhysicsHelper {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        CalculateArcForce_2,
        app::Vector2 origin,
        app::Vector2 final_point,
        float gravity,
        float speed,
        app::Vector2* force_low,
        app::Vector2* force_high
    )
    IL2CPP_REGISTER_METHOD(
        0x01500D20,
        void,
        CalculateBestArcForce,
        app::Vector2 origin,
        app::Vector2 final_point,
        float gravity,
        float speed,
    ...
    IL2CPP_REGISTER_METHOD(
        0x01501030,
        app::Vector2,
        CalculateArcForceBySpeed,
        app::Vector2 start_location,
        app::Vector2 end_location,
        float gravity,
        float speed,
        float peak,
        float rot
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Vector2 final_point,
        float gravity,
        app::Vector2 arc_peak,
        float* duration
    )
    IL2CPP_REGISTER_METHOD(
        0x01501410,
        app::Vector2,
        CalculateArcForceVariablePeak,
        app::Vector2 origin,
        app::Vector2 final_point,
        float gravity,
        app::Vector2 arc_peak,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Vector3 speed,
        float duration,
        app::LayerMask layer_mask,
        app::GameObject* target,
        app::RaycastHit* final_hit_info,
        float hit_tolerance
    )
    IL2CPP_REGISTER_METHOD(
        0x01501EE0,

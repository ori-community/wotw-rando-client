...
namespace app::classes::FoxEnemy2 {
    ...
    IL2CPP_REGISTER_METHOD(
        0x01283DF0,
        void,
        StateMachineBehaviourProxy_IReceiver_OnStateMachineBehaviourEnter,
        app::FoxEnemy2* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        0x01284390,
        void,
        StateMachineBehaviourProxy_IReceiver_OnStateMachineBehaviourUpdate,
        app::FoxEnemy2* this_ptr,
        app::Animator* animator,
        app::AnimatorStateInfo state_info,
        int32_t layer_index
    ...
    IL2CPP_REGISTER_METHOD(
        0x012847B0,
        void,
        StateMachineBehaviourProxy_IReceiver_OnStateMachineBehaviourExit,
        app::FoxEnemy2* this_ptr,
        app::Animator* animator,
        app::AnimatorStateInfo state_info,
        int32_t layer_index

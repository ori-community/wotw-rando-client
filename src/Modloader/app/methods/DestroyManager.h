...
namespace app::classes::DestroyManager {
    ...
    IL2CPP_REGISTER_METHOD(
        0x00B8AC80,
        void,
        DestroyResourcesAsync,
        app::DestroyManager* this_ptr,
        app::List_1_UnityEngine_Object_* resources,
        app::Action* callback
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x00B8BD30,
        void,
        ProcessActiveCountAndCallbacks,
        app::DestroyManager* this_ptr,
        app::List_1_DestroyManager_CountAndCallback_* active_list
    )
} // namespace app::classes::DestroyManager

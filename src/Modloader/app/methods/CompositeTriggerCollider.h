...
namespace app::classes::CompositeTriggerCollider {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        PropagateTrigger,
        app::CompositeTriggerCollider* this_ptr,
        app::String* message,
        app::IEnumerable_1_UnityEngine_Collider_* colliders_to_process,
        app::Func_2_UnityEngine_Collider_Boolean_* should_propagate
    )

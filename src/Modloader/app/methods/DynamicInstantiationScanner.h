...
namespace app::classes::DynamicInstantiationScanner {
    ...
    IL2CPP_REGISTER_METHOD(
        0x030E15C0,
        app::DynamicInstantiationScanner_Visitor*,
        GetVisitor,
        app::DynamicInstantiationScanner* this_ptr,
        app::Type* type,
        app::FieldInfo_1* declaring_field
    )
    IL2CPP_REGISTER_METHOD(
        0x030E20A0,
        void,
        EvaluateComponentOrScriptableObject,
        app::DynamicInstantiationScanner* this_ptr,
        app::Object_1* obj,
    ...
    IL2CPP_REGISTER_METHOD(
        0x030E2940,
        app::List_1_DynamicInstantiationDescriptor_*,
        FromMonoBehaviour,
        app::DynamicInstantiationScanner* this_ptr,
        app::MonoBehaviour* component
    )

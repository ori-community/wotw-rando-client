...
namespace app::classes::VirtualClipsBuilder {
    ...
    IL2CPP_REGISTER_METHOD(
        0x01E96DA0,
        app::VirtualClipsBuilder*,
        AddClip,
        app::VirtualClipsBuilder* this_ptr,
        app::ITimelineEntity* entity,
        float lenght_multiplier,
        bool register_as_last_clip
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        bool should_hide_header,
        bool use_horizontal_collapse
    )
    IL2CPP_REGISTER_METHOD(
        0x01E978E0,
        app::VirtualClipsBuilder*,
        StartGroup_2,
        app::VirtualClipsBuilder* this_ptr,
        app::VirtualTimelineRepresentationGroup__Enum group_type,
        bool expand_by_default
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Attach,
        app::VirtualClipsBuilder* this_ptr,
        app::ITimelineEntity* attached,
        app::ITimelineEntity* holder
    )
} // namespace app::classes::VirtualClipsBuilder

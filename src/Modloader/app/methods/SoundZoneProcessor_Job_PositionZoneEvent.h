...
namespace app::classes::SoundZoneProcessor_Job_PositionZoneEvent {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_1,
        app::SoundZoneProcessor_Job_PositionZoneEvent__Boxed* this_ptr,
        app::SoundZoneProcessor_Job_PositionZoneEventType__Enum event_type,
        app::SoundZoneProcessor_Job_ZoneType__Enum zone_type,
        int32_t zone_index,
        app::Vector2 trackable_distance,

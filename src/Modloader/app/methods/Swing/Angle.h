...
namespace app::classes::Swing::Angle {
    ...
    inline app::Angle operator+(app::Angle _a, app::Angle _b) { return op_Addition(_a, _b); }
    inline app::Angle operator-(app::Angle _a, app::Angle _b) { return op_Subtraction(_a, _b); }
    inline app::Angle operator*(app::Angle _a, float _b) { return op_Multiply_1(_a, _b); }
    inline app::Angle operator*(float _a, app::Angle _b) { return op_Multiply_2(_a, _b); }
    inline app::Angle operator/(app::Angle _a, float _b) { return op_Division_1(_a, _b); }
    inline app::Angle operator/(float _a, app::Angle _b) { return op_Division_2(_a, _b); }
    inline app::Angle operator%(app::Angle _a, app::Angle _b) { return op_Modulus(_a, _b); }
    inline float operator/(app::Angle _a, app::Angle _b) { return op_Division_3(_a, _b); }
    inline app::Angle operator-(app::Angle _a) { return op_UnaryNegation(_a); }
    inline bool operator>(app::Angle _a, app::Angle _b) { return op_GreaterThan(_a, _b); }
    inline bool operator<(app::Angle _a, app::Angle _b) { return op_LessThan(_a, _b); }
    inline bool operator>=(app::Angle _a, app::Angle _b) { return op_GreaterThanOrEqual(_a, _b); }
    inline bool operator<=(app::Angle _a, app::Angle _b) { return op_LessThanOrEqual(_a, _b); }
    inline bool operator==(app::Angle _a, app::Angle _b) { return op_Equality(_a, _b); }
    inline bool operator!=(app::Angle _a, app::Angle _b) { return op_Inequality(_a, _b); }
} // namespace app::classes::Swing::Angle

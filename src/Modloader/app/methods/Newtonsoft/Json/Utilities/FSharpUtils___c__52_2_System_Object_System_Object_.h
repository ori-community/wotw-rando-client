...
namespace app::classes::Newtonsoft::Json::Utilities::FSharpUtils___c__52_2_System_Object_System_Object_ {
    ...
    IL2CPP_REGISTER_METHOD(
        0x01D11080,
        app::Tuple_2_Object_Object_*,
        _BuildMapCreator_b__52_1,
        app::FSharpUtils_c_52_2_System_Object_System_Object_* this_ptr,
        app::KeyValuePair_2_System_Object_System_Object_ kv
    )
} // namespace app::classes::Newtonsoft::Json::Utilities::FSharpUtils___c__52_2_System_Object_System_Object_

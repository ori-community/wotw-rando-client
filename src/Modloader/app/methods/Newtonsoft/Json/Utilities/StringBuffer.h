...
namespace app::classes::Newtonsoft::Json::Utilities::StringBuffer {
    ...
    IL2CPP_REGISTER_METHOD(0x00240A00, void, Append_1, app::StringBuffer__Boxed* this_ptr, app::IArrayPool_1_System_Char_* buffer_pool, char16_t value)
    IL2CPP_REGISTER_METHOD(
        0x00240A10,
        void,
        Append_2,
        app::StringBuffer__Boxed* this_ptr,

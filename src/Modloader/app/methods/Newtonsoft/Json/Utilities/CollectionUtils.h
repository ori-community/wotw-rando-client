...
namespace app::classes::Newtonsoft::Json::Utilities::CollectionUtils {
    ...
    IL2CPP_REGISTER_METHOD(
        0x01C00D90,
        app::ConstructorInfo*,
        ResolveEnumerableCollectionConstructor_1,
        app::Type* collection_type,
        app::Type* collection_item_type
    )
    IL2CPP_REGISTER_METHOD(
        0x01C00EF0,
        app::ConstructorInfo*,
        ResolveEnumerableCollectionConstructor_2,
        app::Type* collection_type,
        app::Type* collection_item_type,
        app::Type* constructor_argument_type
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::IList* values,
        app::Array* multidimensional_array,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        AddRange_2,
        app::IList_1_Newtonsoft_Json_Serialization_JsonProperty_* initial,
        app::IEnumerable_1_Newtonsoft_Json_Serialization_JsonProperty_* collection
    )
    IL2CPP_REGISTER_METHOD(
        0x01552F40,
        void,
        AddRange_3,
        app::IList_1_Newtonsoft_Json_Serialization_SerializationCallback_* initial,
        app::IEnumerable_1_Newtonsoft_Json_Serialization_SerializationCallback_* collection
    )
    IL2CPP_REGISTER_METHOD(
        0x01552F40,
        void,
        AddRange_4,
        app::IList_1_Newtonsoft_Json_Serialization_SerializationErrorCallback_* initial,
        app::IEnumerable_1_Newtonsoft_Json_Serialization_SerializationErrorCallback_* collection
    )
    IL2CPP_REGISTER_METHOD(
        0x01552F40,
        void,
        AddRange_5,
        app::IList_1_System_Reflection_MemberInfo_* initial,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        AddRange_6,
        app::IList_1_System_Linq_Expressions_Expression_* initial,
        app::IEnumerable_1_System_Linq_Expressions_Expression_* collection
    )

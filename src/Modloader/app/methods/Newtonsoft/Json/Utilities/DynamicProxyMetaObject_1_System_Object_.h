...
namespace app::classes::Newtonsoft::Json::Utilities::DynamicProxyMetaObject_1_System_Object_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::DynamicProxyMetaObject_1_System_Object_* this_ptr,
        app::Expression* expression,
        app::Object* value,
        app::DynamicProxy_1_System_Object_* proxy
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        BindSetMember,
        app::DynamicProxyMetaObject_1_System_Object_* this_ptr,
        app::SetMemberBinder* binder,
        app::DynamicMetaObject* value
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::DynamicMetaObjectBinder* binder,
        app::IEnumerable_1_System_Linq_Expressions_Expression_* args,
        app::DynamicProxyMetaObject_1_T_Fallback_System_Object_* fallback,
        app::DynamicProxyMetaObject_1_T_Fallback_System_Object_* fallback_invoke
    )
    IL2CPP_REGISTER_METHOD(
        0x01D10030,
        app::DynamicMetaObject*,
        ...
        app::DynamicMetaObjectBinder* binder,
        app::IEnumerable_1_System_Linq_Expressions_Expression_* args,
        app::DynamicMetaObject* fallback_result,
        app::DynamicProxyMetaObject_1_T_Fallback_System_Object_* fallback_invoke
    )
    IL2CPP_REGISTER_METHOD(
        0x01D10860,

...
namespace app::classes::Newtonsoft::Json::Utilities::DateTimeUtils {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        bool,
        TryParseDateTimeIso,
        app::StringReference text,
        app::DateTimeZoneHandling__Enum date_time_zone_handling,
        app::DateTime* dt
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        bool,
        TryParseDateTime_1,
        app::StringReference s,
        app::DateTimeZoneHandling__Enum date_time_zone_handling,
        app::String* date_format_string,
    ...
    IL2CPP_REGISTER_METHOD(
        0x01C0A3A0,
        bool,
        TryParseDateTimeOffset_1,
        app::StringReference s,
        app::String* date_format_string,
        app::CultureInfo* culture,
        app::DateTimeOffset* dt
    )
    IL2CPP_REGISTER_METHOD(
        0x01C0A750,
        bool,
        TryParseDateTimeOffset_2,
        app::String* s,
        app::String* date_format_string,
        app::CultureInfo* culture,
        app::DateTimeOffset* dt
    ...
    IL2CPP_REGISTER_METHOD(
        0x01C0B500,
        void,
        WriteDateTimeString_1,
        app::TextWriter* writer,
        app::DateTime value,
        app::DateFormatHandling__Enum format,
        app::String* format_string,
        app::CultureInfo* culture
    )
    IL2CPP_REGISTER_METHOD(
        0x01C0B6B0,
        int32_t,
        WriteDateTimeString_2,
        app::Char__Array* chars,
        int32_t start,
        app::DateTime value,
        app::Nullable_1_TimeSpan_ offset,
        app::DateTimeKind__Enum kind,
        app::DateFormatHandling__Enum format
    )

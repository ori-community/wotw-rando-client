...
namespace app::classes::Newtonsoft::Json::Serialization::JsonSerializerInternalWriter {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Serialize,
        app::JsonSerializerInternalWriter* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Object* value,
        app::JsonPrimitiveContract* contract,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::JsonWriter* writer,
        app::Object* value,
        app::JsonContract* value_contract,
        app::JsonProperty* member,
        app::JsonContainerContract* container_contract,
        app::JsonProperty* container_property
    )
    IL2CPP_REGISTER_METHOD(
        ...
        app::JsonContainerContract* collection_contract,
        app::JsonProperty* container_property
    )
    IL2CPP_REGISTER_METHOD(
        0x01BF2D20,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::JsonObjectContract* container_contract,
        app::JsonProperty* property
    )
    IL2CPP_REGISTER_METHOD(
        0x01BF2FA0,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::JsonWriter* writer,
        app::Object* value,
        app::JsonStringContract* contract
    )
    IL2CPP_REGISTER_METHOD(
        0x01BF3B10,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::JsonWriter* writer,
        app::Object* value,
        app::JsonContainerContract* contract,
        app::JsonProperty* member,
        app::JsonProperty* property,
        app::JsonContract** member_contract,
        app::Object** member_value
    )
    IL2CPP_REGISTER_METHOD(
        0x01BF49A0,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        HasFlag_2,
        app::JsonSerializerInternalWriter* this_ptr,
        app::PreserveReferencesHandling__Enum value,
        app::PreserveReferencesHandling__Enum flag
    )
    IL2CPP_REGISTER_METHOD(
        0x01141CD0,
        bool,
        HasFlag_3,
        app::JsonSerializerInternalWriter* this_ptr,
        app::TypeNameHandling__Enum value,
        app::TypeNameHandling__Enum flag
    )
    IL2CPP_REGISTER_METHOD(
        0x01BF5040,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        0x01BF5930,
        void,
        SerializeMultidimensionalArray_1,
        app::JsonSerializerInternalWriter* this_ptr,
        app::JsonWriter* writer,
        app::Array* values,
        app::JsonArrayContract* contract,
    ...
    IL2CPP_REGISTER_METHOD(
        0x01BF5B50,
        void,
        SerializeMultidimensionalArray_2,
        app::JsonSerializerInternalWriter* this_ptr,
        app::JsonWriter* writer,
        app::Array* values,
        app::JsonArrayContract* contract,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::JsonSerializerInternalWriter* this_ptr,
        app::JsonWriter* writer,
        app::IDynamicMetaObjectProvider* value,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ShouldWriteType,
        app::JsonSerializerInternalWriter* this_ptr,
        app::TypeNameHandling__Enum type_name_handling_flag,
        app::JsonContract* contract,
        app::JsonProperty* member,
        app::JsonContainerContract* container_contract,
        app::JsonProperty* container_property

...
namespace app::classes::PhysicalSystemManager {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ApplyState_1,
        app::PhysicalSystemManager* this_ptr,
        int32_t state_g_u_i_d,
        bool apply_immediate,
        bool force_refresh_joints
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ApplyState_2,
        app::PhysicalSystemManager* this_ptr,
        app::PhysicalSystemState* state,
        bool timesliced,
        bool alter_active_state,
        bool force_refresh_joints
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x014F1450,
        void,
        ISceneRootPostEnableObserver_OnSceneRootPostEnable,
        app::PhysicalSystemManager* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        0x014F6BF0,
        void,
        SetRigidbodyInertiaOverride,
        app::PhysicalSystemManager* this_ptr,
        app::Rigidbody* body,
        bool override_inertia,
        app::Vector3 inertia_tensor
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Explode,
        app::PhysicalSystemManager* this_ptr,
        app::ApplyForceToPhysicsSystem_ExplosionSettings explosion,
        float multiply_force
    )

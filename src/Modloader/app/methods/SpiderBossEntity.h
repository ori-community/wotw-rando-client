...
namespace app::classes::SpiderBossEntity {
    ...
    IL2CPP_REGISTER_METHOD(
        0x0096EFC0,
        void,
        UpdateLegPositionTransforms,
        app::SpiderBossEntity* this_ptr,
        app::Transform* leg_position,
        app::Transform* leg_position2_d,
        app::Transform* leg_ground_position2_d,
        app::Transform* knee_position
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x0096FF30,
        app::List_1_SpiderBossBehaviourZone_*,
        GetBehaviourZonesForPosition,
        app::SpiderBossEntity* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        GetMetaGroup,
        app::SpiderBossEntity* this_ptr,
        app::SpiderBossLocationZone__Enum current_zone,

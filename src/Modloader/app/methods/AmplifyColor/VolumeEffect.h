...
namespace app::classes::AmplifyColor::VolumeEffect {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::VolumeEffectFlags* flags,
        app::VolumeEffect* volume1,
        app::VolumeEffect* volume2,
        float blend
    )
    IL2CPP_REGISTER_METHOD(
        0x030CDBC0,
        app::VolumeEffectComponent*,
        AddComponent,
        app::VolumeEffect* this_ptr,
        app::Component_1* c,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        BlendValues,
        app::VolumeEffect* this_ptr,
        app::AmplifyColorBase* target_color,
        app::VolumeEffect* other,
        float blend_amount
    )

...
namespace app::classes::SkinnedMeshLod {
    ...
    IL2CPP_REGISTER_METHOD(
        0x006BD6A0,
        app::SkinnedMeshRenderer*,
        GetRendererByName,
        app::SkinnedMeshLod* this_ptr,
        app::SkinnedMeshRenderer__Array* renderers,
        app::String* name
    )
    IL2CPP_REGISTER_METHOD(
        0x006BD760,
        ...
        UpdateMeshRenderer,
        app::SkinnedMeshLod* this_ptr,
        app::SkinnedMeshRenderer* new_mesh_renderer,
        app::SkinnedMeshRenderer* active_renderer
    )

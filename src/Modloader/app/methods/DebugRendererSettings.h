...
namespace app::classes::DebugRendererSettings {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        RenderCollider_1,
        app::DebugRendererSettings* this_ptr,
        app::Collider* collider,
        app::RenderingType__Enum render_type,
        app::DebugRendererSettings_ColliderType__Enum object_type
    )
    IL2CPP_REGISTER_METHOD(
        0x00B774C0,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        0x00B78C50,
        void,
        RenderCheckpointRestrictZone,
        app::DebugRendererSettings* this_ptr,
        app::CheckpointRestrictZone* zone,
        app::RenderingType__Enum render_type
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x00B79520,
        void,
        RenderCheckpointRestrictZoneGUI,
        app::DebugRendererSettings* this_ptr,
        app::CheckpointRestrictZone* zone,
        app::Camera* camera
    )

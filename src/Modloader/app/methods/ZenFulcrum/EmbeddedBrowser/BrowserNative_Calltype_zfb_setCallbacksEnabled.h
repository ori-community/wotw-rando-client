...
namespace app::classes::ZenFulcrum::EmbeddedBrowser::BrowserNative_Calltype_zfb_setCallbacksEnabled {
    IL2CPP_REGISTER_METHOD(0x00611810, void, ctor, app::BrowserNative_Calltype_zfb_setCallbacksEnabled* this_ptr, app::Object* object, void* method_1)
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::IAsyncResult*,
        BeginInvoke,
        app::BrowserNative_Calltype_zfb_setCallbacksEnabled* this_ptr,
        bool enabled,

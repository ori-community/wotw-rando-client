...
namespace app::classes::ZenFulcrum::EmbeddedBrowser::BrowserNative_Calltype_zfb_setReadyCallback {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::IAsyncResult*,
        BeginInvoke,
        app::BrowserNative_Calltype_zfb_setReadyCallback* this_ptr,
        int32_t id,
        app::BrowserNative_ReadyFunc* cb,

...
namespace app::classes::ZenFulcrum::EmbeddedBrowser::BrowserNative_Calltype_zfb_registerPopupCallback {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Invoke,
        app::BrowserNative_Calltype_zfb_registerPopupCallback* this_ptr,
        int32_t id,
        app::BrowserNative_NewWindowAction__Enum window_action,
        app::BrowserNative_ZFBSettings base_settings,
        app::BrowserNative_NewWindowFunc* cb
    )
    IL2CPP_REGISTER_METHOD(
        0x01DCA8B0,
        app::IAsyncResult*,

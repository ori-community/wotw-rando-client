...
namespace app::classes::ZenFulcrum::EmbeddedBrowser::JSONParser {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        bool,
        SerializeObject,
        app::IEnumerable_1_System_String_* keys,
        app::IEnumerable_1_ZenFulcrum_EmbeddedBrowser_JSONNode_* values,

...
namespace app::classes::ZenFulcrum::VR::OpenVRBinding::CVRApplications {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::CVRApplications* this_ptr,
        uint32_t un_application_index,
        app::StringBuilder* pch_app_key_buffer,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::StringBuilder* pch_property_value_buffer,
        uint32_t un_property_value_buffer_len,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::CVRApplications* this_ptr,
        app::String* pch_app_key,
        app::String* pch_mime_types_buffer,
        uint32_t un_mime_types_buffer
    )
    IL2CPP_REGISTER_METHOD(
        0x01677010,
        uint32_t,
        ...
        app::CVRApplications* this_ptr,
        app::String* pch_mime_type,
        app::String* pch_app_keys_that_support_buffer,
        uint32_t un_app_keys_that_support_buffer
    )
    IL2CPP_REGISTER_METHOD(
        0x01677040,
        uint32_t,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::CVRApplications* this_ptr,
        app::String* pch_binary_path,
        app::String* pch_arguments,
        app::String* pch_working_directory
    )

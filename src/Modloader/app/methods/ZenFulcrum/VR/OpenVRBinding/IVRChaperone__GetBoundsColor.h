...
namespace app::classes::ZenFulcrum::VR::OpenVRBinding::IVRChaperone__GetBoundsColor {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Invoke,
        app::IVRChaperone_GetBoundsColor* this_ptr,
        app::HmdColor_t* p_output_color_array,
        int32_t n_num_output_colors,
        float fl_collision_bounds_fade_distance,
        app::HmdColor_t* p_output_camera_color
    )
    IL2CPP_REGISTER_METHOD(
        0x02F3FBB0,
        app::IAsyncResult*,

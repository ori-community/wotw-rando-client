...
namespace app::classes::ZenFulcrum::VR::OpenVRBinding::IVRCompositor__ShouldAppRenderWithLowResources {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::IAsyncResult*,
        BeginInvoke,
        app::IVRCompositor_ShouldAppRenderWithLowResources* this_ptr,

...
namespace app::classes::ZenFulcrum::VR::OpenVRBinding::CVRCompositor {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        WaitGetPoses,
        app::CVRCompositor* this_ptr,
        app::TrackedDevicePose_t__Array* p_render_pose_array,
        app::TrackedDevicePose_t__Array* p_game_pose_array
    )
    IL2CPP_REGISTER_METHOD(
        0x01677E50,
        app::EVRCompositorError__Enum,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::TrackedDevicePose_t* p_output_game_pose
    )
    IL2CPP_REGISTER_METHOD(
        0x01677ED0,
        app::EVRCompositorError__Enum,
        ...
        app::VRTextureBounds_t* p_bounds,
        app::EVRSubmitFlags__Enum n_submit_flags
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::CVRCompositor* this_ptr,
        app::EVREye__Enum e_eye,
        uint32_t* pgl_texture_id,
        void* pgl_shared_texture_handle
    )

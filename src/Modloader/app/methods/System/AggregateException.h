...
namespace app::classes::System::AggregateException {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_4,
        app::AggregateException* this_ptr,
        app::String* message,
        app::IEnumerable_1_System_Exception_* inner_exceptions
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ctor_7,
        app::AggregateException* this_ptr,
        app::IEnumerable_1_System_Runtime_ExceptionServices_ExceptionDispatchInfo_* inner_exception_infos
    )
    IL2CPP_REGISTER_METHOD(
        0x0228BB00,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::AggregateException* this_ptr,
        app::String* message,
        app::IList_1_System_Runtime_ExceptionServices_ExceptionDispatchInfo_* inner_exception_infos
    )

...
namespace app::classes::System::Comparison_1_GeneralDebugMenuPage_SceneInfo_ {
    IL2CPP_REGISTER_METHOD(0x00611810, void, ctor, app::Comparison_1_GeneralDebugMenuPage_SceneInfo_* this_ptr, app::Object* object, void* method_1)
    IL2CPP_REGISTER_METHOD(
        0x02B840F0,
        int32_t,
        Invoke,
        app::Comparison_1_GeneralDebugMenuPage_SceneInfo_* this_ptr,

...
namespace app::classes::System::Diagnostics::Tracing::CharTypeInfo {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        WriteMetadata,
        app::CharTypeInfo* this_ptr,
        app::TraceLoggingMetadataCollector* collector,
        app::String* name,
        app::EventFieldFormat__Enum format
    )
    IL2CPP_REGISTER_METHOD(0x01747F60, void, WriteData, app::CharTypeInfo* this_ptr, app::TraceLoggingDataCollector* collector, char16_t* value)

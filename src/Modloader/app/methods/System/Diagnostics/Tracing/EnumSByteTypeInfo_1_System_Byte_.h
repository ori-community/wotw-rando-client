...
#include <Modloader/app/structs/EnumSByteTypeInfo_1_System_Byte_.h>
...
namespace app::classes::System::Diagnostics::Tracing::EnumSByteTypeInfo_1_System_Byte_ {
    IL2CPP_REGISTER_METHOD(
        0x02B8F1C0,
        void,
        WriteMetadata,
        app::EnumSByteTypeInfo_1_System_Byte_* this_ptr,

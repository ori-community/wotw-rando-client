...
#include <Modloader/app/structs/EnumInt64TypeInfo_1_System_TimeSpan_.h>
...
namespace app::classes::System::Diagnostics::Tracing::EnumInt64TypeInfo_1_System_TimeSpan_ {
    IL2CPP_REGISTER_METHOD(
        0x02F4F4D0,
        void,
        WriteMetadata,
        app::EnumInt64TypeInfo_1_System_TimeSpan_* this_ptr,

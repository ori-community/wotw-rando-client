...
#include <Modloader/app/structs/EnumSByteTypeInfo_1_EmptyStruct_.h>
...
namespace app::classes::System::Diagnostics::Tracing::EnumSByteTypeInfo_1_EmptyStruct_ {
    IL2CPP_REGISTER_METHOD(
        0x02B8FC10,
        void,
        WriteMetadata,
        app::EnumSByteTypeInfo_1_EmptyStruct_* this_ptr,

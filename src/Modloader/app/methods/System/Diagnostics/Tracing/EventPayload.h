...
namespace app::classes::System::Diagnostics::Tracing::EventPayload {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::EventPayload* this_ptr,
        app::List_1_System_String_* payload_names,
        app::List_1_System_Object_* payload_values
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        CopyTo,
        app::EventPayload* this_ptr,
        app::KeyValuePair_2_System_String_System_Object___Array* payload_entries,
        int32_t count
    )

...
namespace app::classes::System::Diagnostics::Tracing::FieldMetadata {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_1,
        app::FieldMetadata* this_ptr,
        app::String* name,
        app::TraceLoggingDataType__Enum type,
        app::EventFieldTags__Enum tags,
        bool variable_count
    )
    IL2CPP_REGISTER_METHOD(
        0x019FD940,
        ...
        app::FieldMetadata* this_ptr,
        app::String* name,
        app::TraceLoggingDataType__Enum data_type,
        app::EventFieldTags__Enum tags,
        uint8_t count_flags,
        uint16_t fixed_count,
        app::Byte__Array* custom
    )

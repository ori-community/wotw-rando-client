...
namespace app::classes::System::Diagnostics::Tracing::UIntPtrTypeInfo {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        WriteMetadata,
        app::UIntPtrTypeInfo* this_ptr,
        app::TraceLoggingMetadataCollector* collector,
        app::String* name,
        app::EventFieldFormat__Enum format
    )
    IL2CPP_REGISTER_METHOD(0x01A0F7D0, void, WriteData, app::UIntPtrTypeInfo* this_ptr, app::TraceLoggingDataCollector* collector, void** value)

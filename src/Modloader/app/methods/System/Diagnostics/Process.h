...
namespace app::classes::System::Diagnostics::Process {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_2,
        app::Process* this_ptr,
        app::String* machine_name,
        bool is_remote_machine,
        int32_t process_id,
        app::ProcessInfo* process_info
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::ProcessStartInfo* start_info,
        void* stdin_1,
        void* stdout_1,
        void* stderr_1,
        app::Process_ProcInfo* proc_info
    )
    IL2CPP_REGISTER_METHOD(0x02001630, bool, StartWithShellExecuteEx, app::Process* this_ptr, app::ProcessStartInfo* start_info)
    IL2CPP_REGISTER_METHOD(0x02001A20, void, CreatePipe, void** read, void** write, bool write_direction)

...
namespace app::classes::System::Text::EncodingProvider {
    IL2CPP_REGISTER_METHOD(
        ...
        app::Encoding*,
        GetEncoding_1,
        app::EncodingProvider* this_ptr,
        app::String* name,
        app::EncoderFallback* encoder_fallback,
        app::DecoderFallback* decoder_fallback
    )
    IL2CPP_REGISTER_METHOD(
        0x02457710,
        app::Encoding*,
    ...
    IL2CPP_REGISTER_METHOD(
        0x02457CD0,
        app::Encoding*,
        GetEncodingFromProvider_4,
        app::String* encoding_name,
        app::EncoderFallback* enc,
        app::DecoderFallback* dec
    )

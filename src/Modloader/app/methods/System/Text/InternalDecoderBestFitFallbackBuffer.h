...
namespace app::classes::System::Text::InternalDecoderBestFitFallbackBuffer {
    ...
    IL2CPP_REGISTER_METHOD(0x02458660, char16_t, GetNextChar, app::InternalDecoderBestFitFallbackBuffer* this_ptr)
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t,
        InternalFallback,
        app::InternalDecoderBestFitFallbackBuffer* this_ptr,
        app::Byte__Array* bytes,
        uint8_t* p_bytes
    )
    IL2CPP_REGISTER_METHOD(0x024586B0, char16_t, TryBestFit, app::InternalDecoderBestFitFallbackBuffer* this_ptr, app::Byte__Array* bytes_check)
} // namespace app::classes::System::Text::InternalDecoderBestFitFallbackBuffer

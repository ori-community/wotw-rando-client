...
namespace app::classes::System::Array_InternalEnumerator_1_UberInteractionManager_ActorInfo_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        get_Current,
        app::Array_InternalEnumerator_1_UberInteractionManager_ActorInfo___Boxed* this_ptr
    )

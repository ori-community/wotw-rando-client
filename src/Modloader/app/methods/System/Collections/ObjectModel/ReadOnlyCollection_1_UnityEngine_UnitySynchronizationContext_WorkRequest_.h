...
namespace app::classes::System::Collections::ObjectModel::ReadOnlyCollection_1_UnityEngine_UnitySynchronizationContext_WorkRequest_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::ReadOnlyCollection_1_UnityEngine_UnitySynchronizationContext_WorkRequest_* this_ptr,
        app::IList_1_UnityEngine_UnitySynchronizationContext_WorkRequest_* list
    )

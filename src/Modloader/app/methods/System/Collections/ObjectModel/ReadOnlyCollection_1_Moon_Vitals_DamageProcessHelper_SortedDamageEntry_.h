...
namespace app::classes::System::Collections::ObjectModel::ReadOnlyCollection_1_Moon_Vitals_DamageProcessHelper_SortedDamageEntry_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::ReadOnlyCollection_1_Moon_Vitals_DamageProcessHelper_SortedDamageEntry_* this_ptr,
        app::IList_1_Moon_Vitals_DamageProcessHelper_SortedDamageEntry_* list
    )

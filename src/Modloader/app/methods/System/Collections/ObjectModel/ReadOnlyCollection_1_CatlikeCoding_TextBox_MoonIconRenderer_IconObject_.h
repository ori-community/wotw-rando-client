...
namespace app::classes::System::Collections::ObjectModel::ReadOnlyCollection_1_CatlikeCoding_TextBox_MoonIconRenderer_IconObject_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::ReadOnlyCollection_1_CatlikeCoding_TextBox_MoonIconRenderer_IconObject_* this_ptr,
        app::IList_1_CatlikeCoding_TextBox_MoonIconRenderer_IconObject_* list
    )

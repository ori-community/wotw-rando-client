...
namespace app::classes::System::Collections::ObjectModel::ReadOnlyCollection_1_ZenFulcrum_EmbeddedBrowser_PointerUIBase_PointerState_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::ReadOnlyCollection_1_ZenFulcrum_EmbeddedBrowser_PointerUIBase_PointerState_* this_ptr,
        app::IList_1_ZenFulcrum_EmbeddedBrowser_PointerUIBase_PointerState_* list
    )

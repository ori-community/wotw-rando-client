...
namespace app::classes::System::Collections::ObjectModel::ReadOnlyCollection_1_UnityEngine_Experimental_LowLevel_PlayerLoopSystemInternal_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::ReadOnlyCollection_1_UnityEngine_Experimental_LowLevel_PlayerLoopSystemInternal_* this_ptr,
        app::IList_1_UnityEngine_Experimental_LowLevel_PlayerLoopSystemInternal_* list
    )

...
namespace app::classes::System::Collections::ObjectModel::ReadOnlyCollection_1_Moon_Timeline_UberShaderAnimatorStrategyExperimental_FloatRequest_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::ReadOnlyCollection_1_Moon_Timeline_UberShaderAnimatorStrategyExperimental_FloatRequest_* this_ptr,
        app::IList_1_Moon_Timeline_UberShaderAnimatorStrategyExperimental_FloatRequest_* list
    )
    IL2CPP_REGISTER_METHOD(
        0x02B7DD20,
        int32_t,

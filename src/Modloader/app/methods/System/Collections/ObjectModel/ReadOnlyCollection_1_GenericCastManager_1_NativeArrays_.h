...
namespace app::classes::System::Collections::ObjectModel::ReadOnlyCollection_1_GenericCastManager_1_NativeArrays_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_1,
        app::ReadOnlyCollection_1_GenericCastManager_1_NativeArrays_* this_ptr,
        app::IList_1_GenericCastManager_1_NativeArrays_* list
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_2,
        app::ReadOnlyCollection_1_GenericCastManager_1_NativeArrays__1* this_ptr,
        app::IList_1_GenericCastManager_1_NativeArrays__1* list
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_3,
        app::ReadOnlyCollection_1_GenericCastManager_1_NativeArrays__2* this_ptr,
        app::IList_1_GenericCastManager_1_NativeArrays__2* list
    )

...
namespace app::classes::System::Collections::ObjectModel::ReadOnlyCollection_1_System_Diagnostics_Tracing_EventProvider_SessionInfo_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::ReadOnlyCollection_1_System_Diagnostics_Tracing_EventProvider_SessionInfo_* this_ptr,
        app::IList_1_System_Diagnostics_Tracing_EventProvider_SessionInfo_* list
    )

...
namespace app::classes::System::Collections::Generic::List_1_System_Net_NetworkInformation_Win32IPGlobalProperties_Win32_MIB_TCPROW_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Add,
        app::List_1_System_Net_NetworkInformation_Win32IPGlobalProperties_Win32_MIB_TCPROW_* this_ptr,
        app::Win32IPGlobalProperties_Win32_MIB_TCPROW* item
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x025EFC50,
        app::Win32IPGlobalProperties_Win32_MIB_TCPROW*,
        get_Item,
        app::List_1_System_Net_NetworkInformation_Win32IPGlobalProperties_Win32_MIB_TCPROW_* this_ptr,
        int32_t index
    )

...
namespace app::classes::System::Collections::Generic::Dictionary_2_SmartInput_ICachableInput_SmartInput_InputCacheManager_SetupTempData_Node_ {
    IL2CPP_REGISTER_METHOD(
        0x0283B3E0,
        app::Dictionary_2_TKey_TValue_ValueCollection_SmartInput_ICachableInput_SmartInput_InputCacheManager_SetupTempData_Node_*,
        get_Values,
        app::Dictionary_2_SmartInput_ICachableInput_SmartInput_InputCacheManager_SetupTempData_Node_* this_ptr
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        TryGetValue,
        app::Dictionary_2_SmartInput_ICachableInput_SmartInput_InputCacheManager_SetupTempData_Node_* this_ptr,
        app::ICachableInput* key,
        app::InputCacheManager_SetupTempData_Node** value
    )
    IL2CPP_REGISTER_METHOD(
        0x02BAC170,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        0x02BA5400,
        app::Dictionary_2_TKey_TValue_Enumerator_SmartInput_ICachableInput_SmartInput_InputCacheManager_SetupTempData_Node_,
        GetEnumerator,
        app::Dictionary_2_SmartInput_ICachableInput_SmartInput_InputCacheManager_SetupTempData_Node_* this_ptr
    )
} // namespace app::classes::System::Collections::Generic::Dictionary_2_SmartInput_ICachableInput_SmartInput_InputCacheManager_SetupTempData_Node_

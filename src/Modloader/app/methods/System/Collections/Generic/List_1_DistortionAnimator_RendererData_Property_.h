...
namespace app::classes::System::Collections::Generic::List_1_DistortionAnimator_RendererData_Property_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Add,
        app::List_1_DistortionAnimator_RendererData_Property_* this_ptr,
        app::DistortionAnimator_RendererData_Property item
    )
    IL2CPP_REGISTER_METHOD(
        0x02C21490,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ctor_3,
        app::List_1_DistortionAnimator_RendererData_Property_* this_ptr,
        app::IEnumerable_1_DistortionAnimator_RendererData_Property_* collection
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x025E9050,
        app::ReadOnlyCollection_1_DistortionAnimator_RendererData_Property_*,
        AsReadOnly,
        app::List_1_DistortionAnimator_RendererData_Property_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Exists,
        app::List_1_DistortionAnimator_RendererData_Property_* this_ptr,
        app::Predicate_1_DistortionAnimator_RendererData_Property_* match
    )
    IL2CPP_REGISTER_METHOD(
        0x02C21EE0,
        app::DistortionAnimator_RendererData_Property,
    ...
    IL2CPP_REGISTER_METHOD(
        0x02C22010,
        app::List_1_DistortionAnimator_RendererData_Property_*,
        FindAll,
        app::List_1_DistortionAnimator_RendererData_Property_* this_ptr,
        app::Predicate_1_DistortionAnimator_RendererData_Property_* match
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ForEach,
        app::List_1_DistortionAnimator_RendererData_Property_* this_ptr,
        app::Action_1_DistortionAnimator_RendererData_Property_* action
    )
    IL2CPP_REGISTER_METHOD(
        0x02C22520,
        app::List_1_T_Enumerator_DistortionAnimator_RendererData_Property_,
        GetEnumerator,
        app::List_1_DistortionAnimator_RendererData_Property_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
    ...
    IL2CPP_REGISTER_METHOD(
        0x025EAEF0,
        app::DistortionAnimator_RendererData_Property__Array*,
        ToArray,
        app::List_1_DistortionAnimator_RendererData_Property_* this_ptr
    )

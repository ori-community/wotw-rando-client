...
namespace app::classes::System::Collections::Generic::Dictionary_2_System_Object_SneezeSlugEntity_HitProtectionState_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Add,
        app::Dictionary_2_System_Object_SneezeSlugEntity_HitProtectionState_* this_ptr,
        app::Object* key,
        app::SneezeSlugEntity_HitProtectionState__Enum value
    )
    IL2CPP_REGISTER_METHOD(
        0x02BAC140,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        0x02BA5400,
        app::Dictionary_2_TKey_TValue_Enumerator_System_Object_SneezeSlugEntity_HitProtectionState_,
        GetEnumerator,
        app::Dictionary_2_System_Object_SneezeSlugEntity_HitProtectionState_* this_ptr
    )

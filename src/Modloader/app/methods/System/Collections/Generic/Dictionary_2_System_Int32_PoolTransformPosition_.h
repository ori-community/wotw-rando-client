...
namespace app::classes::System::Collections::Generic::Dictionary_2_System_Int32_PoolTransformPosition_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Add,
        app::Dictionary_2_System_Int32_PoolTransformPosition_* this_ptr,
        int32_t key,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ctor_5,
        app::Dictionary_2_System_Int32_PoolTransformPosition_* this_ptr,
        app::IDictionary_2_System_Int32_PoolTransformPosition_* dictionary
    )
    IL2CPP_REGISTER_METHOD(
        0x02BA8150,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        0x0283B2B0,
        app::Dictionary_2_TKey_TValue_KeyCollection_System_Int32_PoolTransformPosition_*,
        get_Keys,
        app::Dictionary_2_System_Int32_PoolTransformPosition_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
    ...
    IL2CPP_REGISTER_METHOD(
        0x0283B3E0,
        app::Dictionary_2_TKey_TValue_ValueCollection_System_Int32_PoolTransformPosition_*,
        get_Values,
        app::Dictionary_2_System_Int32_PoolTransformPosition_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x0283B3E0,
        app::ICollection_1_PoolTransformPosition_*,
        System_Collections_Generic_IDictionary_TKey_TValue__get_Values,
        app::Dictionary_2_System_Int32_PoolTransformPosition_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x0283B3E0,
        app::IEnumerable_1_PoolTransformPosition_*,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Dictionary_2_System_Int32_PoolTransformPosition_* this_ptr,
        app::KeyValuePair_2_System_Int32_PoolTransformPosition_ key_value_pair
    )
    IL2CPP_REGISTER_METHOD(
        0x02BA8890,
        bool,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        CopyTo,
        app::Dictionary_2_System_Int32_PoolTransformPosition_* this_ptr,
        app::KeyValuePair_2_System_Int32_PoolTransformPosition___Array* array,
        int32_t index
    )
    IL2CPP_REGISTER_METHOD(
        0x02BA8ED0,
        app::Dictionary_2_TKey_TValue_Enumerator_System_Int32_PoolTransformPosition_,
        GetEnumerator,
        app::Dictionary_2_System_Int32_PoolTransformPosition_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x02BA8F40,
        app::IEnumerator_1_KeyValuePair_2_System_Int32_PoolTransformPosition_*,

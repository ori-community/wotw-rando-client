...
namespace app::classes::System::Collections::Generic::List_1_WaterPoisonTrail_DamagePoint_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        set_Item,
        app::List_1_WaterPoisonTrail_DamagePoint_* this_ptr,
        int32_t index,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ctor_3,
        app::List_1_WaterPoisonTrail_DamagePoint_* this_ptr,
        app::IEnumerable_1_WaterPoisonTrail_DamagePoint_* collection
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x025E9050,
        app::ReadOnlyCollection_1_WaterPoisonTrail_DamagePoint_*,
        AsReadOnly,
        app::List_1_WaterPoisonTrail_DamagePoint_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t index,
        int32_t count,
        app::WaterPoisonTrail_DamagePoint item,
        app::IComparer_1_WaterPoisonTrail_DamagePoint_* comparer
    )
    IL2CPP_REGISTER_METHOD(
        0x02C21B20,
        int32_t,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Find,
        app::List_1_WaterPoisonTrail_DamagePoint_* this_ptr,
        app::Predicate_1_WaterPoisonTrail_DamagePoint_* match
    )
    IL2CPP_REGISTER_METHOD(
        0x02C22010,
        app::List_1_WaterPoisonTrail_DamagePoint_*,
        FindAll,
        app::List_1_WaterPoisonTrail_DamagePoint_* this_ptr,
        app::Predicate_1_WaterPoisonTrail_DamagePoint_* match
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x02C22520,
        app::List_1_T_Enumerator_WaterPoisonTrail_DamagePoint_,
        GetEnumerator,
        app::List_1_WaterPoisonTrail_DamagePoint_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Sort_4,
        app::List_1_WaterPoisonTrail_DamagePoint_* this_ptr,
        app::Comparison_1_WaterPoisonTrail_DamagePoint_* comparison
    )

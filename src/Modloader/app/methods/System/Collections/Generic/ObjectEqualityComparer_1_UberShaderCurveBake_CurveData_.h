...
namespace app::classes::System::Collections::Generic::ObjectEqualityComparer_1_UberShaderCurveBake_CurveData_ {
    IL2CPP_REGISTER_METHOD(
        ...
        bool,
        Equals_1,
        app::ObjectEqualityComparer_1_UberShaderCurveBake_CurveData_* this_ptr,
        app::UberShaderCurveBake_CurveData x,
        app::UberShaderCurveBake_CurveData y
    )
    IL2CPP_REGISTER_METHOD(
        0x01CD0900,
        int32_t,
        GetHashCode_1,
        app::ObjectEqualityComparer_1_UberShaderCurveBake_CurveData_* this_ptr,
        app::UberShaderCurveBake_CurveData obj
    )
    IL2CPP_REGISTER_METHOD(
        0x01CD2E30,
        int32_t,

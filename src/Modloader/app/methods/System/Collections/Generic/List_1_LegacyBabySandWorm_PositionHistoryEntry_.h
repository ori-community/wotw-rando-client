...
namespace app::classes::System::Collections::Generic::List_1_LegacyBabySandWorm_PositionHistoryEntry_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Add,
        app::List_1_LegacyBabySandWorm_PositionHistoryEntry_* this_ptr,
        app::LegacyBabySandWorm_PositionHistoryEntry item
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ctor_3,
        app::List_1_LegacyBabySandWorm_PositionHistoryEntry_* this_ptr,
        app::IEnumerable_1_LegacyBabySandWorm_PositionHistoryEntry_* collection
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x025E9050,
        app::ReadOnlyCollection_1_LegacyBabySandWorm_PositionHistoryEntry_*,
        AsReadOnly,
        app::List_1_LegacyBabySandWorm_PositionHistoryEntry_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t count,
        app::LegacyBabySandWorm_PositionHistoryEntry item,
        app::IComparer_1_LegacyBabySandWorm_PositionHistoryEntry_* comparer
    )
    IL2CPP_REGISTER_METHOD(
        0x025E91F0,
        int32_t,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Exists,
        app::List_1_LegacyBabySandWorm_PositionHistoryEntry_* this_ptr,
        app::Predicate_1_LegacyBabySandWorm_PositionHistoryEntry_* match
    )
    IL2CPP_REGISTER_METHOD(
        0x025E96E0,
        app::LegacyBabySandWorm_PositionHistoryEntry,
    ...
    IL2CPP_REGISTER_METHOD(
        0x025E9800,
        app::List_1_LegacyBabySandWorm_PositionHistoryEntry_*,
        FindAll,
        app::List_1_LegacyBabySandWorm_PositionHistoryEntry_* this_ptr,
        app::Predicate_1_LegacyBabySandWorm_PositionHistoryEntry_* match
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ForEach,
        app::List_1_LegacyBabySandWorm_PositionHistoryEntry_* this_ptr,
        app::Action_1_LegacyBabySandWorm_PositionHistoryEntry_* action
    )
    IL2CPP_REGISTER_METHOD(
        0x025E9D20,
        app::List_1_T_Enumerator_LegacyBabySandWorm_PositionHistoryEntry_,
        GetEnumerator,
        app::List_1_LegacyBabySandWorm_PositionHistoryEntry_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Sort_4,
        app::List_1_LegacyBabySandWorm_PositionHistoryEntry_* this_ptr,
        app::Comparison_1_LegacyBabySandWorm_PositionHistoryEntry_* comparison
    )
    IL2CPP_REGISTER_METHOD(
        0x025EAEF0,
        app::LegacyBabySandWorm_PositionHistoryEntry__Array*,
        ToArray,
        app::List_1_LegacyBabySandWorm_PositionHistoryEntry_* this_ptr
    )

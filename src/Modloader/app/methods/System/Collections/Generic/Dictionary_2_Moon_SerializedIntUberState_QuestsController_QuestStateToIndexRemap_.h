...
namespace app::classes::System::Collections::Generic::Dictionary_2_Moon_SerializedIntUberState_QuestsController_QuestStateToIndexRemap_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Add,
        app::Dictionary_2_Moon_SerializedIntUberState_QuestsController_QuestStateToIndexRemap_* this_ptr,
        app::SerializedIntUberState* key,
        app::QuestsController_QuestStateToIndexRemap* value
    )
    IL2CPP_REGISTER_METHOD(
        0x02BBA760,
        bool,

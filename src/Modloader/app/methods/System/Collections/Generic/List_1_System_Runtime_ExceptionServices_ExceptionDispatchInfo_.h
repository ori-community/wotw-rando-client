...
namespace app::classes::System::Collections::Generic::List_1_System_Runtime_ExceptionServices_ExceptionDispatchInfo_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_1,
        app::List_1_System_Runtime_ExceptionServices_ExceptionDispatchInfo_* this_ptr,
        app::IEnumerable_1_System_Runtime_ExceptionServices_ExceptionDispatchInfo_* collection
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x025F0B10,
        app::List_1_T_Enumerator_System_Runtime_ExceptionServices_ExceptionDispatchInfo_,
        GetEnumerator,
        app::List_1_System_Runtime_ExceptionServices_ExceptionDispatchInfo_* this_ptr
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Add,
        app::List_1_System_Runtime_ExceptionServices_ExceptionDispatchInfo_* this_ptr,
        app::ExceptionDispatchInfo* item
    )
    IL2CPP_REGISTER_METHOD(
        0x025EFC50,

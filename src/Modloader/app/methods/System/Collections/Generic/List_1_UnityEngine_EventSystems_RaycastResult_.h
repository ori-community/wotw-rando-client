...
namespace app::classes::System::Collections::Generic::List_1_UnityEngine_EventSystems_RaycastResult_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Sort_1,
        app::List_1_UnityEngine_EventSystems_RaycastResult_* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ctor_3,
        app::List_1_UnityEngine_EventSystems_RaycastResult_* this_ptr,
        app::IEnumerable_1_UnityEngine_EventSystems_RaycastResult_* collection
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x025E9050,
        app::ReadOnlyCollection_1_UnityEngine_EventSystems_RaycastResult_*,
        AsReadOnly,
        app::List_1_UnityEngine_EventSystems_RaycastResult_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t index,
        int32_t count,
        app::RaycastResult item,
        app::IComparer_1_UnityEngine_EventSystems_RaycastResult_* comparer
    )
    IL2CPP_REGISTER_METHOD(
        0x02D22C30,
        int32_t,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Exists,
        app::List_1_UnityEngine_EventSystems_RaycastResult_* this_ptr,
        app::Predicate_1_UnityEngine_EventSystems_RaycastResult_* match
    )
    IL2CPP_REGISTER_METHOD(
        0x02D23090,
        app::RaycastResult,
    ...
    IL2CPP_REGISTER_METHOD(
        0x02D23240,
        app::List_1_UnityEngine_EventSystems_RaycastResult_*,
        FindAll,
        app::List_1_UnityEngine_EventSystems_RaycastResult_* this_ptr,
        app::Predicate_1_UnityEngine_EventSystems_RaycastResult_* match
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ForEach,
        app::List_1_UnityEngine_EventSystems_RaycastResult_* this_ptr,
        app::Action_1_UnityEngine_EventSystems_RaycastResult_* action
    )
    IL2CPP_REGISTER_METHOD(
        0x02D23820,
        app::List_1_T_Enumerator_UnityEngine_EventSystems_RaycastResult_,
        GetEnumerator,
        app::List_1_UnityEngine_EventSystems_RaycastResult_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(

...
namespace app::classes::System::Collections::Generic::Dictionary_2_IPortalVisitor_Portal_PortalVisitorTracking_ {
    ...
    IL2CPP_REGISTER_METHOD(
        0x02BD24D0,
        app::Portal_PortalVisitorTracking*,
        get_Item,
        app::Dictionary_2_IPortalVisitor_Portal_PortalVisitorTracking_* this_ptr,
        app::IPortalVisitor* key
    )
    IL2CPP_REGISTER_METHOD(
        0x02BAC170,
        void,
        ...
        app::Dictionary_2_IPortalVisitor_Portal_PortalVisitorTracking_* this_ptr,
        app::IPortalVisitor* key,
        app::Portal_PortalVisitorTracking* value
    )

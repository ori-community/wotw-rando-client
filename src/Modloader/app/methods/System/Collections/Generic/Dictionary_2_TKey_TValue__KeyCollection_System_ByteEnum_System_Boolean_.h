...
namespace app::classes::System::Collections::Generic::Dictionary_2_TKey_TValue__KeyCollection_System_ByteEnum_System_Boolean_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::Dictionary_2_TKey_TValue_KeyCollection_System_ByteEnum_System_Boolean_* this_ptr,
        app::Dictionary_2_System_ByteEnum_System_Boolean_* dictionary
    )
    IL2CPP_REGISTER_METHOD(
        0x01ADC710,
        app::Dictionary_2_TKey_TValue_KeyCollection_TKey_TValue_Enumerator_System_ByteEnum_System_Boolean_,
        GetEnumerator,
        app::Dictionary_2_TKey_TValue_KeyCollection_System_ByteEnum_System_Boolean_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(

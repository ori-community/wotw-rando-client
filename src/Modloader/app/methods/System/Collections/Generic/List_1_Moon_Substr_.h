...
#include <Modloader/app/structs/IEnumerable_1_Moon_Substr_.h>
#include <Modloader/app/structs/IEnumerator.h>
#include <Modloader/app/structs/IEnumerator_1_Moon_Substr_.h>
#include <Modloader/app/structs/List_1_Moon_Substr_.h>
#include <Modloader/app/structs/List_1_T_Enumerator_Moon_Substr_.h>
...
namespace app::classes::System::Collections::Generic::List_1_Moon_Substr_ {
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor_1, app::List_1_Moon_Substr_* this_ptr)
    IL2CPP_REGISTER_METHOD(0x025EFF90, void, Add, app::List_1_Moon_Substr_* this_ptr, app::Substr item)
    IL2CPP_REGISTER_METHOD(0x025E81E0, void, ctor_2, app::List_1_Moon_Substr_* this_ptr, int32_t capacity)
    IL2CPP_REGISTER_METHOD(0x02DE8F80, void, ctor_3, app::List_1_Moon_Substr_* this_ptr, app::IEnumerable_1_Moon_Substr_* collection)
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t,
        BinarySearch_1,
        app::List_1_Moon_Substr_* this_ptr,
        int32_t index,
        int32_t count,
        app::Substr item,
        app::IComparer_1_Moon_Substr_* comparer
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t start_index,
        int32_t count,
        app::Predicate_1_Moon_Substr_* match
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x025F0B50,
        app::IEnumerator_1_Moon_Substr_*,

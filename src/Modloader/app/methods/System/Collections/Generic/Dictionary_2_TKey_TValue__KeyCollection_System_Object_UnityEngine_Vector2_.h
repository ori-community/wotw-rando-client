...
namespace app::classes::System::Collections::Generic::Dictionary_2_TKey_TValue__KeyCollection_System_Object_UnityEngine_Vector2_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::Dictionary_2_TKey_TValue_KeyCollection_System_Object_UnityEngine_Vector2_* this_ptr,
        app::Dictionary_2_System_Object_UnityEngine_Vector2_* dictionary
    )
    IL2CPP_REGISTER_METHOD(
        0x01A729A0,
        app::Dictionary_2_TKey_TValue_KeyCollection_TKey_TValue_Enumerator_System_Object_UnityEngine_Vector2_,
        GetEnumerator,
        app::Dictionary_2_TKey_TValue_KeyCollection_System_Object_UnityEngine_Vector2_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(

...
#include <Modloader/app/structs/Action_1_ExternalForceEntry_.h>
...
#include <Modloader/app/structs/List_1_T_Enumerator_ExternalForceEntry_.h>
...
namespace app::classes::System::Collections::Generic::List_1_ExternalForceEntry_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t,
        BinarySearch_1,
        app::List_1_ExternalForceEntry_* this_ptr,
        int32_t index,
        int32_t count,
        app::ExternalForceEntry item,
    ...
    IL2CPP_REGISTER_METHOD(
        0x02D25A30,
        app::List_1_ExternalForceEntry_*,
        FindAll,
        app::List_1_ExternalForceEntry_* this_ptr,
        app::Predicate_1_ExternalForceEntry_* match
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x02D25FF0,
        app::IEnumerator_1_ExternalForceEntry_*,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::List_1_ExternalForceEntry_* this_ptr,
        int32_t index,
        app::IEnumerable_1_ExternalForceEntry_* collection
    )

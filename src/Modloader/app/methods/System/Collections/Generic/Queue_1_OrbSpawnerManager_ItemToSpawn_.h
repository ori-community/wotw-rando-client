...
namespace app::classes::System::Collections::Generic::Queue_1_OrbSpawnerManager_ItemToSpawn_ {
    ...
    IL2CPP_REGISTER_METHOD(
        0x02CA5040,
        app::Queue_1_T_Enumerator_OrbSpawnerManager_ItemToSpawn_,
        GetEnumerator,
        app::Queue_1_OrbSpawnerManager_ItemToSpawn_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x02CA50B0,
        app::IEnumerator_1_OrbSpawnerManager_ItemToSpawn_*,

...
namespace app::classes::System::Collections::Generic::Dictionary_2_UnityEngine_Bounds_System_Boolean_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_3,
        app::Dictionary_2_UnityEngine_Bounds_System_Boolean_* this_ptr,
        app::IEqualityComparer_1_UnityEngine_Bounds_* comparer
    )
    IL2CPP_REGISTER_METHOD(
        0x02CB65F0,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ctor_5,
        app::Dictionary_2_UnityEngine_Bounds_System_Boolean_* this_ptr,
        app::IDictionary_2_UnityEngine_Bounds_System_Boolean_* dictionary
    )
    IL2CPP_REGISTER_METHOD(
        0x02CB6730,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        0x002FB990,
        app::IEqualityComparer_1_UnityEngine_Bounds_*,
        get_Comparer,
        app::Dictionary_2_UnityEngine_Bounds_System_Boolean_* this_ptr
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x0283B2B0,
        app::Dictionary_2_TKey_TValue_KeyCollection_UnityEngine_Bounds_System_Boolean_*,
        get_Keys,
        app::Dictionary_2_UnityEngine_Bounds_System_Boolean_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x0283B2B0,
        app::ICollection_1_UnityEngine_Bounds_*,
        System_Collections_Generic_IDictionary_TKey_TValue__get_Keys,
        app::Dictionary_2_UnityEngine_Bounds_System_Boolean_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x0283B2B0,
        app::IEnumerable_1_UnityEngine_Bounds_*,
        System_Collections_Generic_IReadOnlyDictionary_TKey_TValue__get_Keys,
        app::Dictionary_2_UnityEngine_Bounds_System_Boolean_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x0283B3E0,
        app::Dictionary_2_TKey_TValue_ValueCollection_UnityEngine_Bounds_System_Boolean_*,
        get_Values,
        app::Dictionary_2_UnityEngine_Bounds_System_Boolean_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Dictionary_2_UnityEngine_Bounds_System_Boolean_* this_ptr,
        app::KeyValuePair_2_UnityEngine_Bounds_System_Boolean_ key_value_pair
    )
    IL2CPP_REGISTER_METHOD(
        0x02CB6E10,
        bool,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        CopyTo,
        app::Dictionary_2_UnityEngine_Bounds_System_Boolean_* this_ptr,
        app::KeyValuePair_2_UnityEngine_Bounds_System_Boolean___Array* array,
        int32_t index
    )
    IL2CPP_REGISTER_METHOD(
        0x02CB73E0,
        app::Dictionary_2_TKey_TValue_Enumerator_UnityEngine_Bounds_System_Boolean_,
        GetEnumerator,
        app::Dictionary_2_UnityEngine_Bounds_System_Boolean_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x02CB7440,
        app::IEnumerator_1_KeyValuePair_2_UnityEngine_Bounds_System_Boolean_*,

...
namespace app::classes::System::Collections::Generic::ArraySortHelper_1_UnityEngine_BeforeRenderHelper_OrderBlock_ {
    IL2CPP_REGISTER_METHOD(
        0x02F64660,
        void,
        Sort_1,
        app::BeforeRenderHelper_OrderBlock__Array* keys,
        int32_t index,
        int32_t length,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t index,
        int32_t length,
        app::Comparison_1_UnityEngine_BeforeRenderHelper_OrderBlock_* comparer
    )
    IL2CPP_REGISTER_METHOD(
        0x02C898B0,
        int32_t,

...
#include <Modloader/app/structs/IEnumerable_1_Moon_DesiredStateTransitionInfo_.h>
...
#include <Modloader/app/structs/Predicate_1_Moon_DesiredStateTransitionInfo_.h>
...
namespace app::classes::System::Collections::Generic::List_1_Moon_DesiredStateTransitionInfo_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_3,
        app::List_1_Moon_DesiredStateTransitionInfo_* this_ptr,
        app::IEnumerable_1_Moon_DesiredStateTransitionInfo_* collection
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x025E9050,
        app::ReadOnlyCollection_1_Moon_DesiredStateTransitionInfo_*,
        AsReadOnly,
        app::List_1_Moon_DesiredStateTransitionInfo_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t index,
        int32_t count,
        app::DesiredStateTransitionInfo item,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Exists,
        app::List_1_Moon_DesiredStateTransitionInfo_* this_ptr,
        app::Predicate_1_Moon_DesiredStateTransitionInfo_* match
    )
    IL2CPP_REGISTER_METHOD(
        0x02D258D0,
    ...
    IL2CPP_REGISTER_METHOD(
        0x02D25A30,
        app::List_1_Moon_DesiredStateTransitionInfo_*,
        FindAll,
        app::List_1_Moon_DesiredStateTransitionInfo_* this_ptr,
        app::Predicate_1_Moon_DesiredStateTransitionInfo_* match
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ForEach,
        app::List_1_Moon_DesiredStateTransitionInfo_* this_ptr,
        app::Action_1_Moon_DesiredStateTransitionInfo_* action
    )
    IL2CPP_REGISTER_METHOD(
        0x02D25F90,
        app::List_1_T_Enumerator_Moon_DesiredStateTransitionInfo_,
        GetEnumerator,
        app::List_1_Moon_DesiredStateTransitionInfo_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Sort_4,
        app::List_1_Moon_DesiredStateTransitionInfo_* this_ptr,
        app::Comparison_1_Moon_DesiredStateTransitionInfo_* comparison
    )

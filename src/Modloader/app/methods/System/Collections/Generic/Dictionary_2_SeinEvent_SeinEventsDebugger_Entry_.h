...
namespace app::classes::System::Collections::Generic::Dictionary_2_SeinEvent_SeinEventsDebugger_Entry_ {
    IL2CPP_REGISTER_METHOD(
        ...
        bool,
        TryGetValue,
        app::Dictionary_2_SeinEvent_SeinEventsDebugger_Entry_* this_ptr,
        app::SeinEvent__Enum key,
        app::SeinEventsDebugger_Entry** value
    )
    IL2CPP_REGISTER_METHOD(
        0x02BAC140,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        0x0283B3E0,
        app::Dictionary_2_TKey_TValue_ValueCollection_SeinEvent_SeinEventsDebugger_Entry_*,
        get_Values,
        app::Dictionary_2_SeinEvent_SeinEventsDebugger_Entry_* this_ptr
    )

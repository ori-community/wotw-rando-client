...
namespace app::classes::System::Collections::Generic::ArraySortHelper_1_SeinSpiritSpearSpell_FlyingSpear_ {
    IL2CPP_REGISTER_METHOD(
        0x02FEFC70,
        void,
        Sort_1,
        app::SeinSpiritSpearSpell_FlyingSpear__Array* keys,
        int32_t index,
        int32_t length,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t index,
        int32_t length,
        app::Comparison_1_SeinSpiritSpearSpell_FlyingSpear_* comparer
    )
    IL2CPP_REGISTER_METHOD(
        0x02F37310,
        int32_t,

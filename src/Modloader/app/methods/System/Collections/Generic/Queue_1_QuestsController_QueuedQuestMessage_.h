...
namespace app::classes::System::Collections::Generic::Queue_1_QuestsController_QueuedQuestMessage_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Enqueue,
        app::Queue_1_QuestsController_QueuedQuestMessage_* this_ptr,
        app::QuestsController_QueuedQuestMessage item
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x0243D290,
        app::Queue_1_T_Enumerator_QuestsController_QueuedQuestMessage_,
        GetEnumerator,
        app::Queue_1_QuestsController_QueuedQuestMessage_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x0243D2D0,
        app::IEnumerator_1_QuestsController_QueuedQuestMessage_*,

...
namespace app::classes::System::Collections::Generic::ArraySortHelper_1_Moon_ActiveAnimationHandle_ {
    IL2CPP_REGISTER_METHOD(
        0x02F338A0,
        void,
        Sort_1,
        app::ActiveAnimationHandle__Array* keys,
        int32_t index,
        int32_t length,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t index,
        int32_t length,
        app::Comparison_1_Moon_ActiveAnimationHandle_* comparer
    )
    IL2CPP_REGISTER_METHOD(
        0x02C898B0,
        int32_t,

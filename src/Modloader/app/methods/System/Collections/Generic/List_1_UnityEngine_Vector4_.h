...
namespace app::classes::System::Collections::Generic::List_1_UnityEngine_Vector4_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t,
        BinarySearch_1,
        app::List_1_UnityEngine_Vector4_* this_ptr,
        int32_t index,
        int32_t count,
        app::Vector4 item,
        app::IComparer_1_UnityEngine_Vector4_* comparer
    )
    IL2CPP_REGISTER_METHOD(
        0x025E91F0,
        int32_t,
    ...
    IL2CPP_REGISTER_METHOD(
        0x025E9800,
        app::List_1_UnityEngine_Vector4_*,
        FindAll,
        app::List_1_UnityEngine_Vector4_* this_ptr,
        app::Predicate_1_UnityEngine_Vector4_* match
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::List_1_UnityEngine_Vector4_* this_ptr,
        int32_t index,
        app::IEnumerable_1_UnityEngine_Vector4_* collection
    )

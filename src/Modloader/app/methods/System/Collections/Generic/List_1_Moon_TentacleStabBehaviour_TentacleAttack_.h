...
namespace app::classes::System::Collections::Generic::List_1_Moon_TentacleStabBehaviour_TentacleAttack_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Add,
        app::List_1_Moon_TentacleStabBehaviour_TentacleAttack_* this_ptr,
        app::TentacleStabBehaviour_TentacleAttack item
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ctor_3,
        app::List_1_Moon_TentacleStabBehaviour_TentacleAttack_* this_ptr,
        app::IEnumerable_1_Moon_TentacleStabBehaviour_TentacleAttack_* collection
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x025E9050,
        app::ReadOnlyCollection_1_Moon_TentacleStabBehaviour_TentacleAttack_*,
        AsReadOnly,
        app::List_1_Moon_TentacleStabBehaviour_TentacleAttack_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Exists,
        app::List_1_Moon_TentacleStabBehaviour_TentacleAttack_* this_ptr,
        app::Predicate_1_Moon_TentacleStabBehaviour_TentacleAttack_* match
    )
    IL2CPP_REGISTER_METHOD(
        0x025ED1F0,
        app::TentacleStabBehaviour_TentacleAttack,
    ...
    IL2CPP_REGISTER_METHOD(
        0x025ED330,
        app::List_1_Moon_TentacleStabBehaviour_TentacleAttack_*,
        FindAll,
        app::List_1_Moon_TentacleStabBehaviour_TentacleAttack_* this_ptr,
        app::Predicate_1_Moon_TentacleStabBehaviour_TentacleAttack_* match
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ForEach,
        app::List_1_Moon_TentacleStabBehaviour_TentacleAttack_* this_ptr,
        app::Action_1_Moon_TentacleStabBehaviour_TentacleAttack_* action
    )
    IL2CPP_REGISTER_METHOD(
        0x025ED850,
        app::List_1_T_Enumerator_Moon_TentacleStabBehaviour_TentacleAttack_,
        GetEnumerator,
        app::List_1_Moon_TentacleStabBehaviour_TentacleAttack_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Sort_4,
        app::List_1_Moon_TentacleStabBehaviour_TentacleAttack_* this_ptr,
        app::Comparison_1_Moon_TentacleStabBehaviour_TentacleAttack_* comparison
    )
    IL2CPP_REGISTER_METHOD(
        0x025EAEF0,
        app::TentacleStabBehaviour_TentacleAttack__Array*,
        ToArray,
        app::List_1_Moon_TentacleStabBehaviour_TentacleAttack_* this_ptr
    )

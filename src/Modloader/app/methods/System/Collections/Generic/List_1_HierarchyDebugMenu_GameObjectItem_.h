...
namespace app::classes::System::Collections::Generic::List_1_HierarchyDebugMenu_GameObjectItem_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        get_Item,
        app::List_1_HierarchyDebugMenu_GameObjectItem_* this_ptr,
        int32_t index
    )
    IL2CPP_REGISTER_METHOD(0x00529FF0, int32_t, get_Count, app::List_1_HierarchyDebugMenu_GameObjectItem_* this_ptr)
    IL2CPP_REGISTER_METHOD(
        0x025F0B10,
        app::List_1_T_Enumerator_HierarchyDebugMenu_GameObjectItem_,
        GetEnumerator,
        app::List_1_HierarchyDebugMenu_GameObjectItem_* this_ptr
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Sort,
        app::List_1_HierarchyDebugMenu_GameObjectItem_* this_ptr,
        app::Comparison_1_HierarchyDebugMenu_GameObjectItem_* comparison
    )
    IL2CPP_REGISTER_METHOD(
        0x02F1EA40,
        void,

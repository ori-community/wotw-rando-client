...
namespace app::classes::System::Collections::Generic::Dictionary_2_System_String_Microsoft_Applications_Events_DataModels_Value_ {
    ...
    IL2CPP_REGISTER_METHOD(
        0x02BA5400,
        app::Dictionary_2_TKey_TValue_Enumerator_System_String_Microsoft_Applications_Events_DataModels_Value_,
        GetEnumerator,
        app::Dictionary_2_System_String_Microsoft_Applications_Events_DataModels_Value_* this_ptr
    )

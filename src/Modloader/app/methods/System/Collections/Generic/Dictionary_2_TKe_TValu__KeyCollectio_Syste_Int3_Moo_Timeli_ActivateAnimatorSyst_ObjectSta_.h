...
#include <Modloader/app/structs/Dictionary_2_TK_TVal_KeyCollect_T_TVa_Enumera_Sys_In_M_Timel_ActivateAnimatorSys_ObjectSt_.h>
...
namespace app::classes::System::Collections::Generic::Dictionary_2_TKey_TValue__KeyCollection_System_Int32_Moon_Timeline_ActivateAnimatorSystem_ObjectState_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::Dictionary_2_TKey_TValue_KeyCollection_System_Int32_Moon_Timeline_ActivateAnimatorSystem_ObjectState_* this_ptr,
        app::Dictionary_2_System_Int32_Moon_Timeline_ActivateAnimatorSystem_ObjectState_* dictionary
    )
    IL2CPP_REGISTER_METHOD(
        0x01A78360,
        app::Dictionary_2_TKey_TValue_KeyCollection_TKey_TValue_Enumerator_System_Int32_Moon_Timeline_ActivateAnimatorSystem_ObjectState_,
        GetEnumerator,
        app::Dictionary_2_TKey_TValue_KeyCollection_System_Int32_Moon_Timeline_ActivateAnimatorSystem_ObjectState_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
  ...
  // app::classes::System::Collections::Generic::Dictionary_2_TKey_TValue__KeyCollection_System_Int32_Moon_Timeline_ActivateAnimatorSystem_ObjectState_

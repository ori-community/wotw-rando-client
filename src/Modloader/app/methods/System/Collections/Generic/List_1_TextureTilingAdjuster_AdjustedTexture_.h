...
namespace app::classes::System::Collections::Generic::List_1_TextureTilingAdjuster_AdjustedTexture_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        get_Item,
        app::List_1_TextureTilingAdjuster_AdjustedTexture_* this_ptr,
        int32_t index
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ctor_3,
        app::List_1_TextureTilingAdjuster_AdjustedTexture_* this_ptr,
        app::IEnumerable_1_TextureTilingAdjuster_AdjustedTexture_* collection
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x025E9050,
        app::ReadOnlyCollection_1_TextureTilingAdjuster_AdjustedTexture_*,
        AsReadOnly,
        app::List_1_TextureTilingAdjuster_AdjustedTexture_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t index,
        int32_t count,
        app::TextureTilingAdjuster_AdjustedTexture item,
        app::IComparer_1_TextureTilingAdjuster_AdjustedTexture_* comparer
    )
    IL2CPP_REGISTER_METHOD(
        0x02D4A210,
        int32_t,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Exists,
        app::List_1_TextureTilingAdjuster_AdjustedTexture_* this_ptr,
        app::Predicate_1_TextureTilingAdjuster_AdjustedTexture_* match
    )
    IL2CPP_REGISTER_METHOD(
        0x02D4A5E0,
        app::TextureTilingAdjuster_AdjustedTexture,
    ...
    IL2CPP_REGISTER_METHOD(
        0x02D4A710,
        app::List_1_TextureTilingAdjuster_AdjustedTexture_*,
        FindAll,
        app::List_1_TextureTilingAdjuster_AdjustedTexture_* this_ptr,
        app::Predicate_1_TextureTilingAdjuster_AdjustedTexture_* match
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ForEach,
        app::List_1_TextureTilingAdjuster_AdjustedTexture_* this_ptr,
        app::Action_1_TextureTilingAdjuster_AdjustedTexture_* action
    )
    IL2CPP_REGISTER_METHOD(
        0x02D4AC20,
        app::List_1_T_Enumerator_TextureTilingAdjuster_AdjustedTexture_,
        GetEnumerator,
        app::List_1_TextureTilingAdjuster_AdjustedTexture_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
    ...
    IL2CPP_REGISTER_METHOD(
        0x025EAEF0,
        app::TextureTilingAdjuster_AdjustedTexture__Array*,
        ToArray,
        app::List_1_TextureTilingAdjuster_AdjustedTexture_* this_ptr
    )

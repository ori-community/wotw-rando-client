...
namespace app::classes::System::Collections::Generic::List_1_MessageDescriptor_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t,
        BinarySearch_1,
        app::List_1_MessageDescriptor_* this_ptr,
        int32_t index,
        int32_t count,
        app::MessageDescriptor item,
        app::IComparer_1_MessageDescriptor_* comparer
    )
    IL2CPP_REGISTER_METHOD(
        0x02C1E650,
        int32_t,
    ...
    IL2CPP_REGISTER_METHOD(
        0x02C1EB60,
        app::List_1_MessageDescriptor_*,
        FindAll,
        app::List_1_MessageDescriptor_* this_ptr,
        app::Predicate_1_MessageDescriptor_* match
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::List_1_MessageDescriptor_* this_ptr,
        int32_t index,
        app::IEnumerable_1_MessageDescriptor_* collection
    )

...
#include <Modloader/app/structs/Dictionary_2_TKey_TValue_Enumerator_System_UInt64_System_Object_.h>
...
#include <Modloader/app/structs/ICollection_1_System_UInt64_.h>
#include <Modloader/app/structs/IDictionaryEnumerator.h>
#include <Modloader/app/structs/IDictionary_2_System_UInt64_System_Object_.h>
#include <Modloader/app/structs/IEnumerable_1_System_Object_.h>
#include <Modloader/app/structs/IEnumerable_1_System_UInt64_.h>
#include <Modloader/app/structs/IEnumerator.h>
#include <Modloader/app/structs/IEnumerator_1_KeyValuePair_2_System_UInt64_System_Object_.h>
...
#include <Modloader/app/structs/KeyValuePair_2_System_UInt64_System_Object___Array.h>
#include <Modloader/app/structs/Object.h>
#include <Modloader/app/structs/SerializationInfo.h>
#include <Modloader/app/structs/StreamingContext.h>

namespace app::classes::System::Collections::Generic::Dictionary_2_System_UInt64_System_Object_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_3,
        app::Dictionary_2_System_UInt64_System_Object_* this_ptr,
        app::IEqualityComparer_1_System_UInt64_* comparer
    )
    IL2CPP_REGISTER_METHOD(
        0x02F08130,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ctor_5,
        app::Dictionary_2_System_UInt64_System_Object_* this_ptr,
        app::IDictionary_2_System_UInt64_System_Object_* dictionary
    )
    IL2CPP_REGISTER_METHOD(
        0x02F08270,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        0x0283B2B0,
        app::Dictionary_2_TKey_TValue_KeyCollection_System_UInt64_System_Object_*,
        get_Keys,
        app::Dictionary_2_System_UInt64_System_Object_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x0283B2B0,
        app::ICollection_1_System_UInt64_*,
        System_Collections_Generic_IDictionary_TKey_TValue__get_Keys,
        app::Dictionary_2_System_UInt64_System_Object_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x0283B2B0,
        app::IEnumerable_1_System_UInt64_*,
        System_Collections_Generic_IReadOnlyDictionary_TKey_TValue__get_Keys,
        app::Dictionary_2_System_UInt64_System_Object_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x0283B3E0,
        app::Dictionary_2_TKey_TValue_ValueCollection_System_UInt64_System_Object_*,
        get_Values,
        app::Dictionary_2_System_UInt64_System_Object_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Dictionary_2_System_UInt64_System_Object_* this_ptr,
        app::KeyValuePair_2_System_UInt64_System_Object_ key_value_pair
    )
    IL2CPP_REGISTER_METHOD(
        0x02BD2610,
        bool,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        CopyTo,
        app::Dictionary_2_System_UInt64_System_Object_* this_ptr,
        app::KeyValuePair_2_System_UInt64_System_Object___Array* array,
        int32_t index
    )
    IL2CPP_REGISTER_METHOD(
        0x02BA5400,
        app::Dictionary_2_TKey_TValue_Enumerator_System_UInt64_System_Object_,
        GetEnumerator,
        app::Dictionary_2_System_UInt64_System_Object_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x02BA5450,
        app::IEnumerator_1_KeyValuePair_2_System_UInt64_System_Object_*,

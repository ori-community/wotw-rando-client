...
namespace app::classes::System::Collections::Generic::Dictionary_2_System_Int32_Moon_Timeline_EventHistoryItem_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_3,
        app::Dictionary_2_System_Int32_Moon_Timeline_EventHistoryItem_* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ctor_5,
        app::Dictionary_2_System_Int32_Moon_Timeline_EventHistoryItem_* this_ptr,
        app::IDictionary_2_System_Int32_Moon_Timeline_EventHistoryItem_* dictionary
    )
    IL2CPP_REGISTER_METHOD(
        0x02BA4760,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        0x0283B2B0,
        app::Dictionary_2_TKey_TValue_KeyCollection_System_Int32_Moon_Timeline_EventHistoryItem_*,
        get_Keys,
        app::Dictionary_2_System_Int32_Moon_Timeline_EventHistoryItem_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
    ...
    IL2CPP_REGISTER_METHOD(
        0x0283B3E0,
        app::Dictionary_2_TKey_TValue_ValueCollection_System_Int32_Moon_Timeline_EventHistoryItem_*,
        get_Values,
        app::Dictionary_2_System_Int32_Moon_Timeline_EventHistoryItem_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x0283B3E0,
        app::ICollection_1_Moon_Timeline_EventHistoryItem_*,
        System_Collections_Generic_IDictionary_TKey_TValue__get_Values,
        app::Dictionary_2_System_Int32_Moon_Timeline_EventHistoryItem_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x0283B3E0,
        app::IEnumerable_1_Moon_Timeline_EventHistoryItem_*,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Dictionary_2_System_Int32_Moon_Timeline_EventHistoryItem_* this_ptr,
        app::KeyValuePair_2_System_Int32_Moon_Timeline_EventHistoryItem_ key_value_pair
    )
    IL2CPP_REGISTER_METHOD(
        0x02BA4E40,
        bool,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        CopyTo,
        app::Dictionary_2_System_Int32_Moon_Timeline_EventHistoryItem_* this_ptr,
        app::KeyValuePair_2_System_Int32_Moon_Timeline_EventHistoryItem___Array* array,
        int32_t index
    )
    IL2CPP_REGISTER_METHOD(
        0x02BA5400,
        app::Dictionary_2_TKey_TValue_Enumerator_System_Int32_Moon_Timeline_EventHistoryItem_,
        GetEnumerator,
        app::Dictionary_2_System_Int32_Moon_Timeline_EventHistoryItem_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x02BA5450,
        app::IEnumerator_1_KeyValuePair_2_System_Int32_Moon_Timeline_EventHistoryItem_*,

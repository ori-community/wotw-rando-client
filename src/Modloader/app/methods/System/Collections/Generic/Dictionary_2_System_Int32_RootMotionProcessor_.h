...
namespace app::classes::System::Collections::Generic::Dictionary_2_System_Int32_RootMotionProcessor_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        bool,
        TryGetValue,
        app::Dictionary_2_System_Int32_RootMotionProcessor_* this_ptr,
        int32_t key,
        app::RootMotionProcessor** value
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x02BA5400,
        app::Dictionary_2_TKey_TValue_Enumerator_System_Int32_RootMotionProcessor_,
        GetEnumerator,
        app::Dictionary_2_System_Int32_RootMotionProcessor_* this_ptr
    )

...
namespace app::classes::System::Collections::Generic::Dictionary_2_System_Int32Enum_UnityEngine_Color_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_3,
        app::Dictionary_2_System_Int32Enum_UnityEngine_Color_* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ctor_5,
        app::Dictionary_2_System_Int32Enum_UnityEngine_Color_* this_ptr,
        app::IDictionary_2_System_Int32Enum_UnityEngine_Color_* dictionary
    )
    IL2CPP_REGISTER_METHOD(
        0x02C3AEB0,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        0x0283B2B0,
        app::Dictionary_2_TKey_TValue_KeyCollection_System_Int32Enum_UnityEngine_Color_*,
        get_Keys,
        app::Dictionary_2_System_Int32Enum_UnityEngine_Color_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
    ...
    IL2CPP_REGISTER_METHOD(
        0x0283B3E0,
        app::Dictionary_2_TKey_TValue_ValueCollection_System_Int32Enum_UnityEngine_Color_*,
        get_Values,
        app::Dictionary_2_System_Int32Enum_UnityEngine_Color_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Dictionary_2_System_Int32Enum_UnityEngine_Color_* this_ptr,
        app::KeyValuePair_2_System_Int32Enum_UnityEngine_Color_ key_value_pair
    )
    IL2CPP_REGISTER_METHOD(
        0x02C3B4C0,
        bool,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        CopyTo,
        app::Dictionary_2_System_Int32Enum_UnityEngine_Color_* this_ptr,
        app::KeyValuePair_2_System_Int32Enum_UnityEngine_Color___Array* array,
        int32_t index
    )
    IL2CPP_REGISTER_METHOD(
        0x02C3BA00,
        app::Dictionary_2_TKey_TValue_Enumerator_System_Int32Enum_UnityEngine_Color_,
        GetEnumerator,
        app::Dictionary_2_System_Int32Enum_UnityEngine_Color_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x02C3BA50,
        app::IEnumerator_1_KeyValuePair_2_System_Int32Enum_UnityEngine_Color_*,

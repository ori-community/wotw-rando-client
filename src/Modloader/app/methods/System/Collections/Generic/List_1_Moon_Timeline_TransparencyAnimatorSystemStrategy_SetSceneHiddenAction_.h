...
namespace app::classes::System::Collections::Generic::List_1_Moon_Timeline_TransparencyAnimatorSystemStrategy_SetSceneHiddenAction_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Add,
        app::List_1_Moon_Timeline_TransparencyAnimatorSystemStrategy_SetSceneHiddenAction_* this_ptr,
        app::TransparencyAnimatorSystemStrategy_SetSceneHiddenAction item
    )
    IL2CPP_REGISTER_METHOD(
        0x025E8A60,
        app::TransparencyAnimatorSystemStrategy_SetSceneHiddenAction,
        get_Item,
        app::List_1_Moon_Timeline_TransparencyAnimatorSystemStrategy_SetSceneHiddenAction_* this_ptr,
        int32_t index
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ctor_3,
        app::List_1_Moon_Timeline_TransparencyAnimatorSystemStrategy_SetSceneHiddenAction_* this_ptr,
        app::IEnumerable_1_Moon_Timeline_TransparencyAnimatorSystemStrategy_SetSceneHiddenAction_* collection
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::List_1_Moon_Timeline_TransparencyAnimatorSystemStrategy_SetSceneHiddenAction_* this_ptr,
        int32_t index,
        app::TransparencyAnimatorSystemStrategy_SetSceneHiddenAction value
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x025E9050,
        app::ReadOnlyCollection_1_Moon_Timeline_TransparencyAnimatorSystemStrategy_SetSceneHiddenAction_*,
        AsReadOnly,
        app::List_1_Moon_Timeline_TransparencyAnimatorSystemStrategy_SetSceneHiddenAction_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t count,
        app::TransparencyAnimatorSystemStrategy_SetSceneHiddenAction item,
        app::IComparer_1_Moon_Timeline_TransparencyAnimatorSystemStrategy_SetSceneHiddenAction_* comparer
    )
    IL2CPP_REGISTER_METHOD(
        0x025E91F0,
        int32_t,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        CopyTo_1,
        app::List_1_Moon_Timeline_TransparencyAnimatorSystemStrategy_SetSceneHiddenAction_* this_ptr,
        app::TransparencyAnimatorSystemStrategy_SetSceneHiddenAction__Array* array
    )
    IL2CPP_REGISTER_METHOD(
        0x02DC0C70,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Exists,
        app::List_1_Moon_Timeline_TransparencyAnimatorSystemStrategy_SetSceneHiddenAction_* this_ptr,
        app::Predicate_1_Moon_Timeline_TransparencyAnimatorSystemStrategy_SetSceneHiddenAction_* match
    )
    IL2CPP_REGISTER_METHOD(
        0x025E96E0,
        app::TransparencyAnimatorSystemStrategy_SetSceneHiddenAction,
    ...
    IL2CPP_REGISTER_METHOD(
        0x025E9800,
        app::List_1_Moon_Timeline_TransparencyAnimatorSystemStrategy_SetSceneHiddenAction_*,
        FindAll,
        app::List_1_Moon_Timeline_TransparencyAnimatorSystemStrategy_SetSceneHiddenAction_* this_ptr,
        app::Predicate_1_Moon_Timeline_TransparencyAnimatorSystemStrategy_SetSceneHiddenAction_* match
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ForEach,
        app::List_1_Moon_Timeline_TransparencyAnimatorSystemStrategy_SetSceneHiddenAction_* this_ptr,
        app::Action_1_Moon_Timeline_TransparencyAnimatorSystemStrategy_SetSceneHiddenAction_* action
    )
    IL2CPP_REGISTER_METHOD(
        0x025E9D20,
        app::List_1_T_Enumerator_Moon_Timeline_TransparencyAnimatorSystemStrategy_SetSceneHiddenAction_,
        GetEnumerator,
        app::List_1_Moon_Timeline_TransparencyAnimatorSystemStrategy_SetSceneHiddenAction_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x025E9D60,
        app::IEnumerator_1_Moon_Timeline_TransparencyAnimatorSystemStrategy_SetSceneHiddenAction_*,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Sort_4,
        app::List_1_Moon_Timeline_TransparencyAnimatorSystemStrategy_SetSceneHiddenAction_* this_ptr,
        app::Comparison_1_Moon_Timeline_TransparencyAnimatorSystemStrategy_SetSceneHiddenAction_* comparison
    )
    IL2CPP_REGISTER_METHOD(
        0x025EAEF0,

...
namespace app::classes::System::Collections::Generic::
    Dictionary_2_TKey_TValue__ValueCollection_MS_Internal_Xml_Cache_XPathNodeRef_MS_Internal_Xml_Cache_XPathNodeRef_ {
    IL2CPP_REGISTER_METHOD(
        0x01AD8DB0,
        void,
        ctor,
        app::Dictionary_2_TKey_TValue_ValueCollection_MS_Internal_Xml_Cache_XPathNodeRef_MS_Internal_Xml_Cache_XPathNodeRef_* this_ptr,
        app::Dictionary_2_MS_Internal_Xml_Cache_XPathNodeRef_MS_Internal_Xml_Cache_XPathNodeRef_* dictionary
    )
    IL2CPP_REGISTER_METHOD(
        0x01A7A830,
        app::Dictionary_2_TKey_TValue_ValueCollection_TKey_TValue_Enumerator_MS_Internal_Xml_Cache_XPathNodeRef_MS_Internal_Xml_Cache_XPathNodeRef_,
        GetEnumerator,
        app::Dictionary_2_TKey_TValue_ValueCollection_MS_Internal_Xml_Cache_XPathNodeRef_MS_Internal_Xml_Cache_XPathNodeRef_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
    ...
    IL2CPP_REGISTER_METHOD(
        0x01A7AC00,
        app::IEnumerator_1_MS_Internal_Xml_Cache_XPathNodeRef_*,
  ...
  // app::classes::System::Collections::Generic::Dictionary_2_TKey_TValue__ValueCollection_MS_Internal_Xml_Cache_XPathNodeRef_MS_Internal_Xml_Cache_XPathNodeRef_

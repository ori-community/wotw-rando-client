...
namespace app::classes::System::Collections::Generic::Dictionary_2_UnityEngine_GameObject_LeashMarkEffect_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::LeashMarkEffect*,
        get_Item,
        app::Dictionary_2_UnityEngine_GameObject_LeashMarkEffect_* this_ptr,
        app::GameObject* key
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Dictionary_2_UnityEngine_GameObject_LeashMarkEffect_* this_ptr,
        app::GameObject* key,
        app::LeashMarkEffect* value
    )
    IL2CPP_REGISTER_METHOD(
        0x0283B2B0,
        app::Dictionary_2_TKey_TValue_KeyCollection_UnityEngine_GameObject_LeashMarkEffect_*,
        get_Keys,
        app::Dictionary_2_UnityEngine_GameObject_LeashMarkEffect_* this_ptr
    )

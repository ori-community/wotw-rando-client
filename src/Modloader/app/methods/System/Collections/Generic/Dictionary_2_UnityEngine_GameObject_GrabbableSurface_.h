...
namespace app::classes::System::Collections::Generic::Dictionary_2_UnityEngine_GameObject_GrabbableSurface_ {
    IL2CPP_REGISTER_METHOD(
        ...
        bool,
        TryGetValue,
        app::Dictionary_2_UnityEngine_GameObject_GrabbableSurface_* this_ptr,
        app::GameObject* key,
        app::GrabbableSurface** value
    )
    IL2CPP_REGISTER_METHOD(
        0x02BAC170,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        0x02BA5400,
        app::Dictionary_2_TKey_TValue_Enumerator_UnityEngine_GameObject_GrabbableSurface_,
        GetEnumerator,
        app::Dictionary_2_UnityEngine_GameObject_GrabbableSurface_* this_ptr
    )

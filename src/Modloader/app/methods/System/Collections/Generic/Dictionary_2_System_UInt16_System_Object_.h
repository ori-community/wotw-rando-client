...
namespace app::classes::System::Collections::Generic::Dictionary_2_System_UInt16_System_Object_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_3,
        app::Dictionary_2_System_UInt16_System_Object_* this_ptr,
        app::IEqualityComparer_1_System_UInt16_* comparer
    )
    IL2CPP_REGISTER_METHOD(
        0x02EFB9B0,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ctor_5,
        app::Dictionary_2_System_UInt16_System_Object_* this_ptr,
        app::IDictionary_2_System_UInt16_System_Object_* dictionary
    )
    IL2CPP_REGISTER_METHOD(
        0x02EFBAF0,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        0x0283B2B0,
        app::Dictionary_2_TKey_TValue_KeyCollection_System_UInt16_System_Object_*,
        get_Keys,
        app::Dictionary_2_System_UInt16_System_Object_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x0283B2B0,
        app::ICollection_1_System_UInt16_*,
        System_Collections_Generic_IDictionary_TKey_TValue__get_Keys,
        app::Dictionary_2_System_UInt16_System_Object_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x0283B2B0,
        app::IEnumerable_1_System_UInt16_*,
        System_Collections_Generic_IReadOnlyDictionary_TKey_TValue__get_Keys,
        app::Dictionary_2_System_UInt16_System_Object_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x0283B3E0,
        app::Dictionary_2_TKey_TValue_ValueCollection_System_UInt16_System_Object_*,
        get_Values,
        app::Dictionary_2_System_UInt16_System_Object_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Dictionary_2_System_UInt16_System_Object_* this_ptr,
        app::KeyValuePair_2_System_UInt16_System_Object_ key_value_pair
    )
    IL2CPP_REGISTER_METHOD(
        0x02EFC0C0,
        bool,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        CopyTo,
        app::Dictionary_2_System_UInt16_System_Object_* this_ptr,
        app::KeyValuePair_2_System_UInt16_System_Object___Array* array,
        int32_t index
    )
    IL2CPP_REGISTER_METHOD(
        0x02BA5400,
        app::Dictionary_2_TKey_TValue_Enumerator_System_UInt16_System_Object_,
        GetEnumerator,
        app::Dictionary_2_System_UInt16_System_Object_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x02BA5450,
        app::IEnumerator_1_KeyValuePair_2_System_UInt16_System_Object_*,

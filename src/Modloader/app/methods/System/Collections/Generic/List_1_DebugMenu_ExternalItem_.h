...
namespace app::classes::System::Collections::Generic::List_1_DebugMenu_ExternalItem_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t,
        BinarySearch_1,
        app::List_1_DebugMenu_ExternalItem_* this_ptr,
        int32_t index,
        int32_t count,
        app::DebugMenu_ExternalItem item,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Find,
        app::List_1_DebugMenu_ExternalItem_* this_ptr,
        app::Predicate_1_DebugMenu_ExternalItem_* match
    )
    IL2CPP_REGISTER_METHOD(
        0x025E9800,
        app::List_1_DebugMenu_ExternalItem_*,
        FindAll,
        app::List_1_DebugMenu_ExternalItem_* this_ptr,
        app::Predicate_1_DebugMenu_ExternalItem_* match
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x025E9D60,
        app::IEnumerator_1_DebugMenu_ExternalItem_*,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::List_1_DebugMenu_ExternalItem_* this_ptr,
        int32_t index,
        app::IEnumerable_1_DebugMenu_ExternalItem_* collection
    )

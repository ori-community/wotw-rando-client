...
namespace app::classes::System::Collections::Generic::Comparer_1_XboxOneStatistics_StatisticReading_ {
    IL2CPP_REGISTER_METHOD(0x02807CD0, app::Comparer_1_XboxOneStatistics_StatisticReading_*, get_Default, )
    IL2CPP_REGISTER_METHOD(
        0x028DBEB0,
        app::Comparer_1_XboxOneStatistics_StatisticReading_*,
        Create,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t,
        IComparer_Compare,
        app::Comparer_1_XboxOneStatistics_StatisticReading_* this_ptr,
        app::Object* x,
        app::Object* y
    )

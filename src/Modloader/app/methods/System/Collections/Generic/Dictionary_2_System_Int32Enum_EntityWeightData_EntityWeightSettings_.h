...
#include <Modloader/app/structs/Dictionary_2_TKey_TValu_ValueCollectio_Syste_Int32Enu_EntityWeightDat_EntityWeightSetting_.h>
...
#include <Modloader/app/structs/Dictionary_2_TKey_TValue_KeyCollection_Syste_Int32Enu_EntityWeightDat_EntityWeightSetting_.h>
...
namespace app::classes::System::Collections::Generic::Dictionary_2_System_Int32Enum_EntityWeightData_EntityWeightSettings_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_3,
        app::Dictionary_2_System_Int32Enum_EntityWeightData_EntityWeightSettings_* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ctor_5,
        app::Dictionary_2_System_Int32Enum_EntityWeightData_EntityWeightSettings_* this_ptr,
        app::IDictionary_2_System_Int32Enum_EntityWeightData_EntityWeightSettings_* dictionary
    )
    IL2CPP_REGISTER_METHOD(
        0x02DB1B40,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        0x0283B2B0,
        app::Dictionary_2_TKey_TValue_KeyCollection_System_Int32Enum_EntityWeightData_EntityWeightSettings_*,
        get_Keys,
        app::Dictionary_2_System_Int32Enum_EntityWeightData_EntityWeightSettings_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
    ...
    IL2CPP_REGISTER_METHOD(
        0x0283B3E0,
        app::Dictionary_2_TKey_TValue_ValueCollection_System_Int32Enum_EntityWeightData_EntityWeightSettings_*,
        get_Values,
        app::Dictionary_2_System_Int32Enum_EntityWeightData_EntityWeightSettings_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x0283B3E0,
        app::ICollection_1_EntityWeightData_EntityWeightSettings_*,
        System_Collections_Generic_IDictionary_TKey_TValue__get_Values,
        app::Dictionary_2_System_Int32Enum_EntityWeightData_EntityWeightSettings_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x0283B3E0,
        app::IEnumerable_1_EntityWeightData_EntityWeightSettings_*,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Dictionary_2_System_Int32Enum_EntityWeightData_EntityWeightSettings_* this_ptr,
        app::KeyValuePair_2_System_Int32Enum_EntityWeightData_EntityWeightSettings_ key_value_pair
    )
    IL2CPP_REGISTER_METHOD(
        0x02DB2480,
        bool,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        CopyTo,
        app::Dictionary_2_System_Int32Enum_EntityWeightData_EntityWeightSettings_* this_ptr,
        app::KeyValuePair_2_System_Int32Enum_EntityWeightData_EntityWeightSettings___Array* array,
        int32_t index
    )
    IL2CPP_REGISTER_METHOD(
        0x02DB2D20,
        app::Dictionary_2_TKey_TValue_Enumerator_System_Int32Enum_EntityWeightData_EntityWeightSettings_,
        GetEnumerator,
        app::Dictionary_2_System_Int32Enum_EntityWeightData_EntityWeightSettings_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x02DB2D90,
        app::IEnumerator_1_KeyValuePair_2_System_Int32Enum_EntityWeightData_EntityWeightSettings_*,

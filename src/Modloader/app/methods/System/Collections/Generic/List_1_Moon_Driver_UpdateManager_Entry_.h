...
namespace app::classes::System::Collections::Generic::List_1_Moon_Driver_UpdateManager_Entry_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        AddRange,
        app::List_1_Moon_Driver_UpdateManager_Entry_* this_ptr,
        app::IEnumerable_1_Moon_Driver_UpdateManager_Entry_* collection
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        BinarySearch,
        app::List_1_Moon_Driver_UpdateManager_Entry_* this_ptr,
        app::UpdateManager_Entry* item,
        app::IComparer_1_Moon_Driver_UpdateManager_Entry_* comparer
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x025F0B10,
        app::List_1_T_Enumerator_Moon_Driver_UpdateManager_Entry_,
        GetEnumerator,
        app::List_1_Moon_Driver_UpdateManager_Entry_* this_ptr
    )
} // namespace app::classes::System::Collections::Generic::List_1_Moon_Driver_UpdateManager_Entry_

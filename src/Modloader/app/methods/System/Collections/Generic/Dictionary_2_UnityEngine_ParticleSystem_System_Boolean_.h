...
namespace app::classes::System::Collections::Generic::Dictionary_2_UnityEngine_ParticleSystem_System_Boolean_ {
    ...
    IL2CPP_REGISTER_METHOD(
        0x0283B2B0,
        app::Dictionary_2_TKey_TValue_KeyCollection_UnityEngine_ParticleSystem_System_Boolean_*,
        get_Keys,
        app::Dictionary_2_UnityEngine_ParticleSystem_System_Boolean_* this_ptr
    )

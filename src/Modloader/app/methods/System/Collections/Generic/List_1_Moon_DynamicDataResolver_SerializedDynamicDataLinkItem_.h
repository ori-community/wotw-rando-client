...
namespace app::classes::System::Collections::Generic::List_1_Moon_DynamicDataResolver_SerializedDynamicDataLinkItem_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Add,
        app::List_1_Moon_DynamicDataResolver_SerializedDynamicDataLinkItem_* this_ptr,
        app::DynamicDataResolver_SerializedDynamicDataLinkItem item
    )
    IL2CPP_REGISTER_METHOD(
        0x02D525D0,
        app::List_1_T_Enumerator_Moon_DynamicDataResolver_SerializedDynamicDataLinkItem_,
        GetEnumerator,
        app::List_1_Moon_DynamicDataResolver_SerializedDynamicDataLinkItem_* this_ptr
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ctor_3,
        app::List_1_Moon_DynamicDataResolver_SerializedDynamicDataLinkItem_* this_ptr,
        app::IEnumerable_1_Moon_DynamicDataResolver_SerializedDynamicDataLinkItem_* collection
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x025E9050,
        app::ReadOnlyCollection_1_Moon_DynamicDataResolver_SerializedDynamicDataLinkItem_*,
        AsReadOnly,
        app::List_1_Moon_DynamicDataResolver_SerializedDynamicDataLinkItem_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t count,
        app::DynamicDataResolver_SerializedDynamicDataLinkItem item,
        app::IComparer_1_Moon_DynamicDataResolver_SerializedDynamicDataLinkItem_* comparer
    )
    IL2CPP_REGISTER_METHOD(
        0x02D51B20,
        int32_t,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Exists,
        app::List_1_Moon_DynamicDataResolver_SerializedDynamicDataLinkItem_* this_ptr,
        app::Predicate_1_Moon_DynamicDataResolver_SerializedDynamicDataLinkItem_* match
    )
    IL2CPP_REGISTER_METHOD(
        0x02D51F20,
        app::DynamicDataResolver_SerializedDynamicDataLinkItem,
    ...
    IL2CPP_REGISTER_METHOD(
        0x02D52080,
        app::List_1_Moon_DynamicDataResolver_SerializedDynamicDataLinkItem_*,
        FindAll,
        app::List_1_Moon_DynamicDataResolver_SerializedDynamicDataLinkItem_* this_ptr,
        app::Predicate_1_Moon_DynamicDataResolver_SerializedDynamicDataLinkItem_* match
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ForEach,
        app::List_1_Moon_DynamicDataResolver_SerializedDynamicDataLinkItem_* this_ptr,
        app::Action_1_Moon_DynamicDataResolver_SerializedDynamicDataLinkItem_* action
    )
    IL2CPP_REGISTER_METHOD(
        0x02D52630,
    ...
    IL2CPP_REGISTER_METHOD(
        0x025EAEF0,
        app::DynamicDataResolver_SerializedDynamicDataLinkItem__Array*,
        ToArray,
        app::List_1_Moon_DynamicDataResolver_SerializedDynamicDataLinkItem_* this_ptr
    )

...
namespace app::classes::System::Collections::Generic::Dictionary_2_System_Int32_UnityEngine_EventSystems_PointerEventData_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        bool,
        TryGetValue,
        app::Dictionary_2_System_Int32_UnityEngine_EventSystems_PointerEventData_* this_ptr,
        int32_t key,
        app::PointerEventData** value
    )
    IL2CPP_REGISTER_METHOD(
        0x02BAC170,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        0x0283B3E0,
        app::Dictionary_2_TKey_TValue_ValueCollection_System_Int32_UnityEngine_EventSystems_PointerEventData_*,
        get_Values,
        app::Dictionary_2_System_Int32_UnityEngine_EventSystems_PointerEventData_* this_ptr
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x02BA5400,
        app::Dictionary_2_TKey_TValue_Enumerator_System_Int32_UnityEngine_EventSystems_PointerEventData_,
        GetEnumerator,
        app::Dictionary_2_System_Int32_UnityEngine_EventSystems_PointerEventData_* this_ptr
    )
} // namespace app::classes::System::Collections::Generic::Dictionary_2_System_Int32_UnityEngine_EventSystems_PointerEventData_

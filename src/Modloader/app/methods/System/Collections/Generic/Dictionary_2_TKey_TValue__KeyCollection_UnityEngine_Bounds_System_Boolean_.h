...
namespace app::classes::System::Collections::Generic::Dictionary_2_TKey_TValue__KeyCollection_UnityEngine_Bounds_System_Boolean_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::Dictionary_2_TKey_TValue_KeyCollection_UnityEngine_Bounds_System_Boolean_* this_ptr,
        app::Dictionary_2_UnityEngine_Bounds_System_Boolean_* dictionary
    )
    IL2CPP_REGISTER_METHOD(
        0x01A7BB40,
        app::Dictionary_2_TKey_TValue_KeyCollection_TKey_TValue_Enumerator_UnityEngine_Bounds_System_Boolean_,
        GetEnumerator,
        app::Dictionary_2_TKey_TValue_KeyCollection_UnityEngine_Bounds_System_Boolean_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(

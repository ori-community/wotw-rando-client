...
namespace app::classes::System::Collections::Generic::List_1_Newtonsoft_Json_JsonPosition_ {
    ...
    IL2CPP_REGISTER_METHOD(
        0x025ED850,
        app::List_1_T_Enumerator_Newtonsoft_Json_JsonPosition_,
        GetEnumerator,
        app::List_1_Newtonsoft_Json_JsonPosition_* this_ptr
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ctor_3,
        app::List_1_Newtonsoft_Json_JsonPosition_* this_ptr,
        app::IEnumerable_1_Newtonsoft_Json_JsonPosition_* collection
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x025E9050,
        app::ReadOnlyCollection_1_Newtonsoft_Json_JsonPosition_*,
        AsReadOnly,
        app::List_1_Newtonsoft_Json_JsonPosition_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t index,
        int32_t count,
        app::JsonPosition item,
        app::IComparer_1_Newtonsoft_Json_JsonPosition_* comparer
    )
    IL2CPP_REGISTER_METHOD(
        0x025ECE20,
        int32_t,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Find,
        app::List_1_Newtonsoft_Json_JsonPosition_* this_ptr,
        app::Predicate_1_Newtonsoft_Json_JsonPosition_* match
    )
    IL2CPP_REGISTER_METHOD(
        0x025ED330,
        app::List_1_Newtonsoft_Json_JsonPosition_*,
        FindAll,
        app::List_1_Newtonsoft_Json_JsonPosition_* this_ptr,
        app::Predicate_1_Newtonsoft_Json_JsonPosition_* match
    )

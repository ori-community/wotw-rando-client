...
namespace app::classes::System::Collections::Generic::Dictionary_2_System_Type_UberTypeTracker_IDerivedTypeTracker_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        bool,
        TryGetValue,
        app::Dictionary_2_System_Type_UberTypeTracker_IDerivedTypeTracker_* this_ptr,
        app::Type* key,
        app::UberTypeTracker_IDerivedTypeTracker** value
    )
    IL2CPP_REGISTER_METHOD(
        0x02BD24D0,
        app::UberTypeTracker_IDerivedTypeTracker*,
        get_Item,
        app::Dictionary_2_System_Type_UberTypeTracker_IDerivedTypeTracker_* this_ptr,
        app::Type* key
    )

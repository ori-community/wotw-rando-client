...
namespace app::classes::System::Collections::Generic::ArraySortHelper_1_System_Int32Enum_ {
    IL2CPP_REGISTER_METHOD(
        0x030007A0,
        void,
        Sort_1,
        app::Int32Enum__Enum__Array* keys,
        int32_t index,
        int32_t length,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t left,
        int32_t length,
        app::Comparison_1_Int32Enum_* comparer
    )
    IL2CPP_REGISTER_METHOD(
        0x02C86FB0,
        void,

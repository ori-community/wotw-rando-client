...
#include <Modloader/app/structs/Dictionary_2_TKey_TValue_ValueCollection_TKey_TValue_Enumerato_Syste_Int32Enu_Syste_Singl_.h>
...
namespace app::classes::System::Collections::Generic::Dictionary_2_TKey_TValue__ValueCollection_System_Int32Enum_System_Single_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::Dictionary_2_TKey_TValue_ValueCollection_System_Int32Enum_System_Single_* this_ptr,
        app::Dictionary_2_System_Int32Enum_System_Single_* dictionary
    )
    IL2CPP_REGISTER_METHOD(
        0x01A78360,
        app::Dictionary_2_TKey_TValue_ValueCollection_TKey_TValue_Enumerator_System_Int32Enum_System_Single_,
        GetEnumerator,
        app::Dictionary_2_TKey_TValue_ValueCollection_System_Int32Enum_System_Single_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(

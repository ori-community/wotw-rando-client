...
namespace app::classes::System::Collections::Generic::List_1_KeyValuePair_2_Moon_UberID_System_Single__ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Add,
        app::List_1_KeyValuePair_2_Moon_UberID_System_Single_* this_ptr,
        app::KeyValuePair_2_Moon_UberID_System_Single_ item
    )
    IL2CPP_REGISTER_METHOD(
        0x025EAEA0,
        void,
        Sort,
        app::List_1_KeyValuePair_2_Moon_UberID_System_Single_* this_ptr,
        app::Comparison_1_System_Collections_Generic_KeyValuePair_2__4* comparison
    )
    IL2CPP_REGISTER_METHOD(
        0x025E9D20,
        app::List_1_T_Enumerator_KeyValuePair_2_Moon_UberID_System_Single_,
        GetEnumerator,
        app::List_1_KeyValuePair_2_Moon_UberID_System_Single_* this_ptr
    )
} // namespace app::classes::System::Collections::Generic::List_1_KeyValuePair_2_Moon_UberID_System_Single__

...
namespace app::classes::System::Collections::Generic::Dictionary_2_System_Xml_XmlQualifiedName_System_Xml_Schema_SchemaEntity_ {
    IL2CPP_REGISTER_METHOD(
        ...
        bool,
        ContainsKey,
        app::Dictionary_2_System_Xml_XmlQualifiedName_System_Xml_Schema_SchemaEntity_* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        0x0283B3E0,
        app::Dictionary_2_TKey_TValue_ValueCollection_System_Xml_XmlQualifiedName_System_Xml_Schema_SchemaEntity_*,
        get_Values,
        app::Dictionary_2_System_Xml_XmlQualifiedName_System_Xml_Schema_SchemaEntity_* this_ptr
    )
} // namespace app::classes::System::Collections::Generic::Dictionary_2_System_Xml_XmlQualifiedName_System_Xml_Schema_SchemaEntity_

...
namespace app::classes::System::Collections::Generic::Dictionary_2_TKey_TValue__KeyCollection_System_UInt32_System_Single_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::Dictionary_2_TKey_TValue_KeyCollection_System_UInt32_System_Single_* this_ptr,
        app::Dictionary_2_System_UInt32_System_Single_* dictionary
    )
    IL2CPP_REGISTER_METHOD(
        0x01A78360,
        app::Dictionary_2_TKey_TValue_KeyCollection_TKey_TValue_Enumerator_System_UInt32_System_Single_,
        GetEnumerator,
        app::Dictionary_2_TKey_TValue_KeyCollection_System_UInt32_System_Single_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(

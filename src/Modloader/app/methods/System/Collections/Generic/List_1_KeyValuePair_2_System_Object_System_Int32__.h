...
namespace app::classes::System::Collections::Generic::List_1_KeyValuePair_2_System_Object_System_Int32__ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_3,
        app::List_1_KeyValuePair_2_System_Object_System_Int32_* this_ptr,
        app::IEnumerable_1_KeyValuePair_2_System_Object_System_Int32_* collection
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Add,
        app::List_1_KeyValuePair_2_System_Object_System_Int32_* this_ptr,
        app::KeyValuePair_2_System_Object_System_Int32_ item
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x025E9050,
        app::ReadOnlyCollection_1_System_Collections_Generic_KeyValuePair_2__4*,
        AsReadOnly,
        app::List_1_KeyValuePair_2_System_Object_System_Int32_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t count,
        app::KeyValuePair_2_System_Object_System_Int32_ item,
        app::IComparer_1_KeyValuePair_2_System_Object_System_Int32_* comparer
    )
    IL2CPP_REGISTER_METHOD(
        0x025E91F0,
        int32_t,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Exists,
        app::List_1_KeyValuePair_2_System_Object_System_Int32_* this_ptr,
        app::Predicate_1_System_Collections_Generic_KeyValuePair_2__4* match
    )
    IL2CPP_REGISTER_METHOD(
        0x025E96E0,
        app::KeyValuePair_2_System_Object_System_Int32_,
    ...
    IL2CPP_REGISTER_METHOD(
        0x025E9800,
        app::List_1_KeyValuePair_2_System_Object_System_Int32_*,
        FindAll,
        app::List_1_KeyValuePair_2_System_Object_System_Int32_* this_ptr,
        app::Predicate_1_System_Collections_Generic_KeyValuePair_2__4* match
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ForEach,
        app::List_1_KeyValuePair_2_System_Object_System_Int32_* this_ptr,
        app::Action_1_System_Collections_Generic_KeyValuePair_2__4* action
    )
    IL2CPP_REGISTER_METHOD(
        0x025E9D20,
        app::List_1_T_Enumerator_KeyValuePair_2_System_Object_System_Int32_,
        GetEnumerator,
        app::List_1_KeyValuePair_2_System_Object_System_Int32_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Sort_4,
        app::List_1_KeyValuePair_2_System_Object_System_Int32_* this_ptr,
        app::Comparison_1_System_Collections_Generic_KeyValuePair_2__7* comparison
    )
    IL2CPP_REGISTER_METHOD(
        0x025EAEF0,

...
namespace app::classes::System::Collections::Generic::Dictionary_2_System_String_System_Net_WebConnectionGroup_ {
    IL2CPP_REGISTER_METHOD(
        ...
        bool,
        TryGetValue,
        app::Dictionary_2_System_String_System_Net_WebConnectionGroup_* this_ptr,
        app::String* key,
        app::WebConnectionGroup** value
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x0283B3E0,
        app::Dictionary_2_TKey_TValue_ValueCollection_System_String_System_Net_WebConnectionGroup_*,
        get_Values,
        app::Dictionary_2_System_String_System_Net_WebConnectionGroup_* this_ptr
    )

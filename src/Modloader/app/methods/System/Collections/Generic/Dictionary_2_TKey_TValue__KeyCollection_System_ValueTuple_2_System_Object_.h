...
#include <Modloader/app/structs/Dictionary_2_TKey_TValue_KeyCollection_TKey_TValu_Enumerato_Syste_ValueTupl_2_Syste_Objec_.h>
...
namespace app::classes::System::Collections::Generic::Dictionary_2_TKey_TValue__KeyCollection_System_ValueTuple_2_System_Object_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::Dictionary_2_TKey_TValue_KeyCollection_System_ValueTuple_2_System_Object_* this_ptr,
        app::Dictionary_2_System_ValueTuple_2_System_Object_* dictionary
    )
    IL2CPP_REGISTER_METHOD(
        0x01A7A830,
        app::Dictionary_2_TKey_TValue_KeyCollection_TKey_TValue_Enumerator_System_ValueTuple_2_System_Object_,
        GetEnumerator,
        app::Dictionary_2_TKey_TValue_KeyCollection_System_ValueTuple_2_System_Object_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(

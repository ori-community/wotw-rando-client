...
namespace app::classes::System::Collections::Generic::Dictionary_2_EquipmentType_EquipmentRadialSelection_ItemCache_ {
    IL2CPP_REGISTER_METHOD(
        ...
        bool,
        ContainsKey,
        app::Dictionary_2_EquipmentType_EquipmentRadialSelection_ItemCache_* this_ptr,
        app::EquipmentType__Enum key
    )
    IL2CPP_REGISTER_METHOD(
        0x02C35530,
        app::EquipmentRadialSelection_ItemCache*,
        get_Item,
        app::Dictionary_2_EquipmentType_EquipmentRadialSelection_ItemCache_* this_ptr,
        app::EquipmentType__Enum key
    )
    IL2CPP_REGISTER_METHOD(
        ...
        app::Dictionary_2_EquipmentType_EquipmentRadialSelection_ItemCache_* this_ptr,
        app::EquipmentType__Enum key,
        app::EquipmentRadialSelection_ItemCache* value
    )

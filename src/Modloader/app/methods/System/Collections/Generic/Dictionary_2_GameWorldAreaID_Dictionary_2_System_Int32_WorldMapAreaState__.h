...
namespace app::classes::System::Collections::Generic::Dictionary_2_GameWorldAreaID_Dictionary_2_System_Int32_WorldMapAreaState__ {
    IL2CPP_REGISTER_METHOD(
        0x02BA5400,
        app::Dictionary_2_TKey_TValue_Enumerator_GameWorldAreaID_Dictionary_2_System_Int32_WorldMapAreaState_,
        GetEnumerator,
        app::Dictionary_2_GameWorldAreaID_Dictionary_2_System_Int32_WorldMapAreaState_* this_ptr
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        TryGetValue,
        app::Dictionary_2_GameWorldAreaID_Dictionary_2_System_Int32_WorldMapAreaState_* this_ptr,
        app::GameWorldAreaID__Enum key,
        app::Dictionary_2_System_Int32_WorldMapAreaState_** value
    )
    IL2CPP_REGISTER_METHOD(
        0x02BAC140,
        void,

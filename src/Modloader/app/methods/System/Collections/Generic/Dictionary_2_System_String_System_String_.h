...
namespace app::classes::System::Collections::Generic::Dictionary_2_System_String_System_String_ {
    ...
    IL2CPP_REGISTER_METHOD(
        0x02BA5400,
        app::Dictionary_2_TKey_TValue_Enumerator_System_String_System_String_,
        GetEnumerator,
        app::Dictionary_2_System_String_System_String_* this_ptr
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x0283B2B0,
        app::Dictionary_2_TKey_TValue_KeyCollection_System_String_System_String_*,
        get_Keys,
        app::Dictionary_2_System_String_System_String_* this_ptr
    )

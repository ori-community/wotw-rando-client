...
namespace app::classes::System::Collections::Generic::List_1_Moon_NewSetupStateControllerResolver_SerializedUberStateControllerLinkItem_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Add,
        app::List_1_Moon_NewSetupStateControllerResolver_SerializedUberStateControllerLinkItem_* this_ptr,
        app::NewSetupStateControllerResolver_SerializedUberStateControllerLinkItem item
    )
    IL2CPP_REGISTER_METHOD(
        0x025E8A60,
        app::NewSetupStateControllerResolver_SerializedUberStateControllerLinkItem,
        get_Item,
        app::List_1_Moon_NewSetupStateControllerResolver_SerializedUberStateControllerLinkItem_* this_ptr,
        int32_t index
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ctor_3,
        app::List_1_Moon_NewSetupStateControllerResolver_SerializedUberStateControllerLinkItem_* this_ptr,
        app::IEnumerable_1_Moon_NewSetupStateControllerResolver_SerializedUberStateControllerLinkItem_* collection
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x025E9050,
        app::ReadOnlyCollection_1_Moon_NewSetupStateControllerResolver_SerializedUberStateControllerLinkItem_*,
        AsReadOnly,
        app::List_1_Moon_NewSetupStateControllerResolver_SerializedUberStateControllerLinkItem_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Exists,
        app::List_1_Moon_NewSetupStateControllerResolver_SerializedUberStateControllerLinkItem_* this_ptr,
        app::Predicate_1_Moon_NewSetupStateControllerResolver_SerializedUberStateControllerLinkItem_* match
    )
    IL2CPP_REGISTER_METHOD(
        0x025E96E0,
        app::NewSetupStateControllerResolver_SerializedUberStateControllerLinkItem,
    ...
    IL2CPP_REGISTER_METHOD(
        0x025E9800,
        app::List_1_Moon_NewSetupStateControllerResolver_SerializedUberStateControllerLinkItem_*,
        FindAll,
        app::List_1_Moon_NewSetupStateControllerResolver_SerializedUberStateControllerLinkItem_* this_ptr,
        app::Predicate_1_Moon_NewSetupStateControllerResolver_SerializedUberStateControllerLinkItem_* match
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ForEach,
        app::List_1_Moon_NewSetupStateControllerResolver_SerializedUberStateControllerLinkItem_* this_ptr,
        app::Action_1_Moon_NewSetupStateControllerResolver_SerializedUberStateControllerLinkItem_* action
    )
    IL2CPP_REGISTER_METHOD(
        0x025E9D20,
        app::List_1_T_Enumerator_Moon_NewSetupStateControllerResolver_SerializedUberStateControllerLinkItem_,
        GetEnumerator,
        app::List_1_Moon_NewSetupStateControllerResolver_SerializedUberStateControllerLinkItem_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x025E9D60,
        app::IEnumerator_1_Moon_NewSetupStateControllerResolver_SerializedUberStateControllerLinkItem_*,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Sort_4,
        app::List_1_Moon_NewSetupStateControllerResolver_SerializedUberStateControllerLinkItem_* this_ptr,
        app::Comparison_1_Moon_NewSetupStateControllerResolver_SerializedUberStateControllerLinkItem_* comparison
    )
    IL2CPP_REGISTER_METHOD(
        0x025EAEF0,
        app::NewSetupStateControllerResolver_SerializedUberStateControllerLinkItem__Array*,
        ToArray,
        app::List_1_Moon_NewSetupStateControllerResolver_SerializedUberStateControllerLinkItem_* this_ptr
    )

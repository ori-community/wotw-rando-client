...
namespace app::classes::System::Collections::Generic::Dictionary_2_System_Int32_LeakedSceneObjectDetector_ObjectData_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        get_Item,
        app::Dictionary_2_System_Int32_LeakedSceneObjectDetector_ObjectData_* this_ptr,
        int32_t key
    )
    IL2CPP_REGISTER_METHOD(
        0x02BAC140,
        ...
        app::Dictionary_2_System_Int32_LeakedSceneObjectDetector_ObjectData_* this_ptr,
        int32_t key,
        app::LeakedSceneObjectDetector_ObjectData* value
    )
    IL2CPP_REGISTER_METHOD(
        0x0283B3E0,
        app::Dictionary_2_TKey_TValue_ValueCollection_System_Int32_LeakedSceneObjectDetector_ObjectData_*,
        get_Values,
        app::Dictionary_2_System_Int32_LeakedSceneObjectDetector_ObjectData_* this_ptr
    )

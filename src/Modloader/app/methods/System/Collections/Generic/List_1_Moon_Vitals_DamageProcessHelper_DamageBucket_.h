...
namespace app::classes::System::Collections::Generic::List_1_Moon_Vitals_DamageProcessHelper_DamageBucket_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        get_Item,
        app::List_1_Moon_Vitals_DamageProcessHelper_DamageBucket_* this_ptr,
        int32_t index
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Add,
        app::List_1_Moon_Vitals_DamageProcessHelper_DamageBucket_* this_ptr,
        app::Vitals_DamageProcessHelper_DamageBucket item
    )
    IL2CPP_REGISTER_METHOD(
        0x02D49BC0,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        0x02D4AC20,
        app::List_1_T_Enumerator_Moon_Vitals_DamageProcessHelper_DamageBucket_,
        GetEnumerator,
        app::List_1_Moon_Vitals_DamageProcessHelper_DamageBucket_* this_ptr
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ctor_3,
        app::List_1_Moon_Vitals_DamageProcessHelper_DamageBucket_* this_ptr,
        app::IEnumerable_1_Moon_Vitals_DamageProcessHelper_DamageBucket_* collection
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x025E9050,
        app::ReadOnlyCollection_1_Moon_Vitals_DamageProcessHelper_DamageBucket_*,
        AsReadOnly,
        app::List_1_Moon_Vitals_DamageProcessHelper_DamageBucket_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t count,
        app::Vitals_DamageProcessHelper_DamageBucket item,
        app::IComparer_1_Moon_Vitals_DamageProcessHelper_DamageBucket_* comparer
    )
    IL2CPP_REGISTER_METHOD(
        0x02D4A210,
        int32_t,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Exists,
        app::List_1_Moon_Vitals_DamageProcessHelper_DamageBucket_* this_ptr,
        app::Predicate_1_Moon_Vitals_DamageProcessHelper_DamageBucket_* match
    )
    IL2CPP_REGISTER_METHOD(
        0x02D4A5E0,
        app::Vitals_DamageProcessHelper_DamageBucket,
    ...
    IL2CPP_REGISTER_METHOD(
        0x02D4A710,
        app::List_1_Moon_Vitals_DamageProcessHelper_DamageBucket_*,
        FindAll,
        app::List_1_Moon_Vitals_DamageProcessHelper_DamageBucket_* this_ptr,
        app::Predicate_1_Moon_Vitals_DamageProcessHelper_DamageBucket_* match
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ForEach,
        app::List_1_Moon_Vitals_DamageProcessHelper_DamageBucket_* this_ptr,
        app::Action_1_Moon_Vitals_DamageProcessHelper_DamageBucket_* action
    )
    IL2CPP_REGISTER_METHOD(
        0x02D4AC60,
    ...
    IL2CPP_REGISTER_METHOD(
        0x025EAEF0,
        app::Vitals_DamageProcessHelper_DamageBucket__Array*,
        ToArray,
        app::List_1_Moon_Vitals_DamageProcessHelper_DamageBucket_* this_ptr
    )

...
namespace app::classes::System::Collections::Generic::List_1_Moon_Timeline_UberShaderAnimatorStrategyExperimental_FloatRequest_ {
    IL2CPP_REGISTER_METHOD(
        0x02D49B80,
        app::UberShaderAnimatorStrategyExperimental_FloatRequest,
        get_Item,
        app::List_1_Moon_Timeline_UberShaderAnimatorStrategyExperimental_FloatRequest_* this_ptr,
        int32_t index
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Add,
        app::List_1_Moon_Timeline_UberShaderAnimatorStrategyExperimental_FloatRequest_* this_ptr,
        app::UberShaderAnimatorStrategyExperimental_FloatRequest item
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ctor_3,
        app::List_1_Moon_Timeline_UberShaderAnimatorStrategyExperimental_FloatRequest_* this_ptr,
        app::IEnumerable_1_Moon_Timeline_UberShaderAnimatorStrategyExperimental_FloatRequest_* collection
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::List_1_Moon_Timeline_UberShaderAnimatorStrategyExperimental_FloatRequest_* this_ptr,
        int32_t index,
        app::UberShaderAnimatorStrategyExperimental_FloatRequest value
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x025E9050,
        app::ReadOnlyCollection_1_Moon_Timeline_UberShaderAnimatorStrategyExperimental_FloatRequest_*,
        AsReadOnly,
        app::List_1_Moon_Timeline_UberShaderAnimatorStrategyExperimental_FloatRequest_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t count,
        app::UberShaderAnimatorStrategyExperimental_FloatRequest item,
        app::IComparer_1_Moon_Timeline_UberShaderAnimatorStrategyExperimental_FloatRequest_* comparer
    )
    IL2CPP_REGISTER_METHOD(
        0x02D4A210,
        int32_t,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        CopyTo_1,
        app::List_1_Moon_Timeline_UberShaderAnimatorStrategyExperimental_FloatRequest_* this_ptr,
        app::UberShaderAnimatorStrategyExperimental_FloatRequest__Array* array
    )
    IL2CPP_REGISTER_METHOD(
        0x02DC2E70,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Exists,
        app::List_1_Moon_Timeline_UberShaderAnimatorStrategyExperimental_FloatRequest_* this_ptr,
        app::Predicate_1_Moon_Timeline_UberShaderAnimatorStrategyExperimental_FloatRequest_* match
    )
    IL2CPP_REGISTER_METHOD(
        0x02D4A5E0,
        app::UberShaderAnimatorStrategyExperimental_FloatRequest,
    ...
    IL2CPP_REGISTER_METHOD(
        0x02D4A710,
        app::List_1_Moon_Timeline_UberShaderAnimatorStrategyExperimental_FloatRequest_*,
        FindAll,
        app::List_1_Moon_Timeline_UberShaderAnimatorStrategyExperimental_FloatRequest_* this_ptr,
        app::Predicate_1_Moon_Timeline_UberShaderAnimatorStrategyExperimental_FloatRequest_* match
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ForEach,
        app::List_1_Moon_Timeline_UberShaderAnimatorStrategyExperimental_FloatRequest_* this_ptr,
        app::Action_1_Moon_Timeline_UberShaderAnimatorStrategyExperimental_FloatRequest_* action
    )
    IL2CPP_REGISTER_METHOD(
        0x02D4AC20,
        app::List_1_T_Enumerator_Moon_Timeline_UberShaderAnimatorStrategyExperimental_FloatRequest_,
        GetEnumerator,
        app::List_1_Moon_Timeline_UberShaderAnimatorStrategyExperimental_FloatRequest_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x02D4AC60,
        app::IEnumerator_1_Moon_Timeline_UberShaderAnimatorStrategyExperimental_FloatRequest_*,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Sort_4,
        app::List_1_Moon_Timeline_UberShaderAnimatorStrategyExperimental_FloatRequest_* this_ptr,
        app::Comparison_1_Moon_Timeline_UberShaderAnimatorStrategyExperimental_FloatRequest_* comparison
    )
    IL2CPP_REGISTER_METHOD(
        0x025EAEF0,
        app::UberShaderAnimatorStrategyExperimental_FloatRequest__Array*,
        ToArray,
        app::List_1_Moon_Timeline_UberShaderAnimatorStrategyExperimental_FloatRequest_* this_ptr
    )

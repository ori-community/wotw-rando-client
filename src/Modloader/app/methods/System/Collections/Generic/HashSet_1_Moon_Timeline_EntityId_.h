...
namespace app::classes::System::Collections::Generic::HashSet_1_Moon_Timeline_EntityId_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_2,
        app::HashSet_1_Moon_Timeline_EntityId_* this_ptr,
        app::IEqualityComparer_1_Moon_Timeline_EntityId_* comparer
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ctor_4,
        app::HashSet_1_Moon_Timeline_EntityId_* this_ptr,
        app::IEnumerable_1_Moon_Timeline_EntityId_* collection,
        app::IEqualityComparer_1_Moon_Timeline_EntityId_* comparer
    )
    IL2CPP_REGISTER_METHOD(
        0x02AB46E0,
    ...
    IL2CPP_REGISTER_METHOD(
        0x02AB5010,
        app::IEnumerator_1_Moon_Timeline_EntityId_*,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::HashSet_1_Moon_Timeline_EntityId_* set1,
        app::HashSet_1_Moon_Timeline_EntityId_* set2
    )

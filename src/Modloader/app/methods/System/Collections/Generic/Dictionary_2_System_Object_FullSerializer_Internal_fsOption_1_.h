...
namespace app::classes::System::Collections::Generic::Dictionary_2_System_Object_FullSerializer_Internal_fsOption_1_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_3,
        app::Dictionary_2_System_Object_FullSerializer_Internal_fsOption_1_* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ctor_5,
        app::Dictionary_2_System_Object_FullSerializer_Internal_fsOption_1_* this_ptr,
        app::IDictionary_2_System_Object_FullSerializer_Internal_fsOption_1_* dictionary
    )
    IL2CPP_REGISTER_METHOD(
        0x02DCC3A0,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        0x0283B2B0,
        app::Dictionary_2_TKey_TValue_KeyCollection_System_Object_FullSerializer_Internal_fsOption_1_*,
        get_Keys,
        app::Dictionary_2_System_Object_FullSerializer_Internal_fsOption_1_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
    ...
    IL2CPP_REGISTER_METHOD(
        0x0283B3E0,
        app::Dictionary_2_TKey_TValue_ValueCollection_System_Object_FullSerializer_Internal_fsOption_1_*,
        get_Values,
        app::Dictionary_2_System_Object_FullSerializer_Internal_fsOption_1_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x0283B3E0,
        app::ICollection_1_FullSerializer_Internal_fsOption_1_*,
        System_Collections_Generic_IDictionary_TKey_TValue__get_Values,
        app::Dictionary_2_System_Object_FullSerializer_Internal_fsOption_1_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x0283B3E0,
        app::IEnumerable_1_FullSerializer_Internal_fsOption_1_*,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Dictionary_2_System_Object_FullSerializer_Internal_fsOption_1_* this_ptr,
        app::KeyValuePair_2_System_Object_FullSerializer_Internal_fsOption_1_ key_value_pair
    )
    IL2CPP_REGISTER_METHOD(
        0x02DCCAB0,
        bool,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        CopyTo,
        app::Dictionary_2_System_Object_FullSerializer_Internal_fsOption_1_* this_ptr,
        app::KeyValuePair_2_System_Object_FullSerializer_Internal_fsOption_1___Array* array,
        int32_t index
    )
    IL2CPP_REGISTER_METHOD(
        0x02CB3A80,
        app::Dictionary_2_TKey_TValue_Enumerator_System_Object_FullSerializer_Internal_fsOption_1_,
        GetEnumerator,
        app::Dictionary_2_System_Object_FullSerializer_Internal_fsOption_1_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x02CB3AE0,
        app::IEnumerator_1_KeyValuePair_2_System_Object_FullSerializer_Internal_fsOption_1_*,

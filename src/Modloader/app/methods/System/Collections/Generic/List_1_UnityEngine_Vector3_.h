...
namespace app::classes::System::Collections::Generic::List_1_UnityEngine_Vector3_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t,
        BinarySearch_1,
        app::List_1_UnityEngine_Vector3_* this_ptr,
        int32_t index,
        int32_t count,
        app::Vector3 item,
        app::IComparer_1_UnityEngine_Vector3_* comparer
    )
    IL2CPP_REGISTER_METHOD(
        0x02D4A210,
        int32_t,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        FindAll,
        app::List_1_UnityEngine_Vector3_* this_ptr,
        app::Predicate_1_UnityEngine_Vector3_* match
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::List_1_UnityEngine_Vector3_* this_ptr,
        int32_t index,
        app::IEnumerable_1_UnityEngine_Vector3_* collection
    )

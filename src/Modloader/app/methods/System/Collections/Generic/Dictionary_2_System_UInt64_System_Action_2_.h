...
namespace app::classes::System::Collections::Generic::Dictionary_2_System_UInt64_System_Action_2_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Add_1,
        app::Dictionary_2_System_UInt64_System_Action_2_* this_ptr,
        uint64_t key,
        app::Action_2_Steamworks_UserAchievementStored_t_Boolean_* value
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Add_2,
        app::Dictionary_2_System_UInt64_System_Action_2__1* this_ptr,
        uint64_t key,
        app::Action_2_Steamworks_UserStatsReceived_t_Boolean_* value
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Add_3,
        app::Dictionary_2_System_UInt64_System_Action_2__2* this_ptr,
        uint64_t key,
        app::Action_2_Steamworks_UserStatsStored_t_Boolean_* value
    )

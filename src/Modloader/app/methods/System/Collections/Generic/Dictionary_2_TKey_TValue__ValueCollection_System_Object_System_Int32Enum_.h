...
namespace app::classes::System::Collections::Generic::Dictionary_2_TKey_TValue__ValueCollection_System_Object_System_Int32Enum_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::Dictionary_2_TKey_TValue_ValueCollection_System_Object_System_Int32Enum_* this_ptr,
        app::Dictionary_2_System_Object_System_Int32Enum_* dictionary
    )
    IL2CPP_REGISTER_METHOD(
        0x01A78360,
        app::Dictionary_2_TKey_TValue_ValueCollection_TKey_TValue_Enumerator_System_Object_System_Int32Enum_,
        GetEnumerator,
        app::Dictionary_2_TKey_TValue_ValueCollection_System_Object_System_Int32Enum_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(

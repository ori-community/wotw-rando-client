...
namespace app::classes::System::Collections::Generic::ArraySortHelper_1_LightCanvasEditorTextureCache_LightCanvasEditorTextureData_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Sort_1,
        app::LightCanvasEditorTextureCache_LightCanvasEditorTextureData__Array* keys,
        int32_t index,
        int32_t length,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t index,
        int32_t length,
        app::Comparison_1_LightCanvasEditorTextureCache_LightCanvasEditorTextureData_* comparer
    )
    IL2CPP_REGISTER_METHOD(
        0x02C8AB70,
        int32_t,

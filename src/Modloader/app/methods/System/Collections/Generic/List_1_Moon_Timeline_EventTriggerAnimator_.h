...
namespace app::classes::System::Collections::Generic::List_1_Moon_Timeline_EventTriggerAnimator_ {
    IL2CPP_REGISTER_METHOD(
        0x025F0B10,
        app::List_1_T_Enumerator_Moon_Timeline_EventTriggerAnimator_,
        GetEnumerator,
        app::List_1_Moon_Timeline_EventTriggerAnimator_* this_ptr
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ctor_2,
        app::List_1_Moon_Timeline_EventTriggerAnimator_* this_ptr,
        app::IEnumerable_1_Moon_Timeline_EventTriggerAnimator_* collection
    )
} // namespace app::classes::System::Collections::Generic::List_1_Moon_Timeline_EventTriggerAnimator_

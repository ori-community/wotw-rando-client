...
#include <Modloader/app/structs/Dictionary_2_TKe_TValu_KeyCollectio_TKe_TValu_Enumerato_Moo_CrossSceneReference_Syst_Obje_.h>
...
namespace app::classes::System::Collections::Generic::Dictionary_2_TKey_TValue__KeyCollection_Moon_CrossSceneReferenceId_System_Object_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::Dictionary_2_TKey_TValue_KeyCollection_Moon_CrossSceneReferenceId_System_Object_* this_ptr,
        app::Dictionary_2_Moon_CrossSceneReferenceId_System_Object_* dictionary
    )
    IL2CPP_REGISTER_METHOD(
        0x01D51940,
        app::Dictionary_2_TKey_TValue_KeyCollection_TKey_TValue_Enumerator_Moon_CrossSceneReferenceId_System_Object_,
        GetEnumerator,
        app::Dictionary_2_TKey_TValue_KeyCollection_Moon_CrossSceneReferenceId_System_Object_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Dictionary_2_TKey_TValue_KeyCollection_Moon_CrossSceneReferenceId_System_Object_* this_ptr,
        app::CrossSceneReferenceId item
    )
    IL2CPP_REGISTER_METHOD(
        0x01D51C30,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        0x01D51D30,
        app::IEnumerator_1_Moon_CrossSceneReferenceId_*,

...
namespace app::classes::System::Collections::Generic::Dictionary_2_System_String_ZenFulcrum_EmbeddedBrowser_JSONNode_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        bool,
        TryGetValue,
        app::Dictionary_2_System_String_ZenFulcrum_EmbeddedBrowser_JSONNode_* this_ptr,
        app::String* key,
        app::JSONNode** value
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x0283B2B0,
        app::Dictionary_2_TKey_TValue_KeyCollection_System_String_ZenFulcrum_EmbeddedBrowser_JSONNode_*,
        get_Keys,
        app::Dictionary_2_System_String_ZenFulcrum_EmbeddedBrowser_JSONNode_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x0283B3E0,
        app::Dictionary_2_TKey_TValue_ValueCollection_System_String_ZenFulcrum_EmbeddedBrowser_JSONNode_*,
        get_Values,
        app::Dictionary_2_System_String_ZenFulcrum_EmbeddedBrowser_JSONNode_* this_ptr
    )
} // namespace app::classes::System::Collections::Generic::Dictionary_2_System_String_ZenFulcrum_EmbeddedBrowser_JSONNode_

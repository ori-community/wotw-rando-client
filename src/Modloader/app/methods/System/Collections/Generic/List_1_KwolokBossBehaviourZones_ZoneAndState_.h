...
namespace app::classes::System::Collections::Generic::List_1_KwolokBossBehaviourZones_ZoneAndState_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Add,
        app::List_1_KwolokBossBehaviourZones_ZoneAndState_* this_ptr,
        app::KwolokBossBehaviourZones_ZoneAndState* item
    )
    IL2CPP_REGISTER_METHOD(
        0x025F0B10,
        app::List_1_T_Enumerator_KwolokBossBehaviourZones_ZoneAndState_,
        GetEnumerator,
        app::List_1_KwolokBossBehaviourZones_ZoneAndState_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(

...
namespace app::classes::System::Collections::Generic::List_1_ScenesManagerBehaviourUtility_SceneMetaAndData_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        get_Item,
        app::List_1_ScenesManagerBehaviourUtility_SceneMetaAndData_* this_ptr,
        int32_t index
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Add,
        app::List_1_ScenesManagerBehaviourUtility_SceneMetaAndData_* this_ptr,
        app::ScenesManagerBehaviourUtility_SceneMetaAndData item
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ctor_3,
        app::List_1_ScenesManagerBehaviourUtility_SceneMetaAndData_* this_ptr,
        app::IEnumerable_1_ScenesManagerBehaviourUtility_SceneMetaAndData_* collection
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x025E9050,
        app::ReadOnlyCollection_1_ScenesManagerBehaviourUtility_SceneMetaAndData_*,
        AsReadOnly,
        app::List_1_ScenesManagerBehaviourUtility_SceneMetaAndData_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t count,
        app::ScenesManagerBehaviourUtility_SceneMetaAndData item,
        app::IComparer_1_ScenesManagerBehaviourUtility_SceneMetaAndData_* comparer
    )
    IL2CPP_REGISTER_METHOD(
        0x02C1E650,
        int32_t,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Exists,
        app::List_1_ScenesManagerBehaviourUtility_SceneMetaAndData_* this_ptr,
        app::Predicate_1_ScenesManagerBehaviourUtility_SceneMetaAndData_* match
    )
    IL2CPP_REGISTER_METHOD(
        0x02C1EA20,
        app::ScenesManagerBehaviourUtility_SceneMetaAndData,
    ...
    IL2CPP_REGISTER_METHOD(
        0x02C1EB60,
        app::List_1_ScenesManagerBehaviourUtility_SceneMetaAndData_*,
        FindAll,
        app::List_1_ScenesManagerBehaviourUtility_SceneMetaAndData_* this_ptr,
        app::Predicate_1_ScenesManagerBehaviourUtility_SceneMetaAndData_* match
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ForEach,
        app::List_1_ScenesManagerBehaviourUtility_SceneMetaAndData_* this_ptr,
        app::Action_1_ScenesManagerBehaviourUtility_SceneMetaAndData_* action
    )
    IL2CPP_REGISTER_METHOD(
        0x02C1F070,
        app::List_1_T_Enumerator_ScenesManagerBehaviourUtility_SceneMetaAndData_,
        GetEnumerator,
        app::List_1_ScenesManagerBehaviourUtility_SceneMetaAndData_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x02C1F0C0,
        app::IEnumerator_1_ScenesManagerBehaviourUtility_SceneMetaAndData_*,
    ...
    IL2CPP_REGISTER_METHOD(
        0x025EAEF0,
        app::ScenesManagerBehaviourUtility_SceneMetaAndData__Array*,
        ToArray,
        app::List_1_ScenesManagerBehaviourUtility_SceneMetaAndData_* this_ptr
    )

...
namespace app::classes::System::Collections::Generic::List_1_Game_AttackableIteratorUnitTester_TestAttackable_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Add,
        app::List_1_Game_AttackableIteratorUnitTester_TestAttackable_* this_ptr,
        app::AttackableIteratorUnitTester_TestAttackable* item
    )
    IL2CPP_REGISTER_METHOD(
        0x025EFC50,
        app::AttackableIteratorUnitTester_TestAttackable*,
        get_Item,
        app::List_1_Game_AttackableIteratorUnitTester_TestAttackable_* this_ptr,
        int32_t index
    )

...
namespace app::classes::System::Collections::Generic::Dictionary_2_System_Int32_AkCallbackManager_EventCallbackPackage_ {
    IL2CPP_REGISTER_METHOD(
        0x02BA5400,
        app::Dictionary_2_TKey_TValue_Enumerator_System_Int32_AkCallbackManager_EventCallbackPackage_,
        GetEnumerator,
        app::Dictionary_2_System_Int32_AkCallbackManager_EventCallbackPackage_* this_ptr
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Dictionary_2_System_Int32_AkCallbackManager_EventCallbackPackage_* this_ptr,
        int32_t key,
        app::AkCallbackManager_EventCallbackPackage** value
    )

...
namespace app::classes::System::Collections::Generic::ObjectEqualityComparer_1_Moon_Wwise_WwiseEventSystem_SoundHandleProtected_CallbackData_ {
    IL2CPP_REGISTER_METHOD(
        ...
        bool,
        Equals_1,
        app::ObjectEqualityComparer_1_Moon_Wwise_WwiseEventSystem_SoundHandleProtected_CallbackData_* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        GetHashCode_1,
        app::ObjectEqualityComparer_1_Moon_Wwise_WwiseEventSystem_SoundHandleProtected_CallbackData_* this_ptr,
        app::WwiseEventSystem_SoundHandleProtected_CallbackData obj
    )
    IL2CPP_REGISTER_METHOD(
        0x01CD24D0,
        int32_t,

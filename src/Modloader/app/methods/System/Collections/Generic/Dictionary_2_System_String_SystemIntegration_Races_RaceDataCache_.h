...
namespace app::classes::System::Collections::Generic::Dictionary_2_System_String_SystemIntegration_Races_RaceDataCache_ {
    ...
    IL2CPP_REGISTER_METHOD(
        0x02BA5400,
        app::Dictionary_2_TKey_TValue_Enumerator_System_String_SystemIntegration_Races_RaceDataCache_,
        GetEnumerator,
        app::Dictionary_2_System_String_SystemIntegration_Races_RaceDataCache_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x02BBA760,
        bool,

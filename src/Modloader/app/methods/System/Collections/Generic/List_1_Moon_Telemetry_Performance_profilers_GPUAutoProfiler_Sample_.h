...
namespace app::classes::System::Collections::Generic::List_1_Moon_Telemetry_Performance_profilers_GPUAutoProfiler_Sample_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Add,
        app::List_1_Moon_Telemetry_Performance_profilers_GPUAutoProfiler_Sample_* this_ptr,
        app::GPUAutoProfiler_Sample* item
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x025F0B10,
        app::List_1_T_Enumerator_Moon_Telemetry_Performance_profilers_GPUAutoProfiler_Sample_,
        GetEnumerator,
        app::List_1_Moon_Telemetry_Performance_profilers_GPUAutoProfiler_Sample_* this_ptr
    )

...
namespace app::classes::System::Collections::Generic::Dictionary_2_System_String_System_Xml_XmlSqlBinaryReader_NamespaceDecl_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::Dictionary_2_System_String_System_Xml_XmlSqlBinaryReader_NamespaceDecl_* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Dictionary_2_System_String_System_Xml_XmlSqlBinaryReader_NamespaceDecl_* this_ptr,
        app::String* key,
        app::XmlSqlBinaryReader_NamespaceDecl** value
    )
    IL2CPP_REGISTER_METHOD(
        0x0283B3E0,
        app::Dictionary_2_TKey_TValue_ValueCollection_System_String_System_Xml_XmlSqlBinaryReader_NamespaceDecl_*,
        get_Values,
        app::Dictionary_2_System_String_System_Xml_XmlSqlBinaryReader_NamespaceDecl_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(

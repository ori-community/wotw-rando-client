...
namespace app::classes::System::Collections::Generic::Dictionary_2_System_Type_MoonTelemetryDamageTransactionEvent_DamageEntity_ {
    IL2CPP_REGISTER_METHOD(
        ...
        bool,
        TryGetValue,
        app::Dictionary_2_System_Type_MoonTelemetryDamageTransactionEvent_DamageEntity_* this_ptr,
        app::Type* key,
        app::MoonTelemetryDamageTransactionEvent_DamageEntity__Enum* value
    )

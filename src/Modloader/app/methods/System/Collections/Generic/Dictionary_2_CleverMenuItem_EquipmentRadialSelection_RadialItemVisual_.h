...
namespace app::classes::System::Collections::Generic::Dictionary_2_CleverMenuItem_EquipmentRadialSelection_RadialItemVisual_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Add,
        app::Dictionary_2_CleverMenuItem_EquipmentRadialSelection_RadialItemVisual_* this_ptr,
        app::CleverMenuItem* key,
        app::EquipmentRadialSelection_RadialItemVisual* value
    )
    IL2CPP_REGISTER_METHOD(
        0x02BD24D0,
        app::EquipmentRadialSelection_RadialItemVisual*,
        get_Item,
        app::Dictionary_2_CleverMenuItem_EquipmentRadialSelection_RadialItemVisual_* this_ptr,
        app::CleverMenuItem* key
    )

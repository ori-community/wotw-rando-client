...
namespace app::classes::System::Collections::Generic::Dictionary_2_System_Int32_HierarchySuspensionTest_PerfTestResult_ {
    IL2CPP_REGISTER_METHOD(
        ...
        bool,
        TryGetValue,
        app::Dictionary_2_System_Int32_HierarchySuspensionTest_PerfTestResult_* this_ptr,
        int32_t key,
        app::HierarchySuspensionTest_PerfTestResult** value
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x02BB8880,
        app::HierarchySuspensionTest_PerfTestResult*,
        get_Item,
        app::Dictionary_2_System_Int32_HierarchySuspensionTest_PerfTestResult_* this_ptr,
        int32_t key
    )

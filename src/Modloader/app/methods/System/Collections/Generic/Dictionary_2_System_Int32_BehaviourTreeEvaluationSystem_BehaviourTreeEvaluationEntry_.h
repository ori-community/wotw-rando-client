...
namespace app::classes::System::Collections::Generic::Dictionary_2_System_Int32_BehaviourTreeEvaluationSystem_BehaviourTreeEvaluationEntry_ {
    IL2CPP_REGISTER_METHOD(
        ...
        bool,
        TryGetValue,
        app::Dictionary_2_System_Int32_BehaviourTreeEvaluationSystem_BehaviourTreeEvaluationEntry_* this_ptr,
        int32_t key,
        app::BehaviourTreeEvaluationSystem_BehaviourTreeEvaluationEntry** value
    )
    IL2CPP_REGISTER_METHOD(
        0x02BAC170,
        void,

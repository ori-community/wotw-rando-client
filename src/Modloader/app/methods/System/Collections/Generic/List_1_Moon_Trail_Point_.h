...
namespace app::classes::System::Collections::Generic::List_1_Moon_Trail_Point_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t,
        BinarySearch_1,
        app::List_1_Moon_Trail_Point_* this_ptr,
        int32_t index,
        int32_t count,
        app::Trail_Point item,
        app::IComparer_1_Moon_Trail_Point_* comparer
    )
    IL2CPP_REGISTER_METHOD(
        0x02DCA770,
        int32_t,
    ...
    IL2CPP_REGISTER_METHOD(
        0x02DCAD70,
        app::List_1_Moon_Trail_Point_*,
        FindAll,
        app::List_1_Moon_Trail_Point_* this_ptr,
        app::Predicate_1_Moon_Trail_Point_* match
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x02DCB3B0,
        app::IEnumerator_1_Moon_Trail_Point_*,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::List_1_Moon_Trail_Point_* this_ptr,
        int32_t index,
        app::IEnumerable_1_Moon_Trail_Point_* collection
    )

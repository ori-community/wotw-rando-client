...
namespace app::classes::System::Collections::Generic::Dictionary_2_TKey_TValue__ValueCollection_Moon_ActiveAnimationHandle_System_Int32_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::Dictionary_2_TKey_TValue_ValueCollection_Moon_ActiveAnimationHandle_System_Int32_* this_ptr,
        app::Dictionary_2_Moon_ActiveAnimationHandle_System_Int32_* dictionary
    )
    IL2CPP_REGISTER_METHOD(
        0x01A78360,
        app::Dictionary_2_TKey_TValue_ValueCollection_TKey_TValue_Enumerator_Moon_ActiveAnimationHandle_System_Int32_,
        GetEnumerator,
        app::Dictionary_2_TKey_TValue_ValueCollection_Moon_ActiveAnimationHandle_System_Int32_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(

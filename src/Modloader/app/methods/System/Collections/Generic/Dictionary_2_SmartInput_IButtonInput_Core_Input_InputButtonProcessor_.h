...
namespace app::classes::System::Collections::Generic::Dictionary_2_SmartInput_IButtonInput_Core_Input_InputButtonProcessor_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Add,
        app::Dictionary_2_SmartInput_IButtonInput_Core_Input_InputButtonProcessor_* this_ptr,
        app::IButtonInput* key,
        app::Input_InputButtonProcessor* value
    )
    IL2CPP_REGISTER_METHOD(
        0x02BA5400,
        app::Dictionary_2_TKey_TValue_Enumerator_SmartInput_IButtonInput_Core_Input_InputButtonProcessor_,
        GetEnumerator,
        app::Dictionary_2_SmartInput_IButtonInput_Core_Input_InputButtonProcessor_* this_ptr
    )
} // namespace app::classes::System::Collections::Generic::Dictionary_2_SmartInput_IButtonInput_Core_Input_InputButtonProcessor_

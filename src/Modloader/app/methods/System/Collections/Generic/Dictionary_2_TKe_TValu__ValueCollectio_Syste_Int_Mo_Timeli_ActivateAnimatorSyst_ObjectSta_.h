...
namespace app::classes::System::Collections::Generic::Dictionary_2_TKey_TValue__ValueCollection_System_Int32_Moon_Timeline_ActivateAnimatorSystem_ObjectState_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::Dictionary_2_TKey_TValue_ValueCollection_System_Int32_Moon_Timeline_ActivateAnimatorSystem_ObjectState_* this_ptr,
        app::Dictionary_2_System_Int32_Moon_Timeline_ActivateAnimatorSystem_ObjectState_* dictionary
    )
    IL2CPP_REGISTER_METHOD(
        0x01A7BB40,
        app::Dictionary_2_TKey_TValue_ValueCollection_TKey_TValue_Enumerator_System_Int32_Moon_Timeline_ActivateAnimatorSystem_ObjectState_,
        GetEnumerator,
        app::Dictionary_2_TKey_TValue_ValueCollection_System_Int32_Moon_Timeline_ActivateAnimatorSystem_ObjectState_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Dictionary_2_TKey_TValue_ValueCollection_System_Int32_Moon_Timeline_ActivateAnimatorSystem_ObjectState_* this_ptr,
        app::ActivateAnimatorSystem_ObjectState item
    )
    IL2CPP_REGISTER_METHOD(
        0x01AE11E0,
        bool,
    ...
    IL2CPP_REGISTER_METHOD(
        0x01A7BF40,
        app::IEnumerator_1_Moon_Timeline_ActivateAnimatorSystem_ObjectState_*,
  ...
  // app::classes::System::Collections::Generic::Dictionary_2_TKey_TValue__ValueCollection_System_Int32_Moon_Timeline_ActivateAnimatorSystem_ObjectState_

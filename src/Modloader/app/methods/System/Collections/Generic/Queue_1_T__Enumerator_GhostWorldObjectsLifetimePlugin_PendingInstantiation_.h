...
namespace app::classes::System::Collections::Generic::Queue_1_T__Enumerator_GhostWorldObjectsLifetimePlugin_PendingInstantiation_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::Queue_1_T_Enumerator_GhostWorldObjectsLifetimePlugin_PendingInstantiation___Boxed* this_ptr,
        app::Queue_1_GhostWorldObjectsLifetimePlugin_PendingInstantiation_* q
    )

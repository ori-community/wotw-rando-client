...
namespace app::classes::System::Collections::Generic::List_1_DynamicInstantiationDescriptor_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        AddRange,
        app::List_1_DynamicInstantiationDescriptor_* this_ptr,
        app::IEnumerable_1_DynamicInstantiationDescriptor_* collection
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x025F0B10,
        app::List_1_T_Enumerator_DynamicInstantiationDescriptor_,
        GetEnumerator,
        app::List_1_DynamicInstantiationDescriptor_* this_ptr
    )
} // namespace app::classes::System::Collections::Generic::List_1_DynamicInstantiationDescriptor_

...
namespace app::classes::System::Collections::Generic::Dictionary_2_System_ByteEnum_System_Object_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_3,
        app::Dictionary_2_System_ByteEnum_System_Object_* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ctor_5,
        app::Dictionary_2_System_ByteEnum_System_Object_* this_ptr,
        app::IDictionary_2_System_ByteEnum_System_Object_* dictionary
    )
    IL2CPP_REGISTER_METHOD(
        0x02EA9C50,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        0x0283B2B0,
        app::Dictionary_2_TKey_TValue_KeyCollection_System_ByteEnum_System_Object_*,
        get_Keys,
        app::Dictionary_2_System_ByteEnum_System_Object_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
    ...
    IL2CPP_REGISTER_METHOD(
        0x0283B3E0,
        app::Dictionary_2_TKey_TValue_ValueCollection_System_ByteEnum_System_Object_*,
        get_Values,
        app::Dictionary_2_System_ByteEnum_System_Object_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Dictionary_2_System_ByteEnum_System_Object_* this_ptr,
        app::KeyValuePair_2_System_ByteEnum_System_Object_ key_value_pair
    )
    IL2CPP_REGISTER_METHOD(
        0x02EA6E60,
        bool,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        CopyTo,
        app::Dictionary_2_System_ByteEnum_System_Object_* this_ptr,
        app::KeyValuePair_2_System_ByteEnum_System_Object___Array* array,
        int32_t index
    )
    IL2CPP_REGISTER_METHOD(
        0x02BA5400,
        app::Dictionary_2_TKey_TValue_Enumerator_System_ByteEnum_System_Object_,
        GetEnumerator,
        app::Dictionary_2_System_ByteEnum_System_Object_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x02BA5450,
        app::IEnumerator_1_KeyValuePair_2_System_ByteEnum_System_Object_*,

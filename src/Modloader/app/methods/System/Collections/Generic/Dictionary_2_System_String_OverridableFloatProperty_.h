...
namespace app::classes::System::Collections::Generic::Dictionary_2_System_String_OverridableFloatProperty_ {
    IL2CPP_REGISTER_METHOD(
        0x0283B3E0,
        app::Dictionary_2_TKey_TValue_ValueCollection_System_String_OverridableFloatProperty_*,
        get_Values,
        app::Dictionary_2_System_String_OverridableFloatProperty_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(0x0283AC20, void, ctor, app::Dictionary_2_System_String_OverridableFloatProperty_* this_ptr)
    IL2CPP_REGISTER_METHOD(
        0x02BA5400,
        app::Dictionary_2_TKey_TValue_Enumerator_System_String_OverridableFloatProperty_,
        GetEnumerator,
        app::Dictionary_2_System_String_OverridableFloatProperty_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        ...
        app::Dictionary_2_System_String_OverridableFloatProperty_* this_ptr,
        app::String* key,
        app::OverridableFloatProperty** value
    )
    IL2CPP_REGISTER_METHOD(
        0x02BAC170,
        void,

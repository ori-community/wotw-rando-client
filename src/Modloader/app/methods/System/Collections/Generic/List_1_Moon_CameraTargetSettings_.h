...
namespace app::classes::System::Collections::Generic::List_1_Moon_CameraTargetSettings_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_3,
        app::List_1_Moon_CameraTargetSettings_* this_ptr,
        app::IEnumerable_1_Moon_CameraTargetSettings_* collection
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Find,
        app::List_1_Moon_CameraTargetSettings_* this_ptr,
        app::Predicate_1_Moon_CameraTargetSettings_* match
    )
    IL2CPP_REGISTER_METHOD(
        0x02C1EB60,
        app::List_1_Moon_CameraTargetSettings_*,
        FindAll,
        app::List_1_Moon_CameraTargetSettings_* this_ptr,
        app::Predicate_1_Moon_CameraTargetSettings_* match
    )

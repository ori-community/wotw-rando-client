...
namespace app::classes::System::Collections::Generic::List_1_System_DateTimeOffset_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t,
        BinarySearch_1,
        app::List_1_System_DateTimeOffset_* this_ptr,
        int32_t index,
        int32_t count,
        app::DateTimeOffset item,
    ...
    IL2CPP_REGISTER_METHOD(
        0x025E9800,
        app::List_1_System_DateTimeOffset_*,
        FindAll,
        app::List_1_System_DateTimeOffset_* this_ptr,
        app::Predicate_1_DateTimeOffset_* match
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x025E9D60,
        app::IEnumerator_1_System_DateTimeOffset_*,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::List_1_System_DateTimeOffset_* this_ptr,
        int32_t index,
        app::IEnumerable_1_System_DateTimeOffset_* collection
    )

...
#include <Modloader/app/structs/IComparer_1_UberPoolManager_ObjectTracking_.h>
#include <Modloader/app/structs/IEnumerable_1_UberPoolManager_ObjectTracking_.h>
...
namespace app::classes::System::Collections::Generic::List_1_UberPoolManager_ObjectTracking_ {
    IL2CPP_REGISTER_METHOD(0x025E8100, void, ctor_1, app::List_1_UberPoolManager_ObjectTracking_* this_ptr)
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        set_Item,
        app::List_1_UberPoolManager_ObjectTracking_* this_ptr,
        int32_t index,
    ...
    IL2CPP_REGISTER_METHOD(0x025E81E0, void, ctor_2, app::List_1_UberPoolManager_ObjectTracking_* this_ptr, int32_t capacity)
    IL2CPP_REGISTER_METHOD(
        0x02EDB5D0,
        void,
        ctor_3,
        app::List_1_UberPoolManager_ObjectTracking_* this_ptr,
        app::IEnumerable_1_UberPoolManager_ObjectTracking_* collection
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x025E9050,
        app::ReadOnlyCollection_1_UberPoolManager_ObjectTracking_*,
        AsReadOnly,
        app::List_1_UberPoolManager_ObjectTracking_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t index,
        int32_t count,
        app::UberPoolManager_ObjectTracking item,
        app::IComparer_1_UberPoolManager_ObjectTracking_* comparer
    )
    IL2CPP_REGISTER_METHOD(
        0x025E91F0,
        int32_t,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Exists,
        app::List_1_UberPoolManager_ObjectTracking_* this_ptr,
        app::Predicate_1_UberPoolManager_ObjectTracking_* match
    )
    IL2CPP_REGISTER_METHOD(
        0x025E96E0,
    ...
    IL2CPP_REGISTER_METHOD(
        0x025E9800,
        app::List_1_UberPoolManager_ObjectTracking_*,
        FindAll,
        app::List_1_UberPoolManager_ObjectTracking_* this_ptr,
        app::Predicate_1_UberPoolManager_ObjectTracking_* match
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ForEach,
        app::List_1_UberPoolManager_ObjectTracking_* this_ptr,
        app::Action_1_UberPoolManager_ObjectTracking_* action
    )
    IL2CPP_REGISTER_METHOD(
        0x025E9D20,
        app::List_1_T_Enumerator_UberPoolManager_ObjectTracking_,
        GetEnumerator,
        app::List_1_UberPoolManager_ObjectTracking_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Sort_4,
        app::List_1_UberPoolManager_ObjectTracking_* this_ptr,
        app::Comparison_1_UberPoolManager_ObjectTracking_* comparison
    )

...
#include <Modloader/app/structs/Dictionary_2_T_TVa_ValueCollect_T_TVa_Enumera_Sys_Obj_SeinNaruComboAnim_AtlasAndSpriteTex_.h>
...
namespace app::classes::System::Collections::Generic::Dictionary_2_TKey_TValue__ValueCollection_System_Object_SeinNaruComboAnimator_AtlasAndSpriteTexture_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::Dictionary_2_TKey_TValue_ValueCollection_System_Object_SeinNaruComboAnimator_AtlasAndSpriteTexture_* this_ptr,
        app::Dictionary_2_System_Object_SeinNaruComboAnimator_AtlasAndSpriteTexture_* dictionary
    )
    IL2CPP_REGISTER_METHOD(
        0x01A7A830,
        app::Dictionary_2_TKey_TValue_ValueCollection_TKey_TValue_Enumerator_System_Object_SeinNaruComboAnimator_AtlasAndSpriteTexture_,
        GetEnumerator,
        app::Dictionary_2_TKey_TValue_ValueCollection_System_Object_SeinNaruComboAnimator_AtlasAndSpriteTexture_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Dictionary_2_TKey_TValue_ValueCollection_System_Object_SeinNaruComboAnimator_AtlasAndSpriteTexture_* this_ptr,
        app::SeinNaruComboAnimator_AtlasAndSpriteTexture item
    )
    IL2CPP_REGISTER_METHOD(
        0x026BBB40,
        bool,
    ...
    IL2CPP_REGISTER_METHOD(
        0x01A7AC00,
        app::IEnumerator_1_SeinNaruComboAnimator_AtlasAndSpriteTexture_*,

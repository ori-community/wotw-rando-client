...
namespace app::classes::System::Collections::Concurrent::ConcurrentBag_1_System_Object_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        TryStealFromTo,
        app::ConcurrentBag_1_System_Object_* this_ptr,
        app::ConcurrentBag_1_T_WorkStealingQueue_System_Object_* start_inclusive,
        app::ConcurrentBag_1_T_WorkStealingQueue_System_Object_* end_exclusive,
        app::Object** result,
        bool take
    )

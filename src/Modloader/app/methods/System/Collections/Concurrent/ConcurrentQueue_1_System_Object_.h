...
namespace app::classes::System::Collections::Concurrent::ConcurrentQueue_1_System_Object_ {
    ...
    IL2CPP_REGISTER_METHOD(
        0x02F27740,
        bool,
        System_Collections_Concurrent_IProducerConsumerCollection_T__TryAdd,
        app::ConcurrentQueue_1_System_Object_* this_ptr,
        app::Object* item
    )
    IL2CPP_REGISTER_METHOD(
        0x02AD65B0,
        bool,
        System_Collections_Concurrent_IProducerConsumerCollection_T__TryTake,
        app::ConcurrentQueue_1_System_Object_* this_ptr,
        app::Object** item
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        int64_t,
        GetCount_2,
        app::ConcurrentQueue_1_T_Segment_System_Object_* head,
        int32_t head_head,
        app::ConcurrentQueue_1_T_Segment_System_Object_* tail,
        int32_t tail_tail
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::ConcurrentQueue_1_System_Object_* this_ptr,
        app::ConcurrentQueue_1_T_Segment_System_Object_* segment,
        int32_t i
    )
    IL2CPP_REGISTER_METHOD(
        0x02F28800,

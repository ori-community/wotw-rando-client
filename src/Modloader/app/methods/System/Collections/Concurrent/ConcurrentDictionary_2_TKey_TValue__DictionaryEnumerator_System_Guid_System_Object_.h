...
namespace app::classes::System::Collections::Concurrent::ConcurrentDictionary_2_TKey_TValue__DictionaryEnumerator_System_Guid_System_Object_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::ConcurrentDictionary_2_TKey_TValue_DictionaryEnumerator_System_Guid_System_Object_* this_ptr,
        app::ConcurrentDictionary_2_System_Guid_System_Object_* dictionary
    )
    IL2CPP_REGISTER_METHOD(
        0x02ADC910,
        app::DictionaryEntry,

...
namespace app::classes::System::Collections::Concurrent::ConcurrentDictionary_2_System_Object_System_Object_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::ConcurrentDictionary_2_System_Object_System_Object_* this_ptr
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::ConcurrentDictionary_2_System_Object_System_Object_* this_ptr,
        app::Object* key,
        app::Func_2_Object_Object_* value_factory
    )
    IL2CPP_REGISTER_METHOD(
        0x02AF0B90,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        GrowTable,
        app::ConcurrentDictionary_2_System_Object_System_Object_* this_ptr,
        app::ConcurrentDictionary_2_TKey_TValue_Tables_System_Object_System_Object_* tables
    )

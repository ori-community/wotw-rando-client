...
namespace app::classes::System::Collections::Concurrent::ConcurrentDictionary_2_Newtonsoft_Json_Utilities_StructMultiKey_2_System_Object_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_2,
        app::ConcurrentDictionary_2_Newtonsoft_Json_Utilities_StructMultiKey_2_System_Object_* this_ptr,
        int32_t concurrency_level,
        int32_t capacity,
        bool grow_lock_array,
        app::IEqualityComparer_1_Newtonsoft_Json_Utilities_StructMultiKey_2__3* comparer
    )
    IL2CPP_REGISTER_METHOD(
        0x02ADE240,
        bool,
        TryAdd,
        app::ConcurrentDictionary_2_Newtonsoft_Json_Utilities_StructMultiKey_2_System_Object_* this_ptr,
        app::StructMultiKey_2_System_Object_System_Object_ key,
        app::Object* value
    )
    IL2CPP_REGISTER_METHOD(
        0x02ADE380,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::ConcurrentDictionary_2_Newtonsoft_Json_Utilities_StructMultiKey_2_System_Object_* this_ptr,
        app::KeyValuePair_2_Newtonsoft_Json_Utilities_StructMultiKey_2_System_Object___Array* array,
        int32_t index
    )
    IL2CPP_REGISTER_METHOD(
        0x02ADF450,
        app::KeyValuePair_2_Newtonsoft_Json_Utilities_StructMultiKey_2_System_Object___Array*,
        ToArray,
        app::ConcurrentDictionary_2_Newtonsoft_Json_Utilities_StructMultiKey_2_System_Object_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
    ...
    IL2CPP_REGISTER_METHOD(
        0x02ADFAD0,
        app::IEnumerator_1_KeyValuePair_2_Newtonsoft_Json_Utilities_StructMultiKey_2_System_Object_*,
        GetEnumerator,
        app::ConcurrentDictionary_2_Newtonsoft_Json_Utilities_StructMultiKey_2_System_Object_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::ConcurrentDictionary_2_Newtonsoft_Json_Utilities_StructMultiKey_2_System_Object_* this_ptr,
        app::StructMultiKey_2_System_Object_System_Object_ key,
        app::Func_2_Newtonsoft_Json_Utilities_StructMultiKey_2_Object_* value_factory
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x02AE0FC0,
        app::ICollection_1_Newtonsoft_Json_Utilities_StructMultiKey_2__3*,
        get_Keys,
        app::ConcurrentDictionary_2_Newtonsoft_Json_Utilities_StructMultiKey_2_System_Object_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x02AE0FC0,
        app::IEnumerable_1_Newtonsoft_Json_Utilities_StructMultiKey_2__3*,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::ConcurrentDictionary_2_Newtonsoft_Json_Utilities_StructMultiKey_2_System_Object_* this_ptr,
        app::KeyValuePair_2_Newtonsoft_Json_Utilities_StructMultiKey_2_System_Object_ key_value_pair
    )
    IL2CPP_REGISTER_METHOD(
        0x02AE10A0,
        bool,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        GrowTable,
        app::ConcurrentDictionary_2_Newtonsoft_Json_Utilities_StructMultiKey_2_System_Object_* this_ptr,
        app::ConcurrentDictionary_2_TKey_TValue_Tables_Newtonsoft_Json_Utilities_StructMultiKey_2_System_Object_* tables
    )

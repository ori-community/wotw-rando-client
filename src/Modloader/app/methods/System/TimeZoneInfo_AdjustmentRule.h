...
namespace app::classes::System::TimeZoneInfo_AdjustmentRule {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        CreateAdjustmentRule_1,
        app::DateTime date_start,
        app::DateTime date_end,
        app::TimeSpan daylight_delta,
        app::TimeZoneInfo_TransitionTime daylight_transition_start,
        app::TimeZoneInfo_TransitionTime daylight_transition_end
    )
    IL2CPP_REGISTER_METHOD(
        0x027B9BE0,
        app::TimeZoneInfo_AdjustmentRule*,
        CreateAdjustmentRule_2,
        app::DateTime date_start,
        app::DateTime date_end,
        app::TimeSpan daylight_delta,
        app::TimeZoneInfo_TransitionTime daylight_transition_start,
        app::TimeZoneInfo_TransitionTime daylight_transition_end,
        app::TimeSpan base_utc_offset_delta
    )
    IL2CPP_REGISTER_METHOD(
        0x027B9C50,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::TimeZoneInfo_AdjustmentRule* this_ptr,

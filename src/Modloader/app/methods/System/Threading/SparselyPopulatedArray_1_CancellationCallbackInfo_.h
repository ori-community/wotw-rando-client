...
namespace app::classes::System::Threading::SparselyPopulatedArray_1_CancellationCallbackInfo_ {
    ...
    IL2CPP_REGISTER_METHOD(
        0x02775670,
        app::SparselyPopulatedArrayAddInfo_1_CancellationCallbackInfo_,
        Add,
        app::SparselyPopulatedArray_1_CancellationCallbackInfo_* this_ptr,
        app::CancellationCallbackInfo* element
    )
    IL2CPP_REGISTER_METHOD(
        0x02775660,

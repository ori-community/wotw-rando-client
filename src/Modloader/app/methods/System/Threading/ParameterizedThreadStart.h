...
namespace app::classes::System::Threading::ParameterizedThreadStart {
    IL2CPP_REGISTER_METHOD(0x00611810, void, ctor, app::ParameterizedThreadStart* this_ptr, app::Object* object, void* method_1)
    IL2CPP_REGISTER_METHOD(0x00673B90, void, Invoke, app::ParameterizedThreadStart* this_ptr, app::Object* obj)
    IL2CPP_REGISTER_METHOD(
        0x00674080,
        app::IAsyncResult*,
        BeginInvoke,
        app::ParameterizedThreadStart* this_ptr,
        app::Object* obj,

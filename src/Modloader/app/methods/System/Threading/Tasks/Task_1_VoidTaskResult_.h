...
namespace app::classes::System::Threading::Tasks::Task_1_VoidTaskResult_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        bool,
        TrySetCanceled_2,
        app::Task_1_VoidTaskResult_* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ctor_5,
        app::Task_1_VoidTaskResult_* this_ptr,
        app::Func_2_Object_System_Threading_Tasks_VoidTaskResult_* function,
        app::Object* state,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ctor_6,
        app::Task_1_VoidTaskResult_* this_ptr,
        app::Func_1_System_Threading_Tasks_VoidTaskResult_* value_selector,
        app::Task* parent,
        app::CancellationToken cancellation_token,
        app::TaskCreationOptions__Enum creation_options,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ctor_8,
        app::Task_1_VoidTaskResult_* this_ptr,
        app::Func_2_Object_System_Threading_Tasks_VoidTaskResult_* value_selector,
        app::Object* state,
        app::Task* parent,
        app::CancellationToken cancellation_token,
        app::TaskCreationOptions__Enum creation_options,
    ...
    IL2CPP_REGISTER_METHOD(
        0x0277FBD0,
        app::ConfiguredTaskAwaitable_1_System_Threading_Tasks_VoidTaskResult_,
        ConfigureAwait,
        app::Task_1_VoidTaskResult_* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ContinueWith_1,
        app::Task_1_VoidTaskResult_* this_ptr,
        app::Action_1_System_Threading_Tasks_Task_1__9* continuation_action
    )
    IL2CPP_REGISTER_METHOD(
        0x02A5D690,
        app::Task*,

...
namespace app::classes::System::Threading::Tasks::ContinuationTaskFromResultTask_1_VoidTaskResult_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::ContinuationTaskFromResultTask_1_VoidTaskResult_* this_ptr,
        app::Task_1_VoidTaskResult_* antecedent,
        app::Delegate* action,
        app::Object* state,
    ...
    IL2CPP_REGISTER_METHOD(0x02775E30, void, InnerInvoke, app::ContinuationTaskFromResultTask_1_VoidTaskResult_* this_ptr)
} // namespace app::classes::System::Threading::Tasks::ContinuationTaskFromResultTask_1_VoidTaskResult_

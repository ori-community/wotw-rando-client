...
namespace app::classes::System::Threading::Tasks::Task_1_SystemIntegration_Races_RaceRequestResult_ {
    IL2CPP_REGISTER_METHOD(
        ...
        app::Task*,
        ContinueWith,
        app::Task_1_SystemIntegration_Races_RaceRequestResult_* this_ptr,
        app::Action_1_System_Threading_Tasks_Task_1__4* continuation_action
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x004C50A0,
        app::TaskAwaiter_1_SystemIntegration_Races_RaceRequestResult_,
        GetAwaiter,
        app::Task_1_SystemIntegration_Races_RaceRequestResult_* this_ptr
    )
} // namespace app::classes::System::Threading::Tasks::Task_1_SystemIntegration_Races_RaceRequestResult_

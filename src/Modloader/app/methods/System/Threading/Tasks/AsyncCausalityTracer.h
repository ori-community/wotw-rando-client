...
namespace app::classes::System::Threading::Tasks::AsyncCausalityTracer {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::CausalityTraceLevel__Enum trace_level,
        int32_t task_id,
        app::String* operation_name,
        uint64_t related_context
    )
    IL2CPP_REGISTER_METHOD(
        0x002FA000,
        void,
        ...
        app::CausalityTraceLevel__Enum trace_level,
        int32_t task_id,
        app::AsyncCausalityStatus__Enum status
    )
    IL2CPP_REGISTER_METHOD(
        0x002FA000,
        void,
        ...
        app::CausalityTraceLevel__Enum trace_level,
        int32_t task_id,
        app::CausalityRelation__Enum relation
    )
    IL2CPP_REGISTER_METHOD(
        0x002FA000,
        void,
        ...
        app::CausalityTraceLevel__Enum trace_level,
        int32_t task_id,
        app::CausalitySynchronousWork__Enum work
    )
    IL2CPP_REGISTER_METHOD(
        0x002FA000,
        void,

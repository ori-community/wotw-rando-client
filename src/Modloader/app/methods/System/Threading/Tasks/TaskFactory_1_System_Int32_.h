...
namespace app::classes::System::Threading::Tasks::TaskFactory_1_System_Int32_ {
    IL2CPP_REGISTER_METHOD(
        ...
        app::Func_3_System_IO_Stream_IAsyncResult_Int32_* end_method
    )
    IL2CPP_REGISTER_METHOD(
        0x01544C70,
        app::Task_1_System_Int32_*,
        ...
        app::Func_3_Object_IAsyncResult_Int32_* end_method
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_2,
        app::TaskFactory_1_System_Int32_* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Func_2_IAsyncResult_Int32_* end_function,
        app::Action_1_IAsyncResult_* end_action,
        app::Task_1_System_Int32_* promise,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Func_2_IAsyncResult_Int32_* end_method,
        app::Object* state
    )
    IL2CPP_REGISTER_METHOD(
        0x0277A390,

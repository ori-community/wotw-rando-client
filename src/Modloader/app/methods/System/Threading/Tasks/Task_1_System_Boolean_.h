...
namespace app::classes::System::Threading::Tasks::Task_1_System_Boolean_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_1,
        app::Task_1_System_Boolean_* this_ptr,
        bool canceled,
        bool result,
    ...
    IL2CPP_REGISTER_METHOD(
        0x0277FBD0,
        app::ConfiguredTaskAwaitable_1_System_Boolean_,
        ConfigureAwait,
        app::Task_1_System_Boolean_* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ctor_5,
        app::Task_1_System_Boolean_* this_ptr,
        app::Func_2_Object_Boolean_* function,
        app::Object* state,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ctor_6,
        app::Task_1_System_Boolean_* this_ptr,
        app::Func_1_Boolean_* value_selector,
        app::Task* parent,
        app::CancellationToken cancellation_token,
        app::TaskCreationOptions__Enum creation_options,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ctor_8,
        app::Task_1_System_Boolean_* this_ptr,
        app::Func_2_Object_Boolean_* value_selector,
        app::Object* state,
        app::Task* parent,
        app::CancellationToken cancellation_token,
        app::TaskCreationOptions__Enum creation_options,

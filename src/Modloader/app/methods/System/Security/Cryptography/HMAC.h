...
namespace app::classes::System::Security::Cryptography::HMAC {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Func_1_System_Security_Cryptography_HashAlgorithm_* create_standard_hash_algorithm_callback,
        app::Func_1_System_Security_Cryptography_HashAlgorithm_* create_fips_hash_algorithm_callback
    )

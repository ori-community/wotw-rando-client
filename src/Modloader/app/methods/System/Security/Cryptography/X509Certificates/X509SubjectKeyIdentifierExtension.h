...
namespace app::classes::System::Security::Cryptography::X509Certificates::X509SubjectKeyIdentifierExtension {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_2,
        app::X509SubjectKeyIdentifierExtension* this_ptr,
        app::AsnEncodedData* encoded_subject_key_identifier,
        bool critical
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::X509SubjectKeyIdentifierExtension* this_ptr,
        app::PublicKey* key,
        app::X509SubjectKeyIdentifierHashAlgorithm__Enum algorithm,
        bool critical
    )

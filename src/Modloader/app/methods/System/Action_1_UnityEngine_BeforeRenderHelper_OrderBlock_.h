...
namespace app::classes::System::Action_1_UnityEngine_BeforeRenderHelper_OrderBlock_ {
    IL2CPP_REGISTER_METHOD(0x00611810, void, ctor, app::Action_1_UnityEngine_BeforeRenderHelper_OrderBlock_* this_ptr, app::Object* object, void* method_1)
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::IAsyncResult*,
        BeginInvoke,
        app::Action_1_UnityEngine_BeforeRenderHelper_OrderBlock_* this_ptr,

...
namespace app::classes::System::Nullable_1_Moon_MoonAnimator_AnimatorPostprocessData_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::Nullable_1_Moon_MoonAnimator_AnimatorPostprocessData___Boxed* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Equals_2,
        app::Nullable_1_Moon_MoonAnimator_AnimatorPostprocessData___Boxed* this_ptr,
        app::Nullable_1_Moon_MoonAnimator_AnimatorPostprocessData_ other
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        GetValueOrDefault_2,
        app::Nullable_1_Moon_MoonAnimator_AnimatorPostprocessData___Boxed* this_ptr,
        app::MoonAnimator_AnimatorPostprocessData default_value
    )

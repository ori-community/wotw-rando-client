...
namespace app::classes::System::Comparison_1_GenericCastManager_1_NativeArrays_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t,
        Invoke_1,
        app::Comparison_1_GenericCastManager_1_NativeArrays_* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t,
        Invoke_2,
        app::Comparison_1_GenericCastManager_1_NativeArrays__1* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        int32_t,
        Invoke_3,
        app::Comparison_1_GenericCastManager_1_NativeArrays__2* this_ptr,

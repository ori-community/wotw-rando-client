...
namespace app::classes::System::Func_2_UberPoolGroupWarmer_PrewarmItem_Boolean_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::IAsyncResult*,
        BeginInvoke,
        app::Func_2_UberPoolGroupWarmer_PrewarmItem_Boolean_* this_ptr,
        app::UberPoolGroupWarmer_PrewarmItem arg,

...
namespace app::classes::System::Reflection::FieldInfo {
    ...
    inline bool operator==(app::FieldInfo_1& left, app::FieldInfo_1& right) { return op_Equality(&left, &right); }
    inline bool operator!=(app::FieldInfo_1& left, app::FieldInfo_1& right) { return op_Inequality(&left, &right); }
} // namespace app::classes::System::Reflection::FieldInfo

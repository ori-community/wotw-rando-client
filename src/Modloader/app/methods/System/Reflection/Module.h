...
namespace app::classes::System::Reflection::Module {
    ...
    inline bool operator==(app::Module& left, app::Module& right) { return op_Equality(&left, &right); }
    inline bool operator!=(app::Module& left, app::Module& right) { return op_Inequality(&left, &right); }
} // namespace app::classes::System::Reflection::Module

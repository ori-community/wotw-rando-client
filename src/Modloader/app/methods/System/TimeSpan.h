...
namespace app::classes::System::TimeSpan {
    ...
    inline app::TimeSpan operator-(app::TimeSpan t1, app::TimeSpan t2) { return op_Subtraction(t1, t2); }
    inline app::TimeSpan operator+(app::TimeSpan t1, app::TimeSpan t2) { return op_Addition(t1, t2); }
    inline bool operator==(app::TimeSpan t1, app::TimeSpan t2) { return op_Equality(t1, t2); }
    inline bool operator!=(app::TimeSpan t1, app::TimeSpan t2) { return op_Inequality(t1, t2); }
    inline bool operator<(app::TimeSpan t1, app::TimeSpan t2) { return op_LessThan(t1, t2); }
    inline bool operator<=(app::TimeSpan t1, app::TimeSpan t2) { return op_LessThanOrEqual(t1, t2); }
    inline bool operator>(app::TimeSpan t1, app::TimeSpan t2) { return op_GreaterThan(t1, t2); }
    inline bool operator>=(app::TimeSpan t1, app::TimeSpan t2) { return op_GreaterThanOrEqual(t1, t2); }
} // namespace app::classes::System::TimeSpan

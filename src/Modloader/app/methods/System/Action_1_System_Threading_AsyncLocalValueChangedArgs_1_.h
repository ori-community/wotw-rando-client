...
namespace app::classes::System::Action_1_System_Threading_AsyncLocalValueChangedArgs_1_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_1,
        app::Action_1_System_Threading_AsyncLocalValueChangedArgs_1__1* this_ptr,
        app::Object* object,
        void* method_1
    )
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_2,
        app::Action_1_System_Threading_AsyncLocalValueChangedArgs_1_* this_ptr,
        app::Object* object,
        void* method_1
    )
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_3,
        app::Action_1_System_Threading_AsyncLocalValueChangedArgs_1__2* this_ptr,
        app::Object* object,
        void* method_1
    )
    IL2CPP_REGISTER_METHOD(
        ...
        Invoke,
        app::Action_1_System_Threading_AsyncLocalValueChangedArgs_1__2* this_ptr,
        app::AsyncLocalValueChangedArgs_1_System_Object_ obj
    )
    IL2CPP_REGISTER_METHOD(
        0x02C07E30,
        app::IAsyncResult*,

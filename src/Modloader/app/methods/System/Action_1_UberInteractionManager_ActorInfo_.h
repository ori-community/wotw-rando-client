...
namespace app::classes::System::Action_1_UberInteractionManager_ActorInfo_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::IAsyncResult*,
        BeginInvoke,
        app::Action_1_UberInteractionManager_ActorInfo_* this_ptr,
        app::UberInteractionManager_ActorInfo obj,

...
namespace app::classes::System::Predicate_1_GenericCastManager_1_NativeArrays_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        bool,
        Invoke_1,
        app::Predicate_1_GenericCastManager_1_NativeArrays_* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        bool,
        Invoke_2,
        app::Predicate_1_GenericCastManager_1_NativeArrays__1* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        bool,
        Invoke_3,
        app::Predicate_1_GenericCastManager_1_NativeArrays__2* this_ptr,

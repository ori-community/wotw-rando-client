...
namespace app::classes::System::Nullable_1_UnityEngine_Rendering_RenderTargetIdentifier_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        GetValueOrDefault_1,
        app::Nullable_1_UnityEngine_Rendering_RenderTargetIdentifier___Boxed* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x0011E7F0,
        void,
        ctor,
        app::Nullable_1_UnityEngine_Rendering_RenderTargetIdentifier___Boxed* this_ptr,
        app::RenderTargetIdentifier value
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Equals_2,
        app::Nullable_1_UnityEngine_Rendering_RenderTargetIdentifier___Boxed* this_ptr,
        app::Nullable_1_UnityEngine_Rendering_RenderTargetIdentifier_ other
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        GetValueOrDefault_2,
        app::Nullable_1_UnityEngine_Rendering_RenderTargetIdentifier___Boxed* this_ptr,
        app::RenderTargetIdentifier default_value
    )

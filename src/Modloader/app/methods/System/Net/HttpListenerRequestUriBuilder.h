...
namespace app::classes::System::Net::HttpListenerRequestUriBuilder {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::HttpListenerRequestUriBuilder* this_ptr,
        app::String* raw_uri,
        app::String* cooked_uri_scheme,
        app::String* cooked_uri_host,
        app::String* cooked_uri_path,
        app::String* cooked_uri_query
    )
    IL2CPP_REGISTER_METHOD(
        0x01D4AAC0,
        app::Uri*,
    ...
    IL2CPP_REGISTER_METHOD(
        0x01D4B970,
        app::HttpListenerRequestUriBuilder_ParsingResult__Enum,
        BuildRequestUriUsingRawPath_2,
        app::HttpListenerRequestUriBuilder* this_ptr,

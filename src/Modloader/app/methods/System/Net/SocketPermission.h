...
namespace app::classes::System::Net::SocketPermission {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_2,
        app::SocketPermission* this_ptr,
        app::NetworkAccess__Enum access,
        app::TransportType__Enum transport,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ToXml_2,
        app::SocketPermission* this_ptr,
        app::SecurityElement* root,
        app::String* child_name,
        app::IEnumerator* enumerator
    )

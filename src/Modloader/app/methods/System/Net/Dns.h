...
namespace app::classes::System::Net::Dns {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::String* host_name_or_address,
        app::AsyncCallback* request_callback,
        app::Object* state
    )
    IL2CPP_REGISTER_METHOD(
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::String* host,
        app::String** h_name,
        app::String__Array** h_aliases,
        app::String__Array** h_addr_list,
        int32_t hint
    )
    IL2CPP_REGISTER_METHOD(
        0x01EB1C30,
        bool,
        GetHostByAddr_internal,
        app::String* addr,
        app::String** h_name,
        app::String__Array** h_aliases,
        app::String__Array** h_addr_list,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::String* original_host_name,
        app::String* h_name,
        app::String__Array* h_aliases,
        app::String__Array* h_addrlist
    )

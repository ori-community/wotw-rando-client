...
namespace app::classes::System::Net::HttpWebRequest {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_2,
        app::HttpWebRequest* this_ptr,
        app::Uri* uri,
        app::MonoTlsProvider* tls_provider,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::HttpWebRequest* this_ptr,
        app::RemoteCertificateValidationCallback* value
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x01E5F0A0,
        app::Stream*,
        EndGetRequestStream_2,
        app::HttpWebRequest* this_ptr,
        app::IAsyncResult* async_result,
        app::TransportContext** context
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        SetResponseError,
        app::HttpWebRequest* this_ptr,
        app::WebExceptionStatus__Enum status,
        app::Exception* e,
        app::String* where
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::String* connection_group_name,
        bool unsafe_connection_group,
        bool is_internal_group
    )

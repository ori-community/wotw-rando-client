...
namespace app::classes::System::Net::ConnectionPool {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::ConnectionPool* this_ptr,
        app::Object* owning_object,
        app::GeneralAsyncDelegate* async_callback,
        int32_t creation_timeout
    )
    IL2CPP_REGISTER_METHOD(
        0x01E9C470,
        void,

...
namespace app::classes::System::Data::DataSet {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::StreamingContext context,
        app::SerializationFormat__Enum_1 remoting_format,
        app::SchemaSerializationMode__Enum schema_serialization_mode
    )
    IL2CPP_REGISTER_METHOD(
        0x017E3B20,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        WriteXmlSchema,
        app::DataSet* this_ptr,
        app::XmlWriter* writer,
        app::SchemaFormat__Enum schema_format,
        app::Converter_2_Type_String_* multiple_target_converter
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        InferSchema,
        app::DataSet* this_ptr,
        app::XmlDocument* xdoc,
        app::String__Array* excluded_namespaces,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        FindTable,
        app::DataSet* this_ptr,
        app::DataTable* base_table,
        app::PropertyDescriptor__Array* props,
        int32_t prop_start
    )

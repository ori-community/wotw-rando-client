...
namespace app::classes::System::Data::Listeners_1_DataViewListener_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::Listeners_1_DataViewListener_* this_ptr,
        int32_t object_i_d,
        app::Listeners_1_TElem_Func_2_DataViewListener_DataViewListener_System_Boolean_* notify_filter
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Notify_1,
        app::Listeners_1_DataViewListener_* this_ptr,
        app::ListChangedEventArgs* arg1,
        bool arg2,
        bool arg3,
        app::Listeners_1_TElem_Action_4_DataViewListener_DataViewListener_System_ComponentModel_ListChangedEventArgs_System_Boolean_System_Boolean_* action
    )
    IL2CPP_REGISTER_METHOD(
        0x01AEEA30,
        void,
        Notify_2,
        app::Listeners_1_DataViewListener_* this_ptr,
        app::ListChangedType__Enum arg1,
        app::DataRow* arg2,
        bool arg3,
        app::Listeners_1_TElem_Action_4_DataViewListener_DataViewListener_System_ComponentModel_ListChangedType_DataRow_System_Boolean_* action
    )
} // namespace app::classes::System::Data::Listeners_1_DataViewListener_

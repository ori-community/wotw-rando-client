...
namespace app::classes::System::Data::Common::DataStorage {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_1,
        app::DataStorage* this_ptr,
        app::DataColumn* column,
        app::Type* type,
        app::Object* default_value,
        app::StorageType__Enum storage_type
    )
    IL2CPP_REGISTER_METHOD(
        0x02159D70,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::StorageType__Enum type_code,
        app::Type* data_type,
        bool* sql_type,
        bool* nullable,
        bool* xml_serializable,
        bool* change_tracking,
        bool* revertible_change_tracking
    )

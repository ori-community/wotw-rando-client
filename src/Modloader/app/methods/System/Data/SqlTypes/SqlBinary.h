...
namespace app::classes::System::Data::SqlTypes::SqlBinary {
    ...
    inline app::SqlBoolean operator==(app::SqlBinary x, app::SqlBinary y) { return op_Equality(x, y); }
    inline app::SqlBoolean operator<(app::SqlBinary x, app::SqlBinary y) { return op_LessThan(x, y); }
    inline app::SqlBoolean operator>(app::SqlBinary x, app::SqlBinary y) { return op_GreaterThan(x, y); }
} // namespace app::classes::System::Data::SqlTypes::SqlBinary

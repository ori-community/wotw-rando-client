...
namespace app::classes::System::Data::SqlTypes::SqlBoolean {
    ...
    inline app::SqlBoolean operator&(app::SqlBoolean x, app::SqlBoolean y) { return op_BitwiseAnd(x, y); }
    inline app::SqlBoolean operator|(app::SqlBoolean x, app::SqlBoolean y) { return op_BitwiseOr(x, y); }
    inline app::SqlBoolean operator==(app::SqlBoolean x, app::SqlBoolean y) { return op_Equality(x, y); }
} // namespace app::classes::System::Data::SqlTypes::SqlBoolean

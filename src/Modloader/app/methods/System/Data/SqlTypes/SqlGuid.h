...
namespace app::classes::System::Data::SqlTypes::SqlGuid {
    ...
    inline app::SqlBoolean operator==(app::SqlGuid x, app::SqlGuid y) { return op_Equality(x, y); }
    inline app::SqlBoolean operator<(app::SqlGuid x, app::SqlGuid y) { return op_LessThan(x, y); }
    inline app::SqlBoolean operator>(app::SqlGuid x, app::SqlGuid y) { return op_GreaterThan(x, y); }
} // namespace app::classes::System::Data::SqlTypes::SqlGuid

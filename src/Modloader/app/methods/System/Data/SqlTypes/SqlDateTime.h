...
namespace app::classes::System::Data::SqlTypes::SqlDateTime {
    ...
    inline app::SqlBoolean operator==(app::SqlDateTime x, app::SqlDateTime y) { return op_Equality(x, y); }
    inline app::SqlBoolean operator<(app::SqlDateTime x, app::SqlDateTime y) { return op_LessThan(x, y); }
    inline app::SqlBoolean operator>(app::SqlDateTime x, app::SqlDateTime y) { return op_GreaterThan(x, y); }
} // namespace app::classes::System::Data::SqlTypes::SqlDateTime

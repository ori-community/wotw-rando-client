...
namespace app::classes::System::Array_InternalEnumerator_1_Moon_Timeline_UberShaderAnimatorStrategyStandard_Request_1_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_1,
        app::Array_InternalEnumerator_1_Moon_Timeline_UberShaderAnimatorStrategyStandard_Request_1___Boxed* this_ptr,
        app::Array* array
    )
    IL2CPP_REGISTER_METHOD(
        0x00002890,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_2,
        app::Array_InternalEnumerator_1_Moon_Timeline_UberShaderAnimatorStrategyStandard_Request_1__1__Boxed* this_ptr,
        app::Array* array
    )
    IL2CPP_REGISTER_METHOD(
        0x00002890,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_3,
        app::Array_InternalEnumerator_1_Moon_Timeline_UberShaderAnimatorStrategyStandard_Request_1__2__Boxed* this_ptr,
        app::Array* array
    )
    IL2CPP_REGISTER_METHOD(
        0x00002890,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_4,
        app::Array_InternalEnumerator_1_Moon_Timeline_UberShaderAnimatorStrategyStandard_Request_1__3__Boxed* this_ptr,
        app::Array* array
    )
    IL2CPP_REGISTER_METHOD(
        0x00002890,

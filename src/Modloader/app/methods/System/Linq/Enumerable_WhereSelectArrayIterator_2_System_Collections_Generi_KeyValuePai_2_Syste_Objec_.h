...
namespace app::classes::System::Linq::Enumerable_WhereSelectArrayIterator_2_System_Collections_Generic_KeyValuePair_2_System_Object_ {
    IL2CPP_REGISTER_METHOD(
        ...
        Select_1,
        app::Enumerable_WhereSelectArrayIterator_2_System_Collections_Generic_KeyValuePair_2_System_Object_* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::IEnumerable_1_System_Int32_*,
        Select_5,
        app::Enumerable_WhereSelectArrayIterator_2_System_Collections_Generic_KeyValuePair_2_System_Object__1* this_ptr,
        app::Func_2_Object_Int32_* selector
    )
    IL2CPP_REGISTER_METHOD(
        0x00E775A0,

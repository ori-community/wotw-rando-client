...
#include <Modloader/app/structs/Enumerable_WhereEnumerableIterator_1_System_Byte_.h>
...
namespace app::classes::System::Linq::Enumerable_WhereEnumerableIterator_1_System_Byte_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::Enumerable_WhereEnumerableIterator_1_System_Byte_* this_ptr,
        app::IEnumerable_1_System_Byte_* source,

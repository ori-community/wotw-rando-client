...
namespace app::classes::System::Linq::Expressions::StackGuard {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        RunOnEmptyStack_1,
        app::StackGuard_1* this_ptr,
        app::Action_2_Object_Object_* action,
        app::Object* arg1,
        app::Object* arg2
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        RunOnEmptyStack_2,
        app::StackGuard_1* this_ptr,
        app::Action_2_System_Linq_Expressions_Interpreter_LightCompiler_System_Linq_Expressions_Expression_* action,
        app::LightCompiler* arg1,
        app::Expression* arg2
    )
} // namespace app::classes::System::Linq::Expressions::StackGuard

...
namespace app::classes::System::Linq::Expressions::Interpreter::TryCatchFinallyHandler {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_1,
        app::TryCatchFinallyHandler* this_ptr,
        int32_t try_start,
        int32_t try_end,
        int32_t goto_end_target_index,
        app::ExceptionHandler__Array* handlers
    )
    IL2CPP_REGISTER_METHOD(
        0x02415060,
        void,
        ...
        int32_t try_start,
        int32_t try_end,
        int32_t goto_end_label_index,
        int32_t finally_start,
        int32_t finally_end,
        app::ExceptionHandler__Array* handlers
    )
    IL2CPP_REGISTER_METHOD(
        ...
        app::Object** unwrapped_exception
    )

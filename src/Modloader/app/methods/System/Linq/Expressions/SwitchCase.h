...
namespace app::classes::System::Linq::Expressions::SwitchCase {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::SwitchCase* this_ptr,
        app::Expression* body,
        app::ReadOnlyCollection_1_System_Linq_Expressions_Expression_* test_values
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Update,
        app::SwitchCase* this_ptr,
        app::IEnumerable_1_System_Linq_Expressions_Expression_* test_values,
        app::Expression* body
    )
} // namespace app::classes::System::Linq::Expressions::SwitchCase

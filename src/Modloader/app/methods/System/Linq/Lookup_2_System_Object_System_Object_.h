...
namespace app::classes::System::Linq::Lookup_2_System_Object_System_Object_ {
    IL2CPP_REGISTER_METHOD(
        0x0153DB70,
        app::Lookup_2_System_Object_System_Object_*,
        Create,
    ...
    IL2CPP_REGISTER_METHOD(
        0x02548410,
        app::Lookup_2_TKey_TElement_Grouping_System_Object_System_Object_*,
        GetGrouping,
        app::Lookup_2_System_Object_System_Object_* this_ptr,
        app::Object* key,
        bool create
    )

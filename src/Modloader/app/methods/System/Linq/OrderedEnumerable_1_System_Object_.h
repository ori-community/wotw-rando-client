...
namespace app::classes::System::Linq::OrderedEnumerable_1_System_Object_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        System_Linq_IOrderedEnumerable_TElement__CreateOrderedEnumerable_1,
        app::OrderedEnumerable_1_System_Object_* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        0x0153D080,
        app::IOrderedEnumerable_1_System_Object_*,
        System_Linq_IOrderedEnumerable_TElement__CreateOrderedEnumerable_2,
        app::OrderedEnumerable_1_System_Object_* this_ptr,

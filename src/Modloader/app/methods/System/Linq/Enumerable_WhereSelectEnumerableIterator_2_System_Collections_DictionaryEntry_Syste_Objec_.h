...
namespace app::classes::System::Linq::Enumerable_WhereSelectEnumerableIterator_2_System_Collections_DictionaryEntry_System_Object_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::Enumerable_WhereSelectEnumerableIterator_2_System_Collections_DictionaryEntry_System_Object_* this_ptr,
        ...
        app::Func_2_System_Collections_DictionaryEntry_Object_* selector
    )
    IL2CPP_REGISTER_METHOD(
        0x028951E0,

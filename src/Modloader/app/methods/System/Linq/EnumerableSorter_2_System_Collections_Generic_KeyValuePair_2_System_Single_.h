...
namespace app::classes::System::Linq::EnumerableSorter_2_System_Collections_Generic_KeyValuePair_2_System_Single_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::EnumerableSorter_2_System_Collections_Generic_KeyValuePair_2_System_Single_* this_ptr,
        app::Func_2_System_Collections_Generic_KeyValuePair_2_Single__3* key_selector,
        app::IComparer_1_System_Single_* comparer,
        bool descending,
        app::EnumerableSorter_1_System_Collections_Generic_KeyValuePair_2_* next
    )
    IL2CPP_REGISTER_METHOD(
        0x0289D210,
        void,

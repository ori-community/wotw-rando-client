...
namespace app::classes::System::Linq::OrderedEnumerable_2_System_Collections_Generic_KeyValuePair_2_System_Single_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::OrderedEnumerable_2_System_Collections_Generic_KeyValuePair_2_System_Single_* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        0x02549A40,
        app::EnumerableSorter_1_System_Collections_Generic_KeyValuePair_2_*,
        GetEnumerableSorter,
        app::OrderedEnumerable_2_System_Collections_Generic_KeyValuePair_2_System_Single_* this_ptr,

...
namespace app::classes::System::Linq::EnumerableSorter_1_System_Collections_Generic_KeyValuePair_2_ {
    IL2CPP_REGISTER_METHOD(
        ...
        app::Int32__Array*,
        Sort_1,
        app::EnumerableSorter_1_System_Collections_Generic_KeyValuePair_2_* this_ptr,
        app::KeyValuePair_2_System_Object_System_Single___Array* elements,
        int32_t count
    )
    IL2CPP_REGISTER_METHOD(
        0x0289C270,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Int32__Array*,
        Sort_2,
        app::EnumerableSorter_1_System_Collections_Generic_KeyValuePair_2__1* this_ptr,

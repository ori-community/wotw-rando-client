...
namespace app::classes::System::TermInfoDriver {
    ...
    IL2CPP_REGISTER_METHOD(0x02440030, void, WriteSpecialKey_2, app::TermInfoDriver* this_ptr, char16_t c)
    IL2CPP_REGISTER_METHOD(0x02440080, bool, IsSpecialKey_1, app::TermInfoDriver* this_ptr, app::ConsoleKeyInfo key)
    IL2CPP_REGISTER_METHOD(0x02440120, bool, IsSpecialKey_2, app::TermInfoDriver* this_ptr, char16_t c)
    ...
    IL2CPP_REGISTER_METHOD(0x02440EC0, void, QueueEcho, app::TermInfoDriver* this_ptr, char16_t c)

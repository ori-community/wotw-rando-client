...
namespace app::classes::System::Resources::RuntimeResourceSet {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::RuntimeResourceSet* this_ptr,
        app::ResourceLocator res_location,
        app::String* key,
        app::Dictionary_2_System_String_System_Resources_ResourceLocator_* copy_of_cache,
        bool key_in_wrong_case
    )
} // namespace app::classes::System::Resources::RuntimeResourceSet

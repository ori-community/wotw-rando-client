...
namespace app::classes::System::Resources::ManifestBasedResourceGroveler {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::ManifestBasedResourceGroveler* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::ManifestBasedResourceGroveler* this_ptr,
        app::CultureInfo* look_for_culture
    )
    IL2CPP_REGISTER_METHOD(
        0x01A81AB0,
        app::CultureInfo*,
        ...
        app::Assembly* a,
        app::UltimateResourceFallbackLocation__Enum* fallback_location
    )
    IL2CPP_REGISTER_METHOD(
        0x01A81DD0,
        app::ResourceSet*,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::ManifestBasedResourceGroveler* this_ptr,
        app::String* reader_type_name,
        app::String* res_set_type_name
    )

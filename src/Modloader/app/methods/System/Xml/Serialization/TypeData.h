...
namespace app::classes::System::Xml::Serialization::TypeData {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_2,
        app::TypeData* this_ptr,
        app::Type* type,
        app::String* element_name,
        bool is_primitive,
        app::TypeData* mapped_type,
        app::XmlSchemaPatternFacet* facet
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x01C917E0,
        app::InvalidOperationException*,
        CreateMissingAddMethodException,
        app::Type* type,
        app::String* inherit_from,
        app::Type* argument_type
    )

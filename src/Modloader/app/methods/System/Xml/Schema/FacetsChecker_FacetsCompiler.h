...
namespace app::classes::System::Xml::Schema::FacetsChecker_FacetsCompiler {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::FacetsChecker_FacetsCompiler__Boxed* this_ptr,
        app::DatatypeImplementation* base_datatype,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::FacetsChecker_FacetsCompiler__Boxed* this_ptr,
        app::XmlSchemaFacet* facet,
        app::RestrictionFlags__Enum flag,
        app::String* error_code
    )
    IL2CPP_REGISTER_METHOD(
        0x001E7090,
        void,

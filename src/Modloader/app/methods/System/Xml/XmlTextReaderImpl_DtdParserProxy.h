...
namespace app::classes::System::Xml::XmlTextReaderImpl_DtdParserProxy {
    ...
    IL2CPP_REGISTER_METHOD(
        0x01FBB4C0,
        int32_t,
        IDtdParserAdapter_ParseNumericCharRef,
        app::XmlTextReaderImpl_DtdParserProxy* this_ptr,
        app::StringBuilder* internal_subset_builder
    )
    IL2CPP_REGISTER_METHOD(
        0x01FBB500,
        int32_t,
        IDtdParserAdapter_ParseNamedCharRef,
        app::XmlTextReaderImpl_DtdParserProxy* this_ptr,
        bool expand,
        app::StringBuilder* internal_subset_builder
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x01FBB5A0,
        bool,
        IDtdParserAdapter_PushEntity,
        app::XmlTextReaderImpl_DtdParserProxy* this_ptr,
        app::IDtdEntityInfo* entity,
        int32_t* entity_id
    )
    IL2CPP_REGISTER_METHOD(
        0x01FBB6D0,
        bool,
        IDtdParserAdapter_PopEntity,
        app::XmlTextReaderImpl_DtdParserProxy* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        0x01FBB740,
        bool,
        IDtdParserAdapter_PushExternalSubset,
        app::XmlTextReaderImpl_DtdParserProxy* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        0x01FBB8C0,
        void,
        IDtdParserAdapter_PushInternalDtd,
        app::XmlTextReaderImpl_DtdParserProxy* this_ptr,
        app::String* base_uri,
        app::String* internal_dtd
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x01FBBB80,
        app::IValidationEventHandling*,
        IDtdParserAdapterWithValidation_get_ValidationEventHandling,
        app::XmlTextReaderImpl_DtdParserProxy* this_ptr
    )

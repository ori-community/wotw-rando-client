...
namespace app::classes::System::Xml::XmlTextEncoder {
    ...
    IL2CPP_REGISTER_METHOD(0x01714D40, void, set_QuoteChar, app::XmlTextEncoder* this_ptr, char16_t value)
    ...
    IL2CPP_REGISTER_METHOD(0x01714FC0, void, WriteSurrogateChar, app::XmlTextEncoder* this_ptr, char16_t low_char, char16_t high_char)
    ...
    IL2CPP_REGISTER_METHOD(0x017155B0, void, WriteSurrogateCharEntity, app::XmlTextEncoder* this_ptr, char16_t low_char, char16_t high_char)
    ...
    IL2CPP_REGISTER_METHOD(0x017161F0, void, WriteCharEntity, app::XmlTextEncoder* this_ptr, char16_t ch)
    IL2CPP_REGISTER_METHOD(0x01716360, void, WriteEntityRef, app::XmlTextEncoder* this_ptr, app::String* name)
    IL2CPP_REGISTER_METHOD(
        0x017163E0,
        void,
        WriteStringFragment,
        app::XmlTextEncoder* this_ptr,
        app::String* str,
        int32_t offset,
        int32_t count,
        app::Char__Array* helper_buffer
    )
    IL2CPP_REGISTER_METHOD(0x017164A0, void, WriteCharEntityImpl_1, app::XmlTextEncoder* this_ptr, char16_t ch)

...
namespace app::classes::System::Xml::XmlUtf8RawTextWriterIndent {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        WriteDocType,
        app::XmlUtf8RawTextWriterIndent* this_ptr,
        app::String* name,
        app::String* pubid,
        app::String* sysid,
        app::String* subset
    ...
    IL2CPP_REGISTER_METHOD(0x01FC8CE0, void, WriteCharEntity, app::XmlUtf8RawTextWriterIndent* this_ptr, char16_t ch)
    IL2CPP_REGISTER_METHOD(0x01FC8CF0, void, WriteSurrogateCharEntity, app::XmlUtf8RawTextWriterIndent* this_ptr, char16_t low_char, char16_t high_char)

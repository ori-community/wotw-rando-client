...
namespace app::classes::System::Xml::XmlAsyncCheckWriter {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        WriteDocType,
        app::XmlAsyncCheckWriter* this_ptr,
        app::String* name,
        app::String* pubid,
        app::String* sysid,
        app::String* subset
    ...
    IL2CPP_REGISTER_METHOD(0x0195A830, void, WriteCharEntity, app::XmlAsyncCheckWriter* this_ptr, char16_t ch)
    ...
    IL2CPP_REGISTER_METHOD(0x0195A920, void, WriteSurrogateCharEntity, app::XmlAsyncCheckWriter* this_ptr, char16_t low_char, char16_t high_char)

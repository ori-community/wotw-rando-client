...
namespace app::classes::System::Func_2_LightCanvasEditorTextureCache_LightCanvasEditorTextureData_LightCanvasEditorTextureCache_LightCanvasEditorTextureData_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::Func_2_LightCanvasEditorTextureCache_LightCanvasEditorTextureData_LightCanvasEditorTextureCache_LightCanvasEditorTextureData_* this_ptr,
        app::Object* object,
        void* method_1
    )
    IL2CPP_REGISTER_METHOD(
        ...
        Invoke,
        app::Func_2_LightCanvasEditorTextureCache_LightCanvasEditorTextureData_LightCanvasEditorTextureCache_LightCanvasEditorTextureData_* this_ptr,
        app::LightCanvasEditorTextureCache_LightCanvasEditorTextureData arg
    )
    IL2CPP_REGISTER_METHOD(
        0x02883CE0,
        app::IAsyncResult*,
  ...
  // app::classes::System::Func_2_LightCanvasEditorTextureCache_LightCanvasEditorTextureData_LightCanvasEditorTextureCache_LightCanvasEditorTextureData_

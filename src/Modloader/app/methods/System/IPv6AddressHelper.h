...
namespace app::classes::System::IPv6AddressHelper {
    ...
    IL2CPP_REGISTER_METHOD(0x0200C6D0, bool, InternalIsValid, char16_t* name, int32_t start, int32_t* end, bool validate_strict_address)
    IL2CPP_REGISTER_METHOD(0x0200CA30, bool, IsValid, char16_t* name, int32_t start, int32_t* end)
    IL2CPP_REGISTER_METHOD(0x0200CA50, bool, IsValidStrict, char16_t* name, int32_t start, int32_t* end)

...
namespace app::classes::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1_System_Object_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        SetStateMachine,
        app::AsyncTaskMethodBuilder_1_System_Object___Boxed* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        SetResult_2,
        app::AsyncTaskMethodBuilder_1_System_Object___Boxed* this_ptr,
        app::Task_1_System_Object_* completed_task
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Start_2,
        app::AsyncTaskMethodBuilder_1_System_Object___Boxed* this_ptr,
        app::XmlUrlResolver_GetEntityAsync_d_15* state_machine
    )
    IL2CPP_REGISTER_METHOD(
        0x001A3C90,
        void,
        ...
        app::AsyncTaskMethodBuilder_1_System_Object___Boxed* this_ptr,
        app::ConfiguredTaskAwaitable_1_TResult_ConfiguredTaskAwaiter_System_IO_Stream_* awaiter,
        app::XmlUrlResolver_GetEntityAsync_d_15* state_machine
    )
    IL2CPP_REGISTER_METHOD(
        0x001A3C70,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::AsyncTaskMethodBuilder_1_System_Object___Boxed* this_ptr,
        app::TaskAwaiter_1_System_Object_* awaiter,
        app::PlayFabRaceServiceProvider_GetRaceData_d_10* state_machine
    )
    IL2CPP_REGISTER_METHOD(
        0x001A3CF0,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::AsyncTaskMethodBuilder_1_System_Object___Boxed* this_ptr,
        app::TaskAwaiter_1_System_Object_* awaiter,
        app::PlayFabRaceServiceProvider_ProcessLeaderBoardList_d_13* state_machine
    )
    IL2CPP_REGISTER_METHOD(
        0x001A3D10,
        void,

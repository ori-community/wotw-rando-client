...
namespace app::classes::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1_System_Boolean_ {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Start,
        app::AsyncTaskMethodBuilder_1_System_Boolean___Boxed* this_ptr,
        app::SemaphoreSlim_WaitUntilCountOrTimeoutAsync_d_31* state_machine
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::AsyncTaskMethodBuilder_1_System_Boolean___Boxed* this_ptr,
        app::ConfiguredTaskAwaitable_1_TResult_ConfiguredTaskAwaiter_System_Threading_Tasks_Task_* awaiter,
        app::SemaphoreSlim_WaitUntilCountOrTimeoutAsync_d_31* state_machine
    )
    IL2CPP_REGISTER_METHOD(
        0x001A3B80,
        ...
        app::AsyncTaskMethodBuilder_1_System_Boolean___Boxed* this_ptr,
        app::ConfiguredTaskAwaitable_1_TResult_ConfiguredTaskAwaiter_System_Boolean_* awaiter,
        app::SemaphoreSlim_WaitUntilCountOrTimeoutAsync_d_31* state_machine
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        SetResult_2,
        app::AsyncTaskMethodBuilder_1_System_Boolean___Boxed* this_ptr,
        app::Task_1_System_Boolean_* completed_task
    )
    IL2CPP_REGISTER_METHOD(
        0x001FF470,

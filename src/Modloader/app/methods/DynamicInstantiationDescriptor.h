...
namespace app::classes::DynamicInstantiationDescriptor {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::DynamicInstantiationDescriptor* this_ptr,
        app::GameObject* prefab,
        int32_t count,
        app::Nullable_1_Single_ high_priority_prewarm_ratio
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x030DD290,
        app::Nullable_1_DynamicInstantiationDescriptor_ReflectionInfo_,
        GetInfoForDynamicInstantiationProvider,
    ...
    IL2CPP_REGISTER_METHOD(
        0x030DD7C0,
        app::Nullable_1_DynamicInstantiationDescriptor_ReflectionInfo_,
        GetInfoForDynamicInstantiation,
        app::Type* component_type,
        app::FieldInfo_1* field
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x030DDCB0,
        app::DynamicInstantiationDescriptor_CountGetter*,
        CreateCountGetter,
        app::Type* component_type,
        app::FieldInfo_1* field,
    ...
    inline bool operator==(app::DynamicInstantiationDescriptor& left, app::DynamicInstantiationDescriptor& right) { return op_Equality(&left, &right); }
    inline bool operator!=(app::DynamicInstantiationDescriptor& left, app::DynamicInstantiationDescriptor& right) { return op_Inequality(&left, &right); }
} // namespace app::classes::DynamicInstantiationDescriptor

...
namespace app::classes::MoonShadingZoneController {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        UpdateTarget,
        app::MoonShadingZoneController* this_ptr,
        app::MoonShadingZoneController_TargetData* target,
        float delta
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        OnTargetEnter,
        app::MoonShadingZoneController* this_ptr,
        app::MoonShadingZoneController_TargetData* data,
        app::IMoonShadingZone* zone
    )
    IL2CPP_REGISTER_METHOD(
        0x014612D0,
        void,

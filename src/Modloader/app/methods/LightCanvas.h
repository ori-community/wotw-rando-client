...
namespace app::classes::LightCanvas {
    ...
    IL2CPP_REGISTER_METHOD(
        0x011415E0,
        void,
        ApplyLightCanvasOnRenderer_2,
        app::LightCanvas* this_ptr,
        app::Renderer* renderer,
        app::LightCanvasShadingZone_LightCanvasShadingZonesFlags__Enum apply_flags
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::LightCanvas* this_ptr,
        app::Renderer* renderer,
        app::UberShaderProperty_Texture__Enum texture_property,
        app::UberShaderProperty_Vector__Enum bounds_property,
        app::UberShaderProperty_Vector__Enum position_property,
        app::UberShaderProperty_Vector__Enum uvs_property,
        app::UberShaderProperty_Vector__Enum atlas_min_max_property,
        app::UberShaderProperty_Float__Enum atlas_flip_property
    )
    IL2CPP_REGISTER_METHOD(
        0x01141CD0,
        bool,
        HasApplyFlag,
        app::LightCanvas* this_ptr,
        app::LightCanvasShadingZone_LightCanvasShadingZonesFlags__Enum flag,
        app::LightCanvasShadingZone_LightCanvasShadingZonesFlags__Enum test
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x01142330,
        void,
        UpdateStatesDefinition,
        app::LightCanvas* this_ptr,
        app::List_1_LightCanvasStateController_LightCanvasState_* new_states
    )
    IL2CPP_REGISTER_METHOD(0x011427F0, void, RebindAllChildrenRuntime, app::LightCanvas* this_ptr)
    IL2CPP_REGISTER_METHOD(
        0x011428E0,
        app::Vector4,
        MakeBakedLightingLightColorMask,
        app::LightCanvas_SubLayerSettings* sub_layer_settings,
        app::Vector3 light_canvas_comp,
        float ubershader_comp_z
    )
    IL2CPP_REGISTER_METHOD(
        0x01142D40,
        void,
        UpdateBakeLightingValues,
        app::Renderer* renderer,
        app::Texture* light_texture,
        app::Rect canvas_rect,
        app::LightCanvas_SubLayerSettings* sub_layer_settings,
        app::Vector3 light_canvas_position,
        app::Vector4 light_color_mask,
        app::Vector4 uvs,
        app::Vector4 atlas_min_max,
        bool atlas_flip
    )
    IL2CPP_REGISTER_METHOD(
        0x01143030,
        void,
        UpdateDynamicBakeLightingValues,
        app::Renderer* renderer,
        app::Texture* light_texture,
        app::Rect canvas_rect,
        app::Vector3 light_canvas_position,

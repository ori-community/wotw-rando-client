...
namespace app::classes::CameraSettings {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor_2,
        app::CameraSettings* this_ptr,
        app::CameraSettingsAsset* settings,
        app::FogGradientController* fog_gradient
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ctor_3,
        app::CameraSettings* this_ptr,
        app::CameraSettingsAsset* camera_settings,
        app::Gradient* fog_gradient,
        app::Gradient* multiply_fog_gradient,
        float range
    )
} // namespace app::classes::CameraSettings

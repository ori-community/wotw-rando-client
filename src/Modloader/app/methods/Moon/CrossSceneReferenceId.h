...
namespace app::classes::Moon::CrossSceneReferenceId {
    ...
    inline bool operator==(app::CrossSceneReferenceId left, app::CrossSceneReferenceId right) { return op_Equality(left, right); }
    inline bool operator!=(app::CrossSceneReferenceId left, app::CrossSceneReferenceId right) { return op_Inequality(left, right); }
} // namespace app::classes::Moon::CrossSceneReferenceId

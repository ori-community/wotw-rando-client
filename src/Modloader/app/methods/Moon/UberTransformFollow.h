...
namespace app::classes::Moon::UberTransformFollow {
    ...
    IL2CPP_REGISTER_METHOD(
        0x02570C20,
        app::ValueTuple_2_UnityEngine_Vector3_UnityEngine_Vector3_,
        DoPositionAndRotation,
        app::UberTransformFollow* this_ptr,
        float delta_time
    )
    IL2CPP_REGISTER_METHOD(
        0x025712B0,
        ...
        app::UberTransformFollow* this_ptr,
        float delta_time,
        app::Vector3 my_position,
        app::Vector3 avg_position
    )
    IL2CPP_REGISTER_METHOD(
        0x02571F30,
        app::Vector3,
        ...
        float delta_time,
        app::Vector3 my_position,
        app::Vector3 my_rotation,
        app::Vector3 avg_position,
        app::Vector3 avg_rotation
    )

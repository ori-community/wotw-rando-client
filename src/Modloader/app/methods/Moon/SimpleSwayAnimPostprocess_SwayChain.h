...
namespace app::classes::Moon::SimpleSwayAnimPostprocess_SwayChain {
    IL2CPP_REGISTER_METHOD(
        0x02121820,
        void,
        CopyPerFrameDataToJob,
        app::SimpleSwayAnimPostprocess_SwayChain* this_ptr,
        app::SimpleSwayAnimPostprocess_PerFrameReadOnly common
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Init,
        app::SimpleSwayAnimPostprocess_SwayChain* this_ptr,
        app::JointChains_Chain* chain,
        app::SimpleSwayAnimPostprocess_Params p
    )

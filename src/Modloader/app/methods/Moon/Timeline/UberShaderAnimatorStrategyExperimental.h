...
namespace app::classes::Moon::Timeline::UberShaderAnimatorStrategyExperimental {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        SubmitColorInternal,
        app::UberShaderAnimatorStrategyExperimental* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        0x00D13470,
        void,
        ClearVector4Requests,
        app::UberShaderAnimatorStrategyExperimental* this_ptr,
        app::Renderer__Array* target_renderers
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        UpdateColorRequests,
        app::UberShaderAnimatorStrategyExperimental* this_ptr,
        app::UberShaderAnimatorStrategyExperimental_RendererState* state
    )
    IL2CPP_REGISTER_METHOD(
        0x00D14150,
        void,

...
namespace app::classes::Moon::Timeline::ExperimentalTransparencyAnimatorSystemStrategy {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        SubmitAlphaInternal,
        app::ExperimentalTransparencyAnimatorSystemStrategy* this_ptr,
        app::Renderer* renderer,
        app::UberShaderProperty_Color__Enum property,
        float value,
        bool persist,
        bool auto_enable_and_disable,
        app::HandoverMode__Enum handover_mode,
        app::TransparencyMode__Enum transparency_mode
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        DisbandState,
        app::ExperimentalTransparencyAnimatorSystemStrategy* this_ptr,
        app::ExperimentalTransparencyAnimatorSystemStrategy_RendererState* state,
        bool force_moon_hidden_to_false
    )
    IL2CPP_REGISTER_METHOD(
        0x00769440,
        void,

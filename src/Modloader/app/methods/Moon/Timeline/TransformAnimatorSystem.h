...
namespace app::classes::Moon::Timeline::TransformAnimatorSystem {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        CreatePositionModification,
        app::TransformAnimatorSystem* this_ptr,
        app::Transform* t,
        app::Vector3 position,
        app::Space__Enum space
    )
    IL2CPP_REGISTER_METHOD(
        0x0311CB50,
        void,
        SubmitDynamicPosition,
        app::TransformAnimatorSystem* this_ptr,
        app::Transform* t,
        app::Vector3 position,
        app::Space__Enum space,
        app::HandoverMode__Enum handover_mode,
        app::UpdateCategory__Enum category
    )
    IL2CPP_REGISTER_METHOD(
        0x0311CE70,
        void,
        SubmitStaticPosition,
        app::TransformAnimatorSystem* this_ptr,
        app::Transform* t,
        app::Vector3 position,
        app::Space__Enum space,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ApplyObjectState_1,
        app::TransformAnimatorSystem* this_ptr,
        app::TransformAnimatorSystem_ObjectState* object_state,
        bool force_apply
    )
    IL2CPP_REGISTER_METHOD(
        0x0311E490,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::TransformAnimatorSystem* this_ptr,
        app::List_1_System_Int32_* objects,
        bool clear_state_holders
    )

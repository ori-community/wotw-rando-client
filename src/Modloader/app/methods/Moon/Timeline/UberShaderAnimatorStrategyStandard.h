...
namespace app::classes::Moon::Timeline::UberShaderAnimatorStrategyStandard {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Vector4,
        GetStaticVector,
        app::UberShaderAnimatorStrategyStandard* this_ptr,
        app::Renderer* target_renderer,
    ...
    IL2CPP_REGISTER_METHOD(
        0x00D16CC0,
        void,
        RemoveFromTrackingStates,
        app::UberShaderAnimatorStrategyStandard* this_ptr,
        app::UberShaderAnimatorStrategyStandard_RendererState* state
    )
    IL2CPP_REGISTER_METHOD(
        0x00D16E60,
        void,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        UpdateColorRequests,
        app::UberShaderAnimatorStrategyStandard* this_ptr,
        app::UberShaderAnimatorStrategyStandard_RendererState* renderer_state
    )
    IL2CPP_REGISTER_METHOD(
        0x00D177E0,
        void,
        UpdateVector4Requests,
        app::UberShaderAnimatorStrategyStandard* this_ptr,
        app::UberShaderAnimatorStrategyStandard_RendererState* renderer_state
    )
    IL2CPP_REGISTER_METHOD(

...
namespace app::classes::Moon::Timeline::EntityId {
    ...
    inline bool operator==(app::EntityId lhs, app::EntityId rhs) { return op_Equality(lhs, rhs); }
    inline bool operator!=(app::EntityId lhs, app::EntityId rhs) { return op_Inequality(lhs, rhs); }
} // namespace app::classes::Moon::Timeline::EntityId

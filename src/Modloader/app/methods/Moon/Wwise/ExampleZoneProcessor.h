...
namespace app::classes::Moon::Wwise::ExampleZoneProcessor {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ProcessZoneTasks,
        app::ExampleZoneProcessor* this_ptr,
        app::ZoneProcessor_2_TListenerTaskData_TEmitterTaskData_ListenerZoneTask_LZData_EZData___Array* listener_zone_tasks,
        app::ZoneProcessor_2_TListenerTaskData_TEmitterTaskData_EmitterZoneTask_LZData_EZData___Array* emitter_zone_tasks,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::ZoneProcessor_2_TListenerTaskData_TEmitterTaskData_ListenerZoneTask_LZData_EZData___Array* listener_tasks,
        app::PositionSyncTask__Array* position_tasks
    )

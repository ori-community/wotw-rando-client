...
namespace app::classes::Moon::Wwise::ZoneProcessor_2_TListenerTaskData_TEmitterTaskData__ListenerZoneTask_ListenerSoundZoneTaskData_EmitterSoundZoneTaskData_ {
    IL2CPP_REGISTER_METHOD(
        ...
        bool,
        get_IsValid,
        app::ZoneProcessor_2_TListenerTaskData_TEmitterTaskData_ListenerZoneTask_ListenerSoundZoneTaskData_EmitterSoundZoneTaskData_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x004430B0,
        bool,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        set_Data,
        app::ZoneProcessor_2_TListenerTaskData_TEmitterTaskData_ListenerZoneTask_ListenerSoundZoneTaskData_EmitterSoundZoneTaskData_* this_ptr,
        app::ListenerSoundZoneTaskData value
    )
    IL2CPP_REGISTER_METHOD(
        0x00654950,
        int32_t,
  ...
  // app::classes::Moon::Wwise::ZoneProcessor_2_TListenerTaskData_TEmitterTaskData__ListenerZoneTask_ListenerSoundZoneTaskData_EmitterSoundZoneTaskData_

...
namespace app::classes::Moon::Sensor_SensorLineOfSightRequest {
    ...
    IL2CPP_REGISTER_METHOD(
        0x0010E170,
        app::Sensor_SensorLineOfSightRequest_State__Enum,
        get_CurrentState,
        app::Sensor_SensorLineOfSightRequest__Boxed* this_ptr
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Vector3 from,
        app::Vector3 to,
        app::Sensor_SensorLineOfSightRequest_State__Enum async_state
    )

...
namespace app::classes::Moon::Trail_Point {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::Trail_Point__Boxed* this_ptr,
    ...
    inline app::Trail_Point operator+(app::Trail_Point p1, app::Trail_Point p2) { return op_Addition(p1, p2); }
    inline app::Trail_Point operator-(app::Trail_Point p1, app::Trail_Point p2) { return op_Subtraction(p1, p2); }
} // namespace app::classes::Moon::Trail_Point

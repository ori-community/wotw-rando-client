...
namespace app::classes::Moon::TentaclePhysicsPostprocess {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        DrawJointChain,
        app::TentaclePhysicsPostprocess* this_ptr,
        app::Vector3__Array* joint_pos,
        app::Color color,
        float radius
    )
    IL2CPP_REGISTER_METHOD(
        ...
        app::TentaclePhysicsPostprocess* this_ptr,
        app::Vector3__Array* joint_pos,
        app::Quaternion__Array* joint_rot
    )
    IL2CPP_REGISTER_METHOD(
        0x010AF9E0,
        void,
        ...
        app::Vector3__Array* joint_pos,
        app::Quaternion__Array* joint_rot,
        app::Vector3__Array* joint_scale
    )
    IL2CPP_REGISTER_METHOD(
        0x010AFA60,
        void,
        PullTowardsTarget,
        app::TentaclePhysicsPostprocess* this_ptr,
        app::Vector3__Array* target_pos,
        app::Vector3__Array* particle_pos,
        app::Vector3__Array* particle_velo,
        float influence,
        float dt
    )
    IL2CPP_REGISTER_METHOD(
    ...
    IL2CPP_REGISTER_METHOD(
        0x010B22D0,
        void,
        ValidateParticlePositions,
        app::TentaclePhysicsPostprocess* this_ptr,
        app::Vector3 origin,
        app::Vector3__Array* particle_pos,
        app::Vector3__Array* particle_velo,
        app::Vector3__Array* fallback_pos,
        float max_dist
    )
    IL2CPP_REGISTER_METHOD(
        0x010B2560,
        ...
        ApplyKickback,
        app::TentaclePhysicsPostprocess* this_ptr,
        app::Vector3__Array* source_pos,
        app::Vector3__Array* result_pos
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::TentaclePhysicsPostprocess* this_ptr,
        app::Vector3__Array* joint_pos,
        app::Quaternion__Array* joint_post_rot,
        app::Quaternion__Array* joint_anim_rot
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x010B3700,
        void,
        ApplyTargetIKToChain,
        app::TentaclePhysicsPostprocess* this_ptr,
        app::Vector3__Array* from_joints,
        app::Vector3__Array* to_joints
    )
    IL2CPP_REGISTER_METHOD(
        0x010B3F90,
        app::Vector3,
        ApplyTargetIKToJoint,
        app::TentaclePhysicsPostprocess* this_ptr,
        app::Vector3 joint_pos,
        app::Vector3 ref_origin,
        app::Vector3 ref_tangent,
        app::Vector3 ref_normal,
        app::Vector3 target_tangent,
        app::Vector3 target_normal,
        float target_tangent_scale,
        float weight
    )
    IL2CPP_REGISTER_METHOD(
        0x010B42E0,
        void,
        UpdateAdaptiveColliders,
        app::TentaclePhysicsPostprocess* this_ptr,
        app::Vector3__Array* joint_pos,
        int32_t joint_count
    )

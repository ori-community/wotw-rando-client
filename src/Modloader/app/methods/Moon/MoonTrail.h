...
namespace app::classes::Moon::MoonTrail {
    ...
    IL2CPP_REGISTER_METHOD(
        0x006FB820,
        void,
        SetMaterialPropertyBlockProvider,
        app::MoonTrail* this_ptr,
        app::IMaterialPropertyBlockProvider* material_property_block_provider
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        EmitParticlesTo,
        app::MoonTrail* this_ptr,
        app::MoonTrailUpdateContext* ctx,
        app::Nullable_1_UnityEngine_Vector3_ last_control_point
    )
    IL2CPP_REGISTER_METHOD(
        0x0255EF30,
        void,

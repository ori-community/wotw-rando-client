...
namespace app::classes::Moon::Rendering::RenderTargetDescriptor {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::RenderTargetType__Enum _type,
        app::Int2 _size,
        app::RenderTextureFormat__Enum _format,
        int32_t _depth_buffer_bits,
        app::FilterMode__Enum _filter_mode,
        app::RenderTexture* _external,
    ...
    inline bool operator==(app::RenderTargetDescriptor left, app::RenderTargetDescriptor right) { return op_Equality(left, right); }
    inline bool operator!=(app::RenderTargetDescriptor left, app::RenderTargetDescriptor right) { return op_Inequality(left, right); }
} // namespace app::classes::Moon::Rendering::RenderTargetDescriptor

...
namespace app::classes::Moon::uberSerializationWisp::PlayerUberStateAreaMapInformation {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::PlayerUberStateAreaMapInformation* map_info
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        ctor,
        app::PlayerUberStateAreaMapInformation* this_ptr,
        app::PlayerUberStateDescriptor* desc,
        app::Action* dirty_call_back
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x00F36860,
        app::WorldMapAreaState__Enum,
        GetAreaState,
        app::PlayerUberStateAreaMapInformation* this_ptr,
        app::GameWorldAreaID__Enum area_i_d,
        int32_t index
    )
    IL2CPP_REGISTER_METHOD(
        0x00F369E0,
    ...
    IL2CPP_REGISTER_METHOD(
        0x00F36E40,
        app::Dictionary_2_System_Int32_WorldMapAreaState_*,
        GetAreaStates,
        app::PlayerUberStateAreaMapInformation* this_ptr,
        app::GameWorldAreaID__Enum area_i_d
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x00F371E0,
        bool,
        IsWithinMapTrailEntryBounds,
        app::PlayerUberStateAreaMapInformation* this_ptr,
        app::PlayerUberStateAreaMapInformation_MapTrailEntry* entry,
        app::Vector2 point
    )
    IL2CPP_REGISTER_METHOD(
        0x00F37270,
        app::PlayerUberStateAreaMapInformation_MapTrailEntry*,
        GetTrailEntryContainingPoint,
        app::PlayerUberStateAreaMapInformation* this_ptr,
        app::Vector2 point,
        int32_t* index
    )
    IL2CPP_REGISTER_METHOD(
        0x002FB930,
        app::List_1_Moon_uberSerializationWisp_PlayerUberStateAreaMapInformation_MapTrailEntry_*,
        GetTrailPoints,
        app::PlayerUberStateAreaMapInformation* this_ptr
    )

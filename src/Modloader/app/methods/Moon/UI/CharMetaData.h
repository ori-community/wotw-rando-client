...
namespace app::classes::Moon::UI::CharMetaData {
    ...
    IL2CPP_REGISTER_METHOD(0x0011E2E0, char16_t, MarkAsStyleStatement, app::CharMetaData_1__Boxed* this_ptr, int32_t unstyled_index, app::Vector2 position)
    IL2CPP_REGISTER_METHOD(
        0x0011E310,
        void,
        MarkAsWhitespace,
        app::CharMetaData_1__Boxed* this_ptr,
        int32_t unstyled_index,
        app::Vector2 position,
        app::AppliedTextStyle_1* style
    )
    IL2CPP_REGISTER_METHOD(
        0x0011E350,
        app::BitmapFontChar_1*,
        MarkAsVisible,
        app::CharMetaData_1__Boxed* this_ptr,
        int32_t unstyled_index,
        app::Vector2 position,

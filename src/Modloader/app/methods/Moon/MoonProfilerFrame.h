...
namespace app::classes::Moon::MoonProfilerFrame {
    ...
    inline app::MoonProfilerFrame operator+(app::MoonProfilerFrame a, app::MoonProfilerFrame b) { return op_Addition(a, b); }
    inline app::MoonProfilerFrame operator/(app::MoonProfilerFrame a, int32_t b) { return op_Division(a, b); }
} // namespace app::classes::Moon::MoonProfilerFrame

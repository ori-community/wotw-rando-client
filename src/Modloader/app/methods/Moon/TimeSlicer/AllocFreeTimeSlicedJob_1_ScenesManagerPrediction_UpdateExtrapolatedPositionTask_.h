...
namespace app::classes::Moon::TimeSlicer::AllocFreeTimeSlicedJob_1_ScenesManagerPrediction_UpdateExtrapolatedPositionTask_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::AllocFreeTimeSlicedJob_1_ScenesManagerPrediction_UpdateExtrapolatedPositionTask_* this_ptr,
        app::String* name
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        SetTask,
        app::AllocFreeTimeSlicedJob_1_ScenesManagerPrediction_UpdateExtrapolatedPositionTask_* this_ptr,
        app::ScenesManagerPrediction_UpdateExtrapolatedPositionTask task
    )
    IL2CPP_REGISTER_METHOD(
        0x02AF3E00,
        bool,
    ...
    IL2CPP_REGISTER_METHOD(
        0x00420EE0,
        app::String*,
        get_TimesliceJobOwnerName,
        app::AllocFreeTimeSlicedJob_1_ScenesManagerPrediction_UpdateExtrapolatedPositionTask_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x00738690,
        float,
        get_CustomTimeBudget,
        app::AllocFreeTimeSlicedJob_1_ScenesManagerPrediction_UpdateExtrapolatedPositionTask_* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x00990EC0,
        void,
        set_CustomTimeBudget,
        app::AllocFreeTimeSlicedJob_1_ScenesManagerPrediction_UpdateExtrapolatedPositionTask_* this_ptr,
        float value
    )
    IL2CPP_REGISTER_METHOD(

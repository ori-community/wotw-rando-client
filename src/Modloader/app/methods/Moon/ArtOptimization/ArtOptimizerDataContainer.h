...
namespace app::classes::Moon::ArtOptimization::ArtOptimizerDataContainer {
    ...
    IL2CPP_REGISTER_METHOD(
        0x01345200,
        void,
        CalculateEnergyLimitsByStripPercentage,
        app::ArtOptimizerDataContainer* this_ptr,
        float objects_strip_percentage,
        float modifiers_strip_percentage
    )
    IL2CPP_REGISTER_METHOD(0x01346590, void, Clear, app::ArtOptimizerDataContainer* this_ptr)
    IL2CPP_REGISTER_METHOD(
        0x01346660,
        bool,
        ShouldStripByEnergyLimit_1,
        app::ArtOptimizerDataContainer* this_ptr,
        app::SerializableUberShaderWrapper* uber_shader
    )
    IL2CPP_REGISTER_METHOD(
        0x013468F0,
        bool,
        ShouldStripByEnergyLimit_2,
        app::ArtOptimizerDataContainer* this_ptr,
        app::SerializableUberSaderModifierWrapper* modifier
    )

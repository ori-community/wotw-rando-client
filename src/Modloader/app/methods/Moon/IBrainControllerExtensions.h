...
namespace app::classes::Moon::IBrainControllerExtensions {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Enum__Array*,
        BuildEntries_2,
        app::IBrainController_1_ConditionBasedBrainController_BranchingBoolEntries_* controller
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::Enum__Array*,
        BuildEntries_14,
        app::IBrainController_1_TimelineBranchingControllerTest_BranchingTestEntries_* controller
    )

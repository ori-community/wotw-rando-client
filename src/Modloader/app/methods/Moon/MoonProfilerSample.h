...
namespace app::classes::Moon::MoonProfilerSample {
    ...
    inline app::MoonProfilerSample operator+(app::MoonProfilerSample a, app::MoonProfilerSample b) { return op_Addition(a, b); }
    inline app::MoonProfilerSample operator/(app::MoonProfilerSample a, int32_t b) { return op_Division(a, b); }
} // namespace app::classes::Moon::MoonProfilerSample

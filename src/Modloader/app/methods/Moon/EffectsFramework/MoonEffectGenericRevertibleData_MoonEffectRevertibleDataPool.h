...
namespace app::classes::Moon::EffectsFramework::MoonEffectGenericRevertibleData_MoonEffectRevertibleDataPool {
    IL2CPP_REGISTER_METHOD(
        0x002FA280,
        app::Stack_1_Moon_EffectsFramework_MoonEffectGenericRevertibleData_MoonEffectRevertibleData_*,
        get_Instances,
        app::MoonEffectGenericRevertibleData_MoonEffectRevertibleDataPool* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x002FA490,
        void,
        set_Instances,
        app::MoonEffectGenericRevertibleData_MoonEffectRevertibleDataPool* this_ptr,
        app::Stack_1_Moon_EffectsFramework_MoonEffectGenericRevertibleData_MoonEffectRevertibleData_* value
    )

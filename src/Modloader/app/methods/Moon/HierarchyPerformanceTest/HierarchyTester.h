...
namespace app::classes::Moon::HierarchyPerformanceTest::HierarchyTester {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Scan_3,
        app::HierarchyTester* this_ptr,
        app::SceneRoot* scene,
        int32_t max_objects_to_scan,
        bool use_prepare_and_finish_tasks
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x014A7A90,
        void,
        AddObjectMeasureTaskRecursively,
        app::HierarchyTester* this_ptr,
        app::HierarchyDebugMenu_GameObjectItem* item,
        app::SceneSample* scene_sample,
        app::CompositeTask* root_task
    )

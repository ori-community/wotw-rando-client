...
namespace app::classes::LaserShieldRotationController {
    ...
    IL2CPP_REGISTER_METHOD(
        0x003FF7B0,
        app::LaserShieldRotationController_RotationType__Enum,
        get_CurrentRotationType,
        app::LaserShieldRotationController* this_ptr
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x00F0EF90,
        void,
        SpawnRepairingShieldPieceProjectile,
        app::LaserShieldRotationController* this_ptr,
        int32_t spawn_point_index,
        int32_t piece_index
    )
    IL2CPP_REGISTER_METHOD(
        0x00F0F150,
        void,
        SpawnAttackingShieldPieceProjectile,
        app::LaserShieldRotationController* this_ptr,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        SetRotationType,
        app::LaserShieldRotationController* this_ptr,
        app::LaserShieldRotationController_RotationType__Enum rotation_type
    )

...
#include <Modloader/app/structs/NativeArray_1_T_Enumerator_System_Single_.h>
#include <Modloader/app/structs/Object.h>
#include <Modloader/app/structs/Single__Array.h>

namespace app::classes::Unity::Collections::NativeArray_1_System_Single_ {
    IL2CPP_REGISTER_METHOD(
        0x001DF770,
        void,
        ctor,
        app::NativeArray_1_System_Single___Boxed* this_ptr,
        int32_t length,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Copy_5,
        app::Single__Array* src,
        int32_t src_index,
        app::NativeArray_1_System_Single_ dst,
        int32_t dst_index,
        int32_t length
    )
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Copy_6,
        app::NativeArray_1_System_Single_ src,
        int32_t src_index,
        app::Single__Array* dst,
        int32_t dst_index,
        int32_t length
    )
} // namespace app::classes::Unity::Collections::NativeArray_1_System_Single_

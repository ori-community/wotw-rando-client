...
namespace app::classes::Unity::Collections::NativeArray_1_UnityEngine_Color_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::NativeArray_1_UnityEngine_Color___Boxed* this_ptr,
        int32_t length,
    ...
    IL2CPP_REGISTER_METHOD(
        0x001DFB30,
        app::NativeArray_1_T_Enumerator_UnityEngine_Color_,
        GetEnumerator,
        app::NativeArray_1_UnityEngine_Color___Boxed* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Copy_5,
        app::Color__Array* src,
        int32_t src_index,
        app::NativeArray_1_UnityEngine_Color_ dst,
        int32_t dst_index,
        int32_t length
    )
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Copy_6,
        app::NativeArray_1_UnityEngine_Color_ src,
        int32_t src_index,
        app::Color__Array* dst,
        int32_t dst_index,
        int32_t length
    )
} // namespace app::classes::Unity::Collections::NativeArray_1_UnityEngine_Color_

...
namespace app::classes::Unity::Collections::NativeArray_1_UnityEngine_SpherecastCommand_ {
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        ctor,
        app::NativeArray_1_UnityEngine_SpherecastCommand___Boxed* this_ptr,
        int32_t length,
    ...
    IL2CPP_REGISTER_METHOD(
        0x001DFB30,
        app::NativeArray_1_T_Enumerator_UnityEngine_SpherecastCommand_,
        GetEnumerator,
        app::NativeArray_1_UnityEngine_SpherecastCommand___Boxed* this_ptr
    )
    IL2CPP_REGISTER_METHOD(
        0x001DFB90,
        app::IEnumerator_1_UnityEngine_SpherecastCommand_*,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        Equals_1,
        app::NativeArray_1_UnityEngine_SpherecastCommand___Boxed* this_ptr,
        app::NativeArray_1_UnityEngine_SpherecastCommand_ other
    )
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Copy_5,
        app::SpherecastCommand__Array* src,
        int32_t src_index,
        app::NativeArray_1_UnityEngine_SpherecastCommand_ dst,
        int32_t dst_index,
        int32_t length
    )
    IL2CPP_REGISTER_METHOD(
        ...
        void,
        Copy_6,
        app::NativeArray_1_UnityEngine_SpherecastCommand_ src,
        int32_t src_index,
        app::SpherecastCommand__Array* dst,
        int32_t dst_index,
        int32_t length
    )
} // namespace app::classes::Unity::Collections::NativeArray_1_UnityEngine_SpherecastCommand_

...
namespace app::classes::Unity::Jobs::LowLevel::Unsafe::JobsUtility {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::JobHandle,
        ScheduleParallelFor,
        app::JobsUtility_JobScheduleParameters* parameters,
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::JobsUtility_JobScheduleParameters* parameters,
        void* transfrom_accesss_array
    )
    IL2CPP_REGISTER_METHOD(
        0x02419720,
        void*,
        CreateJobReflectionData_1,
        app::Type* wrapper_job_type,
        app::Type* user_job_type,
        app::JobType__Enum job_type,
        app::Object* managed_job_function0,
        app::Object* managed_job_function1,
        app::Object* managed_job_function2
    )
    IL2CPP_REGISTER_METHOD(
        0x024197B0,
        void*,
        CreateJobReflectionData_2,
        app::Type* type,
        app::JobType__Enum job_type,
        app::Object* managed_job_function0,
        app::Object* managed_job_function1,

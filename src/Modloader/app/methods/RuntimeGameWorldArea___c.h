...
namespace app::classes::RuntimeGameWorldArea___c {
    ...
    IL2CPP_REGISTER_METHOD(
        0x0137A750,
        bool,
        _get_AreaDiscovered_b__21_0,
        app::RuntimeGameWorldArea_c* this_ptr,
        app::KeyValuePair_2_System_Int32_WorldMapAreaState_ s
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x0137A960,
        int32_t,
        _LogCollectableStates_b__35_3,
        app::RuntimeGameWorldArea_c* this_ptr,
        app::SerializedBooleanUberState* a,
        app::SerializedBooleanUberState* b
    )
    IL2CPP_REGISTER_METHOD(
        0x0137A960,
        int32_t,
        _LogCollectableStates_b__35_4,
        app::RuntimeGameWorldArea_c* this_ptr,
        app::SerializedBooleanUberState* a,
        app::SerializedBooleanUberState* b
    )
    ...
    IL2CPP_REGISTER_METHOD(
        0x0137AA60,
        int32_t,
        _LogCollectableStates_b__35_7,
        app::RuntimeGameWorldArea_c* this_ptr,
        app::RuntimeWorldMapIcon* a,
        app::RuntimeWorldMapIcon* b
    )
    IL2CPP_REGISTER_METHOD(
        0x0137AA60,
        int32_t,
        _LogCollectableStates_b__35_8,
        app::RuntimeGameWorldArea_c* this_ptr,
        app::RuntimeWorldMapIcon* a,
        app::RuntimeWorldMapIcon* b
    )

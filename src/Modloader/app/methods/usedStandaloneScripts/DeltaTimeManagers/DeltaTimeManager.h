...
namespace app::classes::usedStandaloneScripts::DeltaTimeManagers::DeltaTimeManager {
    ...
    IL2CPP_REGISTER_METHOD(
        ...
        app::DeltaTimeManager_InsertionMode__Enum insertion_mode,
    ...
    IL2CPP_REGISTER_METHOD(
        0x03124770,
        bool,
        GetHistoricFrameRange,
        app::DeltaTimeManager* this_ptr,
        int32_t offset,
        int32_t frame_count,
        app::DeltaTimeManager_DeltaTimeFrameHistory__Array** out_array
    )

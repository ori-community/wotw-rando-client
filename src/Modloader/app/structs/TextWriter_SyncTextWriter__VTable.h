...
#ifdef IL2CPP_STRUCT_TextWriter_SyncTextWriter__VTable_INITIALIZING
#elif defined(IL2CPP_STRUCTS_INITIALIZING)
#define IL2CPP_STRUCT_TextWriter_SyncTextWriter__VTable_INITIALIZING
#if !defined(IL2CPP_STRUCT_TextWriter_SyncTextWriter__VTable_DEFINED)
#define IL2CPP_STRUCT_TextWriter_SyncTextWriter__VTable_DEFINED
...
#endif
#if !defined(IL2CPP_STRUCT_TextWriter_SyncTextWriter__VTable_FWDDECL)
#define IL2CPP_STRUCT_TextWriter_SyncTextWriter__VTable_FWDDECL
#endif
#undef IL2CPP_STRUCT_TextWriter_SyncTextWriter__VTable_INITIALIZING
#if !defined(IL2CPP_STRUCT_TextWriter_SyncTextWriter__VTable_DEFINED) && !defined(IL2CPP_STRUCT_TextWriter_SyncTextWriter__VTable_FWDDECL)
#include <Modloader/app/structs/TextWriter_SyncTextWriter__VTable.h>
#endif
#else
namespace app {

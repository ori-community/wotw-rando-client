...
#ifdef IL2CPP_STRUCT_HDRPaperwhiteSlider__VTable_INITIALIZING
#elif defined(IL2CPP_STRUCTS_INITIALIZING)
#define IL2CPP_STRUCT_HDRPaperwhiteSlider__VTable_INITIALIZING
#if !defined(IL2CPP_STRUCT_HDRPaperwhiteSlider__VTable_DEFINED)
#define IL2CPP_STRUCT_HDRPaperwhiteSlider__VTable_DEFINED
...
#endif
#if !defined(IL2CPP_STRUCT_HDRPaperwhiteSlider__VTable_FWDDECL)
#define IL2CPP_STRUCT_HDRPaperwhiteSlider__VTable_FWDDECL
#endif
#undef IL2CPP_STRUCT_HDRPaperwhiteSlider__VTable_INITIALIZING
#if !defined(IL2CPP_STRUCT_HDRPaperwhiteSlider__VTable_DEFINED) && !defined(IL2CPP_STRUCT_HDRPaperwhiteSlider__VTable_FWDDECL)
#include <Modloader/app/structs/HDRPaperwhiteSlider__VTable.h>
#endif
#else
namespace app {

...
#ifdef IL2CPP_STRUCT_App__Fields_INITIALIZING
#elif defined(IL2CPP_STRUCTS_INITIALIZING)
#define IL2CPP_STRUCT_App__Fields_INITIALIZING
#if !defined(IL2CPP_STRUCT_App__Fields_DEFINED)
#define IL2CPP_STRUCT_App__Fields_DEFINED
struct String;
...
#endif
#if !defined(IL2CPP_STRUCT_App__Fields_FWDDECL)
#define IL2CPP_STRUCT_App__Fields_FWDDECL
#include <Modloader/app/structs/String.h>
#endif
#undef IL2CPP_STRUCT_App__Fields_INITIALIZING
#if !defined(IL2CPP_STRUCT_App__Fields_DEFINED) && !defined(IL2CPP_STRUCT_App__Fields_FWDDECL)

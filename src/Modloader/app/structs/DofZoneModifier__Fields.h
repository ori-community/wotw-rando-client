...
#ifdef IL2CPP_STRUCT_DofZoneModifier__Fields_INITIALIZING
#elif defined(IL2CPP_STRUCTS_INITIALIZING)
#define IL2CPP_STRUCT_DofZoneModifier__Fields_INITIALIZING
#if !defined(IL2CPP_STRUCT_DofZoneModifier__Fields_DEFINED)
#include <Modloader/app/structs/MonoBehaviour__Fields.h>
#if defined(IL2CPP_STRUCT_MonoBehaviour__Fields_DEFINED)
#define IL2CPP_STRUCT_DofZoneModifier__Fields_DEFINED
...
#endif
#endif
#if !defined(IL2CPP_STRUCT_DofZoneModifier__Fields_FWDDECL)
#define IL2CPP_STRUCT_DofZoneModifier__Fields_FWDDECL
#endif
#undef IL2CPP_STRUCT_DofZoneModifier__Fields_INITIALIZING
#if !defined(IL2CPP_STRUCT_DofZoneModifier__Fields_DEFINED) && !defined(IL2CPP_STRUCT_DofZoneModifier__Fields_FWDDECL)

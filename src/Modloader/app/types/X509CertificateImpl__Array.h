...
namespace app::classes::types {
    namespace X509CertificateImpl__Array {
        inline app::X509CertificateImpl__Array__Class** type_info() {
            static app::X509CertificateImpl__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::X509CertificateImpl__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

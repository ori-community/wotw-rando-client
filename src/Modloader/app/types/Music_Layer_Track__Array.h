...
namespace app::classes::types {
    namespace Music_Layer_Track__Array {
        inline app::Music_Layer_Track__Array__Class** type_info() {
            static app::Music_Layer_Track__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::Music_Layer_Track__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

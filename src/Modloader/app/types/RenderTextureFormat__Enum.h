...
namespace app::classes::types {
    namespace RenderTextureFormat__Enum {
        inline app::RenderTextureFormat__Enum__Class** type_info() {
            static app::RenderTextureFormat__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::RenderTextureFormat__Enum__Class**)(modloader::win::memory::resolve_rva(0x04711420));
            }
            return cache;
        }

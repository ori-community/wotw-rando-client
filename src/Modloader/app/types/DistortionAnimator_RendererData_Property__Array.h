...
#include <Modloader/app/structs/DistortionAnimator_RendererData_Property__Array__Class.h>
#include <Modloader/il2cpp_helpers.h>
#include <Modloader/macros.h>

namespace app::classes::types {
    namespace DistortionAnimator_RendererData_Property__Array {
        inline app::DistortionAnimator_RendererData_Property__Array__Class** type_info() {
            static app::DistortionAnimator_RendererData_Property__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::DistortionAnimator_RendererData_Property__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

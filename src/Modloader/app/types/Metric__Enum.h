...
namespace app::classes::types {
    namespace Metric__Enum {
        inline app::Metric__Enum__Class** type_info() {
            static app::Metric__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::Metric__Enum__Class**)(modloader::win::memory::resolve_rva(0x0477AD40));
            }
            return cache;
        }

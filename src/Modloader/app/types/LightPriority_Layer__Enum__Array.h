...
namespace app::classes::types {
    namespace LightPriority_Layer__Enum__Array {
        inline app::LightPriority_Layer__Enum__Array__Class** type_info() {
            static app::LightPriority_Layer__Enum__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::LightPriority_Layer__Enum__Array__Class**)(modloader::win::memory::resolve_rva(0x0474D818));
            }
            return cache;
        }

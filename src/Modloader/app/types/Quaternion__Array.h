...
namespace app::classes::types {
    namespace Quaternion__Array {
        inline app::Quaternion__Array__Class** type_info() {
            static app::Quaternion__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::Quaternion__Array__Class**)(modloader::win::memory::resolve_rva(0x04735AC0));
            }
            return cache;
        }

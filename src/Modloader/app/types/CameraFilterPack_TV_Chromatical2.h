...
namespace app::classes::types {
    namespace CameraFilterPack_TV_Chromatical2 {
        inline app::CameraFilterPack_TV_Chromatical2__Class** type_info() {
            static app::CameraFilterPack_TV_Chromatical2__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::CameraFilterPack_TV_Chromatical2__Class**)(modloader::win::memory::resolve_rva(0x04753340));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace SteamUGCDetails_t {
        inline app::SteamUGCDetails_t__Class** type_info() {
            static app::SteamUGCDetails_t__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SteamUGCDetails_t__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

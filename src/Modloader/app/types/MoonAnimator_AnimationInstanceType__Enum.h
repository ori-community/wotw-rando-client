...
namespace app::classes::types {
    namespace MoonAnimator_AnimationInstanceType__Enum {
        inline app::MoonAnimator_AnimationInstanceType__Enum__Class** type_info() {
            static app::MoonAnimator_AnimationInstanceType__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::MoonAnimator_AnimationInstanceType__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

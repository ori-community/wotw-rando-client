...
namespace app::classes::types {
    namespace SaveSlotsUI_c_DisplayClass76_0 {
        inline app::SaveSlotsUI_c_DisplayClass76_0__Class** type_info() {
            static app::SaveSlotsUI_c_DisplayClass76_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::SaveSlotsUI_c_DisplayClass76_0__Class**)(modloader::win::memory::resolve_rva(0x047757D8));
            }
            return cache;
        }

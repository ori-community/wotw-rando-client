...
namespace app::classes::types {
    namespace GameMapUI_HintsSettings {
        inline app::GameMapUI_HintsSettings__Class** type_info() {
            static app::GameMapUI_HintsSettings__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::GameMapUI_HintsSettings__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace ExplainUnzip_c {
        inline app::ExplainUnzip_c__Class** type_info() {
            static app::ExplainUnzip_c__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ExplainUnzip_c__Class**)(modloader::win::memory::resolve_rva(0x0476B580));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace SeinLockOnSpell_State__Enum {
        inline app::SeinLockOnSpell_State__Enum__Class** type_info() {
            static app::SeinLockOnSpell_State__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SeinLockOnSpell_State__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
#include <Modloader/app/structs/DepthOfFieldDeprecated_DofResolution__Enum__Class.h>
#include <Modloader/il2cpp_helpers.h>
#include <Modloader/macros.h>

namespace app::classes::types {
    namespace DepthOfFieldDeprecated_DofResolution__Enum {
        inline app::DepthOfFieldDeprecated_DofResolution__Enum__Class** type_info() {
            static app::DepthOfFieldDeprecated_DofResolution__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::DepthOfFieldDeprecated_DofResolution__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace P3D_TexturePreview {
        inline app::P3D_TexturePreview__Class** type_info() {
            static app::P3D_TexturePreview__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::P3D_TexturePreview__Class**)(modloader::win::memory::resolve_rva(0x04727B98));
            }
            return cache;
        }

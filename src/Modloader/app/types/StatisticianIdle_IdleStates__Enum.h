...
namespace app::classes::types {
    namespace StatisticianIdle_IdleStates__Enum {
        inline app::StatisticianIdle_IdleStates__Enum__Class** type_info() {
            static app::StatisticianIdle_IdleStates__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::StatisticianIdle_IdleStates__Enum__Class**)(modloader::win::memory::resolve_rva(0x047563A8));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace ItemInstance_1__Array {
        inline app::ItemInstance_1__Array__Class** type_info() {
            static app::ItemInstance_1__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::ItemInstance_1__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

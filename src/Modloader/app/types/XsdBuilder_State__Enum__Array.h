...
namespace app::classes::types {
    namespace XsdBuilder_State__Enum__Array {
        inline app::XsdBuilder_State__Enum__Array__Class** type_info() {
            static app::XsdBuilder_State__Enum__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::XsdBuilder_State__Enum__Array__Class**)(modloader::win::memory::resolve_rva(0x0471BD90));
            }
            return cache;
        }

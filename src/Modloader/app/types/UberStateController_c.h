...
namespace app::classes::types {
    namespace UberStateController_c {
        inline app::UberStateController_c__Class** type_info() {
            static app::UberStateController_c__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::UberStateController_c__Class**)(modloader::win::memory::resolve_rva(0x0478E478));
            }
            return cache;
        }

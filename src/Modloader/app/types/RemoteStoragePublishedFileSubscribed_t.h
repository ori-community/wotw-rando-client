...
#include <Modloader/app/structs/RemoteStoragePublishedFileSubscribed_t__Boxed.h>
...
namespace app::classes::types {
    namespace RemoteStoragePublishedFileSubscribed_t {
        inline app::RemoteStoragePublishedFileSubscribed_t__Class** type_info() {
            static app::RemoteStoragePublishedFileSubscribed_t__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::RemoteStoragePublishedFileSubscribed_t__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace Application_NvnBufferUsage__Enum__Array {
        inline app::Application_NvnBufferUsage__Enum__Array__Class** type_info() {
            static app::Application_NvnBufferUsage__Enum__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::Application_NvnBufferUsage__Enum__Array__Class**)(modloader::win::memory::resolve_rva(0x04781ED8));
            }
            return cache;
        }

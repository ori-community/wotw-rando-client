...
namespace app::classes::types {
    namespace HttpListenerContext__Array {
        inline app::HttpListenerContext__Array__Class** type_info() {
            static app::HttpListenerContext__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::HttpListenerContext__Array__Class**)(modloader::win::memory::resolve_rva(0x04709098));
            }
            return cache;
        }

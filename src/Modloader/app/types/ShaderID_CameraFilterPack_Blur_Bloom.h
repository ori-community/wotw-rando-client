...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_Blur_Bloom {
        inline app::ShaderID_CameraFilterPack_Blur_Bloom__Class** type_info() {
            static app::ShaderID_CameraFilterPack_Blur_Bloom__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ShaderID_CameraFilterPack_Blur_Bloom__Class**)(modloader::win::memory::resolve_rva(0x04705720));
            }
            return cache;
        }

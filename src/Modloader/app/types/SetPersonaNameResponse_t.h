...
namespace app::classes::types {
    namespace SetPersonaNameResponse_t {
        inline app::SetPersonaNameResponse_t__Class** type_info() {
            static app::SetPersonaNameResponse_t__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SetPersonaNameResponse_t__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

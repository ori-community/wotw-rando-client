...
namespace app::classes::types {
    namespace CameraFilterPack_Distortion_Dream {
        inline app::CameraFilterPack_Distortion_Dream__Class** type_info() {
            static app::CameraFilterPack_Distortion_Dream__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::CameraFilterPack_Distortion_Dream__Class**)(modloader::win::memory::resolve_rva(0x047681D8));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace PlayFabStatistics_c_DisplayClass14_1 {
        inline app::PlayFabStatistics_c_DisplayClass14_1__Class** type_info() {
            static app::PlayFabStatistics_c_DisplayClass14_1__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::PlayFabStatistics_c_DisplayClass14_1__Class**)(modloader::win::memory::resolve_rva(0x0473E378));
            }
            return cache;
        }

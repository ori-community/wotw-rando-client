...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_Blend2Camera_GreenScreen {
        inline app::ShaderID_CameraFilterPack_Blend2Camera_GreenScreen__Class** type_info() {
            static app::ShaderID_CameraFilterPack_Blend2Camera_GreenScreen__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ShaderID_CameraFilterPack_Blend2Camera_GreenScreen__Class**)(modloader::win::memory::resolve_rva(0x0478DE60));
            }
            return cache;
        }

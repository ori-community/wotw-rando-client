...
namespace app::classes::types {
    namespace CrossSceneReferenceId__Array {
        inline app::CrossSceneReferenceId__Array__Class** type_info() {
            static app::CrossSceneReferenceId__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::CrossSceneReferenceId__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

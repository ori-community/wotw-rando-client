...
#include <Modloader/app/structs/MoonReference_1_UnityEngine_GameObject___Array__Class.h>
#include <Modloader/il2cpp_helpers.h>
#include <Modloader/macros.h>

namespace app::classes::types {
    namespace MoonReference_1_UnityEngine_GameObject___Array {
        inline app::MoonReference_1_UnityEngine_GameObject___Array__Class** type_info() {
            static app::MoonReference_1_UnityEngine_GameObject___Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::MoonReference_1_UnityEngine_GameObject___Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace PetrifiedOwlBossLowFlightArena2Behaviour_AirState {
        inline app::PetrifiedOwlBossLowFlightArena2Behaviour_AirState__Class** type_info() {
            static app::PetrifiedOwlBossLowFlightArena2Behaviour_AirState__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::PetrifiedOwlBossLowFlightArena2Behaviour_AirState__Class**)(modloader::win::memory::resolve_rva(0x04737D60));
            }
            return cache;
        }

...
#include <Modloader/app/structs/CameraFilterPack_Colors_Adjust_PreFilters_filters__Enum__Class.h>
#include <Modloader/il2cpp_helpers.h>
#include <Modloader/macros.h>

namespace app::classes::types {
    namespace CameraFilterPack_Colors_Adjust_PreFilters_filters__Enum {
        inline app::CameraFilterPack_Colors_Adjust_PreFilters_filters__Enum__Class** type_info() {
            static app::CameraFilterPack_Colors_Adjust_PreFilters_filters__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::CameraFilterPack_Colors_Adjust_PreFilters_filters__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace GetContentDownloadUrlRequest_1 {
        inline app::GetContentDownloadUrlRequest_1__Class** type_info() {
            static app::GetContentDownloadUrlRequest_1__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::GetContentDownloadUrlRequest_1__Class**)(modloader::win::memory::resolve_rva(0x047894F0));
            }
            return cache;
        }

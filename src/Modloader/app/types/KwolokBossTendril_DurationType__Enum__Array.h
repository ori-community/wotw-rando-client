...
namespace app::classes::types {
    namespace KwolokBossTendril_DurationType__Enum__Array {
        inline app::KwolokBossTendril_DurationType__Enum__Array__Class** type_info() {
            static app::KwolokBossTendril_DurationType__Enum__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::KwolokBossTendril_DurationType__Enum__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace CameraFilterPack_FX_Glitch1 {
        inline app::CameraFilterPack_FX_Glitch1__Class** type_info() {
            static app::CameraFilterPack_FX_Glitch1__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::CameraFilterPack_FX_Glitch1__Class**)(modloader::win::memory::resolve_rva(0x047677D0));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace FieldMetadata__Array {
        inline app::FieldMetadata__Array__Class** type_info() {
            static app::FieldMetadata__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::FieldMetadata__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

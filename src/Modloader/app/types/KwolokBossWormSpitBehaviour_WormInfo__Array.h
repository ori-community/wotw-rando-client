...
namespace app::classes::types {
    namespace KwolokBossWormSpitBehaviour_WormInfo__Array {
        inline app::KwolokBossWormSpitBehaviour_WormInfo__Array__Class** type_info() {
            static app::KwolokBossWormSpitBehaviour_WormInfo__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::KwolokBossWormSpitBehaviour_WormInfo__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace SpeechError__Enum {
        inline app::SpeechError__Enum__Class** type_info() {
            static app::SpeechError__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::SpeechError__Enum__Class**)(modloader::win::memory::resolve_rva(0x0470C320));
            }
            return cache;
        }

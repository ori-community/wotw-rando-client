...
namespace app::classes::types {
    namespace SeinTurretSpell_State__Enum {
        inline app::SeinTurretSpell_State__Enum__Class** type_info() {
            static app::SeinTurretSpell_State__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SeinTurretSpell_State__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace SceneMetaData_SeinEquipmentWotW {
        inline app::SceneMetaData_SeinEquipmentWotW__Class** type_info() {
            static app::SceneMetaData_SeinEquipmentWotW__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::SceneMetaData_SeinEquipmentWotW__Class**)(modloader::win::memory::resolve_rva(0x0475C130));
            }
            return cache;
        }

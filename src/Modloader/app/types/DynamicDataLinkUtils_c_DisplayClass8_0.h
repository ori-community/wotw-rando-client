...
namespace app::classes::types {
    namespace DynamicDataLinkUtils_c_DisplayClass8_0 {
        inline app::DynamicDataLinkUtils_c_DisplayClass8_0__Class** type_info() {
            static app::DynamicDataLinkUtils_c_DisplayClass8_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::DynamicDataLinkUtils_c_DisplayClass8_0__Class**)(modloader::win::memory::resolve_rva(0x04723608));
            }
            return cache;
        }

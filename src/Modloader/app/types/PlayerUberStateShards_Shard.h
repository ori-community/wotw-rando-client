...
namespace app::classes::types {
    namespace PlayerUberStateShards_Shard {
        inline app::PlayerUberStateShards_Shard__Class** type_info() {
            static app::PlayerUberStateShards_Shard__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::PlayerUberStateShards_Shard__Class**)(modloader::win::memory::resolve_rva(0x0477E3C8));
            }
            return cache;
        }

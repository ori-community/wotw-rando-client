...
namespace app::classes::types {
    namespace TestWindow_State__Enum {
        inline app::TestWindow_State__Enum__Class** type_info() {
            static app::TestWindow_State__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::TestWindow_State__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

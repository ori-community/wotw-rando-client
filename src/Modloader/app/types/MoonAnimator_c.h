...
namespace app::classes::types {
    namespace MoonAnimator_c {
        inline app::MoonAnimator_c__Class** type_info() {
            static app::MoonAnimator_c__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::MoonAnimator_c__Class**)(modloader::win::memory::resolve_rva(0x04709928));
            }
            return cache;
        }

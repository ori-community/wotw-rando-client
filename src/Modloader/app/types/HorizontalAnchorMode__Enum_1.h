...
namespace app::classes::types {
    namespace HorizontalAnchorMode__Enum_1 {
        inline app::HorizontalAnchorMode__Enum_1__Class** type_info() {
            static app::HorizontalAnchorMode__Enum_1__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::HorizontalAnchorMode__Enum_1__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

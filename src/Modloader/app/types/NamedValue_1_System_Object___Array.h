...
namespace app::classes::types {
    namespace NamedValue_1_System_Object___Array {
        inline app::NamedValue_1_System_Object___Array__Class** type_info() {
            static app::NamedValue_1_System_Object___Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::NamedValue_1_System_Object___Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

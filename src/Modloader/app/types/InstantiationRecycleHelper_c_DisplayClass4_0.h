...
namespace app::classes::types {
    namespace InstantiationRecycleHelper_c_DisplayClass4_0 {
        inline app::InstantiationRecycleHelper_c_DisplayClass4_0__Class** type_info() {
            static app::InstantiationRecycleHelper_c_DisplayClass4_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::InstantiationRecycleHelper_c_DisplayClass4_0__Class**)(modloader::win::memory::resolve_rva(0x04789448));
            }
            return cache;
        }

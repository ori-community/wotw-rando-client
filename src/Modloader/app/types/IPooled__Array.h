...
namespace app::classes::types {
    namespace IPooled__Array {
        inline app::IPooled__Array__Class** type_info() {
            static app::IPooled__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::IPooled__Array__Class**)(modloader::win::memory::resolve_rva(0x04717A38));
            }
            return cache;
        }

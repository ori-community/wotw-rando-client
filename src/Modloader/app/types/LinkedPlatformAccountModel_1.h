...
namespace app::classes::types {
    namespace LinkedPlatformAccountModel_1 {
        inline app::LinkedPlatformAccountModel_1__Class** type_info() {
            static app::LinkedPlatformAccountModel_1__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::LinkedPlatformAccountModel_1__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

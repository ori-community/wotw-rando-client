...
namespace app::classes::types {
    namespace String__Array {
        inline app::String__Array__Class** type_info() {
            static app::String__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::String__Array__Class**)(modloader::win::memory::resolve_rva(0x0476D5A0));
            }
            return cache;
        }

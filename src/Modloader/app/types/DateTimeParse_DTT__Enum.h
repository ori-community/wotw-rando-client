...
namespace app::classes::types {
    namespace DateTimeParse_DTT__Enum {
        inline app::DateTimeParse_DTT__Enum__Class** type_info() {
            static app::DateTimeParse_DTT__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::DateTimeParse_DTT__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

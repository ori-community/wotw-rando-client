...
namespace app::classes::types {
    namespace RemoteStorageUpdateUserPublishedItemVoteResult_t {
        inline app::RemoteStorageUpdateUserPublishedItemVoteResult_t__Class** type_info() {
            static app::RemoteStorageUpdateUserPublishedItemVoteResult_t__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::RemoteStorageUpdateUserPublishedItemVoteResult_t__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

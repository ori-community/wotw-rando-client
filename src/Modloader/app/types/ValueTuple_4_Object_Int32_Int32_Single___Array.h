...
namespace app::classes::types {
    namespace ValueTuple_4_Object_Int32_Int32_Single___Array {
        inline app::ValueTuple_4_Object_Int32_Int32_Single___Array__Class** type_info() {
            static app::ValueTuple_4_Object_Int32_Int32_Single___Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::ValueTuple_4_Object_Int32_Int32_Single___Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

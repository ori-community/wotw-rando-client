...
namespace app::classes::types {
    namespace MoonTelemetryCharacterBaseEvent_SpiritShardData__Array {
        inline app::MoonTelemetryCharacterBaseEvent_SpiritShardData__Array__Class** type_info() {
            static app::MoonTelemetryCharacterBaseEvent_SpiritShardData__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::MoonTelemetryCharacterBaseEvent_SpiritShardData__Array__Class**)(modloader::win::memory::resolve_rva(0x0474EE68));
            }
            return cache;
        }

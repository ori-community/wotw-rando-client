...
namespace app::classes::types {
    namespace CharacterResult_1__Array {
        inline app::CharacterResult_1__Array__Class** type_info() {
            static app::CharacterResult_1__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::CharacterResult_1__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

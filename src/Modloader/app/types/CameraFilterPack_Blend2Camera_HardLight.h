...
namespace app::classes::types {
    namespace CameraFilterPack_Blend2Camera_HardLight {
        inline app::CameraFilterPack_Blend2Camera_HardLight__Class** type_info() {
            static app::CameraFilterPack_Blend2Camera_HardLight__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::CameraFilterPack_Blend2Camera_HardLight__Class**)(modloader::win::memory::resolve_rva(0x04785E08));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace Comparer_1 {
        inline app::Comparer_1__Class** type_info() {
            static app::Comparer_1__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::Comparer_1__Class**)(modloader::win::memory::resolve_rva(0x04788778));
            }
            return cache;
        }

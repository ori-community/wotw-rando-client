...
namespace app::classes::types {
    namespace PlayerLocation_1__Array {
        inline app::PlayerLocation_1__Array__Class** type_info() {
            static app::PlayerLocation_1__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::PlayerLocation_1__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace JointDriveMode__Enum {
        inline app::JointDriveMode__Enum__Class** type_info() {
            static app::JointDriveMode__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::JointDriveMode__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace CharacterPlatformMovement_c {
        inline app::CharacterPlatformMovement_c__Class** type_info() {
            static app::CharacterPlatformMovement_c__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::CharacterPlatformMovement_c__Class**)(modloader::win::memory::resolve_rva(0x0472CFE0));
            }
            return cache;
        }

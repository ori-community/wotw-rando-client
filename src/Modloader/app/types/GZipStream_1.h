...
namespace app::classes::types {
    namespace GZipStream_1 {
        inline app::GZipStream_1__Class** type_info() {
            static app::GZipStream_1__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::GZipStream_1__Class**)(modloader::win::memory::resolve_rva(0x0478E0B0));
            }
            return cache;
        }

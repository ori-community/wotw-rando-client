...
namespace app::classes::types {
    namespace NpcProjectItem__Array {
        inline app::NpcProjectItem__Array__Class** type_info() {
            static app::NpcProjectItem__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::NpcProjectItem__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

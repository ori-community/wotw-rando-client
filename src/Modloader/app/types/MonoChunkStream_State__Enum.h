...
namespace app::classes::types {
    namespace MonoChunkStream_State__Enum {
        inline app::MonoChunkStream_State__Enum__Class** type_info() {
            static app::MonoChunkStream_State__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::MonoChunkStream_State__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

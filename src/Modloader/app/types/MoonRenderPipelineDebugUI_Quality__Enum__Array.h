...
namespace app::classes::types {
    namespace MoonRenderPipelineDebugUI_Quality__Enum__Array {
        inline app::MoonRenderPipelineDebugUI_Quality__Enum__Array__Class** type_info() {
            static app::MoonRenderPipelineDebugUI_Quality__Enum__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::MoonRenderPipelineDebugUI_Quality__Enum__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace BuildRegion_1__Array {
        inline app::BuildRegion_1__Array__Class** type_info() {
            static app::BuildRegion_1__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::BuildRegion_1__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
#include <Modloader/app/structs/TimeSpanParse_TimeSpanStandardStyles__Enum__Class.h>
#include <Modloader/il2cpp_helpers.h>
#include <Modloader/macros.h>

namespace app::classes::types {
    namespace TimeSpanParse_TimeSpanStandardStyles__Enum {
        inline app::TimeSpanParse_TimeSpanStandardStyles__Enum__Class** type_info() {
            static app::TimeSpanParse_TimeSpanStandardStyles__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::TimeSpanParse_TimeSpanStandardStyles__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

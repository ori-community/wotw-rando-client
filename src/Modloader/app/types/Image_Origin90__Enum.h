...
namespace app::classes::types {
    namespace Image_Origin90__Enum {
        inline app::Image_Origin90__Enum__Class** type_info() {
            static app::Image_Origin90__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::Image_Origin90__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

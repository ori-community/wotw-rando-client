...
namespace app::classes::types {
    namespace Vertex__Array {
        inline app::Vertex__Array__Class** type_info() {
            static app::Vertex__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::Vertex__Array__Class**)(modloader::win::memory::resolve_rva(0x04772098));
            }
            return cache;
        }

...
#include <Modloader/app/structs/HiddenAreaMesh_t__Boxed.h>
...
namespace app::classes::types {
    namespace HiddenAreaMesh_t {
        inline app::HiddenAreaMesh_t__Class** type_info() {
            static app::HiddenAreaMesh_t__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::HiddenAreaMesh_t__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

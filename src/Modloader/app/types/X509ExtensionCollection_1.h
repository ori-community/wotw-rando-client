...
namespace app::classes::types {
    namespace X509ExtensionCollection_1 {
        inline app::X509ExtensionCollection_1__Class** type_info() {
            static app::X509ExtensionCollection_1__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::X509ExtensionCollection_1__Class**)(modloader::win::memory::resolve_rva(0x04763340));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace RailType__Enum__Array {
        inline app::RailType__Enum__Array__Class** type_info() {
            static app::RailType__Enum__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::RailType__Enum__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

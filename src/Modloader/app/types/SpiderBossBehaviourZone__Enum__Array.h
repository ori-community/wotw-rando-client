...
namespace app::classes::types {
    namespace SpiderBossBehaviourZone__Enum__Array {
        inline app::SpiderBossBehaviourZone__Enum__Array__Class** type_info() {
            static app::SpiderBossBehaviourZone__Enum__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SpiderBossBehaviourZone__Enum__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace XmlAttribute__Array {
        inline app::XmlAttribute__Array__Class** type_info() {
            static app::XmlAttribute__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::XmlAttribute__Array__Class**)(modloader::win::memory::resolve_rva(0x04790B70));
            }
            return cache;
        }

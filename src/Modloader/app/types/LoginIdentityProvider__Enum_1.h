...
namespace app::classes::types {
    namespace LoginIdentityProvider__Enum_1 {
        inline app::LoginIdentityProvider__Enum_1__Class** type_info() {
            static app::LoginIdentityProvider__Enum_1__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::LoginIdentityProvider__Enum_1__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

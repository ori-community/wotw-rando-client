...
namespace app::classes::types {
    namespace DownloadManager_c_DisplayClass7_0 {
        inline app::DownloadManager_c_DisplayClass7_0__Class** type_info() {
            static app::DownloadManager_c_DisplayClass7_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::DownloadManager_c_DisplayClass7_0__Class**)(modloader::win::memory::resolve_rva(0x04732C58));
            }
            return cache;
        }

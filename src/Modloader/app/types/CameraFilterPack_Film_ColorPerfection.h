...
namespace app::classes::types {
    namespace CameraFilterPack_Film_ColorPerfection {
        inline app::CameraFilterPack_Film_ColorPerfection__Class** type_info() {
            static app::CameraFilterPack_Film_ColorPerfection__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::CameraFilterPack_Film_ColorPerfection__Class**)(modloader::win::memory::resolve_rva(0x0474F9A0));
            }
            return cache;
        }

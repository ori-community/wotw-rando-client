...
namespace app::classes::types {
    namespace CameraFilterPack_Distortion_Aspiration {
        inline app::CameraFilterPack_Distortion_Aspiration__Class** type_info() {
            static app::CameraFilterPack_Distortion_Aspiration__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::CameraFilterPack_Distortion_Aspiration__Class**)(modloader::win::memory::resolve_rva(0x0471AAF0));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace _PrivateImplementationDetails_StaticArrayInitTypeSize_6 {
        inline app::_PrivateImplementationDetails_StaticArrayInitTypeSize_6__Class** type_info() {
            static app::_PrivateImplementationDetails_StaticArrayInitTypeSize_6__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::_PrivateImplementationDetails_StaticArrayInitTypeSize_6__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace DtdProcessing__Enum {
        inline app::DtdProcessing__Enum__Class** type_info() {
            static app::DtdProcessing__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::DtdProcessing__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

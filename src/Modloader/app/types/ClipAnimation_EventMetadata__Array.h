...
namespace app::classes::types {
    namespace ClipAnimation_EventMetadata__Array {
        inline app::ClipAnimation_EventMetadata__Array__Class** type_info() {
            static app::ClipAnimation_EventMetadata__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ClipAnimation_EventMetadata__Array__Class**)(modloader::win::memory::resolve_rva(0x04789958));
            }
            return cache;
        }

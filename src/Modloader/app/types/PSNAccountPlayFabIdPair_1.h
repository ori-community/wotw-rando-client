...
namespace app::classes::types {
    namespace PSNAccountPlayFabIdPair_1 {
        inline app::PSNAccountPlayFabIdPair_1__Class** type_info() {
            static app::PSNAccountPlayFabIdPair_1__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::PSNAccountPlayFabIdPair_1__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }
        ...
        inline app::PSNAccountPlayFabIdPair_1__Array* create_array(const std::vector<app::PSNAccountPlayFabIdPair_1*>& items) {
            return il2cpp::array_new<app::PSNAccountPlayFabIdPair_1__Array>(get_class(), items);
        }
    } // namespace PSNAccountPlayFabIdPair_1
} // namespace app::classes::types

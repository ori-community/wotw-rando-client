...
namespace app::classes::types {
    namespace DtdParser_UndeclaredNotation__Array {
        inline app::DtdParser_UndeclaredNotation__Array__Class** type_info() {
            static app::DtdParser_UndeclaredNotation__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::DtdParser_UndeclaredNotation__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace IsShardEquippedCondition {
        inline app::IsShardEquippedCondition__Class** type_info() {
            static app::IsShardEquippedCondition__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::IsShardEquippedCondition__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

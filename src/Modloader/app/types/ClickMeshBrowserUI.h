...
namespace app::classes::types {
    namespace ClickMeshBrowserUI {
        inline app::ClickMeshBrowserUI__Class** type_info() {
            static app::ClickMeshBrowserUI__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ClickMeshBrowserUI__Class**)(modloader::win::memory::resolve_rva(0x047903C0));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace AnimationCurveExtensions_TangentMode__Enum {
        inline app::AnimationCurveExtensions_TangentMode__Enum__Class** type_info() {
            static app::AnimationCurveExtensions_TangentMode__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::AnimationCurveExtensions_TangentMode__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace AnimationTester_Group {
        inline app::AnimationTester_Group__Class** type_info() {
            static app::AnimationTester_Group__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::AnimationTester_Group__Class**)(modloader::win::memory::resolve_rva(0x047719F8));
            }
            return cache;
        }

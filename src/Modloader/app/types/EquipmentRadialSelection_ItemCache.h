...
namespace app::classes::types {
    namespace EquipmentRadialSelection_ItemCache {
        inline app::EquipmentRadialSelection_ItemCache__Class** type_info() {
            static app::EquipmentRadialSelection_ItemCache__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::EquipmentRadialSelection_ItemCache__Class**)(modloader::win::memory::resolve_rva(0x0473C1E0));
            }
            return cache;
        }

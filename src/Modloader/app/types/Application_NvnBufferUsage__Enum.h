...
namespace app::classes::types {
    namespace Application_NvnBufferUsage__Enum {
        inline app::Application_NvnBufferUsage__Enum__Class** type_info() {
            static app::Application_NvnBufferUsage__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::Application_NvnBufferUsage__Enum__Class**)(modloader::win::memory::resolve_rva(0x047070E8));
            }
            return cache;
        }

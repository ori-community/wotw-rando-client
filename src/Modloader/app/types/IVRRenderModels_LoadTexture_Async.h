...
namespace app::classes::types {
    namespace IVRRenderModels_LoadTexture_Async {
        inline app::IVRRenderModels_LoadTexture_Async__Class** type_info() {
            static app::IVRRenderModels_LoadTexture_Async__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::IVRRenderModels_LoadTexture_Async__Class**)(modloader::win::memory::resolve_rva(0x04751168));
            }
            return cache;
        }

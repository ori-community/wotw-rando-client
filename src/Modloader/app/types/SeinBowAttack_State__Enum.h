...
namespace app::classes::types {
    namespace SeinBowAttack_State__Enum {
        inline app::SeinBowAttack_State__Enum__Class** type_info() {
            static app::SeinBowAttack_State__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SeinBowAttack_State__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace SnapTrapEntity_State__Enum {
        inline app::SnapTrapEntity_State__Enum__Class** type_info() {
            static app::SnapTrapEntity_State__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SnapTrapEntity_State__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

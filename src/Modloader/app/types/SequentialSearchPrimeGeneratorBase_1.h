...
namespace app::classes::types {
    namespace SequentialSearchPrimeGeneratorBase_1 {
        inline app::SequentialSearchPrimeGeneratorBase_1__Class** type_info() {
            static app::SequentialSearchPrimeGeneratorBase_1__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::SequentialSearchPrimeGeneratorBase_1__Class**)(modloader::win::memory::resolve_rva(0x047134F0));
            }
            return cache;
        }

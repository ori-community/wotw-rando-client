...
namespace app::classes::types {
    namespace DiscriminatedUnionConverter_c_DisplayClass8_0 {
        inline app::DiscriminatedUnionConverter_c_DisplayClass8_0__Class** type_info() {
            static app::DiscriminatedUnionConverter_c_DisplayClass8_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::DiscriminatedUnionConverter_c_DisplayClass8_0__Class**)(modloader::win::memory::resolve_rva(0x047538B8));
            }
            return cache;
        }

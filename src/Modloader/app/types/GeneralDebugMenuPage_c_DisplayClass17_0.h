...
namespace app::classes::types {
    namespace GeneralDebugMenuPage_c_DisplayClass17_0 {
        inline app::GeneralDebugMenuPage_c_DisplayClass17_0__Class** type_info() {
            static app::GeneralDebugMenuPage_c_DisplayClass17_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::GeneralDebugMenuPage_c_DisplayClass17_0__Class**)(modloader::win::memory::resolve_rva(0x04742E80));
            }
            return cache;
        }

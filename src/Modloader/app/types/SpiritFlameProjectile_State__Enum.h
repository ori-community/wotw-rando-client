...
namespace app::classes::types {
    namespace SpiritFlameProjectile_State__Enum {
        inline app::SpiritFlameProjectile_State__Enum__Class** type_info() {
            static app::SpiritFlameProjectile_State__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SpiritFlameProjectile_State__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

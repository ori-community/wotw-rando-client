...
namespace app::classes::types {
    namespace GameObject {
        inline app::GameObject__Class** type_info() {
            static app::GameObject__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::GameObject__Class**)(modloader::win::memory::resolve_rva(0x0472EF88));
            }
            return cache;
        }

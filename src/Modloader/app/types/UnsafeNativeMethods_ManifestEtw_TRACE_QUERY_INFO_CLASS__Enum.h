...
namespace app::classes::types {
    namespace UnsafeNativeMethods_ManifestEtw_TRACE_QUERY_INFO_CLASS__Enum {
        inline app::UnsafeNativeMethods_ManifestEtw_TRACE_QUERY_INFO_CLASS__Enum__Class** type_info() {
            static app::UnsafeNativeMethods_ManifestEtw_TRACE_QUERY_INFO_CLASS__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::UnsafeNativeMethods_ManifestEtw_TRACE_QUERY_INFO_CLASS__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

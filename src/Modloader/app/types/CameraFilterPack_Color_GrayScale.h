...
namespace app::classes::types {
    namespace CameraFilterPack_Color_GrayScale {
        inline app::CameraFilterPack_Color_GrayScale__Class** type_info() {
            static app::CameraFilterPack_Color_GrayScale__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::CameraFilterPack_Color_GrayScale__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace Ucs4Encoding1234 {
        inline app::Ucs4Encoding1234__Class** type_info() {
            static app::Ucs4Encoding1234__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::Ucs4Encoding1234__Class**)(modloader::win::memory::resolve_rva(0x04792B98));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace TypeDescriptionProviderAttribute {
        inline app::TypeDescriptionProviderAttribute__Class** type_info() {
            static app::TypeDescriptionProviderAttribute__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::TypeDescriptionProviderAttribute__Class**)(modloader::win::memory::resolve_rva(0x0474A740));
            }
            return cache;
        }

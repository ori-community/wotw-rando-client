...
namespace app::classes::types {
    namespace PetrifiedFog__Array {
        inline app::PetrifiedFog__Array__Class** type_info() {
            static app::PetrifiedFog__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::PetrifiedFog__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

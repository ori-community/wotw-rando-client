...
namespace app::classes::types {
    namespace AudioDataLoadState__Enum {
        inline app::AudioDataLoadState__Enum__Class** type_info() {
            static app::AudioDataLoadState__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::AudioDataLoadState__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

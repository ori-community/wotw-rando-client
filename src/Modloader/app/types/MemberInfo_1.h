...
namespace app::classes::types {
    namespace MemberInfo_1 {
        inline app::MemberInfo_1__Class** type_info() {
            static app::MemberInfo_1__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::MemberInfo_1__Class**)(modloader::win::memory::resolve_rva(0x047213C8));
            }
            return cache;
        }

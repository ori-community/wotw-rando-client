...
namespace app::classes::types {
    namespace CameraFilterPack_Distortion_Dissipation {
        inline app::CameraFilterPack_Distortion_Dissipation__Class** type_info() {
            static app::CameraFilterPack_Distortion_Dissipation__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::CameraFilterPack_Distortion_Dissipation__Class**)(modloader::win::memory::resolve_rva(0x04734278));
            }
            return cache;
        }

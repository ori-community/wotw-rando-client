...
namespace app::classes::types {
    namespace IVROverlay_SetOverlayAutoCurveDistanceRangeInMeters {
        inline app::IVROverlay_SetOverlayAutoCurveDistanceRangeInMeters__Class** type_info() {
            static app::IVROverlay_SetOverlayAutoCurveDistanceRangeInMeters__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::IVROverlay_SetOverlayAutoCurveDistanceRangeInMeters__Class**)(modloader::win::memory::resolve_rva(0x04784568));
            }
            return cache;
        }

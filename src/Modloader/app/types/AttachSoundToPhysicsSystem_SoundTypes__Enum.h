...
namespace app::classes::types {
    namespace AttachSoundToPhysicsSystem_SoundTypes__Enum {
        inline app::AttachSoundToPhysicsSystem_SoundTypes__Enum__Class** type_info() {
            static app::AttachSoundToPhysicsSystem_SoundTypes__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::AttachSoundToPhysicsSystem_SoundTypes__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

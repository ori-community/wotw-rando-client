...
namespace app::classes::types {
    namespace Byte__Array {
        inline app::Byte__Array__Class** type_info() {
            static app::Byte__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::Byte__Array__Class**)(modloader::win::memory::resolve_rva(0x04774D00));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace RegionIterator_c_DisplayClass3_0 {
        inline app::RegionIterator_c_DisplayClass3_0__Class** type_info() {
            static app::RegionIterator_c_DisplayClass3_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::RegionIterator_c_DisplayClass3_0__Class**)(modloader::win::memory::resolve_rva(0x04705320));
            }
            return cache;
        }

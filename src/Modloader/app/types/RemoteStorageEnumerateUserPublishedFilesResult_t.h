...
namespace app::classes::types {
    namespace RemoteStorageEnumerateUserPublishedFilesResult_t {
        inline app::RemoteStorageEnumerateUserPublishedFilesResult_t__Class** type_info() {
            static app::RemoteStorageEnumerateUserPublishedFilesResult_t__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::RemoteStorageEnumerateUserPublishedFilesResult_t__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

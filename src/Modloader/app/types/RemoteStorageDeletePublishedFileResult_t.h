...
namespace app::classes::types {
    namespace RemoteStorageDeletePublishedFileResult_t {
        inline app::RemoteStorageDeletePublishedFileResult_t__Class** type_info() {
            static app::RemoteStorageDeletePublishedFileResult_t__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::RemoteStorageDeletePublishedFileResult_t__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

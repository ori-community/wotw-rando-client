...
namespace app::classes::types {
    namespace NotEqualInstruction_NotEqualUInt32LiftedToNull {
        inline app::NotEqualInstruction_NotEqualUInt32LiftedToNull__Class** type_info() {
            static app::NotEqualInstruction_NotEqualUInt32LiftedToNull__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::NotEqualInstruction_NotEqualUInt32LiftedToNull__Class**)(modloader::win::memory::resolve_rva(0x04782670));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace SDK_XBL_c_DisplayClass69_0 {
        inline app::SDK_XBL_c_DisplayClass69_0__Class** type_info() {
            static app::SDK_XBL_c_DisplayClass69_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::SDK_XBL_c_DisplayClass69_0__Class**)(modloader::win::memory::resolve_rva(0x04755F00));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace LeaderboardRowUI__Array {
        inline app::LeaderboardRowUI__Array__Class** type_info() {
            static app::LeaderboardRowUI__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::LeaderboardRowUI__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace SuspensionManager_SuspensionTicket__Array {
        inline app::SuspensionManager_SuspensionTicket__Array__Class** type_info() {
            static app::SuspensionManager_SuspensionTicket__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SuspensionManager_SuspensionTicket__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

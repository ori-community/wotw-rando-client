...
namespace app::classes::types {
    namespace Object__Array {
        inline app::Object__Array__Class** type_info() {
            static app::Object__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::Object__Array__Class**)(modloader::win::memory::resolve_rva(0x0475A068));
            }
            return cache;
        }

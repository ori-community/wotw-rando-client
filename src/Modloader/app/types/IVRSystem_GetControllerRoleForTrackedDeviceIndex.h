...
namespace app::classes::types {
    namespace IVRSystem_GetControllerRoleForTrackedDeviceIndex {
        inline app::IVRSystem_GetControllerRoleForTrackedDeviceIndex__Class** type_info() {
            static app::IVRSystem_GetControllerRoleForTrackedDeviceIndex__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::IVRSystem_GetControllerRoleForTrackedDeviceIndex__Class**)(modloader::win::memory::resolve_rva(0x04760570));
            }
            return cache;
        }

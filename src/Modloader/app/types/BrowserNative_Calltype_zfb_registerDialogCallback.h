...
namespace app::classes::types {
    namespace BrowserNative_Calltype_zfb_registerDialogCallback {
        inline app::BrowserNative_Calltype_zfb_registerDialogCallback__Class** type_info() {
            static app::BrowserNative_Calltype_zfb_registerDialogCallback__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::BrowserNative_Calltype_zfb_registerDialogCallback__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

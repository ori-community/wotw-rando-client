...
namespace app::classes::types {
    namespace XboxOneController_Button__Enum__Array {
        inline app::XboxOneController_Button__Enum__Array__Class** type_info() {
            static app::XboxOneController_Button__Enum__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::XboxOneController_Button__Enum__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

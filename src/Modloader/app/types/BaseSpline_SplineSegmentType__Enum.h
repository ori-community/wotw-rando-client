...
namespace app::classes::types {
    namespace BaseSpline_SplineSegmentType__Enum {
        inline app::BaseSpline_SplineSegmentType__Enum__Class** type_info() {
            static app::BaseSpline_SplineSegmentType__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::BaseSpline_SplineSegmentType__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

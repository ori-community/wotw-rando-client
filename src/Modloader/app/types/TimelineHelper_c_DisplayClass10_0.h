...
namespace app::classes::types {
    namespace TimelineHelper_c_DisplayClass10_0 {
        inline app::TimelineHelper_c_DisplayClass10_0__Class** type_info() {
            static app::TimelineHelper_c_DisplayClass10_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::TimelineHelper_c_DisplayClass10_0__Class**)(modloader::win::memory::resolve_rva(0x04773110));
            }
            return cache;
        }

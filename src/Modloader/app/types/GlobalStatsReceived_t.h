...
namespace app::classes::types {
    namespace GlobalStatsReceived_t {
        inline app::GlobalStatsReceived_t__Class** type_info() {
            static app::GlobalStatsReceived_t__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::GlobalStatsReceived_t__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

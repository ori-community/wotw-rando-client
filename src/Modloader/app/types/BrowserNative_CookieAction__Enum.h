...
namespace app::classes::types {
    namespace BrowserNative_CookieAction__Enum {
        inline app::BrowserNative_CookieAction__Enum__Class** type_info() {
            static app::BrowserNative_CookieAction__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::BrowserNative_CookieAction__Enum__Class**)(modloader::win::memory::resolve_rva(0x0475FDA0));
            }
            return cache;
        }

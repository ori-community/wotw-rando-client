...
namespace app::classes::types {
    namespace GhostWorldObjectsLifetimePlugin_WorldRecordableEventsData_WorldObjectData {
        inline app::GhostWorldObjectsLifetimePlugin_WorldRecordableEventsData_WorldObjectData__Class** type_info() {
            static app::GhostWorldObjectsLifetimePlugin_WorldRecordableEventsData_WorldObjectData__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::GhostWorldObjectsLifetimePlugin_WorldRecordableEventsData_WorldObjectData__Class**)(modloader::win::memory::resolve_rva(0x047009F0));
            }
            return cache;
        }

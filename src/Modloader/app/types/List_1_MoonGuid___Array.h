...
namespace app::classes::types {
    namespace List_1_MoonGuid___Array {
        inline app::List_1_MoonGuid___Array__Class** type_info() {
            static app::List_1_MoonGuid___Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::List_1_MoonGuid___Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

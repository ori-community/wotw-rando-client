...
namespace app::classes::types {
    namespace CageStructureTool_c_DisplayClass108_0 {
        inline app::CageStructureTool_c_DisplayClass108_0__Class** type_info() {
            static app::CageStructureTool_c_DisplayClass108_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::CageStructureTool_c_DisplayClass108_0__Class**)(modloader::win::memory::resolve_rva(0x047738F8));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace UserOrigination__Enum_1 {
        inline app::UserOrigination__Enum_1__Class** type_info() {
            static app::UserOrigination__Enum_1__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::UserOrigination__Enum_1__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

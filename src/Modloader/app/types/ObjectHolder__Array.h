...
namespace app::classes::types {
    namespace ObjectHolder__Array {
        inline app::ObjectHolder__Array__Class** type_info() {
            static app::ObjectHolder__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ObjectHolder__Array__Class**)(modloader::win::memory::resolve_rva(0x0472BB20));
            }
            return cache;
        }

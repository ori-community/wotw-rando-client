...
#include <Modloader/app/structs/JsonSerializerInternalReader_PropertyPresence__Enum__Array__Class.h>
#include <Modloader/il2cpp_helpers.h>
#include <Modloader/macros.h>

namespace app::classes::types {
    namespace JsonSerializerInternalReader_PropertyPresence__Enum__Array {
        inline app::JsonSerializerInternalReader_PropertyPresence__Enum__Array__Class** type_info() {
            static app::JsonSerializerInternalReader_PropertyPresence__Enum__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::JsonSerializerInternalReader_PropertyPresence__Enum__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

#pragma once
#include <Modloader/app/structs/CameraFilterPack_Drawing_Paper3.h>
...
namespace app::classes::types {
    namespace CameraFilterPack_Drawing_Paper3 {
        inline app::CameraFilterPack_Drawing_Paper3__Class** type_info() {
            static app::CameraFilterPack_Drawing_Paper3__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::CameraFilterPack_Drawing_Paper3__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace VolumeEffectComponentFlags_c_DisplayClass7_0 {
        inline app::VolumeEffectComponentFlags_c_DisplayClass7_0__Class** type_info() {
            static app::VolumeEffectComponentFlags_c_DisplayClass7_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::VolumeEffectComponentFlags_c_DisplayClass7_0__Class**)(modloader::win::memory::resolve_rva(0x0471F648));
            }
            return cache;
        }

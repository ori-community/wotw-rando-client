...
namespace app::classes::types {
    namespace XboxLiveAccountPlayFabIdPair_1 {
        inline app::XboxLiveAccountPlayFabIdPair_1__Class** type_info() {
            static app::XboxLiveAccountPlayFabIdPair_1__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::XboxLiveAccountPlayFabIdPair_1__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

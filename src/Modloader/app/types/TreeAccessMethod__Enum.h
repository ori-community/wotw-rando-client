...
namespace app::classes::types {
    namespace TreeAccessMethod__Enum {
        inline app::TreeAccessMethod__Enum__Class** type_info() {
            static app::TreeAccessMethod__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::TreeAccessMethod__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

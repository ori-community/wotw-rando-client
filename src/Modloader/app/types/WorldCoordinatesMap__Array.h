...
namespace app::classes::types {
    namespace WorldCoordinatesMap__Array {
        inline app::WorldCoordinatesMap__Array__Class** type_info() {
            static app::WorldCoordinatesMap__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::WorldCoordinatesMap__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

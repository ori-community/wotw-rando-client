...
namespace app::classes::types {
    namespace SecurityProtocolType__Enum {
        inline app::SecurityProtocolType__Enum__Class** type_info() {
            static app::SecurityProtocolType__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SecurityProtocolType__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

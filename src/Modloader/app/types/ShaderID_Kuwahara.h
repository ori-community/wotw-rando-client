...
namespace app::classes::types {
    namespace ShaderID_Kuwahara {
        inline app::ShaderID_Kuwahara__Class** type_info() {
            static app::ShaderID_Kuwahara__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ShaderID_Kuwahara__Class**)(modloader::win::memory::resolve_rva(0x04733908));
            }
            return cache;
        }

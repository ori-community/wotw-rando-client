...
namespace app::classes::types {
    namespace ProfilingSettings_Setting__Array {
        inline app::ProfilingSettings_Setting__Array__Class** type_info() {
            static app::ProfilingSettings_Setting__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ProfilingSettings_Setting__Array__Class**)(modloader::win::memory::resolve_rva(0x0472C670));
            }
            return cache;
        }

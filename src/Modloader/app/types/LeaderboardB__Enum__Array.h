...
namespace app::classes::types {
    namespace LeaderboardB__Enum__Array {
        inline app::LeaderboardB__Enum__Array__Class** type_info() {
            static app::LeaderboardB__Enum__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::LeaderboardB__Enum__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace CharacterInventory_1__Array {
        inline app::CharacterInventory_1__Array__Class** type_info() {
            static app::CharacterInventory_1__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::CharacterInventory_1__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

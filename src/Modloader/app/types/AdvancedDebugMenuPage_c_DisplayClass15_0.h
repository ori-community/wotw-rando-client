...
namespace app::classes::types {
    namespace AdvancedDebugMenuPage_c_DisplayClass15_0 {
        inline app::AdvancedDebugMenuPage_c_DisplayClass15_0__Class** type_info() {
            static app::AdvancedDebugMenuPage_c_DisplayClass15_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::AdvancedDebugMenuPage_c_DisplayClass15_0__Class**)(modloader::win::memory::resolve_rva(0x0475FD48));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace EqualInstruction_EqualInt64LiftedToNull {
        inline app::EqualInstruction_EqualInt64LiftedToNull__Class** type_info() {
            static app::EqualInstruction_EqualInt64LiftedToNull__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::EqualInstruction_EqualInt64LiftedToNull__Class**)(modloader::win::memory::resolve_rva(0x04741800));
            }
            return cache;
        }

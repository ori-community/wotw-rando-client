...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_Drawing_Manga4 {
        inline app::ShaderID_CameraFilterPack_Drawing_Manga4__Class** type_info() {
            static app::ShaderID_CameraFilterPack_Drawing_Manga4__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ShaderID_CameraFilterPack_Drawing_Manga4__Class**)(modloader::win::memory::resolve_rva(0x047643D8));
            }
            return cache;
        }

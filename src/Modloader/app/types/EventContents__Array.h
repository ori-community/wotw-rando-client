...
namespace app::classes::types {
    namespace EventContents__Array {
        inline app::EventContents__Array__Class** type_info() {
            static app::EventContents__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::EventContents__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace SeinEvents {
        inline app::SeinEvents__Class** type_info() {
            static app::SeinEvents__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::SeinEvents__Class**)(modloader::win::memory::resolve_rva(0x047548F8));
            }
            return cache;
        }

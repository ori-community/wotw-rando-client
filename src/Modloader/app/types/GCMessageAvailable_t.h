...
namespace app::classes::types {
    namespace GCMessageAvailable_t {
        inline app::GCMessageAvailable_t__Class** type_info() {
            static app::GCMessageAvailable_t__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::GCMessageAvailable_t__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

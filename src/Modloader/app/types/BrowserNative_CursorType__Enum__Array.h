...
namespace app::classes::types {
    namespace BrowserNative_CursorType__Enum__Array {
        inline app::BrowserNative_CursorType__Enum__Array__Class** type_info() {
            static app::BrowserNative_CursorType__Enum__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::BrowserNative_CursorType__Enum__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

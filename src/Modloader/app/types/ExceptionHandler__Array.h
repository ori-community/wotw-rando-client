...
namespace app::classes::types {
    namespace ExceptionHandler__Array {
        inline app::ExceptionHandler__Array__Class** type_info() {
            static app::ExceptionHandler__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::ExceptionHandler__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace MessageAndStackTrace__Array {
        inline app::MessageAndStackTrace__Array__Class** type_info() {
            static app::MessageAndStackTrace__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::MessageAndStackTrace__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
#include <Modloader/app/structs/SteamInventoryStartPurchaseResult_t__Boxed.h>
...
namespace app::classes::types {
    namespace SteamInventoryStartPurchaseResult_t {
        inline app::SteamInventoryStartPurchaseResult_t__Class** type_info() {
            static app::SteamInventoryStartPurchaseResult_t__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SteamInventoryStartPurchaseResult_t__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

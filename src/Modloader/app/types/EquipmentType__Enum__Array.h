...
namespace app::classes::types {
    namespace EquipmentType__Enum__Array {
        inline app::EquipmentType__Enum__Array__Class** type_info() {
            static app::EquipmentType__Enum__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::EquipmentType__Enum__Array__Class**)(modloader::win::memory::resolve_rva(0x0472B500));
            }
            return cache;
        }

...
#include <Modloader/app/structs/MoonRenderPipelineAsset_ConfigurableOn__Enum__Class.h>
#include <Modloader/il2cpp_helpers.h>
#include <Modloader/macros.h>

namespace app::classes::types {
    namespace MoonRenderPipelineAsset_ConfigurableOn__Enum {
        inline app::MoonRenderPipelineAsset_ConfigurableOn__Enum__Class** type_info() {
            static app::MoonRenderPipelineAsset_ConfigurableOn__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::MoonRenderPipelineAsset_ConfigurableOn__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

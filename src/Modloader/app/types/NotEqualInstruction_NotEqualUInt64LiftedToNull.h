...
#include <Modloader/app/structs/NotEqualInstruction_NotEqualUInt64LiftedToNull__Class.h>
#include <Modloader/il2cpp_helpers.h>
#include <Modloader/macros.h>

namespace app::classes::types {
    namespace NotEqualInstruction_NotEqualUInt64LiftedToNull {
        inline app::NotEqualInstruction_NotEqualUInt64LiftedToNull__Class** type_info() {
            static app::NotEqualInstruction_NotEqualUInt64LiftedToNull__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::NotEqualInstruction_NotEqualUInt64LiftedToNull__Class**)(modloader::win::memory::resolve_rva(0x0472FB80));
            }
            return cache;
        }

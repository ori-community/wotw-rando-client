...
namespace app::classes::types {
    namespace X509RevocationFlag__Enum {
        inline app::X509RevocationFlag__Enum__Class** type_info() {
            static app::X509RevocationFlag__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::X509RevocationFlag__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

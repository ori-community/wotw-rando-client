...
namespace app::classes::types {
    namespace WriteStreamClosedEventArgs {
        inline app::WriteStreamClosedEventArgs__Class** type_info() {
            static app::WriteStreamClosedEventArgs__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::WriteStreamClosedEventArgs__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

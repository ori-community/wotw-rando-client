...
namespace app::classes::types {
    namespace Sensor_CanSeeCharacterHelper_State__Enum {
        inline app::Sensor_CanSeeCharacterHelper_State__Enum__Class** type_info() {
            static app::Sensor_CanSeeCharacterHelper_State__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::Sensor_CanSeeCharacterHelper_State__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

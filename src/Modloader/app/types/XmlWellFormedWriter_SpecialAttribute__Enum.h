...
namespace app::classes::types {
    namespace XmlWellFormedWriter_SpecialAttribute__Enum {
        inline app::XmlWellFormedWriter_SpecialAttribute__Enum__Class** type_info() {
            static app::XmlWellFormedWriter_SpecialAttribute__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::XmlWellFormedWriter_SpecialAttribute__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace Blend2DTriangleState {
        inline app::Blend2DTriangleState__Class** type_info() {
            static app::Blend2DTriangleState__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::Blend2DTriangleState__Class**)(modloader::win::memory::resolve_rva(0x047794C8));
            }
            return cache;
        }

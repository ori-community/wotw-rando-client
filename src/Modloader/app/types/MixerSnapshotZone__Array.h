...
namespace app::classes::types {
    namespace MixerSnapshotZone__Array {
        inline app::MixerSnapshotZone__Array__Class** type_info() {
            static app::MixerSnapshotZone__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::MixerSnapshotZone__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace Instruction__Array {
        inline app::Instruction__Array__Class** type_info() {
            static app::Instruction__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::Instruction__Array__Class**)(modloader::win::memory::resolve_rva(0x04799920));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace DepthOfField_BlurType__Enum {
        inline app::DepthOfField_BlurType__Enum__Class** type_info() {
            static app::DepthOfField_BlurType__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::DepthOfField_BlurType__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

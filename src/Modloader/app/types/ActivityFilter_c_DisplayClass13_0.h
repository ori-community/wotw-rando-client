...
namespace app::classes::types {
    namespace ActivityFilter_c_DisplayClass13_0 {
        inline app::ActivityFilter_c_DisplayClass13_0__Class** type_info() {
            static app::ActivityFilter_c_DisplayClass13_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ActivityFilter_c_DisplayClass13_0__Class**)(modloader::win::memory::resolve_rva(0x04792C18));
            }
            return cache;
        }

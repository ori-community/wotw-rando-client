...
namespace app::classes::types {
    namespace CompressionMode__Enum_1 {
        inline app::CompressionMode__Enum_1__Class** type_info() {
            static app::CompressionMode__Enum_1__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::CompressionMode__Enum_1__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

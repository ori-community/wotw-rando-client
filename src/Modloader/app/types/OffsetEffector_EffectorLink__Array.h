...
namespace app::classes::types {
    namespace OffsetEffector_EffectorLink__Array {
        inline app::OffsetEffector_EffectorLink__Array__Class** type_info() {
            static app::OffsetEffector_EffectorLink__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::OffsetEffector_EffectorLink__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace KeyValuePair_2_SpellInventory_Binding_EquipmentType___Array {
        inline app::KeyValuePair_2_SpellInventory_Binding_EquipmentType___Array__Class** type_info() {
            static app::KeyValuePair_2_SpellInventory_Binding_EquipmentType___Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::KeyValuePair_2_SpellInventory_Binding_EquipmentType___Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

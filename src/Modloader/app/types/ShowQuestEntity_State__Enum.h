...
namespace app::classes::types {
    namespace ShowQuestEntity_State__Enum {
        inline app::ShowQuestEntity_State__Enum__Class** type_info() {
            static app::ShowQuestEntity_State__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::ShowQuestEntity_State__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

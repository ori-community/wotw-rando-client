...
namespace app::classes::types {
    namespace UberShaderProperty_Color__Enum__Array {
        inline app::UberShaderProperty_Color__Enum__Array__Class** type_info() {
            static app::UberShaderProperty_Color__Enum__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::UberShaderProperty_Color__Enum__Array__Class**)(modloader::win::memory::resolve_rva(0x0475A080));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace GhostTimelineEventsPlugin {
        inline app::GhostTimelineEventsPlugin__Class** type_info() {
            static app::GhostTimelineEventsPlugin__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::GhostTimelineEventsPlugin__Class**)(modloader::win::memory::resolve_rva(0x04750EC0));
            }
            return cache;
        }

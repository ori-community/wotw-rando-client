...
namespace app::classes::types {
    namespace JsonContract_c_DisplayClass58_0 {
        inline app::JsonContract_c_DisplayClass58_0__Class** type_info() {
            static app::JsonContract_c_DisplayClass58_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::JsonContract_c_DisplayClass58_0__Class**)(modloader::win::memory::resolve_rva(0x04741738));
            }
            return cache;
        }

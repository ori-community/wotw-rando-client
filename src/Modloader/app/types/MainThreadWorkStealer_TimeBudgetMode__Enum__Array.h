...
namespace app::classes::types {
    namespace MainThreadWorkStealer_TimeBudgetMode__Enum__Array {
        inline app::MainThreadWorkStealer_TimeBudgetMode__Enum__Array__Class** type_info() {
            static app::MainThreadWorkStealer_TimeBudgetMode__Enum__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::MainThreadWorkStealer_TimeBudgetMode__Enum__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

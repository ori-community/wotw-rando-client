...
namespace app::classes::types {
    namespace Action_2_Steamworks_UserAchievementStored_t_Boolean___Array {
        inline app::Action_2_Steamworks_UserAchievementStored_t_Boolean___Array__Class** type_info() {
            static app::Action_2_Steamworks_UserAchievementStored_t_Boolean___Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::Action_2_Steamworks_UserAchievementStored_t_Boolean___Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

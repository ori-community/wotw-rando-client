...
namespace app::classes::types {
    namespace JsonSerializerInternalReader_CreatorPropertyContext__Array {
        inline app::JsonSerializerInternalReader_CreatorPropertyContext__Array__Class** type_info() {
            static app::JsonSerializerInternalReader_CreatorPropertyContext__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::JsonSerializerInternalReader_CreatorPropertyContext__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

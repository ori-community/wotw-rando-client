...
namespace app::classes::types {
    namespace SeinDamageReciever_c_DisplayClass58_1 {
        inline app::SeinDamageReciever_c_DisplayClass58_1__Class** type_info() {
            static app::SeinDamageReciever_c_DisplayClass58_1__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::SeinDamageReciever_c_DisplayClass58_1__Class**)(modloader::win::memory::resolve_rva(0x0474D648));
            }
            return cache;
        }

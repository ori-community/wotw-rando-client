...
namespace app::classes::types {
    namespace CCText_HorizontalAnchorMode__Enum {
        inline app::CCText_HorizontalAnchorMode__Enum__Class** type_info() {
            static app::CCText_HorizontalAnchorMode__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::CCText_HorizontalAnchorMode__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

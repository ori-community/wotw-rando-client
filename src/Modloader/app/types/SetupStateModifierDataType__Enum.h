...
namespace app::classes::types {
    namespace SetupStateModifierDataType__Enum {
        inline app::SetupStateModifierDataType__Enum__Class** type_info() {
            static app::SetupStateModifierDataType__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SetupStateModifierDataType__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

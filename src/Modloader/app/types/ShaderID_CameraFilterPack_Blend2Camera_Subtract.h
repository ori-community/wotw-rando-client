...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_Blend2Camera_Subtract {
        inline app::ShaderID_CameraFilterPack_Blend2Camera_Subtract__Class** type_info() {
            static app::ShaderID_CameraFilterPack_Blend2Camera_Subtract__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ShaderID_CameraFilterPack_Blend2Camera_Subtract__Class**)(modloader::win::memory::resolve_rva(0x04760E40));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace PropertyAccessor_1_System_Int16___Array {
        inline app::PropertyAccessor_1_System_Int16___Array__Class** type_info() {
            static app::PropertyAccessor_1_System_Int16___Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::PropertyAccessor_1_System_Int16___Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

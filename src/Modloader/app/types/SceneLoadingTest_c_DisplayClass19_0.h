...
namespace app::classes::types {
    namespace SceneLoadingTest_c_DisplayClass19_0 {
        inline app::SceneLoadingTest_c_DisplayClass19_0__Class** type_info() {
            static app::SceneLoadingTest_c_DisplayClass19_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::SceneLoadingTest_c_DisplayClass19_0__Class**)(modloader::win::memory::resolve_rva(0x04727C80));
            }
            return cache;
        }

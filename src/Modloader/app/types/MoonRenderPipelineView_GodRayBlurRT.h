...
namespace app::classes::types {
    namespace MoonRenderPipelineView_GodRayBlurRT {
        inline app::MoonRenderPipelineView_GodRayBlurRT__Class** type_info() {
            static app::MoonRenderPipelineView_GodRayBlurRT__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::MoonRenderPipelineView_GodRayBlurRT__Class**)(modloader::win::memory::resolve_rva(0x0471C458));
            }
            return cache;
        }

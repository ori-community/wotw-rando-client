...
namespace app::classes::types {
    namespace LightCanvas_c {
        inline app::LightCanvas_c__Class** type_info() {
            static app::LightCanvas_c__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::LightCanvas_c__Class**)(modloader::win::memory::resolve_rva(0x047140A8));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace SteamItemDetails_t__Array {
        inline app::SteamItemDetails_t__Array__Class** type_info() {
            static app::SteamItemDetails_t__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SteamItemDetails_t__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

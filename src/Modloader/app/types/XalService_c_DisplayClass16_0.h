...
namespace app::classes::types {
    namespace XalService_c_DisplayClass16_0 {
        inline app::XalService_c_DisplayClass16_0__Class** type_info() {
            static app::XalService_c_DisplayClass16_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::XalService_c_DisplayClass16_0__Class**)(modloader::win::memory::resolve_rva(0x04751BB8));
            }
            return cache;
        }

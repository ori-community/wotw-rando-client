...
namespace app::classes::types {
    namespace IMoonShadingZone__Array {
        inline app::IMoonShadingZone__Array__Class** type_info() {
            static app::IMoonShadingZone__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::IMoonShadingZone__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

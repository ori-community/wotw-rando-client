...
namespace app::classes::types {
    namespace SimpleScripting_c {
        inline app::SimpleScripting_c__Class** type_info() {
            static app::SimpleScripting_c__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::SimpleScripting_c__Class**)(modloader::win::memory::resolve_rva(0x0473E988));
            }
            return cache;
        }

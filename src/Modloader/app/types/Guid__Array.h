...
namespace app::classes::types {
    namespace Guid__Array {
        inline app::Guid__Array__Class** type_info() {
            static app::Guid__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::Guid__Array__Class**)(modloader::win::memory::resolve_rva(0x04713DD0));
            }
            return cache;
        }

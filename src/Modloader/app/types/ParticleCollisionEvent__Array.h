...
namespace app::classes::types {
    namespace ParticleCollisionEvent__Array {
        inline app::ParticleCollisionEvent__Array__Class** type_info() {
            static app::ParticleCollisionEvent__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::ParticleCollisionEvent__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

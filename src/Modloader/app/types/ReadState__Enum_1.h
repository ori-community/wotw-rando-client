...
namespace app::classes::types {
    namespace ReadState__Enum_1 {
        inline app::ReadState__Enum_1__Class** type_info() {
            static app::ReadState__Enum_1__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::ReadState__Enum_1__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

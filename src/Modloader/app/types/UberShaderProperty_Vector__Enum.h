...
namespace app::classes::types {
    namespace UberShaderProperty_Vector__Enum {
        inline app::UberShaderProperty_Vector__Enum__Class** type_info() {
            static app::UberShaderProperty_Vector__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::UberShaderProperty_Vector__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }
        ...
        inline app::UberShaderProperty_Vector__Enum__Array* create_array(const std::vector<app::UberShaderProperty_Vector__Enum*>& items) {

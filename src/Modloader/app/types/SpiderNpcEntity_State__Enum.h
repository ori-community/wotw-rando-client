...
namespace app::classes::types {
    namespace SpiderNpcEntity_State__Enum {
        inline app::SpiderNpcEntity_State__Enum__Class** type_info() {
            static app::SpiderNpcEntity_State__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SpiderNpcEntity_State__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

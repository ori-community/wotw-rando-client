...
namespace app::classes::types {
    namespace MoonAnimator_DirectBlendInstance__Array {
        inline app::MoonAnimator_DirectBlendInstance__Array__Class** type_info() {
            static app::MoonAnimator_DirectBlendInstance__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::MoonAnimator_DirectBlendInstance__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace NotEqualInstruction_NotEqualUInt32 {
        inline app::NotEqualInstruction_NotEqualUInt32__Class** type_info() {
            static app::NotEqualInstruction_NotEqualUInt32__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::NotEqualInstruction_NotEqualUInt32__Class**)(modloader::win::memory::resolve_rva(0x04772E00));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace LayeredRenderSettings_LayerParams {
        inline app::LayeredRenderSettings_LayerParams__Class** type_info() {
            static app::LayeredRenderSettings_LayerParams__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::LayeredRenderSettings_LayerParams__Class**)(modloader::win::memory::resolve_rva(0x0476A108));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace LegacyBabySandWorm__Array {
        inline app::LegacyBabySandWorm__Array__Class** type_info() {
            static app::LegacyBabySandWorm__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::LegacyBabySandWorm__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace WebClient_c_DisplayClass241_0 {
        inline app::WebClient_c_DisplayClass241_0__Class** type_info() {
            static app::WebClient_c_DisplayClass241_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::WebClient_c_DisplayClass241_0__Class**)(modloader::win::memory::resolve_rva(0x04716A80));
            }
            return cache;
        }

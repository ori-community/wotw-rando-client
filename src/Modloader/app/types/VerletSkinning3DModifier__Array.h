...
namespace app::classes::types {
    namespace VerletSkinning3DModifier__Array {
        inline app::VerletSkinning3DModifier__Array__Class** type_info() {
            static app::VerletSkinning3DModifier__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::VerletSkinning3DModifier__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace ValidateIOSReceiptRequest {
        inline app::ValidateIOSReceiptRequest__Class** type_info() {
            static app::ValidateIOSReceiptRequest__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ValidateIOSReceiptRequest__Class**)(modloader::win::memory::resolve_rva(0x04742418));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace Stream_SynchronousAsyncResult_c {
        inline app::Stream_SynchronousAsyncResult_c__Class** type_info() {
            static app::Stream_SynchronousAsyncResult_c__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::Stream_SynchronousAsyncResult_c__Class**)(modloader::win::memory::resolve_rva(0x04796920));
            }
            return cache;
        }

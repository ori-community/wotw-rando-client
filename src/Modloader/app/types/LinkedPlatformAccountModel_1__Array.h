...
namespace app::classes::types {
    namespace LinkedPlatformAccountModel_1__Array {
        inline app::LinkedPlatformAccountModel_1__Array__Class** type_info() {
            static app::LinkedPlatformAccountModel_1__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::LinkedPlatformAccountModel_1__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

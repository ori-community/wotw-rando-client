...
namespace app::classes::types {
    namespace CameraFilterPack_OldFilm_Cutting2 {
        inline app::CameraFilterPack_OldFilm_Cutting2__Class** type_info() {
            static app::CameraFilterPack_OldFilm_Cutting2__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::CameraFilterPack_OldFilm_Cutting2__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

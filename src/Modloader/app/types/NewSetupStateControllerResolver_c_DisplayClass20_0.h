...
namespace app::classes::types {
    namespace NewSetupStateControllerResolver_c_DisplayClass20_0 {
        inline app::NewSetupStateControllerResolver_c_DisplayClass20_0__Class** type_info() {
            static app::NewSetupStateControllerResolver_c_DisplayClass20_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::NewSetupStateControllerResolver_c_DisplayClass20_0__Class**)(modloader::win::memory::resolve_rva(0x047468B8));
            }
            return cache;
        }

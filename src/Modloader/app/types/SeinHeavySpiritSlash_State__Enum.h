...
namespace app::classes::types {
    namespace SeinHeavySpiritSlash_State__Enum {
        inline app::SeinHeavySpiritSlash_State__Enum__Class** type_info() {
            static app::SeinHeavySpiritSlash_State__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SeinHeavySpiritSlash_State__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace XalAchievements_c_DisplayClass26_0 {
        inline app::XalAchievements_c_DisplayClass26_0__Class** type_info() {
            static app::XalAchievements_c_DisplayClass26_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::XalAchievements_c_DisplayClass26_0__Class**)(modloader::win::memory::resolve_rva(0x0470B288));
            }
            return cache;
        }

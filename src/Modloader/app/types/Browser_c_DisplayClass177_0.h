...
namespace app::classes::types {
    namespace Browser_c_DisplayClass177_0 {
        inline app::Browser_c_DisplayClass177_0__Class** type_info() {
            static app::Browser_c_DisplayClass177_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::Browser_c_DisplayClass177_0__Class**)(modloader::win::memory::resolve_rva(0x0474A8F0));
            }
            return cache;
        }

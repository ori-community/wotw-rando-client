...
namespace app::classes::types {
    namespace VelocityBezierSpline_VelocityBezierSplineSegment__Array {
        inline app::VelocityBezierSpline_VelocityBezierSplineSegment__Array__Class** type_info() {
            static app::VelocityBezierSpline_VelocityBezierSplineSegment__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::VelocityBezierSpline_VelocityBezierSplineSegment__Array__Class**)(modloader::win::memory::resolve_rva(0x0473FF10));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace Vitals_DamageProcessHelper_SortedDamageEntry {
        inline app::Vitals_DamageProcessHelper_SortedDamageEntry__Class** type_info() {
            static app::Vitals_DamageProcessHelper_SortedDamageEntry__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::Vitals_DamageProcessHelper_SortedDamageEntry__Class**)(modloader::win::memory::resolve_rva(0x04788440));
            }
            return cache;
        }

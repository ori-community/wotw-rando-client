...
namespace app::classes::types {
    namespace BuildRegion__Array {
        inline app::BuildRegion__Array__Class** type_info() {
            static app::BuildRegion__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::BuildRegion__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

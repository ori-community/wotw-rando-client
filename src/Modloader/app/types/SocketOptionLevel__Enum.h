...
namespace app::classes::types {
    namespace SocketOptionLevel__Enum {
        inline app::SocketOptionLevel__Enum__Class** type_info() {
            static app::SocketOptionLevel__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SocketOptionLevel__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

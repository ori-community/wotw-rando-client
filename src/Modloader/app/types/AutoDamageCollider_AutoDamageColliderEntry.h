...
namespace app::classes::types {
    namespace AutoDamageCollider_AutoDamageColliderEntry {
        inline app::AutoDamageCollider_AutoDamageColliderEntry__Class** type_info() {
            static app::AutoDamageCollider_AutoDamageColliderEntry__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::AutoDamageCollider_AutoDamageColliderEntry__Class**)(modloader::win::memory::resolve_rva(0x04790E50));
            }
            return cache;
        }

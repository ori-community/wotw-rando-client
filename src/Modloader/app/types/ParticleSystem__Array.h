...
namespace app::classes::types {
    namespace ParticleSystem__Array {
        inline app::ParticleSystem__Array__Class** type_info() {
            static app::ParticleSystem__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ParticleSystem__Array__Class**)(modloader::win::memory::resolve_rva(0x04752998));
            }
            return cache;
        }

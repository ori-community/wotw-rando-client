...
namespace app::classes::types {
    namespace X509Certificate_2 {
        inline app::X509Certificate_2__Class** type_info() {
            static app::X509Certificate_2__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::X509Certificate_2__Class**)(modloader::win::memory::resolve_rva(0x0474EEE8));
            }
            return cache;
        }

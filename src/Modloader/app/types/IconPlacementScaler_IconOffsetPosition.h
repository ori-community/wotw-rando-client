...
namespace app::classes::types {
    namespace IconPlacementScaler_IconOffsetPosition {
        inline app::IconPlacementScaler_IconOffsetPosition__Class** type_info() {
            static app::IconPlacementScaler_IconOffsetPosition__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::IconPlacementScaler_IconOffsetPosition__Class**)(modloader::win::memory::resolve_rva(0x0477B760));
            }
            return cache;
        }

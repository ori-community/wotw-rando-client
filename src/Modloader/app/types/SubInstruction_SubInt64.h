...
namespace app::classes::types {
    namespace SubInstruction_SubInt64 {
        inline app::SubInstruction_SubInt64__Class** type_info() {
            static app::SubInstruction_SubInt64__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::SubInstruction_SubInt64__Class**)(modloader::win::memory::resolve_rva(0x04744FF0));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace ProfilingSettings_SettingType__Enum {
        inline app::ProfilingSettings_SettingType__Enum__Class** type_info() {
            static app::ProfilingSettings_SettingType__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ProfilingSettings_SettingType__Enum__Class**)(modloader::win::memory::resolve_rva(0x0476B178));
            }
            return cache;
        }

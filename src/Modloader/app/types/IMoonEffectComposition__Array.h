...
namespace app::classes::types {
    namespace IMoonEffectComposition__Array {
        inline app::IMoonEffectComposition__Array__Class** type_info() {
            static app::IMoonEffectComposition__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::IMoonEffectComposition__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

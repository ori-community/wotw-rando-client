...
namespace app::classes::types {
    namespace CommandBuffer__Array {
        inline app::CommandBuffer__Array__Class** type_info() {
            static app::CommandBuffer__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::CommandBuffer__Array__Class**)(modloader::win::memory::resolve_rva(0x04703540));
            }
            return cache;
        }

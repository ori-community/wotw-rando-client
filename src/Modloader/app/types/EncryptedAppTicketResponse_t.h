...
namespace app::classes::types {
    namespace EncryptedAppTicketResponse_t {
        inline app::EncryptedAppTicketResponse_t__Class** type_info() {
            static app::EncryptedAppTicketResponse_t__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::EncryptedAppTicketResponse_t__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

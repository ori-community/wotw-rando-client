...
namespace app::classes::types {
    namespace IVROverlay_CreateDashboardOverlay {
        inline app::IVROverlay_CreateDashboardOverlay__Class** type_info() {
            static app::IVROverlay_CreateDashboardOverlay__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::IVROverlay_CreateDashboardOverlay__Class**)(modloader::win::memory::resolve_rva(0x04758140));
            }
            return cache;
        }

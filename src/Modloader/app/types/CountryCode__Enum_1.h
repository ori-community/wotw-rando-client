...
namespace app::classes::types {
    namespace CountryCode__Enum_1 {
        inline app::CountryCode__Enum_1__Class** type_info() {
            static app::CountryCode__Enum_1__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::CountryCode__Enum_1__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

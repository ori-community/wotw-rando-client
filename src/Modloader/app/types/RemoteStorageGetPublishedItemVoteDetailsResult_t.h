...
namespace app::classes::types {
    namespace RemoteStorageGetPublishedItemVoteDetailsResult_t {
        inline app::RemoteStorageGetPublishedItemVoteDetailsResult_t__Class** type_info() {
            static app::RemoteStorageGetPublishedItemVoteDetailsResult_t__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::RemoteStorageGetPublishedItemVoteDetailsResult_t__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

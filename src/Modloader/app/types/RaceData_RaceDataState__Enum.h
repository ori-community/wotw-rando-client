...
namespace app::classes::types {
    namespace RaceData_RaceDataState__Enum {
        inline app::RaceData_RaceDataState__Enum__Class** type_info() {
            static app::RaceData_RaceDataState__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::RaceData_RaceDataState__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

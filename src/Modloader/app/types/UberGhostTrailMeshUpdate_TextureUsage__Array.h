...
#include <Modloader/app/structs/UberGhostTrailMeshUpdate_TextureUsage__Array__Class.h>
#include <Modloader/il2cpp_helpers.h>
#include <Modloader/macros.h>

namespace app::classes::types {
    namespace UberGhostTrailMeshUpdate_TextureUsage__Array {
        inline app::UberGhostTrailMeshUpdate_TextureUsage__Array__Class** type_info() {
            static app::UberGhostTrailMeshUpdate_TextureUsage__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::UberGhostTrailMeshUpdate_TextureUsage__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

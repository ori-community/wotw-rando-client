...
#include <Modloader/app/structs/GameConnectedFriendChatMsg_t__Boxed.h>
...
namespace app::classes::types {
    namespace GameConnectedFriendChatMsg_t {
        inline app::GameConnectedFriendChatMsg_t__Class** type_info() {
            static app::GameConnectedFriendChatMsg_t__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::GameConnectedFriendChatMsg_t__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

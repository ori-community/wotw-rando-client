...
namespace app::classes::types {
    namespace MoonTelemetry_State__Enum {
        inline app::MoonTelemetry_State__Enum__Class** type_info() {
            static app::MoonTelemetry_State__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::MoonTelemetry_State__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

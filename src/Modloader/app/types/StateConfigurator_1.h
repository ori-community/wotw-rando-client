...
namespace app::classes::types {
    namespace StateConfigurator_1 {
        inline app::StateConfigurator_1__Class** type_info() {
            static app::StateConfigurator_1__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::StateConfigurator_1__Class**)(modloader::win::memory::resolve_rva(0x0470A0E0));
            }
            return cache;
        }

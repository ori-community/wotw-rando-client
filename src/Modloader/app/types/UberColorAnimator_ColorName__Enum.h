...
namespace app::classes::types {
    namespace UberColorAnimator_ColorName__Enum {
        inline app::UberColorAnimator_ColorName__Enum__Class** type_info() {
            static app::UberColorAnimator_ColorName__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::UberColorAnimator_ColorName__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

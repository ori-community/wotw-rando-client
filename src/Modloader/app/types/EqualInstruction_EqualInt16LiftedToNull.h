...
namespace app::classes::types {
    namespace EqualInstruction_EqualInt16LiftedToNull {
        inline app::EqualInstruction_EqualInt16LiftedToNull__Class** type_info() {
            static app::EqualInstruction_EqualInt16LiftedToNull__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::EqualInstruction_EqualInt16LiftedToNull__Class**)(modloader::win::memory::resolve_rva(0x047774D8));
            }
            return cache;
        }

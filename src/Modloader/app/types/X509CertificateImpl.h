...
namespace app::classes::types {
    namespace X509CertificateImpl {
        inline app::X509CertificateImpl__Class** type_info() {
            static app::X509CertificateImpl__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::X509CertificateImpl__Class**)(modloader::win::memory::resolve_rva(0x0478E458));
            }
            return cache;
        }

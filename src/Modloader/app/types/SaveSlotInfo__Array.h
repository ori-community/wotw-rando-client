...
namespace app::classes::types {
    namespace SaveSlotInfo__Array {
        inline app::SaveSlotInfo__Array__Class** type_info() {
            static app::SaveSlotInfo__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SaveSlotInfo__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_TV_WideScreenVertical {
        inline app::ShaderID_CameraFilterPack_TV_WideScreenVertical__Class** type_info() {
            static app::ShaderID_CameraFilterPack_TV_WideScreenVertical__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ShaderID_CameraFilterPack_TV_WideScreenVertical__Class**)(modloader::win::memory::resolve_rva(0x0476D520));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace XboxOneRichPresence_RichPresence__Enum {
        inline app::XboxOneRichPresence_RichPresence__Enum__Class** type_info() {
            static app::XboxOneRichPresence_RichPresence__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::XboxOneRichPresence_RichPresence__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

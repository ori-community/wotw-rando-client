...
namespace app::classes::types {
    namespace RBTree_1_K_TreePage_System_Int32___Array {
        inline app::RBTree_1_K_TreePage_System_Int32___Array__Class** type_info() {
            static app::RBTree_1_K_TreePage_System_Int32___Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::RBTree_1_K_TreePage_System_Int32___Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace GSPolicyResponse_t {
        inline app::GSPolicyResponse_t__Class** type_info() {
            static app::GSPolicyResponse_t__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::GSPolicyResponse_t__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace Task_c_DisplayClass178_0 {
        inline app::Task_c_DisplayClass178_0__Class** type_info() {
            static app::Task_c_DisplayClass178_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::Task_c_DisplayClass178_0__Class**)(modloader::win::memory::resolve_rva(0x0470D0C0));
            }
            return cache;
        }

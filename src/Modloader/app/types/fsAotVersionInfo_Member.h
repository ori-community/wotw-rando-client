...
namespace app::classes::types {
    namespace fsAotVersionInfo_Member {
        inline app::fsAotVersionInfo_Member__Class** type_info() {
            static app::fsAotVersionInfo_Member__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::fsAotVersionInfo_Member__Class**)(modloader::win::memory::resolve_rva(0x04716148));
            }
            return cache;
        }

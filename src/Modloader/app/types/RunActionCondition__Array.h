...
namespace app::classes::types {
    namespace RunActionCondition__Array {
        inline app::RunActionCondition__Array__Class** type_info() {
            static app::RunActionCondition__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::RunActionCondition__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

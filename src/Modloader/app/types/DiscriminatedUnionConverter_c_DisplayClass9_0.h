...
#include <Modloader/app/structs/DiscriminatedUnionConverter_c_DisplayClass9_0__Class.h>
#include <Modloader/il2cpp_helpers.h>
#include <Modloader/macros.h>

namespace app::classes::types {
    namespace DiscriminatedUnionConverter_c_DisplayClass9_0 {
        inline app::DiscriminatedUnionConverter_c_DisplayClass9_0__Class** type_info() {
            static app::DiscriminatedUnionConverter_c_DisplayClass9_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::DiscriminatedUnionConverter_c_DisplayClass9_0__Class**)(modloader::win::memory::resolve_rva(0x04747DF0));
            }
            return cache;
        }

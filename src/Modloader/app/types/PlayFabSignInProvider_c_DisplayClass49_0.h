...
namespace app::classes::types {
    namespace PlayFabSignInProvider_c_DisplayClass49_0 {
        inline app::PlayFabSignInProvider_c_DisplayClass49_0__Class** type_info() {
            static app::PlayFabSignInProvider_c_DisplayClass49_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::PlayFabSignInProvider_c_DisplayClass49_0__Class**)(modloader::win::memory::resolve_rva(0x04788600));
            }
            return cache;
        }

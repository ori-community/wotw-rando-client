...
namespace app::classes::types {
    namespace ReflectionUtils_GetDelegate {
        inline app::ReflectionUtils_GetDelegate__Class** type_info() {
            static app::ReflectionUtils_GetDelegate__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ReflectionUtils_GetDelegate__Class**)(modloader::win::memory::resolve_rva(0x04774DB8));
            }
            return cache;
        }

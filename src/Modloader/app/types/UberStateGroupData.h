...
namespace app::classes::types {
    namespace UberStateGroupData {
        inline app::UberStateGroupData__Class** type_info() {
            static app::UberStateGroupData__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::UberStateGroupData__Class**)(modloader::win::memory::resolve_rva(0x0477B010));
            }
            return cache;
        }

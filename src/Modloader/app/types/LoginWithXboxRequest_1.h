...
namespace app::classes::types {
    namespace LoginWithXboxRequest_1 {
        inline app::LoginWithXboxRequest_1__Class** type_info() {
            static app::LoginWithXboxRequest_1__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::LoginWithXboxRequest_1__Class**)(modloader::win::memory::resolve_rva(0x04701140));
            }
            return cache;
        }

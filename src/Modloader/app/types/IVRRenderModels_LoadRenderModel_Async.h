...
namespace app::classes::types {
    namespace IVRRenderModels_LoadRenderModel_Async {
        inline app::IVRRenderModels_LoadRenderModel_Async__Class** type_info() {
            static app::IVRRenderModels_LoadRenderModel_Async__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::IVRRenderModels_LoadRenderModel_Async__Class**)(modloader::win::memory::resolve_rva(0x04798BC8));
            }
            return cache;
        }

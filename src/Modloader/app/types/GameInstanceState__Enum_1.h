...
namespace app::classes::types {
    namespace GameInstanceState__Enum_1 {
        inline app::GameInstanceState__Enum_1__Class** type_info() {
            static app::GameInstanceState__Enum_1__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::GameInstanceState__Enum_1__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

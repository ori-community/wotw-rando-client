...
namespace app::classes::types {
    namespace DepthOfFieldDeprecated_Dof34QualitySetting__Enum {
        inline app::DepthOfFieldDeprecated_Dof34QualitySetting__Enum__Class** type_info() {
            static app::DepthOfFieldDeprecated_Dof34QualitySetting__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::DepthOfFieldDeprecated_Dof34QualitySetting__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

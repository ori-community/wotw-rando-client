...
namespace app::classes::types {
    namespace LayeredRenderSettings__Array {
        inline app::LayeredRenderSettings__Array__Class** type_info() {
            static app::LayeredRenderSettings__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::LayeredRenderSettings__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

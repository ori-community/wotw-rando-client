...
namespace app::classes::types {
    namespace WorldEvents__Array {
        inline app::WorldEvents__Array__Class** type_info() {
            static app::WorldEvents__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::WorldEvents__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

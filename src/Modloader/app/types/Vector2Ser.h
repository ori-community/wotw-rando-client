...
namespace app::classes::types {
    namespace Vector2Ser {
        inline app::Vector2Ser__Class** type_info() {
            static app::Vector2Ser__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::Vector2Ser__Class**)(modloader::win::memory::resolve_rva(0x0478A3D8));
            }
            return cache;
        }

#pragma once
#include <Modloader/app/structs/MusicPlayerWantsVolume_t.h>
#include <Modloader/app/structs/MusicPlayerWantsVolume_t__Boxed.h>
...
namespace app::classes::types {
    namespace MusicPlayerWantsVolume_t {
        inline app::MusicPlayerWantsVolume_t__Class** type_info() {
            static app::MusicPlayerWantsVolume_t__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::MusicPlayerWantsVolume_t__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

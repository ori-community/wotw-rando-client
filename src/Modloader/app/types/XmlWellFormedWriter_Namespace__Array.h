...
namespace app::classes::types {
    namespace XmlWellFormedWriter_Namespace__Array {
        inline app::XmlWellFormedWriter_Namespace__Array__Class** type_info() {
            static app::XmlWellFormedWriter_Namespace__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::XmlWellFormedWriter_Namespace__Array__Class**)(modloader::win::memory::resolve_rva(0x0472D330));
            }
            return cache;
        }

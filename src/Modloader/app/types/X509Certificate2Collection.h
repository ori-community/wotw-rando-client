...
namespace app::classes::types {
    namespace X509Certificate2Collection {
        inline app::X509Certificate2Collection__Class** type_info() {
            static app::X509Certificate2Collection__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::X509Certificate2Collection__Class**)(modloader::win::memory::resolve_rva(0x04755468));
            }
            return cache;
        }

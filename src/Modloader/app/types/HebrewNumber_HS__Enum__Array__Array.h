...
namespace app::classes::types {
    namespace HebrewNumber_HS__Enum__Array__Array {
        inline app::HebrewNumber_HS__Enum__Array__Array__Class** type_info() {
            static app::HebrewNumber_HS__Enum__Array__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::HebrewNumber_HS__Enum__Array__Array__Class**)(modloader::win::memory::resolve_rva(0x047889E8));
            }
            return cache;
        }

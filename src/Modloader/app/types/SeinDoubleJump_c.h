...
namespace app::classes::types {
    namespace SeinDoubleJump_c {
        inline app::SeinDoubleJump_c__Class** type_info() {
            static app::SeinDoubleJump_c__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::SeinDoubleJump_c__Class**)(modloader::win::memory::resolve_rva(0x0475DEF8));
            }
            return cache;
        }

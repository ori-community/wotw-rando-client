...
namespace app::classes::types {
    namespace IVRSystem_GetControllerStateWithPose {
        inline app::IVRSystem_GetControllerStateWithPose__Class** type_info() {
            static app::IVRSystem_GetControllerStateWithPose__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::IVRSystem_GetControllerStateWithPose__Class**)(modloader::win::memory::resolve_rva(0x0473DC78));
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace AmbientOcclusion_SampleCount__Enum {
        inline app::AmbientOcclusion_SampleCount__Enum__Class** type_info() {
            static app::AmbientOcclusion_SampleCount__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::AmbientOcclusion_SampleCount__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace ControllerActionSetHandle_t {
        inline app::ControllerActionSetHandle_t__Class** type_info() {
            static app::ControllerActionSetHandle_t__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ControllerActionSetHandle_t__Class**)(modloader::win::memory::resolve_rva(0x0470B788));
            }
            return cache;
        }

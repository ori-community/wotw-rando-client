...
namespace app::classes::types {
    namespace PrimeGeneratorBase_1 {
        inline app::PrimeGeneratorBase_1__Class** type_info() {
            static app::PrimeGeneratorBase_1__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::PrimeGeneratorBase_1__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

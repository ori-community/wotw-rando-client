...
namespace app::classes::types {
    namespace DamageReceiver_DamageFilterType__Enum {
        inline app::DamageReceiver_DamageFilterType__Enum__Class** type_info() {
            static app::DamageReceiver_DamageFilterType__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::DamageReceiver_DamageFilterType__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

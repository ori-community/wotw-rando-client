...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_Blizzard {
        inline app::ShaderID_CameraFilterPack_Blizzard__Class** type_info() {
            static app::ShaderID_CameraFilterPack_Blizzard__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ShaderID_CameraFilterPack_Blizzard__Class**)(modloader::win::memory::resolve_rva(0x04713718));
            }
            return cache;
        }

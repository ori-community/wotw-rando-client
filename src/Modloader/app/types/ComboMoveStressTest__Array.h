...
namespace app::classes::types {
    namespace ComboMoveStressTest__Array {
        inline app::ComboMoveStressTest__Array__Class** type_info() {
            static app::ComboMoveStressTest__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::ComboMoveStressTest__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

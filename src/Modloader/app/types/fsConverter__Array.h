...
namespace app::classes::types {
    namespace fsConverter__Array {
        inline app::fsConverter__Array__Class** type_info() {
            static app::fsConverter__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::fsConverter__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace ICharacterInteractable__Array {
        inline app::ICharacterInteractable__Array__Class** type_info() {
            static app::ICharacterInteractable__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::ICharacterInteractable__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

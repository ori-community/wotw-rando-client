...
namespace app::classes::types {
    namespace Base64Encoder_1 {
        inline app::Base64Encoder_1__Class** type_info() {
            static app::Base64Encoder_1__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::Base64Encoder_1__Class**)(modloader::win::memory::resolve_rva(0x047737C0));
            }
            return cache;
        }

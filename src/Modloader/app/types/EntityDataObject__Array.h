...
namespace app::classes::types {
    namespace EntityDataObject__Array {
        inline app::EntityDataObject__Array__Class** type_info() {
            static app::EntityDataObject__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::EntityDataObject__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

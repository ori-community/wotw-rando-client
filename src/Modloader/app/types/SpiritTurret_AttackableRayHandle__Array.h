...
namespace app::classes::types {
    namespace SpiritTurret_AttackableRayHandle__Array {
        inline app::SpiritTurret_AttackableRayHandle__Array__Class** type_info() {
            static app::SpiritTurret_AttackableRayHandle__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SpiritTurret_AttackableRayHandle__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

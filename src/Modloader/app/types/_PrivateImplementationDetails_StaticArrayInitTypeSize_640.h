...
namespace app::classes::types {
    namespace _PrivateImplementationDetails_StaticArrayInitTypeSize_640 {
        inline app::_PrivateImplementationDetails_StaticArrayInitTypeSize_640__Class** type_info() {
            static app::_PrivateImplementationDetails_StaticArrayInitTypeSize_640__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::_PrivateImplementationDetails_StaticArrayInitTypeSize_640__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

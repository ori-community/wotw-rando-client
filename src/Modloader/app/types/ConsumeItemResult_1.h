...
namespace app::classes::types {
    namespace ConsumeItemResult_1 {
        inline app::ConsumeItemResult_1__Class** type_info() {
            static app::ConsumeItemResult_1__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ConsumeItemResult_1__Class**)(modloader::win::memory::resolve_rva(0x0477AF00));
            }
            return cache;
        }

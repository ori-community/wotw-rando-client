...
namespace app::classes::types {
    namespace GrantCharacterToUserResult_1 {
        inline app::GrantCharacterToUserResult_1__Class** type_info() {
            static app::GrantCharacterToUserResult_1__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::GrantCharacterToUserResult_1__Class**)(modloader::win::memory::resolve_rva(0x0472B9A8));
            }
            return cache;
        }

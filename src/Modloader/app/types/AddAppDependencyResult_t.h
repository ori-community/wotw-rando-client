...
namespace app::classes::types {
    namespace AddAppDependencyResult_t {
        inline app::AddAppDependencyResult_t__Class** type_info() {
            static app::AddAppDependencyResult_t__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::AddAppDependencyResult_t__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

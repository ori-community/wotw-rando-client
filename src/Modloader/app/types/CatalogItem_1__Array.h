...
namespace app::classes::types {
    namespace CatalogItem_1__Array {
        inline app::CatalogItem_1__Array__Class** type_info() {
            static app::CatalogItem_1__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::CatalogItem_1__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace HitReactionBehaviourOld_StaggetEntry__Array {
        inline app::HitReactionBehaviourOld_StaggetEntry__Array__Class** type_info() {
            static app::HitReactionBehaviourOld_StaggetEntry__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::HitReactionBehaviourOld_StaggetEntry__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

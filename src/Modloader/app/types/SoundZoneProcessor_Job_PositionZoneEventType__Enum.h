...
namespace app::classes::types {
    namespace SoundZoneProcessor_Job_PositionZoneEventType__Enum {
        inline app::SoundZoneProcessor_Job_PositionZoneEventType__Enum__Class** type_info() {
            static app::SoundZoneProcessor_Job_PositionZoneEventType__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SoundZoneProcessor_Job_PositionZoneEventType__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

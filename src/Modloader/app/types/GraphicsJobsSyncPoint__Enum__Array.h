...
namespace app::classes::types {
    namespace GraphicsJobsSyncPoint__Enum__Array {
        inline app::GraphicsJobsSyncPoint__Enum__Array__Class** type_info() {
            static app::GraphicsJobsSyncPoint__Enum__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::GraphicsJobsSyncPoint__Enum__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

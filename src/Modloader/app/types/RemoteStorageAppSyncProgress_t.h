...
#include <Modloader/app/structs/RemoteStorageAppSyncProgress_t__Boxed.h>
...
namespace app::classes::types {
    namespace RemoteStorageAppSyncProgress_t {
        inline app::RemoteStorageAppSyncProgress_t__Class** type_info() {
            static app::RemoteStorageAppSyncProgress_t__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::RemoteStorageAppSyncProgress_t__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

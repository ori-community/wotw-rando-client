...
namespace app::classes::types {
    namespace ConcurrentDictionary_2_TKey_TValue_Node_System_String_System_Object___Array {
        inline app::ConcurrentDictionary_2_TKey_TValue_Node_System_String_System_Object___Array__Class** type_info() {
            static app::ConcurrentDictionary_2_TKey_TValue_Node_System_String_System_Object___Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::ConcurrentDictionary_2_TKey_TValue_Node_System_String_System_Object___Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace HashSet_1_System_Int32___Array {
        inline app::HashSet_1_System_Int32___Array__Class** type_info() {
            static app::HashSet_1_System_Int32___Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::HashSet_1_System_Int32___Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

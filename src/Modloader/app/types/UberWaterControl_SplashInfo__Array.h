...
namespace app::classes::types {
    namespace UberWaterControl_SplashInfo__Array {
        inline app::UberWaterControl_SplashInfo__Array__Class** type_info() {
            static app::UberWaterControl_SplashInfo__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::UberWaterControl_SplashInfo__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

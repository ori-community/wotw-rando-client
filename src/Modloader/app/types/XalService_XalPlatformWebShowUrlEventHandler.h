...
namespace app::classes::types {
    namespace XalService_XalPlatformWebShowUrlEventHandler {
        inline app::XalService_XalPlatformWebShowUrlEventHandler__Class** type_info() {
            static app::XalService_XalPlatformWebShowUrlEventHandler__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::XalService_XalPlatformWebShowUrlEventHandler__Class**)(modloader::win::memory::resolve_rva(0x047611E0));
            }
            return cache;
        }

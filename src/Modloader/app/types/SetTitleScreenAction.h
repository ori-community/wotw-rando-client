...
namespace app::classes::types {
    namespace SetTitleScreenAction {
        inline app::SetTitleScreenAction__Class** type_info() {
            static app::SetTitleScreenAction__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::SetTitleScreenAction__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

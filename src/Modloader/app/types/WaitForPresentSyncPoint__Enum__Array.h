...
namespace app::classes::types {
    namespace WaitForPresentSyncPoint__Enum__Array {
        inline app::WaitForPresentSyncPoint__Enum__Array__Class** type_info() {
            static app::WaitForPresentSyncPoint__Enum__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::WaitForPresentSyncPoint__Enum__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

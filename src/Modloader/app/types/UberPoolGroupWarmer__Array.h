...
namespace app::classes::types {
    namespace UberPoolGroupWarmer__Array {
        inline app::UberPoolGroupWarmer__Array__Class** type_info() {
            static app::UberPoolGroupWarmer__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::UberPoolGroupWarmer__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

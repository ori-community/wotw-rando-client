...
namespace app::classes::types {
    namespace HitReaction_HitPointEffector_EffectorLink__Array {
        inline app::HitReaction_HitPointEffector_EffectorLink__Array__Class** type_info() {
            static app::HitReaction_HitPointEffector_EffectorLink__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::HitReaction_HitPointEffector_EffectorLink__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

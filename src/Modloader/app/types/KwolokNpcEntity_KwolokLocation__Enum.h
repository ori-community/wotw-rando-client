...
namespace app::classes::types {
    namespace KwolokNpcEntity_KwolokLocation__Enum {
        inline app::KwolokNpcEntity_KwolokLocation__Enum__Class** type_info() {
            static app::KwolokNpcEntity_KwolokLocation__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::KwolokNpcEntity_KwolokLocation__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

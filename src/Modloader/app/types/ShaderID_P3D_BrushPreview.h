...
namespace app::classes::types {
    namespace ShaderID_P3D_BrushPreview {
        inline app::ShaderID_P3D_BrushPreview__Class** type_info() {
            static app::ShaderID_P3D_BrushPreview__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ShaderID_P3D_BrushPreview__Class**)(modloader::win::memory::resolve_rva(0x04790578));
            }
            return cache;
        }

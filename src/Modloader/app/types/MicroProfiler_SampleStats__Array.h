...
namespace app::classes::types {
    namespace MicroProfiler_SampleStats__Array {
        inline app::MicroProfiler_SampleStats__Array__Class** type_info() {
            static app::MicroProfiler_SampleStats__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::MicroProfiler_SampleStats__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

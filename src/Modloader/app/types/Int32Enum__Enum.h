...
namespace app::classes::types {
    namespace Int32Enum__Enum {
        inline app::Int32Enum__Enum__Class** type_info() {
            static app::Int32Enum__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::Int32Enum__Enum__Class**)(modloader::win::memory::resolve_rva(0x0477BED8));
            }
            return cache;
        }

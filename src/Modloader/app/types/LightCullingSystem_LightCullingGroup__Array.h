...
namespace app::classes::types {
    namespace LightCullingSystem_LightCullingGroup__Array {
        inline app::LightCullingSystem_LightCullingGroup__Array__Class** type_info() {
            static app::LightCullingSystem_LightCullingGroup__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::LightCullingSystem_LightCullingGroup__Array__Class**)(modloader::win::memory::resolve_rva(0x0474FF30));
            }
            return cache;
        }

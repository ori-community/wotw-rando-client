...
namespace app::classes::types {
    namespace ShaderID_CameraFilterPack_TV_Old {
        inline app::ShaderID_CameraFilterPack_TV_Old__Class** type_info() {
            static app::ShaderID_CameraFilterPack_TV_Old__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ShaderID_CameraFilterPack_TV_Old__Class**)(modloader::win::memory::resolve_rva(0x04722BF8));
            }
            return cache;
        }

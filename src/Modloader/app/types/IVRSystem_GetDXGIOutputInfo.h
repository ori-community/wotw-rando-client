...
namespace app::classes::types {
    namespace IVRSystem_GetDXGIOutputInfo {
        inline app::IVRSystem_GetDXGIOutputInfo__Class** type_info() {
            static app::IVRSystem_GetDXGIOutputInfo__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::IVRSystem_GetDXGIOutputInfo__Class**)(modloader::win::memory::resolve_rva(0x0474EBF0));
            }
            return cache;
        }

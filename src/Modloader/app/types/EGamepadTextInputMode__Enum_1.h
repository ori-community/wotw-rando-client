...
namespace app::classes::types {
    namespace EGamepadTextInputMode__Enum_1 {
        inline app::EGamepadTextInputMode__Enum_1__Class** type_info() {
            static app::EGamepadTextInputMode__Enum_1__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::EGamepadTextInputMode__Enum_1__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

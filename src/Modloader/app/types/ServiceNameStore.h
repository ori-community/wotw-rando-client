...
namespace app::classes::types {
    namespace ServiceNameStore {
        inline app::ServiceNameStore__Class** type_info() {
            static app::ServiceNameStore__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ServiceNameStore__Class**)(modloader::win::memory::resolve_rva(0x04793608));
            }
            return cache;
        }

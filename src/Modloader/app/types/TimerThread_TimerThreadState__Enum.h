...
namespace app::classes::types {
    namespace TimerThread_TimerThreadState__Enum {
        inline app::TimerThread_TimerThreadState__Enum__Class** type_info() {
            static app::TimerThread_TimerThreadState__Enum__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::TimerThread_TimerThreadState__Enum__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

...
namespace app::classes::types {
    namespace ReflectionUtils_c_DisplayClass26_0 {
        inline app::ReflectionUtils_c_DisplayClass26_0__Class** type_info() {
            static app::ReflectionUtils_c_DisplayClass26_0__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::ReflectionUtils_c_DisplayClass26_0__Class**)(modloader::win::memory::resolve_rva(0x04702EA0));
            }
            return cache;
        }

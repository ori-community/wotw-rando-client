...
namespace app::classes::types {
    namespace ScreenshotText__Array {
        inline app::ScreenshotText__Array__Class** type_info() {
            static app::ScreenshotText__Array__Class** cache = nullptr;
            if (cache == nullptr) {
                static app::ScreenshotText__Array__Class* type_info_ref = nullptr;
                cache = &type_info_ref;
            }
            return cache;
        }

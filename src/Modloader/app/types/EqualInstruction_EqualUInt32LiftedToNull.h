...
namespace app::classes::types {
    namespace EqualInstruction_EqualUInt32LiftedToNull {
        inline app::EqualInstruction_EqualUInt32LiftedToNull__Class** type_info() {
            static app::EqualInstruction_EqualUInt32LiftedToNull__Class** cache = nullptr;
            if (cache == nullptr) {
                cache = (app::EqualInstruction_EqualUInt32LiftedToNull__Class**)(modloader::win::memory::resolve_rva(0x0471DE38));
            }
            return cache;
        }
